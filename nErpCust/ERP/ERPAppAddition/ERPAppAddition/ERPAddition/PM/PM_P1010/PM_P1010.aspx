<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PM_P1010.aspx.cs" Inherits="ERPAppAddition.ERPAddition.PM.PM_P1010.PM_P1010" %>
    ...
    <div>
        <table  style="border: thin solid #000080">
            ...
            <td class="style12">
                ...
                <td class="style13">
                    <asp:RadioButton ID="RadioButton1" runat="server" Text="BOM조회" Checked="True" 
                        GroupName="view_type" />
                    <asp:RadioButton ID="RadioButton2" runat="server" Text="라우팅조회" 
                        GroupName="view_type" />
                    <asp:RadioButton ID="RadioButton3" runat="server" Text="자품목투입정보조회" 
                        GroupName="view_type" />
                </td>
                <td class="style12">
