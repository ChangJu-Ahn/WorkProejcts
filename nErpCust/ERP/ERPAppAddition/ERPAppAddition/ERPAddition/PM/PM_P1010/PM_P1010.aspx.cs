...
using ERPAppAddition.ERPAddition.PM.PM_P1010;


namespace ERPAppAddition.ERPAddition.PM.PM_P1010
{
    public partial class PM_P1010 : System.Web.UI.Page
    {
        ...
        protected void bt_retrieve_Click(object sender, EventArgs e)
        {
            ...
            DataSet_pm_p1010 dt1 = new DataSet_pm_p1010();
            ReportViewer1.Reset();
            ReportCreator(dt1, sql, ReportViewer1, "pm_p1010.rdlc", "DataSet1");
        }
