<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="sm_s9001.aspx.cs" Inherits="ERPAppAddition.ERPAddition.SM.sm_s9001.ds_sm_s9001" %>
...
<body>
    ...
    <table><tr><td class="auto-style3">
        ...
        <td class="auto-style4"><asp:Label ID="Label2" runat="server" Text="주차별 전사재고" CssClass=title Width="100%"></asp:Label>
        </td></tr></table>        
    ...
    <table style="border: thin solid #000080; ">
        <tr>
            ...
            <td class="auto-style5">                
                <asp:DropDownList ID="str_week" runat="server" Height="22px" Width="170px" >
                </asp:DropDownList>
