<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="sm_s9011.aspx.cs" Inherits="ERPAppAddition.ERPAddition.SM.sm_s9011.sm_s9011" %>
...
<body>
    ...
    <table><tr><td class="auto-style3">
        ...
        <td class="auto-style4"><asp:Label ID="Label2" runat="server" Text="일별 손익레포트." Width="100%"></asp:Label>
        </td></tr></table>        
    ...
    <table style="border: thin solid #000080; ">
        ...
        <asp:Button ID="Button1" runat="server" Text="조회" Width="120px" onclick="Button1_Click" />
            </td>                      
        </tr>
    </table>
