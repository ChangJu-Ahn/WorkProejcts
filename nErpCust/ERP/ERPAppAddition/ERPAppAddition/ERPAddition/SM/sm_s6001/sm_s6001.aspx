<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="sm_s6001.aspx.cs" Inherits="ERPAppAddition.ERPAddition.SM.sm_s6001.sm_s6001" %>
...
<body>
    ...
    <table><tr><td class="auto-style3">
        ...
        <td class="auto-style4"><asp:Label ID="Label2" runat="server" Text="일일 매출현황" CssClass=title Width="100%"></asp:Label>
        </td></tr></table>        
