<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="sm_s1001.aspx.cs" Inherits="ERPAppAddition.ERPAddition.SM.sm_s1001.sm_s1001" %>
...
"></asp:SqlDataSource>
        ...
        <ContentTemplate>--%>
            <table><tr><td>
                ...
                &nbsp;&nbsp;<asp:Button ID="btn_chk_amt_exist" runat="server"  Text="단가미입력체크" 
                    onclick="btn_chk_amt_exist_Click" />
                </td></tr></table>
