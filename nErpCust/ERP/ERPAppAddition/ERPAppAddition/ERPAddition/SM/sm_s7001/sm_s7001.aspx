<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="sm_s7001.aspx.cs" Inherits="ERPAppAddition.ERPAddition.SM.sm_s7001.sm_s7001" %>
...
<body>
    ...
    <table><tr><td class="auto-style3">
        ...
        <td class="auto-style4"><asp:Label ID="Label2" runat="server" Text="EM 매출현황" CssClass=title Width="100%"></asp:Label>
        </td></tr></table>        
