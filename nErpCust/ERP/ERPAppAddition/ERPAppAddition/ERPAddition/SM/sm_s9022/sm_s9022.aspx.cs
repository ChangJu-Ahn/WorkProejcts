...
{
    public partial class sm_s9022 : System.Web.UI.Page
    {
        ...
        private void setGrid()
        {
            try
            {
                ...
                ReportViewer1.LocalReport.ReportPath = Server.MapPath("rd_sm_s9022.rdlc");
        ...
        private string getSQL()
        {
            ...
            /* 실적 조회 쿼리*/
            StringBuilder sbSQL = new StringBuilder();
            sbSQL.Append("USP_S_BOM_CHK02  '" + strDATE + "' \n");
