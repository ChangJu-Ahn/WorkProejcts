<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="sm_s9022b.aspx.cs" Inherits="ERPAppAddition.ERPAddition.SM.sm_s9022.sm_s9022b" %>
...
<body>
    ...
    <table><tr><td class="auto-style3">
        ...
        <td class="auto-style4"><asp:Label ID="Label2" runat="server" Text="자재출고관리집계" CssClass=title Width="100%"></asp:Label>
        </td></tr></table>        
