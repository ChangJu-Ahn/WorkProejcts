<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="sm_sa006.aspx.cs" Inherits="ERPAppAddition.ERPAddition.SM.sm_sa001.sm_sa006.sm_sa006" %>
                        ...
                        <td class="auto-style101">
                            <table>                                
                                <tr>
                                    ...
                                    <td colspan ="2" class="auto-style105">
                                ...
                                <tr>
                                    ...
                                    <td class="auto-style47">
                                        <asp:DropDownList ID="DDL_MACH" runat="server" Height="20px" style="margin-top: 0px" Width="105px" AutoPostBack="True" OnSelectedIndexChanged="DDL_MACH_SelectedIndexChanged">
                                        </asp:DropDownList>
                                    </td>
                                    <td class="auto-style102">    
                                        <asp:Label ID="Label15" runat="server" Text="Lot No :"></asp:Label>                                    
                                    </td>
                                    <td class="auto-style47">
                                        <asp:DropDownList ID="DDL_LOT" runat="server" Height="20px" style="margin-top: 0px" Width="147px">
                                        </asp:DropDownList>
                                    </td>
                                </tr>
                            </table>
                            ...
                            <table class="tbl_list" dir="ltr">
                                ...
                                <tr>
                                    ...
                                    <td colspan ="6" class="auto-style103" >                                        
                                        ...
                                        <asp:Button ID="btnCreateLotNo" runat="server" Text="Lot No 생성" OnClick="btnCreateLotNo_Click" />
                                    </td>                                    
                                </tr>
                            </table>
                        </td>
