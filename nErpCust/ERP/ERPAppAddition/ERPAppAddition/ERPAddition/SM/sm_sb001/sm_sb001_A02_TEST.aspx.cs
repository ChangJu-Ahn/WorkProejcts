...
{
    public partial class sm_sb001_A02_TEST : System.Web.UI.Page
    {
        string userid;
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!Page.IsPostBack)
            {
                ...
                if (Request.QueryString["process_instance_oid"] == null || Request.QueryString["process_instance_oid"] == "")
                    process_instance_oid = "2908"; // "358751";  // 미대상 359174  운영 397833   개발용  2738
                else
        ...
        private void search()
        {
            ...
            try
            {
                ...
                else
                {
                    ...
                    {
                        ImageButton1.ImageUrl = "http://192.168.10.113" + ds.Tables["DataSet1"].Rows[0]["IMAGE1_PATH"].ToString();
                    ...
                    {
                        ImageButton2.ImageUrl = "http://192.168.10.113" + ds.Tables["DataSet1"].Rows[0]["IMAGE2_PATH"].ToString();
                    ...
                    {
                        ImageButton3.ImageUrl = "http://192.168.10.113" + ds.Tables["DataSet1"].Rows[0]["IMAGE3_PATH"].ToString();
