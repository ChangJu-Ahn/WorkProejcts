<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="B2_B0001.aspx.cs" Inherits="ERPAppAddition.ERPAddition.B2.B2_B0001.B2_B0001" %>
...
<head runat="server">
    <title>거래처/납품처별 자동재고이동 창고등록</title>
    <style type="text/css">
        .title
        {
            font-family: 굴림체;
...
<body style="height: 300px; width: 1122px;">
    ...
    <div dir="ltr" style="height: 66px">    
        ...
        <asp:Panel ID="Panel1" runat="server" BackColor="White" Height="28px" 
            Width="1114px" BorderColor="White" BorderWidth="2px" HorizontalAlign="Right">            
            ...
            &nbsp;
            <asp:Button ID="btnSAVE" runat="server" BackColor="#FFFFCC" Font-Bold="True" Font-Size="Small" Height="26px" onclick="btnSAVE_Click" Text="저  장" Width="60px" />
        </asp:Panel>    
        <br />    
    </div>
    <div>
            <table  class="tbl_list" dir="ltr">               
                <tr>
                    <td class="auto-style33">
                        <asp:Label ID="Label3" runat="server" Text="거래처코드 : " Width="80px"></asp:Label>
                    </td>
                    <td class="auto-style34">                       
                        <asp:TextBox ID="txt_BP_CD" runat="server" style="text-align: center" Enabled="False" Width="70px" ></asp:TextBox>
                    </td>
                    <td class="auto-style33">
                        <asp:Label ID="Label7" runat="server" Text="MES 납품처코드 : " Width="120px"></asp:Label>
                    </td>
                    <td class="auto-style34">                       
                        <asp:TextBox ID="txt_MES_SHIPCD" runat="server" style="text-align: left" Enabled="true" Width="80px" ></asp:TextBox>
                    </td>
                    <td class="auto-style35">
                        <asp:Label ID="Label8" runat="server" Text="납품처명 : "></asp:Label>
                    </td>
                    <td class="auto-style17">
                        <asp:TextBox ID="txt_MES_SHIPNM" runat="server" style="text-align: left" Width="140px" ></asp:TextBox>
                    </td>
                    <td class="auto-style30">
                        <asp:Label ID="Label9" runat="server" Text="출하공장 : "></asp:Label>
                    </td>
                    <td class="auto-style43">
                        <asp:DropDownList ID="dnlPlantCd" runat="server" Height="23px" style="margin-top: 0px" Width="80px" OnSelectedIndexChanged="dnlPlant_SelectedIndexChanged" AutoPostBack="true">
                        </asp:DropDownList>
                    </td>
                    <td class="auto-style30">
                        <asp:Label ID="Label1" runat="server" Text="출하창고 : "></asp:Label>
                    </td>
                    <td class="auto-style44">
                        <asp:DropDownList ID="dnlSlcd" runat="server" Height="23px" style="margin-top: 0px" Width="300px" AutoPostBack="true">
                        </asp:DropDownList>
                    </td>
                </tr>
         </table>
...
<div style="width: 900px">                                
    <FarPoint:FpSpread ID="FpSpread1" runat="server" ActiveSheetViewIndex="0" BorderColor="Black" BorderStyle="Solid" BorderWidth="1px" currentPageIndex="0" DesignString="&lt;?xml version=&quot;1.0&quot; encoding=&quot;utf-8&quot;?&gt;&lt;Spread /&gt;" Height="532px" Width="1114px" OnCellClick="FpSpread1_CellClick" EnableTheming="True" UIVirtualization="True" CommandBarOnBottom="False" style="margin-right: 20px" >
