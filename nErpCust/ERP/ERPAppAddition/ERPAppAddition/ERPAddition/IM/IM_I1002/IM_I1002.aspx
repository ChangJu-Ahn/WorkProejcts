<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="IM_I1002.aspx.cs" Inherits="ERPAppAddition.ERPAddition.IM.IM_I1002.IM_I1002" %>
...
<body>
    ...
    <table  style="border: thin solid #000080">
            <tr>
                ...
                <td>
                    <asp:TextBox ID="tb_yyyymm" runat="server" Width="100px" MaxLength="6" 
                        CssClass="style16"></asp:TextBox>
                    <cc1:CalendarExtender ID="tb_yyyymm_CalendarExtender" runat="server" Format="yyyyMM"
                        Enabled="True" TargetControlID="tb_yyyymm">
...
ORDER BY 1">
            ...
            <td class="style12">
                ...
                <td>
                    <asp:DropDownList ID="ddl_item_acct" runat="server" 
                        DataSourceID="SqlDataSource2_itemacct" DataTextField="minor_nm" 
                        DataValueField="minor_cd">
                    </asp:DropDownList>
                    <asp:SqlDataSource ID="SqlDataSource2_itemacct" runat="server" 
...
ORDER BY 1">
                ...
                <td>
                    <asp:DropDownList ID="ddl_sl_cd" runat="server" 
                        DataSourceID="SqlDataSource_sl_cd" DataTextField="SL_NM" 
                        DataValueField="SL_CD">
                    </asp:DropDownList>
                    <asp:SqlDataSource ID="SqlDataSource_sl_cd" runat="server" 
                        ConnectionString="<%$ ConnectionStrings:nepes %>" 
                        
                        SelectCommand="select SL_CD, SL_NM from B_STORAGE_LOCATION where PLANT_CD = @plant_cd 
UNION ALL
SELECT '%','=== 전 체 ==='
ORDER BY 1">
                        <SelectParameters>
                ...
                <td class="style12"><asp:Label ID="Label5" runat="server" Text="조회구분"></asp:Label>
                </td>
                <td class="style13" colspan="3">
                    <asp:RadioButtonList ID="rbtn_view_type" runat="server" 
                        RepeatDirection="Horizontal" Width="445px" 
                        onselectedindexchanged="rbtn_view_type_SelectedIndexChanged" 
                        AutoPostBack="True">
                        <asp:ListItem Selected="True" Value="ERP">ERP 창고별 재고 금액조회</asp:ListItem>
                        <asp:ListItem Value="MES">MES 품목별 공정설 실적 조회</asp:ListItem>
                    </asp:RadioButtonList>
                    <asp:Panel ID="panel_erp_check" runat="server">
                         <asp:RadioButtonList ID="rbtn_erp_view_type" runat="server" 
                        RepeatDirection="Horizontal">
                        <asp:ListItem Selected="True" Value="A">집계조회</asp:ListItem>
                        <asp:ListItem Value="B">상세조회(가로)</asp:ListItem>
                        <asp:ListItem Value="C">상세조회(세로)</asp:ListItem>
                    </asp:RadioButtonList>
                    </asp:Panel>
                    <asp:Panel ID="panel_mes_check" runat="server">
                     <asp:RadioButtonList ID="rbtn_mes_view_type" runat="server" 
                        RepeatDirection="Horizontal" Visible="False">
                        <asp:ListItem Selected="True" Value="A">집계조회</asp:ListItem>
                        <asp:ListItem Value="B">상세조회</asp:ListItem>
                    </asp:RadioButtonList>
                    </asp:Panel>
                </td>
            </tr>
    ...
    <div>
        <rsweb:ReportViewer ID="ReportViewer1" runat="server" AsyncRendering="False" 
            Height="600px" Width="960px" SizeToReportContent="True">
        </rsweb:ReportViewer>
    </div>
    <cc1:ModalPopupExtender ID="ModalPopupExtender1" runat="server" BackgroundCssClass="modalBackground2"
        ...
        <asp:SqlDataSource ID="SqlDataSource_pop_query" runat="server" 
