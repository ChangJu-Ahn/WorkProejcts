<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MM_M1002.aspx.cs" Inherits="ERPAppAddition.ERPAddition.MM.MM_M1002.MM_M1002" %>
...
<head runat="server">
    <title>소모품창고 재고에 대한 기간별조회</title>
    <style type="text/css">
        .style12
        {
            width: 120px;
            ...
            <tr>
                ...
                <td class="auto-style2">
                    <asp:DropDownList ID="dl_plant_cd" runat="server" AppendDataBoundItems="True" Height="25px"
                        ...
                        DataValueField="PLANT_CD" AutoPostBack="True" OnSelectedIndexChanged="dl_plant_cd_SelectedIndexChanged">
                    </asp:DropDownList>
...
">
            ...
            <td class="style12">
                ...
                <td class="style13">
                 ...
                 <asp:TextBox ID="tb_item_cd" runat="server" Width="148px"></asp:TextBox>
         ...
         <table >
            ...
            <td class="style14">
                <asp:RadioButtonList ID="RadioButtonList1" runat="server" 
                    ...
                    <asp:ListItem Selected="True" Value="view1">소모품창고입고현황</asp:ListItem>
                    <asp:ListItem Value="view2">소모품창고출고현황</asp:ListItem>
                    <asp:ListItem Value="InOut">소모품창고입출고현황</asp:ListItem>
                </asp:RadioButtonList>
...
WHERE  a.item_cd = b.item_cd 
       ...
       AND a.item_acct in ('33','34','35','40')
