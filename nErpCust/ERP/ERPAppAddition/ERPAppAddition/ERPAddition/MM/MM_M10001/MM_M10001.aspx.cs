...
{
    public partial class MM_M10001 : System.Web.UI.Page
    {
        ...
        protected void bt_retrieve_Click(object sender, EventArgs e) //조회 버튼 클릭
        {
            ...
            cmd.CommandText = "dbo.USP_NIO_VIEW";
            ...
            SqlParameter param4 = new SqlParameter("@DLVY_FR_DT", SqlDbType.VarChar, 20);
            SqlParameter param5 = new SqlParameter("@DLVY_TO_DT", SqlDbType.VarChar, 20);
            SqlParameter param6 = new SqlParameter("@PUR_GROUP", SqlDbType.VarChar, 20);
            SqlParameter param7 = new SqlParameter("@PO_TYPE_CD", SqlDbType.VarChar, 20);

            string sql;
            string PLANT_CD, ITEM_CD, BP_CD, DLVY_FR_DT, DLVY_TO_DT, PUR_GROUP, PO_TYPE_CD;
            PLANT_CD = dl_plant_cd.SelectedValue;
            ITEM_CD = tb_item_cd.Text;
            BP_CD = tb_bp_cd.Text;
            DLVY_FR_DT = str_fr_dt.Text;
            DLVY_TO_DT = str_to_dt.Text;
            PUR_GROUP = dl_pur_grp.SelectedValue;
            PO_TYPE_CD = dl_po_type.SelectedValue;
            ...
            if (DLVY_FR_DT == null || DLVY_FR_DT == "")
                DLVY_FR_DT = "19900101";
            param5.Value = str_to_dt.Text;
            if (DLVY_TO_DT == null || DLVY_TO_DT == "")
                DLVY_TO_DT = "29991231";

            param6.Value = dl_pur_grp.SelectedValue;
            if (PUR_GROUP == null || PUR_GROUP == "")
                PUR_GROUP = "%";

            param7.Value = dl_po_type.SelectedValue;
            if (PO_TYPE_CD == null || PO_TYPE_CD == "")
                PO_TYPE_CD = "%";
            ...
            try
            {
                ...
                ReportViewer1.LocalReport.ReportPath = Server.MapPath("rp_mm_m10001.rdlc");
                ReportViewer1.LocalReport.DisplayName = "미입고상세조회(NEPES)" + DateTime.Now.ToShortDateString();
        ...
        {
           Response.Write("<script>window.open('pop_mm_m10001.aspx?pgid=mm_m10001&popupid=1','','top=100,left=100,width=800,height=600')</script>");
