<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MM_M10001.aspx.cs" Inherits="ERPAppAddition.ERPAddition.MM.MM_M10001.MM_M10001" %>
...
ORDER BY 1">
            ...
            <td class="style12">
                ...
                <td class="style13">
                    ...
                    <asp:DropDownList ID="dl_pur_grp" runat="server" 
                        DataSourceID="SqlDataSource2_sl_cd" DataTextField="PUR_GRP_NM" 
                        DataValueField="PUR_GRP" Height="25px" Width="221px">
                    </asp:DropDownList>
                    <asp:SqlDataSource ID="SqlDataSource2_sl_cd" runat="server" 
                        ConnectionString="<%$ ConnectionStrings:nepes %>" SelectCommand="Select Distinct PUR_GRP,PUR_GRP_NM From B_Pur_Grp Where  USAGE_FLG='Y' And PUR_GRP>= '' union all select '%', '전체' 
                                                                                             order by 1">
                        <SelectParameters>
                ...
                <cc1:CalendarExtender ID="CalendarExtender2" runat="server" Enabled="True"
                    ...
                    <asp:DropDownList ID="dl_po_type" runat="server" AppendDataBoundItems="True" Height="25px"
                        Width="170px" DataSourceID="SqlDataSource3" DataTextField="PO_TYPE_NM" 
                        DataValueField="PO_TYPE_CD" AutoPostBack="True">
                    </asp:DropDownList>
                    <asp:SqlDataSource ID="SqlDataSource3" runat="server" ConnectionString="<%$ ConnectionStrings:nepes %>"
                        SelectCommand=" Select Distinct PO_TYPE_CD,PO_TYPE_NM From   M_CONFIG_PROCESS Where  PO_TYPE_CD>= '' union all select '%', '전체'  order by 1">
