<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MM_M1001.aspx.cs" Inherits="ERPAppAddition.ERPAddition.MM.MM_M1001.MM_M1001" %>
         ...
         <table >
            ...
            <td class="style14">
                <asp:RadioButtonList ID="RadioButtonList1" runat="server" 
                    ...
                    <asp:ListItem Selected="True" Value="view1">구매입고현황</asp:ListItem>
                    <asp:ListItem Value="view2">구매미입고현황</asp:ListItem>
                    <asp:ListItem Value="view3">자재출고현황(재고이동:자재창고->생산LINE)</asp:ListItem>
                </asp:RadioButtonList>
                
                </td>
                <td>&nbsp;&nbsp;<asp:CheckBox ID="view2_release_flg" runat="server" 
                    Text="발주미확정포함" Visible="False" Checked="True" CssClass="style15" /></td>
                </tr>
        </table>
