<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MM_M5001.aspx.cs" Inherits="ERPAppAddition.ERPAddition.MM.MM_M5001.MM_M5001" %>
...
<body>
    ...
    <table><tr><td>
        ...
        <td  style="width:100%;"><asp:Label ID="Label2" runat="server" Text="자동발주서 생성" CssClass=title Width="100%"></asp:Label>
        </td></tr></table>       
