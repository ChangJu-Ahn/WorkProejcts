...
namespace ERPAppAddition.ERPAddition.MM.MM_M6002
{
    public partial class MM_M6002 : System.Web.UI.Page
    {
        ...
        protected void bt_retrieve_Click(object sender, EventArgs e) //조회 버튼 클릭
        {
            ...
            cmd.CommandText = "dbo.USP_IO_NOPRC_VIEW";
            ...
            try
            {
                ...
                ReportViewer1.LocalReport.ReportPath = Server.MapPath("rp_mm_m6002.rdlc");
                ReportViewer1.LocalReport.DisplayName = "입고상세조회(NEPES)(단가제외)" + DateTime.Now.ToShortDateString();
        ...
        {
            Response.Write("<script>window.open('../MM_M6001/pop_mm_m6001.aspx?pgid=mm_m6001&popupid=1','','top=100,left=100,width=1000,height=600')</script>");
        }
