<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AM_A4001.aspx.cs" Inherits="ERPAppAddition.ERPAddition.AM.AM_A4001.WebForm1" %>
...
<body>
    ...
    <div dir="ltr">
        ...
        <asp:Label ID="Label2" runat="server" Text="은행이체리스트(직원)" CssClass="title" Width="100%"></asp:Label>
        ...
        <asp:Panel ID="Panel1" runat="server" BackColor="White" Height="36px" 
            ...
            <asp:Label ID="Label1" runat="server" 
                ...
                Text="지금일(결의일)"></asp:Label>
            &nbsp;<asp:DropDownList ID="DDL_DATE" runat="server" Height="25px" Width="140px" style="text-align: left"></asp:DropDownList>
            &nbsp; &nbsp;
