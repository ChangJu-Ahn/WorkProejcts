...
using System.Linq;
using System.Web;
using ERPAppAddition.ERPAddition.AM.AM_AB1002;
...
namespace ERPAppAddition.ERPAddition.AM.AM_AB1002
{
    public class sa_fun
    {
        ...
        public DataTable getData(string sql, string DbName)
        {
            sql_conn = new SqlConnection(ConfigurationManager.ConnectionStrings[DbName].ConnectionString);
