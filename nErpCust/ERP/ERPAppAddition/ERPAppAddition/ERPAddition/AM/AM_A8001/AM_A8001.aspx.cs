...
using ERPAppAddition.ERPAddition.AM.AM_A8001;

namespace ERPAppAddition.ERPAddition.AM.AM_A8001
{
    public partial class AM_A8001 : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                tb_fr_dt.Text = DateTime.Today.Year.ToString("0000") + "-" + DateTime.Today.Month.ToString("00") + "-" + DateTime.Today.Day.ToString("00");
            }
        ...
        protected void bt_retrieve_Click(object sender, EventArgs e)
        {
            ...
            if (BIZ_AREA.SelectedItem.Text == "주문처")
            {
                sql = "EXEC USP_A_DEBT_STATEMENT_DEAL_BP_SERCH '" + tb_fr_dt.Text.Trim() + "','" + tb_item_cd.Text.Trim() + "', '" + dl_plant_cd.Text.Trim() + "'";
                DataSet_AM_A8001 dt1 = new DataSet_AM_A8001();
                ReportViewer1.Reset();
                ReportCreator(dt1, sql, ReportViewer1, "AM_A8001_1.rdlc", "DataSet1");
            }
            else
            {
                sql = "EXEC USP_A_DEBT_STATEMENT_PAY_BP_CD_SERCH '" + tb_fr_dt.Text.Trim() + "','" + tb_item_cd.Text.Trim() + "', '" + dl_plant_cd.Text.Trim() + "'";
                DataSet_AM_A8001 dt1 = new DataSet_AM_A8001();
                ReportViewer1.Reset();
                ReportCreator(dt1, sql, ReportViewer1, "AM_A8001_2.rdlc", "DataSet1");
            }
