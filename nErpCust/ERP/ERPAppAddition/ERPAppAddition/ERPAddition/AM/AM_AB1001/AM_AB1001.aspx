<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AM_AB1001.aspx.cs" Inherits="ERPAppAddition.ERPAddition.AM.AM_AB1001.AM_AB1001" %>
...
<body>
   ...
   <table>
       ...
       <asp:Image ID="Image1" runat="server" ImageUrl="~/img/folder.gif" />
                ...
                <td style="width: 100%;">
       <asp:Label ID="Label1" runat="server" Text="손익 Report 예산정보등록" CssClass="title" Width="100%"></asp:Label>
      </td>
            </tr>
        </table>
           </div>
        <table style="border: thin solid #000080; height: 31px;">
            ...
            <td class="style2">공장선택</td>
            <td class="auto-style3">
                        <asp:RadioButtonList ID="RadioButtonPlant" runat="server" Font-Size="Small" 
                            RepeatDirection="Horizontal" 
                            onselectedindexchanged="rbl_view_type_SelectedIndexChanged" 
                            AutoPostBack="True" Width="130px" style="margin-left: 0px; font-weight: 700;" 
                            BackColor="White" Height="16px" >
                            <asp:ListItem Value="SEMI" Selected="True">반도체</asp:ListItem>
                            <asp:ListItem Value="EM">음성</asp:ListItem>
                        </asp:RadioButtonList>  
             </td>
    </table> 
