...
using ERPAppAddition.ERPAddition.AM.AM_A4002_02;

namespace ERPAppAddition.ERPAddition.AM.AM_A4002_02
{
    public partial class AM_A4002_02 : System.Web.UI.Page
    {
        ...
        protected void Load_btn_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                ReportViewer1.LocalReport.ReportPath = Server.MapPath("rp_am_a4002_02.rdlc");
                ReportViewer1.LocalReport.DisplayName = "은행이체리스트(Display 직원)" + ddlDATE.Text + DateTime.Now.ToShortDateString();
