<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AM_A4002_02.aspx.cs" Inherits="ERPAppAddition.ERPAddition.AM.AM_A4002_02.AM_A4002_02" %>
...
<head runat="server">
    <title>은행이체리스트(Display 직원)</title>
    <style type="text/css">
...
<body>
    ...
    <div dir="ltr">
        ...
        <asp:Label ID="Label2" runat="server" Text="은행이체리스트(Display 직원)" CssClass="title" Width="100%"></asp:Label>
