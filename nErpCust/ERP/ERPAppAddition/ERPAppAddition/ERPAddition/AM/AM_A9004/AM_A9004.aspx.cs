...
namespace ERPAppAddition.ERPAddition.AM.AM_A9004
{
    public partial class AM_A9004 : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            ls_biz_area_cd_sql = "select biz_area_cd,biz_area_nm from view_divi";

            ls_date = "select  CONVERT(CHAR(6),GETDATE(),112)" ;

            ls_month_sql = "select distinct(yyyymm) yyyymm from day_m_report_01 order by yyyymm desc";
           ...
           // dr = cmd3.ExecuteReader();
            ...
            if (ddl_biz_area.Items.Count < 100)
            {
           ...
           // txt_yyyy.Text = ls_date;
            ...
            //Public Event  Load_btn_Click(object sender, EventArgs e)
        ...
        protected void Load_btn_Click(object sender, EventArgs e)
        {
            ...
            Select_Qurey = "USP_M_REPORT_F_1'" + ls_month + "' ";
            Select_Qurey1 = "USP_M_REPORT_F_2'" + ls_month + "' ";
