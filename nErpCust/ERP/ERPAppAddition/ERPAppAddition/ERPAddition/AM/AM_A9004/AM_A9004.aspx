<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AM_A9004.aspx.cs" Inherits="ERPAppAddition.ERPAddition.AM.AM_A9004.AM_A9004" %>
        ...
        <div>
            <table>
                <tr>
                    ...
                    <td style="width: 100%;">
                        <asp:Label ID="Label1" runat="server" Text="일일 자재수불현황" CssClass="title" Width="100%"></asp:Label>
                    </td>
                </tr>
            </table>
            <table style="border: thin solid #000080; height: 31px;">
                    ...
                    <td class="style1">
                        <asp:DropDownList ID="ddl_biz_area" runat="server" BackColor="#FFFF99" >
                        </asp:DropDownList>
                    </td>
                </td>
            </table>
            ...
            <table style="border: thin solid #000080; height: 31px;">
                <tr>
                   ...
                   <%-- <td class="auto-style5">
                      ...
                      <td class="style1">
                        <asp:DropDownList ID="ddl_month" runat="server" BackColor="#FFFF99" >
                        </asp:DropDownList>
                    </td>
