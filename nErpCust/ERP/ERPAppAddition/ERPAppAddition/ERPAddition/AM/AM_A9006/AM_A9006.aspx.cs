...
{
    public partial class AM_A9006 : System.Web.UI.Page
    {
        ...
        protected void Load_btn_Click(object sender, EventArgs e)
        {
            ...
            if (rbl_view_type.SelectedValue == "A")
            {
                Select_Qurey = "USP_COST_REPORT_1 '" + txt_yyyy.Text + "' ";
                Select_Qurey1 = "USP_COST_REPORT_9 '" + txt_yyyy.Text + "' ";

                DataSet_AM_A9006 dt1 = new DataSet_AM_A9006();
                DataSet_AM_A9006_1 dt2 = new DataSet_AM_A9006_1();


                ReportViewer1.Reset();
                //conn.Close();

                ReportCreator(dt1, Select_Qurey, dt2, Select_Qurey1, ReportViewer1, "Report_AM_9006.rdlc", "DataSet1", "DataSet2");
            }
            ...
            if (rbl_view_type.SelectedValue == "B")
            {
                ...
                Select_Qurey = "USP_COST_REPORT_1'" + txt_yyyy.Text + "' ";
                Select_Qurey1 = "USP_COST_REPORT_3'" + txt_yyyy.Text + "' ";

                //DataSet_AM_A9005_0 dt3 = new DataSet_AM_A9005_0();
