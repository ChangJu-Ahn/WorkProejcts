<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AM_A9003.aspx.cs" Inherits="ERPAppAddition.ERPAddition.AM.AM_A9003.AM_A9003" %>
        ...
        <div>
            <table>
                <tr>
                    ...
                    <td style="width: 100%;">
                        <asp:Label ID="Label1" runat="server" Text="계정명세서(매출채권,미수금,매입채무,미지급금)" CssClass="title" Width="100%"></asp:Label>
                    </td>
                </tr>
            </table>
            <table style="border: thin solid #000080; height: 31px;">
                ...
                <td class="style3">
                    <asp:RadioButtonList ID="rbl_view_type" runat="server" Font-Size="Small"
                        ...
                        AutoPostBack="True" Width="734px" Style="margin-left: 0px; font-weight: 700;"
                        BackColor="White" Height="21px">
                        <asp:ListItem Value="A" Selected="True">채권</asp:ListItem>
                        <asp:ListItem Value="B" >미수금</asp:ListItem>
                        <asp:ListItem Value="C" >매입채무</asp:ListItem>
                        <asp:ListItem Value="D" >미지급금</asp:ListItem>
                    </asp:RadioButtonList>
                </td>
            </table>
        </div>
...
<asp:ScriptManager ID ="scriptmanager1" runat ="server"></asp:ScriptManager>
        ...
        <asp:Panel ID="Panel_bas_info" runat="server" Visible="False" Width="400px">
            ...
            <table style="border: thin solid #000080; height: 31px;">
                <tr>
                    <td>
                        <asp:Label ID="lb_yyyy" runat="server" Font-Bold="True" Style="text-align: center; font-size: small" Text="[기간]" Visible="False"></asp:Label>
                    </td>
                    <td class="auto-style5">
                        <asp:TextBox ID="txt_yyyy" runat="server" Style="background-color: #FFFF99" Visible="False" Width="80px" ViewStateMode="Disabled"></asp:TextBox>
                    </td>
                    <td>
                        <asp:Label ID="lb_mm" runat="server" Font-Bold="True" Style="text-align: center; font-size: small" Text="~"  Visible="False"></asp:Label>
                    </td>
                    <td>
