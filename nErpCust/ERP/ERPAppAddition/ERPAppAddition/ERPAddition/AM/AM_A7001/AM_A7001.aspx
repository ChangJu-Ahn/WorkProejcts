<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AM_A7001.aspx.cs" Inherits="ERPAppAddition.ERPAddition.AM.AM_A7001.AM_A7001" %>
...
<body>
    ...
    <table>
        <tr>
            ...
            <td  style="width:100%;">
                <asp:Label ID="Label3" runat="server" Text="채권잔액명세서 조회" CssClass=title Width="100%"></asp:Label>
            </td>
        </tr>
    </table>
    </div>
