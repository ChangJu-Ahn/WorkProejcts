...
Dim txtInsrtUserId
	...
	With lgObjComm
		.CommandText = "usp_i_UPDATE_INOUT_UNBALANCE_KO441"
		...
		lgObjComm.Parameters.Append lgObjComm.CreateParameter("@UPDATE_COUNT1", 	adVarChar, adParamOutput,  9)
		lgObjComm.Parameters.Append lgObjComm.CreateParameter("@UPDATE_COUNT2", 	adVarChar, adParamOutput,  9)
		lgObjComm.Parameters.Append lgObjComm.CreateParameter("@UPDATE_COUNT3", 	adVarChar, adParamOutput,  9)
