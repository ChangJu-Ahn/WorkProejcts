...
'			Call DisplayMsgbox("800048","X","X","X")	'지급내역코드에 등록되지 않은 코드입니다.
			Call DisplayMsgBox("970000","X","사번","X")

            frm1.txtApp_name.value = ""
            frm1.txtApp_emp_no.focus
        ELSE    
            frm1.txtApp_name.value = Trim(Replace(lgF0,Chr(11),""))   '수당코드 
            txtApp_emp_no_Onchange = true
        END IF
    END IF 
End Function
                    ...
                    <TR>
                        <TD>
                            <TABLE cellSpacing=1 cellPadding=0 width=100% border=0 bgcolor=#DDDDDD>
                                <TR>
		                            <TD CLASS="ctrow01">근무구분</TD>
		                            <TD CLASS="ctrow06" COLSPAN=3><SELECT  CLASS="form01" NAME="txtDilig_cd" ALT="근무구분" STYLE="WIDTH: 150px" TAG="22"><OPTION VALUE=""></OPTION></SELECT>
		                            </TD>
                                </TR>
                                <TR>
		                            <TD CLASS="ctrow01">근무기간(FROM)</TD>
		                            <TD CLASS="ctrow06" COLSPAN=3>
										<INPUT CLASS="form01" ID="txtFrDilig_dt" NAME="txtFrDilig_dt" TYPE="Text" MAXLENGTH=10 SiZE=12 alt="근무날짜" STYLE="text-align: center" TAG="22D" onChange="vbscript:CalHHMM()" ondblclick="VBScript:Call OpenCalendar('txtFrDilig_dt',3)">&nbsp;
										<SELECT CLASS="form01" NAME="txtFrDilig_hour" ALT="시" STYLE="WIDTH: 50px" TAG="22" onChange="vbscript:CalHHMM()"><OPTION VALUE=""></OPTION></SELECT>시
										<SELECT CLASS="form01" NAME="txtFrDilig_min" ALT="분" STYLE="WIDTH: 50px" TAG="22" onChange="vbscript:CalHHMM()"><OPTION VALUE=""></OPTION></SELECT>분
&nbsp;~&nbsp;
										<INPUT CLASS="form01" ID="txtToDilig_dt" NAME="txtToDilig_dt" TYPE="Text" MAXLENGTH=10 SiZE=12 alt="근무날짜" STYLE="text-align: center" TAG="22D" onChange="vbscript:CalHHMM()" ondblclick="VBScript:Call OpenCalendar('txtFrDilig_dt',3)">&nbsp;
										<SELECT CLASS="form01" NAME="txtToDilig_hour" ALT="시" STYLE="WIDTH: 50px" TAG="22" onChange="vbscript:CalHHMM()"><OPTION VALUE=""></OPTION></SELECT>시
										<SELECT CLASS="form01" NAME="txtToDilig_min" ALT="분" STYLE="WIDTH: 50px" TAG="22" onChange="vbscript:CalHHMM()"><OPTION VALUE=""></OPTION></SELECT>분
		                            </TD>
                                </TR>  
                                <TR>
		                            <TD CLASS="ctrow01">근태시간</TD>
		                            <TD CLASS="ctrow06" COLSPAN=3>
										<SELECT CLASS="form01" NAME="txtDilig_hour" ALT="시간" STYLE="WIDTH: 50px" TAG="24"><OPTION VALUE=""></OPTION></SELECT>시간
										<SELECT CLASS="form01" NAME="txtDilig_min" ALT="분" STYLE="WIDTH: 50px" TAG="24"><OPTION VALUE=""></OPTION></SELECT>분
		                            </TD>
                                </TR>                                
                                <TR>
		                            <TD CLASS="ctrow01">사유</TD>
		                            <TD CLASS="ctrow06" COLSPAN=3><INPUT CLASS="form01" NAME="txtRemark" ALT="사유" TYPE="Text" MAXLENGTH=39 SiZE=40 TAG="22">
		                            </TD>
                                </TR>
		                        <TR>
		                            <TD CLASS="ctrow01">승인자</TD>
