...
Sub InitComboBox()
    ...
    Call SetCombo2(frm1.txtYear_Area_cd,iCodeArr,iNameArr,Chr(11))     
End Sub
...
'On Error Resume Next                                                    '☜: Protect system from crashing
	...
	Dim emp_no,bas_dt, txtYear, biz_area_cd,ocpt_type
    StrEbrFile = "h9113oa1_2004.ebr"

	With frm1
    	emp_no = .txtEmp_no1.value
	    txtYear = .txtYear.value
	    biz_area_cd = .txtYear_Area_cd.value 
	...
	if frm1.txtYear_Area_cd.value = "" then
        Call DisplayMsgBox("800094","X","X","X")
        frm1.txtYear_Area_cd.focus()
        exit function
    end if
                ...
                <TABLE width="100%" cellSpacing=1 cellPadding=0 border=0 bgcolor=#DDDDDD>
                    ...
                    <TR>
	                	...
	                	<TD CLASS=ctrow06 align=left>
                            <Select class="form02" NAME="txtYear_Area_cd" ALT="신고사업장" STYLE=" WIDTH: 200px" disabled></SELECT>
	                	</TD>
                    </TR>
                    <TR>
