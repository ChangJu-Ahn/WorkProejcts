...
Const BIZ_PGM_ID      = "e1emppopb2.asp"						           '☆: Biz Logic ASP Name
...
Sub MakeKeyStream(pOpt)
    ...
    if  pOpt = "Q" then
        ...
        if frm1.txtChkA.checked = true then
            lgKeyStream = lgKeyStream & "A" & gColSep
        elseif frm1.txtChkY.checked = true then
...
Function DoubleGetRow(pRow)
    ...
    with frm1
    	For elmCnt = 0 to .length - 1
    		...
    		If objList.name = "SPREADCELL_yn" & pRow then
       		    if objList.value = "등록" then
		...
		<tr> 
		  ...
		  <td align="right">
			<table border="0" cellspacing="0" cellpadding="0">
				<TR>
				  <TD class=ftgray><font color="057279">등록여부</font> :
    			      <INPUT class=ftgray TYPE="RADIO" NAME="txtChk" CHECKED ID="txtChkA" VALUE=A ><LABEL FOR="txtChkA">전체</LABEL>
				      <INPUT class=ftgray TYPE="RADIO" NAME="txtChk" ID="txtChkY" VALUE=Y ><LABEL FOR="txtChkY">등록</LABEL>
    			      <INPUT class=ftgray TYPE="RADIO" NAME="txtChk" ID="txtChkN" VALUE=N ><LABEL FOR="txtChkN">미등록</LABEL>
				  </TD>
				</TR>
		    </table></td>
		  <td></td>
        ...
        <TR>
           ...
           <td><table width="100%" border="0" cellspacing="1" cellpadding="0" bgcolor="DDDDDD">
				<TR> 
		            ...
		            <TD class=TDFAMILY_TITLE1>등록여부</TD>
                </TR>
				<%            
				For i=1 To 7
				Response.Write "<TR flag='SPREADCELL' bgcolor=#F8F8F8 height=19 onclick='vbscript: Call DoubleGetRow(" & i & ")' onMouseOver=" & chr(34) & "javascript: this.style.backgroundColor='E1EEF1'" & chr(34) & " onMouseOut=" & chr(34) & "javascript: this.style.backgroundColor=''" & chr(34) & ">"
				...
				Response.Write "<TD><INPUT class=listrow01 name='SPREADCELL_name" & i & "' flag='SPREADCELL' style='WIDTH: 80px; TEXT-ALIGN: center' onMouseOver='vbscript: Call MouseRow(" & i & ")'></TD>"
				Response.Write "<TD><INPUT class=listrow01 name='SPREADCELL_dept_nm" & i & "' flag='SPREADCELL' style='WIDTH: 140px; TEXT-ALIGN: left' onMouseOver='vbscript: Call MouseRow(" & i & ")'></TD>"
				...
				Response.Write "<TD><INPUT class=listrow01 name='SPREADCELL_res_no" & i & "' flag='SPREADCELL' style='WIDTH: 90px; TEXT-ALIGN: left'  onMouseOver='vbscript: Call MouseRow(" & i & ")'></TD>"
				Response.Write "<TD><INPUT class=listrow01 name='SPREADCELL_yn" & i & "' flag='SPREADCELL' style='WIDTH: 70px; TEXT-ALIGN: center' onMouseOver='vbscript: Call MouseRow(" & i & ")'></TD>"
				Response.Write "</TR>"
				Next
				%>
               </table>
