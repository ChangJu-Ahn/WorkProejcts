...
Const BIZ_PGM_ID      = "e1104mb1.asp"						           '☆: Biz Logic ASP Name
                    ...
                    <TR>
                        <td><table width="100%" border="0" cellspacing="1" cellpadding="0" bgcolor="DDDDDD">
								<TR> 
								    ...
								    <TD class=TDFAMILY_TITLE1>관계</TD>
								    <TD class=TDFAMILY_TITLE1>성명</TD>
								    <TD class=TDFAMILY_TITLE1>주민번호</TD>
								    <TD class=TDFAMILY_TITLE1>학력</TD>
								    <TD class=TDFAMILY_TITLE1>직업</TD>
		                        	<TD class=TDFAMILY_TITLE1>회사</TD>
		                        	<TD class=TDFAMILY_TITLE1>직위</TD>
		                        	<TD class=TDFAMILY_TITLE1>부양</TD>
		                        	<TD class=TDFAMILY_TITLE1>동거</TD>
		                        	<TD class=TDFAMILY_TITLE1>건강</TD>
		                        	<TD class=TDFAMILY_TITLE1>수당</TD>
								</TR>
							    <% 
                                For i=1 To 10
                                    ...
                                    Response.Write "<TD><INPUT name='SPREADCELL' class=listrow01 flag='SPREADCELL' style='WIDTH:  65px;' readonly></TD>"
                                    Response.Write "<TD><INPUT name='SPREADCELL' class=listrow01 flag='SPREADCELL' style='WIDTH:  80px;' readonly></TD>"
                                	Response.Write "<TD><INPUT name='SPREADCELL' class=listrow01 flag='SPREADCELL' style='WIDTH: 100px; text-align: center;' readonly></TD>"
                                	Response.Write "<TD><INPUT name='SPREADCELL' class=listrow01 flag='SPREADCELL' style='WIDTH:  70px;' readonly></TD>"
                                	Response.Write "<TD><INPUT name='SPREADCELL' class=listrow01 flag='SPREADCELL' style='WIDTH:  70px;' readonly></TD>"
                                	Response.Write "<TD><INPUT name='SPREADCELL' class=listrow01 flag='SPREADCELL' style='WIDTH:  85px;' readonly></TD>"
                                	Response.Write "<TD><INPUT name='SPREADCELL' class=listrow01 flag='SPREADCELL' style='WIDTH:  60px; text-align: center;' readonly></TD>"
                                	Response.Write "<TD><INPUT name='SPREADCELL' class=listrow01 flag='SPREADCELL' style='WIDTH:  40px; text-align: center;' readonly></TD>"
                                	Response.Write "<TD><INPUT name='SPREADCELL' class=listrow01 flag='SPREADCELL' style='WIDTH:  40px; text-align: center;' readonly></TD>"
                                	Response.Write "<TD><INPUT name='SPREADCELL' class=listrow01 flag='SPREADCELL' style='WIDTH:  40px; text-align: center;' readonly></TD>"
                                	Response.Write "<TD><INPUT name='SPREADCELL' class=listrow01 flag='SPREADCELL' style='WIDTH:  40px; text-align: center;' readonly></TD>"
                                    Response.Write "</TR>"
