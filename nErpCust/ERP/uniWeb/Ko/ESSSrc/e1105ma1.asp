                    ...
                    <TR>
                        <td><table width="100%" border="0" cellspacing="1" cellpadding="0" bgcolor="DDDDDD">
                                ...
                                For i=1 To 10
                                    ...
                                    Response.Write "<TD><INPUT name='SPREADCELL' class=listrow01 flag='SPREADCELL' style='WIDTH: 114px;' readonly></TD>"
                                    Response.Write "<TD><INPUT name='SPREADCELL' class=listrow01 flag='SPREADCELL' style='WIDTH:  95px; text-align: center;' readonly></TD>"
                                	Response.Write "<TD><INPUT name='SPREADCELL' class=listrow01 flag='SPREADCELL' style='WIDTH:  95px; text-align: center;' readonly></TD>"
                                	Response.Write "<TD><INPUT name='SPREADCELL' class=listrow01 flag='SPREADCELL' style='WIDTH:  60px; text-align: right;' readonly></TD>"
                                	Response.Write "<TD><INPUT name='SPREADCELL' class=listrow01 flag='SPREADCELL' style='WIDTH: 180px;' readonly></TD>"
                                	Response.Write "<TD><INPUT name='SPREADCELL' class=listrow01 flag='SPREADCELL' style='WIDTH: 150px;' readonly></TD>"
                                    Response.Write "</TR>"
                                Next
								%>
                           </table>
