...
Const BIZ_PGM_ID      = "e1310mb2.asp"						           '☆: Biz Logic ASP Name
...
Sub InitComboBox()
 ...
 '---------------------
     ...
     iCodeArr="1" & Chr(11) & "2" & Chr(11) &  "3" & Chr(11)
     iNameArr="신용카드" & Chr(11) &"현금영수증" & Chr(11) &"학원비지로납부" & Chr(11)
...
Sub Form_Load()
    ...
    lgIntFlgMode = OPMD_CMODE   'insert mo'de
    gQuery_YN = ""              
...
Sub txttype_cd_onChange()
	
	if frm1.txttype_cd.value="2" then '현금영수증 
		
		frm1.txtSubmit_cd.value="Y"
		ProtectTag(frm1.txtSubmit_cd)
	else
	
		frm1.txtSubmit_cd.value="N"
		ReleaseTag(frm1.txtSubmit_cd)	
...
Function OpenCode(pCode)
	...
	arrParam(4) = " CARD_YN='Y' and year_yy = " & FilterVar(frm1.txtYear.value, "''", "S") & " and emp_no = " & FilterVar(frm1.txtEmp_no.value, "''", "S") & " and family_name like " 	'WHERE조건 
	...
	Else
		...
		frm1.txtRel_nm.value = arrRet(1)
 		 ...
 		 " MAJOR_CD ='H0140' AND card_YN = 'Y' AND FAMILY_NAME = " & FilterVar(frm1.txtFamilyName.value, "''", "S")  &_
                        ...
                        <TD>
                            <TABLE cellSpacing=1 cellPadding=0 width=100% border=0 bgcolor=#DDDDDD>
                                ...
                                <TR>
		                            ...
		                            <TD CLASS="ctrow06">
		                            <SELECT CLASS="form01" NAME="txtType_cd" ALT="구분" STYLE="WIDTH: 120px" TAG="22">
		                            </TD>
                                </TR>
                                <TR>
