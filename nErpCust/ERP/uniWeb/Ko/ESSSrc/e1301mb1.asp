...
<Script Language=vbscript>
       With Parent	     
            ...
            .Frm1.txtTax_Union_Ded.Value      = "<%=UNINumClientFormat(lgObjRs("TAX_UNION_DED"), ggAmtOfMoney.DecPoint, 0)%>"
...
'-- 2003 외국인근로자교육비 추가 
    ...
    lgStrSQL = lgStrSQL & "       Retire_pension	   = " & UNIConvNum(Request("txtRetire_pension"),0)      & ","		'2005
...
'-- 2003 직불카드 추가 
    ...
    lgStrSQL = lgStrSQL & "       INSTITUTION_GIRO     = " & UNIConvNum(Request("txtInstitution_giro"),0)         & "," '2005   
      ...
      Case "C"
             Select Case  lgPrevNext 
	                Case ""
                         ...
                         lgStrSQL = lgStrSQL & "       UNIV_EDU, KIND_EDU, KIND_EDU_CNT, UNIV_EDU_CNT, LEGAL_CONTR, APP_CONTR,TaxLaw_contr_amt,TaxLaw_contr_amt2, "             
                         lgStrSQL = lgStrSQL & "       PRIV_CONTR, HOUSE_FUND, INDIV_ANU, SAVE_TAX_SUB, HOUSE_REPAY, TAX_UNION_DED,"
                         lgStrSQL = lgStrSQL & "       STOCK_SAVE,  FORE_PAY, INCOME_REDU, TAXES_REDU, INDIV_ANU2, "
                         lgStrSQL = lgStrSQL & "       invest2_sub_amt,RETIRE_PENSION, CARD_USE_AMT, FAM_EDU_CNT,  "
                         lgStrSQL = lgStrSQL & "       LONG_HOUSE_LOAN_AMT, AFTER_BONUS_AMT, NATIONAL_PENSION_AMT "
						 lgStrSQL = lgStrSQL & "		,  disabled_edu_amt,our_stock_amt,FORE_EDU_AMT,CARD2_USE_AMT,INSTITUTION_GIRO,"                                                  
						 lgStrSQL = lgStrSQL & "		CEREMONY_CNT,CEREMONY_AMT,POLI_CONTRA_AMT1,OURSTOCK_CONTRA_AMT,LONG_HOUSE_LOAN_AMT1 "   '2004년 
