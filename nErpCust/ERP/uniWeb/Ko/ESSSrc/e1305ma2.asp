...
Const BIZ_PGM_ID      = "e1305mb2.asp"						           '☆: Biz Logic ASP Name
...
Sub InitComboBox()
 ...
 '---------------------
    Call CommonQueryRs(" MINOR_CD,MINOR_NM "," B_MINOR "," MAJOR_CD = 'H0070'",lgF0,lgF1,lgF2,lgF3,lgF4,lgF5,lgF6)
...
Function OpenCode(pCode)
	...
	arrParam(4) = " EDU_YN='Y' and year_yy = " & FilterVar(frm1.txtYear.value, "''", "S") & " and emp_no = " & FilterVar(frm1.txtEmp_no.value, "''", "S") & " and family_name like " 	'WHERE조건 
	...
	Else
		...
		Call CommonQueryRs(" top 1 MINOR_CD , PARIA_YN "," B_MINOR , HFA150T", " MAJOR_CD ='H0140' AND MINOR_NM = " & FilterVar(frm1.txtRel_nm.value, "''", "S") &_
		" AND EDU_YN = 'Y' AND FAMILY_NAME = " & FilterVar(frm1.txtFamilyName.value, "''", "S")  & " AND EMP_NO= " & FilterVar(frm1.txtEmp_no.value, "''", "S") & " AND YEAR_YY = " & FilterVar(frm1.txtYear.value, "''", "S")_
		,lgF0,lgF1,lgF2,lgF3,lgF4,lgF5,lgF6)
		
		frm1.txtRel_cd.value = replace(lgF0,chr(11),"")	

		If frm1.txtRel_cd.value = "0" Then
			frm1.txtType_cd.value = "M"
			ProtectTag(frm1.txtType_cd)	
		ElseIf Trim(Replace(lgF1,Chr(11),"")) = "Y" Then
			frm1.txtType_cd.value = "H"
			ProtectTag(frm1.txtType_cd)	
		Else
			frm1.txtType_cd.selectedindex = 0
			ReleaseTag(frm1.txtType_cd)	
		End If
 	End If	
...
Function txtFamilyName_Onchange()
    ...
    Else
 		...
 		IntRetCd = CommonQueryRs(" top 1 MINOR_CD,MINOR_NM , PARIA_YN "," HFA150T  left outer join  B_MINOR   on HFA150T.FAMILY_REL= B_MINOR.MINOR_CD ",_
 		 " MAJOR_CD ='H0140' AND EDU_YN = 'Y' AND FAMILY_NAME = " & FilterVar(frm1.txtFamilyName.value, "''", "S")  &_
...
<FORM NAME=frm1 TARGET="MyBizASP" METHOD="POST">
                        ...
                        <TD>
                            <TABLE cellSpacing=1 cellPadding=0 width=100% border=0 bgcolor=#DDDDDD>
                                ...
                                <TR>
		                            ...
		                            <TD CLASS="ctrow06"><SELECT CLASS="form01" NAME="txtType_cd" ALT="구분" STYLE="WIDTH: 150px" TAG="22"><OPTION VALUE="">
		                            </TD>
                                </TR>
                                <TR>
    ...
    <INPUT TYPE=HIDDEN NAME="htxtAmt"    TAG="24">
