...
<%
	...
	'        Call SubSkipRs(lgObjRs,lgMaxCount * lgStrPrevKeyIndex)
	        ...
	        Do While Not lgObjRs.EOF
	            ...
	            lgstrData = lgstrData & Chr(11) & UNINumClientFormat(lgObjRs("edu_score"), ggQty.DecPoint, 0)
	            ...
	            lgstrData = lgstrData & Chr(11) & UNINumClientFormat(lgObjRs("add_point"), ggQty.DecPoint, 0)
