...
Const BIZ_PGM_ID      = "e1deptpopb1.asp"						           '☆: Biz Logic ASP Name
...
Sub MakeKeyStream(pOpt)
    if  pOpt = "Q" then
        lgKeyStream = Trim(frm1.txtDept_cd.Value) & gColSep       'You Must append one character(gColSep)
        lgKeyStream = lgKeyStream & Trim(frm1.txtDept_nm.Value) & gColSep       'You Must append one character(gColSep)
...
Function GridDsplay()
	...
	For i=1 To C_SHEETMAXROWS
	    ...
	    document.writeln "<TD><INPUT class=listrow01 type=text name='SPREADCELL_dept_cd" & i & "' flag='SPREADCELL' style='WIDTH: 180px; TEXT-ALIGN: left' onMouseOver='vbscript: Call MouseRow(" & i & ")'></TD>"
	    document.writeln "<TD><INPUT class=listrow01 name='SPREADCELL_dept_nm" & i & "' flag='SPREADCELL' style='WIDTH: 350px; TEXT-ALIGN: left'  onMouseOver='vbscript: Call MouseRow(" & i & ")'></TD>"
	    document.writeln "</TR>"
	Next
End Function
...
Sub Form_Load()
    ...
    frm1.txtDept_cd.value = arrParam(0)
	frm1.txtDept_nm.value = arrParam(1)
...
Function DbQueryOk()
    Err.Clear  
    frm1.txtDept_cd.Value=Trim(frm1.txtDept_cd.Value)  
    frm1.txtDept_nm.Value=Trim(frm1.txtDept_nm.Value)         
...
Function DoubleGetRow(pRow)
    ...
    with frm1
    	For elmCnt = 0 to .length - 1
    		...
    		If objList.name = "SPREADCELL_dept_cd" & pRow then
		              ...
		              <td height="30" align="center" bgcolor="#FFFFFF"> 
		                <table border="0" cellspacing="0" cellpadding="1">
		                  <tr> 
		                    ...
		                    <td class="ftgray">부서코드</td>
		                    <td width="5"></td>
		                    <td><input name="txtDept_cd" type="text" class="form01" MAXLENGTH=13 SiZE=12></td>
		                    <td width="20"></td>
		                    <td><img src="../../CShared/ESSimage/icon_03.gif" width="10" height="12"></td>
		                    <td class="ftgray">부서명</td>
		                    <td width="5"></td>
		                    <td><input name="txtDept_nm" type="text" class="form01" MAXLENGTH=20 SiZE=20></td>
		                  </tr>
		                </table>
		              </td>
		            </tr>
        ...
        <TR>
           ...
           <td><table width="100%" border="0" cellspacing="1" cellpadding="0" bgcolor="DDDDDD">
					<TR> 
		            	...
		            	<TD class=TDFAMILY_TITLE1>부서코드</TD>
