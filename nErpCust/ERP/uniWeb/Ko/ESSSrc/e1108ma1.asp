                    ...
                    <TR>
                        <td><table width="100%" border="0" cellspacing="1" cellpadding="0" bgcolor="DDDDDD">
								<TR> 
		                        	...
		                        	<TD class=TDFAMILY_TITLE1>1차평가자의견</TD>
                                </TR>
							    <% 
                                For i=1 To 10
                                    ...
                                    Response.Write "<TD><INPUT name='SPREADCELL' class=listrow01 flag='SPREADCELL' style='WIDTH:  80px; text-align: center;'  readonly></TD>"
                                    Response.Write "<TD><INPUT name='SPREADCELL' class=listrow01 flag='SPREADCELL' style='WIDTH: 184px; text-align: left;' readonly></TD>"
                                	...
                                	Response.Write "<TD><INPUT name='SPREADCELL' class=listrow01 flag='SPREADCELL' style='WIDTH:  80px; text-align: center;' readonly></TD>"
                                	Response.Write "<TD><INPUT name='SPREADCELL' class=listrow01 flag='SPREADCELL' style='WIDTH: 220px; text-align: left;' readonly></TD>"
                                    Response.Write "</TR>"
                                Next
								%>
                           </table>
