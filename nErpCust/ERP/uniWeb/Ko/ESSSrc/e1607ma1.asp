                        ...
                        <td><table width="100%" border="0" cellspacing="1" cellpadding="0" bgcolor="DDDDDD">
							<TR> 
							    <TD class=TDFAMILY_TITLE1></TD>
		                        	...
		                        	<TD NOWRAP class=TDFAMILY_TITLE1>근무날짜</TD>
		                        	<TD NOWRAP class=TDFAMILY_TITLE1>시간</TD>	
		                        	<TD NOWRAP class=TDFAMILY_TITLE1>분</TD>			                        		                        	
		                        	<TD NOWRAP class=TDFAMILY_TITLE1>근태</TD>
							...
							For i=1 To 10
							     ...
							     Response.Write "<TD><INPUT class=listrow01 name='SPREADCELL_EMP_NO" & i & "' flag='SPREADCELL' style='WIDTH: 85px; text-align: left;')' readonly></TD>"
							     Response.Write "<TD><INPUT class=listrow01 name='SPREADCELL' flag='SPREADCELL' style='WIDTH: 90px; text-align:5 left;' readonly></TD>"
							     Response.Write "<TD><INPUT class=listrow01 name='SPREADCELL_DILIG_DT" & i & "' flag='SPREADCELL' style='WIDTH:  80px; text-align: center;' readonly></TD>"
							     Response.Write "<TD align=right><INPUT class=listrow01 name='SPREADCELL_DILIG_HOUR" & i & "' flag='SPREADCELL' style='WIDTH: 46px; text-align: right;' readonly></TD>"
							     Response.Write "<TD align=right><INPUT class=listrow01 name='SPREADCELL_DILIG_MIN" & i & "' flag='SPREADCELL' style='WIDTH:  35px; text-align: right;' readonly></TD>"
							     ...
							     Response.Write "    <INPUT class=listrow01 name='SPREADCELL" & i & "' flag='SPREADCELL' style='WIDTH: 80px; text-align: left;' readonly></TD>"
								 ...
								 Response.Write "<TD align=center><INPUT class=listrow01 type='hidden' name='SPREADCELL_APP_YN1_" & i & "' flag='SPREADCELL' size=10 style='WIDTH: 40px;'>"
