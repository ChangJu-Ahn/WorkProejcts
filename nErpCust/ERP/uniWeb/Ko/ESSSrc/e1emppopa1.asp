...
Const BIZ_PGM_ID      = "e1emppopb1.asp"						           '☆: Biz Logic ASP Name
...
Function GridDsplay()
	...
	For i=1 To C_SHEETMAXROWS
	    ...
	    document.writeln "<TD><INPUT class=listrow01 name='SPREADCELL_name" & i & "' flag='SPREADCELL' style='WIDTH: 90px; TEXT-ALIGN: center'  onMouseOver='vbscript: Call MouseRow(" & i & ")'></TD>"
	    document.writeln "<TD><INPUT class=listrow01 name='SPREADCELL_dept_nm" & i & "' flag='SPREADCELL' style='WIDTH: 220px; TEXT-ALIGN: left'  onMouseOver='vbscript: Call MouseRow(" & i & ")'></TD>"
	    document.writeln "<TD><INPUT class=listrow01 name='SPREADCELL" & i & "' flag='SPREADCELL' style='WIDTH: 80px; TEXT-ALIGN: left'  onMouseOver='vbscript: Call MouseRow(" & i & ")'></TD>"
