                    ...
                    <TR>
                        <td><table width="100%" border="0" cellspacing="1" cellpadding="0" bgcolor="DDDDDD">
								<TR> 
		                        	...
		                        	<TD class=TDFAMILY_TITLE1>근무날짜</TD>
		                        	<TD class=TDFAMILY_TITLE1>시간</TD>	
		                        	<TD class=TDFAMILY_TITLE1>분</TD>		                        		                        	
		                        	<TD class=TDFAMILY_TITLE1>근무구분</TD>
                                ...
                                For i=1 To 9
                                	...
                                	Response.Write "    <INPUT class=listrow01 name='SPREADCELL" & i & "' flag='SPREADCELL' style='WIDTH: 155px; text-align: left;'  onMouseOver='vbscript: Call MouseRow(" & i & ")'></TD>"
                                    Response.Write "<TD><INPUT class=listrow01 name='SPREADCELL" & i & "' flag='SPREADCELL' style='WIDTH: 230px; text-align: left;' onMouseOver='vbscript: Call MouseRow(" & i & ")' readonly></TD>"
                                    Response.Write "<TD><INPUT class=listrow01 name='SPREADCELL_app_emp_no" & i & "' flag='SPREADCELL' style='WIDTH: 88px; text-align: center;' onMouseOver='vbscript: Call MouseRow(" & i & ")' readonly></TD>"
                                    Response.Write "<TD><INPUT class=listrow01 name='SPREADCELL_app_yn" & i & "' flag='SPREADCELL' style='WIDTH: 70px; text-align: center;' onMouseOver='vbscript: Call MouseRow(" & i & ")' readonly></TD>"
                                    Response.Write "</TR>"
                                Next
								%>
                           </table>
