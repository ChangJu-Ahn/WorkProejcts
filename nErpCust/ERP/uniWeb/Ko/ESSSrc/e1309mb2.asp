...
<Script Language=vbscript>
       With Parent	
            ...
            .frm1.txtAmt.value = "<%=UNINumClientFormat(lgObjRs("INSUR_AMT"),ggAmtOfMoney.DecPoint, 0)%>"
...
Sub SubBizSaveSingleCreate()
	...
	'중복 데이터를 check 한다 
	Call CommonQueryRs(" count(EMP_NO) "," HFA170T "," EMP_NO = " & FilterVar(lgKeyStream(0),"''","S")& " AND YEAR_YY = " & FilterVar(lgKeyStream(1),"''","S") &_
	"   AND FAMILY_NAME = "	& FilterVar(lgKeyStream(2),"''","S") & " AND FAMILY_Rel = " & FilterVar(lgKeyStream(3),"''","S") & "   AND SUBMIT_FLAG = "	& FilterVar(lgKeyStream(6),"''","S")_ 
...
Sub SubBizSaveSingleUpdate()
    ...
    lgStrSQL = lgStrSQL & " SET   INSUR_AMT = "		& UNIConvNum(lgKeyStream(5),0) & ","
...
Sub SubMakeSQLStatements(pMode,pCode)
    ...
    Select Case pMode 
      Case "R"
            ...
            lgStrSQL = lgStrSQL & "  FAMILY_TYPE , dbo.ufn_GetCodeName('H0070',FAMILY_TYPE) as FAMILY_TYPE_NM, INSUR_AMT,SUBMIT_FLAG "
