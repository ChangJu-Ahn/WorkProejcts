...
Const BIZ_PGM_ID      = "e1310mb1.asp"						           '☆: Biz Logic ASP Name
Const BIZ_PGM_ID1     = "e1310ma2.asp"						           '☆: Biz Logic ASP Name
...
Function DoubleGetRow(pRow)
    ...
    Dim elmCnt
	Dim strVal
    Dim txtFamilyName, txtFamilyType,txtflag
    ...
    with frm1
    	...
    	For elmCnt = 0 to .length - 1
    		...
    		If objList.name = "SPREADCELL_TYPE_CD" & pRow then
               txtFamilyType = objList.value
    		End if 
    ...
    If frm1.txtYear.value <> "" and frm1.txtEmp_no.value <> "" and txtFamilyName<> ""  then
        ...
        strVal = strVal & "&txtType=" & txtFamilyType 
                    ...
                    <TR>
                        <td><table width="100%" border="0" cellspacing="1" cellpadding="0" bgcolor="DDDDDD">
								<TR> 
	                        		...
	                        		<TD CLASS=TDFAMILY_TITLE1>금액</TD>
                                </TR>
							    <% 
                                For i=1 To 9
                                    ...
                                    Response.Write "<TD><INPUT class=listrow01 name='SPREADCELL_NAME" & i & "'	flag='SPREADCELL' style='WIDTH: 190px; text-align: left;' onMouseOver='vbscript: Call MouseRow(" & i & ")' readonly></TD>"
                                	...
                                	Response.Write "    <INPUT class=listrow01 name='SPREADCELL_REL" & i & "'	flag='SPREADCELL' style='WIDTH: 180px; text-align: left;'  onMouseOver='vbscript: Call MouseRow(" & i & ")' readonly></TD>"
                                	Response.Write "<TD><INPUT class=listrow01 name='SPREADCELL_TYPE_CD" & i & "' type=hidden flag='SPREADCELL' style='WIDTH:   0px; font-family: 돋움; font-size: 9pt; text-align: center; color: 666666; text-align: left;'>"
                                	Response.Write "    <INPUT class=listrow01 name='SPREADCELL_TYPE" & i & "'	flag='SPREADCELL' style='WIDTH: 166px; text-align: left;' onMouseOver='vbscript: Call MouseRow(" & i & ")'  readonly></TD>"
                                	Response.Write "<TD><INPUT class=listrow01 name='SPREADCELL_AMT" & i & "'	flag='SPREADCELL' style='WIDTH: 160px; text-align: right;' onMouseOver='vbscript: Call MouseRow(" & i & ")' readonly></TD>"
