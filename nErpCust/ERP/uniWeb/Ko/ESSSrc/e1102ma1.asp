                ...
                <TABLE width="100%" cellSpacing=0 cellPadding=0 border=0>
                    ...
                    <TR>
                        <td><table width="100%" border="0" cellspacing="1" cellpadding="0" bgcolor="DDDDDD">
							    ...
							    <% 
                                For i=1 To 10
                                    Response.Write "<TR bgcolor=#F8F8F8 height=24 onMouseOver=" & chr(34) & "javascript: this.style.backgroundColor='FFFFFF'" & chr(34) & " onMouseOut=" & chr(34) & "javascript: this.style.backgroundColor=''" & chr(34) & ">"
                                    Response.Write "<TD><INPUT name='" & i & "'  class=listrow01 flag='SPREADCELL' style='WIDTH:  30px; text-align: center;' readonly></TD>"
                                    Response.Write "<TD><INPUT name='SPREADCELL' class=listrow01 flag='SPREADCELL' style='WIDTH:  96px; text-align: center;' readonly></TD>"
                                    Response.Write "<TD><INPUT name='SPREADCELL' class=listrow01 flag='SPREADCELL' style='WIDTH: 140px;' readonly></TD>"
                                	Response.Write "<TD><INPUT name='SPREADCELL' class=listrow01 flag='SPREADCELL' style='WIDTH: 210px;' readonly></TD>"
                                	Response.Write "<TD><INPUT name='SPREADCELL' class=listrow01 flag='SPREADCELL' style='WIDTH: 120px; text-align: left;' readonly></TD>"
                                	Response.Write "<TD><INPUT name='SPREADCELL' class=listrow01 flag='SPREADCELL' style='WIDTH: 130px;' readonly></TD>"
                                    Response.Write "</TR>"
                                Next
								%>
                           </table>
