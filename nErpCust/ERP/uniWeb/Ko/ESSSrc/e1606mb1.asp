...
<%   	 		
	...
	iKey1 = iKey1 & "   AND (convert(varchar(10),dilig_strt_dt,20) between  " & FilterVar(UNIConvDateCompanyToDB((lgKeyStream(3)),NULL), "''", "S") & " and  " & FilterVar(UNIConvDateCompanyToDB((lgKeyStream(4)),NULL), "''", "S") & ")"
