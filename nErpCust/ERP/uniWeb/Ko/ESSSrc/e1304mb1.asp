...
Sub SubBizSave()
    ...
    Dim strstand            '선택기준 : 급여기준일 OR 급여지급일 
    ...
    With lgObjComm
	    ...
	    lgObjComm.Parameters.Append lgObjComm.CreateParameter("@calcu_type" ,adXChar,adParamInput,	Len("1"),               "1")
	    lgObjComm.Parameters.Append lgObjComm.CreateParameter("@bas_dt_s"   ,adXChar,adParamInput,	Len(strBas_dt_s),         strBas_dt_s)
	    lgObjComm.Parameters.Append lgObjComm.CreateParameter("@retro_bas_dt_s",adXChar,adParamInput,Len(strRetire_dt_s),		  strRetire_dt_s)
	    lgObjComm.Parameters.Append lgObjComm.CreateParameter("@stand"      ,adXChar,adParamInput,	Len("1"),               "1")
