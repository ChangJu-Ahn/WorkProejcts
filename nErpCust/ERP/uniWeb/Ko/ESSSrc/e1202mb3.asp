...
%>
        <Script Language=vbscript>
            With parent.frm1
                ...
                '.BONUS_RATE.Value	= "<%=UNINumClientFormat(lgObjRs("BONUS_RATE"), ggAmtOfMoney.DecPoint, 0)%>"	20080218
                '.ADD_RATE.Value		= "<%=UNINumClientFormat(lgObjRs("ADD_RATE"), ggAmtOfMoney.DecPoint, 0)%>"	20080218
                '.MINUS1_RATE.Value	= "<%=UNINumClientFormat(lgObjRs("MINUS1_RATE"), ggAmtOfMoney.DecPoint, 0)%>"	20080218
                '.MINUS2_RATE.Value	= "<%=UNINumClientFormat(lgObjRs("MINUS2_RATE"), ggAmtOfMoney.DecPoint, 0)%>"	20080218
                '.PROV_RATE.Value	= "<%=UNINumClientFormat(lgObjRs("PROV_RATE"), ggAmtOfMoney.DecPoint, 0)%>"		20080218
    ...
    Select Case pSection 
      Case "1"		
      			lsStrSql = ""
   					...
   					lgStrSQL = lgStrSQL & "	  AND b.PAY_YYMM *= c.WK_YYMM"
			'---------------근태내역 
      Case "2"
   					lgStrSQL =            " SELECT "
