...
*  3. Program ID           : 
*  4. Program Name         : 날짜 팝업(기준일,지급일자)
*  5. Program Desc         : 	arrParam(0) = "지급일팝업"	팝업이름	
								arrParam(1) = "지급일"		팝업조회부이름,그리드필드이름 
								arrParam(2) = "hdf070t"			select 하고자하는 테이블이름 
								arrParam(3) = "PROV_DT"			select 하고자하는 필드이름 
								arrParam(4) = frm1.txtprov_dt.text		조회부에 셋팅될 날짜 
*  6. Comproxy List        :
*  7. Modified date(First) : 2001/04/18
*  8. Modified date(Last)  : 2004/06/17
*  9. Modifier (First)     : Bea Hyun Chan
...
'========================================================================================================
Const BIZ_PGM_ID = "StandardDtPopupBiz.asp"							'☆: 비지니스 로직 ASP명 
'========================================================================================================
...
Sub SetDefaultVal()
	...
	lblDate.innerHTML  = arrParam(CODE_NAME)
...
Sub InitSpreadSheet()
	...
	ggoSpread.Source = vspdData
    ggoSpread.Spreadinit "V20040614", , Popupparent.gAllowDragDropSpread
	...
	ggoSpread.SSSetEdit C_PromoteDt, arrParam(CODE_NAME), 20,,,10
	ggoSpread.SSSetEdit C_Count,     "항목건수"  , 24,,,40
...
Function DbQuery()
	...
	strVal = strVal     & "&txtTable="  & arrParam(TABLE_NAME)
	strVal = strVal     & "&txtField="  & arrParam(FIELD_NAME)	
	...
	<TR><TD HEIGHT=40>
		...
		<TABLE CLASS="basicTB" CELLSPACING=0 HEIGHT=100%>
			<TR>				
				...
				<TD CLASS="TD6" ><script language =javascript src='./js/standarddtpopup_I625393891_txtDate.js'></script></TD>
			</TR>
		</TABLE>
		</FIELDSET>
	</TD></TR>
	<TR><TD HEIGHT=100%>
			<script language =javascript src='./js/standarddtpopup_vaSpread1_vspdData.js'></script>
	</TD></TR>
	<TR><TD HEIGHT=20>
