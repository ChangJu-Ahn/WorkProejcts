...
Const BIZ_PGM_ID = "b1b11pb4.asp"							'☆: Asp name of Biz logic
...
<TABLE CELLSPACING=0 CLASS="basicTB">
	<TR><TD HEIGHT=40>
		<FIELDSET CLASS="CLSFLD"><TABLE WIDTH=100% CELLSPACING=0>
			...
			<TR>
				...
				<TD CLASS=TD6 NOWRAP>
					<script language =javascript src='./js/b1b11pa4_I879613661_txtBaseDt.js'></script>
				</TD>
			</TR>
			<TR>
	...
	<TR><TD HEIGHT=100%>
			<script language =javascript src='./js/b1b11pa4_I480697673_vspdData.js'></script>
	</TD></TR>
	<TR><TD HEIGHT=30>
