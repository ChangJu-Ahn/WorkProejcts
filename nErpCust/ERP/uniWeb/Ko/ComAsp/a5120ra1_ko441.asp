		...
		<TD HEIGHT=20 WIDTH=100%>
			<FIELDSET CLASS="CLSFLD">
				...
				<TR>
					...
					<TD CLASS=TD6 NOWRAP><INPUT TYPE=TEXT NAME="txtGlNo" MAXLENGTH="18" SIZE=20  ALT ="전표번호" tag="14XXXU"></TD>
				...
				<TR>
					...
					<TD CLASS="TD6" NOWRAP><INPUT NAME="txtGlDt" ALT="전표일자" SIZE = "10" MAXLENGTH="10" STYLE="TEXT-ALIGN: Center" tag="24X1">
								&nbsp;&nbsp;&nbsp;&nbsp;승인자:&nbsp;
							       <INPUT TYPE=TEXT NAME="txtConfirmEmp" MAXLENGTH="30" SIZE=10 ALT ="승인자" tag="14XXXU">
					</TD>
				...
				<TR>
					...
					<TD CLASS=TD6 NOWRAP><INPUT TYPE=TEXT NAME="txtGlDesc" MAXLENGTH="30" SIZE=32 ALT ="적요" tag="14XXXU"></TD>
