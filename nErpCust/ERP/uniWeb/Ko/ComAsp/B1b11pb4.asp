...
Sub SubBizQueryMulti(pType)
    ...
    '---------- Developer Coding part (Start) ---------------------------------------------------------------
		Call SubMakeSQLStatements("CD",strPlantCd,strItemCd,strItemNm,strFromItemClass,strToItemClass,strFromItemAcctGrp,strToItemAcctGrp,strFromProcType,strToProcType,strFromProdEnv,strToProdEnv,strBaseDt,strSpec,strTrackingFlg,strInspClass,strNextKey, strItemAcct)           '☜ : Make sql statements
	Else	
		Call SubMakeSQLStatements("NM",strPlantCd,strItemCd,strItemNm,strFromItemClass,strToItemClass,strFromItemAcctGrp,strToItemAcctGrp,strFromProcType,strToProcType,strFromProdEnv,strToProdEnv,strBaseDt,strSpec,strTrackingFlg,strInspClass,strNextKey, strItemAcct)           '☜ : Make sql statements
	End If
...
'------ Developer Coding part (End   ) ------------------------------------------------------------------
	...
	End If
 	...
 	iTotalStr = ConvSPChars(Join(TmpBuffer, ""))
	...
	Response.Write "aa" & Err.Description
...
'============================================================================================================
Sub SubMakeSQLStatements(pDataType,pCode,pCode1,pCode2,pCode3,pCode4,pCode5,pCode6,pCode7,pCode8,pCode9,pCode10,pCode11,pCode12,pCode13,pCode14,pCode15, pCode16)
    Dim iSelCount
	'------ Developer Coding part (Start ) ------------------------------------------------------------------
