...
'========================================================================================================
	Const BIZ_PGM_ID = "DeptPopupDtBiz2.asp"							'☆: 비지니스 로직 ASP명 
'========================================================================================================
	...
	<TR><TD HEIGHT=40>
		...
		<TABLE CLASS="basicTB" CELLSPACING=0 HEIGHT=100%>
			<TR>				
				...
				<TD CLASS="TD6" ><SCRIPT LANGUAGE=JavaScript> ExternalWrite('<OBJECT CLASSID=<%=gCLSIDFPDT%> name=txtDate style="HEIGHT: 20px; LEFT: 0px; TOP: 0px; WIDTH: 100px" title=FPDATETIME tag="13X1" ALT="기준일자" id=OBJECT1></OBJECT>');</SCRIPT></TD>
			</TR>
			<TR>
