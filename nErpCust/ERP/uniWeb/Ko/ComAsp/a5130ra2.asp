...
Const BIZ_PGM_ID        = "a5130rb21.asp"                         '☆: Biz logic spread sheet for #1
Const BIZ_PGM_ID1       = "a5130rb22.asp"                         '☆: Biz logic spread sheet for #2
Const BIZ_PGM_ID2       = "a5130rb23.asp"                         '☆: Biz logic spread sheet for #3
...
Sub InitSpreadSheet()
    ...
    Call SetZAdoSpreadSheet("A5130RA1_HDR", "S", "C", "V20030210", PopupParent.C_SORT_DBAGENT, frm1.vspdData0, C_MaxKey, "X", "X")
...
Sub SetPrintCond(StrEbrFile, VarDateFr, VarDateTo, VarDeptCd, VarBizAreaCd, VarTempGlNoFr, VarTempGlNoTo)
	...
	frm1.vspddata0.row = 1		
	
	VarDateFr = UniConvDateToYYYYMMDD(Trim(frm1.vspddata0.text), PopupParent.gDateFormat, PopupParent.gServerDateType)	
	VarDateTo = UniConvDateToYYYYMMDD(Trim(frm1.vspddata0.text), PopupParent.gDateFormat, PopupParent.gServerDateType)
...
' 회계전표의 key는 GL_NO이기 때문에 GL_NO만 넘긴다.	
	...
	frm1.vspddata0.row = 1		
	VarTempGlNoFr =  Trim(frm1.vspddata0.value)
	frm1.vspddata0.row = frm1.vspddata0.maxrows	
	VarTempGlNoTo = Trim(frm1.vspddata0.value)
...
Function DbQuery(pDirect) 
    ...
    Select Case pDirect
		...
		Case  C_MASTER        
			...
			With frm1
				strVal = BIZ_PGM_ID1 & "?txttempglno=" & Trim(GetKeyPosVal("C", 1))		
...
'---
				...
				strVal = BIZ_PGM_ID2 & "?txtTempGlNo=" & Trim(GetKeyPosVal("A", 1))
	...
	<TR HEIGHT=100%>
		<TD WIDTH=100% HEIGHT=* VALIGN=TOP>
			<TABLE <%=LR_SPACE_TYPE_20%>>
				<TR>
					<TD>
						<script language =javascript src='./js/a5130ra2_vspdData0_vspdData0.js'></script>
					</TD>
				</TR>
				<TR>
					<TD>
				...
				<TR HEIGHT="30%">
					<TD>
						<script language =javascript src='./js/a5130ra2_vspdData2_vspdData2.js'></script>
					</TD>
				</TR>
			</TABLE>
		</TD>
