...
Const BIZ_PGM_ID = "b3b30pb1.asp"							 '☆: 비지니스 로직 ASP명 
...
'    vspdData.OperationMode = 3
	...
	ggoSpread.SSSetEdit C_CharCD,			"사양항목",		20
	ggoSpread.SSSetEdit C_CharNM,			"사양항목명",	30
	ggoSpread.SSSetEdit C_CharValueDIGIT,	"사양값자리수",	14,1
		...
		<TD HEIGHT=40>
			<FIELDSET CLASS="CLSFLD">
				...
				<TR>
					...
					<TD CLASS=TD656 NOWRAP><INPUT CLASS="clstxt" TYPE=TEXT NAME="txtCharCd" SIZE=25 MAXLENGTH=18 tag="11XXXU" ALT="사양항목"></TD>
				</TR>
				<TR>
					<TD CLASS=TD5 NOWRAP></TD>	
					<TD CLASS=TD656 NOWRAP><INPUT TYPE=TEXT NAME="txtCharNm" SIZE=40 MAXLENGTH=40 tag="11" ALT="사양항목명"></TD>
				</TR>		
				</TABLE>
			</FIELDSET>
		</TD>
