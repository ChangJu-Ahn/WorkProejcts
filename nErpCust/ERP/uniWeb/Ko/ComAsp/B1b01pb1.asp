...
If Trim(Request("cboItemAccount")) <> "" Then		'품목계정 
...
Sub SubBizQueryMulti(pType)
	...
	If pType = "ITEM_CD" Then
		Call SubMakeSQLStatements("CD",strItemCd,strItemNm,strFromItemClass,strToItemClass,strFromItemAcct,strToItemAcct,strItemGroupCd,strBaseDt,strSpec,strValidFlg,strNextKey)           '☜ : Make sql statements
	Else	
		Call SubMakeSQLStatements("NM",strItemCd,strItemNm,strFromItemClass,strToItemClass,strFromItemAcct,strToItemAcct,strItemGroupCd,strBaseDt,strSpec,strValidFlg,strNextKey)           '☜ : Make sql statements
	End If
...
'============================================================================================================
Sub SubMakeSQLStatements(pDataType,pCode,pCode1,pCode2,pCode3,pCode4,pCode5,pCode6,pCode7,pCode8,pCode9,pCode10)
    Dim iSelCount
	'------ Developer Coding part (Start ) ------------------------------------------------------------------
    Select Case pDataType

		Case "CD"
			lgStrSQL = "SELECT TOP 51 A.*, B.ITEM_NM BASE_ITEM_NM, C.ITEM_GROUP_NM, A.ITEM_ACCT, dbo.ufn_GetCodeName('P1001', A.ITEM_ACCT) NM_ITEM_ACCT, dbo.ufn_GetCodeName('P1002', A.ITEM_CLASS) NM_ITEM_CLASS"
