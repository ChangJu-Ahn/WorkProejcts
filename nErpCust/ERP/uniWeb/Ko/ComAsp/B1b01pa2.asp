...
Const BIZ_PGM_ID = "b1b01pb2.asp"							<% '☆: 비지니스 로직 ASP명 %>
...
Sub InitSpreadSheet()
	...
	ggoSpread.Spreadinit "V20041125",, PopupParent.gAllowDragDropSpread
...
Sub GetSpreadColumnPos(ByVal pvSpdNo)
    ...
    Select Case UCase(pvSpdNo)
       Case "A"
			...
			C_ItemAcctGrp	= iCurColumnPos(29)
    End Select    
End Sub
	...
	<TR><TD HEIGHT=40>
		<FIELDSET CLASS="CLSFLD"><TABLE WIDTH=100% CELLSPACING=0>
			...
			<TR>
				...
				<TD CLASS=TD6 NOWRAP>
					<script language =javascript src='./js/b1b01pa2_I779354673_txtBaseDt.js'></script>
				</TD>
			</TR>
		</TABLE></FIELDSET>
	</TD></TR>
	<TR><TD HEIGHT=100%>
			<script language =javascript src='./js/b1b01pa2_vspdData_vspdData.js'></script>
	</TD></TR>
	<TR><TD HEIGHT=30>
