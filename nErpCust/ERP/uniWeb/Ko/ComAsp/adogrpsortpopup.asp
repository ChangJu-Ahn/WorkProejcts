...
'========================================================================================================
	Function MakeStr( iStr, jBool)
	    MakeStr = ""
		If Len(Trim(iStr)) Then 
		    MakeStr = Trim(iStr)
			If jBool = true then
               MakeStr = MakeStr & " ASC"
			Else
               MakeStr = MakeStr & " DESC"
			End if
		End If
	End Function
			...
			<FIELDSET>
				...
				<TR >
					...
					<TD CLASS="TD6" NOWRAP><SELECT NAME="cboOrderBy1" STYLE="WIDTH: 110px" TAG="1"><OPTION selected></SELECT>
						<INPUT TYPE=RADIO CLASS=RADIO NAME="rdoSortMethod1"  VALUE="ASC" CHECKED ID="rdoSortMethod1_A" ><LABEL FOR="rdoSortMethod1">오름차순</LABEL>
						<INPUT TYPE=RADIO CLASS=RADIO NAME="rdoSortMethod1"  VALUE="DESC" ID="rdoSortMethod1_D"><LABEL FOR="rdoSortMethod1">내림차순</LABEL>
				</TR>
				<TR>
					...
					<TD CLASS="TD6" NOWRAP><SELECT NAME="cboOrderBy2" STYLE="WIDTH: 110px" TAG="2"><OPTION selected></SELECT>
						<INPUT TYPE=RADIO CLASS=RADIO NAME="rdoSortMethod2"  VALUE="ASC" CHECKED ID="rdoSortMethod2_A" ><LABEL FOR="rdoSortMethod2">오름차순</LABEL>
						<INPUT TYPE=RADIO CLASS=RADIO NAME="rdoSortMethod2"  VALUE="DESC" ID="rdoSortMethod2_D"><LABEL FOR="rdoSortMethod2">내림차순</LABEL>
					</TD>
				</TR>
				<TR>
					...
					<TD CLASS="TD6" NOWRAP><SELECT NAME="cboOrderBy3" STYLE="WIDTH: 110px" TAG="3"><OPTION selected></SELECT>
						<INPUT TYPE=RADIO CLASS=RADIO NAME="rdoSortMethod3"  VALUE="ASC" CHECKED ID="rdoSortMethod3_A" ><LABEL FOR="rdoSortMethod3">오름차순</LABEL>
						<INPUT TYPE=RADIO CLASS=RADIO NAME="rdoSortMethod3"  VALUE="DESC" ID="rdoSortMethod3_D"><LABEL FOR="rdoSortMethod3">내림차순</LABEL>
					</TD>
				</TR>
				<TR>
					...
					<TD CLASS="TD6" NOWRAP><SELECT NAME="cboOrderBy4" STYLE="WIDTH: 110px" TAG="4"><OPTION selected></SELECT>
						<INPUT TYPE=RADIO CLASS=RADIO NAME="rdoSortMethod4"  VALUE="ASC" CHECKED ID="rdoSortMethod4_A" ><LABEL FOR="rdoSortMethod4">오름차순</LABEL>
						<INPUT TYPE=RADIO CLASS=RADIO NAME="rdoSortMethod4"  VALUE="DESC" ID="rdoSortMethod4_D"><LABEL FOR="rdoSortMethod4">내림차순</LABEL>
					</TD>
				</TR>
				<TR>
					...
					<TD CLASS="TD6" NOWRAP><SELECT NAME="cboOrderBy5" STYLE="WIDTH: 110px" TAG="5"><OPTION selected></SELECT>
						<INPUT TYPE=RADIO CLASS=RADIO NAME="rdoSortMethod5"  VALUE="ASC" CHECKED ID="rdoSortMethod5_A" ><LABEL FOR="rdoSortMethod5">오름차순</LABEL>
						<INPUT TYPE=RADIO CLASS=RADIO NAME="rdoSortMethod5"  VALUE="DESC" ID="rdoSortMethod5_D"><LABEL FOR="rdoSortMethod5">내림차순</LABEL>
					</TD>
				</TR>
				<TR>
					...
					<TD CLASS="TD6" NOWRAP><SELECT NAME="cboOrderBy6" STYLE="WIDTH: 110px" TAG="6"><OPTION selected></SELECT>
						<INPUT TYPE=RADIO CLASS=RADIO NAME="rdoSortMethod6"  VALUE="ASC" CHECKED ID="rdoSortMethod6_A" ><LABEL FOR="rdoSortMethod6">오름차순</LABEL>
						<INPUT TYPE=RADIO CLASS=RADIO NAME="rdoSortMethod6"  VALUE="DESC" ID="rdoSortMethod6_D"><LABEL FOR="rdoSortMethod6">내림차순</LABEL>
					</TD>
				</TR>
				</TABLE>
			</FIELDSET>
