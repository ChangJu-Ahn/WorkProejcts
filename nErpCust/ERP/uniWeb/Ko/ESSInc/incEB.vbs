...
'========================================================================================
Sub FncEBR5(EBRName, work, condvar, x, y)

	Call FncEBR5RC(EBRName, work, condvar, x, y,"EBR")
...
' Description   : Easybase web Preview for REQUBE 5.1 (EBR) 
'========================================================================================
Sub FncEBR5RC(EBRName, work, condvar, x, y,EBRorEBC)
	...
	window.showModalDialog  pre & "comasp/" & iASP & "?EBWidth=" & x & "&EBHeight=" & y , Array(arrParam, arrField, arrHeader), _
...
Sub FncEBCPrint(objForm, EBRName, condvar)
    ...
    If GetEBVer = "REQUBE" Then
       Call FncEBR5RC(EBRName, "print", condvar, 280, 100, "EBC")
       Exit Sub
    End If
...
Sub FncEBRPrint(objForm, EBRName, condvar)
    ...
    If GetEBVer = "REQUBE" Then
       Call FncEBR5(EBRName, "print", condvar, 280, 100)
       Exit Sub
    End If
...
Sub FncEBCPreview(EBCName, condvar)
	...
	if GetEBVer = "REQUBE" then
	   ...
	   Call AskEBDocumentName2(Split(EBCName,".")(0),x,y)
       Call FncEBR5RC(EBCName, "view", condvar, x, y, "EBC")
	   Exit Sub	
	end if
...
Sub FncEBRPreview(EBRName, condvar)
	...
	If GetEBVer = "REQUBE" then
	   Call AskEBDocumentName2(Split(EBRName,".")(0),x,y)
	   
	   Call FncEBR5(EBRName, "view", CondVar, x,y)
	   Exit Sub	
	End If
...
' Description   : Easybase DB Connection
'========================================================================================
Sub AskEBDocumentName2(Byval pEbId,prWidth,prHeight)
    Dim lgF0,lgF1,lgF2,lgF3,lgF4,lgF5,lgF6
    Dim IntRetCD
 	
	IntRetCD = CommonQueryRs("isnull(form_width,1024),isnull(form_height,768)","Z_DC_EBNAME","MNU_EB_ID = '"& pEbId & "'",lgF0,lgF1,lgF2,lgF3,lgF4,lgF5,lgF6)
