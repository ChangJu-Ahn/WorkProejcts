...
<%
	...
	if from_where = "" then
		Response.Redirect "Content.asp?" & "seqs=" & seqs & "&page=" & page
	else
		Response.Redirect "Content.asp?" & "seqs=" & seqs & "&page=" & page& "&from_where=s&SearchPart=" &SearchPart&"&SearchStr="&SearchStr
	end if	
%>
