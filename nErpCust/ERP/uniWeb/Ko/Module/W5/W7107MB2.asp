...
Sub SubMakeSQLStatements(pMode,pCode1, pCode2, pCode3)
    Select Case pMode 
      Case "R"
			lgStrSQL =			  " SELECT  "
            lgStrSQL = lgStrSQL & " CASE WHEN SEQ_NO1 = 999999 THEN SEQ_NO1 ELSE SEQ_NO END AS SEQ_NO " & vbCrLf
            lgStrSQL = lgStrSQL & "	, W1, W2, W3, W4, W5, W6, W7, W8, W9, W10, W11 "
            lgStrSQL = lgStrSQL & " FROM DBO.ufn_TB_DEFICIT_CARRIED_GetRef( " & pCode1 	 & "," & pCode2 	 & "," & pCode3 	& ") "	 & vbCrLf
