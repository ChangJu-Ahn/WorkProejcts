...
Sub SubBizQuery()
	...
	Call SubMakeSQLStatements("DR",iKey1, iKey2, iKey3)                                       '☜ : Make sql statements
...
Sub SubMakeSQLStatements(pMode,pCode1, pCode2, pCode3)
    Select Case pMode 
      Case "R"
			lgStrSQL =			  " SELECT  "
            lgStrSQL = lgStrSQL & "   SEQ_NO " & vbCrLf
            lgStrSQL = lgStrSQL & "	, W1, W2, W3, W4, W5, W6, W7, W8, W_DESC "
            lgStrSQL = lgStrSQL & " FROM DBO.ufn_TB_22_GetRef( " & pCode1 	 & "," & pCode2 	 & "," & pCode3 	& ") "	 & vbCrLf


            lgStrSQL = lgStrSQL & " ORDER BY  SEQ_NO ASC" & vbcrlf
      Case "DR"
			lgStrSQL =" exec usp_TB_22_Del  " & pCode1 	 & "," & pCode2 	 & "," & pCode3 	
