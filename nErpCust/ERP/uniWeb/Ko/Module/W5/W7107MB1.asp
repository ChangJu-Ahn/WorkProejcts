...
Sub SubBizDelete()
	...
	' 디테일부터 제거한다.
    lgStrSQL =            "DELETE TB_DEFICIT_CARRIED WITH (ROWLOCK) " & vbCrLf
...
Sub SubBizQuery()
    ...
    Else
        ...
        Do While Not lgObjRs.EOF
			...
			lgstrData = lgstrData & Chr(11) & ConvSPChars(lgObjRs("W10"))			
			lgstrData = lgstrData & Chr(11) & ConvSPChars(lgObjRs("W11"))	
...
Sub SubMakeSQLStatements(pMode,pCode1, pCode2, pCode3)
    Select Case pMode 
      Case "R"
			lgStrSQL =			  " SELECT  "
            lgStrSQL = lgStrSQL & " A.SEQ_NO, A.W1, A.W2, A.W3, A.W4, A.W5, A.W6, A.W7 "
            lgStrSQL = lgStrSQL & " , A.W8, A.W9, A.W10, A.W11 "
...
'            lgStrSQL = lgStrSQL & " ORDER BY  A.W1 ASC, A.SEQ_NO ASC" & vbcrlf
...
Sub SubBizSaveMultiCreate(arrColVal)
	...
	lgStrSQL = "INSERT INTO TB_DEFICIT_CARRIED WITH (ROWLOCK) ("
	lgStrSQL = lgStrSQL & " CO_CD, FISC_YEAR, REP_TYPE, SEQ_NO, W1, W2, W3, W4, W5, W6, W7, W8, W9, W10, W11 "  
	...
	lgStrSQL = lgStrSQL & FilterVar(UNIConvDateCompanyToDB(arrColVal(C_W1), ""),"NULL","S")		& ","  
...
Sub SubBizSaveMultiUpdate(arrColVal)
	...
	lgStrSQL = lgStrSQL & " W1		= " &  FilterVar(UNIConvDateCompanyToDB(arrColVal(C_W1), ""),"NULL","S")		& ","  
...
Sub SubBizSaveMultiDelete(arrColVal)
    ...
    lgStrSQL = "DELETE  TB_DEFICIT_CARRIED WITH (ROWLOCK) "
 	lgStrSQL = lgStrSQL & " WHERE CO_CD = " & FilterVar(Trim(UCase(wgCO_CD)),"''","S") 	 & vbCrLf
	lgStrSQL = lgStrSQL & "		AND FISC_YEAR = " & FilterVar(Trim(UCase(sFISC_YEAR)),"''","S") 	 & vbCrLf
