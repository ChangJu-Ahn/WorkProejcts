...
'*  3. Program ID           : w5111mA1
'*  4. Program Name         : w5111mA1.asp
'*  5. Program Desc         : 기부금 등록 
...
Const BIZ_MNU_ID		= "w5111mA1"
Const BIZ_PGM_ID		= "w5111mB1.asp"											 '☆: 비지니스 로직 ASP명 
Const BIZ_REF_PGM_ID	= "W5111MB2.asp"
...
Sub InitComboBox()
	...
	Call CommonQueryRs("MINOR_CD,MINOR_NM"," ufn_TB_MINOR('W1008', '" & C_REVISION_YM & "')  ","  ",lgF0,lgF1,lgF2,lgF3,lgF4,lgF5,lgF6)
    Call SetCombo2(frm1.cboW6_TYPE ,lgF0  ,lgF1  ,Chr(11))
...
Sub InitSpreadComboBox()
	...
	IntRetCD1 = CommonQueryRs("MINOR_CD, MINOR_NM", " ufn_TB_MINOR('W1008', '" & C_REVISION_YM & "') ", " ", lgF0, lgF1, lgF2, lgF3, lgF4, lgF5, lgF6)  
...
Sub InitSpreadSheet()
	...
	With Frm1.vspdData
		...
		ggoSpread.SSSetEdit		C_W4,		"(4)기부처",			15,,,50,1
		ggoSpread.SSSetMask		C_W5,		"(5)사업자등록번호"	, 15, 2,"999-99-99999"
	    ggoSpread.SSSetCombo	C_W6,		"(6)구분",		10
	    ggoSpread.SSSetCombo	C_W6_NM,	"(6)구분",		10
		ggoSpread.SSSetEdit		C_W7,		"(7)적요",			15,,,100,1

	    ret = .AddCellSpan(C_W1, -1000, 3, 1)

		Call ggoSpread.SSSetColHidden(.MaxCols, .MaxCols, True)
		Call ggoSpread.SSSetColHidden(C_SEQ_NO,C_SEQ_NO,True)
		Call ggoSpread.SSSetColHidden(C_W6,C_W6,True)
	...
	With Frm1.vspdData
		...
		For iRow = pvStartRow To pvEndRow
			...
			Else
				...
				ggoSpread.SSSetRequired C_W6_NM, iRow, iRow
			End If
		Next
...
Function GetRef()	' 금액가져오기 링크 클릭시 
    ...
    IntRetCD = DisplayMsgBox("WC0003", parent.VB_YES_NO, sMesg, "X")           '⊙: "Will you destory previous data"
	 ...
	 If lgIntFlgMode = parent.OPMD_UMODE Then
		...
		strVal2 = BIZ_PGM_ID & "?txtMode=" & parent.UID_M0004							'☜: 비지니스 처리 ASP의 상태 
		strVal2 = strVal2     & "&txtFISC_YEAR="       & Frm1.txtFISC_YEAR.Text      '☜: Query Key        
		strVal2 = strVal2     & "&cboREP_TYPE="        & Frm1.cboREP_TYPE.Value      '☜: Query Key            
	
		Call RunMyBizASP(MyBizASP, strVal2)
...
Sub vspdData_ComboSelChange(ByVal Col, ByVal Row)
	...
	With Frm1.vspdData
		...
		ggoSpread.Source = Frm1.vspdData
		If sW6 = "20" Then
			ggoSpread.SpreadLock C_W4, Row, C_W5, Row
			.Col = C_W4	:	.Text = ""
			.Col = C_W5	:	.Text = ""
		Else
			ggoSpread.SpreadUnLock C_W4, Row, C_W5, Row
			ggoSpread.SSSetRequired C_W4, Row, Row
			ggoSpread.SSSetRequired C_W5, Row, Row
		End If
	End With
End Sub
...
Function DbQuery() 
    ...
    With Frm1
        ...
        strVal = strVal     & "&txtFISC_YEAR="       & Frm1.txtFISC_YEAR.Text      '☜: Query Key        
        strVal = strVal     & "&cboREP_TYPE="        & Frm1.cboREP_TYPE.Value      '☜: Query Key   
        strVal = strVal     & "&cboW6_TYPE="         	& Frm1.cboW6_TYPE.Value
						...
						<FIELDSET CLASS="CLSFLD">
							<TABLE <%=LR_SPACE_TYPE_40%>>
								<TR>
									...
									<TD CLASS="TD6"><script language =javascript src='./js/w5111ma1_txtFISC_YEAR_txtFISC_YEAR.js'></script></TD>
									<TD CLASS="TD5">법인명</TD>
								...
								<TR>
									...
									<TD CLASS="TD5">구분</TD>
									<TD CLASS="TD6"><SELECT NAME="cboW6_TYPE" ALT="구분" STYLE="WIDTH: 50%" tag="1X"></SELECT>
									</TD>
								</TR>
							</TABLE>
						</FIELDSET>
					...
					<TD WIDTH=100% HEIGHT=* valign=top>
						<TABLE <%=LR_SPACE_TYPE_60%> CLASS="TD61" BORDER=0>
							<TR>
							     ...
							     <script language =javascript src='./js/w5111ma1_vspdData_vspdData.js'></script>
							    </TD>
							</TR>
						</TABLE>
					</TD>
