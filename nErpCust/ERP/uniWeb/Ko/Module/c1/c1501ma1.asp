...
Const BIZ_PGM_ID = "c1501mb1.asp"	                         'Biz Logic ASP
...
Function OpenPopUp(Byval strCode, Byval strTbl,Byval strCol, Byval iWhere)
	...
	Select Case iWhere
		Case 0
			arrParam(0) = "작업단계팝업"  
			arrParam(1) = "(select minor_cd,minor_nm from b_minor where major_cd = " & FilterVar("C2000", "''", "S") & "  and minor_cd = " & FilterVar("00", "''", "S") & "  union  select b.minor_cd,b.minor_nm from b_configuration a,b_minor b where a.major_cd=" & FilterVar("C2000", "''", "S") & "  and a.seq_no = " & FilterVar("3", "''", "S") & "  and reference = " & FilterVar("Y", "''", "S") & "  and b.major_cd = a.major_cd and a.minor_cd = b.minor_cd) c"
			arrParam(2) = strCode
			arrParam(3) = ""		
			arrParam(4) = ""	
			arrParam(5) = "작업단계"

			arrField(0) = "c.MINOR_CD"
			arrField(1) = "c.MINOR_NM"
		...
		Select Case Col
			...
			Case C_VerCdPop
				...
				IF strWorkStep = "00" Then
					strCode2 = "C_MOVETYPE_CONFIGURATION"
				ELSEIf strWorkStep = "05" Then
					strCode2 = "C_DSTB_RULE_BY_CC"
				Else
					strCode2 = "C_DSTB_RULE"
				End If
			...
			Select Case .vspdData.Text
	            ...
	            Case ggoSpread.InsertFlag
					...
					If strWorkStep = "05" Then
						strVal = strVal & "C_DSTB_RULE_BY_CC" & iColSep
					Else
						strVal = strVal & "C_DSTB_RULE" & iColSep
					End If
...
Function ExeReflect()
    ...
    Call CommonQueryRs("count(*)","c_work_version","yyyymm = " & FilterVar(strYYYYMM, "''", "S"),lgF0,lgF1,lgF2,lgF3,lgF4,lgF5,lgF6)
							...
							<TABLE <%=LR_SPACE_TYPE_40%>>
								<TR>
									...
									<TD CLASS="TD656" NOWRAP>
										<script language =javascript src='./js/c1501ma1_txtYYYYMM_txtYYYYMM.js'></script>
									</TD>								
								</TR>               
							</TABLE>
						</FIELDSET>
					...
					<TD WIDTH=100% HEIGHT=100% valign=top>
						<TABLE <%=LR_SPACE_TYPE_20%>>
							<TR>
								...
								<script language =javascript src='./js/c1501ma1_vspdData_vspdData.js'></script>
								</TD>
							</TR>
						</TABLE>
					</TD>
