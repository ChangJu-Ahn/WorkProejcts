...
'========================================================================================================
Const BIZ_PGM_ID = "c1601mb1.asp"                             'Biz Logic ASP
...
Sub InitSpreadSheet()
    ...
    ggoSpread.SSSetEdit		C_CostElmt		,"원가요소코드"	,20,,,6,2
						...
						<FIELDSET CLASS="CLSFLD">
							<TABLE <%=LR_SPACE_TYPE_40%>>
								...
								<TR>
									...
									<TD CLASS="TD6"><INPUT ClASS="clstxt" TYPE=TEXT NAME="txtCostElmtCd" SIZE=10 MAXLENGTH=6 tag="11XXXU" ALT="원가요소"><IMG SRC="../../../CShared/image/btnPopup.gif" NAME="btnAcctCd" align=top TYPE="BUTTON" ONCLICK="vbscript:Call OpenCostElmt()">
					...
					<TD WIDTH=100% HEIGHT=100% valign=top>
						<TABLE <%=LR_SPACE_TYPE_20%>>
							<TR>
								...
								<script language =javascript src='./js/c1601ma1_vspdData_vspdData.js'></script>
								</TD>
							</TR>
						</TABLE>
					</TD>
