...
Sub SubBizQueryMulti()
    ...
    Set iPC1G070 = Server.CreateObject("PC1G070.cCListAdjRateSvr")
    ...
    Call iPC1G070.C_LIST_ADJ_RATE_BY_ITEM_SVR(gStrGlobalCollection,importArray, exportData, exportGroupData)
	
	
	
	If CheckSYSTEMError(Err, True) = True Then					
	    Set iPC1G070 = Nothing
...
Sub SubBizSaveMulti()
    ...
    Set iPC1G070 = Server.CreateObject("PC1G070.cCMngAdjRateSvr")

    If CheckSYSTEMError(Err, True) = True Then					
       Exit Sub
    End If    
	
    Call iPC1G070.C_MANAGE_ADJ_RATE_BY_ITEM_SVR(gStrGloBalCollection, txtSpread, iErrPosition)		
