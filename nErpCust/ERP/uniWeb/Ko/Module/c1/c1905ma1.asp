...
'========================================================================================================
Const BIZ_PGM_ID = "c1905mb1.asp"							'Biz Logic ASP 
...
sub InitSpreadSheet()
    ...
    ggoSpread.SSSetEdit C_CostElmtCd,	"원가요소", 8,,,6,2
					...
					<TD WIDTH=100% HEIGHT=100% valign=top>
						<TABLE <%=LR_SPACE_TYPE_20%>>
							<TR>
								...
								<script language =javascript src='./js/c1905ma1_vspdData_vspdData.js'></script>
								</TD>
							</TR>
						</TABLE>
					</TD>
