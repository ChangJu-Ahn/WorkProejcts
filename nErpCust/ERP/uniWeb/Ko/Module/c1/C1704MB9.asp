...
Sub SubBizQueryMulti()
    ...
    importArray(C_AcctCd)			= Trim(Request("txtAcctCd"))

	Set iPC1G050Q1 = Server.CreateObject("PC1G050.cCListRcvRlByAcctSvr")
	...
	Call iPC1G050Q1.C_LIST_RECV_RULE_BY_ACCT_SVR(gStrGloBalCollection, importArray, exportData )
	
    If CheckSYSTEMError(Err, True) = True Then					
         Call SetErrorStatus
         Set iPC1G050Q1 = Nothing
       Exit Sub
	...
	For iLngRow = 0 To UBound(exportData, 1) 		
		iStrData1 = iStrData1 & Chr(11) & Trim(Request("txtAcctCd"))
