...
Function SetPrintCond(StrEbrFile, strUrl)
	...
	Dim strQueryYyyy, strQueryMM, strQueryDD,strPlantCd
...
'	strQueryDD		= right("0" & txtQueryDate.day,2)
	...
	strPlantCd	 = FilterVar(Trim(txtPlantCd.value)&"%","","SNM")
...
<BODY TABINDEX="-1" SCROLL="no">
	...
	<TABLE  <%=TABSTYLE01%> >
		<TR>
			...
			<TD CLASS="TD6E" NOWRAP><script language =javascript src='./js/vm001ma1_fpDateTime1_txtQueryDate.js'></script>&nbsp;</TD>
