...
<TABLE CLASS="BatchTB1" CELLSPACING=0 CELLPADDING=0>
	...
	<TR>                                              
		<TD WIDTH=100% HEIGHT=<%=BizSize%>><IFRAME NAME="MyBizASP" SRC= "../../blank.htm "  tabindex=-1 WIDTH=100% HEIGHT=<%=50%> FRAMEBORDER=0 SCROLLING=NO noresize framespacing=0></IFRAME>                                              
		</TD>                                              
	</TR>                                              
</TABLE>                                              
</FORM>                                              
