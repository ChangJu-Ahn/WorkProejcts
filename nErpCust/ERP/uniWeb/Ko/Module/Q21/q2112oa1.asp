...
Function FncDelete()
	FncDelete = False                                                    '☜: Protect system from crashing	
End Function
...
Function FncCopy()
	FncCopy = False                                                   '☜: Protect system from crashing	
End Function
						...
						<FIELDSET CLASS="CLSFLD" STYLE="HEIGHT: 100%">
							<TABLE WIDTH=100% CELLSPACING=0 CELLPADDING=0 STYLE="HEIGHT: 100%">
								...
								<TR>
									...
									<TD CLASS=TD6 NOWRAP>
										<script language =javascript src='./js/q2112oa1_fpDateTime1_txtStartDt.js'></script>&nbsp;~&nbsp;
										<script language =javascript src='./js/q2112oa1_fpDateTime2_txtEndDt.js'></script>																																									
									</TD>
								</TR>
								<TR>
