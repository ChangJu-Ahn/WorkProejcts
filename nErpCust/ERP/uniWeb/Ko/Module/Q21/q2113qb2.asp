...
'Call ServerMesgBox("Request(lgStrPrevKey) : " & Request("lgStrPrevKey"), vbInformation, I_MKSCRIPT)
...
Sub FixUNISQLData()
    ...
    UNIValue(0,5) = FilterVar(strInspSeries,"''","S")
    '--------------- 개발자 coding part(실행로직,End)------------------------------------------------------
