...
Const BIZ_PGM_QRY_ID = "Q2111MB1.asp"										 '☆: 비지니스 로직 ASP명 
Const BIZ_PGM_SAVE_ID = "Q2111MB2.asp"										 '☆: 비지니스 로직 ASP명 
Const BIZ_PGM_DEL_ID = "Q2111MB3.asp"
Const BIZ_PGM_QRY2_ID = "Q2111MB4.asp"
'/* 2003-05 정기패치 : 검사의뢰번호 LOOK UP 기능 추가 - START */
Const BIZ_PGM_LOOKUP_ID ="q2111mb5.asp"							
'/* 2003-05 정기패치 : 검사의뢰번호 LOOK UP 기능 추가 - END */
Const BIZ_PGM_JUMP1_ID = "Q2112ma1"
Const BIZ_PGM_JUMP2_ID = "Q2113ma1"
Const BIZ_PGM_JUMP3_ID = "Q2114ma1"
Const BIZ_PGM_JUMP4_ID = "Q2115ma1"
Const BIZ_PGM_JUMP5_ID = "Q2116ma1"
Const BIZ_PGM_JUMP6_ID = "Q2117ma1"
...
Function OpenInspReqNo2()        
	...
	If arrRet(0) <> "" Then
		...
		frm1.txtBpCd.Value			= arrRet(5)
		frm1.txtBpNm.Value			= arrRet(6)
		frm1.txtLotNo.Value			= arrRet(16)
		frm1.txtLotSubNo.Value		= arrRet(17)
		frm1.txtLotSize.Value		= arrRet(18)
...
Function OpenInspItem(Byval strCode)
	...
	Param2 = Trim(frm1.txtLotSize.Text)
...
Sub LookUpInspReqNo(Byval pvInspReqNo)
    ...
    strVal = BIZ_PGM_LOOKUP_ID & "?txtPlantCd=" & Trim(frm1.txtPlantCd.value)
    strVal = strVal & "&txtInspReqNo=" & pvInspReqNo		
...
Function DbQueryOk()									'☆: 조회 성공후 실행로직 
	...
	If frm1.hStatusFlag.Value = "M" Or  frm1.hStatusFlag.Value = "V" Then
		...
		Call SetActiveCell(frm1.vspdData,C_SampleQty,frm1.vspdData.ActiveRow,"M","X","X")
		Set gActiveElement = document.ActiveElement		    	
	Else
		ggoSpread.SSSetProtected C_SampleQty, 1, -1
					...
					<TD CLASS="CLSMTABP">
						<TABLE ID="MyTab" CELLSPACING=0 CELLPADDING=0>
							<TR>
								...
								<TD BACKGROUND="../../../CShared/image/table/seltab_up_bg.gif" ALIGN="center" CLASS="CLSMTAB"><FONT COLOR=white>수입검사 등록</FONT></TD>
									...
									<FIELDSET CLASS="CLSFLD"><LEGEND>검사의뢰내용</LEGEND>
										<TABLE WIDTH="100%" CELLSPACING=0 CELLPADDING=0>
											...
											<TR>
												...
												<TD CLASS="TD6" NOWRAP><INPUT TYPE=TEXT NAME="txtBpCd" SIZE=10 MAXLENGTH=10 ALT="공급처" tag="24">
      		...
      		<TD WIDTH=100%>
      			<TABLE <%=LR_SPACE_TYPE_30%>>
        				<TR>        				
        					...
        					<TD WIDTH=* ALIGN=RIGHT><A href="vbscript:LoadInspDetails">검사내역</A>&nbsp;|&nbsp;<A href="vbscript:LoadDefectType">불량유형</A>&nbsp;|&nbsp;<A href="vbscript:LoadDecision">판정</A>&nbsp;|&nbsp;<A href="vbscript:LoadDisposition">부적합처리</A>&nbsp;|&nbsp;<A href="vbscript:LoadRejectReport">불합격통지</A>&nbsp;|&nbsp;<A href="vbscript:LoadRelease">Release</A></TD>
					<TD WIDTH=10>&nbsp;</TD>
       				</TR>
      			</TABLE>
      		</TD>
