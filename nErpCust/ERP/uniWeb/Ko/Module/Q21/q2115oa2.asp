...
'*  2. Function Name        : 
'*  3. Program ID           : Q2115OA2
'*  4. Program Name         : 불합격통지서출력 
'*  5. Program Desc         : 
'*  6. Component List       : 
...
Function FncBtnPrint() 
	...
	var2 = Trim(frm1.txtPlantCd.value)
	
	var8 = "Q2115OA2.ebr"
		
	condvar = condvar & "InspReqNo|" & var1
	condvar = condvar & "|PlantCd|" & var2
	
	call FncEBRprint(EBAction, var8, condvar) 
...
Function FncBtnPreview() 
	...
	Call FncEBRPreview(var8, condvar)
...
Function Plant_Req_Check()
	...
	With frm1
 		...
 		If  CommonQueryRs(" B.PLANT_NM, A.DECISION, A.INSP_CLASS_CD "," Q_INSPECTION_RESULT A, B_PLANT B ", " A.PLANT_CD = B.PLANT_CD AND A.INSP_REQ_NO = " & FilterVar(.txtInspReqNo.value, "''", "S") & " AND A.PLANT_CD = " & FilterVar(.txtPlantCd.Value, "''", "S"), _
			...
			Call DisplayMsgBox("174128", "X", "X", "X")
			.txtInspReqNo.Focus
			Set gActiveElement = document.activeElement
			Exit function
		End If
		...
		If lgF2(0) <> "R" Then
			Call DisplayMsgBox("220707", "X", "X", "X")
			.txtInspReqNo.Focus
			Set gActiveElement = document.activeElement
			Exit function
		End If
		...
		If lgF1(0) <> "R" Then
			Call DisplayMsgBox("222001", "X", "X", "X")
			.txtInspReqNo.Focus
			Set gActiveElement = document.activeElement
			Exit function
		End If
					...
					<TD>
						<TABLE ID="MyTab" CELLSPACING=0 CELLPADDING=0>
							<TR>
								...
								<td background="../../../CShared/image/table/seltab_up_bg.gif" align="center" CLASS="CLSMTAB"><font color=white>불합격통지서</font></td>
