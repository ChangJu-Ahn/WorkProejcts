...
<Script Language=vbscript>
	With Parent.frm1
		...
		.txtBpCd.Value = "<%=ConvSPChars(Trim(E2_q_inspection_request(E2_r_bp_cd)))%>"
		.txtBpNm.Value = "<%=ConvSPChars(Trim(E2_q_inspection_request(E2_r_bp_nm)))%>"
