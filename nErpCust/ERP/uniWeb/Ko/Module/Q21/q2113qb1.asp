...
Sub FixUNISQLData()
	...
	Select Case strFlag
		Case "N"
			...
			UNISqlId(0) = "Q2113QA101"
		Case "I"
			Redim UNIValue(0,7)    
			UNISqlId(0) = "Q2113QA102"
		Case "B"
			Redim UNIValue(0,7)    
			UNISqlId(0) = "Q2113QA103"
		Case "IB"
			Redim UNIValue(0,8)    
			UNISqlId(0) = "Q2113QA104"
		Case "IS"
			Redim UNIValue(0,8)    
			UNISqlId(0) = "Q2113QA105"
		Case "A"
			Redim UNIValue(0,9)             
			UNISqlId(0) = "Q2113QA106"
	End Select
	...
	Select Case strFlag
	    	...
	    	Case "B"
	    		 UNIValue(0,6) = FilterBpCd	    					'---공급처 
	    	Case "IB"
	    		 UNIValue(0,6) = FilterItemCd					'---품목 
	    		 UNIValue(0,7) = FilterBpCd	    					'---공급처 
	    	Case "IS"
	    		 UNIValue(0,6) = FilterItemCd					'---품목 
