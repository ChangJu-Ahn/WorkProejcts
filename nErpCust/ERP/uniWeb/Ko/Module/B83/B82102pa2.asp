...
Function OpenPopup(Byval arPopUp)
        ...
        Select Case arPopUp
               Case 1 '
                    ...
                    Param(4) = "A.USER_ID = B.USR_ID AND A.ITEM_ACCT = '" & arrParam(5) & "' AND A.ITEM_KIND = '" & arrParam(6) & "' AND A.ITEM_T = 'Y'"
...
<TABLE CELLSPACING=0 CLASS="basicTB">
			...
			<FIELDSET CLASS="CLSFLD">
				<TABLE WIDTH=100% CELLSPACING=0>					
					...
					<TR>   
				       ...
				       <TD CLASS=TD6 NOWRAP><script language =javascript src='./js/b82102pa2_fpDateTime1_txtDt.js'></script></TD>				            				                
                    </TR> 					
					<TR>	
	...
	<TR>
		<TD WIDTH=100% HEIGHT=0><IFRAME NAME="MyBizASP" SRC= "../../blank.htm " WIDTH=100% HEIGHT=<%=BizSize%> FRAMEBORDER=0 SCROLLING=NO noresize framespacing=0 TABINDEX = "-1"></IFRAME>
		</TD>
	</TR>
</TABLE>
