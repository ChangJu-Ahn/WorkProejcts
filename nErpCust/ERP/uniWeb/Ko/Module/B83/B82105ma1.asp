...
<SCRIPT LANGUAGE="VBScript"   SRC="B82105ma1.vbs"></SCRIPT>
						        ...
						        <TD WIDTH=100% VALIGN=TOP>
									...
									<TABLE <%=LR_SPACE_TYPE_60%>>
									      ...
									      <TR>
				            				...
				            				<TD CLASS="TD6"><script language =javascript src='./js/b82105ma1_fpDateTime1_txtEndDt.js'></script></TD>
	                   						<TD CLASS="TD5" NOWRAP>이관일자</TD>
				            				<TD CLASS="TD6"><script language =javascript src='./js/b82105ma1_fpDateTime1_txtTransDt.js'></script></TD>
              							</TR>
									      <TR>
			    		                 ...
			    		                 <TR>
								            ...
								            <TD CLASS=TD6 NOWRAP><INPUT TYPE="RADIO" NAME="rdoChgVer" ID="rdoChgVer1" Value="Y" CLASS="RADIO" tag="24x"><LABEL FOR="rdoChgVer1">예</LABEL>
														         <INPUT TYPE="RADIO" NAME="rdoChgVer" ID="rdoChgVer2" Value="N" CLASS="RADIO" tag="24x" CHECKED><LABEL FOR="rdoChgVer2">아니오</LABEL>
														         <INPUT TYPE= HIDDEN NAME="hrdoChgVer"  SIZE= 10 MAXLENGTH=10  TAG="24" ALT="이력변경여부"></TD>
				            			    <TD CLASS=TD5 NOWRAP>단종여부</TD>
								            <TD CLASS=TD6 NOWRAP><INPUT TYPE="RADIO" NAME="rdoEndItem" ID="rdoEndItem1" Value="Y" CLASS="RADIO" tag="24x"><LABEL FOR="rdoEndItem1">예</LABEL>
														         <INPUT TYPE="RADIO" NAME="rdoEndItem" ID="rdoEndItem2" Value="N" CLASS="RADIO" tag="24x" CHECKED><LABEL FOR="rdoEndItem2">아니오</LABEL>
														         <INPUT TYPE= HIDDEN NAME="hrdoEndItem"SIZE= 10 MAXLENGTH=10  TAG="24" ALT="단종여부"></TD>
	        						    </TR>
              							<TR>
              							    <TD CLASS=TD5 NOWRAP>조달구분</TD>
				            				<TD CLASS=TD6 NOWRAP><SELECT NAME="cboPurType"  CLASS=cboNormal TAG="24x" ALT="조달구분"><OPTION VALUE=""></OPTION></SELECT></TD>
	        						    ...
	        						    <TR>
				            				...
				            				<TD CLASS=TD6 NOWRAP><script language =javascript src='./js/b82105ma1_fpDateTime1_txtReqDt.js'></script></TD>				            				                
	        						    </TR>
	        						    <TR>
											<TD CLASS=TD5 NOWRAP>Net중량</TD>
											<TD CLASS=TD6 NOWRAP><script language =javascript src='./js/b82105ma1_OBJECT1_txtNetWeight.js'></script>&nbsp;
												                 <INPUT TYPE=TEXT NAME="txtNetWeightUnit" SIZE=5 MAXLENGTH=3 tag="24xXXU" ALT="Net중량단위"></TD>
											<TD CLASS=TD5 NOWRAP>Gross중량</TD>
											<TD CLASS=TD6 NOWRAP><script language =javascript src='./js/b82105ma1_OBJECT2_txtGrossWeight.js'></script>&nbsp;
												                 <INPUT TYPE=TEXT NAME="txtGrossWeightUnit" SIZE=5 MAXLENGTH=3 tag="24xXXU" ALT="Gross중량단위"></TD>
										</TR>
										<TR>
											<TD CLASS=TD5 NOWRAP>CBM(부피)</TD>
											<TD CLASS=TD6 NOWRAP><script language =javascript src='./js/b82105ma1_OBJECT3_txtCBM.js'></script></TD>
											<TD CLASS=TD5 NOWRAP>CBM정보</TD>
											<TD CLASS=TD6 NOWRAP><INPUT TYPE=TEXT NAME="txtCBMInfo" SIZE=40 MAXLENGTH=50 tag="24x" ALT="CBM정보"></TD>
										</TR>
										<TR>
											...
											<TD CLASS=TD6 NOWRAP><script language =javascript src='./js/b82105ma1_OBJECT4_txtValidFromDt.js'></script> &nbsp;~&nbsp;
													             <script language =javascript src='./js/b82105ma1_OBJECT5_txtValidToDt.js'></script></TD>             
	        						    <TR>
				            				...
				            				<TD CLASS=TD6 ColSpan=3><INPUT NAME="txtDocNo" ALT="도면번호" TYPE="Text" SiZE=40 MAXLENGTH=60   tag="24xXXX">
                                                                    ...
                                                                    <INPUT style="FONT-SIZE: 9pt; WIDTH: 100px; COLOR: #000000; PADDING-TOP: 2px; HEIGHT: 19px; BACKGROUND-COLOR: #d4d0c8" onclick = 'vbScript:OpenDocFile()' type=button value="도면파일보기" id=button1 name=button1 tag="22"></TD>
	        						    </TR>	        						    
	        						    <TR>
	        						    ...
	        						    <TR>
				            				...
				            				<TD CLASS=TD6 ColSpan=3><TEXTAREA  NAME="txtRemark" tag="24xxx" rows =1 cols=90  ALT="비고"></TEXTAREA>
																    <INPUT TYPE=HIDDEN NAME="htxtRemark"  SIZE= 50 MAXLENGTH=200  TAG="24" ALT="비고"></TD>
	        						    </TR>
	        						    </TABLE>
							        </DIV>
				    		    </TD>
		...
		<TD <%=HEIGHT_TYPE_03%> WIDTH=100%>
			<TABLE <%=LR_SPACE_TYPE_20%>>
					<TR>
						...
						<TD ALIGN =right>
							 <A href = "VBSCRIPT:JumpChgCheck1()">품목정보변경의뢰등록</A>
						</TD>
					</TR>
			</TABLE>
		</TD>
...
<INPUT TYPE=HIDDEN NAME="htxtItemAcct"   TAG="24">
<INPUT TYPE=HIDDEN NAME="htxtItemKind"   TAG="24">
