...
Const BIZ_PGM_ID		= "XI316QB1_KO441.asp"			'☆: 비지니스 로직 ASP명
						...
						<FIELDSET CLASS="CLSFLD">
							<TABLE <%=LR_SPACE_TYPE_40%>>
								<TR>
									...
									<TD CLASS="TD6">
										<script language =javascript src='./js/xi316qa1_KO441_fpDateTime5_txtDtFr.js'></script>&nbsp;~&nbsp;
										<script language =javascript src='./js/xi316qa1_KO441_fpDateTime6_txtDtTo.js'></script>
									</TD>
								</TR>
								<TR>
