...
'*  2. Function Name		: 
'*  3. Program ID			: xi313mb2_ko119.asp
'*  4. Program Name			: MES수신 
'*  5. Program Desc			: 
'*  6. Comproxy List		: +PXI3G13_KO119
...
Dim ii											'☆ : Lookup 용 코드 저장 변수 
	...
	Set oPXI312 = Server.CreateObject("PXI3G131_KO119.cRcvMesProdRcpt")
	If CheckSYSTEMError(Err,True) = True Then
		Set oPXI312 = Nothing
		Response.End
	End If		

	Call oPXI312.RCV_MES_PROD_RCPT_MAIN(gStrGlobalCollection)
