...
'*  2. Function Name        : 
'*  3. Program ID           : XI311MA1_KO441
'*  4. Program Name         : 최종검사요청 수신
'*  5. Program Desc         : 최종검사요청 수신
'*  6. Comproxy List        : 
'*  7. Modified date(First) : 2006/05/01
...
Const BIZ_PGM_ID = "XI311MB1_KO441.asp"												'☆: Head Query 비지니스 로직 ASP명 
