...
*  2. Function Name        : BOM멀티조회(전체품목조회)
*  3. Program ID           : p1401ma1_nepes
*  4. Program Name         : ERPbom전체조회
*  5. Program Desc         : erp 제품 전체 bom조회를 한다. 
*  6. Comproxy List        :
*  7. Modified date(First) : 2012/04/16
...
<iframe src="http://192.168.31.231:369/ERPAddition/PM/p1401ma6_nepes/pm_p1401ma6.aspx" width="100%" height="100%">
</BODY>
</HTML>