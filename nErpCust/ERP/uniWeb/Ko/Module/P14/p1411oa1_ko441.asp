...
'*  4. Program Name         : BOM Change History 출력 
'*  5. Program Desc         :
'*  6. Comproxy List        : 
...
Sub SetDefaultVal()
	Dim LocSvrDate
	LocSvrDate = "<%=GetSvrDate%>"							'☆: 초기화면에 뿌려지는 처음 날짜 
					...
					<TD>
						<TABLE ID="MyTab" CELLSPACING=0 CELLPADDING=0>
							<TR>
								...
								<td background="../../../CShared/image/table/seltab_up_bg.gif" align="center" CLASS="CLSMTABP"><font color=white>BOM이력출력</font></td>
						...
						<FIELDSET CLASS="CLSFLD">
							<TABLE WIDTH=100% CELLSPACING=0 CELLPADDING=0>
								...
								<TR>	
									...
									<TD CLASS="TD6" NOWRAP><INPUT TYPE=TEXT NAME="txtECNCd" SIZE=20 MAXLENGTH=18 tag="X1XXXU" ALT="설계변경번호"><IMG SRC="../../../CShared/image/btnPopup.gif" NAME="btnECNCd" ALIGN=top TYPE="BUTTON" ONCLICK="vbscript:OpenECNCd()">&nbsp;<INPUT TYPE=TEXT NAME="txtECNDesc" SIZE=40 tag="X4" ALT="설계변경내역"></TD>
								</TR>
								<TR>
								    <TD CLASS="TD5" NOWRAP>품목</TD>
									<TD CLASS="TD6" NOWRAP><INPUT TYPE=TEXT NAME="txtFromItemCd" SIZE=20 MAXLENGTH=18 tag="X1XXXU" ALT="품목"><IMG SRC="../../../CShared/image/btnPopup.gif" NAME="btnFromItemCd" ALIGN=top TYPE="BUTTON" ONCLICK="vbscript:OpenFromItemCd">&nbsp;<INPUT TYPE=TEXT NAME="txtFromItemNm" SIZE=40 tag="X4" ALT="품목명">&nbsp;~&nbsp;</TD>
								</TR>
								<TR>
								    <TD CLASS="TD5" NOWRAP>&nbsp;</TD>
									<TD CLASS="TD6" NOWRAP><INPUT TYPE=TEXT NAME="txtToItemCd" SIZE=20 MAXLENGTH=18 tag="X1XXXU" ALT="품목"><IMG SRC="../../../CShared/image/btnPopup.gif" NAME="btnToItemCd" ALIGN=top TYPE="BUTTON" ONCLICK="vbscript:OpenToItemCd">&nbsp;<INPUT TYPE=TEXT NAME="txtToItemNm" SIZE=40 tag="X4" ALT="품목명"></TD>
								</TR>
								<TR>
								    <TD CLASS="TD5" NOWRAP>자품목</TD>
									<TD CLASS="TD6" NOWRAP><INPUT TYPE=TEXT NAME="txtChildItemCd" SIZE=20 MAXLENGTH=18 tag="X1XXXU" ALT="품목"><IMG SRC="../../../CShared/image/btnPopup.gif" NAME="btnChildItemCd" ALIGN=top TYPE="BUTTON" ONCLICK="vbscript:OpenChildItemCd">&nbsp;<INPUT TYPE=TEXT NAME="txtChildItemNm" SIZE=40 tag="X4" ALT="자품목명"></TD>
								</TR>
							</TABLE>
						</FIELDSET>
					</TD>
