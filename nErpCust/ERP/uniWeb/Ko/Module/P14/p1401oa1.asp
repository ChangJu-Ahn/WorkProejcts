...
'*  2. Function Name        : 
'*  3. Program ID           :  p1401oa1.asp
'*  4. Program Name         :  BOM 정보 출력 
'*  5. Program Desc         :
'*  6. Comproxy List        : 
...
Const BIZ_PGM_QRY_ID = "p1401ob1.asp"
					...
					<TD>
						<TABLE ID="MyTab" CELLSPACING=0 CELLPADDING=0>
							<TR>
								...
								<td background="../../../CShared/image/table/seltab_up_bg.gif" align="center" CLASS="CLSMTAB"><font color=white>BOM정보출력</font></td>
						...
						<FIELDSET CLASS="CLSFLD">
							<TABLE WIDTH=100% CELLSPACING=0 CELLPADDING=0>
								...
								<TR>
									...
									<TD CLASS=TD6 NOWRAP>
										<script language =javascript src='./js/p1401oa1_fpDateTime1_txtBaseDt.js'></script>
									</TD>
								</TR>
							</TABLE>
						</FIELDSET>
