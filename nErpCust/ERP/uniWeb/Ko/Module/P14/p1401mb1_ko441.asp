...
Sub SubBizQueryMulti()
    ...
    Else
		...
		strItemNm     = Trim(lgObjRs("ITEM_NM")) '20071204::hanc
...
'20071204::hanc					Response.Write "Set NodX = .uniTree1.Nodes.Add(,,PrntKey,""" & ConvSPChars(UCase(Trim(strItemCd))) & """" & ",parent.C_PHANTOM, parent.C_PHANTOM)" & vbCrLf
...
'20071204::hanc					Response.Write "Set NodX = .uniTree1.Nodes.Add(,,PrntKey,""" & ConvSPChars(UCase(Trim(strItemCd))) & """" & ",parent.C_SUBCON, parent.C_SUBCON)" & vbCrLf
...
'20071204::hanc					Response.Write "Set NodX = .uniTree1.Nodes.Add(,,PrntKey,""" & ConvSPChars(UCase(Trim(strItemCd))) & """" & ",parent.C_PROD, parent.C_PROD)" & vbCrLf
					...
					Response.Write "NodX.Expanded = True" & vbCrLf
				Else                      ' "20"
'20071204::hanc					Response.Write "Set NodX = .uniTree1.Nodes.Add(,,PrntKey,""" & ConvSPChars(UCase(Trim(strItemCd))) & """" & ",parent.C_ASSEMBLY, parent.C_ASSEMBLY)" & vbCrLf
				...
				End If
			Else
'20071204::hanc				Response.Write "Set NodX = .uniTree1.Nodes.Add(,,PrntKey,""" & ConvSPChars(UCase(Trim(strItemCd))) & """" & ",parent.C_MATL, parent.C_MATL)" & vbCrLf
...
'20071204::hanc						Response.Write "Set Node = .Nodes.Add(""" & ConvSPChars(lgObjRs(3)) & """" & ", parent.tvwChild, """ & ConvSPChars(lgObjRs(4)) & """, """ & ConvSPChars(Trim(lgObjRs(10))) & """" & ", parent.C_PROD, parent.C_PROD)" & vbCrLf
...
'20071204::hanc						Response.Write "Set Node = .Nodes.Add(""" & ConvSPChars(lgObjRs(3)) & """" & ", parent.tvwChild, """ & ConvSPChars(lgObjRs(4)) & """, """ & ConvSPChars(Trim(lgObjRs(10))) & """" & ", parent.C_ASSEMBLY, parent.C_ASSEMBLY)" & vbCrLf
...
'20071204::hanc						Response.Write "Set Node = .Nodes.Add(""" & ConvSPChars(lgObjRs(3)) & """" & ", parent.tvwChild, """ & ConvSPChars(lgObjRs(4)) & """, """ & ConvSPChars(Trim(lgObjRs(10))) & """" & ", parent.C_PHANTOM, parent.C_PHANTOM)" & vbCrLf
...
'20071204::hanc						Response.Write "Set Node = .Nodes.Add(""" & ConvSPChars(lgObjRs(3)) & """" & ", parent.tvwChild, """ & ConvSPChars(lgObjRs(4)) & """, """ & ConvSPChars(Trim(lgObjRs(10))) & """" & ", parent.C_SUBCON, parent.C_SUBCON)" & vbCrLf
						...
						Response.Write "Node.Expanded = True" & vbCrLf
					Else								' 원자재인 경우 
'20071204::hanc						Response.Write "Set Node = .Nodes.Add(""" & ConvSPChars(lgObjRs(3)) & """" & ", parent.tvwChild, """ & ConvSPChars(lgObjRs(4)) & """, """ & ConvSPChars(Trim(lgObjRs(10))) & """" & ", parent.C_MATL, parent.C_MATL)" & vbCrLf
