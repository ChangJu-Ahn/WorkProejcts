...
'*  3. Program ID		    : p1401ma1.asp
'*  4. Program Name		    : BOM 등록 
'*  5. Program Desc		    :
'*  6. Component List		:
...
<SCRIPT LANGUAGE = "VBScript" SRC = "p1401ma1_ko441.vbs"></SCRIPT>
...
Sub Form_Load()
	...
	frm1.txtBaseDt.Text = StartDate	'2003-09-13
					...
					<TD CLASS="CLSMTABP">
						<TABLE ID="MyTab" CELLSPACING=0 CELLPADDING=0>
							<TR>
								...
								<td background="../../../CShared/image/table/seltab_up_bg.gif" align="center" CLASS="CLSMTAB"><font color=white>BOM등록</font></td>
						...
						<FIELDSET CLASS="CLSFLD">
							<TABLE <%=LR_SPACE_TYPE_40%>>
								...
								<TR>
									...
									<TD CLASS=TD6 NOWRAP><INPUT TYPE=TEXT NAME="txtBomNo" SIZE=5 MAXLENGTH=5 tag="12XXXU" ALT="BOM Type"><IMG SRC="../../../CShared/image/btnPopup.gif" NAME="btnBomNo" align=top TYPE="BUTTON" ONCLICK="vbscript:OpenBomNo 0"></TD>
											...
											<TR>
												...
												<TD CLASS=TD6 NOWRAP>
													<TABLE CELLPADDING=0 CELLSPACING=0>
														<TR>
															<TD><INPUT TYPE=TEXT NAME="txtBomNo1" SIZE=5 MAXLENGTH=3  tag="22XXXU" ALT="BOM Type"><IMG SRC="../../../CShared/image/btnPopup.gif" NAME="btnBomNo1" align=top TYPE="BUTTON" ONCLICK="vbscript:OpenBomNo 1"  OnMouseOver="vbscript:PopupMouseOver()" OnMouseOut="vbscript:PopUpMouseOut()"></TD>
															<TD>&nbsp;<INPUT TYPE=TEXT NAME="txtBOMDesc" SIZE=30 MAXLENGTH=40  tag="21" ALT="BOM 설명"></TD>
														</TR>
													</TABLE>
												</TD>														
											</TR>
