...
'********************************************************************************************************
Const BIZ_PGM_QRY_ID			= "p1412rb1.asp"			'☆: 비지니스 로직 ASP명 
...
Function LookUpReasonInfo()
	...
	strVal = strVal & "&txtReasonCd=" & Trim(strReasonCd)					<%'☜: 조회 조건 데이타 %>
			...
			<FIELDSET CLASS="CLSFLD">
				<TABLE WIDTH=100% CELLSPACING=0>					
					...
					<TR>
						...
						<TD CLASS=TD6 NOWRAP colspan=3><INPUT TYPE=TEXT NAME="txtItemCd" SIZE=18 MAXLENGTH=18 tag="14xxxU" ALT="자품목">&nbsp;<INPUT TYPE=TEXT NAME="txtItemNm" SIZE=20 MAXLENGTH=40 tag="14" ALT="자품목"></TD>
					</TR>
				</TABLE>
			</FIELDSET>
		</TD>
						...
						<FIELDSET>
							<TABLE CLASS="TB2" CELLSPACING=0>
								<TR> 
									...
									<TD CLASS=TD6 NOWRAP><INPUT TYPE=TEXT NAME="txtSpec" SIZE=30 MAXLENGTH=50 tag="24"  ALT="규격"></TD>
								</TR>
								<TR>
									...
									<TD CLASS=TD6 NOWRAP><SELECT NAME="cboSupplyType" ALT="유무상구분" STYLE="Width: 130px;" tag="11"><OPTION VALUE=""></OPTION></SELECT></TD>
								</TR>
								<TR>
									<TD CLASS=TD5 NOWRAP>자품목기준수</TD>
									<TD CLASS=TD6 NOWRAP><SCRIPT LANGUAGE=JavaScript> ExternalWrite('<OBJECT title=FPDOUBLESINGLE CLASS=FPDS140 name=txtChildItemQty CLASSID=<%=gCLSIDFPDS%> SIZE="15" MAXLENGTH="15" ALT="자품목기준수" tag="21X8Z"> </OBJECT>');</SCRIPT></TD>
									<TD CLASS=TD5 NOWRAP>자품목기준단위</TD>
									<TD CLASS=TD6 NOWRAP><INPUT TYPE=TEXT NAME="txtChildUnit" SIZE=8 MAXLENGTH=3 tag="21xxxU"  ALT="자품목기준단위"><IMG SRC="../../../CShared/image/btnPopup.gif" NAME="btnItemCd" align=top TYPE="BUTTON" ONCLICK="vbscript:OpenUnit('CHILD')"></TD>
								</TR>
								<TR>
									<TD CLASS=TD5 NOWRAP>모품목기준수</TD>
									<TD CLASS=TD6 NOWRAP><SCRIPT LANGUAGE=JavaScript> ExternalWrite('<OBJECT title=FPDOUBLESINGLE CLASS=FPDS140 name=txtPrntItemQty CLASSID=<%=gCLSIDFPDS%> SIZE="15" MAXLENGTH="15" ALT="모품목기준수" tag="21X8Z"> </OBJECT>');</SCRIPT></TD>
									<TD CLASS=TD5 NOWRAP>모품목기준단위</TD>
									<TD CLASS=TD6 NOWRAP><INPUT TYPE=TEXT NAME="txtPrntUnit" SIZE=8 MAXLENGTH=3 tag="21xxxU"  ALT="모품목기준단위"><IMG SRC="../../../CShared/image/btnPopup.gif" NAME="btnItemCd" align=top TYPE="BUTTON" ONCLICK="vbscript:OpenUnit('PRNT')"></TD>
								</TR>
								<TR>
								...
								<TR>
									...
									<TD CLASS=TD6 NOWRAP>
										<SCRIPT LANGUAGE=JavaScript> ExternalWrite('<OBJECT CLASSID=<%=gCLSIDFPDT%> name=txtValidFromDt CLASS=FPDTYYYYMMDD title=FPDATETIME tag="24" ALT="시작일"></OBJECT>');</SCRIPT>
										&nbsp;~&nbsp;
										<SCRIPT LANGUAGE=JavaScript> ExternalWrite('<OBJECT CLASSID=<%=gCLSIDFPDT%> name=txtValidToDt CLASS=FPDTYYYYMMDD title=FPDATETIME tag="21" ALT="종료일"></OBJECT>');</SCRIPT>
									</TD>
