Const BIZ_PGM_QRY_ID					= "p1401mb1.asp"		'☆: 전체 조회 
Const BIZ_PGM_HDRSAVE_ID				= "p1401mb4.asp"		'☆: 모품목 저장(최상위 노드)
Const BIZ_PGM_DTLSAVE_ID				= "p1401mb5.asp"		'☆: 자품목 입력,수정,삭제 
Const BIZ_PGM_HDRDEL_ID					= "p1401mb6.asp"		'☆: 전체 BOM 삭제 
