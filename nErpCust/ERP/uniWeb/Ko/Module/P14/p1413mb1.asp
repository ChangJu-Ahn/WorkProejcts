...
'*  2. Function Name        : 
'*  3. Program ID           : P1413MB1.asp
'*  4. Program Name         : 자품목 일괄대체 
'*  5. Program Desc         :
'*  6. Modified date(First) : 2003-03-21
...
%>
		...
		strData = strData & Chr(11) & ""	'button
		strData = strData & Chr(11) & ""	'ITEM_NM
		strData = strData & Chr(11) & ""	'SPEC
		strData = strData & Chr(11) & ""	'ITEM_ACCT
		strData = strData & Chr(11) & ""	'PROCUR_TYPE
