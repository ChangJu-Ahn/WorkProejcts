...
<SCRIPT LANGUAGE = "VBScript" SRC = "p1401ma5_ko441.vbs"></SCRIPT>
					...
					<TD CLASS="CLSMTABP">
						<TABLE ID="MyTab" CELLSPACING=0 CELLPADDING=0>
							<TR>
								...
								<td background="../../../CShared/image/table/seltab_up_bg.gif" align="center" CLASS="CLSMTAB"><font color=white>BOM조회(Multi)</font></td>
						...
						<FIELDSET CLASS="CLSFLD">
							<TABLE <%=LR_SPACE_TYPE_40%>>
								<TR>
									...
									<TD CLASS=TD6 NOWRAP><INPUT TYPE="RADIO" NAME="rdoSrchType" ID="rdoSrchType1" CLASS="RADIO" tag="1X" Value="2" CHECKED OnClick="OnrdoSrchType(1)"><LABEL FOR="rdoSrchType1">정전개</LABEL></TD>													     
								</TR>
								<TR>
									...
									<TD CLASS=TD6 NOWRAP><INPUT TYPE="RADIO" NAME="rdoSrchType" ID="rdoSrchType2" CLASS="RADIO" tag="1X" Value="4" OnClick="OnrdoSrchType(2)"><LABEL FOR="rdoSrchType2">역전개</LABEL></TD>
								</TR>
							</TABLE>
						</FIELDSET>
					</TD>
