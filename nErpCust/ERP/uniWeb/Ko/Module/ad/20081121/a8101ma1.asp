...
<SCRIPT LANGUAGE="VBScript"   SRC="../ag/AcctCtrl_ko441_3.vbs">				</SCRIPT>

<SCRIPT LANGUAGE=vbscript>
Option Explicit		

Const BIZ_PGM_ID      = "a8101mb1.asp"	
					...
					<TD CLASS=CLSMTABP>
						<TABLE ID=MyTab CELLSPACING=0 CELLPADDING=0>
							<TR>
								...
								<TD BACKGROUND="../../../CShared/image/table/seltab_up_bg.gif" ALIGN=CENTER CLASS=CLSMTABP><FONT COLOR=WHITE>본지점전표등록</FONT></TD>
