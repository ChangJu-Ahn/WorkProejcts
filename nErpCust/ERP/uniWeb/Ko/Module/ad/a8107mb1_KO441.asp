...
Sub SubBizQuery()
	...
	Const C_E3_PROJECTNO = 16
	Const C_E3_DIST_TYPE= 17
	...
	SET PADG035 = CreateObject("PADG035_ko441.cAHqListTmpGlAHqSvr")
		...
		For iLngRow = 0 To UBound(iVarExportView, 1)
			...
			If  iIntLoopCount < (C_SHEETMAXROWS + 1) Then
				...
				istrData = istrData & Chr(11) & " "' ConvSPChars(iVarExportView(iLngRow,C_E1_CONF_FG))
                                istrData = istrData & Chr(11) & replace(iVarExportView(iLngRow,C_E3_DIST_TYPE),"최종승인","최종결재") ' 17
				istrData = istrData & Chr(11) & iVarExportView(iLngRow,C_E3_PROJECTNO) ' 16
...
Sub SubBizQuery2()
	...
	SET PADG035 = CreateObject("PADG035_ko441.cABrListTmpGlBrchSvr")
	...
	ELSE
		For iLngRow = 0 To UBound(iVarExportView, 1)
			...
			istrData = istrData & Chr(11) & " " 'iVarExportView(iLngRow,A475_EG1_E1_CONF_FG)
		     '	istrData = istrData & Chr(11) & iVarExportView(iLngRow,17) '
                     istrData = istrData & Chr(11) & replace(iVarExportView(iLngRow,17),"최종승인","최종결재")  ' 
                   ' istrData = istrData & Chr(11) & replace(iVarExportView(iLngRow,C_E3_DIST_TYPE),"최종승인","최종결재") ' 17
				istrData = istrData & Chr(11) & iVarExportView(iLngRow,16)  '		
