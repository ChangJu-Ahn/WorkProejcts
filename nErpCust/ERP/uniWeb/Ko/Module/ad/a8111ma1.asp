...
Const BIZ_PGM_ID 		= "a8111mb1.asp"                              '☆: Biz Logic ASP Name
...
Sub SetDefaultVal()
	...
	Dim ServerDate, PreStartDate, PreEndDate
...
Sub LoadInfTB19029()
    ...
    <% Call LoadBNumericFormatA("I", "*", "COOKIE", "QA") %>
...
Function OpenClassTypeCd()
	...
	arrParam(3) = ""							' Name Cindition
	arrParam(4) = "CLASS_TYPE LIKE " & FilterVar("MCS%", "''", "S") & " "							' Where Condition
	arrParam(5) = "재무제표코드"			
					...
					<TD CLASS=CLSMTABP>
						<TABLE ID=MyTab CELLSPACING=0 CELLPADDING=0>
							<TR>
								...
								<TD BACKGROUND="../../../CShared/image/table/seltab_up_bg.gif" ALIGN=CENTER CLASS=CLSMTAB><FONT COLOR=WHITE>본지점제조원가서조회(출력)</FONT></TD>
						...
						<FIELDSET CLASS=CLSFLD>
							<TABLE <%=LR_SPACE_TYPE_40%>>
								<TR>
									...
									<TD CLASS=TD6 NOWRAP><script language =javascript src='./js/a8111ma1_fpDateTime1_txtFromGlDt.js'></script>&nbsp;~&nbsp;
												         <script language =javascript src='./js/a8111ma1_fpDateTime2_txtToGlDt.js'></script></TD>
								...
								<TR>
									...
									<TD CLASS=TD6 NOWRAP><script language =javascript src='./js/a8111ma1_fpDateTime3_txtPreFromGlDt.js'></script>&nbsp;~&nbsp;
												         <script language =javascript src='./js/a8111ma1_fpDateTime4_txtPreToGlDt.js'></script></TD>
					...
					<TD WIDTH="100%" HEIGHT=* VALIGN=TOP>
						<TABLE <%=LR_SPACE_TYPE_20%>>
							<TR>
								...
								<script language =javascript src='./js/a8111ma1_vspdData_vspdData.js'></script></TD>
							</TR>
						</TABLE>
					</TD>
				</TR>
