...
<%'---------------  coding part(실행로직,Start)-----------------------------------------------------------
   EndDate = GetSvrDate                                           '☆: 초기화면에 뿌려지는 시작 날짜 -----                             '☆: 초기화면에 뿌려지는 시작 날짜 -----
   StartDate = UniDateAdd("m", -2, EndDate,gServerDateFormat)
   Call GetAdoFiledInf("A4104RA1","S","A")                        '☆: spread sheet 필드정보 query   -----
                                                                  ' 1. Program id
...
'--------------- 개발자 coding part(실행로직,Start)--------------------------------------------------
	...
	frm1.txtFrPaymDt.Text	= UNIConvDateAToB("<%=StartDate%>" ,gServerDateFormat,gDateFormat)
	frm1.txtToPaymDt.Text	= UNIConvDateAToB("<%=EndDate%>" ,gServerDateFormat,gDateFormat)
...
Dim IntRetCD
    ...
    If CompareDateByFormat(frm1.txtFrPaymDt.text,frm1.txtToPaymDt.text,frm1.txtFrPaymDt.Alt,frm1.txtToPaymDt.Alt, _
                        "970025",frm1.txtFrPaymDt.UserDefinedFormat,gComDateType,True) = False Then		                        
		Exit Function
	End If
			...
			<FIELDSET CLASS="CLSFLD">
				<TABLE <%=LR_SPACE_TYPE_40%>>
					<TR>				
						...
						<TD CLASS=TD6 NOWRAP>
							<script language =javascript src='./js/a8105ra1_I915844511_txtFrPaymDt.js'></script>&nbsp;~&nbsp;
							<script language =javascript src='./js/a8105ra1_I403645747_txtToPaymDt.js'></script>
						</TD>												
						<TD CLASS=TD5 NOWRAP>출금번호</TD>				
						<TD CLASS=TD6 NOWRAP>
						<INPUT TYPE="Text" NAME="txtFrPaymNo" SIZE=15 MAXLENGTH=20 tag="1XXXXU" ALT="출금번호">&nbsp;~&nbsp;
						<INPUT TYPE="Text" NAME="txtToPaymNo" SIZE=15 MAXLENGTH=20 tag="1XXXXU" ALT="출금번호">
						</TD>
					</TR>
					<TR>			
	...
	<TR HEIGHT=100%>
		<TD WIDTH=100% HEIGHT=* VALIGN=TOP>
			<TABLE <%=LR_SPACE_TYPE_20%>>
				<TR HEIGHT=100%>
					<TD WIDTH=100%>
						<script language =javascript src='./js/a8105ra1_I558766210_vspdData.js'></script>
					</TD>
				</TR>
			</TABLE>
		</TD>
