...
Const BIZ_PGM_ID = "a8107mb1.asp"                                              '☆: 비지니스 로직 ASP명 
'========================================================================================================
...
Sub GetSpreadColumnPos(ByVal pvSpdNo)
    ...
    Select Case UCase(pvSpdNo)
       Case "A"
			...
			C_TempGlDt      = iCurColumnPos(3)
			C_GlDt          = iCurColumnPos(4)
			C_TempGlNo      = iCurColumnPos(5)
			C_DeptNm        = iCurColumnPos(6)
			C_Currency      = iCurColumnPos(7)
			C_TempGlAmt	    = iCurColumnPos(8)
			C_TempGlLocAmt  = iCurColumnPos(9)
			C_GlNo          = iCurColumnPos(10)
			C_InputType     = iCurColumnPos(11)
			C_InputTypeNm   = iCurColumnPos(12)
			C_HqBrchNo      = iCurColumnPos(13)
		...
		Case "B"
			...
			C_BTempGlDt      = iCurColumnPos(3)
			C_BGlDt          = iCurColumnPos(4)
			C_BTempGlNo      = iCurColumnPos(5)
			C_BDeptNm        = iCurColumnPos(6)
			C_BCurrency      = iCurColumnPos(7)
			C_BTempGlAmt     = iCurColumnPos(8)
			C_BTempGlLocAmt  = iCurColumnPos(9)
			C_BGlNo          = iCurColumnPos(10)
			C_BInputType     = iCurColumnPos(11)
			C_BInputTypeNm   = iCurColumnPos(12)
			C_BHqBrchNo      = iCurColumnPos(13)
