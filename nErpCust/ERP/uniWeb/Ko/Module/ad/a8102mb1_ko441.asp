...
Sub SubBizDelete()
	...
	Set obj3PADG010 = CreateObject("PADG010_KO441.cAMngTmpGlHqSvr")
...
Sub SubBizQueryMulti()	
	...
	Const A278_EG1_E2_dr_amt		= 7						'>>air
	Const A278_EG1_E2_temp_gl_desc	= 8						'2008.04.03	결의전표(적요)추가	>>air
	...
	Const A278_EG2_E2_dr_amt		= 7						'>>air
	Const A278_EG2_E2_temp_gl_desc	= 8						'2008.04.03	결의전표(적요)추가	>>air
	...
	Dim I5_a_assign_acct_wk_Item_loc_amt
	Dim I6_a_assign_acct_wk_Item_loc_amt	
    ...
    I5_a_assign_acct_wk_item_loc_amt= UNIConvNum(Request("txtfromitemamt"),0)
    I6_a_assign_acct_wk_item_loc_amt= UNIConvNum(Request("txttoitemamt"),0)    
    I5_a_assign_acct_wk_loc_amt  	= UNIConvNum(Request("txtfromamt"),0)
    I6_a_assign_acct_wk_loc_amt  	= UNIConvNum(Request("txttoamt"),0)

'Call ServerMesgBox(UNIConvNum(Request("txtFromItemAmt"),0) , vbInformation, I_MKSCRIPT)
'Call ServerMesgBox(UNIConvNum(Request("txtToItemAmt"),0) , vbInformation, I_MKSCRIPT)

	Set obj1PADG010 = CreateObject("PADG010_KO441.cAListTmpGlHqSvr")
	...
	Call obj1PADG010.A_LIST_TEMP_GL_HQ_SVR (gStrGloBalCollection, , I1_ief_supplied_select_char, I2_b_biz_area_biz_area_cd, _
											I3_a_temp_gl_temp_gl_dt, I4_a_temp_gl_temp_gl_dt, _
											I5_a_assign_acct_wk_item_loc_amt, I6_a_assign_acct_wk_item_loc_amt, _
											I5_a_assign_acct_wk_loc_amt, I6_a_assign_acct_wk_loc_amt, _
	...
	If isArray(EG2_export_grp_temp_dr) then
		...
		For LngRow = 0 To Ubound(EG2_export_grp_temp_dr)
			...
			iStrData = iStrData & Chr(11) & UNINumClientFormat(EG2_export_grp_temp_dr(LngRow, A278_EG2_E2_dr_amt), ggAmtOfMoney.DecPoint, 0)     	'7 C_dramt	>>air
			iStrData = iStrData & Chr(11) & ConvSPChars(EG2_export_grp_temp_dr(LngRow, A278_EG2_E2_temp_gl_desc))  				'8 C_tempgldesc	결의전표(적요)추가	>>air
		...
		For LngRow1 = 0 To Ubound(EG1_export_grp_temp_cr)
			...
			If Trim(strtxttab) = "2" Then
				If  Trim(strtempglhqnodr) = Trim(strtempglhqnocr) Then 
					...
					iStrData1 = iStrData1 & Chr(11) & UNINumClientFormat(EG1_export_grp_temp_cr(LngRow1, A278_EG1_E2_dr_amt), ggAmtOfMoney.DecPoint, 0)    		'7 C_dramt
					iStrData1 = iStrData1 & Chr(11) & ConvSPChars(EG1_export_grp_temp_cr(LngRow1, A278_EG1_E2_temp_gl_desc))  		'8 C_tempgldesc	결의전표(적요)추가	>>air
			...
			Else
				...
				iStrData1 = iStrData1 & Chr(11) & ConvSPChars(EG1_export_grp_temp_cr(LngRow1, A278_EG1_E2_temp_gl_no))  	    '5 C_tempglno
				iStrData1 = iStrData1 & Chr(11) & UNINumClientFormat(EG1_export_grp_temp_cr(LngRow1, A278_EG1_E2_dr_loc_amt), ggAmtOfMoney.DecPoint, 0)     '6 C_drlocamt
				iStrData1 = iStrData1 & Chr(11) & UNINumClientFormat(EG1_export_grp_temp_cr(LngRow1, A278_EG1_E2_dr_amt), ggAmtOfMoney.DecPoint, 0)     	'7 C_dramt	>>air
				iStrData1 = iStrData1 & Chr(11) & ConvSPChars(EG1_export_grp_temp_cr(LngRow1, A278_EG1_E2_temp_gl_desc))  		'8 C_tempgldesc	결의전표(적요)추가		>>air
				iStrData1 = iStrData1 & Chr(11) & LngMaxRow + LngRow1 + 1
				iStrData1 = iStrData1 & Chr(11) & Chr(12)
			End If
...
Sub SubBizSaveMulti()
	...
	Set obj2PADG010 = CreateObject("PADG010_KO441.cAConnectTmpGlSvr")
