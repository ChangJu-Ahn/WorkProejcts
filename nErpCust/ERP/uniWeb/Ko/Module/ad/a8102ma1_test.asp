...
<SCRIPT LANGUAGE="VBScript"   SRC="../../inc/incCliRdsQuery.vbs">	</SCRIPT><!--| 결의전표 팝업을 위해 추가>>air |-->
...
Const BIZ_PGM_ID      = "a8102mb1_test.asp"					'☆: 비지니스 로직 ASP명 
Const BIZ_PGM_QRY_ID2 = "a8102mb7_test.asp"
'========================================================================================================
...
Dim C_DRLOCAMT
Dim	C_DRAMT				'>>air
Dim	C_TEMPGLDESC		'20080403	결의전표(조회-적요)추가	>>air

Dim C_ITEMSEQ										'☆: DTL SPREAD SHEET 의 COLUMNS 인덱스 
Dim C_ACCTNM
Dim C_DRCRFGNM
Dim C_ITEMLOCAMT
Dim C_ITEMDESC			'20080403	결의전표항목(조회-적요)추가	>>air
...
Sub initSpreadPosVariables(ByVal pOpt)
	...
	Select Case pOpt
		Case "A", "B", "E", "F"
			...
			C_DRLOCAMT	= 6
			C_DRAMT		= 7		'>>air
			C_TEMPGLDESC= 8		'20080403	결의전표(적요)추가	>>air			
	...
	Select Case pOpt
		Case "A"
			...
			With frm1.vspdData
			    ...
			    .MaxCols	= C_TEMPGLDESC + 1									'20080403	C_DRLOCAMT -> C_TEMPGLDESC	>>air
				...
				ggoSpread.SSSetFloat C_DRAMT,  "금액(거래)",     15, parent.ggAmtOfMoneyNo, ggStrIntegeralPart, ggStrDeciPointPart, parent.gComNum1000, parent.gComNumDec	'>>air
				ggoSpread.SSSetEdit  C_TEMPGLDESC,"적요", 	  40,   2,   , 50	'20080403	결의전표(적요)	>>air
				
				Call ggoSpread.SSSetColHidden(C_BIZAREACD,C_BIZAREACD,True)
				Call ggoSpread.SSSetColHidden(C_DRAMT,C_DRAMT,True)
		...
		Case "C"
			...
			With frm1.vspdData3
			    ...
			    .MaxCols	= C_ITEMDESC + 1				'20080403	C_ITEMLOCAMT -> C_ITEMDESC	>>air
			    Call ggoSpread.ClearSpreadData()
				...
				ggoSpread.SSSetEdit  C_ITEMDESC,   "적요",	40,   2, , 50	'적요
...
Sub GetSpreadColumnPos(ByVal pvSpdNo)
    ...
    Select Case UCase(pvSpdNo)
       Case "A"
			...
			C_DRAMT  	= iCurColumnPos(7)	'>>air
			C_TEMPGLDESC= iCurColumnPos(8)	'20080403	결의전표(적요)추가	>>air			
		...
		Case "C"
			...
			C_ITEMDESC	 = iCurColumnPos(5)	'20080403	결의전표항목(조회-적요)추가	>>air
...
Function FncQuery()
    ...
    If UNICDbl(frm1.txtFromItemAmt.Text) > UNICDbl(frm1.txtToItemAmt.Text) Then
		IntRetCD = DisplayMsgBox("113123", "X", "X", "X")					        '⊙: "Will you destory previous data"
		frm1.txtFromItemAmt.focus
		Exit Function
    End If
...
Function DbQuery()
    ...
    With frm1
		...
		strVal = strVal		& "&txtFromItemAmt="& Trim(.txtFromItemAmt.Text)	
		strVal = strVal		& "&txtToItemAmt="	& Trim(.txttoItemamt.Text)			
...
Function SetSumItem2()
		...
		If .MaxRows > 0 Then
			For lngRows = 1 to .MaxRows
		        ...
		        If Trim(.Text) = "1"  Then
			       .Col = C_DRLOCAMT
				   If .Text = "" Then
				        DblTotDrLocAmt = UNICDbl(DblTotDrLocAmt) + 0
				   Else
				        DblTotDrLocAmt = UNICDbl(DblTotDrLocAmt) + UNICDbl(.Text)
				   End If
			    End If
			Next
		End If
		...
		If .MaxRows > 0 Then
			For lngRows = 1 to .MaxRows
		        ...
		        If Trim(.Text) = "1"  Then
			       .Col = C_DRLOCAMT
				   If .Text = "" Then
				        DblTotCrLocAmt = UNICDbl(DblTotCrLocAmt) + 0
				   Else
				        DblTotCrLocAmt = UNICDbl(DblTotCrLocAmt) + UNICDbl(.Text)
				   End If
				End If
			Next
		 End If
    ...
    frm1.txtDrLocAmt.Text = UNIConvNumPCToCompanyByCurrency(DblTotDrLocAmt, parent.gCurrency, parent.ggAmtOfMoneyNo, parent.gLocRndPolicyNo, "X")
    frm1.txtCrLocAmt.Text = UNIConvNumPCToCompanyByCurrency(DblTotCrLocAmt, parent.gCurrency, parent.ggAmtOfMoneyNo, parent.gLocRndPolicyNo, "X")

    If DblTotDrLocAmt <> DblTotCrLocAmt Then
       SetSumItem2 = true
    End If
...
Function SetCancelSumItem()
	Call SetCancelSumItem1()
	Call SetCancelSumItem2()
End Function


Function SetCancelSumItem1()
    ...
    frm1.txtDrAmt2.Text = UNIConvNumPCToCompanyByCurrency(DblTotDrAmt, parent.gCurrency, parent.ggAmtOfMoneyNo, parent.gLocRndPolicyNo, "X")
    frm1.txtCrAmt2.Text = UNIConvNumPCToCompanyByCurrency(DblTotCrAmt, parent.gCurrency, parent.ggAmtOfMoneyNo, parent.gLocRndPolicyNo, "X")

    If DblTotDrAmt <> DblTotCrAmt Then
       SetCancelSumItem1 = true
    End If

End Function


Function SetCancelSumItem2()
    ...
    frm1.txtDrLocAmt2.Text = UNIConvNumPCToCompanyByCurrency(DblTotDrLocAmt, parent.gCurrency, parent.ggAmtOfMoneyNo, parent.gLocRndPolicyNo, "X")
    frm1.txtCrLocAmt2.Text = UNIConvNumPCToCompanyByCurrency(DblTotCrLocAmt, parent.gCurrency, parent.ggAmtOfMoneyNo, parent.gLocRndPolicyNo, "X")

    If DblTotDrLocAmt <> DblTotCrLocAmt Then
       SetCancelSumItem2 = true
    End If
...
'		Call ggoSpread.ClearSpreadData()
	...
	End If
	lgSpreadClickStatus	= "A"	'>>air : 결의전표팝업을 위한 변수
End Sub
...
Sub vspdData2_Click(ByVal Col, ByVal Row)
	...
	End If
	lgSpreadClickStatus	= "B"	'>>air : 결의전표팝업을 위한 변수
End Sub
...
Sub vspdData3_Click(ByVal Col, ByVal Row)
    ...
    If Row <= 0 Then
		...
		Exit Sub 
    End If
	lgSpreadClickStatus	= "C"	'>>air : 결의전표팝업을 위한 변수
End Sub
...
Sub vspdData4_Click(ByVal Col, ByVal Row)
    ...
    If Row <= 0 Then
		...
		Exit Sub 
    End If
	lgSpreadClickStatus	= "D"	'>>air : 결의전표팝업을 위한 변수
End Sub
...
Sub vspdData6_Click(ByVal Col, ByVal Row)
	...
	If Col = C_WKCHK Then 
		...
		lgBlnFlgChgValue2 = True
	End If
	lgSpreadClickStatus	= "E"	'>>air : 결의전표팝업을 위한 변수
End Sub
...
Sub vspdData7_Click(ByVal Col, ByVal Row)
	...
	End If
	lgSpreadClickStatus	= "F"	'>>air : 결의전표팝업을 위한 변수
End Sub
...
Sub vspdData8_Click(ByVal Col, ByVal Row)
    ...
    If Row <= 0 Then
		...
		Exit Sub 
    End If
	lgSpreadClickStatus	= "G"	'>>air : 결의전표팝업을 위한 변수
End Sub
...
Sub vspdData9_Click(ByVal Col, ByVal Row)
    ...
    If Row <= 0 Then
		...
		Exit Sub 
    End If
	lgSpreadClickStatus	= "H"	'>>air : 결의전표팝업을 위한 변수
End Sub
...
'========================================================================================================
Sub txtFromItemAmt_KeyDown(KeyCode, Shift)
	If KeyCode = 13 Then Call MainQuery
End Sub

'========================================================================================================
Sub txtToItemAmt_KeyDown(KeyCode, Shift)
	If KeyCode = 13 Then Call MainQuery
End Sub
...
'   Function Desc : 팝업추가>>air
'=======================================================================================================
Function OpenPopupTempGL()

	If lgSpreadClickStatus = "A" Then
		Call OpenPopupTempGL1()	
	ElseIf lgSpreadClickStatus = "B" Then
		Call OpenPopupTempGL2()		
	ElseIf lgSpreadClickStatus = "E" Then	 
		Call OpenPopupTempGL6()	
	ElseIf lgSpreadClickStatus = "F" Then	 	
		Call OpenPopupTempGL7()	
	End If
	
End Function

Sub OpenPopupTempGL1()
	Dim arrRet
	Dim arrParam(1)	
	Dim iCalledAspName
				     	...
				     	<FIELDSET CLASS=CLSFLD>
							<TABLE CLASS=BasicTB CELLSPACING=0>
								<TR>
									...
									<TD CLASS=TD5 NOWRAP>항목금액</TD>
									<TD CLASS=TD6 NOWRAP><script language =javascript src='./js/a8102ma1_fpDoubleSingle1_txtfromitemamt.js'></script>&nbsp;~&nbsp;
														 <script language =javascript src='./js/a8102ma1_fpDoubleSingle1_txttoitemamt.js'></script></TD>
								</TR>
								<TR>
								...
								<TD ALIGN="RIGHT">
									<TABLE>
										<TR>
											<TD>거래</TD>
											<TD>								
												<script language =javascript src='./js/a8102ma1_I157405334_txtDrAmt.js'></script>
											</TD>
										</TR>
									</TABLE>												
								</TD>
								<TD ALIGN="RIGHT">
									<TABLE>
										<TR>
											<TD>자국</TD>
											<TD>
												<script language =javascript src='./js/a8102ma1_I310657852_txtDrLocAmt.js'></script>
											</TD>
										</TR>
									</TABLE>	
								</TD>								
								...
								<TD ALIGN="RIGHT">
									<TABLE>
										<TR>
											<TD>거래</TD>
											<TD>									
												<script language =javascript src='./js/a8102ma1_I579530906_txtCrAmt.js'></script>
											</TD>
										</TR>
									</TABLE>									
								</TD>								
								<TD ALIGN="RIGHT">
									<TABLE>
										<TR>
											<TD>자국</TD>
											<TD>								
												<script language =javascript src='./js/a8102ma1_I768516027_txtCrLocAmt.js'></script>
											</TD>
										</TR>
									</TABLE>												
								</TD>
								...
								<TD ALIGN="RIGHT">
									<TABLE>
										<TR>
											<TD>거래</TD>
											<TD>									
												<script language =javascript src='./js/a8102ma1_fpDoubleSingle2_txtDrAmt2.js'></script>
											</TD>
										</TR>
									</TABLE>	
								</TD>
								<TD ALIGN="RIGHT">
									<TABLE>
										<TR>
											<TD>자국</TD>
											<TD>								
												<script language =javascript src='./js/a8102ma1_fpDoubleSingle4_txtDrLocAmt2.js'></script>
											</TD>
										</TR>
									</TABLE>									
								</TD>								
								...
								<TD ALIGN="RIGHT">
									<TABLE>
										<TR>
											<TD>거래</TD>
											<TD>									
												<script language =javascript src='./js/a8102ma1_fpDoubleSingle3_txtCrAmt2.js'></script>
											</TD>
										</TR>
									</TABLE>		
								</TD>	
								<TD ALIGN="RIGHT">
									<TABLE>
										<TR>
											<TD>자국</TD>
											<TD>								
												<script language =javascript src='./js/a8102ma1_fpDoubleSingle5_txtCrLocAmt2.js'></script>
											</TD>
										</TR>
									</TABLE>													
								</TD>
