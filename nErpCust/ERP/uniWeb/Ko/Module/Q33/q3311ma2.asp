...
Const BIZ_PGM_QRY_ID = "q3311mb2.asp"							'☆: Query 비지니스 로직 ASP명 
						...
						<FIELDSET CLASS=CLSFLD>
							<TABLE WIDTH="100%" <%=LR_SPACE_TYPE_40%>>		
								...
								<TR>
									...
									<TD CLASS="TD6" NOWRAP><INPUT TYPE="RADIO" CLASS="RADIO" NAME="RadioDRType" TAG="1`X" ID="rdoCase1"><LABEL FOR="rdoCase1" >LOT불합격률</LABEL>
														   <INPUT TYPE="RADIO" CLASS="RADIO" NAME="RadioDRType" TAG="1X" ID="rdoCase2"><LABEL FOR="rdoCase2">불량률</LABEL></TD>
								</TR>
							</TABLE>
						</FIELDSET>
					</TD>
