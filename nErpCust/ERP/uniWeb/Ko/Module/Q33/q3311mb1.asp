...
Function GetData()
	...
	strSql1 = "SELECT Day(RELEASE_DT), Count(INSP_REQ_NO), Sum(LOT_SIZE), Sum(INSP_QTY), Sum(DEFECT_QTY) " & _
			  ...
			  " WHERE PLANT_CD= " & FilterVar(strPlantCd, "''", "S") & _
			    ...
			    " and INSP_CLASS_CD=" & FilterVar("P", "''", "S") & "  and status_flag=" & FilterVar("R", "''", "S") & "  "
	...
	strSql2 = "SELECT Day(RELEASE_DT), Count(DECISION) " & _
			  ...
			  " WHERE PLANT_CD = " & FilterVar(strPlantCd, "''", "S") & _
			    " and ITEM_CD= " & FilterVar(strItemCd, "''", "S") & _
			    " and YEAR(RELEASE_DT) = " & strYr & " and MONTH(RELEASE_DT) = " & strMnth & _
			    " and INSP_CLASS_CD=" & FilterVar("P", "''", "S") & "  and status_flag=" & FilterVar("R", "''", "S") & "  and DECISION=" & FilterVar("R", "''", "S") & "  "

	If strRoutNo <> "" Then
		strSql1 = strSql1 & " and ROUT_NO = " & FilterVar(strRoutNo, "''", "S")
		strSql2 = strSql2 & " and ROUT_NO = " & FilterVar(strRoutNo, "''", "S")
	End If
	
	If strOprNo <> "" Then
		strSql1 = strSql1 & " and OPR_NO = " & FilterVar(strOprNo, "''", "S")
		strSql2 = strSql2 & " and OPR_NO = " & FilterVar(strOprNo, "''", "S")
	End If
	...
	strSql4 = " SELECT C.TARGET_VALUE, B.PARAMETER " & _
			  ...
			  " AND A.INSP_CLASS_CD = " & FilterVar("P", "''", "S") & _
