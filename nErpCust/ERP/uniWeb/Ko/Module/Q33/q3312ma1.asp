...
Const BIZ_PGM_QRY_ID = "q3312mb1.asp"							'☆: Query 비지니스 로직 ASP명 
...
Sub ClearChartFx()
	...
	With frm1.ChartFX2
		...
		'범례 Clear
		.ClearLegend 1		'Series Legend를 Clear
						...
						<FIELDSET CLASS=CLSFLD>
							<TABLE WIDTH="100%" <%=LR_SPACE_TYPE_40%>>		
								...
								<TR>
									...
									<TD CLASS="TD6"><INPUT TYPE=TEXT NAME="txtInspItemCd" SIZE="10" MAXLENGTH="5" ALT="검사항목" tag="11XXXU"><IMG SRC="../../../CShared/image/btnPopup.gif" NAME="btnInspItemItem" align=top TYPE="BUTTON" ONCLICK="vbscript:OpenInspItem()">
