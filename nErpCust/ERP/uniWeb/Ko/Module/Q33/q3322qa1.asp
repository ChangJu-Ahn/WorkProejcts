...
Const BIZ_PGM_ID		= "Q3322qb1.asp"                 '☆: 비지니스 로직 ASP명 
Const BIZ_PGM_JUMP_ID	= "Q2214qa1"                     '☆: Cookie에서 사용할 상수 
						...
						<FIELDSET CLASS="CLSFLD">
							<TABLE <%=LR_SPACE_TYPE_40%>>
								...
								<TR>
									...
									<TD CLASS="TD6" NOWRAP><INPUT TYPE=TEXT NAME="txtDefectTypeCd" SIZE="10" MAXLENGTH="3" ALT="불량유형" tag="11XXXU"><IMG SRC="../../../CShared/image/btnPopup.gif" NAME="btnDefectType" align=top TYPE="BUTTON" ONCLICK="vbscript:OpenDefectType()">
