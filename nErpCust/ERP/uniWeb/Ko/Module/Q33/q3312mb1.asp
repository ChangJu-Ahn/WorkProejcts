...
'*  3. Program ID           : q3312mb1.asp
'*  4. Program Name         : 공정불량원인 파레토표 
'*  5. Program Desc         : 공정불량원인 
'*  6. Comproxy List        : 
'                             
'*  7. Modified date(First) : 2000/05/29
'*  8. Modified date(Last)  : 2004/08/03
'*  9. Modifier (First)     : 
'* 10. Modifier (Last)      :
'* 11. Comment              :
'**********************************************************************************************
...
Function GetData()
	...
	'당월 
	strSql1 = "SELECT Q_DEFECT_CAUSE.DEFECT_CAUSE_NM, Sum(Q_PROCESS_DEFECT_CAUSE_TOTAL.DEFECT_QTY) FROM Q_PROCESS_DEFECT_CAUSE_TOTAL Left Outer Join " &_
	              "Q_DEFECT_CAUSE On Q_PROCESS_DEFECT_CAUSE_TOTAL.DEFECT_CAUSE_CD = Q_DEFECT_CAUSE.DEFECT_CAUSE_CD " &_
	              "Where Q_DEFECT_CAUSE.INSP_CLASS_CD=" & FilterVar("P", "''", "S") & "  and Q_PROCESS_DEFECT_CAUSE_TOTAL.PLANT_CD = " & FilterVar(strPlantCd, "''", "S") &_
	              " and Q_PROCESS_DEFECT_CAUSE_TOTAL.YR = '" & strYr1 & "' and Q_PROCESS_DEFECT_CAUSE_TOTAL.Mnth = '" & strMnth1 &_
	              "'and Q_PROCESS_DEFECT_CAUSE_TOTAL.Item_Cd = " & FilterVar(strItemCd, "''", "S") & " and Q_PROCESS_DEFECT_CAUSE_TOTAL.ROUT_NO Like " & FilterVar(strRoutNo, "''", "S") &_
	              " and Q_PROCESS_DEFECT_CAUSE_TOTAL.OPR_NO Like " & FilterVar(strOprNo, "''", "S") & " and Q_PROCESS_DEFECT_CAUSE_TOTAL.INSP_ITEM_CD LIKE " & FilterVar(strInspItemCd, "''", "S") & _
	              " and DEFECT_TYPE_CD LIKE " & FilterVar(strDefectTypeCd, "''", "S") & " and Q_PROCESS_DEFECT_CAUSE_TOTAL.DEFECT_QTY > 0   " &_
	              "GROUP BY Q_DEFECT_CAUSE.DEFECT_CAUSE_NM Order By Sum(Q_PROCESS_DEFECT_CAUSE_TOTAL.DEFECT_QTY) Desc"
	'전월 
	strSql2 = "SELECT Q_DEFECT_CAUSE.DEFECT_CAUSE_NM, Sum(Q_PROCESS_DEFECT_CAUSE_TOTAL.DEFECT_QTY) FROM Q_PROCESS_DEFECT_CAUSE_TOTAL Left Outer Join " &_
	              "Q_DEFECT_CAUSE On Q_PROCESS_DEFECT_CAUSE_TOTAL.DEFECT_CAUSE_CD = Q_DEFECT_CAUSE.DEFECT_CAUSE_CD " &_
	              "Where Q_DEFECT_CAUSE.Insp_Class_Cd=" & FilterVar("P", "''", "S") & "  and Q_PROCESS_DEFECT_CAUSE_TOTAL.PLANT_CD = " & FilterVar(strPlantCd, "''", "S") &_
	              " and Q_PROCESS_DEFECT_CAUSE_TOTAL.YR = '" & strYr2 & "' and Q_PROCESS_DEFECT_CAUSE_TOTAL.Mnth = '" & strMnth2 &_
	              "'and Q_PROCESS_DEFECT_CAUSE_TOTAL.Item_Cd = " & FilterVar(strItemCd, "''", "S") & " and Q_PROCESS_DEFECT_CAUSE_TOTAL.ROUT_NO Like " & FilterVar(strRoutNo, "''", "S") &_
	              " and Q_PROCESS_DEFECT_CAUSE_TOTAL.OPR_NO Like " & FilterVar(strOprNo, "''", "S") & " and Q_PROCESS_DEFECT_CAUSE_TOTAL.INSP_ITEM_CD Like " & FilterVar(strInspItemCd, "''", "S") & _
	              " and DEFECT_TYPE_CD LIKE " & FilterVar(strDefectTypeCd, "''", "S") & " and Q_PROCESS_DEFECT_CAUSE_TOTAL.DEFECT_QTY > 0   " &_
	              "GROUP BY Q_DEFECT_CAUSE.DEFECT_CAUSE_NM Order By Sum(Q_PROCESS_DEFECT_CAUSE_TOTAL.DEFECT_QTY) Desc"
