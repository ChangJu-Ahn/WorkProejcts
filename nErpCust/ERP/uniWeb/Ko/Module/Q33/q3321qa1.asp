...
Const BIZ_PGM_ID		= "Q3321qb1.asp"                 '☆: 비지니스 로직 ASP명 
Const BIZ_PGM_JUMP_ID	= "Q2213qa1"                     '☆: Cookie에서 사용할 상수 
...
Sub InitSpreadSheet()
    ...
    Call SetZAdoSpreadSheet("Q3321QA1", "G", "A", "V20040805", parent.C_GROUP_DBAGENT, frm1.vspdData, C_MaxKey, "X", "X")
    Call SetSpreadLock 
End Sub
...
Function DbQuery() 
	...
	With frm1
		...
		strVal	= BIZ_PGM_ID & "?txtPlantCd=" & Trim(.txtPlantCd.value) _
				...
				& "&txtInspItemCd=" & Trim(.txtInspItemCd.value)
		'--------------- 개발자 coding part(실행로직,End)------------------------------------------------------------------------------
						...
						<FIELDSET CLASS="CLSFLD">
							<TABLE <%=LR_SPACE_TYPE_40%>>
								<TR>
									...
									<TD CLASS="TD6">
										<script language =javascript src='./js/q3321qa1_fpDateTime5_txtDtFr.js'></script>&nbsp;~&nbsp;
										<script language =javascript src='./js/q3321qa1_fpDateTime6_txtDtTo.js'></script>										
									</TD>
								</TR>
								<TR>
					...
					<TD HEIGHT=*  WIDTH=100% VALIGN=TOP>						
						...
						<TR>
								<TD HEIGHT=100% WIDTH=100% Colspan=4>
									<script language =javascript src='./js/q3321qa1_I651244056_vspdData.js'></script>
								</TD>	
							</TR>	
						</TABLE>
					</TD>
	...
	<TR HEIGHT=20>
      		<TD WIDTH=100%>
      			<TABLE <%=LR_SPACE_TYPE_30%>>
        				<TR>        				
        					<TD WIDTH=10>&nbsp;</TD>
					<!--<TD WIDTH="*" ALIGN="RIGHT"><a ONCLICK="VBSCRIPT:CookiePage(1)">공정검사불량유형조회</a></TD>-->
