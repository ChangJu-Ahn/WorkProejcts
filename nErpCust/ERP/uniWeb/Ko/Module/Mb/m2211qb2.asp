...
'----------------------------------------------------------------------------------------------------------
 Sub FixUNISQLData()
	...
	If Len(Request("txtPoNo")) Then
		UNIValue(0,11)	= " " & FilterVar(UCase(Request("txtPoNo")), "''", "S") & " "
		UNIValue(0,12)	= " " & FilterVar(UCase(Request("txtPoNo")), "''", "S") & " "
	else
		UNIValue(0,11)	= "''"
		UNIValue(0,12)	= "" & FilterVar("zzzzzzzzz", "''", "S") & " "
	End If

	If Request("rdoUseflg") = "A"then
		UNIValue(0,13)	= ""
	elseif Request("rdoUseflg") = "F"then
		UNIValue(0,13)	=" AND B.SPPL_TYPE = " & FilterVar("F", "''", "S") & "  "
	else
		UNIValue(0,13)	= " AND B.SPPL_TYPE = " & FilterVar("C", "''", "S") & "  "
	end if

	If Len(Trim(Request("txtTrackNo"))) Then
		UNIValue(0,14) 	= " " & FilterVar(Trim(Request("txtTrackNo")), "''", "S") & ""
	Else
		UNIValue(0,14)	= " '' "
	End If
	...
	elseif Request("rdoClsflg") = "N"then
		UNIValue(0,15)	=" AND L.cls_flg = " & FilterVar("N", "''", "S") & "  "
	else
		UNIValue(0,15)	= " AND L.cls_flg = " & FilterVar("Y", "''", "S") & "  "
	end if
