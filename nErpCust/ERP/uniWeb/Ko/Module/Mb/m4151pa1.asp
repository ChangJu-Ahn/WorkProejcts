...
Const BIZ_PGM_ID 		= "m4151pb1.asp"                              '☆: Biz Logic ASP Name
Const C_MaxKey          = 6                                           '☆: key count of SpreadSheet
Const C_GrNo    		= 1											  '☆: Spread Sheet 의 Columns 인덱스 
'================================================================================================================================	
...
Sub InitSpreadSheet()
	...
	Call SetZAdoSpreadSheet("M4151PA1","S","A","V20030527",PopupParent.C_SORT_DBAGENT,frm1.vspdData, C_MaxKey, "X","X")
...
Function OpenConSItemDC(Byval iWhere)
	...
	Select Case iWhere
		Case 0	'공급처 
			...
			arrParam(4) = "BP_TYPE In (" & FilterVar("S", "''", "S") & " ," & FilterVar("CS", "''", "S") & ") And usage_flag=" & FilterVar("Y", "''", "S") & "  AND  in_out_flag = " & FilterVar("O", "''", "S") & "  "											'사외거래처만' Where Condition
...
Function FncQuery() 
	...
	With frm1
		if (UniConvDateToYYYYMMDD(.txtFrMvmtDt.text,PopupParent.gDateFormat,"") > UniConvDateToYYYYMMDD(.txtToMvmtDt.text,PopupParent.gDateFormat,"")) and Trim(.txtFrMvmtDt.text)<>"" and Trim(.txtToMvmtDt.text)<>"" then	
...
Function DbQuery() 
    ...
    With frm1
		...
		If lgIntFlgMode = PopupParent.OPMD_UMODE Then
			...
			strVal = strVal & "&txtFrMvmtDt=" & .hdnFrDt.value
			strVal = strVal & "&txtToMvmtDt=" & .hdnToDt.value
					...
					<TR>
						...
						<TD CLASS="TD6" NOWRAP>
							<table cellspacing=0 cellpadding=0>
								<tr NOWRAP>
									<td NOWRAP>
										<script language =javascript src='./js/m4151pa1_fpDateTime1_txtFrMvmtDt.js'></script>
									</td>
									<td NOWRAP>~</td>
									<td NOWRAP>
										<script language =javascript src='./js/m4151pa1_fpDateTime1_txtToMvmtDt.js'></script>
									</td>
								<tr>
							</table>
						</TD>	
						<TD CLASS="TD5" NOWRAP>공급처</TD>
						<TD CLASS="TD6" NOWRAP><INPUT TYPE=TEXT AlT="공급처" NAME="txtSupplierCd" SIZE=10 MAXLENGTH=10 tag="11NXXU"><IMG SRC="../../../CShared/image/btnPopup.gif" NAME="btnGroup1Cd" align=top TYPE="BUTTON"ONCLICK="vbscript:OpenConSItemDC 0">
					   			 	     	   <INPUT TYPE=TEXT AlT="공급처" ID="txtSupplierNm" NAME="arrCond" tag="14X"></TD>
					<TR>
						<TD CLASS="TD5" NOWRAP>구매그룹</TD>
						<TD CLASS="TD6" NOWRAP><INPUT TYPE=TEXT AlT="구매그룹" NAME="txtGroupCd" SIZE=10 MAXLENGTH=4 tag="11NXXU"><IMG SRC="../../../CShared/image/btnPopup.gif" NAME="btnGroup1Cd" align=top TYPE="BUTTON"ONCLICK="vbscript:OpenConSItemDC 1">
			...
			<TABLE <%=LR_SPACE_TYPE_20%>>
				<TR>
					<TD HEIGHT=100% WIDTH=100% COLSPAN=4>					
						<script language =javascript src='./js/m4151pa1_vspdData_vspdData.js'></script>
					</TD>
				</TR>
			</TABLE>
		</TD>
