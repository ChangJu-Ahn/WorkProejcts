...
'*  2. Function Name        : 
'*  3. Program ID           : mb115oa1
'*  4. Program Name         : 사급품 출고요청서 출력 
'*  5. Program Desc         : 사급품 출고요청서 출력 
'*  6. Component List       : 
...
'=======================================================================================================
 Function FncBtnPrint() 
	...
	strUrl = strUrl & "|fr_issuemthd|"	& var6
	strUrl = strUrl & "|to_issuemthd|"	& var7
	
'----------------------------------------------------------------
' Print 함수에서 호출 
'----------------------------------------------------------------
	
	ObjName = AskEBDocumentName("mb115oa1","ebr")
					...
					<TD>
						<TABLE ID="MyTab" CELLSPACING=0 CELLPADDING=0>
							<TR>
								...
								<td background="../../../CShared/image/table/seltab_up_bg.gif" align="center" CLASS="CLSMTAB"><font color=white>사급품 출고요청서 출력</font></td>
				...
				<TR>
					<TD WIDTH=100%>
						<TABLE <%=LR_SPACE_TYPE_60%>>
							...
							<TR><TD CLASS="TD5" NOWRAP>발주일</TD>
								<TD CLASS="TD6" NOWRAP>
									<table cellspacing=0 cellpadding=0>
										<tr>
											<td>
												<script language =javascript src='./js/mb115oa1_fpDateTime2_txtFrDt.js'></script>
											</td>
											<td>~</td>
											<td>
												<script language =javascript src='./js/mb115oa1_fpDateTime2_txtToDt.js'></script>
											</td>
										<tr>
									</table>
								</TD>
							...
							<TR>
								...
								<TD CLASS="TD6" NOWRAP><INPUT TYPE=radio Class="Radio" ALT="전체" NAME="rdoflg" id = "rdoflg1" Value=""  checked tag="12"><label for="rdoflg1">&nbsp;전체&nbsp;</label>
													   <INPUT TYPE=radio Class="Radio" ALT="수동" NAME="rdoflg" id = "rdoflg2" Value="M"  tag="12"><label for="rdoflg2">&nbsp;수동&nbsp;</label>
													   <INPUT TYPE=radio Class="Radio" ALT="자동" NAME="rdoflg" id = "rdoflg3" Value="A"  tag="12"><label for="rdoflg3">&nbsp;자동&nbsp;</label>
								</TD>									
							</TR>
						</TABLE>
					</TD>
