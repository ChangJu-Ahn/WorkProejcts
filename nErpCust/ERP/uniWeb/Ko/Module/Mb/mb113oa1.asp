...
'*  2. Function Name        : 
'*  3. Program ID           : mb113oa1
'*  4. Program Name         : 사급품 출고현황 출력 
'*  5. Program Desc         : 사급품 출고현황 출력 
'*  6. Component List       : 
...
'=======================================================================================================
 Function FncBtnPrint() 
	...
	strUrl = strUrl & "|fr_mvmtdt|" & var2
	strUrl = strUrl & "|to_mvmt_dt|" & var3
	strUrl = strUrl & "|fr_bpcd|" 	& var4
	strUrl = strUrl & "|to_bpcd|" 	& var5
	
'----------------------------------------------------------------
' Print 함수에서 호출 
'----------------------------------------------------------------
	
	ObjName = AskEBDocumentName("mb113oa1","ebr")
					...
					<TD>
						<TABLE ID="MyTab" CELLSPACING=0 CELLPADDING=0>
							<TR>
								...
								<td background="../../../CShared/image/table/seltab_up_bg.gif" align="center" CLASS="CLSMTAB"><font color=white>사급품 출고현황 출력</font></td>
				...
				<TR>
					<TD WIDTH=100%>
						<TABLE <%=LR_SPACE_TYPE_60%>>
							...
							<TR><TD CLASS="TD5" NOWRAP>출고일</TD>
								<TD CLASS="TD6" NOWRAP>
									<table cellspacing=0 cellpadding=0>
										<tr>
											<td>
												<script language =javascript src='./js/mb113oa1_fpDateTime2_txtFrDt.js'></script>
											</td>
											<td>~</td>
											<td>
												<script language =javascript src='./js/mb113oa1_fpDateTime2_txtToDt.js'></script>
											</td>
										<tr>
									</table>
								</TD>
