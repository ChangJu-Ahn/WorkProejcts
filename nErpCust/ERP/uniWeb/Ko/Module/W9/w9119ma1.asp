...
'*  1. Module Name          : 법인세 
'*  2. Function Name        : 국조제8호국제거래명세서 
'*  3. Program ID           : w9119ma1
'*  4. Program Name         : w9119ma1.asp
'*  5. Program Desc         : 국조제8호국제거래명세서 
...
Const BIZ_PGM_ID = "w9119mb1.asp"											 '☆: 비지니스 로직 ASP명 
...
Sub InitData2()
	...
	With frm1.vspdData
		...
		.Col = C_W1_NM	: .value = "  (1)법인명(상호)"
		Call .AddCellSpan(C_W1_NM, iRow ,2, 1) 
	  
		iRow = iRow + 1 : .Row = iRow   :.TypeVAlign = 2 :  .rowheight(iRow) = 18
		.Col = C_W1_NM	: .value = "  (2)소재주소"
		Call .AddCellSpan(C_W1_NM, iRow ,2, 1) 
		
		iRow = iRow + 1 : .Row = iRow     :.TypeVAlign = 2  :  .rowheight(iRow) = 18
		.Col = C_W1_NM	: .value = "  (3)업종(업종명)"
		Call .AddCellSpan(C_W1_NM, iRow ,2, 1) 
		
		iRow = iRow + 1 : .Row = iRow     :.TypeVAlign = 2  :  .rowheight(iRow) = 18
		.Col = C_W1_NM	: .value = "       (업종코드)"
		Call .AddCellSpan(C_W1_NM, iRow ,2, 1) 
		

		iRow = iRow + 1 : .Row = iRow    :.TypeVAlign = 2  :  .rowheight(iRow) = 18
		.Col = C_W1_NM	: .value = " (4)제출인과의 관계"
		Call .AddCellSpan(C_W1_NM, iRow ,2, 1) 
		...
		.Col = C_W1_NM	: .text = "매" & vbCr & "출"& vbCrLf & "거"& vbCrLf & "래" : .TypeEditMultiLine = true   :.TypeVAlign = 2
		
		
		.Col = C_W1_NM2	: .value = " (6)소계"
		ggoSpread.SpreadLock	C_W1_NM2  ,iRow , .Maxrows -1 ,iRow
		iRow = iRow + 1 : .Row = iRow      :.TypeVAlign = 2
	
		
		
		.Col = C_W1_NM2	: .value = "유형자산 "
		
		iRow = iRow + 1 : .Row = iRow       :.TypeVAlign = 2
		.Col = C_W1_NM2	: .value = "무형자산"
		
		iRow = iRow + 1 : .Row = iRow       :.TypeVAlign = 2
		.Col = C_W1_NM2	: .value = "용역거래"
		
		iRow = iRow + 1 : .Row = iRow       :.TypeVAlign = 2
		.Col = C_W1_NM2	: .value = "금전대부"
		
		iRow = iRow + 1 : .Row = iRow       :.TypeVAlign = 2
		.Col = C_W1_NM2	: .value = "기타"
		
		iRow = iRow + 1 : .Row = iRow      :.TypeVAlign = 2
		Call .AddCellSpan(C_W1_NM, iRow ,1, 6) 
		 ggoSpread.SpreadLock	C_W1_NM2  ,iRow , .Maxrows -1 ,iRow
		.Col = C_W1_NM	: .text = "매" & vbCr & "입"& vbCrLf & "거"& vbCrLf & "래" : .TypeEditMultiLine = true   :.TypeVAlign = 2
		
		.Col = C_W1_NM2	: .value = " (7)소계"
	...
	With frm1.vspdData
		...
		Select Case ROW
			Case 8,9,10,11,12 ,14,15,16,17,18
			     dblSum1 = FncSumSheet(frm1.vspdData , Col, 8, 12 , true, 7 , Col, "V")	' 합계 
	
			     dblSum2 = FncSumSheet(frm1.vspdData , Col, 14, 18 , true, 13 , Col, "V")	' 합계 
