...
Sub SubBizQuery()
	...
	Else
	    ...
	    Do While Not lgObjRs.EOF
			...
			arrRs(0) = arrRs(0) & Chr(11) & ConvSPChars(lgObjRs("W1"))
			arrRs(0) = arrRs(0) & Chr(11) & ConvSPChars(lgObjRs("W1_NM"))
			arrRs(0) = arrRs(0) & Chr(11) & UNIDateClientFormat(lgObjRs("W2"))	
			arrRs(0) = arrRs(0) & Chr(11) & ConvSPChars(lgObjRs("W3"))	
			arrRs(0) = arrRs(0) & Chr(11) & ConvSPChars(lgObjRs("W4"))	
			arrRs(0) = arrRs(0) & Chr(11) & ConvSPChars(lgObjRs("W5"))	
			arrRs(0) = arrRs(0) & Chr(11) & ConvSPChars(lgObjRs("W6"))	
			arrRs(0) = arrRs(0) & Chr(11) & ConvSPChars(lgObjRs("W7"))		
			arrRs(0) = arrRs(0) & Chr(11) & ConvSPChars(lgObjRs("W8"))		
...
Sub SubMakeSQLStatements(pMode,pCode1, pCode2, pCode3)
    Select Case pMode 
      Case "R"
			lgStrSQL =			  " SELECT  "
            lgStrSQL = lgStrSQL & " A.SEQ_NO, A.W1, dbo.ufn_GetCodeName('W1005', A.W1) W1_NM, A.W2, A.W3, A.W4, A.W5, A.W6, A.W7, A.W8 "
            lgStrSQL = lgStrSQL & " FROM TB_55 A WITH (NOLOCK) "
...
Sub SubBizSaveMultiCreate(arrColVal)
	...
	lgStrSQL = "INSERT INTO TB_55 WITH (ROWLOCK) ("
	lgStrSQL = lgStrSQL & " CO_CD, FISC_YEAR, REP_TYPE "
	lgStrSQL = lgStrSQL & " , SEQ_NO, W1, W2, W3, W4, W5, W6, W7, W8"
...
Sub SubBizSaveMultiUpdate(arrColVal)
    ...
    lgStrSQL = "UPDATE  TB_55 WITH (ROWLOCK) "
    
    lgStrSQL = lgStrSQL & " SET " 
    lgStrSQL = lgStrSQL & " W1	   = " &  FilterVar(Trim(UCase(arrColVal(C_W1_CD))),"''","S") & ","
...
Sub SubBizSaveMultiDelete(arrColVal)
    ...
    lgStrSQL = "DELETE  TB_55 WITH (ROWLOCK) "	 & vbCrLf
	lgStrSQL = lgStrSQL & " WHERE CO_CD = " & FilterVar(Trim(UCase(wgCO_CD)),"''","S") 	 & vbCrLf
	lgStrSQL = lgStrSQL & "		AND FISC_YEAR = " & FilterVar(Trim(UCase(sFISC_YEAR)),"''","S") 	 & vbCrLf
	lgStrSQL = lgStrSQL & "		AND REP_TYPE = " & FilterVar(Trim(UCase(sREP_TYPE)),"''","S") 	 & vbCrLf 
	lgStrSQL = lgStrSQL & "		AND SEQ_NO = " & FilterVar(Trim(UCase(arrColVal(C_SEQ_NO))),"0","D")  & vbCrLf & vbCrLf 
