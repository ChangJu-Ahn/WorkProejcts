...
Sub SubBizDelete()
	...
	' 디테일부터 제거한다.
    lgStrSQL =            "DELETE TB_KJ8 WITH (ROWLOCK) " & vbCrLf
	...
	Else
		...
		iDx = 1
				...
				Do While Not lgObjRs.EOF
						...
						lgstrData = lgstrData & "	.Col = " & C_W5    & " : .value = """ & lgObjRs("W5") & """" & vbCrLf
						lgstrData = lgstrData & "	.Col = " & C_W6    & " : .value = """ & lgObjRs("W6") & """" & vbCrLf
						lgstrData = lgstrData & "	.Col = " & C_W7    & " : .value = """ & lgObjRs("W7") & """" & vbCrLf
						lgstrData = lgstrData & "	.Col = " & C_W8    & " : .value = """ & lgObjRs("W8") & """" & vbCrLf
						lgstrData = lgstrData & "	.Col = " & C_W9    & " : .value = """ & lgObjRs("W9") & """" & vbCrLf
...
Dim iKey1, iKey2    ,iKey3
    ...
    Select Case pMode 
      Case "R"
			...
			lgStrSQL = lgStrSQL & "  From  dbo.ufn_TB_KJ8_GetRef("& iKey1 &","& iKey2 &","& iKey3 &") A"
            ...
            lgStrSQL = lgStrSQL & " FROM TB_KJ8 A WITH (NOLOCK) "
...
Sub SubBizSaveMultiCreate(arrColVal)
	...
	lgStrSQL = "INSERT INTO TB_KJ8 WITH (ROWLOCK) ("
	...
	lgStrSQL = lgStrSQL & FilterVar(UNICDbl(arrColVal(1), "0"),"0","D")    & ","
	lgStrSQL = lgStrSQL & FilterVar(UNICDbl(arrColVal(2), "0"),"0","D")       & ","
	lgStrSQL = lgStrSQL & FilterVar(UNICDbl(arrColVal(3), "0"),"0","D")     & ","
	...
	lgStrSQL = lgStrSQL & FilterVar(UNICDbl(arrColVal(7), "0"),"0","D")      & ","
	lgStrSQL = lgStrSQL & FilterVar(UNICDbl(arrColVal(8), "0"),"0","D")      & ","
	lgStrSQL = lgStrSQL & FilterVar(UNICDbl(arrColVal(9), "0"),"0","D")      & ","
	lgStrSQL = lgStrSQL & FilterVar(UNICDbl(arrColVal(10), "0"),"0","D")      & ","
...
Sub SubBizSaveMultiUpdate(arrColVal)
    ...
    lgStrSQL = "UPDATE  TB_KJ8 WITH (ROWLOCK) "
    
    lgStrSQL = lgStrSQL & " SET " 

    lgStrSQL = lgStrSQL & " W2     = " &  FilterVar(UNICDbl(arrColVal(2), "0"),"0","D")      & ","
    lgStrSQL = lgStrSQL & " W3     = " &  FilterVar(UNICDbl(arrColVal(3), "0"),"0","D")      & ","
    lgStrSQL = lgStrSQL & " W4     = " &  FilterVar(UNICDbl(arrColVal(4), "0"),"0","D")      & ","
    lgStrSQL = lgStrSQL & " W5     = " &  FilterVar(UNICDbl(arrColVal(5), "0"),"0","D")      & ","
    lgStrSQL = lgStrSQL & " W6     = " &  FilterVar(UNICDbl(arrColVal(6), "0"),"0","D")      & ","
    lgStrSQL = lgStrSQL & " W7     = " &  FilterVar(UNICDbl(arrColVal(7), "0"),"0","D")      & ","
    lgStrSQL = lgStrSQL & " W8     = " &  FilterVar(UNICDbl(arrColVal(8), "0"),"0","D")      & ","
    lgStrSQL = lgStrSQL & " W9     = " &  FilterVar(UNICDbl(arrColVal(9), "0"),"0","D")     & ","
    lgStrSQL = lgStrSQL & " W10     = " & FilterVar(UNICDbl(arrColVal(10), "0"),"0","D")      & ","
