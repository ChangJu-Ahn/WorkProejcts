...
'*  2. Function명        : 급여관리 
'*  3. Program ID        : h6018oa1.asp
'*  4. Program 이름      : 급/상여집계표출력 
'*  5. Program 설명      : 급/상여집계표출력 
'*  6. Comproxy 리스트   : 
...
Function FncEBRView(Byval EBRType)
	dim strUrl
...
'	strUrl = strUrl & "|Emp_type|" & Emp_type 
    ...
    If frm1.rbo_type(0).checked Then
	    StrEbrFile = "h6018oa1_1"
    ElseIf frm1.rbo_type(1).checked THEN
	    StrEbrFile = "h6018oa1_2"
    Else
	    StrEbrFile = "h6018oa1"
    End If
...
Function OpenCondAreaPopup(Byval iWhere)
	...
	Select Case iWhere
        ...
        Case "2"
	        ...
	        arrParam(4) = " MAJOR_CD = " & FilterVar("H0040", "''", "S") & " AND (MINOR_TYPE = " & FilterVar("U", "''", "S") & "  OR MINOR_CD = " & FilterVar("1", "''", "S") & " ) "    ' Where Condition							' Where Condition
...
Function txtTo_dept_cd_Onchange()
    ...
    Else
        IntRetCd = FuncDeptName(frm1.txtTo_dept_cd.value , UNIConvDate(strBasDt), lgUsrIntCd,Dept_Nm , Internal_cd)
	    If  IntRetCd < 0 then
	        If  IntRetCd = -1 then
    			Call DisplayMsgbox("800098","X","X","X")	'부서정보코드에 등록되지 않은 코드입니다.
            Else
					...
					<TD CLASS="CLSMTABP">
						<TABLE ID="MyTab" CELLSPACING=0 CELLPADDING=0>
							<TR>
								...
								<td background="../../../CShared/image/table/seltab_up_bg.gif" align="center" CLASS="CLSMTAB"><font color=white>급/상여집계표출력</font></td>
...
<!--							<TR>
								<TD CLASS="TD5" NOWRAP>사원구분</TD>
								<TD CLASS="TD6" NOWRAP><SELECT NAME="cboEmp_type" ALT="사원구분" CLASS=cboNormal TAG="1XN"><OPTION Value=""></OPTION></SELECT></TD>
							</TR> -->
							<TR>			
							...
							<TR>			
								...
								<TD CLASS=TD6 NOWRAP><INPUT NAME="txtFr_dept_cd" ALT="시작부서코드" TYPE="Text" SiZE=10 MAXLENGTH=10 tag="11XXXU"><IMG SRC="../../../CShared/image/btnPopup.gif" NAME="btnSItemDC" ALIGN=top TYPE="BUTTON" ONCLICK="vbscript:Call OpenDept(0)">
			                                         <INPUT NAME="txtFr_dept_nm" ALT="시작부서코드명" TYPE="Text" SiZE=20 MAXLENGTH=40 tag="14XXXU">&nbsp;~
		                                             <INPUT NAME="txtFr_Internal_cd" ALT="내부부서코드" TYPE="HIDDEN" SiZE=7 MAXLENGTH=7 tag="14XXXU">
		                    </TR>
		                    <TR>    
		                        <TD CLASS=TD5 NOWRAP></TD>
								<TD CLASS=TD6 NOWRAP><INPUT NAME="txtto_dept_cd" ALT="종료부서코드" MAXLENGTH="10" SIZE=10 ALT ="Order ID" tag="11XXXU"><IMG SRC="../../../CShared/image/btnPopup.gif" NAME="btnname" ALIGN=top TYPE="BUTTON" ONCLICK="vbscript:Call OpenDept(1)">
							                         <INPUT NAME="txtto_dept_nm" ALT="종료부서코드명" MAXLENGTH="40" SIZE=20 ALT ="Order ID" tag="14XXXU">
    			                                     <INPUT NAME="txtTo_Internal_cd" ALT="내부부서코드" TYPE="HIDDEN" SiZE=7 MAXLENGTH=7 tag="14XXXU"></TD>
    			            </TR> 
				            <TR>
					  			<TD CLASS=TD5 NOWRAP>집계구분</TD>
			        	    	<TD CLASS=TD6 NOWRAP><INPUT TYPE="RADIO" NAME="rbo_type" ID="rbo_type" VALUE="1" CLASS="RADIO" TAG="11" ><LABEL FOR="rbo_type1">사업장별</LABEL>&nbsp;
			        	                             <INPUT TYPE="RADIO" NAME="rbo_type" ID="rbo_type" VALUE="2" CLASS="RADIO" TAG="11" CHECKED><LABEL FOR="rbo_type2">부서별</LABEL></TD>
    			            </TR> 
    					</TABLE>
					</TD>
				</TR>
