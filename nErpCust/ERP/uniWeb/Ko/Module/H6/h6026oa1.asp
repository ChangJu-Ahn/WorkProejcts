...
'*  1. Module Name          : HR
'*  2. Function Name        : 
'*  3. Program ID           : H6026OA1
'*  4. Program Name         : 월별항목별급여지급현황 
					...
					<TD CLASS="CLSMTABP">
						<TABLE ID="MyTab" CELLSPACING=0 CELLPADDING=0>
							<TR>
								...
								<td background="../../../CShared/image/table/seltab_up_bg.gif" align="center" CLASS="CLSMTAB"><font color=white>월별항목별급여지급현황</font></td>
					...
					<TD HEIGHT=20>
						<TABLE <%=LR_SPACE_TYPE_60%>>
							...
							<TR>
								...
								<TD CLASS="TD6" NOWRAP>
								<script language =javascript src='./js/h6026oa1_txtFrYyyymm_txtFrYyyymm.js'></script> ~
							    <script language =javascript src='./js/h6026oa1_txtToYyyymm_txtToYyyymm.js'></script>								
								</TD>															
							</TR>
							<TR>
								<TD CLASS=TD5>&nbsp;</TD>
