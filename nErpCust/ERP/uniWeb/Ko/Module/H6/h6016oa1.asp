...
'*  3. Program ID           : h6016oa1
'*  4. Program Name         : 급/상여명세서출력 
'*  5. Program Desc         : 급/상여명세서출력 
'*  6. Comproxy List        : +
...
Function FncBtnPrint() 
	...
	dim yyyymm, prov_cd, pay_cd, fr_dept_cd, to_dept_cd, emp_no
	...
	if prov_cd = "1" then
		StrEbrFile = "h6016oa1"
	elseif prov_cd = "Z" or prov_cd = "z" then
		StrEbrFile = "h6016oa1_2"
	else
		StrEbrFile = "h6016oa1_1"
	end if
...
Function BtnPreview() 
    ...
    yyyymm = frm1.txtYyyymm.year & Right("0" & frm1.txtYyyymm.month , 2)
	prov_cd = Trim(frm1.txtProvCd.value)
					...
					<TD CLASS="CLSMTABP">
						<TABLE ID="MyTab" CELLSPACING=0 CELLPADDING=0>
							<TR>
								...
								<td background="../../../CShared/image/table/seltab_up_bg.gif" align="center" CLASS="CLSMTAB"><font color=white>급/상여명세서출력</font></td>
					...
					<TD HEIGHT=20>
						<TABLE <%=LR_SPACE_TYPE_60%>>   
							<TR>
								...
								<TD CLASS="TD6" NOWRAP>
								<script language =javascript src='./js/h6016oa1_txtYyyymm_txtYyyymm.js'></script>
								</TD>															
							</TR>
							<TR>
						  		<TD CLASS=TD5 NOWRAP>지급구분</TD>
								<TD CLASS=TD6 NOWRAP><INPUT NAME="txtProvCd" MAXLENGTH="1" SIZE="10" ALT ="지급구분" tag="12XXXU"><IMG SRC="../../../CShared/image/btnPopup.gif" NAME="btnProvCd" ALIGN=top TYPE="BUTTON" ONCLICK="vbscript:OpenCode frm1.txtProvCd.value,'PROV_CD_POP'">
