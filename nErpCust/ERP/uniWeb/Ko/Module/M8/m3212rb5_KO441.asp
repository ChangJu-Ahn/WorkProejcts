...
Sub FixUNISQLData()
	...
	End If
     ...
     If Request("gPurGrp") <> "" Then
        strVal = strVal & " AND e.PUR_GRP=" & FilterVar(Request("gPurGrp"),"''","S")
     End If
     If Request("gPurOrg") <> "" Then
        strVal = strVal & " AND e.PUR_ORG=" & FilterVar(Request("gPurOrg"),"''","S")
     End If
     If Request("gBizArea") <> "" Then
        strVal = strVal & " AND e.BIZ_AREA=" & FilterVar(Request("gBizArea"),"''","S")
     End If   
