...
Sub FixUNISQLData()
    ...
    Redim UNIValue(7,18)                                                  '⊙: DB-Agent로 전송될 parameter를 위한 변수 
                                                                          '    parameter의 수에 따라 변경함 
     UNISqlId(0) = "M5111QA1_KO441"
     ...
     If Request("gBizArea") <> "" Then
        strVal = strVal & " AND a.IV_BIZ_AREA=" & FilterVar(Request("gBizArea"),"''","S")
     End If   
...
<Script Language=vbscript>
    ...
    With Parent
         ...
         Call Parent.ReFormatSpreadCellByCellByCurrency(Parent.Frm1.vspdData,"<%=iPrevEndRow+1%>",<%=iEndRow%>,Parent.GetKeyPos("A",17), Parent.GetKeyPos("A",17),"A", "Q" ,"X","X")	'매입금액 
         Call Parent.ReFormatSpreadCellByCellByCurrency(Parent.Frm1.vspdData,"<%=iPrevEndRow+1%>",<%=iEndRow%>,Parent.GetKeyPos("A",18), Parent.GetKeyPos("A",18),"A", "Q" ,"X","X")	'VAT금액 
         Call Parent.ReFormatSpreadCellByCellByCurrency(Parent.Frm1.vspdData,"<%=iPrevEndRow+1%>",<%=iEndRow%>,Parent.GetKeyPos("A",19), Parent.GetKeyPos("A",19),"A", "Q" ,"X","X")	'매입합계금액 
         Call Parent.ReFormatSpreadCellByCellByCurrency2(Parent.Frm1.vspdData,"<%=iPrevEndRow+1%>",<%=iEndRow%>, parent.parent.gCurrency, Parent.GetKeyPos("A",20),"A", "Q" ,"X","X")					'매입자국금액 
         Call Parent.ReFormatSpreadCellByCellByCurrency2(Parent.Frm1.vspdData,"<%=iPrevEndRow+1%>",<%=iEndRow%>, parent.parent.gCurrency, Parent.GetKeyPos("A",21),"A", "Q" ,"X","X")					'VAT자국금액 
         Call Parent.ReFormatSpreadCellByCellByCurrency2(Parent.Frm1.vspdData,"<%=iPrevEndRow+1%>",<%=iEndRow%>, parent.parent.gCurrency, Parent.GetKeyPos("A",22),"A", "Q" ,"X","X")					'매입합계자국금액 
