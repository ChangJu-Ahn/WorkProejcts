							...
							<TR>
								...
								<TD CLASS="TD6" nowrap>
								    <Table Cellspacing=0 Cellpadding=0>
								        <TR>
										    <TD NOWRAP>
								            <SCRIPT LANGUAGE=JavaScript> ExternalWrite('<OBJECT ALT=지불예정일 NAME="txtPayDt" CLASSID=<%=gCLSIDFPDT%> id=fpDateTime1 CLASS=FPDTYYYYMMDD tag="22N1" Title="FPDATETIME"></OBJECT>');</SCRIPT></TD>
								            <TD NOWRAP>&nbsp;매입일</TD>
								            <TD NOWRAP>
