...
Const BIZ_PGM_ID = "M5121bb1_KO441.asp"
...
Sub SetDefaultVal()
	...
	If lgPGCd <> "" then 
		...
		Call ggoOper.SetReqAttr(frm1.txtConPurGrp, "Q") 
		frm1.txtConPurGrp.Tag = left(frm1.txtConPurGrp.Tag,1) & "4" & mid(frm1.txtConPurGrp.Tag,3,len(frm1.txtConPurGrp.Tag))
        frm1.txtConPurGrp.value = lgPGCd
	End If
End Sub
