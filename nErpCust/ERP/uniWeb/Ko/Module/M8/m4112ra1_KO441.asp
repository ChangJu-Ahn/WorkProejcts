...
Const BIZ_PGM_ID 		= "m4112rb1_KO441.asp"                              '☆: Biz Logic ASP Name
...
Sub InitSpreadSheet()
	Call SetZAdoSpreadSheet("M4112RA1","S","A","V20030921",PopupParent.C_SORT_DBAGENT,frm1.vspdData, _
								C_MaxKey, "X","X")
	Call SetSpreadLock 
					...
					<TR>
						...
						<TD CLASS="TD6" NOWRAP>
							<table cellspacing=0 cellpadding=0>
								<tr>
									<td>
										<script language=JavaScript>ExternalWrite('<OBJECT ALT=입고일 NAME="txtFrMvmtDt" classid=<%=gCLSIDFPDT%> CLASS=FPDTYYYYMMDD Title="FPDATETIME" tag="11"></OBJECT>');</Script>
									</td>
									<td>~</td>
									<td>
										<script language=JavaScript>ExternalWrite('<OBJECT ALT=입고일 NAME="txtToMvmtDt" classid=<%=gCLSIDFPDT%> CLASS=FPDTYYYYMMDD Title="FPDATETIME" tag="11"></OBJECT>');</Script>
									</td>
								<tr>
							</table>
						</TD>
