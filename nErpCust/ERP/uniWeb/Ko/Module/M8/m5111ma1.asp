...
Const BIZ_PGM_JUMP_ID 	= "m5112ma1"
...
Function ChangeTag(Byval Changeflg)
	...
	if Changeflg = true then
		...
		Call ggoOper.SetReqAttr(frm1.txtPayDt,"D")               '지불예정일 
...
Function OpenPoRef()
	...
	iCalledAspName = AskPRAspName("m3111ra4")
	
	If Trim(iCalledAspName) = "" Then
		IntRetCD = DisplayMsgBox("900040", parent.VB_INFORMATION, "m3111ra4", "X")
		lgIsOpenPop = False
		Exit Function
	End If
							...
							<TR>
								...
								<TD CLASS="TD6" nowrap>
								    <Table Cellspacing=0 Cellpadding=0>
								        <TR>
										    <TD NOWRAP>
								            <SCRIPT LANGUAGE=JavaScript> ExternalWrite('<OBJECT ALT=지불예정일 NAME="txtPayDt" CLASSID=<%=gCLSIDFPDT%> id=fpDateTime1 CLASS=FPDTYYYYMMDD tag="21X1" Title="FPDATETIME"></OBJECT>');</SCRIPT></TD>
								            <TD NOWRAP>&nbsp;매입일</TD>
								            <TD NOWRAP>
