...
'	if UCase(Trim(frm1.hdnRetFlg.Value)) <> "Y" or Trim(UCase(frm1.hdnExceptflg.Value)) = "Y" then
	...
	strRet = window.showModalDialog("../m8/m3112ra6.asp?txtCurrency=" + frm1.txtCur.value, Array(window.parent, arrParam), _
			"dialogWidth=760px; dialogHeight=420px; center: Yes; help: No; resizable: No; status: No;")
...
Function OpenGrRef()
	...
	iCalledAspName = AskPRAspName("m4111ra1")
	
	If Trim(iCalledAspName) = "" Then
		IntRetCD = DisplayMsgBox("900040", parent.VB_INFORMATION, "m4111ra1", "X")
		lgIsOpenPop = False
		Exit Function
	End If
...
'	arrParam(5) = ""
	...
	iCalledAspName = AskPRAspName("m4112ra1")
	
	If Trim(iCalledAspName) = "" Then
		IntRetCD = DisplayMsgBox("900040", parent.VB_INFORMATION, "m4112ra1", "X")
		lgIsOpenPop = False
		Exit Function
	End If
...
Function OpenLLCRef()
	...
	iCalledAspName = AskPRAspName("M3212RA5")
	
	If Trim(iCalledAspName) = "" Then
		IntRetCD = DisplayMsgBox("900040", parent.VB_INFORMATION, "M3212RA5", "X")
		lblnWinEvent = False
		Exit Function
	End If
