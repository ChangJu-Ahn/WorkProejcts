	...
	End If
		...
		If Not(rs1.EOF And rs1.BOF) Then
			...
			For i=0 to rs1.RecordCount-1
                ...
                strData = strData & Chr(11) & Replace(Replace(ConvSPChars(rs1("remark"             )), Chr(10),""), Chr(13),"")
                strData = strData & Chr(11) & Replace(Replace(ConvSPChars(rs1("remark2"            )), Chr(10),""), Chr(13),"")
                strData = strData & Chr(11) & Replace(Replace(ConvSPChars(rs1("remark3"            )), Chr(10),""), Chr(13),"")
