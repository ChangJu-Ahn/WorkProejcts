...
'**********************************************************************************************************
'⊙: 비지니스 로직 ASP명 
Const BIZ_PGM_ID = "D1511MB1.asp"'☆: 비지니스 로직 ASP명 
...
Sub initSpreadPosVariables()  
	...
	C_CARD_NO            = 13
	C_CARD_PB            = 14
	C_REPORT_BIZ_AREA_CD = 15
	C_REPORT_BIZ_AREA_PB = 16  
	C_BIZ_AREA_CD        = 17
	C_BIZ_AREA_PB        = 18
	C_GL_NO              = 19
	C_TEMP_GL_NO         = 20
	C_issue_dt_kind_cd	 = 21
	C_issue_dt_kind_nm	 = 22
	C_issue_dt_fg_cd	 = 23
	C_issue_dt_fg_nm	 = 24
...
Sub InitSpreadSheet()
	...
	With frm1.vspdData
		...
		ggoSpread.SSSetEdit      C_TEMP_GL_NO,         "참조번호", 		13, 5

		ggoSpread.SSSetCombo     C_issue_dt_kind_cd,  "전자세금계산서종류",	15
		ggoSpread.SSSetCombo     C_issue_dt_kind_nm,  "전자세금계산서종류",	15
		ggoSpread.SSSetCombo     C_issue_dt_fg_cd,  "전자세금계산서발행여부",	18
		ggoSpread.SSSetCombo     C_issue_dt_fg_nm,  "전자세금계산서발행여부",	18
...
Sub SetSpreadLock()
    ...
    With frm1.vspdData
        ...
        ggoSpread.SpreadLock C_ISSUED_DT,  -1, C_ISSUED_DT       ',-1
        ggoSpread.SpreadLock C_BP_CD,  -1, C_BP_CD       ',-1
        ggoSpread.SpreadLock C_BP_PB,  -1, C_BP_PB       ',-1
        ggoSpread.SpreadLock C_VAT_TYPE_NM,  -1, C_VAT_TYPE_NM       ',-1
        ggoSpread.SpreadLock C_VAT_TYPE_PB,  -1, C_VAT_TYPE_PB       ',-1
        ggoSpread.SpreadLock C_NET_LOC_AMT,  -1, C_NET_LOC_AMT       ',-1
        ggoSpread.SpreadLock C_VAT_LOC_AMT,  -1, C_VAT_LOC_AMT       ',-1
        ggoSpread.SpreadLock C_CARD_NO,  -1, C_CARD_NO       ',-1
        ggoSpread.SpreadLock C_CARD_PB,  -1, C_CARD_PB       ',-1
        ggoSpread.SpreadLock C_REPORT_BIZ_AREA_CD,  -1, C_REPORT_BIZ_AREA_CD       ',-1
        ggoSpread.SpreadLock C_REPORT_BIZ_AREA_PB,  -1, C_REPORT_BIZ_AREA_PB       ',-1
        ggoSpread.SpreadLock C_BIZ_AREA_CD,  -1, C_BIZ_AREA_CD       ',-1
        ggoSpread.SpreadLock C_BIZ_AREA_PB,  -1, C_BIZ_AREA_PB       ',-1
...
Sub InitComboBox()
   ...
   ggoSpread.SetCombo Replace(iCodeArr, Chr(11), vbTab), C_issue_dt_kind_cd			'COLM_DATA_TYPE
   ggoSpread.SetCombo Replace(iNameArr, Chr(11), vbTab), C_issue_dt_kind_nm
...
Function OpenBp(Byval strCode, byval iWhere)
    ...
    arrRet = window.showModalDialog("../../Module/ar/BpPopup.asp", _
...
Sub GetSpreadColumnPos(ByVal pvSpdNo)
    ...
    Select Case UCase(pvSpdNo)
       Case "A"
            ...
            C_MADE_VAT_FG           = iCurColumnPos(7)
            C_VAT_TYPE              = iCurColumnPos(8)
            C_VAT_TYPE_NM           = iCurColumnPos(9)
            C_VAT_TYPE_PB           = iCurColumnPos(10)
            C_NET_LOC_AMT           = iCurColumnPos(11)
            C_VAT_LOC_AMT           = iCurColumnPos(12)
            C_CARD_NO               = iCurColumnPos(13)
            C_CARD_PB               = iCurColumnPos(14)
            C_REPORT_BIZ_AREA_CD    = iCurColumnPos(15)
            C_REPORT_BIZ_AREA_PB    = iCurColumnPos(16)
            C_BIZ_AREA_CD           = iCurColumnPos(17)
            C_BIZ_AREA_PB           = iCurColumnPos(18)
            C_GL_NO                 = iCurColumnPos(19)
            C_TEMP_GL_NO            = iCurColumnPos(20)
    End Select    
End Sub
        ...
        For lRow = 1 To .vspdData.MaxRows
            ...
            Select Case .vspdData.Text
                Case ggoSpread.UpdateFlag                                                '☜: 수정 
                    ...
                    .vspdData.Col = C_VAT_NO 				: strVal = strVal & Trim(.vspdData.Text) & iColSep
                    .vspdData.Col = C_ISSUED_DT 			: strVal = strVal & Trim(.vspdData.Text) & iColSep
                    .vspdData.Col = C_BP_CD					: strVal = strVal & Trim(UCase(.vspdData.Text)) & iColSep
                    .vspdData.Col = C_VAT_TYPE				: strVal = strVal & Trim(.vspdData.Text) & iColSep
                    .vspdData.Col = C_CARD_NO				: strVal = strVal & Trim(UCase(.vspdData.Text)) & iColSep
                    .vspdData.Col = C_REPORT_BIZ_AREA_CD	: strVal = strVal & Trim(UCase(.vspdData.Text)) & iColSep
                    .vspdData.Col = C_BIZ_AREA_CD			: strVal = strVal & Trim(.vspdData.Text) & iColSep
                    .vspdData.Col = C_NET_LOC_AMT			: strVal = strVal & UNIConvNum(Trim(.vspdData.Text),0) & iColSep
                    .vspdData.Col = C_VAT_LOC_AMT			: strVal = strVal & UNIConvNum(Trim(.vspdData.Text),0) & iColSep
                    .vspdData.Col = C_issue_dt_kind_cd	: strVal = strVal & UNIConvNum(Trim(.vspdData.Text),0) & iColSep
                    .vspdData.Col = C_issue_dt_fg_cd	: strVal = strVal & UNIConvNum(Trim(.vspdData.Text),0) & parent.gRowSep                    
                    ...
                    <TD CLASS="CLSMTABP">
                        <TABLE ID="MyTab" CELLSPACING=0 CELLPADDING=0>
                            <TR>
                                ...
                                <td background="../../../CShared/image/table/seltab_up_bg.gif" align="center" CLASS="CLSMTAB"><font color=white>발행계산서종류수정</font></td>
