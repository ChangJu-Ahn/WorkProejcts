...
'========================================================================================================
Const BIZ_PGM_ID = "s2217mb1_ko441.asp"                                      'Biz Logic ASP 
'========================================================================================================
...
'20071221::hanc
'20071224::hancDim C_PART
'20071224::hancDim C_SHIP_TO_PARTY
'20071224::hancDim C_BP_NM
'20071224::hancDim C_ITEM_CD
'20071224::hancDim C_ITEM_NM
'20071224::hancDim C_TOD_GI_QTY      '출고량(today)  
'20071224::hancDim C_TOT_GI_QTY      '출고량(summary)
'20071224::hancDim C_ACTUAL_GI_DT    '출하일         
'20071224::hancDim C_TOD_GI_AMT_LOC  '금액(today)    
'20071224::hancDim C_TOT_GI_AMT_LOC  '금액(summary)  
...
'20071221::hanc	C_good_on_hand_qty	=  8
    ...
    '20071221::hanc
'20071224::hanc    C_PART            =  1
'20071224::hanc    C_SHIP_TO_PARTY   =  2
'20071224::hanc    C_BP_NM           =  3
'20071224::hanc    C_ITEM_CD         =  4
'20071224::hanc    C_ITEM_NM         =  5
'20071224::hanc    C_TOD_GI_QTY      =  6  '출고량(today)  
'20071224::hanc    C_TOT_GI_QTY      =  7  '출고량(summary)
'20071224::hanc    C_ACTUAL_GI_DT    =  8  '출하일         
'20071224::hanc    C_TOD_GI_AMT_LOC  =  9  '금액(today)    
'20071224::hanc    C_TOT_GI_AMT_LOC  = 10  '금액(summary)  
...
Sub InitSpreadSheet()
	...
	With frm1.vspdData
       ...
       .ReDraw = false
       .MaxCols   = C_W5_NM + 1                                                  ' ☜:☜: Add 1 to Maxcols
       Call ggoSpread.ClearSpreadData()
       Call AppendNumberPlace("6","4","2")
       Call GetSpreadColumnPos("A")
				
        '20071224::hanc
       ggoSpread.SSSetEdit    C_PART              ,"구분"       ,10     ,0                  ,     ,100     ,2
       ggoSpread.SSSetEdit    C_PART_NM           ,"구분"    ,10     ,0                  ,     ,100     ,2
       ggoSpread.SSSetEdit    C_PART_NM_SUB       ,"구분" ,10     ,0                  ,     ,100     ,2
       ggoSpread.SSSetFloat   C_TOD               ,"금일"      ,15    , 3                  , ggStrIntegeralPart ,ggStrDeciPointPart,Parent.gComNum1000,Parent.gComNumDec ,       ,      ,"Z" 
       ggoSpread.SSSetFloat   C_W1                ,"W1"         ,15    , 3                  , ggStrIntegeralPart ,ggStrDeciPointPart,Parent.gComNum1000,Parent.gComNumDec ,       ,      ,"Z" 
       ggoSpread.SSSetFloat   C_W2                ,"W2"         ,15    , 3                  , ggStrIntegeralPart ,ggStrDeciPointPart,Parent.gComNum1000,Parent.gComNumDec ,       ,      ,"Z" 
       ggoSpread.SSSetFloat   C_W3                ,"W3"         ,15    , 3                  , ggStrIntegeralPart ,ggStrDeciPointPart,Parent.gComNum1000,Parent.gComNumDec ,       ,      ,"Z" 
       ggoSpread.SSSetFloat   C_W4                ,"W4"         ,15    , 3                  , ggStrIntegeralPart ,ggStrDeciPointPart,Parent.gComNum1000,Parent.gComNumDec ,       ,      ,"Z" 
       ggoSpread.SSSetFloat   C_W5                ,"W5"         ,15    , 3                  , ggStrIntegeralPart ,ggStrDeciPointPart,Parent.gComNum1000,Parent.gComNumDec ,       ,      ,"Z" 
       ggoSpread.SSSetEdit    C_W1_NM             ,"W1_NM"      ,10     ,0                  ,     ,100     ,2
       ggoSpread.SSSetEdit    C_W2_NM             ,"W2_NM"      ,10     ,0                  ,     ,100     ,2
       ggoSpread.SSSetEdit    C_W3_NM             ,"W3_NM"      ,10     ,0                  ,     ,100     ,2
       ggoSpread.SSSetEdit    C_W4_NM             ,"W4_NM"      ,10     ,0                  ,     ,100     ,2
       ggoSpread.SSSetEdit    C_W5_NM             ,"W5_NM"      ,10     ,0                  ,     ,100     ,2

       '20071221::hanc
'20071224::hanc       ggoSpread.SSSetEdit    C_PART              ,"PART"       ,10     ,0                  ,     ,100     ,2
'20071224::hanc       ggoSpread.SSSetEdit    C_SHIP_TO_PARTY     ,"고객코드"   ,10     ,0                  ,     ,100     ,2
'20071224::hanc       ggoSpread.SSSetEdit    C_BP_NM             ,"고객"       ,15     ,0                  ,     ,100     ,2
'20071224::hanc       ggoSpread.SSSetEdit    C_ITEM_CD           ,"품목"       ,13     ,0                  ,     ,100     ,2
'20071224::hanc       ggoSpread.SSSetEdit    C_ITEM_NM           ,"품목명"     ,20     ,0                  ,     ,100     ,2
'20071224::hanc       ggoSpread.SSSetFloat   C_TOD_GI_QTY        ,"TODAY수량"  ,15    , 3                  , ggStrIntegeralPart ,ggStrDeciPointPart,Parent.gComNum1000,Parent.gComNumDec ,       ,      ,"Z" 
'20071224::hanc       ggoSpread.SSSetFloat   C_TOT_GI_QTY        ,"수량"       ,15    , 3                  , ggStrIntegeralPart ,ggStrDeciPointPart,Parent.gComNum1000,Parent.gComNumDec ,       ,      ,"Z" 
'20071224::hanc       ggoSpread.SSSetDate    C_ACTUAL_GI_DT      ,"출하일"     ,15    ,2                  ,parent.gDateFormat   ,-1
'20071224::hanc       ggoSpread.SSSetFloat   C_TOD_GI_AMT_LOC    ,"TODAY금액"  ,15    , 2                  , ggStrIntegeralPart ,ggStrDeciPointPart,Parent.gComNum1000,Parent.gComNumDec ,       ,      ,"Z" 
'20071224::hanc       ggoSpread.SSSetFloat   C_TOT_GI_AMT_LOC    ,"금액"       ,15    , 2                  , ggStrIntegeralPart ,ggStrDeciPointPart,Parent.gComNum1000,Parent.gComNumDec ,       ,      ,"Z" 
...
'       call ggoSpread.MakePairsColumn(C_EnrollDT,C_GraduatedDT,"1")
       ...
       Call ggoSpread.SSSetColHidden(C_W1_NM,C_W1_NM,True)                        '20071227::hanc
       Call ggoSpread.SSSetColHidden(C_W2_NM,C_W2_NM,True)                        '20071227::hanc
       Call ggoSpread.SSSetColHidden(C_W3_NM,C_W3_NM,True)                        '20071227::hanc
       Call ggoSpread.SSSetColHidden(C_W4_NM,C_W4_NM,True)                        '20071227::hanc
       Call ggoSpread.SSSetColHidden(C_W5_NM,C_W5_NM,True)                        '20071227::hanc
...
Sub GetSpreadColumnPos(ByVal pvSpdNo)
    ...
    Select Case UCase(pvSpdNo)
       Case "A"
            ...
            C_PART_NM         =  iCurColumnPos(2)    
            C_PART_NM_SUB     =  iCurColumnPos(3)    
            C_TOD             =  iCurColumnPos(4)    
            C_W1              =  iCurColumnPos(5)    
            C_W2              =  iCurColumnPos(6)    
            C_W3              =  iCurColumnPos(7)    
            C_W4              =  iCurColumnPos(8)    
            C_W5              =  iCurColumnPos(9)    
            C_W1_NM           =  iCurColumnPos(10)   
            C_W2_NM           =  iCurColumnPos(11)   
            C_W3_NM           =  iCurColumnPos(12)    
            C_W4_NM           =  iCurColumnPos(13)    
            C_W5_NM           =  iCurColumnPos(14)    

            '20071221::hanc
'20071227::hanc            C_PART            =  iCurColumnPos(1)
'20071227::hanc            C_SHIP_TO_PARTY   =  iCurColumnPos(2)
'20071227::hanc            C_BP_NM           =  iCurColumnPos(3)
'20071227::hanc            C_ITEM_CD         =  iCurColumnPos(4)
'20071227::hanc            C_ITEM_NM         =  iCurColumnPos(5)
'20071227::hanc            C_TOD_GI_QTY      =  iCurColumnPos(6)
'20071227::hanc            C_TOT_GI_QTY      =  iCurColumnPos(7)
'20071227::hanc            C_ACTUAL_GI_DT    =  iCurColumnPos(8)
'20071227::hanc            C_TOD_GI_AMT_LOC  =  iCurColumnPos(9)  
'20071227::hanc            C_TOT_GI_AMT_LOC  =  iCurColumnPos(10)
...
'========================================================================================================
' 20071227::hanc
Sub SetQuerySpreadRate
    Dim v1_tod, v1_w1, v1_w2, v1_w3, v1_w4, v1_w5
    Dim v2_tod, v2_w1, v2_w2, v2_w3, v2_w4, v2_w5
    Dim v4_tod, v4_w1, v4_w2, v4_w3, v4_w4, v4_w5
        '매출금액
		frm1.vspddata.Row  = 1
		frm1.vspddata.col  = C_TOD
		v1_tod = CDbl(Trim(frm1.vspddata.text))
		frm1.vspddata.col  = C_W1
		v1_w1 = CDbl(Trim(frm1.vspddata.text))
		frm1.vspddata.col  = C_W2
		v1_w2 = CDbl(Trim(frm1.vspddata.text))
		frm1.vspddata.col  = C_W3
		v1_w3 = CDbl(Trim(frm1.vspddata.text))
		frm1.vspddata.col  = C_W4
		v1_w4 = CDbl(Trim(frm1.vspddata.text))
		frm1.vspddata.col  = C_W5
		v1_w5 = CDbl(Trim(frm1.vspddata.text))

        '예상매출금액
		frm1.vspddata.Row  = 2
		frm1.vspddata.col  = C_TOD
		v2_tod = CDbl(Trim(frm1.vspddata.text))
		frm1.vspddata.col  = C_W1
		v2_w1 = CDbl(Trim(frm1.vspddata.text))
		frm1.vspddata.col  = C_W2
		v2_w2 = CDbl(Trim(frm1.vspddata.text))
		frm1.vspddata.col  = C_W3
		v2_w3 = CDbl(Trim(frm1.vspddata.text))
		frm1.vspddata.col  = C_W4
		v2_w4 = CDbl(Trim(frm1.vspddata.text))
		frm1.vspddata.col  = C_W5
		v2_w5 = CDbl(Trim(frm1.vspddata.text))
		...
		if v1_tod = 0 then
		    ...
		    frm1.vspddata.Text = CDbl((v2_tod/v1_tod)*100)
		end if
		frm1.vspddata.col  = C_W1
		if v1_w1 = 0 then
		    frm1.vspddata.Text = 0
		else
		    frm1.vspddata.Text = CDbl((v2_w1/v1_w1)*100)
		end if
		...
		if v1_w2 = 0 then
		    ...
		    frm1.vspddata.Text = CDbl((v2_w2/v1_w2)*100)
		end if
		...
		if v1_w3 = 0 then
		    ...
		    frm1.vspddata.Text = CDbl((v2_w3/v1_w3)*100)
		end if
		...
		if v1_w4 = 0 then
		    ...
		    frm1.vspddata.Text = CDbl((v2_w4/v1_w4)*100)
		end if
		...
		if v1_w5 = 0 then
		    ...
		    frm1.vspddata.Text = CDbl((v2_w5/v1_w5)*100)
		end if
        
        '사업계획금액
		frm1.vspddata.Row  = 4
		frm1.vspddata.col  = C_TOD
		v4_tod = CDbl(Trim(frm1.vspddata.text))
		frm1.vspddata.col  = C_W1
		v4_w1 = CDbl(Trim(frm1.vspddata.text))
		frm1.vspddata.col  = C_W2
		v4_w2 = CDbl(Trim(frm1.vspddata.text))
		frm1.vspddata.col  = C_W3
		v4_w3 = CDbl(Trim(frm1.vspddata.text))
		frm1.vspddata.col  = C_W4
		v4_w4 = CDbl(Trim(frm1.vspddata.text))
		frm1.vspddata.col  = C_W5
		v4_w5 = CDbl(Trim(frm1.vspddata.text))
		...
		if v1_tod = 0 then
		    ...
		    frm1.vspddata.Text = CDbl((v4_tod/v1_tod)*100)
		end if
		frm1.vspddata.col  = C_W1
		if v1_w1 = 0 then
		    frm1.vspddata.Text = 0
		else
		    frm1.vspddata.Text = CDbl((v4_w1/v1_w1)*100)
		end if
		...
		if v1_w2 = 0 then
		    ...
		    frm1.vspddata.Text = CDbl((v4_w2/v1_w2)*100)
		end if
		...
		if v1_w3 = 0 then
		    ...
		    frm1.vspddata.Text = CDbl((v4_w3/v1_w3)*100)
		end if
		...
		if v1_w4 = 0 then
		    ...
		    frm1.vspddata.Text = CDbl((v4_w4/v1_w4)*100)
		end if
		...
		if v1_w5 = 0 then
		    ...
		    frm1.vspddata.Text = CDbl((v4_w5/v1_w5)*100)
		end if
...
Sub SetQuerySpreadColor()
	...
	Dim iLoopCnt
	Dim var1, var2, varW1, varW2, varW3, varW4, varW5
	...
	For iLoopCnt=1 to frm1.vspdData.MaxRows 
		...
		frm1.vspddata.col  = C_PART_NM_SUB
		var1 = Trim(frm1.vspddata.text)

		frm1.vspddata.col  = C_PART_NM
		var2 = Trim(frm1.vspddata.text)
        ...
        if iLoopCnt = 1 then
    		...
    		varW1 = Trim(frm1.vspddata.text)
			.Text = varW1

    		frm1.vspddata.col  = C_W2_NM
    		varW2 = Trim(frm1.vspddata.text)
			.Text = varW2

    		frm1.vspddata.col  = C_W3_NM
    		varW3 = Trim(frm1.vspddata.text)
			.Text = varW3

    		frm1.vspddata.col  = C_W4_NM
    		varW4 = Trim(frm1.vspddata.text)
			.Text = varW4

    		frm1.vspddata.col  = C_W5_NM
    		varW5 = Trim(frm1.vspddata.text)
			.Text = varW5
...
Sub DbQueryOk()
	...
	Call SetQuerySpreadRate     '20071227::hanc
...
Function OpenConPopup()
	...
	pvIntWhere= "G" 'frm1.cboConFlag.value 
					...
					<TD CLASS="CLSMTABP">
						<TABLE ID="MyTab" CELLSPACING=0 CELLPADDING=0>
							<TR>
								...
								<td background="../../../CShared/image/table/seltab_up_bg.gif" align="center" CLASS="CLSMTAB"><font color=white>판매계획대비실적조회</font></td>
