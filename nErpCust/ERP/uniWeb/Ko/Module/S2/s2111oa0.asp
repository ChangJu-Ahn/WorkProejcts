...
'*  1. Module Name          : Sales
'*  2. Function Name        : 
'*  3. Program ID           : S2111OA0
'*  4. Program Name         : 그룹별 판매계획대실적출력 
'*  5. Program Desc         : 그룹별 판매계획대실적출력 
'*  6. Comproxy List        : 
...
'    On Error Resume Next                                                    '☜: Protect system from crashing
	...
	' Print 함수에서 호출 
	'----------------------------------------------------------------
		ObjName = AskEBDocumentName("S2111OG3", "ebr")
	...
	' Print 함수에서 호출 
	'----------------------------------------------------------------
		ObjName = AskEBDocumentName("S2111OG4", "ebr")
		call FncEBRprint(EBAction, ObjName, strUrl)		
	'----------------------------------------------------------------
					...
					<TD>
						<TABLE ID="MyTab" CELLSPACING=0 CELLPADDING=0>
							<TR>
								...
								<td background="../../../CShared/image/table/seltab_up_bg.gif" align="center" CLASS="CLSLTAB"><font color=white>그룹별 판매계획대실적</font></td>
