...
Sub FixUNISQLData()
	...
	Case CStr(1)					'수주인경우 
		strVal = "SELECT SD.ITEM_CD ITEM_CD, SUM(SD.NET_AMT_LOC) NET_AMT_LOC"
		...
		strVal = strVal + " GROUP BY SD.ITEM_CD"

	Case CStr(2)					'매출인경우 
		strVal = "SELECT SD.ITEM_CD ITEM_CD, SUM(SD.BILL_AMT_LOC) NET_AMT_LOC"
