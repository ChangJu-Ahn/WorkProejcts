...
'*  1. Module Name          : Sales
'*  2. Function Name        : 
'*  3. Program ID           : S2111QA3
'*  4. Program Name         : 조직별 품목그룹판매계획실적조회 
'*  5. Program Desc         : 조직별 품목그룹판매계획실적조회 
'*  6. Comproxy List        : 
...
Const BIZ_PGM_ID        = "s2111qb31.asp"
Const BIZ_PGM_ID1       = "s2111qb32.asp"                         '☆: Biz logic spread sheet for #2
...
'========================================================================================================= 
Sub InitSpreadSheet()
	Call SetZAdoSpreadSheet("S2111QA31","S","A","V20021210", Parent.C_GROUP_DBAGENT, frm1.vspdData, C_MaxKey, "X", "X" )
	Call SetZAdoSpreadSheet("S2111QA32","S","B","V20021210", Parent.C_GROUP_DBAGENT, frm1.vspdData2, C_MaxKey, "X", "X" )
				...
				<TR>
					<TD WIDTH=45% HEIGHT=100% ROWSPAN="2" valign=top>
						<TABLE WIDTH=100% HEIGHT=100%>
							<TR>
								<TD HEIGHT="100%">
									<script language =javascript src='./js/s2111qa3_vspdData1_vspdData.js'></script>
								</TD>
							</TR>
						</TABLE>
					</TD>
							...
							<TR>
								...
								<TD CLASS=TD6 NOWRAP>
									<TABLE CELLSPACING=0 CELLPADDING=0 STYLE="PADDING-BOTTOM:2px;PADDING-TOP:2px">
										<TR>
											<TD>
												<script language =javascript src='./js/s2111qa3_fpDoubleSingle1_txtPlanAmt.js'></script>
											</TD>
											<TD>
							...
							<TR>
								...
								<TD CLASS=TD6 NOWRAP>
									<TABLE CELLSPACING=0 CELLPADDING=0 STYLE="PADDING-BOTTOM:2px">
										<TR>
											<TD>
												<script language =javascript src='./js/s2111qa3_fpDoubleSingle2_txtUseAmt.js'></script>
											</TD>
										</TR>
									</TABLE>
								</TD>
							...
							<TR>
								...
								<TD CLASS=TD6 NOWRAP>
									<TABLE CELLSPACING=0 CELLPADDING=0 STYLE="PADDING-BOTTOM:2px">
										<TR>
											<TD>
												<script language =javascript src='./js/s2111qa3_fpDoubleSingle3_txtRate.js'></script>
											</TD>
											<TD>
												&nbsp;
											</TD>
				...
				<TR>
					<TD WIDTH=55% HEIGHT=80% valign=top>
						<TABLE WIDTH="100%" HEIGHT="100%">
							<TR>
								<TD HEIGHT="100%">
									<script language =javascript src='./js/s2111qa3_vspdData2_vspdData2.js'></script>
								</TD>
							</TR>
						</TABLE>
					</TD>
