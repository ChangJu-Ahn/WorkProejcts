...
'======================================================================================================
'*  1. Module Name          : Sales
'*  2. Function Name        : 공장별 품목 판매계획확정 
'*  3. Program ID           : S2215BA1
'*  4. Program Name         : 
...
Const BIZ_PGM_ID = "S2215bb1.asp"
CONST BIZ_JUMP_ID_S2215MA1 = "S2215MA1"			' 공장별품목판매계획조정 
...
Function GetCfmPeriod(ByVal pvIntSpPeriodSeq)
	...
	iStrSelectList = " * "
	iStrFromList = "  dbo.ufn_s_GetCfmPeriod(" & FilterVar("S2215BA1", "''", "S") & ",  " & FilterVar(iStrCode, "''", "S") & ", " & FilterVar("1", "''", "S") & " , " & FilterVar("E", "''", "S") & " ,  " & FilterVar(C_StrGrpFlag, "''", "S") & ", " & pvIntSpPeriodSeq & ") "
	iStrWhereList = ""
...
Function GetCancelPeriod()
	...
	iStrSelectList = " * "
	iStrFromList = "  dbo.ufn_s_GetCancelPeriod(" & FilterVar("S2215BA1", "''", "S") & ",  " & FilterVar(iStrCode, "''", "S") & ", " & FilterVar("1", "''", "S") & " , " & FilterVar("E", "''", "S") & " ,  " & FilterVar(C_StrGrpFlag, "''", "S") & ") "
	iStrWhereList = ""
					...
					<TD CLASS="CLSMTABP">
						<TABLE ID="MyTab" CELLSPACING=0 CELLPADDING=0>
							<TR>
								...
								<td background="../../../CShared/image/table/seltab_up_bg.gif" align="center" CLASS="CLSMTAB"><font color=white>공장별품목판매계획확정</font></td>
		    ...
		    <TABLE <%=LR_SPACE_TYPE_30%>>
		        <TR>
					...
					<TD><BUTTON NAME="btnExe" CLASS="CLSMBTN" onclick="ExeReflect()" Flag=1>확정</BUTTON>
						...
						<% End If %></TD>
					<TD WIDTH=* ALIGN="right"><%If (lgLngUseStep And 512) > 0 Then %><a href = "VBSCRIPT:JumpChgCheck(BIZ_JUMP_ID_S2215MA1)">공장별품목판매계획조정</a> <% End If%>
						<% If (lgLngUseStep And 512) > 0 And (lgLngUseStep And 4096) > 0 Then %>
						&nbsp;|&nbsp;
						<a href = "vbscript:JumpChgCheck(BIZ_JUMP_ID_S2215BA2)">품목판매계획일별별배분</a>
						<% End If %></TD>
					<TD WIDTH=10>&nbsp;</TD>
		        </TR>
		    </TABLE>
