...
'*  1. Module Name          : Sales
'*  2. Function Name        : 
'*  3. Program ID           : S2112QA2
'*  4. Program Name         : 그룹별 품목판매계획실적조회 
'*  5. Program Desc         : 그룹별 품목판매계획실적조회 
'*  6. Comproxy List        : 
...
Const BIZ_PGM_ID        = "s2112qb21.asp"
Const BIZ_PGM_ID1       = "s2112qb22.asp"                         '☆: Biz logic spread sheet for #2
				...
				<TR>
					<TD WIDTH=45% HEIGHT=100% ROWSPAN="2" valign=top>
						<TABLE WIDTH=100% HEIGHT=100%>
							<TR>
								<TD HEIGHT="100%">
									<script language =javascript src='./js/s2112qa2_vspdData1_vspdData.js'></script>
								</TD>
							</TR>
						</TABLE>
					</TD>
							...
							<TR>
								...
								<TD CLASS=TD6 NOWRAP>
									<TABLE CELLSPACING=0 CELLPADDING=0 STYLE="PADDING-BOTTOM:2px;PADDING-TOP:2px">
										<TR>
											<TD>
												<script language =javascript src='./js/s2112qa2_fpDoubleSingle1_txtPlanAmt.js'></script>
											</TD>
											<TD>
							...
							<TR>
								...
								<TD CLASS=TD6 NOWRAP>
									<TABLE CELLSPACING=0 CELLPADDING=0 STYLE="PADDING-BOTTOM:2px">
										<TR>
											<TD>
												<script language =javascript src='./js/s2112qa2_fpDoubleSingle2_txtUseAmt.js'></script>
											</TD>
										</TR>
									</TABLE>
								</TD>
							...
							<TR>
								...
								<TD CLASS=TD6 NOWRAP>
									<TABLE CELLSPACING=0 CELLPADDING=0 STYLE="PADDING-BOTTOM:2px">
										<TR>
											<TD>
												<script language =javascript src='./js/s2112qa2_fpDoubleSingle3_txtRate.js'></script>
											</TD>
											<TD>
												&nbsp;
											</TD>
				...
				<TR>
					<TD WIDTH=55% HEIGHT=80% valign=top>
						<TABLE WIDTH="100%" HEIGHT="100%">
							<TR>
								<TD HEIGHT="100%">
									<script language =javascript src='./js/s2112qa2_vspdData2_vspdData2.js'></script>
								</TD>
							</TR>
						</TABLE>
					</TD>
