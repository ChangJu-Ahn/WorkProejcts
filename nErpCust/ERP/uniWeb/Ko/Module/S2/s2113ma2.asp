...
<%'==========================================  1.2.1 Global 상수 선언  ======================================
'==========================================================================================================%>
Const BIZ_PGM_ID = "s2113mb2.asp"        '☆: Head Query 비지니스 로직 ASP명 
     ...
     <TD CLASS="CLSMTABP">
      <TABLE ID="MyTab" CELLSPACING=0 CELLPADDING=0>
       <TR>
        ...
        <td background="../../../CShared/image/table/seltab_up_bg.gif" align="center" CLASS="CLSLTABP"><font color=white>고객판매계획</font></td>
      ...
      <TABLE <%=LR_SPACE_TYPE_60%>>
       ...
       <TR>
        <TD HEIGHT="100%" WIDTH="100%" COLSPAN=4>
         <script language =javascript src='./js/s2113ma2_I834774315_vspdData.js'></script>
        </TD>
       </TR>
      </TABLE>
     </TD>
