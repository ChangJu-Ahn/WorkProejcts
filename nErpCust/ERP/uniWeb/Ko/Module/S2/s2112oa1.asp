...
'*  1. Module Name          : Sales
'*  2. Function Name        : 
'*  3. Program ID           : S2112OA1
'*  4. Program Name         : 조직별 판매계획현황출력 
'*  5. Program Desc         : 조직별 판매계획현황출력 
'*  6. Comproxy List        : 
...
Function OpenConPop1()
	...
	arrParam(4) = "END_ORG_FLAG='Y' AND USAGE_FLAG='Y'" <%' Where Condition%>
...
Function BtnPrint() 
	...
	End If
	 ...
	 If Ucase(frm1.txtPLAN_SEQ.value) = "" Then
		var5 = "%"
	Else
...
'    On Error Resume Next                                                    '☜: Protect system from crashing
	...
	' Print 함수에서 호출 
	'----------------------------------------------------------------
		ObjName = AskEBDocumentName("S2112OG1", "ebr")
	...
	' Print 함수에서 호출 
	'----------------------------------------------------------------
		ObjName = AskEBDocumentName("S2112OG2", "ebr")
		call FncEBRprint(EBAction, ObjName, strUrl)		
	'----------------------------------------------------------------
	...
	' Print 함수에서 호출 
	'----------------------------------------------------------------
		ObjName = AskEBDocumentName("S2112OG3", "ebr")
		call FncEBRprint(EBAction, ObjName, strUrl)		
	'----------------------------------------------------------------
					...
					<TD>
						<TABLE ID="MyTab" CELLSPACING=0 CELLPADDING=0>
							<TR>
								...
								<td background="../../../CShared/image/table/seltab_up_bg.gif" align="center" CLASS="CLSLTAB"><font color=white>조직별 판매계획현황</font></td>
