...
'*  1. Module Name          : Sales
'*  2. Function Name        : 
'*  3. Program ID           : S2112QA3
'*  4. Program Name         : 그룹별 품목그룹판매계획실적조회 
'*  5. Program Desc         : 그룹별 품목그룹판매계획실적조회 
'*  6. Comproxy List        : 
...
Const BIZ_PGM_ID        = "s2112qb31.asp"
Const BIZ_PGM_ID1       = "s2112qb32.asp"                         '☆: Biz logic spread sheet for #2
...
Sub SetDefaultVal()
	...
	frm1.txtConSalesOrg.value = Parent.gSalesGrp
...
'========================================================================================================= 
Sub InitSpreadSheet()
	Call SetZAdoSpreadSheet("S2111QA31","S","A","V20021210", Parent.C_SORT_DBAGENT, frm1.vspdData, C_MaxKey, "X", "X" )
	Call SetZAdoSpreadSheet("S2111QA32","S","B","V20021210", Parent.C_SORT_DBAGENT, frm1.vspdData2, C_MaxKey, "X", "X" )
...
<TABLE <%=LR_SPACE_TYPE_00%>>
					...
					<TD CLASS="CLSLTAB">
						<TABLE ID="MyTab" CELLSPACING=0 CELLPADDING=0>
							<TR>
								...
								<td background="../../../CShared/image/table/seltab_up_bg.gif" align="center" CLASS="CLSLTAB"><font color=white>품목그룹판매계획대실적</font></td>
						...
						<FIELDSET CLASS="CLSFLD">
							<TABLE <%=LR_SPACE_TYPE_40%>>
								<TR>
									...
									<TD CLASS="TD6"><INPUT NAME="txtConSalesOrg" ALT="영업그룹" TYPE="Text" MAXLENGTH=4 SiZE=10 tag="12XXXU"><IMG SRC="../../../CShared/image/btnPopup.gif" NAME="btnItemSalePlan" align=top TYPE="BUTTON" ONCLICK="vbscript:OpenSaleOrg()">&nbsp;<INPUT NAME="txtConSalesOrgNm" TYPE="Text" MAXLENGTH="20" SIZE=25 tag="14"></TD>
				...
				<TR>
					<TD WIDTH=45% HEIGHT=100% ROWSPAN="2" valign=top>
						<TABLE WIDTH=100% HEIGHT=100%>
							<TR>
								<TD HEIGHT="100%">
									<script language =javascript src='./js/s2112qa3_vspdData1_vspdData.js'></script>
								</TD>
							</TR>
						</TABLE>
					</TD>
							...
							<TR>
								...
								<TD CLASS=TD6 NOWRAP>
									<TABLE CELLSPACING=0 CELLPADDING=0 STYLE="PADDING-BOTTOM:2px;PADDING-TOP:2px">
										<TR>
											<TD>
												<script language =javascript src='./js/s2112qa3_fpDoubleSingle1_txtPlanAmt.js'></script>
											</TD>
											<TD>
							...
							<TR>
								...
								<TD CLASS=TD6 NOWRAP>
									<TABLE CELLSPACING=0 CELLPADDING=0 STYLE="PADDING-BOTTOM:2px">
										<TR>
											<TD>
												<script language =javascript src='./js/s2112qa3_fpDoubleSingle2_txtUseAmt.js'></script>
											</TD>
										</TR>
									</TABLE>
								</TD>
							...
							<TR>
								...
								<TD CLASS=TD6 NOWRAP>
									<TABLE CELLSPACING=0 CELLPADDING=0 STYLE="PADDING-BOTTOM:2px">
										<TR>
											<TD>
												<script language =javascript src='./js/s2112qa3_fpDoubleSingle3_txtRate.js'></script>
											</TD>
											<TD>
												&nbsp;
											</TD>
				...
				<TR>
					<TD WIDTH=55% HEIGHT=80% valign=top>
						<TABLE WIDTH="100%" HEIGHT="100%">
							<TR>
								<TD HEIGHT="100%">
									<script language =javascript src='./js/s2112qa3_vspdData2_vspdData2.js'></script>
								</TD>
							</TR>
						</TABLE>
					</TD>
	...
	<INPUT TYPE=HIDDEN NAME="txtHConCurr" tag="24" TABINDEX="-1">
</FORM>
