...
Sub InitSpreadSheet()
	...
	Call SetZAdoSpreadSheet("S2111QA1","S","A","V20030828", Parent.C_SORT_DBAGENT, frm1.vspdData, C_MaxKey, "X", "X" )
	Call SetSpreadLock
End Sub
...
Function OpenSaleOrg()
	...
	arrParam(3) = Trim(frm1.txtConSalesOrgNm.Value)		<%' Name Cindition%>
					...
					<TD CLASS="CLSMTABP">
						<TABLE ID="MyTab" CELLSPACING=0 CELLPADDING=0>
							<TR>
								...
								<td background="../../../CShared/image/table/seltab_up_bg.gif" align="center" CLASS="CLSMTAB"><font color=white>품목판매계획현황조회</font></td>
				...
				<TR>
					<TD WIDTH=100% HEIGHT=100% valign=top>
							<TABLE <%=LR_SPACE_TYPE_20%>>
								<TR>
									<TD HEIGHT="100%">
										<script language =javascript src='./js/s2111qa1_vaSpread1_vspdData.js'></script>
									</TD>
								</TR>
						</TABLE>
					</TD>
