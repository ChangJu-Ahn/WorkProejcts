...
Const BIZ_PGM_ID = "s2113mb1.asp"        '☆: Head Query 비지니스 로직 ASP명 
...
Sub SetDefaultVal()
	...
	With frm1
		...
		'.txtConSalesOrg.value = Parent.gSalesGrp
		.txtConCurr.value = Parent.gCurrency
		'.txtSalesOrg.value = Parent.gSalesGrp
...
<%
'=============================================================================================================
' Function Desc : 확정품목별판매계획 JUMP Function
'=======================================================================================================
%>
...
Function DbQuery() 
  ...
  If   LayerShowHide(1) = False Then
    ...
    If lgIntFlgMode = Parent.OPMD_UMODE Then
		...
		strVal = strVal & "&txtMaxRows=" & CStr(frm1.vspdData.MaxRows)
    Else
		strVal = BIZ_PGM_ID & "?txtMode=" & Parent.UID_M0001         <%'☜: 비지니스 처리 ASP의 상태 %>
     ...
     <TD CLASS="CLSMTABP">
      <TABLE ID="MyTab" CELLSPACING=0 CELLPADDING=0>
       <TR>
        ...
        <td background="../../../CShared/image/table/seltab_up_bg.gif" align="center" CLASS="CLSMTAB"><font color=white>품목판매계획</font></td>
