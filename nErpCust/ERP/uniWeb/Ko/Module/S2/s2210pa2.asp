...
Const BIZ_PGM_ID 		= "S2210PB2.ASP"                              '☆: Biz Logic ASP Name
...
Dim	lgStrSalesGrp, lgStrFrSpPeriod, lgStrToSpPeriod
...
Sub SetDefaultVal()
	...
	lgStrSalesGrp = iArrParam(0)
	lgStrFrSpPeriod = iArrParam(1)
	lgStrToSpPeriod = iArrParam(2)
End Sub
...
Sub InitSpreadSheet()
	...
	Call SetZAdoSpreadSheet("S2210PA2","S","A","V20021202",PopupParent.C_SORT_DBAGENT,frm1.vspdData, _
								C_MaxKey, "X","X")		
	Call SetSpreadLock 	
...
Function DbQuery() 
    ...
    With frm1
		...
		iStrVal = iStrVal & "&txtSalesGrp=" & lgStrSalesGrp
	...
	<TR>
		<TD WIDTH=100% HEIGHT=* valign=top>
			<TABLE <%=LR_SPACE_TYPE_20%>>
				<TR>
					<TD HEIGHT="100%">
						<script language =javascript src='./js/s2210pa2_OBJECT1_vspdData.js'></script>
					</TD>
				</TR>
			</TABLE>
		</TD>
