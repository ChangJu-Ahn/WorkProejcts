...
'*  3. Program ID           : S2214QA1
'*  4. Program Name         : 판매계획대실적조회(영업조직)
'*  5. Program Desc         :
'*  6. Comproxy List        : 
...
Const BIZ_PGM_ID 		= "S2214QB1.asp"                              '☆: Biz Logic ASP Name
...
Sub InitSpreadSheet(ByVal pvPsdNo)
    ...
    if pvPsdNo = "A" then
		Call SetZAdoSpreadSheet("S2214QA101","S","A", "V20030326", parent.C_SORT_DBAGENT,frm1.vspdData,C_MaxKey, "X", "X")
		Call SetSpreadLock("A")
	else
		Call SetZAdoSpreadSheet("S2214QA102","S","B", "V20030326", parent.C_SORT_DBAGENT,frm1.vspdData2,C_MaxKey, "X", "X")
...
Function FncQuery() 
    ...
    If Trim(frm1.cboDisplayType.value) = "H" and frm1.txtConFromDt.year <> frm1.txtConToDt.year then
		...
		'msgbox "결과출력형식이 가로이면 계획년월의 시작년과 종료년이 같아야 합니다."
		Exit Function
	End If
     ...
     <TD width="240">
      <TABLE ID="MyTab" CELLSPACING=0 CELLPADDING=0>
       <TR>
        ...
        <td background="../../../CShared/image/table/seltab_up_bg.gif" align="center" CLASS="CLSLTABP"><font color=white>판매계획대실적조회(영업조직)</font></td>
       ...
       <TR>       
         ...
         <TD CLASS="TD6" NOWRAP>
          <TABLE CELLSPACING=0 CELLPADDING=0>
           <TR>
            <TD>
             <script language =javascript src='./js/s2214qa1_fpDateTime1_txtConFromDt.js'></script>
            </TD>
            <TD>
             &nbsp;~&nbsp;
            </TD>
            <TD>
             <script language =javascript src='./js/s2214qa1_fpDateTime2_txtConToDt.js'></script>
            </TD>
           </TR>
          </TABLE>
         </TD>
        ...
        <TR>
         ...
         <TD CLASS="TD6"><INPUT NAME="txtConCur" ALT="화폐" TYPE="Text" MAXLENGTH=3 SiZE=10 tag="1XXXXU"><IMG SRC="../../../CShared/image/btnPopup.gif" NAME="btnCur" align=top TYPE="BUTTON" ONCLICK="vbscript:OpenConPopup 3"></TD>
        </TR>
       </TABLE>
      </FIELDSET>
     </TD>
      ...
      <TABLE <%=LR_SPACE_TYPE_60%>>
       <TR>
        <TD HEIGHT="100%" WIDTH="100%" COLSPAN=4>
         <script language =javascript src='./js/s2214qa1_vspdData_vspdData.js'></script>
		 <script language =javascript src='./js/s2214qa1_vspdData2_vspdData2.js'></script>
        </TD>
       </TR>
      </TABLE>
     </TD>
