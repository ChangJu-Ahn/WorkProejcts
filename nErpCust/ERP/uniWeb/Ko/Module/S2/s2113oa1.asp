...
'*  1. Module Name          : Sales
'*  2. Function Name        : 
'*  3. Program ID           : S2113OA1
'*  4. Program Name         : 그룹별 판매계획현황출력 
'*  5. Program Desc         : 그룹별 판매계획현황출력 
'*  6. Comproxy List        : 
...
Function OpenConPop1()
	...
	arrParam(2) = Trim(frm1.txtSALES_GRP.value)		    <%' Code Condition%>
...
Function OpenConPop3()
	...
	arrParam(4) = "MAJOR_CD='s4089'"                    <%' Where Condition%>
...
Function OpenConPop4()
	...
	arrParam(4) = "MAJOR_CD='S4225'"                    <%' Where Condition%>
...
'    On Error Resume Next                                                    '☜: Protect system from crashing
	...
	' Print 함수에서 호출 
	'----------------------------------------------------------------
		ObjName = AskEBDocumentName("S2113OG1", "ebr")
	...
	' Print 함수에서 호출 
	'----------------------------------------------------------------
		ObjName = AskEBDocumentName("S2113OG2", "ebr")
		call FncEBRprint(EBAction, ObjName, strUrl)		
	'----------------------------------------------------------------
	...
	' Print 함수에서 호출 
	'----------------------------------------------------------------
		ObjName = AskEBDocumentName("S2113OG3", "ebr")
		call FncEBRprint(EBAction, ObjName, strUrl)			
	'----------------------------------------------------------------
					...
					<TD>
						<TABLE ID="MyTab" CELLSPACING=0 CELLPADDING=0>
							<TR>
								...
								<td background="../../../CShared/image/table/seltab_up_bg.gif" align="center" CLASS="CLSLTAB"><font color=white>그룹별 판매계획현황</font></td>
					...
					<TD WIDTH=100%>
						<TABLE <%=LR_SPACE_TYPE_60%>>
								...
								<TR>
									...
									<TD CLASS=TD6 NOWRAP><INPUT NAME="txtSALES_GRP" ALT="영업그룹" TYPE="Text" MAXLENGTH="4" SIZE=10 tag="12XXXU"><IMG SRC="../../../CShared/image/btnPopup.gif" NAME="btnSALES_GRP" align=top TYPE="BUTTON"ONCLICK="vbscript:OpenConPop1()">&nbsp;<INPUT NAME="txtSALES_GRP_NM" TYPE="Text" MAXLENGTH="50" SIZE=25 tag="14"></TD>
								</TR>
								<TR>
								...
								<TR>
									...
									<TD CLASS="TD6" NOWRAP><INPUT TYPE="RADIO" CLASS="Radio" NAME=RADIO1 ID=Rb_WK1 tag="12" Checked><LABEL FOR=Rb_WK1>품목그룹별</LABEL>&nbsp;
														   ...
														   <INPUT TYPE="RADIO" CLASS="Radio" NAME=RADIO1 ID=Rb_WK3 tag="12"><LABEL FOR=Rb_WK3>고객별</LABEL></TD>
								</TR>
