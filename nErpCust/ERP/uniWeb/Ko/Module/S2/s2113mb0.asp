...
Sub SubBizQueryMulti()
	...
	I3_s_item_group_sales_plan(S206_I3_sales_grp)   =  Trim(Request("txtConSalesOrg"))
	...
	I3_s_item_group_sales_plan(S206_I3_sales_org)   =  "S"
	...
	If cStr(Err.Description) = "B_MESSAGE" & Chr(11) & "202116" then
		...
		If CheckSYSTEMError(Err,True) = True Then
			...
			Response.Write "   .frm1.txtConSalesOrgNm.value = """ & ConvSPChars(E1_b_sales_grp(S206_E1_sales_grp_nm))            & """" & vbCr    
    ...
    Response.Write "   .frm1.txtSalesOrg.value   = """ & ConvSPChars(E1_b_sales_grp(S206_E1_sales_grp))               & """" & vbCr 
    Response.Write "   .frm1.txtSalesOrgNm.value = """ & ConvSPChars(E1_b_sales_grp(S206_E1_sales_grp_nm))            & """" & vbCr    
    '계획년도 
...
Sub SubBizSaveMulti()   
	...
	Dim E3_s_item_group_sales_plan
    
    Const S207_I2_sales_org = 0
    Const S207_I2_sp_year = 1
    Const S207_I2_sp_month = 2
    Const S207_I2_plan_flag = 3
    Const S207_I2_plan_seq = 4
    Const S207_I2_export_flag = 5
    Const S207_I2_cur = 6
    Const S207_I2_qty_amt_flag = 7
    Const S207_I2_sales_grp = 8

  
    On Error Resume Next                                                                 '☜: Protect system from crashing
    Err.Clear                    '☜: Clear Error status                                                            

	Redim I2_s_item_group_sales_plan(S207_I2_sales_grp)
  
	I2_s_item_group_sales_plan(S207_I2_sales_grp)    =  UCase(Trim(Request("txtSalesOrg")))
	I2_s_item_group_sales_plan(S207_I2_sp_year)      =  UCase(Trim(Request("txtSpYear")))
	I2_s_item_group_sales_plan(S207_I2_plan_flag)    =  UCase(Trim(Request("txtPlanTypeCd")))
	I2_s_item_group_sales_plan(S207_I2_export_flag)  =  UCase(Trim(Request("txtDealTypeCd")))
	I2_s_item_group_sales_plan(S207_I2_cur)          =  UCase(Trim(Request("txtCurr")))
	I2_s_item_group_sales_plan(S207_I2_qty_amt_flag) =  UCase(Trim(Request("txtRdoSelect")))
	If Len(Request("txtPlanNum")) Then 
	       I2_s_item_group_sales_plan(S207_I2_plan_seq)     = UCase(Trim(Request("txtPlanNum")))
	End if
  
	Set iS2G103 = Server.CreateObject("PS2G103.cSItemGpSpByGp")
    ...
    Call iS2G103.S_MAINT_ITEM_GP_SP_BY_GROUP(gStrGlobalCollection, itxtSpread, "" ,  _
                             I2_s_item_group_sales_plan, E3_s_item_group_sales_plan ,iErrorPosition)
    ...
    Select Case E3_s_item_group_sales_plan
    Case ""
		Response.Write "   parent.frm1.txtConPlanNum.value = parent.frm1.txtPlanNum.value " & vbCr    
	Case Else
		Response.Write "   parent.frm1.txtConPlanNum.value = """   & ConvSPChars(E3_s_item_group_sales_plan)    & """" & vbCr 
	End Select          
...
Sub SubBizIsSPIT()
	...
	I3_s_item_group_sales_plan(S201_I3_sales_grp)    =  UCase(Trim(Request("txtSalesOrg")))
	...
	I3_s_item_group_sales_plan(S201_I3_sales_ORG)    =  "S"
