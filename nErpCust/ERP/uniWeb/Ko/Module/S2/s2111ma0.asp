...
Const BIZ_PGM_ID = "s2111mb0.asp"        '☆: Head Query 비지니스 로직 ASP명 
     ...
     <TD CLASS="CLSMTABP">
      <TABLE ID="MyTab" CELLSPACING=0 CELLPADDING=0>
       <TR>
        ...
        <td background="../../../CShared/image/table/seltab_up_bg.gif" align="center" CLASS="CLSLTABP"><font color=white>품목그룹별판매계획</font></td>
      ...
      <TABLE <%=LR_SPACE_TYPE_60%>>
       ...
       <TR>
        <TD HEIGHT="100%" WIDTH="100%" COLSPAN=4>
         <script language =javascript src='./js/s2111ma0_I445294821_vspdData.js'></script>
        </TD>
       </TR>
      </TABLE>
     </TD>
