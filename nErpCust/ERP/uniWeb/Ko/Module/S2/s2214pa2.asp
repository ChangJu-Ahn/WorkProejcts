...
'*  3. Program ID           : S2214PA2
'*  4. Program Name         : 미배분현황 Popup
'*  5. Program Desc         : 
'*  6. Comproxy List        : 
...
Const BIZ_PGM_ID 		= "S2214PB2.ASP"                              '☆: Biz Logic ASP Name
...
Dim	lgStrFrSpPeriod, lgStrToSpPeriod, lgStrPlantCd, lgStrSqlId
...
Sub SetDefaultVal()
	...
	lgStrPlantCd	= iArrParam(2)
	lgStrSqlId		= iArrParam(3)
End Sub
...
Sub InitSpreadSheet()
	...
	Call SetZAdoSpreadSheet("S2214PA2","S","A","V20021202",PopupParent.C_SORT_DBAGENT,frm1.vspdData, _
								C_MaxKey, "X","X")		
	Call SetSpreadLock 	
...
Function DbQuery() 
    ...
    With frm1
		...
		iStrVal = iStrVal & "&txtToSpPeriod=" & lgStrFrSpPeriod
		iStrVal = iStrVal & "&txtToSpPeriod=" & lgStrToSpPeriod
		iStrVal = iStrVal & "&txtPlantCd=" & lgStrPlantCd
		iStrVal = iStrVal & "&txtSqlId=" & lgStrSqlId
	...
	<TR>
		<TD WIDTH=100% HEIGHT=* valign=top>
			<TABLE <%=LR_SPACE_TYPE_20%>>
				<TR>
					<TD HEIGHT="100%">
						<script language =javascript src='./js/s2214pa2_OBJECT1_vspdData.js'></script>
					</TD>
				</TR>
			</TABLE>
		</TD>
