...
Function OpenUser()
    ...
    arrField(0) = "ED20" & PopupParent.gColSep & "usr_id"
    arrField(1) = "ED22" & PopupParent.gColSep & "usr_nm"
    
    arrHeader(0) = "사용자 ID"                        ' Header명(0)
    arrHeader(1) = "사용자명"                        ' Header명(1)

    arrRet = window.showModalDialog("../../comasp/CommonPopup.asp", Array(arrParam, arrField, arrHeader), _
        "dialogWidth=420px; dialogHeight=455px; center: Yes; help: No; resizable: No; status: No;")
        ...
        <TD WIDTH=50%>
            <FIELDSET>
                ...
                <TABLE CLASS="basicTB" CELLSPACING=0 CELLPADDING=0>
                    ...
                    <TR>
                        <TD CLASS="TD5">&nbsp;</TD>
                        <TD CLASS="TD6"><script language =javascript src='./js/za009pa1_I143771451_txtStartDate.js'></script></TD>
                    </TR>
                    <TR>
                        <TD CLASS="TD5">&nbsp;</TD>
                        <TD CLASS="TD6"><script language =javascript src='./js/za009pa1_OBJECT1_txtStartTime.js'></script></TD>
                    </TR>
                </TABLE>
            </FIELDSET>
        </TD>
        <TD WIDTH=50%>
            <FIELDSET>
                ...
                <TABLE CLASS="basicTB" CELLSPACING=0 CELLPADDING=0>
                    ...
                    <TR>
                        <TD CLASS="TD5">&nbsp;</TD>
                        <TD CLASS="TD6"><script language =javascript src='./js/za009pa1_I312266051_txtEndDate.js'></script></TD>
                    </TR>
                    <TR>
                        <TD CLASS="TD5">&nbsp;</TD>
                        <TD CLASS="TD6"><script language =javascript src='./js/za009pa1_OBJECT2_txtEndTime.js'></script></TD>
                    </TR>
                </TABLE>
            </FIELDSET>
        </TD>
        ...
        <TD COLSPAN=2>
            <TABLE CLASS="basicTB" CELLSPACING=0 CELLPADDING=0>
                ...
                <TR>
                    ...
                    <TD CLASS="TD6">
                        <INPUT TYPE="Text" NAME=txtTable SIZE=15 MAXLENGTH=30 tag="11" ALT="테이블 ID"><IMG SRC="../../../CShared/image/btnPopup.gif" NAME="btnTable" ALIGN=top TYPE="BUTTON" ONCLICK="vbscript:OpenTable">
