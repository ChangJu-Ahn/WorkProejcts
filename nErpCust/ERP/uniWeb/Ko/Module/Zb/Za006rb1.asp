...
Sub SubBizQueryMulti()
    ...
    Const ZA14_E1_space = 3
    Const ZA14_E1_module_nm = 4
    Const ZA14_E1_table_type = 5
    Const ZA14_E1_table_type_nm = 6
    Const ZA14_E1_use_yn = 7
    ...
    For iLngRow = 0 To UBound(E1_z_table_info,2)
        ...
        strData = strData & Chr(11) & ConvSPChars(E1_z_table_info(ZA14_E1_table_type,iLngRow))        
