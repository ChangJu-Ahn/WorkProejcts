...
Sub InitSpreadSheet()
    ...
    With frm1.vspdData
        ...
        .ReDraw = false
        .MaxCols = C_Nullable + 1
        .MaxRows = 0

        Call GetSpreadColumnPos("A")        
       
        ggoSpread.SSSetEdit C_ColumnNm  , "Column 명"   , 40, , ,256
        ggoSpread.SSSetEdit C_ColumnType, "Column 타입" , 20, , ,256
        ggoSpread.SSSetEdit C_Key       , "Key"         , 10,2, ,10
        ggoSpread.SSSetEdit C_Nullable  , "NULL 허용"   , 15,2, ,10
        .ReDraw = true
...
Sub SetSpreadLock()
    With frm1
        ...
        ggoSpread.SpreadLock C_ColumnNm   , -1, C_ColumnNm
        ggoSpread.SpreadLock C_ColumnType, -1, C_ColumnType
        ggoSpread.SpreadLock C_Key, -1, C_Key
        ggoSpread.SpreadLock C_Nullable, -1, C_Nullable
...
Sub GetSpreadColumnPos(ByVal pvSpdNo)
    ...
    Select Case UCase(pvSpdNo)
       Case "A"
            ...
            C_ColumnNm    =  iCurColumnPos(1)
            C_ColumnType  =  iCurColumnPos(2)
            C_Key         =  iCurColumnPos(3)
            C_Nullable    =  iCurColumnPos(4)
    ...
    <TR>
        <TD WIDTH=100% HEIGHT=* valign=top>
            <TABLE <%=LR_SPACE_TYPE_20%>>
                <TR>
                    <TD HEIGHT="100%">
                        <script language =javascript src='./js/za005ra2_vaSpread1_vspdData.js'></script>
                    </TD>
                </TR>
            </TABLE>
        </TD>
