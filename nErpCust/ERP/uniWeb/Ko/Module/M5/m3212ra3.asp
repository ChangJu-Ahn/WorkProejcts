...
'********************************************  5.1 DbQuery()  *******************************************
 ...
 With frm1
    ...
    If lgIntFlgMode = PopupParent.OPMD_UMODE Then
 	    ...
 	    strVal = strVal & "&txtItemCd=" & Trim(.hdnItemCd.value)					<%'☆: 조회 조건 데이타 %>
 	...
 	End If
	strVal = strVal & "&txtTrackingNo=" &Trim(.txtTrackingNo.value)		'2003.07 Tracking No. 추가 
 End With
 		...
 		<FIELDSET CLASS="CLSFLD">
 			<TABLE <%=LR_SPACE_TYPE_40%>>
 				...
 				<TR>
 					...
 					<TD CLASS="TD6" NOWRAP><INPUT TYPE=TEXT ALT="수출자" NAME="txtBeneficiaryCd" MAXLENGTH=10 SIZE=10 tag="14NXXU" >&nbsp;&nbsp;&nbsp;&nbsp;
