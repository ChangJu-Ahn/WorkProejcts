...
Const BIZ_PGM_ID 		= "m5211qb2_KO441.asp"                     
...
Sub InitSpreadSheet()
    Call SetZAdoSpreadSheet("M5211QA201","S","A","V20030320", Parent.C_SORT_DBAGENT, frm1.vspdData, C_MaxKey, "X", "X" )
...
Function OpenBlNoPop()
	...
	iCalledAspName = AskPRAspName("M5211PA1_KO441")

	If Trim(iCalledAspName) = "" Then
		IntRetCD = DisplayMsgBox("900040", parent.VB_INFORMATION, "M5211PA1_KO441", "X")
		lgIsOpenPop = False
		Exit Function
	End If
								...
								<TR>
									...
									<TD CLASS="TD6" NOWRAP>
										<table cellspacing=0 cellpadding=0>
											<tr>
												<td>
													<script language =javascript src='./js/m5211qa2_fpDateTime2_txtBlIssueFrDt.js'></script>
												</td>
												<td>~</td>
												<td>
													<script language =javascript src='./js/m5211qa2_fpDateTime2_txtBlIssueToDt.js'></script>
												</td>
											</tr>
										</table>
							         </TD>				   
								...
								<TR>
									...
									<TD CLASS="TD6" NOWRAP>
										<table cellspacing=0 cellpadding=0>
											<tr>
												<td>
													<script language =javascript src='./js/m5211qa2_fpDateTime2_txtLoadingFrDt.js'></script>
												</td>
												<td>~</td>
												<td>
													<script language =javascript src='./js/m5211qa2_fpDateTime2_txtLoadingToDt.js'></script>
												</td>
											</tr>
										</table>
							         </TD>
					...
					<TD WIDTH=100% HEIGHT=* VALIGN=TOP>
						<TABLE <%=LR_SPACE_TYPE_60%>>
							<TR>
								...
								<TD CLASS=TD6 NOWRAP><script language =javascript src='./js/m5211qa2_fpDoubleSingle1_txtTotQty.js'></script></TD>
								<TD CLASS=TD6 NOWRAP></TD>
								<TD CLASS=TD6 NOWRAP></TD>
							</TR>
							<TR>
								<TD HEIGHT=100% WIDTH=100% COLSPAN=4>
									<script language =javascript src='./js/m5211qa2_vaSpread1_vspdData.js'></script>
								</TD>
							</TR>
						</TABLE>
					</TD>
    ...
    <TR HEIGHT="20">
		<TD WIDTH="100%">
			<TABLE <%=LR_SPACE_TYPE_30%>>
				<TR>
					<TD WIDTH=10>&nbsp;</TD>
					<TD WIDTH="*" ALIGN="RIGHT"><a ONCLICK="VBSCRIPT:setCookie_01()">B/L현황조회</a> | <a ONCLICK="VBSCRIPT:setCookie_02()">B/L내역등록</a></TD>
					<TD WIDTH=10>&nbsp;</TD>
				</TR>
			</TABLE>
		</TD>
