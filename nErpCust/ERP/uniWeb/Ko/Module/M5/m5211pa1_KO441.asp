...
'*  3. Program ID           : M5211PA1
'*  4. Program Name         : B/L 관리번호 
'*  5. Program Desc         : B/L 등록을 위한 B/L 관리번호 
'*  6. Comproxy List        : M52118ListImportBlHdrSvr
...
Const BIZ_PGM_ID 		= "m5211pb1_ko441.asp"                              '☆: Biz Logic ASP Name
...
Sub InitSpreadSheet()
	...
	Call SetZAdoSpreadSheet("M5211PA1","S","A","V20021202",PopupParent.C_SORT_DBAGENT,frm1.vspdData, _
								C_MaxKey, "X","X")
	Call SetSpreadLock 
...
Function FncQuery() 
  ...
  If ValidDateCheck(frm1.txtFrDt, frm1.txtToDt) = False Then Exit Function
  ...
  With frm1
  	If lgIntFlgMode = PopupParent.OPMD_UMODE Then		
  		strVal = BIZ_PGM_ID & "?txtMode=" & PopupParent.UID_M0001					'☜: 비지니스 처리 ASP의 상태	
  																		'☆: 조회 조건 데이타 
  	    strVal = strVal & "&txtBeneficiary=" 	& Trim(frm1.hdnBeneficiary.value)	<%'수출자 %>
  	    strVal = strVal & "&txtFrDt=" 			& Trim(frm1.hdnFrDt.Value)			<%'B/L 일자 %>
  	    strVal = strVal & "&txtToDt=" 			& Trim(frm1.hdnToDt.Value)
  		strVal = strVal & "&lgStrPrevKey="   	& lgStrPrevKey     
      Else
  		strVal = BIZ_PGM_ID & "?txtMode=" & PopupParent.UID_M0001			
  		strVal = strVal & "&txtBeneficiary=" 	& Trim(frm1.txtBeneficiary.value)	<%'수출자 %>
  		strVal = strVal & "&txtFrDt=" 			& Trim(frm1.txtFrDt.Text)			<%'B/L 일자 %>
  		...
  		<FIELDSET CLASS="CLSFLD">
  			<TABLE <%=LR_SPACE_TYPE_40%>>
  				<TR>
  					...
  					<TD CLASS=TD5 NOWRAP>B/L 일자</TD>
  					<TD CLASS=TD6 NOWRAP>
  						<table cellspacing=0 cellpadding=0>
  							<tr>
  								<td NOWRAP>
  									<script language =javascript src='./js/m5211pa1_fpDateTime1_txtFrDt.js'></script>
  								</td>
  								<td NOWRAP>~</td>
  								<td NOWRAP>
  									<script language =javascript src='./js/m5211pa1_fpDateTime2_txtToDt.js'></script>
  								</td>
  							</tr>
  						</table>
  					</TD>
  		...
  		<TABLE <%=LR_SPACE_TYPE_20%>>
  			<TR>
  				<TD HEIGHT=100% WIDTH=100% COLSPAN=4>
  					<script language =javascript src='./js/m5211pa1_vaSpread_vspdData.js'></script>
  				</TD>
  			</TR>
  		</TABLE>
  	</TD>
