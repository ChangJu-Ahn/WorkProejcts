...
Function OpenPoRef()
	...
	iCalledAspName = AskPRAspName("M3111RA2_KO441")

	If Trim(iCalledAspName) = "" Then
		IntRetCD = DisplayMsgBox("900040", parent.VB_INFORMATION, "M3111RA2_KO441", "X")
		gblnWinEvent = False
		Exit Function
	End If
...
Function OpenLCRef()
	...
	iCalledAspName = AskPRAspName("M3211RA1_KO441")

	If Trim(iCalledAspName) = "" Then
		IntRetCD = DisplayMsgBox("900040", parent.VB_INFORMATION, "M3211RA1_KO441", "X")
		gblnWinEvent = False
		Exit Function
	End If
