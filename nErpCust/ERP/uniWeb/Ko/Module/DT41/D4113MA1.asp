...
'*  2. Function Name        : 
'*  3. Program ID           : D4113MA1.asp
'*  4. Program Name         : 역발행거래처관리
'*  5. Program Desc         :
'*  6. Modified date(First) : 2011/05/12
...
Const BIZ_PGM_ID = "D4113MB1.ASP"												<%'비지니스 로직 ASP명 %>
...
Sub InitSpreadSheet()
   ...
   With frm1.vspdData
     ...
     .MaxRows = 0			
      ...
      ggoSpread.SSSetEdit		C_BP_NM, "거래처명",    20
...
Sub InitComboBox()
   ...
   '자료유형(Data Type)
   Call CommonQueryRs("MINOR_CD, MINOR_NM", "B_MINOR", "MAJOR_CD=" & FilterVar("DT405", "''", "S") & " ", lgF0, lgF1, lgF2, lgF3, lgF4, lgF5, lgF6)    
