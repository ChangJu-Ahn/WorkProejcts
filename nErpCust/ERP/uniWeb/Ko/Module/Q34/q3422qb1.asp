...
Sub FixUNISQLData()
	...
	Select Case strFlag
		Case "N"
			...
			UNISqlId(0) = "Q3422QA101"
		Case "I"
			Redim UNIValue(0,5)    
			UNISqlId(0) = "Q3422QA102"
		Case "D"
			Redim UNIValue(0,5)    
			UNISqlId(0) = "Q3422QA103"
		Case "IS"
			Redim UNIValue(0,6)    
			UNISqlId(0) = "Q3422QA104"
		Case "ID"
			Redim UNIValue(0,6)    
			UNISqlId(0) = "Q3422QA105"
		Case "A"
			Redim UNIValue(0,7)             
			UNISqlId(0) = "Q3422QA106"
	End Select
