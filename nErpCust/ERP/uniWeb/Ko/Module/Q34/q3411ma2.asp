...
Const BIZ_PGM_QRY_ID = "q3411mb2.asp"							'☆: Query 비지니스 로직 ASP명 
...
Function FncQuery() 
	...
	If 	CommonQueryRs(" DEFECT_RATIO_UNIT_CD "," Q_DEFECT_RATIO_BY_INSP_CLASS ", " INSP_CLASS_CD = " & FilterVar("F", "''", "S") & "  AND PLANT_CD = " & FilterVar(frm1.txtPlantCd.Value, "''", "S"), _
...
Function SetPrintCond(StrEbrFile, strUrl)
	...
	If frm1.RadioDRType.rdoCase1.Checked = True Then
		StrEbrFile	= "Q3411MA22"
	Else
		StrEbrFile	= "Q3411MA21"
	End If
						...
						<FIELDSET CLASS=CLSFLD>
							<TABLE WIDTH="100%" <%=LR_SPACE_TYPE_40%>>		
								<TR>
									...
									<TD CLASS="TD6" NOWRAP>
										<SCRIPT LANGUAGE=JavaScript> ExternalWrite('<OBJECT CLASSID=<%=gCLSIDFPDT%> id=fpDateTime1 name=txtYr CLASS=FPDTYYYY title=FPDATETIME ALT="연도" tag="13X1"> <PARAM Name="AllowNull" Value="-1"><PARAM Name="Text" Value=""> </OBJECT>');</SCRIPT>
									</TD>
								</TR>
								<TR>
									<TD CLASS="TD5" NOWRAP>품목</TD>
									<TD CLASS="TD6" NOWRAP><INPUT TYPE=TEXT NAME="txtItemCd" SIZE=15 MAXLENGTH=18 tag="13XXXU" ALT="품목"><IMG align=top height=20 name=btnItemCd onclick=vbscript:OpenItem() src="../../../CShared/image/btnPopup.gif" width=16  TYPE="BUTTON">
								...
								<TR>
									...
									<TD CLASS="TD6" NOWRAP>
										<INPUT TYPE="RADIO" CLASS="RADIO" NAME="RadioDRType" TAG="1`X" ID="rdoCase1"><LABEL FOR="rdoCase1" >LOT불합격률</LABEL>
