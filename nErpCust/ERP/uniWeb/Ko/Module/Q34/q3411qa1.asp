...
Const BIZ_PGM_ID		= "Q3411qb1.asp"                 '☆: 비지니스 로직 ASP명 
Const BIZ_PGM_JUMP_ID	= "Q2311qa1"                     '☆: Cookie에서 사용할 상수 
...
Sub InitSpreadSheet()
    ...
    Call SetZAdoSpreadSheet("Q3411QA1", "G", "A", "V20021125", parent.C_GROUP_DBAGENT, frm1.vspdData, C_MaxKey, "X", "X")
    Call SetSpreadLock 
End Sub
						...
						<FIELDSET CLASS="CLSFLD">
							<TABLE <%=LR_SPACE_TYPE_40%>>
								<TR>
									...
									<TD CLASS="TD6">
										<script language =javascript src='./js/q3411qa1_fpDateTime5_txtDtFr.js'></script>&nbsp;~&nbsp;
										<script language =javascript src='./js/q3411qa1_fpDateTime6_txtDtTo.js'></script>
									</TD>
								</TR>
								<TR>
						...
						<TABLE <%=LR_SPACE_TYPE_60%>>
							...
							<TR>
								<TD HEIGHT=100% WIDTH=100% Colspan=4>
									<script language =javascript src='./js/q3411qa1_I403107589_vspdData.js'></script>
								</TD>	
							</TR>	
						</TABLE>
					</TD>
	...
	<TR HEIGHT=20>
      		<TD WIDTH=100%>
      			<TABLE <%=LR_SPACE_TYPE_30%>>
        				<TR>        				
        					<TD WIDTH=10>&nbsp;</TD>
					<!--<TD WIDTH="*" ALIGN="RIGHT"><a ONCLICK="VBSCRIPT:CookiePage(1)">최종검사일보조회</a></TD>-->
