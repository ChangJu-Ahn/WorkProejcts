...
'*  2. Function Name        : 
'*  3. Program ID           : Q3412MA1
'*  4. Program Name         : 불량원인파레토도 
'*  5. Program Desc         : 
'*  6. Component List       : 
...
Const BIZ_PGM_QRY_ID = "q3412mb1.asp"							'☆: Query 비지니스 로직 ASP명 
...
Function OpenDefectType()
	...
	arrParam(4) = arrParam(4) & " AND INSP_CLASS_CD = " & FilterVar("F", "''", "S") & " "	' Where Condition
	arrParam(5) = "불량유형"						' 조건필드의 라벨 명칭 
...
Function DbQuery() 
	...
	strVal = strVal & "&txtDefectTypeCd=" & Trim(frm1.txtDefectTypeCd.value)
...
Function DBQueryFailed(intChartNo)
	If intChartNo = 1 Then
		lgNoData1 = True
		MyBizASP1.Document.Location.href = "../../blank.htm"
	ElseIf intChartNo = 2 Then
		lgNoData2 = True
		MyBizASP2.Document.Location.href = "../../blank.htm"
	End If
					...
					<TD CLASS="CLSMTABP">
						<TABLE ID="MyTab" CELLSPACING=0 CELLPADDING=0>
							<TR>
								...
								<td background="../../../CShared/image/table/seltab_up_bg.gif" align="center" CLASS="CLSMTAB"><font color=white>불량원인파레토표</font></td>
					...
					<TD HEIGHT=20 WIDTH=100%>
						<FIELDSET CLASS=CLSFLD>
							<TABLE WIDTH="100%" <%=LR_SPACE_TYPE_40%>>		
								...
								<TD CLASS="TD6" NOWRAP>
									<SCRIPT LANGUAGE=JavaScript> ExternalWrite('<OBJECT CLASSID=<%=gCLSIDFPDT%> id=fpDateTime1 name=txtYrDt CLASS=FPDTYYYYMM title=FPDATETIME ALT="연월" tag="13"></OBJECT>');</SCRIPT>
								</TD>
							</TR>
							<TR>
							...
							<TR>
								...
								<TD CLASS="TD6"><INPUT TYPE=TEXT NAME="txtDefectTypeCd" SIZE="10" MAXLENGTH="5" ALT="불량유형" tag="11XXXU"><IMG SRC="../../../CShared/image/btnPopup.gif" NAME="btnDefectTypeCd" align=top width=16 TYPE="BUTTON" ONCLICK="vbscript:OpenDefectType()">
