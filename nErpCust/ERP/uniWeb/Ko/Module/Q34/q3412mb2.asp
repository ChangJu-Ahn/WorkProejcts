...
'*  3. Program ID           : q3412mb2.asp
'*  4. Program Name         : 최종불량유형 파레토표 
'*  5. Program Desc         : 최종불량유형 
'*  6. Comproxy List        : 
'                             
'*  7. Modified date(First) : 2000/05/27
'*  8. Modified date(Last)  : 2000/10/19
...
Function GetData()
	...
	strSql1 = "SELECT Q_DEFECT_TYPE.Defect_Type_Nm, Sum(Q_FINAL_DEFECT_TYPE_TOTAL.DEFECT_QTY) FROM Q_FINAL_DEFECT_TYPE_TOTAL Left Outer Join " &_
	              "Q_DEFECT_TYPE On Q_FINAL_DEFECT_TYPE_TOTAL.Defect_Type_Cd = Q_DEFECT_TYPE.Defect_Type_Cd Where Q_DEFECT_TYPE.Insp_Class_Cd=" & FilterVar("F", "''", "S") & "  and " &_
	                  "Q_FINAL_DEFECT_TYPE_TOTAL.PLANT_CD = " & FilterVar(strPlantCd, "''", "S") & " and Q_FINAL_DEFECT_TYPE_TOTAL.YR =  " & FilterVar(strYr1 , "''", "S") & " and Q_FINAL_DEFECT_TYPE_TOTAL.Mnth =  " & FilterVar(strMnth1 , "''", "S") & " and " &_
	                  "Q_FINAL_DEFECT_TYPE_TOTAL.Item_Cd = " & FilterVar(strItemCd , "''", "S") & " and Q_FINAL_DEFECT_TYPE_TOTAL.INSP_ITEM_CD LIKE " & FilterVar(strInspItemCd , "''", "S") & " " &_
	                  " and Q_FINAL_DEFECT_TYPE_TOTAL.DEFECT_QTY > 0   " &_
	                  "GROUP BY Q_DEFECT_TYPE.Defect_Type_Nm " &_
	                  "Order By Sum(Q_FINAL_DEFECT_TYPE_TOTAL.DEFECT_QTY) Desc"

	strSql2 = "SELECT Q_DEFECT_TYPE.Defect_Type_Nm, Sum(Q_FINAL_DEFECT_TYPE_TOTAL.DEFECT_QTY) FROM Q_FINAL_DEFECT_TYPE_TOTAL Left Outer Join " &_
	              "Q_DEFECT_TYPE On Q_FINAL_DEFECT_TYPE_TOTAL.Defect_Type_Cd = Q_DEFECT_TYPE.Defect_Type_Cd Where Q_DEFECT_TYPE.Insp_Class_Cd=" & FilterVar("F", "''", "S") & "  and " &_
	                  "Q_FINAL_DEFECT_TYPE_TOTAL.PLANT_CD = " & FilterVar(strPlantCd , "''", "S") & " and Q_FINAL_DEFECT_TYPE_TOTAL.YR =  " & FilterVar(strYr2 , "''", "S") & " and Q_FINAL_DEFECT_TYPE_TOTAL.Mnth =  " & FilterVar(strMnth2 , "''", "S") & " and " &_
	                  "Q_FINAL_DEFECT_TYPE_TOTAL.Item_Cd = " & FilterVar(strItemCd , "''", "S") & " and Q_FINAL_DEFECT_TYPE_TOTAL.INSP_ITEM_CD LIKE " & FilterVar(strInspItemCd , "''", "S") & " " &_
	                  " and Q_FINAL_DEFECT_TYPE_TOTAL.DEFECT_QTY > 0   " &_
	                  "GROUP BY Q_DEFECT_TYPE.Defect_Type_Nm " &_
	                  "Order By Sum(Q_FINAL_DEFECT_TYPE_TOTAL.DEFECT_QTY) Desc"
