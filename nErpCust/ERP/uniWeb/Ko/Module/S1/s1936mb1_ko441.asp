...
Sub SubBizSaveMultiCreate(arrColVal)
	...
	lgStrSQL = "INSERT INTO S_ITEM_SALE_TYPE_KO441"
	lgStrSQL = lgStrSQL & "( BP_CD, ITEM_CD, SALES_TYPE, REMARK,   "
...
Sub SubBizSaveMultiUpdate(arrColVal)
    ...
    lgStrSQL = "UPDATE  S_ITEM_SALE_TYPE_KO441 "
    lgStrSQL = lgStrSQL & " SET " 
    lgStrSQL = lgStrSQL & " REMARK  		=       " &  FilterVar(UCase(arrColVal(5)), "''", "S")	& ","
    ...
    lgStrSQL = lgStrSQL & " SALES_TYPE		=       " & FilterVar(UCase(arrColVal(4)), "''", "S") 
...
Sub SubBizSaveMultiDelete(arrColVal)
    ...
    lgStrSQL = "DELETE  S_ITEM_SALE_TYPE_KO441 WHERE "
    lgStrSQL = lgStrSQL & " BP_CD			=       " & FilterVar(UCase(arrColVal(2)), "''", "S") & " AND "
    lgStrSQL = lgStrSQL & " ITEM_CD 		=       " & FilterVar(UCase(arrColVal(3)), "''", "S") & " AND "
    lgStrSQL = lgStrSQL & " SALES_TYPE		=       " & FilterVar(UCase(arrColVal(4)), "''", "S") 
        ...
        Case "M"
           ...
           Select Case Mid(pDataType,2,1)
               ...
               Case "R"
                       ...
                       lgStrSQL = lgStrSQL & " FROM S_ITEM_SALE_TYPE_KO441 "
                       lgStrSQL = lgStrSQL & " WHERE 1=1 "  & pCode 
                       lgStrSQL = lgStrSQL & " ORDER BY BP_CD, ITEM_CD, SALES_TYPE " 
