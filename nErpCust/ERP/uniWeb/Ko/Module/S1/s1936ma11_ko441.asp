...
'*  4. Program Name         : 고객별판매유형(공정)단가등록 
'*  5. Program Desc         : 고객별판매유형(공정)단가등록
'*  6. Comproxy List        : 
 	...
 	With frm1.vspdData
      ...
      Call GetSpreadColumnPos("A")
	   .ReDraw = false
		...
		ggoSpread.SSSetEdit     C_Deal_type,            "판매유형", 10, 0,,15,2        
...
'	ggoSpread.SSSetProtected   C_To_Qty  ,     pvStartRow, pvEndRow
...
'	ggoSpread.SSSetProtected    C_To_Qty,          lRow, lRow
...
Sub InitSpreadComboBox()
    ...
    ggoSpread.SetCombo Replace(strCD ,Chr(11),vbTab), C_Fr_Qty
    ggoSpread.SetCombo Replace(strVal,Chr(11),vbTab), C_To_Qty
...
'========================================================================================================
 Function DbQuery()
  ...
  If lgIntFlgMode = Parent.OPMD_UMODE Then
   ...
   strVal = strVal & "&txtconBp_cd=" & Trim(frm1.txtHconBiz_partner.value)        <%'☆: 조회 조건 데이타 %>
     ...
     <TD CLASS="CLSLTAB">
      <TABLE ID="MyTab" CELLSPACING=0 CELLPADDING=0>
       <TR>
        ...
        <td background="../../../CShared/image/table/seltab_up_bg.gif" align="center" CLASS="CLSMTAB"><font color=white>고객별판매유형(공정)단가등록</font></td>
