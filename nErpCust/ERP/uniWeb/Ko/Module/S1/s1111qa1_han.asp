...
Const BIZ_PGM_ID        = "s1111qb1_han.asp"
...
'==========================================================================================================
Sub InitSpreadSheet()
	Call SetZAdoSpreadSheet("S1111QA1_HAN","S","A","V20050503", Parent.C_SORT_DBAGENT, frm1.vspdData, C_MaxKey, "X", "X" )
    Call SetSpreadLock 
End Sub
...
Function BtnPrint()
	...
	OBjName = AskEBDocumentName("s1111oa2_han","ebr")    
					...
					<TD CLASS="CLSMTABP">
						<TABLE ID="MyTab" CELLSPACING=0 CELLPADDING=0>
							<TR>
								...
								<td background="../../../CShared/image/table/seltab_up_bg.gif" align="center" CLASS="CLSMTAB"><font color=white>품목단가조회(한철)</font></td>
