...
'*  4. Program Name         : 품목별판가수율등록 
'*  5. Program Desc         : 품목별판가수율등록 
'*  6. Comproxy List        : 
...
Const BIZ_PGM_ID      = "s1937mb1_ko441.asp"            '☆: 비지니스 로직 ASP명 
 	...
 	With frm1.vspdData
      ...
      Call GetSpreadColumnPos("A")
	   .ReDraw = false
		...
		ggoSpread.SSSetEdit     C_Bp_Cd,                "고객사" ,10, 0,,10,2
		ggoSpread.SSSetButton   C_Bp_Cd_Popup    
		ggoSpread.SSSetEdit     C_Bp_Nm,                "고객사명", 20, 0 
		ggoSpread.SSSetEdit     C_Item_Cd,              "품목코드" ,10, 0,,10,2
		ggoSpread.SSSetButton   C_Item_Cd_Popup    
		ggoSpread.SSSetEdit     C_Item_Nm,              "품목명", 20, 0 
        ggoSpread.SSSetDate     C_Valid_Dt,				"적용일", 10,2, parent.gDateFormat   'Lock->Unlock/ Date
		...
		ggoSpread.SSSetFloat    C_Tot_Rate,				"총수율",10, "6" , ggStrIntegeralPart, ggStrDeciPointPart, Parent.gComNum1000, Parent.gComNumDec,,,"Z"	
		ggoSpread.SSSetFloat    C_Net_Die,				"Net Die수",10, Parent.ggAmtOfMoneyNo , ggStrIntegeralPart, ggStrDeciPointPart, Parent.gComNum1000, Parent.gComNumDec,,,"Z"	
		ggoSpread.SSSetEdit     C_Remark,               "비고", 18, 0 
     ...
     <TD CLASS="CLSLTAB">
      <TABLE ID="MyTab" CELLSPACING=0 CELLPADDING=0>
       <TR>
        ...
        <td background="../../../CShared/image/table/seltab_up_bg.gif" align="center" CLASS="CLSMTAB"><font color=white>품목별판가적용수율등록</font></td>
