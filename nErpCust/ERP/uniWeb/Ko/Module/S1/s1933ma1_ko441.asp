...
'*  1. Module Name          : Sales
'*  2. Function Name        : 
'*  3. Program ID           : s1933ma1_ko441
'*  4. Program Name         : 테스트기준단가등록(고객) 
'*  5. Program Desc         : 테스트기준단가등록(고객) 
...
Const BIZ_PGM_ID      = "s1933mb1_ko441.asp"            '☆: 비지니스 로직 ASP명 
...
Sub InitSpreadSheet()
	...
	ggoSpread.Source = frm1.vspdData
 	With frm1.vspdData
       ...
       .MaxCols   = C_Valid_Dt														' ☜:☜: Add 1 to Maxcols
      ...
      Call GetSpreadColumnPos("A")
	   .ReDraw = false
		...
		ggoSpread.SSSetEdit     C_Tester_cd,            "TESTER 모델", 12, 0 
		...
		ggoSpread.SSSetCombo    C_Type,					"TEST종류", 12, 0       
		ggoSpread.SSSetCombo    C_Type_Nm,				"TEST종류", 10, 0       
		ggoSpread.SSSetFloat    C_Price,				"단가",14, Parent.ggUnitCostNo , ggStrIntegeralPart, ggStrDeciPointPart, Parent.gComNum1000, Parent.gComNumDec,,,"Z"	
		ggoSpread.SSSetEdit     C_Cur,                  "환종", 8, 0,,3,2
...
Sub SetSpreadLock()
	...
	ggoSpread.spreadlock		C_Bp_Cd, -1, C_Type_Nm
	ggoSpread.SSSetRequired		C_Price,  -1, C_Price
	ggoSpread.spreadlock		C_Cur, -1, C_Valid_Dt
...
Sub GetSpreadColumnPos(ByVal pvSpdNo)
    ...
    Select Case UCase(pvSpdNo)
       Case "A"
			...
			C_Type				  = iCurColumnPos(i) : i = i + 1
			C_Type_Nm			  = iCurColumnPos(i) : i = i + 1
			C_Price				  = iCurColumnPos(i) : i = i + 1 
...
Sub InitSpreadComboBox()
	...
	strCD = "CP" & vbTab & "FT" 
    ggoSpread.SetCombo Replace(strCD ,Chr(11),vbTab), C_Type
    ggoSpread.SetCombo Replace(strCD ,Chr(11),vbTab), C_Type_Nm
   ...
   For lRow = 1 To .vspdData.MaxRows
    ...
    Select Case .vspdData.Text
     Case ggoSpread.InsertFlag       
		...
		.vspdData.Col = C_Price		    : strVal = strVal & Trim(UNIConvNum(.vspdData.Text, 0)) & parent.gRowSep
     ...
     Case ggoSpread.DeleteFlag  
		...
		.vspdData.Col = C_Tester_cd	    : strDel = strDel & Trim(.vspdData.Text) & parent.gColSep
		.vspdData.Col = C_Method		: strDel = strDel & Trim(.vspdData.Text) & parent.gColSep
     ...
     <TD CLASS="CLSLTAB">
      <TABLE ID="MyTab" CELLSPACING=0 CELLPADDING=0>
       <TR>
        ...
        <td background="../../../CShared/image/table/seltab_up_bg.gif" align="center" CLASS="CLSMTAB"><font color=white>테스트기준단가등록(고객별)</font></td>
