...
'*  1. Module Name          : Sales
'*  2. Function Name        : 
'*  3. Program ID           : S1312OA1
'*  4. Program Name         : 고객별품목할증출력 
'*  5. Program Desc         : 고객별품목할증출력 
'*  6. Comproxy List        : 
...
Function BtnPrint() 
	...
	' Print 함수에서 호출 
	'----------------------------------------------------------------
	OBjName = AskEBDocumentName("s1312oa1","ebr")    
					...
					<TD WIDTH=100%>
						<TABLE <%=LR_SPACE_TYPE_60%>>
								<TR>
									...
									<TD CLASS=TD6 NOWRAP>
										<TABLE CELLSPACING=0 CELLPADDING=0>
											<TR>
												<TD>
													<script language =javascript src='./js/s1312oa1_fpDateTime1_txtValid_From_Dt.js'></script>
												</TD>
								...
								<TR>
									...
									<TD CLASS=TD6 NOWRAP><INPUT NAME="txtBP_Cd" ALT="고객" TYPE="Text" MAXLENGTH="18" SIZE=10  tag="11XXXU"><IMG SRC="../../../CShared/image/btnPopup.gif" NAME="btnBP_CD" align=top TYPE="BUTTON"ONCLICK="vbscript:OpenConPop1">&nbsp;<INPUT NAME="txtBP_Nm" TYPE="Text" SIZE=30 MAXLENGTH="50"  tag="14"></TD>								
							    </TR>
							    <TR>
									<TD CLASS=TD5 NOWRAP>품목</TD>
									<TD CLASS=TD6 NOWRAP><INPUT NAME="txtItem_Cd" ALT="품목" TYPE="Text" MAXLENGTH="18" SIZE=10  tag="11XXXU"><IMG SRC="../../../CShared/image/btnPopup.gif" NAME="btnITEM_CD" align=top TYPE="BUTTON"ONCLICK="vbscript:OpenConPop2">&nbsp;<INPUT NAME="txtItem_Nm" TYPE="Text" SIZE=30 MAXLENGTH="40"  tag="14"></TD>								
							    </TR>
