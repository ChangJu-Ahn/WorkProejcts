...
Const BIZ_PGM_ID = "s1312mb2.asp"            '☆: 비지니스 로직 ASP명 
...
Sub InitSpreadSheet()
  ...
  With frm1.vspdData
	...
	ggoSpread.SSSetEdit     C_Bp_Cd,			"고객" ,10, 0,,10,2
	...
	ggoSpread.SSSetEdit     C_Item_Spec,		"규격", 25, 0
...
Sub SetSpreadLock()
    ...
    ggoSpread.spreadlock    C_Item_spec, -1
    ...
    ggoSpread.spreadUnlock  C_DC_Kind,   -1
    ggoSpread.spreadUnlock  C_Round_type_Popup,   -1    
...
Sub SetSpreadColor(ByVal pvStartRow,ByVal pvEndRow)
    ...
    ggoSpread.SSSetProtected   C_Item_Spec  ,        pvStartRow, pvEndRow
...
Sub SetSpreadColor1(ByVal lRow)
 ...
 Dim Index
    ...
    ggoSpread.SSSetProtected    C_Item_Spec,        lRow, lRow
...
Sub GetSpreadColumnPos(ByVal pvSpdNo)
    ...
    Select Case UCase(pvSpdNo)
       Case "A"
		...
		C_DC_BAS_Qty          = iCurColumnPos(14)
		C_Dc_rate             = iCurColumnPos(15)
		C_DC_Kind             = iCurColumnPos(16)
		C_DC_Kind_Popup       = iCurColumnPos(17)
		C_DC_Kind_Nm          = iCurColumnPos(18)
		C_Round_type          = iCurColumnPos(19)
		C_Round_type_Popup    = iCurColumnPos(20)
		C_Round_type_Nm       = iCurColumnPos(21)
...
'=========================================================================================== Function  OpenBiz_Partner(ByVal strCode)
 Function  OpenBiz_Partner(ByVal strCode)
  Dim arrRet
  Dim arrParam(5), arrField(6), arrHeader(6)
        ggoSpread.Source = frm1.vspdData                                   
...
'===========================================================================================
Function SetBiz_Partner(Byval arrRet)  
 With frm1
...
Sub vspdData_Change(ByVal Col , ByVal Row )
   ...
   If Frm1.vspdData.CellType = Parent.SS_CELL_TYPE_FLOAT Then
      If Parent.UNICDbl(Frm1.vspdData.text) < Parent.UNICDbl(Frm1.vspdData.TypeFloatMin) Then
...
Function DbQuery() 
 ...
 Dim strVal
  ...
  If lgIntFlgMode = Parent.OPMD_UMODE Then
		...
		strVal = strVal & "&txtconBiz_Partner=" & Trim(.txtHconBiz_Partner.value)
  ...
  Else
		strVal = BIZ_PGM_ID & "?txtMode=" & Parent.UID_M0001   
		strVal = strVal & "&txtconBiz_Partner=" & Trim(.txtconBiz_Partner.value)
   ...
   For lRow = 1 To .vspdData.MaxRows
    ...
    Select Case .vspdData.Text
     ...
     Case ggoSpread.InsertFlag        <% '☜: 신규 %>
      ...
      strVal = strVal & Trim(Parent.UNIConvDate(.vspdData.Text)) & Parent.gColSep

      .vspdData.Col = C_Unit        <% '5 %>
      strVal = strVal & Trim(.vspdData.Text) & Parent.gColSep
      
      .vspdData.Col = C_DC_BAS_QTY      <% '6 %>
      strVal = strVal & Trim(Parent.UNICDbl(.vspdData.Text)) & Parent.gColSep
     ...
     Case ggoSpread.DeleteFlag        <% '☜: 삭제 %>
      ...
      .vspdData.Col = C_Valid_from_dt        <% '4 %>
      strDel = strDel & Trim(Parent.UNIConvDate(.vspdData.Text)) & Parent.gColSep

      .vspdData.Col = C_Unit        <% '5 %>
      strDel = strDel & Trim(.vspdData.Text) & Parent.gColSep
      
      .vspdData.Col = C_DC_BAS_QTY      <% '6 %>
      strDel = strDel & Trim(Parent.UNICDbl(.vspdData.Text)) & Parent.gColSep
      ...
      ' Extra Value [ ext1_qty/ ....]
		strDel = strDel & 0 & Parent.gColSep
		strDel = strDel & 0 & Parent.gColSep
		strDel = strDel & 0 & Parent.gColSep
		strDel = strDel & 0 & Parent.gColSep
     ...
     <TD CLASS="CLSLTABP">
      <TABLE ID="MyTab" CELLSPACING=0 CELLPADDING=0>
       <TR>
        ...
        <td background="../../../CShared/image/table/seltab_up_bg.gif" align="center" CLASS="CLSMTAB"><font color=white>고객별품목할증</font></td>
      ...
      <FIELDSET CLASS="CLSFLD">
       <TABLE <%=LR_SPACE_TYPE_40%>>
        <TR>
         ...
         <TD CLASS="TD6"><INPUT NAME="txtconBiz_Partner" ALT="고객" TYPE="Text" MAXLENGTH=10 SiZE=10  tag="11XXXU"><IMG SRC="../../../CShared/image/btnPopup.gif" NAME="btnSItemDC" align=top TYPE="BUTTON" ONCLICK="vbscript:OpenConSItemDC frm1.txtconBiz_Partner.value,3">&nbsp;<INPUT NAME="txtconBiz_Partner_nm" TYPE="Text" MAXLENGTH="50" SIZE=25 tag="14"></TD>
        ...
        <TR>
         ...
         <TD CLASS="TD6"><INPUT NAME="txtconPay_terms" ALT="결제방법" TYPE="Text" MAXLENGTH=4 SiZE=10  tag="11XXXU"><IMG SRC="../../../CShared/image/btnPopup.gif" NAME="btnSItemDC" align=top TYPE="BUTTON" ONCLICK="vbscript:OpenConSItemDC frm1.txtconPay_terms.value,2">&nbsp;<INPUT NAME="txtconPay_terms_nm" TYPE="Text" MAXLENGTH="50" SIZE=25 tag="14"></TD> 
        
         <TD CLASS="TD5" NOWRAP>적용일</TD>
         <TD CLASS="TD6" NOWRAP><script language =javascript src='./js/s1312ma2_fpDateTime1_txtconValid_from_dt.js'></script></TD> 
        </TR>
        <TR>
    ...
    <TR>
     <TD WIDTH=100% HEIGHT=100% valign=top>
       <TABLE <%=LR_SPACE_TYPE_20%>>
        <TR>
         <TD HEIGHT="100%">
          <script language =javascript src='./js/s1312ma2_I572523689_vspdData.js'></script>
         </TD>
        </TR>
      </TABLE>
     </TD>
