...
Const BIZ_PGM_ID      = "s1931mb1_ko441.asp"            '☆: 비지니스 로직 ASP명 
 	...
 	With frm1.vspdData
      ...
      Call GetSpreadColumnPos("A")
	   .ReDraw = false
		...
		ggoSpread.SSSetEdit     C_Bp_Cd,                "고객사" ,12, 0,,10,2
		ggoSpread.SSSetButton   C_Bp_Cd_Popup    
		ggoSpread.SSSetEdit     C_Bp_Nm,                "고객사명", 22, 0 
		...
		ggoSpread.SSSetCombo    C_Term_Opt,             "구간옵션", 10, 0    
		ggoSpread.SSSetCombo    C_Term_Opt_Nm,          "구간옵션", 12, 0
		...
		ggoSpread.SSSetFloat    C_Round_Cp,				"소수점올림"&Chr(13)&"(CP)",9, Parent.ggAmtOfMoneyNo , ggStrIntegeralPart, ggStrDeciPointPart, Parent.gComNum1000, Parent.gComNumDec,,,,"0","5"
		ggoSpread.SSSetFloat    C_Round_Ft,				"소수점올림"&Chr(13)&"(FT)",9, Parent.ggAmtOfMoneyNo , ggStrIntegeralPart, ggStrDeciPointPart, Parent.gComNum1000, Parent.gComNumDec,,,,"0","5"
		...
		Call ggoSpread.SSSetColHidden(C_Term_Opt,C_Term_Opt,True)
		...
		Call .AddCellSpan(8,-1000, 9, 1)
		.Row = -1000 : .Col = 8 : .Text = "Test 단가처리 Rule"
		Call .AddCellSpan(17,-1000, 6, 1)
		.Row = -1000 : .Col = 17 : .Text = "TCP/COF 단가처리 Rule"
...
Sub SetSpreadLock()
	...
	ggoSpread.spreadlock		C_Apply_yymm, -1, C_Bp_Nm
	ggoSpread.SSSetRequired		C_Cur,  -1, C_Cur
	ggoSpread.SSSetRequired		C_Apply_Opt_Nm,  -1, C_Apply_Opt_Nm
	ggoSpread.SSSetRequired		C_Term_Opt_Nm,  -1, C_Term_Opt_Nm
	...
	ggoSpread.SSSetRequired		C_Round_Cp,  -1, C_Round_Cp
	ggoSpread.SSSetRequired		C_Round_Ft,  -1, C_Round_Ft
...
Sub SetSpreadColor(ByVal pvStartRow,ByVal pvEndRow)
    ...
    ggoSpread.SSSetRequired    C_Term_Opt_Nm,       pvStartRow, pvEndRow
    ...
    ggoSpread.SSSetRequired    C_Round_Cp,           pvStartRow, pvEndRow
    ggoSpread.SSSetRequired    C_Round_Ft,           pvStartRow, pvEndRow
...
Sub SetSpreadColor1(ByVal lRow)
    ...
    ggoSpread.SSSetProtected    C_Term_Opt,          lRow, lRow
    ggoSpread.SSSetProtected    C_Term_Opt_Nm,       lRow, lRow
    ggoSpread.SSSetProtected    C_Round_Cp,           lRow, lRow
	ggoSpread.SSSetProtected    C_Basic_Opt,        lRow, lRow
...
Sub GetSpreadColumnPos(ByVal pvSpdNo)
    ...
    Select Case UCase(pvSpdNo)
       Case "A"
			...
			C_Term_Opt            = iCurColumnPos(i) : i = i + 1
			C_Term_Opt_nm         = iCurColumnPos(i) : i = i + 1
			...
			C_Round_Cp            = iCurColumnPos(i) : i = i + 1
			C_Round_Ft			  = iCurColumnPos(i) : i = i + 1
...
Sub InitSpreadComboBox()
    ...
    Call CommonQueryRs(" MINOR_CD, MINOR_NM "," b_minor "," MAJOR_CD = 'ZZ101' ",lgF0,lgF1,lgF2,lgF3,lgF4,lgF5,lgF6)
	lgF0 = " " & vbTab & lgF0 
	lgF1 = " " & vbTab & lgF1 
    ggoSpread.SetCombo Replace(lgF0 ,Chr(11),vbTab), C_Term_Opt
    ggoSpread.SetCombo Replace(lgF1 ,Chr(11),vbTab), C_Term_Opt_Nm
...
'===========================================================================
 Function  OpenItem_cd(ByVal strCode)
  ...
  Else
	 With frm1
	  .vspdData.Col = C_Retest_Rate
	  .vspdData.Text = arrRet(0)
	  .vspdData.Col = C_Qei_Rate
	  .vspdData.Text = arrRet(1)
	  .vspdData.Col = C_Ad_Sec
	  .vspdData.Text = arrRet(2)
	  .vspdData.Col = C_Output_rate
...
Sub vspdData_ComboSelChange(ByVal Col, ByVal Row)
	...
	With frm1.vspdData
        ...
        Select Case Col
			...
			If intIndex = "0" Then
				ggoSpread.SpreadLock    C_Term_Opt, Row, C_Term_Opt_Nm, Row
				ggoSpread.SpreadUnLock    C_Term_Opt, Row, C_Term_Opt_Nm, Row
			Else
				ggoSpread.SSSetRequired    C_Term_Opt, Row, Row
				ggoSpread.SSSetRequired    C_Term_Opt_Nm, Row, Row
			End If	
            Case C_Term_Opt_Nm
                .Col = Col
                intIndex = .Value
...
Sub InitData()
	...
	With frm1.vspdData
		For intRow = 1 To .MaxRows
			...
			.value = intindex
			If intIndex = "0" Then
				ggoSpread.SpreadUnLock    C_Term_Opt, intRow, C_Term_Opt_Nm, intRow
			Else
				ggoSpread.SSSetRequired    C_Term_Opt, intRow, intRow
				ggoSpread.SSSetRequired    C_Term_Opt_Nm, intRow, intRow
			End If							
         ...
         Case  C_Bp_Cd
            ...
            Else
                ...
                If IntRetCd = false then
			        Call DisplayMsgBox("126231","X","X","X")	'거래처정보에 없음
  	                Frm1.vspdData.Col = C_Bp_Nm
                    Frm1.vspdData.value = ""
                Else
					Frm1.vspdData.Col = C_Bp_Nm
   ...
   For lRow = 1 To .vspdData.MaxRows
    ...
    Select Case .vspdData.Text
     Case ggoSpread.InsertFlag       
		...
		.vspdData.Col = C_Term_Opt	    : strVal = strVal & Trim(.vspdData.Text) & parent.gColSep
		...
		.vspdData.Col = C_Round_Cp		: strVal = strVal & Trim(UNIConvNum(.vspdData.Text, 0)) & parent.gColSep
		.vspdData.Col = C_Round_Ft		: strVal = strVal & Trim(UNIConvNum(.vspdData.Text, 0)) & parent.gColSep
     ...
     <TD CLASS="CLSLTAB">
      <TABLE ID="MyTab" CELLSPACING=0 CELLPADDING=0>
       <TR>
        ...
        <td background="../../../CShared/image/table/seltab_up_bg.gif" align="center" CLASS="CLSMTAB"><font color=white>단가처리Config등록(고객별)</font></td>
