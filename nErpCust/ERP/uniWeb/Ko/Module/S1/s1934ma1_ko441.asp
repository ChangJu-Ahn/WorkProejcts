...
Const BIZ_PGM_ID      = "s1934mb1_ko441.asp"            '☆: 비지니스 로직 ASP명 
...
Sub SetSpreadLock()
	...
	ggoSpread.spreadlock		C_Item_Cd, -1, C_Type_Nm
     ...
     <TD CLASS="CLSLTAB">
      <TABLE ID="MyTab" CELLSPACING=0 CELLPADDING=0>
       <TR>
        ...
        <td background="../../../CShared/image/table/seltab_up_bg.gif" align="center" CLASS="CLSMTAB"><font color=white>테스트기준단가등록(품목별)</font></td>
