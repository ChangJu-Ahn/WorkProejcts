...
'*  1. Module Name          : Sales
'*  2. Function Name        : 
'*  3. Program ID           : S1112QA1
'*  4. Program Name         : 고객별품목단가조회 
'*  5. Program Desc         : 고객별품목단가조회 
'*  6. Comproxy List        :
'*  7. Modified date(First) : 2002/07/06
...
Const BIZ_PGM_ID        = "s1112qb1_ko441.asp"
...
'==========================================================================================================
Sub InitSpreadSheet()
	Call SetZAdoSpreadSheet("S1112QA1ko441","S","A","V20050503", Parent.C_SORT_DBAGENT, frm1.vspdData, C_MaxKey, "X", "X" )
    Call SetSpreadLock 
End Sub
...
Function BtnPrint()
	...
	If UCase(frm1.txtconBiz_partner.value) = "" Then
		var2 = "%"	' "%"
	Else
		var2 = FilterVar(Trim(UCase(frm1.txtconBiz_partner.value)), "" ,  "SNM")
	End If
	...
	If UCase(frm1.txtconItem_cd.value) = "" Then
		var3 = "%"	' "%"
	Else
		var3 = FilterVar(Trim(UCase(frm1.txtconItem_cd.value)), "" ,  "SNM")
	End If
    
    If UCase(frm1.txtconPay_terms.value) = "" Then
		var4 = "%"
	Else
		var4 = FilterVar(Trim(UCase(frm1.txtconPay_terms.value)), "" ,  "SNM")
	End If

    If UCase(frm1.txtconDeal_type.value) = "" Then
		var5 = "%"
	Else
		var5 = FilterVar(Trim(UCase(frm1.txtconDeal_type.value)), "" ,  "SNM")
	End If

    If UCase(frm1.txtconSales_unit.value) = "" Then
		var6 = "%"
	Else
		var6 = FilterVar(Trim(UCase(frm1.txtconSales_unit.value)), "" ,  "SNM")
	End If

    If UCase(frm1.txtconCurrency.value) = "" Then
		var7 = "%"
	Else
		var7 = FilterVar(Trim(UCase(frm1.txtconCurrency.value)), "" ,  "SNM")
	End If
	...
	strUrl = strUrl & "|PAY_METH|" & var4
	strUrl = strUrl & "|DEAL_TYPE|" & var5
	strUrl = strUrl & "|UNIT|" & var6
	strUrl = strUrl & "|CUR|" & var7 

    
	OBjName = AskEBDocumentName("s1112oa2","ebr")    
					...
					<TD CLASS="CLSMTABP">
						<TABLE ID="MyTab" CELLSPACING=0 CELLPADDING=0>
							<TR>
								...
								<td background="../../../CShared/image/table/seltab_up_bg.gif" align="center" CLASS="CLSMTAB"><font color=white>고객별품목단가조회</font></td>
						...
						<FIELDSET CLASS="CLSFLD">
							<TABLE <%=LR_SPACE_TYPE_40%>>
								<TR>
									...
									<TD CLASS="TD6" NOWRAP><script language =javascript src='./js/s1112qa1_fpDateTime1_txtconValid_from_dt.js'></script></TD>	
				...
				<TR>
					<TD WIDTH=100% HEIGHT=100% valign=top>
							<TABLE <%=LR_SPACE_TYPE_20%>>
								<TR>
									<TD HEIGHT="100%">
										<script language =javascript src='./js/s1112qa1_vaSpread1_vspdData.js'></script>
									</TD>
								</TR>
						</TABLE>
					</TD>
