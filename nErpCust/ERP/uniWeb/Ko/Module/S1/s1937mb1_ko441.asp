...
Sub SubBizQueryMulti()
    ...
    Else
       ...
       Do While Not lgObjRs.EOF
            ...
            lgstrData = lgstrData & Chr(11) & ConvSPChars(lgObjRs("OUTPUT_RATE1"))
            lgstrData = lgstrData & Chr(11) & ConvSPChars(lgObjRs("OUTPUT_RATE2"))
            lgstrData = lgstrData & Chr(11) & ConvSPChars(lgObjRs("OUTPUT_RATE3") )                 
            lgstrData = lgstrData & Chr(11) & ConvSPChars(lgObjRs("OUTPUT_RATE4"))
            lgstrData = lgstrData & Chr(11) & round((Cdbl(lgObjRs("OUTPUT_RATE1"))/100)*(Cdbl(lgObjRs("OUTPUT_RATE2"))/100)*(Cdbl(lgObjRs("OUTPUT_RATE3"))/100)*(Cdbl(lgObjRs("OUTPUT_RATE4"))/100),2)
            lgstrData = lgstrData & Chr(11) & ConvSPChars(lgObjRs("NET_DIE_QTY"))
...
Sub SubBizSaveMultiCreate(arrColVal)
	...
	lgStrSQL = "INSERT INTO S_ITEM_OUTPUT_RATE_KO441"
	lgStrSQL = lgStrSQL & "(BP_CD, ITEM_CD, VALID_FROM_DT, OUTPUT_RATE1, OUTPUT_RATE2, OUTPUT_RATE3, OUTPUT_RATE4,   "
	lgStrSQL = lgStrSQL & " OUTPUT_RATE5, OUTPUT_RATE6, OUTPUT_RATE7, NET_DIE_QTY, REMARK,  "
	...
	lgStrSQL = lgStrSQL &  UNIConvNum(arrColVal(8),0)    & ", 0,0,0,"
...
Sub SubBizSaveMultiUpdate(arrColVal)
    ...
    lgStrSQL = "UPDATE  S_ITEM_OUTPUT_RATE_KO441 "
    lgStrSQL = lgStrSQL & " SET " 
    lgStrSQL = lgStrSQL & " OUTPUT_RATE1	=       " & UNIConvNum(arrColVal(5),0)	& ","
    lgStrSQL = lgStrSQL & " OUTPUT_RATE2	=       " & UNIConvNum(arrColVal(6),0)	& ","
    lgStrSQL = lgStrSQL & " OUTPUT_RATE3	=       " & UNIConvNum(arrColVal(7),0)	& ","
    lgStrSQL = lgStrSQL & " OUTPUT_RATE4	=       " & UNIConvNum(arrColVal(8),0)	& ","
    lgStrSQL = lgStrSQL & " NET_DIE_QTY	    =       " & UNIConvNum(arrColVal(9),0)	& ","
    ...
    lgStrSQL = lgStrSQL & " ITEM_CD			=       " & FilterVar(UCase(arrColVal(3)), "''", "S") & " AND "
    lgStrSQL = lgStrSQL & " VALID_FROM_DT	=       " & FilterVar(UNIConvDate(arrColVal(4)),NULL,"S")
...
Sub SubBizSaveMultiDelete(arrColVal)
    ...
    lgStrSQL = "DELETE  S_ITEM_OUTPUT_RATE_KO441 WHERE "
    lgStrSQL = lgStrSQL & " BP_CD			=       " & FilterVar(UCase(arrColVal(2)), "''", "S") & " AND "
    lgStrSQL = lgStrSQL & " ITEM_CD			=       " & FilterVar(UCase(arrColVal(3)), "''", "S") & " AND "
    lgStrSQL = lgStrSQL & " VALID_FROM_DT	=       " & FilterVar(UNIConvDate(arrColVal(4)),NULL,"S")
'Response.Write lgStrSQL
        ...
        Case "M"
           ...
           Select Case Mid(pDataType,2,1)
               ...
               Case "R"
                       ...
                       lgStrSQL = lgStrSQL & " BP_CD, ITEM_CD, VALID_FROM_DT, OUTPUT_RATE1, OUTPUT_RATE2, OUTPUT_RATE3, "   
                       lgStrSQL = lgStrSQL & "    OUTPUT_RATE4, NET_DIE_QTY, REMARK,"  
                       ...
                       lgStrSQL = lgStrSQL & " FROM S_ITEM_OUTPUT_RATE_KO441 "
                       lgStrSQL = lgStrSQL & " WHERE 1=1 "  & pCode 
                       lgStrSQL = lgStrSQL & " ORDER BY BP_CD, ITEM_CD, VALID_FROM_DT " 
