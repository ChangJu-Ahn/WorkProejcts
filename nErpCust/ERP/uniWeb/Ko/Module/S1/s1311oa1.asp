...
'*  1. Module Name          : Sales
'*  2. Function Name        : 
'*  3. Program ID           : S1311OA1
'*  4. Program Name         : 품목할증출력 
'*  5. Program Desc         : 품목할증출력 
'*  6. Comproxy List        : 
'*  7. Modified date(First) : 2001/01/15
'*  8. Modified date(Last)  : 2001/01/15
...
' Print 함수에서 호출 
'----------------------------------------------------------------
OBjName = AskEBDocumentName("s1311oa1","ebr")    
					...
					<TD WIDTH=100%>
						<TABLE <%=LR_SPACE_TYPE_60%>>
								<TR>
									...
									<TD CLASS=TD6 NOWRAP>
										<TABLE CELLSPACING=0 CELLPADDING=0>
											<TR>
												<TD>
													<script language =javascript src='./js/s1311oa1_fpDateTime1_txtValid_From_Dt.js'></script>
												</TD>
								...
								<TR>
									...
									<TD CLASS=TD6 NOWRAP><INPUT NAME="txtItem_Cd" ALT="품목" TYPE="Text" MAXLENGTH="18" SIZE=10  tag="11XXXU"><IMG SRC="../../../CShared/image/btnPopup.gif" NAME="btnITEM_CD" align=top TYPE="BUTTON"ONCLICK="vbscript:OpenConPop">&nbsp;<INPUT NAME="txtItem_Nm" TYPE="Text" MAXLENGTH="40" SIZE=30  tag="14"></TD>								
							    </TR>
							</TABLE>
					</TD>
				</TR>
