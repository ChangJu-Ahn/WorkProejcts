...
'*  4. Program Name         : 월근태사항출력 
'*  5. Program Desc         : 월근태사항출력 
'*  6. Comproxy List        : +
...
Sub SetDefaultVal()
	...
	frm1.txtBas_dt.focus 			'년월 default value setting
...
Function FncBtnPrint() 
    ...
    Call FuncGetTermDept(lgUsrIntCd,UNIConvDate(rDate),strMin,strMax)     '로그인한 사원의 부서권한 최소 ,최대를 가지고온다.  
					...
					<TD CLASS="CLSMTABP">
						<TABLE ID="MyTab" CELLSPACING=0 CELLPADDING=0>
							<TR>
								...
								<td background="../../../CShared/image/table/seltab_up_bg.gif" align="center" CLASS="CLSLTAB"><font color=white>월근태사항출력</font></td>
