...
'*  3. Program ID           : h4012oa1
'*  4. Program Name         : 기간별근태출력 
'*  5. Program Desc         : 기간별근태출력 
'*  6. Comproxy List        : +
...
Function FncBtnPrint() 
    ...
    Call FuncGetTermDept(lgUsrIntCd,UNIConvDate(frm1.txtTo_dt.Text),strMin,strMax)
    ...
    If ValidDateCheck(frm1.txtFr_dt, frm1.txtTo_dt)=False Then   
			Call BtnDisabled(0)
            Exit Function
    End if 
	...
	dim fr_dt, to_dt, fr_dept_cd, to_dept_cd
	
	StrEbrFile = "h4012oa1"
	fr_dt = UniConvDateAToB(frm1.txtFr_dt.Text, parent.gDateFormat, parent.gServerDateFormat)
	to_dt = UniConvDateAToB(frm1.txtTo_dt.Text, parent.gDateFormat, parent.gServerDateFormat)
...
Function txtFr_dept_cd_Onchange()
    ...
    Else
        IntRetCd = FuncDeptName(frm1.txtFr_dept_cd.value,UNIConvDate(frm1.txtTo_dt.Text),lgUsrIntCd,strDept_nm,lsInternal_cd)
...
Function txtTo_dept_cd_Onchange()
    ...
    Else
        IntRetCd = FuncDeptName(frm1.txtTo_dept_cd.value,UNIConvDate(frm1.txtTo_dt.Text),lgUsrIntCd,strDept_nm,lsInternal_cd)
					...
					<TD CLASS="CLSMTABP">
						<TABLE ID="MyTab" CELLSPACING=0 CELLPADDING=0>
							<TR>
								...
								<td background="../../../CShared/image/table/seltab_up_bg.gif" align="center" CLASS="CLSLTAB"><font color=white>기간별근태출력</font></td>
				...
				<TR>
					<TD HEIGHT=20>
						<TABLE <%=LR_SPACE_TYPE_60%>>   
							<TR>
								<TD CLASS="TD5" NOWRAP>출력기간</TD>
								<TD CLASS=TD6 NOWRAP><script language =javascript src='./js/h4012oa1_txtFr_dt_txtFr_dt.js'></script>&nbsp;~&nbsp;
													 <script language =javascript src='./js/h4012oa1_txtTo_dt_txtTo_dt.js'></script></td>
							</TR>
							<TR>
