		...
		Case "B"
			...
			With frm1.vspdData2
				...
				ggoSpread.SSSetEdit C_BConf_Nm,      "", 10, 2,,3                  
                                ggoSpread.SSSetEdit  C_BConf_Fg,      "결재여부",   15, ,,15
                                ggoSpread.SSSetEdit  C_BUSER,		 "결재자",   10,,,10
    ...
    Select Case UCase(pvSpdNo)
       Case "A"
		...
		Case "B"
			...
			C_BUSER      = iCurColumnPos(4)
			C_BTempGlDt      = iCurColumnPos(5)
			C_BGlDt          = iCurColumnPos(6)
			C_BTempGlNo      = iCurColumnPos(7)
			C_BDeptNm        = iCurColumnPos(8)
			C_BCurrency      = iCurColumnPos(9)
			C_BTempGlAmt     = iCurColumnPos(10)
			C_BTempGlLocAmt  = iCurColumnPos(11)
			C_BGlNo          = iCurColumnPos(12)
			C_BInputType     = iCurColumnPos(13)
			C_BInputTypeNm   = iCurColumnPos(14)
			C_BHqBrchNo      = iCurColumnPos(15)
