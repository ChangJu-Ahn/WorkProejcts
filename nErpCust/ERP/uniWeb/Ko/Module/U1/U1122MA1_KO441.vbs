...
'		.MaxCols = C_SplitSeqNo + 1
		...
		Call ggoSpread.MakePairsColumn(C_StockCd,C_StockCdPop)  '2008-06-13 11:38오전 :: hanc
...
'2008-06-13 11:39오전 :: hanc
			C_StockCd			= iCurColumnPos(42)
			C_StockCdPop		= iCurColumnPos(43)
			
	End Select

End Sub	

'2008-06-13 11:40오전 :: hanc
...
Function SetFirmPoRef(strRet)
	...
	With frm1.vspdData
		...
		For index1 = 0 to Count1
			...
			Call .SetText(C_StockCd,	Row1, "ETC")        '2008-06-13 11:50오전 :: hanc
...
Sub vspdData_ButtonClicked(ByVal Col, ByVal Row, Byval ButtonDown)
	...
	If Col = C_SlCdPop Then
    	Call OpenSlCd()
	ElseIf Col = C_StockCdPop Then      '2008-06-13 11:41오전 :: hanc
    	Call OpenStockCd()
		...
		For lRow = 1 To .vspdData.MaxRows
			...
			Select Case .vspdData.Text
				Case ggoSpread.InsertFlag, ggoSpread.UpdateFlag
					...
					strVal = strVal & Trim(GetSpreadText(frm1.vspdData,C_StockCd,lRow, "X","X")) & iRowSep	'2008-06-13 12:17오후 :: hanc
