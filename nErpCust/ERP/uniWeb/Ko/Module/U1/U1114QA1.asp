...
'*  1. Module Name          : SCM
'*  2. Function Name        : 
'*  3. Program ID           : mscm03qa1.asp
'*  4. Program Name         : 거래처별입고집계현황 - Query Receipt Summary By Biz Partner
'*  5. Program Desc         : 
'*  6. Comproxy List        : 
...
'================================================================================================================================
Const BIZ_PGM_QRY1_ID	= "u1114qb1.asp"							'☆: 비지니스 로직 ASP명 
Const BIZ_PGM_QRY2_ID	= "u1114qb2.asp"							'☆: 비지니스 로직 ASP명 
...
Sub InitSpreadSheet(ByVal pvSpdNo)
    ...
    If pvSpdNo = "B" Or pvSpdNo = "*" Then
		...
		With frm1.vspdData2 
			...
			ggoSpread.SSSetEdit 	C_SLNM,			"입고창고명"	,15
...
Sub GetSpreadColumnPos(ByVal pvSpdNo)
    ...
    Select Case UCase(pvSpdNo)
		...
		Case "B"
			...
			C_DvryPrice			= iCurColumnPos(12)
			C_DvryAmt			= iCurColumnPos(13)
					...
					<TD CLASS="CLSMTABP">
						<TABLE ID="MyTab" CELLSPACING=0 CELLPADDING=0>
							<TR>
								...
								<td background="../../../CShared/image/table/seltab_up_bg.gif" align="center" CLASS="CLSMTAB"><font color=white>공급처별입고집계현황</font></td>
						...
						<FIELDSET CLASS="CLSFLD">
							<TABLE <%=LR_SPACE_TYPE_40%>>
								...
								<TR>
									...
									<TD CLASS=TD6 NOWRAP><INPUT TYPE=TEXT NAME="txtSlCd" SIZE=18 MAXLENGTH=18 tag="11xxxU" ALT="입고창고"><IMG SRC="../../../CShared/image/btnPopup.gif" NAME="btnSlCd" align=top TYPE="BUTTON"ONCLICK="vbscript:OpenSlCd()">&nbsp;<INPUT TYPE=TEXT NAME="txtSlNm" SIZE=25 tag="14"></TD>
