...
Const BIZ_PGM_ID	= "u1121mb1.asp"			'☆: List & Manage SCM Orders
...
Sub InitSpreadSheet()
	...
	Call InitSpreadPosVariables()
		...
		With frm1
            ...
            ggoSpread.SSSetEdit		C_PlantCd,		"입고창고"  , 10
			ggoSpread.SSSetEdit		C_PlantNm,		"입고창고명",	12
			ggoSpread.SSSetEdit		C_SPLITSEQNO,	"분할번호",	12
			ggoSpread.SSSetEdit		C_GBN,			"구분",	12
...
Sub SetSpreadLock(ByVal pvSpdNo)
	...
	If pvSpdNo = "A" Then
		...
		With frm1
			...
			ggoSpread.SpreadLock	 C_GBN ,-1, C_GBN
...
Sub SetSpreadColor(ByVal pvStartRow, ByVal pvEndRow)
    ...
    ggoSpread.SSSetProtected C_GBN,	pvStartRow, pvEndRow
...
Function FncDeleteRow() 
	...
	With Frm1.vspdData1
		For iDx = 1 To .maxrows
		    ...
		    .Col = C_SPLITSEQNO
		    strSplitSeqNo = .text
			Call CommonQueryRs( " isnull(MVMT_NO,'') mvmt_no " , "  M_SCM_FIRM_PUR_RCPT A " , " A.DLVY_NO = " & "'" & frm1.txtdlvyno.VALUE & "'" & " AND A.PO_NO = " & "'" & strPoNo & "'" & " AND A.PO_SEQ_NO = " & "'" & strPoSeqNo & "'" & " AND A.SPLIT_SEQ_NO = " & "'" & strSPLITSeqNo & "'"   ,  lgF0, lgF1, lgF2, lgF3, lgF4, lgF5, lgF6)
...
Function OpenReqRef()
	...
	if Trim(frm1.txtbpcd.Value) = "" then
		Call DisplayMsgBox("205152", "X", "공급처", "X")
		frm1.txtbpcd.focus
    	Exit Function
    End if
...
Sub txtTransCo_Change()
	lgBlnFlgChgValue = True
End Sub

Sub txtVehicleNo_Change()
	lgBlnFlgChgValue = True
End Sub

Sub txtDriver_Change()
	lgBlnFlgChgValue = True
End Sub

Sub txtTelNo1_Change()
	lgBlnFlgChgValue = True
End Sub

Sub txtTelNo2_Change()
	lgBlnFlgChgValue = True
End Sub

Sub txtDlvyPlace_Change()
	lgBlnFlgChgValue = True
End Sub
