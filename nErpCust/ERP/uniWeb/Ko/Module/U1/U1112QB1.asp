        ...
        Case "M"
           ...
           Select Case Mid(pDataType,2,1)
               Case "R"
					...
					lgStrSQL = lgStrSQL & " 	GROUP BY A.BP_CD, A.ITEM_CD, A.TRACKING_NO , A.PLAN_DVRY_DT WITH ROLLUP ) A, "
					...
					lgStrSQL = lgStrSQL & " order by isNULL(A.BP_CD,'zzzzzzzzzz'), isNULL(A.ITEM_CD, 'zzzzzzzzzzzzzzzzzz'), isNULL(A.PLAN_DVRY_DT, '2999-12-31'), A.grp_flg  "
