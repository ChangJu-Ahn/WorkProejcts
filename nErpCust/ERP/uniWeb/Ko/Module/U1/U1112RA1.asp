...
Sub SetDefaultVal()
	...
	With frm1
		...
		'********* LSW 무조건 gPlant 로 조회하면 데이터가 조회가 안됨.
...
Sub InitSpreadSheet()
	...
	With frm1.vspdData 
		...
		ggoSpread.SSSetFloat		C_POPrc,		"단가"		, 15	,"C" ,ggStrIntegeralPart ,ggStrDeciPointPart,PopupParent.gComNum1000,PopupParent.gComNumDec
		ggoSpread.SSSetFloat 		C_POAmt,		"발주금액"		, 15	,"A" ,ggStrIntegeralPart ,ggStrDeciPointPart,PopupParent.gComNum1000,PopupParent.gComNumDec
...
Function OpentxtDlvyNo()
    ...
    arrParam(1) = arrParam(1) & " WHERE A.BP_CD = B.BP_CD AND D.RET_FLG  = 'N' AND A.BP_CD = '" & Frm1.txtBpCd.value & "'"
    arrParam(1) = arrParam(1) & " AND D.RCPT_TYPE = '" & frm1.hdnRcptType.value & "' AND A.DLVY_NO = C.DLVY_NO AND C.PO_NO = D.PO_NO AND C.RCPT_QTY = 0 )a "
			...
			<FIELDSET CLASS="CLSFLD">
				<TABLE <%=LR_SPACE_TYPE_40%>>
					...
					<TR>
						...
						<INPUT TYPE=TEXT AlT="입고창고" ID="txtSlNm" tag="14X">
						</TD>
					</TR>
					<TR>
