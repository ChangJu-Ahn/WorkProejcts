...
'*  2. Function Name        : 
'*  3. Program ID           : U1112QA1
'*  4. Program Name         : 공급처별입고예정 - Query Plan Receipt Summary By Biz Partner
'*  5. Program Desc         : 
'*  6. Comproxy List        : 
...
'================================================================================================================================
Const BIZ_PGM_QRY1_ID	= "U1112QB1.asp"							'☆: 비지니스 로직 ASP명 
Const BIZ_PGM_QRY2_ID	= "U1112QB2.asp"							'☆: 비지니스 로직 ASP명 
...
'		ggoSpread.SpreadLockWithOddEvenRowColor()
		...
		frm1.vspdData1.ReDraw = False
   		ggoSpread.SpreadLock	 C_BpCd, -1, C_PlanDvryQty
...
Sub SetQuerySpreadColor()
	...
	For iLoopCnt=0 to ubound(iArrColor1,1) - 1
		...
		Select Case iArrColor2(1)
			...
			Case "2"
				.BackColor = RGB(176,234,244) 
			Case "3"
				.BackColor = RGB(224,206,244) 
				.ForeColor = vbBlue
			Case "4"  
				.BackColor = RGB(251,226,153) 
			Case "5" 
					...
					<TD CLASS="CLSMTABP">
						<TABLE ID="MyTab" CELLSPACING=0 CELLPADDING=0>
							<TR>
								...
								<td background="../../../CShared/image/table/seltab_up_bg.gif" align="center" CLASS="CLSMTAB"><font color=white>공급처별입고예정조회</font></td>
