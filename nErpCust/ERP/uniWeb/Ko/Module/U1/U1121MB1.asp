...
Sub  SubBizBatch()
    ...
    With lgObjComm
	    ...
	    lgObjComm.Parameters.Append lgObjComm.CreateParameter("@last_auto_no" ,adVarChar,adParamoutput,13, strno)
...
Sub SubBizQuery()
	...
	'------ Developer Coding part (Start ) ------------------------------------------------------------------
       ...
       Response.Write  "       .Frm1.txtDlvyTime.Value	= """ & Trim(Left(ConvSPChars(lgObjRs("DLVY_TIME")),2))   & """" & vbCr
       Response.Write  "       .Frm1.txtDlvyTime2.Value	= """ & Trim(Right(ConvSPChars(lgObjRs("DLVY_TIME")),2))  & """" & vbCr
...
Sub SubBizSaveSingleCreate()
    Dim lgStrSQL
	Dim strHH , strMM , strHHMM
	
	strHH = Right("0" & Request("txtdlvytime" ),2)
	strMM = Right("0" & Request("txtdlvytime2"),2)
	strHHMM = strHH & strMM
	...
	lgStrSQL = lgStrSQL & FilterVar(strHHMM    ,"''","S") & ","
...
Sub SubBizSaveSingleUpdate()
	...
	lgStrSQL = lgStrSQL & " 	DLVY_TIME	= " &  FilterVar(strHHMM ,"''","S")  & ","
        ...
        Case "M"
           ...
           Select Case Mid(pDataType,2,1)
               Case "R"
					...
					lgStrSQL = lgStrSQL & "	       B.TRACKING_NO , C.BASIC_UNIT , A.PLAN_DVRY_DT , A.PLAN_DVRY_QTY , A.D_BP_CD ,  D.SL_NM , E.RET_FLG "
