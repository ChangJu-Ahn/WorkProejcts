...
Function SetPrintCond(StrEbrFile, strUrl)
	...
	Dim strYyyymm, strUnit, strBizAreaCd
	Dim strWhere,IntRetCd, org_change_dt
    ...
    strWhere = " org_change_dt <=  isnull((SELECT DISTINCT top 1 prov_dt FROM HDF070T "
    strWhere = strWhere +         " WHERE pay_yymm =  " & FilterVar(strYyyymm, "''", "S") 
    strWhere = strWhere +         "   AND Prov_type = 1)," & FilterVar(strYyyymm &"01", "''", "S") &")"
...
<BODY TABINDEX="-1" SCROLL="no">
	...
	<TABLE  <%=TABSTYLE01%> >
		<TR>
			...
			<TD CLASS="TD6E" NOWRAP><script language =javascript src='./js/vh002ma1_fpDateTime1_txtQueryDate.js'></script>&nbsp;</TD>
