...
'**********************************************************************************************************
Const BIZ_PGM_QRY1_ID	= "p4311rb1.asp"								'☆: Head Query 비지니스 로직 ASP명 
Const BIZ_PGM_QRY2_ID	= "p4311rb2.asp"								'☆: 비지니스 로직 ASP명 
'==========================================  1.2.1 Global 상수 선언  ======================================
'==========================================================================================================
...
<TABLE CELLSPACING=0 CLASS="basicTB">
			...
			<FIELDSET CLASS="CLSFLD">
				<TABLE WIDTH=100% CELLSPACING=0>	
					<TR>
						...
						<TD CLASS=TD6 NOWRAP><INPUT TYPE=TEXT NAME="txtProdOrdNo" SIZE=18 MAXLENGTH=18 tag="24xxxU" ALT="제조오더번호"></TD>
	...
	<TR HEIGHT="50%">
		<TD WIDTH="100%" colspan=4>
			<script language =javascript src='./js/p4311ra1_A_vspdData1.js'></script>
		</TD>
	</TR>
	<TR HEIGHT="50%">
		<TD WIDTH="100%" colspan=4>
			<script language =javascript src='./js/p4311ra1_B_vspdData2.js'></script>
		</TD>
	</TR>
	<TR><TD HEIGHT=30>
		<TABLE CLASS="basicTB" CELLSPACING=0>
			<TR>
				<TD WIDTH=70% NOWRAP>&nbsp;&nbsp;
				<IMG SRC="../../../CShared/image/query_d.gif"  Style="CURSOR: hand" ALT="Search" NAME="Search" ONCLICK="DbPreDtlQuery()" onMouseOut="javascript:MM_swapImgRestore()" onMouseOver="javascript:MM_swapImage(this.name,'','../../../CShared/image/Query.gif',1)"></IMG></TD>
