...
'*  3. Program ID           : h2014oa1
'*  4. Program Name         : 학력사항출력 
'*  5. Program Desc         : 학력사항출력 
'*  6. Comproxy List        : +
'*  7. Modified date(First) : 2001/01/03
...
Function FncBtnPrint() 
	...
	strUrl = strUrl & "|to_dept_cd|" & to_dept_cd
   	...
   	ObjName = AskEBDocumentName("h2014oa1","ebr")
					...
					<TD CLASS="CLSMTABP">
						<TABLE ID="MyTab" CELLSPACING=0 CELLPADDING=0>
							<TR>
								...
								<td background="../../../CShared/image/table/seltab_up_bg.gif" align="center" CLASS="CLSMTAB"><font color=white>학력사항출력</font></td>
						...
						<TABLE <%=LR_SPACE_TYPE_60%>>
						    <TR>
								...
								<TD CLASS="TD6" NOWRAP><INPUT TYPE="Text" ID="txtEmp_no" NAME="txtEmp_no" ALT="대상자" SIZE=13 MAXLENGTH=13 tag="11XXXU"><IMG SRC="../../../CShared/image/btnPopup.gif" NAME="btnAcctCdFR" ALIGN=top TYPE="BUTTON" ONCLICK="vbscript:OpenEmptName (1)">
								                       <INPUT TYPE="Text" ID="txtName" NAME="txtName" ALT="대상자코드명" SIZE=20 MAXLENGTH=30 tag="14XXXU"></TD>
							</TR>
							    <TD CLASS=TD5 NOWRAP>직종</TD>
						  		<TD CLASS=TD6 NOWRAP><SELECT ID="cboOcpt_type" NAME="cboOcpt_type" ALT="직종" STYLE="WIDTH: 100px" TAG="11XXXU"><OPTION VALUE=""></OPTION></SELECT>		
							<TR>			
		                    ...
		                    <TR>    
								...
								<TD CLASS=TD6 NOWRAP><INPUT ID="txtTo_dept_cd" NAME="txtTo_dept_cd" ALT="부서코드" MAXLENGTH="10" SIZE="10" tag="11XXXU"><IMG SRC="../../../CShared/image/btnPopup.gif" NAME="btnname" ALIGN=top TYPE="BUTTON" ONCLICK="vbscript:Call OpenDept(1)">
							                         <INPUT ID="txtTo_dept_nm" NAME="txtTo_dept_nm" ALT="부서코드명" MAXLENGTH="40" SIZE="20" tag="14XXXU">까지
