...
'*  3. Program ID           	: h2017oa1
'*  4. Program Name         	: 보증인현황출력 
'*  5. Program Desc         	: 보증인현황출력 
'*  6. Comproxy List        	: +
...
Sub SetDefaultVal()
	...
	With frm1
		.txtBas_dt.focus
		.txtBas_dt.Year = strYear 		 '년월일 default value setting
		.txtBas_dt.Month = strMonth 
		.txtBas_dt.Day = strDay
	End With 
...
Function FncBtnPrint() 
    ...
    If (frm1.txtBas_dt.Text = "") Then
        frm1.txtBas_dt.Text = "" 
    End If
	
	StrEbrFile = "h2017oa1.ebr"
	
	base_dt = UNIConvDate(frm1.txtBas_dt.Text)
	...
	strUrl = "base_dt|" & base_dt
	strUrl = strUrl & "|base_dt1|" & base_dt
	...
	ObjName = AskEBDocumentName("h2017oa1","ebr")
					...
					<TD CLASS="CLSMTABP">
						<TABLE ID="MyTab" CELLSPACING=0 CELLPADDING=0>
							<TR>
								...
								<td background="../../../CShared/image/table/seltab_up_bg.gif" align="center" CLASS="CLSMTAB"><font color=white>보증인현황출력</font></td>
					...
					<TD HEIGHT=20>
						<TABLE <%=LR_SPACE_TYPE_60%>>
						    <TR>
								...
								<TD CLASS="TD6" NOWRAP><script language =javascript src='./js/h2017oa1_txtBas_dt_txtBas_dt.js'></script></TD>
							</TR>
						    <TR>
							...
							<TR>
							    <TD CLASS=TD5 NOWRAP>직종</TD>
						  		<TD CLASS=TD6 NOWRAP><SELECT ID="cboOcpt_type" NAME="cboOcpt_type" ALT="직종" STYLE="WIDTH: 100px" TAG="11XXXU"><OPTION VALUE=""></OPTION></SELECT></td>
						  	</TR>
							<TR>			
								...
								<TD CLASS=TD6 NOWRAP><INPUT ID="txtFr_dept_cd" NAME="txtFr_dept_cd" ALT="부서코드" TYPE="Text" SiZE=10 MAXLENGTH=10 tag="11XXXU"><IMG SRC="../../../CShared/image/btnPopup.gif" NAME="btnSItemDC" ALIGN=top TYPE="BUTTON" ONCLICK="vbscript:Call OpenDept(0)">
			                                         <INPUT ID="txtFr_dept_nm" NAME="txtFr_dept_nm" ALT="부서코드명" TYPE="Text" SiZE=20 MAXLENGTH=40 tag="14XXXU">부터
			                                         <INPUT ID="txtFr_internal_cd" NAME="txtFr_internal_cd" ALT="내부부서코드" TYPE="HIDDEN" SiZE=7 MAXLENGTH=7 tag="14XXXU"></td>
		                    </TR>
		                    <TR>    
		                        <TD CLASS=TD5 NOWRAP></TD>
								<TD CLASS=TD6 NOWRAP><INPUT ID="txtto_dept_cd" NAME="txtto_dept_cd" MAXLENGTH="10" SIZE=10 ALT ="Order ID" tag="11XXXU"><IMG SRC="../../../CShared/image/btnPopup.gif" NAME="btnname" ALIGN=top TYPE="BUTTON" ONCLICK="vbscript:Call OpenDept(1)">
							                         <INPUT ID="txtto_dept_nm" NAME="txtto_dept_nm" MAXLENGTH="40" SIZE=20 ALT ="Order ID" tag="14XXXU">까지
