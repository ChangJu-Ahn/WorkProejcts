...
'*  3. Program ID           : h2013oa1
'*  4. Program Name         : 경력사항출력 
'*  5. Program Desc         : 경력사항출력 
'*  6. Comproxy List        : +
...
Function FncBtnPrint() 
	...
	ObjName = AskEBDocumentName("h2013oa1","ebr")
					...
					<TD CLASS="CLSMTABP">
						<TABLE ID="MyTab" CELLSPACING=0 CELLPADDING=0>
							<TR>
								...
								<td background="../../../CShared/image/table/seltab_up_bg.gif" align="center" CLASS="CLSMTAB"><font color=white>경력사항출력</font></td>
