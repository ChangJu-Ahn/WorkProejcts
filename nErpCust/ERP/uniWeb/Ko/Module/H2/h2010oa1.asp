...
'*  4. Program Name         : 인사기록카드출력 
'*  5. Program Desc         : 인사기록카드출력 
'*  6. Comproxy List        : +
...
Function FncBtnPrint() 
    ...
    Dim StrEbrFile, tdate, strMonth, strDay
    dim ObjName	
	...
	Dim bas_dt, bas1_dt, emp_no, ocpt_type
	Dim Fr_dept_cd , To_dept_cd, rFrDept ,rToDept ,IntRetCd
	
	StrEbrFile = "h2010oa1.ebr"
	tdate  = "<%=GetsvrDate%>"
	bas_dt = UNIDateAdd("yyyy", -1 ,tDate, parent.gAPDateFormat)
	
	Call ExtractDateFrom(tdate, parent.gAPDateFormat, parent.gAPDateSeperator, bas1_dt, strMonth, strDay)
	...
	ObjName = AskEBDocumentName("h2010oa1","ebr")
...
Function FncBtnPreview()
	...
	dim ObjName	
	Dim bas_dt, bas1_dt, emp_no, ocpt_type
	Dim Fr_dept_cd , To_dept_cd, rFrDept ,rToDept ,IntRetCd, tdate, strMonth, strDay
					...
					<TD CLASS="CLSMTABP">
						<TABLE ID="MyTab" CELLSPACING=0 CELLPADDING=0>
							<TR>
								...
								<td background="../../../CShared/image/table/seltab_up_bg.gif" align="center" CLASS="CLSMTAB"><font color=white>인사기록카드출력</font></td>
					...
					<TD HEIGHT=20>
						<TABLE <%=LR_SPACE_TYPE_60%>>
						    <TR>
								...
								<TD CLASS="TD6" NOWRAP><INPUT TYPE="Text" ID="txtEmp_no" NAME="txtEmp_no" ALT="대상자" SIZE=13 MAXLENGTH=13 tag="11XXXU"><IMG SRC="../../../CShared/image/btnPopup.gif" NAME="btnAcctCdFR" ALIGN=top TYPE="BUTTON" ONCLICK="vbscript:OpenEmptName (1)">
								                       <INPUT TYPE="Text" ID="txtName" NAME="txtName" ALT="대상자코드명" SIZE=20 MAXLENGTH=30 tag="14"></TD>
							</TR>
							    <TD CLASS=TD5 NOWRAP>직종</TD>
						  		<TD CLASS=TD6 NOWRAP><SELECT ID="cboOcpt_type" NAME="cboOcpt_type" ALT="직종" CLASS ="cbonormal" TAG="11XXXU"><OPTION VALUE=""></OPTION></SELECT>		
							<TR>
								...
								<TD CLASS=TD6 NOWRAP><INPUT ID="txtFr_dept_cd" NAME="txtFr_dept_cd" ALT="부서코드" TYPE="Text" SiZE="10" MAXLENGTH="10" tag="11XXXU"><IMG SRC="../../../CShared/image/btnPopup.gif" NAME="btnSItemDC" ALIGN=top TYPE="BUTTON" ONCLICK="vbscript:Call OpenDept(0)">
			                                         <INPUT ID="txtFr_dept_nm" NAME="txtFr_dept_nm" ALT="부서코드명" TYPE="Text" SiZE="20" MAXLENGTH="40" tag="14">부터
		                                             <INPUT ID="txtFr_internal_cd" NAME="txtFr_internal_cd" ALT="내부부서코드" TYPE="HIDDEN" SiZE="7" MAXLENGTH="7" tag="14">
		                    </TR>
		                    <TR>    
		                        <TD CLASS=TD5 NOWRAP></TD>
								<TD CLASS=TD6 NOWRAP><INPUT ID="txtTo_dept_cd" NAME="txtTo_dept_cd" ALT ="부서코드" MAXLENGTH="10" SIZE="10" tag="11XXXU"><IMG SRC="../../../CShared/image/btnPopup.gif" NAME="btnname" ALIGN=top TYPE="BUTTON" ONCLICK="vbscript:Call OpenDept(1)">
							                         <INPUT ID="txtTo_dept_nm" NAME="txtTo_dept_nm" ALT ="부서코드명" MAXLENGTH="40" SIZE="20" tag="14">까지
    			                                     <INPUT ID="txtTo_internal_cd" NAME="txtTo_internal_cd" ALT="내부부서코드" TYPE="HIDDEN" SiZE="7" MAXLENGTH="7" tag="14"></TD>
    			            </TR> 
    					</TABLE>
					</TD>
				</TR>
