...
'*  3. Program ID           : h2011oa1
'*  4. Program Name         : 사원명부출력 
'*  5. Program Desc         : 사원명부출력 
'*  6. Comproxy List        : +
...
Function FncBtnPrint() 
	...
	ObjName = AskEBDocumentName("h2011oa1","ebr")
					...
					<TD CLASS="CLSMTABP">
						<TABLE ID="MyTab" CELLSPACING=0 CELLPADDING=0>
							<TR>
								...
								<td background="../../../CShared/image/table/seltab_up_bg.gif" align="center" CLASS="CLSMTAB"><font color=white>사원명부출력</font></td>
