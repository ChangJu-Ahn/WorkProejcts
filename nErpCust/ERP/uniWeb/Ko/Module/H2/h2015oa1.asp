...
'*  3. Program ID           : h2015oa1
'*  4. Program Name         : 자격/면허출력 
'*  5. Program Desc         : 자격/면허출력 
'*  6. Comproxy List        : +
...
Function FncBtnPrint() 
	...
	ObjName = AskEBDocumentName("h2015oa1","ebr")
					...
					<TD CLASS="CLSMTABP">
						<TABLE ID="MyTab" CELLSPACING=0 CELLPADDING=0>
							<TR>
								...
								<td background="../../../CShared/image/table/seltab_up_bg.gif" align="center" CLASS="CLSMTAB"><font color=white>자격/면허출력</font></td>
