...
Sub SubBizDelete()
	...
	' 디테일부터 제거한다.
    lgStrSQL =            "DELETE TB_10A WITH (ROWLOCK) " & vbCrLf
...
Sub SubBizQuery()
    ...
    Else
        ...
        Do While Not lgObjRs.EOF
			...
			lgstrData = lgstrData & Chr(11) & ConvSPChars(lgObjRs("W2_1"))	
			lgstrData = lgstrData & Chr(11) & ConvSPChars(lgObjRs("W2_2"))
...
Sub SubMakeSQLStatements(pMode,pCode1, pCode2, pCode3)
    Select Case pMode 
      Case "R"
			lgStrSQL =			  " SELECT  "
            lgStrSQL = lgStrSQL & " A.SEQ_NO, A.W1, A.W2_1, A.W2_2, A.W3, A.W4, A.W5, A.W6 "
            lgStrSQL = lgStrSQL & " FROM TB_10A A WITH (NOLOCK) " & vbCrLf
...
Sub SubBizSaveMultiCreate(arrColVal)
	...
	lgStrSQL = "INSERT INTO TB_10A WITH (ROWLOCK) ("
	lgStrSQL = lgStrSQL & " CO_CD, FISC_YEAR, REP_TYPE, SEQ_NO, W1, W2_1, W2_2, W3, W4, W5, W6 "  
	...
	lgStrSQL = lgStrSQL & FilterVar(Trim(UCase(arrColVal(C_W2_1))),"''","S")	& ","
	lgStrSQL = lgStrSQL & FilterVar(Trim(UCase(arrColVal(C_W2_2))),"''","S")	& ","
	lgStrSQL = lgStrSQL & FilterVar(UNIConvDateCompanyToDB(arrColVal(C_W3), ""),"NULL","S")		& ","  
...
Sub SubBizSaveMultiUpdate(arrColVal)
    ...
    lgStrSQL = "UPDATE  TB_10A WITH (ROWLOCK) "
    
    lgStrSQL = lgStrSQL & " SET " 
    
	lgStrSQL = lgStrSQL & " W1		= " &  FilterVar(Trim(UCase(arrColVal(C_W1))),"''","S")	& ","
	lgStrSQL = lgStrSQL & " W2_1	= " &  FilterVar(Trim(UCase(arrColVal(C_W2_1))),"''","S")	& ","
	lgStrSQL = lgStrSQL & " W2_2	= " &  FilterVar(Trim(UCase(arrColVal(C_W2_2))),"''","S")	& ","
	lgStrSQL = lgStrSQL & " W3		= " &  FilterVar(UNIConvDateCompanyToDB(arrColVal(C_W3), ""),"NULL","S")		& ","  
	...
	lgStrSQL = lgStrSQL & "		AND SEQ_NO = " & FilterVar(UNICDbl(arrColVal(C_SEQ_NO), "0"),"1","D") 
...
Sub SubBizSaveMultiDelete(arrColVal)
    ...
    lgStrSQL = "DELETE  TB_10A WITH (ROWLOCK) "
 	lgStrSQL = lgStrSQL & " WHERE CO_CD = " & FilterVar(Trim(UCase(wgCO_CD)),"''","S") 	 & vbCrLf
	lgStrSQL = lgStrSQL & "		AND FISC_YEAR = " & FilterVar(Trim(UCase(sFISC_YEAR)),"''","S") 	 & vbCrLf
