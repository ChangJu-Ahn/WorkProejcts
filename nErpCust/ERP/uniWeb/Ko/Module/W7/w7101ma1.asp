...
'*  4. Program Name         : w7101mA1.asp
'*  5. Program Desc         : 제10호 원천납부세액명세서 
...
Const BIZ_MNU_ID		= "w7101mA1"
Const BIZ_PGM_ID		= "w7101mB1.asp"											 '☆: 비지니스 로직 ASP명 
Const BIZ_REF_PGM_ID	= "W7101MB2.asp"
Const EBR_RPT_ID		 = "w7101OA1"
...
Sub InitSpreadComboBox()
	...
	' -- 세율개정 15% -> 14% 
	'IntRetCD1 = CommonQueryRs("B.REFERENCE", "B_CONFIGURATION B", " B.MAJOR_CD='W2010' AND B.SEQ_NO = 2 ", lgF0, lgF1, lgF2, lgF3, lgF4, lgF5, lgF6)  
	...
	If IntRetCD1 <> False Then
		...
		ggoSpread.SetCombo Replace(lgF0, Chr(11), vbTab), C_W5
	End If
...
Sub InitSpreadSheet()
	...
	With Frm1.vspdData
		...
		ggoSpread.SSSetEdit		C_W1,		"(1)적요",			15,,,25,1
		'ggoSpread.SSSetMask		C_W2_1,		"(2)원천징수의무자"	, 17, 2, "999-99-99999" 
		ggoSpread.SSSetEdit		C_W2_1,		"(2)원천징수의무자",			17,2,,13,1
	    ggoSpread.SSSetEdit		C_W2_2,	"상호(성명)",			10,,,25,1
	    ggoSpread.SSSetDate		C_W3,		"(3)원천징수일",			12, 2, parent.gDateFormat
	    ggoSpread.SSSetFloat	C_W4,		"(4)이자금액",		15,		Parent.ggAmtOfMoneyNo,		ggStrIntegeralPart,		ggStrDeciPointPart,		Parent.gComNum1000,		Parent.gComNumDec ,,,,"0","" 
	    ggoSpread.SSSetCombo	C_W5,		"(5)세율",		12
	    ggoSpread.SSSetFloat	C_W6,		"(6)법인세",		15,		Parent.ggAmtOfMoneyNo,		ggStrIntegeralPart,		ggStrDeciPointPart,		Parent.gComNum1000,		Parent.gComNumDec ,,,,"0","" 

	    
	    ret = .AddCellSpan(0, -1000, 1, 2)
	    ret = .AddCellSpan(C_SEQ_NO, -1000, 1, 2)
	    ret = .AddCellSpan(C_W1, -1000, 1, 2)
	    ret = .AddCellSpan(C_W2_1, -1000, 2, 1)
...
Sub SetSpreadLock()
	...
	With Frm1.vspdData
		...
		ggoSpread.SpreadUnLock C_W1, -1, C_W6	' 전체 적용 
'		ggoSpread.SpreadLock C_PGM_ID, -1, C_PGM_ID	' 전체 적용 

		ggoSpread.SSSetRequired C_W1, -1, -1
		'ggoSpread.SSSetRequired C_W2_1, -1, -1
		ggoSpread.SSSetRequired C_W2_2, -1, -1
...
Sub SetSpreadColor(ByVal pvStartRow, ByVal pvEndRow)
	...
	With Frm1.vspdData
		...
		For iRow = pvStartRow To pvEndRow
			...
			.Row = iRow
			If .Text = "999999" Then
				ggoSpread.SpreadLock C_W1,   iRow, C_W6, iRow

				Call .AddCellSpan(C_W1, iRow, 3, 1) 
				.Col = C_W1	:	.CellType = 1	:	.Text = "합계"	:	.TypeHAlign = 2
				.Col = C_W5	:	.CellType = 1	:	.Text = ""
			Else
				ggoSpread.SpreadUnLock C_W1, iRow, C_W6, iRow	' 전체 적용 
				ggoSpread.SSSetRequired C_W1, iRow, iRow
				'ggoSpread.SSSetRequired C_W2_1, iRow, iRow
				ggoSpread.SSSetRequired C_W2_2, iRow, iRow
				ggoSpread.SSSetRequired C_W3, iRow, iRow
				ggoSpread.SpreadLock C_W4, iRow, C_W4
				ggoSpread.SpreadLock C_Seq_no, iRow, C_Seq_no
...
Sub RedrawSumRow()
	...
	ggoSpread.Source = Frm1.vspdData
	With Frm1.vspdData
		ggoSpread.SpreadUnLock C_W1, iRow, C_W6, .MaxRows - 1	' 전체 적용 
		ggoSpread.SSSetRequired C_W1, iRow, .MaxRows - 1
		'ggoSpread.SSSetRequired C_W2_1, iRow, .MaxRows - 1
		ggoSpread.SSSetRequired C_W2_2, iRow, .MaxRows - 1
		ggoSpread.SSSetRequired C_W3, iRow, .MaxRows - 1
		ggoSpread.SpreadLock C_W4, iRow, C_W4, .MaxRows - 1
		ggoSpread.SSSetRequired C_W5, iRow, .MaxRows - 1
		ggoSpread.SSSetRequired C_W6, iRow, .MaxRows - 1

		ggoSpread.SpreadLock C_W1,   .MaxRows, C_W6, .MaxRows
...
Sub GetSpreadColumnPos(ByVal pvSpdNo)
    ...
    Select Case UCase(pvSpdNo)
       Case "A"
            ...
            C_W2_1		= iCurColumnPos(3)
            C_W2_2		= iCurColumnPos(4)
...
Function Fn_GridCalc(ByVal pCol, ByVal pRow)
	...
	With Frm1.vspdData
		...
		If pCol = C_W5 Or pCol = C_W6 Then
			.Row = iRow	:	.Col = C_W6	:	dblW6 = UNICdbl(.Text)
			.Row = iRow	:	.Col = C_W5	:	dblW5 = UNICdbl(Replace(.Text, "%", "")) / 100
			If dblW5 > 0 Then
				.Row = iRow	:	.Col = C_W4	:	dblW4 = dblW6 / dblW5
				.Text = dblW4
			Else
				.Text = 0
			End If
