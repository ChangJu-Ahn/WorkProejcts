...
'        Call SubSkipRs(lgObjRs,C_SHEETMAXROWS_D * lgStrPrevKey)
        ...
        Do While Not lgObjRs.EOF
			...
			lgstrData = lgstrData & Chr(11) & ConvSPChars(lgObjRs("W_CD"))
...
Sub SubMakeSQLStatements(pMode,pCode1, pCode2, pCode3)
    Select Case pMode 
      Case "R"
			lgStrSQL =			  " SELECT  "
            lgStrSQL = lgStrSQL & "   W_CD " & vbCrLf
            lgStrSQL = lgStrSQL & "	, W1, W2, W3, W4, W5, W_DESC "
            lgStrSQL = lgStrSQL & " FROM DBO.ufn_TB_50A_GetRef( " & pCode1 	 & "," & pCode2 	 & "," & pCode3 	& ") "	 & vbCrLf


            lgStrSQL = lgStrSQL & " ORDER BY  W_CD ASC" & vbcrlf
