...
Sub SubBizDelete()
	...
	' 디테일부터 제거한다.
    lgStrSQL =            "DELETE TB_50B WITH (ROWLOCK) " & vbCrLf
...
Sub SubMakeSQLStatements(pMode,pCode1, pCode2, pCode3)
    Select Case pMode 
      Case "R1"
			lgStrSQL =			  " SELECT  "
            lgStrSQL = lgStrSQL & " A.SEQ_NO, A.W1, B.ITEM_NM AS W1_NM, A.W2, A.W3, A.W4, A.W5, A.W_DESC "
            lgStrSQL = lgStrSQL & " FROM TB_50B A WITH (NOLOCK), TB_ADJUST_ITEM B WITH (NOLOCK) "
...
Sub SubBizSaveMultiCreate(arrColVal)
	...
	lgStrSQL = "INSERT INTO TB_50B WITH (ROWLOCK) ("
	lgStrSQL = lgStrSQL & " CO_CD, FISC_YEAR, REP_TYPE, SEQ_NO, W1, W2, W3, W4, W5, W_DESC "  
...
Sub SubBizSaveMultiUpdate(arrColVal)
    ...
    lgStrSQL = "UPDATE  TB_50B WITH (ROWLOCK) "
...
Sub SubBizSaveMultiDelete(arrColVal)
    ...
    lgStrSQL = "DELETE  TB_50B WITH (ROWLOCK) "
 	lgStrSQL = lgStrSQL & " WHERE CO_CD = " & FilterVar(Trim(UCase(wgCO_CD)),"''","S") 	 & vbCrLf
	lgStrSQL = lgStrSQL & "		AND FISC_YEAR = " & FilterVar(Trim(UCase(sFISC_YEAR)),"''","S") 	 & vbCrLf
