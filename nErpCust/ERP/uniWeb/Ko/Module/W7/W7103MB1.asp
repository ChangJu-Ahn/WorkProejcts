...
Sub SubBizDelete()
	...
	' 디테일부터 제거한다.
    lgStrSQL =            "DELETE TB_ORIGIN_PAY_TAX WITH (ROWLOCK) " & vbCrLf
...
Sub SubMakeSQLStatements(pMode,pCode1, pCode2, pCode3)
    Select Case pMode 
      Case "R"
			lgStrSQL =			  " SELECT  "
            lgStrSQL = lgStrSQL & " A.SEQ_NO, A.W1, B.ACCT_NM AS W1_NM, A.W2, A.W3, A.W4, A.W5, A.W6, A.W7, A.W8, A.W9 "
            lgStrSQL = lgStrSQL & " FROM TB_ORIGIN_PAY_TAX A WITH (NOLOCK), " & vbCrLf
...
Sub SubBizSaveMultiCreate(arrColVal)
	...
	lgStrSQL = "INSERT INTO TB_ORIGIN_PAY_TAX WITH (ROWLOCK) ("
	lgStrSQL = lgStrSQL & " CO_CD, FISC_YEAR, REP_TYPE, SEQ_NO, W1, W2, W3, W4, W5, W6, W7, W8, W9 "  
...
Sub SubBizSaveMultiUpdate(arrColVal)
    ...
    lgStrSQL = "UPDATE  TB_ORIGIN_PAY_TAX WITH (ROWLOCK) "
...
Sub SubBizSaveMultiDelete(arrColVal)
    ...
    lgStrSQL = "DELETE  TB_ORIGIN_PAY_TAX WITH (ROWLOCK) "
 	lgStrSQL = lgStrSQL & " WHERE CO_CD = " & FilterVar(Trim(UCase(wgCO_CD)),"''","S") 	 & vbCrLf
	lgStrSQL = lgStrSQL & "		AND FISC_YEAR = " & FilterVar(Trim(UCase(sFISC_YEAR)),"''","S") 	 & vbCrLf
