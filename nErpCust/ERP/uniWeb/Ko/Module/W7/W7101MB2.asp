...
Sub SubMakeSQLStatements(pMode,pCode1, pCode2, pCode3)
    Select Case pMode 
      Case "R"
            ...
            lgStrSQL = lgStrSQL & "	, W1, W2_1, W2_2, W3, W4, W5, W6 "
            lgStrSQL = lgStrSQL & " FROM DBO.ufn_TB_10A_GetRef( " & pCode1 	 & "," & pCode2 	 & "," & pCode3 	& ") "	 & vbCrLf


            lgStrSQL = lgStrSQL & " ORDER BY  SEQ_NO ASC" & vbcrlf
		Case "RD"
			lgStrSQL =	  "exec  usp_TB_ORIGIN_PAY_TAX_del   " & pCode1 	 & "," & pCode2 	 & "," & pCode3 	 
