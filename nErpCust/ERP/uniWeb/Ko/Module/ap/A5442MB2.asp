...
'============================================================================================================
Sub  TrimData()
     strFrDt		= Trim(UNIConvDateToYYYYMMDD(Request("txtApFrDt"),gDateFormat,""))
     strToDt		= Trim(UNIConvDateToYYYYMMDD(Request("txtApToDt"),gDateFormat,""))
...
Sub  SubPreQueryBySp()
	lgStrSQL = ""
	lgStrSQL = lgStrSQL & " DELETE FROM A_TMP_AP_TRACE_LIST WHERE QUERY_ID < CONVERT(VARCHAR(8),  GETDATE(),112)"
    ...
    CONST CALLSPNAME = "A_USP_FROM_AP_TO_GL_TRACE"
...
Sub SubBizQueryMulti()
	...
	lgStrSQL = lgStrSQL & " SUM(CASE WHEN AP_FG=" & FilterVar("AP", "''", "S") & "  THEN ITEM_LOC_AMT ELSE 0 END) AP_LOC_AMT , "
	...
	If Trim(Request("txtShowBp")) = "Y" Then
		lgStrSQL = lgStrSQL & " ,PAY_BP_CD,BP_NM "
	End If
	
	lgStrSQL = lgStrSQL & " FROM A_TMP_AP_TRACE_LIST "
	...
	If UCase(Trim(Request("DispMeth"))) Then 
		lgStrSQL = lgStrSQL & " HAVING ISNULL(SUM(CASE WHEN AP_FG=" & FilterVar("AP", "''", "S") & "  THEN ITEM_LOC_AMT ELSE 0 END),0) "
		lgStrSQL = lgStrSQL & "  <> ISNULL(SUM(CASE WHEN AP_FG=" & FilterVar("GL", "''", "S") & "  THEN ITEM_LOC_AMT ELSE 0 END),0) "
	End If		
	...
	End If
	If Trim(Request("txtShowBp")) = "Y" Then
		lgStrSQL = lgStrSQL & " , PAY_BP_CD ASC "
	End If
