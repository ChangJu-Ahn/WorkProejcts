...
'*  2. Function Name        : A/P
'*  3. Program ID           : a4115ma1
'*  4. Program Name         : 채무CheckList출력 
'*  5. Program Desc         : Report of A/P CheckList
'*  6. Comproxy List        : 
...
Function SetPrintCond(StrEbrFile, StrUrl)
	...
	VarDateFr = UNIConvDate(frm1.fpDateFr.Text)
	VarDateTo = UNIConvDate(frm1.fpDateTo.Text)
