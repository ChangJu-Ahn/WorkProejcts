...
'**********************************************************************************************
'*  1. Module명          : 회계 
'*  2. Function명        : Multi Alloction Payment Query
'*  3. Program ID        : a4125mb1
'*  4. Program 이름      : 멀티출금(조회)
'*  5. Program 설명      : 멀티출금 조회 
...
Dim E1_a_allc_Paym 
Const A290_E1_allc_Paym_allc_dt = 0
Const A290_E1_allc_Paym_bp_cd = 1
Const A290_E1_allc_Paym_bp_nm = 2
Const A290_E1_allc_Paym_org_change_id = 3
Const A290_E1_allc_Paym_dept_cd = 4
Const A290_E1_allc_Paym_dept_nm = 5
Const A290_E1_allc_Paym_temp_gl_no = 6
Const A290_E1_allc_Paym_gl_no = 7
Const A290_E1_allc_Paym_desc = 8
...
Const A290_EG1_E2_Paym_type = 1
Const A290_EG1_E2_Paym_type_nm = 2
...
Const A290_EG3_E3_dc_desc = 8
	...
	I1_a_Paym_no = Trim(Request("txtPaymNO"))

	'-----------------------------------------
	'Com Action Area
	'-----------------------------------------
	Set iPAPG070 = Server.CreateObject("PAPG070.cALkUpPaymMultiSvr")

	If CheckSYSTEMError(Err,True) = True Then
		Response.End																			'☜: 비지니스 로직 처리를 종료함 
	End If

	Call iPAPG070.A_LOOKUP_ALLC_PAYM_MULTI_SVR(gStrGlobalCollection, I1_a_Paym_no, E1_a_allc_Paym,E2_a_sum_amt, _
	...
	'-----------------------
	If CheckSYSTEMError(Err,True) = True Then
		Set iPARG070 = Nothing																	'☜: ComProxy Unload
		Response.End																			'☜: 비지니스 로직 처리를 종료함 
	End If
		
	Set iPAPG070 = Nothing

	'//////////////////////////////////////////////////////////////////
	'  멀티입금 헤더 정보 
	'//////////////////////////////////////////////////////////////////
	txthOrgChangeId = ConvSPChars(E1_a_allc_Paym(A290_E1_allc_Paym_org_change_id))


	Response.Write "<Script Language=vbscript>"																		   & vbCr
	Response.Write " With parent.frm1 "																				   & vbCr

	Response.Write ".txtPaymNo.value	 = """ & ConvSPChars(I1_a_Paym_no)										& """" & vbCr
	Response.Write ".txtPaymDt.text		= """ & UNIDateClientFormat(E1_a_allc_Paym(A290_E1_allc_Paym_allc_dt))	& """" & vbCr
	Response.Write ".txtBpCd.Value		 = """ & ConvSPChars(E1_a_allc_Paym(A290_E1_allc_Paym_bp_cd))			& """" & vbCr
	Response.Write ".txtBpNm.Value		 = """ & ConvSPChars(E1_a_allc_Paym(A290_E1_allc_Paym_bp_nm))			& """" & vbCr
	Response.Write ".txtDeptCd.Value	 = """ & ConvSPChars(E1_a_allc_Paym(A290_E1_allc_Paym_dept_cd))			& """" & vbCr
	Response.Write ".txtDeptNm.Value	 = """ & ConvSPChars(E1_a_allc_Paym(A290_E1_allc_Paym_dept_nm))									& """" & vbCr
	...
	Response.Write ".txtAPClsLocAmt.text = """ & UNIConvNumDBToCompanyByCurrency(E2_a_sum_amt(A290_E2_cls_amt_tot),gCurrency,ggAmtOfMoneyNo, gLocRndPolicyNo, "X")	  & """" & vbCr
	...
	Response.Write ".txtTempGLNo.value	 = """ & ConvSPChars(E1_a_allc_Paym(A290_E1_allc_Paym_temp_gl_no))		& """" & vbCr
	Response.Write ".txtGLNo.value		 = """ & ConvSPChars(E1_a_allc_Paym(A290_E1_allc_Paym_gl_no ))			& """" & vbCr		
	...
	If Not Missing(EG1_export_group_allc) And Not IsEmpty(EG1_export_group_allc) Then
		For IntRows = 0 To intCount
			lgCurrency = EG1_export_group_allc(IntRows,A290_EG1_E3_doc_cur)
   		    ...
   		    strData = strData & Chr(11) & ConvSPChars(EG1_export_group_allc(IntRows,A290_EG1_E2_Paym_type))
   		    strData = strData & Chr(11) & ""   	    
   		    strData = strData & Chr(11) & ConvSPChars(EG1_export_group_allc(IntRows,A290_EG1_E2_Paym_type_nm))
	...
	If Not Missing(EG2_export_group_cls) And Not IsEmpty(EG2_export_group_cls) Then	
		For IntRows = 0 To intCount0
			lgCurrency = EG2_export_group_cls(intRows,A290_EG2_E2_doc_cur)
   		    ...
   		    strData = strData & Chr(11) & UNIConvNumDBToCompanyByCurrency(EG2_export_group_cls(intRows,A290_EG2_E2_xch_rate),gCurrency,ggAmtOfMoneyNo, gLocRndPolicyNo, "X")
		...
		Response.Write "	.ggoSpread.SSShowData """ & strData   & """ ,""F""" & vbCr
		Response.Write  "    Call .ReFormatSpreadCellByCellByCurrency(Parent.Frm1.vspdData1," & LngMaxRow + 1 & "," & LngMaxRow + iLngRow - 1 & ",.C_DocCur1,.C_ApBALAMT,   ""A"" ,""I"",""X"",""X"")" & vbCr
		Response.Write  "    Call .ReFormatSpreadCellByCellByCurrency(Parent.Frm1.vspdData1," & LngMaxRow + 1 & "," & LngMaxRow + iLngRow - 1 & ",.C_DocCur1,.C_ApCLSAMT,   ""A"" ,""I"",""X"",""X"")" & vbCr
		Response.Write  "    Call .ReFormatSpreadCellByCellByCurrency(Parent.Frm1.vspdData1," & LngMaxRow + 1 & "," & LngMaxRow + iLngRow - 1 & ",.C_DocCur1,.C_ApAMT,   ""A"" ,""I"",""X"",""X"")" & vbCr
		Response.Write  "    Call .ReFormatSpreadCellByCellByCurrency(Parent.Frm1.vspdData1," & LngMaxRow + 1 & "," & LngMaxRow + iLngRow - 1 & ",.C_DocCur1,.C_ApDCAMT,   ""A"" ,""I"",""X"",""X"")" & vbCr		
	...
	Response.Write "<Script Language=VBScript> "							   & vbCr  
	Response.Write " With parent "											   & vbCr 
	Response.Write " .frm1.txtPaymNo.value = """ & I1_a_Paym_no			& """" & vbCr
