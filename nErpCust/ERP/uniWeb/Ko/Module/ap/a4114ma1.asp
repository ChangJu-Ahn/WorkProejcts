...
'*  3. Program ID           : a4114ma1.asp
'*  4. Program Name         : 채무상세조회 
'*  5. Program Desc         :
'*  6. Comproxy List        : 
...
'========================================================================================================
Const BIZ_PGM_ID        = "a4114MB1.asp"                         '☆: Biz logic spread sheet for #1
Const BIZ_PGM_ID1       = "a4114MB2.asp"                         '☆: Biz logic spread sheet for #2
...
'==========================================================================================================
Sub  InitSpreadSheet()
    Call SetZAdoSpreadSheet("A4114MA01","S","A","V20021211",Parent.C_SORT_DBAGENT,frm1.vspdData, C_MaxKey, "X","X")
    Call SetZAdoSpreadSheet("A4114MA02","S","B","V20021211",Parent.C_SORT_DBAGENT,frm1.vspdData2,C_MaxKey_B, "X","X")
...
'=======================================================================================================
Function EscReturnVal(Field_fg)
...
Function  DbQuery(ByVal iOpt) 
    ...
    '--------------- 개발자 coding part(실행로직,Start)----------------------------------------------
				...
				strVal = strVal & "&txtApNo_ALT="		& .txtApNo.alt
     ...
     '--------- Developer Coding Part (End) ----------------------------------------------------------
		    ...
		    Case "2"        
    '--------------- 개발자 coding part(실행로직,Start)----------------------------------------------
				strVal = BIZ_PGM_ID1 & "?txtApNo="		& GetKeyPosVal("A",1)                     
'--------- Developer Coding Part (End) ----------------------------------------------------------      
						...
						<FIELDSET CLASS="CLSFLD">
							<TABLE <%=LR_SPACE_TYPE_40%>>
								...
								<TR>
									...
									<TD CLASS="TD6" NOWRAP><INPUT TYPE=TEXT NAME="txtDealBpCd" SIZE=10 MAXLENGTH=10 STYLE="TEXT-ALIGN: left" tag="1XXXXU" ALT="공급처"><IMG SRC="../../../CShared/image/btnPopup.gif" NAME="btnDeptCd" align=top TYPE="BUTTON" ONCLICK="vbscript:CALL OpenBp(frm1.txtDealBpCd.Value, 1)">&nbsp;<INPUT TYPE=TEXT NAME="txtDealBpNm" SIZE=25 tag="14"></TD>
									...
									<TD CLASS="TD6" NOWRAP><INPUT TYPE=TEXT NAME="txtPayBpCd" SIZE=10 MAXLENGTH=10 STYLE="TEXT-ALIGN: left" tag="11XXXU" ALT="지급처"><IMG SRC="../../../CShared/image/btnPopup.gif" NAME="btnBpCd" align=top TYPE="BUTTON" ONCLICK="vbscript:CALL OpenBp(frm1.txtPayBpCd.Value, 2)">&nbsp;<INPUT TYPE=TEXT NAME="txtPayBpNm" SIZE=25 tag="14"></TD>
									...
									<TD CLASS=TD6 NOWRAP><INPUT NAME="txtAcctCd" ALT="계정코드" MAXLENGTH="20" SIZE=10 STYLE="TEXT-ALIGN: Left" tag="11XXXU" ><IMG align=top name=btnCalType onclick="vbscript:CALL OpenAcctPopUp(frm1.txtAcctCd.value)" src="../../../CShared/image/btnPopup.gif"  TYPE="BUTTON"> 
														 <INPUT NAME="txtAcctnm" ALT="계정코드명" MAXLENGTH="20"  tag="14"></TD>
								</TR>
								<TR>
									<TD CLASS="TD5" NOWRAP>채무번호</TD>
									<TD CLASS="TD6" NOWRAP><INPUT TYPE=TEXT NAME="txtApNo" MAXLENGTH=18 STYLE="TEXT-ALIGN: left" tag="11XXXU" ALT="채무번호"><IMG SRC="../../../CShared/image/btnPopup.gif" NAME="btnBpCd" align=top TYPE="BUTTON" ONCLICK="vbscript:OpenAPPopUp()"></TD>
					...
					<TD WIDTH=100% HEIGHT=* valign=top>
						<TABLE <%=LR_SPACE_TYPE_20%>>
							...
							<TR>
								...
								<TD CLASS=TDT NOWRAP><SCRIPT LANGUAGE=JavaScript> ExternalWrite('<OBJECT CLASSID=<%=gCLSIDFPDS%> name="txtTotApLocAmt" CLASS=FPDS140 title=FPDOUBLESINGLE ALT="채무액(자국)" tag="24X2" id=OBJECT1></OBJECT>');</SCRIPT></TD>
