...
Const BIZ_PGM_ID      = "A5443MB1.asp"						           '☆: Biz Logic ASP Name
Const BIZ_PGM_ID1     = "A5443MB2.asp"	
Const BIZ_PGM_ID2     = "A5443MB3.asp"	
...
Function  OpenPopupAllc()
	...
	iCalledAspName = AskPRAspName("a5443ra1")
	If Trim(iCalledAspName) = "" Then
		IntRetCD = DisplayMsgBox("900040", parent.VB_INFORMATION, "a5443ra1", "X")
		IsOpenPop = False
		Exit Function
	End If
...
Function  OpenPopUp(Byval strCode, Byval iWhere)
	...
	Select Case iWhere
		...
		Case 3
			...
			arrParam(4) = " MAJOR_CD=" & FilterVar("A1001", "''", "S") & "  AND MINOR_CD IN (" & FilterVar("PX", "''", "S") & " , " & FilterVar("LP", "''", "S") & " ," & FilterVar("CL", "''", "S") & "  ," & FilterVar("LR", "''", "S") & " ," & FilterVar("JP", "''", "S") & " ," & FilterVar("CP", "''", "S") & " , " & FilterVar("CR", "''", "S") & " ) " ' Where Condition
			arrParam(5) = "전표입력경로"			
				...
				<TR>
					...
					<TD CLASS="CLSMTABP">
						<TABLE ID="MyTab" CELLSPACING=0 CELLPADDING=0 onclick="ClickTab3()">
							<TR>
								<td background="../../image/table/tab_up_bg.gif"><IMG height=23 src="../../image/table/tab_up_left.gif" width=9></td>
								<td background="../../image/table/tab_up_bg.gif" align="center" CLASS="CLSMTABP"><font color=white>채무반제별발생금액</font></td>
								<td background="../../image/table/tab_up_bg.gif" align="right"><IMG height=23 src="../../image/table/tab_up_right.gif" width=10></td>
						    </TR>
						</TABLE>
					</TD>	
						...
						<FIELDSET CLASS="CLSFLD">
							<TABLE <%=LR_SPACE_TYPE_40%>>
								<TR>
									...
									<TD CLASS="TD6" NOWRAP>
									    <script language =javascript src='./js/a5443ma1_fpDateTime1_txtFrDt.js'></script>
									    &nbsp;~&nbsp;
									    <script language =javascript src='./js/a5443ma1_fpDateTime2_txtToDt.js'></script>
									</TD>
					...
					<TD WIDTH=100% HEIGHT=* VALIGN=TOP>
							...
							<TABLE <%=LR_SPACE_TYPE_60%>>
								<TR>
									<TD WIDTH=100% HEIGHT=100% COLSPAN=4>
										<script language =javascript src='./js/a5443ma1_OBJECT1_vspdData1.js'></script>
									</TD>
								</TR>
								<TR>
										...
										<FIELDSET CLASS="CLSFLD">
											<TABLE  <%=LR_SPACE_TYPE_20%>>
												<TR>
													...
													<TD CLASS=TD6 NOWRAP>
														<script language =javascript src='./js/a5443ma1_OBJECT1_txtTotAllcLocAmt1.js'></script>
													</TD>
													<TD class=TD5 STYLE="WIDTH : 0px;"></TD>												
													<TD CLASS="TD5" NOWRAP>차이금액합계</TD>
													<TD CLASS=TD6 NOWRAP>
														<script language =javascript src='./js/a5443ma1_OBJECT1_txtTotDiffLocAmt1.js'></script>
													</TD>
												</TR>
												<TR>
													<TD CLASS="TD5" NOWRAP>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;회계전표금액(자국)합계</TD>
													<TD CLASS=TD6 NOWRAP>
														<script language =javascript src='./js/a5443ma1_OBJECT1_txtTotGlLocAmt1.js'></script>
													</TD>
													<TD class=TD5 STYLE="WIDTH : 0px;"></TD>												
													<TD CLASS="TD5" NOWRAP>결의전표금액(자국)합계</TD>
													<TD CLASS=TD6 NOWRAP>
														<script language =javascript src='./js/a5443ma1_OBJECT1_txtTotTempGlLocAmt1.js'></script>
													</TD>
												</TR>
											</TABLE>
										</FIELDSET>
						...
						<DIV ID="TabDiv" SCROLL=no>
							<TABLE <%=LR_SPACE_TYPE_60%>>
								<TR>
									<TD WIDTH=100% HEIGHT=100% COLSPAN=4>
										<script language =javascript src='./js/a5443ma1_OBJECT1_vspdData2.js'></script>
									</TD>
								</TR>
								<TR>
									<TD HEIGHT=40 WIDTH=25%>
										<FIELDSET CLASS="CLSFLD">
											<TABLE  <%=LR_SPACE_TYPE_20%>>
												<TR>
													<TD CLASS="TD5" NOWRAP>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;반제금액(자국)합계</TD>
													<TD CLASS=TD6 NOWRAP>
														<script language =javascript src='./js/a5443ma1_OBJECT1_txtTotAllcLocAmt2.js'></script>
													</TD>
													<TD class=TD5 STYLE="WIDTH : 0px;"></TD>												
													<TD CLASS="TD5" NOWRAP>차이금액합계</TD>
													<TD CLASS=TD6 NOWRAP>
														<script language =javascript src='./js/a5443ma1_OBJECT1_txtTotDiffLocAmt2.js'></script>
													</TD>
												</TR>
												<TR>
													<TD CLASS="TD5" NOWRAP>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;회계전표금액(자국)합계</TD>
													<TD CLASS=TD6 NOWRAP>
														<script language =javascript src='./js/a5443ma1_OBJECT1_txtTotGlLocAmt2.js'></script>
													</TD>
													<TD class=TD5 STYLE="WIDTH : 0px;"></TD>												
													<TD CLASS="TD5" NOWRAP>결의전표금액(자국)합계</TD>
													<TD CLASS=TD6 NOWRAP>
														<script language =javascript src='./js/a5443ma1_OBJECT1_txtTotTempGlLocAmt2.js'></script>
													</TD>
												</TR>
											</TABLE>
										</FIELDSET>
						...
						<DIV ID="TabDiv" SCROLL=no>
							<TABLE <%=LR_SPACE_TYPE_60%>>
								<TR>
									<TD WIDTH=100% HEIGHT=100% COLSPAN=4>
										<script language =javascript src='./js/a5443ma1_OBJECT1_vspdData3.js'></script>
									</TD>
								</TR>
								<TR>
									<TD HEIGHT=40 WIDTH=25%>
										<FIELDSET CLASS="CLSFLD">
											<TABLE  <%=LR_SPACE_TYPE_20%>>
												<TR>
													<TD CLASS="TD5" NOWRAP>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;반제금액(자국)합계</TD>
													<TD CLASS=TD6 NOWRAP>
														<script language =javascript src='./js/a5443ma1_OBJECT1_txtTotAllcLocAmt3.js'></script>
													</TD>	
													<TD class=TD5 STYLE="WIDTH : 0px;"></TD>												
													<TD CLASS="TD5" NOWRAP>차이금액합계</TD>
													<TD CLASS=TD6 NOWRAP>
														<script language =javascript src='./js/a5443ma1_OBJECT1_txtTotDiffLocAmt3.js'></script>
													</TD>
												</TR>
												<TR>
													<TD CLASS="TD5" NOWRAP>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;회계전표금액(자국)합계</TD>
													<TD CLASS=TD6 NOWRAP>
														<script language =javascript src='./js/a5443ma1_OBJECT1_txtTotGlLocAmt3.js'></script>
													</TD>
													<TD class=TD5 STYLE="WIDTH : 0px;"></TD>												
													<TD CLASS="TD5" NOWRAP>결의전표금액(자국)합계</TD>
													<TD CLASS=TD6 NOWRAP>
														<script language =javascript src='./js/a5443ma1_OBJECT1_txtTotTempGlLocAmt3.js'></script>
													</TD>
												</TR>
											</TABLE>
										</FIELDSET>
