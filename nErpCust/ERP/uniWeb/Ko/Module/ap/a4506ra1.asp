...
Const BIZ_PGM_ID 		= "a4506rb1.asp"                              '☆: Biz Logic ASP Name
...
Sub InitSpreadSheet()
    ...
    Call SetZAdoSpreadSheet("A4506RA1","S","A","V20021211",PopupParent.C_SORT_DBAGENT,frm1.vspdData, C_MaxKey, "X","X")
    Call SetSpreadLock() 
...
Function SetPopUp(Byval arrRet, Byval iWhere)
	...
	Select Case iWhere
		...
		Case 4
				Frm1.txtApNoFr.value = arrRet(0)		
		Case 5
				Frm1.txtApNoTo.value = arrRet(0)		
	End Select	
...
Function DbQuery()
    ...
    '--------- Developer Coding Part (Start) ----------------------------------------------------------
        If lgIntFlgMode  <> PopupParent.OPMD_UMODE Then   ' This means that it is first search
			...
			strVal = strVal & "&txtApNoFr=" & Trim(.txtApNoFr.value)
			strVal = strVal & "&txtApNoTo=" & Trim(.txtApNoTo.value)
	    ...
	    Else
			...
			strVal = strVal & "&txtApNoFr=" & Trim(.htxtApNoFr.value)
			strVal = strVal & "&txtApNoTo=" & Trim(.htxtApNoTo.value)
			...
			<FIELDSET CLASS="CLSFLD">
				<TABLE <%=LR_SPACE_TYPE_40%>>
					<TR>				
						...
						<TD CLASS=TD6 NOWRAP>
							<script language =javascript src='./js/a4506ra1_I741814154_txtAdJustDtFr.js'></script>								
							&nbsp;~&nbsp;<script language =javascript src='./js/a4506ra1_I365818607_txtAdJustDtTo.js'></script></TD>												
						<TD CLASS=TD5 NOWRAP>거래처</TD>
						<TD CLASS=TD6 NOWRAP>
							<INPUT TYPE="Text" NAME="txtBpCd" SIZE=10 MAXLENGTH=10 tag="12NXXU" ALT="거래처"><IMG SRC="../../../CShared/image/btnPopup.gif" NAME="btnBizCd" ALIGN=top TYPE="BUTTON" ONCLICK="vbscript: CALL OpenPopUp(frm1.txtBpCd.value,1)">
					...
					<TR>
						...
						<TD CLASS=TD6 NOWRAP>
							<INPUT TYPE="Text" NAME="txtApNoFr" SIZE=10 MAXLENGTH=10 tag="11NXXU" ALT="채무번호"><IMG SRC="../../../CShared/image/btnPopup.gif" NAME="btnBizCd" ALIGN=top TYPE="BUTTON" ONCLICK="vbscript: CALL OpenPopUp(frm1.txtApNoFr.value,4)"> ~
							<INPUT TYPE="Text" NAME="txtApNoTo" SIZE=10 MAXLENGTH=10 tag="11NXXU" ALT="채무번호"><IMG SRC="../../../CShared/image/btnPopup.gif" NAME="btnBizCd" ALIGN=top TYPE="BUTTON" ONCLICK="vbscript: CALL OpenPopUp(frm1.txtApNoTo.value,5)"> 
						</TD>
					</TR>
				</TABLE>
			</FIELDSET>
	...
	<TR HEIGHT=100%>
		<TD WIDTH=100% HEIGHT=* VALIGN=TOP>
			<TABLE <%=LR_SPACE_TYPE_20%>>
				<TR HEIGHT=100%>
					<TD WIDTH=100%>
						<script language =javascript src='./js/a4506ra1_I495752269_vspdData.js'></script>
					</TD>
				</TR>
			</TABLE>
		</TD>
...
<INPUT TYPE=HIDDEN NAME="htxtApNoFr"		tag="24">
<INPUT TYPE=HIDDEN NAME="htxtApNoTo"        tag="24">
