...
CONST BIZ_PGM_ID = "B81108QB1.ASP"
...
Sub InitSpreadSheet()
	...
	With frm1.vspdData
	   ...
	   .MaxRows = 0
		...
		ggoSpread.SSSetEdit   C_ITEM_KIND,		"품목구분", 15 
		...
		ggoSpread.SSSetEdit   C_INSERT_USER_ID, "의뢰자", 12,,,,2  
		ggoSpread.SSSetEdit   C_REQ_DT,			"의뢰일", 15,,,,2
		ggoSpread.SSSetEdit   C_END_DT,			"완료일", 15,,,,2
...
Sub vspdData_Click(ByVal Col, ByVal Row)	'###그리드 컨버전 주의부분###
	Call SetPopupMenuItemInf("1101111111")         '화면별 설정 
 	...
 	lgAcct_item_cd=GetSpreadText(frm1.vspdData,C_ITEM_KIND,Row,"X","X")
...
Function DbQuery() 
	...
	'	Else	
		    ...
		    strVal = strVal & "&txtFromReqDt=" & UniConvDateAToB(Trim(.txtFromReqDt.text),parent.gDateFormat,parent.gServerDateFormat)
		    strVal = strVal & "&txtToReqDt=" & UniConvDateAToB(Trim(.txtToReqDt.text),parent.gDateFormat,parent.gServerDateFormat)
		    strVal = strVal & "&txtFromEndDt=" & UniConvDateAToB(Trim(.txtFromEndDt.text),parent.gDateFormat,parent.gServerDateFormat) 
		    strVal = strVal & "&txtToEndDt=" & UniConvDateAToB(Trim(.txtToEndDt.text),parent.gDateFormat,parent.gServerDateFormat)
		    strVal = strVal & "&lgStrToKey="	 & lgStrToKey	
			...
			<TABLE <%=LR_SPACE_TYPE_20%>>
				...
				<TR>
					...
					<TR>
                            ...
                            <INPUT TYPE="RADIO" NAME="rbo_status" ID="rbo_status3" VALUE="'E','S','T'" CLASS="RADIO" TAG="11"><LABEL FOR="rbo_status3">완료</LABEL>
                            
                            
							</TD>
							<TD CLASS="TD5" NOWRAP>완료기간</TD>
							<TD CLASS="TD6" NOWRAP >
							<script language =javascript src='./js/b81108qa1_OBJECT2_txtFromEndDt.js'></script>&nbsp;~&nbsp;
							<script language =javascript src='./js/b81108qa1_OBJECT3_txtToEndDt.js'></script>
							</TD>
						
						</TR>
					<TR>
							<TD CLASS="TD5" NOWRAP>의뢰기간</TD>
							<TD CLASS="TD6" NOWRAP >
							<script language =javascript src='./js/b81108qa1_OBJECT2_txtFromReqDt.js'></script>&nbsp;~&nbsp;
							<script language =javascript src='./js/b81108qa1_OBJECT3_txtToReqDt.js'></script>
							<TD CLASS="TD5" NOWRAP>의뢰자</TD>
							<TD CLASS="TD6" NOWRAP><INPUT TYPE=TEXT ALT="의뢰자" NAME="txtreq_user" SIZE=10 MAXLENGTH=10  tag="11NXXU" ><IMG SRC="../../../CShared/image/btnPopup.gif" NAME="btnPlantCd" align=top TYPE="BUTTON" ONCLICK='vbscript:OpenPopupw "req_user","txtreq_user"'>&nbsp;<INPUT TYPE=TEXT NAME="txtreq_user_nm" SIZE=20 MAXLENGTH=20 ALT="의뢰자" tag="14X">
						...
						<TR>
							...
							<TD CLASS="TD6" NOWRAP><INPUT TYPE=TEXT ALT="품목계정" NAME="txtItem_acct" SIZE=10 MAXLENGTH=4  tag="11NXXU"  ><IMG SRC="../../../CShared/image/btnPopup.gif" NAME="btnPlantCd" align=top TYPE="BUTTON" ONCLICK='vbscript:OpenPopupw"item_acct","txtItem_acct"'>&nbsp;<INPUT TYPE=TEXT NAME="txtItem_acct_nm" SIZE=20 MAXLENGTH=20 ALT="품목계정" tag="14X"></td>
							<TD CLASS="TD5" NOWRAP>품목구분</TD>
							<TD CLASS="TD6" NOWRAP><INPUT TYPE=TEXT ALT="품목구분" NAME="txtItem_kind" SIZE=10 MAXLENGTH=4 tag="11NXXU"><IMG SRC="../../../CShared/image/btnPopup.gif" NAME="btnItemCd" align=top TYPE="BUTTON" ONCLICK='vbscript:OpenPopupw "item_kind","txtItem_kind"'>&nbsp;<INPUT TYPE=TEXT ALT="품목구분" NAME="txtitem_kind_Nm" SIZE=20 tag="14X"></TD>
						</TR>
						
						<TR>
							<TD CLASS="TD5" NOWRAP>품목코드</TD>
							<TD CLASS="TD6" NOWRAP><INPUT TYPE=TEXT ALT="품목코드" NAME="txtItem_cd" SIZE=15 MAXLENGTH=18  tag="11NXXU" ><IMG SRC="../../../CShared/image/btnPopup.gif" NAME="btnPlantCd" align=top TYPE="BUTTON" ONCLICK='vbscript:OpenPopupw"item_cd","txtItem_cd"'>&nbsp;<INPUT TYPE=TEXT NAME="txtItem_cd_nm" SIZE=20 MAXLENGTH=20 ALT="품목코드" tag="14X"></td>
				...
				<TR>
					<TD WIDTH=100% HEIGHT=* valign=top>
						<TABLE WIDTH="100%" <%=LR_SPACE_TYPE_20%>>
							<TR>
								<TD HEIGHT="100%">
									<script language =javascript src='./js/b81108qa1_OBJECT1_vspdData.js'></script>
								</TD>
							</TR>
						</TABLE>
					</TD>
		...
		<TD>
		    <TABLE <%=LR_SPACE_TYPE_30%>>
		        <TR>
					...
					&nbsp;<A href='vbscript:Jump("B81109QA1")'>품목코드기본정보조회</a>
					</TD>
					<TD WIDTH=10>&nbsp;</TD>
		        </TR>
		    </TABLE>
