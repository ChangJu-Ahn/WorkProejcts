    ...
    Else
        ...
        Do While Not lgObjRs.EOF
            ...
            Select Case CStr(lgObjRs("MINOR_CD"))
                Case "01"
                    lgstrData = lgstrData & Chr(11) & "G_USP_GB010BA1"
                Case "02"
                    lgstrData = lgstrData & Chr(11) & "G_USP_GB010BA2"
                Case "03"
                    lgstrData = lgstrData & Chr(11) & "G_USP_GB010BA3"
                Case "04"
                    lgstrData = lgstrData & Chr(11) & "G_USP_GB010BA4"
                Case "05"
                    lgstrData = lgstrData & Chr(11) & "G_USP_GB010BA5"
            End Select
    ...
    Select Case Mid(pDataType,1,1)
        ...
        Case "M"
           ...
           Select Case Mid(pDataType,2,1)
               ...
               Case "D"
               Case "R"
                       lgStrSQL = " SELECT A.MINOR_CD, A.MINOR_NM, UPPER(ISNULL(C.PROGRESS_FG," & FilterVar("N", "''", "S") & " ))AS PROGRESS_FG, ISNULL(C.NUM_OF_ERROR,0) AS NUM_OF_ERROR "
                       ...
                       lgStrSQL = lgStrSQL & " AND B.SEQ_NO = " & FilterVar("2", "''", "S") & " "
