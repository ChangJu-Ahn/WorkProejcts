...
*  1. Module Name          : 경영손익 
*  2. Function Name        : 
*  3. Program ID           : GB007MA1
*  4. Program Name         : 본사공통비 내부내역 조회/출력 
*  5. Program Desc         : 
*  6. Comproxy List        :
...
Const BIZ_PGM_ID      = "GB007MB1.asp"						           '☆: Biz Logic ASP Name
...
'--------------------------------------------------------------------------------------------------------
Dim C_center                                                      'Column  Spread Sheet 
Dim C_centerNm    															
Dim C_data        

'Const C_SHEETMAXROWS_D  =  15                                          '☜: Fetch count at a time

'--------------------------------------------------------------------------------------------------------
'  Constants for SpreadSheet #2
'--------------------------------------------------------------------------------------------------------
Dim C_center1                                                     'Column  Spread Sheet 
Dim C_centerNm1    															
Dim C_data1        
Dim C_division     

'Const C_SHEETMAXROWS_D1 = 15                                          '☜: Fetch count at a time
...
Sub MakeKeyStream(pRow)
 ...
 If lgCurrentSpd = "M" Then
       ...
       lgKeyStream       = frm1.hYYYYMM.Value  & Parent.gColSep
    ...
    Else
		...
		lgKeyStream       = frm1.hYYYYMM.Value      & Parent.gColSep                  '날짜                         'You Must append one character(Parent.gColSep)
...
'  SpreadSheet #1
'--------------------------------------------------------------------------------------------------------
 C_center     = 1                                                'Column  Spread Sheet 
 C_centerNm   = 2															
 C_data       = 3
...
'  SpreadSheet #2
'--------------------------------------------------------------------------------------------------------
 C_center1     = 1                                               'Column  Spread Sheet 
 C_centerNm1   = 2															
 C_data1       = 3
 C_division    = 4
...
Sub InitSpreadSheet()
	...
	With Frm1.vspdData
       ...
       ggoSpread.SSSetEdit  C_center     , "Cost Center"        ,12,   ,, 50,2
       ggoSpread.SSSetEdit  C_centerNm   , "Cost Center명"     ,18,   ,, 30    
       ggoSpread.SSSetFloat C_data       , "금액"        ,14,    Parent.ggAmtOfMoneyNo ,ggStrIntegeralPart, ggStrDeciPointPart,Parent.gComNum1000,Parent.gComNumDec
...
Sub InitSpreadSheet1()
	...
	With Frm1.vspdData1
       ...
       .MaxCols   = C_division + 1                                               ' ☜:☜: Add 1 to Maxcols
	   .Col       = .MaxCols                                                        ' ☜:☜: Hide maxcols
       .ColHidden = True                                                            ' ☜:☜:
       ...
       ggoSpread.SSSetEdit  C_center1     , "Cost Center"         ,12,   ,, 50,2
       ggoSpread.SSSetEdit  C_centerNm1   , "Cost Center명"      ,18,   ,, 80    
       ggoSpread.SSSetFloat C_data1       , "금액"         ,14,    Parent.ggAmtOfMoneyNo ,ggStrIntegeralPart, ggStrDeciPointPart,Parent.gComNum1000,Parent.gComNumDec
       ggoSpread.SSSetEdit  C_division    , "사업부"         ,11,   ,, 80,2
...
Sub SetSpreadColor(ByVal pvStartRow,ByVal pvEndRow)
    ...
    With Frm1
             ...
             .vspdData1.ReDraw = False
                ggoSpread.SSSetProtected   C_center1	,pvStartRow	,pvEndRow
                ggoSpread.SSSetProtected   C_centerNm1	,pvStartRow	,pvEndRow
                ggoSpread.SSSetProtected   C_data1		,pvStartRow	,pvEndRow
                ggoSpread.SSSetProtected   C_division	,pvStartRow	,pvEndRow                
...
Sub Form_Load()
	...
	Call SetToolbar("110000000000111")                                             '☆: Developer must customize
	'------ Developer Coding part (End )   -------------------------------------------------------------- 
    Call InitComboBox
	Call CookiePage (0)                                                             '☜: Check Cookie
	
	frm1.txtDataAmt.allownull = false
	frm1.txtDataAmt1.allownull = false
...
'========================================================================================================
' Name : ReferencePopup1
' Desc : 
'========================================================================================================
Function ReferencePopup1()
					...
					<TD CLASS="CLSMTABP">
						<TABLE ID="MyTab" CELLSPACING=0 CELLPADDING=0>
							<TR>
								...
								<td background="../../../CShared/image/table/seltab_up_bg.gif" align="center" CLASS="CLSMTABP"><font color=white>공통비 배부현황</font></td>
						...
						<FIELDSET CLASS="CLSFLD">
							<TABLE <%=LR_SPACE_TYPE_40%>>
								<TR>
									...
									<TD CLASS="TD6" NOWRAP>
										<script language =javascript src='./js/gb007ma1_fpDateTime3_fpdtWk_yymm.js'></script>										
									</TD>									
							...
							<TR>
								<TD WIDTH="45%">
									<TABLE  <%=LR_SPACE_TYPE_20%> CLASS="BasicTB" CELLSPACING=0>
										<TR>
										<TD  COLSPAN=3>
											<script language =javascript src='./js/gb007ma1_vaSpread1_vspdData.js'></script>
										</TD>
										</TR>
										<TR HEIGHT=20>
								            ...
								            <TD CLASS=TD6 NOWRAP>
									            <script language =javascript src='./js/gb007ma1_txtDataAmt_txtDataAmt.js'></script>
											</TD>
										</TR>
									</TABLE>
								</TD>
								<TD WIDTH="55%">
									<TABLE  <%=LR_SPACE_TYPE_20%> CLASS="BasicTB" CELLSPACING=0>
										<TR>
											<TD COLSPAN=3>
												<script language =javascript src='./js/gb007ma1_vaSpread2_vspdData1.js'></script>
											</TD>
										</TR>
										<TR HEIGHT=20>
										    <TD CLASS=TD6 NOWRAP>&nbsp;</TD>										    
											<TD CLASS=TD5 NOWRAP>합계</TD>								            
											<TD CLASS="TD6" >
												<script language =javascript src='./js/gb007ma1_txtDataAmt1_txtDataAmt1.js'></script></TD>			    	    		            			    	    		            
										</TR>										
									</TABLE>
								</TD>
							</TR>
...
<INPUT TYPE=HIDDEN NAME="txtGiveCostCd" tag="24">
<INPUT TYPE=HIDDEN NAME="txtAmount" tag="24">
<INPUT TYPE=HIDDEN NAME="TotalAmount" tag="24">
