...
*  1. Module Name          : 경영 손익 
*  2. Function Name        :
*  3. Program ID           : GB001BA1
*  4. Program Name         : 경영손익 사업부별 손익작업 
*  5. Program Desc         : 경영손익 사업부별 손익작업 
*  6. Comproxy List        :
*  7. Modified date(First) : 2001/11/24
*  8. Modified date(Last)  : 2001/11/24
...
Sub InitSpreadSheet()
	...
	With frm1.vspdData
       ...
       ggoSpread.SSSetFloat    C_ERR_CNT,      "ERROR COUNT",   20,Parent.ggQtyNo,ggStrIntegeralPart, ggStrDeciPointPart,Parent.gComNum1000,Parent.gComNumDec
					...
					<TD NOWRAP  CLASS="CLSMTABP">
						<TABLE ID="MyTab" CELLSPACING=0 CELLPADDING=0>
							<TR>
								...
								<TD NOWRAP  background="../../../CShared/image/table/seltab_up_bg.gif" align="center" CLASS="CLSMTAB"><font color=white>사업부별 손익작업</font></td>
					...
					<TD NOWRAP  HEIGHT=20>
						<TABLE <%=LR_SPACE_TYPE_60%>>
						    	<TR>
									...
									<TD NOWRAP  CLASS=TD656 NOWRAP><script language =javascript src='./js/gb001ba1_fpDateTime_txtWork_dt.js'></script></TD>
								</TR>
    					</TABLE>
					</TD>
				</TR>
					    ...
					    <TABLE <%=LR_SPACE_TYPE_20%>>
							<TR>
								<TD NOWRAP  HEIGHT="100%">
									<script language =javascript src='./js/gb001ba1_vspdData_vspdData.js'></script>
								</TD>
							</TR>
						</TABLE>
					</TD>
