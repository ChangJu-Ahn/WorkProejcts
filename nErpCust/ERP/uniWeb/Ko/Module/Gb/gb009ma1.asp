...
*  1. Module Name          : 경영손익 
*  2. Function Name        :
*  3. Program ID           : GB009MA1
*  4. Program Name         : GB009MA1
*  5. Program Desc         : 경영손익 사업부별 손익현황 조회 
*  6. Comproxy List        :
...
Const BIZ_PGM_ID      = "GB009MB1.asp"						           '☆: Biz Logic ASP Name
Const BIZ_PGM_JUMP_ID   = "GB011MA1"									'사업부별 손익비교(컴퍼니 메뉴에 등록된 명)
'========================================================================================================
   ...
   '------ Developer Coding part (Start ) --------------------------------------------------------------       
	With Frm1                      	
		...
		Case 0
			...
			If UCase(Trim(.txtJumpFlag.Value)) = "GB009MA1" Then
				...
				If ReadCookie("ToYYYYMM")	<>"" Then TempToDt				= ReadCookie("ToYYYYMM")
			...
			If ReadCookie("Unt_Code")	<>"" Then .txtDeptCd.value 			= ReadCookie("Unt_Code")
...
Function OpenCode()
    ...
    arrField(0) = "BIZ_UNIT_CD"	     			<%' Field명(1)%>
    arrField(1) = "BIZ_UNIT_NM"					<%' Field명(0)%>
					...
					<TD NOWRAP  CLASS="CLSMTABP">
						<TABLE ID="MyTab" CELLSPACING=0 CELLPADDING=0>
							<TR>
								...
								<TD NOWRAP  background="../../../CShared/image/table/seltab_up_bg.gif" align="center" CLASS="CLSMTAB"><font color=white>사업부별 손익현황</font></td>
						...
						<FIELDSET CLASS="CLSFLD">
							<TABLE <%=LR_SPACE_TYPE_40%>>
								<TR>
									...
									<TD NOWRAP  CLASS=TD6 NOWRAP><script language =javascript src='./js/gb009ma1_fpdtWk_yymm_fpdtWk_yymm.js'></script>~<script language =javascript src='./js/gb009ma1_fpdtWk_yymm1_fpdtWk_yymm1.js'></script></TD>
                                    <TD NOWRAP  CLASS=TD5 NOWRAP>사업부</TD>
									<TD NOWRAP  CLASS=TD6 NOWRAP>
									 <INPUT TYPE=TEXT NAME="txtDeptCd" SIZE=15 MAXLENGTH=10 tag="12XXXU" ALT="사업부코드"><IMG SRC="../../../CShared/image/btnPopup.gif" NAME="btnCode" ALIGN=top TYPE="BUTTON" ONCLICK="vbscript:OpenCode()">
									 <INPUT TYPE=TEXT NAME="txtDeptNm" SIZE=20 MAXLENGTH=30 tag="14" ALT="사업부명" >
									 </TD>
								</TR>
							</TABLE>
						</FIELDSET>
						...
						<TABLE <%=LR_SPACE_TYPE_20%>>
							<TR>
								<TD NOWRAP  HEIGHT="100%">
									<script language =javascript src='./js/gb009ma1_vspdData_vspdData.js'></script>
								</TD>
							</TR>
						</TABLE>
					</TD>
