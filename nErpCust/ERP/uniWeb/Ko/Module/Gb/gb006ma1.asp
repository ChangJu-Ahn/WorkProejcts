...
*  1. Module Name          : 경영손익 
*  2. Function Name        :
*  3. Program ID           : GB006MA1
*  4. Program Name         : 본사공통비 기준 Data 등록 
*  5. Program Desc         : 
*  6. Comproxy List        :
...
'========================================================================================================
Const BIZ_PGM_ID = "GB006MB1.asp"                                      'Biz Logic ASP
'========================================================================================================
...
Sub MakeKeyStream(pOpt)
   ...
   '------ Developer Coding part (Start ) --------------------------------------------------------------
    ...
    lgKeyStream = lgKeyStream & Frm1.txtCurrencyCode.value & Parent.gColSep                      '배부기준(alloc_base)
...
Sub InitSpreadSheet()
	...
	With frm1.vspdData
       ...
       ggoSpread.SSSetEdit  C_center   , "Cost Center"      ,35,,, 35,2
       ggoSpread.SSSetButton C_center_bt
       ggoSpread.SSSetEdit  C_centernm , "Cost Center 명"   ,45,,, 45,2
       ggoSpread.SSSetFloat C_data     , "배부 Data"        ,30, Parent.ggAmtOfMoneyNo ,ggStrIntegeralPart, ggStrDeciPointPart,Parent.gComNum1000,Parent.gComNumDec
...
Sub SetSpreadLock(ByVal lRow  , ByVal lRow2 )
    ...
    .vspdData.ReDraw = False
      ...
      ggoSpread.SpreadUnlock	C_data,			lRow,  C_data,		lRow2
...
Function OpenCurrency()
	...
	arrParam(4) = arrParam(4) & "  AND  a.seq_no =2  and reference = " & FilterVar("Y", "''", "S") & "   "				<%' Where Condition%>
	arrParam(5) = "배부기준 코드"
       ...
       For lRow = 1 To .vspdData.MaxRows
           ...
           Select Case .vspdData.Text
               ...
               Case ggoSpread.InsertFlag                                      '☜: Update
                                                  ...
                                                  strval = strval & Trim(.txtCurrencyCode.value) & Parent.gColSep
                    .vspdData.Col = C_center	: strVal = strVal & Trim(.vspdData.text) & Parent.gColSep
                    .vspdData.Col = C_data   	: strVal = strVal & Trim(.vspdData.text) & Parent.gRowSep
                    lGrpCnt = lGrpCnt + 1
               ...
               Case ggoSpread.DeleteFlag                                      '☜: Delete
												  ...
												  strVal = strVal & lRow & Parent.gColSep
                                                  strval = strval & ggoOper.RetFormat(.fpdtWk_yymm.text,"yyyyMM") & Parent.gColSep
                                                  strval = strval & Trim(.txtCurrencyCode.value) & Parent.gColSep
                    .vspdData.Col = C_center 	: strval = strVal & Trim(.vspdData.Text) & Parent.gRowSep
...
Sub vspdData_Change(Col , Row)
	...
	IntRetCD = CommonQueryRs(" cost_nm "," b_cost_center  "," cost_cd =  " & FilterVar(Input_alloc , "''", "S") & " and cost_type <> " & FilterVar("C", "''", "S") & "  ",lgF0,lgF1,lgF2,lgF3,lgF4,lgF5,lgF6)	
...
'------------------------------------------------------- 조건 체트(순서 유의)
		...
		Call CommonQueryRs("count(*)","g_alloc_data","yyyymm = " & FilterVar(strYYYYMM, "''", "S") & " and alloc_kinds = " & FilterVar("1", "''", "S") & "  and alloc_base = " & FilterVar(Trim(Frm1.txtCurrencyCode.value), "''", "S") & " " ,lgF0,lgF1,lgF2,lgF3,lgF4,lgF5,lgF6)
    ...
    End If        
		...
		Call CommonQueryRs("count(*)","b_configuration","Major_cd = 'G1004' and Minor_cd = " & FilterVar(Trim(Frm1.txtCurrencyCode.value), "''", "S") & " and seq_no = 1 and reference = 'n' "  ,lgF0,lgF1,lgF2,lgF3,lgF4,lgF5,lgF6)
			if Trim(Replace(lgF0,Chr(11),"")) = 0 then							'수동배부요소가 없으면 
		             Call DisplayMsgBox("GA1511","X","X","X")					'Test 메시지 
		             Exit Function
			end if
						...
						<FIELDSET CLASS="CLSFLD">
							<TABLE <%=LR_SPACE_TYPE_40%>>
								<TR>
									...
									<TD CLASS="TD6" NOWRAP>
										<script language =javascript src='./js/gb006ma1_fpDateTime3_fpdtWk_yymm.js'></script>
				...
				<TR>
					<TD WIDTH=100% HEIGHT=100% valign=top>
							<TABLE <%=LR_SPACE_TYPE_30%>>
								<TR>
									<TD HEIGHT="100%">
										<script language =javascript src='./js/gb006ma1_OBJECT1_vspdData.js'></script>
								</TD>
								</TR>
							</TABLE>
					</TD>
						...
						<FIELDSET CLASS="CLSFLD">
							<TABLE <%=LR_SPACE_TYPE_40%>>
								<TR>
							    	...
							    	<TD CLASS=TD6 NOWRAP><script language =javascript src='./js/gb006ma1_fpDoubleSingle2_txtDataAmt.js'></script></TD>
