...
Sub FixUNISQLData()
	...
	Select Case strFlag
		Case "N"
			...
			UNISqlId(0) = "Q3221QA101"
		Case "I"
			Redim UNIValue(0,5)    
			UNISqlId(0) = "Q3221QA102"
		Case "B"
			Redim UNIValue(0,5)    
			UNISqlId(0) = "Q3221QA103"
		Case "IB"
			Redim UNIValue(0,6)    
			UNISqlId(0) = "Q3221QA104"
		Case "IS"
			Redim UNIValue(0,6)    
			UNISqlId(0) = "Q3221QA105"
		Case "A"
			Redim UNIValue(0,7)             
			UNISqlId(0) = "Q3221QA106"
	End Select
