...
Const BIZ_PGM_QRY_ID = "q3212mb1.asp"							'☆: Query 비지니스 로직 ASP명 
...
Function SetPrintCond(StrEbrFile, strUrl, intChartNo)
	...
	Dim strInspClassCd, strInspItemCd, strInspYear, strInspMnth, strItemCd, strPlantCd, strBpCd
...
Function FncNew()
	With frm1	 
		...
		'	IntRetCD = DisplayMsgBox("900004", Parent.VB_YES_NO,"X","X")               
		'	If IntRetCD = vbNo Then
		'		Exit Function
		'	End If
		'End If
