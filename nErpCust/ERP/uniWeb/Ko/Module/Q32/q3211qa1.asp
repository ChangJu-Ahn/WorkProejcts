...
Const BIZ_PGM_ID		= "Q3211qb1.asp"                 '☆: 비지니스 로직 ASP명 
Const BIZ_PGM_JUMP_ID	= "Q2111qa1"                     '☆: Cookie에서 사용할 상수 
...
Sub InitSpreadSheet()
    ...
    Call SetZAdoSpreadSheet("Q3211QA1", "G", "A", "V20021125", parent.C_GROUP_DBAGENT, frm1.vspdData, C_MaxKey, "X", "X")
    Call SetSpreadLock 
End Sub
						...
						<FIELDSET CLASS="CLSFLD">
							<TABLE <%=LR_SPACE_TYPE_40%>>
								<TR>
									...
									<TD CLASS="TD6">
										<script language =javascript src='./js/q3211qa1_fpDateTime5_txtDtFr.js'></script>&nbsp;~&nbsp;
										<script language =javascript src='./js/q3211qa1_fpDateTime6_txtDtTo.js'></script>
									</TD>
								</TR>
								<TR>
						...
						<TABLE <%=LR_SPACE_TYPE_60%>>
							...
							<TR>
								<TD HEIGHT=100% WIDTH=100% Colspan=4>
									<script language =javascript src='./js/q3211qa1_I998055613_vspdData.js'></script>
								</TD>	
							</TR>	
						</TABLE>
					</TD>
