...
'*  3. Program ID           : q3212mb1.asp
'*  4. Program Name         : 수입불량유형 파레토표 
'*  5. Program Desc         : 수입불량유형 
'*  6. Comproxy List        : 
'                             
'*  7. Modified date(First) : 2000/05/27
...
Function GetData()
	...
	'당월 
	strSql1 = "SELECT Q_DEFECT_TYPE.Defect_Type_Nm, Sum(Q_Receiving_Defect_Type_Total.DEFECT_QTY) FROM Q_Receiving_Defect_Type_Total Left Outer Join " &_
	              "Q_DEFECT_TYPE On Q_Receiving_Defect_Type_Total.Defect_Type_Cd = Q_DEFECT_TYPE.Defect_Type_Cd Where Q_DEFECT_TYPE.Insp_Class_Cd=" & FilterVar("R", "''", "S") & "  and " &_
	                  "Q_Receiving_Defect_Type_Total.PLANT_CD = " & FilterVar(strPlantCd, "''", "S") & " and Q_Receiving_Defect_Type_Total.YR =  " & FilterVar(strYr1 , "''", "S") & " and Q_Receiving_Defect_Type_Total.Mnth =  " & FilterVar(strMnth1 , "''", "S") & " and " &_
	                  "Q_Receiving_Defect_Type_Total.Item_Cd = " & FilterVar(strItemCd, "''", "S") & " and Q_Receiving_Defect_Type_Total.BP_CD Like " & FilterVar(strBpCd, "''", "S") & " and Q_Receiving_Defect_Type_Total.INSP_ITEM_CD LIKE " & FilterVar(strInspItemCd, "''", "S") & "" &_
	                  " and Q_Receiving_Defect_Type_Total.DEFECT_QTY > 0   " &_
	                  "GROUP BY Q_DEFECT_TYPE.Defect_Type_Nm Order By Sum(Q_Receiving_Defect_Type_Total.DEFECT_QTY) Desc"
	'전월 
	strSql2 = "SELECT Q_DEFECT_TYPE.Defect_Type_Nm, Sum(Q_Receiving_Defect_Type_Total.DEFECT_QTY) FROM Q_Receiving_Defect_Type_Total Left Outer Join " &_
	              "Q_DEFECT_TYPE On Q_Receiving_Defect_Type_Total.Defect_Type_Cd = Q_DEFECT_TYPE.Defect_Type_Cd Where Q_DEFECT_TYPE.Insp_Class_Cd=" & FilterVar("R", "''", "S") & "  and " &_
	                  "Q_Receiving_Defect_Type_Total.PLANT_CD = " & FilterVar(strPlantCd, "''", "S") & " and Q_Receiving_Defect_Type_Total.YR =  " & FilterVar(strYr2 , "''", "S") & " and Q_Receiving_Defect_Type_Total.Mnth =  " & FilterVar(strMnth2 , "''", "S") & " and " &_
	                  "Q_Receiving_Defect_Type_Total.Item_Cd = " & FilterVar(strItemCd, "''", "S") & " and Q_Receiving_Defect_Type_Total.BP_CD Like " & FilterVar(strBpCd, "''", "S") & " and Q_Receiving_Defect_Type_Total.INSP_ITEM_CD Like " & FilterVar(strInspItemCd, "''", "S") & "" &_
	                  " and Q_Receiving_Defect_Type_Total.DEFECT_QTY > 0   " &_
	                  "GROUP BY Q_DEFECT_TYPE.Defect_Type_Nm Order By Sum(Q_Receiving_Defect_Type_Total.DEFECT_QTY) Desc"
