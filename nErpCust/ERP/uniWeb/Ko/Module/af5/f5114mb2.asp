...
Dim strNoteFg, strNoteSts, strDueDtStart, strDueDtEnd, strBpCd, strCardCoCd
Dim strWhere0
...
%>
	...
	With parent		
		.frm1.txtBpCd1.value = "<%=Trim(rs1(0))%>"
		.frm1.txtBpNm1.value = "<%=Trim(rs1(1))%>"					
	End With
	</Script>
<%
    End If
...
%>
	<Script Language=vbScript>
	With parent		
		.frm1.txtCardCoCd1.value = "<%=Trim(rs2(0))%>"
		.frm1.txtCardCoNm1.value = "<%=Trim(rs2(1))%>"					
	End With
	</Script>
<%
    End If
...
%>
	<Script Language=vbScript>
	With parent
		.frm1.txtfromBizAreaCd.value = "<%=Trim(rs3(0))%>"
		.frm1.txtfromBizAreaNm.value = "<%=Trim(rs3(1))%>"					
	End With
	</Script>
<%
    End If
...
%>
	<Script Language=vbScript>
	With parent
		.frm1.txttoBizAreaCd.value = "<%=Trim(rs4(0))%>"
		.frm1.txttoBizAreaNm.value = "<%=Trim(rs4(1))%>"					
	End With
	</Script>
<%
    End If
