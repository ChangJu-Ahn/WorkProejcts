...
Sub TrimData()
	...
	lgAuthUsrID		= Trim(Request("lgAuthUsrID"))
     ...
     If strToPrDt <> "" Then
		strCond = strCond & " and A.DUE_DT <=  " & FilterVar(strToPrDt , "''", "S") & ""
     End If
     
     If strFrPrDt <> "" Then
		strCond = strCond & " and A.DUE_DT >=  " & FilterVar(strFrPrDt , "''", "S") & ""
     End If  
	...
	strCond = strCond & lgBizAreaAuthSQL & lgInternalCdAuthSQL & lgSubInternalCdAuthSQL & lgAuthUsrIDAuthSQL
     ...
     'strCond = strCond & " and A.NOTE_FG = '" & strNoteFg & "'"
