...
Sub TrimData()
    ...
    '--------------- 개발자 coding part(실행로직,Start)----------------------------------------------------
     ...
     strCardCoCd	= Request("txtCardCoCd")     
     ...
     If strCardCoCd <> "" Then
		strCond = strCond & " and A.CARD_CO_CD = " & Filtervar(strCardCoCd	, "''", "S")
     End If     
     
     If  strPgmId = "F5501MA1" Then		
		strCond = strCond & " and A.NOTE_FG = " & Filtervar(strNoteFg	, "" & FilterVar("CR", "''", "S") & " ", "S")											
	Elseif strPgmId = "F5502MA1" Then
		strCond = strCond & " and A.NOTE_FG = " & Filtervar(strNoteFg	, "" & FilterVar("CP", "''", "S") & " ", "S")												
	End If
