...
Sub InitSpreadSheet()
    ...
    Call SetZAdoSpreadSheet("F5101RA1","S","A","V20021211",PopupParent.C_SORT_DBAGENT,frm1.vspdData, C_MaxKey, "X","X")
    Call SetSpreadLock() 
End Sub
