...
'========================================================================================================
Const BIZ_PGM_ID  = "f5502mb1.asp"										'☆: 비지니스 로직 ASP명 
Const BIZ_PGM_ID2 = "f5502mb2.asp"										'☆: 비지니스 로직 ASP명 
'========================================================================================================
...
Function FncSave()
  ...
  '-----------------------
	...
	If CommonQueryRs(" A.CARD_CO_NM ","B_CARD_CO A","A.PAY_CARD_FG = " & FilterVar("Y", "''", "S") & "  AND A.CARD_CO_CD = " & FilterVar(frm1.txtCardCoCd.value, "''", "S"),lgF0,lgF1,lgF2,lgF3,lgF4,lgF5,lgF6) = False Then
...
Function OpenNoteInfo()
	...
	iCalledAspName = AskPRAspName("f5502ra1")
					...
					<TD HEIGHT=20 WIDTH=100%>
						<FIELDSET CLASS="CLSFLD">
							<TABLE <%=LR_SPACE_TYPE_40%>>
								<TR>
									<TD CLASS=TD5 NOWRAP>지불구매카드번호</TD>
									<TD CLASS=TD656 NOWRAP><INPUT CLASS="clstxt" TYPE="Text" ID="txtCardNoQry" NAME="txtCardNoQry" SIZE=30 MAXLENGTH=30 tag="12XXXU"ALT="구매카드번호"><IMG SRC="../../../CShared/image/btnPopup.gif" NAME="btnNoteQry" ALIGN=top TYPE="BUTTON" ONCLICK="vbscript:OpenNoteInfo"></TD>
								<TR>		
							</TABLE>
						</FIELDSET>
					</TD>
