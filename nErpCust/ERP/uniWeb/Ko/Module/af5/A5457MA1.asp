...
Const BIZ_PGM_ID      = "A5457MB1.asp"						           '☆: Biz Logic ASP Name
Const BIZ_PGM_ID1     = "A5457MB2.asp"	
...
Sub InitComboBox()
  	Dim arrData
		...
		'구매카드구분 
	Call CommonQueryRs(" MINOR_CD,MINOR_NM "," B_MINOR "," MAJOR_CD = " & FilterVar("F5001", "''", "S") & "  ",lgF0,lgF1,lgF2,lgF3,lgF4,lgF5,lgF6)
	...
	Select Case UCase(Trim(pvSpdNo))
		...
		Case "B"
			...
			With frm1.vspdData2
			   ...
			   ggoSpread.SSSetEdit    C_NoteNo2       ,"구매카드번호"       ,18    ,2        ,    ,18       ,2
...
Dim innerString
	...
	Select Case gSelframeFlg
		...
		Case TAB2							
			...
			inputTypeView1.innerHTML =  "구매카드번호"
			
			innerString = " <INPUT TYPE=TEXT NAME=txtNoteNoFr ALT='시작구매카드번호' SIZE=20 MAXLENGTH=30 tag='11NXXU'><IMG SRC='../../../CShared/image/btnPopup.gif' STYLE='HEIGHT: 21px; WIDTH: 16px' NAME=btnNoteNoFr ALIGN=TOP TYPE=BUTTON onClick='vbscript:Call OpenPopup(frm1.txtNoteNoFr.value, 3)' > &nbsp;~&nbsp; "
			innerString = innerString & " <INPUT TYPE=TEXT NAME=txtNoteNoTo ALT='종료구매카드번호'  SIZE=20 MAXLENGTH=30 tag='11NXXU'><IMG SRC='../../../CShared/image/btnPopup.gif' STYLE='HEIGHT: 21px; WIDTH: 16px' NAME=btnNoteNoTo ALIGN=TOP TYPE=BUTTON onClick='vbscript:Call OpenPopup(frm1.txtNoteNoTo.value, 4)' ></TD>"			
...
Sub Form_Load()
	...
	frm1.txtTotTempGlLocAmt2.allownull = false
					...
					<TD CLASS="CLSMTABP">
						<TABLE ID="MyTab" CELLSPACING=0 CELLPADDING=0 onclick="ClickTab2()">
							<TR>
								...
								<td background="../../image/table/tab_up_bg.gif" align="center" CLASS="CLSMTABP"><font color=white>구매카드처리정보</font></td>
						...
						<FIELDSET CLASS="CLSFLD">
							<TABLE <%=LR_SPACE_TYPE_40%>>
								<TR>
									...
									<TD CLASS="TD6" NOWRAP>
									    <script language =javascript src='./js/a5457ma1_fpDateTime1_txtSttlFrDt.js'></script>
									    &nbsp;~&nbsp;
									    <script language =javascript src='./js/a5457ma1_fpDateTime2_txtSttlToDt.js'></script>
									</TD>		
									<TD CLASS=TD5 NOWRAP>구매카드구분</TD>
									<TD CLASS=TD6 NOWRAP><SELECT ID="cboNoteFg" NAME="cboNoteFg" ALT="구매카드구분" STYLE="WIDTH: 132px" tag="12X"></SELECT></TD>
								</TR>
								<TR>		
								...
								<TR>
									<TD CLASS=TD5 ID=inputTypeView1>구매카드번호</TD>								
									<TD CLASS=TD6 ID=inputTypeView2><INPUT TYPE=TEXT NAME=txtNoteNoFr ALT="검색시작구매카드번호" STYLE="HEIGHT: 20px; WIDTH: 80px" SIZE=30 MAXLENGTH=30 tag="11NXXU"><IMG SRC="../../../CShared/image/btnPopup.gif" STYLE="HEIGHT: 21px; WIDTH: 16px" NAME=btnNoteNoFr ALIGN=TOP TYPE=BUTTON onClick="vbscript:Call OpenPopup(frm1.txtNoteNoFr.value, 3)" > &nbsp;~&nbsp;																	
																	<INPUT TYPE=TEXT NAME=txtNoteNoTo ALT="검색종료구매카드번호" STYLE="HEIGHT: 20px; WIDTH: 80px" SIZE=30 MAXLENGTH=30 tag="11NXXU"><IMG SRC="../../../CShared/image/btnPopup.gif" STYLE="HEIGHT: 21px; WIDTH: 16px" NAME=btnNoteNoTo ALIGN=TOP TYPE=BUTTON onClick="vbscript:Call OpenPopup(frm1.txtNoteNoTo.value, 4)"  ismap></TD>
					...
					<TD WIDTH=100% HEIGHT=* VALIGN=TOP>
							...
							<TABLE <%=LR_SPACE_TYPE_60%>>
								<TR>
									<TD WIDTH=100% HEIGHT=100% COLSPAN=4>
										<script language =javascript src='./js/a5457ma1_OBJECT1_vspdData1.js'></script>
									</TD>
								</TR>
								<TR>
										...
										<FIELDSET CLASS="CLSFLD">
											<TABLE  <%=LR_SPACE_TYPE_20%>>
												<TR>
													...
													<TD CLASS=TD6 NOWRAP>
														<script language =javascript src='./js/a5457ma1_OBJECT1_txtTotClsLocAmt1.js'></script>
													</TD>
													<TD class=TDT STYLE="WIDTH : 0px;"></TD>												
													<TD CLASS="TDt" NOWRAP>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;차이금액합계</TD>
													<TD CLASS=TD6 NOWRAP>
														<script language =javascript src='./js/a5457ma1_OBJECT1_txtTotBatchLocAmt1.js'></script>
													</TD>
												</TR>
												<TR>
													<TD CLASS="TDt" NOWRAP>회계전표금액(자국)합계</TD>
													<TD CLASS=TD6 NOWRAP>
														<script language =javascript src='./js/a5457ma1_OBJECT1_txtTotGlLocAmt1.js'></script>
													</TD>
													<TD class=TDT STYLE="WIDTH : 0px;"></TD>												
													<TD CLASS="TDt" NOWRAP>결의전표금액(자국)합계</TD>
													<TD CLASS=TD6 NOWRAP>
														<script language =javascript src='./js/a5457ma1_OBJECT1_txtTotTempGlLocAmt1.js'></script>
													</TD>
												</TR>
											</TABLE>
										</FIELDSET>
						...
						<DIV ID="TabDiv" SCROLL=no>
							<TABLE <%=LR_SPACE_TYPE_60%>>
								<TR>
									<TD WIDTH=100% HEIGHT=100% COLSPAN=4>
										<script language =javascript src='./js/a5457ma1_OBJECT1_vspdData2.js'></script>
									</TD>
								</TR>
								<TR>
									<TD HEIGHT=40 WIDTH=25%>
										<FIELDSET CLASS="CLSFLD">
											<TABLE  <%=LR_SPACE_TYPE_20%>>
												<TR>
													<TD CLASS="TDt" NOWRAP>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;결제금액(자국)합계</TD>
													<TD CLASS=TD6 NOWRAP>
														<script language =javascript src='./js/a5457ma1_OBJECT1_txtTotClsLocAmt2.js'></script>
													</TD>
													<TD class=TDT STYLE="WIDTH : 0px;"></TD>												
													<TD CLASS="TDt" NOWRAP>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;차이금액합계</TD>
													<TD CLASS=TD6 NOWRAP>
														<script language =javascript src='./js/a5457ma1_OBJECT1_txtTotBatchLocAmt2.js'></script>
													</TD>
												</TR>
												<TR>
													<TD CLASS="TDt" NOWRAP>회계전표금액(자국)합계</TD>
													<TD CLASS=TD6 NOWRAP>
														<script language =javascript src='./js/a5457ma1_OBJECT1_txtTotGlLocAmt2.js'></script>
													</TD>
													<TD class=TDT STYLE="WIDTH : 0px;"></TD>												
													<TD CLASS="TDt" NOWRAP>결의전표금액(자국)합계</TD>
													<TD CLASS=TD6 NOWRAP>
														<script language =javascript src='./js/a5457ma1_OBJECT1_txtTotTempGlLocAmt2.js'></script>
													</TD>
												</TR>
											</TABLE>
										</FIELDSET>
