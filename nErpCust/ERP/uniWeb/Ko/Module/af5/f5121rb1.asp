...
Err.Clear
    ...
    '--------------- 개발자 coding part(실행로직,Start)----------------------------------------------------
     strFrPrNo	   = FilterVar(Request("txtFrPrNo"),"","S")
     strToPrNo     = FilterVar(Request("txtToPrNo"),"","S")
...
'	 strNoteFg	   = Request("cboNoteFg")
	 ...
	 strCond = strCond & " and A.NOTE_FG = " & FilterVar("D1", "''", "S") & "  "
     strCond = strCond & " and A.NOTE_STS IN (" & FilterVar("DH", "''", "S") & " , " & FilterVar("DS", "''", "S") & "  ) "        
