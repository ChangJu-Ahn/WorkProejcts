...
'*  3. Program ID           : F5121RA1.ASP
'*  4. Program Name         : Dishonor Note Reference Popup
'*  5. Program Desc         :
'*  6. Comproxy List        : 
'*  7. Modified date(First) : 
'*  8. Modified date(Last)  : 2003/04/18
...
'		frm1.txtFrPrDt.Text = UNIDateClientFormat(arrParam(0))
...
'		frm1.txtToPrDt.Text = UNIDateClientFormat(arrParam(1))
	...
	End If
'	If arrParam(5) <> "" Then	'어음구분 
'		frm1.cboNoteFg.value = arrParam(5)
'	End If
...
Sub InitSpreadSheet()
    ...
    Call SetZAdoSpreadSheet("F5121RA1","S","A","V20021211",PopupParent.C_SORT_DBAGENT,frm1.vspdData, C_MaxKey, "X","X")
    Call SetSpreadLock() 
End Sub
			...
			<FIELDSET CLASS="CLSFLD">
				<TABLE <%=LR_SPACE_TYPE_40%>>
					<TR>
						...
						<TD CLASS=TD6 NOWRAP>
							<script language =javascript src='./js/f5121ra1_fpDateTime1_txtFrPrDt.js'></script>&nbsp;~&nbsp;
							<script language =javascript src='./js/f5121ra1_fpDateTime2_txtToPrDt.js'></script>
						</TD>
	...
	<TR HEIGHT=100%>
		<TD WIDTH=100% HEIGHT=* VALIGN=TOP>
			<TABLE <%=LR_SPACE_TYPE_20%>>
				<TR HEIGHT=100%>
					<TD WIDTH=100%>
						<script language =javascript src='./js/f5121ra1_vspdData_vspdData.js'></script>
					</TD>
				</TR>
			</TABLE>
		</TD>
