...
'*  3. Program ID           : f5501RA1.ASP
'*  4. Program Name         : Card Reference Popup
'*  5. Program Desc         :
'*  6. Comproxy List        : 
...
Dim lgAuthUsrID		' 개인 
	...
	If Trim("<%=Request("PGM")%>") = "F5501MA1"  Then
		top.document.title = "수취구매카드정보팝업"
	ElseIf Trim("<%=Request("PGM")%>") = "F5502MA1"  Then
		top.document.title = "지불구매카드정보팝업"	
	Else
		top.document.title = "카드정보팝업"
	End If
...
Function OpenPopUp(Byval PopFg,strCode)
	...
	ElseIf PopFg = "CC" Then	
			...
			arrParam(2) = strCode						' Code Condition
			arrParam(3) = ""							' Name Cindition
			arrParam(4) = "NOTE_FG IN (" & FilterVar("CR", "''", "S") & " ," & FilterVar("CP", "''", "S") & " )"							' Where Condition
...
Function EScPopUp(Byval PopupFg)
...
Sub InitSpreadSheet()
    ...
    Call SetZAdoSpreadSheet("F5502RA1","S","A","V20021211",PopupParent.C_SORT_DBAGENT,frm1.vspdData, C_MaxKey, "X","X")
    Call SetSpreadLock() 
End Sub
...
'--------------- 개발자 coding part(실행로직,End)------------------------------------------------
		strVal = strVal & "&txtPgmId=" & Trim("<%=Request("PGM")%>")			 '☜: (reference 조건 추가)
			...
			<FIELDSET CLASS="CLSFLD">
				<TABLE <%=LR_SPACE_TYPE_40%>>
					<TR>
						...
						<TD CLASS=TD5 NOWRAP>구매카드번호</TD>				
						<TD CLASS=TD6 NOWRAP>
							<INPUT TYPE="Text" NAME="txtFrPrNo" SIZE=15 MAXLENGTH=20 STYLE="TEXT-ALIGN: left" tag="11XXXU" ALT="시작승인번호"><IMG SRC="../../../CShared/image/btnPopup.gif" NAME="btnCostCd" align=top TYPE="BUTTON" ONCLICK="vbscript:Call OpenPopup('FrPr',frm1.txtFrPrNo.Value)">&nbsp;~
							<INPUT TYPE="Text" NAME="txtToPrNo" SIZE=15 MAXLENGTH=20 STYLE="TEXT-ALIGN: left" tag="11XXXU" ALT="종료승인번호"><IMG SRC="../../../CShared/image/btnPopup.gif" NAME="btnCostCd" align=top TYPE="BUTTON" ONCLICK="vbscript:Call OpenPopup('ToPr',frm1.txtToPrNo.Value)">
						</TD>
					</TR>
					<TR>
						...
						<TD CLASS=TD6 NOWRAP>
							...
							<INPUT NAME="txtBpNm" ALT="거래처명" MAXLENGTH="20" SIZE=20 STYLE="TEXT-ALIGN: left" tag="14X"></TD>
						<TD CLASS=TD5 NOWRAP>카드사코드</TD>
						<TD CLASS=TD6 NOWRAP>
							<INPUT NAME="txtCardCoCd" ALT="카드사코드" MAXLENGTH="10" SIZE=10 STYLE="TEXT-ALIGN: left" tag  ="11XXXU"><IMG SRC="../../../CShared/image/btnPopup.gif" NAME="btnCostCd" align=top TYPE="BUTTON" ONCLICK="vbscript:Call OpenPopup('CC',frm1.txtCardCoCd.Value)">
							<INPUT NAME="txtCardCoNm" ALT="카드사명" MAXLENGTH="20" SIZE=20 STYLE="TEXT-ALIGN: left" tag="14X"></TD>
					</TR>
				</TABLE>
			</FIELDSET>
		</TD>
