...
Const A707_EG1_E1_rcpt_type = 17
...
Sub SubBizQuery()		
	...
	iArrImportView(A707_I1_DUEDTEND) = UNIConvDate(Trim(Request("txtDueDtEnd")))
	...
	'DEBUG
	'Response.WRITE iArrImportView(A707_I1_PROGFG) & "<BR>"
	'Response.WRITE iArrImportView(A707_I1_DUEDTEND) & "<BR>"
	'Response.WRITE iArrImportView(A707_I1_STSDTSTART) & "<BR>"
	'Response.WRITE iArrImportView(A707_I1_STSDTEND) & "<BR>"
	'Response.WRITE iArrImportView(A707_I1_BPCD) & "<BR>"
	'Response.WRITE iArrImportView(A707_I1_BANKCD) & "<BR>"
	'Response.WRITE iArrImportView(A707_I1_PREVKEYNOTENO) & "<BR>"
	'Response.WRITE iArrImportView(A707_I1_PREVKEYGINO) & "<BR>"
	'Response.End 
	...
	'ProtoType
	'Sub FC0048_LIST_CARD_FOR_BATCH_SVR(pvStrGlobalCollection As String, ByVal pvSheetMaxRowsD As Long, 
	'									ByVal pvArrImportView As Variant, ByRef prVarExportView As Variant)
	...
	'debug	
	'Response.write UBound(iVarExportView, 1)
