...
'*  2. Function명        : 
'*  3. Program ID        : f5110ma1.asp
'*  4. Program 이름      : 받을어음명세서출력 
'*  5. Program 설명      : 받을어음명세서출력 
'*  6. Comproxy 리스트   : 
...
'⊙: 비지니스 로직 ASP명 
'Const BIZ_PGM_ID = "f5110mb1.asp"			'☆: 비지니스 로직 ASP명 
...
Sub RADIO1_Click()
	With frm1
		If .Rb_WK1.checked = True Then	 '만기일별 
...
Sub SetPrintCond(StrUrl, StrEbrFile)
	Dim VarBizAreaCd, VarBizAreaCd1, VarDateFr, VarDateTo, VarBpCd, VarBankCd, VarNoteSts, VarPlace, VarRcptFg
	Dim	strAuthCond
	
	If frm1.Rb_WK1.checked = True Then
		StrEbrFile = "f5110ma1a"
	Else
		StrEbrFile = "f5110ma1b"
	End If
	...
	If Trim(frm1.cboPlace.value)	<> "" Then VarPlace = Trim(frm1.cboPlace.value)
	If Trim(frm1.cboRcptFg.value)	<> "" Then VarRcptFg = Trim(frm1.cboRcptFg.value)
	...
	StrUrl = StrUrl & "|Place|"			& VarPlace
	StrUrl = StrUrl & "|RcptFg|"		& VarRcptFg
			...
			<TABLE <%=LR_SPACE_TYPE_20%>>
				<TR>
					<TD WIDTH=100% HEIGHT=20% valign=top>
						<FIELDSET STYLE="HEIGHT:60%"><LEGEND>출력구분</LEGEND>
							<TABLE <%=LR_SPACE_TYPE_60%>>
								<TR>
									<TD CLASS="TD5" NOWRAP>날짜선택</TD>
									<TD CLASS="TD6" NOWRAP><INPUT TYPE="RADIO" CLASS="Radio" NAME=RADIO1 ID=Rb_WK1 checked ONCLICK="vbscript:Call RADIO1_Click()"><LABEL FOR=Rb_WK1>만기일별</LABEL>&nbsp;
														   <INPUT TYPE="RADIO" CLASS="Radio" NAME=RADIO1 ID=Rb_WK2 ONCLICK="vbscript:Call RADIO1_Click()"><LABEL FOR=Rb_WK2>기준일별</LABEL></TD>
								</TR>
							</TABLE>
						</FIELDSET>
					</TD>
				...
				<TR>
					<TD WIDTH=100% HEIGHT=* valign=top>
						<FIELDSET STYLE="HEIGHT:90%"><LEGEND>출력조건</LEGEND>
							<TABLE <%=LR_SPACE_TYPE_60%>>
								<TR>
								...
								<TR>
									...
									<TD CLASS="TD6" NOWRAP><SELECT ID="cboPlace" NAME="cboPlace" ALT="보관장소" STYLE="WIDTH: 132px" tag="11X"><OPTION VALUE="" selected></OPTION></SELECT></TD>
								</TR>
								<TR>
									<TD CLASS="TD5" NOWRAP>자수타수구분</TD>
									<TD CLASS="TD6" NOWRAP><SELECT ID="cboRcptFg" NAME="cboRcptFg" ALT="자수타수구분" STYLE="WIDTH: 132px" tag="11X"><OPTION VALUE="" selected></OPTION></SELECT></TD>
								</TR>
							</TABLE>
						</FIELDSET>
					</TD>
