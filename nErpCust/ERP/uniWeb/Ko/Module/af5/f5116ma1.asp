...
'*  4. Program Name         : 지불구매카드처리 
'*  5. Program Desc         : 지불구매카드처리 
'*  6. Comproxy List        : +
...
'========================================================================================================= 
Const BIZ_PGM_ID = "f5116mb1.asp"											 '☆: 비지니스 로직 ASP명 
Const BIZ_PGM_ID2 = "f5116mb2.asp"											 '☆: 비지니스 로직 ASP명 
Const BIZ_PGM_ID3 = "f5116mb3.asp"											 '☆: 비지니스 로직 ASP명    
...
Sub InitSpreadSheet(ByVal spdsep)
    ...
    Case "A"
		...
		With frm1
			...
			ggoSpread.SSSetEdit		C_NOTE_NO,		"지불구매카드번호", 20, , , 30
			ggoSpread.SSSetFloat		C_NOTE_AMT,	"구매카드금액", 15, Parent.ggAmtOfMoneyNo, ggStrIntegeralPart, ggStrDeciPointPart,Parent.gComNum1000,Parent.gComNumDec
			ggoSpread.SSSetDate		C_DUE_DT,		"결제일자", 10, 2, Parent.gDateFormat
			ggoSpread.SSSetEdit		C_NOTE_STS,		"카드상태", 10, , , 5
			ggoSpread.SSSetEdit		C_BP_CD,		"거래처", 10, , , 10
			ggoSpread.SSSetEdit		C_BP_NM,		"거래처명", 20, , , 50
			ggoSpread.SSSetEdit		C_CARD_CO_CD,	"카드사", 10, , , 10
    ...
    Case "B"
		...
		ggoSpread.SSSetEdit		C_CNCL_NOTE_NO,			"지불구매카드번호", 20, , , 30
		...
		ggoSpread.SSSetFloat	C_CNCL_NOTE_AMT,		"구매카드금액", 15, Parent.ggAmtOfMoneyNo, ggStrIntegeralPart, ggStrDeciPointPart,Parent.gComNum1000,Parent.gComNumDec
...
Sub SetSpreadLock(ByVal spdsep1)
    ...
    With frm1.vspdData
		...
		ggoSpread.SpreadLock C_NOTE_NO,	-1, C_NOTE_NO			' 구매카드번호 
		ggoSpread.SpreadLock C_NOTE_AMT,-1, C_NOTE_AMT			' 구매카드금액 
		ggoSpread.SpreadLock C_DUE_DT,	-1, C_DUE_DT			' 결제일 
		ggoSpread.SpreadLock C_BP_CD,	-1, C_BP_CD				' 거래처코드 
		ggoSpread.SpreadLock C_BP_NM,	-1, C_BP_NM				' 거래처명 
		ggoSpread.SpreadLock C_CARD_CO_CD,	-1, C_CARD_CO_CD			' 발행카드사 
		ggoSpread.SpreadLock C_CARD_CO_NM,	-1, C_CARD_CO_NM			' 발행카드사명 
    ...
    With frm1.vspdData2
		...
		ggoSpread.SpreadLock C_CNCL_NOTE_NO,	-1, C_CNCL_NOTE_NO			' 구매카드번호 
		ggoSpread.SpreadLock C_CNCL_TEMP_GL_NO,	-1, C_CNCL_TEMP_GL_NO			' 전표번호 
		ggoSpread.SpreadLock C_CNCL_TEMP_GL_DT,	-1, C_CNCL_TEMP_GL_DT			' 전표일자 		
		...
		ElseIf .hProcFg.value = "DG" Then									 '☜:일괄취소 
			For lRow = 1 To .vspdData2.MaxRows
				...
				If .vspdData2.Text = "1" Then
					...
					strVal = strVal & Trim(.vspdData2.Text) & Parent.gRowSep		' 전표번호  				
					...
					<TD CLASS="CLSMTABP">
						<TABLE ID="MyTab" CELLSPACING=0 CELLPADDING=0 onclick="ClickTab2()">
							<TR>
								...
								<td background="../../../CShared/image/table/tab_up_bg.gif" align="center" CLASS="CLSMTABP"><font color=white>지불구매카드취소</font></td>
					...
					<TD WIDTH=100% HEIGHT=* VALIGN=TOP>
						<TABLE <%=LR_SPACE_TYPE_60%>>
							...
							<TR>
								...
								<TD CLASS=TD6 NOWRAP><INPUT NAME="txtRcptType" ALT="출금유형코드" SIZE="10" MAXLENGTH="2" tag="22XXXU"><IMG SRC="../../image/btnPopup.gif" NAME="btnRcptType" align=top TYPE="BUTTON" ONCLICK="vbscript:Call OpenPopUp(frm1.txtRcptType.value, 0)">&nbsp;<INPUT NAME="txtRcptTypeNm" ALT="출금유형명" STYLE="TEXT-ALIGN: Left" tag="24X"></TD>
								<TD CLASS="TD5" NOWRAP>출금계정</TD>												
								<TD CLASS="TD6" NOWRAP><INPUT NAME="txtNoteAcctCd" ALT="출금계정" SIZE="10" MAXLENGTH="20"  tag="22XXXU"><IMG SRC="../../../CShared/image/btnPopup.gif" NAME="btnNoteAcct" align=top TYPE="BUTTON" ONCLICK="vbscript:Call OpenPopUp(frm1.txtNoteAcctCd.value, 11)">
													   <INPUT NAME="txtNoteAcctNm" ALT="출금계정명" SIZE="20" tag="24X"></TD>								
							</TR>							
							<TR>
								<TD CLASS=TD5 NOWRAP>은행</TD>
								<TD CLASS=TD6 NOWRAP><INPUT CLASS="clstxt" TYPE=TEXT ID="txtBankCd" NAME="txtBankCd" SIZE=10 MAXLENGTH=10  tag="21XXXU" ALT="은행코드"><IMG SRC="../../../CShared/image/btnPopup.gif" NAME="btnBankCd1" ALIGN=top TYPE="BUTTON" ONCLICK="vbscript:Call OpenPopUp(frm1.txtBankCd.Value, 1)">&nbsp;<INPUT CLASS="clstxt" TYPE=TEXT ID="txtBankNm" NAME="txtBankNm" SIZE=20 MAXLENGTH=30  STYLE="TEXT-ALIGN: left" tag="24X" ALT="은행명"></TD>
							...
							<TR>
								...
								<TD CLASS="TD6" NOWRAP><INPUT NAME="txtChargeAcctCd" ALT="수수료계정" SIZE="10" MAXLENGTH="20"  tag="24X"><IMG SRC="../../../CShared/image/btnPopup.gif" NAME="btnChargeAcct" align=top TYPE="BUTTON" ONCLICK="vbscript:Call OpenPopUp(frm1.txtChargeAcctCd.value, 12)">
