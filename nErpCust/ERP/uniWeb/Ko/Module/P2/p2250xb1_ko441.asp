...
Sub SubBizQueryMulti()
    ...
    lgStrSQL = ""
    lgStrSQL = lgStrSQL & " select	distinct version            "
    lgStrSQL = lgStrSQL & "  from	prod_Item_Plan_Ko441        "
    lgStrSQL = lgStrSQL & " where	version like   " & replace(FilterVar(Trim(Request("txtFromDt"))&"%","''", "S"), "-", "")
    lgStrSQL = lgStrSQL & "  order by version desc              "
    ...
    Else    
       ...
       Do While Not lgObjRs.EOF
          ...
          lgstrData = lgstrData & Chr(11) & ConvSPChars(lgObjRs("version"))
