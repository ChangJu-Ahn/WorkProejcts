...
<% 
    ...
    Select Case CStr(Request("txtMode"))
        ...
        Case CStr(UID_M0003)                                                         '☜: Delete
             Call SubBizDelete()
        Case CStr(UID_M0004)                                                         '☜: 20080304::hanc 수주계획 일괄복사하기
             Call SubBizExec()
    End Select
...
'    S_plantCd =   Trim(Request("txtPlantCd"))
'    S_plantCd =   Trim(Request("txtPlantCd"))
'    S_plantCd =   Trim(Request("txtPlantCd"))
' UniConvDate(Request("txtPlanDt"))
'UNIConvNum(Request("txtPeriod"),0)
'FilterVar(Trim(Request("txtPlantCd"))	, "''", "S")
'FilterVar(Trim(Request("txtPlanDt"))	, "''", "S")


        
    lgStrSQL = " EXEC USP_p2240mb3_ko441 " & FilterVar(Trim(Request("txtPlantCd"))	, "''", "S") & "," & UNIConvNum(Request("txtPeriod"),0) & "," & FilterVar(Trim(Request("txtPlanDt"))	, "''", "S") & " "
'    lgStrSQL =  "EXEC USP_p2240mb3_ko441                            "
...
'       Response.Write  "    Parent.lgStrPrevKey         = """ & lgStrPrevKey    & """" & vbCr
'       Response.Write  "    Parent.ggoSpread.SSShowData   """ & lgstrData       & """" & vbCr
       Response.Write  "    Parent.DBExecOk   " & vbCr      
