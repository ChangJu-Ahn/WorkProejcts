        ...
        Case "M"
           ...
           Select Case Mid(pDataType,2,1)
               Case "R"
                    ...
                    lgStrSQL = lgStrSQL & vbCrLf & "  declare @ItemCd       Varchar(20)                                                                                   "                                                               
                    lgStrSQL = lgStrSQL & vbCrLf & "                                                                                                                       "                                                            
                    lgStrSQL = lgStrSQL & vbCrLf & " set @ProdPlanMonth = " & FilterVar(pCode(0), "''", "S")
                    lgStrSQL = lgStrSQL & vbCrLf & " set @ItemCd       = " & FilterVar(pCode(1), "''", "S")
                    lgStrSQL = lgStrSQL & vbCrLf & " set @PlantCd       = " & FilterVar(pCode(3), "''", "S")
'                    lgStrSQL = lgStrSQL & vbCrLf & " set @ProdPlanMonth = '2008-01-01'                                                                                     "
                    lgStrSQL = lgStrSQL & vbCrLf & " set @iPeriod       = 40                                                                                               "
'                    lgStrSQL = lgStrSQL & vbCrLf & " set @PlantCd       = 'PS01'                                                                                           "
                    lgStrSQL = lgStrSQL & vbCrLf & "                                                                                                                       "
                    lgStrSQL = lgStrSQL & vbCrLf & " SELECT	ITEM_CD,                                                                                                       "
                    lgStrSQL = lgStrSQL & vbCrLf & " 		ITEM_NM,                                                                                                       "                                                          
                    lgStrSQL = lgStrSQL & vbCrLf & " 		'*' tracking_no,                                                                                                   "                                                         
                    lgStrSQL = lgStrSQL & vbCrLf & " 		TYPE,                                                                                                          "                                         
                    lgStrSQL = lgStrSQL & vbCrLf & " 		SUM(ISNULL(QTY01, 0))  QTY01,                                                                                  "
                    lgStrSQL = lgStrSQL & vbCrLf & " 		SUM(ISNULL(QTY02, 0))  QTY02,                                                                                  "
                    lgStrSQL = lgStrSQL & vbCrLf & " 		SUM(ISNULL(QTY03, 0))  QTY03,                                                                                  "
                    lgStrSQL = lgStrSQL & vbCrLf & " 		SUM(ISNULL(QTY04, 0))  QTY04,                                                                                  "
                    lgStrSQL = lgStrSQL & vbCrLf & " 		SUM(ISNULL(QTY05, 0))  QTY05,                                                                                  "
                    lgStrSQL = lgStrSQL & vbCrLf & " 		SUM(ISNULL(QTY06, 0))  QTY06,                                                                                  "
                    lgStrSQL = lgStrSQL & vbCrLf & " 		SUM(ISNULL(QTY07, 0))  QTY07,                                                                                  "
                    lgStrSQL = lgStrSQL & vbCrLf & " 		SUM(ISNULL(QTY08, 0))  QTY08,                                                                                  "
                    lgStrSQL = lgStrSQL & vbCrLf & " 		SUM(ISNULL(QTY09, 0))  QTY09,                                                                                  "
                    lgStrSQL = lgStrSQL & vbCrLf & " 		SUM(ISNULL(QTY10, 0))  QTY10,                                                                                  "
                    lgStrSQL = lgStrSQL & vbCrLf & " 		SUM(ISNULL(QTY11, 0))  QTY11,                                                                                  "
                    lgStrSQL = lgStrSQL & vbCrLf & " 		SUM(ISNULL(QTY12, 0))  QTY12,                                                                                  "
                    lgStrSQL = lgStrSQL & vbCrLf & " 		SUM(ISNULL(QTY13, 0))  QTY13,                                                                                  "
                    lgStrSQL = lgStrSQL & vbCrLf & " 		SUM(ISNULL(QTY14, 0))  QTY14,                                                                                  "
                    lgStrSQL = lgStrSQL & vbCrLf & " 		SUM(ISNULL(QTY15, 0))  QTY15,                                                                                  "
                    lgStrSQL = lgStrSQL & vbCrLf & " 		SUM(ISNULL(QTY16, 0))  QTY16,                                                                                  "
                    lgStrSQL = lgStrSQL & vbCrLf & " 		SUM(ISNULL(QTY17, 0))  QTY17,                                                                                  "
                    lgStrSQL = lgStrSQL & vbCrLf & " 		SUM(ISNULL(QTY18, 0))  QTY18,                                                                                  "
                    lgStrSQL = lgStrSQL & vbCrLf & " 		SUM(ISNULL(QTY19, 0))  QTY19,                                                                                  "
                    lgStrSQL = lgStrSQL & vbCrLf & " 		SUM(ISNULL(QTY20, 0))  QTY20,                                                                                  "
                    lgStrSQL = lgStrSQL & vbCrLf & " 		SUM(ISNULL(QTY21, 0))  QTY21,                                                                                  "
                    lgStrSQL = lgStrSQL & vbCrLf & " 		SUM(ISNULL(QTY22, 0))  QTY22,                                                                                  "
                    lgStrSQL = lgStrSQL & vbCrLf & " 		SUM(ISNULL(QTY23, 0))  QTY23,                                                                                  "
                    lgStrSQL = lgStrSQL & vbCrLf & " 		SUM(ISNULL(QTY24, 0))  QTY24,                                                                                  "
                    lgStrSQL = lgStrSQL & vbCrLf & " 		SUM(ISNULL(QTY25, 0))  QTY25,                                                                                  "
                    lgStrSQL = lgStrSQL & vbCrLf & " 		SUM(ISNULL(QTY26, 0))  QTY26,                                                                                  "
                    lgStrSQL = lgStrSQL & vbCrLf & " 		SUM(ISNULL(QTY27, 0))  QTY27,                                                                                  "
                    lgStrSQL = lgStrSQL & vbCrLf & " 		SUM(ISNULL(QTY28, 0))  QTY28,                                                                                  "
                    lgStrSQL = lgStrSQL & vbCrLf & " 		SUM(ISNULL(QTY29, 0))  QTY29,                                                                                  "
                    lgStrSQL = lgStrSQL & vbCrLf & " 		SUM(ISNULL(QTY30, 0))  QTY30,                                                                                  "
                    lgStrSQL = lgStrSQL & vbCrLf & " 		SUM(ISNULL(QTY31, 0))  QTY31,                                                                                  "
                    lgStrSQL = lgStrSQL & vbCrLf & " 		SUM(ISNULL(QTY32, 0))  QTY32,                                                                                  "
                    lgStrSQL = lgStrSQL & vbCrLf & " 		SUM(ISNULL(QTY33, 0))  QTY33,                                                                                  "
                    lgStrSQL = lgStrSQL & vbCrLf & " 		SUM(ISNULL(QTY34, 0))  QTY34,                                                                                  "
                    lgStrSQL = lgStrSQL & vbCrLf & " 		SUM(ISNULL(QTY35, 0))  QTY35,                                                                                  "
                    lgStrSQL = lgStrSQL & vbCrLf & " 		SUM(ISNULL(QTY36, 0))  QTY36,                                                                                  "
                    lgStrSQL = lgStrSQL & vbCrLf & " 		SUM(ISNULL(QTY37, 0))  QTY37,                                                                                  "
                    lgStrSQL = lgStrSQL & vbCrLf & " 		SUM(ISNULL(QTY38, 0))  QTY38,                                                                                  "
                    lgStrSQL = lgStrSQL & vbCrLf & " 		SUM(ISNULL(QTY39, 0))  QTY39,                                                                                  "
                    lgStrSQL = lgStrSQL & vbCrLf & " 		SUM(ISNULL(QTY40, 0))  QTY40,                                                                                  "
                    lgStrSQL = lgStrSQL & vbCrLf & "        SUM(ISNULL(MONTH_1, 0)) MONTH_1,                                                                               "                                                                                 
                    lgStrSQL = lgStrSQL & vbCrLf & "        SUM(ISNULL(MONTH_2, 0)) MONTH_2,                                                                               "                                                                                 
                    lgStrSQL = lgStrSQL & vbCrLf & "        SUM(ISNULL(MONTH_3, 0)) MONTH_3                                                                                "
                    lgStrSQL = lgStrSQL & vbCrLf & "FROM                                                                                                                   "
                    lgStrSQL = lgStrSQL & vbCrLf & "(                                                                                                                      "
                    lgStrSQL = lgStrSQL & vbCrLf & " SELECT	DISTINCT A.ITEM_CD,                                                                                            "
                    lgStrSQL = lgStrSQL & vbCrLf & " 		B.ITEM_NM,                                                                                                     "                                                            
                    lgStrSQL = lgStrSQL & vbCrLf & " 		'' tracking_no,                                                                                                "                                                            
                    lgStrSQL = lgStrSQL & vbCrLf & " 		'생판요청' TYPE,                                                                                               "                                                    
                    ...
                    lgStrSQL = lgStrSQL & vbCrLf & " 		(SELECT PLAN_QTY FROM SALES_ITEM_REQ_PLAN_KO441 WHERE PROJECT_CODE = A.PROJECT_CODE AND ITEM_CD = A.ITEM_CD AND DLVY_PLAN_DT = DATEADD(day, 9, @ProdPlanMonth)) QTY10,     "
                    lgStrSQL = lgStrSQL & vbCrLf & " 		(SELECT PLAN_QTY FROM SALES_ITEM_REQ_PLAN_KO441 WHERE PROJECT_CODE = A.PROJECT_CODE AND ITEM_CD = A.ITEM_CD AND DLVY_PLAN_DT = DATEADD(day, 10, @ProdPlanMonth)) QTY11,    "
                    lgStrSQL = lgStrSQL & vbCrLf & " 		(SELECT PLAN_QTY FROM SALES_ITEM_REQ_PLAN_KO441 WHERE PROJECT_CODE = A.PROJECT_CODE AND ITEM_CD = A.ITEM_CD AND DLVY_PLAN_DT = DATEADD(day, 11, @ProdPlanMonth)) QTY12,    "
                    lgStrSQL = lgStrSQL & vbCrLf & " 		(SELECT PLAN_QTY FROM SALES_ITEM_REQ_PLAN_KO441 WHERE PROJECT_CODE = A.PROJECT_CODE AND ITEM_CD = A.ITEM_CD AND DLVY_PLAN_DT = DATEADD(day, 12, @ProdPlanMonth)) QTY13,    "
                    lgStrSQL = lgStrSQL & vbCrLf & " 		(SELECT PLAN_QTY FROM SALES_ITEM_REQ_PLAN_KO441 WHERE PROJECT_CODE = A.PROJECT_CODE AND ITEM_CD = A.ITEM_CD AND DLVY_PLAN_DT = DATEADD(day, 13, @ProdPlanMonth)) QTY14,    "
                    lgStrSQL = lgStrSQL & vbCrLf & " 		(SELECT PLAN_QTY FROM SALES_ITEM_REQ_PLAN_KO441 WHERE PROJECT_CODE = A.PROJECT_CODE AND ITEM_CD = A.ITEM_CD AND DLVY_PLAN_DT = DATEADD(day, 14, @ProdPlanMonth)) QTY15,    "
                    lgStrSQL = lgStrSQL & vbCrLf & " 		(SELECT PLAN_QTY FROM SALES_ITEM_REQ_PLAN_KO441 WHERE PROJECT_CODE = A.PROJECT_CODE AND ITEM_CD = A.ITEM_CD AND DLVY_PLAN_DT = DATEADD(day, 15, @ProdPlanMonth)) QTY16,    "
                    lgStrSQL = lgStrSQL & vbCrLf & " 		(SELECT PLAN_QTY FROM SALES_ITEM_REQ_PLAN_KO441 WHERE PROJECT_CODE = A.PROJECT_CODE AND ITEM_CD = A.ITEM_CD AND DLVY_PLAN_DT = DATEADD(day, 16, @ProdPlanMonth)) QTY17,    "
                    lgStrSQL = lgStrSQL & vbCrLf & " 		(SELECT PLAN_QTY FROM SALES_ITEM_REQ_PLAN_KO441 WHERE PROJECT_CODE = A.PROJECT_CODE AND ITEM_CD = A.ITEM_CD AND DLVY_PLAN_DT = DATEADD(day, 17, @ProdPlanMonth)) QTY18,    "
                    lgStrSQL = lgStrSQL & vbCrLf & " 		(SELECT PLAN_QTY FROM SALES_ITEM_REQ_PLAN_KO441 WHERE PROJECT_CODE = A.PROJECT_CODE AND ITEM_CD = A.ITEM_CD AND DLVY_PLAN_DT = DATEADD(day, 18, @ProdPlanMonth)) QTY19,    "
                    lgStrSQL = lgStrSQL & vbCrLf & " 		(SELECT PLAN_QTY FROM SALES_ITEM_REQ_PLAN_KO441 WHERE PROJECT_CODE = A.PROJECT_CODE AND ITEM_CD = A.ITEM_CD AND DLVY_PLAN_DT = DATEADD(day, 19, @ProdPlanMonth)) QTY20,    "
                    lgStrSQL = lgStrSQL & vbCrLf & " 		(SELECT PLAN_QTY FROM SALES_ITEM_REQ_PLAN_KO441 WHERE PROJECT_CODE = A.PROJECT_CODE AND ITEM_CD = A.ITEM_CD AND DLVY_PLAN_DT = DATEADD(day, 20, @ProdPlanMonth)) QTY21,    "
                    lgStrSQL = lgStrSQL & vbCrLf & " 		(SELECT PLAN_QTY FROM SALES_ITEM_REQ_PLAN_KO441 WHERE PROJECT_CODE = A.PROJECT_CODE AND ITEM_CD = A.ITEM_CD AND DLVY_PLAN_DT = DATEADD(day, 21, @ProdPlanMonth)) QTY22,    "
                    lgStrSQL = lgStrSQL & vbCrLf & " 		(SELECT PLAN_QTY FROM SALES_ITEM_REQ_PLAN_KO441 WHERE PROJECT_CODE = A.PROJECT_CODE AND ITEM_CD = A.ITEM_CD AND DLVY_PLAN_DT = DATEADD(day, 22, @ProdPlanMonth)) QTY23,    "
                    lgStrSQL = lgStrSQL & vbCrLf & " 		(SELECT PLAN_QTY FROM SALES_ITEM_REQ_PLAN_KO441 WHERE PROJECT_CODE = A.PROJECT_CODE AND ITEM_CD = A.ITEM_CD AND DLVY_PLAN_DT = DATEADD(day, 23, @ProdPlanMonth)) QTY24,    "
                    lgStrSQL = lgStrSQL & vbCrLf & " 		(SELECT PLAN_QTY FROM SALES_ITEM_REQ_PLAN_KO441 WHERE PROJECT_CODE = A.PROJECT_CODE AND ITEM_CD = A.ITEM_CD AND DLVY_PLAN_DT = DATEADD(day, 24, @ProdPlanMonth)) QTY25,    "
                    lgStrSQL = lgStrSQL & vbCrLf & " 		(SELECT PLAN_QTY FROM SALES_ITEM_REQ_PLAN_KO441 WHERE PROJECT_CODE = A.PROJECT_CODE AND ITEM_CD = A.ITEM_CD AND DLVY_PLAN_DT = DATEADD(day, 25, @ProdPlanMonth)) QTY26,    "
                    lgStrSQL = lgStrSQL & vbCrLf & " 		(SELECT PLAN_QTY FROM SALES_ITEM_REQ_PLAN_KO441 WHERE PROJECT_CODE = A.PROJECT_CODE AND ITEM_CD = A.ITEM_CD AND DLVY_PLAN_DT = DATEADD(day, 26, @ProdPlanMonth)) QTY27,    "
                    lgStrSQL = lgStrSQL & vbCrLf & " 		(SELECT PLAN_QTY FROM SALES_ITEM_REQ_PLAN_KO441 WHERE PROJECT_CODE = A.PROJECT_CODE AND ITEM_CD = A.ITEM_CD AND DLVY_PLAN_DT = DATEADD(day, 27, @ProdPlanMonth)) QTY28,    "
                    lgStrSQL = lgStrSQL & vbCrLf & " 		(SELECT PLAN_QTY FROM SALES_ITEM_REQ_PLAN_KO441 WHERE PROJECT_CODE = A.PROJECT_CODE AND ITEM_CD = A.ITEM_CD AND DLVY_PLAN_DT = DATEADD(day, 28, @ProdPlanMonth)) QTY29,    "
                    lgStrSQL = lgStrSQL & vbCrLf & " 		(SELECT PLAN_QTY FROM SALES_ITEM_REQ_PLAN_KO441 WHERE PROJECT_CODE = A.PROJECT_CODE AND ITEM_CD = A.ITEM_CD AND DLVY_PLAN_DT = DATEADD(day, 29, @ProdPlanMonth)) QTY30,    "
                    lgStrSQL = lgStrSQL & vbCrLf & " 		(SELECT PLAN_QTY FROM SALES_ITEM_REQ_PLAN_KO441 WHERE PROJECT_CODE = A.PROJECT_CODE AND ITEM_CD = A.ITEM_CD AND DLVY_PLAN_DT = DATEADD(day, 30, @ProdPlanMonth)) QTY31,    "
                    lgStrSQL = lgStrSQL & vbCrLf & " 		(SELECT PLAN_QTY FROM SALES_ITEM_REQ_PLAN_KO441 WHERE PROJECT_CODE = A.PROJECT_CODE AND ITEM_CD = A.ITEM_CD AND DLVY_PLAN_DT = DATEADD(day, 31, @ProdPlanMonth)) QTY32,    "
                    lgStrSQL = lgStrSQL & vbCrLf & " 		(SELECT PLAN_QTY FROM SALES_ITEM_REQ_PLAN_KO441 WHERE PROJECT_CODE = A.PROJECT_CODE AND ITEM_CD = A.ITEM_CD AND DLVY_PLAN_DT = DATEADD(day, 32, @ProdPlanMonth)) QTY33,    "
                    lgStrSQL = lgStrSQL & vbCrLf & " 		(SELECT PLAN_QTY FROM SALES_ITEM_REQ_PLAN_KO441 WHERE PROJECT_CODE = A.PROJECT_CODE AND ITEM_CD = A.ITEM_CD AND DLVY_PLAN_DT = DATEADD(day, 33, @ProdPlanMonth)) QTY34,    "
                    lgStrSQL = lgStrSQL & vbCrLf & " 		(SELECT PLAN_QTY FROM SALES_ITEM_REQ_PLAN_KO441 WHERE PROJECT_CODE = A.PROJECT_CODE AND ITEM_CD = A.ITEM_CD AND DLVY_PLAN_DT = DATEADD(day, 34, @ProdPlanMonth)) QTY35,    "
                    lgStrSQL = lgStrSQL & vbCrLf & " 		(SELECT PLAN_QTY FROM SALES_ITEM_REQ_PLAN_KO441 WHERE PROJECT_CODE = A.PROJECT_CODE AND ITEM_CD = A.ITEM_CD AND DLVY_PLAN_DT = DATEADD(day, 35, @ProdPlanMonth)) QTY36,    "
                    lgStrSQL = lgStrSQL & vbCrLf & " 		(SELECT PLAN_QTY FROM SALES_ITEM_REQ_PLAN_KO441 WHERE PROJECT_CODE = A.PROJECT_CODE AND ITEM_CD = A.ITEM_CD AND DLVY_PLAN_DT = DATEADD(day, 36, @ProdPlanMonth)) QTY37,    "
                    lgStrSQL = lgStrSQL & vbCrLf & " 		(SELECT PLAN_QTY FROM SALES_ITEM_REQ_PLAN_KO441 WHERE PROJECT_CODE = A.PROJECT_CODE AND ITEM_CD = A.ITEM_CD AND DLVY_PLAN_DT = DATEADD(day, 37, @ProdPlanMonth)) QTY38,    "
                    lgStrSQL = lgStrSQL & vbCrLf & " 		(SELECT PLAN_QTY FROM SALES_ITEM_REQ_PLAN_KO441 WHERE PROJECT_CODE = A.PROJECT_CODE AND ITEM_CD = A.ITEM_CD AND DLVY_PLAN_DT = DATEADD(day, 38, @ProdPlanMonth)) QTY39,    "
                    lgStrSQL = lgStrSQL & vbCrLf & " 		(SELECT PLAN_QTY FROM SALES_ITEM_REQ_PLAN_KO441 WHERE PROJECT_CODE = A.PROJECT_CODE AND ITEM_CD = A.ITEM_CD AND DLVY_PLAN_DT = DATEADD(day, 39, @ProdPlanMonth)) QTY40,    "
                    ...
                    lgStrSQL = lgStrSQL & vbCrLf & " 		B.ITEM_NM,                                                                                                                                                                 "
                    lgStrSQL = lgStrSQL & vbCrLf & " 		'' tracking_no,                                                                                                                                                            "
                    lgStrSQL = lgStrSQL & vbCrLf & " 		'생산계획' TYPE,                                                                                                                                                           "
                    lgStrSQL = lgStrSQL & vbCrLf & " 		0 QTY01,                                                                                                                                                                   "
                    lgStrSQL = lgStrSQL & vbCrLf & " 		0 QTY02,                                                                                                                                                                   "
                    lgStrSQL = lgStrSQL & vbCrLf & " 		0 QTY03,                                                                                                                                                                   "
                    lgStrSQL = lgStrSQL & vbCrLf & " 		0 QTY04,                                                                                                                                                                   "
                    lgStrSQL = lgStrSQL & vbCrLf & " 		0 QTY05,                                                                                                                                                                   "
                    lgStrSQL = lgStrSQL & vbCrLf & " 		0 QTY06,                                                                                                                                                                   "
                    lgStrSQL = lgStrSQL & vbCrLf & " 		0 QTY07,                                                                                                                                                                   "
                    lgStrSQL = lgStrSQL & vbCrLf & " 		0 QTY08,                                                                                                                                                                   "
                    lgStrSQL = lgStrSQL & vbCrLf & " 		0 QTY09,                                                                                                                                                                   "
                    lgStrSQL = lgStrSQL & vbCrLf & " 		0 QTY10,                                                                                                                                                                   "
                    lgStrSQL = lgStrSQL & vbCrLf & " 		0 QTY11,                                                                                                                                                                   "
                    lgStrSQL = lgStrSQL & vbCrLf & " 		0 QTY12,                                                                                                                                                                   "
                    lgStrSQL = lgStrSQL & vbCrLf & " 		0 QTY13,                                                                                                                                                                   "
                    lgStrSQL = lgStrSQL & vbCrLf & " 		0 QTY14,                                                                                                                                                                   "
                    lgStrSQL = lgStrSQL & vbCrLf & " 		0 QTY15,                                                                                                                                                                   "
                    lgStrSQL = lgStrSQL & vbCrLf & " 		0 QTY16,                                                                                                                                                                   "
                    lgStrSQL = lgStrSQL & vbCrLf & " 		0 QTY17,                                                                                                                                                                   "
                    lgStrSQL = lgStrSQL & vbCrLf & " 		0 QTY18,                                                                                                                                                                   "
                    lgStrSQL = lgStrSQL & vbCrLf & " 		0 QTY19,                                                                                                                                                                   "
                    lgStrSQL = lgStrSQL & vbCrLf & " 		0 QTY20,                                                                                                                                                                   "
                    lgStrSQL = lgStrSQL & vbCrLf & " 		0 QTY21,                                                                                                                                                                   "
                    lgStrSQL = lgStrSQL & vbCrLf & " 		0 QTY22,                                                                                                                                                                   "
                    lgStrSQL = lgStrSQL & vbCrLf & " 		0 QTY23,                                                                                                                                                                   "
                    lgStrSQL = lgStrSQL & vbCrLf & " 		0 QTY24,                                                                                                                                                                   "
                    lgStrSQL = lgStrSQL & vbCrLf & " 		0 QTY25,                                                                                                                                                                   "
                    lgStrSQL = lgStrSQL & vbCrLf & " 		0 QTY26,                                                                                                                                                                   "
                    lgStrSQL = lgStrSQL & vbCrLf & " 		0 QTY27,                                                                                                                                                                   "
                    lgStrSQL = lgStrSQL & vbCrLf & " 		0 QTY28,                                                                                                                                                                   "
                    lgStrSQL = lgStrSQL & vbCrLf & " 		0 QTY29,                                                                                                                                                                   "
                    lgStrSQL = lgStrSQL & vbCrLf & " 		0 QTY30,                                                                                                                                                                   "
                    lgStrSQL = lgStrSQL & vbCrLf & " 		0 QTY31,                                                                                                                                                                   "
                    lgStrSQL = lgStrSQL & vbCrLf & " 		0 QTY32,                                                                                                                                                                   "
                    lgStrSQL = lgStrSQL & vbCrLf & " 		0 QTY33,                                                                                                                                                                   "
                    lgStrSQL = lgStrSQL & vbCrLf & " 		0 QTY34,                                                                                                                                                                   "
                    lgStrSQL = lgStrSQL & vbCrLf & " 		0 QTY35,                                                                                                                                                                   "
                    lgStrSQL = lgStrSQL & vbCrLf & " 		0 QTY36,                                                                                                                                                                   "
                    lgStrSQL = lgStrSQL & vbCrLf & " 		0 QTY37,                                                                                                                                                                   "
                    lgStrSQL = lgStrSQL & vbCrLf & " 		0 QTY38,                                                                                                                                                                   "
                    lgStrSQL = lgStrSQL & vbCrLf & " 		0 QTY39,                                                                                                                                                                   "
                    lgStrSQL = lgStrSQL & vbCrLf & " 		0 QTY40,                                                                                                                                                                   "
                    lgStrSQL = lgStrSQL & vbCrLf & "         0 MONTH_1,                                                                                                                                                                "
                    lgStrSQL = lgStrSQL & vbCrLf & "         0 MONTH_2,                                                                                                                                                                "
                    lgStrSQL = lgStrSQL & vbCrLf & "         0 MONTH_3                                                                                                                                                                 "
                    lgStrSQL = lgStrSQL & vbCrLf & " FROM	SALES_ITEM_REQ_PLAN_KO441 A,                                                                                                                                               "
                    ...
                    lgStrSQL = lgStrSQL & vbCrLf & "         0 MONTH_2,                                                                                                                                                                "
                    lgStrSQL = lgStrSQL & vbCrLf & "         0 MONTH_3                                                                                                                                                                 "
                    lgStrSQL = lgStrSQL & vbCrLf & " FROM	P_MPS A,                                                                                                                                                                   "
                    lgStrSQL = lgStrSQL & vbCrLf & " 		B_ITEM B                                                                                                                                                                   "
                    lgStrSQL = lgStrSQL & vbCrLf & " WHERE	A.ITEM_CD = B.ITEM_CD                                                                                                                                                      "
                    lgStrSQL = lgStrSQL & vbCrLf & " AND	A.PLANT_CD = @PlantCd                                                                                                                                                      "
                    lgStrSQL = lgStrSQL & vbCrLf & "  AND    CONVERT(CHAR(10), A.mps_dt, 120) BETWEEN @ProdPlanMonth AND DATEADD(day, @iPeriod, @ProdPlanMonth)                                                                        "
                    lgStrSQL = lgStrSQL & vbCrLf & " and mps_confirm_flg <> 'Y'     "
                    lgStrSQL = lgStrSQL & vbCrLf & " and mrp_confirm_flg <> 'Y'     "
                    lgStrSQL = lgStrSQL & vbCrLf & " and mps_status not in ('FM', 'PL')   "
                    lgStrSQL = lgStrSQL & vbCrLf & "                                                                                                                                                                                   "
                    lgStrSQL = lgStrSQL & vbCrLf & "UNION ALL                                                                                                                                                                          "
                    lgStrSQL = lgStrSQL & vbCrLf & "                                                                                                                                                                                   "
                    lgStrSQL = lgStrSQL & vbCrLf & " SELECT	DISTINCT A.ITEM_CD,                                                                                                                                                        "
                    ...
                    lgStrSQL = lgStrSQL & vbCrLf & " 		'' tracking_no,                                                                                                                                                            "
                    lgStrSQL = lgStrSQL & vbCrLf & " 		'생산계획' TYPE,                                                                                                                                                           "
                    lgStrSQL = lgStrSQL & vbCrLf & " 		(SELECT ISNULL(sum(mps_qty), 0) FROM P_MPS WHERE PLANT_CD = A.PLANT_CD AND ITEM_CD = A.ITEM_CD AND mps_dt = DATEADD(day, 0, @ProdPlanMonth)  AND mps_status = 'OP'  ) QTY01,                             "
                    lgStrSQL = lgStrSQL & vbCrLf & " 		(SELECT ISNULL(sum(mps_qty), 0) FROM P_MPS WHERE PLANT_CD = A.PLANT_CD AND ITEM_CD = A.ITEM_CD AND mps_dt = DATEADD(day, 1, @ProdPlanMonth)  AND mps_status = 'OP'  ) QTY02,                             "
                    lgStrSQL = lgStrSQL & vbCrLf & " 		(SELECT ISNULL(sum(mps_qty), 0) FROM P_MPS WHERE PLANT_CD = A.PLANT_CD AND ITEM_CD = A.ITEM_CD AND mps_dt = DATEADD(day, 2, @ProdPlanMonth)  AND mps_status = 'OP'  ) QTY03,                             "
                    lgStrSQL = lgStrSQL & vbCrLf & " 		(SELECT ISNULL(sum(mps_qty), 0) FROM P_MPS WHERE PLANT_CD = A.PLANT_CD AND ITEM_CD = A.ITEM_CD AND mps_dt = DATEADD(day, 3, @ProdPlanMonth)  AND mps_status = 'OP'  ) QTY04,                             "
                    lgStrSQL = lgStrSQL & vbCrLf & " 		(SELECT ISNULL(sum(mps_qty), 0) FROM P_MPS WHERE PLANT_CD = A.PLANT_CD AND ITEM_CD = A.ITEM_CD AND mps_dt = DATEADD(day, 4, @ProdPlanMonth)  AND mps_status = 'OP'  ) QTY05,                             "
                    lgStrSQL = lgStrSQL & vbCrLf & " 		(SELECT ISNULL(sum(mps_qty), 0) FROM P_MPS WHERE PLANT_CD = A.PLANT_CD AND ITEM_CD = A.ITEM_CD AND mps_dt = DATEADD(day, 5, @ProdPlanMonth)  AND mps_status = 'OP'  ) QTY06,                             "
                    lgStrSQL = lgStrSQL & vbCrLf & " 		(SELECT ISNULL(sum(mps_qty), 0) FROM P_MPS WHERE PLANT_CD = A.PLANT_CD AND ITEM_CD = A.ITEM_CD AND mps_dt = DATEADD(day, 6, @ProdPlanMonth)  AND mps_status = 'OP'  ) QTY07,                             "
                    lgStrSQL = lgStrSQL & vbCrLf & " 		(SELECT ISNULL(sum(mps_qty), 0) FROM P_MPS WHERE PLANT_CD = A.PLANT_CD AND ITEM_CD = A.ITEM_CD AND mps_dt = DATEADD(day, 7, @ProdPlanMonth)  AND mps_status = 'OP'  ) QTY08,                             "
                    lgStrSQL = lgStrSQL & vbCrLf & " 		(SELECT ISNULL(sum(mps_qty), 0) FROM P_MPS WHERE PLANT_CD = A.PLANT_CD AND ITEM_CD = A.ITEM_CD AND mps_dt = DATEADD(day, 8, @ProdPlanMonth)  AND mps_status = 'OP'  ) QTY09,                             "
                    lgStrSQL = lgStrSQL & vbCrLf & " 		(SELECT ISNULL(sum(mps_qty), 0) FROM P_MPS WHERE PLANT_CD = A.PLANT_CD AND ITEM_CD = A.ITEM_CD AND mps_dt = DATEADD(day, 9, @ProdPlanMonth)  AND mps_status = 'OP'  ) QTY10,                             "
                    lgStrSQL = lgStrSQL & vbCrLf & " 		(SELECT ISNULL(sum(mps_qty), 0) FROM P_MPS WHERE PLANT_CD = A.PLANT_CD AND ITEM_CD = A.ITEM_CD AND mps_dt = DATEADD(day, 10, @ProdPlanMonth)  AND mps_status = 'OP'  ) QTY11,                            "
                    lgStrSQL = lgStrSQL & vbCrLf & " 		(SELECT ISNULL(sum(mps_qty), 0) FROM P_MPS WHERE PLANT_CD = A.PLANT_CD AND ITEM_CD = A.ITEM_CD AND mps_dt = DATEADD(day, 11, @ProdPlanMonth)  AND mps_status = 'OP'  ) QTY12,                            "
                    lgStrSQL = lgStrSQL & vbCrLf & " 		(SELECT ISNULL(sum(mps_qty), 0) FROM P_MPS WHERE PLANT_CD = A.PLANT_CD AND ITEM_CD = A.ITEM_CD AND mps_dt = DATEADD(day, 12, @ProdPlanMonth)  AND mps_status = 'OP'  ) QTY13,                            "
                    lgStrSQL = lgStrSQL & vbCrLf & " 		(SELECT ISNULL(sum(mps_qty), 0) FROM P_MPS WHERE PLANT_CD = A.PLANT_CD AND ITEM_CD = A.ITEM_CD AND mps_dt = DATEADD(day, 13, @ProdPlanMonth)  AND mps_status = 'OP'  ) QTY14,                            "
                    lgStrSQL = lgStrSQL & vbCrLf & " 		(SELECT ISNULL(sum(mps_qty), 0) FROM P_MPS WHERE PLANT_CD = A.PLANT_CD AND ITEM_CD = A.ITEM_CD AND mps_dt = DATEADD(day, 14, @ProdPlanMonth)  AND mps_status = 'OP'  ) QTY15,                            "
                    lgStrSQL = lgStrSQL & vbCrLf & " 		(SELECT ISNULL(sum(mps_qty), 0) FROM P_MPS WHERE PLANT_CD = A.PLANT_CD AND ITEM_CD = A.ITEM_CD AND mps_dt = DATEADD(day, 15, @ProdPlanMonth)  AND mps_status = 'OP'  ) QTY16,                            "
                    lgStrSQL = lgStrSQL & vbCrLf & " 		(SELECT ISNULL(sum(mps_qty), 0) FROM P_MPS WHERE PLANT_CD = A.PLANT_CD AND ITEM_CD = A.ITEM_CD AND mps_dt = DATEADD(day, 16, @ProdPlanMonth)  AND mps_status = 'OP'  ) QTY17,                            "
                    lgStrSQL = lgStrSQL & vbCrLf & " 		(SELECT ISNULL(sum(mps_qty), 0) FROM P_MPS WHERE PLANT_CD = A.PLANT_CD AND ITEM_CD = A.ITEM_CD AND mps_dt = DATEADD(day, 17, @ProdPlanMonth)  AND mps_status = 'OP'  ) QTY18,                            "
                    lgStrSQL = lgStrSQL & vbCrLf & " 		(SELECT ISNULL(sum(mps_qty), 0) FROM P_MPS WHERE PLANT_CD = A.PLANT_CD AND ITEM_CD = A.ITEM_CD AND mps_dt = DATEADD(day, 18, @ProdPlanMonth)  AND mps_status = 'OP'  ) QTY19,                            "
                    lgStrSQL = lgStrSQL & vbCrLf & " 		(SELECT ISNULL(sum(mps_qty), 0) FROM P_MPS WHERE PLANT_CD = A.PLANT_CD AND ITEM_CD = A.ITEM_CD AND mps_dt = DATEADD(day, 19, @ProdPlanMonth)  AND mps_status = 'OP'  ) QTY20,                            "
                    lgStrSQL = lgStrSQL & vbCrLf & " 		(SELECT ISNULL(sum(mps_qty), 0) FROM P_MPS WHERE PLANT_CD = A.PLANT_CD AND ITEM_CD = A.ITEM_CD AND mps_dt = DATEADD(day, 20, @ProdPlanMonth)  AND mps_status = 'OP'  ) QTY21,                            "
                    lgStrSQL = lgStrSQL & vbCrLf & " 		(SELECT ISNULL(sum(mps_qty), 0) FROM P_MPS WHERE PLANT_CD = A.PLANT_CD AND ITEM_CD = A.ITEM_CD AND mps_dt = DATEADD(day, 21, @ProdPlanMonth)  AND mps_status = 'OP'  ) QTY22,                            "
                    lgStrSQL = lgStrSQL & vbCrLf & " 		(SELECT ISNULL(sum(mps_qty), 0) FROM P_MPS WHERE PLANT_CD = A.PLANT_CD AND ITEM_CD = A.ITEM_CD AND mps_dt = DATEADD(day, 22, @ProdPlanMonth)  AND mps_status = 'OP'  ) QTY23,                            "
                    lgStrSQL = lgStrSQL & vbCrLf & " 		(SELECT ISNULL(sum(mps_qty), 0) FROM P_MPS WHERE PLANT_CD = A.PLANT_CD AND ITEM_CD = A.ITEM_CD AND mps_dt = DATEADD(day, 23, @ProdPlanMonth)  AND mps_status = 'OP'  ) QTY24,                            "
                    lgStrSQL = lgStrSQL & vbCrLf & " 		(SELECT ISNULL(sum(mps_qty), 0) FROM P_MPS WHERE PLANT_CD = A.PLANT_CD AND ITEM_CD = A.ITEM_CD AND mps_dt = DATEADD(day, 24, @ProdPlanMonth)  AND mps_status = 'OP'  ) QTY25,                            "
                    lgStrSQL = lgStrSQL & vbCrLf & " 		(SELECT ISNULL(sum(mps_qty), 0) FROM P_MPS WHERE PLANT_CD = A.PLANT_CD AND ITEM_CD = A.ITEM_CD AND mps_dt = DATEADD(day, 25, @ProdPlanMonth)  AND mps_status = 'OP'  ) QTY26,                            "
                    lgStrSQL = lgStrSQL & vbCrLf & " 		(SELECT ISNULL(sum(mps_qty), 0) FROM P_MPS WHERE PLANT_CD = A.PLANT_CD AND ITEM_CD = A.ITEM_CD AND mps_dt = DATEADD(day, 26, @ProdPlanMonth)  AND mps_status = 'OP'  ) QTY27,                            "
                    lgStrSQL = lgStrSQL & vbCrLf & " 		(SELECT ISNULL(sum(mps_qty), 0) FROM P_MPS WHERE PLANT_CD = A.PLANT_CD AND ITEM_CD = A.ITEM_CD AND mps_dt = DATEADD(day, 27, @ProdPlanMonth)  AND mps_status = 'OP'  ) QTY28,                            "
                    lgStrSQL = lgStrSQL & vbCrLf & " 		(SELECT ISNULL(sum(mps_qty), 0) FROM P_MPS WHERE PLANT_CD = A.PLANT_CD AND ITEM_CD = A.ITEM_CD AND mps_dt = DATEADD(day, 28, @ProdPlanMonth)  AND mps_status = 'OP'  ) QTY29,                            "
                    lgStrSQL = lgStrSQL & vbCrLf & " 		(SELECT ISNULL(sum(mps_qty), 0) FROM P_MPS WHERE PLANT_CD = A.PLANT_CD AND ITEM_CD = A.ITEM_CD AND mps_dt = DATEADD(day, 29, @ProdPlanMonth)  AND mps_status = 'OP'  ) QTY30,                            "
                    lgStrSQL = lgStrSQL & vbCrLf & " 		(SELECT ISNULL(sum(mps_qty), 0) FROM P_MPS WHERE PLANT_CD = A.PLANT_CD AND ITEM_CD = A.ITEM_CD AND mps_dt = DATEADD(day, 30, @ProdPlanMonth)  AND mps_status = 'OP'  ) QTY31,                            "
                    lgStrSQL = lgStrSQL & vbCrLf & " 		(SELECT ISNULL(sum(mps_qty), 0) FROM P_MPS WHERE PLANT_CD = A.PLANT_CD AND ITEM_CD = A.ITEM_CD AND mps_dt = DATEADD(day, 31, @ProdPlanMonth)  AND mps_status = 'OP'  ) QTY32,                            "
                    lgStrSQL = lgStrSQL & vbCrLf & " 		(SELECT ISNULL(sum(mps_qty), 0) FROM P_MPS WHERE PLANT_CD = A.PLANT_CD AND ITEM_CD = A.ITEM_CD AND mps_dt = DATEADD(day, 32, @ProdPlanMonth)  AND mps_status = 'OP'  ) QTY33,                            "
                    lgStrSQL = lgStrSQL & vbCrLf & " 		(SELECT ISNULL(sum(mps_qty), 0) FROM P_MPS WHERE PLANT_CD = A.PLANT_CD AND ITEM_CD = A.ITEM_CD AND mps_dt = DATEADD(day, 33, @ProdPlanMonth)  AND mps_status = 'OP'  ) QTY34,                            "
                    lgStrSQL = lgStrSQL & vbCrLf & " 		(SELECT ISNULL(sum(mps_qty), 0) FROM P_MPS WHERE PLANT_CD = A.PLANT_CD AND ITEM_CD = A.ITEM_CD AND mps_dt = DATEADD(day, 34, @ProdPlanMonth)  AND mps_status = 'OP'  ) QTY35,                            "
                    lgStrSQL = lgStrSQL & vbCrLf & " 		(SELECT ISNULL(sum(mps_qty), 0) FROM P_MPS WHERE PLANT_CD = A.PLANT_CD AND ITEM_CD = A.ITEM_CD AND mps_dt = DATEADD(day, 35, @ProdPlanMonth)  AND mps_status = 'OP'  ) QTY36,                            "
                    lgStrSQL = lgStrSQL & vbCrLf & " 		(SELECT ISNULL(sum(mps_qty), 0) FROM P_MPS WHERE PLANT_CD = A.PLANT_CD AND ITEM_CD = A.ITEM_CD AND mps_dt = DATEADD(day, 36, @ProdPlanMonth)  AND mps_status = 'OP'  ) QTY37,                            "
                    lgStrSQL = lgStrSQL & vbCrLf & " 		(SELECT ISNULL(sum(mps_qty), 0) FROM P_MPS WHERE PLANT_CD = A.PLANT_CD AND ITEM_CD = A.ITEM_CD AND mps_dt = DATEADD(day, 37, @ProdPlanMonth)  AND mps_status = 'OP'  ) QTY38,                            "
                    lgStrSQL = lgStrSQL & vbCrLf & " 		(SELECT ISNULL(sum(mps_qty), 0) FROM P_MPS WHERE PLANT_CD = A.PLANT_CD AND ITEM_CD = A.ITEM_CD AND mps_dt = DATEADD(day, 38, @ProdPlanMonth)  AND mps_status = 'OP'  ) QTY39,                            "
                    lgStrSQL = lgStrSQL & vbCrLf & " 		(SELECT ISNULL(sum(mps_qty), 0) FROM P_MPS WHERE PLANT_CD = A.PLANT_CD AND ITEM_CD = A.ITEM_CD AND mps_dt = DATEADD(day, 39, @ProdPlanMonth)  AND mps_status = 'OP'  ) QTY40,                            "
                    lgStrSQL = lgStrSQL & vbCrLf & "         0 MONTH_1,                                                                                                                                                                "
                    lgStrSQL = lgStrSQL & vbCrLf & "         0 MONTH_2,                                                                                                                                                                "
                    lgStrSQL = lgStrSQL & vbCrLf & "         0 MONTH_3                                                                                                                                                                 "
                    lgStrSQL = lgStrSQL & vbCrLf & " FROM	P_MPS A,                                                                                                                                                                   "
                    ...
                    lgStrSQL = lgStrSQL & vbCrLf & " where x.item_cd like @ItemCd + '%' "
...
'                    lgStrSQL = lgStrSQL & vbCrLf & "    from pms_item_req_plan_ko441 a (nolock) "
    ...
    For i = 0 To 39  '20080304::hanc:: 30
        ...
        If UNIConvNum(arrColVal(3 * i + 6), 0) <> UNIConvNum(arrColVal(3 * i + 7), 0) Then
			...
			If FncOpenRs("R", lgObjConn, lgObjRs, lgStrSQL, "X", "X") = False Then
			    ...
			    Call SetErrorStatus()
			Else
			'hanc	If UNIConvNum(lgObjRs("nvnum"),0) > 0 Then
			'hanc		Call DisplayMsgBox("P43002", vbInformation, "", "", I_MKSCRIPT)      '☜ : No data is found.
			'hanc		Call SetErrorStatus()
			'hanc	Else
					'미확정된 자료라면
