...
<SCRIPT LANGUAGE = "VBScript" SRC = "p2217ma1.vbs"></SCRIPT>
					...
					<TD CLASS="CLSMTABP">
						<TABLE ID="MyTab" CELLSPACING=0 CELLPADDING=0>
							<TR>
								...
								<td background="../../../CShared/image/table/seltab_up_bg.gif" align="center" CLASS="CLSMTAB"><font color=white>MPS관리</font></td>
						...
						<FIELDSET CLASS="CLSFLD">
							<TABLE <%=LR_SPACE_TYPE_40%>>
								<TR>
									...
									<TD CLASS="TD6">
										<script language =javascript src='./js/p2217ma1_fpDateTime3_txtPlndFromDt.js'></script>
										&nbsp;~&nbsp;
										<script language =javascript src='./js/p2217ma1_fpDateTime3_txtPlndToDt.js'></script>
									</TD>																						
								</TR>
								<TR>
									<TD CLASS=TD5 NOWRAP>품목</TD>
									<TD CLASS=TD6 NOWRAP><INPUT TYPE=TEXT NAME="txtItemCd" SIZE=18 MAXLENGTH=18 tag="11XXXU" ALT="품목"><IMG SRC="../../../CShared/image/btnPopup.gif" NAME="btnItemCd" align=top TYPE="BUTTON"ONCLICK="vbscript:OpenItemInfo frm1.txtItemCd.value,0">&nbsp;<INPUT TYPE=TEXT NAME="txtItemNm" SIZE=25 tag="14"></TD>
					...
					<TABLE <%=LR_SPACE_TYPE_20%>>
						<TR>
							<TD HEIGHT="100%" colspan=4>
								<script language =javascript src='./js/p2217ma1_I510907393_vspdData.js'></script>
							</TD>
						</TR>
						<TR>
							...
							<FIELDSET valign=top>
								...
								<TABLE CLASS="TB2" CELLSPACING=0>
									<TR>
										...
										<TD CLASS=TD6 NOWRAP>
											<script language =javascript src='./js/p2217ma1_I971399927_txtMaxLotQty.js'></script>
										</TD>
									...
									<TR>
										...
										<TD CLASS=TD6 NOWRAP>
											<script language =javascript src='./js/p2217ma1_I506583994_txtMinLotQty.js'></script>
										</TD>
									...
									<TR>
										...
										<TD CLASS=TD6 NOWRAP>
											<script language =javascript src='./js/p2217ma1_I116137993_txtRondQty.js'></script>
										</TD>
							...
							<FIELDSET valign=top>
								...
								<TABLE CLASS="TB2" CELLSPACING=0>
									<TR>
										...
										<TD CLASS=TD6 NOWRAP>
											<script language =javascript src='./js/p2217ma1_I522844403_txtDTF.js'></script>
										</TD>
									</TR>	
									<TR>
										<TD CLASS=TD5 NOWRAP>PTF(Planning Time Fence)</TD>
										<TD CLASS=TD6 NOWRAP>
											<script language =javascript src='./js/p2217ma1_I402000319_txtPTF.js'></script>
										</TD>
									</TR>	
									<TR>
										<TD CLASS=TD5 NOWRAP>Planning Horizon</TD>
										<TD CLASS=TD6 NOWRAP>
											<script language =javascript src='./js/p2217ma1_I224389749_txtPH.js'></script>
										</TD>
									</TR>	
								</TABLE>	
							</FIELDSET>			
	...
	<TR HEIGHT=20>
		<TD WIDTH=100%>
			<TABLE <%=LR_SPACE_TYPE_30%>>
				<TR>
					<TD WIDTH=10>&nbsp;</TD>
					<TD><BUTTON NAME="btnSelect1" CLASS="CLSMBTN" onclick="ConfirmMPS()">MPS확정</BUTTON>&nbsp;<BUTTON NAME="btnAutoSel" CLASS="CLSMBTN">전체선택</BUTTON></TD>
				</TR>
			</TABLE>
		</TD>
	</TR>
