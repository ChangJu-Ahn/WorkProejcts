...
'*  1. Module Name          : 
'*  2. Function Name        : 
'*  3. Program ID           : p2220oa1.asp
'*  4. Program Name         : MPS전개근거 출력 
'*  5. Program Desc         :
'*  6. Comproxy List        : 
					...
					<TD>
						<TABLE ID="MyTab" CELLSPACING=0 CELLPADDING=0>
							<TR>
								...
								<td background="../../../CShared/image/table/seltab_up_bg.gif" align="center" CLASS="CLSMTABP"><font color=white>MPS생성근거출력</font></td>
