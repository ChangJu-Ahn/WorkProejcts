...
<SCRIPT LANGUAGE = "VBScript" SRC = "p2240ma1_ko441.vbs"></SCRIPT>
...
Sub Form_Load()
    ...
    frm1.txtPlanDt.Text = UniConvDateAToB(strDate, Parent.gDateFormat, Parent.gDateFormatYYYYMM)        '20080304::hanc
					...
					<TD>
						<TABLE ID="MyTab" CELLSPACING=0 CELLPADDING=0>
							<TR>
								...
								<td background="../../../CShared/image/table/seltab_up_bg.gif" align="center" CLASS="CLSMTAB"><font color=white>수주계획일괄복사</font></td>
				...
				<TR>
					<TD WIDTH=100% HEIGHT=* valign=top>
						<TABLE CLASS="BasicTB" CELLSPACING=0 CELLPADDING=0>							
							...
							<TR>
								<TD CLASS=TD5 NOWRAP>생산계획기간<br>&nbsp;</TD>
								<TD CLASS=TD6 NOWRAP>
									<script language =javascript src='./js/p2210ma1_I662456655_txtPlanDt.js'></script> 
									<br><INPUT TYPE=TEXT  NAME="txtPeriod" SIZE=2 MAXLENGTH=2 tag="14" ALT = "생산계획기간">일
								</TD>
							</TR>
							<TR STYLE="DISPLAY:NONE">
