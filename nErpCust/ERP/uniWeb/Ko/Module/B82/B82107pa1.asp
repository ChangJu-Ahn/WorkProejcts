...
Const BIZ_PGM_ID = "B82107pb1.asp"           <% '☆: 비지니스 로직 ASP명 %>
...
Sub InitSpreadSheet()
     ...
     frm1.vspdData.MaxCols = C_ReqReason + 1
	 ...
	 ggoSpread.SSSetEdit  C_NewItemNm,	"변경품목",   20
	 ggoSpread.SSSetEdit  C_NewSpec,	"변경규격",	  20
	 ...
	 ggoSpread.SSSetDate  C_TransDt,    "이관일자",   10, 2, PopupParent.gDateFormat  
 	 ggoSpread.SSSetEdit  C_ReqReason,	"의뢰사유",	  50
...
Sub GetSpreadColumnPos(ByVal pvSpdNo)
    ...
    Select Case UCase(pvSpdNo)
       Case "A"
		    ...
		    C_NewItemNm	= iCurColumnPos(10)
		    C_NewSpec	= iCurColumnPos(11)
		    C_AcctR		= iCurColumnPos(12)
		    C_AcctT		= iCurColumnPos(13)
		    C_AcctP		= iCurColumnPos(14)
		    C_AcctQ		= iCurColumnPos(15)
		    C_TransDt	= iCurColumnPos(16)
		    C_ReqReason	= iCurColumnPos(17)
    End Select    
End Sub
               ...
               <FIELDSET CLASS="CLSFLD">
                    <TABLE <%=LR_SPACE_TYPE_40%>>
                        <TR>
                          ...
                          <TD CLASS=TD6 NOWRAP><script language =javascript src='./js/b82107pa1_fpDateTime5_txtDtFr.js'></script>&nbsp;~&nbsp;
                                               <script language =javascript src='./js/b82107pa1_fpDateTime6_txtDtTo.js'></script>
                        </TD>
     ...
     <TR>
          <TD WIDTH=100% HEIGHT=* valign=top>
               <TABLE <%=LR_SPACE_TYPE_20%>>
                    <TR>
                         <TD HEIGHT="100%">
                              <script language =javascript src='./js/b82107pa1_vaSpread1_vspdData.js'></script>
                         </TD>
                    </TR>
               </TABLE>
          </TD>
