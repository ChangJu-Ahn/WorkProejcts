...
'   on error resume next
	  ...
	  '-----------------------------
	    Call SubOpenDB(lgObjConn) 
	  	call GetNameChk("MINOR_NM","B_MINOR","MINOR_CD="&filterVar(Request("txtreq_user"),"''","S") & " AND MAJOR_CD=" & filterVar("Y1006","''","S") ,	Request("txtreq_user"),"txtreq_user","의뢰자","Y") '의뢰자 
		call GetNameChk("item_nm","B_CIS_ITEM_MASTER","item_cd="&filterVar(Request("txtitem_cd"),"''","S"),	Request("txtItem_cd"),"txtItem_cd","품목코드","N") '품목code
...
Sub FixUNISQLData()
	...
	UNISqlId(0) = "B82109MA101" 											' header
	UNIValue(0,0)="REQ_NO,dbo.ufn_GetCodeName('Y1006' , REQ_ID ),REQ_DT,dbo.ufn_s_CIS_GetStatus(STATUS),ITEM_CD,NEW_ITEM_NM,NEW_ITEM_SPEC,dbo.ufn_GetCodeName('Y1007' ,R_GRADE ),dbo.ufn_GetCodeName('Y1007' ,T_GRADE ),dbo.ufn_GetCodeName('Y1007' ,P_GRADE ),dbo.ufn_GetCodeName('Y1007' ,Q_GRADE ),END_DT,TRANS_DT"
