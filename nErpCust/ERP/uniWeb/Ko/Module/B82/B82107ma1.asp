...
<SCRIPT LANGUAGE="VBScript"   SRC="B82107ma1.vbs"></SCRIPT>
						        ...
						        <TD WIDTH=100% VALIGN=TOP>
									...
									<TABLE <%=LR_SPACE_TYPE_60%>>									
									    <TR>
				            				...
				            				<TD CLASS="TD6"><script language =javascript src='./js/b82107ma1_fpDateTime1_txtEndDt.js'></script></TD>
	                   						<TD CLASS="TD5" NOWRAP>이관일자</TD>
				            				<TD CLASS="TD6"><script language =javascript src='./js/b82107ma1_fpDateTime1_txtTransDt.js'></script></TD>
              							</TR>									    
	        						    <TR>
				            			    <TD CLASS=TD5 NOWRAP>의뢰자</TD>
				            				<TD CLASS=TD6 NOWRAP><INPUT NAME="txtreq_user" ALT="의뢰자" TYPE="Text" SiZE=10 MAXLENGTH=10   tag="22XXXU"><IMG SRC="../../../CShared/image/btnPopup.gif" NAME="btnPumpType" align=top TYPE="BUTTON" ONCLICK="VBScript: OpenPopup('1')">
				            				                     <INPUT NAME="txtreq_user_Nm" ALT="의뢰자명" TYPE="Text" SiZE=25   tag="24XXXU"></TD>
				            			    <TD CLASS=TD5 NOWRAP>의뢰일자</TD>
				            				<TD CLASS=TD6 NOWRAP><script language =javascript src='./js/b82107ma1_fpDateTime1_txtReqDt.js'></script></TD>				            				                
	        						    </TR>
				            			<TR>
                                            <TD CLASS=TD5 NOWRAP>변경품목명</TD>
                                            <TD CLASS=TD6 NOWRAP><INPUT NAME="txtNewItemNm"  ALT="품목명"     TYPE="Text" SiZE=40 maxlength=40 tag="22XXXU"></TD>
	                   						<TD CLASS=TD5 NOWRAP>변경품목정식명</TD>
				            				<TD CLASS=TD6 NOWRAP><INPUT NAME="txtNewItemNm2" ALT="품목정식명" TYPE="Text" SiZE=38 maxlength=40  tag="21XXXX"></TD>
				            			</TR>	
				            			<TR>	
				            				<TD CLASS=TD5 NOWRAP>변경규격</TD>
				            				<TD CLASS=TD6 NOWRAP><INPUT NAME="txtNewSpec"    ALT="규격" TYPE="Text" SiZE=38 maxlength=40 tag="22XXXU"><IMG SRC="../../../CShared/image/btnPopup.gif" NAME="btnPumpType" align=top TYPE="BUTTON" ONCLICK="VBScript: OpenCategory()">
	        						        <TD CLASS=TD5 NOWRAP>변경상세규격</TD>
				            				<TD CLASS=TD6 NOWRAP><INPUT NAME="txtNewSpec2"   ALT="상세규격" TYPE="Text" SiZE=38  maxlength=40 tag="21XXXX"></TD>
				            			</TR>       						    
	        						    <TR>
              							    <TD CLASS=TD5 NOWRAP>의뢰사유</TD>
				            				<TD CLASS=TD6 ColSpan=3><TEXTAREA  NAME="txtReqReason" tag="22xxx" rows = 3 cols=90  ALT="의뢰사유"></TEXTAREA>
