...
Const BIZ_PGM_ID = "B82101pb1.asp"           <% '☆: 비지니스 로직 ASP명 %>
               ...
               <FIELDSET CLASS="CLSFLD">
                    <TABLE <%=LR_SPACE_TYPE_40%>>
                        <TR>
                          ...
                          <TD CLASS=TD6 NOWRAP><script language =javascript src='./js/b82101pa1_fpDateTime5_txtDtFr.js'></script>&nbsp;~&nbsp;
                                               <script language =javascript src='./js/b82101pa1_fpDateTime6_txtDtTo.js'></script>
                        </TD>
                        ...
                        <TR>
                          ...
                          <TD CLASS=TD6 NOWRAP><INPUT NAME="txtreq_user" ALT="의뢰자" TYPE="Text" SiZE=10 MAXLENGTH=10   tag="11XXXU"><IMG SRC="../../../CShared/image/btnPopup.gif" NAME="btnPumpType" align=top TYPE="BUTTON" ONCLICK="VBScript: OpenPopup('2')">
                                               <INPUT NAME="txtreq_user_Nm" ALT="의뢰자명" TYPE="Text" SiZE=25   tag="14XXXU"></TD>
     ...
     <TR>
          <TD WIDTH=100% HEIGHT=* valign=top>
               <TABLE <%=LR_SPACE_TYPE_20%>>
                    <TR>
                         <TD HEIGHT="100%">
                              <script language =javascript src='./js/b82101pa1_vaSpread1_vspdData.js'></script>
                         </TD>
                    </TR>
               </TABLE>
          </TD>
