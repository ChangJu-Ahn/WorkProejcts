...
CONST BIZ_PGM_ID = "B82106QB1.ASP"
...
Sub InitSpreadSheet()
	...
	With frm1.vspdData
	   ...
	   .MaxRows = 0
		...
		ggoSpread.SSSetEdit C_END_DT, "완료일자", 10
		ggoSpread.SSSetEdit C_TRANS_DT, "이관일자", 10
			...
			<TABLE <%=LR_SPACE_TYPE_20%>>
				...
				<TR>
					...
					<TR>
							...
							<TD CLASS="TD6" NOWRAP >
							<script language =javascript src='./js/b82106qa1_OBJECT2_txtFromReqDt.js'></script>&nbsp;~&nbsp;
							<script language =javascript src='./js/b82106qa1_OBJECT3_txtToReqDt.js'></script>
						...
						<TR>
							...
							<TD CLASS="TD6" NOWRAP >
							<script language =javascript src='./js/b82106qa1_OBJECT2_txtFromEndDt.js'></script>&nbsp;~&nbsp;
							<script language =javascript src='./js/b82106qa1_OBJECT3_txtToEndDt.js'></script>
							</TD>
						</TR>
				...
				<TR>
					<TD WIDTH=100% HEIGHT=* valign=top>
						<TABLE WIDTH="100%" <%=LR_SPACE_TYPE_20%>>
							<TR>
								<TD HEIGHT="100%">
									<script language =javascript src='./js/b82106qa1_OBJECT1_vspdData.js'></script>
								</TD>
							</TR>
						</TABLE>
					</TD>
		...
		<TD>
		    <TABLE <%=LR_SPACE_TYPE_30%>>
		        <TR>
					...
					&nbsp;<A href='vbscript:Jump("B82105MA1")'>품목변경의뢰승인</a>
					</TD>
					<TD WIDTH=10>&nbsp;</TD>
		        </TR>
		    </TABLE>
