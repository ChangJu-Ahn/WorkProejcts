		...
		<TD WIDTH=100%>
			<TABLE <%=LR_SPACE_TYPE_10%>>
				<TR>
					...
					<TD WIDTH=* align=right><A href="vbscript:OpenItemCd()">변경품목코드참조&nbsp;</A></TD>
					<TD WIDTH=10>&nbsp;</TD>
				</TR>
			</TABLE>
		</TD>
                            ...
                            <TR>
						        <TD WIDTH=100% VALIGN=TOP>
									...
									<TABLE <%=LR_SPACE_TYPE_60%>>
	    				        	    <TR>
              							    <TD CLASS=TD5 NOWRAP>의뢰번호</TD>
				            				<TD CLASS=TD6 NOWRAP><INPUT NAME="txtReqNo" ALT="의뢰번호" TYPE="Text" SiZE=20 MAXLENGTH=18   tag="24XXXU">  <INPUT NAME="txtStatus" ALT="진행상태" TYPE="Text" SiZE=11 MAXLENGTH=18 style="font-weight:bold;text-align:center;"  tag="24XXXU"></TD>
				            				<TD CLASS=TD5 NOWRAP>품목코드</TD>
				            				<TD CLASS=TD6 NOWRAP><INPUT NAME="txtItemCd" ALT="품목코드" TYPE="Text" SiZE=15 MAXLENGTH=18   tag="24XXXU"></TD>
				            			</TR>
				            			<TR>
				            				<TD CLASS=TD5 NOWRAP>품목명</TD>
				            				<TD CLASS=TD6 NOWRAP><INPUT NAME="txtItemNm" ALT="품목명"   TYPE="Text" SiZE=40  tag="24XXXU"></TD>				            				
	                   						<TD CLASS=TD5 NOWRAP>품목정식명</TD>
				            				<TD CLASS=TD6 NOWRAP><INPUT NAME="txtItemNm2" ALT="품목정식명" TYPE="Text" SiZE=40   tag="24XXXX"></TD>
              							</TR>              							
				            			<TR>
				            				<TD CLASS=TD5 NOWRAP>규격</TD>
				            				<TD CLASS=TD6 NOWRAP><INPUT NAME="txtSpec" ALT="규격" TYPE="Text" SiZE=40 tag="24XXXU"></TD>
                            ...
                            <TR>
						        <TD WIDTH=100% VALIGN=TOP>
									...
									<TR>
				            				...
				            				<SELECT NAME="txtRgrade" TYPE="Text"  TAG="24" ALT="접수검토"><OPTION VALUE=""></OPTION></SELECT></TD>
									    ...
									    <TR>
									      ...
									      <TR>
                                            ...
                                            <TD CLASS=TD6 NOWRAP><INPUT NAME="txtBasicItem"   ALT="기준품목코드" TYPE="Text" SiZE=15 MAXLENGTH=18   tag="24XXXX">
				            				 ...
				            				 <TD CLASS=TD6 NOWRAP><INPUT NAME="txtItemUnit" ALT="재고단위" TYPE="Text" SiZE=10 MAXLENGTH=10   tag="22XXXU"><IMG SRC="../../../CShared/image/btnPopup.gif" NAME="btnPumpType" align=top TYPE="BUTTON" ONCLICK="VBScript: OpenPopup('1')"></TD>
			    		                 </TR>
			    		                 <TR>
				            			    <TD CLASS=TD5 NOWRAP>이력변경여부</TD>
								            <TD CLASS=TD6 NOWRAP><INPUT TYPE="RADIO" NAME="rdoChgVer" ID="rdoChgVer1" Value="Y" CLASS="RADIO" tag="21X"><LABEL FOR="rdoChgVer1">예</LABEL>
														         <INPUT TYPE="RADIO" NAME="rdoChgVer" ID="rdoChgVer2" Value="N" CLASS="RADIO" tag="21X" CHECKED><LABEL FOR="rdoChgVer2">아니오</LABEL>
														         <INPUT TYPE= HIDDEN NAME="hrdoChgVer"  SIZE= 10 MAXLENGTH=10  TAG="24" ALT="이력변경여부"></TD>
				            			    <TD CLASS=TD5 NOWRAP>단종여부</TD>
								            <TD CLASS=TD6 NOWRAP><INPUT TYPE="RADIO" NAME="rdoEndItem" ID="rdoEndItem1" Value="Y" CLASS="RADIO" tag="21X"><LABEL FOR="rdoEndItem1">예</LABEL>
														         <INPUT TYPE="RADIO" NAME="rdoEndItem" ID="rdoEndItem2" Value="N" CLASS="RADIO" tag="21X" CHECKED><LABEL FOR="rdoEndItem2">아니오</LABEL>
														         <INPUT TYPE= HIDDEN NAME="hrdoEndItem"SIZE= 10 MAXLENGTH=10  TAG="24" ALT="단종여부"></TD>
	        						    </TR>
              							<TR>
				            				...
				            				<TD CLASS=TD6 NOWRAP><INPUT NAME="txtPurGroup" ALT="구매그룹" TYPE="Text" SiZE=10 MAXLENGTH=10   tag="21XXXU"><IMG SRC="../../../CShared/image/btnPopup.gif" NAME="btnPumpType" align=top TYPE="BUTTON" ONCLICK="VBScript: OpenPopup('3')">
				            			...
				            			<TR>
				            				...
				            				<INPUT NAME="txtPurVendor" ALT="공급처" TYPE="Text" SiZE=10 MAXLENGTH=10   tag="21XXXU"><IMG SRC="../../../CShared/image/btnPopup.gif" NAME="btnPumpType" align=top TYPE="BUTTON" ONCLICK="VBScript: OpenPopup('2')">
	        						    ...
	        						    <TR>
				            				...
				            				<TD CLASS=TD6 NOWRAP><INPUT NAME="txtreq_user" ALT="의뢰자" TYPE="Text" SiZE=10 MAXLENGTH=10   tag="22XXXU"><IMG SRC="../../../CShared/image/btnPopup.gif" NAME="btnPumpType" align=top TYPE="BUTTON" ONCLICK="VBScript: OpenPopup('4')">
	        						    ...
	        						    <TR>
											...
											<TD CLASS=TD6 NOWRAP><script language =javascript src='./js/b82104ma1_OBJECT1_txtNetWeight.js'></script>&nbsp;
												                 <INPUT TYPE=TEXT NAME="txtNetWeightUnit" SIZE=5 MAXLENGTH=3 tag="21XXXU" ALT="Net중량단위"><IMG SRC="../../../CShared/image/btnPopup.gif" NAME="btnWeightUnit" align=top TYPE="BUTTON"ONCLICK="vbscript:OpenPopup('5')"></TD>
											...
											<TD CLASS=TD6 NOWRAP><script language =javascript src='./js/b82104ma1_OBJECT2_txtGrossWeight.js'></script>&nbsp;
												                 <INPUT TYPE=TEXT NAME="txtGrossWeightUnit" SIZE=5 MAXLENGTH=3 tag="21XXXU" ALT="Gross중량단위"><IMG SRC="../../../CShared/image/btnPopup.gif" NAME="btnGrossWeightUnit" align = top TYPE="BUTTON"ONCLICK="vbscript:OpenPopup('6')"></TD>
										</TR>
										<TR>
										...
										<TR>
											...
											<TD CLASS=TD6 NOWRAP><INPUT TYPE=TEXT NAME="txtHSCd" SIZE=13 MAXLENGTH=15 tag="21XXXU" ALT="HS코드"><IMG SRC="../../../CShared/image/btnPopup.gif" NAME="btnHsCd" align=top TYPE="BUTTON"ONCLICK="vbscript:OpenPopup('7')">
	        						    ...
	        						    <TR>
				            				...
				            				<TD CLASS=TD6 ColSpan=3><INPUT  NAME="txtRemark" tag="21xxx"  SiZE=107 MAXLENGTH=200   ALT="비고">
																    <INPUT TYPE=HIDDEN NAME="htxtRemark"  SIZE= 50 MAXLENGTH=70  TAG="24" ALT="비고"></TD>
	        						    </TR>
	        						    </TABLE>
							        </DIV>
				    		    </TD>
	...
	<!--<TR HEIGHT=12>
		<TD <%=HEIGHT_TYPE_03%> WIDTH=100%>
			<TABLE <%=LR_SPACE_TYPE_20%>>
					<TR>
						<TD>
							<BUTTON NAME="btnRun" CLASS="CLSMBTN" ONCLICK="vbscript:btnReReq()" >재의뢰</BUTTON>							
						</TD>
					</TR>
			</TABLE>
		</TD>
