...
Sub SubBizQueryMulti()
	...
	iLngMaxRow      = CInt(C_SHEETMAXROWS_D)
   
	Redim importArray(C_Next_chg_seq_Key+4)	
	'Key 값을 읽어온다 
    importArray(C_count)			= "" 'iStrPrevBdgCdKey
    importArray(C_dept_org_chg_id)	= UCase(Trim(Request("txtOrgChangeId")))
       ...
       For iLngRow = 0 To UBound(exportData2, 1)
          iIntLoopCount = iIntLoopCount + 1
           ...
           If iIntLoopCount < (C_SHEETMAXROWS_D + 1) Then
                ...
                istrData = istrData & Chr(11) & UNIMonthClientFormat(strChgDate)   'CHG_DATE
                istrData = istrData & Chr(11) & Trim(exportData2(iLngRow, 9))   'CTRL_UNIT
                istrData = istrData & Chr(11) & ConvSPChars(Trim(exportData2(iLngRow, 14)))  'DIVERT_FG
...
Sub SubBizSaveMulti()
    ...
    Call iPAFG215.F_MANAGE_BDG_CHG_SVR(gStrGlobalCollection, Trim(Request("txtSpread")),"D",iErrorPosition,I2_a_data_auth)						
