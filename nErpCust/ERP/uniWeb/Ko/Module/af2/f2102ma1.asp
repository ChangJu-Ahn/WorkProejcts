...
'*  3. Program ID           : f2102ma1
'*  4. Program Name         : 예산정보등록 
...
'**********************************************************************************************************
'⊙: 비지니스 로직 ASP명 
Const BIZ_PGM_ID = "f2102mb1.asp"			'☆: 비지니스 로직 ASP명 
...
Sub GetSpreadColumnPos(ByVal pvSpdNo)
    ...
    Select Case UCase(pvSpdNo)
       Case "A"
			...
			C_BDG_PLAN_AMT          = iCurColumnPos(9)
			C_BDG_AMT               = iCurColumnPos(10)
			C_BDG_GL_AMT            = iCurColumnPos(11)
			C_BDG_TEMP_AMT          = iCurColumnPos(12)
			C_ACCT_BDG_CTRL_FG      = iCurColumnPos(13)
			C_GP_BDG_CTRL_FG        = iCurColumnPos(14)
    End Select    
End Sub
