...
'*  3. Program ID           : f2104mb1
'*  4. Program Name         : 예산전용등록등록 
...
Sub SubBizQueryMulti()
	...
	Redim importArray(C_Next_chg_seq_Key+4)	
	'Key 값을 읽어온다 
    ...
    importArray(C_yyyymm_fr)		= Trim(Request("txtBdgYymmFr"))
    importArray(C_yyyymm_to)		= Trim(Request("txtBdgYymmTo"))
    importArray(C_chg_fg)			= "T"
       ...
       For iLngRow = 0 To UBound(exportData2, 1)
          iIntLoopCount = iIntLoopCount + 1
           ...
           If iIntLoopCount < (C_SHEETMAXROWS_D + 1) Then
				...
				Call ExtractDateFrom(exportData2(iLngRow,15),"YYYYMM","",strYear,strMonth,strDay)
				StrDate2 = UniConvYYYYMMDDToDate(gAPDateFormat,strYear,strMonth,"01")
			    ...
			    iStrData = iStrData & Chr(11) & ""
				iStrData = iStrData & Chr(11) & ConvSPChars(exportData2(iLngRow,4))             'DEPT_NM
				iStrData = iStrData & Chr(11) & ConvSPChars(exportData2(iLngRow,5))             'ORG_CHANGE_ID
				iStrData = iStrData & Chr(11) & exportData2(iLngRow,6)                          'SEQ
				iStrData = iStrData & Chr(11) & UNINumClientFormat(exportData2(iLngRow,7),ggAmtOfMoney.DecPoint, 0)  'CHG_AMT
				iStrData = iStrData & Chr(11) & ConvSPChars(exportData2(iLngRow,10))            'BDG_CD
				iStrData = iStrData & Chr(11) & ""
				iStrData = iStrData & Chr(11) & ConvSPChars(exportData2(iLngRow,11))            'BDG_NM
				iStrData = iStrData & Chr(11) & UNIMonthClientFormat(ConvSPChars(StrDate2))     'CHG_TO_YYYYMM
				iStrData = iStrData & Chr(11) & ConvSPChars(Trim(exportData2(iLngRow,16)))      'CHG_DEPT_CD
				iStrData = iStrData & Chr(11) & ""
				iStrData = iStrData & Chr(11) & ConvSPChars(Trim(exportData2(iLngRow,17)))      'CHG_DEPT_NM
				iStrData = iStrData & Chr(11) & ConvSPChars(Trim(exportData2(iLngRow,18)))            'TO_ORG_CHANGE_ID				
				iStrData = iStrData & Chr(11) & ConvSPChars(Trim(exportData2(iLngRow,9)))       '""'Bdg_Ctrl_unit
				iStrData = iStrData & Chr(11) & ConvSPChars(Trim(exportData2(iLngRow,12)))      '""'TRANS_fg
				...
				iStrData = iStrData & Chr(11) & exportData2(iLngRow,22)                         'BDG_CTRL_FG
				iStrData = iStrData & Chr(11) & exportData2(iLngRow,23)                         'BDG_CTRL_FG
...
End If
	...
	Response.Write " .frm1.txtDeptNm.value      = """ & exportData1(5) & """ " & vbCr
	Response.Write " .frm1.txtBdgNmFr.value     = """ & exportData1(1) & """ " & vbCr
...
Sub SubBizSaveMulti()
    ...
    Call iPAFG215.F_MANAGE_BDG_CHG_SVR(gStrGlobalCollection, _
