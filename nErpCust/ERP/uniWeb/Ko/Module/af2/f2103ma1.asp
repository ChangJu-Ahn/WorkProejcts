...
'*  8. Modified date(Last)  : 2002.08.13
...
'**********************************************************************************************************
'⊙: 비지니스 로직 ASP명 
Const BIZ_PGM_ID = "f2103mb1.asp"			'☆: 비지니스 로직 ASP명 
'Const BIZ_PGM_ID2 = "f2103mb2.asp"
...
CONST C_ACCT_BDG_CTRL_FG =15
CONST C_GP_BDG_CTRL_FG =16				
'CONST C_SEQ =15
...
Sub InitSpreadSheet()
	...
	With frm1.vspdData
		...
		ggoSpread.SSSetEdit	    C_BDG_NM,			"예산명",		25, , , 30
		...
		ggoSpread.SSSetEdit      C_DEPT_NM,		"부서명",		25, , , 40
		ggoSpread.SSSetEdit      C_ORG_CHANGE_ID,	"조직변경ID",	10, , , 5
		ggoSpread.SSSetEdit      C_CHG_SEQ,			"순서",			04, , , 03
		ggoSpread.SSSetFloat     C_CHG_AMT,		"추가금액",		20, parent.ggAmtOfMoneyNo ,ggStrIntegeralPart, ggStrDeciPointPart,parent.gComNum1000,parent.gComNumDec,,,"Z"
		ggoSpread.SSSetDate   C_MG_DT,			"관리일",		12,2, parent.gDateFormat
		ggoSpread.SSSetEdit   C_BDG_DESC,		"예산추가내역",		25, , , 128
		'	ggoSpread.SSSetDate   C_BDG_CTRL_FG,			"예산통제구분",		10, , ,5
		.ReDraw = True
		...
		Call ggoSpread.SSSetColHidden(C_CHG_SEQ,C_CHG_SEQ,True)
		Call ggoSpread.SSSetColHidden(C_CTRL_UNIT,C_CTRL_UNIT,True)
		Call ggoSpread.SSSetColHidden(C_ADD_FG,C_ADD_FG,True)
...
Sub SetSpreadLock()
    ...
    With frm1.vspdData
		...
		ggoSpread.SSSetRequired  C_CHG_AMT, -1,-1
...
''OrgchangeID_20030730_HC_START
		ggoSpread.SSSetProtected  C_BDG_YYYYMM, pvStartRow, pvEndRow			' 예산년월 
		ggoSpread.SSSetProtected  C_DEPT_CD, pvStartRow, pvEndRow			    ' 부서코드 
		ggoSpread.SpreadLock C_DEPT_PB,		-1, C_DEPT_PB
''OrgchangeID_20030730_HC_END
...
Sub GetSpreadColumnPos(ByVal pvSpdNo)
    ...
    Select Case UCase(pvSpdNo)
       Case "A"
            ...
            C_CHG_SEQ         = iCurColumnPos(9) 
            C_CHG_AMT         = iCurColumnPos(10)
            C_CTRL_UNIT       = iCurColumnPos(11)
            C_ADD_FG          = iCurColumnPos(12)
            C_MG_DT           = iCurColumnPos(13)
            C_BDG_DESC		= iCurColumnPos(14)
...
Sub Form_Load()
    ...
    Call ggoOper.ClearField(Document, "A")        '⊙: Condition, Contents field All clear
    ggoSpread.Source = frm1.vspdData
...
Sub SetBdgCtrlUnit(Row)
	With frm1.vspdData
		...
		.COL=C_ACCT_BDG_CTRL_FG
		IF .TEXT = "Y" THEN
		 
			.Col = C_ADD_FG
			If .Text = "1" Then
				frm1.txtAdd.value = "추가가능"
			Else
				frm1.txtAdd.value = ""
			End If
		ELSE 
...
Function Serarch_UnitCd(ByVal StrData)
	Dim strVal	
	
	Err.Clear 	
	
	if Trim(StrData) <> "" then 		
		strVal = BIZ_PGM_ID2 & "?txtMode="   & "UnitFg"
		strVal = strVal & "&Unit=" & Trim(StrData)
							...
							<TABLE <%=LR_SPACE_TYPE_40%>>
								<TR>
									...
									<TD CLASS="TD6" NOWRAP><INPUT NAME="txtDeptCd" MAXLENGTH="10" SIZE=10 ALT ="부서코드" tag="11XXXU"><IMG SRC="../../../CShared/image/btnPopup.gif" NAME="btnDeptCd" ALIGN=top TYPE="BUTTON" ONCLICK="vbscript:Call OpenDeptOrgPopup()">
														   <INPUT NAME="txtDeptNm" MAXLENGTH="40" SIZE=20 ALT ="부서명" tag="24X"></TD>
								</TR>
								<TR>
									...
									<TD CLASS="TD6" NOWRAP><INPUT NAME="txtBdgCdFr" MAXLENGTH="18" SIZE=10 ALT ="시작예산코드" tag="11XXXU"><IMG SRC="../../../CShared/image/btnPopup.gif" NAME="btnBdgCdFr" ALIGN=top TYPE="BUTTON" ONCLICK="vbscript:Call OpenPopUp(txtBdgCdFr.Value, 'BdgCdFr')">
														   <INPUT NAME="txtBdgNmFr" MAXLENGTH="30" SIZE=20 ALT ="시작예산명" tag="24X">
									</TD>
									...
									<TD CLASS="TD6" NOWRAP><INPUT NAME="txtBdgCdTo" MAXLENGTH="18" SIZE=10 ALT ="종료예산코드" tag="11XXXU"><IMG SRC="../../../CShared/image/btnPopup.gif" NAME="btnBdgCdTo" ALIGN=top TYPE="BUTTON" ONCLICK="vbscript:Call OpenPopUp(txtBdgCdTo.Value, 'BdgCdTo')">
														   <INPUT NAME="txtBdgNmTo" MAXLENGTH="30" SIZE=20 ALT ="종료예산명" tag="24X">
									</TD>
								</TR>
							</TABLE>
						</FIELDSET>
								...
								<TD HEIGHT=10 WIDTH=100%>
									<TABLE <%=LR_SPACE_TYPE_60%>>
									    <TR>
											...
											<TD CLASS="TD6" NOWRAP><SELECT NAME="cboCtrlUnit" ALT="통제기간단위" STYLE="WIDTH: 100px" tag="24X" ><OPTION VALUE=""></OPTION></SELECT></TD>
											<TD CLASS="TD5" NOWRAP>추가여부</TD>
											<TD CLASS="TD6" NOWRAP><INPUT NAME="txtAdd" MAXLENGTH="30" SIZE=20 STYLE="TEXT-ALIGN:left" ALT ="추가여부" tag="24X"></TD>
										</TR>
									</TABLE>
								</TD>
							</TR>
