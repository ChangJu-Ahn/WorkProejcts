...
'*  3. Program ID           : f2104ma1
'*  4. Program Name         : 예산전용등록 
'*  5. Program Desc         : Register of Budget Transfer
...
'*   - 2001.03.28 Song, Mun Gil 스프레드에 조직변경ID 컬럼 추가 
'======================================================================================================= -->
<HTML>
<HEAD>
...
Const BIZ_PGM_ID = "f2104mb1.asp"			'☆: 비지니스 로직 ASP명 
'Const BIZ_PGM_ID2 = "f2104mb2.asp"
...
Sub InitSpreadPosVariables()
    ...
    C_CHG_DEPT_NM         = 17 
    C_TO_ORG_CHANGE_ID    = 18 
    C_CTRL_UNIT           = 19 
    C_TRANS_FG            = 20 
    C_MG_DT               = 21 
    C_BDG_DESC			= 22
    
    C_ACCT_BDG_CTRL_FG    = 23
    C_GP_BDG_CTRL_FG      = 24
End Sub
 '==========================================  2.1.1 InitVariables()  ======================================
'	Name : InitVariables()
...
Sub InitSpreadSheet()
	...
	With frm1.vspdData
		...
		.ReDraw = false
		ggoSpread.SSSetEdit		C_SEQ,			"순서",		04, , ,03
		ggoSpread.SSSetEdit		C_BDG_CD,		"예산코드",	12, , ,18,2
		ggoSpread.SSSetButton	C_BDG_PB
		ggoSpread.SSSetEdit		C_BDG_NM,		"예산명",	20, , ,30
		ggoSpread.SSSetMask		C_BDG_YYYYMM,		"예산년월",	15,2, strMaskYM
		ggoSpread.SSSetEdit		C_DEPT_CD,		"부서코드",	12, , ,10,2
		ggoSpread.SSSetButton	C_DEPT_PB
		ggoSpread.SSSetEdit		C_DEPT_NM,		"부서명",	20, , ,40
		ggoSpread.SSSetEdit		C_ORG_CHANGE_ID,"조직변경ID",10, , ,5
		ggoSpread.SSSetFloat		C_CHG_AMT,		"전용금액",	15, parent.ggAmtOfMoneyNo ,ggStrIntegeralPart, ggStrDeciPointPart,parent.gComNum1000,parent.gComNumDec,,,"Z"
		ggoSpread.SSSetMask		C_CHG_TO_YYYYMM,"전용년월", 10,2, strMaskYM
		ggoSpread.SSSetEdit		C_CHG_BDG_CD,	"전용코드",	12, , ,18,2
		ggoSpread.SSSetButton	C_CHG_BDG_PB
		ggoSpread.SSSetEdit		C_CHG_BDG_NM,	"전용명",	20, , ,30
		ggoSpread.SSSetEdit		C_CHG_DEPT_CD,	"전용부서",	12, , ,18,2
		ggoSpread.SSSetButton	C_CHG_DEPT_PB
		ggoSpread.SSSetEdit		C_CHG_DEPT_NM,	"전용부서명",20, , ,40
		ggoSpread.SSSetEdit		C_TO_ORG_CHANGE_ID,	"조직변경ID",10, , ,5
		ggoSpread.SSSetDate		C_MG_DT,		"관리일",	12,2, parent.gDateFormat
		ggoSpread.SSSetEdit		C_BDG_DESC,	"예산전용내역",		25, , , 128

		.ReDraw = True
		Call ggoSpread.MakePairsColumn(C_BDG_CD,C_BDG_PB)
		Call ggoSpread.MakePairsColumn(C_DEPT_CD,C_DEPT_PB)
		Call ggoSpread.MakePairsColumn(C_CHG_BDG_CD,C_CHG_BDG_PB)
		Call ggoSpread.MakePairsColumn(C_CHG_DEPT_CD,C_CHG_DEPT_PB)


		Call ggoSpread.SSSetColHidden(.MaxCols, .MaxCols, True)
		Call ggoSpread.SSSetColHidden(C_SEQ,C_SEQ,True)
		Call ggoSpread.SSSetColHidden(C_CTRL_UNIT,C_CTRL_UNIT,True)
		Call ggoSpread.SSSetColHidden(C_TRANS_FG,C_TRANS_FG,True)
		Call ggoSpread.SSSetColHidden(C_MG_DT,C_MG_DT,True)
		Call ggoSpread.SSSetColHidden(C_ORG_CHANGE_ID,C_ORG_CHANGE_ID,True)
		Call ggoSpread.SSSetColHidden(C_TO_ORG_CHANGE_ID,C_TO_ORG_CHANGE_ID,True)
...
Sub SetSpreadLock()
    ...
    With frm1.vspdData
		...
		ggoSpread.SpreadLock C_CHG_BDG_NM, -1, C_CHG_BDG_NM
		ggoSpread.SpreadLock C_CHG_DEPT_NM,-1, C_CHG_DEPT_NM
		
		ggoSpread.SSSetRequired C_CHG_AMT, -1
		ggoSpread.SSSetRequired C_CHG_BDG_CD, -1
		ggoSpread.SSSetRequired C_CHG_TO_YYYYMM, -1
		ggoSpread.SSSetRequired C_CHG_DEPT_CD, -1
...
Sub SetSpreadColor(ByVal pvStartRow, ByVal pvEndRow)
    ...
    With frm1
		...
		ggoSpread.SSSetRequired C_CHG_AMT        , pvStartRow, pvEndRow			    ' 전용금액 
		ggoSpread.SSSetRequired C_CHG_BDG_CD     , pvStartRow, pvEndRow		    ' 전용코드 
		ggoSpread.SSSetRequired C_CHG_TO_YYYYMM  , pvStartRow, pvEndRow
		ggoSpread.SSSetRequired C_CHG_DEPT_CD    , pvStartRow, pvEndRow
		
		ggoSpread.SSSetProtected C_BDG_NM        , pvStartRow, pvEndRow			    ' 예산코드명 
		ggoSpread.SSSetProtected C_DEPT_NM       , pvStartRow, pvEndRow			    ' 전용코드명 
		ggoSpread.SSSetProtected C_CHG_BDG_NM    , pvStartRow, pvEndRow		    ' 전용코드명 
		ggoSpread.SSSetProtected C_CHG_DEPT_NM   , pvStartRow, pvEndRow
    ...
    Select Case UCase(pvSpdNo)
       Case "A"
            ...
            Call ggoSpread.GetSpreadColumnPos(iCurColumnPos)
                ...
                C_CHG_BDG_CD          = iCurColumnPos(11) 

                C_CHG_BDG_PB          = iCurColumnPos(12) 
                C_CHG_BDG_NM          = iCurColumnPos(13) 
                C_CHG_TO_YYYYMM       = iCurColumnPos(14) 
                C_CHG_DEPT_CD         = iCurColumnPos(15) 
                C_CHG_DEPT_PB         = iCurColumnPos(16) 

                C_CHG_DEPT_NM         = iCurColumnPos(17) 
                C_TO_ORG_CHANGE_ID    = iCurColumnPos(18) 
                C_CTRL_UNIT           = iCurColumnPos(19) 
                C_TRANS_FG            = iCurColumnPos(20) 
                C_MG_DT               = iCurColumnPos(21) 
                C_BDG_DESC			= iCurColumnPos(22)
                C_ACCT_BDG_CTRL_FG    = iCurColumnPos(23) 
                C_GP_BDG_CTRL_FG      = iCurColumnPos(24) 
...
Function OpenPopUp(Byval strCode, Byval iWhere)
	...
	Select Case iWhere
		...
		Case "BdgCdFr", "BdgCdTo"
			...
			arrParam(4) = "A.ADD_FG = " & FilterVar("1", "''", "S") & "  "
...
Function OpenPopupDept(Byval strCode, Byval iWhere)
	...
	Case "DeptCd_Trans"
		With frm1
			.vspdData.Col  = C_CHG_DEPT_CD
			.vspdData.Text = arrRet(0)
			.vspdData.Col  = C_CHG_DEPT_NM
			.vspdData.Text = arrRet(1)

			Call vspdData_Change(C_CHG_DEPT_CD, .vspdData.Row )	 	
		End With
	End Select
End Function
...
'		End If
		...
		End If
	Case C_CHG_DEPT_CD, C_CHG_TO_YYYYMM

		frm1.vspdData.Col = C_CHG_TO_YYYYMM
		If Trim(frm1.vspdData.Text = "") Then	Exit sub

		frm1.vspdData.Col = C_CHG_DEPT_CD
		If Trim(frm1.vspdData.Text = "") Then	Exit sub
			'----------------------------------------------------------------------------------------
		strSelect	=			 " dept_cd, org_change_id, internal_cd "    		
		strFrom		=			 " b_acct_dept(NOLOCK) "		
...
'		End If
		...
		If CommonQueryRs2by2(strSelect, strFrom ,  strWhere , lgF2By2) = False Then
			...
			frm1.vspdData.Col = C_CHG_DEPT_CD
			frm1.vspdData.Text = ""
			frm1.vspdData.Col = C_CHG_DEPT_NM
			frm1.vspdData.Text = ""
			frm1.vspdData.Col = C_TO_ORG_CHANGE_ID
			frm1.vspdData.Text = ""
		Else 
			arrVal1 = Split(lgF2By2, Chr(11) & Chr(12))			
...
Sub vspdData_ScriptLeaveCell(ByVal Col, ByVal Row, ByVal NewCol, ByVal NewRow, Cancel)
    ...
    With frm1.vspdData 
		...
		If  NewCol > 0 Then
			...
			Select Case Col
			Case C_BDG_YYYYMM, C_CHG_TO_YYYYMM
				.Row = Row
				.Col = Col
	...
	With frm1.vspdData
		...
		If Row > 0 Then
			...
			Case C_CHG_BDG_PB
				.Col = Col
				.Row = Row
				'Call OpenPopup(.Text, "BdgCd_Trans")
				Call OpenRefBdg("BdgCd_Trans")

			Case C_CHG_DEPT_PB
				.Col = Col
				.Row = Row
				Call OpenPopupDept(.Text, "DeptCd_Trans")
			End Select
		End If
...
Function DbQuery() 
    ...
    With frm1
		...
		If lgIntFlgMode = parent.OPMD_UMODE Then
			...
			strVal = strVal & "&txtBdgYymmFr=" & strFrDt 'trim(.htxtBdgYymmFr.value)
			strVal = strVal & "&txtBdgYymmTo=" & strToDt 'Trim(.htxtBdgYymmTo.value)
		    ...
		    Select Case .vspdData.Text
  				...
  				Case ggoSpread.InsertFlag												'☜: 신규 
		           ...
		           .vspdData.Col = C_DEPT_CD
		            ...
		            strVal = strVal & UNIConvNum(Trim(.vspdData.Text),0) & iColSep
		            .vspdData.Col = C_CHG_BDG_CD
		            strVal = strVal & Trim(.vspdData.Text) & iColSep
		            .vspdData.Col = C_CHG_TO_YYYYMM
		            Call ExtractDateFrom(.vspdData.Text,parent.gDateFormatYYYYMM,parent.gComDateType,strYear,strMonth,strDay)
		            strVal = strVal & strYear & strMonth & iColSep
		           
		            .vspdData.Col = C_CHG_DEPT_CD
		            strVal = strVal & Trim(.vspdData.Text) & iColSep
		            .vspdData.Col = C_TO_ORG_CHANGE_ID
		            strVal = strVal & Trim(.vspdData.Text) & iColSep	'신규입력인 경우, 조직변경ID
		            .vspdData.Col = C_MG_DT
		        ...
		        Case ggoSpread.DeleteFlag												'☜: 삭제 
		            ...
		            .vspdData.Col = C_BDG_DESC
		            strDel = strDel & .vspdData.Text & parent.gRowSep        		            
							...
							<TABLE <%=LR_SPACE_TYPE_40%>>
								<TR>
									...
									<TD CLASS="TD6" NOWRAP><INPUT NAME="txtDeptCd" MAXLENGTH="10" SIZE=10 ALT ="부서코드" tag="11XXXU"><IMG SRC="../../../CShared/image/btnPopup.gif" NAME="btnDeptCd" ALIGN=top TYPE="BUTTON" ONCLICK="vbscript:Call OpenDeptOrgPopup()">
														   <INPUT NAME="txtDeptNm" MAXLENGTH="40" SIZE=20 ALT ="부서명"   tag="24X">
									</TD>
								</TR>
								<TR>
									<TD CLASS="TD5" NOWRAP>시작예산</TD>
									<TD CLASS="TD6" NOWRAP><INPUT NAME="txtBdgCdFr" MAXLENGTH="18" SIZE=10  ALT ="시작예산코드" tag="11XXXU"><IMG SRC="../../../CShared/image/btnPopup.gif" NAME="btnBdgCd" ALIGN=top TYPE="BUTTON" ONCLICK="vbscript:Call OpenPopUp(txtBdgCdFr.Value, 'BdgCdFr')">
														   <INPUT NAME="txtBdgNmFr" MAXLENGTH="30" SIZE=20  ALT ="예산명"       tag="24X">
									</TD>
									<TD CLASS="TD5" NOWRAP>종료예산</TD>
									<TD CLASS="TD6" NOWRAP><INPUT NAME="txtBdgCdTo" MAXLENGTH="18" SIZE=10  ALT ="종료예산코드" tag="11XXXU"><IMG SRC="../../../CShared/image/btnPopup.gif" NAME="btnBdgCd" ALIGN=top TYPE="BUTTON" ONCLICK="vbscript:Call OpenPopUp(txtBdgCdTo.Value, 'BdgCdTo')">
														   <INPUT NAME="txtBdgNmTo" MAXLENGTH="30" SIZE=20  ALT ="예산명"       tag="24X">
									</TD>
								</TR>
							</TABLE>
						</FIELDSET>
								...
								<TD HEIGHT=10 WIDTH=100%>
									<TABLE <%=LR_SPACE_TYPE_60%>>
									    <TR>
											...
											<TD CLASS="TD6" NOWRAP><SELECT NAME="cboCtrlUnit" ALT="통제기간단위" CLASS=cboSmall tag="24X" ><OPTION VALUE=""></OPTION></SELECT></TD>
											<TD CLASS="TD5" NOWRAP>전용여부</TD>
											<TD CLASS="TD6" NOWRAP><INPUT NAME="txtTrans" SIZE=20 ALT ="전용여부" tag="24X"></TD>
										</TR>
									</TABLE>
								</TD>
							</TR>
