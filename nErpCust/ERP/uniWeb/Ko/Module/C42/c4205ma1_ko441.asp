...
'*  3. Program ID			: C4205MA1_ko441.asp
...
'==========================================  1.2.1 Global 상수 선언  ======================================
'==========================================================================================================
Const BIZ_PGM_ID	= "c4205mb1_ko441.asp"			'☆:  비지니스 로직 ASP명 
Const BIZ_PGM_ID2	= "c4205mb2_ko441.asp"			'☆:  비지니스 로직 ASP명 
...
Sub InitSpreadSheet(byVal pvSpd)	
    ...
    If pvSpd = "" or pvSpd ="A" Then 
		...
		ggoSpread.SSSetEdit	C_PlantCd,		"공장", 4,,,7
		ggoSpread.SSSetEdit	C_CCCd,			"작업지시C/C", 6   
		ggoSpread.SSSetEdit	C_CCNM,			"작업지시C/C명", 6
		ggoSpread.SSSetEdit	C_OrderNo,		"제조번호", 12
		ggoSpread.SSSetEdit	C_ItemCd1,		"품목코드", 12
		ggoSpread.SSSetEdit	C_ItemNm1,		"품목명", 12
		ggoSpread.SSSetEdit	C_RoutNo,		"라우팅번호", 10   
		ggoSpread.SSSetEdit	C_CloseFlag,		"마감여부", 4
		ggoSpread.SSSetEdit	C_Unit,			"재고단위", 8
		ggoSpread.SSSetEdit	C_WcCd,			"공정", 6
		ggoSpread.SSSetEdit	C_WcNm,			"공정명", 10
		ggoSpread.SSSetEdit	C_OprNo,		"공순", 4
		ggoSpread.SSSetEdit	C_InsideFlg,		"사내공정여부", 10  
		ggoSpread.SSSetEdit	C_MilestoneFlg,		"Milestone", 10
    
		ggoSpread.SSSetFloat	C_WipQty,		"기초재공수량",		10,	Parent.ggAmtOfMoneyNo, ggStrIntegeralPart, ggStrDeciPointPart,	Parent.gComNum1000, Parent.gComNumDec
		ggoSpread.SSSetFloat	C_PriorOprQty,		"전공정대체(착수)수량",	10,	Parent.ggAmtOfMoneyNo, ggStrIntegeralPart, ggStrDeciPointPart,	Parent.gComNum1000, Parent.gComNumDec
		ggoSpread.SSSetFloat	C_NextOprQty,		"차공정(완성)대체수량",	10,	Parent.ggAmtOfMoneyNo, ggStrIntegeralPart, ggStrDeciPointPart,	Parent.gComNum1000, Parent.gComNumDec

		ggoSpread.SSSetFloat	C_LastWipQty,		"기말재공수량",		10,	Parent.ggAmtOfMoneyNo, ggStrIntegeralPart, ggStrDeciPointPart,	Parent.gComNum1000, Parent.gComNumDec
		'ggoSpread.SSSetFloat	C_LastWipQty,		"기말재공수량",		10,	Parent.ggAmtOfMoneyNo, ggStrIntegeralPart, ggStrDeciPointPart,	Parent.gComNum1000, Parent.gComNumDec
		ggoSpread.SSSetFloat	C_BAS_BAD_Qty,		"기초불량수량",		10,	Parent.ggAmtOfMoneyNo, ggStrIntegeralPart, ggStrDeciPointPart,	Parent.gComNum1000, Parent.gComNumDec
		ggoSpread.SSSetFloat	C_THIS_BadQty,		"당월불량수량",		10,	Parent.ggAmtOfMoneyNo, ggStrIntegeralPart, ggStrDeciPointPart,	Parent.gComNum1000, Parent.gComNumDec
		ggoSpread.SSSetFloat	C_REWORKED_BAD_QTY,	"재작업불량수량",	10,	Parent.ggAmtOfMoneyNo, ggStrIntegeralPart, ggStrDeciPointPart,	Parent.gComNum1000, Parent.gComNumDec
		ggoSpread.SSSetFloat	C_BAL_BAD_QTY,		"기말불량수량",		10,	Parent.ggAmtOfMoneyNo, ggStrIntegeralPart, ggStrDeciPointPart,	Parent.gComNum1000, Parent.gComNumDec  
		ggoSpread.SSSetFloat	C_ProdRate,			"완성품환산율(%)", 10,"6",	ggStrIntegeralPart,	ggStrDeciPointPart,	parent.gComNum1000,	parent.gComNumDec,	,,	"Z"  ,"0","100"
   
 		Call ggoSpread.SSSetColHidden(C_CcCd, C_CcCd, True)   
 		Call ggoSpread.SSSetColHidden(C_CcNm, C_CcNm, True)  
 		Call ggoSpread.SSSetColHidden(C_RoutNo, C_RoutNo, True)  
 		Call ggoSpread.SSSetColHidden(C_InsideFlg, C_InsideFlg, True)
 		Call ggoSpread.SSSetColHidden(C_MilestoneFlg, C_MilestoneFlg, True)   
 		Call ggoSpread.SSSetColHidden(C_Unit, C_Unit, True)
...
Sub GetSpreadColumnPos(ByVal pvSpdNo)
 	...
 	Case "A"
		...
		C_ItemCd1	= iCurColumnPos(5)
		C_ItemNm1	= iCurColumnPos(6)

		C_RoutNo       = iCurColumnPos(7)
		C_CloseFlag    = iCurColumnPos(8)
		C_Unit            = iCurColumnPos(9)
		C_WcCd         = iCurColumnPos(10)
		C_WcNm         = iCurColumnPos(11)
		C_OprNo         = iCurColumnPos(12)
		C_InsideFlg     = iCurColumnPos(13)
		C_MilestoneFlg  = iCurColumnPos(14)
		C_WipQty         =iCurColumnPos(15)
		C_PriorOprQty   =iCurColumnPos(16)
		C_NextOprQty    =iCurColumnPos(17)	
		C_LastWipQty     =iCurColumnPos(18)	
		C_BAS_BAD_Qty       =iCurColumnPos(19)
		C_THIS_BadQty          =iCurColumnPos(20)
		C_REWORKED_BAD_QTY = iCurColumnPos(21)
		C_BAL_BAD_QTY = iCurColumnPos(22)
		C_ProdRate	     =iCurColumnPos(23)
