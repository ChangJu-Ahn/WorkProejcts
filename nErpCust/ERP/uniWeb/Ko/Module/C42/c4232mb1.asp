...
'**********************************************************************************************
'*  1. Module Name          : 원가 
'*  2. Function Name        : 영업그룹별매출이익분석 
'*  3. Program ID           : c4232ma1
'*  4. Program Name         : 영업그룹별매출이익분석 
'*  5. Program Desc         :
'*  6. Comproxy List        : 
...
Sub SubBizQuery()
	...
	Dim sProjectNo, sItemAcct, sItemCd, sSalesGrp, sBPCd, sTypeFlag, sGrid, arrTmp, TmpBuffer()
...
'    On Error Resume Next                                                             '☜: Protect system from crashing
	...
	If sStartDt = "" And sProjectNo = "" And sItemAcct = "" And sItemCd = "" Then
...
'	If Instr(1, sBPCd, "%") = 0 Then sBPCd	= sBPCd & "%"
    ...
    With lgObjComm
		...
		.CommandText = "dbo.usp_C_C4232MA1_TYPE" & sTypeFlag		' --  변경해야할 SP 명 
