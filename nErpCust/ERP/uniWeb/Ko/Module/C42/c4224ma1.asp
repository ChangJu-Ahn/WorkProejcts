...
Sub InitSpreadSheet(Byval pMaxCols)
	...
	With frm1.vspdData
		...
		ggoSpread.SSSetEdit		2,	"C/C명" , 12		
		ggoSpread.SSSetEdit		3,	"원가요소"	, 8,,,,1	
		ggoSpread.SSSetEdit		4,	"원가요소명"	, 12
		ggoSpread.SSSetEdit		5,	"계정"	, 12,,,,1	
		ggoSpread.SSSetEdit		6,	"계정명"	, 15
		ggoSpread.SSSetEdit		7,	"직과항목코드"	, 10,,,,1
		ggoSpread.SSSetEdit		8,	"직과항목"	, 10
		ggoSpread.SSSetEdit		9,	"집계원천"	, 10,,,,1

		For i = 10 To pMaxCols				
			ggoSpread.SSSetFloat	i,	"금액"	, 15,		Parent.ggAmtOfMoneyNo,		ggStrIntegeralPart,		ggStrDeciPointPart,		Parent.gComNum1000,		Parent.gComNumDec
			.ColHidden = False
		Next
...
Sub InitSpreadSheet2(Byval pMaxCols)
	...
	With frm1.vspdData2
		...
		For i = 1 To pMaxCols - 1 Step 2
			ggoSpread.SSSetEdit		i,	"관리항목" , 10,,,,1	
			ggoSpread.SSSetEdit		i+1,	"관리항목명"	, 12
		Next

		ggoSpread.SSSetFloat	pMaxCols,	"금액"	, 15,		Parent.ggAmtOfMoneyNo,		ggStrIntegeralPart,		ggStrDeciPointPart,		Parent.gComNum1000,		Parent.gComNumDec
						...
						<FIELDSET CLASS="CLSFLD">
							<TABLE <%=LR_SPACE_TYPE_40%>>
								...
								<TR>
									...
									<TD CLASS="TD6" NOWRAP><input NAME="txtCOST_ELMT_CD" TYPE="Text" MAXLENGTH="20" tag="15XXXU" size="10" ALT="원가요소"><IMG SRC="../../../CShared/image/btnPopup.gif" NAME="btnCalType" align=top TYPE="BUTTON" onclick="vbscript:Call OpenPopup(1)">
									<input NAME="txtCOST_ELMT_NM" TYPE="TEXT" tag="14XXX" size="20">
									</TD>
									<TD CLASS="TD5">집계구분</TD>
									<TD CLASS="TD6" valign=top><INPUT TYPE=RADIO CLASS=RADIO NAME=rdoTYPE ID=rdoTYPE1 tag="15XXXU" checked><LABEL FOR="rdoTYPE1">기간</LABEL>&nbsp;&nbsp;&nbsp;
