...
'*  3. Program ID           : c4223ma1_ko441.asp
'*  4. Program Name         : 재공내역조회(수량)
'*  5. Program Desc         : 재공내역조회(수량)
...
Const BIZ_PGM_ID = "c4223mb2_ko441.asp"                               'Biz Logic ASP
...
Sub InitSpreadSheet(Byval pMaxCols)
	...
	With frm1.vspdData
		...
		ggoSpread.SSSetEdit		1,	"공장" , 4,,,20,1	
		ggoSpread.SSSetEdit		2,	"작업지시 C/C"	, 6,,,20,1	
		ggoSpread.SSSetEdit		3,	"C/C명"	, 8,,,20,1	
		ggoSpread.SSSetEdit		4,	"품목"	, 12,,,20,1	
		ggoSpread.SSSetEdit		5,	"품목명", 12,,,20,1	

		For i = 6 To pMaxCols -1			
			ggoSpread.SSSetFloat	i,	""	, 8, Parent.ggAmtOfMoneyNo, ggStrIntegeralPart, ggStrDeciPointPart,	Parent.gComNum1000, Parent.gComNumDec
		Next

		'2009.04.02 kbs change
		'ggoSpread.SSSetFloat	pMaxCols,	"재공마감"	, 8, Parent.ggAmtOfMoneyNo, ggStrIntegeralPart, ggStrDeciPointPart,	Parent.gComNum1000, Parent.gComNumDec
		...
		'2009.04.02 kbs change
		'ret = .AddCellSpan(pMaxCols, -1000, 1, 2)	' -- 기초 
...
Sub InitSpreadSheet2(Byval pMaxCols)
	...
	With frm1.vspdData2
		...
		ggoSpread.SSSetEdit		1,	"오더번호" , 12,,,20,1	
...
Sub SetQuerySpreadColor2(Byval pRowCnt)
	Dim arrRow, arrCol, iRow
	Dim iLoopCnt, i
	Dim ret, iCnt
