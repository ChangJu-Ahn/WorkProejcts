...
Sub InitSpreadSheet2()
	...
	With frm1.vspdData2
		...
		ggoSpread.Spreadinit "V20021124",,"" ',parent.gAllowDragDropSpread 
		...
		For i = 6 To 119	Step 3 ' -- 숫자형 필드부터 
			...
			ggoSpread.SSSetFloat	i+2,	""	, 10,		Parent.ggUnitCostNo,		ggStrIntegeralPart,		ggStrDeciPointPart,		Parent.gComNum1000,		Parent.gComNumDec
		Next
