...
'*  3. Program ID           : c4209ma1.asp
'*  4. Program Name         : 수불유형별원가수불장조회 
'*  5. Program Desc         : 수불유형별원가수불장조회 
...
Const BIZ_PGM_ID = "c4209mb1.asp"                               'Biz Logic ASP
...
Sub InitSpreadSheet()
	...
	With frm1.vspdData
		...
		ggoSpread.SSSetEdit		2,	"품목계정"	, 6,,,,1	
		ggoSpread.SSSetEdit		3,	"품목계정명"	, 8	
		ggoSpread.SSSetEdit		4,	"수불유형"	, 10,,,,1	
