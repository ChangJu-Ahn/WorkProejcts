...
Const BIZ_PGM_ID = "c4230mb1.asp"                               'Biz Logic ASP
...
Sub InitSpreadSheet(byVal iTab, byVal iMaxCols)
    ...
    SELECT CASE ITAB
		CASE TAB1
			...
			ggoSpread.SSSetEdit		2,	"작업지시C/C"	, 10,,,,1
			ggoSpread.SSSetEdit		3,	"작업지시C/C명"	, 18
			ggoSpread.SSSetEdit		4,	"공정"	, 10,,,,1
			ggoSpread.SSSetEdit		5,	"공정명"	, 20		


			For i = 6 To iMaxCols	step 4
					...
					ggoSpread.SSSetFloat	i+3,		""		, 13,		Parent.ggExchRateNo,		ggStrIntegeralPart,		ggStrDeciPointPart,		Parent.gComNum1000,		Parent.gComNumDec
...
'			Call ggoSpread.SSSetColHidden(1,1,True)
		...
		CASE TAB2
			...
			ggoSpread.SSSetEdit		2,	"품목계정", 18
			ggoSpread.SSSetEdit		3,	"작업지시C/C"	, 10,,,,1
			ggoSpread.SSSetEdit		4,	"품목"	, 18,,,,1
			ggoSpread.SSSetEdit		5,	"품목명"	,20
			ggoSpread.SSSetEdit		6,	"공정"	, 10,,,,1
			ggoSpread.SSSetEdit		7,	"공정명"	, 18


			For i = 8 To iMaxCols	STEP 4
					ggoSpread.SSSetFloat	i,		""		, 13,		Parent.ggQtyNo,		ggStrIntegeralPart,		ggStrDeciPointPart,		Parent.gComNum1000,		Parent.gComNumDec
					ggoSpread.SSSetFloat	i+1,		""		, 13,		Parent.ggAmtOfMoneyNo,		ggStrIntegeralPart,		ggStrDeciPointPart,		Parent.gComNum1000,		Parent.gComNumDec
					ggoSpread.SSSetFloat	i+2,		""		, 13,		Parent.ggAmtOfMoneyNo,		ggStrIntegeralPart,		ggStrDeciPointPart,		Parent.gComNum1000,		Parent.gComNumDec
					ggoSpread.SSSetFloat	i+3,		""		, 13,		Parent.ggExchRateNo,		ggStrIntegeralPart,		ggStrDeciPointPart,		Parent.gComNum1000,		Parent.gComNumDec
...
'			Call ggoSpread.SSSetColHidden(1,1,True)
		...
		CASE TAB3
			...
			ggoSpread.SSSetEdit		4,	"자품목계정"	, 10,,,,1
			ggoSpread.SSSetEdit		5,	"자품목"	, 18,,,,1
			ggoSpread.SSSetEdit		6,	"자품목명"	, 20
			...
			For i = 7 To iMaxCols 	STEP 3
					...
					ggoSpread.SSSetFloat	i+2,	""	, 15,		Parent.ggAmtOfMoneyNo,		ggStrIntegeralPart,		ggStrDeciPointPart,		Parent.gComNum1000,		Parent.gComNumDec
			Next		
			For i = 1 To 6
				ret = .AddCellSpan(i, -1000 , 1, 2)
			Next
...
Sub vspdData4_ScriptLeaveCell(ByVal Col, ByVal Row, ByVal NewCol, ByVal NewRow, Cancel)
   If Row <> NewRow And NewRow > 0 Then
       With frm1
            .vspdData4.Row = NewRow :        .vspdData4.Col = 1
			.hGridKey.value=.vspdData4.text
    ...
    With frm1
		...
		For iRow = 0 to iMaxRows
			select case gSelframeFlg
				...
				CASE TAB4
						If .vspdData4.Row =tmpGrp(iRow) then 
							.hGridKey.value=""					
					End If		
			End Select
		Next
...
Function DbQueryOk(byval currRow)	
	...
	CASE TAB1 
		...
		frm1.vspdData.Col=4 : frm1.vspdData.Row=currRow '공정  
		frm1.hGridKey.value= frm1.vspdData.Text
		Frm1.vspdData.Focus

	CASE TAB2
		frm1.vspdData2.style.display = ""	'-- 그리드 보이게..	
		frm1.vspdData2.Col=6 : frm1.vspdData2.Row=currRow '공정  
	...
	CASE TAB4
		...
		frm1.vspdData4.Col=1 : frm1.vspdData4.Row=currRow '공정  
		frm1.hGridKey.value= frm1.vspdData4.Text
				...
				<TR>
					...
					<TD CLASS="CLSMTABP" >
						<TABLE ID="MyTab" CELLSPACING=0 CELLPADDING=0 onclick="ClickTab1()">
							<TR>
								...
								<td background="../../../CShared/image/table/seltab_up_bg.gif" align="center" CLASS="CLSMTAB"><font color=white>C/C-공정별원가Portion</font></td>
					...
					<TD CLASS="CLSMTABP" >
						<TABLE ID="MyTab" CELLSPACING=0 CELLPADDING=0 onclick="ClickTab2()">
							<TR>
								<td background="../../../CShared/image/table/seltab_up_bg.gif"><img src="../../../CShared/image/table/seltab_up_left.gif" width="9" height="23"></td>
								<td background="../../../CShared/image/table/seltab_up_bg.gif" align="center" CLASS="CLSMTAB"><font color=white>품목-공정별원가Portion</font></td>
								<td background="../../../CShared/image/table/seltab_up_bg.gif" align="right"><img src="../../../CShared/image/table/seltab_up_right.gif" width="10" height="23"></td>
						    </TR>
						</TABLE>
					</TD>
					<TD CLASS="CLSMTABP" >
						<TABLE ID="MyTab" CELLSPACING=0 CELLPADDING=0 onclick="ClickTab3()">
							<TR>
								<td background="../../../CShared/image/table/seltab_up_bg.gif"><img src="../../../CShared/image/table/seltab_up_left.gif" width="9" height="23"></td>
								<td background="../../../CShared/image/table/seltab_up_bg.gif" align="center" CLASS="CLSMTAB"><font color=white>공정별자품목투입현황</font></td>
								<td background="../../../CShared/image/table/seltab_up_bg.gif" align="right"><img src="../../../CShared/image/table/seltab_up_right.gif" width="10" height="23"></td>
						    </TR>
						</TABLE>
					</TD>
					<TD CLASS="CLSMTABP" >
						<TABLE ID="MyTab" CELLSPACING=0 CELLPADDING=0 onclick="ClickTab4()">
							<TR>
								<td background="../../../CShared/image/table/seltab_up_bg.gif"><img src="../../../CShared/image/table/seltab_up_left.gif" width="9" height="23"></td>
								<td background="../../../CShared/image/table/seltab_up_bg.gif" align="center" CLASS="CLSMTAB"><font color=white>공정별가공비투입현황</font></td>
								<td background="../../../CShared/image/table/seltab_up_bg.gif" align="right"><img src="../../../CShared/image/table/seltab_up_right.gif" width="10" height="23"></td>
						    </TR>
						</TABLE>
					</TD>
						...
						<FIELDSET CLASS="CLSFLD">
							<TABLE <%=LR_SPACE_TYPE_40%>>
								...
								<TR>
									...
									<TD CLASS="TD6" NOWRAP><input NAME="txtCost_cd" TYPE="Text" MAXLENGTH="10" tag="15XXXU" size="10" ALT="C/C"><IMG SRC="../../../CShared/image/btnPopup.gif" NAME="btnCalType" align=top TYPE="BUTTON" onclick="vbscript:Call OpenPopup(1)">
