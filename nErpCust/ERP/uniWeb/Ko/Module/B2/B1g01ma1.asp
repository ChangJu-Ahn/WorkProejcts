...
Const BIZ_PGM_ID = "B1g01mb1.asp"												<%'비지니스 로직 ASP명 %>
...
Sub InitSpreadSheet()
    ...
    ggoSpread.SSSetEdit C_ZipCd, "우편번호", 10,,,12,2    
    ggoSpread.SSSetEdit C_SerNo, "Serial No", 10,,,12
    ggoSpread.SSSetEdit C_Address, "주소", 60,,,100
    ggoSpread.SSSetEdit C_Ref1, "번지", 20,,,50
    ggoSpread.SSSetEdit C_Ref2, "호", 10,,,50
    ggoSpread.SSSetEdit C_Ref3, "기타", 10,,,50
    ggoSpread.SSSetEdit C_Country, "국가코드", 15
					...
					<TD CLASS="CLSMTABP">
						<TABLE ID="MyTab" CELLSPACING=0 CELLPADDING=0>
							<TR>
								...
								<td background="../../../CShared/image/table/seltab_up_bg.gif" align="center" CLASS="CLSMTAB"><font color=white>우편번호</font></td>
