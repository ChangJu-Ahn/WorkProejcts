...
'*  2. Function Name        : Master Data(User Major Code)
'*  3. Program ID           : b1a04ma1.asp
'*  4. Program Name         : b1a04ma1.asp
'*  5. Program Desc         :
...
Const BIZ_PGM_ID = "B1a04mb1.asp"												'☆: 비지니스 로직 ASP명 
Const BIZ_PGM_JUMP_ID = "B1a03ma1"												'☆: Jump시 호출 ASP명 
...
Sub InitSpreadSheet()
   ...
   'patch version
    ...
    .MaxCols = C_Reference + 1							'☜: 최대 Columns의 항상 1개 증가시킴 
	...
	ggoSpread.SSSetEdit C_Minor, "사용자Minor코드", 26	, , ,15, 2			'1
	ggoSpread.SSSetEdit C_MinorNm, "사용자Minor코드명", 50	, , ,30			'2
	ggoSpread.SSSetEdit C_Reference, "Reference", 42, , ,100			'3
...
<TABLE <%=LR_SPACE_TYPE_00%>>
					...
					<TD CLASS="CLSMTABP">
						<TABLE ID="MyTab" CELLSPACING=0 CELLPADDING=0>
							<TR>
								...
								<td background="../../../CShared/image/table/seltab_up_bg.gif" align="center" CLASS="CLSMTAB"><font color=white>사용자Minor코드(Site용)</font></td>
					...
					<TD WIDTH=100% HEIGHT=* valign=top>
						...
						<TR>
							<TD WIDTH=100% HEIGHT=100% COLSPAN=2>
								<script language =javascript src='./js/b1a04ma1_OBJECT1_vspdData.js'></script>
							</TD>
						</TR>
						</TABLE>
					</TD>
    ...
    <tr HEIGHT="20">
      ...
      <table WIDTH="100%">
        <tr>
          <td WIDTH="*" ALIGN=RIGHT><a href = "VBSCRIPT:PgmJump(BIZ_PGM_JUMP_ID)" ONCLICK="VBSCRIPT:CookiePage 1">사용자Major코드등록</a></td>
		  <TD WIDTH=10>&nbsp;</TD>
        </tr>
      </table>
      </td>
