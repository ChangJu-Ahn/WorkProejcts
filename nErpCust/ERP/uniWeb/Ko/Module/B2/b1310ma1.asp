...
'**********************************************************************************************************
Const BIZ_PGM_QUERY_ID = "b1310mb1.asp"												'☆: 비지니스 로직 ASP명 
Const BIZ_PGM_SAVE_ID  = "b1310mb2.asp"												'☆: 비지니스 로직 ASP명 
Const BIZ_PGM_DEL_ID   = "b1310mb3.asp"
...
Sub GetSpreadColumnPos(ByVal pvSpdNo)
    ...
    Select Case UCase(pvSpdNo)
       Case "A"
	        ...
	        C_BP_POPUP      = iCurColumnPos(9)
	        C_BP_NM         = iCurColumnPos(10)
	        C_ACCT_LIMIT    = iCurColumnPos(11)
	...
	With frm1
		...
		For lRow = 1 To .vspdData.MaxRows
            ...
            Case ggoSpread.InsertFlag											'☜: 신규 
                ...
                strVal = strVal & Trim(UNIConvNum(.vspdData.Text,0)) & Parent.gRowSep
					...
					<TD CLASS="CLSMTABP">
						<TABLE ID="MyTab" CELLSPACING=0 CELLPADDING=0>
							<TR>
								...
								<td background="../../../CShared/image/table/seltab_up_bg.gif" align="center" CLASS="CLSMTABP"><font color=white>은행정보등록</font></td>
