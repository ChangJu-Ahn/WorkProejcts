...
'*  2. Function Name        : Master Data(Currency)(통화코드등록)
...
Sub InitSpreadSheet()
   ...
   'patch version
    ...
    .MaxCols = C_CurrencyNm + 1												'☜: 최대 Columns의 항상 1개 증가시킴 
    ...
    ggoSpread.SSSetEdit C_Currency, "통화코드", 44,,,3,2
    ggoSpread.SSSetEdit C_CurrencyNm, "통화명", 72,,,30
	ggoSpread.SSSetMask C_Currency, "통화코드", 44,,"UUU"   
					...
					<TD CLASS="CLSMTABP">
						<TABLE ID="MyTab" CELLSPACING=0 CELLPADDING=0>
							<TR>
								...
								<td background="../../../CShared/image/table/seltab_up_bg.gif" align="center" CLASS="CLSMTAB"><font color=white>통화코드등록</font></td>
						...
						<FIELDSET CLASS="CLSFLD">
							<TABLE <%=LR_SPACE_TYPE_40%>>
								<TR>
									<TD CLASS="TD5">통 화</TD>
									<TD CLASS="TD6">
										<INPUT TYPE=TEXT NAME="txtCurrency" SIZE=10  MAXLENGTH=3 tag="11XXXU" ALT="통화코드"><IMG SRC="../../../CShared/image/btnPopup.gif" NAME="btnCurrencyCd" ALIGN=top TYPE="BUTTON" ONCLICK="vbscript:OpenCurrency()">
