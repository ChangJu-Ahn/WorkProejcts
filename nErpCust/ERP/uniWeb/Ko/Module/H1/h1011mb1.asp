...
<%
    ...
    Call LoadInfTB19029B("I", "H","NOCOOKIE","MB")                                                            '¢Ð: Hide Processing message
    lgErrorStatus     = "NO"
...
Sub SubBizQueryMulti()
    ...
    Else
        ...
        Do While Not lgObjRs.EOF
            ...
            lgstrData = lgstrData & Chr(11) & UNINumClientFormat(lgObjRs("man_amt"), 4, 0)
            lgstrData = lgstrData & Chr(11) & UNINumClientFormat(lgObjRs("woman_amt"), 4, 0)
...
Sub SubBizSaveMultiCreate(arrColVal)
    ...
    lgStrSQL = "INSERT INTO HDA130T( DEPT_CD , ALLOW_CD , MAN_AMT  , WOMAN_AMT   ,"  
...
Sub SubBizSaveMultiUpdate(arrColVal)
    ...
    lgStrSQL = "UPDATE  HDA130T"
    lgStrSQL = lgStrSQL & " SET " 
    lgStrSQL = lgStrSQL & "       MAN_AMT = " & UNIConvNum(arrColVal(4), 0) & ","
    lgStrSQL = lgStrSQL & "       WOMAN_AMT = " & UNIConvNum(arrColVal(5), 0) & ","
    ...
    Select Case Mid(pDataType,1,1)
        Case "M"
           ...
           Select Case Mid(pDataType,2,1)
               Case "R"
                       lgStrSQL = "Select TOP " & iSelCount  & " dept_cd, "
                       lgStrSQL = lgStrSQL & "                   dbo.ufn_H_GetCodeName(" & FilterVar("H_CURRENT_DEPT", "''", "S") & ",DEPT_CD,'') DEPT_nm, "
                       lgStrSQL = lgStrSQL & "                   man_amt, "
                       lgStrSQL = lgStrSQL & "                   woman_amt "
                       lgStrSQL = lgStrSQL & " From  HDA130T "
