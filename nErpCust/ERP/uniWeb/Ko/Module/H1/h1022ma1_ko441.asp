...
*  3. Program ID           	: H1022ma1_ko441
*  4. Program Name         	: H1022ma1_ko441
...
'========================================================================================================
Const BIZ_PGM_ID = "H1022mb1_ko441.asp"						           '☆: Biz Logic ASP Name
	        ...
	        Case "ALLOW_CD"
                ...
                If IRow > 0 Then
				    ...
				    If frm1.cboProv_type.value = "2" AND ArgMt = "1" Then  '상여 면 '000'만 선택되도록 
		           	...
		           	ElseIF  ArgMt = "X" or ArgMt = "Y" Then 
		                arrParam(4) = "Code_Type =  " & FilterVar("2" , "''", "S") & ""		           		
		            Else
