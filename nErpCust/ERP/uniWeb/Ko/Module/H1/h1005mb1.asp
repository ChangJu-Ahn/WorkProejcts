...
Sub SubBizSaveMultiCreate(arrColVal)
    ...
    lgStrSQL = "INSERT INTO HDA290T("
    lgStrSQL = lgStrSQL & " CODE_TYPE, ALLOW_CD, LIMIT_AMT, ISRT_EMP_NO , ISRT_DT  ," 
...
Sub SubBizSaveMultiUpdate(arrColVal)
    ...
    lgStrSQL = "UPDATE  HDA290T"
    lgStrSQL = lgStrSQL & " SET " 
    lgStrSQL = lgStrSQL & " CODE_TYPE   = " & FilterVar(UCase(arrColVal(3)), "''", "S")   & ","
    lgStrSQL = lgStrSQL & " ALLOW_CD	= " & FilterVar(UCase(arrColVal(4)), "''", "S")   & ","
    lgStrSQL = lgStrSQL & " LIMIT_AMT   = 0 "
    lgStrSQL = lgStrSQL & " WHERE        "
    lgStrSQL = lgStrSQL & " CODE_TYPE   = " & FilterVar(UCase(arrColVal(2)), "''", "S")
    ...
    Select Case Mid(pDataType,1,1)
        Case "M"
           ...
           Select Case Mid(pDataType,2,1)
               Case "R"               
                       lgStrSQL = "SELECT TOP " & iSelCount  & " CODE_TYPE, "
                       lgStrSQL = lgStrSQL & "                   dbo.ufn_GetCodeName(" & FilterVar("H0065", "''", "S") & ",CODE_TYPE) CODE_TYPE_nm, "
                       lgStrSQL = lgStrSQL & "                   ALLOW_CD, "
                       lgStrSQL = lgStrSQL & "                   dbo.ufn_H_GetCodeName(" & FilterVar("HDA010T", "''", "S") & ",ALLOW_CD," & FilterVar("1", "''", "S") & " ) ALLOW_nm "
                       lgStrSQL = lgStrSQL & "  FROM HDA290T "
                       lgStrSQL = lgStrSQL & " WHERE CODE_TYPE " & pComp & pCode
           End Select             
    End Select
End Sub
