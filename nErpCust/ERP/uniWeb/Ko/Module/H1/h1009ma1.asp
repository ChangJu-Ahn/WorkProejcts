...
*  2. Function Name        : 직위수당기준등록
*  3. Program ID           : H1009ma1
*  4. Program Name         : H1009ma1
*  5. Program Desc         : 기준정보관리/직위수당기준등록 
*  6. Comproxy List        :
...
Const BIZ_PGM_ID = "h1009mb1.asp"                                      'Biz Logic ASP 
...
Sub InitSpreadPosVariables()
	 C_ROLL_PSTN		= 1											'☆: Spread Sheet 의 Columns 인덱스 
	 C_ROLL_PSTN_POP	= 2
	 C_ROLL_PSTN_NM		= 3
	 C_ALLOW			= 4
End Sub
...
Sub InitSpreadSheet()
    ...
    With frm1.vspdData
       ...
       Call  GetSpreadColumnPos("A")
		 ...
		 ggoSpread.SSSetEdit   C_ROLL_PSTN,       "직위코드",   10,,,2,2
         ggoSpread.SSSetButton C_ROLL_PSTN_POP
		 ggoSpread.SSSetEdit   C_ROLL_PSTN_NM,    "직위코드명", 54
		 ggoSpread.SSSetFloat  C_ALLOW,           "직위수당",   46, parent.ggAmtOfMoneyNo, ggStrIntegeralPart,  ggStrDeciPointPart, parent.gComNum1000, parent.gComNumDec,,,"Z"
		 
		 Call ggoSpread.MakePairsColumn(C_ROLL_PSTN,  C_ROLL_PSTN_POP)
...
Sub SetSpreadLock()
    ...
    .vspdData.ReDraw = False
     ...
     ggoSpread.SpreadLock      C_ROLL_PSTN_POP , -1, C_ROLL_PSTN_POP
...
Sub SetSpreadColor(ByVal pvStartRow, ByVal pvEndRow)
    ...
    .vspdData.ReDraw = False
     ...
     ggoSpread.SSSetRequired    C_ROLL_PSTN		, pvStartRow, pvEndRow
...
Sub GetSpreadColumnPos(ByVal pvSpdNo)
    ...
    Select Case UCase(pvSpdNo)
       Case "A"
            ...
            C_ROLL_PSTN		= iCurColumnPos(1)											'☆: Spread Sheet 의 Columns 인덱스 
			C_ROLL_PSTN_POP	= iCurColumnPos(2)
			C_ROLL_PSTN_NM	= iCurColumnPos(3)
...
Sub Form_Load()
    ...
    ' 수당코드에 값을 
    Call  CommonQueryRs(" MAX(allow_cd) "," hda120t ","",lgF0,lgF1,lgF2,lgF3,lgF4,lgF5,lgF6)
...
Function FncSave()
    ...
    IntRetCd =  CommonQueryRs("distinct ALLOW_CD "," HDA120T "," ALLOW_CD <>  " & FilterVar(frm1.txtAllow_cd.value, "''", "S") & " ",lgF0,lgF1,lgF2,lgF3,lgF4,lgF5,lgF6)
    strAllow_cd = Trim(Replace(lgF0,Chr(11),""))

    If IsNull(strAllow_cd) OR strAllow_cd = "" then
    Else
        Call  DisplayMsgBox("800492","x",UCase(strAllow_cd),"직위수당")                        
        Exit Function          
    End if 
       ...
       For lRow = 1 To .vspdData.MaxRows
           ...
           Select Case .vspdData.Text
               ...
               Case  ggoSpread.DeleteFlag                                      '☜: Delete
                   ...
                   .vspdData.Col = C_ROLL_PSTN	: strDel = strDel & Trim(.vspdData.Text) & parent.gColSep
...
Function OpenAllowCd(iWhere)
    ...
    if  iWhere = 0 then
	    ...
	    arrParam(4) = " MAJOR_CD = " & FilterVar("H0002", "''", "S") & ""
	    arrParam(5) = "직위코드"			
...
Sub vspdData_Change(ByVal Col , ByVal Row )
    ...
    Select Case Col
         Case  C_ROLL_PSTN
                iDx = FuncCodeName(1, "H0002", Frm1.vspdData.value)
					...
					<TD CLASS="CLSMTABP">
						<TABLE ID="MyTab" CELLSPACING=0 CELLPADDING=0>
							<TR>
								...
								<td background="../../../CShared/image/table/seltab_up_bg.gif" align="center" CLASS="CLSMTAB"><font color=white>직위수당기준등록</font></td>
			...
			<TABLE <%=LR_SPACE_TYPE_20%>>
						...
						<FIELDSET CLASS="CLSFLD">
							<TABLE <%=LR_SPACE_TYPE_40%>>
								<TR>
                                    ...
                                    <TD CLASS=TD6 NOWRAP>
										<INPUT ID=txtAllow_cd TYPE=TEXT NAME="txtAllow_cd" MAXLENGTH=3 SIZE=10 MAXLENGTH=8 tag=12XXXU ALT="수당코드코드"><IMG SRC="../../../CShared/image/btnPopup.gif" NAME="btnWarrentNo" ALIGN=top TYPE="BUTTON" ONCLICK="vbscript:OpenAllowCd(0)">
				...
				<TR>
					<TD WIDTH=100% HEIGHT=100% valign=top>
							...
							<TR>
								<TD HEIGHT="100%">
									<script language =javascript src='./js/h1009ma1_vaSpread1_vspdData.js'></script>
								</TD>
							</TR>
						</TABLE>
					</TD>
