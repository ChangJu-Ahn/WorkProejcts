...
*  2. Function Name        : 일일수당기준등록 
*  3. Program ID           : H1011ma1
*  4. Program Name         : H1011ma1
*  5. Program Desc         : 기준정보관리/일일수당기준등록 
*  6. Comproxy List        :
...
Sub InitSpreadSheet()
    ...
    With frm1.vspdData
	    ...
	    .ReDraw = false
        .MaxCols = C_WOMAN_AMT + 1												<%'☜: 최대 Columns의 항상 1개 증가시킴 %>
       ...
       Call  GetSpreadColumnPos("A")
		 ...
		 ggoSpread.SSSetEdit   C_DEPT_CD,       "부서", 20,,,13,2
		 ggoSpread.SSSetButton C_DEPT_CD_POP
		 ggoSpread.SSSetEdit   C_DEPT_CD_NM,    "부서명", 44,,,44,2
		 ggoSpread.SSSetFloat  C_MAN_AMT,       "남자수당액", 25, parent.ggAmtOfMoneyNo, ggStrIntegeralPart,  ggStrDeciPointPart, parent.gComNum1000, parent.gComNumDec,,,"Z"
		 ggoSpread.SSSetFloat  C_WOMAN_AMT,     "여자수당액", 25, parent.ggAmtOfMoneyNo, ggStrIntegeralPart,  ggStrDeciPointPart, parent.gComNum1000, parent.gComNumDec,,,"Z"
...
Function FncSave()
    ...
    Else
        Call  DisplayMsgBox("800492","x",UCase(strAllow_cd),"일일수당")                        
        Exit Function          
    End if 
					...
					<TD CLASS="CLSMTABP">
						<TABLE ID="MyTab" CELLSPACING=0 CELLPADDING=0>
							<TR>
								...
								<td background="../../../CShared/image/table/seltab_up_bg.gif" align="center" CLASS="CLSMTAB"><font color=white>일일수당기준등록</font></td>
