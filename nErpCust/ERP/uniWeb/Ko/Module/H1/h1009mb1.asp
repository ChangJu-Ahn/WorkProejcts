...
Sub SubBizQueryMulti()
    ...
    Else
        ...
        Do While Not lgObjRs.EOF
            ...
            lgstrData = lgstrData & Chr(11) & ConvSPChars(lgObjRs("ROLL_PSTN_name"))
...
Sub SubBizSaveMultiCreate(arrColVal)
    ...
    lgStrSQL = "INSERT INTO HDA120T( ROLL_PSTN , ALLOW_CD , ALLOW  , ISRT_EMP_NO," 
...
Sub SubBizSaveMultiUpdate(arrColVal)
    ...
    lgStrSQL = "UPDATE  HDA120T"
    lgStrSQL = lgStrSQL & " SET " 
    lgStrSQL = lgStrSQL & "       ALLOW = " & UNIConvNum(arrColVal(4), 0)  & ","
    lgStrSQL = lgStrSQL & "       UPDT_EMP_NO = " & FilterVar(gUsrId, "''", "S") & ","
    lgStrSQL = lgStrSQL & "       UPDT_DT = " & FilterVar(GetSvrDateTime, "''", "S")
    lgStrSQL = lgStrSQL & " WHERE        "
    lgStrSQL = lgStrSQL & "       ROLL_PSTN = " & FilterVar(UCase(arrColVal(2)), "''", "S")
    ...
    Select Case Mid(pDataType,1,1)
        Case "M"
           ...
           Select Case Mid(pDataType,2,1)
               Case "R"
                       lgStrSQL = "SELECT TOP " & iSelCount  & " ROLL_PSTN, dbo.ufn_GetCodeName(" & FilterVar("H0002", "''", "S") & ",HDA120T.ROLL_PSTN) ROLL_PSTN_name, ALLOW "
                       lgStrSQL = lgStrSQL & " FROM  HDA120T "
