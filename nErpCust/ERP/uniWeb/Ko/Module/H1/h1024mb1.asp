...
Sub SubBizQueryMulti()
    ...
    Else
        ...
        Do While Not lgObjRs.EOF
            ...
            lgstrData = lgstrData & Chr(11) & ConvSPChars(lgObjRs("PAY_GRD1_name"))
...
Sub SubBizSaveMultiCreate(arrColVal)
    ...
    lgStrSQL = "INSERT INTO HDA220T( PAY_GRD1, EMP_TYPE," 
...
Sub SubBizSaveMultiUpdate(arrColVal)
    ...
    lgStrSQL = "UPDATE  HDA220T"
    lgStrSQL = lgStrSQL & " SET " 
    lgStrSQL = lgStrSQL & " EMP_TYPE = " & FilterVar(arrColVal(3),"NULL", "S") & ","
    lgStrSQL = lgStrSQL & " UPDT_EMP_NO = " & FilterVar(gUsrId, "''", "S") & ","
    lgStrSQL = lgStrSQL & " UPDT_DT = " & FilterVar(GetSvrDateTime, "''", "S")
    lgStrSQL = lgStrSQL & " WHERE PAY_GRD1 = " & FilterVar(arrColVal(2), "NULL", "S")
    ...
    Select Case Mid(pDataType,1,1)
        Case "M"
           Select Case Mid(pDataType,2,1)
               Case "R"
                       lgStrSQL = "          Select  PAY_GRD1, " 
                       lgStrSQL = lgStrSQL & "       dbo.ufn_GetCodeName(" & FilterVar("H0001", "''", "S") & ", PAY_GRD1)  PAY_GRD1_name, "
                       lgStrSQL = lgStrSQL & "       EMP_TYPE, "                       
                       lgStrSQL = lgStrSQL & "       dbo.ufn_GetCodeName(" & FilterVar("H0122", "''", "S") & ", EMP_TYPE)  EMP_TYPE_nm "
                       lgStrSQL = lgStrSQL & " From  HDA220T"
           End Select             
    End Select
End Sub
