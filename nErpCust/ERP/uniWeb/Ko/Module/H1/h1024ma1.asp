...
Sub InitSpreadSheet()
    ...
    With frm1.vspdData
	    ...
	    .ReDraw = false
        .MaxCols = C_EMP_TYPE_CD + 1												<%'☜: 최대 Columns의 항상 1개 증가시킴 %>
        ...
        ggoSpread.ClearSpreadData
		 ...
		 ggoSpread.SSSetEdit	 C_PAY_GRD1,          "급호코드", 20
		 ggoSpread.SSSetButton   C_PAY_GRD1Popup
		 ggoSpread.SSSetEdit	 C_PAY_GRD1_NM,       "급호명", 40,,,50,2 
         ggoSpread.SSSetCombo    C_EMP_TYPE,          "사원구분", 28
         ggoSpread.SSSetCombo    C_EMP_TYPE_CD,       "사원구분코드", 14
					...
					<TD CLASS="CLSMTABP">
						<TABLE ID="MyTab" CELLSPACING=0 CELLPADDING=0>
							<TR>
								...
								<td background="../../../CShared/image/table/seltab_up_bg.gif" align="center" CLASS="CLSMTAB"><font color=white>급호별사원구분등록</font></td>
