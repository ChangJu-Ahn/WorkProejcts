        ...
        Case "M"
           Select Case Mid(pDataType,2,1)
               Case "R"
                       ...
                       lgStrSQL = lgStrSQL & "	(select  max(allow_nm)   from  hda010t           "                             
                       lgStrSQL = lgStrSQL & "	where code_type =                         "                                     
                       lgStrSQL = lgStrSQL & "		 		(case when  hda200t.prov_type =  '2'  then '0'    "                         
                       lgStrSQL = lgStrSQL & "						when  hda200t.code_type  in ('X' , 'Y')  then  '2'  else     hda200t.code_type  end )  "     
                       lgStrSQL = lgStrSQL & "      and  allow_cd  = hda200t.allow_cd )  as allow_nm,      "                   
