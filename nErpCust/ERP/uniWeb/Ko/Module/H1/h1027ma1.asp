...
*  5. Program Desc         : 근태집계예외기간등록
*  6. Comproxy List        :
*  7. Modified date(First) : 2003/09/05
*  8. Modified date(Last)  : 
*  9. Modifier (First)     : SongBongKyu 
* 10. Modifier (Last)      : 
* 11. Comment              : 근태집계시 근태코드/급여구분별로 근태기준일을 다르게 가져가고자 하는 경우 사용 
=======================================================================================================-->
<HTML>
<HEAD>
...
'========================================================================================================
Const BIZ_PGM_ID = "H1027mb1.asp"                                      '비지니스 로직 ASP명 
...
Dim C_PAY_CD
Dim C_PAY_NM
Dim C_CRT_STRT_MM     '2003.09.01 by sbk 추가 
Dim C_CRT_STRT_MM_NM  '2003.09.01 by sbk 추가 
Dim C_CRT_STRT_DD     '2003.09.01 by sbk 추가 
Dim C_BAR             '2003.09.01 by sbk 추가 
Dim C_CRT_END_MM      '2003.09.01 by sbk 추가 
Dim C_CRT_END_MM_NM   '2003.09.01 by sbk 추가 
Dim C_CRT_END_DD      '2003.09.01 by sbk 추가 
...
Sub InitSpreadSheet()
	...
	With frm1.vspdData
        ...
        .MaxCols = C_CRT_END_DD + 1												<%'☜: 최대 Columns의 항상 1개 증가시킴 %>
		...
		Call  GetSpreadColumnPos("A")      
         ...
         ggoSpread.SSSetEdit  C_DILIG_NM         , "근태코드명", 22,,, 20,2    
         ggoSpread.SSSetCombo C_PAY_CD		     , "급여구분CD" ,10, 0
         ggoSpread.SSSetCombo C_PAY_NM           , "급여구분" , 18, 0

		 ggoSpread.SSSetCombo C_CRT_STRT_MM,      "집계기간",         5
		 ggoSpread.SSSetCombo C_CRT_STRT_MM_NM,   "집계시작월",       12
		 ggoSpread.SSSetMask  C_CRT_STRT_DD,      "일",              6,2, "99"

		 ggoSpread.SSSetEdit  C_BAR,              "" ,                    2,2

		 ggoSpread.SSSetCombo C_CRT_END_MM,       "",                     10
		 ggoSpread.SSSetCombo C_CRT_END_MM_NM,    "집계종료월",       12
		 ggoSpread.SSSetMask  C_CRT_END_DD,       "일",              6,2, "99"
     ...
     <TD CLASS="CLSMTABP">
      <TABLE ID="MyTab" CELLSPACING=0 CELLPADDING=0>
       <TR>
        ...
        <td background="../../../CShared/image/table/seltab_up_bg.gif" align="center" CLASS="CLSMTABP"><font color=white>월근태집계예외기간등록</font></td>
     ...
     <TD HEIGHT=20 WIDTH=100%>
      ...
      <TABLE <%=LR_SPACE_TYPE_40%>>
       <TR>
		   ...
		   <TD CLASS="TD6" NOWRAP><INPUT ID=txtDilig_cd NAME="txtDilig_cd" ALT="근태코드" TYPE="Text" SiZE="10" MAXLENGTH="2" tag="11XXXU"><IMG SRC="../../../CShared/image/btnPopup.gif" NAME="btnname" ALIGN=top TYPE="BUTTON" ONCLICK="VBScript: OpenCondAreaPopup '1',0">
