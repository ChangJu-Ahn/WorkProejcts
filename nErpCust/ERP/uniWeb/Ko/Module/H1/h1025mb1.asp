...
Sub SubBizQueryMulti()
    ...
    Else
        ...
        Do While Not lgObjRs.EOF
            ...
            lgstrData = lgstrData & Chr(11) & ConvSPChars(lgObjRs("COST_TYPE_nm"))
            lgstrData = lgstrData & Chr(11) & ConvSPChars(lgObjRs("COST_TYPE"))
            lgstrData = lgstrData & Chr(11) & ConvSPChars(lgObjRs("DI_FG_nm"))
            lgstrData = lgstrData & Chr(11) & ConvSPChars(lgObjRs("DI_FG"))
...
Sub SubBizSaveMultiCreate(arrColVal)
    ...
    lgStrSQL = "INSERT INTO HDA230T( COST_TYPE, DI_FG, SALE_TAG," 
...
Sub SubBizSaveMultiUpdate(arrColVal)
    ...
    lgStrSQL = "UPDATE  HDA230T"
    lgStrSQL = lgStrSQL & " SET " 
    lgStrSQL = lgStrSQL & "     SALE_TAG = " & FilterVar(arrColVal(4),"NULL", "S") & ","
    lgStrSQL = lgStrSQL & "     UPDT_EMP_NO = " & FilterVar(gUsrId, "''", "S") & ","
    lgStrSQL = lgStrSQL & "     UPDT_DT = " & FilterVar(lgGetSvrDateTime, "''", "S")
    lgStrSQL = lgStrSQL & " WHERE COST_TYPE = " & FilterVar(arrColVal(2), "NULL", "S")
    lgStrSQL = lgStrSQL & "   AND DI_FG = " & FilterVar(arrColVal(3), "NULL", "S")
        ...
        Case "M"
           Select Case Mid(pDataType,2,1)
               Case "R"
                       ...
                       lgStrSQL = lgStrSQL & "	    dbo.ufn_GetCodeName(" & FilterVar("C2203", "''", "S") & ",COST_TYPE) COST_TYPE_nm, "
                       lgStrSQL = lgStrSQL & "		DI_FG, "
                       lgStrSQL = lgStrSQL & "	    dbo.ufn_GetCodeName(" & FilterVar("C0002", "''", "S") & ",DI_FG) DI_FG_nm, "
                       lgStrSQL = lgStrSQL & "		SALE_TAG, "
                       lgStrSQL = lgStrSQL & "	    dbo.ufn_GetCodeName(" & FilterVar("H0071", "''", "S") & ",SALE_TAG) SALE_TAG_nm "
                       lgStrSQL = lgStrSQL & " From  HDA230T"
           End Select             
    End Select
End Sub
