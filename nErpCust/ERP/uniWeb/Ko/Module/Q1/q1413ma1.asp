...
'*  4. Program Name         : 계수규준형 1회 샘플링 검사방식 
...
<HTML>
<HEAD>
<TITLE>T계수 규준형 샘플링 검사방식 적용</TITLE>
...
Function ShowGraphClick()
	...
	strVal = strVal & "&txtDefectRate=" & frm1.txtBeta.Text		'불량률을 베타값으로 한다.
					...
					<TD CLASS="CLSMTABP">
						<TABLE ID="MyTab" CELLSPACING=0 CELLPADDING=0 >
							<TR>
								...
								<TD BACKGROUND="../../../CShared/image/table/seltab_up_bg.gif" ALIGN="center" CLASS="CLSMTAB"><FONT COLOR=white>계수 규준형 샘플링 검사</FONT></TD>
						...
						<LEGEND>입력사항</LEGEND>
							<TABLE CLASS="basicTB" CELLSPACING=0 HEIGHT=100%>
								<TR>
									...
									<TD CLASS="TD6" NOWRAP>
										<script language =javascript src='./js/q1413ma1_txtAlpha_txtAlpha.js'></script>&nbsp;%
									</TD>
									<TD CLASS="TD5" NOWRAP>소비자 위험(β)</TD>
									<TD CLASS="TD6" NOWRAP>
										<script language =javascript src='./js/q1413ma1_txtBeta_txtBeta.js'></script>&nbsp;%
									</TD>
								</TR>
								<TR>
									<TD CLASS="TD5" NOWRAP>P1(AQL)</TD>
									<TD CLASS="TD6" NOWRAP>
										<script language =javascript src='./js/q1413ma1_txtP1_txtP1.js'></script>
									</TD>
									<TD CLASS="TD5" NOWRAP>P2(LTPD)</TD>
									<TD CLASS="TD6" NOWRAP>
										<script language =javascript src='./js/q1413ma1_txtP2_txtP2.js'></script>&nbsp;%
									</TD>
								</TR>
								<TR>
									<TD CLASS="TD5" NOWRAP>로트크기</TD>
									<TD CLASS="TD6" NOWRAP>
										<script language =javascript src='./js/q1413ma1_txtLotSize_txtLotSize.js'></script>
									</TD>								
						...
						<LEGEND>결과</LEGEND>
							<TABLE CLASS="basicTB" CELLSPACING=0 HEIGHT=100% >
								...
								<TR>
									...
									<TD CLASS="TD6" NOWRAP>
										<script language =javascript src='./js/q1413ma1_txtSampleSize_txtSampleSize.js'></script>
									</TD>
									<TD CLASS="TD5" NOWRAP>합격판정개수</TD>
									<TD CLASS="TD6" NOWRAP>
										<script language =javascript src='./js/q1413ma1_txtAcceptSize_txtAcceptSize.js'></script>
									</TD>
								</TR>
								<TR>
									<TD CLASS="TD5" HEIGHT=5 NOWRAP></TD>
