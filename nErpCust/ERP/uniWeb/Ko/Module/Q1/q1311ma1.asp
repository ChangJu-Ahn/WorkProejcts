...
Const BIZ_PGM_QRY_ID = "q1311mb1.asp"				'☆: 비지니스 로직 ASP명 
Const BIZ_PGM_SAVE_ID = "q1311mb2.asp"				'☆: 비지니스 로직 ASP명 

Dim C_DefectTypeCd '= 1															'☆: Spread Sheet의 Column별 상수 
Dim C_DefectTypeNm '= 2
...
Sub InitSpreadSheet()
	...
	With frm1.vspdData
		...
		.MaxCols = C_DefectTypeNm + 1							'☜: 최대 Columns의 항상 1개 증가시킴 
		.MaxRows = 0
		
		Call GetSpreadColumnPos("A")
		
		ggoSpread.SSSetEdit C_DefectTypeCd, "불량유형코드", 30, 0, -1, 3, 2
		ggoSpread.SSSetEdit C_DefectTypeNm, "불량유형명", 60, 0, -1, 40
...
Sub SetSpreadLock()
	With frm1
		...
		Call ggoSpread.SpreadLock(C_DefectTypeCd, -1, C_DefectTypeCd)
		Call ggoSpread.SSSetRequired(C_DefectTypeNm, -1)	
...
Sub SetSpreadColor(ByVal pvStartRow, ByVal pvEndRow)
	With frm1
		.vspdData.ReDraw = False
		ggoSpread.SSSetRequired C_DefectTypeCd, pvStartRow, pvEndRow
		ggoSpread.SSSetRequired C_DefectTypeNm, pvStartRow, pvEndRow
		.vspdData.ReDraw = True
	End With
End Sub
...
Sub InitSpreadPosVariables()
	C_DefectTypeCd = 1															'☆: Spread Sheet의 Column별 상수 
	C_DefectTypeNm = 2
End Sub
...
Sub GetSpreadColumnPos(ByVal pvSpdNo)
 	...
 	Case "A"
		...
		C_DefectTypeNm = iCurColumnPos(2)
...
Sub vspdData_Change(ByVal Col, ByVal Row)
	With frm1.vspdData
		If Col = C_DefectTypeNm And Row > 0 Then
			.Row = Row
			.Col = Col
		End If
	End With
...
Function FncCopy() 
	...
	End With
	Call SetActiveCell(frm1.vspdData,C_DefectTypeCd,frm1.vspdData.ActiveRow,"M","X","X")
	Set gActiveElement = document.ActiveElement	
	FncCopy = true
End Function
...
Function DbQueryOk()									'☆: 조회 성공후 실행로직 
	...
	If frm1.vspdData.MaxRows <= 100 Then
		posActiveRow = 1
		Call SetActiveCell(frm1.vspdData,C_DefectTypeNm,posActiveRow,"M","X","X")
		Set gActiveElement = document.ActiveElement		
	End If
		...
		For lRow = 1 To iMaxRows
			...
			Select Case .vspdData.Text
				Case iInsertFlag
					...
					.vspdData.Col = C_DefectTypeNm
					strDefectTypeNm = Trim(.vspdData.Text)
					
					strVal = strVal & "C" & iColSep & _
									strDefectTypeCd & iColSep & _
									strDefectTypeNm & iColSep & _
									CStr(lRow) & iRowSep
					lGrpCnt = lGrpCnt + 1
					...
					<TD CLASS="CLSMTABP">
						<TABLE ID="MyTab" CELLSPACING=0 CELLPADDING=0>
							<TR>
								...
								<td background="../../../CShared/image/table/seltab_up_bg.gif" align="center" CLASS="CLSMTAB"><font color=white>불량유형 등록</font></td>
						...
						<FIELDSET CLASS="CLSFLD">
							<TABLE WIDTH=100% <%=LR_SPACE_TYPE_40%>>
								<TR>
									...
									<td CLASS="TD6" NOWPAP>
										<input TYPE=TEXT NAME="txtPlantCd" SIZE="10" MAXLENGTH="4" ALT="공장" tag="12XXXU" ><IMG align=top height=20 name=btnPlantCd1 onclick=vbscript:OpenPlant() src="../../../CShared/image/btnPopup.gif" width=16  TYPE="BUTTON">
				...
				<TR>
					<TD WIDTH=100% HEIGHT=* valign=top>
						<TABLE WIDTH="100%" HEIGHT="100%" <%=LR_SPACE_TYPE_20%>>
							<TR>
								<TD HEIGHT="100%">
									<script language =javascript src='./js/q1311ma1_I636959415_vspdData.js'></script>
								</TD>
							</TR>
						</TABLE>
					</TD>
