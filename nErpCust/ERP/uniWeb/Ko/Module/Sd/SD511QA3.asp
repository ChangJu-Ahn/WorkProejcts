...
*  3. Program ID           : SD511QA3
*  4. Program Name         : 발행처별판수현황 
...
Const BIZ_PGM_ID 		= "SD511QB3.asp"                              '☆: Biz Logic ASP Name
...
Sub InitSpreadSheet()
    ...
    Call SetZAdoSpreadSheet("SD511QA3","S","A", "V20030402", parent.C_SORT_DBAGENT,frm1.vspdData,C_MaxKey, "X", "X")
    Call SetSpreadLock()   
...
Sub Form_Load()
    ...
    Call ggoOper.FormatDate(frm1.txtConYYYYDt, Parent.gDateFormat, 2)			'YYYYMM으로 포멧팅 
...
Function DbQuery() 
    ...
    '--------- Developer Coding Part (Start) ----------------------------------------------------------
        ...
        If lgIntFlgMode  <> parent.OPMD_UMODE Then									'☜: This means that it is first search
			...
			strConBaseDt	= UNIConvDate(UNIGetFirstDay(Trim(frm1.txtConYYYYDt.text),parent.gDateFormatYYYYMM))
			strConBeforeDt	= UniDateAdd("m", -1,strConBaseDt,parent.gServerDateFormat)

			With frm1			
				strVal = BIZ_PGM_ID & "?ConDt=" & strConBaseDt			<%'☜: 비지니스 처리 ASP의 상태 %>
				strVal = strVal & "&PrevDt=" & strConBeforeDt			 
					...
					<TD CLASS="CLSMTABP">
						<TABLE ID="MyTab" CELLSPACING=0 CELLPADDING=0>
							<TR>
								...
								<td background="../../../CShared/image/table/seltab_up_bg.gif" align="center" CLASS="CLSMTAB"><font color=white>매출대수금조회(발행처)</font></td>
						...
						<FIELDSET>
							<TABLE <%=LR_SPACE_TYPE_40%>>
								<TR>									
									...
									<TD CLASS="TD6" NOWRAP>
											<script language =javascript src='./js/sd511qa3_OBJECT3_txtConYYYYDt.js'></script>
									</TD>
				...
				<TR>
					<TD WIDTH=100% HEIGHT=* valign=top>
						<TABLE <%=LR_SPACE_TYPE_20%>>
							<TR>
								<TD HEIGHT="100%">
									<script language =javascript src='./js/sd511qa3_vspdData_vspdData.js'></script>
								</TD>
							</TR>
						</TABLE>
					</TD>
