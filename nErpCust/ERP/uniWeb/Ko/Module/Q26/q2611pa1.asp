...
'top.document.title = "이상발생보고 현황 팝업"
...
Sub SetDefaultVal()
	...
	txtMgmtNo.Value 		= arrParam(2)
	lgCounterPlanFlag 		= arrParam(3)
...
Sub InitSpreadSheet()
	...
	vspdData.MaxCols = C_InspClassNm + 1
	vspdData.MaxRows = 0
	...
	ggoSpread.SSSetEdit C_InspClassCd, "검사분류", 10
	ggoSpread.SSSetEdit C_InspClassNm, "검사분류", 20
...
Sub GetSpreadColumnPos(ByVal pvSpdNo)
    ...
    Select Case UCase(pvSpdNo)
       Case "A"
			...
			C_CounterPlanFlag	= iCurColumnPos(7)
			C_OccurDtFr			= iCurColumnPos(8)
			C_OccurDtTo			= iCurColumnPos(9)
			C_Framer			= iCurColumnPos(10)
			C_PlantCd			= iCurColumnPos(11)
			C_PlantNm			= iCurColumnPos(12)
			C_InspClassCd		= iCurColumnPos(13)
			C_InspClassNm		= iCurColumnPos(14)
						...
						<FIELDSET CLASS="CLSFLD">
							<TABLE <%=LR_SPACE_TYPE_40%>>
								...
								<TR>
									...
									<TD CLASS="TD6" NOWRAP>
										<script language =javascript src='./js/q2611pa1_fpDateTime1_txtFrameDt1.js'></script>&nbsp;~&nbsp; 
										<script language =javascript src='./js/q2611pa1_fpDateTime2_txtFrameDt2.js'></script>
									</TD>			
								</TR>
							</TABLE>
						</FIELDSET>
				...
				<TR>
					<TD HEIGHT=*  WIDTH=100% VALIGN=TOP>						
						<TABLE <%=LR_SPACE_TYPE_20%>>
							<TR>
								<TD>
									<script language =javascript src='./js/q2611pa1_I593112432_vspdData.js'></script>
								</TD>
							</TR>
						</TABLE>
					</TD>
