...
*  1. Module Name          : 경영손익 
*  2. Function Name        :
*  3. Program ID           : GE003MA1
*  4. Program Name         : 품목별 배부기준 DATA 등록 
*  5. Program Desc         : 
*  6. Comproxy List        :
...
'========================================================================================================
Const BIZ_PGM_ID = "ge003mb1.asp"                                      'Biz Logic ASP
'========================================================================================================
...
Sub InitSpreadSheet()
	...
	With frm1.vspdData
       ...
       ggoSpread.SSSetEdit  C_center   , "품  목  코  드"      ,35,,, 35,2
       ggoSpread.SSSetButton C_center_bt
       ggoSpread.SSSetEdit  C_centernm , "품    목    명"   ,45,,, 45,2
...
Function OpenCurrency()
	...
	arrParam(4) = arrParam(4) & "  AND  a.seq_no =6  and reference = " & FilterVar("Y", "''", "S") & "   "				<%' Where Condition%>
	arrParam(5) = "배부기준 코드"
...
Function OpenCost(strCode, iWhere, Row)
	...
	Select Case iWhere
	    Case 1
	    	arrParam(1) = " B_COST_CENTER A , B_ITEM B"								' TABLE 명칭 
	    	arrParam(2) = ""														' Code Condition
	    	arrParam(3) = ""														' Name Cindition
	    	arrParam(4) = " A.COST_CD = B.ITEM_CD "									' Where Condition
	    	arrParam(5) = "품목코드"		   										' TextBox 명칭 
...
Sub vspdData_Change(Col , Row)
	...
	IntRetCD = CommonQueryRs(" item_nm ","B_COST_CENTER A, B_item B  "," cost_cd = " & Input_alloc  ,lgF0,lgF1,lgF2,lgF3,lgF4,lgF5,lgF6)	
					...
					<TD CLASS="CLSMTABP">
						<TABLE ID="MyTab" CELLSPACING=0 CELLPADDING=0>
							<TR>
								...
								<td background="../../../CShared/image/table/seltab_up_bg.gif" align="center" CLASS="CLSMTAB"><font color=white>품목별 기준Data</font></td>
						...
						<FIELDSET CLASS="CLSFLD">
							<TABLE <%=LR_SPACE_TYPE_40%>>
								<TR>
									...
									<TD CLASS="TD6" NOWRAP>
										<script language =javascript src='./js/ge003ma1_fpDateTime3_fpdtWk_yymm.js'></script>
				...
				<TR>
					<TD WIDTH=100% HEIGHT=100% valign=top>
							<TABLE <%=LR_SPACE_TYPE_30%>>
								<TR>
									<TD HEIGHT="100%">
										<script language =javascript src='./js/ge003ma1_OBJECT1_vspdData.js'></script>
								</TD>
								</TR>
							</TABLE>
					</TD>
					...
					<TD>
							...
							<TABLE <%=LR_SPACE_TYPE_30%>>
										<TR HEIGHT=20>
							    			...
							    			<TD CLASS=TD6 NOWRAP><script language =javascript src='./js/ge003ma1_fpDoubleSingle2_txtDataAmt.js'></script></TD>
										</TR>
							</TABLE>
							</FIELDSET>
					</TD>
