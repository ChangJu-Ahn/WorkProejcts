...
*  1. Module Name          : 경영손익 
*  2. Function Name        :
*  3. Program ID           : GE005MA1
*  4. Program Name         : GE005MA1
*  5. Program Desc         : 경영손익 품목별 손익현황 조회 
*  6. Comproxy List        :
...
Const BIZ_PGM_ID		= "GE005MB1.asp"						           '☆: Biz Logic ASP Name
Const BIZ_PGM_JUMP_ID	= "GE010MA1"
'========================================================================================================
...
Sub LoadInfTB19029()
  ...
  <% Call loadInfTB19029A("G", "*", "NOCOOKIE", "QA") %>
   ...
   '------ Developer Coding part (Start ) --------------------------------------------------------------    
	With Frm1                      	
		...
		Case 0
			...
			If UCase(Trim(.txtJumpFlag.Value)) = "GE010MA1" Then
...
Sub MakeKeyStream(pOpt)
   ...
   '------ Developer Coding part (Start ) --------------------------------------------------------------
    ...
    if frm1.rdoGiYes.checked then
        lgKeyStream       = lgKeyStream + frm1.txtAmtFg(0).value & Parent.gColSep              'You Must append one character(Parent.gColSep)
    else
        lgKeyStream       = lgKeyStream + frm1.txtAmtFg(1).value & Parent.gColSep              'You Must append one character(Parent.gColSep)
    end if
    
    frm1.txtSpread.value = lgKeyStream
...
Sub InitSpreadSheet()
	...
	ELSE
       ggoSpread.SSSetEdit   C_PROFIT_NM    , "손익항목"  ,23
       ggoSpread.SSSetFloat  C_PROFIT_AMT    , "금액",19,Parent.ggQtyNo,ggStrIntegeralPart, ggStrDeciPointPart,Parent.gComNum1000,Parent.gComNumDec
	   ggoSpread.SSSetFloat  C_PROFIT_PCNT    , "%"  ,11,Parent.ggExchRateNo,ggStrIntegeralPart, ggStrDeciPointPart,Parent.gComNum1000,Parent.gComNumDec
       ggoSpread.SSSetFloat  C_OLD_PROFIT_AMT    , "전년동기",19,Parent.ggQtyNo,ggStrIntegeralPart, ggStrDeciPointPart,Parent.gComNum1000,Parent.gComNumDec
	   ggoSpread.SSSetFloat  C_OLD_PROFIT_PCNT    , "%"  ,11,Parent.ggExchRateNo,ggStrIntegeralPart, ggStrDeciPointPart,Parent.gComNum1000,Parent.gComNumDec
	   ggoSpread.SSSetFloat  C_AMT_DIFF    , "차이",19,Parent.ggQtyNo,ggStrIntegeralPart, ggStrDeciPointPart,Parent.gComNum1000,Parent.gComNumDec
	   ggoSpread.SSSetFloat  C_INC_PCNT    , "증감율"  ,11,Parent.ggExchRateNo,ggStrIntegeralPart, ggStrDeciPointPart,Parent.gComNum1000,Parent.gComNumDec
	END IF				
...
Function OpenCode()
    ...
    arrField(0) = "ITEM_CD"	     			<%' Field명(1)%>
    arrField(1) = "ITEM_NM"					<%' Field명(0)%>
...
'========================================================================================================
'   Event Name : fpdtWk_yymm1_KeyPress
'   Event Desc :
'========================================================================================================
					...
					<TD NOWRAP  CLASS="CLSMTABP">
						<TABLE ID="MyTab" CELLSPACING=0 CELLPADDING=0>
							<TR>
								...
								<TD NOWRAP  background="../../../CShared/image/table/seltab_up_bg.gif" align="center" CLASS="CLSMTAB"><font color=white>품목별 손익현황</font></td>
						...
						<FIELDSET CLASS="CLSFLD">
							<TABLE <%=LR_SPACE_TYPE_40%>>
								<TR>
									...
									<TD NOWRAP  CLASS=TD6 NOWRAP><script language =javascript src='./js/ge005ma1_fpdtWk_yymm_fpdtWk_yymm.js'></script>~<script language =javascript src='./js/ge005ma1_fpdtWk_yymm1_fpdtWk_yymm1.js'></script></TD>
                                    <TD NOWRAP  CLASS=TD5 NOWRAP>품목</TD>
									<TD NOWRAP  CLASS=TD6 NOWRAP>
									 <INPUT TYPE=TEXT NAME="txtDeptCd" SIZE=20 MAXLENGTH=18 tag="12XXXU" ALT="품목코드"><IMG SRC="../../../CShared/image/btnPopup.gif" NAME="btnCode" ALIGN=top TYPE="BUTTON" ONCLICK="vbscript:OpenCode()">
									 <INPUT TYPE=TEXT NAME="txtDeptNm" SIZE=20 MAXLENGTH=40 tag="14" ALT="품목명" >
									 </TD>
								</TR>
							<TR>
									<TD NOWRAP  CLASS=TD5 NOWRAP></TD>
									<TD NOWRAP  CLASS=TD6 NOWRAP></TD>
                                    <TD NOWRAP  CLASS=TD5 NOWRAP>작업구분</TD>
									<TD NOWRAP  CLASS=TD6 NOWRAP>
										<INPUT TYPE=radio CLASS="RADIO" NAME="txtAmtFg" id="rdoGiYes" VALUE="Y" tag = "11" CHECKED onclick=rdoGiYes_onchange()>
											<LABEL FOR="rdoGiYes">금액</LABEL>&nbsp;&nbsp;&nbsp;&nbsp;
										<INPUT TYPE=radio CLASS = "RADIO" NAME="txtAmtFg" id="rdoGiNo" VALUE="N" tag = "11" onclick=rdoGiNo_onchange()>
											<LABEL FOR="rdoGiNo">단가(원/단위당)</LABEL>
									 </TD>
								</TR>
							</TABLE>
						</FIELDSET>
						...
						<TABLE <%=LR_SPACE_TYPE_20%>>
							<TR>
								<TD NOWRAP  HEIGHT="100%">
									<script language =javascript src='./js/ge005ma1_vspdData_vspdData.js'></script>
								</TD>
							</TR>
						</TABLE>
					</TD>
...
<TEXTAREA CLASS="hidden" NAME="txtSpread" TAG="24" cols=50 TABINDEX="-1"></TEXTAREA>
