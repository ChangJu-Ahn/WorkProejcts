...
*  1. Module Name          : 경영손익 
*  2. Function Name        : 
*  3. Program ID           : GE004MA1
*  4. Program Name         : 품목별 배부 현황 
*  5. Program Desc         : 
*  6. Comproxy List        :
...
Const BIZ_PGM_ID      = "ge004mb1.asp"						           '☆: Biz Logic ASP Name
...
'--------------------------------------------------------------------------------------------------------
Dim C_center1                                                    'Column Dimant for Spread Sheet 
Dim C_centerNm1   															
Dim C_data1       
...
Sub InitSpreadSheet()
	...
	With Frm1.vspdData
       ...
       ggoSpread.SSSetEdit  C_center     , "품목그룹"        ,15,   ,, 25,2
       ggoSpread.SSSetEdit  C_centerNm   , "품목그룹명"     ,20,   ,, 30    
       ggoSpread.SSSetFloat C_data       , "금       액"          ,15,    Parent.ggAmtOfMoneyNo ,ggStrIntegeralPart, ggStrDeciPointPart,Parent.gComNum1000,Parent.gComNumDec
...
Sub InitSpreadSheet1()
	...
	With Frm1.vspdData1
       ...
       ggoSpread.SSSetEdit  C_center1     , "품   목"         ,15,   ,, 25,2
       ggoSpread.SSSetEdit  C_centerNm1   , "품 목 명"       ,20,   ,, 80    
       ggoSpread.SSSetFloat C_data1       , "금       액"      ,15,    Parent.ggAmtOfMoneyNo ,ggStrIntegeralPart, ggStrDeciPointPart,Parent.gComNum1000,Parent.gComNumDec       
...
Function initMinor()
	...
	Dim intRetCD   	  
	'intRetCD = CommonQueryRs(" bm.minor_Cd, bm.minor_nm "," g_option go,b_minor bm","go.minor_Cd = bm.minor_cd and  go.major_cd ='g1012' and  bm.major_cd = go.major_cd" ,lgF0,lgF1,lgF2,lgF3,lgF4,lgF5,lgF6)
	intRetCD = False
	if intRetCd = False then
		Call CommonQueryRs(" bm.minor_Cd, bm.minor_nm ","b_minor bm"," bm.major_cd = " & FilterVar("g1012", "''", "S") & " and  bm.minor_cd = " & FilterVar("2", "''", "S") & "" ,lgF0,lgF1,lgF2,lgF3,lgF4,lgF5,lgF6)
     ...
     With Frm1
          If .vspdData1.ActiveRow > 0 Then
             .vspdData1.ReDraw = False
              ...
              ggoSpread.Source = .vspdData1	
              ggoSpread.CopyRow
              SetSpread2Color   .vspdData1.ActiveRow, .vspdData1.ActiveRow
	'------ Developer Coding part (Start ) -------------------------------------------------------------- 
...
Sub vspdData1_Change( Col ,  Row)
    ...
    Select Case Col
         Case  C_MinorTypeNm
                 ...
                 Frm1.vspdData1.Col   = C_MinorTypeCd
					...
					<TD CLASS="CLSMTABP">
						<TABLE ID="MyTab" CELLSPACING=0 CELLPADDING=0>
							<TR>
								...
								<td background="../../../CShared/image/table/seltab_up_bg.gif" align="center" CLASS="CLSMTABP"><font color=white>품목별 배부현황</font></td>
						...
						<FIELDSET CLASS="CLSFLD">
							<TABLE <%=LR_SPACE_TYPE_40%>>
								<TR>
									...
									<TD CLASS="TD6" NOWRAP>
										<script language =javascript src='./js/ge004ma1_fpDateTime3_fpdtWk_yymm.js'></script>										
									</TD>									
							...
							<TR>
								<TD WIDTH="50%">
									<TABLE  <%=LR_SPACE_TYPE_20%> CLASS="BasicTB" CELLSPACING=0>
										<TR>
										<TD  COLSPAN=3>
											<script language =javascript src='./js/ge004ma1_vaSpread1_vspdData.js'></script>
										</TD>
										</TR>
										<TR HEIGHT=20>
								            ...
								            <TD CLASS=TD6 NOWRAP>
									            <script language =javascript src='./js/ge004ma1_txtDataAmt_txtDataAmt.js'></script>
											</TD>
										</TR>
									</TABLE>
								</TD>
								<TD WIDTH="50%">
									<TABLE  <%=LR_SPACE_TYPE_20%> CLASS="BasicTB" CELLSPACING=0>
										<TR>
											<TD COLSPAN=3>
												<script language =javascript src='./js/ge004ma1_vaSpread2_vspdData1.js'></script>
											</TD>
										</TR>
										<TR HEIGHT=20>
										    <TD CLASS=TD6 NOWRAP>&nbsp;</TD>										    
											<TD CLASS=TD5 NOWRAP>합계</TD>								            
											<TD CLASS="TD6" >
												<script language =javascript src='./js/ge004ma1_txtDataAmt1_txtDataAmt1.js'></script></TD>			    	    		            			    	    		            
										</TR>										
									</TABLE>
								</TD>
							</TR>
