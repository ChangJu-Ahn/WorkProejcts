...
Sub SubBizQueryMulti()
  ...
  If Trim(lgKeyStream(3)) <> "" Then
       ...
       Call CommonQueryRs("sales_grp_nm","b_sales_grp","sales_grp = " & FilterVar(lgKeyStream(3), "''", "S"),lgF0,lgF1,lgF2,lgF3,lgF4,lgF5,lgF6)
       if Trim(Replace(lgF0,Chr(11),"")) = "X" then
	       txtCost= ""
	    else
...
Sub bulk_disposal()
    ...
    strWhere = FilterVar(prevStartDate, "''", "S")
    ...
    If Currency_code = "3" Then
        ...
        Call CommonQueryRs("count(*)","g_alloc_Base","yyyymm =" & FilterVar(lgKeyStream(0), "''", "S") & " and alloc_kinds = " & FilterVar("4", "''", "S") & " and from_alloc <>" & FilterVar("*", "''", "S") & "  and acct_gp <>" & FilterVar("*", "''", "S") & " ",lgF0,lgF1,lgF2,lgF3,lgF4,lgF5,lgF6)
    ...
    Select Case Mid(pDataType,1,1)
        ...
        Case "M"
           ...
           Select Case Mid(pDataType,2,1)
               ...
               Case "R"
                       lgStrSQL = "Select Top " &iSelCount& " gab.from_alloc, bcc.sales_grp_nm,gab.acct_gp, a.gp_nm, gab.acct_cd, ac.acct_nm,bm.minor_nm, bm.minor_cd,gab.alloc_rate"
                       lgStrSQL = lgStrSQL & " From  g_alloc_base  gab,b_sales_grp bcc,a_acct ac,b_minor bm, a_acct_gp a"
                       lgStrSQL = lgStrSQL & " WHERE gab.from_alloc *= bcc.sales_grp"
                       ...
                       lgStrSQL = lgStrSQL & "  and gab.alloc_kinds = " & FilterVar("4", "''", "S") & ""
