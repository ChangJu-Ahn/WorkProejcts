...
'========================================================================================================
Const BIZ_PGM_ID = "C3001MB1.asp"                                      'Biz Logic ASP 
'========================================================================================================
'=                       4.2 Global 변수/상수 선언 
'========================================================================================================
...
Sub MakeKeyStream(pOpt)
   ...
   Select Case pOpt
       Case "MQ"
                  lgKeyStream = Frm1.CboCostType.Value  & Parent.gColSep     'You Must append one character(Parent.gColSep)
       Case "MN"
                  lgKeyStream = Frm1.hCboCostType.Value & Parent.gColSep       'You Must append one character(Parent.gColSep)
   End Select                 
...
Sub InitComboBox()
    ...
    Call CommonQueryRs(" MINOR_CD,MINOR_NM "," B_MINOR ", _
                         " MAJOR_CD = " & FilterVar("C4020", "''", "S") & " ",lgF0,lgF1,lgF2,lgF3,lgF4,lgF5,lgF6)
						...
						<FIELDSET CLASS="CLSFLD">
							<TABLE <%=LR_SPACE_TYPE_40%>>
								<TR>
									...
									<TD CLASS="TD656"><SELECT ID="cboCostType" NAME="cboCostType" ALT="원가종류" tag="12X" STYLE="WIDTH:82px:"></SELECT></TD>
									</TD>
								</TR>               
							</TABLE>
						</FIELDSET>
