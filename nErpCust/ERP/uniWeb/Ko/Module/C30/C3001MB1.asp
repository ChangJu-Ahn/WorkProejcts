...
Sub SubBizQueryMulti()
	...
	Set iPC4G010Q = Server.CreateObject("PC4G010.cCListCoConfgSvr")
	...
	Call iPC4G010Q.C_LIST_COST_CONFG_SVR(gStrGloBalCollection, lgMaxCount,importArray, exportData, exportData1,iStrPrevKey)
    
    If CheckSYSTEMError(Err, True) = True Then					
         Set iPC4G010Q = Nothing
         Call SetErrorStatus
       Exit Sub
    End If    
...
Sub SubBizSaveMulti()
    ...
    IF Trim(Request("CboCostType")) = "C1100" Then
		importArray(1)		= "STD"
	Else
		importArray(1)		= "ACTL"
	End if 
    ...
    Set iPC4G010S = Server.CreateObject("PC4G010.cCMngCoConfgSvr")
    ...
    Call iPC4G010S.C_MANAGE_COST_CONFG_SVR(gStrGloBalCollection, importArray, txtSpread)		
		
    If CheckSYSTEMError(Err, True) = True Then					
       Set iPC4G010S = Nothing
       SetErrorStatus()
       Exit Sub
    End If    
