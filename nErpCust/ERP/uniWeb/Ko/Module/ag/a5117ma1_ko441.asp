...
Sub InitSpreadSheet()
	...
	With frm1.vspdData
		...
		ggoSpread.SSSetEdit    C_GL_NO                ,"회계번호"	,15    ,0                  ,     ,100     ,2
		ggoSpread.SSSetEdit    C_GL_INSRT_ID          ,"승인자"	    ,7    ,0                  ,     ,100     ,2
...
'	arrParam(1) = ""			      
    ...
    iCalledAspName = AskPRAspName("a5130ra1_ko441")    
...
'	arrParam(1) = ""			      
    ...
    iCalledAspName = AskPRAspName("a5120ra1_ko441")    
	arrRet = window.showModalDialog(iCalledAspName, Array(window.parent, arrParam), _
		     "dialogWidth=780px; dialogHeight=450px; center: Yes; help: No; resizable: No; status: No;")
