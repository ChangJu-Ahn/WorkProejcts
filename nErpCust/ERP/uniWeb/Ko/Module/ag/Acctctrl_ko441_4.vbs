...
'		.vspdData2.AutoClipboard	= False
		...
		.vspdData2.MaxCols			= C_HItemSeq2 + 1
		...
		'20090922 kbs
		ggoSpread.SSSetEdit		C_HItemSeq2,     "H",				1
	...
	'20090922 kbs 임시로 코맨트 처리
	'	Call ggoSpread.SSSetColHidden(C_HItemSeq,C_HItemSeq,True)
	'	Call ggoSpread.SSSetColHidden(C_HItemSeq2,C_HItemSeq2,True)
...
'	  	arrHeader(1) = "관리항목 VALUE명"		
'	ElseIf strFld1 = "COST_CD" Then	
'	  	msgbox frm1.vspddata.activerow
 '               msgbox frm1.vspddata.activecol
'		arrParam(0) = "관리항목 VALUE 팝업"						' 팝업 명칭 
'	  	arrParam(1) = "B_ACCT_DEPT A, B_COST_CENTER B "	    	' TABLE 명칭 
'	  	arrParam(2) = strCode						' Code Condition
'	  	arrParam(3) = ""							' Name Cindition
	...
	Select Case Col
		...
		'----------------------------------
	        ...
	        If Trim(frm1.vspdData2.Text) = "D" Then
				...
				if LEN(frm1.vspdData2.Text) = 8 then
					frm1.vspdData2.Text = Mid(frm1.vspdData2.Text,1,4) & "-" & Mid(frm1.vspdData2.Text,5,2) + "-" + Mid(frm1.vspdData2.Text,7,2) 
				End if 
