...
'Call ServerMesgBox(lgStrPrevKey , vbInformation, I_MKSCRIPT)
	...
	lgStrSQL = ""
	lgStrSQL = lgStrSQL & " SELECT   TOP " & iSelCount & "SEQ,TEMP_GL_DT,   "
	lgStrSQL = lgStrSQL & " 		 BIZ_AREA_CD,      "
	lgStrSQL = lgStrSQL & "          BIZ_AREA_NM,      "
	lgStrSQL = lgStrSQL & " 		 TEMP_GL_NO,       "
	lgStrSQL = lgStrSQL & " 		 ACCT_CD,          "
	lgStrSQL = lgStrSQL & " 		 ACCT_NM,          "
	lgStrSQL = lgStrSQL & " 		 DR_ITEM_LOC_AMT,  "
	lgStrSQL = lgStrSQL & " 		 CR_ITEM_LOC_AMT,  "
	lgStrSQL = lgStrSQL & " 		 TEMP_GL_DESC,     "
	lgStrSQL = lgStrSQL & " 		 GL_INPUT_TYPE,    "
	lgStrSQL = lgStrSQL & "          GL_INPUT_TYPE_NM, "
	lgStrSQL = lgStrSQL & " 		 DEPT_CD,          "
	lgStrSQL = lgStrSQL & " 		 DEPT_NM,          "
	lgStrSQL = lgStrSQL & " 		 COST_CD,          "
	lgStrSQL = lgStrSQL & " 		 COST_NM,          "		
