...
Sub SubBizQueryMulti()
	...
	Set PAGG0015_cAListTmpGlSvr = Server.CreateObject("PAGG015_ko441.cAListTmpGlSvr")
			    ...
			    If  iIntLoopCount < (C_SHEETMAXROWS + 1) Then
					...
					For iLngCol = 0 To UBound(EG1_export_grp_temp_gl, 2)
						If iLngCol = A051_EG1_E2_temp_gl_dt  Then '1
						       'iStrData = iStrData & Chr(11) & EG1_export_grp_temp_gl(iLngRow, 11) 
						       iStrData = iStrData & Chr(11) & replace(EG1_export_grp_temp_gl(iLngRow, 11) ,"승인","결재")
							iStrData = iStrData & Chr(11) & EG1_export_grp_temp_gl(iLngRow, 10)
						...
						elseif cint(iLngCol) =10 or cint(iLngCol) =11  then
							'iStrData = iStrData & Chr(11) & EG1_export_grp_temp_gl(iLngRow, 10) 
