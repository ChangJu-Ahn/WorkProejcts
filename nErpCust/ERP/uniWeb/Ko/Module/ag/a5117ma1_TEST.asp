...
'========================================================================================================
Const BIZ_PGM_ID = "A5117MB1_TEST.asp"                                      'Biz Logic ASP 
'========================================================================================================
...
Sub GetSpreadColumnPos(ByVal pvSpdNo)
    ...
    Select Case UCase(pvSpdNo)
       Case "A"
			...
			C_DR_ITEM_LOC_AMT   = iCurColumnPos(8)
			c_CR_ITEM_LOC_AMT   = iCurColumnPos(9)
			...
			C_DEPT_NM			= iCurColumnPos(14)
			C_COST_CD			= iCurColumnPos(15)
			C_COST_NM			= iCurColumnPos(16)			
			C_ITEM_SEQ			= iCurColumnPos(17)					          
							...
							<TABLE  <%=LR_SPACE_TYPE_40%>>
								...
								<TR>
								 ...
								 <TR>
									...
									<TD CLASS=TD6 NOWRAP> <INPUT NAME="txtUsr_ID" MAXLENGTH="12" SIZE=12 ALT ="작성자" tag="11XXXU"><IMG SRC="../../../CShared/image/btnPopup.gif" NAME="btn" ALIGN=top TYPE="BUTTON" ONCLICK="Call OpenPopup(frm1.txtUsr_ID.value, 4)">
