...
'--------------- 개발자 coding part(변수선언,Start)--------------------------------------------------------
	...
	Dim lgFlag
	Dim bAbNomal
	Dim lgtxtGlInputType, lgtxtMaxRows
...
Sub TrimData()
	...
	lgtxtTransDt		= UNIConvDate( Request("txtTransDt"))
	...
	lgtxtGlInputType	= FilterVar(Trim(Request("txtGlInputType")),"","S")
	...
	strSql  =  " AND  TRANS_DT =   " & FilterVar(lgtxtTransDt , "''", "S") & ""
	strSql2 = " AND  B.GL_DT =  " & FilterVar(lgtxtTransDt , "''", "S") & ""
	...
	strSqlTemp  = strSqlTemp & " AND GL_INPUT_TYPE =  " & FilterVar(lgtxtGlInputType , "''", "S") & " "
	...
	strSql2 = strSql2 & "  AND DBO.UFN_A_GETTRANSTYPE(A.BATCH_NO, A.BIZ_AREA_CD)= " & FilterVar(lgtxtTransType, "''", "S") & " "
	strSql2 = strSql2 & "  AND A.BIZ_AREA_CD  =  " & FilterVar(lgtxtBizArea , "''", "S") & " "
'	strSql2 = strSql2 &  " AND GL_INPUT_TYPE = '"& lgtxtGlInputType & "' "
...
Sub FixUNISQLData()
	...
	IF  bAbNomal = "Y"  Then
	    UNISqlId(0) = "A5340MA104"
	else
	    UNISqlId(0) = "A5340MA103"
	end if
