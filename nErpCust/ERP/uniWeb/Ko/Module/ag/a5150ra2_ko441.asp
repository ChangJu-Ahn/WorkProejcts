...
Const BIZ_PGM_ID 		= "a5150rb2_ko441.asp"                              '☆: Biz Logic ASP Name

'========================================================================================================
'=                       4.2 Constant variables 
'========================================================================================================
Const C_SHEETMAXROWS_D  = 30                                          '☆: Server에서 한번에 fetch할 최대 데이타 건수
Const C_MaxKey          = 29					                      '☆: SpreadSheet의 키의 갯수
...
'air	If  arrParam(8) <> "" Then				
'air		Call ggoOper.SetReqAttr(txtDocCur,   "Q")		
'air	Else		
'air		Call ggoOper.SetReqAttr(txtDocCur,   "N")		
'air	End If	
...
Sub InitSpreadSheet()
    ...
    Call SetZAdoSpreadSheet("a5150RA2KO441","S","A","V20030220",PopupParent.C_SORT_DBAGENT,vspdData, C_MaxKey, "X","X")
    Call SetSpreadLock() 
End Sub
