...
======================================================================================================
*  1. Module Name          : 회계 
*  2. Function Name        : a5150ra1.asp
*  3. Program ID           : 
*  4. Program Name         : 멀티반제팝업
*  5. Program Desc         : 
*  6. Comproxy List        :
*  7. Modified date(First) : 2006/10/19
...
Const BIZ_PGM_ID 		= "a5150rb1.asp"                              '☆: Biz Logic ASP Name
...
Sub InitSpreadSheet()
    ...
    Call SetZAdoSpreadSheet("a5150RA1","S","A","V20081211",PopupParent.C_SORT_DBAGENT,frm1.vspdData, C_MaxKey, "X","X")
    Call SetSpreadLock() 
End Sub
			...
			<FIELDSET CLASS="CLSFLD">
				<TABLE <%=LR_SPACE_TYPE_40%>>
					<TR>				
						...
						<TD CLASS=TD6 NOWRAP>
						<INPUT TYPE="Text" NAME="txtFrAllcNo" SIZE=15 MAXLENGTH=18 STYLE="TEXT-ALIGN: Left" tag="1XXXXU" ALT="입금번호">&nbsp;~&nbsp;
						<INPUT TYPE="Text" NAME="txtToAllcNo" SIZE=15 MAXLENGTH=18 STYLE="TEXT-ALIGN: Left" tag="1XXXXU" ALT="입금번호">
						</TD>
					</TR>
					<TR>				
