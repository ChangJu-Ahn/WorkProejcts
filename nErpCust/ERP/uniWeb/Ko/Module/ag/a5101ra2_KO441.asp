...
<!-- '--eWare Inf End -->
					...
					<TR>
						...
						<TD CLASS=TD6 NOWRAP><INPUT NAME="txtUsrId"   ALT="작성자"   Size="12" MAXLENGTH="10" STYLE="TEXT-ALIGN: left" tag   ="14XXXU"><IMG SRC="../../../CShared/image/btnPopup.gif" NAME="btn" ALIGN=top TYPE="BUTTON" ONCLICK="vbscript:Call OpenPopUp('4')">
