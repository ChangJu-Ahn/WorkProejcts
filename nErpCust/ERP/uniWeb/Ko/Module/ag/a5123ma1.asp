...
'**********************************************************************************************************
Const BIZ_PGM_ID1 = "a5123mb1.asp"												'☆: 비지니스 로직 ASP명 
Const BIZ_PGM_ID2 = "a5123mb2.asp"												'☆: 비지니스 로직 ASP명 
'==========================================================================================================
...
Sub InitSpreadSheet()
    ...
    ggoSpread.SSSetEdit C_TEMP_Gl_FG     , "", 2,,,2
					...
					<TD CLASS="CLSMTABP">
						<TABLE ID="MyTab" CELLSPACING=0 CELLPADDING=0>
							<TR>
								...
								<td background="../../../CShared/image/table/seltab_up_bg.gif" align="center" CLASS="CLSMTAB"><font color=white>회계전표일괄생성</font></td>
						...
						<FIELDSET CLASS="CLSFLD">
							<TABLE <%=LR_SPACE_TYPE_40%>>
								<TR>
									...
									<TD CLASS="TD6"NOWRAP>
										<script language =javascript src='./js/a5123ma1_fpDateTime1_txtFromReqDt.js'></script>
~ 
										<script language =javascript src='./js/a5123ma1_fpDateTime2_txtToReqDt.js'></script>										
									</TD>
									<TD CLASS="TD5"NOWRAP>전표입력경로</TD>
									<TD CLASS="TD6"NOWRAP><INPUT CLASS="clstxt" TYPE=TEXT NAME="txtGlInputType" SIZE=10  MAXLENGTH=10 tag="11XXXU" ALT="부서"><IMG SRC="../../../CShared/image/btnPopup.gif" NAME="btnDeptCd" align=top TYPE="BUTTON" ONCLICK="vbscript:Call OpenPopUp(frm1.txtGlInputType.Value, 0)">
										 <INPUT TYPE=TEXT ID="txtGlInputTypeNm" NAME="txtGlInputTypeNm" SIZE=20 tag="14X" ALT="부서명">
									</TD>
						
								</TR>
								<TR>
									<TD CLASS="TD5"NOWRAP>사업장</TD>
									<TD CLASS="TD6"NOWRAP><INPUT ClASS="clstxt" TYPE=TEXT NAME="txtBizCd" SIZE=10 MAXLENGTH=10 tag="11XXXU" ALT="거래처"><IMG SRC="../../../CShared/image/btnPopup.gif" NAME="btnBizCd" align=top TYPE="BUTTON" ONCLICK="vbscript:Call OpenPopup(frm1.txtBizCd.Value, 1)">
										 <INPUT TYPE=TEXT ID="txtBizNm" NAME="txtBizNm" SIZE=20 tag="14X" ALT="거래처명">
									</TD>
									<TD CLASS="TD5"NOWRAP>승인상태</TD>
									<TD CLASS="TD6"NOWRAP><SELECT NAME="cboConfFg" tag="12" STYLE="WIDTH:82px:" Alt="승인상태"><OPTION VALUE="" selected></OPTION></SELECT>
								</TR>
								<TR>
									<TD CLASS="TD5"NOWRAP>거래처</TD>
									<TD CLASS="TD6"NOWRAP><INPUT ClASS="clstxt" TYPE=TEXT NAME="txtBpCd" SIZE=10 MAXLENGTH=10 tag="11XXXU" ALT="거래처"><IMG SRC="../../../CShared/image/btnPopup.gif" NAME="btnBizCd" align=top TYPE="BUTTON" ONCLICK="vbscript:Call OpenBp(frm1.txtBpCd.Value, 2)">
				...
				<TR>
					<TD WIDTH=100% HEIGHT=* valign=top>
						<TABLE <%=LR_SPACE_TYPE_20%>>				
							<TR>
								<TD HEIGHT="100%"><script language =javascript src='./js/a5123ma1_vaSpread1_vspdData.js'></script>
								</TD>
							</TR>							
						</TABLE>
					</TD>
...
<script language =javascript src='./js/a5123ma1_fpDateTime1_hFromReqDt.js'></script>
<script language =javascript src='./js/a5123ma1_fpDateTime2_hToReqDt.js'></script>										
</FORM>
