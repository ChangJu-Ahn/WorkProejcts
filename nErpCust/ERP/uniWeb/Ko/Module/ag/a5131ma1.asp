...
'*  4. Program Name         : 전표관리번호조회 
'*  5. Program Desc         : 
'*  6. Component List       : 
'*  7. Modified date(First) : 2006/11/13
...
Sub InitSpreadSheet()
    ...
    Call SetZAdoSpreadSheet("A5131MA1", "S", "A", "V20021108", parent.C_SORT_DBAGENT, frm1.vspdData, C_MaxKey, "X", "X")
    Call SetSpreadLock()      
...
Function DbQuery() 
    ...
    '--------- Developer Coding Part (Start) ----------------------------------------------------------
		...
		'	strVal = strVal & "&lgStrPreglno=" & lgStrPreglno		
			...
			If .Rb_WK1.checked = True Then
				strVal = strVal & "&txtGLMgmtRadio=" & "1"
			Elseif .Rb_WK2.checked = True Then
				strVal = strVal & "&txtGLMgmtRadio=" & "2"
			Elseif .Rb_WK3.checked = True Then				
				strVal = strVal & "&txtGLMgmtRadio=" & "3"
			End If        
        Else
            strVal = strVal & "?txtMode=" & parent.UID_M0001	
		...
		'	strVal = strVal & "&lgStrPreglno=" & lgStrPreglno		
			...
			strVal = strVal & "&txtGLMgmtRadio=" & .htxtMgmtRadio.VALUE
        End If   
							...
							<TABLE <%=LR_SPACE_TYPE_40%>>
								...
								<TR>
								 ...
								 <TR>
									...
									<TD CLASS=TD5 NOWRAP>전표관리번호</TD>
									<TD CLASS=TD6><INPUT TYPE="RADIO" CLASS="Radio" NAME=Radio1 ID=Rb_WK1 Checked><LABEL FOR=Rb_WK1>전체</LABEL>&nbsp;&nbsp;&nbsp;<INPUT TYPE="RADIO" CLASS="Radio" NAME=RADIO1 ID=Rb_WK2><LABEL FOR=Rb_WK2>채번</LABEL>&nbsp;&nbsp;&nbsp;<INPUT TYPE="RADIO" CLASS="Radio" NAME=RADIO1 ID=Rb_WK3><LABEL FOR=Rb_WK2>미채번</LABEL></TD>				
								 </TR>
							</TABLE>
						</FIELDSET>
					</TD>
...
<INPUT TYPE=HIDDEN NAME="htxtMgmtRadio" tag="24" TABINDEX="-1">
</FORM>
