...
'*  2. Function Name        : 
'*  3. Program ID           : a5119ma1
'*  4. Program Name         : 결의전표집계목록출력 
'*  5. Program Desc         : 결의전표집계목록출력 
'*  6. Component List       : 
...
Sub SetPrintCond(StrEbrFile, StrUrl)
    ...
    Dim VarDateFr, VarDateTo, VarDeptCd, VarBizAreaCd, VarBizAreaCd1, VarTempGlNoFr, VarTempGlNoTo, VarConfFG
	...
	If Trim(frm1.cboConfFg.value)     <> "" Then VarConfFG     = UCase(Trim(frm1.cboConfFg.value))	
	...
	StrUrl = StrUrl & "|ConfFG|"		& VarConfFG
						...
						<TABLE <%=LR_SPACE_TYPE_60%>>
							<TR>
								...
								<TD CLASS="TD6" NOWRAP><SCRIPT LANGUAGE=JavaScript> ExternalWrite('<OBJECT CLASSID=<%=gCLSIDFPDT%> NAME="txtDateFr" CLASS=FPDTYYYYMMDD tag="12X1" Title="FPDATETIME" ALT="시작결의일자" id=fpDateTime1></OBJECT>');</SCRIPT>&nbsp;~&nbsp;
													   <SCRIPT LANGUAGE=JavaScript> ExternalWrite('<OBJECT CLASSID=<%=gCLSIDFPDT%> NAME="txtDateTo" CLASS=FPDTYYYYMMDD tag="12X1" Title="FPDATETIME" ALT="종료결의일자" id=fpDateTime2></OBJECT>');</SCRIPT></TD>
							</TR>
							<TR>
							...
							<TR>
								...
								<TD CLASS="TD6" NOWRAP><INPUT TYPE="Text" NAME="txtTempGlNoFr" SIZE=25 MAXLENGTH=18 tag="11XXXU" ALT="시작결의번호" STYLE="TEXT-ALIGN:left"><IMG SRC="../../../CShared/image/btnPopup.gif" NAME="btnTempGlNoFr" ALIGN=top TYPE="BUTTON" ONCLICK="vbscript:Call OpenRefTempGl(0)">&nbsp;~&nbsp;</TD>
							</TR>
							<TR>
								<TD CLASS="TD5" NOWRAP></TD>
								<TD CLASS="TD6" NOWRAP><INPUT TYPE="Text" NAME="txtTempGlNoTo" SIZE=25 MAXLENGTH=18 tag="11XXXU" ALT="종료결의번호" STYLE="TEXT-ALIGN:left"><IMG SRC="../../../CShared/image/btnPopup.gif" NAME="btnTempGlNoTo" ALIGN=top TYPE="BUTTON" ONCLICK="vbscript:Call OpenRefTempGl(1)"></TD>
								</TD>
							</TR>
							<TR>
								<TD CLASS="TD5" NOWRAP>승인상태</TD>
								<TD CLASS="TD6" NOWRAP><SELECT NAME="cboConfFg" tag="11X" STYLE="WIDTH:120px:" ALT="승인상태"><OPTION VALUE="" selected></OPTION></SELECT></TD>
							</TR>
						</TABLE>
					</TD>
				</TR>
