...
Sub InitSpreadSheet()
	...
	With frm1.vspdData	
        .MaxCols = C_USER + 1										'☜: 최대 Columns의 항상 1개 증가시킴 
        ...
        ggoSpread.SSSetEdit  C_Conf_Fg,      "최종승인여부",   15, ,,15
        ...
        ggoSpread.SSSetEdit	 C_USER,		 "최종승인자",   10,,,10
...
Sub SetSpreadLock()
    With frm1
        ...
        ggoSpread.SpreadLock		C_RefNo			, -1	,C_USER
...
Sub GetSpreadColumnPos(ByVal pvSpdNo)
    ...
    Select Case UCase(pvSpdNo)
       Case "A"
            ...
            C_TempGlDt     = iCurColumnPos(4)
            C_GlDt         = iCurColumnPos(5)
            C_TempGlNo     = iCurColumnPos(6)
            C_DeptNm       = iCurColumnPos(7)
            C_Currency     = iCurColumnPos(8)
            C_TempGlAmt    = iCurColumnPos(9)
            C_TempGlLocAmt = iCurColumnPos(10)
            C_GlNo         = iCurColumnPos(11)
            C_TempGlDesc   = iCurColumnPos(12)
            C_RefNo		   = iCurColumnPos(13)
            C_USER		   = iCurColumnPos(14)
