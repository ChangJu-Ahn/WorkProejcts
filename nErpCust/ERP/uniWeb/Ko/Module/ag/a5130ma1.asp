...
'=======================================================================================================
'@PGM_ID
Const BIZ_PGM_ID = "a5130mb1.asp"													'조회 비지니스 로직 ASP명 
...
Sub InitSpreadSheet()
	...
	With frm1.vspdData
	   ...
	   .ReDraw = True
		...
		ggoSpread.SSSetEdit  C_YYYYMM ,			"전표년월"    ,12, 2		
		ggoSpread.SSSetEdit  C_STATUS   ,       ""                , 2, 0
		ggoSpread.SSSetEdit  C_STATUS_NM,       "채번상태"    ,10, 2		
		ggoSpread.SSSetEdit  C_AUTO_NO_TYPE,    "채번유형"    ,10, 2		
		ggoSpread.SSSetEdit  C_DATE_INFO ,      "날짜형식"    ,10, 2
		ggoSpread.SSSetEdit  C_AUTO_NO ,        "최종채번번호",15, 2
		ggoSpread.SSSetDate  C_WORKING_DT ,     "최종작업일"  ,12, 2, parent.gDateFormat  			
		ggoSpread.SSSetEdit  C_WORKING_ID ,		"최종작업자"  ,15, 2	
		ggoSpread.SSSetCheck C_RUN,             "채번실행"    ,10, ,"",True
		ggoSpread.SSSetCheck C_CANCEL,          "채번취소"    ,10, ,"",True
...
Sub SetSpreadLock()
	With frm1
		...
		ggoSpread.SpreadLock C_YYYYMM, -1, C_CANCEL ,-1
...
Sub SetSpreadColor()
	...
	With frm1
		...
		For ii = 1 To .vspdData.Maxrows
			...
			If Ucase(Trim(.vspdData.text)) = "1" Or Ucase(Trim(.vspdData.text)) = "3" Then
				ggoSpread.SpreadLock C_RUN,ii,C_RUN,ii
				.vspddata.Col = C_RUN
				.vspdData.text = "0"
				...
				.vspdData.text = "0"					
			Else
				ggoSpread.SpreadUnLock C_RUN,ii,C_RUN,ii
				.vspddata.Col = C_RUN
				.vspdData.text = "0"
...
Sub GetSpreadColumnPos()
	...
	C_STATUS_NM    = iCurColumnPos(3)
	C_AUTO_NO_TYPE = iCurColumnPos(4)
	C_DATE_INFO    = iCurColumnPos(5)
	C_AUTO_NO      = iCurColumnPos(6)
	C_WORKING_DT   = iCurColumnPos(7)
	C_WORKING_ID   = iCurColumnPos(8)
	C_RUN          = iCurColumnPos(9)
	C_CANCEL       = iCurColumnPos(10)
...
Function DbQuery() 
	...
	With frm1
		If Trim(.txtYear.Text) <> "" Then
			Call ExtractDateFrom(.txtYear.Text,parent.gDateFormatYYYYMM,parent.gComDateType,strYear,strMonth,strDay) 
		Else
			strYear = ""
		End If	
	End With
					...
					<TD HEIGHT=20 WIDTH="100%">
						<FIELDSET CLASS="CLSFLD">
							<TABLE <%=LR_SPACE_TYPE_40%>>
								<TR>
									<TD CLASS="TD5" NOWRAP>전표년도</TD>
									<TD CLASS="TD6" NOWRAP><SCRIPT LANGUAGE=JavaScript> ExternalWrite('<OBJECT CLASSID=<%=gCLSIDFPDT%> NAME="txtYear" CLASS=FPDTYYYY tag="11" Title="FPDATETIME" ALT="전표년도" id=fpYear></OBJECT>');</SCRIPT></TD>
...
<iframe name="MouseWindow" FRAMEBORDER=0 SCROLLING=NO noresize framespacing=0 width=350 height=41 src="../../inc/cursor.htm"></iframe>
</DIV>
</BODY>
</HTML>
