...
'**********************************************************************************************************
Const BIZ_PGM_ID        = "a5101rb1_ko441.asp"
...
Sub SetDefaultVal()
	...
	'frm1.txtUsrId.value = PopupParent.gUsrId
	'frm1.txtUsrNm.value = PopupParent.gUsrNm
End Sub
...
Function OpenPopUp(Byval iwhere)
	...
	Select Case iwhere	
		...
		Case 4
			If UCase(frm1.txtUsrId.className) = UCase(PopupParent.UCN_PROTECTED) Then Exit Function		
...
Sub InitSpreadSheet()    
	...
	Call SetZAdoSpreadSheet("A5101RA1", "S", "A", "V20081011", PopupParent.C_SORT_DBAGENT, frm1.vspdData, C_MaxKey, "X", "X")
	Call SetSpreadLock()          
End Sub
...
<!-- '--eWare Inf End -->
					...
					<TR>
						...
						<TD CLASS=TD6 NOWRAP><INPUT NAME="txtUsrId"   ALT="작성자"   Size="12" MAXLENGTH="10" STYLE="TEXT-ALIGN: left" tag   ="11XXXU"><IMG SRC="../../../CShared/image/btnPopup.gif" NAME="btn" ALIGN=top TYPE="BUTTON" ONCLICK="vbscript:Call OpenPopUp('4')">
