...
Const BIZ_PGM_ID  = "a5150mb1.asp"												'☆: 비지니스 로직 ASP명
...
Function OpenRefOpenNo()
	...
	iCalledAspName = AskPRAspName("a5150ra2")
	
	If Trim(iCalledAspName) = "" Then
		IntRetCD = DisplayMsgBox("900040", parent.VB_INFORMATION, "a5150ra2", "X")
		IsOpenPop = False
		Exit Function
	End If
					...
					<TD WIDTH="100%">
						<TABLE <%=LR_SPACE_TYPE_60%>>
							...
							<TR>
								...
								<TD CLASS=TD6 NOWRAP COLSPAN=3><INPUT TYPE=TEXT NAME="txtDesc" SIZE=76 MAXLENGTH=256 tag="21XXX" ALT="비고"></TD>								
							</TR>							
						</TABLE>
					</TD>
				</TR>		
