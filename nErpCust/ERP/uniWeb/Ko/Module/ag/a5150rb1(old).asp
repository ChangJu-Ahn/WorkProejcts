...
Sub  TrimData()
	...
	strCond = strCond & " where A.ALLC_DT >=  " & FilterVar(strFrAllcDt , "''", "S") & ""
	...
	strCond = strCond & " and ((isnull(a.temp_gl_no,'') = '' and isnull(a.gl_no,'') <> '') or (isnull(a.temp_gl_no,'') <> '' and isnull(a.gl_no,'') = '') or (isnull(a.temp_gl_no,'') <> '' and isnull(a.gl_no,'') = '') ) " 
...
<Script Language=vbscript>
    If "<%=lgDataExist%>" = "Yes" Then
       ...
       If "<%=lgPageNo%>" = "1" Then   ' "1" means that this query is first and next data exists
			Parent.Frm1.htxtFrAllcDt.Value  = "<%=strFrAllcDt%>"
			Parent.Frm1.htxtToAllcDt.Value  = "<%=strToAllcDt%>"
			Parent.Frm1.htxtFrAllcNo.Value	= "<%=strFrAllcNo%>"
			Parent.Frm1.htxtToAllcNo.Value	= "<%=strToAllcNo%>"
			Parent.Frm1.htxtdeptcd.Value	= "<%=strdeptcd%>"
       End If
       ...
       'Show multi spreadsheet data from this line
		...
		Call Parent.ReFormatSpreadCellByCellByCurrency2(Parent.Frm1.vspdData,<%=iPrevEndRow+1%>,<%=iEndRow%>,"<%=gCurrency%>",Parent.GetKeyPos("A",2),"A", "Q" ,"X","X")
		Call Parent.ReFormatSpreadCellByCellByCurrency2(Parent.Frm1.vspdData,<%=iPrevEndRow+1%>,<%=iEndRow%>,"<%=gCurrency%>",Parent.GetKeyPos("A",3),"A", "Q" ,"X","X")
