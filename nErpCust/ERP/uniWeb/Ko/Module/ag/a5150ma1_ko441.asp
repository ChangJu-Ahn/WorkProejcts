	...
	With frm1
		...
		For I = TempRow To TempRow + Ubound(arrRet, 1)
			...
			For x = 1 To TempRow
				...
				If UCase(Trim(iOpenNo)) = UCase(Trim(arrRet(I - TempRow, 18)))  And  Trim(iGLSeq) = Trim(arrRet(I - TempRow, 26))  Then
					sFindFg	= "Y"
				End If
			Next
			...
			If 	sFindFg	= "N" Then
				...
				.vspddata4.text = arrRet(I - TempRow,11)
				...
				.vspddata4.text = arrRet(I - TempRow,25)
				...
				.vspddata4.text = arrRet(I - TempRow,27)
		...
		If arrRet(0, 8) <> parent.gCurrency Then
			.hDocCur.Value = arrRet(0, 12)
			.txtDocCur.Value = arrRet(0, 12)
			.hDocCur2.value = arrRet(0, 12)
