...
'========================================================================================================
Const BIZ_PGM_ID			= "a5101mb1_ko441.asp"
...
Function OpenReftempgl()
	...
	If Trim(iCalledAspName) = "" Then
		IntRetCD = DisplayMsgBox("900040", parent.VB_INForMATION, "a5101ra1_ko441", "X")
		IsOpenPop = False
		Exit Function
	End If
...
'    Call ggoOper.ClearField(Document, "2")
    ...
    Call InitVariables
		...
		If CommonQueryRs("INSRT_USER_ID", "a_temp_gl",  "TEMP_GL_NO="&FilterVar(frm1.txtTempGlNo.value,"''","S"), lgF0,lgF1,lgF2,lgF3,lgF4,lgF5,lgF6) Then
				If UCase(Trim(replace(lgF0,Chr(11),"")))<>UCase(Trim(parent.gUsrId)) Then
						Call DisplayMsgBox("17A003", "X", parent.gUsrNm & "님이 등록한 전표만 조회가능합니다. 권한", "X")
						Exit Function
				End If
		End If
