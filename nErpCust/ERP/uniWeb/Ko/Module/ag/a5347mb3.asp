...
'--------------- 개발자 coding part(변수선언,End)----------------------------------------------------------
    Call HideStatusWnd
    lgPageNo       = UNICInt(Trim(Request("lgPageNo_C")),0)                  '☜: "0"(First),"1"(Second),"2"(Third),"3"(...)
    lgSelectList   = Request("lgSelectList_C")                               '☜ : select 대상목록 
    lgSelectListDT = Split(Request("lgSelectListDT_C"), gColSep)             '☜ : 각 필드의 데이타 타입 
    lgTailList     = Request("lgTailList_C")                                 '☜ : Orderby value
    lgDataExist    = "No"
    iPrevEndRow = 0
    iEndRow = 0
...
Sub TrimData()
	...
	lgtxtGlNo		= FilterVar(Trim(Request("txtGlNo")),"","S")
...
<Script Language=vbscript>
    If "<%=lgDataExist%>" = "Yes" Then
       ...
       Parent.lgPageNo_C      =  "<%=lgPageNo%>"               '☜ : Next next data tag
