...
Sub SubBizQueryMulti()
    ...
    Const C_SHEETMAXROWS_D  = 10000                                          '☆: Server에서 한번에 fetch할 최대 데이타 건수        
	...
	lgStrSQL = ""
	lgStrSQL = lgStrSQL & " SELECT   TOP " & C_SHEETMAXROWS_D * ( lgStrPrevKey + 1)  & " a.SEQ, a.TEMP_GL_DT,   "
    ...
    Else    
	   If CDbl(lgStrPrevKey) > 0 Then
		  ...
		  lgObjRs.Move     = CDbl(C_SHEETMAXROWS_D*lgStrPrevKey) 
	   End If 
