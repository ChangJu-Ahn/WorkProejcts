...
'			ggoSpread.SSSetProtected  C_DocCur, lRow, lRow2	   ' 부서코드 
		ELSE
...
Sub CboGLType_ProtectGrid(Byval GlType)
	...
	Select Case GlType		
		case "01"			
'			ggoSpread.SSSetProtected C_DocCur, 1, frm1.vspddata.maxrows	' 차대구분 
'			ggoSpread.SSSetProtected C_DocCurPopup, 1, frm1.vspddata.maxrows	' 차대구분 
...
'			ggoSpread.SSSetProtected C_DocCurPopup, 1, frm1.vspddata.maxrows	' 차대구분 
			...
			ggoSpread.SSSetProtected C_DrCrNm, 1, frm1.vspddata.maxrows	' 차대구분 
		Case "03"			
			ggoSpread.SSSetRequired C_DocCur, 1, frm1.vspddata.maxrows	' 차대구분 
			ggoSpread.SpreadUnLock C_DocCurPopup, 1, frm1.vspddata.maxrows	' 차대구분 
					...
					<TD CLASS="CLSMTABP">
						<TABLE ID="MyTab" CELLSPACING=0 CELLPADDING=0>
							<TR>
								...
								<td background="../../../CShared/image/table/seltab_up_bg.gIf" align="center" CLASS="CLSMTABP"><font color=white>회계전표등록 (Copy)</font></td>
					...
					<TD WIDTH="100%" HEIGHT=* VALIGN=TOP >
						<TABLE <%=LR_SPACE_TYPE_60%>>					
							<TR>
								...
								<TD CLASS=TD6 NOWRAP><SCRIPT LANGUAGE=JavaScript> ExternalWrite('<OBJECT CLASSID=<%=gCLSIDFPDT%> name=txtGLDt CLASS=FPDTYYYYMMDD title=FPDATETIME tag="22" ALT="회계일자" id=OBJECT7></OBJECT>');</SCRIPT></TD>								
								<TD CLASS=TD5 NOWRAP>전표형태</TD>
								<TD CLASS=TD6 NOWRAP><SELECT NAME="cboGlType" tag="23" STYLE="WIDTH:82px:" ALT="전표형태"><OPTION VALUE="" selected></OPTION></SELECT></TD>
							</TR>
							<TR>
		...
		<TD WIDTH="100%">
			<TABLE <%=LR_SPACE_TYPE_30%>>
				<TR>
					...
					<TD WIDTH="*" ALIGN=RIGHT><A HREF = "VBSCRIPT:PgmJumpChk(JUMP_PGM_ID_TAX_REP)">회계전표등록</A></TD>
					</TD>
				</TR>
			</TABLE>
		</TD>
