...
'    lgMaxCount     = CInt(Request("lgMaxCount"))                           '☜ : 한번에 가져올수 있는 데이타 건수 
	...
	lgtxtGLMgmtRadio      = Request("txtGLMgmtRadio")
...
Sub FixUNISQLData()
	...
	If Trim(lgtxtGLMgmtRadio) = "2" Then
		strSql = strSql & " and ISNULL(A.GL_MGMT_NO,'') <> " & FilterVar("", "''", "S") & " "
	ElseIf Trim(lgtxtGLMgmtRadio) = "3" Then
		strSql = strSql & " and ISNULL(A.GL_MGMT_NO,'') = " & FilterVar("", "''", "S") & " "	
	End If
       ...
       'Set condition data to hidden area
		With parent
			If "<%=lgPageNo%>" = "1" Then   ' "1" means that this query is first and next data exists
				...
				.Frm1.htxtMgmtRadio.Value		= "<%=lgtxtGLMgmtRadio%>"
			End If
