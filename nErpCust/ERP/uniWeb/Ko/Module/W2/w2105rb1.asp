...
Sub SubMakeSQLStatements(pMode,pCode1, pCode2, pCode3)
    Select Case pMode 
      Case "R1"
			lgStrSQL =			  " SELECT B.ACCT_CD W1, B.ACCT_NM W2,  A.CREDIT_BASIC_AMT+A.CREDIT_SUM_AMT-A.DEBIT_BASIC_AMT-A.DEBIT_SUM_AMT W3  " & vbCrLf
            lgStrSQL = lgStrSQL & " 	, B.ACCT_GP_CD W4, dbo.ufn_getCodeName('W1084', B.ACCT_GP_CD)W5 " & vbCrLf
            lgStrSQL = lgStrSQL & "		, ( CASE C.COMP_TYPE2 WHEN '1' THEN '매출' WHEN '2' THEN '영업이익' END ) W6 " & vbCrLf
			...
			lgStrSQL = lgStrSQL & "  		AND B.MATCH_CD = '06'" & vbCrLf
