...
Const BIZ_PGM_QRY_ID    = "s3112bb1_ko441.asp"	    		
Const BIZ_PGM_QRY_ID2   = "s3112bb2_ko441.asp"		    '20080220::hanc	
	...
	Select Case UCase(pvSpdNo)
		...
		Case "B"
        	...
        	With ggoSpread
        		...
        		vspdData2.MaxCols = C_OUT_TYPE_SUB + 1
        		vspdData2.MaxRows = 0
        		...
        		.SSSetEdit		C_OUT_TYPE_SUB           , "C_OUT_TYPE_SUB", 20, 0
 
        		Call .SSSetColHidden(C_ITEM_NM,C_OUT_TYPE_SUB,True)
...
'	With vspdData1
		...
		If iLngSelectedRows > 0 Then 
			...
			Redim arrReturn(iLngSelectedRows, 33)
...
'					vspdData1.Col = C_Remark			: arrReturn(intInsRow, 29) = vspdData1.Text
					vspdData2.Col = C_OUT_NO			: arrReturn(intInsRow, 29) = vspdData2.Text
					vspdData2.Col = C_OUT_TYPE		: arrReturn(intInsRow, 30) = vspdData2.Text
					...
					vspdData2.Col = C_OUT_TYPE_SUB	: arrReturn(intInsRow, 33) = vspdData2.Text
...
Sub GetSpreadColumnPos(ByVal pvSpdNo)
    ...
    Select Case UCase(pvSpdNo)
       ...
       Case "B"
            ...
            C_TRANS_TIME             = iCurColumnPos(15)
            C_CREATE_TYPE            = iCurColumnPos(16)
						C_OUT_TYPE_SUB					 = iCurColumnPos(17)
...
Sub vspdData2_TopLeftChange(ByVal OldLeft, ByVal OldTop, ByVal NewLeft, ByVal NewTop)
	...
	If vspdData1.MaxRows < NewTop + VisibleRowCnt(vspdData2,NewTop) Then	    '☜: 재쿼리 체크	
		If CheckRunningBizProcess Then Exit Sub
		If lgStrPrevKey2 <> "" Then Call DbDtlQuery()
	End If		 
