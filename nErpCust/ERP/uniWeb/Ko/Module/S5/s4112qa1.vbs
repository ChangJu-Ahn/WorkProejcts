...
'=========================================
Sub InitSpreadSheet()
	Call SetZAdoSpreadSheet("S4112QA1","S","A","V20021106", Parent.C_SORT_DBAGENT, frm1.vspdData, C_MaxKey, "X", "X" )
    Call SetSpreadLock 
End Sub
...
'========================================
Sub FormatField()
	Call FormatDATEField(frm1.txtDNFrDt)
	Call FormatDATEField(frm1.txtDNToDt)
End Sub
'=========================================
Sub LockFieldInit()
	Call LockObjectField(frm1.txtDNFrDt, "O")
	Call LockObjectField(frm1.txtDNToDt, "O")
End Sub
'========================================
...
'=======================================================
Sub txtDNToDt_KeyDown(KeyCode, Shift)
	If KeyCode = 13	Then Call MainQuery()
End Sub
