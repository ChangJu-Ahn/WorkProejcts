...
Case CStr(UID_M0001)														'☜: 현재 조회/Prev/Next 요청을 받음 
    ...
    Set pS5G128 = Server.CreateObject("pS5G128.cSListDnDtl")
	...
	For LngRow = 0 To UBound(EG1_EXP_GRP,1)	
		...
		iArrCols(46) = iLngLastRow + LngRow
...
Case CStr(UID_M0002)																'☜: 저장 요청을 받음 
	...
	Set pS5G531 = Server.CreateObject("pS5G531.cSDnDtlSvrForDnReqNo")
