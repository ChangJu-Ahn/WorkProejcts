...
<SCRIPT LANGUAGE="VBScript"   SRC="S4112ma1.vbs"></SCRIPT>
		...
		<TD WIDTH=100%>
			<TABLE <%=LR_SPACE_TYPE_10%>>
				<TR>
					...
					<TD WIDTH=* align=right><A href="vbscript:OpenSODtlRef">수주내역참조</A>&nbsp;<A href="vbscript:OpenDnReqDtlRef">출하요청내역참조</A></TD>
					<TD WIDTH=10>&nbsp;</TD>
				</TR>
			</TABLE>
		</TD>
