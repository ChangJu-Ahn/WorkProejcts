...
Sub FixUNISQLData()
	...
	If Len(Request("txtBpCd")) Then
		strVal = " AND SHIP_TO_PARTY = " & FilterVar(Trim(Request("txtBpCd")), "''", "S") & " "		
	Else
		strVal = ""
	End If
    ...
    If Len(Request("txtDlvyFrDt")) Then
		If Trim(Request("txtRadio")) = "Y" Then
			strVal = strVal & " AND ACTUAL_GI_DT >= " & FilterVar(UNIConvDate(Request("txtDlvyFrDt")), "''", "S") & ""
		Else
			strVal = strVal & " AND PROMISE_DT >= " & FilterVar(UNIConvDate(Request("txtDlvyFrDt")), "''", "S") & ""
		End If
	End If		
	
	If Len(Request("txtDlvyToDt")) Then
		If Trim(Request("txtRadio")) = "Y" Then
			strVal = strVal & " AND ACTUAL_GI_DT <= " & FilterVar(UNIConvDate(Request("txtDlvyToDt")), "''", "S") & ""
		Else
			strVal = strVal & " AND PROMISE_DT >= " & FilterVar(UNIConvDate(Request("txtDlvyToDt")), "''", "S") & ""
		End If
	End If	
