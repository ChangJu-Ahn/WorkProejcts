...
<SCRIPT LANGUAGE="VBScript"   SRC="S4113ma1_ko441.vbs"></SCRIPT>
		...
		<TD WIDTH=100%>
			<TABLE <%=LR_SPACE_TYPE_10%>>
				<TR>
					...
					<TD WIDTH=* align=right><A href="vbscript:OpenMESIssueRef">MES출고참조</A>&nbsp;|&nbsp;<A href="vbscript:OpenSODtlRef">수주내역및거래처재고참조</A>&nbsp;</TD>
					<TD WIDTH=10>&nbsp;</TD>
				</TR>
			</TABLE>
		</TD>
