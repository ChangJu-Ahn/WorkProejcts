...
'*  3. Program ID           : s3112ya1_ko441     														*
'*  4. Program Name         : MES반품입고참조																*
'*  5. Program Desc         : 국내출고_반품등록을 위한 MES반품입고참조 	                                    *
'*  6. Comproxy List        : 																			*
...
Set PopupParent  = arrParent(0)
    ...
    lgDn_Type	= arrParent(3)      '출하형태

top.document.title = PopupParent.gActivePRAspName

Const BIZ_PGM_QRY_ID = "s3112yb1_ko441.asp"			
...
Sub InitSpreadSheet()
	...
	With ggoSpread
		...
		Call AppendNumberPlace("7","5","0")
    		...
    		.SSSetEdit		C_OUT_TYPE_SUB               , "MES출하TYPESUB", 20, 0
    		...
    		.SSSetEdit		C_VAT_TYPE          , "VAT_TYPE", 20, 0
					...
					<TR>
						...
						<TD CLASS=TD6>
							<TABLE CELLSPACING=0 CELLPADDING=0>
								<TR>
									<TD>
										<script language =javascript src='./js/s3112ya1_ko441_fpDateTime1_txtFromDt.js'></script>
									</TD>
									<TD>
										&nbsp;~&nbsp;
									</TD>
									<TD>
										<script language =javascript src='./js/s3112ya1_ko441_fpDateTime2_txtToDt.js'></script>
									</TD>
								</TR>
							</TABLE>
						</TD>								
	...
	<TR>
		<TD WIDTH=100% HEIGHT=* valign=top>
			<TABLE <%=LR_SPACE_TYPE_20%>>
				<TR>
					<TD HEIGHT="100%">
						<script language =javascript src='./js/s3112ya1_ko441_vaSpread_vspdData.js'></script>
					</TD>
				</TR>
			</TABLE>
		</TD>
