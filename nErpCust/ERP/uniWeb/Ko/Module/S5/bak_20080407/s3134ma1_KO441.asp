...
Const BIZ_PGM_ID        = "s3134mb1_KO441.asp"
...
Sub SetDefaultVal()
	...
	If lgPLCd <> "" then 
		Call ggoOper.SetReqAttr(frm1.txtPlantCode, "Q") 
        	frm1.txtPlantCode.value = lgPLCd
	End If
	If lgSGCd <> "" then 
...
Function OpenConDnPopup(ByVal iWhere)
	...
	Case 4					'공장
		If frm1.txtPlantCode.className = "protected" Then
                	lgIsOpenPop = False
                	Exit Function
                End If 
		arrParam(1) = "B_PLANT"								
