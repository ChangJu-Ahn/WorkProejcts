...
On Error Resume Next
	...
	With frm1.vspdData
		...
		For iLngCnt = 0 to iLngLoopCnt - 1
            ...
            '20080305::hanc txtVat_Type txtVatTypeNm txtVat_rate frm1.txtVat_rate.Value
            .Col = C_VatType    :            .Text = frm1.txtVat_Type.Value
            .Col = C_VatTypeNm  :            .Text = frm1.txtVatTypeNm.Value
            .Col = C_VatRate    :            .Text = UNIFormatNumber(UNICDbl(frm1.txtVat_rate.Value), ggExchRate.DecPoint, -2, 0, ggExchRate.RndPolicy, ggExchRate.RndUnit)
            Call SetVATTypeForSpread(.ActiveRow)
