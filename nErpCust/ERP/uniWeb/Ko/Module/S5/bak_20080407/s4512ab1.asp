...
Select Case strMode
	Case CStr(UID_M0001)													
		...
		Const S5G212_RS_SO_DN_REMAIN = 31
		...
		' 자료 조회 
		Set iPS5G512 = Server.CreateObject("PS5G512.cSListSSoSchdForDnReq")
        ...
        Call iPS5G512.ListRows(gStrGlobalCollection, C_SHEETMAXROWS_D, iArrWhere, iArrRsOut, iArrNextKey, iArrWhereOut)
		...
		For iLngRow = 0 To iLngSheetMaxRows
   			...
   			iArrCols(4) = UNINumClientFormat(iArrRsOut(S5G212_RS_REMN_QTY, iLngRow), ggQty.DecPoint, 0)			' 미출하요청수량 
   			iArrCols(5) = UNINumClientFormat(iArrRsOut(S5G212_RS_REMN_BONUS_QTY, iLngRow), ggQty.DecPoint, 0)		' 미출하요청덤수량 
   			...
   			iArrCols(31) = UNINumClientFormat(iArrRsOut(S5G212_RS_SO_DN_REMAIN, iLngRow), ggQty.DecPoint, 0)			' 미출고수량 
			iArrCols(32) = iLngLastRow + iLngRow
