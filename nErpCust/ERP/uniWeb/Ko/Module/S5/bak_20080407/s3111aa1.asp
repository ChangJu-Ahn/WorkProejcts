...
'*  6. Comproxy List        : 
'*  7. Modified date(First) : 2003/08/21
...
Sub SetDefaultVal()
	...
	frm1.txtConFrPromiseDt.Text = lgStartDate
	frm1.txtConToPromiseDt.Text = lgCurDate
...
'========================================
Sub InitSpreadSheet()
	Call SetZAdoSpreadSheet("S3111AA1","S","A","V20030821", PopupParent.C_SORT_DBAGENT, frm1.vspdData, C_MaxKey, "X", "X" )
	Call SetSpreadLock 	  
End Sub
...
'========================================
Sub txtConFrPromiseDt_DblClick(Button)
	If Button = 1 Then
		frm1.txtConFrPromiseDt.Action = 7		
		Call SetFocusToDocument("P")
		frm1.txtConFrPromiseDt.Focus
	End If
End Sub

'========================================
Sub txtConToPromiseDt_DblClick(Button)
	If Button = 1 Then
		frm1.txtConToPromiseDt.Action = 7
		Call SetFocusToDocument("P")
		frm1.txtConToPromiseDt.Focus
	End If
End Sub
...
'========================================
Sub txtConFrPromiseDt_KeyPress(KeyAscii)
	On Error Resume Next
    If KeyAscii = 27 Then
       Call CancelClick()
...
'========================================
Sub txtConToPromiseDt_KeyPress(KeyAscii)
	On Error Resume Next
    If KeyAscii = 27 Then
       Call CancelClick()
    Elseif KeyAscii = 13 Then
...
Function FncQuery() 
	...
	If ValidDateCheck(frm1.txtConFrPromiseDt, frm1.txtConToPromiseDt) = False Then Exit Function
...
Function DbQuery() 
    ...
    With frm1
		If lgIntFlgMode = PopupParent.OPMD_UMODE Then		
			...
			strVal = strVal & "&txtConFrPromiseDt=" & Trim(.HFrPromiseDt.value)
			strVal = strVal & "&txtConToPromiseDt=" & Trim(.HToPromiseDt.value)
        ...
        Else
			...
			strVal = strVal & "&txtConFrPromiseDt=" & Trim(.txtConFrPromiseDt.text)
			strVal = strVal & "&txtConToPromiseDt=" & Trim(.txtConToPromiseDt.text)
					...
					<TR>
						...
						<TD CLASS="TD6" NOWRAP>
							<TABLE CELLSPACING=0 CELLPADDING=0>
								<TR>
									<TD>
										<script language =javascript src='./js/s3111aa1_fpDateTime1_txtConFrPromiseDt.js'></script>
									</TD>
									<TD>
										&nbsp;~&nbsp;
									</TD>
									<TD>
										<script language =javascript src='./js/s3111aa1_fpDateTime2_txtConToPromiseDt.js'></script>
									</TD>
								</TR>
							</TABLE>
						</TD>
					...
					<TR>
						...
						<TD CLASS="TD6" NOWRAP>
							<TABLE CELLSPACING=0 CELLPADDING=0>
								<TR>
									<TD>
										<script language =javascript src='./js/s3111aa1_fpDateTime1_txtConFrDlvyDt.js'></script>
									</TD>
									<TD>
										&nbsp;~&nbsp;
									</TD>
									<TD>
										<script language =javascript src='./js/s3111aa1_fpDateTime2_txtConToDlvyDt.js'></script>
									</TD>
								</TR>
							</TABLE>
						</TD>
	...
	<TR>
		<TD WIDTH=100% HEIGHT=* valign=top>
			<TABLE <%=LR_SPACE_TYPE_20%>>
				<TR>
					<TD HEIGHT="100%">
						<script language =javascript src='./js/s3111aa1_vaSpread_vspdData.js'></script>
					</TD>
				</TR>
			</TABLE>
		</TD>
