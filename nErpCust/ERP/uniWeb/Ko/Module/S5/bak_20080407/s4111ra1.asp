			...
			<TD <%=HEIGHT_TYPE_02%> WIDTH=100%>
				<FIELDSET CLASS="CLSFLD">
					<TABLE <%=LR_SPACE_TYPE_40%>>
						<TR>
							<TD CLASS=TD5>납품처</TD>
							<TD CLASS=TD6><INPUT TYPE=TEXT NAME="txtShipToParty" SIZE=10 MAXLENGTH=10 TAG="14XXXU" ALT="납품처"><IMG SRC="../../../CShared/image/btnPopup.gif" NAME="btnApplicant" align=top TYPE="BUTTON" ONCLICK ="">&nbsp;<INPUT TYPE=TEXT NAME="txtShipToPartyNm" SIZE=20 TAG="14"></TD>
							<TD CLASS=TD5 NOWRAP>인수자명</TD>
							<TD CLASS=TD6 NOWRAP><INPUT NAME="txtReceiver" ALT="인수자명" TYPE="Text" MAXLENGTH="50" SIZE= 20 tag="11XXXX"></TD>
						</TR>
					</TABLE>
				</FIELDSET>
			</TD>
