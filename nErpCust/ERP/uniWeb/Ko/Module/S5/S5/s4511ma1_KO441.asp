...
<SCRIPT LANGUAGE="VBScript"   SRC="S4511ma1_KO441.vbs"></SCRIPT>
					...
					<TD CLASS="CLSMTABP">
						<TABLE ID="MyTab" CELLSPACING=0 CELLPADDING=0 onclick="changeTabs(TAB1)">
							<TR>
								...
								<td background="../../../CShared/image/table/seltab_up_bg.gif" align="center" CLASS="CLSMTAB"><font color=white>출하요청등록</font></td>
						...
						<FIELDSET CLASS="CLSFLD">
							<TABLE <%=LR_SPACE_TYPE_40%>>
								<TR>
									...
									<TD CLASS="TD6"><INPUT NAME="txtConDnNo" ALT="출하요청번호" TYPE="Text" MAXLENGTH=18 SiZE=20 tag="12XXXU" CLASS="required" STYLE="text-transform:uppercase"><IMG SRC="../../../CShared/image/btnPopup.gif" NAME="btnDnHDR" align=top TYPE="BUTTON"ONCLICK="vbscript:OpenConDnReqNo()"></TD>
									<TD CLASS="TDT"></TD>
									<TD CLASS="TD6"></TD>
								</TR>
							</TABLE>
					...
					<TD WIDTH=100% VALIGN=TOP>
						<DIV ID="TabDiv" STYLE="FLOAT: left; HEIGHT: 100%; WIDTH: 100%;" SCROLL=no>
							<TABLE <%=LR_SPACE_TYPE_60%>>
								<TR>
									<TD CLASS="TD5" NOWRAP>출하요청번호</TD>
									<TD CLASS="TD6"><INPUT NAME="txtDnNo" ALT="출하요청번호" TYPE="Text" MAXLENGTH=18 SiZE=20 tag="25XXXU" STYLE="text-transform:uppercase"></TD>
								...
								<TR>
									<TD CLASS=TD5 NOWRAP>SCM D/O No.</TD>
									<TD CLASS=TD6 NOWRAP><INPUT NAME="txtSCMDONo" ALT="SCM D/O No." TYPE="Text" style="text-align=center" SIZE=20 tag="24" CLASS="protected" READONLY="true" TABINDEX="-1"></TD>
									<TD CLASS=TD5 NOWRAP>SCM D/O Seq.</TD>
									<TD CLASS=TD6 NOWRAP><INPUT NAME="txtSCMDONoSeq" ALT="SCM D/O Seq." TYPE="Text" style="text-align=center" SIZE=20 tag="24" CLASS="protected" READONLY="true" TABINDEX="-1"></TD>
								</TR>							
	...
	<TR HEIGHT=20>
		<TD WIDTH=100%>
			<TABLE <%=LR_SPACE_TYPE_30%>>
			    <TR>
					<TD WIDTH=10>&nbsp;</TD>
					<TD WIDTH=* Align=Right><a href = "VBSCRIPT:JumpChgCheck()">출하요청내역등록</a></TD>
					<TD WIDTH=10>&nbsp;</TD>
				</TR>
			</TABLE>
		</TD>
