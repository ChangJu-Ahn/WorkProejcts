...
'=========================================
Sub InitSpreadSheet()
	Call SetZAdoSpreadSheet("S4511PA1","S","A","V20021106", PopupParent.C_SORT_DBAGENT, frm1.vspdData, C_MaxKey, "X", "X" )
    Call SetSpreadLock 
End Sub
...
Function OpenSCMDoNo()
	...
	arrParam(0) = Trim(frm1.txtSCMDoNo.Value)

	iCalledAspName = AskPRAspName("J2072RA1")

	If Trim(iCalledAspName) = "" Then
		IntRetCD = DisplayMsgBox("900040", parent.VB_INFORMATION, "J2072RA1", "X")
		lgIsOpenPop = False
		Exit Function
	End If

	arrRet = window.showModalDialog(iCalledAspName, Array(window.PopupParent, arrParam), _
		"dialogWidth=800px; dialogHeight=480px; center: Yes; help: No; resizable: No; status: No;")

	lgIsOpenPop = False

	If arrRet(0) <> "" Then
		frm1.txtSCMDoNo.Value   = arrRet(0)
		frm1.txtSCMDoNo.focus
	End If
End Function
...
Function DbQuery() 
    ...
    With frm1
		...
		If lgIntFlgMode = PopupParent.OPMD_UMODE Then	
			...
			strVal = strVal & "&txtSCMDoNo=" & Trim(.HSCMDoNo.value)
		...
		Else			
			...
			strVal = strVal & "&txtSCMDoNo=" & Trim(.txtSCMDoNo.value)
			...
			<FIELDSET CLASS="CLSFLD">
				<TABLE <%=LR_SPACE_TYPE_40%>>
					<TR>
						...
						<TD CLASS=TD6 NOWRAP>
							<INPUT TYPE=TEXT NAME="txtDnReqNo" SIZE=30 MAXLENGTH=18 TAG="11XXXU" ALT="출하요청번호">
						</TD>
						<TD CLASS=TD5 NOWRAP>SCM D/O번호</TD>
						<TD CLASS=TD6 NOWRAP>
							<INPUT TYPE=TEXT NAME="txtSCMDoNo" SIZE=30 MAXLENGTH=30 TAG="11XXXU" ALT="SCM D/O번호"><IMG SRC="../../../CShared/image/btnPopup.gif" NAME="btnSCMDONo" align=top TYPE="BUTTON" ONCLICK="vbscript:ZbtnSCMDONo_OnClick">
						</TD>
					</TR>
					<TR>
					...
					<TR>
						...
						<INPUT TYPE="HIDDEN" NAME="txtCCNo" SIZE=30 MAXLENGTH=35 TAG="11XXXU" ALT="통관관리번호">
<!--					<TR>
						<%If Request("txtExceptFlag") = "Y" Then%>
							<TD CLASS=TD5 NOWRAP></TD>
...
<INPUT TYPE=HIDDEN NAME="HSCMDoNo" tag="24">
