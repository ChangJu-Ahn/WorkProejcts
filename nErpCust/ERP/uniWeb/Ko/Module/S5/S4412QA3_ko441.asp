...
Const BIZ_PGM_ID 		= "S4412QB3_ko441.asp" 
Const C_MaxKey          = 15				                         
...
Function DbQuery() 
    ...
    With frm1
        ...
        .txtBizarea.value = parent.gBizArea
              
        lgStartRow = .vspdData.MaxRows + 1										
    End With
    
    Call CommonQueryRs(" USE_YN "," Z_USR_ORG_MAST "," USR_ID = " & FilterVar(parent.gUsrId, "''", "S") & " AND ORG_TYPE = " & FilterVar("BA", "''", "S") & "  ",lgF0,lgF1,lgF2,lgF3,lgF4,lgF5,lgF6)
...
<INPUT TYPE=HIDDEN NAME="txtBizarea"			tag="24" TABINDEX="-1">
