...
<SCRIPT LANGUAGE="VBScript"   SRC="S4112qa1.vbs"></SCRIPT>
					...
					<TD CLASS="CLSMTABP">
						<TABLE ID="MyTab" CELLSPACING=0 CELLPADDING=0>
							<TR>
								...
								<td background="../../../CShared/image/table/seltab_up_bg.gif" align="center" CLASS="CLSMTAB"><font color=white>출하상세</font></td>
							...
							<TABLE <%=LR_SPACE_TYPE_40%>>
								...
								<TR>
									...
									<TD CLASS=TD6 NOWRAP>
										...
										<INPUT TYPE="RADIO" CLASS="RADIO" NAME="rdoQueryFlg" TAG="11X" VALUE="Y" ID="rdoQueryFlg2"><LABEL FOR="rdoQueryFlg2">출고</LABEL>&nbsp;&nbsp;&nbsp;
										<INPUT TYPE="RADIO" CLASS="RADIO" NAME="rdoQueryFlg" TAG="11X" VALUE="N" ID="rdoQueryFlg3"><LABEL FOR="rdoQueryFlg3">미출고</LABEL>			
									</TD>
								</TR>
								<TR>	
									<TD CLASS=TD5 NOWRAP>출고일</TD>
									<TD CLASS=TD6 NOWRAP>
										<SCRIPT LANGUAGE=JavaScript> ExternalWrite('<OBJECT CLASSID=<%=gCLSIDFPDT%> id=fpDateTime1 NAME="txtDNFrDt" CLASS=FPDTYYYYMMDD tag="11X1" Title="FPDATETIME" ALT="출고시작일"></OBJECT>');</SCRIPT>&nbsp;~&nbsp;
										<SCRIPT LANGUAGE=JavaScript> ExternalWrite('<OBJECT CLASSID=<%=gCLSIDFPDT%> id=fpDateTime2 NAME="txtDNToDt" CLASS=FPDTYYYYMMDD tag="11X1" Title="FPDATETIME" ALT="출고종료일"></OBJECT>');</SCRIPT>
									</TD>
...
<INPUT TYPE=HIDDEN NAME="HtxtDNFrDt" tag="24">
<INPUT TYPE=HIDDEN NAME="HtxtDNToDt" tag="24">	    
