...
Const BIZ_PGM_ID        = "s4124mb1_ko441.asp"
...
Sub InitSpreadSheet()
	...
	Call SetZAdoSpreadSheet("S4124MA1_ko441","S","A","V20030711", Parent.C_SORT_DBAGENT, frm1.vspdData, C_MaxKey, "X", "X" )

 	frm1.vspdData.Col = 1	: frm1.vspdData.ColMerge = 2
...
Function DbQuery() 
    ...
    With frm1
		...
		strVal = strVal & "&lgTailList="     & " ORDER BY A.PART_TYPE, A.ITEM_CD " 'MakeSQLGroupOrderByList("A")
    ...
    If frm1.vspdData.MaxRows > 0 Then
	    ...
	    With frm1.vspdData
		    ...
		    For intRow = 1 To .MaxRows			
			    .Row = intRow
			    .Col = 2
    			IF Trim(right(.Value,5)) = "TOTAL" THEN
			        .Col = -1 
			        .Col2 = -1
			        .BackColor = RGB(249,119,240) 'RGB(255,230,255)
			    END IF
	         next
...
Sub FormatSpreadCellByCurrency()
	Call ReFormatSpreadCellByCellByCurrency(frm1.vspdData,lgLngStartRow,frm1.vspdData.MaxRows,GetKeyPos("A",5),GetKeyPos("A",7),"A", "Q" ,"X","X")		
	Call ReFormatSpreadCellByCellByCurrency(frm1.vspdData,lgLngStartRow,frm1.vspdData.MaxRows,GetKeyPos("A",5),GetKeyPos("A",8),"A", "Q" ,"X","X")		
	Call ReFormatSpreadCellByCellByCurrency(frm1.vspdData,lgLngStartRow,frm1.vspdData.MaxRows,GetKeyPos("A",5),GetKeyPos("A",11),"A", "Q" ,"X","X")		
					...
					<TD CLASS="CLSMTABP">
						<TABLE ID="MyTab" CELLSPACING=0 CELLPADDING=0>
							<TR>
								...
								<td background="../../../CShared/image/table/seltab_up_bg.gif" align="center" CLASS="CLSMTAB"><font color=white>마감-취합표지</font></td>
						...
						<FIELDSET CLASS="CLSFLD">
							<TABLE <%=LR_SPACE_TYPE_40%>>
								<TR>
									...
									<TD CLASS="TD6"><INPUT NAME="txtPlantCode" TYPE="Text" ALT="공장" MAXLENGTH=4 SiZE=10 tag="12XXXU"><IMG SRC="../../../CShared/image/btnPopup.gif" NAME="btnSDN" align=top TYPE="BUTTON" ONCLICK="vbscript:OpenConDnPopup 4">&nbsp;<INPUT NAME="txtPlantName" TYPE="Text" MAXLENGTH="20" SIZE=25 tag="14"></TD>
