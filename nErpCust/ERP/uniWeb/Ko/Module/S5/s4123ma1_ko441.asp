...
Const BIZ_PGM_ID        = "s4123mb1_ko441.asp"
...
Sub InitSpreadSheet()
	...
	Call SetZAdoSpreadSheet("S4123MA1_ko441","S","A","V20030711", Parent.C_SORT_DBAGENT, frm1.vspdData, C_MaxKey, "X", "X" )
...
Sub FormatSpreadCellByCurrency()
	Call ReFormatSpreadCellByCellByCurrency(frm1.vspdData,lgLngStartRow,frm1.vspdData.MaxRows,GetKeyPos("A",16),GetKeyPos("A",17),"A", "Q" ,"X","X")		
	Call ReFormatSpreadCellByCellByCurrency(frm1.vspdData,lgLngStartRow,frm1.vspdData.MaxRows,GetKeyPos("A",16),GetKeyPos("A",18),"A", "Q" ,"X","X")		
					...
					<TD CLASS="CLSMTABP">
						<TABLE ID="MyTab" CELLSPACING=0 CELLPADDING=0>
							<TR>
								...
								<td background="../../../CShared/image/table/seltab_up_bg.gif" align="center" CLASS="CLSMTAB"><font color=white>마감-출고현황조회<BR>(기타업체양식)</font></td>
