...
Const BIZ_PGM_ID = "s4311mb1_ko441.asp"            '☆: Head Query 비지니스 로직 ASP명 
Const BIZ_PGM_ID2 = "s4311mb2_ko441.asp"            '☆: Head Query 비지니스 로직 ASP명 
...
Sub FormatField()
    With frm1
		...
		Call FormatDoubleSingleField(.txtXchg_rate) '20080305::hanc
...
Sub LockFieldInit(ByVal pvFlag)
    With frm1
		...
		Call LockObjectField(.txtXchg_rate,"O") '20080305::hanc
...
Sub SetDefaultVal()
    ...
    With frm1
    	...
    	.txtXchg_rate.Text = 0      '20080305::hanc
...
Sub InitSpreadSheet()
    ...
    With ggoSpread
        ...
        frm1.vspdData.MaxCols = C_CUST_LOT_NO + 1            '☜: 최대 Columns의 항상 1개 증가시킴 
...
'2008-04-17 9:34오전 :: hanc
        .SSSetEdit C_TRANS_TIME , "C_TRANS_TIME", 30
        .SSSetEdit C_OUT_NO     , "C_OUT_NO", 30
        .SSSetEdit C_OUT_TYPE   , "C_OUT_TYPE", 30
        .SSSetEdit C_OUT_TYPE_SUB   , "C_OUT_TYPE_SUB", 30
        .SSSetEdit C_CREATE_TYPE, "C_CREATE_TYPE", 30
        .SSSetEdit C_CUST_LOT_NO, "C_CUST_LOT_NO", 30
        ...
        Call .SSSetColHidden(C_DnSeq, C_DbVatAmt, True)
        Call .SSSetColHidden(C_TRANS_TIME, C_CREATE_TYPE, True)
        Call .SSSetColHidden(frm1.vspdData.MaxCols, frm1.vspdData.MaxCols, True)
        Call .SSSetColHidden(C_Remark, C_Remark, True)      '20080226::hanc
...
Function OpenSODtlRef1()
	...
	If Trim(frm1.txtPlant.value) = "" Then
		Msgbox "공장을 입력하십시오.",vbInformation, parent.gLogoName
		Exit Function
	End If

	If Trim(frm1.txtDn_Type.value) = "" Then
		Msgbox "출하형태를 입력하십시오.",vbInformation, parent.gLogoName
		Exit Function
	End If

'	If Trim(frm1.txtVat_Type.value) = "" Then
'		Msgbox "VAT유형을 입력하십시오.",vbInformation, parent.gLogoName
'		Exit Function
'	End If
...
'	End If
	...
	iCalledAspName = AskPRAspName("s3112xa1_ko441")     '20080221::hanc
	...
	arrParam(0) =	Trim(frm1.txtPlant.Value)
...
On Error Resume Next
	...
	With frm1.vspdData
		...
		For iLngCnt = 0 to iLngLoopCnt - 1
			...
			.Col = C_SlCd		:		.text = pvArrRet(iLngCnt, 0)			'SL_CD 
			.Col = C_ItemCd     :		.text = pvArrRet(iLngCnt, 1)			'ITEM_CD
			.Col = C_ItemNm     :		.text = pvArrRet(iLngCnt, 2)			'ITEM_NM
			.Col = C_Spec       :		.text = pvArrRet(iLngCnt, 3)			'SPEC
			.Col = C_DnUnit     :		.text = pvArrRet(iLngCnt, 4)			'출고단위
			.Col = C_DnQty      :		.text = pvArrRet(iLngCnt, 5)			'출고량
			.Col = C_Price      :		.text = pvArrRet(iLngCnt, 6)			'단가
             Call CalcAmtLoc(.Row)
			.Col = C_LotNo      :		.text = pvArrRet(iLngCnt, 7)			'LOT NO
			.Col = C_LotSeq      :		.text = pvArrRet(iLngCnt, 8)			'LOT SEQ
			.Col = C_Remark			:	.text = pvArrRet(iLngCnt, 9)			'비고  20080226::hanc

            frm1.txtSold_to_party.Value     = pvArrRet(iLngCnt, 10)         '2008-04-16 6:48오후 :: hanc
            frm1.txtSold_to_partyNm.Value   = pvArrRet(iLngCnt, 11)         '2008-04-16 6:48오후 :: hanc
            Call SoldToPartyLookUp                                          '2008-04-16 6:52오후 :: hanc


    		.Col = C_VatType      :		.Text = pvArrRet(iLngCnt, 12)    '2008-04-16 8:45오후 :: hanc
			.Col = C_VatTypeNm    :		.Text = pvArrRet(iLngCnt, 13)    '2008-04-16 8:45오후 :: hanc
			.Col = C_VatIncFlag   :		.Text = pvArrRet(iLngCnt, 14)    '2008-04-16 8:45오후 :: hanc
			.Col = C_VatIncFlagNm :		.Text = pvArrRet(iLngCnt, 15)    '2008-04-16 8:45오후 :: hanc

			.Col = C_TRANS_TIME :		.Text = pvArrRet(iLngCnt, 16)    '2008-04-17 9:40오전 :: hanc
			.Col = C_OUT_NO			:	.text = pvArrRet(iLngCnt, 9)	 '2008-04-17 9:40오전 :: hanc
			.Col = C_OUT_TYPE :		.Text = pvArrRet(iLngCnt, 18)    '2008-04-17 9:40오전 :: hanc
			.Col = C_OUT_TYPE_SUB :		.Text = pvArrRet(iLngCnt, 19)    '2008-04-17 9:40오전 :: hanc
			.Col = C_CREATE_TYPE :		.Text = pvArrRet(iLngCnt, 17)    '2008-04-17 9:40오전 :: hanc
			.Col = C_CUST_LOT_NO :		.Text = pvArrRet(iLngCnt, 20)
...
Function OpenSODtlRef2()
	...
	If Trim(frm1.txtDn_Type.value) <> "I33" Then
		Msgbox "출하형태이 'I33'만 가능합니다.",vbInformation, parent.gLogoName
		Exit Function
	End If
...
'	End If
	...
	iCalledAspName = AskPRAspName("s3112ya1_ko441")     '20080221::hanc
...
'	    "dialogWidth=850px; dialogHeight=420px; center: Yes; help: No; resizable: No; status: No;")
	...
	If arrRet(0, 0) = "" Then
		...
		Exit Function
	Else
		Call SetSODtlRef2(arrRet)
	End If 
End Function

'20080221::hanc========================================
Function SetSODtlRef2(pvArrRet)
On Error Resume Next
...
Function OpenItem(ByVal strCode)
    ...
    iCalledAspName = AskPRAspName("s3112pa3_ko441")     '20080314::hanc
        
    If Trim(iCalledAspName) = "" Then
        IntRetCD = DisplayMsgBox("900040", Parent.VB_INFORMATION, "s3112pa3_ko441", "x") '20080314::hanc
        IsOpenPop = False
        Exit Function
    End If
...
Function CurrencyOnChange()
	...
	If UCase(Trim(frm1.txtCurrency.value)) = UCase(parent.gCurrency) Then
...
'	Call CurFormatNumericOCX()
	...
	Call DbQueryRate        '20080312::hanc
...
Sub LockColor_CfmYes()
    With ggoOper
		...
		Call .SetReqAttr(frm1.txtXchg_rate, "Q")                '20080305::hanc
...
Sub CurFormatNumericOCX()
 With frm1
  ...
  ggoOper.FormatFieldByObjectOfCur .txtXchg_rate, .txtDoc_cur.value, parent.ggExchRateNo, gBCurrency, gBDataType, gBDecimals, parent.gDateFormat, parent.gComNum1000, parent.gComNumDec		'20080305::hanc
...
Sub GetSpreadColumnPos(ByVal pvSpdNo)
    ...
    Select Case UCase(pvSpdNo)
       Case "A"
            ...
            '2008-04-17 9:35오전 :: hanc
			C_TRANS_TIME  	= iCurColumnPos(35)
			C_OUT_NO    	= iCurColumnPos(36)
			C_OUT_TYPE 	    = iCurColumnPos(37)
			C_OUT_TYPE_SUB 	    = iCurColumnPos(38)
			C_CREATE_TYPE 	= iCurColumnPos(39)
			C_CUST_LOT_NO		= iCurColumnPos(40)
    End Select
End Sub
...
Sub Form_Load()
	...
	Call ggoOper.SetReqAttr(frm1.txtXchg_rate, "Q") '20080305::hanc
...
'20080312::hanc:: 환율 계산해서 가져오기 위함.========================================
Function DbQueryRate()
    Err.Clear
    ...
    strVal = strVal     & "&txtKeyStream="  & ""         '☜: Query Key
...
Function DbSave()
    ...
    Dim iTmpKBuffer             '현재의 버퍼 [for key]
    Dim iTmpKBufferCount        '현재의 버퍼 Position
    Dim iTmpKBufferMaxCount     '현재의 버퍼 Chunk Size
    ...
    iTmpKBufferMaxCount = Parent.C_CHUNK_ARRAY_COUNT
    ...
    ReDim iArrData(40)
    ReDim iArrData1(4)  '2008-04-17 9:55오전 :: hanc
    ...
    ReDim iTmpKBuffer(iTmpKBufferMaxCount)  '최기 버퍼의 설정[FOR KEY]
...
'2008-04-17 9:43오전 :: hanc
                .Col = C_TRANS_TIME:        iArrData1(1) = Trim(.Text)             
                .Col = C_OUT_NO:            iArrData1(2) = Trim(.Text)                 
                .Col = C_OUT_TYPE_SUB:          iArrData1(3) = Trim(.Text)               
                .Col = C_CREATE_TYPE:       iArrData1(4) = Trim(.Text)            
                .Col = C_CUST_LOT_NO:       iArrData(24) = Trim(.Text)            
...
'BEGIN HANC -------------------------------------------------------------------------------
                    iStrKey = Join(iArrData1, Parent.gColSep) & Parent.gRowSep

                    If iLngKTotalValLen + Len(iStrKey) > Parent.C_FORM_LIMIT_BYTE Then   '한개의 form element에 넣을 Data 한개치가 넘으면 
                        Call MakeTextArea("txtKSpread", iTmpKBuffer)
                        
                       iTmpKBufferMaxCount = Parent.C_CHUNK_ARRAY_COUNT                  ' 임시 영역 새로 초기화 
                       ReDim iTmpKBuffer(iTmpKBufferMaxCount)
                       iTmpKBufferCount = -1
                       iLngKTotalValLen = 0
                    End If
                       
                    iTmpKBufferCount = iTmpKBufferCount + 1
                      
                    If iTmpKBufferCount > iTmpKBufferMaxCount Then                              '버퍼의 조정 증가치를 넘으면 
                       iTmpKBufferMaxCount = iTmpKBufferMaxCount + Parent.C_CHUNK_ARRAY_COUNT '버퍼 크기 증성 
                       ReDim Preserve iTmpKBuffer(iTmpKBufferMaxCount)
                    End If
                    iTmpKBuffer(iTmpKBufferCount) = iStrKey
                    iLngKTotalValLen = iLngKTotalValLen + Len(iStrKey)
...
'END HANC -----------------------------------------------------------------------------------
   ...
   ' 나머지 데이터 처리 
    ...
    If iTmpKBufferCount > -1 Then Call MakeTextArea("txtKSpread", iTmpKBuffer)
