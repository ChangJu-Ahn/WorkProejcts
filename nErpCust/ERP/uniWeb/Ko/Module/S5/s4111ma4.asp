...
'*  3. Program ID           : S4111MA4
'*  4. Program Name         : 일괄출고등록2
'*  5. Program Desc         :
'*  6. Comproxy List        : 
'*  7. Modified date(First) : 2003/04/14
'*  8. Modified date(Last)  : 2003/08/27
...
Const BIZ_PGM_ID = "s4111mb4.asp"											'☆: Head Query 비지니스 로직 ASP명 
...
<TABLE <%=LR_SPACE_TYPE_00%>>
					...
					<TD CLASS="CLSMTABP">
						<TABLE ID="MyTab" CELLSPACING=0 CELLPADDING=0 onclick="ClickTab1()">
							<TR>
								...
								<td background="../../../CShared/image/table/seltab_up_bg.gif" align="center" CLASS="CLSMTAB"><font color=white>일괄출고등록2</font></td>
						...
						<FIELDSET CLASS="CLSFLD">
							<TABLE <%=LR_SPACE_TYPE_40%>>
								<TR>
									...
									<TD CLASS="TD6" NOWRAP>
										<TABLE CELLSPACING=0 CELLPADDING=0>
											<TR>
												<TD>
													<script language =javascript src='./js/s4111ma4_fpDateTime1_txtConReqDateFrom.js'></script>
												</TD>
												<TD>
													&nbsp;~&nbsp;
												</TD>
												<TD>
													<script language =javascript src='./js/s4111ma4_fpDateTime2_txtConReqDateTo.js'></script>
												</TD>
											</TR>
										</TABLE>
									</TD>
								...
								<TR>
									...
									<TD CLASS=TD6 NOWRAP><INPUT NAME="txtConDnType" TYPE="Text" MAXLENGTH="3" SIZE=10 Alt="출하형태" tag="11XXXU"><IMG SRC="../../../CShared/image/btnPopup.gif" NAME="btnOpenPopUp" align=top TYPE="BUTTON" ONCLICK="vbscript:OpenConPopUp C_PopDnType">&nbsp;<INPUT NAME="txtConDnTypeNm" TYPE="Text" Alt="출하형태명" SIZE=25 tag="14"></TD>
									<TD CLASS=TD5 NOWRAP>납품처</TD>
									<TD CLASS=TD6><INPUT NAME="txtConShipToParty" TYPE="Text" Alt="납품처" MAXLENGTH=10 SiZE=10 tag="11XXXU"><IMG SRC="../../../CShared/image/btnPopup.gif" NAME="btnOpenPopUp" align=top TYPE="BUTTON" ONCLICK="vbscript:OpenConPopUp C_PopShipToParty">&nbsp;<INPUT NAME="txtConShipToPartyNm" TYPE="Text" Alt="납품처명" SIZE=25 tag="14"></TD>									
								</TR>
								<TR>	
									<TD CLASS=TD5 NOWRAP>영업그룹</TD>
									<TD CLASS=TD6><INPUT NAME="txtConSalesGrp" TYPE="Text" Alt="영업그룹" MAXLENGTH=4 SiZE=10 tag="11XXXU"><IMG SRC="../../../CShared/image/btnPopup.gif" NAME="btnOpenPopUp" align=top TYPE="BUTTON" ONCLICK="vbscript:OpenConPopUp C_PopSalesGrp">&nbsp;<INPUT NAME="txtConSalesGrpNm" TYPE="Text" Alt="영업그룹명" SIZE=25 tag="14"></TD>									
					...
					<TD WIDTH=100% HEIGHT=* VALIGN=TOP>
						<TABLE <%=LR_SPACE_TYPE_60%>>
							<TR>
								...
								<TD CLASS=TD6 NOWRAP><script language =javascript src='./js/s4111ma4_fpDateTime1_txtActualGIDt.js'></script></TD>
							...
							<TR>
								<TD HEIGHT="100%" WIDTH="100%" COLSPAN=4>
									<script language =javascript src='./js/s4111ma4_vaSpread1_vspdData.js'></script>
								</TD>
							</TR>
						</TABLE>					
					</TD>
	...
	<TR>
		<TD WIDTH=100% HEIGHT=<%=BizSize%>><IFRAME NAME="MyBizASP" SRC="../../blank.htm" WIDTH=100% HEIGHT=<%=BizSize%> FRAMEBORDER=0 SCROLLING=NO noresize framespacing=0 TABINDEX="-1"></IFRAME>
			<script language =javascript src='./js/s4111ma4_OBJECT1_vspdDataH.js'></script>
		</TD>
	</TR>
</TABLE>
...
<INPUT TYPE=HIDDEN NAME="txtHConReqDateFrom" tag="24" TABINDEX="-1">
<INPUT TYPE=HIDDEN NAME="txtHConReqDateTo" tag="24" TABINDEX="-1">
