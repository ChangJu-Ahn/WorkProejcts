...
'*  3. Program ID           : S4512MA1
'*  4. Program Name         : 출하요청내역등록
'*  5. Program Desc         :
...
<SCRIPT LANGUAGE="VBScript"   SRC="S4512ma1_KO441.vbs"></SCRIPT>
					...
					<TD CLASS="CLSMTABP">
						<TABLE ID="MyTab" CELLSPACING=0 CELLPADDING=0>
							<TR>
								...
								<td background="../../../CShared/image/table/seltab_up_bg.gif" align="center" CLASS="CLSMTAB"><font color=white>출하요청내역등록</font></td>
...
<!--					<TD>
					...
					<TD WIDTH=* Align=Right><a href = "vbscript:PgmJump(BIZ_PGM_JUMP_ID)" ONCLICK="VBSCRIPT:CookiePage 1">출하요청등록</a></TD>
					<TD WIDTH=10>&nbsp;</TD>
				</TR>
			</TABLE>
		</TD>
