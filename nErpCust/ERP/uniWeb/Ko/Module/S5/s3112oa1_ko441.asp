...
Sub SetDefaultVal()
	...
	If lgSOCd <> "" then 
		Call ggoOper.SetReqAttr(frm1.txtSales_org, "Q") 
        	frm1.txtSales_org.value = lgSOCd
	End If
	If lgPLCd <> "" then 
...
Function OpenConPop3()
	...
	If frm1.txtSales_org.className = "protected" Then Exit Function
	If IsOpenPop = True Then Exit Function
...
Dim vargBizArea,vargPlant,vargSalesGrp,vargSalesOrg
	...
	OBjName = AskEBDocumentName("s3112oa1_ko441","ebr")    
