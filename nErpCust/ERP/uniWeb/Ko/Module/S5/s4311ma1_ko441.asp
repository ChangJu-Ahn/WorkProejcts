...
<SCRIPT LANGUAGE="VBScript"   SRC="S4311ma1_ko441.vbs"></SCRIPT>
		...
		<TD WIDTH=100%>
			<TABLE <%=LR_SPACE_TYPE_10%>>
				<TR>
					...
					<TD CLASS="CLSMTABP">
						<TABLE ID="MyTab" CELLSPACING=0 CELLPADDING=0 onclick="ChangeTabs(TAB1)">
							<TR>
								...
								<td background="../../../CShared/image/table/seltab_up_bg.gif" align="center" CLASS="CLSMTAB"><font color=white>국내출고/반품</font></td>
					...
					<TD WIDTH=* align=right><A href="vbscript:OpenSODtlRef1">MES출고참조</A>&nbsp;<A href="vbscript:OpenSODtlRef2">MES반품입고참조</A>&nbsp;</TD>
					<TD WIDTH=10>&nbsp;</TD>
			    </TR>
			</TABLE>
		</TD>
...
<!--													<INPUT NAME="txtCurrency" TYPE="Text" MAXLENGTH="3" SIZE=10 tag="24XXXU" STYLE="text-transform:uppercase" CLASS="protected" READONLY="true" TABINDEX="-1" ALT="화폐">  -->
													<INPUT NAME="txtCurrency" TYPE="Text" MAXLENGTH="3" SIZE=10 tag="23XXXU" class=required STYLE="text-transform:uppercase" ALT="화폐"><IMG SRC="../../../CShared/image/btnPopup.gif" NAME="btnSoHDR" align=top TYPE="BUTTON"ONCLICK="vbscript:OpenOption 2">&nbsp; 
												</TD>
											</TR>
										</TABLE>
									</TD>
								...
								<TR>
									...
									<TD CLASS=TD6 NOWRAP>
										<SCRIPT LANGUAGE=JavaScript> ExternalWrite('<OBJECT CLASSID=<%=gCLSIDFPDS%> id=fpDoubleSingle2s NAME="txtXchg_rate" CLASS=FPDS140 tag="22X5Z" ALT = "환율" Title="FPDOUBLESINGLE"></OBJECT>');</SCRIPT>&nbsp;&nbsp; 
									</TD>
								</TR>
								<TR>
