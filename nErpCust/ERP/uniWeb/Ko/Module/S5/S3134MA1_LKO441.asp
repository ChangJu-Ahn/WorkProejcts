...
'*  3. Program ID           : s3134ma1_lko441
'*  4. Program Name         : 출고현황조회 (단가추가)
...
Const BIZ_PGM_ID        = "s3134mb1_lko441.asp"
...
'=========================================
Sub InitSpreadSheet()
	Call SetZAdoSpreadSheet("s3134ma1_lko441","S","A","V20030711", Parent.C_SORT_DBAGENT, frm1.vspdData, C_MaxKey, "X", "X" )
    Call SetSpreadLock 
End Sub
					...
					<TD CLASS="CLSMTABP">
						<TABLE ID="MyTab" CELLSPACING=0 CELLPADDING=0>
							<TR>
								...
								<td background="../../../CShared/image/table/seltab_up_bg.gif" align="center" CLASS="CLSMTAB"><font color=white>출고현황조회(S)</font></td>
