...
'*  3. Program ID           : S4512AA1																	*
'*  4. Program Name         : 수주내역참조																*
'*  5. Program Desc         : 출하요청내역등록을 위한 수주내역참조 (Business Logic Asp)						*
'*  6. Comproxy List        : 																			*
...
Const BIZ_PGM_QRY_ID = "s4512ab1.asp"			
...
Sub InitSpreadSheet()
	...
	With ggoSpread
		...
		.Source = vspdData
		.Spreadinit "V20050615",,PopupParent.gAllowDragDropSpread    

		vspdData.MaxCols = C_SO_DN_QTY + 1
		vspdData.MaxRows = 0
		...
		.SSSetFloat		C_Qty,"미출하요청수량" ,15,PopupParent.ggQtyNo,ggStrIntegeralPart, ggStrDeciPointPart,PopupParent.gComNum1000,PopupParent.gComNumDec,,,"Z"
		.SSSetFloat		C_BonusQty,"미출하요청덤수량" ,15,PopupParent.ggQtyNo,ggStrIntegeralPart, ggStrDeciPointPart,PopupParent.gComNum1000,PopupParent.gComNumDec,,,"Z"
		...
		.SSSetFloat		C_SO_DN_QTY,"미출고수량" ,15,PopupParent.ggQtyNo,ggStrIntegeralPart, ggStrDeciPointPart,PopupParent.gComNum1000,PopupParent.gComNumDec,,,"Z"
...
Function OpenConPopup(ByVal pvIntWhere)
	...
	Select Case pvIntWhere
		...
		Case C_PopSoNo
			...
			If UCase(txtSoNo.className) = "PROTECTED" Then Exit Function
					...
					<TR>
						...
						<TD CLASS=TD6>
							<TABLE CELLSPACING=0 CELLPADDING=0>
								<TR>
									<TD>
										<SCRIPT LANGUAGE=JavaScript> ExternalWrite('<OBJECT CLASSID=<%=gCLSIDFPDT%> id=fpDateTime1 NAME="txtFromDt" CLASS=FPDTYYYYMMDD tag="12X1" Alt="출고예정시작일" Title="FPDATETIME"></OBJECT>');</SCRIPT>
									</TD>
									<TD>
										&nbsp;~&nbsp;
									</TD>
									<TD>
										<SCRIPT LANGUAGE=JavaScript> ExternalWrite('<OBJECT CLASSID=<%=gCLSIDFPDT%> id=fpDateTime2 NAME="txtToDt" CLASS=FPDTYYYYMMDD tag="11X1" Alt="출고예정종료일" Title="FPDATETIME"></OBJECT>');</SCRIPT>
									</TD>
								</TR>
							</TABLE>
						</TD>								
