...
<% 
	...
	lgStrSQL = lgStrSQL & " select b.OUT_NO, " & vbcrlf _
		...
		& " ,b.ACTUAL_GI_DT,b.CUST_LOT_NO1 cust_lot_no ,a.SL_CD,b.TRANS_TIME,b.CREATE_TYPE,b.cust_lot_no rcpt_lot_no " & vbcrlf _
...
'수정본
	...
	For iDx = 0 To iLngCnt
		iStrData = Chr(11) & ConvSPChars(Trim(iArrExport(0, iDx))) _
			...
			& Chr(11) & UNINumClientFormat(iArrExport(9, iDx), ggQty.DecPoint, 0) _	
			& Chr(11) & UNINumClientFormat(iArrExport(10, iDx), ggQty.DecPoint, 0) _	
			& Chr(11) & ConvSPChars(Trim(iArrExport(11, iDx))) _	
			& Chr(11) & ConvSPChars(Trim(iArrExport(12, iDx))) _	
			& Chr(11) & ConvSPChars(Trim(iArrExport(13, iDx))) _	
			& Chr(11) & UNIDateClientFormat(iArrExport(14, iDx)) _	
			...
			& Chr(11) & ConvSPChars(Trim(iArrExport(15, iDx))) _	
			& Chr(11) & ConvSPChars(Trim(iArrExport(20, iDx))) _	
			& Chr(11) & UNINumClientFormat(iArrExport(21, iDx), ggQty.DecPoint, 0) _	
