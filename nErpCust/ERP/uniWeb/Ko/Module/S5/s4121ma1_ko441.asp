...
Const BIZ_PGM_ID        = "s4121mb1_ko441.asp"
Const C_MaxKey          = 80                                    '☆☆☆☆: Max key value
...
Sub InitSpreadSheet()
	...
	Call SetZAdoSpreadSheet("S4121MA1_ko441","S","A","V20030711", Parent.C_SORT_DBAGENT, frm1.vspdData, C_MaxKey, "X", "X" )
	With 	frm1.vspdData
	    .ColHeaderRows = 2
		...
		'Call .AddCellSpan(8,-1000, 1, 2) 

		Call .AddCellSpan(8,-1000, 3, 1)
		.Row = -1000 : .Col = 8 : .Text = "BUMP"
		Call .AddCellSpan(11,-1000, 3, 1)
		.Row = -1000 : .Col = 11 : .Text = "Laser Marking(LM)"
		Call .AddCellSpan(14,-1000, 3, 1)
		.Row = -1000 : .Col = 14 : .Text = "P-TEST"

		Call .AddCellSpan(17,-1000, 3, 1)
		.Row = -1000 : .Col = 17 : .Text = "ASSY"
		Call .AddCellSpan(20,-1000, 3, 1)
		.Row = -1000 : .Col = 20 : .Text = "BG"
		Call .AddCellSpan(23,-1000, 3, 1)
		.Row = -1000 : .Col = 23 : .Text = "FT"
...
Sub FormatSpreadCellByCurrency()
	Call ReFormatSpreadCellByCellByCurrency(frm1.vspdData,lgLngStartRow,frm1.vspdData.MaxRows,GetKeyPos("A",6),GetKeyPos("A",7),"A", "Q" ,"X","X")		
	Call ReFormatSpreadCellByCellByCurrency(frm1.vspdData,lgLngStartRow,frm1.vspdData.MaxRows,GetKeyPos("A",6),GetKeyPos("A",9),"A", "Q" ,"X","X")		
	...
	Call ReFormatSpreadCellByCellByCurrency(frm1.vspdData,lgLngStartRow,frm1.vspdData.MaxRows,GetKeyPos("A",6),GetKeyPos("A",12),"A", "Q" ,"X","X")		
	Call ReFormatSpreadCellByCellByCurrency(frm1.vspdData,lgLngStartRow,frm1.vspdData.MaxRows,GetKeyPos("A",6),GetKeyPos("A",13),"A", "Q" ,"X","X")		
	Call ReFormatSpreadCellByCellByCurrency(frm1.vspdData,lgLngStartRow,frm1.vspdData.MaxRows,GetKeyPos("A",6),GetKeyPos("A",15),"A", "Q" ,"X","X")		
	Call ReFormatSpreadCellByCellByCurrency(frm1.vspdData,lgLngStartRow,frm1.vspdData.MaxRows,GetKeyPos("A",6),GetKeyPos("A",16),"A", "Q" ,"X","X")		
	...
	Call ReFormatSpreadCellByCellByCurrency(frm1.vspdData,lgLngStartRow,frm1.vspdData.MaxRows,GetKeyPos("A",6),GetKeyPos("A",18),"A", "Q" ,"X","X")		
	Call ReFormatSpreadCellByCellByCurrency(frm1.vspdData,lgLngStartRow,frm1.vspdData.MaxRows,GetKeyPos("A",6),GetKeyPos("A",19),"A", "Q" ,"X","X")		
	Call ReFormatSpreadCellByCellByCurrency(frm1.vspdData,lgLngStartRow,frm1.vspdData.MaxRows,GetKeyPos("A",6),GetKeyPos("A",21),"A", "Q" ,"X","X")		
	Call ReFormatSpreadCellByCellByCurrency(frm1.vspdData,lgLngStartRow,frm1.vspdData.MaxRows,GetKeyPos("A",6),GetKeyPos("A",22),"A", "Q" ,"X","X")		
	Call ReFormatSpreadCellByCellByCurrency(frm1.vspdData,lgLngStartRow,frm1.vspdData.MaxRows,GetKeyPos("A",6),GetKeyPos("A",24),"A", "Q" ,"X","X")		
	Call ReFormatSpreadCellByCellByCurrency(frm1.vspdData,lgLngStartRow,frm1.vspdData.MaxRows,GetKeyPos("A",6),GetKeyPos("A",25),"A", "Q" ,"X","X")		
	Call ReFormatSpreadCellByCellByCurrency2(frm1.vspdData,lgLngStartRow,frm1.vspdData.MaxRows,parent.gCurrency,GetKeyPos("A",20),"A", "Q" ,"X","X")		
	Call ReFormatSpreadCellByCellByCurrency2(frm1.vspdData,lgLngStartRow,frm1.vspdData.MaxRows,parent.gCurrency,GetKeyPos("A",23),"A", "Q" ,"X","X")		
	Call ReFormatSpreadCellByCellByCurrency2(frm1.vspdData,lgLngStartRow,frm1.vspdData.MaxRows,parent.gCurrency,GetKeyPos("A",26),"A", "Q" ,"X","X")		
				...
				<TR>
					...
					<TD CLASS="CLSMTABP">
						<TABLE ID="MyTab" CELLSPACING=0 CELLPADDING=0>
							<TR>
								<td background="../../../CShared/image/table/seltab_up_bg.gif"><img src="../../../CShared/image/table/seltab_up_left.gif" width="9" height="30"></td>
								<td background="../../../CShared/image/table/seltab_up_bg.gif" align="center" CLASS="CLSMTAB"><font color=white>마감-출고현황조회<BR>(매그너칩양식)</font></td>
								<td background="../../../CShared/image/table/seltab_up_bg.gif" align="right"><img src="../../../CShared/image/table/seltab_up_right.gif" width="10" height="30"></td>
						    </TR>
						</TABLE>
					</TD>
									...
									<TD CLASS="TD6" NOWRAP>
										<TABLE CELLSPACING=0 CELLPADDING=0>
											<TR>
												...
												<TD>&nbsp;~&nbsp;</TD>
												<TD><SCRIPT LANGUAGE=JavaScript> ExternalWrite('<OBJECT CLASSID=<%=gCLSIDFPDT%> id=fpDateTime2 NAME="txtSoDtTo" CLASS=FPDTYYYYMMDD tag="12X1" Alt="출하종료일" Title="FPDATETIME"></OBJECT>');</SCRIPT></TD>
											</TR>
										</TABLE>
									</TD>
...
<INPUT TYPE=HIDDEN NAME="txtPlantCode" tag="24">
