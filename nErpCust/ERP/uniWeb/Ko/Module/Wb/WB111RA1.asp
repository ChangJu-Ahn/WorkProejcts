...
'*  3. Program ID           : WB111RA1
'*  4. Program Name         : WB111RA1.asp
'*  5. Program Desc         : ERP계정 조회 팝업 
...
'========================================================================================================
Const BIZ_PGM_ID 		= "wb111rb1.asp"                              '☆: Biz Logic ASP Name
...
Sub SetDefaultVal()
    ...
    frm1.txtCO_CD.value	= arrParam(0)		'법인코드 
    frm1.txtCO_NM.value	= arrParam(1)		'법인명 
	frm1.txtFISC_YEAR.text	= arrParam(2)		'사업연도 
	frm1.cboREP_TYPE.Value	= arrParam(3)		'신고구분 
	frm1.txtSpread.Value = arrParam(4)			' 계정코드	
...
Sub InitComboBox()
	...
	'------ Developer Coding part (Start ) -------------------------------------------------------------- 
	Dim IntRetCD1
	call CommonQueryRs("MINOR_CD,MINOR_NM"," dbo.ufn_TB_MINOR('W1018', '" & frm1.txtFISC_YEAR.text & "') "," ",lgF0,lgF1,lgF2,lgF3,lgF4,lgF5,lgF6)
...
Sub InitSpreadSheet()
	...
	With frm1.vspdData
		...
		.OperationMode = 5
		.MaxCols = C_W1_NM + 1							'☜: 최대 Columns의 항상 1개 증가시킴 
			...
			<FIELDSET CLASS="CLSFLD">
				<TABLE <%=LR_SPACE_TYPE_40%>>
					<TR>
						...
						<TD CLASS="TD6"><script language =javascript src='./js/wb111ra1_txtFISC_YEAR_txtFISC_YEAR.js'></script></TD>
						<TD CLASS="TD5">법인명</TD>
	...
	<TR HEIGHT=100%>
		<TD WIDTH=100% HEIGHT=* VALIGN=TOP>
			<TABLE <%=LR_SPACE_TYPE_20%>>
				<TR HEIGHT=100%>
					<TD WIDTH=100%>
						<script language =javascript src='./js/wb111ra1_I778301799_vspdData.js'></script>
					</TD>
				</TR>
			</TABLE>
		</TD>
...
<TEXTAREA CLASS="hidden" NAME="txtSpread" tag="14" style="display:'none'"></TEXTAREA>
<INPUT TYPE=HIDDEN NAME="lgPageNo"     TAG="14">
<INPUT TYPE=HIDDEN NAME="lgMaxCount" tag="14">
</FORM>
