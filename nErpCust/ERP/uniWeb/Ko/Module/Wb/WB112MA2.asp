...
Const BIZ_PGM_ID = "WB112MB2.asp"											 '☆: 비지니스 로직 ASP명 
...
Sub InitSpreadSheet()
   ...
   'patch version
    ...
    ggoSpread.ClearSpreadData
			...
			ggoSpread.SSSetEdit     C_MAP_CD, "맵핑코드", 10,,,100,1
			ggoSpread.SSSetEdit     C_MAP_NM, "맵핑계정명",   30,,,100,1
   ...
   'patch version
    ...
    ggoSpread.ClearSpreadData
		...
		ggoSpread.SSSetEdit     C_ACCT_NM, "계정명",   30,,,100,1
		ggoSpread.SSSetEdit     C_ACCT_GP_CD, "대표계정", 10,,,100,1
		ggoSpread.SSSetButton   C_ACCT_GP_POP
		ggoSpread.SSSetEdit     C_ACCT_GP_NM, "대표계정명",   30,,,100,1
...
Function  OpenPopUp(Byval strCode, Byval iWhere)
	...
	Select Case iWhere
		...
		Case 3
			...
			elseif  Trim(frm1.cboACCT.value) = "06" then
					 arrParam(4) = "MAJOR_CD = 'W1084'"	      
			elseif  Trim(frm1.cboACCT.value) = "07" then
					 arrParam(4) = "MAJOR_CD = 'W1085'"	
			elseif  Trim(frm1.cboACCT.value) = "34" then
...
<TABLE <%=LR_SPACE_TYPE_00%>>
						...
						<FIELDSET CLASS="CLSFLD">
							<TABLE <%=LR_SPACE_TYPE_40%>>
								<TR>
									...
									<TD CLASS="TD6"><script language =javascript src='./js/wb112ma2_txtFISC_YEAR_txtFISC_YEAR.js'></script>
									<TD CLASS="TD5">법인명</TD>
				...
				<TR>
					<TD WIDTH=100% HEIGHT=* valign=top>
						<TABLE <%=LR_SPACE_TYPE_20%>>
							<TR HEIGHT="100%">
								<TD WIDTH=35%>
									<script language =javascript src='./js/wb112ma2_vaSpread1_vspdData0.js'></script>
								</TD>
								<TD WIDTH=65%>
									<TABLE <%=LR_SPACE_TYPE_20%>>
									<TR>
										<TD HEIGHT=100%>
										<script language =javascript src='./js/wb112ma2_vaSpread2_vspdData1.js'></script>
										</TD>
									</TR>
	...
	<TR>
		<TD WIDTH=100% HEIGHT=<%=100%>><IFRAME NAME="MyBizASP" SRC="" WIDTH=100% HEIGHT=<%=100%> FRAMEBORDER=0 SCROLLING=YES noresize framespacing=0></IFRAME>
		</TD>
	</TR>
</TABLE>
