...
'*  5. Program Desc         : Local L/C Amend 등록을 위한 Local L/C Amend번호 
...
Option Explicit                              '☜: indicates that All variables must be declared in advance
	...
	Const BIZ_PGM_ID 		= "m3221pb2_KO441.asp"                              '☆: Biz Logic ASP Name
...
Function FncQuery() 
	...
	With frm1
		if (UniConvDateToYYYYMMDD(.txtAmendReqFrDt.text,gDateFormat,"") > UniConvDateToYYYYMMDD(.txtAmendReqToDt.text,gDateFormat,"")) and Trim(.txtAmendReqFrDt.text)<>"" and Trim(.txtAmendReqToDt.text)<>"" then	
			Call DisplayMsgBox("17a003", "X","AMEND신청일", "X")			
    ...
    With frm1
		If lgIntFlgMode = PopupParent.OPMD_UMODE Then		
			strVal = BIZ_PGM_ID & "?txtMode=" & PopupParent.UID_M0001						'☜: 비지니스 처리 ASP의 상태	
																				'☆: 조회 조건 데이타 
		    strVal = strVal & "&txtBeneficiary=" & Trim(.txtHBeneficiary.value)	'수출자 
		    strVal = strVal & "&txtAmendReqFrDt=" & Trim(.txtHAmendReqFrDt.Value)		'신청일 
        ...
        Else
			...
			strVal = strVal & "&txtAmendReqFrDt=" & Trim(.txtAmendReqFrDt.Text)	'신청일 
			...
			<FIELDSET CLASS="CLSFLD">
				<TABLE <%=LR_SPACE_TYPE_40%>>
					<TR>
						...
						<TD CLASS=TD6 NOWRAP><INPUT TYPE=TEXT NAME="txtBeneficiary" SIZE=10  MAXLENGTH=10 TAG="11XXXU" ALT="수혜자" ><IMG SRC="../../../CShared/image/btnPopup.gif" NAME="btnBeneficiary" align=top TYPE="BUTTON" onclick="vbscript:OpenConSItemDC()">&nbsp;<INPUT TYPE=TEXT NAME="txtBeneficiaryNm" SIZE=20 TAG="14"></TD>
