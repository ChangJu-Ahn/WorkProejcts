...
'*  2. Function Name        : 
'*  3. Program ID           : M3211QA2
'*  4. Program Name         :
'*  5. Program Desc         : LC상세 조회 
'*  6. Comproxy List        : 
...
Const BIZ_PGM_ID 	= "m3211qb2_KO441.asp"                     
Const BIZ_PGM_JUMP_ID1 	= "m3211ma1"                     
...
Sub InitSpreadSheet()
    Call SetZAdoSpreadSheet("M3211QA2","S","A","V20030410", Parent.C_SORT_DBAGENT, frm1.vspdData, C_MaxKey, "X", "X" )
					...
					<TD CLASS="CLSMTABP">
						<TABLE ID="MyTab" CELLSPACING=0 CELLPADDING=0>
							<TR>
								...
								<td background="../../../CShared/image/table/seltab_up_bg.gif" align="center" CLASS="CLSMTAB"><font color=white>L/C상세</font></td>
								...
								<TR>						   
									...
									<TD CLASS="TD6" NOWRAP>
										<table cellspacing=0 cellpadding=0>
											<tr>
												<td>
													<script language =javascript src='./js/m3211qa2_fpDateTime2_txtFrDt.js'></script>
												</td>
												<td>~</td>
												<td>
													<script language =javascript src='./js/m3211qa2_fpDateTime2_txtToDt.js'></script>
												</td>
											<tr>
										</table>
									</TD>
								...
								<TR>
                                    ...
                                    <TD CLASS="TD6" NOWRAP>
                                               <TABLE CELLSPACING=0 CELLPADDING=0 > 
                                                     <TR>
                                                        <TD NOWRAP>           
                                                           <script language =javascript src='./js/m3211qa2_fpDoubleSingle1_txtTLCQty.js'></script>
									                    </TD><!--<TD>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</TD><TD>  
									                       <script language =javascript src='./js/m3211qa2_fpDoubleSingle1_txtTLCAmt.js'></script>
									                    </TD>-->
									                 </TR>
									           </TABLE>
									 </TD>                  
				...
				<TR>
					<TD WIDTH=100% HEIGHT=* valign=top>
						<TABLE <%=LR_SPACE_TYPE_20%>>
							<TR>
								<TD HEIGHT="100%">
									<script language =javascript src='./js/m3211qa2_vaSpread1_vspdData.js'></script>
								</TD>
							</TR>
						</TABLE>
					</TD>
    ...
    <TR HEIGHT="20">
		<TD WIDTH="100%">
			<TABLE <%=LR_SPACE_TYPE_30%>>
				<TR>	
					<TD WIDTH=10>&nbsp;</TD>
					<TD WIDTH="*" ALIGN="RIGHT"><a ONCLICK="VBSCRIPT:CookiePage(2)">L/C 등록</a></a></TD>
					<TD WIDTH=10>&nbsp;</TD>
				</TR>
			</TABLE>
		</TD>
