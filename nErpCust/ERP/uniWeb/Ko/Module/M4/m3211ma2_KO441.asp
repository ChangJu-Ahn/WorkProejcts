...
<Script Language="VBS">
	...
	Const BIZ_PGM_QRY_ID = "m3211mb5_KO441.asp"			
	Const BIZ_PGM_SAVE_ID = "m3211mb5_KO441.asp"			
	Const BIZ_PGM_DEL_ID = "m3211mb5_KO441.asp"			
	Const BIZ_PGM_POQRY_ID = "m3211mb8_KO441.asp"			
	Const BIZ_PGM_GRQRY_ID = "m3211mb8_KO441.asp"			
...
Function OpenPORef()
	...
	iCalledAspName = AskPRAspName("M3111RA3_KO441")		

	If gblnWinEvent = True Then Exit Function
	gblnWinEvent = True

	If Trim(iCalledAspName) = "" Then
		IntRetCD = DisplayMsgBox("900040", parent.VB_INFORMATION, "M3111RA3_KO441", "X")
		gblnWinEvent = False
		Exit Function
	End If
