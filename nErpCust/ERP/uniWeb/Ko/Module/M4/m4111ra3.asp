...
Function OpenConSItemDC(Byval iWhere)
 ...
 Select Case iWhere
 	...
 	Case 3
 		...
 		arrParam(3) = ""									' Name Cindition
 		arrParam(4) = ""									' Where Condition
 		arrParam(5) = "수입담당"						' TextBox 명칭 

 		arrField(0) = "PUR_GRP"								' Field명(0)
 		arrField(1) = "PUR_GRP_NM"							' Field명(1)

 		arrHeader(0) = "수입담당"						' Header명(0)
 		arrHeader(1) = "수입담당명"						' Header명(1)
...
Function DbQuery() 
 ...
 With frm1
 	...
 	If lgIntFlgMode = PopupParent.OPMD_UMODE Then
 		...
 		strVal = strVal & "&txtPayTerms=" & Trim(.txtHPayTerms.value)		<%'☆: 조회 조건 데이타 %>
 	...
 	Else
 		...
 		strVal = strVal & "&txtPayTerms=" & Trim(.txtPayTerms.value)		<%'☆: 조회 조건 데이타 %>
 		...
 		<FIELDSET CLASS="CLSFLD">
 			<TABLE <%=LR_SPACE_TYPE_40%>>
 				<TR>
 					...
 					<TD CLASS=TD6><INPUT TYPE=TEXT NAME="txtPayTerms" SIZE=10  MAXLENGTH=5 TAG="11XXXU" ALT="결제방법"><IMG SRC="../../../CShared/image/btnPopup.gif" NAME="btnPayTerms" align=top TYPE="BUTTON" onclick="vbscript:OpenConSItemDC 1">&nbsp;<INPUT TYPE=TEXT NAME="txtPayTermsNm" SIZE=20 TAG="14"></TD>
 				</TR>
 				<TR>
 					<TD CLASS=TD5>입고유형</TD>
 					<TD CLASS=TD6><INPUT TYPE=TEXT NAME="txtMvmtType" SIZE=10  MAXLENGTH=5 TAG="11XXXU" ALT="입고유형"><IMG SRC="../../../CShared/image/btnPopup.gif" NAME="btnMvmtType" align=top TYPE="BUTTON" onclick="vbscript:OpenConSItemDC 2">&nbsp;<INPUT TYPE=TEXT NAME="txtMvmtTypeNm" SIZE=20 TAG="14"></TD>
 					<TD CLASS=TD5>입고일</TD>
 					<TD CLASS=TD6 NOWRAP>
 				...
 				<TR>	
 					...
 					<TD CLASS=TD6 NOWRAP><INPUT TYPE=TEXT NAME="txtPurGrp" SIZE=10 MAXLENGTH=4 TAG="11XXXU" ALT="구매그룹"><IMG SRC="../../../CShared/image/btnPopup.gif" NAME="btnPurGrp" align=top TYPE="BUTTON" onclick="vbscript:OpenConSItemDC 3">&nbsp;<INPUT TYPE=TEXT NAME="txtPurGrpNm" SIZE=20 TAG="24"></TD>
 					<TD CLASS=TD5>발주형태</TD>
 					<TD CLASS=TD6><INPUT TYPE=TEXT NAME="txtPOType" SIZE=10  MAXLENGTH=5 TAG="11XXXU" ALT="발주형태"><IMG SRC="../../../CShared/image/btnPopup.gif" NAME="btnPOType" align=top TYPE="BUTTON" onclick="vbscript:OpenConSItemDC 4">&nbsp;<INPUT TYPE=TEXT NAME="txtPOTypeNm" SIZE=20 TAG="14"></TD>
 				</TR>
 			</TABLE>
 		</FIELDSET>
 	</TD>
