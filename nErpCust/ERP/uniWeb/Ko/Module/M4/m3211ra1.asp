...
'*  4. Program Name         :																			*
'*  5. Program Desc         : Open L/C Amend 등록(m3221ma1.asp)을 위한 L/C Reference ASP															*
...
Const BIZ_PGM_ID 		= "M3211rb1.asp"                              '☆: Biz Logic ASP Name
   		...
   		<FIELDSET CLASS="CLSFLD">
   			<TABLE CLASS="basicTB" CELLSPACING=0 HEIGHT=100%>
   				<TR>
   					...
   					<TD CLASS=TD6 NOWRAP><INPUT TYPE=TEXT Alt="구매그룹" NAME="txtGrp" SIZE=10 MAXLENGTH=4  tag="1XNXXU"><IMG SRC="../../../CShared/image/btnPopup.gif" NAME="btnGrp" align=top TYPE="BUTTON" onclick="vbscript:OpenConSItemDC 1">
   										 <INPUT TYPE=TEXT Alt="구매그룹" NAME="txtGrpNm" NAME="arrCond" tag="14X"></TD>
   				</TR>
   				<TR>
   					<TD CLASS=TD5 NOWRAP>결제방법</TD>
   					<TD CLASS=TD6 NOWRAP><INPUT TYPE=TEXT NAME="txtPayTerms" SIZE=10 MAXLENGTH=5 TAG="11XXXU" ALT="결제방법"><IMG SRC="../../../CShared/image/btnPopup.gif" NAME="btnPayTerms" align=top TYPE="BUTTON" onclick="vbscript:OpenConSItemDC 2">
   										 <INPUT TYPE=TEXT NAME="txtPayTermsNm" SIZE=20 TAG="14"></TD>
   					<TD CLASS=TD5 NOWRAP>가격조건</TD>
   					<TD CLASS=TD6 NOWRAP><INPUT TYPE=TEXT NAME="txtIncoterms" SIZE=10  MAXLENGTH=5 TAG="1XNXXU" ALT="가격조건"><IMG SRC="../../../CShared/image/btnPopup.gif" NAME="btnIncoterms" align=top TYPE="BUTTON" onclick="vbscript:OpenConSItemDC 3">
