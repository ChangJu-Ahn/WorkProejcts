...
'*  2. Function Name        :																			*
'*  3. Program ID           : m3221mb4.asp																*
'*  4. Program Name         :																			*
'*  5. Program Desc         : L/C Header Insert를 위한 L/C Header Data Query Transaction 처리용 ASP		*
...
Sub SubBizQuery()
 ...
 Dim iPM4G119 
   ...
   Dim E30_b_biz_partner 
	...
	'확인	.txtLCAmdNo.value = "<%=ConvSPChars(M32119.ExportMLcAmendHdrLcAmdNo)
	    Response.Write ".frm1.txtLCNo.value = """ & ConvSPChars(E18_m_lc_hdr(EA_m_lc_hdr_lc_no1)) & """" & vbCr
	    Response.Write ".frm1.txtLCDocNo.value = """ & ConvSPChars(E18_m_lc_hdr(EA_m_lc_hdr_lc_doc_no1)) & """" & vbCr
		Response.Write ".frm1.txtLCAmendSeq.value 	= """ & ConvSPChars(E18_m_lc_hdr(EA_m_lc_hdr_lc_amend_seq1)) + 1 & """" & vbCr	
		...
		Response.Write ".frm1.txtAmendAmt.Text = ""0"" " & vbCr
		...
		If cDate(uniConvDate(strDt)) <> cDate(uniConvDate(strDefDate)) Then
			Response.Write " .frm1.txtBeExpiryDt.text		= """ & strDt & """" & vbCr
			Response.Write " .frm1.txtAtExpiryDt.text		= """ & strDt & """" & vbCr
	    ...
	    Response.Write "If """ & ConvSPChars(E18_m_lc_hdr(EA_m_lc_hdr_transhipment1)) & """  = ""Y"" Then " & vbCr
			Response.Write ".frm1.txtBeTranshipment.Value = ""Y"" " & vbCr
		Response.Write "ElseIf """ & ConvSPChars(E18_m_lc_hdr(EA_m_lc_hdr_transhipment1)) & """  = ""N"" Then " & vbCr
			Response.Write ".frm1.txtBeTranshipment.Value = ""N"" " & vbCr
		Response.Write "end if " & vbCr

		Response.Write "If """ & ConvSPChars(E18_m_lc_hdr(EA_m_lc_hdr_partial_ship1)) & """  = ""Y"" Then " & vbCr
			Response.Write ".frm1.txtBePartialShip.Value = ""Y"" " & vbCr
		Response.Write "ElseIf """ & ConvSPChars(E18_m_lc_hdr(EA_m_lc_hdr_partial_ship1)) & """  = ""N"" Then " & vbCr
			Response.Write ".frm1.txtBePartialShip.Value = ""N"" " & vbCr
		Response.Write "end if " & vbCr

		Response.Write "If """ & ConvSPChars(E18_m_lc_hdr(EA_m_lc_hdr_transfer1)) & """  = ""Y"" Then " & vbCr
			Response.Write ".frm1.txtBeTransfer.Value = ""Y"" " & vbCr
		Response.Write "ElseIf """ & ConvSPChars(E18_m_lc_hdr(EA_m_lc_hdr_transfer1)) & """  = ""N"" Then " & vbCr
			Response.Write ".frm1.txtBeTransfer.Value = ""N"" " & vbCr
		Response.Write "end if " & vbCr
...
'		Response.Write "end if " & vbCr
		...
		Response.Write " .frm1.txtXchRt.text  = """ & UNINumClientFormat(E18_m_lc_hdr(EA_m_lc_hdr_xch_rate1), ggExchRate.DecPoint, 0) & """" & vbCr
	    Response.Write " .frm1.txtBeTransport.value  = """ & ConvSPChars(E18_m_lc_hdr(EA_m_lc_hdr_transport1)) & """" & vbCr
		Response.Write " .frm1.txtAtTransport.value  = """ & ConvSPChars(E18_m_lc_hdr(EA_m_lc_hdr_transport1)) & """" & vbCr
	   
	    Response.Write " .frm1.txtBeTransportNm.value  = """ & ConvSPChars(E11_b_minor(1)) & """" & vbCr
	    Response.Write " .frm1.txtAtTransportNm.value  = """ & ConvSPChars(E11_b_minor(1)) & """" & vbCr
	    Response.Write " .frm1.txtBeLoadingPort.value  = """ & ConvSPChars(E18_m_lc_hdr(EA_m_lc_hdr_loading_port1  )) & """" & vbCr
	    Response.Write " .frm1.txtAtLoadingPort.value  = """ & ConvSPChars(E18_m_lc_hdr(EA_m_lc_hdr_loading_port1  )) & """" & vbCr
	    Response.Write " .frm1.txtBeLoadingPortNm.value  = """ & ConvSPChars(E10_b_minor(1))  & """" & vbCr
	    Response.Write " .frm1.txtAtLoadingPortNm.value  = """ & ConvSPChars(E10_b_minor(1))  & """" & vbCr
	    Response.Write " .frm1.txtBeDischgePort.value  = """ & ConvSPChars(E18_m_lc_hdr(EA_m_lc_hdr_dischge_port1  )) & """" & vbCr
	    Response.Write " .frm1.txtAtDischgePort.value  = """ & ConvSPChars(E18_m_lc_hdr(EA_m_lc_hdr_dischge_port1  )) & """" & vbCr
	    Response.Write " .frm1.txtBeDischgePortNm.value  = """ & ConvSPChars(E9_b_minor(1)) & """" & vbCr
	    Response.Write " .frm1.txtAtDischgePortNm.value  = """ & ConvSPChars(E9_b_minor(1)) & """" & vbCr
	    
	    Response.Write " .frm1.txtCurrency.value  = """ & ConvSPChars(E18_m_lc_hdr(EA_m_lc_hdr_currency1  )) & """" & vbCr
   
	    'Response.Write " .frm1.txtBeDocAmt.text  = """ & UNINumClientFormat(E18_m_lc_hdr(EA_m_lc_hdr_doc_amt1 ), ggAmtOfMoney.DecPoint, 0) & """" & vbCr
	    'Response.Write " .frm1.txtAtDocAmt.text  = """ & UNINumClientFormat(E18_m_lc_hdr(EA_m_lc_hdr_doc_amt1), ggAmtOfMoney.DecPoint, 0) & """" & vbCr
		...
		strDt = UNIDateClientFormat(E18_m_lc_hdr(M445_E17_open_dt))
