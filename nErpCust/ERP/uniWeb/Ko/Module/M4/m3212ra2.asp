...
'*  3. Program ID           : M3212RA2																	*
'*  4. Program Name         : LOCAL L/C 내역 참조																*
'*  5. Program Desc         : Local L/C Amend 내역등록을 위한 LOCAL L/C 내역 참조 (Business Logic Asp)	*
'*  6. Comproxy List        : M32128ListLcDtlSvr														*
...
Const BIZ_PGM_ID 		= "m3212rb2.asp"                              '☆: Biz Logic ASP Name
...
Sub SetDefaultVal()
	...
	With frm1
		.txtLCDocNo.Value 		= arrParam(0)
		.txtLCAmendSeq.Value 	= arrParam(1)
		.txtPurGrp.Value 		= arrParam(2)
		.txtPurGrpNm.value 		= arrParam(3)
		.txtBeneficiary.value 	= arrParam(4)
		.txtBeneficiaryNm.value	= arrParam(5)
		.txtCurrency.value		= arrParam(6)
		.txtPayTerms.value 		= arrParam(7)
		.txtPayTermsNm.value 	= arrParam(8)
		.txtLCNo.value 			= arrParam(9)
...
'=================================  InitSpreadSheet()  ======================================================
Sub InitSpreadSheet()
	Call SetZAdoSpreadSheet("m3212ra2","S","A","V20030410",PopupParent.C_SORT_DBAGENT,frm1.vspdData, _
									C_MaxKey, "X","X")
	Call SetSpreadLock 	    
End Sub
'=================================  SetSpreadLock()  ======================================================
...
Function DbQuery()
	...
	If lgIntFlgMode = PopupParent.OPMD_UMODE Then
		strVal = BIZ_PGM_ID & "?txtMode=" & PopupParent.UID_M0001		<%'☜: 비지니스 처리 ASP의 상태 %>
																		<%'☆: 조회 조건 데이타 %>
		strVal = strVal & "&txtLCNo=" & Trim(.txtHLCNo.value)			<%'L/C관리번호 %>
 ...
 <TR>
 	<TD WIDTH=100% HEIGHT=* valign=top>
 		<TABLE <%=LR_SPACE_TYPE_20%>>
 			<TR>
 				<TD HEIGHT="100%">
 					<script language =javascript src='./js/m3212ra2_vaSpread1_vspdData.js'></script>
 				</TD>
 			</TR>
 		</TABLE>
 	</TD>
...
<INPUT TYPE=HIDDEN NAME="txtLCNo" TAG="14">
