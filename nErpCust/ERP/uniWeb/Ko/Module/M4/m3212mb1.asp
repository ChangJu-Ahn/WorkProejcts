...
Sub SubBizQuery()
    ...
    If Request("txtMaxRows") = 0 Then
		...
		Response.Write ".hdnPONo.value 			= """ & ConvSPChars(E18_m_lc_hdr(EA_m_lc_hdr_po_no1)) & """" & vbCr
		Response.Write ".hdnPayMethCd.value 	= """ & ConvSPChars(E18_m_lc_hdr(EA_m_lc_hdr_pay_method1)) & """" & vbCr
		Response.Write ".hdnPayMethNm.value 	= """ & ConvSPChars(E12_b_minor(1)) & """" & vbCr
		Response.Write ".hdnIncotermsCd.value 	= """ & ConvSPChars(E18_m_lc_hdr(EA_m_lc_hdr_incoterms1)) & """" & vbCr
		'Response.Write ".hdnIncotermsNm.value 	= """ & iif(ConvSPChars(E16_b_minor(1) = Null, "", E16_b_minor(1))) & """" & vbCr
		Response.Write ".hdnIncotermsNm.value 	= """ & ConvSPChars(E13_b_minor(1)) & """" & vbCr
		Response.Write ".hdnGrpCd.value 		= """ & ConvSPChars(E25_b_pur_grp(M476_E25_pur_grp)) & """" & vbCr
		Response.Write ".hdnGrpNm.value 		= """ & ConvSPChars(E25_b_pur_grp(M476_E25_pur_grp_nm)) & """" & vbCr
	...
	For iLngRow = 0 To UBound(EG1_export_group,1)
		...
		lngPORemain = ConvSPChars(EG1_export_group(iLngRow, M474_EG1_E3_m_pur_ord_dtl_po_qty)) - ConvSPChars(EG1_export_group(iLngRow, M474_EG1_E3_m_pur_ord_dtl_lc_qty))
		
		istrData = istrData & Chr(11) & ConvSPChars(EG1_export_group(iLngRow, M474_EG1_E4_m_lc_dtl_lc_seq)) 												'9
		istrData = istrData & Chr(11) & ConvSPChars(EG1_export_group(iLngRow, M474_EG1_E5_b_item_item_cd))												'1
		istrData = istrData & Chr(11) & ConvSPChars(EG1_export_group(iLngRow, M474_EG1_E5_b_item_item_nm))
		istrData = istrData & Chr(11) & ConvSPChars(EG1_export_group(iLngRow, M474_EG1_E5_b_item_spec))												'2
		istrData = istrData & Chr(11) & ConvSPChars(EG1_export_group(iLngRow, M474_EG1_E4_m_lc_dtl_unit))												'3
		istrData = istrData & Chr(11) & UNINumClientFormat(EG1_export_group(iLngRow, M474_EG1_E4_m_lc_dtl_qty), ggQty.DecPoint, 0)
		
		istrData = istrData & Chr(11) & UNIConvNumDBToCompanyByCurrency(EG1_export_group(iLngRow, M474_EG1_E4_m_lc_dtl_price), lgCurrency, ggUnitCostNo,"X" ,"X")
		'istrData = istrData & Chr(11) &  UNINumClientFormat(EG1_export_group(iLngRow, M474_EG1_E4_m_lc_dtl_price), ggAmtOfMoney.DecPoint, 0)
		
		istrData = istrData & Chr(11) & UNIConvNumDBToCompanyByCurrency(EG1_export_group(iLngRow, M474_EG1_E4_m_lc_dtl_doc_amt),lgCurrency,ggAmtOfMoneyNo,"X" ,"X")
		'istrData = istrData & Chr(11) &  UNINumClientFormat(EG1_export_group(iLngRow, M474_EG1_E4_m_lc_dtl_doc_amt), ggAmtOfMoney.DecPoint, 0)
        
		istrData = istrData & Chr(11) & UNINumClientFormat(lngPORemain, ggQty.DecPoint, 0)												'5
		istrData = istrData & Chr(11) & ConvSPChars(EG1_export_group(iLngRow, M474_EG1_E4_m_lc_dtl_hs_cd))												'7
		istrData = istrData & Chr(11) & ConvSPChars(EG1_export_group(iLngRow, M474_EG1_E6_b_hs_code_hs_nm))												'8
		istrData = istrData & Chr(11) & ConvSPChars(EG1_export_group(iLngRow, M474_EG1_E2_m_pur_ord_hdr_po_no))											'10
		istrData = istrData & Chr(11) & ConvSPChars(EG1_export_group(iLngRow, M474_EG1_E3_m_pur_ord_dtl_po_seq_no))											'11
		istrData = istrData & Chr(11) & UNINumClientFormat(EG1_export_group(iLngRow, M474_EG1_E4_m_lc_dtl_over_tolerance), ggExchRate.DecPoint, 0)		'12
		istrData = istrData & Chr(11) & UNINumClientFormat(EG1_export_group(iLngRow, M474_EG1_E4_m_lc_dtl_under_tolerance), ggExchRate.DecPoint, 0)		'13
		istrData = istrData & Chr(11) & ConvSPChars(EG1_export_group(iLngRow, M474_EG1_E4_m_lc_dtl_bl_qty))
