...
Sub FixUNISQLData()
	...
	UNISqlId(0) = "M4111RA301"												' main query(spread sheet에 뿌려지는 query statement)
    UNISqlId(1) = "S0000QA002"	'수출자 
    UNISqlId(2) = "S0000QA022"	'구매그룹(수입담당)
    UNISqlId(3) = "S0000QA000"	'결제방법 
    UNISqlId(4) = "s0000qa020"	'발주형태 
	UNISqlId(5) = "s0000qa023"	'입고형태 
	...
	UNIValue(2,0) = FilterVar(Trim(UCase(Request("txtPurGrp"))), " " , "S") 					'구매그룹 
	UNIValue(3,0) = FilterVar("B9004""))), " " , "S")																		'결제방법(Major_cd)
	UNIValue(3,1) = FilterVar(Trim(UCase(Request("txtPayTerms"))), " " , "S")					'결제방법 
	UNIValue(4,0) = FilterVar(Trim(UCase(Request("txtPOType"))), " " , "S") 					'발주형태 
	UNIValue(5,0) = FilterVar(Trim(UCase(Request("txtMvmtType"))), " " , "S") 				'입고형태 
