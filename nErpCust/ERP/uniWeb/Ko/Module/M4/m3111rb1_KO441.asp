...
Sub FixUNISQLData()
	...
	UNISqlId(0) = "M3111RA101"												' main query(spread sheet에 뿌려지는 query statement)
	...
	If Len(Request("txtFrDt")) Then
		strVal =  strVal & " AND mhdr.PO_DT >=  " & FilterVar(UNIConvDate(Request("txtFrDt")), "''", "S") & ""
	End If	
	
	If Len(Request("txtToDt")) Then
		strVal =  strVal & " AND mhdr.PO_DT <=  " & FilterVar(UNIConvDate(Request("txtToDt")), "''", "S") & ""
	End If	
	...
	If Len(Trim(Request("txtIncoterms"))) Then
		strVal = strVal & " AND mhdr.INCOTERMS =  " & FilterVar(Trim(UCase(Request("txtIncoterms"))), " " , "S") & " "
	End If
	...
	If Len(Trim(Request("gPlant"))) Then
		strVal = strVal & " AND mdtl.PLANT_CD =  " & FilterVar(Trim(UCase(Request("gPlant"))), " " , "S") & " "
	End If
	...
	UNIValue(5,0) = FilterVar("B9006", " " , "S")												'가격조건(Major_cd)
	UNIValue(5,1) = FilterVar(Trim(UCase(Request("txtIncoterms"))), " " , "S")				'가격조건 
