...
Sub FixUNISQLData()
    ...
    If Len(Request("gBizArea")) Then		
		strVal = strVal & " AND A.BIZ_AREA = " & FilterVar(Trim(Request("gBizArea")), "''", "S") & " "			
	End If		
    If Len(Request("gPurGrp")) Then		
		strVal = strVal & " AND A.PUR_GRP = " & FilterVar(Trim(Request("gPurGrp")), "''", "S") & " "			
	End If		
    If Len(Request("gPurOrg")) Then		
		strVal = strVal & " AND A.PUR_ORG = " & FilterVar(Trim(Request("gPurOrg")), "''", "S") & " "			
	End If		
