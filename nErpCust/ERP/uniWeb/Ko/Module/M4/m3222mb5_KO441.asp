...
'---------------------------------- L/C Amend Header Data Query ----------------------------------
			...
			Response.Write ".txtTotDocAmt.text 	= """ & UNIConvNumDBToCompanyByCurrency(E18_m_lc_hdr(M445_E18_tot_amend_amt),ConvSPChars(E17_m_lc_amend_hdr(M445_E17_currency)),ggAmtOfMoneyNo,"X","X") & """" & vbCr
			...
			Response.Write ".txtPONO.value 			= """ & ConvSPChars(E18_m_lc_hdr(M445_E18_po_no)) & """" & vbCr	
			Response.Write ".txtHPurGrp.value 		= """ & ConvSPChars(E25_b_pur_grp(M445_E25_pur_grp)) & """" & vbCr	
			Response.Write ".txtHPurGrpNm.value 		= """ & ConvSPChars(E25_b_pur_grp(M445_E25_pur_grp_nm)) & """" & vbCr	
			Response.Write ".txtHPayTerms.value 		= """ & ConvSPChars(E18_m_lc_hdr(M445_E18_pay_method)) & """" & vbCr	
			Response.Write ".txtHPayTermsNm.value 		= """ & ConvSPChars(E8_b_minor_paymeth_nm) & """" & vbCr	
			Response.Write ".txtXchRate.value  		= """ & UNINumClientFormat(E17_m_lc_amend_hdr(M445_E17_at_xch_rate), ggExchRate.DecPoint, 0) & """" & vbCr	
			'에러수정(2003.05.30)
			Response.Write ".hdnDiv.value  		= """ & ConvSPChars(E18_m_lc_hdr(M445_E18_xch_rate_op)) & """" & vbCr	
			'**수정(2003.03.20)
		...
		str_txtLCAmdNo = Request("txtLCAmdNo")
   	  	...
   	  	Call iPM4G228.M_LIST_LC_AMEND_DTL_SVR(gStrGlobalCollection, _
		                                             C_SHEETMAXROWS_D, _
		 	                                         str_txtLCAmdNo, _
		 	                                         UNIConvNum(Request("lgStrPrevKey"),0), _
					                            	 EG1_export_group, _
					                            	 E1_m_lc_amend_dtl, _
					                            	 E2_m_lc_amend_dtl,_
					                            	 E3_m_lc_amend_dtl)
		...
		Else 
			If CheckSYSTEMError2(Err,True,"","","","","") = true then 		
				Set iPM4G228 = Nothing												'☜: ComProxy Unload
		...
		For iLngRow = 0 To UBound(EG1_export_group,1)
	        ...
	        istrData = istrData & Chr(11) & UNINumClientFormat(EG1_export_group(iLngRow, M443_EG1_E1_m_lc_amend_dtl_at_loc_amt), ggAmtOfMoney.DecPoint, 0)
