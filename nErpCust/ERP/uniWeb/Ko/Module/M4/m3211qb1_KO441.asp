...
'----------------------------------------------------------------------------------------------------------
 Sub FixUNISQLData()
    ...
    If Request("gBizArea") <> "" Then
        strSQL = " AND E.BIZ_AREA=" & FilterVar(Request("gBizArea"),"''","S")
    End If
    If Request("gPurGrp") <> "" Then
        strSQL = strSQL & " AND E.PUR_GRP=" & FilterVar(Request("gPurGrp"),"''","S")
    End If
    If Request("gPurOrg") <> "" Then
        strSQL = strSQL & " AND E.PUR_ORG=" & FilterVar(Request("gPurOrg"),"''","S")
    End If
     UNIValue(0,13) = strSQL
