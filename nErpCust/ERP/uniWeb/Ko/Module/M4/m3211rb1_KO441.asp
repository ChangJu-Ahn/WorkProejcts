...
Sub FixUNISQLData()
	...
	If Len(Trim(Request("gBizArea"))) Then
		strVal = strVal & " AND lhdr.BIZ_AREA =  " & FilterVar(Trim(UCase(Request("gBizArea"))), " " , "S") & " "
	End If

	If Len(Trim(Request("gPurGrp"))) Then
		strVal = strVal & " AND lhdr.PUR_GRP =  " & FilterVar(Trim(UCase(Request("gPurGrp"))), " " , "S") & " "
	End If

	If Len(Trim(Request("gPurOrg"))) Then
		strVal = strVal & " AND lhdr.PUR_ORG =  " & FilterVar(Trim(UCase(Request("gPurOrg"))), " " , "S") & " "
	End If

	If Len(Trim(Request("gPlant"))) Then
		strVal = strVal & " AND ldtl.PLANT_CD =  " & FilterVar(Trim(UCase(Request("gPlant"))), " " , "S") & " "
	End If
