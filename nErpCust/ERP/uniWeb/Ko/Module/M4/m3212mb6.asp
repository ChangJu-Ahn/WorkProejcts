...
'*  2. Function Name        :																			*
'*  3. Program ID           : m3212mb6.asp																*
'*  4. Program Name         :																			*
'*  5. Program Desc         : Import Local L/C 내역등록 Save Transaction 처리용 ASP						*
...
Sub SubBizSaveMulti()
	...
	If CheckSYSTEMError(Err,True) = True Then
		...
		Exit Sub
	End If
	str_txtLCNo = Request("txtLCNo")	
	
	Call iPM4G121.M_MAINT_LC_DTL_SVR(gStrGlobalCollection, str_txtLCNo, ,itxtSpread, _
									 , , iErrorPosition)
