...
Call PQIG310.Q_MAINT_INSP_RELEASE_SIMPLE_SVR(gstrGlobalCollection, "CONFIRM", IG1_q_inspection_result)

If CheckSystemError(Err,True) Then											'☜: ComProxy Unload
	Set PQIG310 = Nothing
%>
<Script Language=vbscript>
	Parent.DbConfirmReleaseNotOK
</Script>
<%
	Response.End														'☜: 비지니스 로직 처리를 종료함 
End If
