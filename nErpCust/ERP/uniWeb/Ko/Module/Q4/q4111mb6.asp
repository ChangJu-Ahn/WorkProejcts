...
'*  2. Function Name        : 
'*  3. Program ID           : Q4111MB4
'*  4. Program Name         : 검사의뢰번호 LookUp
'*  5. Program Desc         : 
'*  6. Component List       : 
...
With parent.frm1		
	...
	.txtInspClass.value = "<%=Trim(EG2_q_inspection_request(E2_common_insp_class_nm))%>"
	...
	.txtSpec.value = "<%=ConvSPChars(Trim(EG2_q_inspection_request(E2_common_item_spec)))%>"
	...
	.txtInspReqDt.Text = "<%=ConvSPChars(UniDateClientFormat(Trim(EG2_q_inspection_request(E2_common_insp_req_dt))))%>"
...
Call parent.LookUpInspReqNoOk("<%=Trim(EG2_q_inspection_request(E2_common_insp_class_cd))%>")
</Script>
