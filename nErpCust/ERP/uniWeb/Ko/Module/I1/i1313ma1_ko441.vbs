Const BIZ_PGM_QRY_ID    = "i1313mb1_ko441.asp"					
Const BIZ_PGM_DQRY_ID   = "i1313mb1_ko441.asp"					
Const BIZ_PGM_SAVE_ID   = "i1313mb2_ko441.asp"					
Const BIZ_PGM_DEL_ID    = "i1313mb3_ko441.asp"					
Const BIZ_PGM_LOOKUP_ID	= "i1313mb4_ko441.asp"					
...
Sub InitSpreadPosVariables()
	...
	C_ItemPopup       = 2
	C_ItemNm          = 3 
	C_EntryQty        = 4       '20080313::hanc
	C_TrnsItemCd      = 5   
	C_TrnsItemPopup   = 6
	C_EntryQtyAfter   = 7       '20080313::hanc
	C_EntryUnit       = 8 
	C_EntryUnitPopup  = 9 
	C_ItemSpec        = 10
	C_InvUnit         = 11
	C_TrackingNo      = 12
	C_TrackingNoPopup = 13 
	C_LotNo           = 14
	C_LotSubNo        = 15
	C_LotNoPopup      = 16
	C_TrnsLotNo       = 17
...
Sub SetDefaultVal()
	...
	frm1.txtMovType.Value      = "TX8"
	frm1.txtMovTypeNm.Value    = "재고이동(사업장+공장+품목+창고)네패스"
...
Dim iCurColumnPos
	...
	Select Case UCase(pvSpdNo)
		Case "A"
			...
			C_EntryQty        =iCurColumnPos(4)     '20080313::hanc
			C_TrnsItemCd      =iCurColumnPos(5)
			C_TrnsItemPopup   =iCurColumnPos(6)
		    C_EntryQtyAfter   =iCurColumnPos(7)  '20080313::hanc
			C_EntryUnit       =iCurColumnPos(8) 
			C_EntryUnitPopup  =iCurColumnPos(9) 
			C_ItemSpec        =iCurColumnPos(10)
			C_InvUnit         =iCurColumnPos(11)
			C_TrackingNo      =iCurColumnPos(12)
			C_TrackingNoPopup =iCurColumnPos(13)
			C_LotNo           =iCurColumnPos(14)
			C_LotSubNo        =iCurColumnPos(15)
			C_LotNoPopup      =iCurColumnPos(16)
			C_TrnsLotNo       =iCurColumnPos(17)
			C_TrnsLotSubNo    =iCurColumnPos(18)
			C_ItemStatus      =iCurColumnPos(19)
			C_TrnsPlantCd     =iCurColumnPos(20)
			C_TrnsSLCd        =iCurColumnPos(21)
			C_TrnsTrackingNo  =iCurColumnPos(22)
			C_SeqNo           =iCurColumnPos(23)
			...
			Select Case Trim(.Text)
				Case ggoSpread.InsertFlag, ggoSpread.UpdateFlag
					...
					If  UNICDbl(.Text) = 0 then
						...
						Exit function
                    End if
					strVal = strVal & Trim(.Text) & iRowSep					'20080313::hanc::이동후수량
