...
Dim E1_b_cost_center,            E2_b_cost_center_cost_nm , _
	...
	Const C_EG1_i_goods_movement_detail_entry_amt			= 17	'20090817::kimByungSang::이동금액
...
'============================================================================================================================    
    ...
    For LngRow = 0 To UBound(EG1_export_group,1)
		strData = Chr(11) & ConvSPChars(EG1_export_group(LngRow,C_EG1_b_item_item_cd)) & _
				  Chr(11) & "" & _
				  Chr(11) & ConvSPChars(EG1_export_group(LngRow,C_EG1_b_item_item_nm)) 

		'20090817::KimbyungSang::이동금액
		strData = strData & Chr(11) & UniConvNumberDBToCompany(EG1_export_group(LngRow,C_EG1_i_goods_movement_detail_entry_amt),ggAmtOfMoney.DecPoint, ggAmtOfMoney.RndPolicy, ggAmtOfMoney.RndUnit, 0)

		strData = strData & Chr(11) & UniConvNumberDBToCompany(EG1_export_group(LngRow,C_EG1_i_goods_movement_detail_entry_qty),ggQty.DecPoint,ggQty.RndPolicy, ggQty.RndUnit, 0) 
