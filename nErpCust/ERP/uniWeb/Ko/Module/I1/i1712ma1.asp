...
'*  2. Function Name        : Batch Posting 작업 (Monthly)
...
Const BIZ_PGM_QRY_ID  = "i1712mb1.asp"
Const BIZ_PGM_QRY2_ID = "i1712mb2.asp"
Const BIZ_PGM_ID      = "i1712mb3.asp"
...
Sub InitSpreadSheet()
	...
	With frm1.vspdData
		...
		ggoSpread.SSSetEdit		C_MovTypeNm,		"수불유형명",		40
...
Function OpenDept(Byval strCode, Byval iWhere)
	...
	arrParam(4) = "2"										' 결의일자 상태 Condition
	arrParam(5) = frm1.txtBizCd.Value						' 결의일자 상태 Condition		
...
Sub txtDeptCd_OnChange()
	...
	strWhere	= strWhere & " from b_acct_dept where org_change_dt <='" & UniConvDateToYYYYMMDD(frm1.GIDate.Text, Parent.gDateFormat,"") & "'))"			
...
Function OpenMoveDtlRef()
    ...
    If frm1.vspdData.MaxRows = 0 Then
		...
		Exit Function	
	Else
		frm1.vspdData.Col = C_TrnsType  : frm1.vspdData.Row = frm1.vspdData.ActiveRow : Param6 = Trim(frm1.vspdData.Text )
...
Sub txtDocumentDt_Change()
	...
	postmnth = frm1.txtDocumentDt.Text
	GlDate = UniGetLastDay(postmnth,Parent.gDateFormat)

	frm1.GIDate.Text = GlDate
End Sub
...
'	Dim iTmpCUBufferMaxCount
	...
	frm1.hCostFlag.value = strCostFlag
					...
					<TD CLASS="CLSMTABP">
						<TABLE ID="MyTab" CELLSPACING=0 CELLPADDING=0">
							<TR>
								...
								<TD BACKGROUND="../../../CShared/image/table/seltab_up_bg.gif" ALIGN="center" CLASS="CLSMTAB"><FONT COLOR=white>Batch Posting작업(Monthly)</FONT></TD>
										...
										<FIELDSET CLASS="CLSFLD">
											<TABLE <%=LR_SPACE_TYPE_40%>>
												...
												<TR>
													...
													<TD CLASS="TD6">
														<INPUT TYPE="RADIO" CLASS="RADIO" NAME="RadioOutputType" ID="rdoCase1" TAG="1X" checked><LABEL FOR="rdoCase2">재고</LABEL>
														<INPUT TYPE="RADIO" CLASS="RADIO" NAME="RadioOutputType" ID="rdoCase2" TAG="1X"><LABEL FOR="rdoCase1">원가보정</LABEL>
													</TD>
												</TR>
											</TABLE>
										</FIELDSET>
											...
											<TABLE <%=LR_SPACE_TYPE_40%>>
												<TR>
													...
													<TD CLASS="TD6"NOWRAP COLSPAN = 3>
														<SCRIPT LANGUAGE=JavaScript> ExternalWrite('<OBJECT CLASSID=<%=gCLSIDFPDT%> id=GIDate name=GIDate CLASS=FPDTYYYYMMDD title=FPDATETIME tag="12X1" ALT="전표일자"></OBJECT>');</SCRIPT></TD>
...
<TEXTAREA CLASS=HIDDEN NAME=txtSpread Width=100% tag="24" TABINDEX="-1"></TEXTAREA>
	...
	<INPUT TYPE=HIDDEN NAME="hCostFlag" tag="24" TABINDEX="-1">
