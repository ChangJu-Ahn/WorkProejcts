...
<%Option Explicit%>
<!--'**********************************************************************************************
'*  1. Module Name          : Batch Posting Ãë¼Ò asp
'*  2. Function Name        : 
...
<%	
	...
	If itxtSpread <> "" Then
		...
		Set iPI1G202 = Server.CreateObject("PI1G202.cIBchPostGoodMovSvrOld")

		'-----------------------
		'Com action result check area(OS,internal)
		'-----------------------
		If CheckSYSTEMError(Err,True) = True Then
		      Set iPI1G202 = Nothing			
			  Response.End						
		End If

		Call iPI1G202.I_BATCH_POST_GOODS_MOV_SVR_OLD(gStrGlobalCollection, _
