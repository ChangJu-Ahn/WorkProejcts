...
<SCRIPT LANGUAGE="VBScript"   SRC="i1311ma1.vbs"></SCRIPT>
		...
		<TD WIDTH=100%>
			<TABLE <%=LR_SPACE_TYPE_10%> WIDTH=100% border=0>
				<TR>
					...
					<TD WIDTH=* align=right><A ID="txtOpenGL1Title" STYLE="DISPLAY: none" href="vbscript:OpenPopupGL()">회계전표정보 | </A><A ID="txtOpenGL2Title" STYLE="DISPLAY: none" href="vbscript:OpenPopupGL2()">결의전표정보 | </A><A href="vbscript:OpenMoveInvRef()">사내재고이동정보| </A>
						...
						<FIELDSET CLASS="CLSFLD">
							<TABLE WIDTH=100% <%=LR_SPACE_TYPE_40%> >
								...
								<TR>
									...
									<TD CLASS="TD6" NOWRAP>
									<script language =javascript src='./js/i1311ma1_fpDateTime1_txtYear.js'></script>
									</TD>
								</TR>
							</TABLE>
						</FIELDSET>
					  ...
					  <TABLE <%=LR_SPACE_TYPE_60%>>
						<TR>
							...
							<TD CLASS="TD656" NOWRAP>
								<script language =javascript src='./js/i1311ma1_fpDateTime2_txtDocumentDt.js'></script>
							</TD>
						</TR>
						<TR>
							<TD CLASS="TD5" NOWRAP>회계전표일자</TD>
							<TD CLASS="TD656" NOWRAP>
								<script language =javascript src='./js/i1311ma1_fpDateTime3_txtPostingDt.js'></script>
							</TD>							
						</TR>
						<TR>
					...
					<TD HEIGHT=* VALIGN=TOP WIDTH=100%>
				          ...
				          <TR>
					           <TD WIDTH=100% HEIGHT=100% COLSPAN=4> 
						    	<script language =javascript src='./js/i1311ma1_I963957387_vspdData.js'></script>
							  </TD>
						 </TR>
						</TABLE>	
					</TD>
