Const BIZ_PGM_QRY_ID    = "i1231mb1.asp"							
Const BIZ_PGM_DQRY_ID   = "i1231mb1.asp"							
Const BIZ_PGM_SAVE_ID   = "i1231mb2.asp"							
...
Sub InitSpreadSheet()
	...
	With frm1.vspdData
		...
		ggoSpread.SSSetFloat		C_EntryAmount,			"출고금액", 15, Parent.ggAmtOfMoneyNo, ggStrIntegeralPart, ggStrDeciPointPart, Parent.gComNum1000, Parent.gComNumDec, , ,"Z"	
...
Sub GetSpreadColumnPos(ByVal pvSpdNo)
	...
	Select Case UCase(pvSpdNo)
		Case "A"
			...
			C_ProdOrdNo       = iCurColumnPos(15)
			C_ProdOrdNoPopUp  = iCurColumnPos(16)
			C_ReqNo			  = iCurColumnPos(17)
			C_SeqNo           = iCurColumnPos(18)
			C_SubSeqNo        = iCurColumnPos(19)
	End Select
...
Sub SetSpreadColor(ByVal pvStartRow, ByVal pvEndRow)
	...
	If UCase(frm1.txtMovType.value) = "ISU" Then
...
Function FncSave() 
	...
	'-----------------------
	'Check 후 Spread Clear
	'-----------------------		
	Call txtMovType_onchange()
