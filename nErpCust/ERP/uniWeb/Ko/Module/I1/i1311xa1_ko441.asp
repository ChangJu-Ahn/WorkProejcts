...
Const BIZ_PGM_QRY_ID = "i1311xb1_ko441.asp"			
...
'            C_PRICE          = 16
        	...
        	C_ITEM_SEQ              = 9       
        	C_ISSUE_REQ_NO          = 10    
        	C_req_dt                = 11        '20080305
            C_dept_cd               = 12
            C_dept_nm               = 13
            C_emp_no                = 14
            C_mov_type              = 15        '20080312::hanc
            C_emp_nm                = 16
...
'    		.SSSetFloat		C_PRICE                 , "단가" ,15,PopupParent.ggQtyNo,ggStrIntegeralPart, ggStrDeciPointPart,PopupParent.gComNum1000,PopupParent.gComNumDec,,,"Z"
    		...
    		Call .SSSetColHidden(C_ITEM_SEQ,C_ITEM_SEQ,True)
		...
		If iLngSelectedRows > 0 Then 
			...
			For intRowCnt = 1 To .MaxRows
				...
				If .SelModeSelected Then
					.Col = C_ITEM_CD        : arrReturn(intInsRow, 0) = .Text
					.Col = C_ITEM_NM        : arrReturn(intInsRow, 1) = .Text
					.Col = C_SPEC           : arrReturn(intInsRow, 2) = "*"
					.Col = C_REMIND_QTY     : arrReturn(intInsRow, 3) = .Text
					.Col = C_BASIC_UNIT     : arrReturn(intInsRow, 4) = .Text
					.Col = C_ISSUE_REQ_NO   : curr_ISSUE_REQ_NO = .Text
					.Col = C_ITEM_SEQ       : arrReturn(intInsRow, 5) = .Text
					.Col = C_ISSUE_REQ_NO   : arrReturn(intInsRow, 6) = .Text
					.Col = C_mov_type       : arrReturn(intInsRow, 7) = .Text
                ...
                before_ISSUE_REQ_NO     =   curr_ISSUE_REQ_NO
			Next
		End if			
	End With
...
Sub GetSpreadColumnPos(ByVal pvSpdNo)
    ...
    Select Case UCase(pvSpdNo)
       Case "A"
            ...
            C_PRODT_ORDER_NO        = iCurColumnPos(4)   
            C_BASIC_UNIT            = iCurColumnPos(5)   
            C_REQ_QTY               = iCurColumnPos(6)   
            C_ISSUE_QTY             = iCurColumnPos(7)   
            C_REMIND_QTY            = iCurColumnPos(8)   
            C_ITEM_SEQ              = iCurColumnPos(9)   
            C_ISSUE_REQ_NO          = iCurColumnPos(10)  
    		C_req_dt                = iCurColumnPos(11)  '20080305
    		C_dept_cd               = iCurColumnPos(12) 
    		C_dept_nm               = iCurColumnPos(13) 
    		C_emp_no                = iCurColumnPos(14) 
    		C_mov_type              = iCurColumnPos(15) '20080312::HANC 
    		C_emp_nm                = iCurColumnPos(16) 
					...
					<TR STYLE="DISPLAY:NONE">
						...
						<TD CLASS=TD6>
							<TABLE CELLSPACING=0 CELLPADDING=0>
								<TR>
									<TD>
										<script language =javascript src='./js/I1311xa1_ko441_fpDateTime1_txtFromDt.js'></script>
									</TD>
									<TD>
										&nbsp;~&nbsp;
									</TD>
									<TD>
										<script language =javascript src='./js/I1311xa1_ko441_fpDateTime2_txtToDt.js'></script>
									</TD>
								</TR>
							</TABLE>
						</TD>								
	...
	<TR>
		<TD WIDTH=100% HEIGHT=* valign=top>
			<TABLE <%=LR_SPACE_TYPE_20%>>
				<TR>
					<TD HEIGHT="100%">
						<script language =javascript src='./js/I1311xa1_ko441_vaSpread_vspdData.js'></script>
					</TD>
				</TR>
			</TABLE>
		</TD>
