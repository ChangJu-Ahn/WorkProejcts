...
'*  2. Function Name        : 수불장  출력 
'*  3. Program ID           : i1811oa1
'*  4. Program Name         :
'*  5. Program Desc         :
'*  6. Comproxy List        : 
'*  7. Modified date(First) : 2001/09/12
...
Function FncBtnPrint() 
    ...
    var6 = strYear1
    var7 = strMonth1
    var8 = "%" & Trim(frm1.txtTrackingNo.value) & "%"
    ...
    condvar = condvar & "|TRACKINGNO|"  & var8

	ObjName = AskEBDocumentName("i1811oa1", "ebr")
					...
					<TD>
						<TABLE ID="MyTab" CELLSPACING=0 CELLPADDING=0>
							<TR>
								...
								<TD background="../../../CShared/image/table/seltab_up_bg.gif" align="center" CLASS="CLSMTAB"><font color=white>수불장출력</font></TD>
					...
					<TD>
						<TABLE <%=LR_SPACE_TYPE_60%> >
							...
							<TR>
								...
								<TD CLASS="TD6">
								<script language =javascript src='./js/i1811oa1_I874346500_txtMovFrDt.js'></script>
								&nbsp;~&nbsp;
								<script language =javascript src='./js/i1811oa1_I271773815_txtMovToDt.js'></script>
								</TD>
							</TR>
							<TR>
								<TD CLASS="TD5">품목계정</TD>
								<TD CLASS="TD6">
								<input TYPE=TEXT NAME="txtItemAcct" SIZE="8" MAXLENGTH="2" tag="12XXXU" ALT="품목계정"  ><IMG align=top height=20 name="btnItemAcct" onclick="vbscript:OpenItemAcct()" src="../../../CShared/image/btnPopup.gif" width=16  TYPE="BUTTON">&nbsp;<INPUT TYPE=TEXT NAME="txtItemAcctNm" SIZE=30 MAXLENGTH=40 tag="14">
								</TD>
							</TR>
							<TR>
								<TD CLASS="TD5">품목</TD>
