Const BIZ_PGM_QRY_ID    = "i1312mb1_ko441.asp"					
Const BIZ_PGM_DQRY_ID   = "i1312mb1_ko441.asp"					
Const BIZ_PGM_SAVE_ID   = "i1312mb2_ko441.asp"					
Const BIZ_PGM_DEL_ID    = "i1311mb3_ko441.asp"					
Const BIZ_PGM_LOOKUP_ID	= "i1312mb4_ko441.asp"					
...
Sub SetDefaultVal()
	...
	frm1.txtMovType.Value      = "TX7"
	frm1.txtMovTypeNm.Value    = "재고이동(공장+품목+창고)네패스"
...
Function OpenItem2(Byval strCode)
	...
	arrParam(0) = Trim(frm1.txtPlantCd2.value)	       '2008-03-17 3:21오후 :: hanc
...
'HANC		Call .SetText(C_EntryUnit,	.ActiveRow, arrRet(3))
...
Function SetItem2(byRef arrRet)
	With frm1.vspdData
		...
		Call .SetText(C_EntryUnit,	.ActiveRow, arrRet(2))      'HANC
...
'HANC			Call .SetText(C_EntryUnit,Row, lgF2(0))
