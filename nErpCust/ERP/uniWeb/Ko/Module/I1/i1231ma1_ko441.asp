...
<SCRIPT LANGUAGE="VBScript"   SRC="i1231ma1_ko441.vbs"></SCRIPT>
				...
				<TD WIDTH=100%>
					<TABLE <%=LR_SPACE_TYPE_10%> WIDTH=100% border=0>
						<TR>
							...
							<TD WIDTH=* align=right><A href="vbscript:OpenMoveInvRef1()">자재불출의뢰정보| </A><A ID="txtOpenGL1Title" STYLE="DISPLAY: none" href="vbscript:OpenPopupGL()">회계전표정보 |</A>&nbsp;<A ID="txtOpenGL2Title" STYLE="DISPLAY: none" href="vbscript:OpenPopupGL2()">결의전표정보</A></TD>
						</TR>
					</TABLE>
				</TD>
			</TR>
									...
									<FIELDSET CLASS="CLSFLD">
										<TABLE WIDTH=100% <%=LR_SPACE_TYPE_40%>>
											...
											<TR>
												...
												<TD CLASS="TD6" NOWRAP>
													<script language =javascript src='./js/i1231ma1_ko441_fpDateTime1_txtYear.js'></script>
												</TD>
											</TR>
										</TABLE>
									</FIELDSET>
								...
								<TD WIDTH=100% VALIGN=top>
									<TABLE <%=LR_SPACE_TYPE_60%>>
										<TR>
											...
											<script language =javascript src='./js/i1231ma1_ko441_fpDateTime2_txtDocumentDt.js'></script>
											</TD>
										</TR>
										<TR>
											<TD CLASS="TD5" NOWRAP>회계전표일자</TD>
											<TD CLASS="TD656" NOWRAP>
											<script language =javascript src='./js/i1231ma1_ko441_fpDateTime3_txtPostingDt.js'></script>
											</TD>
										</TR>
										<TR>
										...
										<TR>
											...
											<TD CLASS="TD656" NOWRAP><INPUT NAME="txtDocumentText" ALT="불출의뢰번호" TYPE="Text"  CLASS=protected readonly=true MAXLENGTH="20" SIZE=20 tag="24"></TD>
										</TR>
						...
						<TABLE WIDTH="100%" <%=LR_SPACE_TYPE_20%>>
							<TR>
								<TD WIDTH=100% HEIGHT=100%>
									<script language =javascript src='./js/i1231ma1_ko441_OBJECT1_vspdData.js'></script>
								</TD>
							</TR>    
						</TABLE>
					</DIV>
