...
'*  3. Program ID           : I1231mb1.asp
'*  4. Program Name         : 기타출고 수불조회 
'*  5. Program Desc         : 기타출고 수불정보/상세정보를 조회한다.
'*  6. Comproxy List        :                           

'*  7. Modified date(First) : 2002/08/10
'*  8. Modified date(Last)  : 2002/08/10
...
Const C_EG1_i_goods_movement_detail_cost_cd						= 47
    ...
    I1_i_good_mvmt_header(C_I1_TrnsType)		= "OI"    
	...
	For LngRow = 0 To UBound(EG1_export_group,1)
		strData = Chr(11) & ConvSPChars(EG1_export_group(LngRow,C_EG1_b_item_item_cd)) & _
				  ...
				  Chr(11) & "" & _ 
				  Chr(11) & ConvSPChars(EG1_export_group(LngRow,C_EG1_i_goods_movement_detail_prodt_order_no)) & _  
				  Chr(11) & "" & _
				  Chr(11) & ConvSPChars(EG1_export_group(LngRow,C_EG1_i_goods_movement_detail_req_no)) & _ 
	...
	Response.Write ".frm1.txtWCCd.value           = """ & ConvSPChars(EG1_export_group(0,C_EG1_i_goods_movement_detail_wc_cd)) & """" & vbCr
	Response.Write ".frm1.txtWCNm.value           = """ & ConvSPChars(E8_p_work_center_wc_nm(0)) & """" & vbCr
