...
Err.Clear																	'☜: Protect system from crashing
	...
	End If
	IF Request("txtRefNo") = "" Then
		strRefNo = "|"
	Else
		strRefNo = " " & FilterVar(UCase(Request("txtRefNo")), "''", "S") & ""
	End IF
...
%>
				...
				& Chr(11) & "<%=ConvSPChars(rs0("TEMP_GL_NO"))%>" _
				& Chr(11) & "<%=ConvSPChars(rs0("GL_NO"))%>" _
...
%>	
	...
	Else
		...
		.frm1.hRefNo.value = "<%=ConvSPChars(Request("txtRefNo"))%>"
		.DbQueryOk()
	End If
