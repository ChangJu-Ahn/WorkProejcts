...
'*  2. Function Name        : Batch Posting 취소작업 
'*  3. Program ID           : i1721ma1
'*  4. Program Name         : 
'*  5. Program Desc         :
'*  6. Comproxy List        : 
...
Const BIZ_PGM_ID	= "i1721mb2.asp"
Const BIZ_LOOKUP_ID = "i1721mb1.asp"
...
Sub SetDefaultVal()
	frm1.txtBizCd.focus 
	frm1.txtDocumentFrDt.Text	= StartDate
	frm1.txtDocumentToDt.Text	= EndDate
End Sub
...
Sub InitSpreadSheet()
	...
	With frm1.vspdData
		...
		ggoSpread.SSSetDate		C_DocumentDt,		"수불발생일",		12,2,Parent.gDateFormat
	 	ggoSpread.SSSetDate		C_PosDt,			"전표발생일",		16,2,Parent.gDateFormat
...
Function FncSave() 
	...
	If  ggoSpread.SSCheckChange = False Then
	   IntRetCD = DisplayMsgBox("169802","X", "X", "X")
 	   Exit Function
	End If
...
Function DbSave() 
		...
		For lRow = 1 To .MaxRows
			...
			Select Case .Text
				Case ggoSpread.UpdateFlag
			        ...
			        strVal = strVal & strYear & iColSep & lRow & iRowSep
	...
	If iTmpCUBufferCount > -1 Then 
		...
		Call DisplayMsgBox("169802","X", "X", "X")
		Exit Function
	End If  
					...
					<TD CLASS="CLSMTABP">
						<TABLE ID="MyTab" CELLSPACING=0 CELLPADDING=0>
							<TR>
								...
								<TD background="../../../CShared/image/table/seltab_up_bg.gif" align="center" CLASS="CLSMTAB"><font color=white>Batch Posting취소</font></TD>
					...
					<FIELDSET CLASS="CLSFLD">
						<TABLE <%=LR_SPACE_TYPE_40%>>
							<TR>
								...
								<TD CLASS="TD6" NOWRAP>
								      <script language =javascript src='./js/i1721ma1_fpDateTime1_txtDocumentFrDt.js'></script>
							          &nbsp;~&nbsp;
							          <script language =javascript src='./js/i1721ma1_fpDateTime2_txtDocumentToDt.js'></script>
							    </TD>      
							</TR>
							<TR>
					...
					<TABLE <%=LR_SPACE_TYPE_60%>>						
						<TR>
							<TD WIDTH=100% HEIGHT=100% COLSPAN=4>
								<script language =javascript src='./js/i1721ma1_I204339164_vspdData.js'></script>
							</TD>
						</TR>
					</TABLE>
					</TD>
