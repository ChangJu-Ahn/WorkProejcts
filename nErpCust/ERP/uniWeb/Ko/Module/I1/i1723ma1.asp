...
Const BIZ_PGM_ID	= "i1723mb2.asp"
Const BIZ_LOOKUP_ID = "i1723mb1.asp"
...
Sub InitSpreadSheet()
	...
	With frm1.vspdData
		...
		ggoSpread.SSSetDate		C_DocumentDt,		"수불발생일",		12,2,Parent.gDateFormat
	 	ggoSpread.SSSetDate		C_PosDt,			"회계전표발생일",	16,2,Parent.gDateFormat
					...
					<TD CLASS="CLSMTABP">
						<TABLE ID="MyTab" CELLSPACING=0 CELLPADDING=0>
							<TR>
								...
								<TD background="../../../CShared/image/table/seltab_up_bg.gif" align="center" CLASS="CLSMTAB"><font color=white>Batch Posting취소(OLD)</font></TD>
					...
					<FIELDSET CLASS="CLSFLD">
						<TABLE <%=LR_SPACE_TYPE_40%>>
							<TR>
								...
								<TD CLASS="TD6" NOWRAP>
								      <script language =javascript src='./js/i1723ma1_fpDateTime1_txtDocumentFrDt.js'></script>
							          &nbsp;~&nbsp;
							          <script language =javascript src='./js/i1723ma1_fpDateTime2_txtDocumentToDt.js'></script>
							    </TD>      
							</TR>
							<TR>
					...
					<TABLE <%=LR_SPACE_TYPE_60%>>						
						<TR>
							<TD WIDTH=100% HEIGHT=100% COLSPAN=4>
								<script language =javascript src='./js/i1723ma1_I396432054_vspdData.js'></script>
							</TD>
						</TR>
					</TABLE>
					</TD>
