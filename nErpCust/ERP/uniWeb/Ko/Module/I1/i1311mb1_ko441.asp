...
'============================================================================================================================    
    ...
    ''2008-05-19 4:21오후 :: hanc-------------------------------------------------------------------------------
    	...
    	lgStrSQL = lgStrSQL & " WHERE	LOT_NO		=	" &  FilterVar(EG1_export_group(LngRow,C_EG1_i_goods_movement_detail_lot_no),"''", "S")
    	lgStrSQL = lgStrSQL & " AND		ITEM_CD		=	" &  FilterVar(EG1_export_group(LngRow, C_EG1_b_item_item_cd),"''", "S")
...
'             End If        
    ...
    '-------------------------------------------------------------------------------
		...
		Else   
		  strData = strData & Chr(11) & ""
		End If                
		  strData = strData & Chr(11) & ConvSPChars(d_EXT2_CD)
		  strData = strData & Chr(11) & ConvSPChars(d_BP_CD)
		  strData = strData & Chr(11) & ConvSPChars(d_BP_NM)
