...
Const BIZ_PGM_QRY_ID	= "i1503qb1.asp"
...
Sub InitSpreadSheet()
	...
	ggoSpread.Spreadinit "V20030630", , Parent.gAllowDragDropSpread
	...
	With frm1.vspdData
		...
		ggoSpread.SSSetEdit     C_TrnsPlantCd,		"이동공장",		10
		ggoSpread.SSSetEdit		C_TrnsPlantNm,		"이동공장명",	14
...
Sub GetSpreadColumnPos(ByVal pvSpdNo)
 	...
 	Case "A"
		...
		C_TrnsPlantCd		= iCurColumnPos(14)
		C_TrnsPlantNm		= iCurColumnPos(15)
...
Function OpenTrnsPlant()
	...
	arrParam(0) = "공장팝업" 
	arrParam(1) = "B_PLANT"    
	arrParam(2) = Trim(frm1.txtTrnsPlantCd.Value)
	arrParam(3) = ""
	arrParam(4) = "" 
	arrParam(5) = "공장"   
	...
	If arrRet(0) = "" Then
		...
		Exit Function
	Else
		frm1.txtTrnsPlantCd.Value    = arrRet(0)  
		frm1.txtTrnsPlantNm.Value    = arrRet(1)  
		frm1.txtTrnsPlantCd.focus
	End If  
End Function
...
Function OpenMovType()
	...
	arrParam(3) = ""
	arrParam(4) = "A.minor_cd = B.mov_type and A.major_cd = " & FilterVar("I0001", "''", "S") & " and B.trns_type = " & FilterVar("ST", "''", "S") & " and B.gui_control_flag = " & FilterVar("Y", "''", "S") & " "
	arrParam(5) = "수불유형"
...
Function FncQuery() 
	...
	frm1.txtTrnsPlantNm.value = "" 
	If frm1.txtTrnsPlantCd.value <> "" Then 
		If  CommonQueryRs(" PLANT_NM "," B_PLANT ", " PLANT_CD = " & FilterVar(frm1.txtTrnsPlantCd.Value, "''", "S"), _
						lgF0,lgF1,lgF2,lgF3,lgF4,lgF5,lgF6) = True Then
			lgF0 = Split(lgF0,Chr(11))
			frm1.txtTrnsPlantNm.value = lgF0(0)
		End if 
	End If
...
Function DbQuery()
    ...
    With frm1    
		strVal = BIZ_PGM_QRY_ID &	"?txtMode="				& Parent.UID_M0001				& _	
									...
									"&txtTrnsPlantCd="		& Trim(.txtTrnsPlantCd.value)	& _	
					...
					<TD CLASS="CLSMTABP">
						<TABLE ID="MyTab" CELLSPACING=0 CELLPADDING=0>
							<TR>
								...
								<TD background="../../../CShared/image/table/seltab_up_bg.gif" align="center" CLASS="CLSMTAB"><font color=white>재고이동현황조회(공장간)</font></TD>
					...
					<FIELDSET CLASS="CLSFLD">
						<TABLE <%=LR_SPACE_TYPE_40%>>
							<TR>
								...
								<TD CLASS="TD6" NOWRAP>
									<script language =javascript src='./js/i1503qa1_OBJECT2_txtMovFrDt.js'></script>
									&nbsp;~&nbsp;
									<script language =javascript src='./js/i1503qa1_OBJECT3_txtMovToDt.js'></script>
								</TD>
							</TR>
							<TR>
								<TD CLASS="TD5" NOWRAP>이동공장</TD>
								<TD CLASS="TD6" NOWRAP>
								<INPUT TYPE=TEXT NAME="txtTrnsPlantCd" SIZE=8 MAXLENGTH=4 tag="11XXXU" ALT="이동공장"><IMG SRC="../../../CShared/image/btnPopup.gif" NAME="btnTrnsPlant" align=top TYPE="BUTTON" ONCLICK="vbscript:OpenTrnsPlant()">&nbsp;<INPUT TYPE=TEXT NAME="txtTrnsPlantNm" SIZE=30 MAXLENGTH=40 tag="14">	
								</TD>
					...
					<TD WIDTH=100% VALIGN=TOP>
						...
						<TR>
							<TD WIDTH=100% HEIGHT=100% COLSPAN=4>
								<script language =javascript src='./js/i1503qa1_OBJECT1_vspdData.js'></script>
							</TD>
						</TR>											
						</TABLE>
					</TD>
