...
Dim EG1_group_export
    ...
    Set iPI1G192 = Server.CreateObject("PI1G192.cILstGoodMvmtBchPstOld")

    '-----------------------
    'Com action result check area(OS,internal)
    '-----------------------
    If CheckSYSTEMError(Err,True) = True Then
          Set iPI1G192 = Nothing			
		  Response.End						
    End If
    ...
    'Com Action Area
    '-----------------------
    Call iPI1G192.I_LIST_GOODS_MVMT_BCH_POST_OLD (gStrGlobalCollection, C_SHEETMAXROWS_D, _
