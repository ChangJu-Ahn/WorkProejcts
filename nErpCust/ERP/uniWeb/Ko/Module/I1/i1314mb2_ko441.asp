...
On Error Resume Next											
	...
	Dim arrColVal			
		...
		Const C_EntryQtyAfter	= 14	'20080313::hanc::이동후수량

		Const C_EntryAmount	= 15	'20090817::kimByungSang::이동금액
    ...
    Dim IG1_import_group
		...
		Const C_IG1_I5_amount				= 23	'20090817::kimByungSang::이동금액
    ...
    If itxtSpread <> "" Then
	   ...
	   LngMaxRow = UBound(arrRowVal) - 1
		...
		Redim IG1_import_group(LngMaxRow, C_IG1_I2_return_flag) '20080313::hanc::기존->C_IG1_I2_return_flag  
	   ...
	   For LngRow = 0 To LngMaxRow
		...
		'	IG1_import_group(LngRow,C_IG1_I2_entry_qty_after)	= arrColVal(C_EntryQtyAfter)   '20080313::hanc::이동후수량
			...
			IG1_import_group(LngRow,C_IG1_I5_amount)	= UNIConvNum(arrColVal(C_EntryAmount), 0)   '20090817::kimByungSang::이동금액
	...
	Set iPI0C180 = Server.CreateObject("PI0C180.cIStockTransfer")     '20080313::HANC::공장간이동
