...
'	Const I134_E3_temp_gl_no = 4
	Const I134_E3_gl_no = 4
	Const I134_E3_cost_mvmt = 5
	cONST I134_E3_cost_mvmt_nm= 6
	Const I134_E3_ref_no = 7
	...
	I5_cost_document_fg				= Request("txtCostMvmt")
...
'		Next
		...
		strData = Chr(11) & "0" & _
				  ...
				  Chr(11) & ConvSPChars(E3_i_goods_movement_header(LngRow, I134_E3_trns_type)) & _				  
				  Chr(11) & ConvSPChars(E3_i_goods_movement_header(LngRow, I134_E3_trns_nm)) & _
				  Chr(11) & ConvSPChars(E3_i_goods_movement_header(LngRow, I134_E3_gl_no)) & _	
				  Chr(11) & ConvSPChars(E3_i_goods_movement_header(LngRow, I134_E3_cost_mvmt)) & _
				  Chr(11) & ConvSPChars(E3_i_goods_movement_header(LngRow, I134_E3_cost_mvmt_nm)) & _				  
				  Chr(11) & ConvSPChars(E3_i_goods_movement_header(LngRow, I134_E3_ref_no)) & _					  				  					  
