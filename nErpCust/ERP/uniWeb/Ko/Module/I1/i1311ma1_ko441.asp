...
<SCRIPT LANGUAGE="VBScript"   SRC="i1311ma1_KO441.vbs"></SCRIPT>
						...
						<FIELDSET CLASS="CLSFLD">
							<TABLE WIDTH=100% <%=LR_SPACE_TYPE_40%> >
								...
								<TR>
									...
									<TD CLASS="TD6" NOWRAP>
									<script language =javascript src='./js/i1311ma1_ko441_fpDateTime1_txtYear.js'></script>
									</TD>
								</TR>
							</TABLE>
						</FIELDSET>
					  ...
					  <TABLE <%=LR_SPACE_TYPE_60%>>
						<TR>
							...
							<TD CLASS="TD656" NOWRAP>
								<script language =javascript src='./js/i1311ma1_ko441_fpDateTime2_txtDocumentDt.js'></script>
							</TD>
						</TR>
						<TR>
							<TD CLASS="TD5" NOWRAP>회계전표일자</TD>
							<TD CLASS="TD656" NOWRAP>
								<script language =javascript src='./js/i1311ma1_ko441_fpDateTime3_txtPostingDt.js'></script>
							</TD>							
						</TR>
						<TR>
					...
					<TD HEIGHT=* VALIGN=TOP WIDTH=100%>
				          ...
				          <TR>
					           <TD WIDTH=100% HEIGHT=100% COLSPAN=4> 
						    	<script language =javascript src='./js/i1311ma1_ko441_I963957387_vspdData.js'></script>
							  </TD>
						 </TR>
						</TABLE>	
					</TD>
