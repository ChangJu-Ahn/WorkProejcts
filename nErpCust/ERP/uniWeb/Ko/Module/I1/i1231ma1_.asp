									...
									<FIELDSET CLASS="CLSFLD">
										<TABLE WIDTH=100% <%=LR_SPACE_TYPE_40%>>
											...
											<TR>
												...
												<TD CLASS="TD6" NOWRAP>
													<script language =javascript src='./js/i1231ma1_fpDateTime1_txtYear.js'></script>
												</TD>
											</TR>
										</TABLE>
									</FIELDSET>
								...
								<TD WIDTH=100% VALIGN=top>
									<TABLE <%=LR_SPACE_TYPE_60%>>
										<TR>
											...
											<script language =javascript src='./js/i1231ma1_fpDateTime2_txtDocumentDt.js'></script>
											</TD>
										</TR>
										<TR>
											<TD CLASS="TD5" NOWRAP>회계전표일자</TD>
											<TD CLASS="TD656" NOWRAP>
											<script language =javascript src='./js/i1231ma1_fpDateTime3_txtPostingDt.js'></script>
											</TD>
										</TR>
										<TR>
						...
						<TABLE WIDTH="100%" <%=LR_SPACE_TYPE_20%>>
							<TR>
								<TD WIDTH=100% HEIGHT=100%>
									<script language =javascript src='./js/i1231ma1_OBJECT1_vspdData.js'></script>
								</TD>
							</TR>    
						</TABLE>
					</DIV>
