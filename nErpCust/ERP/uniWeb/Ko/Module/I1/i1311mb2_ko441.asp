...
'Call ServerMesgBox("HANC : " & I2_good_mvmt_workset(C_I2_item_document_no)     , vbInformation, I_MKSCRIPT)     
'Call ServerMesgBox("HANC : " & I2_good_mvmt_workset(C_I2_trns_type) 	       , vbInformation, I_MKSCRIPT)     
'Call ServerMesgBox("HANC : " & I2_good_mvmt_workset(C_I2_mov_type) 	           , vbInformation, I_MKSCRIPT)     
'Call ServerMesgBox("HANC : " & I2_good_mvmt_workset(C_I2_document_dt)	       , vbInformation, I_MKSCRIPT)     
'Call ServerMesgBox("HANC : " & I2_good_mvmt_workset(C_I2_pos_dt)  		       , vbInformation, I_MKSCRIPT)     
'Call ServerMesgBox("HANC : " & I2_good_mvmt_workset(C_I2_document_text)        , vbInformation, I_MKSCRIPT)     
'Call ServerMesgBox("HANC : " & I2_good_mvmt_workset(C_I2_plant) 		       , vbInformation, I_MKSCRIPT)     
'Call ServerMesgBox("HANC : " & I2_good_mvmt_workset(C_I2_cost_cd)		       , vbInformation, I_MKSCRIPT)     
    ...
    If itxtSpread <> "" Then
	   ...
	   LngMaxRow = UBound(arrRowVal) - 1
		...
		Redim IG1_import_group(LngMaxRow, C_IG1_I2_return_flag)  
	   ...
	   For LngRow = 0 To LngMaxRow
		...
		Case "C"			
			...
			End if
'Call ServerMesgBox("HANC : C_IG1_I2_tracking_no" & IG1_import_group(LngRow,C_IG1_I2_tracking_no) , vbInformation, I_MKSCRIPT)
			...
			End if
'Call ServerMesgBox("HANC : C_IG1_I2_trns_item_cd" & IG1_import_group(LngRow,C_IG1_I2_trns_item_cd) , vbInformation, I_MKSCRIPT)
			...
			End if
'Call ServerMesgBox("HANC : C_IG1_I2_trns_plant_cd" & IG1_import_group(LngRow,C_IG1_I2_trns_plant_cd) , vbInformation, I_MKSCRIPT)
			...
			End if
'Call ServerMesgBox("HANC : C_IG1_I2_trns_sl_cd" & IG1_import_group(LngRow,C_IG1_I2_trns_sl_cd) , vbInformation, I_MKSCRIPT)
			...
			End if
'Call ServerMesgBox("HANC : C_IG1_I2_trns_tracking_no" & IG1_import_group(LngRow,C_IG1_I2_trns_tracking_no) , vbInformation, I_MKSCRIPT)
...
'Call ServerMesgBox("HANC : " & IG1_import_group(LngRow,C_IG1_I1_sl_cd)            , vbInformation, I_MKSCRIPT)
'Call ServerMesgBox("HANC : " & IG1_import_group(LngRow,C_IG1_I2_lot_no)           , vbInformation, I_MKSCRIPT)
'Call ServerMesgBox("HANC : " & IG1_import_group(LngRow,C_IG1_I2_lot_sub_no)       , vbInformation, I_MKSCRIPT)
'Call ServerMesgBox("HANC : " & IG1_import_group(LngRow,C_IG1_I2_item_status)      , vbInformation, I_MKSCRIPT)
'Call ServerMesgBox("HANC : " & IG1_import_group(LngRow,C_IG1_I2_entry_qty)        , vbInformation, I_MKSCRIPT)
'Call ServerMesgBox("HANC : " & IG1_import_group(LngRow,C_IG1_I2_entry_unit)       , vbInformation, I_MKSCRIPT)
'Call ServerMesgBox("HANC : " & IG1_import_group(LngRow,C_IG1_I2_trns_lot_no)      , vbInformation, I_MKSCRIPT)
'Call ServerMesgBox("HANC : " & IG1_import_group(LngRow,C_IG1_I2_trns_lot_sub_no)  , vbInformation, I_MKSCRIPT)
'Call ServerMesgBox("HANC : " & IG1_import_group(LngRow,C_IG1_I2_trns_plant_cd)    , vbInformation, I_MKSCRIPT)
'Call ServerMesgBox("HANC : " & IG1_import_group(LngRow,C_IG1_I2_trns_sl_cd)       , vbInformation, I_MKSCRIPT)
'Call ServerMesgBox("HANC : " & IG1_import_group(LngRow,C_IG1_I2_trns_item_cd)     , vbInformation, I_MKSCRIPT)
'Call ServerMesgBox("HANC : " & IG1_import_group(LngRow,C_IG1_I2_tracking_no)      , vbInformation, I_MKSCRIPT)
'Call ServerMesgBox("HANC : " & IG1_import_group(LngRow,C_IG1_I2_trns_tracking_no) , vbInformation, I_MKSCRIPT)
'Call ServerMesgBox("HANC : " & IG1_import_group(LngRow,C_IG1_I3_plant_cd)         , vbInformation, I_MKSCRIPT)
'Call ServerMesgBox("HANC : " & IG1_import_group(LngRow,C_IG1_I4_item_cd)          , vbInformation, I_MKSCRIPT)
'Call ServerMesgBox("HANC : " & IG1_import_group(LngRow,C_IG1_I5_cost_cd)          , vbInformation, I_MKSCRIPT)
	...
	Set iPI0C180 = Server.CreateObject("PI0C180.cIStockTransfer")
