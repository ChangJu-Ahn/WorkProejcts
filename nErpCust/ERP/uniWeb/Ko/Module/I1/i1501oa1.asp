...
'*  2. Function Name        : 예외수불현황 출력 
'*  3. Program ID           : i1501oa1
'*  4. Program Name         :
'*  5. Program Desc         :
'*  6. Comproxy List        : 
...
Function FncBtnPrint() 
    ...
    condvar = condvar & "|ITEMCD|"		& var4
    condvar = condvar & "|INVMGR|"		& var5
    condvar = condvar & "|TrnsType|"    & var6
    
	ObjName = AskEBDocumentName("i1501oa1", "ebr")
					...
					<TD>
						<TABLE ID="MyTab" CELLSPACING=0 CELLPADDING=0>
							<TR>
								...
								<TD background="../../../CShared/image/table/seltab_up_bg.gif" align="center" CLASS="CLSMTAB"><font color=white>예외수불현황출력</font></TD>
					...
					<TD>
						<TABLE <%=LR_SPACE_TYPE_60%> >
							...
							<TR>
								...
								<TD CLASS="TD6">
								<script language =javascript src='./js/i1501oa1_I432067131_txtMovFrDt.js'></script>
								&nbsp;~&nbsp;
								<script language =javascript src='./js/i1501oa1_I461472028_txtMovToDt.js'></script>
								</TD>
							</TR>
							<TR>
								<TD CLASS="TD5">품목</TD>
							...
							<TR>
								<TD CLASS="TD5">재고담당자</TD>
								<TD CLASS="TD6"><SELECT Name="cboInvMgr" ALT="재고담당자"  STYLE="WIDTH: 150px" tag="11"><OPTION Value=""></OPTION></SELECT>
								</TD>
							</TR>
							<TR>
								<TD CLASS="TD5">구분</TD>
								<TD CLASS="TD6">
								<INPUT TYPE="RADIO" CLASS="RADIO" NAME="RadioOutputType" ID="rdoCase1" TAG="1X" checked><LABEL FOR="rdoCase1">입고</LABEL>
								<INPUT TYPE="RADIO" CLASS="RADIO" NAME="RadioOutputType" ID="rdoCase2" TAG="1X"><LABEL FOR="rdoCase2">출고</LABEL>
								</TD>
							</TR>
						</TABLE>
					</TD>
