...
Const BIZ_PGM_ID = "m6111mb2_ko441.asp"												'☆: 비지니스 로직 ASP명 
...
Dim C_BizArea       '2008-03-26 1:16오후 :: hanc
Dim C_BizAreaDesc   '2008-03-26 1:16오후 :: hanc
Dim C_comment       '2008-03-25 4:05오후 :: hanc
...
Sub initSpreadPosVariables()  
    ...
    C_BizArea           = 20        '2008-03-26 1:16오후 :: hanc
    C_BizAreaDesc       = 21        '2008-03-26 1:16오후 :: hanc
	C_comment 			= 22       '비고사항   '2008-03-25 4:00오후 :: hanc

	C_currency 			= 23       '화폐 
	C_currency_pop 		= 24       '화폐 팝업 
	C_charge_doc_amt 	= 25       '발생금액 
	C_charge_loc_amt 	= 26       '발생자국금액 
	C_xch_rate	 		= 27       '환율 
	C_Vat_rate 			= 28       'VAT율 
	C_vat_doc_amt		= 29       'VAT금액 
	C_vat_loc_amt 		= 30       'VAT자국금액 
	C_pay_type 			= 31       '지급유형 
	C_pay_type_pop 		= 32       '지급유형 팝업 
	C_pay_type_Nm 		= 33       '지급유형명 
	C_pay_doc_amt		= 34       '지급금액 
	C_pay_loc_amt		= 35       '지급자국금액 추가(2003.08.14)
	C_pay_due_dt		= 36       '만기일 
	C_charge_rate 		= 37       '경비세율(%)
	C_cost_flag 		= 38       '물대포함여부 
	C_bank_cd 			= 39       '출금은행 
	C_bank_pop 			= 40       '출금은행 팝업 
	C_bank_Nm 			= 41       '출금은행명 
	C_bank_acct 		= 42       '출금계좌 
	C_bank_acct_pop 	= 43       '출금계좌 팝업 
	C_note_no			= 44       '어음번호 
	C_note_no_pop		= 45       '어음번호 팝업 
	C_prpaym_no			= 46       '선급금번호 
	C_prpaym_no_pop		= 47       '선급금번호 팝업 
	C_pp_xch_rt			= 48	   '선급금환율 
	C_remark 			= 49       '기타참조 
	C_bas_no			= 50       '발생근거 관리번호 
	C_calcd				= 51       'calcd(hidden)	금액계산시 필요한 * or / 코드 
	C_pay_type_seq4		= 52       'seq4 (hidden)
	C_GlType            = 53       '전표 type
	C_GlNo              = 54       '전표번호 
	C_old_posting_flg	= 55       'oldpostingflg(hidden)
...
Sub SetDefaultVal()
	...
	If lgPGCd <> "" then 
		Call ggoOper.SetReqAttr(frm1.txtpur_grp1, "Q") 
		frm1.txtpur_grp1.Tag = left(frm1.txtpur_grp1.Tag,1) & "4" & mid(frm1.txtpur_grp1.Tag,3,len(frm1.txtpur_grp1.Tag))
        frm1.txtpur_grp1.value = lgPGCd
		Call ggoOper.SetReqAttr(frm1.txtpur_grp, "Q") 
		frm1.txtpur_grp.Tag = left(frm1.txtpur_grp.Tag,1) & "4" & mid(frm1.txtpur_grp.Tag,3,len(frm1.txtpur_grp.Tag))
...
Sub InitSpreadSheet()
    ...
    '2008-03-26 1:19오후 :: hanc
    ggoSpread.SSSetCombo    C_BizArea,      "사업장", 10
    ggoSpread.SSSetCombo    C_BizAreaDesc,  "사업장", 15

    '2008-03-25 4:01오후 :: hanc
    ggoSpread.SSSetEdit 	C_comment			, "비고사항"		, 20,,,50

    ggoSpread.SSSetEdit 	C_currency			, "화폐", 8,,,3,2
    ggoSpread.SSSetButton 	C_currency_pop
    ggoSpread.SSSetFloat    C_charge_doc_amt	, "발생금액"		, 15    ,"A"   ,ggStrIntegeralPart ,ggStrDeciPointPart,Parent.gComNum1000,Parent.gComNumDec, 1,,"Z", -1000000000000000           '2008-03-21 2:06오후 :: hanc min수량 추가
...
'2008-03-27 10:47오후 :: hanc    SetSpreadFloatLocal 	C_vat_loc_amt		, "VAT자국금액"		, 15, 1, 2
    ggoSpread.SSSetFloat    C_vat_loc_amt	, "VAT자국금액"		, 15    ,"A"   ,ggStrIntegeralPart ,ggStrDeciPointPart,Parent.gComNum1000,Parent.gComNumDec, 1,,"Z", -1000000000000000           '2008-03-21 2:06오후 :: hanc min수량 추가
    ...
    Call ggoSpread.SSSetColHidden(C_BizArea,C_BizArea,True)         '2008-03-26 2:23오후 :: hanc
...
Sub SetSpreadLock()
	...
	ggoSpread.spreadUnlock 		C_BizArea, -1,C_BizArea, -1                      ''2008-03-25 4:01오후 :: hanc 비고사항 
	ggoSpread.spreadUnlock 		C_BizAreaDesc, -1,C_BizAreaDesc, -1                      ''2008-03-25 4:01오후 :: hanc 비고사항 
	ggoSpread.spreadUnlock 		C_comment, -1,C_comment, -1                      ''2008-03-25 4:01오후 :: hanc 비고사항 
...
Sub GetSpreadColumnPos(ByVal pvSpdNo)
    ...
    Select Case UCase(pvSpdNo)
       Case "A"
			...
			C_BizArea 			= iCurColumnPos(20)     '2008-03-25 4:02오후 :: hanc
			C_BizAreaDesc		= iCurColumnPos(21)     '2008-03-25 4:02오후 :: hanc
			C_comment 			= iCurColumnPos(22)     '2008-03-25 4:02오후 :: hanc
			C_currency 			= iCurColumnPos(23)
			C_currency_pop 		= iCurColumnPos(24)
			C_charge_doc_amt 	= iCurColumnPos(25)
			C_charge_loc_amt 	= iCurColumnPos(26)
			C_xch_rate	 		= iCurColumnPos(27)
			C_Vat_rate 			= iCurColumnPos(28)
			C_vat_doc_amt		= iCurColumnPos(29)
			C_vat_loc_amt 		= iCurColumnPos(30)
			C_pay_type 			= iCurColumnPos(31)
			C_pay_type_pop 		= iCurColumnPos(32)
			C_pay_type_Nm 		= iCurColumnPos(33)
			C_pay_doc_amt		= iCurColumnPos(34)
			C_pay_loc_amt		= iCurColumnPos(35)	'지급자국금액 추가 (2003.08.14)
			C_pay_due_dt		= iCurColumnPos(36)
			C_charge_rate 		= iCurColumnPos(37)
			C_cost_flag 		= iCurColumnPos(38)
			C_bank_cd 			= iCurColumnPos(39)
			C_bank_pop 			= iCurColumnPos(40)
			C_bank_Nm 			= iCurColumnPos(41)
			C_bank_acct 		= iCurColumnPos(42)
			C_bank_acct_pop 	= iCurColumnPos(43)
			C_note_no			= iCurColumnPos(44)
			C_note_no_pop		= iCurColumnPos(45)
			C_prpaym_no			= iCurColumnPos(46)
			C_prpaym_no_pop		= iCurColumnPos(47)
			C_pp_xch_rt			= iCurColumnPos(48)
			C_remark 			= iCurColumnPos(49)
			C_bas_no			= iCurColumnPos(50)
			C_calcd				= iCurColumnPos(51)
			C_pay_type_seq4		= iCurColumnPos(52)
			C_GlType            = iCurColumnPos(53)
			C_GlNo              = iCurColumnPos(54)
			C_old_posting_flg	= iCurColumnPos(55)
    ...
    With frm1
		...
		For index = Cint(.hdnmaxrow.value) + 1	to .vspdData.MaxRows 
			...
			End If
				...
				ggoSpread.spreadUnlock 		C_BizArea, index,C_BizArea, index         '2008-03-25 4:03오후 :: hanc
				ggoSpread.spreadUnlock 		C_BizAreaDesc, index,C_BizAreaDesc, index         '2008-03-25 4:03오후 :: hanc
				ggoSpread.spreadUnlock 		C_comment, index,C_comment, index         '2008-03-25 4:03오후 :: hanc
...
Sub Form_Load()
    ...
    Call InitSpreadComboBox()  '2008-03-26 2:05오후 :: hanc
    Call CookieOp()
...
Sub vspdData_Change(ByVal Col , ByVal Row )
	...
	Dim sBpCd, Cur
	Dim scharge_doc_amt , svat_doc_amt  '2008-05-08 5:35오후 :: hanc
	Dim scharge_loc_amt , svat_loc_amt  '2008-05-08 5:35오후 :: hanc
	Dim Strcharge_dt
	ggoSpread.Source = frm1.vspdData
...
'		Case C_charge_doc_amt       '2008-05-08 5:34오후 :: hanc
'			frm1.vspdData.Col = C_charge_doc_amt
'			scharge_doc_amt = frm1.vspdData.text
'
'			frm1.vspdData.Col = C_vat_doc_amt
'			svat_doc_amt = frm1.vspdData.text
'
'    		Call frm1.vspdData.SetText(C_pay_doc_amt,	Row, scharge_doc_amt + svat_doc_amt)
	
'		Case C_charge_loc_amt       '2008-05-08 5:34오후 :: hanc
'			frm1.vspdData.Col = C_charge_loc_amt
'			scharge_loc_amt = frm1.vspdData.text
'
'			frm1.vspdData.Col = C_vat_loc_amt
'			svat_loc_amt = frm1.vspdData.text
'
'    		Call frm1.vspdData.SetText(C_pay_loc_amt,	Row, scharge_loc_amt + svat_loc_amt)
		...
		Case C_pay_type                                       '지급유형 
			...
			Call vspdData_Change(C_vat_doc_amt , frm1.vspdData.Row)
			Call setPayDueDt(Row)
			
			if frm1.vspdData.value <> "CS" then
				frm1.vspdData.Col = C_charge_dt
				Strcharge_dt = frm1.vspdData.text 
				frm1.vspdData.Col = C_pay_due_dt
				frm1.vspdData.text  = Strcharge_dt
			End if
			frm1.vspdData.ReDraw = true
		...
		Case C_charge_doc_amt,C_Vat_rate   '발생금액,VAT율 
			...
			End If
			Frm1.vspdData.Col = C_charge_doc_amt 
			scharge_doc_amt = unicdbl(frm1.vspddata.value)
			
			Frm1.vspdData.Col = C_charge_loc_amt
			scharge_loc_amt = unicdbl(frm1.vspddata.value)
			
			Frm1.vspdData.Col = C_vat_doc_amt
			svat_doc_amt = unicdbl(frm1.vspddata.value)
			
			Frm1.vspdData.Col = C_vat_loc_amt
			svat_loc_amt = unicdbl(frm1.vspddata.value)
			
			Frm1.vspdData.Col = C_pay_doc_amt 
			frm1.vspddata.value = scharge_doc_amt + svat_doc_amt
			
			Frm1.vspdData.Col = C_pay_loc_amt 
			frm1.vspddata.value = scharge_loc_amt + svat_loc_amt
			
			Call FixDecimalPlaceByCurrency(frm1.vspdData,Row,C_currency,C_charge_doc_amt,   "A" ,"X","X")
			Call FixDecimalPlaceByCurrency(frm1.vspdData,Row,C_currency,C_Vat_rate,"D" ,"X","X")

            '2008-06-09 4:35오후 :: hanc
'			frm1.vspdData.Col = C_charge_doc_amt
'			scharge_doc_amt = frm1.vspdData.text
'
'			frm1.vspdData.Col = C_vat_doc_amt
...
'
'    		Call frm1.vspdData.SetText(C_pay_loc_amt,	Row, scharge_loc_amt + svat_loc_amt)
		Case C_charge_loc_amt,C_vat_doc_amt,C_vat_loc_amt
	...
	With frm1.vspdData
		...
		Select Case Col
			Case  1
				...
				.Col = C_BillFG
				.Value = intIndex
			Case  C_BizAreaDesc         '2008-03-26 2:22오후 :: hanc
				.Col = Col
				intIndex = .Value
				.Col = C_BizArea
				.Value = intIndex
...
Sub PopRestoreSpreadColumnInf()
    ...
    Call InitSpreadComboBox '2008-03-26 1:51오후 :: hanc
...
Sub InitSpreadComboBox()
    ...
    Call CommonQueryRs(" BIZ_AREA_CD,BIZ_AREA_NM "," B_BIZ_AREA "," BIZ_AREA_CD >= " & FilterVar("", "''", "S") & " ",lgF0,lgF1,lgF2,lgF3,lgF4,lgF5,lgF6)
    iCodeArr =  lgF0
    iNameArr =  lgF1

    ggoSpread.Source = frm1.vspdData
    ggoSpread.SetCombo Replace(lgF0,Chr(11),vbTab), C_BizArea
    ggoSpread.SetCombo Replace(lgF1,Chr(11),vbTab), C_BizAreaDesc


End Sub

'2008-03-26 2:14오후 :: hanc
'==========================================  2.2.6 InitData()  ========================================== 
'	Name : InitData()
'	Description : Combo Display
'======================================================================================================== 
...
Function DbQueryOk()														
	...
	Call InitData(1)        '2008-03-26 2:17오후 :: hanc
		...
		For lRow = 1 To .vspdData.MaxRows
		    ...
		    Select Case .vspdData.Text
		        ...
		        Case ggoSpread.InsertFlag,ggoSpread.UpdateFlag
					...
					strVal = strVal & Trim(GetSpreadText(frm1.vspdData,C_comment,lRow, "X","X"))    				& iColSep           '2008-03-25 4:21오후 :: hanc 32
					strVal = strVal & Trim(GetSpreadText(frm1.vspdData,C_BizArea,lRow, "X","X"))    				& iColSep           '2008-03-26 4:21오후 :: hanc 33
...
Function UsrFnPreCheck(Byval lRow)
	...
	Dim paydocamt, chargedocamt, vatdocamt, vat_loc_amtdocamt
	...
	With frm1
		...
		vat_loc_amtdocamt = GetSpreadText(frm1.vspdData,C_vat_loc_amt,lRow,"X","X")
		vatdocamt = GetSpreadText(frm1.vspdData,C_vat_doc_amt,lRow,"X","X")
						
'hanc		If UNICDbl(paydocamt) > UNICDbl(chargedocamt) + UNICDbl(vatdocamt) Then 
'hanc			Call DisplayMsgBox("970023", "X",lRow&"Row,"&"발생금액","지급금액")
'hanc			Call LayerShowHide(0)
'hanc			Exit Function
'hanc		End If


		If  UNICDbl(chargedocamt) + UNICDbl(vat_loc_amtdocamt) = 0 Then 
		    Msgbox "발생금액과 VAT자국금액이 0 이면 등록이 안됩니다.",vbInformation, parent.gLogoName
...
'hanc		If (Trim(GetSpreadText(frm1.vspdData,C_charge_doc_amt,lRow,"X","X")) = "" Or UNICDBl(GetSpreadText(frm1.vspdData,C_charge_doc_amt,lRow,"X","X")) = 0) Then
'hanc			Call DisplayMsgBox("970021","X" ,lRow&"Row,"&"발생금액","X")
'hanc			Call LayerShowHide(0)
'hanc			Exit Function
'hanc		End If
