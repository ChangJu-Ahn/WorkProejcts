...
'----------------------------------------------------------------------------------------------------------
 Sub FixUNISQLData()
    ...
    UNISqlId(0) = "M6113RA101"     
       																  'Reusage is Recommended
    UNIValue(0,0) = Trim(lgSelectList)		                              '☜: Select 절에서 Summary    필드 
	
    UNIValue(0,1)  = " " & FilterVar(UCase(Request("txtChargeNo")), "''", "S") & " "
    UNIValue(0,2)  = " " & FilterVar(Request("txtSeqNo"), "''", "S") & " "
...
<Script Language=vbscript>
    ...
    With parent
		 ...
		 Call .ReFormatSpreadCellByCellByCurrency2(.frm1.vspdData,"<%=iFrPoint+1%>",.frm1.vspddata.maxrows, gCurrency,.GetKeyPos("A",5),"A","Q","X","X")
