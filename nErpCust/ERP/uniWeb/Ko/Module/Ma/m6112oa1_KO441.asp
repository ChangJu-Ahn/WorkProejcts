...
Sub SetDefaultVal()
	...
	If lgBACd <> "" then 
		...
		frm1.txtBizAreaCd.Tag = left(frm1.txtBizAreaCd.Tag,1) & "4" & mid(frm1.txtBizAreaCd.Tag,3,len(frm1.txtBizAreaCd.Tag))
        frm1.txtBizAreaCd.value = lgBACd
	End If
End Sub
'==============================================================================================================================
Sub LoadInfTB19029()
...
Function FncBtnPrint() 
	...
	if frm1.rdoflg1.checked = True then
		ObjName = AskEBDocumentName("m6112oa1_KO441","ebr")
		Call FncEBRprint(EBAction, ObjName, strUrl)
	else
		ObjName = AskEBDocumentName("m6112oa2_KO441","ebr")
		Call FncEBRprint(EBAction, ObjName, strUrl)
	End if
