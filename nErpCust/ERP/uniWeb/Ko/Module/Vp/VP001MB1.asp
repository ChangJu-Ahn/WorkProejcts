...
Case CStr(UID_M0002)														'☜: 현재 조회/Prev/Next 요청을 받음 
	...
	With lgObjComm
		...
		.CommandText = "usp_v_vp0010t"
		.CommandType = adCmdStoredProc

		.Parameters.Append .CreateParameter("RETURN_VALUE",	adInteger,	adParamReturnValue)

		.Parameters.Append .CreateParameter("@strYyyyMmDd",	adVarXChar,	adParamInput,	8,	strDate)
		.Parameters.Append .CreateParameter("@strPlantCd",	adVarXChar,	adParamInput,	4,	strPlantCD)
