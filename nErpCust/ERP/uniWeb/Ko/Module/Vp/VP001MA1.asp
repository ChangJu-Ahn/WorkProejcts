...
Function SetPrintCond(StrEbrFile, strUrl)
	...
	strDate = txtQueryDate.year & right("0" & txtQueryDate.month,2) & right("0" & txtQueryDate.day,2)
...
<BODY TABINDEX="-1" SCROLL="no">
	...
	<TABLE  <%=TABSTYLE01%> >
		<TR>
			...
			<TD CLASS="TD6E" NOWRAP><script language =javascript src='./js/vp001ma1_fpDateTime1_txtQueryDate.js'></script>&nbsp;</TD>
