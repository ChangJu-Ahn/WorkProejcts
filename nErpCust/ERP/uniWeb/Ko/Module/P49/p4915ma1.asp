...
'*  2. Function Name		:
'*  3. Program ID			: p4915ma1
'*  4. Program Name			: 유실현황리스트 
'*  5. Program Desc			:
'*  6. Comproxy List		: +
...
<SCRIPT LANGUAGE = "VBScript" SRC = "p4915ma1.vbs"></SCRIPT>
					...
					<TD>
						<TABLE ID="MyTab" CELLSPACING=0 CELLPADDING=0>
							<TR>
								...
								<td background="../../../CShared/image/table/seltab_up_bg.gif" align="center" CLASS="CLSMTAB"><font color=white>유실현황리스트</font></td>
						...
						<FIELDSET CLASS="CLSFLD">
							<TABLE <%=LR_SPACE_TYPE_40%>>
								<TR>
									...
									<TD CLASS="TD6">
										<script language =javascript src='./js/p4915ma1_I907185590_txtFromDt.js'></script>
										&nbsp;~&nbsp;
										<script language =javascript src='./js/p4915ma1_I508394485_txtToDt.js'></script>
									</TD>
								</TR>
								<TR>
				...
				<TR>
					<TD WIDTH=100% HEIGHT=* valign=top>
						<TABLE <%=LR_SPACE_TYPE_20%>>
							<TR>
								<TD HEIGHT="100%">
									<script language =javascript src='./js/p4915ma1_I570704078_vspdData.js'></script>
								</TD>
							</TR>
						</TABLE>
					</TD>
    ...
    <TR HEIGHT="20">
      <TD WIDTH="100%">
		<TABLE <%=LR_SPACE_TYPE_30%>>
			<TR>
			  <TD WIDTH=* align=right><A href="vbscript:OpenDailyWorkTime()">작업일보등록</A></TD>
	  		  <TD WIDTH=10>&nbsp;</TD>
			</TR>
		</TABLE>
      </TD>
