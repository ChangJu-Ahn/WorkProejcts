...
<SCRIPT LANGUAGE = "VBScript" SRC = "p4913ma1.vbs"></SCRIPT>
						...
						<FIELDSET CLASS="CLSFLD">
							<TABLE <%=LR_SPACE_TYPE_40%>>
								<TR>
									...
									<TD CLASS="TD6">
										<script language =javascript src='./js/p4913ma1_I943229651_txtprodDt.js'></script>
									</TD>
								</TR>
								<TR>
					...
					<TD WIDTH=100% VALIGN=TOP>
						...
						<TABLE <%=LR_SPACE_TYPE_60%>>
							<TR>
								...
								<TD CLASS=TDT NOWRAP><script language =javascript src='./js/p4913ma1_fpDoubleSingle1_txtDocAmt.js'></script>명</TD>
								<TD CLASS=TD6Y6 NOWRAP>지원인원(+)</TD>
								<TD CLASS=TDT NOWRAP><script language =javascript src='./js/p4913ma1_fpDoubleSingle2_txtDocAmt.js'></script>명</TD>
								<TD CLASS=TD6Y6 NOWRAP>잔업인원</TD>
								<TD CLASS=TDT NOWRAP><script language =javascript src='./js/p4913ma1_fpDoubleSingle3_txtDocAmt.js'></script>명</TD>
								<TD CLASS=TD6Y6 NOWRAP>작업공수</TD>
								<TD CLASS=TDT NOWRAP><script language =javascript src='./js/p4913ma1_fpDoubleSingle4_txtDocAmt.js'></script>&nbsp;&nbsp;</TD>
							</TR>
							<TR>
								<TD CLASS=TD6Y6 NOWRAP>재적시간</TD>
								<TD CLASS=TDT NOWRAP><script language =javascript src='./js/p4913ma1_fpDoubleSingle5_txtDocAmt.js'></script>&nbsp;&nbsp;</TD>
								<TD CLASS=TD6Y6 NOWRAP>지원시간(+)</TD>
								<TD CLASS=TDT NOWRAP><script language =javascript src='./js/p4913ma1_fpDoubleSingle6_txtDocAmt.js'></script>&nbsp;&nbsp;</TD>
								<TD CLASS=TD6Y6 NOWRAP>잔업시간</TD>
								<TD CLASS=TDT NOWRAP><script language =javascript src='./js/p4913ma1_fpDoubleSingle7_txtDocAmt.js'></script>&nbsp;&nbsp;</TD>
								<TD CLASS=TD6Y6 NOWRAP>총유실공수</TD>
								<TD CLASS=TDT NOWRAP><script language =javascript src='./js/p4913ma1_fpDoubleSingle8_txtDocAmt.js'></script>&nbsp;&nbsp;</TD>
							</TR>
							<TR>
								<TD CLASS=TD6Y6 NOWRAP>휴업인원</TD>
								<TD CLASS=TDT NOWRAP><script language =javascript src='./js/p4913ma1_fpDoubleSingle9_txtDocAmt.js'></script>명</TD>
								<TD CLASS=TD6Y6 NOWRAP>지원인원(-)</TD>
								<TD CLASS=TDT NOWRAP><script language =javascript src='./js/p4913ma1_fpDoubleSingle10_txtDocAmt.js'></script>명</TD>
								<TD CLASS=TD6Y6 NOWRAP>잔업공수</TD>
								<TD CLASS=TDT NOWRAP><script language =javascript src='./js/p4913ma1_fpDoubleSingle11_txtDocAmt.js'></script>&nbsp;&nbsp;</TD>
								<TD CLASS=TD6Y6 NOWRAP>&nbsp;</TD>
								<TD CLASS=TDT NOWRAP>&nbsp;</TD>
							</TR>
							<TR>
								<TD CLASS=TD6Y6 NOWRAP>휴업시간</TD>
								<TD CLASS=TDT NOWRAP><script language =javascript src='./js/p4913ma1_fpDoubleSingle12_txtDocAmt.js'></script>&nbsp;&nbsp;</TD>
								<TD CLASS=TD6Y6 NOWRAP>지원시간(-)</TD>
								<TD CLASS=TDT NOWRAP><script language =javascript src='./js/p4913ma1_fpDoubleSingle13_txtDocAmt.js'></script>&nbsp;&nbsp;</TD>
								<TD CLASS=TD6Y6 NOWRAP>기타공수</TD>
								<TD CLASS=TDT NOWRAP><script language =javascript src='./js/p4913ma1_fpDoubleSingle14_txtDocAmt.js'></script>&nbsp;&nbsp;</TD>
								<TD CLASS=TD6Y6 NOWRAP>실동공수</TD>
								<TD CLASS=TDT NOWRAP><script language =javascript src='./js/p4913ma1_fpDoubleSingle15_txtDocAmt.js'></script>&nbsp;&nbsp;</TD>
							</TR>
									...
									<TABLE <%=LR_SPACE_TYPE_20%>>
										<TR HEIGHT="50%">
											<TD WIDTH="100%" colspan=4>
												<script language =javascript src='./js/p4913ma1_A_vspdData1.js'></script>
											</TD>
										</TR>
										<TR HEIGHT="50%">
											<TD WIDTH="50%">
												<script language =javascript src='./js/p4913ma1_B_vspdData2.js'></script>
											</TD>
											<TD WIDTH="50%">
												<script language =javascript src='./js/p4913ma1_C_vspdData3.js'></script>
											</TD>
										</TR>
									</TABLE>
								</TD>
								...
								<TR>
									<TD WIDTH=100% HEIGHT=* valign=top>
										<TABLE <%=LR_SPACE_TYPE_20%>>
											<TR HEIGHT="50%">
												<TD WIDTH="100%" colspan=4>
													<script language =javascript src='./js/p4913ma1_D_vspdData4.js'></script>
												</TD>
											</TR>
											<TR HEIGHT="50%">
												<TD WIDTH="100%" colspan=4>
													<script language =javascript src='./js/p4913ma1_E_vspdData5.js'></script>
												</TD>
											</TR>
										</TABLE>
									</TD>
