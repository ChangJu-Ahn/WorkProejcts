...
'*  2. Function Name        :
'*  3. Program ID           : p4916oa1
'*  4. Program Name         : 작업일보출력 
'*  5. Program Desc         :
'*  6. Comproxy List        :
...
Function BtnPrint()
	...
	var4 = UniConvDateAtoB(frm1.txtStartDt.Text,parent.gDateFormat,parent.gServerDateFormat)
					...
					<TD>
						<TABLE ID="MyTab" CELLSPACING=0 CELLPADDING=0>
							<TR>
								...
								<td background="../../../CShared/image/table/seltab_up_bg.gif" align="center" CLASS="CLSMTABP"><font color=white>작업일보출력</font></td>
						...
						<FIELDSET CLASS="CLSFLD">
							<TABLE WIDTH=100% CELLSPACING=0 CELLPADDING=0>
								...
								<TR>
									...
									<TD CLASS=TD6 NOWRAP>
										<script language =javascript src='./js/p4916oa1_I804716461_txtStartDt.js'></script>
										&nbsp;~&nbsp;
										<script language =javascript src='./js/p4916oa1_I583605825_txtEndDt.js'></script>
									</TD>
								</TR>
								<TR>
