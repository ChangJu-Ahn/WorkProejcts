...
'*  2. Function Name        : 
'*  3. Program ID           : D4211MA1
'*  4. Program Name         : 매출세금계산서(정발행)
'*  5. Program Desc         : 매출세금계산서에 대하여 매출저장, 저장취소, 매출발행   
'*  6. Component List       : 
'*  7. Modified date(First) : 2011/05/20
...
'========================================================================================================
Const BIZ_PGM_ID  = "D4211MB1.asp"  'Main조회
Const BIZ_PGM_ID2 = "D4211MB2.asp"  'Dtl조회
Const BIZ_PGM_ID3 = "D4211MB3.asp"  '매출저장, 저장취소
Const BIZ_PGM_ID4 = "D4211MB4.asp"  '매출발행(batch_id 채번후 XXSB_DTI_MAIN 테이블 Update)
			...
			If .vspdData.text = "1"  Then
				...
				if	strAmend <> "" then
				   if (strAmend = "03" or  strAmend = "04") then
				        ...
				        .vspdData.Col = C1_total_amt ' total_amt pjs 2012-06-08 				        				        
