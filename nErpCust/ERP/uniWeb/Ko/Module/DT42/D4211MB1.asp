...
UNIValue(0, 1) = "^"
UNIValue(0, 2) = "^"
UNIValue(0, 3) = FilterVar(UniConvDate(Request("txtIssuedFromDt")), "''", "S")
UNIValue(0, 4) = FilterVar(UniConvDate(Request("txtIssuedToDt")), "''", "S")


If Request("txtSupplierCd") = "" Then
	UNIValue(0, 5) = "|"
Else
	UNIValue(0, 5) = FilterVar(UCase(Request("txtSupplierCd")), "''", "S")
End If

If Request("txtSalesGrpCd") = "" Then
	UNIValue(0, 6) = "|"
Else
	UNIValue(0, 6) = FilterVar(UCase(Request("txtSalesGrpCd")), "''", "S")
End If
...
If Request("rdoStatusFlag") = "A" Then
	UNIValue(0, 9) = "|"
Else
	UNIValue(0, 9) = FilterVar(UCase(Request("rdoStatusFlag")), "''", "S")
End If
...
If Request("txtDocNo") = "%" Then
	UNIValue(0, 10) = "|"
Else
	UNIValue(0, 10) = FilterVar(UCase(Request("txtDocNo")) & "%", "''", "S")
End If
