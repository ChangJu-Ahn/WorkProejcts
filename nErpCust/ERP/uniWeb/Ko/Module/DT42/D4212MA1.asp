...
'========================================================================================================
Const BIZ_PGM_ID  = "D4212MB1.asp"  'Main조회
Const BIZ_PGM_ID2 = "D4212MB2.asp"  'Dtl조회
Const BIZ_PGM_ID3 = "D4212MB3.asp"  'batch_id 채번후 발행취소
Const BIZ_PGM_ID4 = "D4212MB4.asp"  '발행취소 승인
Const BIZ_PGM_ID5 = "D4212MB5.asp"  '발행취소 거부
Const BIZ_PGM_ID6 = "D4212MB6.asp"  '발행취소 요청
Const BIZ_PGM_ID7 = "D4212MB7.asp"  '계산서 보기
...
Dim	C2_bill_qty                 '수량
Dim	C2_bill_unit                '단위
Dim	C2_bill_price               '단가
Dim	C2_total_amt                '합계금액
Dim	C2_bill_amt                 '매출금액
Dim	C2_vat_amt                  '부가세금액
Dim	C2_total_amt_loc            '합계금액(자국)          '    
Dim	C2_bill_amt_loc             '매출금액(자국)
Dim	C2_vat_amt_loc              '부가세금액(자국)
Dim	C2_bill_no                  '매출번호
Dim	C2_bill_seq                 'SEQ
Dim	C2_tax_bill_no              '세금계산서관리번호
Dim	C2_where_flag               '업무명
...
Sub InitSpreadPosVariables()
	'add tab1 header datatable column
        ...
        C1_conversation_id      =  4     '전송관리번호
     	...
     	C1_tax_doc_no           =  6     '세금계산서번호
        C1_dti_status           =  7     '계산서상태
        C1_dti_status_nm        =  8     '계산서상태명
        C1_tax_bill_type_nm     =  9     '계산서유형
        C1_amend_code           =  10    '수정코드
        C1_amend_pop            =  11    '수정코드팝업                
        C1_amend_code_nm        =  12     'Amend Code Name.                
     	C1_bp_cd                =  13     '거래처코드
     	C1_bp_nm                =  14     '거래처명
        C1_byr_emp_name         =  15     '거래처담당자        
        C1_byr_emp_pop          =  16     '거래처담당자팝업                
        C1_byr_dept_name        =  17     '거래처부서명        
        C1_byr_tel_num          =  18     '거래처 전화번호
        C1_byr_email            =  19     '거래처 담당자 E-Mail
        C1_issued_dt            =  20     '발행일
     	C1_vat_calc_type_nm     =  21    '부가세적용기준
     	C1_vat_inc_flag_nm      =  22     '부가세포함여부
     	C1_vat_type             =  23     '부가세타입
     	C1_vat_type_nm          =  24     '부가세형태명
     	C1_vat_rate             =  25     '부가세율
     	C1_cur                  =  26     '통화
     	C1_total_amt            =  27     '합계금액
     	C1_fi_total_amt         =  28     '(회계)합계금액    
     	C1_net_amt              =  29     '공급가액
     	C1_fi_net_amt           =  30     '(회계)공급가액 
     	C1_vat_amt              =  31     '부가세금액
     	C1_fi_vat_amt           =  32     '(회계)부가세금액
     	C1_total_loc_amt        =  33     '합계금액(자국)       
     	C1_fi_total_loc_amt     =  34     '(회계)합계금액(자국)
     	C1_net_loc_amt          =  35     '공급가액(자국)
     	C1_fi_net_loc_amt       =  36     '(회계)공급가액(자국)
     	C1_vat_loc_amt          =  37     '부가세금액(자국)
     	C1_fi_vat_loc_amt       =  38     '(회계)부가세금액(자국)
     	C1_report_biz_area      =  39     '세금신고사업장
     	C1_tax_biz_area_nm      =  40     '세금신고사업장명
     	C1_sales_grp            =  41     '영업그룹
     	C1_sales_grp_nm         =  42     '영업그룹명
    	C1_remark               =  43     '비고    	
    	C1_sbdescription        =  44     '취소/거부사유
...
Sub InitSpreadPosVariables2()
	'add tab1 detail datatable column
    	...
    	C2_bill_amt_loc             =  11     '매출금액(자국)
    	C2_vat_amt_loc              =  12     '부가세금액(자국)
    	C2_bill_no                  =  13     '매출번호
    	C2_bill_seq                 =  14     'SEQ
    	C2_tax_bill_no              =  15     '세금계산서관리번호
    	C2_where_flag               =  16     '업무명
...
Sub InitSpreadSheet()
	...
	With frm1.vspdData	
		...
		ggoSpread.SSSetEdit  	C1_bp_cd,			 "거래처처코드",   			15, ,,18
...
Sub InitSpreadSheet2()
	...
	With frm1.vspdData2	
		...
		ggoSpread.SSSetFloat  	C2_vat_amt, 			"부가세금액",		18, parent.ggAmtOfMoneyNo,ggStrIntegeralPart, ggStrDeciPointPart,parent.gComNum1000,parent.gComNumDec
		...
		ggoSpread.SSSetFloat  	C2_bill_amt_loc, 		"매출금액(자국)",   18, parent.ggAmtOfMoneyNo,ggStrIntegeralPart, ggStrDeciPointPart,parent.gComNum1000,parent.gComNumDec
		ggoSpread.SSSetFloat  	C2_vat_amt_loc, 		"부가세금액(자국)", 18, parent.ggAmtOfMoneyNo,ggStrIntegeralPart, ggStrDeciPointPart,parent.gComNum1000,parent.gComNumDec

		ggoSpread.SSSetEdit  	C2_bill_no, 			"매출번호", 		15, ,,18
		ggoSpread.SSSetEdit  	C2_bill_seq, 			"Seq", 		        15, ,,18
		ggoSpread.SSSetEdit  	C2_tax_bill_no, 		"세금계산서관리번호", 	15, ,,18
		ggoSpread.SSSetEdit  	C2_where_flag, 		    "업무명", 		    15, ,,18
	...
	Select Case UCase(pvSpdNo)
		Case "A"
            ...
            C1_conversation_id      = iCurColumnPos(4)     '전송관리번호
     	    ...
     	    C1_tax_doc_no           = iCurColumnPos(6)     '세금계산서번호
            C1_dti_status           = iCurColumnPos(7)     '계산서상태
            C1_dti_status_nm        = iCurColumnPos(8)     '계산서상태명
            C1_tax_bill_type_nm     = iCurColumnPos(9)     '계산서유형
            C1_amend_code           = iCurColumnPos(10)    '수정코드
            C1_amend_pop            = iCurColumnPos(11)    '팝업                        
            C1_amend_code_nm        = iCurColumnPos(12)     'Amend Code Name.                 	    
     	    C1_bp_cd                = iCurColumnPos(13)     '거래처코드
     	    C1_bp_nm                = iCurColumnPos(14)     '거래처명
            C1_byr_emp_name         = iCurColumnPos(15)    '거래처담당자            
            C1_byr_emp_pop          = iCurColumnPos(16)    '거래처담당자팝업                        
            C1_byr_dept_name        = iCurColumnPos(17)    '거래처부서명            
            C1_byr_tel_num          = iCurColumnPos(18)     '거래처 전화번호
            C1_byr_email            = iCurColumnPos(19)     '거래처 담당자 E-Mail
            C1_issued_dt            = iCurColumnPos(20)     '발행일
     	    C1_vat_calc_type_nm     = iCurColumnPos(21)    '부가세적용기준
     	    C1_vat_inc_flag_nm      = iCurColumnPos(22)     '부가세포함여부
     	    C1_vat_type             = iCurColumnPos(23)     '부가세타입
     	    C1_vat_type_nm          = iCurColumnPos(24)     '부가세형태명
     	    C1_vat_rate             = iCurColumnPos(25)     '부가세율
     	    C1_cur                  = iCurColumnPos(26)     '통화
     	    C1_total_amt            = iCurColumnPos(27)    '(회계)합계금액
     	    C1_fi_total_amt         = iCurColumnPos(28)     '(회계)합계금액(자국)    
     	    C1_net_amt              = iCurColumnPos(29)     '공급가액
     	    C1_fi_net_amt           = iCurColumnPos(30)     '(회계)공급가액 
     	    C1_vat_amt              = iCurColumnPos(31)     '부가세금액
     	    C1_fi_vat_amt           = iCurColumnPos(32)     '(회계)부가세금액
     	    C1_total_loc_amt        = iCurColumnPos(33)     '합계금액(자국)       
     	    C1_fi_total_loc_amt     = iCurColumnPos(34)     '(회계)합계금액(자국)
     	    C1_net_loc_amt          = iCurColumnPos(35)     '공급가액(자국)
     	    C1_fi_net_loc_amt       = iCurColumnPos(36)     '(회계)공급가액(자국)
     	    C1_vat_loc_amt          = iCurColumnPos(37)     '부가세금액(자국)
     	    C1_fi_vat_loc_amt       = iCurColumnPos(38)     '(회계)부가세금액(자국)
     	    C1_report_biz_area      = iCurColumnPos(39)     '세금신고사업장
     	    C1_tax_biz_area_nm      = iCurColumnPos(40)     '세금신고사업장명
     	    C1_sales_grp            = iCurColumnPos(41)     '영업그룹
     	    C1_sales_grp_nm         = iCurColumnPos(42)     '영업그룹명
    	    C1_remark               = iCurColumnPos(43)     '비고
    	    
    	    C1_sbdescription        = iCurColumnPos(44)     '취소/거부사유
...
Sub GetSpreadColumnPos2(ByVal pvSpdNo)
	...
	Select Case UCase(pvSpdNo)
		Case "A"
    	    ...
    	    C2_bill_qty                 = iCurColumnPos(4)     '수량
    	    C2_bill_unit                = iCurColumnPos(5)     '단위
    	    C2_bill_price               = iCurColumnPos(6)     '단가
    	    C2_total_amt                = iCurColumnPos(7)     '합계금액
    	    C2_bill_amt                 = iCurColumnPos(8)     '매출금액
    	    C2_vat_amt                  = iCurColumnPos(9)     '부가세금액
    	    C2_total_amt_loc            = iCurColumnPos(10)     '합계금액(자국)          = iCurColumnPos(1     '    
    	    C2_bill_amt_loc             = iCurColumnPos(11)     '매출금액(자국)
    	    C2_vat_amt_loc              = iCurColumnPos(12)     '부가세금액(자국)
    	    C2_bill_no                  = iCurColumnPos(13)     '매출번호
    	    C2_bill_seq                 = iCurColumnPos(14)     'SEQ
    	    C2_tax_bill_no              = iCurColumnPos(15)     '세금계산서관리번호
    	    C2_where_flag               = iCurColumnPos(16)     '업무명
	End Select    
End Sub
				 ...
				 strVal = strVal & "C" & parent.gColSep								'0
  			     ...
  			     .vspdData.Col = C1_conversation_id     :	strVal = strVal & Trim(.vspdData.Text) & parent.gColSep		'Conversation ID              '2			     
                                                        ...
                                                        :	strVal = strVal & sbdescription & parent.gColSep		                                  '4  			     			       			     
  													    :	strVal = strVal & CancelFlag & parent.gRowSep				'구분      			      '5	
...
Function DbQueryOk()																		'☆: 조회 성공후 실행로직 
    ...
    With frm1.vspdData
        ...
        If (strDtiStatus <> "I") and (strDtiStatus <> "C") and (strDtiStatus <> "N")   then    '상태값 체크
...
Sub SetButtonDisable(strTaxDocStatus)
   ...
   With frm1 
      Select Case UCase(strTaxDocStatus)
        ...
        case "I":
            .btnPublishCancel.disabled = false    '발행취소
            .btnAccept.disabled = true
            .btnReject.disabled = true
            .btnEmailPublish.disabled = false '이메일재발송
            .CancelRequest.disabled = true
            .btnPrint.disabled = true
        ...
        case "C":
            ...
            .btnReject.disabled = true
            .btnEmailPublish.disabled = false '이메일재발송
            .CancelRequest.disabled = false  '발행취소요청
            .btnPrint.disabled = false    '계산서보기
								...
								<FIELDSET CLASS="CLSFLD">
									<TABLE <%=LR_SPACE_TYPE_40%>>
										...
										<TR>
											...
											<TD CLASS=TD6 NOWRAP><INPUT CLASS="clstxt" TYPE=TEXT NAME="txtKeyNo" SIZE=40 MAXLENGTH=40 STYLE="TEXT-ALIGN: Left" tag="11XXXU" ALT="세금계산서번호"></TD>
			...
			<TR HEIGHT="20">
				<TD WIDTH="100%" >
  					<TABLE <%=LR_SPACE_TYPE_30%>>
						<TR>
							<TD WIDTH=10>&nbsp</TD>
							<TD><BUTTON NAME="btnPublishCancel" CLASS="CLSSBTN" OnClick="VBScript:Call fnPublishCancel()">발행취소</BUTTON>&nbsp;
							    ...
							    <BUTTON NAME="btnEmailPublish" CLASS="CLSSBTN" OnClick="VBScript:Call fnEmailPublish()">이메일 재발송</BUTTON>&nbsp;
							    <BUTTON NAME="CancelRequest" CLASS="CLSSBTN" OnClick="VBScript:Call fnCancelRequest()">발행취소 요청</BUTTON>&nbsp;
