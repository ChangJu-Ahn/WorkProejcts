...
Else
    If Request("cboBillStatus") = "X" Then
	    UNIValue(0, 6) = " is null "
    Else
	    UNIValue(0, 6) = "=" & FilterVar(UCase(Request("cboBillStatus")), "''", "S")
    End If
End IF    
...
If Request("rdoStatusFlag") = "A" Then
	UNIValue(0, 7) = "|"
Else
	UNIValue(0, 7) = FilterVar(UCase(Request("rdoStatusFlag")), "''", "S")
End If
...
If Request("txtDocNo") = "%" Then
	UNIValue(0, 8) = "|"
Else
	UNIValue(0, 8) = FilterVar(UCase(Request("txtDocNo")) & "%", "''", "S")
End If
...
if Request("cboAmendCode") = "" Then
     UNIValue(0, 9) = "|"
Else   
     UNIValue(0, 9) = FilterVar(UCase(Request("cboAmendCode")), "''", "S")
End IF    
