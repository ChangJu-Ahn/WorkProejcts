...
'========================================================================================================
Const BIZ_PGM_ID  = "D4221MB1.asp"  'Main조회
Const BIZ_PGM_ID2 = "D4221MB2.asp"  'Dtl조회
Const BIZ_PGM_ID3 = "D4221MB3.asp"  '역매출발행
Const BIZ_PGM_ID4 = "D4221MB4.asp"  '역발행거부, 발행취소, 발행취소요청, 발행취소승인, 취소거부
Const BIZ_PGM_ID5 = "D4221MB5.asp"  '계산서보기
...
Sub InitSpreadSheet()
	...
	With frm1.vspdData	
	    ...
	    .ReDraw = false
        .MaxCols = C1_sup_com_email + 1												'☜: 최대 Columns의 항상 1개 증가시킴 
				 ...
				 strVal = strVal & "C" & parent.gColSep								'0
  			     ...
  			     .vspdData.Col = C1_conversation_id     :	strVal = strVal & Trim(.vspdData.Text) & parent.gColSep		'Conversation ID              '2			     
                                                        :	strVal = strVal & sbdescription & parent.gColSep		                                  '3  			     			       			     
  													    :	strVal = strVal & docIssued & parent.gColSep				'구분      			      '4	
                .vspdData.Col = C1_sup_com_regno        :	strVal = strVal & Trim(.vspdData.Text) & parent.gRowSep		    '사업자번호               '5			       													    
...
'역발행거부, 발행취소, 발행취소요청, 발행취소승인,   (웹페이지 호출은 안한상태)
Function  ExeNumOk2()
    Dim change_code 
    Dim signal
    Dim sbdescription
								...
								<FIELDSET CLASS="CLSFLD">
									<TABLE <%=LR_SPACE_TYPE_40%>>
										...
										<TR> 											
											...
											<TD CLASS="TD6" NOWRAP>
											    <SELECT NAME="cboTaxArea" ALT="세금신고사업장" CLASS=cboNormal TAG="11" style="width:170px"><OPTION VALUE=""></OPTION></SELECT>											    
											</TD> 																						 											
										</TR>
										<TR>
			...
			<TR HEIGHT="20">
				<TD WIDTH="100%" >
  					<TABLE <%=LR_SPACE_TYPE_30%>>
						<TR>
							<TD WIDTH=10>&nbsp</TD>
							<TD><BUTTON NAME="btnIssue" CLASS="CLSSBTN" OnClick="VBScript:Call fnIssue()">역매출 발행</BUTTON>&nbsp;
                                <BUTTON NAME="btnIssueReject" CLASS="CLSSBTN" OnClick="VBScript:Call fnIssueReject()">역발행 거부</BUTTON>&nbsp;
							    <BUTTON NAME="btnCancel" CLASS="CLSSBTN" OnClick="VBScript:Call fnCancel()">발행취소</BUTTON>&nbsp;
							    
							    <BUTTON NAME="btnCancelAll" CLASS="CLSSBTN" OnClick="VBScript:Call fnCancelAll()">발행취소 요청</BUTTON>&nbsp;
							    <BUTTON NAME="btnOk" CLASS="CLSSBTN" OnClick="VBScript:Call fnOk()">발행취소 승인</BUTTON>&nbsp;
							    <BUTTON NAME="btnRireject" CLASS="CLSSBTN" OnClick="VBScript:Call fnRireject()">취소거부</BUTTON>&nbsp;
							    <BUTTON NAME="btnEmail" CLASS="CLSSBTN" OnClick="VBScript:Call fnEmail()">이메일 재발송</BUTTON>&nbsp;
							    <BUTTON NAME="btnPrint" CLASS="CLSSBTN" OnClick="VBScript:Call fnPrint()">계산서보기</BUTTON>&nbsp;
