...
Response.Write "With parent" & vbCrLf
	...
	Response.Write ".frm1.txtRoutNo.value = """ & ConvSPChars(rs1("ROUT_NO")) & """" & vbCrLf
	Response.Write ".frm1.txtRoutingNm.value = """ & ConvSPChars(rs1("DESCRIPTION")) & """" & vbCrLf
	Response.Write ".frm1.txtRoutingNo.value = """ & ConvSPChars(rs1("ROUT_NO")) & """" & vbCrLf
