...
<SCRIPT LANGUAGE = "VBScript" SRC = "p1201ma1_ko441.vbs"></SCRIPT>
				...
				<TR>
					<TD WIDTH=100% HEIGHT=* valign=top>
						<TABLE <%=LR_SPACE_TYPE_60%>>
							...
							<TR>
								<TD CLASS="TD5" NOWRAP>재작업여부</TD>
								<TD CLASS="TD6" NOWRAP><INPUT TYPE="RADIO" NAME="rdoReworkYN" ID="rdoReworkYN1" Value="Y" CLASS="RADIO" tag="11" ><LABEL FOR="rdoReworkYN1">Y&nbsp;</LABEL>
													 <INPUT TYPE="RADIO" NAME="rdoReworkYN" ID="rdoReworkYN2" Value="N" CLASS="RADIO" tag="11" ><LABEL op="rdoReworkYN2">N&nbsp;</LABEL>
													 <INPUT TYPE="RADIO" NAME="rdoReworkYN" ID="rdoReworkYN3" Value="A" CLASS="RADIO" tag="11" CHECKED><LABEL op="rdoReworkYN2">전체&nbsp;</LABEL></TD>
		 						<TD CLASS="TD5" NOWRAP>장비</TD>
								<TD CLASS="TD6" NOWRAP><INPUT CLASS="clstxt" TYPE=TEXT NAME="txtMachineCd" SIZE=15 MAXLENGTH=15 tag="11XXXU" ALT="장비"><IMG SRC="../../../CShared/image/btnPopup.gif" NAME="btnMachineCd" align=top TYPE="BUTTON"ONCLICK="vbscript:OpenConMachine()">&nbsp;<INPUT TYPE=TEXT NAME="txtMachineNm" SIZE=20 tag="14"></TD>
							</TR>
							<TR HEIGHT="40%">
