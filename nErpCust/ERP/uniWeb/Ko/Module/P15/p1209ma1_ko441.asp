...
Const BIZ_PGM_QRY_ID = "p1209mb1_ko441.asp"											'☆: 비지니스 로직 ASP명 
Const BIZ_PGM_SAVE_ID= "p1209mb2_ko441.asp"											'☆: 비지니스 로직 ASP명 
Const BIZ_PGM_DEL_ID = "p1209mb3_ko441.asp"											'☆: 비지니스 로직 ASP명 
...
Sub InitSpreadSheet()
	...
	With frm1.vspdData
		...
		ggoSpread.SSSetEdit	C_WcCd, 		"작업장",	 8,,,7,2
		ggoSpread.SSSetButton	C_WcPopup
		ggoSpread.SSSetEdit	C_WcNm, 		"작업장명", 	20
		ggoSpread.SSSetCombo	C_JobCd, 		"공정작업코드",	12
		ggoSpread.SSSetCombo	C_JobNm, 		"공정작업명",	20
		ggoSpread.SSSetEdit	C_InsideFlg, 		"타입", 	 8
		ggoSpread.SSSetEdit	C_InsideFlgDesc, 	"타입", 	 8
		ggoSpread.SSSetCombo	C_RoutOrder, 	 	"공정단계", 	10      
...
Function DbQueryOk(ByVal LngMaxRow)														'☆: 조회 성공후 실행로직 
	...
	If UCase(Trim(frm1.vspdData.Text)) = "N" Then	'외주 공정이면 
		ggoSpread.SpreadUnLock		C_BpCd,		lRow, C_BpPopup, lRow
		ggoSpread.SpreadUnLock		C_CurCd,	lRow, C_CurPopup, lRow
		ggoSpread.SpreadUnLock		C_SubconPrc,	lRow, C_SubconPrc, lRow
		ggoSpread.SpreadUnLock		C_TaxType,	lRow, C_TaxPopup, lRow
					...
					<TD CLASS="CLSMTABP">
						<TABLE ID="MyTab" CELLSPACING=0 CELLPADDING=0>
							<TR>
								...
								<td background="../../../CShared/image/table/seltab_up_bg.gif" align="center" CLASS="CLSMTAB"><font color=white>품목그룹표준라우팅등록</font></td>
						...
						<FIELDSET CLASS="CLSFLD">
							<TABLE <%=LR_SPACE_TYPE_40%>>
								<TR>
									...
									<TD CLASS="TD6" NOWRAP><INPUT TYPE=TEXT NAME="txtRoutNo" SIZE=15 MAXLENGTH=7 tag="12XXXU" ALT = "품목그룹"><IMG SRC="../../../CShared/image/btnPopup.gif" NAME="btnRoutNo" align=top TYPE="BUTTON"ONCLICK="vbscript:OpenConRouting frm1.txtRoutNo.value">&nbsp;<INPUT TYPE=TEXT NAME="txtRoutingNm" SIZE=30 MAXLENGTH=50 tag="14"></TD>
								</TR>
							</TABLE>
						</FIELDSET>
					</TD>
				...
				<TR>
					<TD WIDTH=100% HEIGHT=* valign=top>
						<TABLE <%=LR_SPACE_TYPE_60%>>
							<TR>
								<TD CLASS="TD5" NOWRAP>품목그룹</TD>
								<TD CLASS="TD6" NOWRAP><INPUT TYPE=TEXT NAME="txtRoutingNo" SIZE=20 MAXLENGTH=7 tag="23XXXU" ALT="품목그룹"><IMG SRC="../../../CShared/image/btnPopup.gif" NAME="btnRoutNo" align=top TYPE="BUTTON"ONCLICK="vbscript:OpenRouting frm1.txtRoutingNo.value">&nbsp;&nbsp;<INPUT TYPE=TEXT NAME="txtRoutingNm1" SIZE=30 MAXLENGTH=50 tag="22" ALT="품목그룹명"></TD>
							...
							<TR>
								...
								<TD CLASS=TD6 NOWRAP><INPUT TYPE=TEXT NAME="txtCostCd" SIZE=15 MAXLENGTH=10 tag="23XXXU" ALT="작업지시 C/C"><IMG SRC="../../../CShared/image/btnPopup.gif" NAME="btnCostCtr" align=top TYPE="BUTTON" ONCLICK="vbscript:OpenCostCtr()">&nbsp;<INPUT NAME="txtCostNm" MAXLENGTH="20" SIZE=30 ALT ="코스트센타명" tag="24"></TD>
							</TR>
							<TR>
								<TD CLASS=TD5 NOWRAP>주라우팅</TD>
								<TD CLASS=TD6 NOWRAP><INPUT TYPE="RADIO" NAME="rdoMajorRouting" ID="rdoMajorRouting1" Value="Y" CLASS="RADIO" tag="23X" CHECKED><LABEL FOR="rdoMajorRouting1">예</LABEL>
													 <INPUT TYPE="RADIO" NAME="rdoMajorRouting" ID="rdoMajorRouting2" Value="N" CLASS="RADIO" tag="23X"><LABEL op="rdoMajorRouting2">아니오</LABEL></TD>
								<TD CLASS=TD5 NOWRAP>라우팅 순서</TD>
								<TD CLASS=TD6 NOWRAP>
									<SCRIPT LANGUAGE=JavaScript> ExternalWrite('<OBJECT CLASSID="CLSID:DD55D13D-EBF7-11D0-8810-0000C0E5948C" name=txtALTRTVALUE CLASS=FPDS65 title=FPDOUBLESINGLE SIZE="3" MAXLENGTH="3" ALT="순서" tag="23X6Z" id=OBJECT1> </OBJECT>');</SCRIPT>
								</TD>							
							</TR>	
							<TR>
