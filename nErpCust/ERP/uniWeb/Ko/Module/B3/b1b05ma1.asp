...
Function OpenSpreadPop(Byval strCode)
 ...
 arrParam(4) = "(Plant.PLANT_CD = ItemPlant.PLANT_CD) and (itemplant.item_cd='"_
    & FilterVar(Trim(frm1.txtItemCode.value),"","SNM") & "')"     <%' Where Condition%>
  ...
  For lRow = 1 To .vspdData.MaxRows
   ...
   Select Case .vspdData.Text
    Case ggoSpread.InsertFlag, ggoSpread.UpdateFlag
     '--- 품목코드 
     strVal = strVal & FilterVar(Trim(frm1.txtItemCode.value), "", "SNM") & Parent.gColSep
     '--- 공장코드 
     .vspdData.Col = C_PlantCode              
    ...
    Case ggoSpread.DeleteFlag
     '--- 품목코드 
     strDel = strDel & FilterVar(Trim(frm1.txtItemCode.value), "", "SNM") & Parent.gColSep
     '--- 공장코드 
     .vspdData.Col = C_PlantCode              
						...
						<FIELDSET CLASS="CLSFLD">
							<TABLE <%=LR_SPACE_TYPE_40%>>
								<TR>
									...
									<TD CLASS=TD6 COLSPAN = 4><INPUT NAME="txtConItemCode" ALT="품목" TYPE="Text" MAXLENGTH="18" SIZE=10 tag="12XXXU"><IMG SRC="../../../CShared/image/btnPopup.gif" NAME="btnPopUp" align=top TYPE="BUTTON" ONCLICK="vbscript:OpenItemPopup 1,frm1.txtConItemCode,frm1.txtConItemName">&nbsp;<INPUT NAME="txtConItemName" TYPE="Text" MAXLENGTH="40" SIZE=30 tag="24"></TD>
				...
				<TR>
					<TD WIDTH=100% HEIGHT=* VALIGN=TOP>
						<TABLE <%=LR_SPACE_TYPE_60%>>
							<TR>
								<TD CLASS=TD5 NOWRAP>품목</TD>
								<TD CLASS=TD6 COLSPAN = 4><INPUT NAME="txtItemCode" ALT="품목" TYPE="Text" MAXLENGTH="18" SIZE=18 tag="24XXXU">&nbsp;<INPUT NAME="txtItemName" TYPE="Text" MAXLENGTH="40" SIZE=40 tag="24"></TD>
							</TR>
							<TR>
								<TD CLASS=TD5 NOWRAP>배분비의합</TD>
								<TD CLASS=TD6 NOWRAP><INPUT NAME="txtRate" TYPE="Text" MAXLENGTH="10" SIZE=20 STYLE="Text-Align:Right" tag="24XXX">&nbsp;<B>%</B>&nbsp;</TD>
								<TD CLASS=TD6 NOWRAP></TD>
								<TD CLASS=TD6 NOWRAP></TD>
							</TR>
							<TR>
