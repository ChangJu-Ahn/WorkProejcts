...
Call ServerMesgBox("HANC : " & "4번" , vbInformation, I_MKSCRIPT)
...
'---------------------------------------------------
Call ServerMesgBox("HANC : ConvSPChars(UCase(Trim(I5_b_item_group_cd)))  " & ConvSPChars(UCase(Trim(I5_b_item_group_cd))) , vbInformation, I_MKSCRIPT)
Response.Write "<Script Language = VBScript>" & vbCrLf
