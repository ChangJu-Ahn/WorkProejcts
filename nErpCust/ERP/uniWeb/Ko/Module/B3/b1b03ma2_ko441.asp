...
Const BIZ_PGM_QRY_ID				= "b1b03mb4_ko441.asp"			
Const BIZ_PGM_LOOKUPITEMGROUP_ID	= "b1b03mb5_ko441.asp"			
Const BIZ_PGM_LOOKUPITEM_ID			= "b1b03mb6_ko441.asp"			
						...
						<FIELDSET CLASS="CLSFLD">
							<TABLE <%=LR_SPACE_TYPE_40%>>
								<TR>
									...
									<TD CLASS=TD6 NOWRAP><SELECT NAME="cboItemGroup" ALT="품목계정" STYLE="Width: 100px;" tag="11"><OPTION VALUE = ""></OPTION></SELECT></TD>
