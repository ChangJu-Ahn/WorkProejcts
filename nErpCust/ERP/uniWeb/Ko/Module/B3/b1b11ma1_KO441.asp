...
<SCRIPT LANGUAGE = "VBScript" SRC = "b1b11ma1_KO441.vbs"></SCRIPT>
										...
										<LEGEND>기본정보</LEGEND>
											...
											<!-- 품목그룹별표준라우팅 생성 기능 추가...KBS...2010.10.26...시작...--->
												<TR>
													...
													<TD CLASS=TD6 NOWRAP><INPUT TYPE=TEXT NAME="txtItemGrp1" CLASS=protected READONLY=true TABINDEX="-1" SIZE=20 MAXLENGTH=40 tag="24" ALT="품목그룹"> &nbsp;/&nbsp;
															     <INPUT TYPE=TEXT NAME="txtItemGrp2" CLASS=protected READONLY=true TABINDEX="-1" SIZE=20 MAXLENGTH=40 tag="24" ALT="품목그룹"> &nbsp;&nbsp;
															     <BUTTON NAME="btnCrtRouting" CLASS="CLSNBTN">라우팅생성</BUTTON>
													</TD>
												</TR>
										...
										<LEGEND>재고정보</LEGEND>
											<TABLE CLASS="TB2" CELLSPACING=0>	
												...
												<TR>
													...
													<TD CLASS=TD6 NOWRAP><SELECT NAME="cboIssueType" CLASS=required ALT="출고방법" STYLE="Width: 133px;" tag="22"></SELECT> [오창3/음성공장 출고방법재확인] </TD>
												</TR>
												<TR>
