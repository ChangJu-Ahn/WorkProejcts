...
Const BIZ_PGM_QRY_ID	= "b1b01mb1_ko441.asp"											'☆: 비지니스 로직 ASP명 
Const BIZ_PGM_SAVE_ID	= "b1b01mb2_ko441.asp"											'☆: 비지니스 로직 ASP명 
...
Sub InitSpreadSheet()
	...
	With frm1.vspdData
		...
		ggoSpread.SSSetEdit 	C_CBMDesc,			"MES 품목코드",	20,,,50	
		...
		Call ggoSpread.SSSetColHidden(C_ClassCd, C_ClassCd, True)
		Call ggoSpread.SSSetColHidden(C_ClassNm, C_ClassNm, True)
		Call ggoSpread.SSSetColHidden(C_CharValue1, C_CharValue1, True)
		Call ggoSpread.SSSetColHidden(C_CharValueDesc1, C_CharValueDesc1, True)
		Call ggoSpread.SSSetColHidden(C_CharValue2, C_CharValue2, True)
		Call ggoSpread.SSSetColHidden(C_CharValueDesc2, C_CharValueDesc2, True)
...
Sub SetSpreadLock()
    With frm1
		...
		ggoSpread.SSSetRequired  C_ValidFromDt, -1, C_ValidFromDt
...
Sub SetSpreadColor(ByVal pvStartRow, ByVal pvEndRow)
    With frm1
		...
		ggoSpread.SSSetRequired  C_ItemAcctDesc,  pvStartRow, pvEndRow
		ggoSpread.SSSetRequired  C_BasicUnit,  pvStartRow, pvEndRow
		ggoSpread.SSSetRequired  C_ValidFromDt, pvStartRow, pvEndRow
		ggoSpread.SSSetRequired  C_ValidToDt, pvStartRow, pvEndRow

		ggoSpread.SpreadLock	 C_ItemGroupNm, pvStartRow,C_ItemGroupNm, pvEndRow
		ggoSpread.SpreadLock	 C_BaseItemNm, pvStartRow,C_ItemGroupNm, pvEndRow
...
'20080116::hanc	ggoSpread.Source = frm1.vspdData
'20080116::hanc	If Not ggoSpread.SSDefaultCheck  Then                                  '⊙: Check contents area
'20080116::hanc       Exit Function
'20080116::hanc    End If
   ...
   With frm1
   	.vspdData.focus
        for imRow2 = 1 to imRow 
			...
			.vspdData.Text = "N"
            .vspdData.col = C_BlanketPurFlg  
			.vspdData.Text = "N"
            .vspdData.col = C_ItemImageFlag  
			.vspdData.Text = "N"
            .vspdData.col = C_ValidFlag   
			.vspdData.Text = "Y"

            .vspdData.col = C_ValidFromDt
			.vspdData.Text =  StartDate											'유효기간 default : today	
    ...
    For lRow = 1 To .vspdData.MaxRows
        ...
        Select Case GetSpreadText(.vspdData,0,lRow,"X","X")
            ...
            Case ggoSpread.InsertFlag
                call vspdData_ComboSelChange(5,lRow)    '20080116::hanc
...
<TABLE <%=LR_SPACE_TYPE_00%>>
	...
	<TR>
		<TD WIDTH=100% HEIGHT=<%=BizSize%>><IFRAME NAME="MyBizASP" SRC="../../blank.htm" WIDTH=100% HEIGHT=30FRAMEBORDER=0 SCROLLING=yes noresize framespacing=0  TABINDEX="-1"></IFRAME>
		</TD>
	</TR>
</TABLE>
