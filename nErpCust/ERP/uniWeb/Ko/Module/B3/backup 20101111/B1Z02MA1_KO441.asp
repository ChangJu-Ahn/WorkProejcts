...
'========================================================================================================
Const BIZ_PGM_ID = "B1Z02MB1_KO441.asp"                                      '비지니스 로직 ASP명 
...
Sub InitSpreadSheet()
	...
	With frm1.vspdData
      ...
      ggoSpread.Source = frm1.vspdData
			...
			ggoSpread.SSSetEdit   C_USER_ID     , "사용자ID", 10,,, 18, 2
			ggoSpread.SSSetButton C_USER_POP
			ggoSpread.SSSetEdit  	C_USER_NM     , "사용자명", 16
			ggoSpread.SSSetCheck	C_CDN_RCV			, "접수",10,,,true
			ggoSpread.SSSetCheck	C_CDN_BIZ			, "영업",10,,,true
			ggoSpread.SSSetCheck	C_CDN_BMP			, "기술(BUMP)",10,,,true
			ggoSpread.SSSetCheck	C_CDN_PKG			, "기술(PKG)",10,,,true
			ggoSpread.SSSetCheck	C_CDN_PRD			, "생산",10,,,true
			ggoSpread.SSSetCheck	C_CDN_TQC			, "품질",10,,,true
    ...
    Select Case UCase(pvSpdNo)
       Case "A"
            ...
            Call ggoSpread.GetSpreadColumnPos(iCurColumnPos)
						...
						C_USER_POP	= iCurColumnPos(2)
						C_USER_NM		= iCurColumnPos(3)
						C_CDN_RCV		= iCurColumnPos(4)
						C_CDN_BIZ		= iCurColumnPos(5)
						C_CDN_BMP		= iCurColumnPos(6)
						C_CDN_PKG		= iCurColumnPos(7)
						C_CDN_PRD		= iCurColumnPos(8)
						C_CDN_TQC		= iCurColumnPos(9)
...
Sub SetSpreadLock()
    With frm1
        ...
        ggoSpread.SpreadLock    C_USER_POP, -1, C_USER_POP
...
Sub SetSpreadColor(ByVal pvStartRow,ByVal pvEndRow)
    With frm1
       ...
       .vspdData.ReDraw = False
         ...
         ggoSpread.SSSetProtected		C_USER_NM, pvStartRow, pvEndRow
           ...
           Select Case .vspdData.Text
               ...
               Case ggoSpread.InsertFlag                                      '☜: Insert
                    strVal = strVal & "C" & parent.gColSep
										strVal = strVal & GetSpreadText(frm1.vspdData,C_USER_ID,lRow,"X","X") & parent.gColSep
										strVal = strVal & GetSpreadText(frm1.vspdData,C_CDN_RCV,lRow,"X","X") & parent.gColSep
               ...
               Case ggoSpread.DeleteFlag                                      '☜: Delete
                    ...
                    strDel = strDel & "D" & parent.gColSep
										strDel = strDel & GetSpreadText(frm1.vspdData,C_USER_ID,lRow,"X","X") & parent.gColSep
										strDel = strDel & GetSpreadText(frm1.vspdData,C_CDN_RCV,lRow,"X","X") & parent.gColSep
...
Function OpenUser2(pRow)
	...
	arrParam(2) = Trim(GetSpreadText(frm1.vspdData,C_USER_ID,pRow,"X","X"))	
	arrParam(3) = ""								
	arrParam(4) = "USR_KIND='U'"	
	arrParam(5) = "사용자 ID"					
    arrField(0) = "USR_ID"						
    arrField(1) = "USR_NM"					
	...
	If arrRet(0) = "" Then
		Exit Function
	Else
		call frm1.vspdData.SetText(C_USER_ID,pRow,arrRet(0))
		call frm1.vspdData.SetText(C_USER_NM,pRow,arrRet(1))
	End If	
End Function
					...
					<TD CLASS="CLSMTABP">
						<TABLE ID="MyTab" CELLSPACING=0 CELLPADDING=0>
							<TR>
								...
								<td background="../../../CShared/image/table/seltab_up_bg.gif" align="center" CLASS="CLSMTABP"><font color=white>CDN사용자등록</font></td>
