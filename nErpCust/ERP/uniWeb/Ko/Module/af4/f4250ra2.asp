...
Const BIZ_PGM_ID = "F4250RB2.asp"												'☆: 비지니스 로직 ASP명 
'========================================================================================================
...
Sub InitSpreadSheet()
    ...
    Call SetZAdoSpreadSheet("F4250RA201","S","A","V20030507",PopupParent.C_SORT_DBAGENT,frm1.vspdData, C_MaxKey, "X","X")
    Call SetSpreadLock() 
End Sub
			...
			<FIELDSET CLASS="CLSFLD">
				<TABLE <%=LR_SPACE_TYPE_40%>>
					<TR>
						...
						<TD CLASS=TD6 NOWRAP><SCRIPT LANGUAGE=JavaScript> ExternalWrite('<OBJECT CLASSID=<%=gCLSIDFPDT%> id=txtPayFromDt name=txtPayFromDt CLASS=FPDTYYYYMMDD title=FPDATETIME tag="13Z" ALT="시작상환일자"></OBJECT>');</SCRIPT>&nbsp;~&nbsp;<SCRIPT LANGUAGE=JavaScript> ExternalWrite('<OBJECT CLASSID=<%=gCLSIDFPDT%> id=txtPaynToDt name=txtPayToDt CLASS=FPDTYYYYMMDD title=FPDATETIME tag="13Z" ALT="종료상환일자"></OBJECT>');</SCRIPT></TD>
