...
Const BIZ_PGM_ID = "F4214MB1_ko441.asp"												'☆: 비지니스 로직 ASP명 
'========================================================================================================
						...
						<FIELDSET>
							<TABLE <%=LR_SPACE_TYPE_40%>>
								<TR>
									...
									<!--네패스 요청으로 필수항목에서 선택항목으로 변경...20090901...kbs	-->
									<TD CLASS=TD6 NOWRAP><SCRIPT LANGUAGE=JavaScript> ExternalWrite('<OBJECT CLASSID=<%=gCLSIDFPDT%> id=fpBaseFrDt name=txtBaseFromDt CLASS=FPDTYYYYMMDD title=FPDATETIME tag="11" ALT="시작기준일자"></OBJECT>');</SCRIPT>&nbsp;~&nbsp;
														 <SCRIPT LANGUAGE=JavaScript> ExternalWrite('<OBJECT CLASSID=<%=gCLSIDFPDT%> id=fpBaseToDt name=txtBaseToDt CLASS=FPDTYYYYMMDD title=FPDATETIME tag="11" ALT="종료기준일자"></OBJECT>');</SCRIPT></TD>
