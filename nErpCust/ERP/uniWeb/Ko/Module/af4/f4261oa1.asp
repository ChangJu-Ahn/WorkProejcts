...
'*  3. Program ID           : F4261OA1
'*  4. Program Name         : 차입금전표내역출력 
'*  5. Program Desc         : Report of Loan Repay Result
'*  6. Comproxy List        : 
'*  7. Modified date(First) : 2003/05/08
...
Sub SetPrintCond(Condvar,StrEbrFile)
	Dim VarDateFr, VarDateTo
	Dim VarBizAreaCd, VarBizAreaCd1, VarLoanPlcFg, VarLoanPlcCd, VarLoanPlcField

	Dim	strAuthCond
	
	If frm1.Rb_Fg1.checked = True Then	 '회계전표 
			StrEbrFile = "f4261oa1a"
	ElseIf frm1.Rb_Fg2.checked = True Then	 '결의전표 
			StrEbrFile = "f4261oa1b"
	End If
					...
					<TD WIDTH=100% HEIGHT=*>
							<TABLE <%=LR_SPACE_TYPE_60%>>
								<TR>
									...
									<TD CLASS="TD6" NOWRAP><INPUT TYPE="RADIO" CLASS="Radio" NAME=Radio_Fg ID=Rb_Fg1 Checked ><LABEL FOR=Rb_Fg1>회계전표</LABEL>&nbsp;
										<INPUT TYPE="RADIO" CLASS="Radio" NAME=Radio_Fg ID=Rb_Fg2 ><LABEL FOR=Rb_Fg2>결의전표</LABEL>&nbsp;</TD>
								</TR>
								<TR>
									<TD CLASS="TD5" NOWRAP>전표일자</TD>
									<TD CLASS="TD6" NOWRAP><SCRIPT LANGUAGE=JavaScript> ExternalWrite('<OBJECT CLASSID=<%=gCLSIDFPDT%> NAME="txtDateFr" CLASS=FPDTYYYYMMDD tag="12X1" Title="FPDATETIME" ALT="시작회계일자" id=fpDateFr></OBJECT>');</SCRIPT>&nbsp;~&nbsp;
														   <SCRIPT LANGUAGE=JavaScript> ExternalWrite('<OBJECT CLASSID=<%=gCLSIDFPDT%> NAME="txtDateTo" CLASS=FPDTYYYYMMDD tag="12X1" Title="FPDATETIME" ALT="종료회계일자" id=fpDateTo></OBJECT>');</SCRIPT>
									</TD>
								</TR>
								<TR>
									<TD CLASS="TD5" NOWRAP>사업장</TD>
									<TD CLASS="TD6" NOWRAP><INPUT TYPE="Text" NAME="txtBizAreaCd" SIZE=10 MAXLENGTH=10 tag="11XXXU" ALT="시작사업장" STYLE="TEXT-ALIGN:left"><IMG SRC="../../../CShared/image/btnPopup.gif" NAME="btnBizAreaCd" ALIGN=top TYPE="BUTTON" ONCLICK="vbscript:Call OpenPopup(frm1.txtBizAreaCD.Value,1)"> 
														   <INPUT TYPE="Text" NAME="txtBizAreaNm" SIZE=25 tag="14X" ALT="사업장명">&nbsp;~&nbsp;</TD>
								</TR>
								<TR>
									<TD CLASS="TD5" NOWRAP></TD>
									<TD CLASS="TD6" NOWRAP><INPUT TYPE="Text" NAME="txtBizAreaCd1" SIZE=10 MAXLENGTH=10 tag="11XXXU" ALT="종료사업장" STYLE="TEXT-ALIGN:left"><IMG SRC="../../../CShared/image/btnPopup.gif" NAME="btnBizAreaCd1" ALIGN=top TYPE="BUTTON" ONCLICK="vbscript:Call OpenPopup(frm1.txtBizAreaCD1.Value,2)"> 
