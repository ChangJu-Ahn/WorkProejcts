...
'========================================================================================================
Const BIZ_PGM_ID = "F4233MB1.asp"                                      'Biz Logic ASP 
'========================================================================================================
...
Sub initSpreadPosVariables()  
	C_Choice				=  1	'선택 
	C_FLT_CONV_DT			=  2	'전화일자 
	C_Loan_No				=  3	'차입금번호 
	C_Loan_Nm				=  4	'차입내역 
	C_PLAN_ACCT_CD			=  5	'유동성계정 
	C_PLAN_ACCT_NM			=  6	'유동성계정명 
	C_LOAN_ACCT_CD			=  7	'차입계정 
	C_LOAN_ACCT_NM			=  8	'차입계정명 
	C_PAY_PLAN_DT			=  9	'상환예정일자 
	C_DOC_CUR				= 10	'통화 
	C_XCH_RATE				= 11	'환율 
	C_PLAN_AMT				= 12	'상환예정액 
	C_PLAN_LOC_AMT			= 13	'상환예정액(자국)
	C_LOAN_DT				= 14 	'차입일자 
	C_DUE_DT				= 15	'만기일자 
	C_TEMP_GL_NO			= 16	'결의 전표번호 
	C_GL_NO					= 17	'전표번호 
	C_REF_NO				= 18	'LOAN_NO 참조값 
	C_REF_SEQ				= 19	'SEQ	참조값 
	C_PAY_OBJ				= 20	'장단기 원금 OR 이자 구분(EX : LL, SL, LN, SN)
	C_RDP_CLS_FG			= 21	'상환완료여부 
	C_RESL_FG				= 22	'상환여부 
	C_CONF_FG				= 23	'확정여부 
End Sub
...
Sub GetSpreadColumnPos(ByVal pvSpdNo)
    ...
    Select Case UCase(pvSpdNo)
       Case "A"
			...
			C_FLT_CONV_DT			= iCurColumnPos(2)
			C_Loan_No				= iCurColumnPos(3)    
			C_Loan_Nm				= iCurColumnPos(4)
			C_PLAN_ACCT_CD			= iCurColumnPos(5)
			C_PLAN_ACCT_NM			= iCurColumnPos(6)
			C_LOAN_ACCT_CD			= iCurColumnPos(7)
			C_LOAN_ACCT_NM			= iCurColumnPos(8)
			C_PAY_PLAN_DT			= iCurColumnPos(9)
			C_Doc_Cur				= iCurColumnPos(10)
			C_Xch_Rate				= iCurColumnPos(11)
			C_PLAN_AMT				= iCurColumnPos(12)
			C_PLAN_LOC_AMT			= iCurColumnPos(13)
			C_Loan_Dt			    = iCurColumnPos(14)
			C_Due_Dt				= iCurColumnPos(15)
			C_TEMP_GL_NO			= iCurColumnPos(16)
			C_GL_NO					= iCurColumnPos(17)
			C_REF_NO				= iCurColumnPos(18)
			C_REF_SEQ				= iCurColumnPos(19)
			C_PAY_OBJ				= iCurColumnPos(20)
			C_RDP_CLS_FG			= iCurColumnPos(21)
			C_RESL_FG				= iCurColumnPos(22)
			C_CONF_FG				= iCurColumnPos(23)
