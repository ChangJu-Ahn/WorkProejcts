					...
					<TD WIDTH=100% HEIGHT=*>
							<TABLE <%=LR_SPACE_TYPE_60%>>
								...
								<TR>
									...
									<TD CLASS=TD6 NOWRAP><SCRIPT LANGUAGE=JavaScript> ExternalWrite('<OBJECT CLASSID=<%=gCLSIDFPDT%> id=txtBaseFromDt name=txtBaseFromDt CLASS=FPDTYYYYMMDD title=FPDATETIME tag="12" ALT="시작기준일자"></OBJECT>');</SCRIPT>&nbsp;~&nbsp;
														 <SCRIPT LANGUAGE=JavaScript> ExternalWrite('<OBJECT CLASSID=<%=gCLSIDFPDT%> id=txtBaseToDt name=txtBaseToDt CLASS=FPDTYYYYMMDD title=FPDATETIME tag="12" ALT="종료기준일자"></OBJECT>');</SCRIPT></TD>
								</TR>
								<TR>
