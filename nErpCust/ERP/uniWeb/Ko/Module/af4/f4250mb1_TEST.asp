...
Sub SubBizQuery()
    ...
    Set iPAFG425LOOKUP = server.CreateObject("PAFG425_TEST.bFLkUpRepaySvr")
...
Sub SubBizSave()
    ...
    Set iPAFG425CU = server.CreateObject("PAFG425_TEST.cFMngRepaySvr")   
...
Sub SubBizDelete()
	...
	Set iPAFG425D = server.CreateObject("PAFG425_TEST.cFMngRepaySvr")   
