...
'==========================================  1.2.1 Global 상수 선언  ======================================
'==========================================================================================================
Const BIZ_PGM_ID = "f4205mb1.asp"			 '☆: 비지니스 로직 ASP명 
Const BIZ_PGM_ID2 = "f4205mb2.asp"
...
'			arrHeader(3) = "거래통화"					' Header명(3)										
		...
		With frm1			
				lgtempStrFg = "P"
				arrParam(0) = frm1.txtBpLoanCd.Alt
				arrParam(1) = "B_Biz_Partner A"
				arrParam(2) = strCode
				arrParam(3) = ""
				arrParam(4) = ""
				arrParam(5) = frm1.txtBpLoanCd.Alt
...
Sub cboPrRdpCond_OnChange()
	...
	'	Call ggoOper.SetReqAttr(frm1.txtLoanTermYr, "N")
	'	Call ggoOper.SetReqAttr(frm1.txtLoanTermMnth, "N")		
	...
	'	Call ggoOper.SetReqAttr(frm1.txtLoanTermYr, "Q")
	'	Call ggoOper.SetReqAttr(frm1.txtLoanTermMnth, "Q")	
...
'   strVal = strVal & "&txtLoanFg		=" & Trim("LL")					 	'☆: 조회 조건 데이타 
					...
					<TD HEIGHT=100% valign=top>
							<TABLE <%=LR_SPACE_TYPE_60%>>
								...
								<TR>		
									...
									<TD CLASS="TD6" NOWRAP><INPUT CLASS="clstxt" TYPE=TEXT NAME="txtBpLoanCd" SIZE="10" MAXLENGTH=10 STYLE="TEXT-ALIGN: Left" tag="22X" ALT="차입처"><IMG SRC="../../../CShared/image/btnPopup.gif" NAME="btnBankLoanCd" align=top TYPE="BUTTON"ONCLICK="vbscript:CALL OpenBp(frm1.txtBpLoanCd.Value, 5)">
									                       <INPUT TYPE=TEXT NAME="txtBpLoanNm" ALT="차입처명" SIZE=20 tag="24X"></TD>																		
								</TR>
								<TR>
								    ...
								    <TD CLASS="TD6" NOWRAP><INPUT NAME="txtDocCur" ALT="거래통화" SIZE = "10" MAXLENGTH="3"  tag="22XXXU"><IMG SRC="../../../CShared/image/btnPopup.gif" NAME="btnDocCurCd" align=top TYPE="BUTTON" ONCLICK="vbscript:Call OpenPopUp(frm1.txtDocCur.value, 0)">&nbsp;
															<SCRIPT LANGUAGE=JavaScript> ExternalWrite('<OBJECT CLASSID=<%=gCLSIDFPDS%> id=OBJECT5 name=txtXchRate align="top" CLASS=FPDS115 title=FPDOUBLESINGLE ALT="환율" tag="21X5Z"></OBJECT>');</SCRIPT></TD>
