...
'*  3. Program ID           : f4254oa1
'*  4. Program Name         : 차입금상환실적출력 
'*  5. Program Desc         : Report of Loan Repay Result
'*  6. Comproxy List        : 
'*  7. Modified date(First) : 2000.12.29
...
Function SetDefaultVal()
	...
	frm1.txtDateFr.Text  = UniConvDateAToB(FirstDate, Parent.gServerDateFormat, Parent.gDateFormat)
	frm1.txtDateTo.Text  = UniConvDateAToB(StartDate, Parent.gServerDateFormat, Parent.gDateFormat)
...
Function OpenPopupLoan()
	...
	arrRet = window.showModalDialog("f4202ra1.asp", Array(window.parent,arrParam), _
...
'========================================================================================================
'   Event Name : txtLoanNo_Onchange()
'   Event Desc : 월차코드를 직접입력할경우에 월차코드명을 설정해준다.
'========================================================================================================
sub txtLoanNo_Onchange()
	Dim strCd

	strCd = frm1.txtLoanNo.value

	Call CommonQueryRs("A.LOAN_NM","F_LN_INFO A","A.LOAN_NO = " & FilterVar(strCd, "''", "S"),lgF0,lgF1,lgF2,lgF3,lgF4,lgF5,lgF6)
	
	if Trim(Replace(lgF0,Chr(11),"")) = "X" then
		frm1.txtLoanNm.value = ""
	else
		frm1.txtLoanNm.value = Trim(Replace(lgF0,Chr(11),""))
	end if
...
Sub SetPrintCond(Condvar,StrEbrFile)
	Dim VarDateFr, VarDateTo, VarLoanNo
	...
	If Trim(frm1.cboLoanFg.value) <> "" Then VarLoanFg = Trim(frm1.cboLoanFg.value)
	If Trim(frm1.txtLoanType.value) <> "" Then VarLoanType = FilterVar(Trim(frm1.txtLoanType.value)	, "", "SNM")
	If Trim(frm1.txtLoanNo.value) <> "" Then VarLoanNo = FilterVar(Trim(frm1.txtLoanNo.value)	, "", "SNM")
	If frm1.txtLoanPlcfg1.checked = true Then
		VarLoanPlcFg = "BK"
	...
	Condvar = Condvar & "LoanNo|"			& VarLoanNo
	...
	Condvar = Condvar & "|DateFr|"			& VarDateFr
	Condvar = Condvar & "|DateTo|"			& VarDateTo
			...
			<TABLE <%=LR_SPACE_TYPE_20%>>
				<TR>
					<TD WIDTH=100% HEIGHT=*>
							...
							<!--	<TR>
									<TD CLASS="TD5" NOWRAP>자국/외화구분</TD>
									<TD CLASS="TD6" NOWRAP><INPUT TYPE="RADIO" CLASS="Radio" NAME=Radio_Cur ID=Rb_Cur1 Checked ><LABEL FOR=Rb_Cur1>자국화폐</LABEL>&nbsp;
														<INPUT TYPE="RADIO" CLASS="Radio" NAME=Radio_Cur ID=Rb_Cur2 ><LABEL FOR=Rb_Cur2>외화화폐</LABEL>&nbsp;
									</TD>
								</TR>
							-->
								<TR></TR>
								<TR>
									...
									<TD CLASS="TD6" NOWRAP><SCRIPT LANGUAGE=JavaScript> ExternalWrite('<OBJECT CLASSID=<%=gCLSIDFPDT%> NAME="txtDateFr" CLASS=FPDTYYYYMMDD tag="12X1" Title="FPDATETIME" ALT="시작발생일자" id=fpDateFr></OBJECT>');</SCRIPT>&nbsp;~&nbsp;
														   <SCRIPT LANGUAGE=JavaScript> ExternalWrite('<OBJECT CLASSID=<%=gCLSIDFPDT%> NAME="txtDateTo" CLASS=FPDTYYYYMMDD tag="12X1" Title="FPDATETIME" ALT="종료발생일자" id=fpDateTo></OBJECT>');</SCRIPT>
									</TD>
								</TR>
								<TR>
								...
								<TR>
									...
									<TD CLASS="TD6" NOWRAP colspan=2><SELECT NAME="cboLoanFg" ALT="장단기구분" STYLE="WIDTH: 135px" tag="11X"><OPTION VALUE=""></OPTION></SELECT>
									</TD>
								</TR>
								<TR>
									...
									<TD CLASS="TD6" NOWRAP><INPUT TYPE="Text" NAME="txtLoanType" SIZE=10 MAXLENGTH=10 tag="11XXXU" ALT="차입용도코드" ><IMG SRC="../../../CShared/image/btnPopup.gif" NAME="btnLoanType" ALIGN=top TYPE="BUTTON" ONCLICK="vbscript:Call OpenPopup(frm1.txtLoanType.Value,1)">
														   <INPUT TYPE="Text" NAME="txtLoanTypeNm" tag="14X" ALT="차입용도명">
									</TD>
								</TR>
								<TR>
								...
								<TR>
									...
									<TD CLASS="TD6" NOWRAP><INPUT TYPE="Text" NAME="txtLoanNo" SIZE=15 MAXLENGTH=18  tag="11XXXU" ALT="차입금번호" ><IMG SRC="../../../CShared/image/btnPopup.gif" NAME="btnLoanNo" ALIGN=top TYPE="BUTTON" ONCLICK="vbscript:Call OpenPopUpLoan()">
														   <INPUT TYPE="Text" NAME="txtLoanNm" MAXLENGTH=40  tag="14X" ALT="차입금내역">
									</TD>
								</TR>
								<TR>
