...
Const BIZ_PGM_ID 		= "f4201rb2_ko441.asp"                              '☆: Biz Logic ASP Name

'========================================================================================================
'=                       4.2 Constant variables 
'========================================================================================================
Const C_SHEETMAXROWS_D  = 30                                          '☆: Server에서 한번에 fetch할 최대 데이타 건수
Const C_MaxKey          = 25					                      '☆: SpreadSheet의 키의 갯수
...
Sub SetDefaultVal()
	...
	lsMode				= arrParam(3)	
	txtAcctCd.value		= arrParam(4)	'계정코드
	txtAcctNm.value		= arrParam(5)	'계정명
...
Sub InitComboBox()
	Err.clear
	Call CommonQueryRs("minor_cd, minor_nm", "b_minor", "major_cd=" & FilterVar("A1050", "''", "S") & " and minor_cd='AP' order by minor_cd", lgF0, lgF1, lgF2, lgF3, lgF4, lgF5, lgF6)
...
Sub InitSpreadSheet()
    ...
    Call SetZAdoSpreadSheet("F4201RA2_KO441","S","A","V20030215",PopupParent.C_SORT_DBAGENT,vspdData, C_MaxKey, "X","X")
    Call SetSpreadLock() 
End Sub
			...
			<FIELDSET CLASS="CLSFLD">
				<TABLE <%=LR_SPACE_TYPE_40%>>
					...
					<TR ID="StdCondition1" style="display: yes">
						...
						<TD CLASS=TD6 NOWRAP><INPUT NAME="txtDocCur" ALT="거래통화" MAXLENGTH="3" SIZE=10 STYLE="TEXT-ALIGN: Left" tag ="11NXXU"><IMG align=top name=btnCalType onclick="vbscript:OpenCurrencyInfo()" src="../../../CShared/image/btnPopup.gif"  TYPE="BUTTON"> 
					...
					<TR ID="OpenCondition2" style="display: none">						
						...
						<TD CLASS=TD6 NOWRAP><span id="spnNm99"><INPUT TYPE="Text" NAME="txtBpCd" SIZE=10 MAXLENGTH=10 STYLE="TEXT-ALIGN: Left" tag="11NXXU" Alt="거래처"><IMG SRC="../../../CShared/image/btnPopup.gif" NAME="btnBizCd" ALIGN=top TYPE="BUTTON" ONCLICK="vbscript:CALL OpenBp(txtBpCd.Value, 1)"> <INPUT TYPE=TEXT NAME="txtBpNm" SIZE=20 MAXLENGTH=20 STYLE="TEXT-ALIGN: Left" tag="14" ALT="거래처명"></span></TD>				
