...
'*  3. Program ID           : F4213MA1
'*  4. Program Name         : 차입처별차입금상세조회 
'*  5. Program Desc         : Query of Bank Loan State
...
Const BIZ_PGM_ID 		= "f4213mb1.asp"                              '☆: Biz Logic ASP Name
...
Function SetDefaultVal()
	...
	frm1.txtLoanDtFr.Text  = Parent.UniConvDateAToB(FristDate, Parent.gServerDateFormat, Parent.gDateFormat)
	frm1.txtLoanDtTo.Text  = Parent.UniConvDateAToB(StartDate, Parent.gServerDateFormat, Parent.gDateFormat)
	frm1.txtPaymDt.Text  = Parent.UniConvDateAToB(StartDate, Parent.gServerDateFormat, Parent.gDateFormat)
End Function
...
Sub InitSpreadSheet()
	...
	Call SetZAdoSpreadSheet("F4213MA1","S","A","V20030103",parent.C_SORT_DBAGENT,frm1.vspdData, C_MaxKey, "X","X")
...
Function FncQuery() 
    ...
    If Parent.CompareDateByFormat(frm1.txtLoanDtFr.Text, frm1.txtLoanDtTo.Text, frm1.txtLoanDtFr.Alt, frm1.txtLoanDtTo.Alt, _
						"970025", frm1.txtLoanDtFr.UserDefinedFormat, Parent.gComDateType, true) = False Then
			frm1.txtLoanDtFr.focus											'⊙: GL Date Compare Common Function
			Exit Function
	End if
...
Function DbQuery() 
    ...
    With frm1
		If lgIntFlgMode <> Parent.OPMD_UMODE Then										'This means that it is first search
        	strVal = BIZ_PGM_ID & "?cboConfFg="	& Trim(.cboConfFg.value)
		...
		Else
			...
			strVal = strVal & "&txtPaymDt="		& Trim(.hPaymDt.value)
...
sub txtBankCd_Onchange()
	...
	Call Parent.CommonQueryRs("A.BANK_NM","B_BANK A","A.BANK_cd = " & Parent.FilterVar(strCd, "''", "S"),lgF0,lgF1,lgF2,lgF3,lgF4,lgF5,lgF6)
...
Sub txtPaymDt_KeyPress(KeyAscii)
	If KeyAscii = 13 Then 
		frm1.txtLoanDtFr.Focus
	   Call MainQuery
	End If   
						...
						<FIELDSET CLASS="CLSFLD">
							<TABLE <%=LR_SPACE_TYPE_40%>>
								<TR>
									...
									<TD CLASS=TD6 NOWRAP><SCRIPT LANGUAGE=JavaScript> ExternalWrite('<OBJECT CLASSID=<%=gCLSIDFPDT%> id=fpLoanDtFr name=txtLoanDtFr CLASS=FPDTYYYYMMDD title=FPDATETIME tag="12X1" ALT="시작차입일자"></OBJECT>');</SCRIPT>&nbsp;~&nbsp;
														 <SCRIPT LANGUAGE=JavaScript> ExternalWrite('<OBJECT CLASSID=<%=gCLSIDFPDT%> id=fpLoanDtTo name=txtLoanDtTo CLASS=FPDTYYYYMMDD title=FPDATETIME tag="12X1" ALT="종료차입일자"></OBJECT>');</SCRIPT>
									</TD>
									<TD CLASS=TD5 NOWRAP>기준일자</TD>
									<TD CLASS=TD6 NOWRAP><SCRIPT LANGUAGE=JavaScript> ExternalWrite('<OBJECT CLASSID=<%=gCLSIDFPDT%> id=fpPaymDt name=txtPaymDt CLASS=FPDTYYYYMMDD title=FPDATETIME tag="12X1" ALT="기준일자"></OBJECT>');</SCRIPT>&nbsp;
								    </TD>
                              	</TR>
								<TR>
						...
						<FIELDSET CLASS="CLSFLD">
							<TABLE <%=LR_SPACE_TYPE_20%>>
								<TR>
									...
									<TD CLASS=TD6 NOWRAP>
										<SCRIPT LANGUAGE=JavaScript> ExternalWrite('<OBJECT CLASSID=<%=gCLSIDFPDS%> id=fpDoubleSingle2 name="txtLoan" CLASS=FPDS140 title="FPDOUBLESINGLE" ALT="차입총액" tag="24X2"></OBJECT>');</SCRIPT>&nbsp;
										<SCRIPT LANGUAGE=JavaScript> ExternalWrite('<OBJECT CLASSID=<%=gCLSIDFPDS%> id=fpDoubleSingle2 name="txtLoanLoc" CLASS=FPDS140 title="FPDOUBLESINGLE" ALT="차입총액(자국)" tag="24X2"></OBJECT>');</SCRIPT>
									</TD>
									<TD CLASS="TD5" NOWRAP>이자지급총액|자국</TD>
									<TD CLASS=TD6 NOWRAP>
										<SCRIPT LANGUAGE=JavaScript> ExternalWrite('<OBJECT CLASSID=<%=gCLSIDFPDS%> id=fpDoubleSingle2 name="txtInt" CLASS=FPDS140 title="FPDOUBLESINGLE" ALT="이자지급총액" tag="24X2"></OBJECT>');</SCRIPT>&nbsp;
										<SCRIPT LANGUAGE=JavaScript> ExternalWrite('<OBJECT CLASSID=<%=gCLSIDFPDS%> id=fpDoubleSingle2 name="txtIntLoc" CLASS=FPDS140 title="FPDOUBLESINGLE" ALT="이자지급총액(자국)" tag="24X2"></OBJECT>');</SCRIPT>
									</TD>
								</TR>
								<TR>
									<TD CLASS="TD5" NOWRAP>원금상환총액|자국</TD>
									<TD CLASS=TD6 NOWRAP>
										<SCRIPT LANGUAGE=JavaScript> ExternalWrite('<OBJECT CLASSID=<%=gCLSIDFPDS%> id=fpDoubleSingle2 name="txtRdp" CLASS=FPDS140 title="FPDOUBLESINGLE" ALT="원금상환총액" tag="24X2"></OBJECT>');</SCRIPT>&nbsp;
										<SCRIPT LANGUAGE=JavaScript> ExternalWrite('<OBJECT CLASSID=<%=gCLSIDFPDS%> id=fpDoubleSingle2 name="txtRdpLoc" CLASS=FPDS140 title="FPDOUBLESINGLE" ALT="원금상환총액(자국)" tag="24X2"></OBJECT>');</SCRIPT>
									</TD>
									<TD CLASS="TD5" NOWRAP>차입잔액|자국</TD>
									<TD CLASS=TD6 NOWRAP>
										<SCRIPT LANGUAGE=JavaScript> ExternalWrite('<OBJECT CLASSID=<%=gCLSIDFPDS%> id=fpDoubleSingle2 name="txtBal" CLASS=FPDS140 title="FPDOUBLESINGLE" ALT="차입잔액" tag="24X2"></OBJECT>');</SCRIPT>&nbsp;
										<SCRIPT LANGUAGE=JavaScript> ExternalWrite('<OBJECT CLASSID=<%=gCLSIDFPDS%> id=fpDoubleSingle2 name="txtBalLoc" CLASS=FPDS140 title="FPDOUBLESINGLE" ALT="차입잔액(자국)" tag="24X2"></OBJECT>');</SCRIPT>
									</TD>
								</TR>
							</TABLE>
						</FIELDSET>
...
<INPUT TYPE=HIDDEN NAME="hPaymDt" tag="24">
