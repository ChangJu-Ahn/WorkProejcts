...
Sub SubBizQueryMulti()
	...
	lgStrSQL = ""
	lgStrSQL = lgStrSQL & "  SELECT LOAN_ACCT_CD,		ACCT_NM,	"	 & vbCr
	lgStrSQL = lgStrSQL & "  	SUM_LOAN_AMT,		SUM_GL_ITEM_AMT, ISNULL(SUM_LOAN_AMT, 0) - ISNULL(SUM_GL_ITEM_AMT, 0), " & vbCr
	lgStrSQL = lgStrSQL & "   	SUM_TEMP_ITEM_AMT, 	SUM_BATCH_ITEM_AMT,	" & vbCr
	...
	lgStrSQL = lgStrSQL & "  		F.GL_INPUT_TYPE, H.MINOR_NM " & vbCr
	...
	lgStrSQL = lgStrSQL & "	GROUP BY A.LOAN_ACCT_CD, B.ACCT_NM, F.GL_INPUT_TYPE, H.MINOR_NM " & vbCr
	...
	lgStrSQL = lgStrSQL & " ORDER BY LOAN_ACCT_CD, GL_INPUT_TYPE "	 & vbCr
