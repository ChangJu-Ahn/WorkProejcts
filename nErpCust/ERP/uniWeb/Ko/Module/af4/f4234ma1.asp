...
'*  3. Program ID           : f4234ma1
'*  4. Program Name         : 은행차입금만기연장 
...
'==========================================  1.2.1 Global 상수 선언  ======================================
'==========================================================================================================
Const BIZ_PGM_ID = "f4234mb1.asp"			 '☆: 비지니스 로직 ASP명 
Const BIZ_PGM_ID2 = "f4234mb3.asp"
...
'			arrHeader(3) = "거래통화"					' Header명(3)										
		...
		Case 5		'차입처 
			...
			If frm1.txtBankLoanRoCd.className = Parent.UCN_PROTECTED Then Exit Function
			With frm1			
				lgtempStrFg = "B"
				arrParam(0) = frm1.txtBankLoanRoCd.Alt
				arrParam(1) = "B_BANK A"
				arrParam(2) = strCode
				arrParam(3) = ""
				arrParam(4) = ""
				arrParam(5) = frm1.txtBankLoanRoCd.Alt
	...
	Else
		...
		Case 5	'차입은행 
			frm1.txtBankLoanRoCd.value = arrRet(0)
			frm1.txtBankLoanRoNm.value = arrRet(1)
			frm1.txtBankLoanRoCd.focus
		Case 6	'차입용도 
...
Function OpenPopupLoan()
	...
	With frm1
		...
		Else
			...
			.txtBankLoanRoCd.value = arrRet(15)																					'차입은행코드			
			.txtBankLoanRoNm.value = arrRet(16)																					'차입은행명		
			...
			.txtXchRate.Text	= UNIFormatNumber(arrRet(30),ggExchRate.DecPoint,-2,0,ggExchRate.RndPolicy,ggExchRate.RndUnit)	'환율 
					...
					<TD HEIGHT=100% valign=top>
							<TABLE <%=LR_SPACE_TYPE_60%>>
								<TR>
									...
									<TD CLASS="TD6" NOWRAP><INPUT CLASS="clstxt" TYPE=TEXT NAME="txtBankLoanRoCd" SIZE="10" MAXLENGTH=10 STYLE="TEXT-ALIGN: Left" tag="24X" ALT="차입은행"><IMG SRC="../../../CShared/image/btnPopup.gif" NAME="btnBankLoanCd" align=top TYPE="BUTTON"ONCLICK="vbscript:Call OpenPopUp(frm1.txtBankLoanRoCd.value, 5)">
									                       <INPUT TYPE=TEXT NAME="txtBankLoanRoNm" ALT="차입은행명" SIZE=20 tag="24X"></TD>									
								</TR>							
								<TR>								     
								...
								<TR>
								    ...
								    <TD CLASS="TD6" NOWRAP><INPUT NAME="txtDocCur" ALT="거래통화" SIZE = "10" MAXLENGTH="3" tag="24XXXU">&nbsp;
															<SCRIPT LANGUAGE=JavaScript> ExternalWrite('<OBJECT CLASSID=<%=gCLSIDFPDS%> id=fpXRate name=txtXchRate CLASS=FPDS140 align="top" title=FPDOUBLESINGLE ALT="환율" tag="24X5Z"></OBJECT>');</SCRIPT></TD>
								</TR>
								<TR>
...
<INPUT TYPE=hidden NAME="htxtBankLoanCd" tag="24">
