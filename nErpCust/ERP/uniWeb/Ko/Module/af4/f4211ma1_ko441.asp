...
Const BIZ_PGM_ID = "F4211MB1_ko441.asp"												'☆: 비지니스 로직 ASP명 
'========================================================================================================
						...
						<FIELDSET>
							<TABLE <%=LR_SPACE_TYPE_40%>>
								<TR>
									...
									<!--네패스 요청으로 필수항목에서 선택항목으로 변경...20090901...kbs	txtLoanDtFr, txtLoanDtTo	-->
									<TD CLASS=TD6 NOWRAP><SCRIPT LANGUAGE=JavaScript> ExternalWrite('<OBJECT CLASSID=<%=gCLSIDFPDT%> id=fpLoanFrDt name=txtLoanFromDt CLASS=FPDTYYYYMMDD title=FPDATETIME tag="11" ALT="시작차입일자"></OBJECT>');</SCRIPT>&nbsp;~&nbsp;
														 <SCRIPT LANGUAGE=JavaScript> ExternalWrite('<OBJECT CLASSID=<%=gCLSIDFPDT%> id=fpLoanToDt name=txtLoanToDt CLASS=FPDTYYYYMMDD title=FPDATETIME tag="11" ALT="종료차입일자"></OBJECT>');</SCRIPT></TD>
