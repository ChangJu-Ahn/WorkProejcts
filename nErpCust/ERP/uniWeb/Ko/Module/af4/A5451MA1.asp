...
Const BIZ_PGM_ID      = "A5451MB1.asp"						           '☆: Biz Logic ASP Name
Const BIZ_PGM_ID1     = "A5451MB2.asp"	
Const BIZ_PGM_ID2     = "A5451MB3.asp"	
	...
	Select Case UCase(Trim(pvSpdNo))
		...
		Case "A"
			With frm1.vspdData1
			   ...
			   ggoSpread.SSSetFloat   C_LoanLocAmt1       ,"차입금액(자국)"     ,15     ,Parent.ggAmtOfMoneyNo,ggStrIntegeralPart, ggStrDeciPointPart,Parent.gComNum1000,Parent.gComNumDec,1      ,True  
			   ...
			   ggoSpread.SSSetFloat   C_DiffLocAmt1       ,"차이금액(자국)"		,15     ,Parent.ggAmtOfMoneyNo,ggStrIntegeralPart, ggStrDeciPointPart,Parent.gComNum1000,Parent.gComNumDec,1      ,True  
		...
		Case "B"
			...
			With frm1.vspdData2
			   ...
			   ggoSpread.SSSetEdit    C_AcctNm2           ,"계정코드명"         ,18    ,3
			                         'ColumnPosition     Header            Width   Grp                    IntegeralPart       DeciPointpart                             Align   Sep    PZ   Min       Max 
			   ggoSpread.SSSetFloat   C_LoanLocAmt2         ,"차입금액(자국)"     ,15     ,Parent.ggAmtOfMoneyNo,ggStrIntegeralPart, ggStrDeciPointPart,Parent.gComNum1000,Parent.gComNumDec,1      ,True  
			   ...
			   ggoSpread.SSSetFloat   C_DiffLocAmt2       ,"차이금액(자국)"		,15     ,Parent.ggAmtOfMoneyNo,ggStrIntegeralPart, ggStrDeciPointPart,Parent.gComNum1000,Parent.gComNumDec,1      ,True  
		...
		Case "C"
			...
			With frm1.vspdData3
			   ...
			   Call GetSpreadColumnPos("C")			   
			                         'ColumnPosition     Header            Width  Align(0:L,1:R,2:C)  Row   Length  CharCase(0:L,1:N,2:U)
			   ggoSpread.SSSetEdit    C_AcctCd3       ,"계정코드"           ,18    ,         ,    ,20       ,2
			   ggoSpread.SSSetEdit    C_AcctNm3       ,"계정코드명"         ,18    ,3
			   ggoSpread.SSSetEdit    C_LoanNo3       ,"차입번호"           ,18    ,2                  ,     ,15     ,2
			   ggoSpread.SSSetDate    C_LoanDt3       ,"차입일자"           ,15    ,2                  ,Parent.gDateFormat   ,-1 
			   ggoSpread.SSSetDate    C_GlDt3         ,"회계전표일자"       ,15    ,2                  ,Parent.gDateFormat   ,-1			   
			   
			                         'ColumnPosition     Header            Width   Grp                    IntegeralPart       DeciPointpart                             Align   Sep    PZ   Min       Max 			   
			   ggoSpread.SSSetFloat   C_LoanLocAmt3   ,"차입금액(자국)"     ,15     ,Parent.ggAmtOfMoneyNo,ggStrIntegeralPart, ggStrDeciPointPart,Parent.gComNum1000,Parent.gComNumDec,1      ,True  
			   ...
			   ggoSpread.SSSetEdit    C_GLNo3          ,"회계전표번호"       ,18    ,2                  ,     ,18     ,2			   
			   ggoSpread.SSSetEdit    C_TempGlNo3      ,"결의전표번호"       ,10    ,0                  ,     ,18     ,2
			   ggoSpread.SSSetEdit    C_BatchNo3       ,"Batch 번호"         ,18    ,2                  ,     ,18     ,2
			   ggoSpread.SSSetEdit    C_GLInPutCd3	  ,"전표입력경로"       ,18    ,         ,    ,10       ,2	
			   ggoSpread.SSSetEdit    C_GLInPutNm3    ,"전표입력경로명"     ,18    ,         ,    ,20       ,2
			   ggoSpread.SSSetEdit    C_BizAreaCd3    ,"사업장"             ,10    ,         ,    ,10       ,2
			   ggoSpread.SSSetEdit    C_BizAreaNm3    ,"사업장명"           ,15    ,3
			   ggoSpread.SSSetEdit    C_LoanerCd3     ,"차입처"             ,18    ,         ,    ,20       ,2
			   ggoSpread.SSSetEdit    C_LoanerNm3     ,"차입처명"           ,18    ,3				   
			   ggoSpread.SSSetDate    C_TempGlDt3     ,"결의전표일자"       ,15    ,2                  ,Parent.gDateFormat   ,-1 
...
Sub GetSpreadColumnPos(ByVal pvSpdNo)
    ...
    Select Case UCase(pvSpdNo)
       Case "A"
			...
			C_LoanerCd1			= iCurColumnPos(10)
			C_LoanerNm1			= iCurColumnPos(11)
       ...
       Case "B"
		...
		Case "C"
			...
			C_LoanNo3			= iCurColumnPos(3)
			C_LoanDt3			= iCurColumnPos(4)
			C_GlDt3				= iCurColumnPos(5)			
			C_LoanLocAmt3		= iCurColumnPos(6)
			C_GlLocAmt3			= iCurColumnPos(7)
			C_DiffLocAmt3		= iCurColumnPos(8)
...
Function  OpenPopUp(Byval strCode, Byval iWhere)
	...
	Select Case iWhere
		...
		Case 3
			...
			arrParam(4) = arrParam(4) & "and b.minor_cd in (" & FilterVar("LN", "''", "S") & " , " & FilterVar("LO", "''", "S") & " ) " ' Where Condition
			arrParam(5) = "전표입력경로"			
...
Sub DoSum()
	...
	Select Case gSelframeFlg
		Case TAB1
			With frm1.vspdData1
				dbTotLoanLocAmt		= FncSumSheet(frm1.vspdData1,C_LoanLocAmt1, 1, .MaxRows, False, -1, -1, "V")
				...
				dbTotBatchLocAmt	= FncSumSheet(frm1.vspdData1,C_BatchLocAmt1, 1, .MaxRows, False, -1, -1, "V")
				
				frm1.txtTotLoanLocAmt1.text = UNIConvNumPCToCompanyByCurrency(dbTotLoanLocAmt,parent.gCurrency,parent.ggAmtOfMoneyNo, parent.gLocRndPolicyNo, "X")
...
'				frm1.txtTotBatchLocAmt1.text = UNIConvNumPCToCompanyByCurrency(dbTotBatchLocAmt,parent.gCurrency,parent.ggAmtOfMoneyNo, parent.gLocRndPolicyNo, "X")    
		...
		Case TAB2
			With frm1.vspdData2
				dbTotLoanLocAmt		= FncSumSheet(frm1.vspdData2,C_LoanLocAmt2, 1, .MaxRows, False, -1, -1, "V")
				dbTotGlLocAmt		= FncSumSheet(frm1.vspdData2,C_GlLocAmt2, 1, .MaxRows, False, -1, -1, "V")				
				dbTotDiffLocAmt		= FncSumSheet(frm1.vspdData1,C_DiffLocAmt2, 1, .MaxRows, False, -1, -1, "V")
				dbTotTempGlLocAmt	= FncSumSheet(frm1.vspdData2,C_TempGlLocAmt2, 1, .MaxRows, False, -1, -1, "V")
				dbTotBatchLocAmt	= FncSumSheet(frm1.vspdData2,C_BatchLocAmt2, 1, .MaxRows, False, -1, -1, "V")
				
				frm1.txtTotLoanLocAmt2.text = UNIConvNumPCToCompanyByCurrency(dbTotLoanLocAmt,parent.gCurrency,parent.ggAmtOfMoneyNo, parent.gLocRndPolicyNo, "X")
...
'				frm1.txtTotBatchLocAmt2.text = UNIConvNumPCToCompanyByCurrency(dbTotBatchLocAmt,parent.gCurrency,parent.ggAmtOfMoneyNo, parent.gLocRndPolicyNo, "X")    
		...
		Case TAB3			
'			With frm1.vspdData3
'				dbTotLoanLocAmt		= FncSumSheet(frm1.vspdData3,C_LoanLocAmt3, 1, .MaxRows, False, -1, -1, "V")
'				dbTotGlLocAmt		= FncSumSheet(frm1.vspdData3,C_GlLocAmt3, 1, .MaxRows, False, -1, -1, "V")				
'				dbTotDiffLocAmt		= FncSumSheet(frm1.vspdData1,C_DiffLocAmt3, 1, .MaxRows, False, -1, -1, "V")
'				dbTotTempGlLocAmt	= FncSumSheet(frm1.vspdData3,C_TempGlLocAmt3, 1, .MaxRows, False, -1, -1, "V")
'				dbTotBatchLocAmt	= FncSumSheet(frm1.vspdData3,C_BatchLocAmt3, 1, .MaxRows, False, -1, -1, "V")
'				
'				frm1.txtTotLoanLocAmt3.text = UNIConvNumPCToCompanyByCurrency(dbTotLoanLocAmt,parent.gCurrency,parent.ggAmtOfMoneyNo, parent.gLocRndPolicyNo, "X")
...
'				frm1.txtTotDiffLocAmt3.text = UNIConvNumPCToCompanyByCurrency(dbTotDiffLocAmt,parent.gCurrency,parent.ggAmtOfMoneyNo, parent.gLocRndPolicyNo, "X")    				
...
'				frm1.txtTotBatchLocAmt3.text = UNIConvNumPCToCompanyByCurrency(dbTotBatchLocAmt,parent.gCurrency,parent.ggAmtOfMoneyNo, parent.gLocRndPolicyNo, "X")    
'			End With 			
				...
				<TR>
					...
					<TD CLASS="CLSMTABP">
						<TABLE ID="MyTab" CELLSPACING=0 CELLPADDING=0 onclick="ClickTab3()">
							<TR>
								<td background="../../image/table/tab_up_bg.gif"><IMG height=23 src="../../image/table/tab_up_left.gif" width=9></td>
								<td background="../../image/table/tab_up_bg.gif" align="center" CLASS="CLSMTABP"><font color=white>차입금별발생정보</font></td>
								<td background="../../image/table/tab_up_bg.gif" align="right"><IMG height=23 src="../../image/table/tab_up_right.gif" width=10></td>
						    </TR>
						</TABLE>
					</TD>	
						...
						<FIELDSET CLASS="CLSFLD">
							<TABLE <%=LR_SPACE_TYPE_40%>>
								<TR>
									...
									<TD CLASS="TD6" NOWRAP>
									    <script language =javascript src='./js/a5451ma1_fpDateTime1_txtLoanFrDt.js'></script>
									    &nbsp;~&nbsp;
									    <script language =javascript src='./js/a5451ma1_fpDateTime2_txtLoanToDt.js'></script>
									</TD>		
					...
					<TD WIDTH=100% HEIGHT=* VALIGN=TOP>
							...
							<TABLE <%=LR_SPACE_TYPE_60%>>
								<TR>
									<TD WIDTH=100% HEIGHT=100% COLSPAN=4>
										<script language =javascript src='./js/a5451ma1_OBJECT1_vspdData1.js'></script>
									</TD>
								</TR>
								<TR>
									<TD HEIGHT=40 WIDTH=25%>
										<FIELDSET CLASS="CLSFLD">
											<TABLE  <%=LR_SPACE_TYPE_20%>>
												<TR>
													<TD CLASS="TDt" NOWRAP>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;차입금액(자국)합계</TD>
													<TD CLASS=TD6 NOWRAP>
														<script language =javascript src='./js/a5451ma1_OBJECT1_txtTotLoanLocAmt1.js'></script>
													</TD>
													<TD class=TDT STYLE="WIDTH : 0px;"></TD>												
													<TD CLASS="TDt" NOWRAP>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;차이금액(자국)합계</TD>
													<TD CLASS=TD6 NOWRAP>
														<script language =javascript src='./js/a5451ma1_OBJECT1_txtTotDiffLocAmt1.js'></script>
													</TD>
												</TR>
												<TR>
													<TD CLASS="TDt" NOWRAP>회계전표금액(자국)합계</TD>
													<TD CLASS=TD6 NOWRAP>
														<script language =javascript src='./js/a5451ma1_OBJECT1_txtTotGlLocAmt1.js'></script>
													</TD>
													<TD class=TDT STYLE="WIDTH : 0px;"></TD>												
													<TD CLASS="TDt" NOWRAP>결의전표금액(자국)합계</TD>
													<TD CLASS=TD6 NOWRAP>
														<script language =javascript src='./js/a5451ma1_OBJECT1_txtTotTempGlLocAmt1.js'></script>
													</TD>
												</TR>
											</TABLE>
										</FIELDSET>
						...
						<DIV ID="TabDiv" SCROLL=no>
							<TABLE <%=LR_SPACE_TYPE_60%>>
								<TR>
									<TD WIDTH=100% HEIGHT=100% COLSPAN=4>
										<script language =javascript src='./js/a5451ma1_OBJECT1_vspdData2.js'></script>
									</TD>
								</TR>
								<TR>
									<TD HEIGHT=40 WIDTH=25%>
										<FIELDSET CLASS="CLSFLD">
											<TABLE  <%=LR_SPACE_TYPE_20%>>
												<TR>
													<TD CLASS="TDt" NOWRAP>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;차입금액(자국)합계</TD>
													<TD CLASS=TD6 NOWRAP>
														<script language =javascript src='./js/a5451ma1_OBJECT1_txtTotLoanLocAmt2.js'></script>
													</TD>
													<TD class=TDT STYLE="WIDTH : 0px;"></TD>												
													<TD CLASS="TDt" NOWRAP>차이금액(자국)합계</TD>
													<TD CLASS=TD6 NOWRAP>
														<script language =javascript src='./js/a5451ma1_OBJECT1_txtTotDiffLocAmt2.js'></script>
													</TD>
												</TR>
												<TR>
													<TD CLASS="TDt" NOWRAP>회계전표금액(자국)합계</TD>
													<TD CLASS=TD6 NOWRAP>
														<script language =javascript src='./js/a5451ma1_OBJECT1_txtTotGlLocAmt2.js'></script>
													</TD>
													<TD class=TDT STYLE="WIDTH : 0px;"></TD>												
													<TD CLASS="TDt" NOWRAP>결의전표금액(자국)합계</TD>
													<TD CLASS=TD6 NOWRAP>
														<script language =javascript src='./js/a5451ma1_OBJECT1_txtTotTempGlLocAmt2.js'></script>
													</TD>
												</TR>
											</TABLE>
										</FIELDSET>
						...
						<DIV ID="TabDiv" SCROLL=no>
							<TABLE <%=LR_SPACE_TYPE_60%>>
								<TR>
									<TD WIDTH=100% HEIGHT=100% COLSPAN=4>
										<script language =javascript src='./js/a5451ma1_OBJECT1_vspdData3.js'></script>
									</TD>
								</TR>
								<TR>
									<TD HEIGHT=40 WIDTH=25%>
										<FIELDSET CLASS="CLSFLD">
											<TABLE  <%=LR_SPACE_TYPE_20%>>
												<TR>
													<TD CLASS="TDt" NOWRAP>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;차입금액(자국)합계</TD>
													<TD CLASS=TD6 NOWRAP>
														<script language =javascript src='./js/a5451ma1_OBJECT1_txtTotLoanLocAmt3.js'></script>
													</TD>
													<TD class=TDT STYLE="WIDTH : 0px;"></TD>												
													<TD CLASS="TDt" NOWRAP>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;차이금액(자국)합계</TD>
													<TD CLASS=TD6 NOWRAP>
														<script language =javascript src='./js/a5451ma1_OBJECT1_txtTotDiffLocAmt3.js'></script>
													</TD>
												</TR>
												<TR>
													<TD CLASS="TDt" NOWRAP>회계전표금액(자국)합계</TD>
													<TD CLASS=TD6 NOWRAP>
														<script language =javascript src='./js/a5451ma1_OBJECT1_txtTotGlLocAmt3.js'></script>
													</TD>
													<TD class=TDT STYLE="WIDTH : 0px;"></TD>												
													<TD CLASS="TDt" NOWRAP>결의전표금액(자국)합계</TD>
													<TD CLASS=TD6 NOWRAP>
														<script language =javascript src='./js/a5451ma1_OBJECT1_txtTotTempGlLocAmt3.js'></script>
													</TD>
												</TR>
											</TABLE>
										</FIELDSET>
