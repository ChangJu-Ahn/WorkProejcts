...
'**********************************************************************************************************
'⊙: 비지니스 로직 ASP명 
Const BIZ_PGM_ID =  "f4223mb1.asp"								'☆: 비지니스 로직 ASP명 
Const BIZ_PGM_ID3 = "f4223mb3.asp"								'☆: 비지니스 로직 ASP명 
...
Sub SetSpreadColor(ByVal lRow)	
    ...
    With frm1
		...
		ggoSpread.SSSetProtected	C_PAY_PLAN_LOC_AMT,	lRow, lRow						
					...
					<TD CLASS="CLSLTABP">
						<TABLE ID="MyTab" CELLSPACING=0 CELLPADDING=0>
							<TR>
								...
								<td background="../../../CShared/image/table/seltab_up_bg.gif" align="center" CLASS="CLSLTAB"><font color=white>차입금상환계획변경</font></td>
