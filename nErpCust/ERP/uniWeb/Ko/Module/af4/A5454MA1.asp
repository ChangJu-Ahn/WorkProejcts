					...
					<TD CLASS="CLSMTABP">
						<TABLE ID="MyTab" CELLSPACING=0 CELLPADDING=0 onclick="ClickTab2()">
							<TR>
								...
								<td background="../../image/table/tab_up_bg.gif" align="center" CLASS="CLSMTABP"><font color=white>미지급이자월결산정보</font></td>
										...
										<FIELDSET CLASS="CLSFLD">
											<TABLE  <%=LR_SPACE_TYPE_20%>>
												<TR>
													...
													<TD CLASS="TDt" NOWRAP>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;차이금액합계(자국)</TD>
													<TD CLASS=TD6 NOWRAP>
														<SCRIPT LANGUAGE=JavaScript> ExternalWrite('<OBJECT CLASSID=<%=gCLSIDFPDS%> name="txtTotDiffLocAmt2" style="HEIGHT: 20px; LEFT: 0px; TOP: 0px; WIDTH: 150px" title=FPDOUBLESINGLE ALT="차이금액합계(자국)" tag="24X2" id=OBJECT1></OBJECT>');</SCRIPT>
													</TD>
												</TR>
												<TR>
													<TD CLASS="TDt" NOWRAP>회계전표금액합계(자국)</TD>
													...
													<TD CLASS="TDt" NOWRAP>결의전표금액합계(자국)</TD>
													<TD CLASS=TD6 NOWRAP>
														<SCRIPT LANGUAGE=JavaScript> ExternalWrite('<OBJECT CLASSID=<%=gCLSIDFPDS%> name="txtTotTempGlLocAmt2" style="HEIGHT: 20px; LEFT: 0px; TOP: 0px; WIDTH: 150px" title=FPDOUBLESINGLE ALT="결의전표금액합계(자국)" tag="24X2" id=OBJECT1></OBJECT>');</SCRIPT>
													</TD>
												</TR>
											</TABLE>
										</FIELDSET>
