...
'========================================================================================================
Const BIZ_PGM_ID	= "F4250MB1_KO441.asp"						           '☆: Biz Logic ASP Name
	...
	Else
		...
		IF arrRet(26) = "DI" Then			'미지급이자 
			...
			'	" and int_pay_plan_dt =  " & FilterVar(UNIConvDate(arrRet(2)), "''", "S") & " and CLS_FG = " & FilterVar("Y", "''", "S") & "  group by xch_rate"  ,lgF0,lgF1,lgF2,lgF3,lgF4,lgF5,lgF6)
				...
				Call CommonQueryRs("sum(int_cls_amt),sum(int_cls_loc_amt), max(xch_rate)","f_ln_mon_dfr_int"," loan_no = " & FilterVar(arrRet(0), "''", "S") & _
				" and int_pay_plan_dt =  " & FilterVar(UNIConvDate(arrRet(2)), "''", "S") & " and CLS_FG = " & FilterVar("Y", "''", "S") & " "  ,lgF0,lgF1,lgF2,lgF3,lgF4,lgF5,lgF6)
...
'		frm1.txtTotLocAmt.Text = UNICDbl(arrRet(9)) + UNICDbl(arrRet(11))
		...
		'원금상환액
		Call CommonQueryRs("plan_loc_amt","f_ln_plan"," loan_no = " & FilterVar(frm1.txtLoanNo.value, "''", "S") & _
			" and PAY_PLAN_DT =  " & FilterVar(UNIConvDate(frm1.hPayPlanDt.value), "''", "S") & " AND PAY_OBJ IN ('LL','SL','LN','SN')",lgF0,lgF1,lgF2,lgF3,lgF4,lgF5,lgF6)
		frm1.txtPlanLocAmtPR.Text = Replace(lgf0,chr(11),"")
		
		'이자지급액
		Call CommonQueryRs("plan_loc_amt","f_ln_plan"," loan_no = " & FilterVar(frm1.txtLoanNo.value, "''", "S") & _
			" and PAY_PLAN_DT =  " & FilterVar(UNIConvDate(frm1.hPayPlanDt.value), "''", "S") & " AND PAY_OBJ IN ('AI','DI')",lgF0,lgF1,lgF2,lgF3,lgF4,lgF5,lgF6)


		frm1.txtPlanLocAmtPI.Text = Replace(lgf0,chr(11),"")		
...
frm1.txtPlanAmtPI.value = cdbl(frm1.txtPlanAmtPI.value) + cdbl(strIntClsPlanAmt)
frm1.txtPlanLocAmtPI.value = cdbl(frm1.txtPlanLocAmtPI.value) + cdbl(strIntClsPlanLocAmt)

frm1.txtDfrIntPay.text="0"
frm1.txtDfrIntPayLoc.text="0"
