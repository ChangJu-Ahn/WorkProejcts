...
Dim txtLoanNo, lgErrorStatus, lgErrorPos,lgOpModeCRUD
...
Sub SubBizQuery()
    ...
    Const A851_f_ln_plan_biz_area_cd_from = 8    '///사업장관련 추가된 인터페이스 
    Const A851_f_ln_plan_biz_area_cd_to = 9      '///사업장관련 추가된 인터페이스 
...
'    End If
	...
	Set PAFG460LOOKUP = Server.CreateObject("PAFG460_KO441.bFLkUpCvSvr")
...
'			If  iIntLoopCount < (C_SHEETMAXROWS_D + 1) Then
			...
			iStrData = iStrData & Chr(11) & ""
			iStrData = iStrData & Chr(11) & UNIDateClientFormat(EG1_export_group(iLngRow,EA_f_ln_plan_flt_conv_dt1))
			...
			iStrData = iStrData & Chr(11) & ConvSPChars(	 EG1_export_group(iLngRow,EA_f_ln_plan_plan_acct_cd1))
			iStrData = iStrData & Chr(11) & ConvSPChars(	 EG1_export_group(iLngRow,EA_f_ln_plan_plan_acct_nm1))
			...
			iStrData = iStrData & Chr(11) & ConvSPChars(	EG1_export_group(iLngRow,EA_f_ln_plan_temp_gl_no1))
			iStrData = iStrData & Chr(11) & ConvSPChars(	EG1_export_group(iLngRow,EA_f_ln_plan_gl_no1))
			iStrData = iStrData & Chr(11) & ConvSPChars(	EG1_export_group(iLngRow,EA_f_ln_plan_ref_no1))
			iStrData = iStrData & Chr(11) & ConvSPChars(	EG1_export_group(iLngRow,EA_f_ln_plan_ref_seq1))
			iStrData = iStrData & Chr(11) & ConvSPChars(	EG1_export_group(iLngRow,EA_f_ln_plan_pay_obj1))
			iStrData = iStrData & Chr(11) & ConvSPChars(	EG1_export_group(iLngRow,EA_f_ln_plan_rdp_cls_fg1))
			iStrData = iStrData & Chr(11) & ConvSPChars(	EG1_export_group(iLngRow,EA_f_ln_plan_resl_fg1))
			iStrData = iStrData & Chr(11) & ConvSPChars(	EG1_export_group(iLngRow,EA_f_ln_plan_conf_fg1))
...
Sub SubBizSave()
    ...
    Set PAFG460CU = server.CreateObject ("PAFG460_KO441.cFMngCvSvr")   
