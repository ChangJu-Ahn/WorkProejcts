					...
					<TD HEIGHT=* WIDTH=100%>
							<TABLE <%=LR_SPACE_TYPE_60%>>
								<TR>
									...
									<TD CLASS="TD6" NOWRAP><INPUT TYPE="RADIO" CLASS="Radio" NAME=Radio_Fg ID=Rb_Fg1 Checked ><LABEL FOR=Rb_Fg1>차입번호별</LABEL>&nbsp;
										<INPUT TYPE="RADIO" CLASS="Radio" NAME=Radio_Fg ID=Rb_Fg2 ><LABEL FOR=Rb_Fg2>지급일자별</LABEL>&nbsp;</TD>
								</TR>
								<TR>
									<TD CLASS=TD5 NOWRAP>지급예정일자</TD>
									<TD CLASS=TD6 NOWRAP colspan=2 >
										<SCRIPT LANGUAGE=JavaScript> ExternalWrite('<OBJECT CLASSID=<%=gCLSIDFPDT%> id=fpDateFr name=txtDateFr CLASS=FPDTYYYYMMDD title=FPDATETIME ALT="지급예정시작일" tag="12X1" VIEWASTEXT></OBJECT>');</SCRIPT>&nbsp;~&nbsp;
										<SCRIPT LANGUAGE=JavaScript> ExternalWrite('<OBJECT CLASSID=<%=gCLSIDFPDT%> id=fpDateTo name=txtDateTo CLASS=FPDTYYYYMMDD title=FPDATETIME ALT="지급예정종료일" tag="12X1" VIEWASTEXT></OBJECT>');</SCRIPT>
									</TD>
								</TR>
								<TR>
								...
								<TR>
								    ...
								    <TD CLASS=TD6 NOWRAP colspan=2><INPUT NAME="txtLoanType" MAXLENGTH="18" SIZE=10  ALT ="차입용도코드" tag="11XXXU"><IMG SRC="../../../CShared/image/btnPopup.gif" NAME="btnLoanType" ALIGN=top TYPE="BUTTON" ONCLICK="vbscript:Call OpenPopUp(frm1.txtLoanType.Value, 1)">
									                     <INPUT NAME="txtLoanTypeNm" MAXLENGTH="25" ALT ="차입용도명" tag="14X"></TD>  
								</TR>
								<TR>
