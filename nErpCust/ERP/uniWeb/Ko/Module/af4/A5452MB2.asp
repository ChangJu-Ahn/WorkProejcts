...
Sub SubBizQueryMulti()
	...
	lgStrSQL = lgStrSQL & "		AND ISNULL(B.LOAN_NO,'') <> '' "				
	...
	lgStrSQL = lgStrSQL & "	GROUP BY B.PAY_ITEM_ACCT_CD, C.ACCT_NM, H.GL_INPUT_TYPE, K.MINOR_NM " & vbCr
	...
	lgStrSQL = lgStrSQL & " ORDER BY PAY_ITEM_ACCT_CD, GL_INPUT_TYPE " & vbCr	
	...
	Else 
		...
		Do While Not lgObjRs.EOF
			'lgstrData = lgstrData & Chr(11) & ConvSPChars(lgObjRs("LOAN_ACCT_CD"))
	        'lgstrData = lgstrData & Chr(11) & ConvSPChars(lgObjRs("ACCT_NM"))	             
			'lgstrData = lgstrData & Chr(11) & UNIConvNumDBToCompanyByCurrency(lgObjRs("SUM_LOAN_AMT"), gCurrency,  ggAmtOfMoneyNo, gLocRndPolicyNo, "X")	        
	        'lgstrData = lgstrData & Chr(11) & UNIConvNumDBToCompanyByCurrency(lgObjRs("SUM_GL_ITEM_AMT"), gCurrency,  ggAmtOfMoneyNo, gLocRndPolicyNo, "X")
	        'lgstrData = lgstrData & Chr(11) & UNIConvNumDBToCompanyByCurrency(lgObjRs("SUM_TEMP_ITEM_AMT"), gCurrency,  ggAmtOfMoneyNo, gLocRndPolicyNo, "X")
	        'lgstrData = lgstrData & Chr(11) & UNIConvNumDBToCompanyByCurrency(lgObjRs("SUM_BATCH_ITEM_AMT"), gCurrency,  ggAmtOfMoneyNo, gLocRndPolicyNo, "X")
	        ...
	        'lgstrData = lgstrData & Chr(11) & ConvSPChars(lgObjRs("LOANER"))
			'lgstrData = lgstrData & Chr(11) & ConvSPChars(lgObjRs("LOANER_NM"))	  
