...
'*  3. Program ID           : f4240rb1
'*  4. Program Name         :
'*  5. Program Desc         :
'*  6. Modified date(First) : 2002.04.25
'*  7. Modified date(Last)  : 2003.05.19
'*  8. Modifier (First)     : Hwang Eun Hee
'*  9. Modifier (Last)      : Ahn do hyun
'* 10. Comment              :
...
Sub QueryData()
    ...
    If  rs0.EOF And rs0.BOF Then
		Call DisplayMsgBox(900014, vbInformation, strMsg1, strMsg2, I_MKSCRIPT)
	%>
...
Sub TrimData()
	...
	strCond = " AND A.CONF_FG IN (" & FilterVar("C", "''", "S") & " ," & FilterVar("E", "''", "S") & " )"

	Select Case strPgmId
	Case "F4240MA1"
		strCond = strCond & " and A.int_Pay_stnd= " & FilterVar("AI", "''", "S") & " "  
		strDB = "f_ln_mon_adv_int D"
	Case "F4241MA1"
		strCond = strCond & " and A.int_Pay_stnd= " & FilterVar("DI", "''", "S") & " "  
		strDB = "f_ln_mon_dfr_int D"
	End Select
	
	If strLoanFrDt <> "" Then strCond = strCond & " and D.int_cls_plan_dt >=  " & FilterVar(strLoanFrDt , "''", "S") & " "
	If strLoanToDt <> "" Then strCond = strCond & " and D.int_cls_plan_dt <=  " & FilterVar(strLoanToDt , "''", "S") & " "
	...
	If txtDocCur   <> "" Then strCond = strCond & " and D.Doc_Cur   = " & Filtervar(txtDocCur ,"''"	,"S")
	...
	If txtLoanNo   <> "" Then strCond = strCond & " and D.Loan_No   = " & Filtervar(txtLoanNo ,"''"	,"S")
