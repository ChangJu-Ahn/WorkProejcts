...
Const BIZ_PGM_ID      = "A5453MB1.asp"						           '☆: Biz Logic ASP Name
Const BIZ_PGM_ID1     = "A5453MB2.asp"	
	...
	Select Case UCase(Trim(pvSpdNo))
		...
		Case "A"
			With frm1.vspdData1
			   ...
			   ggoSpread.SSSetFloat   C_ClsLocAmt1        ,"결산금액(자국)"     ,15     ,Parent.ggAmtOfMoneyNo,ggStrIntegeralPart, ggStrDeciPointPart,Parent.gComNum1000,Parent.gComNumDec,1      ,True  
		...
		Case "B"
			...
			With frm1.vspdData2
			   ...
			   ggoSpread.SSSetEdit    C_LoanNo2       ,"차입번호"           ,18    ,0                  ,     ,15     ,2
			   ggoSpread.SSSetEdit    C_ClsSeq2       ,"순번"				,5     ,2                  ,     ,15     ,2			   
			   ggoSpread.SSSetDate    C_ClsDt2        ,"결산일자"           ,15    ,2                  ,Parent.gDateFormat   ,-1 
			   ggoSpread.SSSetDate    C_GlDt2         ,"회계전표일자"       ,15    ,2                  ,Parent.gDateFormat   ,-1			   						   			 
			                         'ColumnPosition     Header            Width   Grp                    IntegeralPart       DeciPointpart                             Align   Sep    PZ   Min       Max 			   
			   ggoSpread.SSSetFloat   C_ClsLocAmt2    ,"결산금액(자국)"     ,15     ,Parent.ggAmtOfMoneyNo,ggStrIntegeralPart, ggStrDeciPointPart,Parent.gComNum1000,Parent.gComNumDec,1      ,True  
			   ...
			   ggoSpread.SSSetEdit    C_GLNo2         ,"회계전표번호"       ,18    ,0                  ,     ,18     ,2			   
...
Function  OpenPopUp(Byval strCode, Byval iWhere)
	...
	Select Case iWhere
		...
		Case 1
			...
			arrParam(4) = " A.TRANS_TYPE = " & FilterVar("FI005", "''", "S") & "  "
			arrParam(4) = arrParam(4) & " AND A.JNL_CD = " & FilterVar("AI", "''", "S") & "  "
		...
		Case 3
			...
			arrParam(0) = "차입번호팝업"						' 팝업 명칭 
			arrParam(1) = " f_ln_info"						' TABLE 명칭 
			arrParam(2) = strCode						 				' Code Condition
			arrParam(3) = ""											' Name Condition
			arrParam(4) = "int_pay_stnd = " & FilterVar("AI", "''", "S") & "  "						' Where Condition
			...
			arrHeader(0) = "차입번호"							' Header명(0)
			arrHeader(1) = "차입명"							' Header명(1)			
...
Function DbQuery(pDirect)
	...
	If frm1.txtLoanerFg1.checked Then
		strLoanerFg = frm1.txtLoanerFg1.value
	ElseIf frm1.txtLoanerFg2.checked Then
		strLoanerFg = frm1.txtLoanerFg2.value
	Else
		strLoanerFg = ""
	End if
    ...
    strVal = strVal     & "&txtLoanerFg="	 & strLoanerFg										'☜:    
...
Sub txtLoanerCd_onChange()
	...
	If frm1.txtLoanerFg1.checked = True Then
		...
		Else
			IntRetCD = DisplayMsgBox("970000","X","차입은행","X")  	
					...
					<TD CLASS="CLSMTABP">
						<TABLE ID="MyTab" CELLSPACING=0 CELLPADDING=0 onclick="ClickTab2()">
							<TR>
								...
								<td background="../../image/table/tab_up_bg.gif" align="center" CLASS="CLSMTABP"><font color=white>선급이자월결산정보</font></td>
						...
						<FIELDSET CLASS="CLSFLD">
							<TABLE <%=LR_SPACE_TYPE_40%>>
								<TR>
									...
									<TD CLASS="TD6" NOWRAP>
									    <SCRIPT LANGUAGE=JavaScript> ExternalWrite('<OBJECT id=fpDateTime1 title=FPDATETIME style="LEFT: 0px; WIDTH: 100px; TOP: 0px; HEIGHT: 20px" name=txtLoanFrDt CLASSID=<%=gCLSIDFPDT%> ALT="검색시작날짜" tag="12X1"> <PARAM Name="AllowNull" Value="-1"><PARAM Name="Text" Value=""> </OBJECT>');</SCRIPT>
									    &nbsp;~&nbsp;
									    <SCRIPT LANGUAGE=JavaScript> ExternalWrite('<OBJECT id=fpDateTime2 title=FPDATETIME style="LEFT: 0px; WIDTH: 100px; TOP: 0px; HEIGHT: 20px" name=txtLoanToDt CLASSID=<%=gCLSIDFPDT%>ALT="검색끝날짜" tag="12x1"> <PARAM Name="AllowNull" Value="-1"><PARAM Name="Text" Value=""> </OBJECT>');</SCRIPT>
									</TD>		
								...
								<TR>
									...
									<TD CLASS=TD5 style="DISPLAY: none;" ID=inputTypeView1>차입번호</TD>								
									<TD CLASS=TD6 style="DISPLAY: none;" ID=inputTypeView2><INPUT TYPE=TEXT NAME=txtLoanNo ALT="차입번호" STYLE="HEIGHT: 20px; WIDTH: 80px" MAXLENGTH=20 tag="11NXXU"><IMG SRC="../../../CShared/image/btnPopup.gif" STYLE="HEIGHT: 21px; WIDTH: 16px" NAME=btnGlInputTypee ALIGN=TOP TYPE=BUTTON onClick="vbscript:Call OpenPopup(frm1.txtLoanNo.value, 3)" >
												   <INPUT TYPE=TEXT NAME=txtLoanNm ALT="차입명" SIZE="18" style="HEIGHT: 20px; " tag="14" >											   
									...
									<TD CLASS=TD6 NOWRAP><INPUT TYPE=RADIO CLASS="RADIO" NAME="RdoType" ID="RdoDiff" VALUE="S" TAG="11" ><LABEL FOR="RdoDiff">차이금액(자국)</LABEL>&nbsp;&nbsp
														 <INPUT TYPE=RADIO CLASS="RADIO" NAME="RdoType" ID="RdoTotal" VALUE="D" TAG="11" Checked><LABEL FOR="RdoTotal">전체금액</LABEL></TD>		
								</TR>								
							</TABLE>
						</FIELDSET>
					</TD>
								...
								<TR>
									<TD HEIGHT=40 WIDTH=25%>
										<FIELDSET CLASS="CLSFLD">
											<TABLE  <%=LR_SPACE_TYPE_20%>>
												<TR>
													<TD CLASS="TDt" NOWRAP>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;결산금액합계(자국)</TD>
													<TD CLASS=TD6 NOWRAP>
														<SCRIPT LANGUAGE=JavaScript> ExternalWrite('<OBJECT CLASSID=<%=gCLSIDFPDS%> name="txtTotClsLocAmt1" style="HEIGHT: 20px; LEFT: 0px; TOP: 0px; WIDTH: 150px" title=FPDOUBLESINGLE ALT="결산금액합계(자국)" tag="24X2" id=OBJECT1></OBJECT>');</SCRIPT>
													</TD>
													<TD class=TDT STYLE="WIDTH : 0px;"></TD>												
													<TD CLASS="TDt" NOWRAP>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;차이금액합계(자국)</TD>
													<TD CLASS=TD6 NOWRAP>
														<SCRIPT LANGUAGE=JavaScript> ExternalWrite('<OBJECT CLASSID=<%=gCLSIDFPDS%> name="txtTotDiffLocAmt1" style="HEIGHT: 20px; LEFT: 0px; TOP: 0px; WIDTH: 150px" title=FPDOUBLESINGLE ALT="결산금액합계(자국)" tag="24X2" id=OBJECT1></OBJECT>');</SCRIPT>
													</TD>
												</TR>
												<TR>
													<TD CLASS="TDt" NOWRAP>회계전표금액합계(자국)</TD>
													<TD CLASS=TD6 NOWRAP>
														<SCRIPT LANGUAGE=JavaScript> ExternalWrite('<OBJECT CLASSID=<%=gCLSIDFPDS%> name="txtTotGlLocAmt1" style="HEIGHT: 20px; LEFT: 0px; TOP: 0px; WIDTH: 150px" title=FPDOUBLESINGLE ALT="회계전표금액합계(자국)" tag="24X2" id=OBJECT1></OBJECT>');</SCRIPT>
													</TD>
													<TD class=TDT STYLE="WIDTH : 0px;"></TD>
													<TD CLASS="TDt" NOWRAP>결의전표금액합계(자국)</TD>
													<TD CLASS=TD6 NOWRAP>
														<SCRIPT LANGUAGE=JavaScript> ExternalWrite('<OBJECT CLASSID=<%=gCLSIDFPDS%> name="txtTotTempGlLocAmt1" style="HEIGHT: 20px; LEFT: 0px; TOP: 0px; WIDTH: 150px" title=FPDOUBLESINGLE ALT="회계전표금액합계(자국)" tag="24X2" id=OBJECT1></OBJECT>');</SCRIPT>
													</TD>
												</TR>
											</TABLE>
										</FIELDSET>
										...
										<FIELDSET CLASS="CLSFLD">
											<TABLE  <%=LR_SPACE_TYPE_20%>>
												<TR>
													<TD CLASS="TDt" NOWRAP>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;결산금액합계(자국)</TD>
													<TD CLASS=TD6 NOWRAP>
														<SCRIPT LANGUAGE=JavaScript> ExternalWrite('<OBJECT CLASSID=<%=gCLSIDFPDS%> name="txtTotClsLocAmt2" style="HEIGHT: 20px; LEFT: 0px; TOP: 0px; WIDTH: 150px" title=FPDOUBLESINGLE ALT="결산금액합계(자국)" tag="24X2" id=OBJECT1></OBJECT>');</SCRIPT>
													</TD>
													<TD class=TDT STYLE="WIDTH : 0px;"></TD>												
													<TD CLASS="TDt" NOWRAP>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;차이금액합계(자국)</TD>
													<TD CLASS=TD6 NOWRAP>
														<SCRIPT LANGUAGE=JavaScript> ExternalWrite('<OBJECT CLASSID=<%=gCLSIDFPDS%> name="txtTotDiffLocAmt2" style="HEIGHT: 20px; LEFT: 0px; TOP: 0px; WIDTH: 150px" title=FPDOUBLESINGLE ALT="결산금액합계(자국)" tag="24X2" id=OBJECT1></OBJECT>');</SCRIPT>
													</TD>
												</TR>
												<TR>
													<TD CLASS="TDt" NOWRAP>회계전표금액합계(자국)</TD>
													<TD CLASS=TD6 NOWRAP>
														<SCRIPT LANGUAGE=JavaScript> ExternalWrite('<OBJECT CLASSID=<%=gCLSIDFPDS%> name="txtTotGlLocAmt2" style="HEIGHT: 20px; LEFT: 0px; TOP: 0px; WIDTH: 150px" title=FPDOUBLESINGLE ALT="회계전표금액합계(자국)" tag="24X2" id=OBJECT1></OBJECT>');</SCRIPT>
													</TD>
													<TD class=TDT STYLE="WIDTH : 0px;"></TD>												
													<TD CLASS="TDt" NOWRAP>결의전표금액합계(자국)</TD>
													<TD CLASS=TD6 NOWRAP>
														<SCRIPT LANGUAGE=JavaScript> ExternalWrite('<OBJECT CLASSID=<%=gCLSIDFPDS%> name="txtTotTempGlLocAmt2" style="HEIGHT: 20px; LEFT: 0px; TOP: 0px; WIDTH: 150px" title=FPDOUBLESINGLE ALT="회계전표금액합계(자국)" tag="24X2" id=OBJECT1></OBJECT>');</SCRIPT>
													</TD>
												</TR>
											</TABLE>
										</FIELDSET>
