...
Sub InitSpreadSheet()
	...
	Call SetZAdoSpreadSheet("F4234RA1","S","A","V20030407",PopupParent.C_SORT_DBAGENT,frm1.vspdData, C_MaxKey, "X","X")
    Call SetSpreadLock() 
End Sub
...
'   
		...
		Case 3
			...
			If Trim("<%=Request("PGM")%>") = "F4234MA1"  Then			
			...
			Else
			End If			
'			arrParam(4) = arrParam(4) & "AND A.LOAN_BASIC_FG <>'LR'"				
			...
			<FIELDSET CLASS="CLSFLD">
				<TABLE <%=LR_SPACE_TYPE_40%>>
					...
					<TR>
						...
						<TD CLASS="TD6" NOWRAP><INPUT NAME="txtBankLoanCd" ALT="차입처" SIZE="10" MAXLENGTH="10"  tag="11XXXU"><IMG SRC="../../../CShared/image/btnPopup.gif" NAME="btnBankLoanCd" align=top TYPE="BUTTON" ONCLICK="vbscript:Call OpenPopUp(frm1.txtBankLoanCd.value, 5)">&nbsp;<INPUT NAME="txtBankLoanNm" ALT="차입처명" STYLE="TEXT-ALIGN: Left" tag="24X"></TD>						
					<TR>
