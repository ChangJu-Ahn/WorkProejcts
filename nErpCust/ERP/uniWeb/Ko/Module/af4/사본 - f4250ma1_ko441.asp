					...
					<TD WIDTH=100% VALIGN=TOP>
						<TABLE <%=LR_SPACE_TYPE_60%>>
							...
							<TR>
                                ...
                                <TD CLASS=TD6 NOWRAP><INPUT TYPE=TEXT NAME="txtDocCur"  SIZE=10 TAG="21xxxZ" ALT="거래통화">&nbsp;
												<SCRIPT LANGUAGE=JavaScript> ExternalWrite('<OBJECT CLASSID=<%=gCLSIDFPDS%> id=hXchRate Name=hXchRate ALT="환율" align="top" CLASS=FPDS115 title=FPDOUBLESINGLE tag="21X5Z"></OBJECT>');</SCRIPT></TD>
