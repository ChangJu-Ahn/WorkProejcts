...
'   Event Desc : 사업장코드드를 직접입력할경우에 사업장코드명을 설정해준다.
'========================================================================================================
...
Sub SetPrintCond(condvar,StrEbrFile)
	...
	If frm1.txtBaseFromDt.Text  = "" Then
		frm1.txtBaseFromDt.Text = "2001-01-01"
	End If

	If frm1.txtBaseToDt.Text  = "" Then
		frm1.txtBaseToDt.Text = "2999-12-31"
	End If
					...
					<TD WIDTH=100% HEIGHT=*>
							<TABLE <%=LR_SPACE_TYPE_60%>>
								...
								<TR>
									...
									<!--네패스 요청으로 필수항목에서 선택항목으로 변경...20090901...kbs	-->
									<TD CLASS=TD6 NOWRAP><SCRIPT LANGUAGE=JavaScript> ExternalWrite('<OBJECT CLASSID=<%=gCLSIDFPDT%> id=txtBaseFromDt name=txtBaseFromDt CLASS=FPDTYYYYMMDD title=FPDATETIME tag="11" ALT="시작기준일자"></OBJECT>');</SCRIPT>&nbsp;~&nbsp;
														 <SCRIPT LANGUAGE=JavaScript> ExternalWrite('<OBJECT CLASSID=<%=gCLSIDFPDT%> id=txtBaseToDt name=txtBaseToDt CLASS=FPDTYYYYMMDD title=FPDATETIME tag="11" ALT="종료기준일자"></OBJECT>');</SCRIPT></TD>
								</TR>
								<TR>
