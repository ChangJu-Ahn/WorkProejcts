...
*  2. Function Name        : 
*  3. Program ID           : a5445ma1
*  4. Program Name         : Verify Prepayment
*  5. Program Desc         : 
...
Const BIZ_PGM_ID      = "A5445MB1.asp"						           '☆: Biz Logic ASP Name
Const BIZ_PGM_ID1     = "A5445MB2.asp"	
Const BIZ_PGM_ID2     = "A5445MB3.asp"	
...
Sub SetDefaultVal()
	...
	frm1.txtPpFrDt.Text  = UniConvDateAToB(FirstDate, Parent.gServerDateFormat, Parent.gDateFormat)
	frm1.txtPpToDt.Text  = UniConvDateAToB(LastDate, Parent.gServerDateFormat, Parent.gDateFormat)
	

	frm1.txtShowBiz.value = "N"
	frm1.txtShowBp.value = "N"

	frm1.txtPpFrDt.focus 	
End Sub
	...
	Select Case UCase(Trim(pvSpdNo))
		Case "A"
			With frm1.vspdData1
				...
				ggoSpread.SSSetFloat   C_PpLocAmt1         ,"선급금액(자국)"     ,15     ,Parent.ggAmtOfMoneyNo,ggStrIntegeralPart, ggStrDeciPointPart,Parent.gComNum1000,Parent.gComNumDec,1      ,True  
		...
		Case "B"
			With frm1.vspdData2
				...
				ggoSpread.SSSetEdit    C_AcctNm2           ,"계정코드명"         ,15    ,3
				                      'ColumnPosition     Header            Width   Grp                    IntegeralPart       DeciPointpart                             Align   Sep    PZ   Min       Max 
				ggoSpread.SSSetFloat   C_PpLocAmt2         ,"선급금액(자국)"     ,15     ,Parent.ggAmtOfMoneyNo,ggStrIntegeralPart, ggStrDeciPointPart,Parent.gComNum1000,Parent.gComNumDec,1      ,True 
		...
		Case "C"
			With frm1.vspdData3
				...
				ggoSpread.SSSetEdit    C_PpNo          ,"선급금번호"           ,15    ,3        ,     ,15     ,2
				ggoSpread.SSSetDate    C_PpDt          ,"선급일자"           ,10    ,2        ,Parent.gDateFormat   ,-1 
				ggoSpread.SSSetDate    C_GlDt          ,"회계전표일자"       ,10    ,2        ,Parent.gDateFormat   ,-1 
				                      'ColumnPosition     Header            Width   Grp                    IntegeralPart       DeciPointpart                             Align   Sep    PZ   Min       Max 
				
				ggoSpread.SSSetFloat   C_PpLocAmt3     ,"선급금액(자국)"     ,15     ,Parent.ggAmtOfMoneyNo,ggStrIntegeralPart, ggStrDeciPointPart,Parent.gComNum1000,Parent.gComNumDec,1      ,True  
				...
				ggoSpread.SSSetEdit    C_PpType3       ,"전표입력경로"       , 5    ,         ,    ,10       ,2
				ggoSpread.SSSetEdit    C_PpTypeNm3     ,"전표입력경로명"     ,15    ,3				
				...
				Call ggoSpread.SSSetColHidden(C_PpType3,C_PpType3,True)
				.ReDraw = True
    ...
    Select Case UCase(pvSpdNo)
       ...
       Case "B"
		...
		Case "C"
			...
			C_PpNo			    = iCurColumnPos(3)
			C_PpDt			    = iCurColumnPos(4)
			C_GlDt			    = iCurColumnPos(5)
			
			C_PpLocAmt3		    = iCurColumnPos(6)
			...
			C_PpType3			= iCurColumnPos(15)
			C_PpTypeNm3			= iCurColumnPos(16)
...
Function  OpenPopUp(Byval strCode, Byval iWhere)
	...
	Select Case iWhere
		...
		Case 1
			...
			arrParam(3)  = ""												' Name Cindition
			arrParam(4)  = "ACCT_TYPE = " & FilterVar("G1", "''", "S") & "  "								' Where Condition
			arrParam(5)  = "계정코드"			
		...
		Case 3
			...
			arrParam(1) = " f_prpaym a , b_minor b "						' TABLE 명칭 
			arrParam(2) = strCode						 					' Code Condition
			arrParam(3) = ""												' Name Condition
			arrParam(4) = " b.major_cd=" & FilterVar("A1001", "''", "S") & "  and a.prpaym_fg=b.minor_cd " ' Where Condition
			arrParam(5) = "전표입력경로"			
			arrField(0) = "a.prpaym_fg "									' Field명(0)
...
Function DbQuery(pDirect)
    ...
    strVal = strVal		& "&txtPpFrDt="      & frm1.txtPpFrDt.text								'☜:
    strVal = strVal		& "&txtPpToDt="      & frm1.txtPpToDt.text								'☜:
...
Sub DoSum()
	...
	Select Case gSelframeFlg
		Case TAB1
			With frm1.vspdData1
				dbTotPpLocAmt		= FncSumSheet(frm1.vspdData1,C_PpLocAmt1, 1, .MaxRows, False, -1, -1, "V")
				...
				frm1.txtTotPpLocAmt1.text = UNIConvNumPCToCompanyByCurrency(dbTotPpLocAmt,parent.gCurrency,parent.ggAmtOfMoneyNo, parent.gLocRndPolicyNo, "X")
		...
		Case TAB2
			With frm1.vspdData2
				dbTotPpLocAmt		= FncSumSheet(frm1.vspdData2,C_PpLocAmt2, 1, .MaxRows, False, -1, -1, "V")
				...
				frm1.txtTotPpLocAmt2.text = UNIConvNumPCToCompanyByCurrency(dbTotPpLocAmt,parent.gCurrency,parent.ggAmtOfMoneyNo, parent.gLocRndPolicyNo, "X")
...
Sub txtdealbpCd_onChange()
	...
	If frm1.dealbpCd.value = "" Then Exit Sub	
...
'========================================================================================================
' Name : txtPpFrDt_DblClick
' Desc : developer describe this line
'========================================================================================================
Sub txtPpFrDt_DblClick(Button)
    If Button = 1 Then
		frm1.txtPpFrDt.Action = 7                                    ' 7 : Popup Calendar ocx
		Call SetFocusToDocument("M")	
		frm1.txtPpFrDt.Focus
    End If
End Sub

Sub txtPpFrDt_KeyDown(KeyCode, Shift)
	If KeyCode = 13 Then 
		frm1.txtPpFrDt.focus
		Call FncQuery
	end if
End Sub
'========================================================================================================
' Name : txtPpToDt_DblClick
' Desc : developer describe this line
'========================================================================================================
Sub txtPpToDt_DblClick(Button)
    If Button = 1 Then
		frm1.txtPpToDt.Action = 7                                    ' 7 : Popup Calendar ocx
		Call SetFocusToDocument("M")	
		frm1.txtPpToDt.Focus
    End If
End Sub
Sub txtPpToDt_KeyDown(KeyCode, Shift)
	If KeyCode = 13 Then 
		frm1.txtPpToDt.focus
		Call FncQuery
	end if
				...
				<TR>
					...
					<TD CLASS="CLSMTABP">
						<TABLE ID="MyTab" CELLSPACING=0 CELLPADDING=0 onclick="ClickTab3()">
							<TR>
								<td background="../../image/table/tab_up_bg.gif"><IMG height=23 src="../../image/table/tab_up_left.gif" width=9></td>
								<td background="../../image/table/tab_up_bg.gif" align="center" CLASS="CLSMTABP"><font color=white>선급금번호별출금금액</font></td>
								<td background="../../image/table/tab_up_bg.gif" align="right"><IMG height=23 src="../../image/table/tab_up_right.gif" width=10></td>
						    </TR>
						</TABLE>
					</TD>	
						...
						<FIELDSET CLASS="CLSFLD">
							<TABLE <%=LR_SPACE_TYPE_40%>>
								<TR>
									...
									<TD CLASS="TD6" NOWRAP>
									    <script language =javascript src='./js/a5445ma1_fpDateTime1_txtPpFrDt.js'></script>
									    &nbsp;~&nbsp;
									    <script language =javascript src='./js/a5445ma1_fpDateTime2_txtPpToDt.js'></script>
									</TD>
					...
					<TD WIDTH=100% HEIGHT=* VALIGN=TOP>
							...
							<TABLE <%=LR_SPACE_TYPE_60%>>
								<TR>
									<TD WIDTH=100% HEIGHT=100% COLSPAN=4>
										<script language =javascript src='./js/a5445ma1_OBJECT1_vspdData1.js'></script>
									</TD>
								</TR>
								<TR>
									<TD HEIGHT=40 WIDTH=25%>
										<FIELDSET CLASS="CLSFLD">
											<TABLE  <%=LR_SPACE_TYPE_20%>>
												<TR>
													<TD CLASS="TD5" NOWRAP>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;선급금액(자국)합계</TD>
													<TD CLASS=TD6 NOWRAP>
														<script language =javascript src='./js/a5445ma1_OBJECT1_txtTotPpLocAmt1.js'></script>
													</TD>
													<TD class=TD5 STYLE="WIDTH : 0px;"></TD>												
													<TD CLASS="TD5" NOWRAP>차이금액합계</TD>
													<TD CLASS=TD6 NOWRAP>
														<script language =javascript src='./js/a5445ma1_OBJECT1_txtTotDiffLocAmt1.js'></script>
													</TD>
												</TR>
												<TR>
													<TD CLASS="TD5" NOWRAP>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;회계전표금액(자국)합계</TD>
													<TD CLASS=TD6 NOWRAP>
														<script language =javascript src='./js/a5445ma1_OBJECT1_txtTotGlLocAmt1.js'></script>
													</TD>
													<TD class=TD5 STYLE="WIDTH : 0px;"></TD>												
													<TD CLASS="TD5" NOWRAP>결의전표금액(자국)합계</TD>
													<TD CLASS=TD6 NOWRAP>
														<script language =javascript src='./js/a5445ma1_OBJECT1_txtTotTempGlLocAmt1.js'></script>
													</TD>
												</TR>
											</TABLE>
										</FIELDSET>
						...
						<DIV ID="TabDiv" SCROLL=no>
							<TABLE <%=LR_SPACE_TYPE_60%>>
								<TR>
									<TD WIDTH=100% HEIGHT=100% COLSPAN=4>
										<script language =javascript src='./js/a5445ma1_OBJECT1_vspdData2.js'></script>
									</TD>
								</TR>
								<TR>
									<TD HEIGHT=40 WIDTH=25%>
										<FIELDSET CLASS="CLSFLD">
											<TABLE  <%=LR_SPACE_TYPE_20%>>
												<TR>
													<TD CLASS="TD5" NOWRAP>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;선급금액(자국)합계</TD>
													<TD CLASS=TD6 NOWRAP>
														<script language =javascript src='./js/a5445ma1_OBJECT1_txtTotPpLocAmt2.js'></script>
													</TD>
													<TD class=TD5 STYLE="WIDTH : 0px;"></TD>												
													<TD CLASS="TD5" NOWRAP>차이금액합계</TD>
													<TD CLASS=TD6 NOWRAP>
														<script language =javascript src='./js/a5445ma1_OBJECT1_txtTotDiffLocAmt2.js'></script>
													</TD>
												</TR>
												<TR>
													<TD CLASS="TD5" NOWRAP>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;회계전표금액(자국)합계</TD>
													<TD CLASS=TD6 NOWRAP>
														<script language =javascript src='./js/a5445ma1_OBJECT1_txtTotGlLocAmt2.js'></script>
													</TD>
													<TD class=TD5 STYLE="WIDTH : 0px;"></TD>												
													<TD CLASS="TD5" NOWRAP>결의전표금액(자국)합계</TD>
													<TD CLASS=TD6 NOWRAP>
														<script language =javascript src='./js/a5445ma1_OBJECT1_txtTotTempGlLocAmt2.js'></script>
													</TD>
												</TR>
											</TABLE>
										</FIELDSET>
						...
						<DIV ID="TabDiv" SCROLL=no>
							<TABLE <%=LR_SPACE_TYPE_60%>>
								<TR>
									<TD WIDTH=100% HEIGHT=100% COLSPAN=4>
										<script language =javascript src='./js/a5445ma1_OBJECT1_vspdData3.js'></script>
									</TD>
								</TR>
								<TR>
									<TD HEIGHT=40 WIDTH=25%>
										<FIELDSET CLASS="CLSFLD">
											<TABLE  <%=LR_SPACE_TYPE_20%>>
												<TR>
													<TD CLASS="TD5" NOWRAP>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;선급금액(자국)합계</TD>
													<TD CLASS=TD6 NOWRAP>
														<script language =javascript src='./js/a5445ma1_OBJECT1_txtTotPpLocAmt3.js'></script>
													</TD>
													<TD class=TD5 STYLE="WIDTH : 0px;"></TD>												
													<TD CLASS="TD5" NOWRAP>차이금액합계</TD>
													<TD CLASS=TD6 NOWRAP>
														<script language =javascript src='./js/a5445ma1_OBJECT1_txtTotDiffLocAmt3.js'></script>
													</TD>
												</TR>
												<TR>
													<TD CLASS="TD5" NOWRAP>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;회계전표금액(자국)합계</TD>
													<TD CLASS=TD6 NOWRAP>
														<script language =javascript src='./js/a5445ma1_OBJECT1_txtTotGlLocAmt3.js'></script>
													</TD>
													<TD class=TD5 STYLE="WIDTH : 0px;"></TD>												
													<TD CLASS="TD5" NOWRAP>결의전표금액(자국)합계</TD>
													<TD CLASS=TD6 NOWRAP>
														<script language =javascript src='./js/a5445ma1_OBJECT1_txtTotTempGlLocAmt3.js'></script>
													</TD>
												</TR>
											</TABLE>
										</FIELDSET>
