...
'*  3. Program ID           : a6506ra1.asp																			*
'*  4. Program Name         : 회계관리-선급금관리-																			*
...
Const BIZ_PGM_ID 		= "f6506rb1.asp"                              '☆: Biz Logic ASP Name

'========================================================================================================
'=                       4.2 Constant variables 
'========================================================================================================
Const C_SHEETMAXROWS_D  = 30                                          '☆: Server에서 한번에 fetch할 최대 데이타 건수 
Const C_MaxKey          = 4					                          '☆: SpreadSheet의 키의 갯수 
...
Sub InitSpreadSheet()
    ...
    Call SetZAdoSpreadSheet("F6506RA1","S","A","V20021211",PopupParent.C_SORT_DBAGENT,frm1.vspdData, C_MaxKey, "X","X")
    Call SetSpreadLock() 
...
Function SetPopUp(Byval arrRet, Byval iWhere)
	...
	Select Case iWhere
		...
		Case 4
				Frm1.txtPrpaymNoFr.value = arrRet(0)		
				frm1.txtPrpaymNoFr.focus
		Case 5
				Frm1.txtPrpaymNoTo.value = arrRet(0)		
				frm1.txtPrpaymNoTo.focus
	End Select	
...
Function DbQuery()
    ...
    '--------- Developer Coding Part (Start) ----------------------------------------------------------
        If lgIntFlgMode  <> PopupParent.OPMD_UMODE Then   ' This means that it is first search
			...
			strVal = strVal & "&txtPrpaymNoFr=" & Trim(.txtPrpaymNoFr.value)
			strVal = strVal & "&txtPrpaymNoTo=" & Trim(.txtPrpaymNoTo.value)
	    ...
	    Else
			...
			strVal = strVal & "&txtPrpaymNoFr=" & Trim(.htxtPrpaymNoFr.value)
			strVal = strVal & "&txtPrpaymNoTo=" & Trim(.htxtPrpaymNoTo.value)
			...
			<FIELDSET CLASS="CLSFLD">
				<TABLE <%=LR_SPACE_TYPE_40%>>
					...
					<TR>
						...
						<TD CLASS=TD6 NOWRAP>
							<INPUT TYPE="Text" NAME="txtPrpaymNoFr" SIZE=10 MAXLENGTH=10 tag="11NXXU" ALT="시작선급금번호"><IMG SRC="../../../CShared/image/btnPopup.gif" NAME="btnBizCd" ALIGN=top TYPE="BUTTON" ONCLICK="vbscript: CALL OpenPopUp(frm1.txtPrpaymNoFr.value,4)"> ~
							<INPUT TYPE="Text" NAME="txtPrpaymNoTo" SIZE=10 MAXLENGTH=10 tag="11NXXU" ALT="종료선급금번호"><IMG SRC="../../../CShared/image/btnPopup.gif" NAME="btnBizCd" ALIGN=top TYPE="BUTTON" ONCLICK="vbscript: CALL OpenPopUp(frm1.txtPrpaymNoTo.value,5)"> 
						</TD>
					</TR>
				</TABLE>
			</FIELDSET>
...
<INPUT TYPE=HIDDEN NAME="htxtPrpaymNoFr"		tag="24">
<INPUT TYPE=HIDDEN NAME="htxtPrpaymNoTo"        tag="24">
