...
'*  2. Function Name        : Prepayment_Settlement
'*  3. Program ID           : f6102ma1
'*  4. Program Name         : 선급금청산 
'*  5. Program Desc         : 선급금청산 
...
Const BIZ_PGM_ID         = "f6102mb1.asp"									' F_PrPaym_Sttl 의 CRUD
...
Sub InitSpreadSheet()
    ...
    With frm1
	    ...
	    .vspdData.MaxCols = C_SttlDESC + 1 												'☜: 최대 Columns의 항상 1개 증가시킴 
...
Sub SetSpreadLock()
    With frm1
		...
		ggoSpread.SSSetRequired C_STTL_AMT,	-1, C_STTL_AMT
		.vspdData.Redraw = True
	End With
End Sub
...
Function OpenPopupGL()
	...
	arrParam(0) = Trim(frm1.txtSttlGlNo.value)	'결의전표 번호 
	' 권한관리 추가 
...
Function OpenCurrency(Byval strCode)
	...
	If arrRet(0) = "" Then
		Call SetActiveCell(frm1.vspdData,C_DOC_CUR,frm1.vspdData.ActiveRow ,"M","X","X")
		Exit Function
	Else
...
Function SetCurrency(ByVal arrRet)
	With frm1
		...
		Call vspdData_Change(C_DOC_CUR , .vspdData.Row)						' 변경이 일어났다고 알려줌 
		Call SetActiveCell(.vspdData,C_DOC_CUR,.vspdData.ActiveRow ,"M","X","X")
	    lgBlnFlgChgValue = True
	End With
End Function
...
Function OpenSttlmentNo()
	...
	iCalledAspName = AskPRAspName("f6506ra1")

	If Trim(iCalledAspName) = "" Then
		IntRetCD = DisplayMsgBox("900040", parent.VB_INFORMATION, "f6506ra1", "X")
		IsOpenPop = False
		Exit Function
	End If
...
Function OpenRefPrePaymNo()
	...
	iCalledAspName = AskPRAspName("f6102ra2")

	If Trim(iCalledAspName) = "" Then
		IntRetCD = DisplayMsgBox("900040", parent.VB_INFORMATION, "f6102ra2", "X")
		IsOpenPop = False
		Exit Function
	End If
...
Function  SetRefPrePaymNo(Byval arrRet)
	...
	With frm1
		.hPrpaymNo.Value	  = arrRet(0)	
		.txtPrpaymNo.value    = arrRet(0)		
		.txtPrpaymDt.text	  = arrRet(1)		
...
Sub Form_Load()
    ...
    Call SetToolbar("11100000000011111")											'버튼 툴바 제어 
...
Function FncInsertRow(Byval pvRowcnt) 
    ...
    If frm1.vspdData.maxrows > 0 Then
		If Trim(frm1.hprpaymno.value) = "" Then
...
Function DbDelete() 
   DbDelete = false   
    ...
    With frm1
		...
		strVal = strVal & "&txtPrPaymNo=" & Trim(.txtPrPaymNo.value)					'조회 조건 데이타 
...
Function DbQueryOk()																	'☆: 조회 성공후 실행로직 
    ...
    Call txtDocCur_OnChange()
	Call SetSpreadLock()
    Call SetToolbar("1111110100101111")
...
' Function Desc : 선급금청산계정의 관리항목 Query
'=======================================================================================================
Function DbQuery2(ByVal Row)
	...
	With frm1
		...
		strFrom = " A_CTRL_ITEM	A , A_ACCT_CTRL_ASSN B , F_PRPAYM_STTL_DTL C , F_PRPAYM_STTL D  "
		
		strWhere =			  " D.PRPAYM_NO  =  " & FilterVar(UCase(.hPrpaymNo.value), "''", "S") & "  "
		strWhere = strWhere & " AND D.STTLMENT_NO =  " & FilterVar(UCase(.hSttlmentNo.value), "''", "S") & "  "
		strWhere = strWhere & " AND D.STTL_NO = " & .hItemSeq.Value & " "
		strWhere = strWhere & " AND D.PRPAYM_NO    =  C.PRPAYM_NO    "
						...
						Select Case frm1.vspdData3.Text 
							Case ggoSpread.UpdateFlag
								...
								If UCase(Trim(frm1.vspdData.Text)) = UCase(Trim(frm1.vspdData3.Text)) Then
									Call DeleteHsheet(frm1.vspdData.Text)										
									Call fncRestoreDbQuery2(indx, frm1.vspdData.ActiveRow, frm1.txtPrpaymNo.Value) 
								End If
						End Select
					Next
					'ggoSpread.Source = frm1.vspdData					
				...
				Case ggoSpread.UpdateFlag
					...
					For indx1 = 0 to frm1.vspdData.MaxRows
						...
						If frm1.vspdData.Text = frm1.vspdData2.Text Then
							...
							ggoSpread.Source = frm1.vspdData
							ggoSpread.EditUndo
							Call fncRestoreDbQuery2(indx1, frm1.vspdData.ActiveRow, frm1.txtPrpaymNo.Value)
						End If
					Next
		...
		<TD WIDTH="100%">
			<TABLE <%=LR_SPACE_TYPE_10%>>
			    <TR>
					...
					<TD WIDTH=* ALIGN=RIGHT><A HREF="VBSCRIPT:OpenPopupTempGL()">결의전표</A>&nbsp;|&nbsp;<A HREF="VBSCRIPT:OpenPopupGL()">회계전표</A>&nbsp;|&nbsp;<Span id="RefPop"><A href="vbscript:OpenRefPrePaymNo()">선급금정보</A></Span></TD>
					<TD WIDTH=10>&nbsp;</TD>
				</TR>
			</TABLE>
		</TD>
					...
					<TD WIDTH="100%" HEIGHT=30% VALIGN=TOP>
						<TABLE <%=LR_SPACE_TYPE_60%>>
							<TR>
								...
								<TD CLASS="TD6" NOWRAP><INPUT TYPE=TEXT NAME="txtPrpaymNo" SIZE=20 MAXLENGTH=20 STYLE="TEXT-ALIGN: Left" tag="24" ALT="선급금번호"></TD>
								<TD CLASS="TD5" NOWRAP>출금일자</TD>
								<TD CLASS="TD6" NOWRAP><SCRIPT LANGUAGE=JavaScript> ExternalWrite('<OBJECT CLASSID=<%=gCLSIDFPDT%> name=txtPrpaymDt CLASS=FPDTYYYYMMDD title=FPDATETIME ALT="출금일자" tag="24X1" id=fpDateTime1></OBJECT>');</SCRIPT></TD>
							</TR>
							<TR>
							...
							<TR>
		                        ...
		                        <TD CLASS="TD6" NOWRAP><INPUT NAME="txtGlNo" ALT="회계전표번호" TYPE="Text" SIZE=19 STYLE="TEXT-ALIGN: Left" tag="24" ></TD>
		                        <TD CLASS="TD5" NOWRAP>결의전표번호</TD>
		                        <TD CLASS="TD6" NOWRAP><INPUT NAME="txtTempGlNo" ALT="결의전표번호" TYPE="Text" SIZE=19 STYLE="TEXT-ALIGN: Left" tag="24" ></TD>
		                    </TR>
							<TR>
							
								<TD CLASS="TD5" NOWRAP>선급금액|자국</TD>
					            <TD CLASS="TD6" NOWRAP><SCRIPT LANGUAGE=JavaScript> ExternalWrite('<OBJECT CLASSID=<%=gCLSIDFPDS%> name=txtPrpaymAmt CLASS=FPDS140 title=FPDOUBLESINGLE ALT="선급금액" tag="24X2" id=fpDoubleSingle2></OBJECT>');</SCRIPT>&nbsp;
								<SCRIPT LANGUAGE=JavaScript> ExternalWrite('<OBJECT CLASSID=<%=gCLSIDFPDS%> name=txtPrpaymLocAmt CLASS=FPDS140 title=FPDOUBLESINGLE ALT="선급금액(자국)" tag="24X2" id=fpDoubleSingle3></OBJECT>');</SCRIPT>
								</TD>
							...
							<TR>
								...
								<TD CLASS="TD656" NOWRAP COLSPAN=3><INPUT TYPE=TEXT NAME="txtPrpaymDesc" SIZE=90 MAXLENGTH=128 tag="24" ALT="비고"></TD>
							</TR>
						</TABLE>
					</TD>
					</TR>
...
<!--								<TD CLASS=TD5 NOWRAP>환율</TD>
							...
							<TR>
								<TD WIDTH="100%" HEIGHT=50% COLSPAN=4>
									<SCRIPT LANGUAGE=JavaScript> ExternalWrite('<OBJECT CLASSID=<%=gCLSIDFPSPD%> Title="Spread" tag="2" HEIGHT="100%" name=vspdData width="100%" id=fpSpread1> <PARAM NAME="MaxCols" VALUE="0"><PARAM NAME="MaxRows" VALUE="0"> </OBJECT>');</SCRIPT>
								</TD>
							</TR>
							<TR>
								<TD WIDTH="100%" HEIGHT=50% COLSPAN=4>
									<SCRIPT LANGUAGE=JavaScript> ExternalWrite('<OBJECT CLASSID=<%=gCLSIDFPSPD%> Title="Spread" HEIGHT="100%" name=vspdData2 width="100%" tag="2" id=fpSpread2> <PARAM NAME="MaxCols" VALUE="0"><PARAM NAME="MaxRows" VALUE="0"> </OBJECT>');</SCRIPT>
								</TD>
							</TR>
						</TABLE>
					</TD>
...
<INPUT TYPE=hidden NAME="hPrpaymNo"    tag="24" TABINDEX="-1">
<INPUT TYPE=hidden NAME="hItemSeq"     tag="24" TABINDEX="-1">
<INPUT TYPE=hidden NAME="txtMaxRows3"  tag="24" TABINDEX="-1">
<INPUT TYPE=hidden NAME="hSttlmentNo"     tag="14" TABINDEX="-1">
...
<SCRIPT LANGUAGE=JavaScript> ExternalWrite('<OBJECT CLASSID=<%=gCLSIDFPSPD%> HEIGHT=0 name=vspdData3 width="100%" TABINDEX="-1"> <PARAM NAME="MaxCols" VALUE="0"><PARAM NAME="MaxRows" VALUE="0"></OBJECT>');</SCRIPT>
