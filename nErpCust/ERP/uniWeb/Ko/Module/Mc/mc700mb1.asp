...
'*  2. Function Name        : 
'*  3. Program ID           : mc700mb1
'*  4. Program Name         : 납입지시마감 
'*  5. Program Desc         : 납입지시마감 
'*  6. Component List       : PMCG700.cMListDvlyOrdCls / PMCG750.cMManageDlvyOrdCls
...
Sub SubBizQueryMulti()
	...
	For iLngRow = 0 To UBound(EG_m_dlvy_ord,1)
		...
		istrData = istrData & Chr(11) & ConvSPChars(EG_m_dlvy_ord(iLngRow,M805_EG1_do_stauts_desc))
