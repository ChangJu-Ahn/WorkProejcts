...
'**********************************************************************************************************
Const BIZ_PGM_QRY_ID	= "mc300mb1.asp"							'☆: 비지니스 로직 ASP명 
Const BIZ_PGM_SAVE_ID	= "mc300mb2.asp"							'☆: 비지니스 로직 ASP명 
    ...
    For lRow = 1 To .vspdData.MaxRows
		Select Case Trim(GetSpreadText(.vspdData,0,lRow,"X","X"))
            Case ggoSpread.UpdateFlag
				...
				strVal = "U" & igColSep	& lRow & igColSep			'☜: U=Update, RowNum
					...
					<TD CLASS="CLSMTABP">
						<TABLE ID="MyTab" CELLSPACING=0 CELLPADDING=0>
							<TR>
								...
								<td background="../../../CShared/image/table/seltab_up_bg.gif" align="center" CLASS="CLSMTAB"><font color=white>납입지시확정</font></td>
						...
						<FIELDSET CLASS="CLSFLD">
							<TABLE <%=LR_SPACE_TYPE_40%>>
			 					<TR>
									...
									<TD CLASS="TD6">
										<script language =javascript src='./js/mc300ma1_OBJECT1_txtFromReqDt.js'></script>
										&nbsp;~&nbsp;
										<script language =javascript src='./js/mc300ma1_OBJECT2_txtToReqDt.js'></script>
									</TD>
								</TR>
								<TR>
						...
						<TABLE <%=LR_SPACE_TYPE_60%>>
							<TR>
								...
								<TD CLASS="TD6">
									<TABLE><TR>
									<TD>
									<script language =javascript src='./js/mc300ma1_OBJECT3_txtDoDate.js'></script>
									</TD>
									<TD>&nbsp;
									<SELECT NAME="cboDoTime" ALT="납입지시시간" STYLE="Width: 98px;" tag="22"></SELECT>
									</TD>
									</TR></TABLE>
								</TD>
							...
							<TR>
								<TD HEIGHT="100%" colspan=4>
									<script language =javascript src='./js/mc300ma1_OBJECT4_vspdData.js'></script>
								</TD>
							</TR>
						</TABLE>
					</TD>
...
<INPUT TYPE=HIDDEN NAME="txtMaxRows" tag="24"><INPUT TYPE=HIDDEN NAME="hPlantCd" tag="24"><INPUT TYPE=HIDDEN NAME="hFromReqDt" tag="24">
<INPUT TYPE=HIDDEN NAME="hToReqDt" tag="24"><INPUT TYPE=HIDDEN NAME="hItemCd" tag="24"><INPUT TYPE=HIDDEN NAME="hBpCd" tag="24">
