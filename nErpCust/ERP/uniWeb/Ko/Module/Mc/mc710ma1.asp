...
Function OpenItemCd()
	...
	iCalledAspName = AskPRAspName("MC101PA1")
	
	If Trim(iCalledAspName) = "" Then
		IntRetCD = DisplayMsgBox("900040", parent.VB_INFORMATION, "MC101PA1", "X")
		IsOpenPop = False
		Exit Function
	End If
	
	arrParam1(0) = Trim(frm1.txtPlantCd.Value)
	arrParam1(1) = Trim(frm1.txtItemCd.Value)
					...
					<TD CLASS="CLSMTABP">
						<TABLE ID="MyTab" CELLSPACING=0 CELLPADDING=0>
							<TR>
								...
								<td background="../../../CShared/image/table/seltab_up_bg.gif" align="center" CLASS="CLSMTAB"><font color=white>납입지시마감취소</font></td>
		...
		<TD WIDTH=100% CLASS="Tab11">
					...
					<TR>
						...
						<TD CLASS=TD6 NOWRAP>								
							<table cellspacing=0 cellpadding=0>
								<tr>
									<td NOWRAP>
										<script language =javascript src='./js/mc710ma1_fpDateTime1_txtFrDt.js'></script>
									</td>
									<td NOWRAP>&nbsp;~&nbsp;</td>
									<td NOWRAP>
										<script language =javascript src='./js/mc710ma1_fpDateTime1_txtToDt.js'></script>
									</td>
								<tr>
							</table>
			...
			<TR>
				<TD WIDTH=100% valign=top><TABLE <%=LR_SPACE_TYPE_20%>>
					<TR>
						<TD HEIGHT="100%">
						    <script language =javascript src='./js/mc710ma1_I173383361_vspdData.js'></script>
						</TD>
					</TR></TABLE>
				</TD>
			</TR>
