...
Err.Clear
	...
	If Trim(Request("txtDoDate")) = "" Then
    ...
    I1_M_DLVY_ORD_HDR(C_Do_Date) = UniConvDate(Request("txtDoDate"))
	I1_M_DLVY_ORD_HDR(C_Do_Time) = Trim(Request("cboDoTime"))
	...
	Call oPMCG350.M_UPDATE_DELIVERY_ORDER(gStrGlobalCollection, _
										I1_M_DLVY_ORD_HDR, _
										IG1_M_DLVY_ORD_KEY)
