...
'*  2. Function Name        : 
'*  3. Program ID           : p1503ma1.asp
'*  4. Program Name         : 자원별 Shift 등록 
'*  5. Program Desc         :
'*  6. Comproxy List        : 
...
'**********************************************************************************************************
Const BIZ_PGM_QRY_ID  = "p1503mb1.asp"												'☆: 비지니스 로직 ASP명 
Const BIZ_PGM_SAVE_ID = "p1503mb2.asp"					
...
Sub InitSpreadSheet()
	...
	With frm1.vspdData
		...
		.MaxCols = C_ShiftNm+1												'☜: 최대 Columns의 항상 1개 증가시킴 
		.MaxRows = 0
		...
		ggoSpread.SSSetEdit 		C_ShiftCd,	"Shift",	20,,,2,2
		ggoSpread.SSSetButton 		C_ShiftPopup
		ggoSpread.SSSetEdit 		C_ShiftNm,	"Shift명",	94,,,40
	
		Call ggoSpread.MakePairsColumn(C_ShiftCd,C_ShiftPopup)
...
Sub GetSpreadColumnPos(ByVal pvSpdNo)
    ...
    Select Case UCase(pvSpdNo)
       Case "A"
			...
			C_ShiftCd	= iCurColumnPos(1)
			C_ShiftPopup= iCurColumnPos(2)
			C_ShiftNm	= iCurColumnPos(3)
    End Select    
End Sub
...
Function FncInsertRow(ByVal pvRowCnt) 
	...
	If CntMaxRows(imRow) = False Then Exit Function
    ...
    For lRow = 1 To .vspdData.MaxRows
        ...
        Select Case .vspdData.Text
            ...
            Case ggoSpread.InsertFlag												'☜: 신규 
                ...
                .vspdData.Col = C_ShiftCd	'1
                strVal = strVal & Trim(.vspdData.Text) & parent.gColSep
                
                .vspdData.Col = C_ShiftNm	'3
					...
					<TD CLASS="CLSMTABP">
						<TABLE ID="MyTab" CELLSPACING=0 CELLPADDING=0>
							<TR>
								...
								<td background="../../../CShared/image/table/seltab_up_bg.gif" align="center" CLASS="CLSMTAB"><font color=white>자원별Shift등록</font></td>
			...
			<TABLE <%=LR_SPACE_TYPE_20%>>
				...
				<TR>
					<TD WIDTH=100% HEIGHT=* valign=top>
						...
						<TR>
								<TD HEIGHT=100%>
									<script language =javascript src='./js/p1503ma1_I915706700_vspdData.js'></script>
								</TD>
							</TR>
						</TABLE>
					</TD>
