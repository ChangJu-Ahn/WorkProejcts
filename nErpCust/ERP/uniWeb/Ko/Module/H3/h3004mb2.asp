...
Sub SubBizQueryMulti()
    ...
    iKey1 = iKey1 & " WHERE (retire_resn IS NULL OR retire_resn = '')"
    ...
    if  lgKeyStream(3) <> "" then
        iKey1 = iKey1 & " AND roll_pstn = " & FilterVar(lgKeyStream(3), "''", "S")
    end if
    ...
    Else
        ...
        Do While Not lgObjRs.EOF
            ...
            lgstrData = lgstrData & Chr(11) & ""    'FuncCodeName(1,"H0001",lgObjRs("pay_grd1"))
            lgstrData = lgstrData & Chr(11) & ""
            lgstrData = lgstrData & Chr(11) & ""    'lgObjRs("pay_grd2")
            lgstrData = lgstrData & Chr(11) & ConvSPChars(lgObjRs("roll_pstn"))
            lgstrData = lgstrData & Chr(11) & ConvSPChars(lgObjRs("roll_pstn_nm"))
            lgstrData = lgstrData & Chr(11) & ""
            lgstrData = lgstrData & Chr(11) & ConvSPChars(lgObjRs("ocpt_type"))
