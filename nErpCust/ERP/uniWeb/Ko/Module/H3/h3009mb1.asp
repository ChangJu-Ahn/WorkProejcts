...
Sub SubBizQueryMulti()
    ...
    Else
        ...
        Do While Not lgObjRs.EOF
            ...
            lgstrData = lgstrData & Chr(11) & ConvSPChars(lgObjRs("prze_pernish"))
            lgstrData = lgstrData & Chr(11) & ""
            lgstrData = lgstrData & Chr(11) & ConvSPChars(lgObjRs("prze_pernish_nm"))
            lgstrData = lgstrData & Chr(11) & UNIConvDateDBToCompany(lgObjRs("crt_dt"),"")
...
Sub SubBizSaveMultiUpdate(arrColVal)
    ...
    lgStrSQL = "UPDATE  HBA020T"
    lgStrSQL = lgStrSQL & " SET " 
    lgStrSQL = lgStrSQL & "     end_dt = " & FilterVar(UNIConvDateCompanyToDB(arrColVal(6),NULL),"NULL","S") & ","
    lgStrSQL = lgStrSQL & "     add_point = " & UNIConvNum(Trim(arrColVal(7)),0) & ","
    lgStrSQL = lgStrSQL & "     cont = " & FilterVar(arrColVal(8), "''", "S") & ","
    lgStrSQL = lgStrSQL & "     rel_office = " & FilterVar(arrColVal(9), "''", "S") & ","

    lgStrSQL = lgStrSQL & "     updt_emp_no = " & FilterVar(gUsrId, "''", "S") & ","
    lgStrSQL = lgStrSQL & "     updt_dt = " & FilterVar(GetSvrDateTime, "''", "S")
    lgStrSQL = lgStrSQL & " WHERE        "
    lgStrSQL = lgStrSQL & "     emp_no = " & FilterVar(UCase(arrColVal(2)), "''", "S")
    lgStrSQL = lgStrSQL & " AND prze_pernish = " & FilterVar(UCase(arrColVal(3)), "''", "S")
    lgStrSQL = lgStrSQL & " AND prze_pernish_nm = " & FilterVar(UCase(arrColVal(4)), "''", "S")
    lgStrSQL = lgStrSQL & " AND crt_dt = " & FilterVar(UNIConvDateCompanyToDB(arrColVal(5),NULL),"NULL","S")
...
Sub SubBizSaveMultiDelete(arrColVal)
    ...
    lgStrSQL = "DELETE  HBA020T"
    lgStrSQL = lgStrSQL & " WHERE        "
    lgStrSQL = lgStrSQL & "     emp_no = " & FilterVar(UCase(arrColVal(2)), "''", "S")
    lgStrSQL = lgStrSQL & " AND prze_pernish = " & FilterVar(UCase(arrColVal(3)), "''", "S")
    lgStrSQL = lgStrSQL & " AND prze_pernish_nm = " & FilterVar(arrColVal(4), "''", "S")
    lgStrSQL = lgStrSQL & " AND crt_dt = " & FilterVar(UNIConvDateCompanyToDB(arrColVal(5),NULL),"NULL","S")
