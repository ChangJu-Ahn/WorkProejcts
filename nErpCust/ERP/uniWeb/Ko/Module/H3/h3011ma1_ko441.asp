...
Const BIZ_PGM_ID = "h3011mb1_ko441.asp"                                      'Biz Logic ASP 
Const C_SHEETMAXROWS    = 9	                                      '한 화면에 보여지는 최대갯수*1.5%>
...
Sub InitSpreadSheet()
	...
	With frm1.vspdData
       ...
       .MaxCols = C_EDU_PASS_YN + 1                                                 ' ☜:☜: Add 1 to Maxcols
       ...
       .MaxRows = 0	
        ...
        'Call  AppendNumberPlace("6","7","2")
         ...
         ggoSpread.SSSetEdit     C_EDU_PASS_YN,   "수료여부",    10,,,10
...
Sub GetSpreadColumnPos(ByVal pvSpdNo)
    ...
    Select Case UCase(pvSpdNo)
       Case "A"
			...
			C_EDU_CONT		= iCurColumnPos(6)			
			C_EDU_START_DT	= iCurColumnPos(7)
			C_EDU_END_DT	= iCurColumnPos(8)
			C_EDU_PASS_YN	= iCurColumnPos(9)
    End Select    
End Sub
'======================================================================================================
       ...
       For lRow = 1 To .vspdData.MaxRows
           ...
           Select Case .vspdData.Text
               ...
               Case  ggoSpread.InsertFlag                                      '☜: Update
					...
					.vspdData.Col = C_DEPT_NM		: strVal = strVal & Trim(.vspdData.Text) & parent.gColSep
					...
					.vspdData.Col = C_EDU_PASS_YN	: strVal = strVal & Trim(.vspdData.Text) & parent.gColSep
...
Function OpenCode(strCode, iWhere)
	...
	Select Case iWhere
	    Case 1
	    	arrParam(1) = "H_IF_HBA030T_KO441"				    ' TABLE 명칭 
	    	arrParam(2) = Trim(strCode)	                        ' Code Condition
	    	arrParam(3) = ""									' Name Cindition
	    	arrParam(4) = " 1=1 "		    		' Where Condition
	    	arrParam(5) = "교육코드"		   				    ' TextBox 명칭 
	
	    	arrField(0) = "EDU_CD"								' Field명(0)
	    	arrField(1) = "EDU_CONT"    						' Field명(1)%>
...
'	    	arrHeader(1) = "교육기관명"	       					' Header명(1)
	...
	arrRet = window.showModalDialog("../../comasp/EduPopup.asp", Array(arrParam, arrField, arrHeader), _
