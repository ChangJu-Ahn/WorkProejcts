...
'    end if
    ...
    Else
        ...
        Do While Not lgObjRs.EOF
            ...
            If  lgObjRs("EDU_PASS_YN") = "Y" Then
                lgstrData = lgstrData & Chr(11) & "수료"
            Else
                lgstrData = lgstrData & Chr(11) & "미수료"
            End If
        ...
        Case "M"
           ...
           Select Case Mid(pDataType,2,1)
               Case "R"
					...
					lgStrSQL = ""
					lgStrSQL = lgStrSQL & " SELECT  TOP " & iSelCount & " DBO.UFN_H_GET_DEPT_CD(A.EMP_NO," & pCode1 & ") DEPT_CD,  "
					...
					lgStrSQL = lgStrSQL & " 		A.EDU_CD,               "
					lgStrSQL = lgStrSQL & " 		A.EDU_CONT,             "
					lgStrSQL = lgStrSQL & " 		EDU_START_DT,           "
					lgStrSQL = lgStrSQL & " 		EDU_END_DT,             "
					lgStrSQL = lgStrSQL & " 		EDU_PASS_YN             "
					lgStrSQL = lgStrSQL & " FROM	HBA030T A,   "
					lgStrSQL = lgStrSQL & "         HAA010T B               "
