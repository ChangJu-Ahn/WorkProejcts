...
'*  3. Program ID           : h3015oa1
'*  4. Program Name         : 인사변동사항출력 
'*  5. Program Desc         : 인사변동사항출력 
'*  6. Comproxy List        : +
...
Function FncBtnPrint() 
	...
	if to_dept_cd = "" then
		to_dept_cd = strMax
		frm1.txtTo_dept_cd.value = ""
		frm1.txtTo_dept_nm.value = ""
		frm1.txtTo_internal_cd.value = ""
	End if		

	strUrl = "stand_dt|" & bas_dt
	strUrl = strUrl & "|stand_dt1|" & bas_dt
					...
					<TD CLASS="CLSMTABP">
						<TABLE ID="MyTab" CELLSPACING=0 CELLPADDING=0>
							<TR>
								...
								<td background="../../../CShared/image/table/seltab_up_bg.gif" align="center" CLASS="CLSLTAB"><font color=white>인사변동사항출력</font></td>
					...
					<TD HEIGHT=20>
						<TABLE <%=LR_SPACE_TYPE_60%>>   
							<TR>
								...
								<TD CLASS=TD6  NOWRAP><script language =javascript src='./js/h3015oa1_txtBas_dt_txtBas_dt.js'></script></TD>
							</TR>
							<TR>
							...
							<TR>
								...
								<TD CLASS="TD6" NOWRAP><SELECT ID = "cboOcpt_type" NAME="cboOcpt_type" ALT="직종" CLASS ="cbonormal" TAG="11"><OPTION VALUE=""></OPTION></SELECT></TD>
							</TR>			
							<TR>
								...
								<TD CLASS="TD6" NOWRAP><INPUT TYPE="Text" ID = "txtFr_dept_cd" NAME="txtFr_dept_cd" SIZE=10 MAXLENGTH=10  tag="11XXXU" ALT="시작부서코드"><IMG SRC="../../../CShared/image/btnPopup.gif" NAME="btnAcctCdFR" ALIGN=top TYPE="BUTTON" ONCLICK="vbscript:Call OpenDept(0)">
								                       <INPUT TYPE="Text" ID = "txtFr_dept_nm" NAME="txtFr_dept_nm" SIZE=20 MAXLENGTH=40 tag="14XXXU" ALT="부서코드명">&nbsp;부터&nbsp;
								                       <INPUT TYPE="hidden" ID = "txtFr_internal_cd" NAME="txtFr_internal_cd" ALT="내부부서코드" SiZE=7 MAXLENGTH=30  tag="14XXXU"></TD>
							</TR>			
							<TR>
								...
								<TD CLASS="TD6" NOWRAP><INPUT TYPE="Text" ID = "txtTo_dept_cd" NAME="txtTo_dept_cd" SIZE=10 MAXLENGTH=10  tag="11XXXU" ALT="종료부서코드"><IMG SRC="../../../CShared/image/btnPopup.gif" NAME="btnAcctCdFR" ALIGN=top TYPE="BUTTON" ONCLICK="vbscript:Call OpenDept(1)">
								                       <INPUT TYPE="Text" ID = "txtTo_dept_nm" NAME="txtTo_dept_nm" SIZE=20 MAXLENGTH=40  tag="14XXXU" ALT="부서코드명">&nbsp;까지
