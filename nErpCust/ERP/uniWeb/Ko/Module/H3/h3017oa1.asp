...
'*  3. Program ID           : h3017oa1
'*  4. Program Name         : 교육사항출력 
'*  5. Program Desc         : 교육사항출력 
'*  6. Comproxy List        : +
...
Function FncBtnPrint() 
	...
	dim bas_dt, bas_dt1, emp_no, ocpt_type, fr_dept_cd, to_dept_cd
	
	StrEbrFile = "h3017oa1"
	
	bas_dt = UNIConvDate(frm1.txtBas_dt.Text)
	bas_dt1 = UNIConvDate(frm1.txtBas_dt.Text)
					...
					<TD CLASS="CLSMTABP">
						<TABLE ID="MyTab" CELLSPACING=0 CELLPADDING=0>
							<TR>
								...
								<td background="../../../CShared/image/table/seltab_up_bg.gif" align="center" CLASS="CLSLTAB"><font color=white>교육사항출력</font></td>
					...
					<TD HEIGHT=20>
						<TABLE <%=LR_SPACE_TYPE_60%>>   
							<TR>
								...
								<TD CLASS=TD6  NOWRAP><script language =javascript src='./js/h3017oa1_fpDateTime1_txtBas_dt.js'></script></TD>
							</TR>
							<TR>
