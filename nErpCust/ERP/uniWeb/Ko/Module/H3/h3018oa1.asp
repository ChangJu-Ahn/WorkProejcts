...
'*  4. Program Name         : 고과사항출력 
'*  5. Program Desc         : 고과사항출력 
'*  6. Comproxy List        : +
...
Sub SetDefaultVal()
	...
	frm1.txtFr_year.Year = strYear 		 '년월일 default value setting
	frm1.txtTo_year.Year = strYear 		 '년월일 default value setting
...
Function FncBtnPrint() 
    ...
    Else
        ...
        ElseIf Cdbl(strtxtFrYear) > Cdbl(strtxtToYear) then
	        Call DisplayMsgBox("800055","X","X","X")	'시작년도는 종료년도보다 작아야 합니다.
					...
					<TD CLASS="CLSMTABP">
						<TABLE ID="MyTab" CELLSPACING=0 CELLPADDING=0>
							<TR>
								...
								<td background="../../../CShared/image/table/seltab_up_bg.gif" align="center" CLASS="CLSLTAB"><font color=white>고과사항출력</font></td>
					...
					<TD HEIGHT=20>
						<TABLE <%=LR_SPACE_TYPE_60%>>   
							<TR>
								...
								<TD CLASS=TD6  NOWRAP><script language =javascript src='./js/h3018oa1_fpDateTime1_txtFr_year.js'></script>&nbsp;부터</TD>
							</TR>
							<TR>
								<TD CLASS=TD5  NOWRAP></TD>
								<TD CLASS=TD6  NOWRAP><script language =javascript src='./js/h3018oa1_fpDateTime2_txtTo_year.js'></script>&nbsp;까지</TD>
							</TR>
							<TR>
							...
							<TR>
								...
								<TD CLASS="TD6" NOWRAP><INPUT TYPE="Text" ID = "txtFr_emp_no" NAME="txtFr_emp_no"  SIZE=13 MAXLENGTH=13 tag="11XXXU" ALT="대상자"><IMG SRC="../../../CShared/image/btnPopup.gif" NAME="btnAcctCdFR" ALIGN=top TYPE="BUTTON" ONCLICK="vbscript:OpenEmptName(0)">
								                       <INPUT TYPE="Text" NAME="txtFr_name" SIZE=20 MAXLENGTH=30  tag="14XXXU" ALT="시작대상자코드명">&nbsp;부터</TD>
							</TR>
							<TR>
								<TD CLASS="TD5" NOWRAP></TD>
								<TD CLASS="TD6" NOWRAP><INPUT TYPE="Text" ID = "txtTo_emp_no" NAME="txtTo_emp_no"  SIZE=13 MAXLENGTH=13 tag="11XXXU" ALT="대상자"><IMG SRC="../../../CShared/image/btnPopup.gif" NAME="btnAcctCdFR" ALIGN=top TYPE="BUTTON" ONCLICK="vbscript:OpenEmptName2(0)">
								                       <INPUT TYPE="Text" NAME="txtTo_name" SIZE=20 MAXLENGTH=30  tag="14XXXU" ALT="종료대상자코드명">&nbsp;까지</TD>
							</TR>
    					</TABLE>
					</TD>
				</TR>
