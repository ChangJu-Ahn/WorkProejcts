...
Const BIZ_PGM_QRY_ID = "Q2417MB1.asp"
Const BIZ_PGM_SAVE_ID = "Q2417MB2.asp"
Const BIZ_PGM_DEL_ID = "Q2417MB3.asp"											 '☆: 비지니스 로직 ASP명 
...
Sub Form_Load()
	...
	Call ggoOper.FormatDate(frm1.txtInspReqDt, gDateFormat, 1)		
...
Function DbQueryOk()																		'☆: 조회 성공후 실행로직 
	...
	'검사진행상태가 "R"인 아닌 경우에만 수정이 가능하도록 처리   	
   	If frm1.hStatusFlag.value = "R" Then
   		...
   		Call SetToolBar("11110000000110")
   	Else
   		Call ggoOper.LockField(Document, "N")		
   		Call SetToolBar("11101000000000")		'⊙: 버튼 툴바 제어 
   	End If
End Function
					...
					<TD CLASS="CLSMTABP">
						<TABLE ID="MyTab" CELLSPACING=0 CELLPADDING=0>
							<TR>
								...
								<TD BACKGROUND="../../../CShared/image/table/seltab_up_bg.gif" ALIGN="center" CLASS="CLSMTAB"><FONT COLOR=white>출하검사 RELEASE</FONT></TD>
					...
					<TD HEIGHT=*  WIDTH=100% VALIGN=TOP>						
						<TABLE <%=LR_SPACE_TYPE_60%>>
							<TR>
								...
								<TD CLASS="TD6" NOWRAP>
									<script language =javascript src='./js/q2417ma1_txtReleaseDt_txtReleaseDt.js'></script>
								</TD>								
							</TR>
							<TR>
								<TD CLASS="TD5" NOWRAP>거래처</TD>
								<TD CLASS="TD6" NOWRAP><INPUT TYPE=TEXT NAME="txtBpCd" SIZE=10 ALT="거래처" tag="24">&nbsp;<INPUT TYPE=TEXT NAME="txtBpNm" SIZE=20 tag="24"></TD>
								<TD CLASS="TD5" NOWRAP>검사의뢰일</TD>
								<TD CLASS="TD6" NOWRAP>
									<script language =javascript src='./js/q2417ma1_txtInspReqDt_txtInspReqDt.js'></script>
								</TD>								
							</TR>							
							<TR>
								...
								<TD CLASS="TD6" NOWRAP>
									<script language =javascript src='./js/q2417ma1_fpDoubleSingle1_txtLotSize.js'></script>
								</TD>
                			</TR>
                			<TR>
								...
								<TD CLASS="TD6" NOWRAP>
									<script language =javascript src='./js/q2417ma1_txtInspDt_txtInspDt.js'></script>
								</TD>								
							</TR>
							<TR>
								<TD CLASS="TD5" NOWRAP>양품수</TD>
								<TD CLASS="TD6" NOWRAP>
									<script language =javascript src='./js/q2417ma1_fpDoubleSingle2_txtGoodQty.js'></script>
								</TD>
								<TD CLASS="TD5" NOWRAP>불량품수</TD>
								<TD CLASS="TD6" NOWRAP>
									<script language =javascript src='./js/q2417ma1_fpDoubleSingle3_txtDefectQty.js'></script>
								</TD>
							</TR>
							<TR>
	...
	<TR HEIGHT=20>
      		<TD WIDTH=100%>
      			<TABLE <%=LR_SPACE_TYPE_30%>>
        				<TR>        				
        					<TD WIDTH=10>&nbsp;</TD>
	        				<TD WIDTH=* ALIGN=RIGHT><A href="vbscript:LoadInspection">출하검사</A></TD>
					<TD WIDTH=10>&nbsp;</TD>
       				</TR>
      			</TABLE>
      		</TD>
