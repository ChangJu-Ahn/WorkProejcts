...
'*  2. Function Name        : 
'*  3. Program ID           : Q2413MB4
'*  4. Program Name         : 불량유형 전체 삭제 
...
Dim PQIG080																	'☆ : 조회용 ComProxy Dll 사용 변수 
...
I2_q_inspection_result(Q229_I2_insp_result_no) = 1	
I2_q_inspection_result(Q229_I2_plant_cd) = strPlantCd
I2_q_inspection_result(Q229_I2_insp_class_cd) = strinsp_class_cd	'@@@주의 
...
Call PQIG080.Q_MAINT_INSP_DEFT_TYPE_SVR(gStrGlobalCollection, _
									UCase(strInspReqNo), _
