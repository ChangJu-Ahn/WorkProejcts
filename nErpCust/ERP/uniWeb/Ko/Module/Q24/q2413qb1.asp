...
Sub FixUNISQLData()
	...
	Select Case strFlag
		Case "N"
			...
			UNISqlId(0) = "Q2413QA101"
		Case "I"
			Redim UNIValue(0,7)    
			UNISqlId(0) = "Q2413QA102"
		Case "B"
			Redim UNIValue(0,7)    
			UNISqlId(0) = "Q2413QA103"
		Case "IB"
			Redim UNIValue(0,8)    
			UNISqlId(0) = "Q2413QA104"
		Case "IS"
			Redim UNIValue(0,8)    
			UNISqlId(0) = "Q2413QA105"
		Case "A"
			Redim UNIValue(0,9)             
			UNISqlId(0) = "Q2413QA106"
	End Select
	...
	Select Case strFlag
	    	...
	    	Case "B"
	    		 UNIValue(0,6) = FilterBpCd	    					'---거래처 
	    	Case "IB"
	    		 UNIValue(0,6) = FilterItemCd					'---품목 
	    		 UNIValue(0,7) = FilterBpCd	    					'---거래처 
	    	Case "IS"
	    		 UNIValue(0,6) = FilterItemCd					'---품목 
...
Sub TrimData()
	...
	If strItemCd = "" And strBpCd = "" And strInspItemCd = "" Then
		strFlag = "N"
	ElseIf strItemCd <> "" And strBpCd = "" And strInspItemCd = "" Then
		strFlag = "I"
	ElseIf strItemCd = "" And strBpCd <> "" And strInspItemCd = "" Then
		strFlag = "B"
	ElseIf strItemCd <> "" And strBpCd <> "" And strInspItemCd = "" Then
