...
Function Plant_Req_Check()
	...
	With frm1
		...
		If lgF0(0) <> "S" Then
			Call DisplayMsgBox("220733", "X", "X", "X")
			.txtInspReqNo.Focus
			Set gActiveElement = document.activeElement
			Exit function
		End If
					...
					<TD>
						<TABLE ID="MyTab" CELLSPACING=0 CELLPADDING=0>
							<TR>
								...
								<td background="../../../CShared/image/table/seltab_up_bg.gif" align="center" CLASS="CLSMTAB"><font color=white>출하검사성적서출력</font></td>
