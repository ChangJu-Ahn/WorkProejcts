...
<!--
======================================================================================================
*  1. Module Name          : CAST Resources
*  2. Function Name        : 금형수리내역등록 
*  3. Program ID           : P6225ma
*  4. Program Name         :
*  5. Program Desc         : 금형수리내역등록 
*  6. Comproxy List        :
...
Const BIZ_PGM_ID = "P6225mb1.asp"                                      'Biz Logic ASP
...
Sub InitComboBox()
    ...
    'Call CommonQueryRs(" MINOR_CD, MINOR_NM "," B_MINOR "," MAJOR_CD = 'Z408' ",lgF0,lgF1,lgF2,lgF3,lgF4,lgF5,lgF6)
    'Call SetCombo2(frm1.txtPlantCd ,lgF0  ,lgF1  ,Chr(11))
...
Sub InitSpreadSheet(ByVal pvSpdNo)
	...
	If pvSpdNo = "" OR pvSpdNo = "A" Then
		...
		With frm1.vspdData
				...
				ggoSpread.SSSetButton C_CastPop
				ggoSpread.SSSetEdit		C_CAST_NM,				"금형명", 		15,,,40,2
				ggoSpread.SSSetEdit		C_SET_PLANTNm,  		"공장",     15,,,20,2
				ggoSpread.SSSetEdit		C_CAR_KINDNm,			"적용모델", 	15,,,20,2
				...
				ggoSpread.SSSetCombo 	C_Insp_Flag,			"점검여부",  10, 0, True
				ggoSpread.SSSetCombo 	C_Insp_FlagNm,			"점검여부",  10, 0, True
    ...
    If pvSpdNo = "" OR pvSpdNo = "B" Then
		...
		With frm1.vspdData1
			...
			ggoSpread.SSSetCombo	C_Insp_PartCd,		"수리항목",  10, 0, True
			ggoSpread.SSSetCombo	C_Insp_PartNm,		"수리항목",  10, 0, False
			ggoSpread.SSSetCombo	C_Insp_MethCd,		"수리방법",  10, 0, True
			...
			ggoSpread.SSSetEdit		C_Sury_Assy_Nm,		"부품명",	    15,,,20,2
    ...
    If pvSpdNo = "" OR pvSpdNo = "C" Then
		...
		With frm1.vspdData2
			...
			ggoSpread.SSSetFloat	C_Seq,				"순서",     8, "7", ggStrIntegeralPart,  ggStrDeciPointPart, parent.gComNum1000, parent.gComNumDec,,,"Z"
			ggoSpread.SSSetCombo 	C_Insp_Emp_Gb,		"구분",  10, 0, True
...
Sub SetSpreadColor(ByVal pvStartRow,ByVal pvEndRow)
	...
	With frm1.vspdData
		...
		.ReDraw = False
		ggoSpread.SSSetRequired		C_CAST_CD				, pvStartRow, pvEndRow
		...
		ggoSpread.SSSetProtected	C_Car_KindNm		, pvStartRow, pvEndRow
		...
		ggoSpread.SSSetProtected	C_Matl_Cost			, pvStartRow, pvEndRow
    ...
    Select Case UCase(pvSpdNo)
       Case "A"
            ...
            Call ggoSpread.GetSpreadColumnPos(iCurColumnPos)
				...
				C_CastPop       = iCurColumnPos(2 )
				C_Cast_Nm      	= iCurColumnPos(3 )
				C_Set_PlantNm        	= iCurColumnPos(4 )
				C_Car_KindNm      	= iCurColumnPos(5 )
				...
				C_Insp_FlagNm      	= iCurColumnPos(20)
       ...
       Case "B"
            ...
            Call ggoSpread.GetSpreadColumnPos(iCurColumnPos)
				...
				C_Sury_TypeNM      	= iCurColumnPos(19)
...
Function DbDtlQuery1()
    ...
    With Frm1
	    ...
	    strVal = strVal     & "&txtCast_Cd="		    & Frm1.hFacility_Cd.value      '☜: Query Key
           ...
           For lRow = 1 To .vspdData.MaxRows
               ...
               Select Case .vspdData.Text
                   ...
                   Case  ggoSpread.InsertFlag                                      '☜: Update
                        ...
                        .vspdData.Col = C_Insp_FlagNm	: strVal = strVal &				Trim(.vspdData.Text) 	& parent.gColSep
                        .vspdData.Col = C_PayRoll		: strVal = strVal & UNIConvNum (Trim(.vspdData.Text),0)	& parent.gColSep
                        .vspdData.Col = C_Insp_Hour		: strVal = strVal & UNIConvNum (Trim(.vspdData.Text),0)	& parent.gColSep
                        .vspdData.Col = C_Insp_Min		: strVal = strVal & UNIConvNum (Trim(.vspdData.Text),0)	& parent.gRowSep
                        lGrpCnt = lGrpCnt + 1
...
Function OpenFacility_Popup(Byval iWhere)
	...
	Select Case iWhere
		Case "1"
			arrParam(0) = "금형코드 팝업"
			arrParam(1) = "Y_CAST"
			arrParam(2) = frm1.txtCastCd.value
...
Sub SetCondArea(Byval arrRet, Byval iWhere)
	With Frm1
		Select Case iWhere
			Case "1"
			    .txtCastCd.value = arrRet(0)
			    .txtCastNm.value = arrRet(1)
			Case "2"
				frm1.vspdData.Col = C_cast_CD
				frm1.vspdData.text = arrRet(0)
				frm1.vspdData.Col = C_cast_NM
				frm1.vspdData.text = arrRet(1)

				Call vspdData_Change(C_CAST_CD, frm1.vspdData.ActiveRow)
	...
	With frm1
		...
		Select Case iWhere
		    Case C_Insp_Dept_POP
		    	...
		    	.vspdData.action=0
		    	Call SetActiveCell(frm1.vspdData,C_INSP_EMP_QTY, frm1.vspdData.ActiveRow,"M","X","X")
				Set gActiveElement = document.activeElement
		    Case C_Req_Dept_POP
		    	...
		    	.vspdData.text = arrRet(0)
		    	.vspdData.action=0
		    	Call SetActiveCell(frm1.vspdData,C_Insp_Dept,frm1.vspdData.ActiveRow,"M","X","X")
				Set gActiveElement = document.activeElement
        End Select
	End With
...
Sub vspdData_Change(ByVal Col , ByVal Row )
	...
	Select Case Col
		Case  C_Cast_Cd
			...
			IntRetCd = CommonQueryRs(" Cast_nm, dbo.ufn_GetCodeName('Z408', Set_Plant) Set_Plant_nm "," Y_CAST "," SET_PLANT = '" & frm1.txtPlantCd.value & "' AND cast_cd = '" & strFac & "'",lgF0,lgF1,lgF2,lgF3,lgF4,lgF5,lgF6)

			If IntRetCd = false then
				Call DisplayMsgBox("971012", "X", "금형코드", "X")
				Frm1.vspdData.Col = C_CAST_NM
				Frm1.vspdData.text = Trim(Replace(lgF0,Chr(11),""))
				Call SetActiveCell(frm1.vspdData,C_Cast_Cd,Row,"M","X","X")
				Set gActiveElement = document.activeElement
			ELSE
				Frm1.vspdData.Col = C_CAST_Nm
				Frm1.vspdData.text = Trim(Replace(lgF0,Chr(11),""))
				...
				Call SetActiveCell(frm1.vspdData,C_Plan_Dt,Row,"M","X","X")
				Set gActiveElement = document.activeElement
			END IF
...
Function vspdData1_Change(ByVal Col , ByVal Row )
    Dim intIndex
					...
					<TD CLASS="CLSMTABP">
						<TABLE ID="MyTab" CELLSPACING=0 CELLPADDING=0>
							<TR>
								...
								<td background="../../../CShared/image/table/seltab_up_bg.gif" align="center" CLASS="CLSMTABP"><font color=white>금형수리내역등록</font></td>
						...
						<FIELDSET CLASS="CLSFLD">
							<TABLE <%=LR_SPACE_TYPE_40%>>
								<TR>
									...
									<TD CLASS="TD6" NOWRAP><INPUT TYPE=TEXT ALT="공장" NAME="txtPlantCd" SIZE=6 MAXLENGTH=4 tag="12XXXU" ><IMG SRC="../../../CShared/image/btnPopup.gif" NAME="btnORGCd1" align=top TYPE="BUTTON"ONCLICK="vbscript:OpenPlant('Plant1')" OnMouseOver="vbscript:PopUpMouseOver()" OnMouseOut="vbscript:PopUpMouseOut()">
								...
								<TR>
									...
									<TD CLASS="TD6" NOWRAP><script language =javascript src='./js/p6225ma1_txtWork_Dt_txtWork_Dt.js'></script></TD>
						...
						<TABLE <%=LR_SPACE_TYPE_20%>>
							<TR HEIGHT="60%">
								<TD WIDTH="100%" colspan=4>
									<script language =javascript src='./js/p6225ma1_vaSpread_vspdData.js'></script>
								</TD>
							</TR>
							<TR HEIGHT="20%">
								<TD WIDTH="100%" colspan=4>
									<script language =javascript src='./js/p6225ma1_vaSpread1_vspdData1.js'></script>
								</TD>
							</TR>
							<TR HEIGHT="20%">
								<TD WIDTH="100%" colspan=4>
									<script language =javascript src='./js/p6225ma1_vaSpread2_vspdData2.js'></script>
								</TD>
							</TR>
						</Table>
					</TD>
