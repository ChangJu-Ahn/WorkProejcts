...
'**********************************************************************************************************%>
Const BIZ_PGM_ID = "P6225QB1.asp"												'☆: 비지니스 로직 ASP명 
...
'--------------- 개발자 coding part(실행로직,Start)-----------------------------------------------------------
 '  EndDate = GetSvrDate                                           '☆: 초기화면에 뿌려지는 시작 날짜 -----
  ' EndDate = Year(Date) & gComDateType & Right("0" & Month(Date),2) & gComDateType & Right("0" & Day(Date),2)      ' ToDay Infomation
 '  StartDate = EndDate                                           '☆: 초기화면에 뿌려지는 시작 날짜 -----
...
Sub InitSpreadSheet()
	...
	With frm1.vspdData
		...
		ggoSpread.SSSetFloat	C_INSP_HOUR				, "소요시간"		, 15, "6",ggStrIntegeralPart, ggStrDeciPointPart,Parent.gComNum1000,Parent.gComNumDec,,,"Z"    
		ggoSpread.SSSetFloat	C_INSP_MIN				, "소요분"			, 15, "6",ggStrIntegeralPart, ggStrDeciPointPart,Parent.gComNum1000,Parent.gComNumDec,,,"Z"    
		ggoSpread.SSSetEdit		C_INSP_DEPT				, "점검부서"		, 10
...
Sub GetSpreadColumnPos(ByVal pvSpdNo)
    ...
    Select Case UCase(pvSpdNo)
       Case "A"
			...
			C_INSP_TEXT				= iCurColumnPos(4)
			C_INSP_HOUR				= iCurColumnPos(5)
			C_INSP_MIN				= iCurColumnPos(6)
			C_INSP_DEPT				= iCurColumnPos(7)
...
Function FncQuery() 
    ...
    Call InitVariables                                                       '⊙: Initializes local global variable
					...
					<TD CLASS="CLSMTABP" colspan=2>
						<TABLE ID="MyTab" CELLSPACING=0 CELLPADDING=0>
							<TR>
								...
								<td background="../../image/table/seltab_up_bg.gif" align="center" CLASS="CLSMTAB"><font color=white>금형점검내역조회</font></td>
							...
							<TABLE <%=LR_SPACE_TYPE_40%>>
								<TR>
									...
									<TD CLASS=TD6 NOWRAP><TABLE CELLSPACING=0 CELLPADDING=0>
										<TR>
											<TD><script language =javascript src='./js/p6225qa1_fpDateTime1_txtReqdlvyFromDt.js'></script>
											&nbsp;~&nbsp;
											<script language =javascript src='./js/p6225qa1_fpDateTime1_txtReqdlvyToDt.js'></script>
											</TD>
										</TR>
													</TABLE></TD>
						...
						<TABLE <%=LR_SPACE_TYPE_20%>>
							<TR>
								<TD HEIGHT="100%" WIDTH="100%" COLSPAN=4>
									<script language =javascript src='./js/p6225qa1_vaSpread1_vspdData.js'></script>
								</TD>
							</TR>
						</TABLE>
					</TD>
