...
Sub FixUNISQLData()
    ...
    UNISqlId(0) = "C3602MA01"
    UNISqlId(1) = "C3602MA02"					'SUM
	...
	strWhere = " AND E.MAJOR_CD= " & FilterVar("P1001", "''", "S") & " AND A.YYYYMM = "				' MAJOR_CD=P1001
...
Sub QueryData()
    ...
    IF NOT (rs1.EOF or rs1.BOF) then
		SUM = rs1("SUM")				' SUM(A.CHILD_ISSUE_AMT)
	ELSE
		SUM = ""
	End if
    rs1.Close
	...
	If Request("txtCostCd")<>""then    
	    IF NOT (rs2.EOF or rs2.BOF) then
		    COST_NM = rs2("COST_NM")
		ELSE
			Call DisplayMsgBox("124400", vbOKOnly, "", "", I_MKSCRIPT)		'cost center 가 존재하지 않는다.
	%>
    ...
    If  rs0.EOF And rs0.BOF Then
		Call DisplayMsgBox("234500", vbOKOnly, "", "", I_MKSCRIPT)		'No Data Found!!
	%>
		<Script Language=vbscript>
