...
Sub FixUNISQLData()
    ...
    UNISqlId(0) = "C3911MA01"	'sheet1 화면 
    UNISqlId(1) = "C3911MA01"	'Diff Amt
    UNISqlId(2) = "C3911MA03"	'Tot Allc Amt

    '--------------- 개발자 coding part(실행로직,End)------------------------------------------------------
    UNIValue(0,0) = lgSelectList                                          '☜: Select list
    UNIValue(1,0) = "SUM(a.RCPT_DIFF_AMT)"
	...
	IF Trim(Request("txtItemAcct")) <> "" Then
		lgCodeCond		= lgCodeCond   & " and e.ITEM_ACCT = " & FilterVar(Request("txtItemAcct"), "''", "S")
		lgTotAmtCond	= lgTotAmtCond & " and e.ITEM_ACCT = " & FilterVar(Request("txtItemAcct"), "''", "S")
	Else
