...
Sub SubBizCancel()
    ...
    Set iPC3G045S = Server.CreateObject("PC3G045.cCCnclOfRefltSvr")
    ...
    Call iPC3G045S.C_CANCEL_OF_REFLECTION_SVR(gStrGloBalCollection,importArray1)		
