...
Const BIZ_PGM_ID 		= "C3604mb1.asp"                              '☆: Biz Logic ASP Name
...
Sub InitSpreadSheet()
		...
		Call SetZAdoSpreadSheet("c3604ma01","S","A","V20021213",parent.C_SORT_DBAGENT,frm1.vspdData, C_MaxKey, "X","X")
		Call SetSpreadLock 
'
End Sub
...
Sub Form_Load()
    ...
    Call LoadInfTB19029														
	'------ Developer Coding part (Start ) -------------------------------------------------------------- 
'    Call Parent.GetAdoFieldInf("C3604MA01","S","A")                                ' S for Sort , A for SpreadSheet No('A','B',....             
...
'    Call Parent.MakePopData(Parent.gDefaultT,Parent.gFieldNM,Parent.gFieldCD,lgPopUpR,lgSortFieldNm,lgSortFieldCD,Parent.C_MaxSelList)
	...
	frm1.txtMfcSum.allownull = False
	frm1.txtDirSum.allownull = False
	'------ Developer Coding part (End   ) -------------------------------------------------------------- 
...
Sub SumValueToZero()
	frm1.txtSum.Value = 0
	frm1.txtMfcSum.Value = 0
	frm1.txtDirSum.Value = 0
End Sub
					...
					<TD CLASS="CLSMTABP">
						<TABLE ID="MyTab" CELLSPACING=0 CELLPADDING=0>
							<TR>
								...
								<td background="../../../CShared/image/table/seltab_up_bg.gif" align="center" CLASS="CLSMTAB"><font color=white>회계가공비집계조회</font></td>
						...
						<FIELDSET CLASS="CLSFLD">
							<TABLE <%=LR_SPACE_TYPE_40%>>
								<TR>
									...
									<TD CLASS="TD6"><script language =javascript src='./js/c3604ma1_fpDateTime1_txtYyyymm.js'></script></TD>
					...
					<TD WIDTH=100% HEIGHT=100% valign=top>
						<TABLE <%=LR_SPACE_TYPE_20%>>
							<TR>
								...
								<script language =javascript src='./js/c3604ma1_OBJECT1_vspdData.js'></script>
								</TD>
							</TR>
						</TABLE>
					</TD>
						...
						<FIELDSET CLASS="CLSFLD">
							<TABLE <%=LR_SPACE_TYPE_20%>>
								<TR>
									...
									<TD CLASS=TD5 NOWRAP>
										<script language =javascript src='./js/c3604ma1_fpDoubleSingle2_txtSum.js'></script>&nbsp;
									</TD>
									<TD CLASS="TD5" NOWRAP>가공비합계</TD>
									<TD CLASS="TD5" NOWRAP>
										<script language =javascript src='./js/c3604ma1_fpDoubleSingle2_txtMfcSum.js'></script>&nbsp;
									</TD>

									<TD CLASS="TD5" NOWRAP>직과가공비합계</TD>
									<TD CLASS="TD5" NOWRAP>
										<script language =javascript src='./js/c3604ma1_fpDoubleSingle2_txtDirSum.js'></script>&nbsp;
									</TD>
