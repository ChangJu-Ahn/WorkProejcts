...
Sub MakeSpreadSheetData()
    ...
    Do while Not (rs0.EOF Or rs0.BOF)
        ...
        lgstrData = lgstrData & Chr(11) & ConvSPChars(rs0(0))		'코스트센터 
        lgstrData = lgstrData & Chr(11) & ConvSPChars(rs0(1))		'코스트센터명 
        lgstrData = lgstrData & Chr(11) & ConvSPChars(rs0(2))		'계정 
        lgstrData = lgstrData & Chr(11) & ConvSPChars(rs0(3))		'계정명 
        lgstrData = lgstrData & Chr(11) & ConvSPChars(rs0(4))		'관리항목 
        lgstrData = lgstrData & Chr(11) & ConvSPChars(rs0(5))		'관리항목명 
        lgstrData = lgstrData & Chr(11) & ConvSPChars(rs0(6))		'관리항목 Value
        lgstrData = lgstrData & Chr(11) & ConvSPChars(rs0(7))		'관리항목 Value명 
...
Sub FixUNISQLData()
    ...
    Redim UNIValue(4,7)                                                  '⊙: DB-Agent로 전송될 parameter를 위한 변수 
