...
'*  3. Program ID           : c3702oa1
'*  4. Program Name         : 직과가공비집계출력 
'*  5. Program Desc         : 직과가공비집계출력 
'*  6. Comproxy List        : +
'*  7. Modified date(First) : 2000/11/15
...
Function OpenCostCd(Byval strCode, Byval iWhere)
	...
	arrParam(0) = "코스트센타팝업"
	arrParam(1) = "B_COST_CENTER a, C_DIR_MFC_COST b"
	arrParam(2) = strCode
	arrParam(3) = ""
					...
					<TD CLASS="CLSMTABP">
						<TABLE ID="MyTab" CELLSPACING=0 CELLPADDING=0>
							<TR>
								...
								<td background="../../../CShared/image/table/seltab_up_bg.gif" align="center" CLASS="CLSMTAB"><font color=white>직과가공비집계출력</font></td>
					...
					<TD WIDTH=100% HEIGHT=* valign=top>
						<TABLE <%=LR_SPACE_TYPE_60%>>
								<TR>
									...
									<TD CLASS="TD6" NOWRAP>
										<script language =javascript src='./js/c3702oa1_fpDateTime1_txtYyyymm.js'></script>
									</TD>								
								</TR>
								<TR>	
