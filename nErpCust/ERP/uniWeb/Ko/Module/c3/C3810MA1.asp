...
'========================================================================================
Sub InitSpreadSheet()
    Call SetZAdoSpreadSheet("C3810MA1","S","A","V20051010","",frm1.vspdData, C_MaxKey, "X","X")
					...
					<TD CLASS="CLSMTABP">
						<TABLE ID="MyTab" CELLSPACING=0 CELLPADDING=0>
							<TR>
								...
								<td background="../../../CShared/image/table/seltab_up_bg.gif" align="center" CLASS="CLSMTAB"><font color=white>배부근거조회(C/C별)</font></td>
					...
					<TD HEIGHT=20 WIDTH=100%>
						<FIELDSET CLASS="CLSFLD">
								...
								<TR>
									...
									<TD CLASS="TD6" NOWRAP><script language =javascript src='./js/c3810ma1_fpDateTime1_txtDt.js'></script></TD>
					...
					<TD WIDTH=100% HEIGHT=* valign=top>
						<TABLE <%=LR_SPACE_TYPE_60%>>
							<TR>
								...
								<script language =javascript src='./js/c3810ma1_vspdData_vspdData.js'></script></TD>
							</TR>
						</TABLE>						
					</TD>
				</TR>
