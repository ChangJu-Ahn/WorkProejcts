...
'=======================================================================================================
'@PGM_ID
Const BIZ_PGM_QRY_ID = "C3101Bb9.asp"					'조회 비지니스 로직 ASP명 
Const BIZ_PGM_ID = "C3101Bb1.asp"
...
Sub InitSpreadPosVariables()
	 C_ChkFlag		= 1
	 C_PrgYn		= 2
	 C_MinorCd		= 3										'Spread Sheet의 Column별 상수 
	 C_MinorNM		= 4
	 C_Reference	= 5
End Sub
...
Sub InitSpreadSheet()
	...
	With frm1.vspdData
	   ...
	   .ReDraw = false
		...
		ggoSpread.SSSetEdit C_MinorCd, "작업단계코드",20, 0
		ggoSpread.SSSetEdit C_MinorNm, "작업단계명", 68, 0
...
Sub SetSpreadLock()
	With frm1
		...
		ggoSpread.SpreadLock C_MinorCd, -1, C_MinorCd
...
Sub GetSpreadColumnPos(ByVal pvSpdNo)
    ...
    Select Case UCase(pvSpdNo)
       Case "A"
			...
			C_PrgYn					= iCurColumnPos(2)
			C_MinorCd     			= iCurColumnPos(3)    
			C_MinorNM       		= iCurColumnPos(4)
			C_Reference       		= iCurColumnPos(5)
    End Select    
End Sub
			...
			<TABLE <%=LR_SPACE_TYPE_20%>>
						...
						<FIELDSET CLASS="CLSFLD">
							<TABLE <%=LR_SPACE_TYPE_40%>>
								<TR>
									...
									<TD CLASS="TD6" NOWRAP><script language =javascript src='./js/c3101ba1_fpDateTime1_txtYyyymm.js'></script></TD>
				...
				<TR>
					<TD WIDTH=100% HEIGHT=100% VALIGN=top COLSPAN=4>
						<script language =javascript src='./js/c3101ba1_vaSpread1_vspdData.js'></script>
					</TD>
				</TR>
			</TABLE>
		</TD>
