...
Sub  FixUNISQLData()
    ...
    'UNIValue(3,0) = " select biz_unit_cd,biz_unit_nm from b_biz_unit where biz_unit_cd = " & FilterVar(UCase(strToBizUnitCd1),"''","S")
    'UNIValue(4,0) = " select biz_unit_cd,biz_unit_nm from b_biz_unit where biz_unit_cd = " & FilterVar(UCase(strToBizUnitCd2),"''","S")            
    'UNIValue(5,0) = " select Item_cd,item_nm from b_item where item_cd = " & FilterVar(UCase(strFrItemCd1),"''","S")
    'UNIValue(6,0) = " select Item_cd,item_nm from b_item where item_cd = " & FilterVar(UCase(strFrItemCd2),"''","S")
    'UNIValue(7,0) = " select Item_cd,item_nm from b_item where item_cd = " & FilterVar(UCase(strToItemCd1),"''","S")
    'UNIValue(8,0) = " select Item_cd,item_nm from b_item where item_cd = " & FilterVar(UCase(strToItemCd2),"''","S")        
