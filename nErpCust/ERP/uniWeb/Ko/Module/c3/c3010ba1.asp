					...
					<TD CLASS="CLSMTABP">
						<TABLE ID="MyTab" CELLSPACING=0 CELLPADDING=0>
							<TR>
								...
								<td background="../../../CShared/image/table/seltab_up_bg.gif" align="center" CLASS="CLSMTAB"><font color=white>구매품재고금액평가</font></td>
					...
					<TD WIDTH=100% HEIGHT=* valign=top>
						<TABLE <%=LR_SPACE_TYPE_60%>>
							<TR>
									...
									<TD CLASS="TD6" NOWRAP>
										<script language =javascript src='./js/c3010ba1_fpDateTime1_txtYyyymm.js'></script>
									</TD>								
							</TR>
						</TABLE>
					</TD>
