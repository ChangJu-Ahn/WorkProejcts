...
'*  3. Program ID           : c3900mb2
'*  4. Program Name         : 평가금액반영 
'*  5. Program Desc         : 재고금액평가반영 
'*  6. Comproxy List        : 
...
Sub SubBizSaveMulti()
    ...
    Set iPC3G045S = Server.CreateObject("PC3G045.cCRefltOfValSvr")
    ...
    Call iPC3G045S.C_REFLECTION_OF_VALUATION_SVR(gStrGloBalCollection,importArray1)		
		
    If CheckSYSTEMError(Err, True) = True Then					
       Set iPC3G045S = Nothing
       SetErrorStatus
       Exit Sub
    End If    
