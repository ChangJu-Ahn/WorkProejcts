...
Const BIZ_PGM_ID		= "C3911MB1.asp"                         '☆: Biz logic spread sheet for #1
Const BIZ_PGM_SUB_ID	= "C3911MB2.asp"                         '☆: Biz logic spread sheet for #2
...
'========================================================================================================
Sub InitSpreadSheet()
    Call SetZAdoSpreadSheet("C3911MA1","S","A", "V20021201", Parent.C_SORT_DBAGENT,frm1.vspdData ,C_MaxKey, "X", "X")
    Call SetZAdoSpreadSheet("C3911MA1","S","B", "V20021201", Parent.C_SORT_DBAGENT,frm1.vspdData1,C_MaxKey, "X", "X")
					...
					<TD CLASS="CLSMTABP">
						<TABLE ID="MyTab" CELLSPACING=0 CELLPADDING=0>
							<TR>
								...
								<td background="../../../CShared/image/table/seltab_up_bg.gif" align="center" CLASS="CLSMTAB"><font color=white>입고차이배부내역</font></td>
			...
			<TABLE <%=LR_SPACE_TYPE_20%>>
						...
						<FIELDSET CLASS="CLSFLD">
							<TABLE <%=LR_SPACE_TYPE_40%>>
								<TR>
									...
									<TD CLASS="TD6" NOWRAP><script language =javascript src='./js/c3911ma1_OBJECT1_txtYyyymm.js'></script>
				...
				<TR>
					<TD WIDTH=100% HEIGHT=* valign=top>
						<TR HEIGHT="70%">
							...
							<script language =javascript src='./js/c3911ma1_vspdData_vspdData.js'></script>
							</TD>
						</TR>
					</TD>
				</TR>
						...
						<FIELDSET CLASS="CLSFLD">
							<TABLE <%=LR_SPACE_TYPE_20%>>
								<TR>
									...
									<TD CLASS="TD5" NOWRAP>입고차이금액</TD>
									<TD CLASS="TD6" NOWRAP>
										<script language =javascript src='./js/c3911ma1_fpDoubleSingle2_txtDiffAmt.js'></script>&nbsp;
									</TD>
								</TR>
							</TABLE>
						</FIELDSET>
				...
				<TR>
					<TD WIDTH=100% HEIGHT=* valign=top>
						<TR HEIGHT="30%">
							<TD WIDTH="100%" colspan=4>
							<script language =javascript src='./js/c3911ma1_vspdData1_vspdData1.js'></script>
							</TD>
						</TR>
					</TD>
				</TR>
						...
						<FIELDSET CLASS="CLSFLD">
							<TABLE <%=LR_SPACE_TYPE_20%>>
								<TR>
									...
									<TD CLASS="TD6" NOWRAP>
										<script language =javascript src='./js/c3911ma1_fpDoubleSingle2_txtAllcAmt.js'></script>&nbsp;
									</TD>
									<TD CLASS="TD5" NOWRAP>총 배부된 차이금액</TD>
									<TD CLASS="TD6" NOWRAP>
										<script language =javascript src='./js/c3911ma1_fpDoubleSingle2_txtTotAllcAmt.js'></script>&nbsp;
									</TD>									
								</TR>
							</TABLE>
						</FIELDSET>
