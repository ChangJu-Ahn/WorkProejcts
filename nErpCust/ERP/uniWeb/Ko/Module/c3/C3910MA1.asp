...
'========================================================================================================
Const BIZ_PGM_ID		= "c3910mb1.asp"                                      'Biz Logic ASP 
'========================================================================================================
			...
			<TABLE <%=LR_SPACE_TYPE_20%>>
						...
						<FIELDSET CLASS="CLSFLD">
							<TABLE <%=LR_SPACE_TYPE_40%>>
								<TR>
									...
									<TD CLASS="TD6" NOWRAP>
										<script language =javascript src='./js/c3910ma1_txtYyyymm_txtYyyymm.js'></script>
									</TD>								
				...
				<TR>
					<TD WIDTH=100% HEIGHT=100% valign=top>
							...
							<TR>
								<TD HEIGHT="100%">
									<script language =javascript src='./js/c3910ma1_OBJECT1_vspdData.js'></script>
								</TD>
							</TR>
						</TABLE>
					</TD>
						...
						<FIELDSET CLASS="CLSFLD">
							<TABLE <%=LR_SPACE_TYPE_20%>>
								<TR>
									...
									<TD CLASS=TD6 NOWRAP>
										<script language =javascript src='./js/c3910ma1_fpDoubleSingle2_txtSum.js'></script>&nbsp;
	                                </TD>
								</TR>
							</TABLE>
						</FIELDSET>
