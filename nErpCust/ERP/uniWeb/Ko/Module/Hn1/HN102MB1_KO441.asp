...
'Call ServerMesgBox("arrColVal(7) = " & arrColVal(7) , vbInformation, I_MKSCRIPT)
				...
				lgStrSQL = lgStrSQL & "			PAY_GRD1, PAY_GRD2, PAY_CD, TAX_CD, INTERNAL_CD, ISRT_EMP_NO, UPDT_EMP_NO, MINUS2_RATE, DEPT_NM )"
				...
				lgStrSQL = lgStrSQL & FilterVar(Trim(UCase(arrColVal(23))),"","S")		& " "		'>>AIR
				lgStrSQL = lgStrSQL & ")"
