...
<SCRIPT LANGUAGE="VBScript"   SRC="site_m3111ma1.vbs"></SCRIPT>
...
Sub GwCheck()
    ...
    strval = frm1.txtPoNo2.value

    Err.Clear

	Call CommonQueryRs(" EXT1_CD ", " M_PUR_ORD_HDR ", " PO_NO = '" & strval & "' AND EXT1_CD = 'Y'", lgF0,lgF1,lgF2,lgF3,lgF4,lgF5,lgF6)
	
	If lgF0 <> "" then
		Call Cfm()
	Else
		Msgbox "그룹웨어 결재가 승인되지 않았습니다.",vbInformation,gLogoNam
		Exit Sub
	End If
End Sub
					...
					<TD CLASS="CLSMTABP">
						<TABLE ID="MyTab" CELLSPACING=0 CELLPADDING=0 onclick="ClickTab1()">
							<TR>
								...
								<td background="../../../CShared/image/table/seltab_up_bg.gif" align="center" CLASS="CLSMTAB"><font color=white>발주일반정보(site)</font></td>
					...
					<TD CLASS="CLSMTABP">
						<TABLE ID="MyTab" CELLSPACING=0 CELLPADDING=0 onclick="ClickTab2()" onMouseOver="vbscript:SetClickflag" onMouseOut="vbscript:ResetClickflag" onFocus="vbscript:SetClickflag" onBlur="vbscript:ResetClickflag">
							<TR>
								...
								<td background="../../../CShared/image/table/tab_up_bg.gif" align="center" CLASS="CLSMTAB"><font color=white>발주무역정보(site)</font></td>
    ...
    <tr HEIGHT="20">
		<td WIDTH="100%">
			<table <%=LR_SPACE_TYPE_30%>>
				<tr>
					<TD WIDTH=10>&nbsp;</TD>
					<td align="Left"><!-- SH케미칼 사이트 스크립트 START -->
					<td align="Left"><a><button name="btnCfmSel" id="btnCfm" class="clsmbtn" ONCLICK="vbscript:Call GwCheck()">확정</button></a>
					<!--<a><button name="btnCfmSel" id="btnCfm" class="clsmbtn" ONCLICK="vbscript:Cfm()">확정</button></a>-->&nbsp;
					<!-- SH케미칼 사이트 스크립트 END -->
