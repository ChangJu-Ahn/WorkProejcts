...
'--------------- 개발자 coding part(실행로직,Start)----------------------------------------------------
	...
	If Len(Trim(Request("gPlant"))) Then
		strVal = strVal & " AND A.PLANT_CD = " & FilterVar(Trim(UCase(Request("gPlant"))), " " , "S") & "  "		
	End If	

	If Len(Trim(Request("gPurGrp"))) Then
		strVal = strVal & " AND A.PUR_GRP = " & FilterVar(Trim(UCase(Request("gPurGrp"))), " " , "S") & "  "		
	End If	

	If Len(Trim(Request("gPurOrg"))) Then
		strVal = strVal & " AND A.PUR_ORG = " & FilterVar(Trim(UCase(Request("gPurOrg"))), " " , "S") & "  "		
	End If	
