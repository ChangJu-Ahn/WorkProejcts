...
Sub SubBizQuery()
	...
	If ConvSPChars(UCase(Trim(E22_m_pur_ord_hdr(M239_E22_ret_flg)))) = "N" Then
   ...
   Set M31119 = Nothing																	'☜: ComProxy UnLoad
	...
	Response.Write "<Script Language=vbscript>"															& vbCr
	Response.Write "With parent.frm1"	
		'##### Rounding Logic #####		
			'항상 거래화폐가 우선																& vbCr
...
'	End If
	...
	'Response.Write "	.txtCurrNm.value			= """ & ConvSPChars(E18_b_currency_currency_desc) 							& """"	& vbCr
	'Response.Write "	.txtXch.value				= """ & UNINumClientFormat(E22_m_pur_ord_hdr(M239_E22_xch_rt),ggExchRate.DecPoint,0) & """"	& vbCr
	'Response.Write "	.txtVatType.Value			= """ & ConvSPChars(E22_m_pur_ord_hdr(M239_E22_vat_type)) 		& """"	& vbCr
	'Response.Write "	.txtVatTypeNm.Value			= """ & ConvSPChars(E2_b_minor_vat_type) 						& """"	& vbCr
	'Response.Write "	.txtVatRt.Text				= """ & UNINumClientFormat(E22_m_pur_ord_hdr(M239_E22_vat_rt),ggExchRate.DecPoint,0) & """"	& vbCr
		
	'Response.Write "	.txtVatAmt.Text             = """ & UNINumClientFormatByTax(E22_m_pur_ord_hdr(M239_E22_tot_vat_doc_amt),lgCurrency,ggAmtOfMoneyNo) & """"	& vbCr

	Response.Write "	.txtNetPoAmt.Text			= """ & UNIConvNumDBToCompanyByCurrency(E22_m_pur_ord_hdr(M239_E22_tot_po_doc_amt),lgCurrency,ggAmtOfMoneyNo,"X" , "X") & """"	& vbCr
	Response.Write "	.txtNetPoLocAmt.Text		= """ & UNINumClientFormat(E22_m_pur_ord_hdr(M239_E22_tot_po_loc_amt),ggAmtOfMoney.DecPoint,0) & """"	& vbCr
	Response.Write "	.txtPoAmt.Text				= """ & UNIConvNumDBToCompanyByCurrency(cdbl(E22_m_pur_ord_hdr(M239_E22_tot_po_doc_amt))+cdbl(E22_m_pur_ord_hdr(M239_E22_tot_vat_doc_amt)),lgCurrency,ggAmtOfMoneyNo,"X" , "X") & """"	& vbCr
	Response.Write "	.txtPoLocAmt.Text			= """ & UNINumClientFormat(cdbl(E22_m_pur_ord_hdr(M239_E22_tot_po_loc_amt))+cdbl(E22_m_pur_ord_hdr(M239_E22_tot_vat_loc_amt)),ggAmtOfMoney.DecPoint,0) & """"	& vbCr

	'Response.Write "	.txtPaytermCd.Value			= """ & ConvSPChars(E22_m_pur_ord_hdr(M239_E22_pay_meth)) 		& """"	& vbCr
	'Response.Write "	.txtPaytermNm.Value			= """ & ConvSPChars(E3_b_minor_pay_meth) 						& """"	& vbCr
	'Response.Write "	.txtReference.Value			= """ & ConvSPChars(E17_b_configuration_reference) 				& """"	& vbCr
	'Response.Write "	.txtPayDur.Text				= """ & UNINumClientFormat(E22_m_pur_ord_hdr(M239_E22_pay_dur),0,0) & """"	& vbCr
	'Response.Write "	.txtPaytermstxt.Value		= """ & ConvSPChars(E22_m_pur_ord_hdr(M239_E22_pay_terms_txt)) 	& """"	& vbCr
	'Response.Write "	.txtPayTypeCd.Value			= """ & ConvSPChars(E22_m_pur_ord_hdr(M239_E22_pay_type)) 		& """"	& vbCr
	'Response.Write "	.txtPayTypeNm.Value			= """ & ConvSPChars(E4_b_minor_pay_type) 						& """"	& vbCr
	...
	'Response.Write ".hdnRcptflg.value			= """ & ConvSPChars(E22_m_pur_ord_hdr(M239_E22_rcpt_flg)) & """" & vbCr
	...
	'Response.Write ".hdnIvflg.value			= """ & ConvSPChars(E22_m_pur_ord_hdr(M239_E22_iv_flg)) & """" & vbCr
	...
	Response.Write "If """ & ConvSPChars(E22_m_pur_ord_hdr(M239_E22_ref_no)) & """ <> """" Then  " & vbCr
	Response.Write "  .txtPoNo1.value	 = """ & ConvSPChars(Trim(E22_m_pur_ord_hdr(M239_E22_ref_no))) & """" & vbCr
	Response.Write "  .chkPoNo.checked	 = True " & vbCr
	Response.Write "Else " & vbCr
	Response.Write "  .txtPoNo1.value	 = """" " & vbCr
	Response.Write "  .chkPoNo.checked	 = False " & vbCr
	Response.Write "End If " & vbCr
		
	' 반품참조시 사용을 위한 숨겨진 필드 채우기 
	Response.Write ".hdnMergPurFlg.value		= """ & ConvSPChars(Trim(E22_m_pur_ord_hdr(M239_E22_merg_pur_flg))) & """" & vbCr
	Response.Write ".txtXch.value			    = """ & UNINumClientFormat(E22_m_pur_ord_hdr(M239_E22_xch_rt),ggExchRate.DecPoint,0) & """" & vbCr
	Response.Write ".txtPayTermCd.value			= """ & ConvSPChars(Trim(E22_m_pur_ord_hdr(M239_E22_pay_meth))) & """" & vbCr
	Response.Write ".txtPayDur.value			= """ & UNINumClientFormat(E22_m_pur_ord_hdr(M239_E22_pay_dur),0,0) & """" & vbCr
	...
	Response.Write ".txtVatrt.value				= """ & UNINumClientFormat(E22_m_pur_ord_hdr(M239_E22_vat_rt),ggExchRate.DecPoint,0) & """" & vbCr
	Response.Write ".txtApplicantCd.value		= """ & ConvSPChars(Trim(E22_m_pur_ord_hdr(M239_E22_applicant))) & """" & vbCr
	Response.Write ".hdvatFlg.value				= """ & ConvSPChars(Trim(E22_m_pur_ord_hdr(M239_E22_vat_inc_flag))) & """" & vbCr
...
Sub SubBizSave()																	'☜: 저장 요청을 받음 
	...
	I4_b_pur_grp									= UCase(Trim(UCase(Request("txtGroupCd"))))
  	I3_b_biz_partner								= UCase(Trim(UCase(Request("txtSupplierCd"))))
  	...
  	I5_m_pur_ord_hdr(M193_I2_po_cur)				= UCase(Trim(UCase(Request("txtCurr"))))
  	
  	I5_m_pur_ord_hdr(M193_I2_vat_type)				= UCase(Trim(Request("txtVatType")))
  	I5_m_pur_ord_hdr(M193_I2_pay_meth)				= Trim(UCase(Request("txtPaytermCd")))
    ...
    I5_m_pur_ord_hdr(M193_I2_pay_terms_txt)					= Trim(Request("txtPayTermstxt"))
    I5_m_pur_ord_hdr(M193_I2_pay_type)						= Trim(Request("txtPayTypeCd"))
	I5_m_pur_ord_hdr(M193_I2_vat_type)						= Trim(Request("txtVatType"))		
	If Trim(Request("txtVatrt")) = "" Then
		I5_m_pur_ord_hdr(M193_I2_vat_rt)                        = "0"
	Else
		I5_m_pur_ord_hdr(M193_I2_vat_rt)                        = UNIConvNum(Request("txtVatrt"),0)
	End If

	I5_m_pur_ord_hdr(M193_I2_vat_inc_flag)					= Trim(Request("hdvatFlg"))		
	' 여기까지 2002.03.22
    
    'I5_m_pur_ord_hdr(M193_I2_import_flg)					= Request("hdnImportflg")
    'I5_m_pur_ord_hdr(M193_I2_bl_flg)						= Request("hdnBlflg")
    'I5_m_pur_ord_hdr(M193_I2_cc_flg)						= Request("hdnCcflg")
    'I5_m_pur_ord_hdr(M193_I2_rcpt_flg)						= Request("hdnRcptflg")
    'I5_m_pur_ord_hdr(M193_I2_subcontra_flg)				= Request("hdnSubcontraflg")
    'I5_m_pur_ord_hdr(M193_I2_ret_flg)						= Request("hdnRetflg")
    'I5_m_pur_ord_hdr(M193_I2_iv_flg) 						= Request("hdnIvflg")
    'I5_m_pur_ord_hdr(M193_I2_rcpt_type)					= Trim(Request("hdnRcptType"))
    'I5_m_pur_ord_hdr(M193_I2_issue_type)					= Trim(Request("hdnIssueType"))
    'I5_m_pur_ord_hdr(M193_I2_iv_type)						= Trim(Request("hdnIvType"))
    
    I5_m_pur_ord_hdr(M193_I2_release_flg)			= "N"
    'I5_m_pur_ord_hdr(M193_I2_cls_flg) 						= "N"
    'I5_m_pur_ord_hdr(ImpMPurOrdHdrPoPrcFlg)					= "F"
    'I5_m_pur_ord_hdr(M193_I2_charge_flg) 					= "N"
    I5_m_pur_ord_hdr(M193_I2_ref_no)		= Trim(Request("txtPoNo1")) '반품시 발주참조번호   
...
Sub SubReleaseCheck()
	...
	txtSpread = txtSpread & "1" & gColSep & gRowSep
...
Sub SubLookUpPoType()
	...
	iStrPoTypeCd = Trim(Request("txtPoTypeCd"))
	...
	If E1_m_config_process(M369_E1_ret_flg) = "N" Then
	...
	Response.Write "	.hdnpotype.value        = """ & ConvSPChars(Trim(Request("txtPoTypeCd"))) & """" & vbCr  'park.j.k
...
'    End If
	...
	Set B1H019 = Nothing 		
		...
		Response.Write ".txtCurr.Value				= """ & ConvSPChars(Trim(E1_b_biz_partner(S074_E1_currency))) & """" & vbCr
		Response.Write ".txtSuppSalePrsn.Value		= """ & ConvSPChars(Trim(E1_b_biz_partner(S074_E1_bp_prsn_nm))) & """" & vbCr
		'Response.Write ".txtTransCd.Value			= """ & ConvSPChars(E1_b_biz_partner(S074_E1_trans_meth)) & """" & vbCr
		'Response.Write ".txtTransNm.Value			= """ & ConvSPChars(E1_b_biz_partner(S074_E1_trans_meth_nm)) & """" & vbCr	'구매그룹 추가 
		If Trim(Request("lgPGCd")) = "" Then
		...
		Response.Write ".txtPayDur.Value			= """ & UNINumClientFormat(E1_b_biz_partner(S074_E1_pay_dur),0 ,0) & """" & vbCr 
		...
		Response.Write ".txtVatrt.value				= """ & UNINumClientFormat(E1_b_biz_partner(S074_E1_vat_rate),ggExchRate.DecPoint,0) & """" & vbCr
		Response.write ".hdvatFlg.value				= """ & ConvSPChars(Trim(E1_b_biz_partner(S074_E1_vat_inc_flag))) & """" & vbCr
...
Sub afterPORef()
   ...
   Set M31119 = Nothing																	'☜: ComProxy UnLoad
	...
	Response.Write "With parent.frm1"	
		'##### Rounding Logic #####		
			'항상 거래화폐가 우선																& vbCr
	Response.Write "	.txtCurr.value	= """ & ConvSPChars(E22_m_pur_ord_hdr(M239_E22_po_cur))	& """" 	& vbCr
	Response.Write "	parent.CurFormatNumericOCX	" 													& vbCr
	
	Response.Write "	.rdoRelease(0).Checked = true" & vbCr
	Response.Write " .txtPoNo.value	= """" " & vbCr
	Response.Write " .txtPoNo2.value = """" " & vbCr
	...
	Response.Write "	.txtNetPoAmt.Text			= 0"	& vbCr
	Response.Write "	.txtNetPoLocAmt.Text		= 0"	& vbCr
	Response.Write "	.txtPoAmt.Text				= 0 "	& vbCr
	Response.Write "	.txtPoLocAmt.Text			= 0 "	& vbCr
	...
	Response.Write "parent.DbQueryOk1	"    & vbCr									'☜: 조화가 성공 
	Response.Write "End With"
	Response.Write "</Script>" & vbCr
