...
<SCRIPT LANGUAGE="VBScript"   SRC="m3111oa2.vbs"></SCRIPT>
					...
					<TD>
						<TABLE ID="MyTab" CELLSPACING=0 CELLPADDING=0>
							<TR>
								...
								<td background="../../../CShared/image/table/seltab_up_bg.gif" align="center" CLASS="CLSMTAB"><font color=white>발주서발행</font></td>
	    		...
	    		<TR>
					<TD WIDTH=100%>
						<TABLE <%=LR_SPACE_TYPE_60%>>
							<TR>
								<TD CLASS="TD5" NOWRAP>발주서형태</TD>
								<TD CLASS="TD6" NOWRAP><INPUT TYPE=radio Class="Radio" ALT="발주서형태" NAME="rdoPoflg" id = "rdoPoflg1" Value="Y" checked  tag="12"><label for="rdoPoflg1">&nbsp;OFFER SHEET&nbsp;</label>
													   <INPUT TYPE=radio Class="Radio" ALT="발주서형태" NAME="rdoPoflg" id = "rdoPoflg2" Value="N" tag="12"><label for="rdoPoflg2">&nbsp;발주서&nbsp;</label>
								</TD>									
							</TR>
							<TR>
							...
							<TR>
								...
								<TD CLASS="TD6" NOWRAP>
									<table cellspacing=0 cellpadding=0>
										<tr>
											<td>
												<script language =javascript src='./js/m3111oa2_fpDateTime1_txtFrDt.js'></script>
											</td>
											<td>~</td>
											<td>
												<script language =javascript src='./js/m3111oa2_fpDateTime2_txtToDt.js'></script>
											</td>
										<tr>
									</table>
								</TD>
