...
Sub MakeSpreadSheetData()
	...
	Const m_pr_quota_by_sppl_sppl_cd		= 0
	Const b_biz_partner_bp_nm				= 1
	Const m_pr_quota_by_sppl_quota_rate		= 2
	Const m_pr_quota_by_sppl_apportion_qty	= 3
	Const m_pr_quota_by_sppl_pur_plan_dt	= 4
	Const m_pr_quota_by_sppl_pur_grp		= 5
	Const b_pur_grp_pur_grp_nm    			= 6
   ...
   Do while Not (rs0.EOF Or rs0.BOF)
        ...
        iRowStr = ""
        iRowStr = iRowStr & Chr(11) & ConvSPChars(rs0(m_pr_quota_by_sppl_sppl_cd))	    '1 공급처 
        iRowStr = iRowStr & Chr(11) & ""                                                '2 공급처 팝업 
        iRowStr = iRowStr & Chr(11) & ConvSPChars(rs0(b_biz_partner_bp_nm))				'3 공급처명 
        iRowStr = iRowStr & Chr(11) & UNINumClientFormat(rs0(m_pr_quota_by_sppl_quota_rate),ggExchRate.DecPoint,0)	'4 배분비율 
        iRowStr = iRowStr & Chr(11) & UNINumClientFormat(rs0(m_pr_quota_by_sppl_apportion_qty),ggQty.DecPoint,0)		'5 배부량 
        iRowStr = iRowStr & Chr(11) & UNIDateClientFormat(rs0(m_pr_quota_by_sppl_pur_plan_dt))						'6 발주예정일 
        iRowStr = iRowStr & Chr(11) & ConvSPChars(rs0(m_pr_quota_by_sppl_pur_grp))		                        '10 구매그룹 
        iRowStr = iRowStr & Chr(11) & ""												'11 구매그룹팝업 
        iRowStr = iRowStr & Chr(11) & ConvSPChars(rs0(b_pur_grp_pur_grp_nm))		                        '12 구매그룹명 
