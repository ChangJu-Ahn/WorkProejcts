					...
					<TD CLASS="CLSMTABP">
						<TABLE ID="MyTab" CELLSPACING=0 CELLPADDING=0>
							<TR>
								...
								<td background="../../../CShared/image/table/seltab_up_bg.gif" align="center" CLASS="CLSMTAB"><font color=white>발주내역(site)</font></td>
						...
						<TABLE <%=LR_SPACE_TYPE_60%>>
							...
							<TR>
								<TD HEIGHT=100% WIDTH=100% COLSPAN=4>
									<script language =javascript src='./js/m3112ma1_I515398806_vspdData.js'></script>
								</TD>
							</TR>
						</TABLE>
			...
			<table <%=LR_SPACE_TYPE_30%>>
				<tr>
					...
					<td align="Left"><!-- SH케미칼 사이트 스크립트 START -->
						<a><button name="btnCfmSel" id="btnCfm" class="clsmbtn" ONCLICK="vbscript:Call GwCheck()">확정</button></a>
