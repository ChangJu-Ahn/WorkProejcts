...
'**********************************************************************************************************
Const BIZ_PGM_ID 		= "m3111pb1_ko441.asp"                              '☆: Biz Logic ASP Name
...
Function DbQuery() 
    ...
    With frm1
		If lgIntFlgMode = PopupParent.OPMD_UMODE Then
		    ...
		    strVal = strVal & "&hdnSTOFlg=" & Trim(.hdnSTOFlg.value) 'STO Flag추가 
					...
					<TR>	
						...
						<TD CLASS="TD6" NOWRAP>
							<table cellspacing=0 cellpadding=0>
								<tr>
									<td>
										<script language =javascript src='./js/m3111pa1_fpDateTime1_txtFrPoDt.js'></script>
									</td>
									<td>~</td>
									<td>
										<script language =javascript src='./js/m3111pa1_fpDateTime1_txtToPoDt.js'></script>
									</td>
								<tr>
							</table>
						</TD>
			...
			<TABLE <%=LR_SPACE_TYPE_20%>>
				<TR>
					<TD HEIGHT=100% WIDTH=100% COLSPAN=4>
						<script language =javascript src='./js/m3111pa1_vaSpread1_vspdData.js'></script>
					</TD>		
				</TR>
			</TABLE>
		</TD>
...
<INPUT TYPE=HIDDEN NAME="hdnSTOFlg" TAG="24">
</FORM>
