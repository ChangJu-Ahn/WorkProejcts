...
Sub lookupPriceForSelection()
   ...
   If CheckSYSTEMError(Err,True) = true Then 		
    ...
    For iLngRow = 1 To iLngMaxRow
		...
		returnValue(iLngRow) =UNIConvNumDBToCompanyByCurrency(E1_m_supplier_item_price(M106_E1_pur_prc), ConvSPChars(I1_m_supplier_item_price(M106_I1_pur_cur)), ggUnitCostNo,"X","X")
	...
	Response.Write " Parent.frm1.vspdData.Text = """ & UNIConvNumDBToCompanyByCurrency(returnValue(resultindex), ConvSPChars(I1_m_supplier_item_price(M106_I1_pur_cur)), ggUnitCostNo,"X","X") & """" & vbCr
