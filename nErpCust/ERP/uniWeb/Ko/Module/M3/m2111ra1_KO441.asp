...
Const BIZ_PGM_ID 		= "m2111rb1_ko441.asp"                              '☆: Biz Logic ASP Name
...
'========================================================================================================
Sub InitSpreadSheet()
	Call SetZAdoSpreadSheet("M2111RA1_1","S","A","V20030303",PopupParent.C_SORT_DBAGENT,frm1.vspdData, C_MaxKey, "X","X")
	Call SetSpreadLock 
End Sub
					...
					<TR>
						...
						<TD CLASS="TD6" NOWRAP>
							<table cellpadding=0 cellspacing=0>
								<tr>
									<td NOWRAP>
										<script language =javascript src='./js/m2111ra1_fpDateTime1_txtFrPoDt.js'></script>
									</td>
									<td NOWRAP>~</td>
									<td NOWRAP>
									   <script language =javascript src='./js/m2111ra1_fpDateTime1_txtToPoDt.js'></script>
									</td>
								</tr>
							</table>
						</TD>
						...
						<TD CLASS="TD6" NOWRAP>
							<table cellspacing=0 cellpadding=0>
								<tr>
									<td NOWRAP>
										<script language =javascript src='./js/m2111ra1_fpDateTime2_txtFrDlvyDt.js'></script>
									</td>
									<td NOWRAP>~</td>
									<td NOWRAP>
										<script language =javascript src='./js/m2111ra1_fpDateTime2_txtToDlvyDt.js'></script>
									</td>
								<tr>
							</table>
						</TD>						
	...
	<TR>
		<TD WIDTH=100% HEIGHT=* valign=top>
			<TABLE <%=LR_SPACE_TYPE_20%>>
				<TR>
					<TD HEIGHT="100%">
						<script language =javascript src='./js/m2111ra1_vaSpread1_vspdData.js'></script>
					</TD>
				</TR>
			</TABLE>
		</TD>
