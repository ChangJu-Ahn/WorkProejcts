...
Sub FixUNISQLData()
	...
	Select Case strFlag
		Case "N"
			...
			UNISqlId(0) = "Q3511QA101"
		Case "I"
			Redim UNIValue(0,5)    
			UNISqlId(0) = "Q3511QA102"
		Case "B"
			Redim UNIValue(0,5)    
			UNISqlId(0) = "Q3511QA103"
		Case "A"
			Redim UNIValue(0,6)    
			UNISqlId(0) = "Q3511QA104"
	End Select
	'--------------- 개발자 coding part(실행로직,End)------------------------------------------------------
