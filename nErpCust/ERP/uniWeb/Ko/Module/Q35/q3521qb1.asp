...
Sub FixUNISQLData()
	...
	Select Case strFlag
		Case "N"
			...
			UNISqlId(0) = "Q3521QA101"
		Case "I"
			Redim UNIValue(0,5)    
			UNISqlId(0) = "Q3521QA102"
		Case "B"
			Redim UNIValue(0,5)    
			UNISqlId(0) = "Q3521QA103"
		Case "IB"
			Redim UNIValue(0,6)    
			UNISqlId(0) = "Q3521QA104"
		Case "IS"
			Redim UNIValue(0,6)    
			UNISqlId(0) = "Q3521QA105"
		Case "A"
			Redim UNIValue(0,7)             
			UNISqlId(0) = "Q3521QA106"
	End Select
