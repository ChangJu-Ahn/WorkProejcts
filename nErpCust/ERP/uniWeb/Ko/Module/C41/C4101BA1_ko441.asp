...
'=======================================================================================================
'@PGM_ID
Const BIZ_PGM_QRY_ID = "c4101bb9_ko441.asp"					'조회 비지니스 로직 ASP명 
...
Sub InitSpreadSheet()
	...
	With frm1.vspdData
		...
		.MaxCols = C_ErrorCntPop + 1			'☜: 최대 Columns의 항상 1개 증가시킴 
	   ...
	   .ReDraw = false
		...
		ggoSpread.SSSetFloat    C_ErrCnt,      "전체ERROR COUNT",   12,Parent.ggAmtOfMoneyNo,ggStrIntegeralPart, ggStrDeciPointPart,Parent.gComNum1000,Parent.gComNumDec
		ggoSpread.SSSetButton  C_ErrPop

		'경고,오류 건수 항목 추가...2009.10.12...kbs
		ggoSpread.SSSetFloat    C_WarningCnt,    "경고건수",   8,Parent.ggAmtOfMoneyNo,ggStrIntegeralPart, ggStrDeciPointPart,Parent.gComNum1000,Parent.gComNumDec
		ggoSpread.SSSetButton  C_WarningCntPop
		ggoSpread.SSSetFloat    C_ErrorCnt,      "오류건수",   8,Parent.ggAmtOfMoneyNo,ggStrIntegeralPart, ggStrDeciPointPart,Parent.gComNum1000,Parent.gComNumDec
		ggoSpread.SSSetButton  C_ErrorCntPop
...
Sub SetSpreadColor(ByVal pvStartRow, ByVal pvEndRow)
	...
	With frm1
		...
		'경고,오류 건수 항목 추가...2009.10.12...kbs
		ggoSpread.SSSetProtected C_WarningCnt, pvStartRow, pvEndRow
		ggoSpread.SSSetProtected C_ErrorCnt, pvStartRow, pvEndRow
...
Sub GetSpreadColumnPos(ByVal pvSpdNo)
    ...
    Select Case UCase(pvSpdNo)
       Case "A"
			...
			'경고,오류 건수 항목 추가...2009.10.12...kbs
			C_WarningCnt			= iCurColumnPos(9)
			C_WarningCntPop 		= iCurColumnPos(10)
			C_ErrorCnt			= iCurColumnPos(11)
			C_ErrorCntPop   		= iCurColumnPos(12)
...
'            End If
	...
	'경고,오류 건수 항목 추가...2009.10.12...kbs
        Case C_WarningCntPop
'            frm1.vspdData.Col = C_WarningCnt
'            If CInt(frm1.vspdData.Text) > 0 Then
		Call ExtractDateFrom(frm1.txtYyyyMm.Text,frm1.txtYyyyMm.UserDefinedFormat,Parent.gComDateType,strYear,strMonth,strDay)
		...
		strYYYYMM = strYear & strMonth	
                ...
                work_step = frm1.vspdData.Text
                'frm1.vspdData.Col = C_YYYYMM
                Call OpenErr1(strYYYYMM,work_step)

'            End If

        Case C_ErrorCntPop
'            frm1.vspdData.Col = C_ErrorCnt
'            If CInt(frm1.vspdData.Text) > 0 Then
		Call ExtractDateFrom(frm1.txtYyyyMm.Text,frm1.txtYyyyMm.UserDefinedFormat,Parent.gComDateType,strYear,strMonth,strDay)
		...
		strYYYYMM = strYear & strMonth	
                ...
                work_step = frm1.vspdData.Text
                'frm1.vspdData.Col = C_YYYYMM
                Call OpenErr2(strYYYYMM,work_step)
...
'경고,오류 건수 항목 추가...2009.10.12...kbs
Function OpenErr1(yyyymm, work_step)
	Dim arrRet
	Dim arrParam(5), arrField(6), arrHeader(6)
	...
	arrParam(3) = "" 		            	<%' Name Cindition%>
	arrParam(4) = " YYYYMM = " & FilterVar(yyyymm, "''", "S") & " AND work_step = " & FilterVar(work_step, "''", "S")                       <%' Where Condition%>
	arrParam(4) = arrParam(4) & " and substring(msg_text,2,2) = 'Wa' "
...
'경고,오류 건수 항목 추가...2009.10.12...kbs
Function OpenErr2(yyyymm, work_step)
	Dim arrRet
	Dim arrParam(5), arrField(6), arrHeader(6)
