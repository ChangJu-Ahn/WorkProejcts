...
'========================================================================================================
Const BIZ_PGM_ID = "C4105MB1.asp"                                      'Biz Logic ASP 
'========================================================================================================
...
Sub GetSpreadColumnPos(ByVal pvSpdNo)
    ...
    Select Case UCase(pvSpdNo)
       Case "A"
			...
			C_ItemSpec		    = iCurColumnPos(6)
			C_RcptPrc			= iCurColumnPos(7)
			C_TotAvgPrc		    = iCurColumnPos(8)
			C_StockStdPrc		= iCurColumnPos(9)
    End Select    
End Sub
						...
						<FIELDSET CLASS="CLSFLD">
							<TABLE <%=LR_SPACE_TYPE_40%>>
								<TR>
									...
									<TD CLASS="TD6"><SCRIPT LANGUAGE=JavaScript> ExternalWrite('<OBJECT CLASSID=<%=gCLSIDFPDT%> NAME="txtYyyymm" CLASS=FPDTYYYYMM tag="12X1" Title="FPDATETIME" ALT=작업년월 id=fpDateTime1> </OBJECT>');</SCRIPT></TD>
