...
Sub SubBizSaveMulti()
    ...
    Set iPC4G020S = Server.CreateObject("PC4G020.cCRefltOfValSvr")
    ...
    Call iPC4G020S.C_REFLECTION_OF_VALUATION_SVR(gStrGloBalCollection,importArray1)		
