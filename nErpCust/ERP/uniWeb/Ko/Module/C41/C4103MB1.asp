...
Sub SubBizQueryMulti()
   ...
   lgMaxCount = CInt(C_SHEETMAXROWS_D)                     '☜: Max fetched data at a time    
	...
	Set iPC4G020Q = Server.CreateObject("PC4G020.cClistCItmByPlantSvr")
	...
	Call iPC4G020Q.C_LIST_C_ITEM_BY_PLANT_SVR(gStrGloBalCollection, lgMaxCount, importArray1,exportData2,exportGroupData,importArray2)
	
	
	
    If CheckSYSTEMError(Err, True) = True Then					
       Call SetErrorStatus
       Set iPC4G020Q = Nothing
       Exit Sub
    End If    
