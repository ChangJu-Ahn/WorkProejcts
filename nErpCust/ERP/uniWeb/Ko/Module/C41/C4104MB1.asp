...
Sub SubBizQueryMulti()
	...
	Set iPC4G021Q = Server.CreateObject("PC4G021.cCListCRcDifSvr")

    If CheckSYSTEMError(Err, True) = True Then
		Exit Sub
    End If    
	
	Call iPC4G021Q.C_LIST_C_RCPT_DIFF_SVR(gStrGloBalCollection, lgMaxCount, importArray1, exportGroupData,exportData2,importArray2)
	
    
    If CheckSYSTEMError(Err, True) = True Then					
         Set iPC4G021Q = Nothing
       Exit Sub
...
Sub ExeReflect()
    ...
    Set iPC4G021S = Server.CreateObject("PC4G021.cCRefltOfRcDifSvr")
    ...
    Call iPC4G021S.C_REFLECTION_OF_RCPT_DIFF_SVR(gStrGloBalCollection,importArray1)		
		
    If CheckSYSTEMError(Err, True) = True Then					
       Call SetErrorStatus
       Set iPC4G021S = Nothing
       Exit Sub
    End If    
...
Sub ExeCancel()
    ...
    Set iPC4G021S = Server.CreateObject("PC4G021.cCCnclRefltRcDifSvr")
    ...
    Call iPC4G021S.C_CANCEL_OF_REFLT_RCPT_DIFF_SVR(gStrGloBalCollection,importArray1)		
