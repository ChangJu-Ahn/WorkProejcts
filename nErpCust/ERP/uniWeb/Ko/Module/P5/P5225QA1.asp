...
======================================================================================================
*  1. Module Name          : P5
*  2. Function Name        : 설비점검내역조회(HB)
*  3. Program ID           : XP009OA_KO321
*  4. Program Name         : 설비점검내역조회(HB)
*  5. Program Desc         : 
*  6. Comproxy List        :
...
'========================================================================================================
Const BIZ_PGM_ID       = "P5225QB1.ASP"						           '☆: Biz Logic ASP Name
...
Sub GetSpreadColumnPos(ByVal pvSpdNo)
    ...
    Select Case UCase(pvSpdNo)
       Case "A"
			...
			C_INSP_HOUR				= iCurColumnPos(6)
			C_INSP_MIN				= iCurColumnPos(7)
			C_INSP_DEPT				= iCurColumnPos(8)	
					...
					<TD CLASS="CLSMTABP">
						<TABLE ID="MyTab" CELLSPACING=0 CELLPADDING=0>
							<TR>
								...
								<td background="../../../CShared/image/table/seltab_up_bg.gif" align="center" CLASS="CLSMTAB"><font color=white>설비점검내역조회</font></td>
