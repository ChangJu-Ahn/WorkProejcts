...
'		iRowStr	=	iRowStr	&	Chr(11)	&	UNINumClientFormatByCurrency(rs0("PRICE"), tmpCur, ggUnitCostNo)
		iRowStr	=	iRowStr	&	Chr(11)	&	UNINumClientFormat(rs0("PRICE"), ggUnitCost.DecPoint  , 0)
'		iRowStr	=	iRowStr	&	Chr(11)	&	rs0("PRICE")
...
Sub	SubBizSaveMulti()
	...
	Dim	pPY5G225		'구	pS13111
	Dim	iErrorPosition

	On Error Resume	Next																																 '☜:	Protect	system from	crashing
	Err.Clear																			 '☜:	Clear	Error	status

	Set	pPY5G225 = Server.CreateObject("PY5G225.CsF_Cast_PlanMultiSvr")
	...
	Call pPY5G225.PY5_MAINT_Y_FAC_CAST_MULTI_SVR(gStrGlobalCollection, trim(reqtxtSpread), iErrorPosition)

	If CheckSYSTEMError2(Err,	True,	iErrorPosition & "행","","","","") = True	Then
		 Set pPY5G225	=	Nothing
		 Exit	Sub
	End	If
