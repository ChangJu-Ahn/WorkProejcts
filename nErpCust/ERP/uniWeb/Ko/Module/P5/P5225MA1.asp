...
Const	BIZ_PGM_ID = "P5225mb1.asp"																			 'Biz	Logic	ASP
...
'========================================================================================================
'	Name : InitComboBox()
'	Desc : Set ComboBox for spreadsheet2
'========================================================================================================
Sub	InitComboBox2()
		Dim	iCodeArr
		Dim	iNameArr
...
Sub	InitSpreadSheet(ByVal	pvSpdNo)
	...
	If pvSpdNo = ""	OR pvSpdNo = "A" Then
		...
		With frm1.vspdData
				...
				ggoSpread.SSSetEdit		C_Insp_Text,			"점검/수리내용",			15,0,,40
	...
	End	if
		...
		With frm1.vspdData1
			...
			ggoSpread.SSSetFloat	C_Price,			"단가",			15,	Parent.ggQtyNo			, ggStrIntegeralPart, ggStrDeciPointPart,Parent.gComNum1000,Parent.gComNumDec,,,,"0"
...
Sub	SetSpreadLock1()
	...
	With frm1.vspdData1
				...
				.ReDraw	=	False
						...
						ggoSpread.SpreadLock C_Sury_Amt				,	-1, C_Sury_Amt
...
Sub	SetSpreadColor1(ByVal	pvStartRow,ByVal pvEndRow)
	...
	With frm1.vspdData1
			...
			ggoSpread.SSSetProtected	C_Sury_Amt			,	pvStartRow,	pvEndRow
...
Sub	GetSpreadColumnPos(ByVal pvSpdNo)
		...
		Select Case	UCase(pvSpdNo)
			 Case	"A"
				...
				C_Facility_Accnt_Nm	=	iCurColumnPos(5)
					...
					<TD	CLASS="CLSMTABP">
						<TABLE ID="MyTab"	CELLSPACING=0	CELLPADDING=0>
							<TR>
								...
								<td	background="../../../CShared/image/table/seltab_up_bg.gif" align="center"	CLASS="CLSMTABP"><font color=white>설비점검내역등록</font></td>
						...
						<FIELDSET	CLASS="CLSFLD">
							<TABLE <%=LR_SPACE_TYPE_40%>>
								<TR>
									...
									<TD	CLASS="TD6"	NOWRAP><script language =javascript src='./js/p5225ma1_txtWork_Dt_txtWork_Dt.js'></script></TD>
						...
						<TABLE <%=LR_SPACE_TYPE_20%>>
							<TR	HEIGHT="60%">
								<TD	WIDTH="100%" colspan=4>
									<script language =javascript src='./js/p5225ma1_vaSpread_vspdData.js'></script>
								</TD>
							</TR>
							<TR	HEIGHT="20%">
								<TD	WIDTH="100%" colspan=4>
									<script language =javascript src='./js/p5225ma1_vaSpread1_vspdData1.js'></script>
								</TD>
							</TR>
							<TR	HEIGHT="20%">
								<TD	WIDTH="100%" colspan=4>
									<script language =javascript src='./js/p5225ma1_vaSpread2_vspdData2.js'></script>
								</TD>
							</TR>
						</Table>
					</TD>
