...
Sub	InitSpreadSheet()
	...
	With frm1.vspdData
		...
		ggoSpread.SSSetEdit	C_Mvmt_No, "입고번호", 16,,,,2
		ggoSpread.SSSetEdit	C_Plant_Cd,	"공장",	8,,,,2
		ggoSpread.SSSetEdit	C_Plant_Nm,	"공장명",	15
		ggoSpread.SSSetEdit	C_Sl_Cd, "창고", 7
		ggoSpread.SSSetEdit	C_Sl_Nm, "창고명", 30
		ggoSpread.SSSetEdit	C_Item_Cd, "품목", 18,,,,2
		ggoSpread.SSSetEdit	C_Item_Nm, "품목명", 30
		ggoSpread.SSSetEdit	C_Bp_Cd, "거래처", 18
		ggoSpread.SSSetEdit	C_Bp_Nm, "거래처명", 28
		ggoSpread.SSSetEdit	C_BaseUnit,	"단위",	8
		ggoSpread.SSSetFloat C_Qty,	"수량",	8,Parent.ggQtyNo ,ggStrIntegeralPart,	ggStrDeciPointPart,Parent.gComNum1000,Parent.gComNumDec
...
Sub	SetSpreadLock()
		...
		ggoSpread.SpreadLock		C_Mvmt_No,				-1,	C_Amount				,-1
...
Sub	GetSpreadColumnPos(ByVal pvSpdNo)
		...
		Case "A"
			...
			C_Mvmt_No			=	iCurColumnPos(1	)
			C_Plant_Cd		=	iCurColumnPos(2	)
			C_Plant_Nm		=	iCurColumnPos(3	)
...
Function ChkKeyField()
	...
	If Trim(frm1.txtItemCd.value) <> "" Then
		strWhere = "	B_Item.phantom_flg = 'N' and  item_Cd =  " & FilterVar(frm1.txtItemCd.value, "''", "S") & "  "
					...
					<TD	CLASS="CLSMTABP">
						<TABLE ID="MyTab"	CELLSPACING=0	CELLPADDING=0>
							<TR>
								...
								<td	background="../../../CShared/image/table/seltab_up_bg.gif" align="center"	CLASS="CLSMTAB"><font	color=white>설비부품입고현황</font></td>
		...
		<TD	WIDTH=100% CLASS="Tab11">
			<TABLE <%=LR_SPACE_TYPE_20%>>
			 					...
			 					<TR>
									...
									<TD	CLASS="TD6">
										<table cellspacing=0 cellpadding=0>
											<tr>
												<td>
													<script language =javascript src='./js/p5235ma1_OBJECT1_txtAppFrDt.js'></script>
												</td>
												<td>&nbsp;~&nbsp;</td>
												<td>
													<script language =javascript src='./js/p5235ma1_OBJECT2_txtAppToDt.js'></script>
												</td>
											<tr>
										</table>
									</TD>
				...
				<TD	WIDTH=100% valign=top><TABLE <%=LR_SPACE_TYPE_20%>>
					<TR>
						<TD	HEIGHT="100%">
								<script language =javascript src='./js/p5235ma1_OBJECT3_vspdData.js'></script>
						</TD>
					</TR></TABLE>
				</TD>
			</TR>
