			...
			<FIELDSET CLASS="CLSFLD">
				<TABLE <%=LR_SPACE_TYPE_40%>>
					<TR>
						...
						<TD CLASS=TD6 NOWRAP>
							<INPUT TYPE="Text" NAME="txtfrtempglNo" SIZE=10 MAXLENGTH=20 tag="1XXXXU" ALT="시작선급금번호">&nbsp;~
							<INPUT TYPE="Text" NAME="txttotempglNo" SIZE=10 MAXLENGTH=20 tag="1XXXXU" ALT="종료선급금번호">
						</TD>
					</TR>
					<TR>				
