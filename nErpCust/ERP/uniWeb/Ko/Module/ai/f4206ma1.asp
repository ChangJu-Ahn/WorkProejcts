...
'*  3. Program ID           : f4206ma1
'*  4. Program Name         : 거래처기초차입금등록 
...
'==========================================  1.2.1 Global 상수 선언  ======================================
'==========================================================================================================
Const BIZ_PGM_ID = "f4206mb1.asp"			 '☆: 비지니스 로직 ASP명 
Const BIZ_PGM_ID2 = "f4206mb2.asp"
...
'	If frm1.txtDocCur.value <> gCurrency Then
'		frm1.txtXchRate.Text = "0"
'	ElseIf frm1.txtDocCur.value = gCurrency Then
'		frm1.txtXchRate.Text = "1"
'	End If  
End Sub
					...
					<TD CLASS="CLSMTABP">
						<TABLE ID="MyTab" CELLSPACING=0 CELLPADDING=0>
							<TR>
								...
								<td background="../../../CShared/image/table/seltab_up_bg.gif" align="center" CLASS="CLSMTAB"><font color=white>거래처기초차입금등록</font></td>
					...
					<TD WIDTH=100% HEIGHT=* VALIGN=TOP>
							<TABLE <%=LR_SPACE_TYPE_60%>>
								...
								<TR>
									...
									<TD CLASS="TD6" NOWRAP><script language =javascript src='./js/f4206ma1_fpLoanDt_txtLoanDt.js'></script></TD>
									<TD CLASS="TD5" NOWRAP>기초등록일</TD>
									<TD CLASS="TD6" NOWRAP><script language =javascript src='./js/f4206ma1_fpBasicLoanDt_txtBasicLoanDt.js'></script></TD>
								</TR>
								<TR>
								...
								<TR>
									...
									<TD CLASS="TD6" NOWRAP><INPUT CLASS="clstxt" TYPE=TEXT NAME="txtBpCd" SIZE="10" MAXLENGTH=10 STYLE="TEXT-ALIGN: Left" tag="22X" ALT="차입거래처"><IMG SRC="../../../CShared/image/btnPopup.gif" NAME="btnBankLoanCd" align=top TYPE="BUTTON"ONCLICK="vbscript:Call OpenBp(frm1.txtBpCd.value, 5)">
								...
								<TR>
								    ...
								    <TD CLASS="TD6" NOWRAP><INPUT NAME="txtDocCur" ALT="거래통화" SIZE = "10" MAXLENGTH="3"  tag="22XXXU"><IMG SRC="../../../CShared/image/btnPopup.gif" NAME="btnDocCurCd" align=top TYPE="BUTTON" ONCLICK="vbscript:Call OpenPopUp(frm1.txtDocCur.value, 0)">&nbsp;
															<script language =javascript src='./js/f4206ma1_OBJECT5_txtXchRate.js'></script></TD>
									<TD CLASS="TD5" NOWRAP>차입금액|자국</TD>
									<TD CLASS="TD6" NOWRAP><script language =javascript src='./js/f4206ma1_fpLoanAmt_txtLoanAmt.js'></script>&nbsp;
														   <script language =javascript src='./js/f4206ma1_fpLoanLocAmt_txtLoanLocAmt.js'></script></TD>									
								</TR>	
								<TR>
									<TD CLASS="TD5" NOWRAP>이자지급기초액|자국</TD>
									<TD CLASS="TD6" NOWRAP><script language =javascript src='./js/f4206ma1_fpBasIntPayAmt_txtBasIntPayAmt.js'></script>&nbsp;
														   <script language =javascript src='./js/f4206ma1_fpBasIntPayLocAmt_txtBasIntPayLocAmt.js'></script></TD>
									<TD CLASS="TD5" NOWRAP>원금상환기초액|자국</TD>
									<TD CLASS="TD6" NOWRAP><script language =javascript src='./js/f4206ma1_fpBasRdpAmt_txtBasRdpAmt.js'></script>&nbsp;
														   <script language =javascript src='./js/f4206ma1_fpBasRdpLocAmt_txtBasRdpLocAmt.js'></script></TD>									
								</TR>
							...
							<TR>
								...
								<TR>
									...
									<TD CLASS="TD6" NOWRAP><script language =javascript src='./js/f4206ma1_fp1StPrRdpDt_txt1StPrRdpDt.js'></script></TD>
								</TR>
								<TR>
									<TD CLASS="TD5" NOWRAP>원금상환주기</TD>
									<TD CLASS="TD6" NOWRAP><script language =javascript src='./js/f4206ma1_fpPrRdpPerd_txtPrRdpPerd.js'></script>개월</TD>
									<TD CLASS="TD5" NOWRAP>상환만기일</TD>
									<TD CLASS="TD6" NOWRAP><script language =javascript src='./js/f4206ma1_fpDueDt_txtDueDt.js'></script></TD>
								</TR>								
								<TR>
								</TR>
								<TR>
									...
									<TD CLASS="TD6" NOWRAP><script language =javascript src='./js/f4206ma1_OBJECT5_txtIntRate.js'></script>&nbsp;%&nbsp;/&nbsp;년</TD>
								</TR>								
								<TR>
								...
								<TR>
								    ...
								    <TD CLASS="TD6" NOWRAP><script language =javascript src='./js/f4206ma1_fpIntPayPerd_txtIntPayPerd.js'></script>&nbsp;/&nbsp;<SELECT NAME="cboIntBaseMthd" ALT="이자계산방법" STYLE="WIDTH: 135px" tag="22X" OnClick ="vbscript:Type_itemChange()"><OPTION VALUE=""></OPTION></SELECT></TD>
								    <TD CLASS="TD5" NOWRAP>최초이자지급일</TD>
									<TD CLASS="TD6" NOWRAP><script language =javascript src='./js/f4206ma1_fp1StIntDueDT_txt1StIntDueDT.js'></script></TD>								    
								</TR>								
								<TR>
								...
								<TR>	
									...
									<TD CLASS="TD6" NOWRAP><script language =javascript src='./js/f4206ma1_fpPrRdpAmt_txtRdpAmt.js'></script>&nbsp;
														   <script language =javascript src='./js/f4206ma1_fpPrRdpLocAmt_txtRdpLocAmt.js'></script></TD>									
									<TD CLASS="TD5" NOWRAP>이자지급총액|자국</TD>
									<TD CLASS="TD6" NOWRAP><script language =javascript src='./js/f4206ma1_fpIntPayAmt_txtIntPayAmt.js'></script>&nbsp;
														   <script language =javascript src='./js/f4206ma1_fpIntPayLocAmt_txtIntPayLocAmt.js'></script></TD>																				
								</TR>								
								<TR>									
									<TD CLASS="TD5" NOWRAP>차입잔액|자국</TD>
									<TD CLASS="TD6" NOWRAP><script language =javascript src='./js/f4206ma1_fpLoanBalAmt_txtLoanBalAmt.js'></script>&nbsp;
														   <script language =javascript src='./js/f4206ma1_fpLoanBalLocAmt_txtLoanBalLocAmt.js'></script></TD>									
