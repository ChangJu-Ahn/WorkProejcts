...
'==================================================================================================================================		
	...
	'A_GL에 대한 정보  Setting
	'--------------------------------------------------------------------
	pvCommandSent = Request("txtCommandMode")	'Spread Sheet 내용을 담고 있는 Element명 
...
'==================================================================================================================================
	...
	iStrRetGlNo = PAGG020_cAMngGlSvr.A_MANAGE_GL_SVR(gStrGlobalCollection, _
	                                                 pvCommandSent, _
	                                                 I1_b_currency, _
	                                                 I2_a_gl, _
	                                                 txtSpread, _
...
Sub SubBizDeleteMulti()
   ...
   'I2_a_gl(A381_I2_a_gl_gl_desc)		= Request("txtDesc") 
	...
	iStrRetGlNo = PAGG020_cAMngGlSvr.A_MANAGE_GL_SVR(gStrGlobalCollection, pvCommandSent, "", I2_a_gl, "", "", ,gDsnNo)
