...
Const BIZ_PGM_ID 		= "a3112rb1.asp"                              '☆: Biz Logic ASP Name
...
Function FncQuery() 
	...
	If PopupParent.CompareDateByFormat(frm1.txtFrArDt.text,frm1.txtToArDt.text,frm1.txtFrArDt.Alt,frm1.txtToArDt.Alt, _
			...
			<FIELDSET CLASS="CLSFLD">
				<TABLE <%=LR_SPACE_TYPE_40%>>
					<TR>				
						...
						<TD CLASS=TD6 NOWRAP>
							<script language =javascript src='./js/a3112ra1_fpDateTime1_txtFrArDt.js'></script>&nbsp;~&nbsp;
							<script language =javascript src='./js/a3112ra1_fpDateTime2_txtToArDt.js'></script>
						</TD>												
	...
	<TR HEIGHT=100%>
		<TD WIDTH=100% HEIGHT=* VALIGN=TOP>
			<TABLE <%=LR_SPACE_TYPE_20%>>
				<TR HEIGHT=100%>
					<TD WIDTH=100%>
						<script language =javascript src='./js/a3112ra1_vspdData_vspdData.js'></script>
					</TD>
				</TR>
			</TABLE>
		</TD>
