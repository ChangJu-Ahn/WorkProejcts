...
Const BIZ_PGM_ID 		= "a3122rb1.asp"                              '☆: Biz Logic ASP Name
			...
			<FIELDSET CLASS="CLSFLD">
				<TABLE <%=LR_SPACE_TYPE_40%>>
					<TR>				
						...
						<TD CLASS=TD6 NOWRAP>
							<script language =javascript src='./js/a3122ra1_fpDateTime1_txtFrPrDt.js'></script>&nbsp;~&nbsp;
							<script language =javascript src='./js/a3122ra1_fpDateTime2_txtToPrDt.js'></script>
						</TD>												
	...
	<TR HEIGHT=100%>
		<TD WIDTH=100% HEIGHT=* VALIGN=TOP>
			<TABLE <%=LR_SPACE_TYPE_20%>>
				<TR HEIGHT=100%>
					<TD WIDTH=100%>
						<script language =javascript src='./js/a3122ra1_vspdData_vspdData.js'></script>
					</TD>
				</TR>
			</TABLE>
		</TD>
