...
Const BIZ_PGM_ID 		= "a4110rb1.asp"                              '☆: Biz Logic ASP Name
...
Sub InitSpreadSheet()
	...
	Call SetZAdoSpreadSheet("A4101RA1","S","A","V20021211",PopupParent.C_SORT_DBAGENT,frm1.vspdData, C_MaxKey, "X","X")
	Call SetSpreadLock() 
			...
			<FIELDSET CLASS="CLSFLD">
				<TABLE <%=LR_SPACE_TYPE_40%>>
					<TR>				
						...
						<TD CLASS=TD6 NOWRAP>
							<script language =javascript src='./js/a4110ra1_fpDateTime1_txtFrApDt.js'></script>&nbsp;~&nbsp;
							<script language =javascript src='./js/a4110ra1_fpDateTime2_txtToApDt.js'></script>
						</TD>												
	...
	<TR HEIGHT=100%>
		<TD WIDTH=100% HEIGHT=* VALIGN=TOP>
			<TABLE <%=LR_SPACE_TYPE_20%>>
				<TR HEIGHT=100%>
					<TD WIDTH=100%>
						<script language =javascript src='./js/a4110ra1_vspdData_vspdData.js'></script>
					</TD>
				</TR>
			</TABLE>
		</TD>
