...
Sub FixUNISQLData()
    ...
    UNISqlId(0) = "A5130RA201"	'계정보조부조회
    UNISqlId(1) = "A5130RA202"	'계정코드
...
Sub TrimData()
	...
	txtStdYYYY		= Trim(Request("txtStdYYYY"))
	txtStdMM		= Trim(Request("txtStdDt"))
	...
	strWhere0 = strWhere0 & " AND (b.gl_input_type = " & FilterVar("TR", "''", "S") & "  or b.gl_input_type = " & FilterVar("BR", "''", "S") & "  or b.gl_input_type LIKE " & FilterVar("%T", "''", "S") & " ) "

	If Trim(txtStdMM) = "" Then
		strFrDt = txtStdYYYY +  "0101"
		strToDt = txtStdYYYY +  "1231"
		strWhere0 = strWhere0 & " AND b.gl_dt between  " & FilterVar(strFrDt, "''", "S") & " and  " & FilterVar(strToDt, "''", "S") & " "
	Else
		strFrDt = txtStdYYYY & "-" & txtStdMM
		'strToDt = strDt + strDateMnth + "31"
		
		strWhere0 = strWhere0 & " AND convert(char(7),CONVERT(DATETIME,b.GL_DT ),121) =  " & FilterVar(strFrDt , "''", "S") & ""
	End If
