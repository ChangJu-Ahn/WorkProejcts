...
'==========================================  1.2.1 Global 상수 선언  ======================================
'==========================================================================================================
Const BIZ_PGM_QRY_ID  = "a7122mb1_ko441.asp"												'☆: Head Query 비지니스 로직 ASP명 
'Const Biz_PGM_QRY_ID2 = "a7122mb4_ko441.asp"
Const BIZ_PGM_QRY_ID2  = "a7122mb1_ko441.asp"												'☆: Head Query 비지니스 로직 ASP명 

Const BIZ_PGM_DEL_ID  = "a7122mb3_ko441.asp"												'☆: Delete 비지니스 로직 ASP명 
Const BIZ_PGM_SAVE_ID = "a7122mb2_ko441.asp"												'☆: Save 비지니스 로직 ASP명 
...
''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''<<<<<<<<<<<<<<<<<<<<<<<<<<<<
    ...
    ggoSpread.SSSetFloat    C_DurYrs,    "내용월수",      15,"6",ggStrIntegeralPart, ggStrDeciPointPart,parent.gComNum1000,parent.gComNumDec
...
'MsgBox strYear & strMonth
				strVal = strVal & parent.gColSep							'30	A073_IG1_I4_tax_dur_mnth
				strVal = strVal & parent.gColSep							'31	A073_IG1_I4_cas_dur_mnth
				strVal = strVal & parent.gColSep							'32	A073_IG1_I4_cost_cd		'>>air
				.Col = C_DurYrs												'33	내용월수	A073_IG1_I4_dur_mnth	'>>air
				strVal = strVal & Trim(.Text) & parent.gColSep
					...
					<TD CLASS="CLSMTABP">
						<TABLE ID="MyTab" CELLSPACING=0 CELLPADDING=0 onclick="ClickTab1()">
							<TR>
								...
								<td background="../../../CShared/image/table/seltab_up_bg.gif" align="center" CLASS="CLSMTAB"><font color=white>기초자산Master등록(KO441)</font></td>
