...
'*  3. Program ID           : a4110ma.asp
'*  4. Program Name         : 기초채무등록 
'*  5. Program Desc         :
'*  6. Complus List         : 
...
'@PGM_ID
Const BIZ_PGM_QRY_ID = "a4110mb1.asp"												'☆: Head Query 비지니스 로직 ASP명 
Const BIZ_PGM_SAVE_ID = "a4110mb2.asp"												'☆: Save 비지니스 로직 ASP명 
Const BIZ_PGM_DEL_ID = "a4110mb3.asp"
...
'=======================================================================================================
Sub  SetDefaultVal()
	frm1.txtApDt.text  =  UniConvDateAToB("<%=dtToday%>", parent.gServerDateFormat,gDateFormat)
...
Function  OpenPopUp(Byval strCode, Byval iWhere)
	...
	iCalledAspName = AskPRAspName("A4110RA1")

	If Trim(iCalledAspName) = "" Then
		IntRetCD = DisplayMsgBox("900040", parent.VB_INFORMATION, "A4110RA1", "X")
		IsOpenPop = False
		Exit Function
	End If
					...
					<TD CLASS="CLSMTABP">
						<TABLE ID="MyTab" CELLSPACING=0 CELLPADDING=0>
							<TR>
								...
								<td background="../../../CShared/image/table/seltab_up_bg.gif" align="center" CLASS="CLSMTABP"><font color=white>기초채무등록</font></td>
					...
					<DIV ID="TabDiv" STYLE="FLOAT: left; HEIGHT: 100%; OVERFLOW: auto; WIDTH: 100%" SCROLL="no">
						<TABLE <%=LR_SPACE_TYPE_60%>>
							...
							<TR>
								...
								<TD CLASS=TD6 NOWRAP>
								<script language =javascript src='./js/a4110ma1_OBJECT3_txtInvDt.js'></script></TD>
							</TR>
							<TR>
							...
							<TR>
								...
								<TD CLASS=TD6 NOWRAP>
								<script language =javascript src='./js/a4110ma1_OBJECT4_txTblDt.js'></script></TD>															
							</TR>
							<TR><TD CLASS=TD5 NOWRAP>계정코드</TD>
								...
								<TD CLASS=TD5 NOWRAP>LC번호</TD>
								<TD CLASS=TD6 NOWRAP><INPUT NAME="txTlcNo" ALT="LC번호" MAXLENGTH="35" SIZE=20 STYLE="TEXT-ALIGN: left" tag ="21XXXU"></TD>										
							</TR>
							<TR>
								<TD CLASS=TD5 NOWRAP>채무일자</TD>
								<TD CLASS=TD6 NOWRAP><script language =javascript src='./js/a4110ma1_OBJECT1_txtApDt.js'></script></TD>																					 
								<TD CLASS=TD5 NOWRAP>LC발행일</TD>
								<TD CLASS=TD6 NOWRAP><script language =javascript src='./js/a4110ma1_OBJECT6_txtLcDt.js'></script></TD>
							</TR>								
							<TR>
								<TD CLASS=TD5 NOWRAP>채무만기일자</TD>
								<TD CLASS=TD6 NOWRAP><script language =javascript src='./js/a4110ma1_OBJECT2_txtDueDt.js'></script></TD>
								<TD CLASS="TD5" nowrap>결제기간</TD>
								<TD CLASS="TD6" NOWRAP>
									<Table cellpadding=0 cellspacing=0>
										<TR>
											<TD NOWRAP>
											<script language =javascript src='./js/a4110ma1_fpDoubleSingle5_txtPayDur.js'></script>
											</TD>
											<TD NOWRAP>
												&nbsp;일
											</TD>
...
<%	If gIsShowLocal <> "N" Then	%>		
								...
								&nbsp;&nbsp;환율<script language =javascript src='./js/a4110ma1_OBJECT5_txtXchRate.js'></script></TD>
<%	ELSE %>
...
<%	End If %>								
							...
							<TR>
								...
								<TD CLASS=TD6 NOWRAP><script language =javascript src='./js/a4110ma1_OBJECT1_txtGlDt.js'></script></TD>
							...
							<TR>				
								...
								<TD CLASS=TD6 NOWRAP><INPUT NAME="txtGlNo" ALT="전표번호" MAXLENGTH="18" STYLE="TEXT-ALIGN: Left" tag="24XXXU" ></TD>
							...
							<TR>
								...
								<TD CLASS=TD6 NOWRAP>
								<script language =javascript src='./js/a4110ma1_I442793124_txtNetAmt.js'></script></TD>
<%	If gIsShowLocal <> "N" Then	%>								
								<TD CLASS=TD5 NOWRAP>외상매입액(자국통화)</TD>
								<TD CLASS=TD6 NOWRAP>
								<script language =javascript src='./js/a4110ma1_I731363141_txtNetLocAmt.js'></script></TD>
							</TR>
							<TR>
<%	ELSE %>
...
<%	End If %>															
								...
								<TD CLASS=TD6 NOWRAP>
								<script language =javascript src='./js/a4110ma1_I318674331_txtBalAmt.js'></script></TD>
<%	If gIsShowLocal <> "N" Then	%>								
								<TD CLASS=TD5 NOWRAP>채무잔액(자국통화)</TD>
								<TD CLASS=TD6 NOWRAP>
								<script language =javascript src='./js/a4110ma1_I591427040_txtBalLocAmt.js'></script></TD>
<%	ELSE %>
...
<%	End If %>								
							...
							<TR>
								...
								<TD CLASS=TD6 NOWRAP COLSPAN=3><INPUT NAME="txtDesc" ALT="비고" MAXLENGTH="128" SIZE="80" tag="2X" ></TD>
							</TR>
						</TABLE>
					</DIV>
					</TD>
