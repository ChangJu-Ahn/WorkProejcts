...
*  2. Function Name        : 연월차계산 - 퇴직자용 
*  3. Program ID           : H9201ba1
*  4. Program Name         : H9201ba1
*  5. Program Desc         : 연말정산관리/연월차계산(퇴직자용)
*  6. Comproxy List        :
					...
					<TD>
						<TABLE ID="MyTab" CELLSPACING=0 CELLPADDING=0>
							<TR>
								...
								<td background="../../../CShared/image/table/seltab_up_bg.gif" align="center" CLASS="CLSMTAB"><font color=white>연월차계산(퇴직자)</font></td>
