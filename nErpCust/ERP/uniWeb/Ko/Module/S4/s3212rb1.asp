...
'--------------- 개발자 coding part(실행로직,End)----------------------------------------------------
    ...
    UNIValue(0,1) = strVal   'UNISqlId(0)의 첫번째 Where이하의 조건 
    UNIValue(0,2) = strVal2   'UNISqlId(0)의 첫번째 Where이하의 조건 
    UNIValue(0,3) = strVal1   'UNISqlId(0)의 두번째 Where이하의 조건 
    UNIValue(1,0) = FilterVar(Trim(Request("txtItem")), " " , "S")  'UNISqlId(1)의 첫번째 Where이하의 조건 
