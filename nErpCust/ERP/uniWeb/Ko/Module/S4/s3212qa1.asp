...
'*  1. Module Name          : 영업관리 
'*  2. Function Name        : 
'*  3. Program ID           : s3212qa1
'*  4. Program Name         : L/C 상세조회 
'*  5. Program Desc         : L/C 상세조회 
'*  6. Comproxy List        : 
...
Const BIZ_PGM_ID        = "s3212qb1.asp"
Const BIZ_PGM_JUMP_ID	= "s3212ma1"
Const C_MaxKey          = 18                                   
...
'===========================================================================================================
Sub InitSpreadSheet()
    Call SetZAdoSpreadSheet("S3212QA1","S","A","V20030318", Parent.C_SORT_DBAGENT, frm1.vspdData, C_MaxKey, "X", "X" )
	Call SetSpreadLock 
End Sub
...
<TABLE <%=LR_SPACE_TYPE_00%>>
						...
						<FIELDSET CLASS="CLSFLD">
							<TABLE <%=LR_SPACE_TYPE_40%>>
								...
								<TR>	
									...
									<TD CLASS=TD6 NOWRAP>
										<script language =javascript src='./js/s3212qa1_fpDateTime1_txtOpenFrDt.js'></script>&nbsp;~&nbsp;
										<script language =javascript src='./js/s3212qa1_fpDateTime2_txtOpenToDt.js'></script>
									</TD>
								</TR>	
							</TABLE>
						</FIELDSET>	
				...
				<TR>
					<TD WIDTH=100% HEIGHT=* valign=top>
						<TABLE <%=LR_SPACE_TYPE_20%>>
							<TR>
								<TD HEIGHT="100%">
								<script language =javascript src='./js/s3212qa1_vaSpread1_vspdData.js'></script>
								</TD>
							</TR>
						</TABLE>
					</TD>
	...
	<TR HEIGHT="20">
		<TD WIDTH="100%"><TABLE <%=LR_SPACE_TYPE_30%>>
			<TR>
				<TD WIDTH="*" ALIGN=RIGHT><a href = "vbscript:PgmJump(BIZ_PGM_JUMP_ID)" ONCLICK="VBSCRIPT:CookiePage 1">L/C내역등록</a></TD>
			</TR>
		</TABLE></TD>
	</TR>
	<TR>
