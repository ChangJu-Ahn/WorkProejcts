...
Const BIZ_PGM_QRY_ID = "s3111rb1.asp"							   

Const C_MaxKey          = 16                                           

Dim gblnWinEvent											'☜: ShowModal Dialog(PopUp) 
Dim arrReturn
Dim lgIsOpenPop												'☜: Return Parameter Group
...
'========================================================================================================
 Function OpenIncoTerms()
 	...
 	arrParam(3) = Trim(txtIncoTermsNm.value)	
				...
				<FIELDSET CLASS="CLSFLD">
					<TABLE <%=LR_SPACE_TYPE_40%>>
						<TR>
							...
							<TD CLASS=TD5>수주일</TD>
							<TD CLASS=TD6>
								<script language =javascript src='./js/s3111ra1_fpDateTime1_txtFromDt.js'></script>&nbsp;~&nbsp;
								<script language =javascript src='./js/s3111ra1_fpDateTime2_txtToDt.js'></script>
							</TD>	
						</TR>
						<TR>
							<TD CLASS=TD5>결제방법</TD>
							<TD CLASS=TD6>
								<INPUT TYPE=TEXT NAME="txtPayTerms" SIZE=10 MAXLENGTH=4 TAG="11XXXU" ALT="결제방법"><IMG SRC="../../../CShared/image/btnPopup.gif" NAME="btnPayTerms" align=top TYPE="BUTTON" ONCLICK ="vbscript:btnPayTermsOnClick()">&nbsp;
								<INPUT TYPE=TEXT NAME="txtPayTermsNm" SIZE=20 TAG="14">
							</TD>
							<TD CLASS=TD5>가격조건</TD>
							<TD CLASS=TD6 NOWRAP>
								<INPUT TYPE=TEXT NAME="txtIncoTerms" SIZE=10 MAXLENGTH=3 TAG="11XXXU" ALT="가격조건"><IMG SRC="../../../CShared/image/btnPopup.gif" NAME="btnIncoTerms" align=top TYPE="BUTTON" ONCLICK ="vbscript:btnIncoTermsOnClick()">&nbsp;
								<INPUT TYPE=TEXT NAME="txtIncoTermsNm" SIZE=20 TAG="14">
							</TD>
						</TR>
					</TABLE>
				</FIELDSET>
				...
				<TABLE <%=LR_SPACE_TYPE_20%>>
					<TR>
						<TD HEIGHT="100%" NOWRAP>
							<script language =javascript src='./js/s3111ra1_vaSpread_vspdData.js'></script>
						</TD>
					</TR>
				</TABLE>
			</TD>
