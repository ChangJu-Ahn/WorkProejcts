...
'*  1. Module Name          : 영업관리																	*
'*  2. Function Name        :																			*
'*  3. Program ID           : s3221pa2.asp																*
'*  4. Program Name         : Local L/C Amend 번호(Local L/C Amend등록)									*
'*  5. Program Desc         : Local L/C Amend 번호(Local L/C Amend등록)									*
'*  6. Comproxy List        :																			*
'*  7. Modified date(First) : 2000/04/03																*
'*  8. Modified date(Last)  : 2001/07/08																*
...
<HTML>
<HEAD>
<TITLE>LOCAL L/C AMEND 번호</TITLE>
...
'============================================================================================================
Sub InitSpreadSheet()
	Call SetZAdoSpreadSheet("s3221pa2","S","A","V20030320", PopupParent.C_SORT_DBAGENT, frm1.vspdData, C_MaxKey, "X", "X" )
...
Function OpenLCDocNo()
	...
	arrParam(0) = "L/C Amend번호"									
	arrParam(1) = "S_LC_AMEND_HDR"									
	arrParam(2) = Trim(frm1.txtLCDocNo.value)						
	arrParam(3) = ""											
	arrParam(4) = "LC_KIND = " & FilterVar("L", "''", "S") & " "								
	arrParam(5) = "L/C Amend번호"									

	arrField(0) = "ED33" & PopupParent.gColSep & "LC_DOC_NO"						
	arrField(1) = "ED12" & PopupParent.gColSep & "LC_AMEND_SEQ"	                    '기존--CONVERT(char(3),LC_AMEND_SEQ) 표준반영건으로 convert 삭제 2002-06-17
				...
				<FIELDSET CLASS="CLSFLD">
					<TABLE <%=LR_SPACE_TYPE_40%>>
						...
						<TR>
							...
							<TD CLASS=TD6 NOWRAP><INPUT NAME="txtLCDocNo" ALT="L/C번호" TYPE=TEXT SIZE=35 MAXLENGTH=35 TAG="11XXXU"><IMG SRC="../../../CShared/image/btnPopup.gif" NAME="btnLCDocNo" align=top TYPE="BUTTON" ONCLICK ="vbscript:btnLCDocNoOnClick()"></TD>
							<TD CLASS=TD5 NOWRAP>AMEND 일</TD>						
							<TD CLASS=TD6 NOWRAP>
								<script language =javascript src='./js/s3221pa2_fpDateTime1_txtFromDt.js'></script>&nbsp;~&nbsp;
								<script language =javascript src='./js/s3221pa2_fpDateTime2_txtToDt.js'></script>
							</TD>
						</TR>
					</TABLE>
				</FIELDSET>
				...
				<TABLE <%=LR_SPACE_TYPE_20%>>
					<TR>
						<TD HEIGHT="100%" NOWRAP>
							<script language =javascript src='./js/s3221pa2_vaSpread_vspdData.js'></script>
						</TD>
					</TR>
				</TABLE>
			</TD>
