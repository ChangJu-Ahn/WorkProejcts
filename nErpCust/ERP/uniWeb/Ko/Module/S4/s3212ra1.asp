...
'*  1. Module Name          : 영업관리																	*
'*  2. Function Name        : 																			*
'*  3. Program ID           : s3212ra1.asp																*
'*  4. Program Name         : L/C 내역참조(L/C Amend 내역등록에서)										*
'*  5. Program Desc         : L/C 내역참조(L/C Amend 내역등록에서)										*
'*  6. Comproxy List        :																			*
...
'========================================================================================================
 Sub InitSpreadSheet()
    ...
    Call SetZAdoSpreadSheet("S3212RA1","S","A","V20030318", PopupParent.C_SORT_DBAGENT, frm1.vspdData, C_MaxKey, "X", "X" )
 	With frm1.vspdData
				...
				<FIELDSET CLASS="CLSFLD">
					<TABLE <%=LR_SPACE_TYPE_40%>>
						<TR>
							...
							<TD CLASS=TD6 NOWRAP><INPUT NAME="txtLCNo" ALT="L/C관리번호" TYPE=TEXT SIZE=20 MAXLENGTH=35 TAG="14XXXU"></TD>
						</TR>		
						<TR>
                                                        <TD CLASS=TD5 NOWRAP>Tracking No.</TD>
							<TD CLASS=TD6 NOWRAP><INPUT TYPE=TEXT NAME="txtTrackingNo" SIZE=30 MAXLENGTH=25 TAG="11XXXU" ALT="Tracking No."><IMG SRC="../../../CShared/image/btnPopup.gif" NAME="btnTRno" align=top TYPE="BUTTON" OnClick="vbscript:OpenTrackingNo">&nbsp;</TD>
				...
				<TABLE <%=LR_SPACE_TYPE_20%>>
					<TR>
						<TD HEIGHT="100%" NOWRAP>
							<script language =javascript src='./js/s3212ra1_vaSpread_vspdData.js'></script>
						</TD>
					</TR>
				</TABLE>
			</TD>
