...
'*  1. Module Name          : 영업관리 
'*  2. Function Name        : 
'*  3. Program ID           : S3211PA2
'*  4. Program Name         : Local L/C관리번호 팝업 
'*  5. Program Desc         : Local L/C관리번호 팝업 
'*  6. Comproxy List        : 
...
Sub InitSpreadSheet()
	...
	Call SetZAdoSpreadSheet("S3211PA2","S","A","V20030320", PopupParent.C_SORT_DBAGENT, frm1.vspdData, C_MaxKey, "X", "X" )
				...
				<FIELDSET CLASS="CLSFLD">
					<TABLE <%=LR_SPACE_TYPE_40%>>
						...
						<TR>
							...
							<TD CLASS=TD6 NOWRAP>
								<TABLE CELLSPACING=0 CELLPADDING=0>
									<TR>
										...
										<TD>&nbsp;<script language =javascript src='./js/s3211pa2_fpDoubleSingle1_txtDocAmt.js'></script>
										</TD>
									</TR>
								</TABLE>
							</TD>	
							...
							<TD CLASS=TD6 NOWRAP>
								<script language =javascript src='./js/s3211pa2_fpDateTime1_txtFromDt.js'></script>&nbsp;~&nbsp;
								<script language =javascript src='./js/s3211pa2_fpDateTime2_txtToDt.js'></script>
							</TD>
						</TR>					
					</TABLE>
				</FIELDSET>
				...
				<TABLE <%=LR_SPACE_TYPE_20%>>
					<TR>
						<TD HEIGHT="100%" NOWRAP>
							<script language =javascript src='./js/s3211pa2_vaSpread_vspdData.js'></script>
						</TD>
					</TR>
				</TABLE>
			</TD>
