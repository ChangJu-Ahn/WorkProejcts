...
'*  1. Module Name          : 영업관리																	*
'*  2. Function Name        :																			*
'*  3. Program ID           : s3211ma8.asp																*
'*  4. Program Name         : L/C 현황조회																*
'*  5. Program Desc         : L/C 현황조회																*
'*  6. Comproxy List        :																			*
...
Const BIZ_PGM_ID 		= "s3211mb8.asp"                              '☆: Biz Logic ASP Name
Const BIZ_PGM_JUMP_ID	= "s3211ma1"
...
'========================================================================================================
Sub InitSpreadSheet()
	Call SetZAdoSpreadSheet("S3211QA8","S","A","V20030318", Parent.C_SORT_DBAGENT, frm1.vspdData, C_MaxKey, "X", "X" )
	Call SetSpreadLock 
End Sub
...
Function OpenLCHdrRef()
	...
	iCalledAspName = AskPRAspName("s3211ra4")

	If Trim(iCalledAspName) = "" Then
		IntRetCD = DisplayMsgBox("900040", parent.VB_INFORMATION, "s3211ra4", "X")
		IsOpenPop = False
		Exit Function
	End If

	arrRet = window.showModalDialog(iCalledAspName,Array(window.parent,arrParam),"dialogWidth=850px; dialogHeight=450px; center: Yes; help: No; resizable: No; status: No;")
...
Function OpenLCDtlRef()
    ...
    iCalledAspName = AskPRAspName("s3212ra4")

	If Trim(iCalledAspName) = "" Then
		IntRetCD = DisplayMsgBox("900040", parent.VB_INFORMATION, "s3212ra4", "X")
		IsOpenPop = False
		Exit Function
	End If
					...
					<TD CLASS="CLSMTABP">
						<TABLE ID="MyTab" CELLSPACING=0 CELLPADDING=0>
							<TR>
								...
								<td background="../../../CShared/image/table/seltab_up_bg.gif" align="center" CLASS="CLSMTAB"><font color=white>L/C현황</font></td>
								<td background="../../../CShared/image/table/seltab_up_bg.gif" align="right"><img src="../../../CShared/image/table/seltab_up_right.gif" width="10" height="23"></td>
						    </TR>
						</TABLE>
					</TD>
					<TD WIDTH=* align=right><A href="vbscript:OpenLCHdrRef">L/C 상세정보</A> | <A href="vbscript:OpenLCDtlRef">L/C 내역정보</A>					
					<TD WIDTH=10>&nbsp;</TD>
				</TR>
			</TABLE>
		</TD>
		...
		<TD WIDTH=100% CLASS="Tab11">
				...
				<TR>
					...
					<FIELDSET CLASS="CLSFLD"><TABLE <%=LR_SPACE_TYPE_40%>>
						...
						<TR>
							...
							<TD CLASS=TD6 NOWRAP>
								<script language =javascript src='./js/s3211ma8_fpDoubleSingle1_txtFromLocAmt.js'></script>							
								&nbsp;~&nbsp;
								<script language =javascript src='./js/s3211ma8_fpDoubleSingle2_txtToLocAmt.js'></script>							
							</TD>
						...
						<TR>
							...
							<TD CLASS=TD6 NOWRAP>
								<script language =javascript src='./js/s3211ma8_fpDateTime1_txtFromDate.js'></script>
								&nbsp;~&nbsp;
								<script language =javascript src='./js/s3211ma8_fpDateTime2_txtToDate.js'></script>
							</TD>
			...
			<TR>
				<TD WIDTH=100% HEIGHT=* valign=top><TABLE <%=LR_SPACE_TYPE_20%>>
					<TR>
						<TD HEIGHT="100%">
							<script language =javascript src='./js/s3211ma8_I789813196_vspdData.js'></script>
						</TD>
					</TR></TABLE>
				</TD>
			</TR>
