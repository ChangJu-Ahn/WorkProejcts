...
Const BIZ_PGM_ID 		= "s3112rb2.asp"                              '☆: Biz Logic ASP Name
Const C_MaxKey          = 14                                           
...
'========================================================================================================
Sub InitSpreadSheet()	    
	Call SetZAdoSpreadSheet("S3112RA2","S","A","V20030318", PopupParent.C_SORT_DBAGENT, frm1.vspdData, C_MaxKey, "X", "X" )
	With frm1.vspdData
				...
				<TABLE WIDTH="100%" HEIGHT="100%">
					<TR>
						<TD HEIGHT="100%" NOWRAP>
							<script language =javascript src='./js/s3112ra2_vaSpread_vspdData.js'></script>
						</TD>
					</TR>
				</TABLE>
			</TD>
