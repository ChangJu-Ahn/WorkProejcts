...
'   iB0C004
    ...
    'Const B253_I1_currency = 0       import b_currency
    'Const B253_I2_currency = 0       import_to b_currency
    'Const B253_I3_apprl_dt = 0   :   import b_daily_exchange_rate
...
'    Const S383_I1_lc_amd_no = 0    '[CONVERSION INFORMATION]  View Name : imp s_lc_amend_hdr
 ...
 '   Const S383_I2_lc_amd_seq = 0    '[CONVERSION INFORMATION]  View Name : imp_next s_lc_amend_dtl
    ...
    Const S383_EG1_E7_tracking_no = 32
...
'         Response.Write "b"
        ...
        If ConvSPChars(E12_s_lc_amend_hdr(S375_E12_cur)) <> gCurrency Then
'        	          Response.Write  "c1"
'        		pB17014.ImportBCurrencyCurrency = S32219.ExpSLcAmendHdrCur
'				pB17014.ImportBDailyExchangeRateApprlDt = S32219.ExpSLcAmendHdrOpenDt 
'				pB17014.ImportToBCurrencyCurrency = gCurrency
        	
        	Set iB0C004 = Server.CreateObject("PB0C004.CB0C004")	

	        If CheckSYSTEMError(Err,True) = True Then
                Exit Sub
            End If
        
            E1_b_daily_exchange_rate = iB0C004.B_SELECT_EXCHANGE_RATE(gStrGlobalCollection, E12_s_lc_amend_hdr(S375_E12_cur), gCurrency,E12_s_lc_amend_hdr(S375_E12_open_dt))
            ...
            Set iB0C004 = Nothing	
            strExchRateOp = E1_b_daily_exchange_rate(B253_E1_multi_divide)
        Else
        	strExchRateOp = "*"
        End if
		...
		Response.Write ".txtTotCurrency.value =  """ & lgCurrency & """" & vbCr
		...
		Response.Write ".txtXchRate.value     =  """ & UNINumClientFormat(E12_s_lc_amend_hdr(S375_E12_at_xch_rate), ggExchRate.DecPoint, 0) & """" & vbCr
		Response.Write ".txtCurrency.value    =  """ & ConvSPChars(E12_s_lc_amend_hdr(S375_E12_cur)) & """" & vbCr
		Response.Write ".txtTotCurrency.value =  """ & ConvSPChars(E12_s_lc_amend_hdr(S375_E12_cur)) & """" & vbCr
		
		'##### Rounding Logic #####
		'.txtDocAmt.value =  """ & UNINumClientFormat(E12_s_lc_amend_hdr(ExpSLcAmendHdrAtLcAmt, ggAmtOfMoney.DecPoint, 0)) & """" & vbCr
...
'		Response.Write ".txtHBeDocAmt.value =  """ & UNINumClientFormat(S32219.ExpTotSLcDtlLcAmt, ggAmtOfMoney.DecPoint, 0)) & """" & vbCr
		
		'##### Rounding Logic #####
'		Response.Write ".txtLocAmt.value =  """ & UNINumClientFormat(E12_s_lc_amend_hdr(ExpSLcAmendHdrAtLocAmt, ggAmtOfMoney.DecPoint, 0)) & """" & vbCr 
		Response.Write ".txtLocAmt.value	=  """ & UniConvNumberDBToCompany(E12_s_lc_amend_hdr(S375_E12_at_loc_amt), ggAmtOfMoney.DecPoint, ggAmtOfMoney.RndPolicy, ggAmtOfMoney.RndUnit, 0) & """" & vbCr

'		.txtTotItemLocAmt.text =  """ & UNINumClientFormat(S32219.ExpTotSLcDtlLcLocAmt, ggAmtOfMoney.DecPoint, 0)) & """" & vbCr
		Response.Write ".txtTotItemLocAmt.text	=  """ & UniConvNumberDBToCompany(E19_s_lc_dtl(S375_E19_lc_loc_amt), ggAmtOfMoney.DecPoint, ggAmtOfMoney.RndPolicy, ggAmtOfMoney.RndUnit, 0) & """" & vbCr

'		.txtHBeLocAmt.value =  """ & UNINumClientFormat(S32219.ExpTotSLcDtlLcLocAmt, ggAmtOfMoney.DecPoint, 0)) & """" & vbCr
		Response.Write ".txtHBeLocAmt.value	=  """ & UniConvNumberDBToCompany(E19_s_lc_dtl(S375_E19_lc_loc_amt), ggAmtOfMoney.DecPoint, ggAmtOfMoney.RndPolicy, ggAmtOfMoney.RndUnit, 0) & """" & vbCr
		...
		Response.Write ".txtHOpenDt.value  =  """ & ConvSPChars(E12_s_lc_amend_hdr(S375_E12_open_dt)) & """" & vbCr
		...
		Response.Write ".txtExchRateOp.value    =  """ & strExchRateOp & """" & vbCr
...
'iS4G228
	...
	For iLngRow = 0 To UBound(EG1_exp_grp,1)
		...
		istrData = istrData & Chr(11) & UniConvNumberDBToCompany(EG1_exp_grp(iLngRow,S383_EG1_E5_be_loc_amt), ggAmtOfMoney.DecPoint, ggAmtOfMoney.RndPolicy, ggAmtOfMoney.RndUnit, 0)
        istrData = istrData & Chr(11) & UniConvNumberDBToCompany(EG1_exp_grp(iLngRow,S383_EG1_E5_at_loc_amt), ggAmtOfMoney.DecPoint, ggAmtOfMoney.RndPolicy, ggAmtOfMoney.RndUnit, 0)
        ...
        istrData = istrData & Chr(11) 
        istrData = istrData & Chr(11) & ConvSPChars(EG1_exp_grp(iLngRow,S383_EG1_E7_tracking_no)) 
...
Sub SubBizSaveMulti()   
	...
	I1_s_lc_hdr_no = Trim(Request("txtLCNo"))
