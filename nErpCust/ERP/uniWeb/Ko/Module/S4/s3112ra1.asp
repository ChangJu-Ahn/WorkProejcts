...
'*  1. Module Name          : 영업																		*
'*  2. Function Name        : 																			*
'*  3. Program ID           : s3112ra1.asp																*
'*  4. Program Name         : 수주내역참조(L/C내역등록)													*
'*  5. Program Desc         : 수주내역참조(L/C내역등록)													*
'*  6. Comproxy List        : 																			*
...
Const BIZ_PGM_ID 		= "s3112rb1.asp"                              '☆: Biz Logic ASP Name
...
Sub SetDefaultVal()				
	...
	frm1.txtPayTerms.value = ArrParam(5)
	frm1.txtPayTermsNm.value = ArrParam(6)
...
Sub InitSpreadSheet()	    
	Call SetZAdoSpreadSheet("S3112RA1","S","A","V20030318", PopupParent.C_SORT_DBAGENT, frm1.vspdData, C_MaxKey, "X", "X" )
	With frm1.vspdData
				...
				<TABLE <%=LR_SPACE_TYPE_20%>>
					<TR>
						<TD HEIGHT="100%" NOWRAP>
							<script language =javascript src='./js/s3112ra1_vaSpread_vspdData.js'></script>
						</TD>
					</TR>
				</TABLE>
			</TD>
