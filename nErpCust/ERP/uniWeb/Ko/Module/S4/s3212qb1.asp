...
Private Sub FixUNISQLData()
    ...
    If Len(Trim(Request("txtOpenFrDt"))) Then
		strVal = strVal & " AND A.OPEN_DT >= " & FilterVar(UNIConvDate(Request("txtOpenFrDt")), "''", "S") & ""		
	End If		
	
	If Len(Trim(Request("txtOpenToDt"))) Then
...
Private Sub QueryData()
    ...
    If  rs1.EOF And rs1.BOF Then
		...
		If Len(Trim(Request("txtconBp_cd"))) And BlankchkFlg = False Then
    ...
    If  rs2.EOF And rs2.BOF Then
		...
		If Len(Trim(Request("txtSalesGroup"))) And BlankchkFlg = False Then
    ...
    If  rs3.EOF And rs3.BOF Then
		...
		If Len(Trim(Request("txtItem_cd"))) And BlankchkFlg = False Then
...
<Script Language=vbscript>
    ...
    With parent
        ...
        If "<%=lgDataExist%>" = "Yes" Then
			...
			Call Parent.ReFormatSpreadCellByCellByCurrency(Parent.frm1.vspdData,"<%=iFrPoint+1%>",.frm1.vspddata.maxrows,Parent.GetKeyPos("A",8),Parent.GetKeyPos("A",7),"C", "Q" ,"X","X")
	    	Call Parent.ReFormatSpreadCellByCellByCurrency(Parent.frm1.vspdData,"<%=iFrPoint+1%>",.frm1.vspddata.maxrows,Parent.GetKeyPos("A",8),Parent.GetKeyPos("A",9),"A", "Q" ,"X","X")
