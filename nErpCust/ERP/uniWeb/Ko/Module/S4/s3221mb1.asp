...
Sub SubBizQuery()
    ...
    Response.Write " Parent.frm1.txtAtCurrency.value		= """ & ConvSPChars(E12_s_lc_amend_hdr(S375_E12_cur)) & """" & vbCr 
    Response.Write " Parent.frm1.txtBeCurrency.value        = """ & ConvSPChars(E12_s_lc_amend_hdr(S375_E12_cur)) & """" & vbCr       
    ...
    If E12_s_lc_amend_hdr(S375_E12_at_trnshp_flag) = "Y" Then        
		Response.Write " Parent.frm1.rdoAtTranshipment1.Checked = True "							             & vbCr    
    ElseIf E12_s_lc_amend_hdr(S375_E12_at_trnshp_flag) = "N" Then        
		Response.Write " Parent.frm1.rdoAtTranshipment2.Checked = True "							             & vbCr    		
    End If		
	
	Response.Write " Parent.frm1.txtBeTranshipment.value     = """ & ConvSPChars(E12_s_lc_amend_hdr(S375_E12_be_trnshp_flag))  & """" & vbCr 	
    ...
    If E12_s_lc_amend_hdr(S375_E12_at_transfer_flag) = "Y" Then        
		Response.Write " Parent.frm1.rdoAtTransfer1.Checked = True "							             & vbCr    
    ElseIf E12_s_lc_amend_hdr(S375_E12_at_transfer_flag) = "N" Then        
		Response.Write " Parent.frm1.rdoAtTransfer2.Checked = True "							             & vbCr    		
    End If	    	
		
    Response.Write " Parent.frm1.txtBeTransfer.value      = """ & ConvSPChars(E12_s_lc_amend_hdr(S375_E12_be_transfer_flag))  & """" & vbCr 	
    
    Response.Write " Parent.frm1.txtAtTransport.value     = """ & ConvSPChars(E12_s_lc_amend_hdr(S375_E12_at_transport))	  & """" & vbCr 	
    Response.Write " Parent.frm1.txtBeTransport.value     = """ & ConvSPChars(E12_s_lc_amend_hdr(S375_E12_be_transport))	  & """" & vbCr 	
    Response.Write " Parent.frm1.txtAtTransportNm.value   = """ & ConvSPChars(E6_b_minor(S375_E6_minor_nm))					  & """" & vbCr 	
    Response.Write " Parent.frm1.txtBeTransportNm.value   = """ & ConvSPChars(E3_b_minor(S375_E3_minor_nm))					  & """" & vbCr 	                
    
    Response.Write " Parent.frm1.txtAtLoadingPort.value   = """ & ConvSPChars(E12_s_lc_amend_hdr(S375_E12_at_loading_port))   & """" & vbCr 	
    Response.Write " Parent.frm1.txtBeLoadingPort.value   = """ & ConvSPChars(E12_s_lc_amend_hdr(S375_E12_be_loading_port))   & """" & vbCr 	
    Response.Write " Parent.frm1.txtAtDischgePort.value   = """ & ConvSPChars(E12_s_lc_amend_hdr(S375_E12_at_dischge_port))   & """" & vbCr 	
    Response.Write " Parent.frm1.txtBeDischgePort.value   = """ & ConvSPChars(E12_s_lc_amend_hdr(S375_E12_be_dischge_port))   & """" & vbCr 	
    
    Response.Write " Parent.frm1.txtAtLoadingPortNm.value = """ & ConvSPChars(E8_b_minor(S375_E8_minor_nm))					  & """" & vbCr 	
    Response.Write " Parent.frm1.txtBeLoadingPortNm.value = """ & ConvSPChars(E5_b_minor(S375_E5_minor_nm))					  & """" & vbCr 	                
    Response.Write " Parent.frm1.txtAtDischgePortNm.value = """ & ConvSPChars(E7_b_minor(S375_E7_minor_nm))					  & """" & vbCr 	    
    Response.Write " Parent.frm1.txtBeDischgePortNm.value = """ & ConvSPChars(E4_b_minor(S375_E4_minor_nm))					  & """" & vbCr 	
    
		    
    Response.Write " Parent.frm1.txtDoc1.value			 = """ & ConvSPChars(E12_s_lc_amend_hdr(S375_E12_remark))				& """" & vbCr 	
    ...
    Response.Write " Parent.frm1.txtManufacturer.value   = """ & ConvSPChars(E12_s_lc_amend_hdr(S375_E12_manufacturer))			& """" & vbCr 	
    Response.Write " Parent.frm1.txtManufacturerNm.value = """ & ConvSPChars(E14_b_biz_partner(S375_E14_bp_nm))					& """" & vbCr 	                
    Response.Write " Parent.frm1.txtAgent.value			 = """ & ConvSPChars(E12_s_lc_amend_hdr(S375_E12_agent))				& """" & vbCr 	            
    Response.Write " Parent.frm1.txtAgentNm.value		 = """ & ConvSPChars(E13_b_biz_partner(S375_E13_bp_nm))					& """" & vbCr 	            
...
Sub SubBizSave
	...
	I2_s_lc_amend_hdr(S369_I2_cur) = UCase(Trim(Request("txtAtCurrency")))
	...
	End If
	If Len(Trim(Request("txtAtXchRate"))) Then
	...
	I2_s_lc_amend_hdr(S369_I2_at_trnshp_flag) = Trim(Request("rdoAtTranshipment"))
	I2_s_lc_amend_hdr(S369_I2_at_partial_ship_flag) = Trim(Request("rdoAtPartialShip"))
	I2_s_lc_amend_hdr(S369_I2_at_transfer_flag) = Trim(Request("rdoAtTransfer"))
	I2_s_lc_amend_hdr(S369_I2_at_transport) = Trim(Request("txtAtTransport"))
		
	I2_s_lc_amend_hdr(S369_I2_at_loading_port) = Trim(Request("txtatLoadingPort"))
	I2_s_lc_amend_hdr(S369_I2_at_dischge_port) = Trim(Request("txtatDischgePort"))

	'Tab 2 : L/C Amend 기타	
	
	I2_s_lc_amend_hdr(S369_I2_remark) = Trim(Request("txtDoc1"))
	I2_s_lc_amend_hdr(S369_I2_lc_kind) = "M"
