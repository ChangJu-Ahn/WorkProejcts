...
Sub FixUNISQLData()
    ...
    UNISqlId(0) = "S3112RA101"  ' main query(spread sheet에 뿌려지는 query statement)
	...
	If Len(Request("txtPayTerms")) Then		
		strVal = strVal & " and  S_SO_HDR.pay_meth = " & FilterVar(Request("txtPayTerms"), "''", "S") & " "
		
	End If	
	
	If Len(Request("txtIncoTerms")) Then		
		strVal = strVal & " and  S_SO_HDR.INCOTERMS = " & FilterVar(Request("txtIncoTerms"), "''", "S") & " "		
	End If		  
