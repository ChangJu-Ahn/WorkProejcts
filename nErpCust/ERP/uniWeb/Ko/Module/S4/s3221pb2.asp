...
Sub FixUNISQLData()
    ...
    UNISqlId(0) = "S3221PA201"									'* : 데이터 조회를 위한 SQL문 만듬 
	...
	If Trim(Request("txtSalesGroup")) <> "" Then
		strVal = strVal& " AND D.sales_grp >= " & FilterVar(UCase(Request("txtSalesGroup")), "''", "S") & " AND D.sales_grp <=  " & FilterVar(UCase(Request("txtSalesGroup")), "''", "S") & ""
	Else
