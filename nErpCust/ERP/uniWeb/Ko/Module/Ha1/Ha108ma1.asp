...
Const BIZ_PGM_ID    = "Ha108mb1.asp"                                      'Biz Logic ASP 
Const BIZ_PGM_ID2   = "ha108mb2.asp"                                 '☆: File Creation Asp Name
...
Sub InitSpreadSheet(ByVal pvSpdNo)
    ...
    If pvSpdNo = "" OR pvSpdNo = "C" Then
    	...
    	With frm1.vspdData2
               ...
               .MaxCols = 55 + 1										'☜: 최대 Columns의 항상 1개 증가시킴 %>	   
    	       .Col = .MaxCols                                                  ' ☜:☜: Hide maxcols
               .ColHidden = True                                                ' ☜:☜:
               ...
               .MaxRows = 0
                ...
                ggoSpread.SSSetEdit     15,	"명예수당또는추가퇴직급여", 24
                ...
                ggoSpread.SSSetEdit     31,	"주(현)근무지입사연월일",               20
                ggoSpread.SSSetEdit     32,	"주(현)근무지퇴사연월일",               20
                ggoSpread.SSSetEdit     33,	"주(현)근무지근속월수",               20
                ggoSpread.SSSetEdit     34,	"주(현)근무지제외월수",               20
                ggoSpread.SSSetEdit     35,	"종(전)근무지입사연월일",               20
                ggoSpread.SSSetEdit     36,	"종(전)퇴사연월일",               20
                ggoSpread.SSSetEdit     37,	"종(전)근속월수",               20
                ggoSpread.SSSetEdit     38,	"종(전)제외월수",               20
                ggoSpread.SSSetEdit     39,	"중복월수",                 10
                ggoSpread.SSSetEdit     40,	"근속연수",                 10
                ggoSpread.SSSetEdit     41,	"퇴직급여액",               12
                ggoSpread.SSSetEdit     42,	"퇴직소득공제",           16
                ggoSpread.SSSetEdit     43,	"퇴직소득과세표준",         18
                ggoSpread.SSSetEdit     44,	"연평균과세표준",           16
                ggoSpread.SSSetEdit     45,	"연평균산출세액",           16
                ggoSpread.SSSetEdit     46,	"산출세액",                 10
                ggoSpread.SSSetEdit     47, "소득세",                   8
                ggoSpread.SSSetEdit     48,	"주민세",                   8
                ggoSpread.SSSetEdit     49,	"농특세",             14
                ggoSpread.SSSetEdit     50,	"계",                       12
                ggoSpread.SSSetEdit     51,	"소득세",                   8
                ggoSpread.SSSetEdit     52,	"주민세",                   8
                ggoSpread.SSSetEdit     53,	"농특세",             14
                ggoSpread.SSSetEdit     54,	"계",                       12
                ggoSpread.SSSetEdit     55,	"공란",                       12
