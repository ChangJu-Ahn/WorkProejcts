...
Const BIZ_PGM_ID    = "ha111mb1.asp"                                      'Biz Logic ASP 
Const BIZ_PGM_ID2   = "ha111mb2.asp"                                 '☆: File Creation Asp Name
...
'StartDate = "2004-12-31"
    ...
    'frm1.txtStrt_dt.Text = UniConvDateAToB(StartDate,parent.gServerDateFormat,parent.gDateFormat)
...
Sub MakeKeyStream(pRow)
   ...
   lgKeyStream    = Trim(Frm1.txtGubun.value) & parent.gColSep       ' 0 You Must append one character(parent.gColSep)
   ...
   lgKeyStream    = lgKeyStream & Trim(frm1.txtStrt_dt.Year) & parent.gColSep  '8 5의 년도 
   lgKeyStream    = lgKeyStream & Trim(frm1.txtBas_dt.Year) & parent.gColSep   '9 6의 년도 
...
Dim RetFlag
    ...
    If Not(ValidDateCheckThisForm(frm1.txtStrt_dt, frm1.txtBas_dt)) Then        
        Exit Sub
    End If
					...
					<TD CLASS="CLSMTABP">
						<TABLE ID="MyTab" CELLSPACING=0 CELLPADDING=0>
							<TR>
								...
								<td background="../../../CShared/image/table/seltab_up_bg.gif" align="center" CLASS="CLSMTABP"><font color=white>통합퇴직정산신고(명예퇴직)</font></td>
					...
					<TD HEIGHT=20>
						...
						<TABLE <%=LR_SPACE_TYPE_40%>>
						    ...
						    <TR>
								...
								<TD CLASS=TD6  NOWRAP><script language =javascript src='./js/ha111ma1_fpDateTime1_txtDt.js'></script></TD>															
							</TR>
							<TR>
								...
								<TD CLASS=TD6  NOWRAP><script language =javascript src='./js/ha111ma1_fpDateTime2_txtStrt_dt.js'></script>&nbsp;~&nbsp;
								                      <script language =javascript src='./js/ha111ma1_fpDateTime3_txtBas_dt.js'></script></TD>
							</TR>
						</TABLE>
						</FIELDSET>
					</TD>
						...
						<TABLE <%=LR_SPACE_TYPE_60%>>
            			    <TR >
            					<TD WIDTH="50%" HEIGHT=*>
	            					<TABLE WIDTH="100%" HEIGHT="100%">
	            						<TR>
	            							<TD HEIGHT="100%"><script language =javascript src='./js/ha111ma1_vaSpread_vspdData.js'></script></TD>
		               					</TR>
					            	</TABLE>
		            			</TD>
            					<TD WIDTH="50%" HEIGHT=*>
	            					<TABLE WIDTH="100%" HEIGHT="100%">
	            						<TR>
	            							<TD HEIGHT="100%"><script language =javascript src='./js/ha111ma1_vaSpread1_vspdData1.js'></script></TD>
		               					</TR>
					            	</TABLE>
		            			</TD>
                            </TR>  
                            <TR HEIGHT="70%">
				            	<TD WIDTH="100%" HEIGHT=* VALIGN=TOP COLSPAN=3>
				            		<TABLE WIDTH="100%" HEIGHT="100%">
				            			<TR>
				            				<TD HEIGHT="100%"><script language =javascript src='./js/ha111ma1_vaSpread2_vspdData2.js'></script></TD>
					            		</TR>
					            	</TABLE>
					            </TD>
			                </TR>
