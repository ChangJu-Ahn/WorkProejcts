...
*  2. Function Name        : 상여인상분계산 
*  3. Program ID           : H8002ba1
*  4. Program Name         : H8002ba1
*  5. Program Desc         : 급.상여소급분관리/상여인상분계산 
*  6. Comproxy List        :
...
'=======================================================================================================
Sub SetDefaultVal()
	frm1.txtBas_dt.Text = UniConvDateAToB("<%=GetSvrDate%>" ,Parent.gServerDateFormat,Parent.gDateFormat)  '년월일 default value setting
	frm1.txtBonus_yymm_dt.Text = UniConvDateAToB(frm1.txtBas_dt.Text ,Parent.gDateFormat,Parent.gDateFormatYYYYMM)  '년월일 default value setting
...
Function ExeReflect() 
	...
	strBonusYYYY = frm1.txtbonus_yymm_dt.Year
	strBonusMM = frm1.txtbonus_yymm_dt.Month
	If len(strBonusMM) = 1 Then
		strBonusMM = "0" & strBonusMM
	End if
	strBonusDt = strBonusYYYY & strBonusMM
	...
	strVal = strVal & "&txtbonus_yymm_dt=" & strBonusDt
	strVal = strVal & "&txtbas_dt=" & UNIConvDate(frm1.txtbas_dt.text)
...
'======================================================================================================
'   Event Name : txtbas_dt_dt_DblClick
'   Event Desc : 달력 Popup을 호출 
'=======================================================================================================
					...
					<TD>
						<TABLE ID="MyTab" CELLSPACING=0 CELLPADDING=0>
							<TR>
								...
								<td background="../../../CShared/image/table/seltab_up_bg.gif" align="center" CLASS="CLSMTAB"><font color=white>상여인상분계산</font></td>
				...
				<TR>
					<TD HEIGHT=20>
						<TABLE <%=LR_SPACE_TYPE_40%>WIDTH=100%>   
							<TR>
								<TD CLASS=TD5 NOWRAP>인상분계산년월</TD>
								<TD CLASS=TD6 NOWRAP><script language =javascript src='./js/h8002ba1_txtbonus_yymm_dt_txtbonus_yymm_dt.js'></script></TD>
							</TR>
							<TR>
								<TD CLASS=TD5 NOWRAP>작업대상명</TD>
								<TD CLASS=TD6 NOWRAP><SELECT Name="txtprov_type" ALT="작업대상명" CLASS ="cbonormal" tag="12"></SELECT></TD>
							</TR>
							<TR>	
								<TD CLASS=TD5 NOWRAP>상여기준일</TD>
								<TD CLASS=TD6 NOWRAP><script language =javascript src='./js/h8002ba1_txtbas_dt_txtbas_dt.js'></script></TD>
							</TR>
    						<TR>
