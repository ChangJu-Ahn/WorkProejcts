    ...
    If pvSpdNo = "" OR pvSpdNo = "A" Then
	    ...
	    With frm1.vspdData
           ...
           .MaxRows = 0
            ...
            ggoSpread.SSSetEdit C_PAY_GRD1           , "직급", 11,,, 50,2
            ggoSpread.SSSetFloat C_EMP_COUNT         , "인원"            ,7,"6",ggStrIntegeralPart, ggStrDeciPointPart,Parent.gComNum1000,Parent.gComNumDec
            ggoSpread.SSSetFloat C_ORIGINAL_BASE_AMT , "원지급분기본수당",17,Parent.ggAmtOfMoneyNo,ggStrIntegeralPart, ggStrDeciPointPart,Parent.gComNum1000,Parent.gComNumDec
            ggoSpread.SSSetFloat C_ORIGINAL_OTHER_AMT, "원지급분기타수당",17,Parent.ggAmtOfMoneyNo,ggStrIntegeralPart, ggStrDeciPointPart,Parent.gComNum1000,Parent.gComNumDec
	        ggoSpread.SSSetFloat C_RAISE_BASE_AMT    , "인상분기본수당"  ,16,Parent.ggAmtOfMoneyNo,ggStrIntegeralPart, ggStrDeciPointPart,Parent.gComNum1000,Parent.gComNumDec
	        ggoSpread.SSSetFloat C_RAISE_OTHER_AMT   , "인상분기타수당"  ,16,Parent.ggAmtOfMoneyNo,ggStrIntegeralPart, ggStrDeciPointPart,Parent.gComNum1000,Parent.gComNumDec
	        ggoSpread.SSSetFloat C_RETRO_BASE_AMT    , "소급분기본수당"  ,17,Parent.ggAmtOfMoneyNo,ggStrIntegeralPart, ggStrDeciPointPart,Parent.gComNum1000,Parent.gComNumDec
	        ggoSpread.SSSetFloat C_RETRO_OTHER_AMT   , "소급분기타수당"  ,16,Parent.ggAmtOfMoneyNo,ggStrIntegeralPart, ggStrDeciPointPart,Parent.gComNum1000,Parent.gComNumDec
...
'========================================================================================================
'   Event Name : txtpay_grd1_Onchange()             '<==코드만 입력해도 앤터키,탭키를 치면 코드명을 불러준다 
'   Event Desc :
'========================================================================================================
					...
					<TD CLASS="CLSMTABP">
						<TABLE ID="MyTab" CELLSPACING=0 CELLPADDING=0>
							<TR>
								...
								<td background="../../../CShared/image/table/seltab_up_bg.gif" align="center" CLASS="CLSMTABP"><font color=white>소급급여직급별조회</font></td>
					  ...
					  <FIELDSET CLASS="CLSFLD">
					   <TABLE <%=LR_SPACE_TYPE_40%>>
						    <TR>
								...
								<TD CLASS=TD6 NOWRAP><INPUT NAME="txtpay_grd1" ALT="직급" TYPE="Text" SiZE="10" MAXLENGTH="2" tag="11XXXU"><IMG SRC="../../../CShared/image/btnPopup.gif" NAME="btnSItemDC" ALIGN=top TYPE="BUTTON" ONCLICK="VBScript: OpenCondAreaPopup('1')">
								                    <INPUT NAME="txtpay_grd1_nm" ALT="직급" TYPE="Text" SiZE="20" MAXLENGTH="50" tag="14XXXU"></td>
			               </TR>
	                   </TABLE>
				     </FIELDSET>
				   </TD>
