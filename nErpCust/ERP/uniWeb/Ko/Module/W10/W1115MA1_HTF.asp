...
<%
'======================================================================================================
'*  1. Function Name        : 제3호의3(3) 부속명세 운송원가 
...
Function MakeHTF_W1115MA1()
	...
	Do Until lgcTB_3_3_3.EOF 
		...
		If  ChkNotNull(lgcTB_3_3_3.W5, lgcTB_3_3_3.W3) Then 
					...
					If lgcTB_3_3_3.W4 = "01" Then   '코드(01)재료비= 코드 02 + 03 + 04 + 05
					...
					If lgcTB_3_3_3.W4 = "06" Then	 '- 코드(06)노무비= 코드 07 + 08 + 09
						oRs2.Find "W4 = '07'"		' 해당코드는 반드시 존재해야, 다음행에서 에러가 안남 
						dblAmt1 = UNICDbl(oRs2("W5"), 0)
					...
					If lgcTB_3_3_3.W4 = "10" Then   '- 코드(10)경비= = 코드 11 + 12 + 13 + 14 + 15 + 16 + 17 + 18 + 22 + 23 + 24 + 25 + 26+ 27 + 28
						...
						If UNICDbl(lgcTB_3_3_3.W5, 0) <> dblAmt1  Then
						   Call SaveHTFError(lgsPGM_ID, UNICDbl(lgcTB_3_3_3.W5, 0), UNIGetMesg(TYPE_CHK_NOT_EQUAL, "경비","코드코드 11 + 12 + 13 + 14 + 15 + 16 + 17 + 18 + 22 + 23 + 24 + 25 + 26+ 27 + 28"))
						   blnError = True	
						End If	
					...
					If lgcTB_3_3_3.W4 = "18" Then	 '코드(18)임차료= 코드 19 + 20 + 21
						oRs2.MoveFirst				' 이전 레코드로 돌아가서 검색하고자할때 MoveFirst해야됨 
						oRs2.Find "W4 = '19'"		' 해당코드는 반드시 존재해야, 다음행에서 에러가 안남 
						dblAmt1 = UNICDbl(oRs2("W5"), 0)
						...
						If UNICDbl(lgcTB_3_3_3.W5, 0) <> dblAmt1 + dblAmt2 + dblAmt3 Then
						    Call SaveHTFError(lgsPGM_ID, UNICDbl(lgcTB_3_3_3.W5, 0), UNIGetMesg(TYPE_CHK_NOT_EQUAL, "임차료","코드 19 + 20 + 21"))
							blnError = True	
						End If
					...
					If lgcTB_3_3_3.W4 = "30" Then	 '- 코드(30)당기총운송원가= 코드 01 + 06 + 10 - 29
					    oRs2.MoveFirst	
						...
						If UNICDbl(lgcTB_3_3_3.W5, 0) <> dblAmt1 Then
						    Call SaveHTFError(lgsPGM_ID, lgcTB_3_3_3.W5, UNIGetMesg(TYPE_CHK_NOT_EQUAL, "당기총운송원가"," 코드 01 + 06 + 10 - 29"))
							blnError = True	
						End If
