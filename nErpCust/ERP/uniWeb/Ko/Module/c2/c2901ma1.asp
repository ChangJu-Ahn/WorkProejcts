...
*  3. Program ID           : C2901MA1.ASP
*  4. Program Name         : 표준원가반영 
*  5. Program Desc         : 표준원가 재고표준단가 반영 
*  6. Comproxy List        :
...
'========================================================================================================
Const BIZ_PGM_ID = "C2901MB1.asp"                                      'Biz Logic ASP 
'========================================================================================================
...
Sub InitSpreadSheet()
	...
	With frm1.vspdData
       ...
       'Call AppendNumberPlace("6","2","0")
		...
		ggoSpread.SSSetFloat C_StdPrc,"표준단가",15,Parent.ggUnitCostNo,ggStrIntegeralPart, ggStrDeciPointPart,Parent.gComNum1000,Parent.gComNumDec
					...
					<TD CLASS="CLSMTABP">
						<TABLE ID="MyTab" CELLSPACING=0 CELLPADDING=0>
							<TR>
								...
								<td background="../../../CShared/image/table/seltab_up_bg.gif" align="center" CLASS="CLSMTABP"><font color=white>표준원가반영</font></td>
			...
			<TABLE <%=LR_SPACE_TYPE_20%>>
				...
				<TR>
					<TD WIDTH=100% HEIGHT=100% VALIGN=top COLSPAN=4>
						<script language =javascript src='./js/c2901ma1_vaSpread1_vspdData.js'></script>
					</TD>
				</TR>
			</TABLE>
		</TD>
