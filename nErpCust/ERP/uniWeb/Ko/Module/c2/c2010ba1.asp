...
'*  3. Program ID           : c2010ba1
'*  4. Program Name         : 표준원가 계산 
...
'**********************************************************************************************************
Const BIZ_PGM_ID = "c2010bb1.asp"												'☆: 비지니스 로직 ASP명 
					...
					<TD CLASS="CLSMTABP">
						<TABLE ID="MyTab" CELLSPACING=0 CELLPADDING=0>
							<TR>
								...
								<td background="../../../CShared/image/table/seltab_up_bg.gif" align="center" CLASS="CLSMTAB"><font color=white>표준원가계산</font></td>
					...
					<TD WIDTH=100% HEIGHT=* valign=top>
						<TABLE <%=LR_SPACE_TYPE_60%>>
							...
							<TR>
								...
								<TD CLASS=TD6 NOWRAP><INPUT TYPE=CHECKBOX NAME="chkMaterial" ID="chkMaterial" tag="11X" Class="RADIO" VALUE="Y"><LABEL FOR="chkMaterial">재료비 계산</LABEL></TD>
							</TR>
							<TR>
								<TD CLASS=TD5 NOWRAP>&nbsp;</TD>
								<TD CLASS=TD6 NOWRAP><INPUT TYPE=CHECKBOX NAME="chkProcess" ID="chkProcess" tag="11X" Class="RADIO" VALUE="Y"><LABEL FOR="chkProcess">가공비 계산</LABEL></TD>
							</TR>
							<TR>
								<TD CLASS=TD5 NOWRAP>&nbsp;</TD>
								<TD CLASS=TD6 NOWRAP><INPUT TYPE=CHECKBOX NAME="chkIndirect" ID="chkIndirect" tag="11X" Class="RADIO" VALUE="Y"><LABEL FOR="chkIndirect">간접비 계산</LABEL></TD>
							</TR>
							<TR>
								<TD CLASS=TD5 NOWRAP>&nbsp;</TD>
