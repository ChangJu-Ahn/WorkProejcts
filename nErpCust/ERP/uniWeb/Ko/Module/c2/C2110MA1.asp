...
Const BIZ_PGM_ID = "c2110mb8.asp"			'☆: 비지니스 로직 ASP명 
Const BIZ_PGM_DTL_ID = "c2110mb6.asp"			'☆: 비지니스 로직 ASP명 
const BIZ_PGM_BOM_ID = "c2110mb7.asp"	 '☆: 비지니스 로직 ASP명 
					...
					<TD WIDTH=100% HEIGHT=100% valign=top>
						...
						<DIV ID="TabDiv" STYLE="FLOAT: left; HEIGHT: 100%; WIDTH: 100%;" SCROLL=no>
							<TABLE <%=LR_SPACE_TYPE_20%>>
								<TR>
									<TD HEIGHT="100%">
									<script language =javascript src='./js/c2110ma1_vaSpread1_vspdData.js'></script></TD>
								</TR>
							</TABLE>
						</DIV>
							...
							<TABLE <%=LR_SPACE_TYPE_60%>>
							    <TR>
									<TD HEIGHT=100% WIDTH=40%>
										<script language =javascript src='./js/c2110ma1_uniTree1_N913131296.js'></script>
									</TD>
								    <TD HEIGHT=100% WIDTH=60%>
										...
										<FIELDSET CLASS="CLSFLD" STYLE="HEIGHT: 24%">        							        
											<TABLE CLASS="BasicTB" CELLSPACING=0 CELLPADDING=2>
												...
												<TR>
							                        ...
							                        <TD CLASS=TD6 NOWRAP>
													<script language =javascript src='./js/c2110ma1_OBJECT1_txtDi_Mcost.js'></script>
													</TD>
							                        <TD CLASS=TD6 NOWRAP>
													<script language =javascript src='./js/c2110ma1_OBJECT2_txtInd_Mcost.js'></script>
													</TD>
												</TR>
												<TR>
													<TD CLASS=TD5 NOWRAP>노무비</TD>
							                        <TD CLASS=TD6 NOWRAP>
													<script language =javascript src='./js/c2110ma1_OBJECT3_txtDi_Lcost.js'></script>
													</TD>
							                        <TD CLASS=TD6 NOWRAP>
													<script language =javascript src='./js/c2110ma1_OBJECT4_txtInd_Lcost.js'></script>
													</TD>
												</TR>
												<TR>
													<TD CLASS=TD5 NOWRAP>경비</TD>
							                        <TD CLASS=TD6 NOWRAP>
													<script language =javascript src='./js/c2110ma1_OBJECT5_txtDi_Ecost.js'></script>
													</TD>
							                        <TD CLASS=TD6 NOWRAP>
													<script language =javascript src='./js/c2110ma1_OBJECT6_txtInd_Ecost.js'></script>
													</TD>
												</TR>
										    </TABLE>	
										 </FIELDSET>	    
										 ...
										 <FIELDSET CLASS="CLSFLD">			
									        <TABLE CELLSPACING=0 CELLPADDING=4 WIDTH="100%">
												<TR>
							                        ...
							                        <TD CLASS=TD6 NOWRAP>
													<script language =javascript src='./js/c2110ma1_OBJECT7_txtDi_Sum.js'></script>
													</TD>
							                        <TD CLASS=TD6 NOWRAP>
													<script language =javascript src='./js/c2110ma1_OBJECT8_txtInd_Sum.js'></script>
													</TD>
												</TR>
												<TR>
													<TD CLASS=TD5 NOWRAP>내부원가</TD>
							                        <TD CLASS=TD6 NOWRAP>
													<script language =javascript src='./js/c2110ma1_OBJECT9_txtInDi_Sum.js'></script>
													</TD>
							                        <TD CLASS=TD6 NOWRAP>
													<script language =javascript src='./js/c2110ma1_OBJECT10_txtInInd_Sum.js'></script>
													</TD>
												</TR>
												<TR>
													<TD CLASS=TD5 NOWRAP HEIGHT=10>외부원가</TD>
													<TD CLASS=TD6 NOWRAP>
													<script language =javascript src='./js/c2110ma1_OBJECT11_txtOutDi_Sum.js'></script>
													</TD>
													<TD CLASS=TD6 NOWRAP>
													<script language =javascript src='./js/c2110ma1_OBJECT12_txtOutInd_Sum.js'></script>
													</TD>													
												</TR>
											</table>
										</FIELDSET>	    
										...
										<FIELDSET CLASS="CLSFLD" STYLE="HEIGHT: 42%">	
											<TABLE WIDTH=100% HEIGHT=100% CELLSPACING=0 CELLPADDING=0>
												<TR>
													<TD HEIGHT=150>
													<script language =javascript src='./js/c2110ma1_vaSpread1_vspdData2.js'></script></TD>
												</TR>
											</TABLE>
										</FIELDSET>
									</TD>
...
<script language =javascript src='./js/c2110ma1_fpDateTime1_txtPlantItemFromDt.js'></script>
							&nbsp;~&nbsp;
<script language =javascript src='./js/c2110ma1_fpDateTime2_txtPlantItemToDt.js'></script>

<script language =javascript src='./js/c2110ma1_I361810207_txtValidFromDt.js'></script>
&nbsp;~&nbsp;
<script language =javascript src='./js/c2110ma1_I613136357_txtValidToDt.js'></script>
