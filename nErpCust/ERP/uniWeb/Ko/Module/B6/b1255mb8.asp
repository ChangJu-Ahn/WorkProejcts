...
Sub FixUNISQLData()
    ...
    UNISqlId(0) = "B1255MA801"			'* : 데이터 조회를 위한 SQL문 만듬 
	
	UNISqlId(1) = "B1255MA802"			'영업조직 
	UNISqlId(2) = "B1255MA802"			'상위영업조직 
...
Sub QueryData()
    ...
    If  rs1.EOF And rs1.BOF Then
        ...
        If Len(Request("txtSales_Org")) And BlankchkFlg = False Then
		   Call DisplayMsgBox("970000", vbInformation, "영업조직", "", I_MKSCRIPT)	
	       BlankchkFlg = True
            ' Modify Focus Events    
            %>
                <Script language=vbs>
    ...
    If  rs2.EOF And rs2.BOF Then
        ...
        If Len(Request("txtUpper_Sales_Org")) And BlankchkFlg = False Then
		   Call DisplayMsgBox("970000", vbInformation, "상위영업조직", "", I_MKSCRIPT)	'⊙: you must release this line if you change msg into code
	       BlankchkFlg = True
            ' Modify Focus Events    
            %>
                <Script language=vbs>
