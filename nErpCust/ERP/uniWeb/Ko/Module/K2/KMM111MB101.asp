...
Sub MakeSpreadSheetData()
	...
	Const M_MC_SPPL_INV_LIST_D_BILL_NO			= 0
	Const M_MC_SPPL_INV_LIST_D_BILL_SEQ_NO      = 1
	Const M_MC_SPPL_INV_LIST_D_CUST_ITEM_CD     = 2
	Const B_ITEM_ITEM_NM                        = 3
	Const B_ITEM_SPEC                           = 4
	Const M_MC_SPPL_INV_LIST_D_BILL_QTY         = 5
	Const M_MC_SPPL_INV_LIST_D_BILL_UNIT        = 6
	Const M_MC_SPPL_INV_LIST_D_BILL_PRC         = 7
	Const M_MC_SPPL_INV_LIST_D_BILL_DOC_AMT     = 8
	Const M_MC_SPPL_INV_LIST_D_VAT_DOC_AMT      = 9
	Const M_MC_SPPL_INV_LIST_D_VAT_TYPE         = 10
	Const M_MC_SPPL_INV_LIST_D_VAT_TYPE_NM      = 11
	Const M_MC_SPPL_INV_LIST_D_VAT_RATE         = 12
	Const M_MC_SPPL_INV_LIST_D_VAT_INC          = 13
   ...
   Do while Not (rs0.EOF Or rs0.BOF)
		...
		iRowStr = iRowStr & Chr(11) & UNINumClientFormat(rs0(M_MC_SPPL_INV_LIST_D_VAT_DOC_AMT), ggAmtOfMoney.DecPoint,0)     '부가세금액             
		iRowStr = iRowStr & Chr(11) & ConvSPChars(rs0(M_MC_SPPL_INV_LIST_D_VAT_TYPE))                                       '부가세유형    
		iRowStr = iRowStr & Chr(11) & ConvSPChars(rs0(M_MC_SPPL_INV_LIST_D_VAT_TYPE_NM))                                    '부가세유형명  
		iRowStr = iRowStr & Chr(11) & UNINumClientFormat(rs0(M_MC_SPPL_INV_LIST_D_VAT_RATE), ggExchRate.DecPoint,6)         '부가세율      
		IF rs0(M_MC_SPPL_INV_LIST_D_VAT_INC) = "1" Then
			iStrVatIncFlg = "별도"
		Else
			iStrVatIncFlg = "포함"			
		End if	
