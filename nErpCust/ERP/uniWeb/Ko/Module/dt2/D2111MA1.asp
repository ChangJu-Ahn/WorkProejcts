...
Const BIZ_PGM_ID = "D2111mb1.asp"												<%'비지니스 로직 ASP명 %>
...
Sub InitSpreadSheet()
   ...
   'patch version
    ...
    .MaxCols = C_smartbill_pw + 1							'☜: 최대 Columns의 항상 1개 증가시킴 
	...
	ggoSpread.SSSetEdit		C_user_id,		"ERP 사용자", 15,,,15,2
	ggoSpread.SSSetButton	C_user_id_pop
	ggoSpread.SSSetEdit		C_user_name,	"ERP 사용자명", 20,,,20,2
