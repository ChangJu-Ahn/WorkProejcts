...
'*  3. Program ID           : W3105RA1
'*  4. Program Name         : W3105RA1.asp
'*  5. Program Desc         : 채권 금액 조회 팝업 
...
'========================================================================================================
Const BIZ_PGM_ID 		= "w3105rb1.asp"                              '☆: Biz Logic ASP Name
...
Sub InitSpreadSheet()
	...
	With frm1.vspdData
		...
		ggoSpread.SSSetEdit		C_SEQ_NO,	"순번",			0,,,100,1
		ggoSpread.SSSetEdit		C_W1,		"계정코드",		10,,,100,1
		ggoSpread.SSSetEdit		C_W1_NM,	"계정명",		25,,,100,1
	    ggoSpread.SSSetFloat	C_W2,		"채권잔액의 장부가액", 15,		PopupParent.ggAmtOfMoneyNo,		ggStrIntegeralPart,		ggStrDeciPointPart,		PopupParent.gComNum1000,		PopupParent.gComNumDec ,,,,"0","" 
	    ggoSpread.SSSetFloat	C_W3,		"대손금부인누계", 15,		PopupParent.ggAmtOfMoneyNo,		ggStrIntegeralPart,		ggStrDeciPointPart,		PopupParent.gComNum1000,		PopupParent.gComNumDec ,,,,"0","" 
...
Sub SetSpreadLock()
	...
	ggoSpread.SpreadLock C_W1, -1, -1
	ggoSpread.SpreadLock C_W1_NM, -1, -1
	ggoSpread.SpreadLock C_W2, -1, -1
	ggoSpread.SpreadLock C_W3, -1, -1
			...
			<FIELDSET CLASS="CLSFLD">
				<TABLE <%=LR_SPACE_TYPE_40%>>
					<TR>
						...
						<TD CLASS="TD6"><script language =javascript src='./js/w3105ra1_txtFISC_YEAR_txtFISC_YEAR.js'></script></TD>
						<TD CLASS="TD5">법인명</TD>
	...
	<TR HEIGHT=100%>
		<TD WIDTH=100% HEIGHT=* VALIGN=TOP>
			<TABLE <%=LR_SPACE_TYPE_20%>>
				<TR HEIGHT=100%>
					<TD WIDTH=100%>
						<script language =javascript src='./js/w3105ra1_I223308712_vspdData.js'></script>
					</TD>
				</TR>
			</TABLE>
		</TD>
