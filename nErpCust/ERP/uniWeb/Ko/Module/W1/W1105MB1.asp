...
Sub SubBizDelete()
    ...
    lgStrSQL = "DELETE  TB_3_3 WITH (ROWLOCK) "
...
Sub SubBizSaveSingleCreate()
    ...
    For iDx = 1 To lgLngMaxRow
	    ...
	    lgStrSQL =            " INSERT INTO TB_3_3 WITH (ROWLOCK) "
...
Sub SubBizSaveSingleUpdate()
    ...
    For iDx = 1 To lgLngMaxRow
	    ...
	    lgStrSQL =            "UPDATE TB_3_3 WITH (ROWLOCK) " & vbCrLf
...
Sub SubMakeSQLStatements(pMode,pCode1,pCode2,pCode3)
    ...
    Select Case pMode 
      Case "R"
			...
			lgStrSQL =			  " SELECT a.CO_CD, a.FISC_YEAR, a.REP_TYPE, a.W1, a.W2, c.PAR_GP_CD, SPACE((c.GP_LVL * 2)) + a.W3 AS W3, a.W4, a.W5, c.SUM_FG, c.GP_LVL, c.GP_SEQ " & vbCrLf
            lgStrSQL = lgStrSQL & "  FROM TB_3_3 a WITH (NOLOCK)  " & vbCrLf
            lgStrSQL = lgStrSQL & "		INNER JOIN TB_COMPANY_HISTORY B WITH (NOLOCK) ON A.CO_CD=B.CO_CD AND A.FISC_YEAR=B.FISC_YEAR AND A.REP_TYPE=B.REP_TYPE AND A.W1=B.COMP_TYPE2" & vbCrLf
            lgStrSQL = lgStrSQL & "		INNER JOIN dbo.ufn_TB_ACCT_GP('" & C_REVISION_YM & "') c ON A.W1=C.COMP_TYPE2 AND A.W2=C.GP_CD" & vbCrLf
            lgStrSQL = lgStrSQL & "  WHERE a.CO_CD = " & pCode1 	 & vbCrLf
            'lgStrSQL = lgStrSQL & "  AND b.CO_CD = a.CO_CD " & vbCrLf
            'lgStrSQL = lgStrSQL & "  AND a.W1 = b.COMP_TYPE2 " & vbCrLf
            lgStrSQL = lgStrSQL & "  AND a.FISC_YEAR = " & pCode2 	 & vbCrLf
            lgStrSQL = lgStrSQL & "  AND a.REP_TYPE = " & pCode3 	 & vbCrLf
            'lgStrSQL = lgStrSQL & "  AND c.CO_CD = a.CO_CD " & vbCrLf
            'lgStrSQL = lgStrSQL & "  AND c.COMP_TYPE2 = a.W1 " & vbCrLf
            'lgStrSQL = lgStrSQL & "  AND c.GP_CD = a.W2 " & vbCrLf
            

            lgStrSQL = lgStrSQL & "  ORDER BY LEFT(a.W2, 1), c.GP_SEQ " & vbCrLf
