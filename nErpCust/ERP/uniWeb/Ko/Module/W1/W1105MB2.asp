...
Sub SubMakeSQLStatements(pMode,pCode1,pCode2, pCode3)
    ...
    Select Case pMode 
      Case "R"
			...
			lgStrSQL =			  " SELECT a.GP_CD, a.PAR_GP_CD, SPACE((GP_LVL * 2)) + a.GP_PRN_NM AS GP_NM, FORM_REP_NO AS FISC_CD, 0 AS AMT, SUM_FG, GP_LVL, a.COMP_TYPE2 " & vbCrLf
            ...
            lgStrSQL = lgStrSQL & "  WHERE a.BS_PL_FG = '2' " & vbCrLf
