...
'*  4. Program Name         : 제3호의3(3) 부속명세서-운송원가명세서 
'*  5. Program Desc         : 제3호의3(3) 부속명세서-운송원가명세서 등록/조회 
'*  6. Component List       : 
...
'
'서식간 검증 
'      27.접대비 >0 인경우 47호(갑) (117)의 ③ < 0 이면 오류	오류	WC0024	법인세 제47호(갑) 주요계정명세서의 접대비중 ③회사계상금액이 존재하지 않습니다.	%1의 %2중 %3이 존재하지 않습니다.
'***********************************************************************k*********************** -->
...
Const BIZ_PGM_ID 		= "W1115MB1.asp"											 '☆: 비지니스 로직 ASP명 
Const BIZ_PGM_ID2 		= "W1115MB2.asp"											 '☆: 비지니스 로직 ASP명 
...
'      ggoSpread.SpreadLockWithOddEvenRowColor()
   ...
   With frm1
	...
	ggoSpread.SSSetProtected C_AMT, 6, 6
...
'	FORM_REP_NO	:	01		( 02 + 03 + 04 + 05 ) 를 계산하여 입력함.	
'					02~05		사용자가 직접숫자로 입력함.	
'					06		( 07 + 08 + 09 ) 를 계산하여 입력함.	
'					07~09		사용자가 직접숫자로 입력함.	
'					10		11~18, 22~28 의 합계의 합계를 계산하여 입력함.	
'					11~17		사용자가 직접숫자로 입력함.	
'					18		( 19 + 20 + 21 )를 계산하여 입력함.	
'					22~29		사용자가 직접숫자로 입력함.	
'					30		( 01 + 06 + 10 - 29 ) 를 계산하여 입력함.	
'========================================================================================================
Function SubMakeSum()
	Dim iSchRow
	Dim iSumAmt
	...
	'18		( 19 + 20 + 21 )를 계산하여 입력함.	
	iSchRow = Frm1.vspdData.SearchCol(C_FORM_REP_NO, 0, Frm1.vspdData.MaxRows, "19", 0)
   	Frm1.vspdData.Row = iSchRow
	Frm1.vspdData.Col = C_AMT
	iSumAmt = UNICDbl(Frm1.vspdData.text)

	iSchRow = Frm1.vspdData.SearchCol(C_FORM_REP_NO, 0, Frm1.vspdData.MaxRows, "20", 0)
   	Frm1.vspdData.Row = iSchRow
	Frm1.vspdData.Col = C_AMT
	iSumAmt = iSumAmt + UNICDbl(Frm1.vspdData.text)

	iSchRow = Frm1.vspdData.SearchCol(C_FORM_REP_NO, 0, Frm1.vspdData.MaxRows, "21", 0)
   	Frm1.vspdData.Row = iSchRow
	Frm1.vspdData.Col = C_AMT
	iSumAmt = iSumAmt + UNICDbl(Frm1.vspdData.text)

	iSchRow = Frm1.vspdData.SearchCol(C_FORM_REP_NO, 0, Frm1.vspdData.MaxRows, "18", 0)
   	Frm1.vspdData.Row = iSchRow
	Frm1.vspdData.Col = C_AMT
	Frm1.vspdData.text  = iSumAmt
					...
					<TD CLASS="CLSMTABP_BAK">
						<TABLE ID="MyTab" CELLSPACING=0 CELLPADDING=0>
							<TR>
								...
								<td background="../../../CShared/image/table/seltab_up_bg.gif" align="center" CLASS="CLSMTABP_BAK"><font color=white>제3호의3(3) 부속명세 운송원가</font></td>
