...
'*  4. Program Name         : 제3호의3(3) 부속명세서-제조원가명세서 
'*  5. Program Desc         : 제3호의3(3) 부속명세서-제조원가명세서 등록/조회 
'*  6. Component List       : 
...
Const BIZ_PGM_ID 		= "W1107MB1.asp"											 '☆: 비지니스 로직 ASP명 
Const BIZ_PGM_ID2 		= "W1107MB2.asp"											 '☆: 비지니스 로직 ASP명 
Const EBR_RPT_ID		= "W1107OA" 
...
'      ggoSpread.SpreadLockWithOddEvenRowColor()
   ...
   With frm1
	...
	ggoSpread.SSSetProtected C_AMT, 9, 9
	'ggoSpread.SSSetProtected C_AMT, 30, 30
...
'	FORM_REP_NO	:	01		( 02 + 03 - 04 ) 를 계산하여 입력함.
'					02 ~ 04		사용자가 숫자로 직접입력함.
'					05		( 06 + 07 + 08 ) 를 계산하여 입력함.
'					06 ~ 08		사용자가 숫자로 직접입력함.
'					09		10 ~ 28 까지의 합계를 입력함.
'					10 ~ 28		사용자가 숫자로 직접입력함.
'					29		( 01 + 05 + 09 ) 를 계산하여 입력함.
'					30		사용자가 숫자로 직접입력함.
'					31		( 29 + 30 ) 를 계산하여 입력함.
					...
					<TD CLASS="CLSMTABP_BAK">
						<TABLE ID="MyTab" CELLSPACING=0 CELLPADDING=0>
							<TR>
								...
								<td background="../../../CShared/image/table/seltab_up_bg.gif" align="center" CLASS="CLSMTABP_BAK"><font color=white>제3호의3(3) 부속명세 제조원가</font></td>
