...
'*  4. Program Name         : 제3호의3(3) 부속명세서-공사원가명세서 
'*  5. Program Desc         : 제3호의3(3) 부속명세서-공사원가명세서 등록/조회 
'*  6. Component List       : 
...
'
'서식간 검증 
'      22.접대비 >0 인경우 47호(갑) (117)의 ③ < 0 이면 오류	오류	WC0024	법인세 제47호(갑) 주요계정명세서의 접대비중 ③회사계상금액이 존재하지 않습니다.	%1의 %2중 %3이 존재하지 않습니다.
'***********************************************************************k*********************** -->
...
Const BIZ_PGM_ID 		= "W1109MB1.asp"											 '☆: 비지니스 로직 ASP명 
Const BIZ_PGM_ID2 		= "W1109MB2.asp"											 '☆: 비지니스 로직 ASP명 
...
'					06 ~ 09		사용자가 숫자로 직접입력함.
'					10		11 ~ 25 까지의 합계를 입력함.
'					11 ~ 25		사용자가 숫자로 직접입력함.
'					26		( 01 + 05 + 09 + 10 ) 를 계산하여 입력함.
'					27 ~ 28		사용자가 숫자로 직접입력함.
'					29		( 26 + 27 + 28 ) 를 계산하여 입력함.
'					30		사용자가 숫자로 직접입력함.
'					31		사용자가 숫자로 직접입력함.
					...
					<TD CLASS="CLSMTABP_BAK">
						<TABLE ID="MyTab" CELLSPACING=0 CELLPADDING=0>
							<TR>
								...
								<td background="../../../CShared/image/table/seltab_up_bg.gif" align="center" CLASS="CLSMTABP_BAK"><font color=white>제3호의3(3) 부속명세 공사원가</font></td>
