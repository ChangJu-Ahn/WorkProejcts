...
'*  4. Program Name         : 납품집계현황 - Query Delivery Summary
'*  5. Program Desc         : 
'*  6. Comproxy List        : 
...
'================================================================================================================================
Const BIZ_PGM_QRY1_ID	= "U3111QB1.asp"							'☆: 비지니스 로직 ASP명 
Const BIZ_PGM_QRY2_ID	= "U3111QB2.asp"							'☆: 비지니스 로직 ASP명 
...
Sub InitSpreadSheet(ByVal pvSpdNo)
	...
	If pvSpdNo = "A" Or pvSpdNo = "*" Then
		...
		With frm1.vspdData1 
			...
			ggoSpread.SSSetFloat 	C_RcptAmt,		 "납품금액"		,15,parent.ggAmtOfMoneyNo, ggStrIntegeralPart,	ggStrDeciPointPart,	parent.gComNum1000,	parent.gComNumDec,,,"Z"
			...
			ggoSpread.SSSetFloat 	C_TotQty,		 "입고총량"		,12,parent.ggQtyNo ,ggStrIntegeralPart, ggStrDeciPointPart,parent.gComNum1000,parent.gComNumDec,,,"Z"
			ggoSpread.SSSetFloat 	C_TotAmt,		 "입고총금액"	,15,parent.ggAmtOfMoneyNo, ggStrIntegeralPart,	ggStrDeciPointPart,	parent.gComNum1000,	parent.gComNumDec,,,"Z"
    ...
    If pvSpdNo = "B" Or pvSpdNo = "*" Then
		...
		With frm1.vspdData2 
			...
			ggoSpread.SSSetDate 	C_DvryDt,		"납품일"		,10, 2, parent.gDateFormat		 
			ggoSpread.SSSetEdit 	C_SLCD,			"납품창고"		,12
			...
			ggoSpread.SSSetFloat	C_DvryAmt,		"납품금액"		,15,parent.ggAmtOfMoneyNo, ggStrIntegeralPart,	ggStrDeciPointPart,	parent.gComNum1000,	parent.gComNumDec,,,"Z"
					...
					<TD CLASS="CLSMTABP">
						<TABLE ID="MyTab" CELLSPACING=0 CELLPADDING=0>
							<TR>
								...
								<td background="../../../CShared/image/table/seltab_up_bg.gif" align="center" CLASS="CLSMTAB"><font color=white>납품집계현황</font></td>
					...
					<TD HEIGHT=20 WIDTH=100%>
						<FIELDSET CLASS="CLSFLD">
							<TABLE <%=LR_SPACE_TYPE_40%>>
			 					...
			 					<TR>
									<TD CLASS="TD5" NOWRAP>정상/반품구분</TD>
									<TD CLASS="TD6" NOWRAP><INPUT TYPE=radio Class="Radio" ALT="구분" NAME="rdoGbnflg" id = "rdoGbnflg1" Value="A" checked tag="11"><label for="rdoGbnflg1">&nbsp;전체&nbsp;</label>
														   <INPUT TYPE=radio Class="Radio" ALT="구분" NAME="rdoGbnflg" id = "rdoGbnflg2" Value="N" tag="11"><label for="rdoGbnflg2">&nbsp;정상&nbsp;</label>
														   <INPUT TYPE=radio Class="Radio" ALT="구분" NAME="rdoGbnflg" id = "rdoGbnflg3" Value="Y" tag="11"><label for="rdoGbnflg3">&nbsp;반품&nbsp;</label></TD>
									...
									<TD CLASS="TD6" NOWRAP><INPUT TYPE=radio Class="Radio" ALT="구분" NAME="rdoAppflg" id = "rdoAppflg1" Value="A" checked tag="11"><label for="rdoAppflg1">&nbsp;전체&nbsp;</label>
														   <INPUT TYPE=radio Class="Radio" ALT="구분" NAME="rdoAppflg" id = "rdoAppflg2" Value="N" tag="11"><label for="rdoAppflg2">&nbsp;사급&nbsp;</label>
														   <INPUT TYPE=radio Class="Radio" ALT="구분" NAME="rdoAppflg" id = "rdoAppflg3" Value="Y" tag="11"><label for="rdoAppflg3">&nbsp;일반&nbsp;</label></TD>
								</TR>
								<TR>
	...
	<!--<TR HEIGHT=20>
		<TD WIDTH=100%>
			<TABLE <%=LR_SPACE_TYPE_30%>>
				<TR>				
					<TD WIDTH=10>&nbsp;</TD>
					<TD><BUTTON NAME="btnRun" CLASS="CLSSBTN" ONCLICK="vbscript:BtnPreview()" Flag=0>미리보기</BUTTON>&nbsp;<BUTTON NAME="btnRun" CLASS="CLSSBTN" ONCLICK="vbscript:BtnPrint()" Flag=0>인쇄</BUTTON></TD>
					<TD WIDTH=10>&nbsp;</TD>
				</TR>
			</TABLE>
		</TD>
