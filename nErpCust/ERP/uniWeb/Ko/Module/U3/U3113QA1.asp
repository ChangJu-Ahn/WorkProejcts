...
'*  1. Module Name          : SCM
'*  2. Function Name        : 
'*  3. Program ID           : U3113QA1.asp
'*  4. Program Name         : 거래처매입현황 - Query Delivery Summary
'*  5. Program Desc         : 
'*  6. Comproxy List        : 
...
'================================================================================================================================
Const BIZ_PGM_QRY1_ID	= "U3113QB1.asp"							'☆: 비지니스 로직 ASP명 
Const BIZ_PGM_QRY2_ID	= "U3113QB2.asp"							'☆: 비지니스 로직 ASP명 
...
Sub InitSpreadSheet(ByVal pvSpdNo)
	...
	If pvSpdNo = "A" Or pvSpdNo = "*" Then
		...
		With frm1.vspdData1 
			...
			ggoSpread.SSSetEdit 	C_IV_BIZ_AREA,		"사업장"		,15
			ggoSpread.SSSetDate 	C_IV_DT,			"매입일자"		,10, 2, parent.gDateFormat		 
			ggoSpread.SSSetEdit 	C_IV_TYPE,			"매입형태"		,20
			ggoSpread.SSSetEdit 	C_IV_CUR,			"화폐단위"		,6
			ggoSpread.SSSetFloat 	C_NET_DOC_AMT,		"매입금액"		,15,parent.ggAmtOfMoneyNo, ggStrIntegeralPart,	ggStrDeciPointPart,	parent.gComNum1000,	parent.gComNumDec,,,"Z"
			ggoSpread.SSSetFloat 	C_VAT_AMT,			"VAT금액"		,15,parent.ggAmtOfMoneyNo, ggStrIntegeralPart,	ggStrDeciPointPart,	parent.gComNum1000,	parent.gComNumDec,,,"Z" 
			ggoSpread.SSSetFloat 	C_GROSS_DOC_AMT,	"총매입금액"	,15,parent.ggAmtOfMoneyNo, ggStrIntegeralPart,	ggStrDeciPointPart,	parent.gComNum1000,	parent.gComNumDec,,,"Z"
			ggoSpread.SSSetFloat 	C_VAT_RATE,			"VAT율"			,15, parent.ggExchRateNo,ggStrIntegeralPart, ggStrDeciPointPart,parent.gComNum1000,parent.gComNumDec
			ggoSpread.SSSetEdit 	C_VAT_TYPE,			"VAT형태"		,12
			ggoSpread.SSSetEdit 	C_IV_NO,			"매입번호"		,18
    ...
    If pvSpdNo = "B" Or pvSpdNo = "*" Then
		...
		With frm1.vspdData2 
			...
			ggoSpread.SSSetEdit 	C_IV_UNIT,      "매입단위"		,6
			ggoSpread.SSSetFloat 	C_IV_QTY,		"매입수량"		,12,parent.ggQtyNo ,ggStrIntegeralPart, ggStrDeciPointPart,parent.gComNum1000,parent.gComNumDec,,,"Z"
			ggoSpread.SSSetFloat 	C_IV_PRC,		"매입단가"		,15,parent.ggUnitCostNo,   ggStrIntegeralPart,	ggStrDeciPointPart,	parent.gComNum1000,	parent.gComNumDec,,,"Z"
			ggoSpread.SSSetFloat	C_IV_DOC_AMT,	"매입금액"		,15,parent.ggAmtOfMoneyNo, ggStrIntegeralPart,	ggStrDeciPointPart,	parent.gComNum1000,	parent.gComNumDec,,,"Z"
			ggoSpread.SSSetFloat	C_VAT_DOC_AMT,	"VAT금액"		,15,parent.ggAmtOfMoneyNo, ggStrIntegeralPart,	ggStrDeciPointPart,	parent.gComNum1000,	parent.gComNumDec,,,"Z"
			ggoSpread.SSSetFloat	C_TOT_IV_AMT,	"총매입금액"	,15,parent.ggAmtOfMoneyNo, ggStrIntegeralPart,	ggStrDeciPointPart,	parent.gComNum1000,	parent.gComNumDec,,,"Z"
					...
					<TD CLASS="CLSMTABP">
						<TABLE ID="MyTab" CELLSPACING=0 CELLPADDING=0>
							<TR>
								...
								<td background="../../../CShared/image/table/seltab_up_bg.gif" align="center" CLASS="CLSMTAB"><font color=white>거래처매입현황</font></td>
							...
							<TABLE <%=LR_SPACE_TYPE_40%>>
			 					<TR>
									...
									<TD CLASS=TD6 NOWRAP><INPUT TYPE=TEXT NAME="txtBpCd" SIZE=10 MAXLENGTH=10 tag="14" ALT="업체">&nbsp;<INPUT TYPE=TEXT NAME="txtBpNm" SIZE=25 tag="14" ALT="업체명"></TD>
			 						<TD CLASS=TD5 NOWRAP>매입일자</TD> 
									<TD CLASS=TD6>
										<SCRIPT LANGUAGE=JavaScript> ExternalWrite('<OBJECT CLASSID=<%=gCLSIDFPDT%> name=txtIvFrDt CLASS=FPDTYYYYMMDD title=FPDATETIME tag="12" ALT="시작일" id=OBJECT1></OBJECT>');</SCRIPT>
										&nbsp;~&nbsp;
										<SCRIPT LANGUAGE=JavaScript> ExternalWrite('<OBJECT CLASSID=<%=gCLSIDFPDT%> name=txtIvToDt CLASS=FPDTYYYYMMDD title=FPDATETIME tag="12" ALT="종료일" id=OBJECT2></OBJECT>');</SCRIPT>
									</TD>
								</TR>
			 					<TR>
									<TD CLASS=TD5 NOWRAP>사업장</TD>
									<TD CLASS=TD6 NOWRAP><INPUT TYPE=TEXT NAME="txtPlantCd" SIZE=6 MAXLENGTH=4 tag="11xxxU" ALT="사업장"><IMG SRC="../../../CShared/image/btnPopup.gif" NAME="btnPlantCd" align=top TYPE="BUTTON" ONCLICK="vbscript:OpenPlant()">&nbsp;<INPUT TYPE=TEXT NAME="txtPlantNm" SIZE=25 tag="14" ALT="사업장명"></TD>
									<TD CLASS=TD5 NOWRAP>매입형태</TD>
									<TD CLASS=TD6 NOWRAP><INPUT TYPE=TEXT NAME="txtIvType" SIZE=18 MAXLENGTH=18 tag="11xxxU" ALT="매입형태"><IMG SRC="../../../CShared/image/btnPopup.gif" NAME="btnIvType" align=top TYPE="BUTTON"ONCLICK="vbscript:OpenIvType()">&nbsp;<INPUT TYPE=TEXT NAME="txtIvTypeNm" SIZE=25 tag="14"></TD>
