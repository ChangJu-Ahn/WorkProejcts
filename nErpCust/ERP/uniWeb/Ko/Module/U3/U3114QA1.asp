...
'*  2. Function Name        : 
'*  3. Program ID           : U3114QA1.asp
'*  4. Program Name         : Query Return Summary
'*  5. Program Desc         : 
'*  6. Comproxy List        : 
'*  7. Modified date(First) : 2005-01-11
'*  8. Modified date(Last)  : 
'*  9. Modifier (First)     : noh - hyoung -gyun
'* 10. Modifier (Last)      : 
'* 11. Comment              :
'* 12. History              : 
'********************************************************************************************** -->
...
'================================================================================================================================
Const BIZ_PGM_QRY_ID	= "U3114QB1.asp"						
...
Sub InitSpreadSheet(ByVal pvSpdNo)
	...
	If pvSpdNo = "A" Or pvSpdNo = "*" Then
		...
		With frm1.vspdData 
			...
			ggoSpread.SSSetEdit 	C_Unit,			"재고단위"		,10,2
			ggoSpread.SSSetFloat	C_Qty,			"재고수량"		,12,parent.ggQtyNo ,ggStrIntegeralPart, ggStrDeciPointPart,parent.gComNum1000,parent.gComNumDec,,,"Z"
       ...
       Case "M"
				...
				With frm1
					If lgIntFlgMode = parent.OPMD_UMODE Then
						lgKeyStream =				UCase(Trim(.hBPCd.value))  & Parent.gColSep
					...
					<TD CLASS="CLSMTABP">
						<TABLE ID="MyTab" CELLSPACING=0 CELLPADDING=0>
							<TR>
								...
								<td background="../../../CShared/image/table/seltab_up_bg.gif" align="center" CLASS="CLSMTAB"><font color=white>거래처재고현황</font></td>
