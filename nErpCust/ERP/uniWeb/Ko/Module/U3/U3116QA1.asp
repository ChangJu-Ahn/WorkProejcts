...
'*  4. Program Name         : 거래처매출현황 - Query Delivery Summary
'*  5. Program Desc         : 
'*  6. Comproxy List        : 
...
'================================================================================================================================
Const BIZ_PGM_QRY1_ID	= "U3116QB1.asp"							'☆: 비지니스 로직 ASP명 
Const BIZ_PGM_QRY2_ID	= "U3116QB2.asp"							'☆: 비지니스 로직 ASP명 
...
Sub InitSpreadSheet(ByVal pvSpdNo)
	...
	If pvSpdNo = "A" Or pvSpdNo = "*" Then
		...
		With frm1.vspdData1 
			...
			ggoSpread.SSSetDate 	C_IV_DT,			"매출일자"		,10, 2, parent.gDateFormat		 
			ggoSpread.SSSetEdit 	C_IV_TYPE,			"매출형태"		,20
			ggoSpread.SSSetEdit 	C_IV_CUR,			"화폐단위"		,6
			ggoSpread.SSSetFloat 	C_NET_DOC_AMT,		"매출금액"		,15,parent.ggAmtOfMoneyNo, ggStrIntegeralPart,	ggStrDeciPointPart,	parent.gComNum1000,	parent.gComNumDec,,,"Z"
			...
			ggoSpread.SSSetFloat 	C_GROSS_DOC_AMT,	"총매출금액"	,15,parent.ggAmtOfMoneyNo, ggStrIntegeralPart,	ggStrDeciPointPart,	parent.gComNum1000,	parent.gComNumDec,,,"Z"
			...
			ggoSpread.SSSetEdit 	C_IV_NO,			"매출번호"		,18
    ...
    If pvSpdNo = "B" Or pvSpdNo = "*" Then
		...
		With frm1.vspdData2 
			...
			ggoSpread.SSSetEdit 	C_IV_UNIT,      "매출단위"		,6
			ggoSpread.SSSetFloat 	C_IV_QTY,		"매출수량"		,12,parent.ggQtyNo ,ggStrIntegeralPart, ggStrDeciPointPart,parent.gComNum1000,parent.gComNumDec,,,"Z"
			ggoSpread.SSSetFloat 	C_IV_PRC,		"매출단가"		,15,parent.ggUnitCostNo,   ggStrIntegeralPart,	ggStrDeciPointPart,	parent.gComNum1000,	parent.gComNumDec,,,"Z"
			ggoSpread.SSSetFloat	C_IV_DOC_AMT,	"매출금액"		,15,parent.ggAmtOfMoneyNo, ggStrIntegeralPart,	ggStrDeciPointPart,	parent.gComNum1000,	parent.gComNumDec,,,"Z"
			...
			ggoSpread.SSSetFloat	C_TOT_IV_AMT,	"총매출금액"	,15,parent.ggAmtOfMoneyNo, ggStrIntegeralPart,	ggStrDeciPointPart,	parent.gComNum1000,	parent.gComNumDec,,,"Z"
...
Function OpenIVType()
    ...
    arrField(0) = "BILL_TYPE"												' Field명(0)
    arrField(1) = "BILL_TYPE_NM"												' Field명(1)
    
    arrHeader(0) = "매출형태"													' Header명(0)
    arrHeader(1) = "매출형태명"													' Header명(1)
					...
					<TD CLASS="CLSMTABP">
						<TABLE ID="MyTab" CELLSPACING=0 CELLPADDING=0>
							<TR>
								...
								<td background="../../../CShared/image/table/seltab_up_bg.gif" align="center" CLASS="CLSMTAB"><font color=white>거래처매출현황</font></td>
						...
						<FIELDSET CLASS="CLSFLD">
							<TABLE <%=LR_SPACE_TYPE_40%>>
			 					...
			 					<TR>
									...
									<TD CLASS=TD5 NOWRAP>매출형태</TD>
									<TD CLASS=TD6 NOWRAP><INPUT TYPE=TEXT NAME="txtIvType" SIZE=18 MAXLENGTH=18 tag="11xxxU" ALT="매출형태"><IMG SRC="../../../CShared/image/btnPopup.gif" NAME="btnIvType" align=top TYPE="BUTTON"ONCLICK="vbscript:OpenIvType()">&nbsp;<INPUT TYPE=TEXT NAME="txtIvTypeNm" SIZE=25 tag="14"></TD>
								</TR>
			 				</TABLE>
						</FIELDSET>
					</TD>
	...
	<TR HEIGHT=20>
		<TD WIDTH=100%>
			<TABLE <%=LR_SPACE_TYPE_30%>>
				<TR>				
					<TD WIDTH=10>&nbsp;</TD>
					<TD ><BUTTON NAME="btnRun" CLASS="CLSSBTN" ONCLICK="vbscript:BtnPreview()" Flag=1>미리보기</BUTTON>&nbsp;<BUTTON NAME="btnRun" CLASS="CLSSBTN" ONCLICK="vbscript:BtnPrint()" Flag=1>인쇄</BUTTON>
					<TD WIDTH=10>&nbsp;</TD>
				</TR>
			</TABLE>
		</TD>
