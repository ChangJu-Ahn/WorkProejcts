...
Dim txtInsrtUserId
	...
	With lgObjComm
		.CommandText = "usp_i_CHECK_INOUT_UNBALANCE_KO441"
		...
		lgObjComm.Parameters.Append lgObjComm.CreateParameter("@ERROR_COUNT1", 		adVarChar, adParamOutput,  9)
		lgObjComm.Parameters.Append lgObjComm.CreateParameter("@ERROR_COUNT2", 		adVarChar, adParamOutput,  9)
		lgObjComm.Parameters.Append lgObjComm.CreateParameter("@ERROR_COUNT3", 		adVarChar, adParamOutput,  9)
	...
	Response.Write "	.txtCheckCnt1.value =	"""		& lgObjComm.Parameters("@ERROR_COUNT1").Value & """ " & vbcr
	Response.Write "	.txtCheckCnt2.value =	"""		& lgObjComm.Parameters("@ERROR_COUNT2").Value & """ " & vbcr
	Response.Write "	.txtCheckCnt3.value =	"""		& lgObjComm.Parameters("@ERROR_COUNT3").Value & """ " & vbcr
