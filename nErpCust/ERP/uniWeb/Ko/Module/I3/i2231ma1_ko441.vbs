...
Const BIZ_IO_CHECK_ID		= "i2231mb5_ko441.asp" 
Const BIZ_IO_UPDATE_ID		= "i2231mb6_ko441.asp" 
...
Function DbSave1() 
	...
	'2009.10.21...kbs...재고마감시 수불오류내역 체크 및 보정 부분 추가
	frm1.btnIoChk.disabled		= True
	frm1.btnIoUpd.disabled		= True

	frm1.txtCheckCnt1.value 	= ""
	frm1.txtCheckCnt2.value 	= ""
	frm1.txtCheckCnt3.value 	= ""
	frm1.txtUpdateCnt1.value 	= ""
	frm1.txtUpdateCnt2.value 	= ""
	frm1.txtUpdateCnt3.value 	= ""
...
'2009.10.21...kbs...재고마감시 수불오류내역 체크 및 보정 부분 추가
'========================================================================================
' Function Name : DBSave11
' Function Desc : 재고수불체크, 성공적이면 DBSaveOk 호출됨 
'========================================================================================
Function DbSave11() 
	...
	Call ExecMyBizASP(frm1, BIZ_IO_CHECK_ID)          
...
'2009.10.21...kbs...재고마감시 수불오류내역 체크 및 보정 부분 추가
'========================================================================================
' Function Name : DBSave12
' Function Desc : 재고수불보정, 성공적이면 DBSaveOk 호출됨 
'========================================================================================
Function DbSave12() 
	...
	Call ExecMyBizASP(frm1, BIZ_IO_UPDATE_ID)          
...
Function Btnabled()
	...
	'2009.10.21...kbs...재고마감시 수불오류내역 체크 및 보정 부분 추가
	frm1.btnIoChk.disabled		= False
	frm1.btnIoUpd.disabled		= False
