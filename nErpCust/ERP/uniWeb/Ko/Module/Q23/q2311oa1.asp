					...
					<TD>
						<TABLE ID="MyTab" CELLSPACING=0 CELLPADDING=0>
							<TR>
								...
								<td background="../../../CShared/image/table/seltab_up_bg.gif" align="center" CLASS="CLSMTAB"><font color=white>최종검사일보</font></td>
						...
						<FIELDSET CLASS="CLSFLD" STYLE="HEIGHT: 100%">
							<TABLE WIDTH=100% CELLSPACING=0 CELLPADDING=0 STYLE="HEIGHT: 100%">
								...
								<TR>
									...
									<TD CLASS=TD6 NOWRAP>
										<script language =javascript src='./js/q2311oa1_fpDateTime1_txtStartDt.js'></script>&nbsp;~&nbsp;
										<script language =javascript src='./js/q2311oa1_fpDateTime2_txtEndDt.js'></script>																					
									</TD>
								</TR>
								<TR>
