...
Const BIZ_PGM_QRY_ID = "Q2317MB1.asp"
Const BIZ_PGM_SAVE_ID = "Q2317MB2.asp"
Const BIZ_PGM_DEL_ID = "Q2317MB3.asp"											 '☆: 비지니스 로직 ASP명 
...
Sub ReleaseDetails()
	With ggoOper
		...
		If frm1.txtGoodQty > 0 Then
			Call .SetReqAttr(frm1.txtSlCdForGood, "N")
		Else
			Call .SetReqAttr(frm1.txtSlCdForGood, "Q")
		End If
		
		If frm1.txtDefectQty > 0 Then
...
Sub Form_Load()
	...
	Call ggoOper.FormatDate(frm1.txtReleaseDt, gDateFormat, 1)
	Call ggoOper.FormatDate(frm1.txtInspDt, gDateFormat, 1)		
					...
					<TD CLASS="CLSMTABP">
						<TABLE ID="MyTab" CELLSPACING=0 CELLPADDING=0>
							<TR>
								...
								<TD BACKGROUND="../../../CShared/image/table/seltab_up_bg.gif" ALIGN="center" CLASS="CLSMTAB"><FONT COLOR=white>최종검사 RELEASE</FONT></TD>
					...
					<TD HEIGHT=*  WIDTH=100% VALIGN=TOP>						
						<TABLE <%=LR_SPACE_TYPE_60%>>
							<TR>
								...
								<TD CLASS="TD6" NOWRAP>
									<script language =javascript src='./js/q2317ma1_txtReleaseDt_txtReleaseDt.js'></script>
								</TD>
							</TR>
							<TR>
								...
								<TD CLASS="TD6" NOWRAP>
									<script language =javascript src='./js/q2317ma1_txtInspReqDt_txtInspReqDt.js'></script>
								</TD>								
							</TR>							
							<TR>
								...
								<TD CLASS="TD6" NOWRAP>
									<script language =javascript src='./js/q2317ma1_fpDoubleSingle1_txtLotSize.js'></script>
								</TD>
	                					</TR>
            							<TR>
								...
								<TD CLASS="TD6" NOWRAP>
									<script language =javascript src='./js/q2317ma1_txtInspDt_txtInspDt.js'></script>
								</TD>
							</TR>
							<TR>
								<TD CLASS="TD5" NOWRAP>양품수</TD>
								<TD CLASS="TD6" NOWRAP>
									<script language =javascript src='./js/q2317ma1_fpDoubleSingle2_txtGoodQty.js'></script>
								</TD>
								<TD CLASS="TD5" NOWRAP>불량품수</TD>
								<TD CLASS="TD6" NOWRAP>
									<script language =javascript src='./js/q2317ma1_fpDoubleSingle3_txtDefectQty.js'></script>
								</TD>
							</TR>
							<TR>
	...
	<TR HEIGHT=20>
      		<TD WIDTH=100%>
      			<TABLE <%=LR_SPACE_TYPE_30%>>
        				<TR>        				
        					<TD WIDTH=10>&nbsp;</TD>
	        				<TD WIDTH=* ALIGN=RIGHT><A href="vbscript:LoadInspection">최종검사</A></TD>
					<TD WIDTH=10>&nbsp;</TD>
       				</TR>
      			</TABLE>
      		</TD>
