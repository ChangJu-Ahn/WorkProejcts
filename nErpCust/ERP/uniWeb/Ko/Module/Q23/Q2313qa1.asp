...
Const BIZ_PGM_ID          = "q2313qb1.asp"             '☆: Biz logic spread sheet for #1
Const BIZ_PGM_ID1		  = "q2313qb2.asp"             '☆: Biz logic spread sheet for #2
...
Sub InitSpreadSheet(ByVal pvGridId)
    If pvGridId = "A" Then                                   ' 초기화 Spreadsheet #1 
        Call SetZAdoSpreadSheet("Q2313QA1", "S", "A", "V20021125", parent.C_SORT_DBAGENT, frm1.vspdData, C_MaxKey, "X", "X")
    End If

    Call SetZAdoSpreadSheet("Q2313QA1", "S", "B", "V20021125", parent.C_SORT_DBAGENT, frm1.vspdData2, C_MaxKey, "X", "X")
					...
					<TD CLASS="CLSMTABP">
						<TABLE ID="MyTab" CELLSPACING=0 CELLPADDING=0>
							<TR>
								...
								<td background="../../../CShared/image/table/seltab_up_bg.gif" align="center" CLASS="CLSMTAB"><font color=white>최종검사불량유형조회</font></td>
						...
						<FIELDSET CLASS="CLSFLD">
							<TABLE <%=LR_SPACE_TYPE_40%>>
								<TR>
									...
									<TD CLASS="TD6">
										<script language =javascript src='./js/q2313qa1_fpDateTime5_txtDtFr.js'></script>&nbsp;~&nbsp;
										<script language =javascript src='./js/q2313qa1_fpDateTime6_txtDtTo.js'></script>										
									</TD>
								</TR>
								<TR>
							...
							<TR>
								<TD HEIGHT=100% WIDTH=100% Colspan=4>
									<TABLE WIDTH="100%" HEIGHT="100%" CELLSPACING=0 CELLPADDING=0>
										<TR HEIGHT="*">
											<TD WIDTH="60%">
												<script language =javascript src='./js/q2313qa1_A_vspdData.js'></script>
											</TD>
											<TD WIDTH=10>&nbsp;</TD>
											<TD WIDTH="40%">
												<script language =javascript src='./js/q2313qa1_B_vspdData2.js'></script>
											</TD>
										</TR>
									</TABLE>
								</TD>
	...
	<TR HEIGHT=20>
      		<TD WIDTH=100%>
      			<TABLE <%=LR_SPACE_TYPE_30%>>
        				<TR>        				
        					<TD WIDTH=10>&nbsp;</TD>
        					<!--<TD WIDTH="*" ALIGN="RIGHT"><a ONCLICK="VBSCRIPT:CookiePage(1)">수입검사불량유형등록</a></TD>-->
