	...
	Else
        ...
        Do While Not lgObjRs.EOF
            ...
            lgstrData = Chr(11) & ConvSPChars(lgObjRs(0)) & _
                        ...
                        Chr(11) & UNINumClientFormat(lgObjRs(13), 2, 0) & _
...
Sub SubMakeSQLStatements()
	...
	lgStrSQL = " SELECT Top " & C_SHEETMAXROWS_D + 1 & _
					 " a.INSP_REQ_NO, a.INSP_RESULT_NO, a.Release_DT, a.INSP_DT, a.ITEM_CD, b.ITEM_NM, " & _
				...
				" FROM Q_INSPECTION_RESULT a " & _
				     ...
				     " left outer join B_MINOR d ON d.MAJOR_CD = " & FilterVar("Q0010", "''", "S") & " AND a.DECISION = d.MINOR_CD " & _
			   " WHERE a.INSP_CLASS_CD = " & FilterVar("F", "''", "S") & "  AND a.PLANT_CD = " & FilterVar(Request("txtPlantCd"), "''", "S") & _
