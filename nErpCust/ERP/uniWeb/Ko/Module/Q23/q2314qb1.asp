...
Sub FixUNISQLData()
	...
	Select Case strFlag
		Case "N"
			...
			UNISqlId(0) = "Q2314QA101"
		Case "I"
			Redim UNIValue(0,7)    
			UNISqlId(0) = "Q2314QA102"
		Case "D"
			Redim UNIValue(0,7)    
			UNISqlId(0) = "Q2314QA103"
		Case "IS"
			Redim UNIValue(0,8)    
			UNISqlId(0) = "Q2314QA104"
		Case "ID"
			Redim UNIValue(0,8)    
			UNISqlId(0) = "Q2314QA105"
		Case "A"
			Redim UNIValue(0,9)             
			UNISqlId(0) = "Q2314QA106"
	End Select
	...
	UNIValue(0,5) = FilterLotNo		'---로트번호 
	    ...
	    Case "A"
			 UNIValue(0,6) = FilterItemCd					'---품목 
	    	 UNIValue(0,7) = FilterInspItemCd	    			'---검사항목 
	    	 UNIValue(0,8) = FilterDefectTypeCd	    			'---불량유형 
	End Select
...
Sub TrimData()
	...
	If strItemCd = "" And strInspItemCd = "" And strDefectTypeCd = "" Then
		strFlag = "N"
	ElseIf strItemCd <> "" And strInspItemCd = "" And strDefectTypeCd = "" Then
		strFlag = "I"
	ElseIf strItemCd = "" And strInspItemCd = "" And strDefectTypeCd <> "" Then
		strFlag = "D"
	ElseIf strItemCd <> "" And strInspItemCd <> "" And strDefectTypeCd = "" Then
