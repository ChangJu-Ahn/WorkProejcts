...
Const BIZ_PGM_QRY_ID = "Q2312MB1.asp"								'☆: 비지니스 로직 ASP명 
Const BIZ_PGM_QRY2_ID = "Q2312MB3.asp"								'☆: 비지니스 로직 ASP명 
Const BIZ_PGM_SAVE_ID = "Q2312MB2.asp"								'☆: 비지니스 로직 ASP명 
'/* 전체 삭제 관련 - START */
Const BIZ_PGM_DEL_ID = "Q2312MB4.asp"
'/* 전체 삭제 관련 - END */
Const BIZ_PGM_JUMP1_ID = "Q2311MA1"
Const BIZ_PGM_JUMP2_ID = "Q2313MA1"
'/* 9월 정기패치: 판정으로의 Link 추가 - START */
Const BIZ_PGM_JUMP3_ID = "Q2315MA1"
...
Sub SetDefaultVal()
	...
	If Parent.ReadCookie("txtPlantCd") <> "" Then
		frm1.txtPlantCd.Value = Parent.ReadCookie("txtPlantCd")
	End If
	
	If Parent.ReadCookie("txtPlantNm") <> "" Then
		frm1.txtPlantNm.Value = Parent.ReadCookie("txtPlantNm")
	End If
	
	If Parent.ReadCookie("txtInspReqNo") <> "" Then
		frm1.txtInspReqNo.Value = Parent.ReadCookie("txtInspReqNo")
	End If
	
	Parent.WriteCookie "txtPlantCd", ""
	Parent.WriteCookie "txtPlantNm", ""
	Parent.WriteCookie "txtInspReqNo", ""
End Sub
					...
					<TD CLASS="CLSMTABP">
						<TABLE ID="MyTab" CELLSPACING=0 CELLPADDING=0">
							<TR>
								...
								<TD BACKGROUND="../../../CShared/image/table/seltab_up_bg.gif" ALIGN="center" CLASS="CLSMTAB"><FONT COLOR=white>최종검사내역 등록</FONT></TD>
					...
					<TD HEIGHT=*  WIDTH=100% VALIGN=TOP>						
						<TABLE <%=LR_SPACE_TYPE_60%>>
							...
							<TR>
								...
								<TD CLASS="TD6" NOWRAP>
									<script language =javascript src='./js/q2312ma1_fpDoubleSingle1_txtLotSize.js'></script>
								</TD>
							</TR>
							<TR>
										...
										<TR HEIGHT="*">
												...
												<TABLE <%=LR_SPACE_TYPE_20%>>
													<TR HEIGHT="*" WIDTH="100%">
														<TD WIDTH="100%" Colspan=4>
															<script language =javascript src='./js/q2312ma1_I859864556_vspdData.js'></script>
														</TD>
													</TR>
													<TR HEIGHT="20" WIDTH="100%">
														<TD CLASS="TD5" NOWRAP>시료수</TD>            
														<TD CLASS="TD6" NOWRAP>
															<script language =javascript src='./js/q2312ma1_fpDoubleSingle1_txtSampleQty.js'></script>
														</TD>
														<TD CLASS="TD5" NOWRAP>불량수</TD>
														<TD CLASS="TD6" NOWRAP>
															<script language =javascript src='./js/q2312ma1_fpDoubleSingle2_txtDefectQty.js'></script>
														</TD>
													</TR>			
													<TR HEIGHT="20" WIDTH="100%">
											...
											<TD HEIGHT=100% WIDTH=35%>
												<TABLE <%=LR_SPACE_TYPE_20%>>
													<TR HEIGHT="*">
														<TD WIDTH="100%">
															<script language =javascript src='./js/q2312ma1_I779556804_vspdData2.js'></script>
														</TD>
													</TR>
												</TABLE>
											</TD>
    	...
    	<TD WIDTH=100%>
    		<TABLE <%=LR_SPACE_TYPE_30%>>
    			<TR>        				
    				...
    				<!-- '/* 9월 정기패치: 판정으로의 Link 추가 - START */ -->
    				<TD WIDTH=* ALIGN=RIGHT><A href="vbscript:LoadInspection">최종검사</A>&nbsp;|&nbsp;<A href="vbscript:LoadDefectType">불량유형</A>&nbsp;|&nbsp;<A href="vbscript:LoadDecision">판정</A></TD>
    				<!-- '/* 9월 정기패치: 판정으로의 Link 추가 - END */ -->
					<TD WIDTH=10>&nbsp;</TD>
    			</TR>
    		</TABLE>
