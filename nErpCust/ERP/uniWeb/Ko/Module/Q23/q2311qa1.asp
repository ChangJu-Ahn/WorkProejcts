...
Const BIZ_PGM_ID		= "Q2311qb1.asp"                 '☆: 비지니스 로직 ASP명 
Const BIZ_PGM_JUMP_ID	= "Q2311ma1"                     '☆: Cookie에서 사용할 상수 
...
Function OpenItem()
	...
	arrParam(3) = ""										' Name Condition
	arrParam(4) = "a.Item_Cd = b.Item_Cd And a.Plant_Cd = " & FilterVar(frm1.txtPlantCd.Value, "''", "S")
...
Sub GetSpreadColumnPos(ByVal pvSpdNo)
 	...
 	Case "A"
		...
		C_MinorCd		= iCurColumnPos(9)
		C_MinorNm		= iCurColumnPos(10)
		C_LotSize		= iCurColumnPos(11)
		C_InspQty		= iCurColumnPos(12)
		C_DefectQty		= iCurColumnPos(13)
		C_DefectRatio	= iCurColumnPos(14)
					...
					<TD CLASS="CLSMTABP">
						<TABLE ID="MyTab" CELLSPACING=0 CELLPADDING=0>
							<TR>
								...
								<td background="../../../CShared/image/table/seltab_up_bg.gif" align="center" CLASS="CLSMTAB"><font color=white>최종검사일보조회</font></td>
						...
						<FIELDSET CLASS="CLSFLD">
							<TABLE <%=LR_SPACE_TYPE_40%>>
								<TR>
									...
									<TD CLASS="TD6">
										<script language =javascript src='./js/q2311qa1_fpDateTime5_txtDtFr.js'></script>&nbsp;~&nbsp;
										<script language =javascript src='./js/q2311qa1_fpDateTime6_txtDtTo.js'></script>
									</TD>
								</TR>
								<TR>
					...
					<TD HEIGHT=*  WIDTH=100% VALIGN=TOP>						
						<TR>
							<TD HEIGHT=100% WIDTH=100% Colspan=2>
								<script language =javascript src='./js/q2311qa1_I305916351_vspdData.js'></script>
							</TD>	
						</TR>	
					</TD>
				</TR>
