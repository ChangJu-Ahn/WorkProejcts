...
Const BIZ_PGM_QRY_ID = "Q2314MB1.asp"								'☆: 비지니스 로직 ASP명 
Const BIZ_PGM_QRY2_ID = "Q2314MB3.asp"								'☆: 비지니스 로직 ASP명 
Const BIZ_PGM_SAVE_ID = "Q2314MB2.asp"								'☆: 비지니스 로직 ASP명 
'/* 전체 삭제 관련 - START */
Const BIZ_PGM_DEL_ID = "Q2314MB4.asp"
'/* 전체 삭제 관련 - END */
Const BIZ_PGM_JUMP1_ID = "Q2311MA1"
Const BIZ_PGM_JUMP2_ID = "Q2315MA1"
					...
					<TD CLASS="CLSMTABP">
						<TABLE ID="MyTab" CELLSPACING=0 CELLPADDING=0>
							<TR>
								...
								<TD BACKGROUND="../../../CShared/image/table/seltab_up_bg.gif" ALIGN="center" CLASS="CLSMTAB"><FONT COLOR=white>최종검사 불량원인</FONT></TD>
					...
					<TD HEIGHT=*  WIDTH=100% VALIGN=TOP>						
						<TABLE <%=LR_SPACE_TYPE_60%>>
							...
							<TR>
								...
								<TD CLASS="TD6" NOWRAP>
									<script language =javascript src='./js/q2314ma1_fpDoubleSingle1_txtLotSize.js'></script>
								</TD>
							</TR>
							<TR>
								<TD HEIGHT=100% WIDTH=100% Colspan=4>
									<TABLE WIDTH="100%" HEIGHT="100%" CELLSPACING=0 CELLPADDING=0>
										<TR HEIGHT="*">
											<TD WIDTH="62%">
												<script language =javascript src='./js/q2314ma1_I797086489_vspdData.js'></script>
											</TD>
											<TD WIDTH=10>&nbsp;</TD>
											<TD WIDTH="38%">
												<script language =javascript src='./js/q2314ma1_I797602921_vspdData2.js'></script>
											</TD>
										</TR>
									</TABLE>
								</TD>
	...
	<TR HEIGHT=20>
      		<TD WIDTH=100%>
      			<TABLE <%=LR_SPACE_TYPE_30%>>
        			<TR>        				
        				<TD WIDTH=10>&nbsp;</TD>
        				<TD WIDTH=* ALIGN=RIGHT><A href="vbscript:LoadInspection">최종검사</A>&nbsp;|&nbsp;<A href="vbscript:LoadDecision">판정</A></TD>
        				<TD WIDTH=10>&nbsp;</TD>
       				</TR>
      			</TABLE>
      		</TD>
