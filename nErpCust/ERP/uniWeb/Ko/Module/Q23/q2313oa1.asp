...
Function Plant_Req_Check()
	...
	With frm1
		...
		If lgF0(0) <> "F" Then
			Call DisplayMsgBox("220732", "X", "X", "X")
			.txtInspReqNo.Focus
			Set gActiveElement = document.activeElement
			Exit function
		End If
					...
					<TD>
						<TABLE ID="MyTab" CELLSPACING=0 CELLPADDING=0>
							<TR>
								...
								<td background="../../../CShared/image/table/seltab_up_bg.gif" align="center" CLASS="CLSMTAB"><font color=white>최종검사성적서출력</font></td>
