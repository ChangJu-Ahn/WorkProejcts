...
'--------------- 개발자 coding part(변수선언,End)----------------------------------------------------------
	...
	DurYrsFg			= Trim(Request("DurYrsFg"))
...
Sub FixUNISQLData()
	...
	If DurYrsFg= "T" then
		UNISqlId(0) = "A7112MA01"	'상위 
	else
		UNISqlId(0) = "A7112MA03"	'상위 
	End If
    ...
    strWhereDown =  strWhereDown & " and dur_yrs_fg		= " & FilterVar(DurYrsFg ,"''" ,"S")
...
With Parent
	...
	If "<%=lgDataExist%>" = "Yes" Then
		...
		.frm1.txtDurYrs.value				= "<%=txtDurYrs%>"				'내용연수 
