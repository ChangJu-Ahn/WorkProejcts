...
'*  1. Module명          : 회계관리 
'*  2. Function명        : 자산관리 
'*  3. Program ID        : a7118ma1.asp
'*  4. Program 이름      : 고정자산변동내역출력 
'*  5. Program 설명      : 고정자산변동내역출력 
'*  6. Comproxy 리스트   : 
...
Sub SetPrintCond(StrEbrFile,StrUrl)
	...
	Dim	VarBizAreaCd,VarBizAreaCd1,VarFrAcct,VarToAcct,VarFromDt,VarTodt,varChgFg
	Dim	strAuthCond
	...
	If frm1.Rb_tot.checked = true then
		varChgFg = "%"
	elseIf frm1.Rb_cpt.checked = true then
		varChgFg = "01"
	elseif frm1.Rb_rvn.checked = true then
		varChgFg = "02"
	elseif frm1.Rb_sold.checked = true then
		varChgFg = "03"
	elseif frm1.Rb_disuse.checked = true then
		varChgFg = "04"
	elseif frm1.Rb_trns.checked = true then
		varChgFg = "05"
	End if			
	...
	VarFromDt = UNIConvDateToYYYYMMDD(frm1.fpDateTime1.Text, parent.gDateFormat, parent.gServerDateType)	
	VarToDt   = UNIConvDateToYYYYMMDD(frm1.fpDateTime2.Text, parent.gDateFormat, parent.gServerDateType)	
	...
	StrUrl = StrUrl & "|varChgFg|"		& varChgFg
					...
					<TD WIDTH=100% HEIGHT=100% valign=top>
						<TABLE <%=LR_SPACE_TYPE_60%>>
							<TR>
								...
								<TD CLASS="TD6" NOWRAP><INPUT TYPE="RADIO" CLASS="Radio" NAME=RADIO1 ID=Rb_tot Checked><LABEL FOR=Rb_tot>총괄</LABEL>&nbsp;
													   <INPUT TYPE="RADIO" CLASS="Radio" NAME=RADIO1 ID=Rb_cpt><LABEL FOR=Rb_cpt>자본적지출</LABEL>&nbsp;
													   <INPUT TYPE="RADIO" CLASS="Radio" NAME=RADIO1 ID=Rb_rvn><LABEL FOR=Rb_rvn>수익적지출</LABEL></TD>	
							</TR>
							<TR><TD CLASS="TD5" NOWRAP></TD>
								<TD CLASS="TD6" NOWRAP><INPUT TYPE="RADIO" CLASS="Radio" NAME=RADIO1 ID=Rb_sold><LABEL FOR=Rb_sold>매각</LABEL>&nbsp;
													   <INPUT TYPE="RADIO" CLASS="Radio" NAME=RADIO1 ID=Rb_disuse><LABEL FOR=Rb_disuse>폐기</LABEL>&nbsp;
													   <INPUT TYPE="RADIO" CLASS="Radio" NAME=RADIO1 ID=Rb_trns><LABEL FOR=Rb_trns>부서이동</LABEL>
							   </TD>													   
							</TR>
							<TR>
								<TD CLASS="TD5" NOWRAP>변동일</TD>
								<TD CLASS="TD6" NOWRAP>
									<SCRIPT LANGUAGE=JavaScript> ExternalWrite('<OBJECT CLASSID=<%=gCLSIDFPDT%> NAME="txtFrYymm" CLASS=FPDTYYYYMMDD tag="12X1" Title="FPDATETIME" ALT=시작변동일 id=fpDateTime1> </OBJECT>');</SCRIPT>~&nbsp
									<SCRIPT LANGUAGE=JavaScript> ExternalWrite('<OBJECT CLASSID=<%=gCLSIDFPDT%> NAME="txtToYymm" CLASS=FPDTYYYYMMDD tag="12X1" Title="FPDATETIME" ALT=종료변동일 id=fpDateTime2> </OBJECT>');</SCRIPT>									
								</TD>					
							</TR>
							<TR>
							...
							<TR>
								...
								<TD CLASS="TD6" NOWRAP><INPUT TYPE="Text" ID = "txtFrAcctCd" NAME="txtFrAcctCd" SIZE=15 MAXLENGTH=10 tag="11XXXU" ALT="시작계정코드"><IMG SRC="../../../CShared/image/btnPopup.gif" NAME="btnAcctCdFR" ALIGN=top TYPE="BUTTON" ONCLICK="vbscript:Call OpenPopup(frm1.txtFrAcctCd.value, 'FrAcct')"> <INPUT TYPE="Text" NAME="txtFrAcctNm" SIZE=25 MAXLENGTH=30 tag="14X" ALT="계정코드명">&nbsp;~&nbsp;</TD>
							</TR>			
							<TR>
								<TD CLASS="TD5" NOWRAP></TD>
								<TD CLASS="TD6" NOWRAP><INPUT TYPE="Text" ID = "txtToAcctCd" NAME="txtToAcctCd" SIZE=15 MAXLENGTH=10 tag="11XXXU" ALT="종료계정코드"><IMG SRC="../../../CShared/image/btnPopup.gif" NAME="btnAcctCdFR" ALIGN=top TYPE="BUTTON" ONCLICK="vbscript:Call OpenPopup(frm1.txtToAcctCd.value, 'ToAcct')"> <INPUT TYPE="Text" NAME="txtToAcctNm" SIZE=25 MAXLENGTH=30 tag="14X" ALT="계정코드명"></TD>
							</TR>
						</TABLE>
					</TD>
				</TR>
