...
'*  4. Program 이름      : 고정자산취득Check LIst 출력 
'*  5. Program 설명      : 
'*  6. Comproxy 리스트   : 
'*  7. 최초 작성년월일   : 2000/12/16
'*  8. 최종 수정년월일   : 2004/01/08
'*  9. 최초 작성자       : 김희정 
'* 10. 최종 작성자       : Kim Chang Jin
'* 11. 전체 comment      :
					...
					<TD WIDTH=100% HEIGHT=100% valign=top>
						<TABLE <%=LR_SPACE_TYPE_60%>>
							<TR>
								...
								<TD CLASS="TD6" NOWRAP><INPUT TYPE="Text" NAME="txtBizAreacd" SIZE=10 MAXLENGTH=10 tag="11XXXU" ALT="사업장코드" STYLE="TEXT-ALIGN:left"><IMG SRC="../../../CShared/image/btnPopup.gif" NAME="btnAcctCdFR" ALIGN=top TYPE="BUTTON" ONCLICK="vbscript:Call OpenPopup(frm1.txtBizAreaCd.Value, 'Biz')"> 
													   <INPUT TYPE="Text" NAME="txtBizAreanm" SIZE=20 MAXLENGTH=30 tag="14" ALT="사업장명">&nbsp;~</TD>
							</TR>
							<TR>
								<TD CLASS="TD5" NOWRAP></TD>
								<TD CLASS="TD6" NOWRAP><INPUT TYPE="Text" NAME="txtBizAreacd1" SIZE=10 MAXLENGTH=10 tag="11XXXU" ALT="사업장코드" STYLE="TEXT-ALIGN:left"><IMG SRC="../../../CShared/image/btnPopup.gif" NAME="btnAcctCdFR" ALIGN=top TYPE="BUTTON" ONCLICK="vbscript:Call OpenPopup(frm1.txtBizAreaCd1.Value, 'Biz1')"> 
													   <INPUT TYPE="Text" NAME="txtBizAreanm1" SIZE=20 MAXLENGTH=30 tag="14" ALT="사업장명"></TD>
							</TR>					
							<TR>
								<TD CLASS="TD5" NOWRAP>취득일자</TD>
								<TD CLASS="TD6" NOWRAP>
									<SCRIPT LANGUAGE=JavaScript> ExternalWrite('<OBJECT CLASSID=<%=gCLSIDFPDT%> NAME="txtFrYymm" CLASS=FPDTYYYYMMDD tag="12X1" Title="FPDATETIME" ALT=시작취득일자 id=fpDateTime1> </OBJECT>');</SCRIPT> ~
									<SCRIPT LANGUAGE=JavaScript> ExternalWrite('<OBJECT CLASSID=<%=gCLSIDFPDT%> NAME="txtToYymm" CLASS=FPDTYYYYMMDD tag="12X1" Title="FPDATETIME" ALT=종료취득일자 id=fpDateTime2> </OBJECT>');</SCRIPT>
								</TD>								
							</TR>				
   							<TR>
           						<TD CLASS="TD5" NOWRAP>취득번호</TD>           						
								<TD CLASS="TD6" NOWRAP><INPUT TYPE="Text" NAME="txtFrAcqNo" SIZE=15 MAXLENGTH=18 tag="11XXXU" ALT="시작취득번호" STYLE="TEXT-ALIGN:left"><IMG SRC="../../../CShared/image/btnPopup.gif" NAME="btnAcctCdFR" ALIGN=top TYPE="BUTTON" ONCLICK="vbscript:Call OpenPopup(frm1.txtFrAcqNo.Value, 'FrAcqNo')">&nbsp;~&nbsp;</TD>
							</TR>	
							<TR>
								<TD CLASS="TD5" NOWRAP></TD>
								<TD CLASS="TD6" NOWRAP><INPUT TYPE="Text" NAME="txtToAcqNo" SIZE=15 MAXLENGTH=18 tag="11XXXU" ALT="종료취득번호" STYLE="TEXT-ALIGN:left"><IMG SRC="../../../CShared/image/btnPopup.gif" NAME="btnAcctCdFR" ALIGN=top TYPE="BUTTON" ONCLICK="vbscript:Call OpenPopup(frm1.txtToAcqNo.Value, 'ToAcqNo')"></TD>
                    	        </TD>
							</TR>
						</TABLE>
					</TD>
	...
	<TR HEIGHT=20>
		<TD WIDTH=100%>
			<TABLE <%=LR_SPACE_TYPE_30%>>
				<TR>
					<TD WIDTH=10>&nbsp;</TD>
					<TD><BUTTON NAME="btnpre" CLASS="CLSSBTN" OnClick="VBScript:Call FncBtnPreview()" Flag=1>미리보기</BUTTON>
					 &nbsp<BUTTON NAME="btn" CLASS="CLSSBTN" OnClick="VBScript:Call FncBtnPrint()" Flag=1>인쇄</BUTTON></TD>
				</TR>
			</TABLE>
		</TD>
	</TR>
