...
Const BIZ_PGM_QRY_ID  = "a7102mb1_ko441.asp"												'☆: Head Query 비지니스 로직 ASP명 
Const Biz_PGM_QRY_ID2 = "a7102mb4_ko441.asp"
Const BIZ_PGM_DEL_ID  = "a7102mb3_ko441.asp"												'☆: Delete 비지니스 로직 ASP명 
Const BIZ_PGM_SAVE_ID = "a7102mb2_ko441.asp"												'☆: Save 비지니스 로직 ASP명 
...
Dim C_DeptPop
Dim C_DeptNm
Dim C_CostCd	'air :: 회계부서정보(default : cost Center)
Dim C_CostPop	'air :: Popup
Dim C_AcctCd
Dim C_AcctPop
Dim C_AcctNm
Dim C_AsstNo
...
Dim C_AcqLocAmt
Dim C_AcqQty
Dim C_DurYrs	'air :: 고정자산계정별(default : 내용월수)
Dim C_ResAmt
Dim C_RefNo		'air :: 참조번호 -> 품목그룹
Dim C_ItemGroupPopup	'air :: Popup
Dim C_Desc
...
Sub initSpreadPosVariables(ByVal pvSpdNo)
	Select Case UCase(Trim(pvSpdNo))
		Case "A"	
			...
			C_DeptNm		= 3
			C_RefNo			= 4
			C_CostCd		= 5		'air :: cost center code
			C_CostPop		= 6
			C_AcctCd		= 7
			C_AcctPop		= 8
			C_AcctNm		= 9
    ...
    Select Case UCase(Trim(pvSpdNo))
		Case "A"
			With frm1.vspdData '자산master	'A
				...
				ggoSpread.Spreadinit "V20080306",,parent.gAllowDragDropSpread 
				...
				ggoSpread.SSSetEdit		C_RefNo, "품목그룹", 10,0,-1, 30, 2
				ggoSpread.SSSetButton	C_ItemGroupPopup
				
				ggoSpread.SSSetEdit		C_CostCd,  "코스트센터", 10,0,-1, 10, 2	'air :: Cost Center Code
			    ...
			    ggoSpread.SSSetEdit		C_DurYrs,   "내용월수", 10,0,-1, 10, 2 '20,0,-1,10,2
				...
				Call ggoSpread.MakePairsColumn(C_CostCd,C_CostPop,"1")
				Call ggoSpread.MakePairsColumn(C_RefNo,C_ItemGroupPopup,"1")				
				.ReDraw = True				
			End With
...
Sub GetSpreadColumnPos(ByVal pvSpdNo)
	...
	Select Case UCase(pvSpdNo)
		Case "A"
			...
			'C_CostCd		= iCurColumnPos(4)	'air :: 코스터센터
			'C_CostPop		= iCurColumnPos(5)	'air :: Popup
			'C_AcctCd		= iCurColumnPos(6)
			'C_AcctPop		= iCurColumnPos(7)
			'C_AcctNm		= iCurColumnPos(8)
			'C_AsstNo		= iCurColumnPos(9)
			'C_AsstNm		= iCurColumnPos(10)
			'C_AcqAmt		= iCurColumnPos(11)
			'C_AcqLocAmt		= iCurColumnPos(12)
			'C_AcqQty		= iCurColumnPos(13)
			'C_DurYrs		= iCurColumnPos(14)	'air :: 내용월수
			'C_ResAmt		= iCurColumnPos(15)
			'C_RefNo			= iCurColumnPos(16)	'air :: 품목그룹
			'C_ItemGroupPopup= iCurColumnPos(17) 'air :: Popup
			'C_Desc			= iCurColumnPos(18)
			
			C_Deptcd		= iCurColumnPos(1)
			C_DeptPop		= iCurColumnPos(2)
			C_DeptNm		= iCurColumnPos(3)
			C_RefNo			= iCurColumnPos(4)	'air :: 품목그룹
			C_ItemGroupPopup	= iCurColumnPos(5) 'air :: Popup
			C_CostCd		= iCurColumnPos(6)	'air :: 코스터센터
			C_CostPop		= iCurColumnPos(7)	'air :: Popup
			C_AcctCd		= iCurColumnPos(8)
			C_AcctPop		= iCurColumnPos(9)
			C_AcctNm		= iCurColumnPos(10)
			C_AsstNo		= iCurColumnPos(11)
			C_AsstNm		= iCurColumnPos(12)
			C_AcqAmt		= iCurColumnPos(13)
			C_AcqLocAmt		= iCurColumnPos(14)
			C_AcqQty		= iCurColumnPos(15)
			C_DurYrs		= iCurColumnPos(16)	'air :: 내용월수
			C_ResAmt		= iCurColumnPos(17)
			C_Desc			= iCurColumnPos(18)
...
'------------------------------------------  OpenItemGroup()  --------------------------------------------
' Name : OpenItemGroupCd()
' Description : ItemGroupCd PopUp
'---------------------------------------------------------------------------------------------------------
Function OpenItemGroupCd()
	Dim arrRet
	Dim arrParam(5), arrField(6), arrHeader(6)
...
Function OpenItemGroup1(byval strItemGroup, byval Row)
	...
	Call SetActiveCell(frm1.vspdData,C_RefNo,Row,"M","X","X")
	...
	With frm1	
		Select case field_fg
			...
			case "DeptCd_grid"
				...
				Call vspdData_Change(C_DeptCd, .vspdData.Row)
			...
			case "AcctCd"
				...
				Call vspdData_Change(C_AcctCd, .vspdData.Row)
...
'	End If
	...
	'Param1 = "P01" 'hanc Trim(frm1.txtPlantCd1.value)
...
'	arrField(4) = 5
'
'	iCalledAspName = AskPRAspName("A7102PA1")
'	If Trim(iCalledAspName) = "" Then
...
'	End With
	With frm1
		.vspdData2.Col = C_BuildAsstNo
'msgbox arrRet(0,0)		
		.vspdData2.Text = arrRet(0,0)

		.vspdData2.Col = C_Amt
		.vspdData2.Text = arrRet(0,1)		
		.vspdData2.Col = C_LocAmt
		.vspdData2.Text = arrRet(0,1)

		Call vspdData2_Change(C_BuildAsstNo, frm1.vspdData2.Row)				 ' 변경이 읽어났다고 알려줌 		
	End With
	lgBlnFlgChgValue = True
End Function
	...
	With frm1.vspdData
		...
		If Row > 0 then
			...
			elseif Col = C_DeptPop Then
 			...
 			elseif Col = C_CostPop Then
 			    .Col = C_CostCd
 			    .Row = Row
 
 			   	Call OpenCostPopUP(.Text)
 		    elseif Col = C_ItemGroupPopup Then
...
Function FncSave() 
    ...
    If CheckNumeric(Trim(GetSpreadText(frm1.vspdData, C_DurYrs, frm1.vspdData.ActiveRow, "X", "X")))=1 then          
        IntRetCD = DisplayMsgBox("229924", "x","x","x")                'Menu sequence only decimal
        Exit Function        
    End If
    ...
    For IntRows = 1 To .MaxRows
		...
		Select Case .Text		    
		    ...
		    Case Else
		        ...
		        .Col = C_BuildAsstNo	'>>air : 건설중인자산번호		
	...
	For IntRows = 1 To .MaxRows
		...
		Select Case  .Text 
            ...
            Case Else 
				...
				.Col = C_CostCd													'32	A073_IG1_I4_cost_cd		코스트코드 : air
				strVal = strVal & Trim(.Text) & parent.gColSep
				.Col = C_DurYrs													'33	A073_IG1_I4_dur_yrs		내용월수(공통) : air
				strVal = strVal & Trim(.Text) & parent.gColSep
