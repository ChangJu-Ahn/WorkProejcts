					...
					<TD WIDTH=100% HEIGHT=20% valign=top>
						<FIELDSET STYLE="HEIGHT:60%"><LEGEND>출력구분</LEGEND>
							<TABLE <%=LR_SPACE_TYPE_60%>>
								<TR>
									<TD CLASS="TD6" NOWRAP><INPUT TYPE="RADIO" CLASS="Radio" NAME=RadioFg ID=Depr_By_Dept><LABEL FOR=Depr_By_Dept>부서별감가상각내역</LABEL></TD>
								</TR>
								<TR>
									<TD CLASS="TD6" NOWRAP><INPUT TYPE="RADIO" CLASS="Radio" NAME=RadioFg ID=Depr_By_Acct><LABEL FOR=Depr_By_Acct>자산별감가상각내역</LABEL></TD>
								</TR>
							</TABLE>
						</FIELDSET>
					</TD>
