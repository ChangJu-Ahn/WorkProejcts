...
Const BIZ_PGM_ID = "A7104MB1_ko441.asp"			'☆: 비지니스 로직 ASP명 
...
Sub InitSpreadSheet()
    ...
    Call SetZAdoSpreadSheet("A7104MA101_ko441","S","A","V20030701",Parent.C_SORT_DBAGENT,frm1.vspdData, C_MaxKey, "X","X")
