...
Const BIZ_PGM_ID 		= "A7112MB1_KO441.asp"                              '☆: Biz Logic ASP Name
...
Function DbQuery() 
	...
	With frm1	
    '---------Developer Coding part (Start)----------------------------------------------------------------
		if .rdoDurMnthFg(0).checked then DurMnthFg = "C"
    	if .rdoDurMnthFg(1).checked then DurMnthFg = "T"
		...
		strVal	= strVal & "&DurMnthFg="		& DurMnthFg
						...
						<FIELDSET CLASS="CLSFLD">
							<TABLE <%=LR_SPACE_TYPE_40%>>
								...
								<TR>
									...
									<TD CLASS="TD5" NOWRAP>내용월수구분</TD>
									<TD CLASS="TD6" COLSPAN="3" NOWRAP> <SPAN STYLE="width:120;"><INPUT TYPE="RADIO" CLASS="RADIO" checked NAME="rdoDurMnthFg" TAG="12" ID="rbMnthTax"><LABEL TYPE="HIDDEN" FOR="rbMnthCas">기업회계기준</LABEL></SPAN>
																		<SPAN STYLE="width:120;"><INPUT TYPE="RADIO" CLASS="RADIO" NAME="rdoDurMnthFg" TAG="12" ID="rbMnthCas"><LABEL TYPE="HIDDEN" FOR="rbMnthTax">세법기준</LABEL></SPAN></TD>
								</TR>
...
<!--										<TD CLASS="TD6" NOWRAP><INPUT TYPE="Text" NAME="txtDeprMthd" SIZE=20 MAXLENGTH="10" tag="24" STYLE="TEXT-ALIGN: center" ALT="상각방법"></TD>  -->
									...
									<TR>
										...
										<TD CLASS=TD6 NOWRAP>
											<SCRIPT LANGUAGE=JavaScript> ExternalWrite('<OBJECT CLASSID=<%=gCLSIDFPDS%> id=fpDoubleSingle4 name="txtDurMnth" style="HEIGHT: 20px; RIGHT: 0px; TOP: 0px; WIDTH: 80px" title="FPDOUBLESINGLE" ALT="내용월수" tag="24X3"> </OBJECT>');</SCRIPT>&nbsp;
										</TD>											
										<TD CLASS="TD5" NOWRAP></TD>
										<TD CLASS=TD6 NOWRAP></TD>
									</TR>
