...
Sub SubBizQuery()
	...
	Set iPAAG015 = Server.CreateObject("PAAG015.cAAS0049LkUpSvr")
    ...
    Response.Write "	.frm1.txtRefNo.value     = """ & ConvSPChars(E2_a_asset_master(A512_E2_ref_no))			& """" & vbCr '참조번호            
...
Sub SubBizSave()
	...
	'------------------
	'*** Import Data ***
	Redim I1_a_asset_master(24)
	
	I1_a_asset_master(A510_I1_asst_no)						= Trim(Request("txtCondAsstNo")) 			   '자산번호                    
    I1_a_asset_master(A510_I1_ref_no)						= Trim(Request("txtRefNo"))					   '참조번호                    
   ...
   'I1_a_asset_master(A510_I1_cas_dur_mnth)					= ?                             '기업회계기준기준내용월수    
    ...
    Set iPAAG015 = Server.CreateObject("PAAG015.cAAS0041MngSvr")
