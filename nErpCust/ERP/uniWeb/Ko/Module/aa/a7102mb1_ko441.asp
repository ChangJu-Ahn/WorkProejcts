...
'추가내역
    ...
    Const A311_EG2_E3_cost_cd = 2		'Cost Center : air   
    Const A311_EG2_E2_acct_cd = 3		'계정코드
    Const A311_EG2_E2_acct_nm = 4		'계정단명
    Const A311_EG2_E3_asst_no = 5		'자산번호
    Const A311_EG2_E3_asst_nm = 6		'자산명
    Const A311_EG2_E3_acq_amt = 7		'취득금액
    Const A311_EG2_E3_acq_loc_amt = 8	'취득금액(자국)
    Const A311_EG2_E3_acq_qty = 9		'취득수량
    Const A311_EG2_E3_dur_yrs = 10		'내용연수    : air 
    Const A311_EG2_E3_res_amt = 11		'잔존가액(자국)
...
'-------------------------
    ...
    For iLngRow = 0 To UBound(EG1_exp_group,1) - 1
		...
		iStrData = iStrData & "" & gColSep
                iStrData = iStrData & ConvSPChars(EG1_exp_group(iLngRow,A311_EG2_E1_dept_cd)) & gColSep
                iStrData = iStrData & "" & gColSep
                iStrData = iStrData & ConvSPChars(EG1_exp_group(iLngRow,A311_EG2_E1_dept_nm)) & gColSep
                iStrData = iStrData & ConvSPChars(EG1_exp_group(iLngRow,A311_EG2_E3_ref_no)) & gColSep
                iStrData = iStrData & "" & gColSep
                iStrData = iStrData & ConvSPChars(EG1_exp_group(iLngRow,A311_EG2_E3_cost_cd)) & gColSep
                iStrData = iStrData & "" & gColSep
                iStrData = iStrData & ConvSPChars(EG1_exp_group(iLngRow,A311_EG2_E2_acct_cd)) & gColSep
                iStrData = iStrData & "" & gColSep
                iStrData = iStrData & ConvSPChars(EG1_exp_group(iLngRow,A311_EG2_E2_acct_nm)) & gColSep
                iStrData = iStrData & ConvSPChars(EG1_exp_group(iLngRow,A311_EG2_E3_asst_no)) & gColSep
                iStrData = iStrData & ConvSPChars(EG1_exp_group(iLngRow,A311_EG2_E3_asst_nm)) & gColSep
                iStrData = iStrData & UNIConvNumDBToCompanyByCurrency(EG1_exp_group(iLngRow,A311_EG2_E3_acq_amt),lgCurrency,ggAmtOfMoneyNo, "X" , "X")  & gColSep
                iStrData = iStrData & UNIConvNumDBToCompanyByCurrency(EG1_exp_group(iLngRow,A311_EG2_E3_acq_loc_amt),lgCurrency,ggAmtOfMoneyNo,gLocRndPolicyNo,"X")  & gColSep              
                iStrData = iStrData & ConvSPChars(EG1_exp_group(iLngRow,A311_EG2_E3_acq_qty)) & gColSep
                iStrData = iStrData & UNIConvNumDBToCompanyByCurrency(EG1_exp_group(iLngRow,A311_EG2_E3_dur_yrs),lgCurrency,ggAmtOfMoneyNo,gLocRndPolicyNo,"X")  & gColSep
		iStrData = iStrData & UNIConvNumDBToCompanyByCurrency(EG1_exp_group(iLngRow,A311_EG2_E3_res_amt),lgCurrency,ggAmtOfMoneyNo, "X" , "X")  & gColSep			
		iStrData = iStrData & ConvSPChars(EG1_exp_group(iLngRow,A311_EG2_E3_asset_desc)) & gColSep
		iStrData = iStrData & intMaxRows_i + iLngRow + 1
