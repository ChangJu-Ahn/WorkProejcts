...
'*  3. Program ID           : a7111ma1_ko441.asp
'*  4. Program Name         : 감가상각계산(site)
'*  5. Program Desc         :
...
Const BIZ_PGM_ID = "a7111bb1_ko441.asp"  
					...
					<TD>
						<TABLE ID="MyTab" CELLSPACING=0 CELLPADDING=0>
							<TR>
								...
								<td background="../../../CShared/image/table/seltab_up_bg.gif" align="center" CLASS="CLSMTAB"><font color=white>감가상각계산(site)</font></td>
