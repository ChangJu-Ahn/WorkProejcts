								...
								<TD WIDTH=50%>
									...
									<TABLE CLASS="TB2" CELLSPACING=0 STYLE="HEIGHT: 96%">
										...
										<TR>
											...
											<TD CLASS="TD6" NOWRAP><INPUT TYPE="Text" NAME="txtCostCd" SIZE=15 MAXLENGTH=10 tag="24" ALT="코스트센터코드"> <INPUT TYPE="Text" NAME="txtCostNm" SIZE=27 MAXLENGTH=40 tag="24" ALT="코스트센터명"></TD>
										</TR>
										<TR>
								...
								<TD WIDTH=50% valign=top>
									...
									<TABLE CLASS="BasicTB" CELLSPACING=0>
										<TR>
											...
											<TD CLASS="TD6" NOWRAP><SCRIPT LANGUAGE=JavaScript> ExternalWrite('<OBJECT title=FPDOUBLESINGLE style="LEFT: 0px; WIDTH: 80px; TOP: 0px; HEIGHT: 20px" name=txtTaxDurYrs CLASSID=<%=gCLSIDFPDS%> tag="22X60" ALT="내용월수" VIEWASTEXT id=OBJECT1></OBJECT>');</SCRIPT>
										</TR>
										<TR>
									...
									<TABLE CLASS="BasicTB" CELLSPACING=0>
										<TR>
											<TD CLASS="TD5" NOWRAP>내용월수</TD>
											<TD CLASS="TD6" NOWRAP><SCRIPT LANGUAGE=JavaScript> ExternalWrite('<OBJECT title=FPDOUBLESINGLE style="LEFT: 0px; WIDTH: 80px; TOP: 0px; HEIGHT: 20px" name=txtCasDurYrs CLASSID=<%=gCLSIDFPDS%> tag="22X60" ALT="내용월수" VIEWASTEXT id=OBJECT2></OBJECT>');</SCRIPT>										
										</TR>
										<TR>
											<TD CLASS="TD5" NOWRAP>상각율</TD>
