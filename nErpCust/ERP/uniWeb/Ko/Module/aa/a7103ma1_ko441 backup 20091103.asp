...
Const BIZ_PGM_ID = "a7103mb1_ko441.asp"     									'☆: 비지니스 로직 ASP명 
...
Function OpenItemGroup()
	...
	If IsOpenPop = True Or UCase(frm1.txtRefNo.className) = UCase(parent.UCN_PROTECTED) Then Exit Function

	IsOpenPop = True

	arrParam(0) = "품목그룹팝업"	
	arrParam(1) = "B_ITEM_GROUP"				
	arrParam(2) = Trim(frm1.txtRefNo.Value)
	arrParam(3) = ""
...
msgbox "cboCasDeprSts:" & frm1.cboCasDeprSts.value
...
msgbox "varRemAmtCas(3):"& varRemAmtCas
msgbox "varBalAmtCas(3):"& varBalAmtCas
		...
		' 상각완료 아니면서 미상각금액이 상각완료되는 금액이면 Error
		'***********************************************************	
msgbox "varRemAmtCas(4):"& varRemAmtCas
msgbox "varBalAmtCas(4):"& varBalAmtCas
								...
								<TD WIDTH=50%>
									...
									<TABLE CLASS="TB2" CELLSPACING=0 STYLE="HEIGHT: 96%">
										...
										<TR>
											...
											<TD CLASS="TD6" NOWRAP><INPUT TYPE="Text" NAME="txtRefNo" SIZE=30 MAXLENGTH=30 TAG="2x" ALT="참조번호"><IMG SRC="../../../CShared/image/btnPopup.gif" NAME="btnItemGroup" align=top TYPE="BUTTON"ONCLICK="vbscript:OpenItemGroup()"></TD>
										</TR>
										<TR>
										...
										<TR>
											...
											<TD CLASS="TD6" NOWRAP><INPUT TYPE="Text" NAME="txtCostCd" SIZE=15 MAXLENGTH=10 tag="22X60" ALT="코스트센터코드"><IMG SRC="../../../CShared/image/btnPopup.gif" NAME="btn" ALIGN=top TYPE="BUTTON" ONCLICK="Call OpenPopup(frm1.txtCostCd.value, 0)"><INPUT TYPE="Text" NAME="txtCostNm" SIZE=27 MAXLENGTH=40 tag="24" ALT="코스트센터명"></TD>
										</TR>
										<TR>
...
<%	End If %>										
								...
								<TD WIDTH=50% valign=top>
									...
									<TABLE CLASS="BasicTB" CELLSPACING=0>
										<TR>
											<TD CLASS="TD5" NOWRAP>내용월수</TD>
											<TD CLASS="TD6" NOWRAP><SCRIPT LANGUAGE=JavaScript> ExternalWrite('<OBJECT title=FPDOUBLESINGLE style="LEFT: 0px; WIDTH: 80px; TOP: 0px; HEIGHT: 20px" name=txtTaxDurYrs CLASSID=<%=gCLSIDFPDS%> tag="22X7" ALT="내용월수" VIEWASTEXT id=OBJECT1></OBJECT>');</SCRIPT>
										</TR>
										<TR>
									...
									<TABLE CLASS="BasicTB" CELLSPACING=0>
										<TR>
											<TD CLASS="TD5" NOWRAP>내용월수</TD>
											<TD CLASS="TD6" NOWRAP><SCRIPT LANGUAGE=JavaScript> ExternalWrite('<OBJECT title=FPDOUBLESINGLE style="LEFT: 0px; WIDTH: 80px; TOP: 0px; HEIGHT: 20px" name=txtCasDurYrs CLASSID=<%=gCLSIDFPDS%> tag="22X7" ALT="내용월수" VIEWASTEXT id=OBJECT2></OBJECT>');</SCRIPT>										
										</TR>
										<TR>
											<TD CLASS="TD5" NOWRAP>상각율</TD>
