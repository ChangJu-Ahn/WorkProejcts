...
'**********************************************************************************************************
Const BIZ_PGM_ID = "a7105mb1.asp"			'☆: 비지니스 로직 ASP명 
...
svrDate = GetSvrDate
%>
	frm1.htxtCurrentDt.value = UniConvDateAToB("<%=svrDate%>", parent.gServerDateFormat,gDateFormat)
    
    ' 부서배분율Master 와 부서배분율History 중 어떤 것을 사용할지에 대한 변수 설정 
	Dim IntRet, iWhere

    iWhere = " MAJOR_CD = " & FilterVar("A1001", "''", "S") & " AND MINOR_CD = 'DP' AND SEQ_NO = 2 "
...
Sub InitSpreadSheet()
	...
	'    .ColHidden = True
	    ...
	    ggoSpread.SSSetEdit     C_DeptCd,     "관리부서",		  12, , , 10,2 '3
	    ggoSpread.SSSetButton   C_DeptCdPopUp									'4
	    ggoSpread.SSSetEdit		C_DeptNm,     "부서명",           35			'5
	    ggoSpread.SSSetEdit		C_OrgChangeId,"조직변경코드",     35			'5
		...
		'Col, Header, ColWidth, HAlign, FloatMax, FloatMin, FloatSeparator, FloatSepChar, FloatDecimalPlaces, FloatDeciamlChar
	   	ggoSpread.SSSetFloat	C_AssnRate,   "배분비율(%)", 21, parent.ggExchRateNo,ggStrIntegeralPart, ggStrDeciPointPart,parent.gComNum1000,parent.gComNumDec,,,"Z","0","100"
...
Sub GetSpreadColumnPos(ByVal pvSpdNo)
	...
	Case "A"
		...
		Call ggoSpread.GetSpreadColumnPos(iCurColumnPos)
			...
			C_DeptCdPopUp = iCurColumnPos(2)
			C_DeptNm      = iCurColumnPos(3)
			C_OrgChangeId = iCurColumnPos(4)
			C_CostCd		= iCurColumnPos(5)
			C_CostNm		= iCurColumnPos(6)
			C_CostType    = iCurColumnPos(7)
			C_CostTypeNm  = iCurColumnPos(8)
			C_InvQty		= iCurColumnPos(9)
			C_AssnRate    = iCurColumnPos(10)
	End Select
End Sub
...
'	Call FormatField(Document, "2", ggAmtOfMoney, ggQty, ggUnitCost, ggExchRate)  '⊙: Format Contents  Field
						...
						<FIELDSET CLASS="CLSFLD">
							<TABLE <%=LR_SPACE_TYPE_40%>>
								<TR>
									...
									<TD CLASS="TD656" NOWRAP><INPUT TYPE="Text" NAME="txtCondAsstNo"  SIZE=18 MAXLENGTH=18 STYLE="TEXT-ALIGN: Left" tag="12XXXU" ALT="자산번호"><IMG SRC="../../../CShared/image/btnPopup.gif" NAME="btnAcqNo" ALIGN=top TYPE="BUTTON" ONCLICK="vbscript:OpenMasterRef()"> <INPUT TYPE="Text" NAME="txtCondAsstNm" SIZE=25 MAXLENGTH=30 tag="14" ALT="자산명"></TD>
								</TR>
							</TABLE>
						</FIELDSET>
					</TD>
