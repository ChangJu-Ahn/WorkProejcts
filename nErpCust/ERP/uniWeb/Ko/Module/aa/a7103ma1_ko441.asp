								...
								<TD WIDTH=50% valign=top>
									...
									<TABLE CLASS="BasicTB" CELLSPACING=0>
										<TR>
											...
											<TD CLASS="TD6" NOWRAP><SCRIPT LANGUAGE=JavaScript> ExternalWrite('<OBJECT title=FPDOUBLESINGLE style="LEFT: 0px; WIDTH: 80px; TOP: 0px; HEIGHT: 20px" name=txtTaxDurYrs CLASSID=<%=gCLSIDFPDS%> tag="22X99" ALT="내용월수" VIEWASTEXT id=OBJECT1></OBJECT>');</SCRIPT>
										</TR>
										<TR>
									...
									<TABLE CLASS="BasicTB" CELLSPACING=0>
										<TR>
											<TD CLASS="TD5" NOWRAP>내용월수</TD>
											<TD CLASS="TD6" NOWRAP><SCRIPT LANGUAGE=JavaScript> ExternalWrite('<OBJECT title=FPDOUBLESINGLE style="LEFT: 0px; WIDTH: 80px; TOP: 0px; HEIGHT: 20px" name=txtCasDurYrs CLASSID=<%=gCLSIDFPDS%> tag="22X99" ALT="내용월수" VIEWASTEXT id=OBJECT2></OBJECT>');</SCRIPT>										
										</TR>
										<TR>
											<TD CLASS="TD5" NOWRAP>상각율</TD>
