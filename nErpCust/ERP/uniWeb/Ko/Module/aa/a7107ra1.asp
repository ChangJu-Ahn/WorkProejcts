...
Sub InitSpreadSheet()
    ...
    Select Case "<%=strPid%>"
		Case "A7107MA1"	
			Call SetZAdoSpreadSheet("A7107RA1","S","A","V20021211",PopupParent.C_SORT_DBAGENT,frm1.vspdData, C_MaxKey, "X","X")
		Case "A7108MA1"	
			Call SetZAdoSpreadSheet("A7107RA3","S","A","V20021211",PopupParent.C_SORT_DBAGENT,frm1.vspdData, C_MaxKey, "X","X")
		Case "A7109MA1"
			Call SetZAdoSpreadSheet("A7107RA2","S","A","V20021211",PopupParent.C_SORT_DBAGENT,frm1.vspdData, C_MaxKey, "X","X")
    End Select 
