...
Sub SubBizQuery()
	...
	Const A509_EG1_E2_a_asset_chg_item_build_asst_no = 7
  ...
  '********************************************************  
    ...
    Set iPAAG035 = Server.CreateObject("PAAG035_KO441.cAAS0039LkUpSvr")    
...
'    Response.Write "	.frm1.txtApAcctNm.value  = """ & ConvSPChars(E9_a_acct(A311_E9_ap_acct_nm))				 & """" & vbCr '미지급금계정            
	...
	if IsArray(EG1_export_group) then  
		For IntRows = 0 To ubound(EG1_export_group,1)
	        ...
	        '2010.05.31...kbs..건설중인자산번호 추가
			strData = strData & Chr(11)  & ConvSPChars(EG1_export_group(IntRows,A509_EG1_E2_a_asset_chg_item_build_asst_no))
			strData = strData & Chr(11)  & " "	 'build asst pop																	                'C_ItemPopup
...
'	redim IG1_import_group (LngMaxRow,A507_IG1_I3_a_asset_chg_item_paym_loc_amt)
    ...
    Set iPAAG035 = Server.CreateObject("PAAG035_KO441.cAAS0031MngSvr") 
