...
'*  3. Program ID           : h5403oa1
'*  4. Program Name         : 국민연금자격취득/상실신고서 
'*  5. Program Desc         : 국민연금자격취득/상실신고서 
'*  6. Comproxy List        : +
...
Function FncBtnPrint() 
	...
	Dim emp_no, fr_dt, to_dt, sect_cd , singo_dt, singo_org_no, print_emp_no 
	...
	If frm1.txtCap_type(0).checked Then
		StrEbrFile = "h5403oa1_1"
	Else
		StrEbrFile = "h5403oa1_2"
	End If
	...
	singo_org_no = frm1.txtOrg_control.value
	print_emp_no = frm1.txtWrt_prsn.value
	...
	condvar = condvar & "|singo_dt|" & singo_dt
	condvar = condvar & "|singo_org_no|" & singo_org_no
	condvar = condvar & "|print_emp_no|" & print_emp_no
...
Function txtSect_cd_OnChange()
    ...
    ELSE
        ...
        IF IntRetCd = False THEN
            Call DisplayMsgBox("970000", "x","근무구역","x")   '등록되지 않은 코드입니다 
	        frm1.txtSect_cd_nm.value = ""
	        frm1.txtSect_cd_nm.focus
	        Set gActiveElement = document.ActiveElement
					...
					<TD CLASS="CLSMTABP">
						<TABLE ID="MyTab" CELLSPACING=0 CELLPADDING=0>
							<TR>
								...
								<td background="../../../CShared/image/table/seltab_up_bg.gif" align="center" CLASS="CLSLTAB"><font color=white>국민연금취득/상실신고</font></td>
					...
					<TD HEIGHT=20>
						<TABLE <%=LR_SPACE_TYPE_60%>>   
							<TR>
				        	    ...
				        	    <TD CLASS="TD6"><INPUT TYPE="RADIO" CLASS="RADIO" NAME="txtCap_type" TAG=11 VALUE="자격취득" CHECKED ID="med_entr_flag1"><LABEL FOR="txtCap_type1">자격취득</LABEL>&nbsp;
  				        	                    <INPUT TYPE="RADIO" CLASS="RADIO" NAME="txtCap_type" TAG=11 VALUE="자격상실" ID="med_entr_flag2"><LABEL FOR="txtCap_type2">자격상실</LABEL></TD>
							</TR>
							<TR>
								<TD CLASS=TD5 NOWRAP>사업장번호</TD>
								<TD CLASS=TD6 NOWRAP><INPUT NAME="txtOrg_control" ALT="사업장번호" TYPE="Text" MAXLENGTH="10" SIZE="15" tag="12XXXU"></TD>
							</TR>
							<TR>
								...
								<TD CLASS=TD6 NOWRAP><INPUT ID="txtSect_cd" NAME="txtSect_cd" ALT="근무구역" TYPE="Text" SiZE="10" MAXLENGTH="7" tag="12XXXU"><IMG SRC="../../../CShared/image/btnPopup.gif" NAME="btnSItemDC" ALIGN=top TYPE="BUTTON" ONCLICK="vbscript:Call OpenCode('x', 'SECT_CD_POP', 'x')">
								                     <INPUT NAME="txtSect_cd_nm" ALT="근무구역" TYPE="Text" SiZE="20" MAXLENGTH="20" tag="14XXXU"></td>
							</TR>
							<TR>
								<TD CLASS=TD5 NOWRAP>해당일</TD>
								<TD CLASS=TD6 NOWRAP><script language =javascript src='./js/h5403oa1_txtFr_acq_dt_txtFr_acq_dt.js'></script>&nbsp;~&nbsp;
								                    <script language =javascript src='./js/h5403oa1_txtTo_acq_dt_txtTo_acq_dt.js'></script></TD>
							</TR>
							<TR>
							...
							<TR>
								...
								<TD CLASS=TD6 NOWRAP><script language =javascript src='./js/h5403oa1_txtRprt_dt_txtRprt_dt.js'></script></TD>
							</TR>
							<TR>
