...
' 캡션 날짜로 표시
    ...
    With frm1.vspdData
        ...
        ggoSpread.SSSetEdit 	C_PoTypeCdNm     , "",     50,,,50,2
        ggoSpread.SSSetEdit 	C_EMP_NM     , "",     18,,,18,2
        ggoSpread.SSSetEdit 	C_DEPT_NM     , "",     18,,,18,2
        
        ggoSpread.SSSetDate 	C_LIMIT_DT             , "납기일",11, 2, parent.gDateFormat
        ...
        Call ggoSpread.SSSetColHidden(C_CONFIG_FLAG       , C_DEPT_NM          , True)  
...
'		ggoSpread.SpreadUNLock   C_ISSUE_QTY     , -1, C_ISSUE_QTY
        ggoSpread.SSSetRequired  C_LIMIT_DT, -1
...
Sub GetSpreadColumnPos()
    ...
    C_PoTypeCdNm       = iCurColumnPos(18)
    C_EMP_NM        = iCurColumnPos(19)
    C_DEPT_NM       = iCurColumnPos(20)
    C_LIMIT_DT      = iCurColumnPos(21)
    C_LOC      = iCurColumnPos(22)
...
Sub InitComboBox()
    ...
    Call CommonQueryRs(" MINOR_CD,MINOR_NM "," B_MINOR "," MAJOR_CD = " & FilterVar("ZZ005", "''", "S") & " ",lgF0,lgF1,lgF2,lgF3,lgF4,lgF5,lgF6)
    Call SetCombo2(frm1.txtLoc, lgF0, lgF1, Chr(11))
...
'msgbox " 여긴aa insert "
                    ...
                    .vspdData.Col = C_ISSUE_QTY    : strVal = strVal & Trim(.vspdData.Text)      & Parent.gColSep       '6
                    .vspdData.Col = C_REMARK1      : strVal = strVal & Trim(.vspdData.Text)      & Parent.gColSep       '7
                    .vspdData.Col = C_LIMIT_DT      : strVal = strVal & Trim(.vspdData.Text)      & Parent.gColSep      '8
...
Function FncInsertRow(ByVal pvRowCnt)
    ...
    With frm1
	    ...
	    ggoSpread.sssetrequired C_LIMIT_DT,.vspdData.ActiveRow,.vspdData.ActiveRow + imRow - 1        '20080305::HANC
    	...
    	For pvRow = .vspdData.ActiveRow To .vspdData.ActiveRow + imRow -1
			...
			.vspdData.Row = pvRow
			.vspdData.Col   = C_LIMIT_DT
			.vspdData.Text  = .txtPoDt.Text
...
'		    .vspdData.Row   = 1
'		    .vspdData.Col   = C_LIMIT_DT
'		    .vspdData.value  = frm1.txtPoDt.Value
...
Sub vspdData_Click1(ByVal Col, ByVal Row)
    ...
    End If
		...
		With frm1
			...
			.vspdData.Col = C_PoTypeCdNm
			.txtPoTypeCdNm.value = .vspdData.Text
...
Function OpenIssueReq()
	Dim arrRet
	Dim arrParam(5), arrField(8), arrHeader(8)
	Dim iCalledAspName
	Dim IntRetCD
	...
	Param1 = Trim(frm1.txtPoNo.value)
	Param2 = Trim(frm1.txtPlantCd.value)
	...
	iCalledAspName = AskPRAspName("M9311XA1_KO441")     '20080226::HANC
...
Function OpenLoc()
    ...
    arrParam(0) = "LOCATION 팝업"                 ' 팝업 명칭
    arrParam(1) = "B_MINOR "                ' TABLE 명칭
    arrParam(2) = ""
    arrParam(3) = ""                                ' Name Cindition
    arrParam(4) = "MAJOR_CD = 'ZZ005' AND MINOR_TYPE = 'U' "
    arrParam(5) = "LOCATION"
    
    arrField(0) = "MINOR_CD"                         ' Field명(0)

    arrHeader(0) = "LOCATION"                     	' Header명(0)

    	
	arrRet = window.showModalDialog("../../ComAsp/CommonPopup.asp", Array(arrParam, arrField, arrHeader), _
		"dialogWidth=220px; dialogHeight=250px; center: Yes; help: No; resizable: No; status: No;")
...
End Function
'2008-04-29 5:00오후 :: hanc
Function SetLoc(byval arrRet)
	frm1.txtLoc.Value      = arrRet(0)
End Function
'==========================================   Release()  ======================================
'	Name : Release()
'===================================================================================================
...
Function FncBtnPrint() 
  ...
  End If
	...
	strUrl = "PLANT_CD|"		& frm1.txtPlantCd.value 
	strUrl = strUrl & "|REQ_NO|"	& frm1.txtPoNo.value

	ObjName = AskEBDocumentName("M9311OA1_KO441","ebr")
                ...
                <TR>
                    <TD WIDTH=100% HEIGHT=* VALIGN=TOP>
											...
											<TR>
												...
												<INPUT TYPE=TEXT Alt="불출의뢰유형" NAME="txtPoTypeCdNm" SIZE=20 tag="24X">
												</TD>
											</TR>
											<TR>
											...
											<TR>
												...
												<!--    <TD CLASS="TD6" NOWRAP><INPUT TYPE=TEXT Alt="Location" NAME="txtLoc" SIZE=13 MAXLENGTH=13 tag="23NXXU" ><IMG SRC="../../../CShared/image/btnPopup.gif" NAME="btnMoveType" align=top TYPE="BUTTON" ONCLICK="vbscript:OpenLoc()" OnMouseOver="vbscript:PopUpMouseOver()" OnMouseOut="vbscript:PopUpMouseOut()"> -->
												<TD CLASS="TD6" NOWRAP><SELECT NAME="txtLoc" CLASS=required STYLE="text-transform:uppercase; Width: 168px;" ALT="Location" tag="23NXXU"></SELECT></TD>
											</TR>
											<TR STYLE="display:none">
												...
												<INPUT TYPE=TEXT Alt="구매그룹" ID="txtGroupNm" SIZE=20 NAME="arrCond" tag="24X">
												</TD>								
											</TR>
											<TR STYLE="display:none">
			...
			<table <%=LR_SPACE_TYPE_30%>>
				<tr>
					...
					<td align="Left"><a><button name="btnCfmSel" id="btnCfm" class="clsmbtn" ONCLICK="vbscript:Cfm()">확정</button></a>&nbsp;
						<a><button name="btnPrint" id="btnPrint" class="clsmbtn" ONCLICK="vbscript:FncBtnPrint()">불출의뢰서출력</button></a></td>					
