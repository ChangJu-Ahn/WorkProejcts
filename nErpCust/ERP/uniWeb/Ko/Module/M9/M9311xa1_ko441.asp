...
'========================================
Dim arrParent, lgPoNo, lgPlantCD, lgPlantNM, lgDn_Type, lgFLAG, lgMovType
ArrParent = window.dialogArguments
Set PopupParent  = arrParent(0)
    lgPoNo	= arrParent(1)
    lgPlantCD	= arrParent(2)
    lgDn_Type	= arrParent(3)      '
    lgMovType	= arrParent(4)      'trns_type

top.document.title = PopupParent.gActivePRAspName

Const BIZ_PGM_QRY_ID = "M9311xb1_ko441.asp"			
...
Sub InitSpreadSheet()
	...
	With ggoSpread
		...
		Call AppendNumberPlace("7","5","0")
    		...
    		.SSSetEdit		CC_ISSUE_REQ_NO         , "불출의뢰번호",   15,     0
    		.SSSetEdit		CC_REQ_DT               , "불출의뢰일",     10,      0
    		.SSSetEdit		CC_NAME                 , "의뢰담당자",     8,      0
    		.SSSetEdit		CC_TRNS_TYPE            , "출고구분",       8,      0
    		.SSSetEdit		CC_MOV_TYPE             , "불출의뢰유형",   20,     0
    		.SSSetEdit		CC_LOC                  , "LOCATION",       15,     0
    		.SSSetEdit		CC_ITEM_CD              , "품목",           10,     0
    		.SSSetEdit		CC_ITEM_NM              , "품목명",         15,     0
...
Function OKClick()
	...
	Dim before_mov_type, curr_mov_type
		...
		If iLngSelectedRows > 0 Then 
			...
			For intRowCnt = 1 To .MaxRows
				...
				If .SelModeSelected Then
    				.Col = CC_ISSUE_REQ_NO        : arrReturn(0,0) = .Text
				End IF
			Next
...
Sub GetSpreadColumnPos(ByVal pvSpdNo)
    ...
    Select Case UCase(pvSpdNo)
       Case "A"
            ...
            CC_ISSUE_REQ_NO         = iCurColumnPos(1) 
            CC_REQ_DT               = iCurColumnPos(2) 
            CC_NAME                 = iCurColumnPos(3) 
            CC_TRNS_TYPE            = iCurColumnPos(4) 
            CC_MOV_TYPE             = iCurColumnPos(5) 
            CC_LOC                  = iCurColumnPos(6) 
            CC_ITEM_CD              = iCurColumnPos(7) 
            CC_ITEM_NM              = iCurColumnPos(8) 
			...
			<FIELDSET CLASS="CLSFLD">
				<TABLE <%=LR_SPACE_TYPE_40%>>
					<TR >
						...
						<TD CLASS="TD6" NOWRAP><INPUT TYPE=TEXT NAME="txtPoNo" SIZE=29 MAXLENGTH=18 ALT="불출의뢰번호" tag="11NXXU"></TD>
					...
					<TR  STYLE="DISPLAY:NONE">
						...
						<TD CLASS="TD6" NOWRAP></TD>
						<TD CLASS="TD5" NOWRAP STYLE="DISPLAY:NONE">공장</TD>
						<TD CLASS="TD6" NOWRAP STYLE="DISPLAY:NONE"><INPUT NAME="txtPlant" ALT="공장" TYPE="Text" MAXLENGTH=4 SiZE=10 tag="12XXXU" CLASS="required" STYLE="text-transform:uppercase"><IMG SRC="../../../CShared/image/btnPopup.gif" NAME="btnLCType" align=top TYPE="BUTTON" ONCLICK ="vbscript:OpenPlant()">&nbsp;<INPUT NAME="txtPlantNm" TYPE="Text" MAXLENGTH="20" SIZE=25 tag="24" CLASS="protected" READONLY="true" TABINDEX="-1"></TD>
					</TR>
					<TR STYLE="DISPLAY:NONE">
						<TD CLASS=TD5>MES출고일</TD>
						<TD CLASS=TD6>
							<TABLE CELLSPACING=0 CELLPADDING=0>
								<TR>
									<TD>
										<script language =javascript src='./js/m9311xa1_ko441_fpDateTime1_txtFromDt.js'></script>
									</TD>
									<TD>
										&nbsp;~&nbsp;
									</TD>
									<TD>
										<script language =javascript src='./js/m9311xa1_ko441_fpDateTime2_txtToDt.js'></script>
									</TD>
								</TR>
							</TABLE>
						</TD>								
	...
	<TR>
		<TD WIDTH=100% HEIGHT=* valign=top>
			<TABLE <%=LR_SPACE_TYPE_20%>>
				<TR>
					<TD HEIGHT="100%">
						<script language =javascript src='./js/m9311xa1_ko441_vaSpread_vspdData.js'></script>
					</TD>
				</TR>
			</TABLE>
		</TD>
