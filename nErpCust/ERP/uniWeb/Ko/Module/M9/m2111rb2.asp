...
'--------------- 개발자 coding part(실행로직,Start)----------------------------------------------------
	...
	If Len(Request("txtSoNo")) Then
		strVal = strVal & "AND A.SO_NO = " & FilterVar(UCase(Request("txtSoNo")), "''", "S") & " "	
	End If
	...
	If Len(Request("txtSupplier")) Then				
 		strVal = strVal & " AND ((A.SPPL_CD = " & FilterVar("Y", "''", "S") & "   AND G.SPPL_CD LIKE  " & FilterVar(UCase(Request("txtSupplier")), "''", "S") & " ) OR (A.SPPL_CD<>" & FilterVar("Y", "''", "S") & " ))"
	End If	
    
 	If Len(Request("txtGroup")) Then
		strVal = strVal & " AND G.PUR_GRP = " & FilterVar(UCase(Request("txtGroup")), "''", "S") & "  "		
	End If	    
	...
	If Len(Trim(Request("txtPlantCd"))) Then
		strVal = strVal & " AND A.PLANT_CD = " & FilterVar(UCase(Request("txtPlantCd")), "''", "S") & "  "		
	End If	
