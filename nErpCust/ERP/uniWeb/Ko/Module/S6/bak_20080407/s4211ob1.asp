...
'*  1. Module Name          : 영업관리																	*
'*  2. Function Name        :																			*
'*  3. Program ID           : s4211ob1.asp																*
'*  4. Program Name         : 데이터가져오기(Commercial Invoice 출력 통관참조)							*
'*  5. Program Desc         : 데이터가져오기(Commercial Invoice 출력 통관참조)							*
'*  7. Modified date(First) : 2000/12/08																*
'*  8. Modified date(Last)  : 2002/08/22																*
...
<Script Language=VBScript>
	With parent.frm1
		...
		.txtShipper.value = "<%=ConvSPChars(EG1_s_cc_hdr(S446_E3_bp_cd))%>"
		.txtShipperNm.value = "<%=ConvSPChars(EG1_s_cc_hdr(S446_E3_bp_nm))%>"
		.txtParty.value = "<%=ConvSPChars(EG1_s_cc_hdr(S446_E2_bp_cd))%>"
		.txtPartyNm.value = "<%=ConvSPChars(EG1_s_cc_hdr(S446_E2_bp_nm))%>"
		.txtMessers.value = "<%=ConvSPChars(EG1_s_cc_hdr(S446_E2_bp_cd))%>"
		.txtMessersNm.value = "Same As Above"
		.txtLoadingPort.value = "<%=ConvSPChars(EG1_s_cc_hdr(S446_E1_loading_port))%>"
		.txtLoadingPortNm.value = "<%=ConvSPChars(EG1_s_cc_hdr(S446_E18_minor_nm))%>"
		.txtDestination.value = "<%=ConvSPChars(EG1_s_cc_hdr(S446_E1_dischge_port))%>"
		.txtDestinationNm.value = "<%=ConvSPChars(EG1_s_cc_hdr(S446_E20_minor_nm))%>"
		.txtCarrier.value =  "<%=ConvSPChars(EG1_s_cc_hdr(S446_E1_vessel_nm))%>"

		.txtSailing.text = "<%=UNIDateClientFormat(EG1_s_cc_hdr(S446_E1_ship_fin_dt))%>"
		...
		.txtLCNo.value = "<%=ConvSPChars(EG1_s_cc_hdr(S446_E1_lc_doc_no))%>"
		.txtRemarks1.value = "<%=ConvSPChars(EG1_s_cc_hdr(S446_E1_remark1))%>"
		.txtRemarks2.value = "<%=ConvSPChars(EG1_s_cc_hdr(S446_E1_remark2))%>"
		.txtRemarks3.value = "<%=ConvSPChars(EG1_s_cc_hdr(S446_E1_remark3))%>"
		.txtHLCNo.value = "<%=ConvSPChars(EG1_s_cc_hdr(S446_E1_lc_doc_no))%>"
