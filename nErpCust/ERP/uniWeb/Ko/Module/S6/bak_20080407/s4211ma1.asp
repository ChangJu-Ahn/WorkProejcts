...
Function OpenSORef()
	...
	iCalledAspName = AskPRAspName("S3111RA6")
	
	If Trim(iCalledAspName) = "" Then
		IntRetCD = DisplayMsgBox("900040", parent.VB_INFORMATION, "S3111RA6", "X")			
		gblnWinEvent = False
		Exit Function
	End If
...
'		gblnWinEvent = True
	...
	iCalledAspName = AskPRAspName("S3211RA6")
	
	If Trim(iCalledAspName) = "" Then
		IntRetCD = DisplayMsgBox("900040", parent.VB_INFORMATION, "S3211RA6", "X")			
'			gblnWinEvent = False
		Exit Function
	End If
...
'		gblnWinEvent = True
	...
	iCalledAspName = AskPRAspName("M4111RA6")
	
	If Trim(iCalledAspName) = "" Then
		IntRetCD = DisplayMsgBox("900040", parent.VB_INFORMATION, "M4111RA6", "X")			
'			gblnWinEvent = False
		Exit Function
	End If
			...
			<TR HEIGHT=20>
				<TD WIDTH=100%>
					<TABLE <%=LR_SPACE_TYPE_30%>>
						<TD WIDTH=10>&nbsp;</TD>
						<TD WIDTH=* ALIGN=RIGHT><A HREF = "VBSCRIPT:JumpChgCheck(2)">Container배정</A>&nbsp;|&nbsp;<A HREF = "VBSCRIPT:JumpChgCheck(0)">통관내역등록</A>&nbsp;|&nbsp;<A HREF = "VBSCRIPT:JumpChgCheck(1)">판매경비등록</A></TD>
						<TD WIDTH=10>&nbsp;</TD>
					</TABLE>
				</TD>
			</TR>
