				...
				<FIELDSET CLASS="CLSFLD">
					<TABLE <%=LR_SPACE_TYPE_40%>>
						...
						<TR>
							...
							<TD CLASS=TD6 NOWRAP>
								<TABLE CELLSPACING=0 HEIGHT=100%>
									<TR>										
										<TD><script language =javascript src='./js/s3211ra6_fpDoubleSingle3_txtDocAmt.js'></script></TD>
									</TR>
								</TABLE>
							</TD>								
						</TR>
						<TR>	
							...
							<TD CLASS=TD6 NOWRAP>
								<script language =javascript src='./js/s3211ra6_fpDateTime1_txtFromDt.js'></script>&nbsp;~&nbsp;
								<script language =javascript src='./js/s3211ra6_fpDateTime2_txtToDt.js'></script>
							</TD>
				...
				<TABLE <%=LR_SPACE_TYPE_20%>>
					<TR>
						<TD HEIGHT="100%" NOWRAP>
							<script language =javascript src='./js/s3211ra6_vaSpread_vspdData.js'></script>
						</TD>
					</TR>
				</TABLE>
			</TD>
