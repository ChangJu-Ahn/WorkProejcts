...
Sub SetDefaultVal()	
	...
	frm1.txtWeightUnit.value = arrParam(2)
	frm1.txtNetWeight.text = arrParam(3)
	frm1.txtCurrency.value = arrParam(4)
	frm1.txtAmt.Text = arrParam(5)
...
Sub InitSpreadSheet()	    
	...
	Call SetZAdoSpreadSheet("S4212RA601","S","A","V20030321",PopupParent.C_SORT_DBAGENT,frm1.vspdData, _
								C_MaxKey, "X","X")		
	Call SetSpreadLock 								
...
Sub CurFormatNumericOCX()
	With frm1
		'개설금액 
		ggoOper.FormatFieldByObjectOfCur .txtAmt, .txtCurrency.value, PopupParent.ggamtofmoneyNo, gBCurrency, gBDataType, gBDecimals, PopupParent.gDateFormat, PopupParent.gComNum1000,PopupParent.gComNumDec
	End With
End Sub
'========================================================================================
Function FncQuery() 
					...
					<TR>
						...
						<TD CLASS=TD6 NOWRAP>
							<TABLE CELLSPACING=0 CELLPADDING=0>
								<TR>
									<TD>
										<INPUT TYPE=TEXT NAME="txtWeightUnit" SIZE=5 MAXLENGTH=3 TAG="24XXXU">&nbsp;
									</TD>
									<TD>
										&nbsp;&nbsp;&nbsp;&nbsp;<script language =javascript src='./js/s4212ra6_fpDoubleSingle1_txtNetWeight.js'></script>
									</TD>
								</TR>
							</TABLE>
						</TD>	
						<TD CLASS=TD5 NOWRAP>총 통관금액</TD>
						<TD CLASS=TD6 NOWRAP>
							<TABLE CELLSPACING=0 CELLPADDING=0>
								<TR>
									<TD>
										<INPUT TYPE=TEXT NAME="txtCurrency" SIZE=5 MAXLENGTH=3 TAG="24XXXU">&nbsp;
									</TD>
									<TD>
										&nbsp;&nbsp;&nbsp;&nbsp;<script language =javascript src='./js/s4212ra6_fpDoubleSingle1_txtAmt.js'></script>
									</TD>
								</TR>
							</TABLE>
						</TD>	
		...
		<TR>
			<TD WIDTH=100% HEIGHT=* valign=top>
				<TABLE WIDTH="100%" HEIGHT="100%">
					<TR>
						<TD HEIGHT="100%">
							<script language =javascript src='./js/s4212ra6_vaSpread1_vspdData.js'></script>
						</TD>
					</TR>
				</TABLE>
			</TD>
...
<INPUT TYPE=HIDDEN NAME="HWeightUnit" tag="24">
<INPUT TYPE=HIDDEN NAME="HNetWeight" tag="24">
<INPUT TYPE=HIDDEN NAME="HCurrency" tag="24">
<INPUT TYPE=HIDDEN NAME="HAmt" tag="24">
</FORM>	
