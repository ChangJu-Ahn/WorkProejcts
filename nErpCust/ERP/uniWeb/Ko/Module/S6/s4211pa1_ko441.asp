			...
			<FIELDSET CLASS="CLSFLD">
				<TABLE <%=LR_SPACE_TYPE_40%>>
					...
					<TR>
						...
						<TD CLASS=TD6 NOWRAP>
							<SCRIPT LANGUAGE=JavaScript> ExternalWrite('<OBJECT CLASSID=<%=gCLSIDFPDT%> id=fpDateTime1 NAME="txtFromDt" CLASS=FPDTYYYYMMDD tag="11X1" Title="FPDATETIME" ALT="작성일시작일"></OBJECT>');</SCRIPT>&nbsp;~&nbsp;
							<SCRIPT LANGUAGE=JavaScript> ExternalWrite('<OBJECT CLASSID=<%=gCLSIDFPDT%> id=fpDateTime2 NAME="txtToDt" CLASS=FPDTYYYYMMDD tag="11X1" Title="FPDATETIME" ALT="작성일종료일"></OBJECT>');</SCRIPT>
						</TD>	
					</TR>
				</TABLE>
			</FIELDSET>
