...
Const EXCC_HEADER_ENTRY_ID = "s4211ma1_ko441"			'☆: 이동할 ASP명
		...
		<TR HEIGHT=20>
			<TD WIDTH=100%>
				<TABLE <%=LR_SPACE_TYPE_30%>>
					<TD WIDTH=10>&nbsp;</TD>
					<TD WIDTH=* ALIGN=RIGHT><A HREF = "VBSCRIPT:JumpChgCheck(2)">Container배정</A>&nbsp;|&nbsp;<A HREF = "VBSCRIPT:JumpChgCheck(0)">통관란등록</A>&nbsp;|&nbsp;<A HREF = "VBSCRIPT:JumpChgCheck(1)">통관등록</A>|&nbsp;<A HREF = "VBSCRIPT:JumpChgCheck(3)">통관INVOICE추가내역등록</A></TD>
					<TD WIDTH=10>&nbsp;</TD>
				</TABLE>
			</TD>
		</TR>
