...
Sub FixUNISQLData()
	...
	If Len(Request("txtCcNo")) Then
		strVal = " AND B.CC_NO =  " & FilterVar(Request("txtCCNo"), "''", "S") & " "
	Else
		strVal = ""
	End If
...
<Script Language=vbscript>
	...
	With Parent	
		...
		.frm1.vspdData.Redraw = False
			...
			Call .ReFormatSpreadCellByCellByCurrency2(.frm1.vspdData,-1,-1,"<%=Trim(Request("txtCurrency"))%>",.GetKeyPos("A",1),"A","Q","X","X")
			Call .ReFormatSpreadCellByCellByCurrency2(.frm1.vspdData,-1,-1,"<%=Trim(Request("txtLocCurrency"))%>",.GetKeyPos("A",2),"A","Q","X","X")
			Call .ReFormatSpreadCellByCellByCurrency2(.frm1.vspdData,-1,-1,"<%=Trim(Request("txtCurrency"))%>",.GetKeyPos("A",3),"A","Q","X","X")
