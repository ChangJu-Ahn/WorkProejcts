...
Function FncBtnPrint() 
	...
	If frm1.Rb_TA1.checked = True Then
		...
		If frm1.Rb_WK1.checked = True Then     ' 매입처별 세금계산서합계표 
			var1 = "I"
			If frm1.Rb_AB1.checked = True Then    '갑 
				StrEbrFile = "a6111ma1"
			Else                                  '을 
				StrEbrFile = "a6111ma1a"
			End IF		
		Else
		                                  ' 매출처별 세금계산서합계표 
			var1 = "O"
			If frm1.Rb_AB1.checked = True Then    '갑 
				StrEbrFile = "a6111ma2"
			Else                                  '을 
				StrEbrFile = "a6111ma2a"	
			End IF		
		End If

	Else                                      ' 계산서 일때는 매입만 필요하기 때문에 갑을 체크만 한다.
		If frm1.Rb_WK1.checked = True Then     ' 매입처별 계산서합계표 
			var1 = "I"
			If frm1.Rb_AB1.checked = True Then    '갑 
					StrEbrFile = "a6111ma1a1"
			Else                                  '을 
					StrEbrFile = "a6111ma1a2"
			End IF	
		Else
		                                  ' 매출처별 계산서합계표 
			var1 = "O"
			If frm1.Rb_AB1.checked = True Then    '갑 
				StrEbrFile = "a6111ma2a1"
			Else                                  '을 
				StrEbrFile = "a6111ma2a2"	
			End IF		
		End If
...
Sub Form_Load()
	...
	'//매출계산서합계도 추가되었기때문에 이부분을 주석처리함 2002-05-28 이남요 
	'//strradio.innerHTML = "매출"
					...
					<TD CLASS="CLSMTABP">
						<TABLE ID="MyTab" CELLSPACING=0 CELLPADDING=0>
							<TR>
								...
								<td background="../../../CShared/image/table/seltab_up_bg.gif" align="center" CLASS="CLSMTABP"><font color=white>계산서합계표출력</font></td>
					...
					<TD WIDTH=100% HEIGHT=100% valign=top>
						<TABLE <%=LR_SPACE_TYPE_60%>>
							...
							<TR>
								...
								<TD CLASS="TD6"><INPUT TYPE="RADIO" CLASS="Radio" NAME=Radio3 ID=Rb_TA1 Checked><LABEL FOR=Rb_TA1>세금계산서</LABEL>&nbsp;
								                <INPUT TYPE="RADIO" CLASS="Radio" NAME=Radio3 ID=Rb_TA2><LABEL FOR=Rb_TA2>계산서</LABEL></TD>
							</TR>
							<TR>
								<TD CLASS="TD5" NOWRAP>입출구분</TD>
								<TD CLASS="TD6">									
									<SPAN STYLE="WIDTH: 80px"><INPUT TYPE="RADIO" CLASS="RADIO" NAME="OptFlag" CHECKED ID="Rb_WK1" VALUE="Y" tag="25"><LABEL FOR="Rb_WK1">매입</LABEL></SPAN>
									&nbsp;&nbsp;&nbsp;&nbsp;
									<!-- 매출계산서합계도 추가되었기때문에 이부분을 주석처리하고 다시 작성함 2002-05-28 이남요 
									<SPAN STYLE="WIDTH: 80px"><INPUT TYPE="RADIO" CLASS="RADIO" NAME="OptFlag" ID="Rb_WK2" VALUE="N" tag="25"><LABEL TYPE = "LABEL" CLASS="normal" ID="strradio" FOR="Rb_WK2"></LABEL></SPAN></TD>
									-->
									<SPAN STYLE="WIDTH: 80px"><INPUT TYPE="RADIO" CLASS="RADIO" NAME="OptFlag"  ID="Rb_WK2" VALUE="N" tag="25"><LABEL FOR="Rb_WK2">매출</LABEL></SPAN>&nbsp;
									<!--<SPAN CLASS="normal" ID="strradio">매출</SPAN></TD> -->
									
									
							</TR>
							<TR>
								<TD CLASS="TD5" NOWRAP>갑을구분</TD>
								<TD CLASS="TD6"><INPUT TYPE="RADIO" CLASS="Radio" NAME=Radio2 ID=Rb_AB1 Checked><LABEL FOR=Rb_AB1>갑</LABEL>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								                <INPUT TYPE="RADIO" CLASS="Radio" NAME=Radio2 ID=Rb_AB2><LABEL FOR=Rb_AB2>을</LABEL></TD>
							</TR>
							<TR>
								<TD CLASS="TD5">&nbsp;</TD>
								<TD CLASS="TD6">&nbsp;</TD>
								...
								<TD CLASS="TD6"><INPUT TYPE=TEXT ID="txtBizAreaCD" NAME="txtBizAreaCD" SIZE=12 MAXLENGTH=10 ALT="세금신고사업장" tag="11NXXU" ><IMG SRC="../../../CShared/image/btnPopup.gif" NAME="btn" ALIGN=top TYPE="BUTTON" ONCLICK="vbscript:Call OpenPopUp(frm1.txtBizAreaCD.Value, 0)">&nbsp;
											    <INPUT TYPE=TEXT ID="txtBizAreaNM" NAME="txtBizAreaNM" SIZE=20 MAXLENGTH=50 ALT="세금신고사업장" tag="14X" ></TD>
							</TR>
							<TR>
							 	<TD CLASS="TD5">발행일</TD>
								<TD CLASS="TD6"><script language =javascript src='./js/a6110oa1_fpDateTime1_txtFromIssueDt.js'></script>
												 &nbsp;~&nbsp;
											    <script language =javascript src='./js/a6110oa1_fpDateTime2_txtToIssueDt.js'></script></TD>
							</TR>
							<TR>
							 	<TD CLASS="TD5">작성일</TD>
								<TD CLASS="TD6"><script language =javascript src='./js/a6110oa1_fpDateTime3_txtDrawnUpDt.js'></script></TD>
							</TR>
							<TR>
							 	<TD CLASS="TD5">회기</TD>
								<TD CLASS="TD6"><script language =javascript src='./js/a6110oa1_fpDoubleSingle1_txtFiscCnt.js'></script></TD>
							</TR>
							<TR>
								<TD CLASS="TD5">&nbsp;</TD>
								<TD CLASS="TD6">&nbsp;</TD>
