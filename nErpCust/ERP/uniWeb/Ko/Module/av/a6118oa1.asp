...
'*  3. Program ID           : A6118OA1
'*  4. Program Name         : 신용카드매출전표수취명세서출력 
'*  5. Program Desc         :
'*  6. Component List       : 
'*  7. Modified date(First) : 2004/05/10
'*  8. Modified date(Last)  : 
'*  9. Modifier (First)     : Eun Joo KIM
'* 10. Modifier (Last)      : 
'* 11. Comment              :
...
Function FncBtnPrint() 
	...
	If frm1.Rb_AB1.checked = True Then            '갑 
			StrEbrFile = "A6118OA1"
	Elseif frm1.Rb_AB2.checked = True then        '을 
			StrEbrFile = "A6118OA2"
	Else                                          '병 
			StrEbrFile = "a6118ma3"
	End IF		
					...
					<TD CLASS="CLSMTABP">
						<TABLE ID="MyTab" CELLSPACING=0 CELLPADDING=0>
							<TR>
								...
								<td background="../../../CShared/image/table/seltab_up_bg.gif" align="center" CLASS="CLSMTABP"><font color=white>신용카드매출전표수취명세서</font></td>
						...
						<TABLE <%=LR_SPACE_TYPE_60%>>
							...
							<TR>
								...
								<TD CLASS="TD6"><INPUT TYPE="RADIO" CLASS="Radio" NAME=Radio2 ID=Rb_AB1 Checked><LABEL FOR=Rb_AB1>갑</LABEL>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								                <INPUT TYPE="RADIO" CLASS="Radio" NAME=Radio2 ID=Rb_AB2><LABEL FOR=Rb_AB2>을</LABEL>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
								                <!--<INPUT TYPE="RADIO" CLASS="Radio" NAME=Radio2 ID=Rb_AB3><LABEL FOR=Rb_AB3>병</LABEL>--></TD>
							</TR>
							<TR>
								<TD CLASS="TD5">&nbsp;</TD>
								<TD CLASS="TD6">&nbsp;</TD>
							...
							<TR>
							 	<TD CLASS="TD5">발행일</TD>
								<TD CLASS="TD6"><script language =javascript src='./js/a6118oa1_fpDateTime1_txtFromIssueDt.js'></script>
												 &nbsp;~&nbsp;
											    <script language =javascript src='./js/a6118oa1_fpDateTime2_txtToIssueDt.js'></script></TD>
							</TR>
							<TR>
							 	<TD CLASS="TD5">작성일</TD>
								<TD CLASS="TD6"><script language =javascript src='./js/a6118oa1_fpDateTime3_txtDrawnUpDt.js'></script></TD>
							</TR>
                            <TR>
							...
							<TR>
							 	<TD CLASS="TD5">회기</TD>
								<TD CLASS="TD6"><script language =javascript src='./js/a6118oa1_fpDoubleSingle1_txtFiscCnt.js'></script></TD>
							</TR>
							<TR>
								<TD CLASS="TD5">&nbsp;</TD>
								<TD CLASS="TD6">&nbsp;</TD>
