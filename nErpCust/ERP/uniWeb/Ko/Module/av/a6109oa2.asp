...
'*  3. Program ID           : A6109OA2
'*  4. Program Name         : 신용카드매출전표등 수취명세서 전산매체 일괄제출 명세서 
'*  5. Program Desc         :
'*  6. Component List       : 
'*  7. Modified date(First) : 2005/07/01
'*  8. Modified date(Last)  : 2005/07/01
'*  9. Modifier (First)     : Shin Hyun Ho
'* 10. Modifier (Last)      : Shin Hyun Ho
'* 11. Comment              :
...
Function FncBtnPrint() 
	...
	Dim StrEbrFile
	Dim ObjName,lgF0,lgF1,lgF2,lgF3,lgF4,lgF5,lgF6
	...
	StrChk =  CommonQueryRs(" TAX_BIZ_AREA_NM "," B_TAX_BIZ_AREA ", " TAX_BIZ_AREA_CD = " & FilterVar(frm1.txtBizAreaCD.value, "''", "S") & " ",lgF0,lgF1,lgF2,lgF3,lgF4,lgF5,lgF6)
	IF StrChk = FALSE THEN 
		IntRetCD = DisplayMsgBox("179043", "X", "X", "X")
		frm1.txtBizAreaCD.value = ""
		Exit Function
	ELSE
		frm1.txtBizAreaNm.value = replace(lgF0,CHR(11),"")
	End If
	
	
	var1 = FilterVar(UCase(Trim(frm1.txtBizAreaCD.value)),"","SNM")
	var2 = UniConvDateToYYYYMMDD(frm1.txtFromIssueDt.Text,parent.gDateFormat,"") 
	var3 = UniConvDateToYYYYMMDD(frm1.txtToIssueDt.Text,parent.gDateFormat,"") 
					...
					<TD CLASS="CLSMTABP">
						<TABLE ID="MyTab" CELLSPACING=0 CELLPADDING=0>
							<TR>
								...
								<td background="../../../CShared/image/table/seltab_up_bg.gif" align="center" CLASS="CLSMTAB"><font color=white>일괄제출 명세서</font></td>
					...
					<TD WIDTH=100% HEIGHT=100% valign=top>
						<TABLE <%=LR_SPACE_TYPE_60%>>
							<TR>
								...
								<TD CLASS="TD6"><INPUT TYPE=TEXT ID="txtBizAreaCD" NAME="txtBizAreaCD" SIZE=12 MAXLENGTH=10 STYLE="TEXT-ALIGN: Left" ALT="세금신고사업장" tag="12NXXU" ><IMG SRC="../../../CShared/image/btnPopup.gif" NAME="btn" ALIGN=top TYPE="BUTTON" ONCLICK="vbscript:Call OpenPopUp(frm1.txtBizAreaCD.Value, 0)">&nbsp;
											    <INPUT TYPE=TEXT ID="txtBizAreaNM" NAME="txtBizAreaNM" SIZE=25 MAXLENGTH=50 STYLE="TEXT-ALIGN: Left" ALT="세금신고사업장" tag="14X" ></TD>
							</TR>
							<TR>
							 	<TD CLASS="TD5">발행일</TD>
								<TD CLASS="TD6"><script language =javascript src='./js/a6109oa2_fpDateTime1_txtFromIssueDt.js'></script>
												 &nbsp;~&nbsp;
											    <script language =javascript src='./js/a6109oa2_fpDateTime2_txtToIssueDt.js'></script></TD>
							</TR>
