...
*  4. Program Name         : 저축코드별 등록 
*  5. Program Desc         : 저축코드별 조회,등록,변경,삭제 
*  6. Comproxy List        :
...
'========================================================================================================
Const BIZ_PGM_ID      = "h5202mb1.asp"						           '☆: Biz Logic ASP Name
...
Sub initSpreadPosVariables()  
    ...
    C_NAME = 3
    C_HDC010T_SAVE_CD = 4
    C_HDC010T_SAVE_CD_NM = 5
    C_HDC010T_SAVE_TYPE = 6
    C_HDC010T_SAVE_TYPE_NM = 7
    C_HDC010T_BANK_ACCNT = 8
    C_HDC010T_BANK_CD = 9
    C_HDC010T_BANK_CD_POP = 10
    C_FAA090T_BANK_NAME = 11
    C_HDC010T_SCRIPT_AMT = 12
    C_HDC010T_TOT_SCRIPT_CNT = 13
    C_EXPIRE_AMT = 14
    C_HDC010T_NEW_DT = 15
    C_HDC010T_EXPIR_DT = 16
    C_HDC010T_REVOKE_DT = 17
    C_HDC010T_TAX_RATE = 18
...
Sub MakeKeyStream(pOpt)
    lgKeyStream       = Trim(Frm1.txtSave_cd.value) & parent.gColSep                   'You Must append one character( parent.gColSep)
...
Sub InitSpreadSheet()
	...
	With frm1.vspdData
       ...
       .MaxCols   = C_HDC010T_TAX_RATE + 1                                               ' ☜:☜: Add 1 to Maxcols
       ...
       Call  AppendNumberPlace("7","2","2")
        ...
        ggoSpread.SSSetCombo    C_HDC010T_SAVE_CD_NM,      "저축코드",15,,False
        ggoSpread.SSSetCombo    C_HDC010T_SAVE_TYPE,       "",8
        ggoSpread.SSSetCombo    C_HDC010T_SAVE_TYPE_NM,    "저축구분",15,,False
        ggoSpread.SSSetEdit     C_HDC010T_BANK_ACCNT,      "계좌번호",15,,,20,2
        ggoSpread.SSSetEdit     C_HDC010T_BANK_CD,         "은행코드", 15,,,10,2
        ggoSpread.SSSetButton   C_HDC010T_BANK_CD_POP
        ggoSpread.SSSetEdit     C_FAA090T_BANK_NAME,       "은행명", 15,,,30,2
        ggoSpread.SSSetFloat    C_HDC010T_SCRIPT_AMT,      "월불입액" ,12, parent.ggAmtOfMoneyNo, ggStrIntegeralPart,  ggStrDeciPointPart, parent.gComNum1000, parent.gComNumDec,,,"Z"
        ggoSpread.SSSetFloat    C_HDC010T_TOT_SCRIPT_CNT,  "총불입횟수" ,12,"6", ggStrIntegeralPart,  ggStrDeciPointPart, parent.gComNum1000, parent.gComNumDec
        ggoSpread.SSSetFloat    C_EXPIRE_AMT,              "만기금액" ,15, parent.ggAmtOfMoneyNo, ggStrIntegeralPart,  ggStrDeciPointPart, parent.gComNum1000, parent.gComNumDec,,,"Z"
        ...
        ggoSpread.SSSetFloat    C_HDC010T_TAX_RATE,        "세액공제율", 10,"7", ggStrIntegeralPart,  ggStrDeciPointPart, parent.gComNum1000, parent.gComNumDec

        Call ggoSpread.MakePairsColumn(C_EMP_NO,C_EMP_NO_POP)    'sbk
        Call ggoSpread.MakePairsColumn(C_HDC010T_BANK_CD,C_HDC010T_BANK_CD_POP)    'sbk

        Call ggoSpread.SSSetColHidden(C_HDC010T_SAVE_CD,C_HDC010T_SAVE_CD,True)
        Call ggoSpread.SSSetColHidden(C_HDC010T_SAVE_CD_NM,C_HDC010T_SAVE_CD_NM,True)
        Call ggoSpread.SSSetColHidden(C_HDC010T_SAVE_TYPE,C_HDC010T_SAVE_TYPE,True)
        Call ggoSpread.SSSetColHidden(C_HDC010T_TOT_SCRIPT_CNT,C_HDC010T_TOT_SCRIPT_CNT,True)
...
Sub SetSpreadLock()
    With frm1
        .vspdData.ReDraw = False
             ...
             ggoSpread.SpreadLock       C_HDC010T_SAVE_CD, -1, C_HDC010T_SAVE_CD, -1
             ggoSpread.SpreadLock       C_HDC010T_SAVE_CD_NM, -1, C_HDC010T_SAVE_CD_NM, -1
             ggoSpread.SpreadLock       C_HDC010T_SAVE_TYPE, -1, C_HDC010T_SAVE_TYPE, -1
             ggoSpread.SpreadLock       C_HDC010T_SAVE_TYPE_NM, -1, C_HDC010T_SAVE_TYPE_NM, -1
             ggoSpread.SpreadLock       C_HDC010T_BANK_ACCNT, -1, C_HDC010T_BANK_ACCNT, -1
             ggoSpread.SpreadLock       C_HDC010T_SAVE_CD_NM, -1, C_HDC010T_SAVE_CD_NM, -1
             ggoSpread.SpreadLock       C_HDC010T_BANK_CD, -1, C_HDC010T_BANK_CD, -1
             ggoSpread.SpreadLock       C_HDC010T_BANK_CD_POP, -1, C_HDC010T_BANK_CD_POP, -1
             ggoSpread.SpreadLock       C_FAA090T_BANK_NAME, -1, C_FAA090T_BANK_NAME, -1
             ggoSpread.SpreadLock       C_HDC010T_SCRIPT_AMT, -1, C_HDC010T_SCRIPT_AMT, -1
             ggoSpread.SpreadLock       C_EXPIRE_AMT, -1, C_EXPIRE_AMT, -1
             ggoSpread.SpreadLock	    C_HDC010T_BANK_CD , -1, -1
...
Sub SetSpreadColor(ByVal pvStartRow,ByVal pvEndRow)
    ...
    .vspdData.ReDraw = False
         ...
         ggoSpread.SSSetProtected   C_HDC010T_NEW_DT , pvStartRow, pvEndRow
         ggoSpread.SSSetProtected   C_HDC010T_EXPIR_DT , pvStartRow, pvEndRow
         ggoSpread.SSSetProtected   C_HDC010T_REVOKE_DT , pvStartRow, pvEndRow
         ggoSpread.SSSetProtected   C_HDC010T_TAX_RATE , pvStartRow, pvEndRow
...
Sub GetSpreadColumnPos(ByVal pvSpdNo)
    ...
    Select Case UCase(pvSpdNo)
       Case "A"
            ...
            C_HDC010T_SAVE_CD = iCurColumnPos(4)
            C_HDC010T_SAVE_CD_NM = iCurColumnPos(5)
            C_HDC010T_SAVE_TYPE = iCurColumnPos(6)
            C_HDC010T_SAVE_TYPE_NM = iCurColumnPos(7)
            C_HDC010T_BANK_ACCNT = iCurColumnPos(8)
            C_HDC010T_BANK_CD = iCurColumnPos(9)
            C_HDC010T_BANK_CD_POP = iCurColumnPos(10)
            C_FAA090T_BANK_NAME = iCurColumnPos(11)
            C_HDC010T_SCRIPT_AMT = iCurColumnPos(12)
            C_HDC010T_TOT_SCRIPT_CNT = iCurColumnPos(13)
            C_EXPIRE_AMT = iCurColumnPos(14)
            C_HDC010T_NEW_DT = iCurColumnPos(15)
            C_HDC010T_EXPIR_DT = iCurColumnPos(16)
            C_HDC010T_REVOKE_DT = iCurColumnPos(17)
            C_HDC010T_TAX_RATE = iCurColumnPos(18)            
        ...
        For iRow = 1 To  .MaxRows
           ...
           Select Case .Text
               Case  ggoSpread.InsertFlag, ggoSpread.UpdateFlag
                    ...
                    strRevoke_dt = .Text
                    If (strExpir_dt <> "" ) And  CompareDateByFormat(strNew_dt,strExpir_dt,frm1.txtHdc010t_new_dt.alt,frm1.txtHdc010t_expir_dt.alt,"970025", parent.gDateFormat, parent.gComDateType,True) = False then	                    
	                    .Row = iRow
  	                    .Col = C_EMP_NO
  	                    .Action=0
                        ...
                        Exit Function
                    End if
                    If (strRevoke_dt <> "" ) And  CompareDateByFormat(strNew_dt,strRevoke_dt,frm1.txtHdc010t_new_dt.alt,frm1.txtHdc010t_revoke_dt.alt,"970023", parent.gDateFormat, parent.gComDateType,True) = False then
	                    .Row = iRow
  	                    .Col = C_EMP_NO
  	                    .Action=0
                        ...
                        Exit Function
                    End if
                    If (strRevoke_dt <> "" ) And  CompareDateByFormat(strRevoke_dt,strExpir_dt,frm1.txtHdc010t_revoke_dt.alt,frm1.txtHdc010t_expir_dt.alt,"970025", parent.gDateFormat, parent.gComDateType,True) = False then
	                    .Row = iRow
  	                    .Col = C_EMP_NO
  	                    .Action=0
                        Call vspdData_Click(C_HDC010T_EXPIR_DT , iRow )
...
Function FncCopy()
	...
	With Frm1
		...
		If .vspdData.ActiveRow > 0 Then
            ...
            .vspdData.Text = ""
            .vspdData.Col  = C_HDC010T_SAVE_TYPE
            .vspdData.Text = ""
...
Function FncInsertRow(ByVal pvRowCnt)
	...
	With frm1
        ...
        For iCnt = 1 To imRow 
            ...
            .vspdData.Col = C_HDC010T_SAVE_CD
            .vspdData.text = Frm1.txtSave_cd.options(Frm1.txtSave_cd.selectedIndex).value
...
Sub vspdData_ScriptLeaveCell(Col,Row,NewCol,NewRow,Cancel)
	...
	End If
		...
		With frm1
		            ...
		            .vspdData.Col = C_HDC010T_TAX_RATE
		            .txtHdc010t_tax_rate.value = .vspdData.value
					...
					<TD CLASS="CLSMTABP">
						<TABLE ID="MyTab" CELLSPACING=0 CELLPADDING=0>
							<TR>
								...
								<td background="../../../CShared/image/table/seltab_up_bg.gif" align="center" CLASS="CLSMTABP"><font color=white>저축코드별등록</font></td>
					  ...
					  <FIELDSET CLASS="CLSFLD">
					   <TABLE <%=LR_SPACE_TYPE_40%>>
							<TR>
								...
								<TD CLASS=TD6 NOWRAP><SELECT NAME="txtSave_cd"  ALT="저축코드" STYLE="WIDTH: 100px" TAG="12"></SELECT>
				...
				<TR>
					<TD WIDTH=100% HEIGHT=* VALIGN=TOP>
						<TABLE <%=LR_SPACE_TYPE_20%> >
							<TR>
								<TD HEIGHT="100%">
									<script language =javascript src='./js/h5202ma1_vaSpread_vspdData.js'></script>
								</TD>
							</TR>
							<TR>
							<TD HEIGHT=* WIDTH=100%>
                            		<TABLE WIDTH=100% CELLSPACING=0 CELLPADDING=0>
	                        				<TR>
	                        					...
	                        					<TD CLASS="TD6" NOWRAP>
	                        					    <script language =javascript src='./js/h5202ma1_OBJECT_txtHdc010t_script_amt.js'></script>
	                        					</TD>
	                        					<TD CLASS="TD5" NOWRAP>신규가입일</TD>
	                        					<TD CLASS="TD6" NOWRAP>
	                        					    <script language =javascript src='./js/h5202ma1_fpDateTime12_txtHdc010t_new_dt.js'></script>
	                        					</TD>
	                        			    </TR>
	                        			    <TR>
	                        					<TD CLASS="TD5" NOWRAP>저축구분</TD>
	                        					...
	                        					<TD CLASS="TD6" NOWRAP>
	                        					    <script language =javascript src='./js/h5202ma1_OBJECT_txtHdc010t_tot_script_cnt.js'></script>
	                        					</TD>
	                         					<TD CLASS="TD5" NOWRAP>만기일</TD>
	                        					<TD CLASS="TD6" NOWRAP>
	                        					    <script language =javascript src='./js/h5202ma1_fpDateTime12_txtHdc010t_expir_dt.js'></script>
	                        					</TD>
	                        				</TR>
	                        				<TR>
	                        					...
	                        					<TD CLASS="TD6" NOWRAP>
	                        					    <script language =javascript src='./js/h5202ma1_OBJECT_txtHdc010t_expir_amt.js'></script>
	                        					</TD>
	                         					<TD CLASS="TD5" NOWRAP>해약일</TD>
	                        					<TD CLASS="TD6" NOWRAP>
	                        					    <script language =javascript src='./js/h5202ma1_fpDateTime12_txtHdc010t_revoke_dt.js'></script>
	                        					</TD>
	                        				</TR>
	                        				<TR>
	                        					...
	                        					<TD CLASS="TD6" NOWRAP>
	                        					    <script language =javascript src='./js/h5202ma1_OBJECT_txtHdc010t_tax_rate.js'></script>
	                        					</TD>
                             				</TR>
	                        				<TR>
