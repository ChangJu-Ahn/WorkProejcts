...
'*  3. Program ID           : h5601oa1
'*  4. Program Name         : 직장가입자통합신고 
'*  5. Program Desc         : 직장가입자통합신고 
'*  6. Comproxy List        : +
'*  7. Modified date(First) : 2003/07/30
'*  8. Modified date(Last)  : 2003/09/05
...
Function FncBtnPrint() 
	...
	Dim lngPos
	Dim intCnt
	Dim emp_no, fr_dt, to_dt, sect_cd ,cust_cd , singo_dt, singo_org_no, print_emp_no 
...
'------------------------------------------------------------------------------------------------	
	...
	If frm1.txtCap_type(0).checked Then
		StrEbrFile  = "h5601oa1_1.ebr"
		StrEbrFile2 = "h5601oa1_1T.ebr"		
		StrEbrFile3 = "h5601oa1_2.ebr"
	Else
		StrEbrFile  = "h5601oa1_3.ebr"
		StrEbrFile2 = "h5601oa1_1T.ebr"			
	End If
					...
					<TD CLASS="CLSMTABP">
						<TABLE ID="MyTab" CELLSPACING=0 CELLPADDING=0>
							<TR>
								...
								<td background="../../image/table/seltab_up_bg.gif" align="center" CLASS="CLSLTAB"><font color=white>직장가입자자격취득신고</font></td>
				...
				<TR>
					<TD HEIGHT=20>
						<TABLE <%=LR_SPACE_TYPE_60%>>   
							<TR>
								<TD CLASS="TD5" NOWRAP>피부양자(유/무)</TD>
				        	    <TD CLASS="TD6"><INPUT TYPE="RADIO" CLASS="RADIO" NAME="txtCap_type" TAG=11 VALUE="피부양자(유)" CHECKED ID="med_entr_flag1"><LABEL FOR="txtCap_type1">피부양자(유)</LABEL>&nbsp;
  				        	                    <INPUT TYPE="RADIO" CLASS="RADIO" NAME="txtCap_type" TAG=11 VALUE="피부양자(무)" ID="med_entr_flag2"><LABEL FOR="txtCap_type2">피부양자(무)</LABEL></TD>
							</TR>
							<TR>
							...
							<TR>
								...
								<TD CLASS=TD6 NOWRAP><script language =javascript src='./js/h5601oa1_txtFr_acq_dt_txtFr_acq_dt.js'></script>&nbsp;~&nbsp;
								                    <script language =javascript src='./js/h5601oa1_txtTo_acq_dt_txtTo_acq_dt.js'></script></TD>
							</TR>
							<TR>
								<TD CLASS=TD5 NOWRAP>신고일</TD>
								<TD CLASS=TD6 NOWRAP><script language =javascript src='./js/h5601oa1_txtRprt_dt_txtRprt_dt.js'></script></TD>
							</TR>
							<TR>
