...
'*  2. Function Name        : 
'*  3. Program ID           : p4218oa1
'*  4. Program Name         : (p)operation outsourcing detail 
'*  5. Program Desc         : 
'*  6. Comproxy List        : 
...
Function BtnPrint()
	...
	var11 = UCase(Trim(frm1.txtBpCd.value))	
	...
	var7 =UNIConvDateToYYYYMMDD(frm1.txtStartDt.Text, parent.gDateFormat, "")
	var8 = UNIConvDateToYYYYMMDD(frm1.txtEndDt.Text, parent.gDateFormat, "")
		
	var12 = Trim(frm1.cboOrderStatus.value)
	
	strUrl = strUrl & "plant_cd|" & var1 
	strUrl = strUrl & "|bp_cd|" & var11 
...
Function OpenConWC()
	...
	arrParam(4) = "PLANT_CD = " & FilterVar(UCase(frm1.txtPlantCd.value), "''", "S") &_
				 " AND INSIDE_FLG = " & FilterVar("N", "''", "S") & " " ' Where Condition
					...
					<TD>
						<TABLE ID="MyTab" CELLSPACING=0 CELLPADDING=0>
							<TR>
								...
								<td background="../../../CShared/image/table/seltab_up_bg.gif" align="center" CLASS="CLSMTABP"><font color=white>공정외주주문서</font></td>
						...
						<FIELDSET CLASS="CLSFLD">
							<TABLE WIDTH=100% CELLSPACING=0 CELLPADDING=0>
								...
								<TR>	
									...
									<TD CLASS=TD6 NOWRAP><INPUT TYPE=TEXT NAME="txtBpCd" SIZE=10 MAXLENGTH=10 tag="x2xxxU" ALT="거래처"><IMG SRC="../../../CShared/image/btnPopup.gif" NAME="btnBPCd1" ALIGN=top TYPE="BUTTON" ONCLICK="vbscript:OpenBizPartner()"> <INPUT TYPE=TEXT NAME="txtBpNm" SIZE=40 MAXLENGTH=40 tag="x4"></TD>
								</TR>
								<TR>	
								    <TD CLASS="TD5" NOWRAP>외주작업장</TD>
									<TD CLASS=TD6 NOWRAP><INPUT TYPE=TEXT NAME="txtWCCd" SIZE=10 MAXLENGTH=7 tag="x1xxxU" ALT="작업장"><IMG SRC="../../../CShared/image/btnPopup.gif" NAME="btnWCCd1" ALIGN=top TYPE="BUTTON" ONCLICK="vbscript:OpenConWC()"> <INPUT TYPE=TEXT NAME="txtWCNm" SIZE=40 MAXLENGTH=40 tag="x4"></TD>
								</TR>
								<TR>
									<TD CLASS=TD5 NOWRAP>착수예정일</TD>
									<TD CLASS=TD6 NOWRAP>
										<script language =javascript src='./js/p4218oa1_OBJECT1_txtStartDt.js'></script>								
										&nbsp;~&nbsp; 
										<script language =javascript src='./js/p4218oa1_OBJECT2_txtEndDt.js'></script>								
									</TD>
								</TR>
								<TR>
