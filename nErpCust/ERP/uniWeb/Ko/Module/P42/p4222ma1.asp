...
'*  2. Function Name        : 
'*  3. Program ID           : p4222ma1.asp
'*  4. Program Name         : 오더별자원스케쥴조회 
'*  5. Program Desc         : p4222mb1.asp p4222mb2.asp  
...
'**********************************************************************************************************
'Grid 1 - Operation
Const BIZ_PGM_QRY1_ID	= "p4222mb1.asp"								'☆: 비지니스 로직 ASP명 
Const BIZ_PGM_QRY2_ID	= "p4222mb2.asp"								'☆: 비지니스 로직 ASP명 
...
Sub InitSpreadSheet(ByVal pvSpdNo)
	...
	If pvSpdNo = "A" Or pvSpdNo = "*" Then
		...
		With frm1.vspdData1
			...
			ggoSpread.SSSetEdit		C_ProdtOrderNo,	"제조오더번호"	, 16
			ggoSpread.SSSetEdit 	C_ItemCd,       "품목"			, 18 
			ggoSpread.SSSetEdit 	C_ItemNm,       "품목명"		, 20       
			ggoSpread.SSSetEdit 	C_RoutingNo,    "라우팅 No."		, 10
			ggoSpread.SSSetEdit 	C_PlanStartDt,  "착수예정일"	, 20
			ggoSpread.SSSetEdit 	C_PlanComptDt,  "완료예정일"	, 20        
			ggoSpread.SSSetEdit 	C_SchdStartDt,  "착수계획일자"	, 20        
			ggoSpread.SSSetEdit 	C_SchdComptDt,  "완료계획일자"	, 20
			ggoSpread.SSSetEdit 	C_RealStartDt,  "실착수일"		, 20                                    
	...
	If pvSpdNo = "B" Or pvSpdNo = "*" Then
		...
		With frm1.vspdData2
			...
			ggoSpread.SSSetEdit 	C_OprNo,		"공정순서"	, 6
			ggoSpread.SSSetEdit		C_WcCd, 		"작업장"	, 12,,,7    
			ggoSpread.SSSetEdit		C_ResourceCd,	"자원"	, 12,,,10
			...
			'Call ggoSpread.MakePairsColumn(,)
 			Call ggoSpread.SSSetColHidden( C_LoadNo, C_LoadNo, True)
 			Call ggoSpread.SSSetColHidden( .MaxCols, .MaxCols, True)
...
Sub GetSpreadColumnPos(ByVal pvSpdNo)
 	...
 	Select Case UCase(pvSpdNo)
		...
		Case "B"
 			...
 			C_LoadNo			= iCurColumnPos(1)
			C_OprNo				= iCurColumnPos(2)
			C_WcCd				= iCurColumnPos(3)
			C_ResourceCd		= iCurColumnPos(4)
			C_ResourceNm		= iCurColumnPos(5)
					...
					<TD CLASS="CLSMTABP">
						<TABLE ID="MyTab" CELLSPACING=0 CELLPADDING=0>
							<TR>
								...
								<td background="../../../CShared/image/table/seltab_up_bg.gif" align="center" CLASS="CLSMTAB"><font color=white>오더별자원계획(S)</font></td>
						...
						<FIELDSET CLASS="CLSFLD">
							<TABLE <%=LR_SPACE_TYPE_40%>>
			 					<TR>
									...
									<TD CLASS=TD6 NOWRAP>
										<script language =javascript src='./js/p4222ma1_I486334872_txtStartDt.js'></script>
										&nbsp;~&nbsp;
										<script language =javascript src='./js/p4222ma1_I919616073_txtEndDt.js'></script>									
									</TD>
								</TR>
							</TABLE>
						</FIELDSET>
				...
				<TR>
					<TD WIDTH=100% HEIGHT=* valign=top>
						<TABLE <%=LR_SPACE_TYPE_20%>>
							<TR HEIGHT="100%">
								<TD WIDTH="40%">
									<script language =javascript src='./js/p4222ma1_A_vspdData1.js'></script>
								</TD>							
								<TD WIDTH="60%">
									<script language =javascript src='./js/p4222ma1_B_vspdData2.js'></script>
								</TD>
							</TR>
						</TABLE>
					</TD>
