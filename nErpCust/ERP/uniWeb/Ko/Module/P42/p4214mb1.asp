...
'*  2. Function Name        : 
'*  3. Program ID           : p4214mb1.asp
'*  4. Program Name         : List Order Document
'*  5. Program Desc         : 189400saa
'*  6. Modified date(First) : 2000-12-10	
'*  7. Modified date(Last)  : 2001-09-25
...
On Error Resume Next
	...
	lgStrPrevKey = FilterVar(UCase(Trim(Request("lgStrPrevKey"))),"","SNM")
	...
	Case CStr(OPMD_UMODE)
		UNIValue(0, 3) = " " & FilterVar(lgStrPrevKey, "''", "S") & ""
	End Select
