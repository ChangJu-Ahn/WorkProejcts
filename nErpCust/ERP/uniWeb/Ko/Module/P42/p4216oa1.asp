...
'*  2. Function Name        : 
'*  3. Program ID           : p4216oa1
'*  4. Program Name         : 작업지시서 출력 
'*  5. Program Desc         : 
'*  6. Comproxy List        : 
'*  7. Modified date(First) : 2002/01/13
...
Function BtnPrint()
	...
	If frm1.txtOrderNo.value = "" Then
		var2 = "0"
	Else
		var2 = Trim(frm1.txtOrderNo.value)
	End If
	
	If frm1.txtOrderNo1.value = "" Then
		var11 = "zzzzzzzzzzzzzzzz"
	Else
		var11 = Trim(frm1.txtOrderNo1.value)
	End If
	...
	If frm1.rdoFlag1.checked = True Then
		var9 = "N"
	Else
		var9 = "Y"
	End If

	var12 = frm1.cboOrderStatus.value 
...
Function OpenFrProdOrderNo()
	...
	arrParam(1) = frm1.txtStartDt.Text
	arrParam(2) = frm1.txtEndDt.Text
	arrParam(3) = "RL"
	arrParam(4) = "ST"
...
Function OpenToProdOrderNo()
	...
	arrParam(6) = ""
	arrParam(7) = Trim(frm1.txtToItemCd.value)
	arrParam(8) = ""	
					...
					<TD>
						<TABLE ID="MyTab" CELLSPACING=0 CELLPADDING=0>
							<TR>
								...
								<td background="../../../CShared/image/table/seltab_up_bg.gif" align="center" CLASS="CLSMTABP"><font color=white>작업지시서출력</font></td>
						...
						<FIELDSET CLASS="CLSFLD">
							<TABLE WIDTH=100% CELLSPACING=0 CELLPADDING=0>
								...
								<TR>
									...
									<TD CLASS=TD6 NOWRAP>
										<script language =javascript src='./js/p4216oa1_I757483351_txtStartDt.js'></script>								
										&nbsp;~&nbsp; 
										<script language =javascript src='./js/p4216oa1_I398736554_txtEndDt.js'></script>								
									</TD>
								</TR>
								<TR>
