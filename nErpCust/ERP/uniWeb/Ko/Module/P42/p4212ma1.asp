...
<SCRIPT LANGUAGE = "VBScript" SRC = "p4212ma1.vbs"></SCRIPT>
					...
					<TD CLASS="CLSMTABP">
						<TABLE ID="MyTab" CELLSPACING=0 CELLPADDING=0>
							<TR>
								...
								<td background="../../../CShared/image/table/seltab_up_bg.gif" align="center" CLASS="CLSMTAB"><font color=white>제조오더확정</font></td>
								<td background="../../../CShared/image/table/seltab_up_bg.gif" align="right"><img src="../../../CShared/image/table/seltab_up_right.gif" width="10" height="23"></td>
							</TR>
						</TABLE>
					</TD>
					<TD WIDTH=* align=right><A href="vbscript:OpenStockRef()">재고현황</A> | <A href="vbscript:OpenOprRef()">공정내역</A></TD>
					<TD WIDTH=10>&nbsp;</TD>
				</TR>
			</TABLE>
		</TD>
						...
						<FIELDSET CLASS="CLSFLD">
							<TABLE <%=LR_SPACE_TYPE_40%>>
								<TR>
									...
									<TD CLASS="TD6">
										<script language =javascript src='./js/p4212ma1_fpDateTime1_txtFromDt.js'></script>
										&nbsp;~&nbsp;
										<script language =javascript src='./js/p4212ma1_OBJECT1_txtToDt.js'></script>
									</TD>
								</TR>
								<TR>
						...
						<TABLE <%=LR_SPACE_TYPE_20%>>
							<TR HEIGHT="60%">
								<TD WIDTH="100%" colspan=4>
									<script language =javascript src='./js/p4212ma1_A_vspdData1.js'></script>
								</TD>
							</TR>
							<TR HEIGHT="40%">
								<TD WIDTH="100%" colspan=4>
									<script language =javascript src='./js/p4212ma1_B_vspdData2.js'></script>
								</TD>
							</TR>
						</TABLE>
					</TD>
...
<INPUT TYPE=HIDDEN NAME="hOrderType" tag="24"><INPUT TYPE=HIDDEN NAME="KeyProdOrdNo" tag="24">
