...
'*  2. Function Name        : 
'*  3. Program ID           : p4221ma1.asp
'*  4. Program Name         : 자원스케쥴조회 
'*  5. Program Desc         : p4221mb1.asp p4221mb2.asp  
...
'**********************************************************************************************************
'Grid 1 - Operation
Const BIZ_PGM_QRY1_ID	= "p4221mb1.asp"								'☆: 비지니스 로직 ASP명 
Const BIZ_PGM_QRY2_ID	= "p4221mb2.asp"								'☆: 비지니스 로직 ASP명 
...
Sub InitSpreadSheet(ByVal pvSpdNo)
    ...
    If pvSpdNo = "A" Or pvSpdNo = "*" Then 
		...
		With frm1.vspdData1
			...
			.MaxCols = C_ResourceNm+1 											'☜: 최대 Columns의 항상 1개 증가시킴 
			.MaxRows = 0
	...
	If pvSpdNo = "B" Or pvSpdNo = "*" Then
		...
		With frm1.vspdData2
			...
			ggoSpread.SSSetEdit 	C_StartDt,		"시작시간"	, 20    
			ggoSpread.SSSetEdit 	C_EndDt, 		"종료시간"	, 20 
			ggoSpread.SSSetEdit 	C_ProdtOrderNo,	"작업지시"	, 15 
			ggoSpread.SSSetEdit 	C_LoadNo,       "Load No"   , 10
			ggoSpread.SSSetEdit 	C_ItemCd, 		"품목"		, 18 
			ggoSpread.SSSetEdit 	C_RoutingNo,	"라우팅 No."	, 20
			ggoSpread.SSSetEdit	    C_OprNo, 		"공정순서"	, 7,,,3
			ggoSpread.SSSetEdit		C_WcCd, 		"작업장"	, 10,,,7
...
Sub GetSpreadColumnPos(ByVal pvSpdNo)
 	...
 	Select Case UCase(pvSpdNo)
		...
		Case "B"
			...
			C_LoadNo			= iCurColumnPos(4)
			C_ItemCd			= iCurColumnPos(5)
			C_RoutingNo			= iCurColumnPos(6)
			C_OprNo				= iCurColumnPos(7)
			C_WcCd				= iCurColumnPos(8)
			C_StartFlg			= iCurColumnPos(9)
			C_EndFlg			= iCurColumnPos(10)
					...
					<TD CLASS="CLSMTABP">
						<TABLE ID="MyTab" CELLSPACING=0 CELLPADDING=0>
							<TR>
								...
								<td background="../../../CShared/image/table/seltab_up_bg.gif" align="center" CLASS="CLSMTAB"><font color=white>자원계획(S)</font></td>
					...
					<TD HEIGHT=20 WIDTH=100%>
						<FIELDSET CLASS="CLSFLD">
					    	<TABLE <%=LR_SPACE_TYPE_40%>>
								...
								<TR>
									<TD CLASS="TD5">자원그룹</TD>
									<TD CLASS="TD6"><INPUT TYPE=TEXT NAME="txtResourceGroupCd" SIZE=15 MAXLENGTH=10 tag="12xxxU" ALT="자원그룹"><IMG SRC="../../../CShared/image/btnPopup.gif" NAME="btnResourceGroupCd" align=top TYPE="BUTTON" ONCLICK="vbscript:OpenResourceGroup()">&nbsp;<INPUT TYPE=TEXT NAME="txtResourceGroupNm" SIZE=30 tag="14"></TD>
									<TD CLASS=TD5 NOWRAP>일자</TD>
									<TD CLASS=TD6 NOWRAP>
										<script language =javascript src='./js/p4221ma1_I745906937_txtStartDt.js'></script>
										&nbsp;~&nbsp;
										<script language =javascript src='./js/p4221ma1_I426873999_txtEndDt.js'></script>									
									</TD>
								</TR>
							</TABLE>
						</FIELDSET>
				...
				<TR>
					<TD WIDTH=100% HEIGHT=* valign=top>
						<TABLE <%=LR_SPACE_TYPE_20%>>
							<TR HEIGHT="100%">
								<TD WIDTH="25%">
									<script language =javascript src='./js/p4221ma1_A_vspdData1.js'></script>
								</TD>							
								<TD WIDTH="75%">
									<script language =javascript src='./js/p4221ma1_B_vspdData2.js'></script>
								</TD>
							</TR>
						</TABLE>
					</TD>
