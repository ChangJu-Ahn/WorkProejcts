...
'**********************************************************************************************************
'Grid 1 - Operation
Const BIZ_PGM_QRY1_ID	= "p4219mb1.asp"								'☆: 비지니스 로직 ASP명 
Const BIZ_PGM_QRY2_ID	= "p4219mb2.asp"								'☆: 비지니스 로직 ASP명 
...
Sub InitSpreadSheet(ByVal pvSpdNo)
	...
	If pvSpdNo = "B" Or pvSpdNo = "*" Then
		...
		With frm1.vspdData2
			...
			ggoSpread.SSSetEdit 		C_ProdtOrderNo,	"오더번호"	, 15  
					...
					<TD CLASS="CLSMTABP">
						<TABLE ID="MyTab" CELLSPACING=0 CELLPADDING=0>
							<TR>
								...
								<td background="../../../CShared/image/table/seltab_up_bg.gif" align="center" CLASS="CLSMTAB"><font color=white>자원스케쥴(자원별)(P)</font></td>
