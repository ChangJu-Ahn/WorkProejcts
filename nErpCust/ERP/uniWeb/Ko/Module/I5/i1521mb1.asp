...
'*  2. Function Name        : VMI 입고등록 조회 
'*  3. Program ID           : I1521MB1
'*  4. Program Name         : 
'*  5. Program Desc         : 
'*  6. Comproxy List        : 
...
'* 10. Modifier (Last)      : Choi Sung Jae
...
Dim PvArr	
	...
	I1_VMI_goods_mvmt_hdr(I152_I1_trns_type)        = "VR"
	...
	For LngRow = 0 To GroupCount
	    ...
	    strData = Chr(11) & ConvSPChars(EG1_i_VMI_goods_mvmt_dtl(LngRow, I152_EG1_b_item_item_cd)) & _ 
				  ...
				  Chr(11) & ""
	    If UCase(Trim(EG1_i_VMI_goods_mvmt_dtl(LngRow, I152_EG1_insp_flag))) = "Y" Then
			strData = strData & Chr(11) & "1"                                                                    'C_InspFlag
	    Else
			strData = strData & Chr(11) & "0"                                                                    'C_InspFlag
	    End If
	    strData = strData & Chr(11) & ConvSPChars(EG1_i_VMI_goods_mvmt_dtl(LngRow, I152_EG1_tracking_no)) & _
						    Chr(11) & "" & _
							...
							Chr(11) & ConvSPChars(EG1_i_VMI_goods_mvmt_dtl(LngRow, I152_EG1_insp_req_no)) & _
							Chr(11) & ConvSPChars(EG1_i_VMI_goods_mvmt_dtl(LngRow, I152_EG1_insp_status)) & _
