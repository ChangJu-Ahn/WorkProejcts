...
'*  2. Function Name        : Master Data(Message등록)
...
Const BIZ_PGM_ID = "B1c03mb1.asp"												<%'비지니스 로직 ASP명 %>
...
Sub InitSpreadSheet()
   ...
   'patch version
    ...
    .MaxCols = C_MsgText + 1						'☜: 최대 Columns의 항상 1개 증가시킴 
    ...
    ggoSpread.SSSetCombo C_Lang, "언어", 10 '1
    ggoSpread.SSSetEdit C_Msg, "메세지 코드", 15, , ,6 '2
	ggoSpread.SSSetCombo C_MsgType, "", 10 '3
	ggoSpread.SSSetCombo C_MsgTypeNm, "메세지 종류", 17 '4
	ggoSpread.SSSetCombo C_MsgLevel, "", 10 '5
	ggoSpread.SSSetCombo C_MsgLevelNm, "메세지 Level", 15 '6
    ggoSpread.SSSetEdit C_MsgText, "내용", 58, , , 1024 '7
...
Sub vspdData_TopLeftChange(ByVal OldLeft , ByVal OldTop , ByVal NewLeft , ByVal NewTop )
    ...
    if frm1.vspdData.MaxRows < NewTop +  VisibleRowCnt(frm1.vspdData,NewTop) Then	    <%'☜: 재쿼리 체크 %>
    	If lgStrPrevKey <> "" And lgStrPrevLang <> "" Then      <%'다음 키 값이 없으면 더 이상 업무로직ASP를 호출하지 않음 %>
						...
						<FIELDSET CLASS="CLSFLD">
							<TABLE <%=LR_SPACE_TYPE_40%>>
								<TR>
									...
									<TD CLASS="TD6"><INPUT TYPE=TEXT NAME="txtMsg" SIZE=16 MAXLENGTH=6 tag="11XXXU" ALT="메세지 코드"></TD>
								</TR>
								<TR>
									<TD CLASS="TD5">메세지 종류</TD>
									<TD CLASS="TD6"><SELECT NAME="cboMsgType" tag="11X"  CLASS=cboNormal ALT="메세지 종류"><OPTION value=""></OPTION></SELECT></TD>
									<TD CLASS="TD5">메세지 Level</TD>
									<TD CLASS="TD6"><SELECT NAME="cboMsgLevel" tag="11X" CLASS=cboNormal" ALT="메세지 Level"><OPTION value=""></OPTION></SELECT></TD>
								</TR>
								<TR>
									<TD CLASS="TD5">내용</TD>
									<TD CLASS="TD6"><INPUT TYPE=TEXT NAME="txtMsgText" SIZE=30 MAXLENGTH=1024 tag="11" ALT="내용"></TD>
									<TD CLASS="TD5"></TD>
									<TD CLASS="TD6"></TD>
								</TR>
							</TABLE>
