        ...
        Case "M"
           ...
           Select Case Mid(pDataType,2,1)
               ...
               Case "R"
                       ...
                       lgStrSQL = lgStrSQL & " case when isnull(C.JOB_FG,'1') = " & FilterVar("1", "''", "S") & "  and isnull(C.PROGRESS_FG,'N') = " & FilterVar("Y", "''", "S") & "  then " & FilterVar("Y", "''", "S") & "  else " & FilterVar("N", "''", "S") & "  end AS PROGRESS_FG, "                                                  
                       ...
                       lgStrSQL = lgStrSQL & " C.JOB_FG, C.PROGRESS_FG, C.JOB_START, C.JOB_END "
