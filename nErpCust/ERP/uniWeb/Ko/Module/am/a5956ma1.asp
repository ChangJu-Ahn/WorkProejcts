					...
					<TD WIDTH=100% VALIGN=TOP>
						<TABLE <%=LR_SPACE_TYPE_60%>>
							...
							<TR>
								...
								<TD CLASS=TD6 NOWRAP><OBJECT classid=<%=gCLSIDFPDT%> id=fpDateTime1 NAME="fpDateTime" style="HEIGHT: 20px; WIDTH: 100px" tag="23X1X" Title="FPDATETIME" ALT="전표일자"></OBJECT></TD>
							</TR>
							<TR>
								...
								<TD CLASS=TD6 NOWRAP><OBJECT classid=<%=gCLSIDFPDS%> id=txtExRate1 name=txtExRate style="HEIGHT: 20px; RIGHT: 0px; TOP: 0px; WIDTH: 150px" title="FPDOUBLESINGLE" ALT="환율" tag="23X5"></OBJECT></TD>
							</TR>
							<TR>
							...
							<TR>
								...
								<TD CLASS=TD6 NOWRAP><OBJECT classid=<%=gCLSIDFPDS%> id=txtCntAmt1 name=txtCntAmt style="HEIGHT: 20px; RIGHT: 0px; TOP: 0px; WIDTH: 150px" title="FPDOUBLESINGLE" ALT="계약금액" tag="23X2"></OBJECT></TD>
								<TD CLASS=TD5 NOWRAP>계약액(자국)</TD>
								<TD CLASS=TD6 NOWRAP><OBJECT classid=<%=gCLSIDFPDS%> id=txtLocCntAmt1 name=txtLocCntAmt style="HEIGHT: 20px; RIGHT: 0px; TOP: 0px; WIDTH: 150px" title="FPDOUBLESINGLE" ALT="계약액(자국)" tag="21X2"></OBJECT></TD>
							</TR>
							<TR>
								<TD CLASS=TD5 NOWRAP>보험료</TD>
								<TD CLASS=TD6 NOWRAP><OBJECT classid=<%=gCLSIDFPDS%> id=txtAmt1 name=txtAmt style="HEIGHT: 20px; RIGHT: 0px; TOP: 0px; WIDTH: 150px" title="FPDOUBLESINGLE" ALT="보험료" tag="23X2"></OBJECT></TD>
								<TD CLASS=TD5 NOWRAP>보험료(자국)</TD>
								<TD CLASS=TD6 NOWRAP><OBJECT classid=<%=gCLSIDFPDS%> id=txtLocAmt1 name=txtLocAmt style="HEIGHT: 20px; RIGHT: 0px; TOP: 0px; WIDTH: 150px" title="FPDOUBLESINGLE" ALT="보험료(자국)" tag="21X2"></OBJECT></TD>
							</TR>
							<TR>
								<TD CLASS=TD5 NOWRAP>계약기간</TD>
								<TD CLASS=TD6 NOWRAP><OBJECT classid=<%=gCLSIDFPDT%> id=txtCntFrom1 NAME="txtCntFrom" style="HEIGHT: 20px; WIDTH: 100px" tag="23X1X" Title="FPDATETIME" ALT="계약기간시작"></OBJECT>~
									<OBJECT classid=<%=gCLSIDFPDT%> id=txtCntTo1 NAME="txtCntTo" style="HEIGHT: 20px; WIDTH: 100px" tag="23X1X" Title="FPDATETIME" ALT="계약기간종료"></OBJECT></TD>
								<TD CLASS=TD5 NOWRAP>적용기간(년월)</TD>
								<TD CLASS=TD6 NOWRAP><OBJECT classid=<%=gCLSIDFPDT%> id=txtFromDt NAME="txtFromDt" style="HEIGHT: 20px; WIDTH: 70px" tag="23X1X" Title="FPDATETIME" ALT="적용기간(년월)시작"></OBJECT>~
									<OBJECT classid=<%=gCLSIDFPDT%> id=txtToDt NAME="txtToDt" style="HEIGHT: 20px; WIDTH: 70px" tag="23X1X" Title="FPDATETIME" ALT="적용기간(년월)종료"></OBJECT></TD>
							</TR>
							<TR>
