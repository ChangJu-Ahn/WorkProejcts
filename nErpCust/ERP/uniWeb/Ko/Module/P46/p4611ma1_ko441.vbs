...
'==========================================================================================================
Const BIZ_PGM_QRY_ID = "p4611mb1.asp"									'☆: Head Query 비지니스 로직 ASP명 
Const BIZ_PGM_SAVE_ID = "p4611mb2.asp"									'☆: Save 비지니스 로직 ASP명 


Const BIZ_PGM_SAVE_ID2 = "p4611mb6_ko441.asp"
...
Dim C_ItemName				'= 4
Dim C_Spec					'= 5
Dim C_ProdtOrderQty			'= 6
Dim C_ProdtOrderUnit		'= 7
Dim C_RemainQty				'= 8
Dim C_PlanStartDt			'= 9
Dim C_PlanComptDt			'= 10
Dim C_SchdStartDt			'= 11
Dim C_SchdComptDt			'= 12
Dim C_RoutingNo				'= 13
Dim C_TrackingNo			'= 14
Dim C_ProdQtyInOrderUnit	'= 15
Dim C_GoodQtyInOrderUnit	'= 16
Dim C_BadQtyInOrderUnit		'= 17
Dim C_InspGoodQtyInOrderUnit'= 18
Dim C_InspBadQtyInOrderUnit	'= 19
Dim C_RcptQtyInOrderUnit	'= 20
Dim C_UnRcptQtyInOrderUnit	'= 21
Dim C_BaseUnit				'= 22
Dim C_OrderQtyInBaseUnit	'= 23
Dim C_ProdQtyInBaseUnit		'= 24
Dim C_GoodQtyInBaseUnit		'= 25
Dim C_BadQtyInBaseUnit		'= 26
Dim C_InspGoodQtyInBaseUnit	'= 27
Dim C_InspBadQtyInBaseUnit	'= 28
Dim C_RcptQtyInBaseUnit		'= 29
Dim C_UnRcptQtyInBaseUnit	'= 30
Dim C_ReleaseDt				'= 31
Dim C_RealStartDt			'= 32
Dim C_RealComptDt			'= 33
Dim C_OrderStatus			'= 34
Dim C_OrderType
Dim C_Prod_Mgr
Dim C_ItemGroupCd
Dim C_ItemGroupNm
...
Sub GetSpreadColumnPos(ByVal pvSpdNo)
 	...
 	Select Case UCase(pvSpdNo)
  	Case "A"
		...
		C_PlanStartDt				= iCurColumnPos(10)
		C_PlanComptDt				= iCurColumnPos(11)
		C_SchdStartDt				= iCurColumnPos(12)
		C_SchdComptDt				= iCurColumnPos(13)
		C_RoutingNo					= iCurColumnPos(14)
		C_ProdQtyInOrderUnit		= iCurColumnPos(15)
		C_GoodQtyInOrderUnit		= iCurColumnPos(16)
		C_RcptQtyInOrderUnit		= iCurColumnPos(17)
    ...
    With frm1.vspdData
		...
		Else
			If ButtonDown = 1 Then
				ggoSpread.SpreadUnLock C_RealComptDt, Row, C_RealComptDt, Row
				ggoSpread.SSSetRequired C_RealComptDt, Row, Row
				.Row = Row 
				.Col = C_RealComptDt 
				.Text = LocSvrDate
				ggoSpread.UpdateRow Row
			Else
				...
				.Col = C_RealComptDt 
				.Text = ""
				ggoSpread.SpreadLock C_RealComptDt, Row, C_RealComptDt, Row
				ggoSpread.SSSetProtected C_RealComptDt, Row, Row
				ggoSpread.SSDeleteFlag Row,Row
			End If			
		End If
	End With
...
Function DbSaveOk2()
	Msgbox "Productor Order Close Sucess" 
End Function

Function DBSaveError2()
	Msgbox "Productor Order Close Fail" 
End Function
