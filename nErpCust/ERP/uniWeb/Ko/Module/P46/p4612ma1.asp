...
'*  2. Function Name		: 
'*  3. Program ID			: p4612ma1.asp
'*  4. Program Name			: Cancel Order Closing
'*  5. Program Desc			:
'*  6. Component List		: 
...
<SCRIPT LANGUAGE = "VBScript" SRC = "p4612ma1.vbs"></SCRIPT>
					...
					<TD CLASS="CLSMTABP">
						<TABLE ID="MyTab" CELLSPACING=0 CELLPADDING=0>
							<TR>
								...
								<td background="../../../CShared/image/table/seltab_up_bg.gif" align="center" CLASS="CLSMTAB"><font color=white>제조오더마감취소</font></td>
						...
						<FIELDSET CLASS="CLSFLD">
							<TABLE <%=LR_SPACE_TYPE_40%>>
								<TR>
									...
									<TD CLASS=TD6 NOWRAP>												
										<script language =javascript src='./js/p4612ma1_I580870562_txtProdFromDt.js'></script>&nbsp;~&nbsp;
										<script language =javascript src='./js/p4612ma1_I540263152_txtProdtODt.js'></script>
									</TD>
								</TR>
								<TR>
					...
					<TABLE <%=LR_SPACE_TYPE_60%>>
						<TR>
							<TD HEIGHT="100%" colspan=4>
								<script language =javascript src='./js/p4612ma1_I300408971_vspdData.js'></script>
							</TD>
						</TR>
						<TR>
							...
							<FIELDSET valign=top>
								...
								<TABLE CLASS="TB2" CELLSPACING=0>
									<TR>
										...
										<TD CLASS=TD6 NOWRAP>												
											<script language =javascript src='./js/p4612ma1_OBJECT1_txtPlanStratDt.js'></script>
										</TD>
									</TR>	
									<TR>
										<TD CLASS=TD5 NOWRAP>완료예정일</TD>
										<TD CLASS=TD6 NOWRAP>												
											<script language =javascript src='./js/p4612ma1_OBJECT2_txtPlanEndDt.js'></script>
										</TD>
									</TR>	
									<TR>
										<TD CLASS=TD5 NOWRAP>착수계획일정</TD>
										<TD CLASS=TD6 NOWRAP>											
											<script language =javascript src='./js/p4612ma1_OBJECT1_txtPlannedStratDt.js'></script>
										</TD>
									</TR>	
									<TR>
										<TD CLASS=TD5 NOWRAP>완료계획일정</TD>
										<TD CLASS=TD6 NOWRAP>												
											<script language =javascript src='./js/p4612ma1_OBJECT2_txtPlannedEndDt.js'></script>
										</TD>
									</TR>	
									<TR>
										<TD CLASS=TD5 NOWRAP>작업지시일</TD>
										<TD CLASS=TD6 NOWRAP>												
											<script language =javascript src='./js/p4612ma1_I110077327_txtReleaseDt.js'></script>
										</TD>
									</TR>	
									<TR>
										<TD CLASS=TD5 NOWRAP>실착수일</TD>
										<TD CLASS=TD6 NOWRAP>												
											<script language =javascript src='./js/p4612ma1_OBJECT1_txtRealStratDt.js'></script>
										</TD>
									</TR>
									<TR>
							...
							<FIELDSET valign=top>
								...
								<TABLE CLASS="TB2" CELLSPACING=0>
									...
									<TR>
										...
										<TD CLASS=TD6 NOWRAP>
											<script language =javascript src='./js/p4612ma1_fpDoubleSingle4_txtOrderQty.js'></script>
										</TD>
									</TR>	
									<TR>
										<TD CLASS=TD5 NOWRAP>실적수량</TD>
										<TD CLASS=TD6 NOWRAP>
											<script language =javascript src='./js/p4612ma1_fpDoubleSingle5_txtProdQty.js'></script> 
										</TD>
									</TR>
									<TR>
										<TD CLASS=TD5 NOWRAP>양품수량</TD>
										<TD CLASS=TD6 NOWRAP>
											<script language =javascript src='./js/p4612ma1_fpDoubleSingle6_txtGoodQty.js'></script>
										</TD>
									</TR>
									<TR>
										<TD CLASS=TD5 NOWRAP>불량수량</TD>
										<TD CLASS=TD6 NOWRAP>
											<script language =javascript src='./js/p4612ma1_fpDoubleSingle7_txtBadQty.js'></script>
										</TD>
									</TR>
									<TR>
										<TD CLASS=TD5 NOWRAP>입고수량</TD>
										<TD CLASS=TD6 NOWRAP>
											<script language =javascript src='./js/p4612ma1_fpDoubleSingle8_txtRcptQty.js'></script>
										</TD>
									</TR>
									<TR>
										<TD CLASS=TD5 NOWRAP>입고대기수량</TD>
										<TD CLASS=TD6 NOWRAP>
											<script language =javascript src='./js/p4612ma1_fpDoubleSingle9_txtUnRcptQty.js'></script>
										</TD>
									</TR>
								</TABLE>	
							</FIELDSET>
							...
							<FIELDSET valign=top>
								...
								<TABLE CLASS="TB2" CELLSPACING=0>
									...
									<TR>
										<TD CLASS=TD5 NOWRAP>오더수량</TD>
										<TD CLASS=TD6 NOWRAP>
											<script language =javascript src='./js/p4612ma1_fpDoubleSingle1_txtOrderQty1.js'></script>
										</TD>
									</TR>	
									<TR>
										<TD CLASS=TD5 NOWRAP>실적수량</TD>
										<TD CLASS=TD6 NOWRAP>
											<script language =javascript src='./js/p4612ma1_fpDoubleSingle2_txtProdQty1.js'></script>
										</TD>
									</TR>
									<TR>
										<TD CLASS=TD5 NOWRAP>양품수량</TD>
										<TD CLASS=TD6 NOWRAP>
											<script language =javascript src='./js/p4612ma1_fpDoubleSingle3_txtGoodQty1.js'></script>
										</TD>
									</TR>
									<TR>
										<TD CLASS=TD5 NOWRAP>불량수량</TD>
										<TD CLASS=TD6 NOWRAP>
											<script language =javascript src='./js/p4612ma1_fpDoubleSingle4_txtBadQty1.js'></script>
										</TD>
									</TR>
									<TR>
										<TD CLASS=TD5 NOWRAP>입고수량</TD>
										<TD CLASS=TD6 NOWRAP>
											<script language =javascript src='./js/p4612ma1_fpDoubleSingle5_txtRcptQty1.js'></script>
										</TD>
									</TR>
									<TR>
										<TD CLASS=TD5 NOWRAP>입고대기수량</TD>
										<TD CLASS=TD6 NOWRAP>
											<script language =javascript src='./js/p4612ma1_fpDoubleSingle6_txtUnRcptQty1.js'></script>
										</TD>
									</TR>
								</TABLE>	
							</FIELDSET>
