...
'*  4. Program Name         : 근로소득공제신고서 
'*  5. Program Desc         : 근로소득공제신고서 
'*  6. Comproxy List        : +
					...
					<TD CLASS="CLSMTABP">
						<TABLE ID="MyTab" CELLSPACING=0 CELLPADDING=0>
							<TR>
								...
								<td background="../../../CShared/image/table/seltab_up_bg.gif" align="center" CLASS="CLSLTAB"><font color=white>근로소득공제신고서</font></td>
					...
					<TD HEIGHT=20>
						<TABLE <%=LR_SPACE_TYPE_60%>>   
							<TR>
								...
								<TD CLASS=TD6 NOWRAP><SCRIPT LANGUAGE=JavaScript> ExternalWrite('<OBJECT CLASSID=<%=gCLSIDFPDT%> id=txtBas_dt NAME="txtBas_dt" CLASS=FPDTYYYYMMDD tag="12X1" ALT="기준일자" Title="FPDATETIME"></OBJECT>');</SCRIPT></td>
							</TR>
							<TR>
								<TD CLASS="TD5" NOWRAP>급여구분</TD>
	                        	<TD CLASS="TD6" NOWRAP><SELECT Name="cboPay_cd" ALT="급여구분" STYLE="WIDTH: 120px" tag="11"><OPTION Value=""></OPTION></SELECT></TD>
							</TR>
							<TR>
								<TD CLASS=TD5 NOWRAP>근무구역</TD>
	                        	<TD CLASS="TD6" NOWRAP><SELECT Name="cboSect_cd" ALT="근무구역" STYLE="WIDTH: 120px" tag="11"><OPTION Value=""></OPTION></SELECT></TD>
							</TR>
							<TR>
							...
							<TR>
								...
								<TD CLASS=TD6 NOWRAP><SELECT Name="cboOcpt_type" ALT="직종구분" STYLE="WIDTH: 120px" tag="11"><OPTION Value=""></OPTION></SELECT></TD>
