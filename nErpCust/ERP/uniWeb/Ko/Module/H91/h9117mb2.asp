...
'				DFnm = "C:\c" & li_biz_own_rgst_no   
                ...
                Fnm = Fso.GetFileName("C:\c" & lgKeyStream(0) )                
'                FPnm = Server.MapPath("../../files/" & gCompany & "/" & Fnm)       '
...
Sub SubBizQuery()
    ...
    lgStrSQL = "SELECT  REPLACE(DATA,CHAR(11),'') data	FROM HFA160T ORDER BY YEAR_AREA_CD,EMP_NO,TYPE ,right(rtrim(DATA) ,2) "
