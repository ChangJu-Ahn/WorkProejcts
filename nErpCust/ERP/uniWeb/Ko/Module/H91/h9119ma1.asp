...
======================================================================================================
*  1. Module Name          : 연말정산 
*  2. Function Name        : 사업장연말정산신고(퇴직자미포함)
*  3. Program ID           : H1a02ma1
*  4. Program Name         : 사업장연말정산신고 
*  5. Program Desc         : 사업장연말정산신고(퇴직자미포함)
*  6. Comproxy List        :
...
Const BIZ_PGM_ID      = "h9119mb1.asp"						           '☆: Biz Logic ASP Name
Const BIZ_PGM_ID2     = "h9119mb2.asp"                                 '☆: File Creation Asp Name
...
Function FncBtnPrint() 
	...
	strUrl = strUrl & "|b_biz_area|" & biz_area_cd
					...
					<TD CLASS="CLSMTABP">
						<TABLE ID="MyTab" CELLSPACING=0 CELLPADDING=0>
							<TR>
								...
								<td background="../../../CShared/image/table/seltab_up_bg.gif" align="center" CLASS="CLSMTABP"><font color=white>사업장연말정산신고</font></td>
					...
					<TD HEIGHT=20>
						...
						<TABLE <%=LR_SPACE_TYPE_40%>>
							...
							<TR>
								...
								<TD CLASS=TD6  NOWRAP><script language =javascript src='./js/h9119ma1_fpDateTime1_txtDt.js'></script></TD>
							</TR>	
				            <TR>
								...
								<TD CLASS=TD6  NOWRAP><script language =javascript src='./js/h9119ma1_fpDateTime2_txtBas_dt.js'></script></TD>
							</TR>
						...
						<TABLE <%=LR_SPACE_TYPE_60%>>
            			    <TR HEIGHT="25%">
            					<TD WIDTH="50%" HEIGHT=*>
	            					<TABLE WIDTH="100%" HEIGHT="100%">
	            						<TR>
	            							<TD HEIGHT="100%"><script language =javascript src='./js/h9119ma1_vaSpread_vspdData.js'></script></TD>
		               					</TR>
					            	</TABLE>
		            			</TD>
            					<TD WIDTH="50%" HEIGHT=*>
	            					<TABLE WIDTH="100%" HEIGHT="100%">
	            						<TR>
	            							<TD HEIGHT="100%"><script language =javascript src='./js/h9119ma1_vaSpread1_vspdData1.js'></script></TD>
		               					</TR>
					            	</TABLE>
		            			</TD>
                            </TR>  
                            <TR HEIGHT="40%">
				            	<TD WIDTH="100%" HEIGHT=* VALIGN=TOP COLSPAN=3>
				            		<TABLE WIDTH="100%" HEIGHT="100%">
				            			<TR>
				            				<TD HEIGHT="100%"><script language =javascript src='./js/h9119ma1_vaSpread2_vspdData2.js'></script></TD>
					            		</TR>
					            	</TABLE>
					            </TD>
			                </TR>
                            <TR HEIGHT="35%">
				            	<TD WIDTH="100%" HEIGHT=* VALIGN=TOP COLSPAN=3>
				            		<TABLE WIDTH="100%" HEIGHT="100%">
				            			<TR>
				            				<TD HEIGHT="100%"><script language =javascript src='./js/h9119ma1_vaSpread3_vspdData3.js'></script></TD>
					            		</TR>
					            	</TABLE>
					            </TD>
			                </TR>
