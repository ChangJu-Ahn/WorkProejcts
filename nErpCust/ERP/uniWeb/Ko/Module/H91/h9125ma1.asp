...
Sub InitSpreadSheet()
	...
	With frm1.vspdData
		...
		ggoSpread.SSSetDate  C_CONTR_DT      , "기부일자",   10,2, gDateFormat
        ggoSpread.SSSetEdit  C_CONTR_RGST_NO,      "기부처사업자등록번호", 16,,, 13,1   
        ggoSpread.SSSetEdit  C_CONTR_NAME,      "기부처명", 25,,, 20,1   
        
		ggoSpread.SSSetCombo C_CONTR_CODE     , "",5
		ggoSpread.SSSetCombo C_CONTR_CODE_NM      , "코드", 25     
		ggoSpread.SSSetCombo C_CONTR_TYPE    , "",5
		ggoSpread.SSSetCombo C_CONTR_TYPE_NM      , "유형", 20       
		ggoSpread.SSSetFloat C_CONTR_AMT       , "기부금액", 20,"2", ggStrIntegeralPart,  ggStrDeciPointPart, Parent.gComNum1000, Parent.gComNumDec,,,"Z"
		ggoSpread.SSSetFloat C_PROV_CNT      , "지급건수", 10,"6", ggStrIntegeralPart,  ggStrDeciPointPart, Parent.gComNum1000, Parent.gComNumDec,,,"P"		
		ggoSpread.SSSetCombo C_subMitCd    , "",5
		ggoSpread.SSSetCombo C_subMitCdNM    , "제출구분", 20
		ggoSpread.SSSetEdit C_YEAR_FLAG      , "반영여부", 5  
...
<TABLE <%=LR_SPACE_TYPE_00%>>
					...
					<TD CLASS="CLSMTABP">
						<TABLE ID="MyTab" CELLSPACING=0 CELLPADDING=0>
							<TR>
								...
								<td background="../../../Cshared/Image/table/seltab_up_bg.gif" align="center" CLASS="CLSMTAB"><font color=white>기초자료등록(기부금)</font></td>
	...
	<TR HEIGHT=55>
		<TD WIDTH=100%>
			<TABLE >
				<TR><TD WIDTH=10>&nbsp;</TD>
					<TD WIDTH=150>법정기부금(100%):</TD>
					<TD WIDTH=100><SCRIPT LANGUAGE=JavaScript> ExternalWrite('<OBJECT CLASSID=<%=gCLSIDFPDS%> id=txtSum1 NAME="txtSum1" CLASS=FPDS140 tag="24X2Z" ALT="법정기부금" Title="FPDOUBLESINGLE"></OBJECT>');</SCRIPT></TD>
					<TD WIDTH=170>&nbsp;&nbsp;정치자금기부금(100%):</TD>
					<TD WIDTH=100><SCRIPT LANGUAGE=JavaScript> ExternalWrite('<OBJECT CLASSID=<%=gCLSIDFPDS%> id=txtSum2 NAME="txtSum2" CLASS=FPDS140 tag="24X2Z" ALT="정치자금기부금" Title="FPDOUBLESINGLE"></OBJECT>');</SCRIPT></TD>
					<TD WIDTH=150>&nbsp;&nbsp;진흥기금(75%):</TD>
					<TD WIDTH=100><SCRIPT LANGUAGE=JavaScript> ExternalWrite('<OBJECT CLASSID=<%=gCLSIDFPDS%> id=txtSum3 NAME="txtSum3" CLASS=FPDS140 tag="24X2Z" ALT="진흥기금" Title="FPDOUBLESINGLE"></OBJECT>');</SCRIPT></TD>
					<TD WIDTH=*>&nbsp;</TD>
				</TR>
				<TR><TD WIDTH=10>&nbsp;</TD>
					<TD WIDTH=150>특례기부(50%):</TD>
					<TD WIDTH=100><SCRIPT LANGUAGE=JavaScript> ExternalWrite('<OBJECT CLASSID=<%=gCLSIDFPDS%> id=txtSum4 NAME="txtSum4" CLASS=FPDS140 tag="24X2Z" ALT="특례기부" Title="FPDOUBLESINGLE"></OBJECT>');</SCRIPT></TD>
					<TD WIDTH=170>&nbsp;&nbsp;우리사주기부금(30%):</TD>
					<TD WIDTH=100><SCRIPT LANGUAGE=JavaScript> ExternalWrite('<OBJECT CLASSID=<%=gCLSIDFPDS%> id=txtSum5 NAME="txtSum5" CLASS=FPDS140 tag="24X2Z" ALT="우리사주기부금" Title="FPDOUBLESINGLE"></OBJECT>');</SCRIPT></TD>
					<TD WIDTH=150>&nbsp;&nbsp;지정기부금(10%):</TD>
					<TD WIDTH=100><SCRIPT LANGUAGE=JavaScript> ExternalWrite('<OBJECT CLASSID=<%=gCLSIDFPDS%> id=txtSum6 NAME="txtSum6" CLASS=FPDS140 tag="24X2Z" ALT="지정기부금" Title="FPDOUBLESINGLE"></OBJECT>');</SCRIPT></TD>
					<TD WIDTH=*>&nbsp;</TD>
				</TR>				
				<TR><TD WIDTH=10>&nbsp;</TD>
