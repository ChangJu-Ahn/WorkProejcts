        ...
        Do While Not lgObjRs.EOF
            Select Case UCase(Trim(lgCurrentSpd))
                 Case "A"
					 ...
					 strWhere = " year_area_cd in ( select year_area_cd from haa010t )"  '20031211 lsn
                     Call CommonQueryRs("count(*) ","HFA100T",strWhere,lgF0,lgF1,lgF2,lgF3,lgF4,lgF5,lgF6) '20031211 lsn
   ...
   '                     lgstrData = lgstrData & Chr(11) & 0                    
    '                 End if                     
               ...
               Case "D"                     
                     ...
                     'lgstrData = lgstrData & Chr(11) & lgObjRs("work_no")
