...
======================================================================================================
*  1. Module Name          : 연말정산 
*  2. Function Name        : 통합연말정산신고(퇴직자포함)
*  3. Program ID           : H9118ma1
*  4. Program Name         : 통합연말정산신고 
*  5. Program Desc         : 통합연말정산신고(퇴직자포함)
*  6. Comproxy List        :
...
Const BIZ_PGM_ID      = "h9118mb1.asp"						           '☆: Biz Logic ASP Name
Const BIZ_PGM_ID2     = "h9118mb2.asp"                                 '☆: File Creation Asp Name
					...
					<TD HEIGHT=20>
						...
						<TABLE <%=LR_SPACE_TYPE_40%>>
							...
							<TR>
								...
								<TD CLASS=TD6  NOWRAP><script language =javascript src='./js/h9118ma1_fpDateTime1_txtDt.js'></script></TD>
							</TR>	
				            <TR>
								...
								<TD CLASS=TD6  NOWRAP><script language =javascript src='./js/h9118ma1_fpDateTime2_txtBas_dt.js'></script></TD>
							</TR>
						...
						<TABLE <%=LR_SPACE_TYPE_60%>>
            			    <TR HEIGHT="25%">
            					<TD WIDTH="50%" HEIGHT=*>
	            					<TABLE WIDTH="100%" HEIGHT="100%">
	            						<TR>
	            							<TD HEIGHT="100%"><script language =javascript src='./js/h9118ma1_vaSpread_vspdData.js'></script></TD>
		               					</TR>
					            	</TABLE>
		            			</TD>
            					<TD WIDTH="50%" HEIGHT=*>
	            					<TABLE WIDTH="100%" HEIGHT="100%">
	            						<TR>
	            							<TD HEIGHT="100%"><script language =javascript src='./js/h9118ma1_vaSpread1_vspdData1.js'></script></TD>
		               					</TR>
					            	</TABLE>
		            			</TD>
                            </TR>  
                            <TR HEIGHT="40%">
				            	<TD WIDTH="100%" HEIGHT=* VALIGN=TOP COLSPAN=3>
				            		<TABLE WIDTH="100%" HEIGHT="100%">
				            			<TR>
				            				<TD HEIGHT="100%"><script language =javascript src='./js/h9118ma1_vaSpread2_vspdData2.js'></script></TD>
					            		</TR>
					            	</TABLE>
					            </TD>
			                </TR>
                            <TR HEIGHT="35%">
				            	<TD WIDTH="100%" HEIGHT=* VALIGN=TOP COLSPAN=3>
				            		<TABLE WIDTH="100%" HEIGHT="100%">
				            			<TR>
				            				<TD HEIGHT="100%"><script language =javascript src='./js/h9118ma1_vaSpread3_vspdData3.js'></script></TD>
					            		</TR>
					            	</TABLE>
					            </TD>
			                </TR>
...
<INPUT TYPE=HIDDEN ID="txtFile" NAME="txtFile" SIZE=15 tag="24" ALT="저장파일경로">
