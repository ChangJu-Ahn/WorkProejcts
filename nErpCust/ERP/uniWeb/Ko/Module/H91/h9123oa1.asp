...
'*  1. Module Name          : HR
'*  2. Function Name        : 
'*  3. Program ID           : H9123OA1
'*  4. Program Name         : 연말정산환수및환급현황 
...
Sub SetDefaultVal()
	...
	frm1.txtYyyy.focus			'년월 default value setting
 	
	frm1.txtYyyy.text = UNIConvDateAToB("<%=GetSvrDate%>" ,parent.gServerDateFormat, parent.gDateFormat)
...
'========================================================================================================
' Name : txtYyyy_DblClick
' Desc : 달력 Popup을 호출 
'========================================================================================================
Sub txtYyyy_DblClick(Button)
	If Button = 1 Then
		Call SetFocusToDocument("M")	
		frm1.txtYyyy.Action = 7
		frm1.txtYyyy.focus
	End If
End Sub
...
Function SetPrintCond(StrEbrFile, strUrl)
	...
	Dim yyyy, pay_cd, fr_dept_cd, to_dept_cd, emp_no

	SetPrintCond = False

	StrEbrFile = "h9123oa1"

    rDate = UNIGetLastDay(frm1.txtYyyy.Text, Parent.gDateFormatYYYYMM)                     '해당년월의 마지막 날을 가지고 온다.
					...
					<TD CLASS="CLSMTABP">
						<TABLE ID="MyTab" CELLSPACING=0 CELLPADDING=0>
							<TR>
								...
								<td background="../../../CShared/image/table/seltab_up_bg.gif" align="center" CLASS="CLSMTAB"><font color=white>연말정산환수및환급현황</font></td>
					...
					<TD HEIGHT=20>
						<TABLE <%=LR_SPACE_TYPE_60%>>
							...
							<TR>
								...
								<TD CLASS="TD6" NOWRAP>
								<script language =javascript src='./js/h9123oa1_txtYyyy_txtYyyy.js'></script> 								
								</TD>	
							</TR>
							<TR>
								<TD CLASS=TD5>&nbsp;</TD>
