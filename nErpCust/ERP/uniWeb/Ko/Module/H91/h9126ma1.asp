...
*  4. Program Name         : 의료비지급명세서신고 
*  5. Program Desc         : 의료비지급명세서신고 
*  6. Comproxy List        :
...
'  max_row = 7        '전역변수세팅: 출력문에 뿌려질 총 Row 의 갯수  
'  med_sub = 2000000  '전역변수세팅: 연말정산시 의료비 공제금액이 200만원이상인 경우의 내역을 보여줌 
'========================================================================================================
Dim emp_no, max_row
	emp_no  = "%"
	max_row = 6
...
Sub InitSpreadSheet(strSPD)
	...
	With Frm1.vspdData
	   ...
	   .MaxRows = 0
        ...
        '[의료비 지급내역]
	    ggoSpread.SSSetEdit      C_MED_RGST_NO,     "지급처사업자등록번호",    16  '지급처의 사업자등록번호 
	    ggoSpread.SSSetEdit      C_MED_NAME,        "지급처상호",              16
	    ggoSpread.SSSetEdit      C_B_COUNT,         "신용카드 등 지급건수",                 20  '연간건수기록 
	    ggoSpread.SSSetEdit      C_MED_AMT,         "신용카드 등 지급금액",                20
	    
	    ggoSpread.SSSetEdit      C_B_COUNT2,         "현금지급건수",                 20  '연간건수기록 
	    ggoSpread.SSSetEdit      C_MED_AMT2,         "현금지급금액",                20
	  
	  
	    ggoSpread.SSSetEdit      C_FAMILY_REL,      "관계",                     5
	    ggoSpread.SSSetEdit      C_FAMILY_RES_NO,   "주민등록번호",            13
	    ggoSpread.SSSetEdit      C_NAT2,            "내외국인구분코드",			8
	    ggoSpread.SSSetEdit      C_FAMILY_TYPE,     "본인등해당여부",  18
					...
					<TD CLASS="CLSMTABP">
						<TABLE ID="MyTab" CELLSPACING=0 CELLPADDING=0>
							<TR>
								...
								<td background="../../../CShared/image/table/seltab_up_bg.gif" align="center" CLASS="CLSMTABP"><font color=white>의료비지급명세서신고</font></td>
