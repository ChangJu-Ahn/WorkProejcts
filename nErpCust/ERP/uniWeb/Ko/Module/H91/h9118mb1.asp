     ...
     '                End if          
               ...
               Case "D"  
	                 ...
	                 Else
	                    strDNO = ""                        
                     End If
                     lgstrData = lgstrData & Chr(11) & ConvSPChars(Trim(strDNO))
                     lgstrData = lgstrData & Chr(11) & replace(ConvSPChars(lgObjRs("biz_own_rgst_no")),"-","")
                     lgstrData = lgstrData & Chr(11) & ConvSPChars(lgObjRs("empty"))
                     If Trim(Oldres_no) = "" Then
                        Oldres_no = lgObjRs("res_no")
                        Cwork_no = 1
                     Else
                        ...
                        End If
                     End If
                     lgstrData = lgstrData & Chr(11) & left(ConvSPChars(lgObjRs("res_no")),13)
                     lgstrData = lgstrData & Chr(11) & ConvSPChars(lgObjRs("comp_nm"))
                     lgstrData = lgstrData & Chr(11) & ConvSPChars(lgObjRs("comp_no"))
                     lgstrData = lgstrData & Chr(11) & lgObjRs("hfa040t_pay_tot")
                     lgstrData = lgstrData & Chr(11) & lgObjRs("bonus_tot")
                     lgstrData = lgstrData & Chr(11) & lgObjRs("bonus_amt")
                     lgstrData = lgstrData & Chr(11) & lgObjRs("pay_tot")
 ...
 '                   lgStrSQL = lgStrSQL & " repre_nm,"           '/* 대표자(성명) */
  ...
  '                  lgStrSQL = lgStrSQL & " SPACE(1)  mod_code,"           '/* 자료수정코드 */
                ...
                Case "B"                
                    ...
                    lgStrSQL = lgStrSQL & " (SELECT emp_no, COUNT(*) emp_no_cnt"                    '바뀐 Query                                       '1차에서 바뀐 Query
