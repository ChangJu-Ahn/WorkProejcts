...
*  2. Function Name        : 연말정산결과반영 
*  3. Program ID           : H9110ba1
*  4. Program Name         : H9110ba1
*  5. Program Desc         : 연말정산관리/연말정산결과반영 
*  6. Comproxy List        :
...
Dim strYear,strMonth,strDay
	...
	Call ggoOper.FormatDate(frm1.txtycal_yy_dt, parent.gDateFormat, 3)	
...
Function ExeReflect() 
	...
	strVal = strVal & "&txtycal_yy_dt=" & frm1.txtycal_yy_dt.Year
	strVal = strVal & "&txtycal_yymm_dt=" & frm1.txtycal_yymm_dt.Year & Right("0" & frm1.txtycal_yymm_dt.Month,2)
...
'======================================================================================================
'   Event Name : txtycal_yy_dt_DblClick
...
'======================================================================================================
'   Event Name : ycal_yymm_dt_DblClick
'   Event Desc : 달력 Popup을 호출 
'=======================================================================================================
Sub ycal_yymm_dt_DblClick(Button)
	If Button = 1 Then
		Call SetFocusToDocument("M")	
		frm1.ycal_yymm_dt.Action = 7
		frm1.ycal_yymm_dt.focus
	End If
End Sub
...
<TABLE CLASS="BatchTB1" CELLSPACING=0 CELLPADDING=0>
					...
					<TD>
						<TABLE ID="MyTab" CELLSPACING=0 CELLPADDING=0>
							<TR>
								...
								<td background="../../../CShared/image/table/seltab_up_bg.gif" align="center" CLASS="CLSMTAB"><font color=white>연말정산결과반영</font></td>
					...
					<TD HEIGHT=20>
						<TABLE <%=LR_SPACE_TYPE_40%>WIDTH=100%>   
							<TR>
								...
								<TD CLASS=TD6 NOWRAP><script language =javascript src='./js/h9110ba1_ycal_yy_dt_txtycal_yy_dt.js'></script></TD>
							</TR>
							<TR>	
								<TD CLASS=TD5 NOWRAP>정산반영월</TD>
								<TD CLASS=TD6 NOWRAP><script language =javascript src='./js/h9110ba1_ycal_yymm_dt_txtycal_yymm_dt.js'></script></TD>
							</TR>
    						<TR>
								<TD CLASS=TD5 NOWRAP>지급구분</TD>
								<TD CLASS=TD6 NOWRAP><SELECT Name="txtProv_type" ALT="지급구분" STYLE="WIDTH: 133px" tag="12"><OPTION Value=""></OPTION></SELECT></TD>
							</TR>
    						<TR>
	...
	<TR>
		<TD WIDTH=100% HEIGHT=0 <%=BizSize%>><IFRAME NAME="MyBizASP" SRC="../../blank.htm" WIDTH=100% HEIGHT= 0 <%=BizSize%> FRAMEBORDER=0 SCROLLING=NO noresize framespacing=0></IFRAME>
		</TD>
	</TR>
</TABLE>
