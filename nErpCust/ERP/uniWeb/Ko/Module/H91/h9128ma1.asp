...
' 2007.04  res_no 변경 ggoSpread.SSSetEdit     C_RES_NO,      "주민번호" ,13,,, 13,2 --> 20
'========================================================================================================
Sub InitSpreadSheet()
	Dim strMaskYM
	...
	With frm1.vspdData
	    ...
	    .ReDraw = false    
        .MaxCols = C_CARD_YN + 1												<%'☜: 최대 Columns의 항상 1개 증가시킴 %>
        ...
        ggoSpread.SSSetEdit     C_FAMILY_NM,   "성명", 15,,, 30    
        ggoSpread.SSSetCombo    C_REL_CD,      "관계", 14
        ggoSpread.SSSetCombo    C_REL_CD_NM,   "관계", 15
	    ggoSpread.SSSetEdit     C_RES_NO,      "주민번호" ,20,,, 20,2
	    ggoSpread.SSSetCombo    C_NAT_FLAG,		"내외국인구분", 1, 0
	    ggoSpread.SSSetCombo    C_NAT_FLAG_NM,   "내외국인구분", 11, 0

        ggoSpread.SSSetCheck    C_BASE_YN,		"기본공제", 9
        ggoSpread.SSSetCheck    C_PARIA_YN,		"장애인", 9
        ggoSpread.SSSetCheck    C_CHILD_YN,		"자녀양육비", 9
        ggoSpread.SSSetCheck    C_INSUR_YN,		"보험료", 9       
        ggoSpread.SSSetCheck    C_MEDI_YN,		"의료비", 9
        ggoSpread.SSSetCheck    C_EDU_YN,		"교육비", 9
        ggoSpread.SSSetCheck    C_CARD_YN,		"신용카드등", 9 
...
' 2007.04 res_no 외국인일경우 자릿수 처리 부분 막음.
'========================================================================================================
Function FncSave()
    Dim IntRetCD 
    Dim lRow
					...
					<TD CLASS="CLSMTABP">
						<TABLE ID="MyTab" CELLSPACING=0 CELLPADDING=0>
							<TR>
								...
								<td background="../../../CShared/image/table/seltab_up_bg.gif" align="center" CLASS="CLSMTABP"><font color=white>부양가족공제자등록</font></td>
	...
	<TR HEIGHT=20>
	    <TD>
	        <TABLE <%=LR_SPACE_TYPE_30%>>
	            <TR>
	                <TD WIDTH=10>&nbsp;</TD>
	                <TD><BUTTON NAME="btnCb_autoisrt" CLASS="CLSMBTN" ONCLICK="VBScript: autoInsert_ButtonClicked('1')" flag=1>기존정보에서가져오기</BUTTON>
	                이전정보가 존재할때는 이전정보를,이전정보가 없고 가족사항이 있으면 가족사항에서 정보를 가져옵니다.</TD>
