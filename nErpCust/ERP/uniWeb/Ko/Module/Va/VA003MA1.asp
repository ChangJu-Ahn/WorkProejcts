...
Function SetPrintCond(StrEbrFile, strUrl)
	...
	Dim strSpId, strBizAreaCd,strYyyyMm
...
<BODY TABINDEX="-1" SCROLL="no">
	...
	<TABLE  <%=TABSTYLE01%> >
		<TR>
			<TD CLASS="TD5E" NOWRAP>조회년월</TD>
			<TD CLASS="TD6E" NOWRAP><script language =javascript src='./js/va003ma1_fpDateTime1_txtQueryDate.js'></script>&nbsp;</TD>
