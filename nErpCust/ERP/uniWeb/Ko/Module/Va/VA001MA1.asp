...
Function SetPrintCond(StrEbrFile, strUrl)
	...
	Dim strSpId, strUnit
	Dim strDate, strFiscDate
	Dim strFiscYyyy, strFiscMM, strFiscDD
	Dim strQueryYyyy, strQueryMM, strQueryDD
	Dim strBizAreaCd
	...
	strQueryDD		= right("0" & txtQueryDate.day, 2)
	
	If strQueryMM >= strFiscMM Then
		strFiscDate = strQueryYyyy & strFiscMM & strFiscDD
	Else
		strFiscDate = UNIConvNum(strQueryYyyy, 0) - 1 & strFiscMM & strFiscDD
	End If
	...
	StrUrl = StrUrl & "|strFiscDate|" & strFiscDate
...
<BODY TABINDEX="-1" SCROLL="no">
	...
	<TABLE  <%=TABSTYLE01%> >
		<TR>
			...
			<TD CLASS="TD6E" NOWRAP><script language =javascript src='./js/va001ma1_fpDateTime1_txtQueryDate.js'></script>&nbsp;</TD>
