...
Function SetPrintCond(StrEbrFile, strUrl)
	...
	Dim strYyyyMm, strSpId, strUnit, strBizAreaCd
...
<BODY TABINDEX="-1" SCROLL="no">
	...
	<TABLE  <%=TABSTYLE01%> >
		<TR>
			...
			<TD CLASS="TD6E" NOWRAP><script language =javascript src='./js/va005ma1_fpDateTime1_txtQueryDate.js'></script>&nbsp;</TD>
