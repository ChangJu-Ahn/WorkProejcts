...
Function SetPrintCond(StrEbrFile, strUrl)
	...
	Dim strYyyyMmdd, strSpId, strUnit
...
Function DoSpExec(strPrintOpt)		'Preview, Print
	...
	strVal = strVal & "&strYyyymmdd="	& strYyyymmdd
...
<BODY TABINDEX="-1" SCROLL="no">
	...
	<TABLE  <%=TABSTYLE01%> >
		<TR>
			...
			<TD CLASS="TD6E" NOWRAP><script language =javascript src='./js/va008ma1_fpDateTime1_txtQueryDate.js'></script>&nbsp;</TD>
