...
'*  2. Function Name		: 
'*  3. Program ID			: p4512ma1
'*  4. Program Name			: 생산입고취소 
'*  5. Program Desc			:
'*  6. Comproxy List		: 
...
<SCRIPT LANGUAGE = "VBScript" SRC = "p4512ma1.vbs"></SCRIPT>
					...
					<TD CLASS="CLSMTABP">
						<TABLE ID="MyTab" CELLSPACING=0 CELLPADDING=0>
							<TR>
								...
								<td background="../../../CShared/image/table/seltab_up_bg.gif" align="center" CLASS="CLSMTAB"><font color=white>생산입고취소</font></td>
						...
						<FIELDSET CLASS="CLSFLD">
							<TABLE <%=LR_SPACE_TYPE_40%>>
								<TR>
									...
									<TD CLASS="TD6">
										<script language =javascript src='./js/p4512ma1_fpDateTime1_txtFromDt.js'></script>
										&nbsp;~&nbsp;
										<script language =javascript src='./js/p4512ma1_fpDateTime2_txtToDt.js'></script>
									</TD>
								</TR>								
								<TR>
						...
						<TABLE <%=LR_SPACE_TYPE_20%>>
							<TR>
								<TD HEIGHT="100%" colspan=4>
									<script language =javascript src='./js/p4512ma1_I385355442_vspdData.js'></script>
								</TD>
							</TR>
							<TR>
								...
								<FIELDSET valign=top>
									...
									<TABLE CLASS="TB2" CELLSPACING=0>
										...
										<TR>
											...
											<TD CLASS=TD6 NOWRAP>
												<script language =javascript src='./js/p4512ma1_I679340571_txtOrderQty.js'></script>
											</TD>
											<TD CLASS=TD5 NOWRAP>오더수량</TD>
											<TD CLASS=TD6 NOWRAP>
												<script language =javascript src='./js/p4512ma1_I719352638_txtOrderQty1.js'></script>
											</TD>
										</TR>	
										<TR>
											<TD CLASS=TD5 NOWRAP>실적수량</TD>
											<TD CLASS=TD6 NOWRAP>
												<script language =javascript src='./js/p4512ma1_I736810332_txtProdQty.js'></script>
											</TD>
											<TD CLASS=TD5 NOWRAP>실적수량</TD>
											<TD CLASS=TD6 NOWRAP>
												<script language =javascript src='./js/p4512ma1_I665705561_txtProdQty1.js'></script>
											</TD>
										</TR>
										<TR>
											<TD CLASS=TD5 NOWRAP>양품수량</TD>
											<TD CLASS=TD6 NOWRAP>
												<script language =javascript src='./js/p4512ma1_I653964942_txtGoodQty.js'></script>
											</TD>
											<TD CLASS=TD5 NOWRAP>양품수량</TD>
											<TD CLASS=TD6 NOWRAP>
												<script language =javascript src='./js/p4512ma1_I408101594_txtGoodQty1.js'></script>
											</TD>
										</TR>	
										<TR>
											<TD CLASS=TD5 NOWRAP>입고수량</TD>
											<TD CLASS=TD6 NOWRAP>
												<script language =javascript src='./js/p4512ma1_I357697254_txtRcptQty.js'></script>
											</TD>
											<TD CLASS=TD5 NOWRAP>입고수량</TD>
											<TD CLASS=TD6 NOWRAP>
												<script language =javascript src='./js/p4512ma1_I566643428_txtRcptQty1.js'></script>
											</TD>
										</TR>
									</TABLE>	
								</FIELDSET>			
								...
								<FIELDSET valign=top>
									...
									<TABLE CLASS="TB2" CELLSPACING=0>
										<TR>
											...
											<TD CLASS=TD6 NOWRAP>
												<script language =javascript src='./js/p4512ma1_I387398803_txtPlanStratDt.js'></script>
											</TD>
										</TR>	
										<TR>
											<TD CLASS=TD5 NOWRAP>완료예정일</TD>
											<TD CLASS=TD6 NOWRAP>
												<script language =javascript src='./js/p4512ma1_OBJECT1_txtPlanEndDt.js'></script>
											</TD>
										</TR>	
										<TR>
											<TD CLASS=TD5 NOWRAP>작업지시일</TD>
											<TD CLASS=TD6 NOWRAP>
												<script language =javascript src='./js/p4512ma1_I559991174_txtReleaseDt.js'></script>
											</TD>
										</TR>	
										<TR>
											<TD CLASS=TD5 NOWRAP>실착수일</TD>
											<TD CLASS=TD6 NOWRAP>
												<script language =javascript src='./js/p4512ma1_I889205026_txtRealStratDt.js'></script>
											</TD>
										</TR>
										<TR>
