...
'*  4. Program Name         :
'*  5. Program Desc         : 
'*  6. Modified date(First) : 2002-04-01	
...
Dim i
	...
	If Request("rdoStatus") = "ST" Then 'Processing
		strStatus = "<> " & FilterVar("CL", "''", "S") & ""
	ElseIf Request("rdoStatus") = "CL" Then 'Closed
		strStatus = "= " & FilterVar("CL", "''", "S") & ""
	Else                                     'All
		strStatus = "<> ''"
	End If

	strDeleteFlag = " " & FilterVar(Request("txtrdoflag"), "''", "S") & ""
	...
	UNIValue(0, 8) = strDeleteFlag
	UNIValue(0, 9) = strStatus
...
%>
		...
		.frm1.hrdoflag.value		= "<%=ConvSPChars(Request("txtrdoflag"))%>"
		...
		If .frm1.rdoStatus1.checked = True Then
			.frm1.hStatusFlg.value = "ST"
		ElseIf .frm1.rdoStatus2.checked = True Then
			.frm1.hStatusFlg.value = "CL"
		Else  
			.frm1.hStatusFlg.value = "*"
		End If
