    ...
    Else 
				...
				<Script Language=vbscript>
				       With Parent	
				                ...
				                .Frm1.txtW10_1.Value			  = "<%=ConvSPChars(lgObjRs("w10_1"))%>"
				                .Frm1.txtW10_2.Value			  = "<%=ConvSPChars(lgObjRs("w10_2"))%>"
...
Sub SubBizSaveSingleCreate()
    ...
    lgStrSQL = lgStrSQL & UNIConvNum(Request("txtW10_1"),0)     & ","     
    lgStrSQL = lgStrSQL & UNIConvNum(Request("txtW10_2"),0)     & ","    
...
Sub SubBizSaveSingleUpdate()
    ...
    lgStrSQL = lgStrSQL & " Update TB_2 set"
    ...
    lgStrSQL = lgStrSQL & " W10_1	 = " & UNIConvNum(Request("txtW10_1"),0)   & ","
    lgStrSQL = lgStrSQL & " W10_2	 = " & UNIConvNum(Request("txtW10_2"),0)   & ","                                    
...
Sub SubMakeSQLStatements(pMode,pCode)
    ...
    Select Case pMode 
      Case "R"
            ...
            lgStrSQL = lgStrSQL & "  W1,				W2,					W3,           "
            lgStrSQL = lgStrSQL & "  W4,				W5,					W6,			  "
            lgStrSQL = lgStrSQL & "  W5,				W6,					W7,		      "
            lgStrSQL = lgStrSQL & "  W8,				W9,					W10_1,		     W10_2 "					
            lgStrSQL = lgStrSQL & " FROM  TB_2"
