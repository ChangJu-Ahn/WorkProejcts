...
<%'==========================================  1.2.1 Global 상수 선언  ======================================
'==========================================================================================================%>
Const BIZ_PGM_ID = "s6111mb1.asp"												'☆: Head Query 비지니스 로직 ASP명 
...
Sub InitSpreadSheet()
	...
	With frm1.vspdData
	    ...
	    .MaxCols = C_RefRemark + 1												'☜: 최대 Columns의 항상 1개 증가시킴 
...
Sub GetSpreadColumnPos(ByVal pvSpdNo)
    ...
    Select Case UCase(pvSpdNo)
       Case "A"
			...
			C_ChargeDt		= iCurColumnPos(9)
			C_VatType		= iCurColumnPos(10)
			C_VatTypePop	= iCurColumnPos(11)
			C_VatTypeNm		= iCurColumnPos(12)
			C_Curr			= iCurColumnPos(13)
			C_CurrPop		= iCurColumnPos(14)
			C_ChargeDocAmt	= iCurColumnPos(15)
			C_XchCalop		= iCurColumnPos(16)
			C_XchRate		= iCurColumnPos(17)
			C_ChargeLocAmt	= iCurColumnPos(18)
			C_VatRate		= iCurColumnPos(19)
			C_VatDocAmt		= iCurColumnPos(20)
			C_VatLocAmt		= iCurColumnPos(21)
			C_TaxBizArea	= iCurColumnPos(22)
			C_TaxBizAreaPop = iCurColumnPos(23)
			C_TaxBizAreaNm	= iCurColumnPos(24)
			C_PayDueDt		= iCurColumnPos(25)
			C_PayType		= iCurColumnPos(26)
			C_PayTypePop	= iCurColumnPos(27)
			C_PayTypeNm		= iCurColumnPos(28)
			C_PayDocAmt		= iCurColumnPos(29)
			C_PayLocAmt		= iCurColumnPos(30)
			C_CheckNo		= iCurColumnPos(31)
			C_CheckNoPop	= iCurColumnPos(32)
			C_BankCd		= iCurColumnPos(33)
			C_BankPop		= iCurColumnPos(34)
			C_BankNm		= iCurColumnPos(35)
			C_BankAcct		= iCurColumnPos(36)
			C_BankAcctPop	= iCurColumnPos(37)
			C_RefRemark		= iCurColumnPos(38)
