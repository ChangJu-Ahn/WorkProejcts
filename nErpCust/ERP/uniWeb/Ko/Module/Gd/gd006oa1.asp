...
*  4. Program Name      : 영업그룹 손익추이표출력 
*  5. Program Desc      : 영업그룹 손익추이표출력 
*  6. Comproxy 리스트   : 
*  7. 최초 작성년월일   : 2001/12/18
*  8. 최종 수정년월일   : 2001/12/18
*  9. 최초 작성자       : Lee Kang Yeong
* 10. 최종 작성자       : Lee Kang Yeong
* 11. 전체 comment      :
...
'	Call ExtractDateFrom(frm1.txtYyyymm.Text,frm1.txtYyyymm.UserDefinedFormat,Parent.gComDateType,strYear,strMonth,strDay)
    ...
    if var2 = "" then
		...
		Call CommonQueryRs(" SALES_GRP_NM "," B_SALES_GRP "," SALES_GRP =  " & FilterVar(frm1.txtFr_dept_cd.value, "''", "S"),lgF0,lgF1,lgF2,lgF3,lgF4,lgF5,lgF6)
	...
	condvar = "YYYY|" & var1
	condvar = condvar & "|SALES_GRP|" & var2		
					...
					<TD CLASS="CLSMTABP">
						<TABLE ID="MyTab" CELLSPACING=0 CELLPADDING=0>
							<TR>
								...
								<td background="../../../CShared/image/table/seltab_up_bg.gif" align="center" CLASS="CLSMTAB"><font color=white>영업그룹별 손익추이표</font></td>
					...
					<TD>
						<TABLE <%=LR_SPACE_TYPE_60%>>
						    <TR>
								...
								<TD CLASS=TD6  NOWRAP><script language =javascript src='./js/gd006oa1_fpLoanDtFr_txtYyyymm.js'></script>&nbsp;</TD>
							</TR>
							<TR>
								<TD CLASS=TD5 NOWRAP>영업그룹</TD>
								<TD CLASS=TD6 NOWRAP><INPUT NAME="txtFr_dept_cd" ALT="영업그룹코드" TYPE="Text" SiZE=10 MAXLENGTH=10 tag="11XXXU"><IMG SRC="../../../CShared/image/btnPopup.gif" NAME="btnSItemDC" ALIGN=top TYPE="BUTTON" ONCLICK="vbscript:Call OpenPopUp()">
			                                         <INPUT NAME="txtFr_dept_nm" ALT="영업그룹코드명" TYPE="Text" SiZE=20 MAXLENGTH=40 tag="14XXXU"></TD>
							</TR>
    					</TABLE>
					</TD>
				</TR>
