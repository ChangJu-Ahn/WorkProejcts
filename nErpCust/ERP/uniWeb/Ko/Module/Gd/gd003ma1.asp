...
*  1. Module Name          : 경영손익 
*  2. Function Name        :
*  3. Program ID           : gd003MA1
*  4. Program Name         : 영업그룹별 기준 Data 등록 
*  5. Program Desc         : 
*  6. Comproxy List        :
*  7. Modified date(First) : 2001/12/06
*  8. Modified date(Last)  : 2005/06/23
...
'========================================================================================================
Const BIZ_PGM_ID = "gd003mb1.asp"                                      'Biz Logic ASP
'========================================================================================================
...
Sub InitSpreadSheet()
	...
	With frm1.vspdData
       ...
       ggoSpread.SSSetEdit  C_center   , "영업그룹코드"      ,35,,, 35,2
       ggoSpread.SSSetButton C_center_bt
       ggoSpread.SSSetEdit  C_centernm , "영업그룹명"   ,45,,, 45,2
...
Function OpenCurrency()
	...
	arrParam(4) = arrParam(4) & "  AND  a.seq_no =4  and reference = " & FilterVar("Y", "''", "S") & "   "				<%' Where Condition%>
	arrParam(5) = "배부기준 코드"
...
Function OpenCost(strCode, iWhere, Row)
	...
	Select Case iWhere
	    Case 1
	    	arrParam(1) = "B_SALES_GRP B "								' TABLE 명칭 
...
Sub vspdData_Change(Col , Row)
	...
	Frm1.vspdData.Col = C_center	
	Input_alloc = Trim(Frm1.vspdData.value)

	
	IntRetCD = CommonQueryRs(" sales_grp_nm ","B_SALES_GRP"," sales_grp = " & FilterVar(Input_alloc, "''", "S"),lgF0,lgF1,lgF2,lgF3,lgF4,lgF5,lgF6)	
	If IntRetCD = False Then		
		Call DisplayMsgBox("971001","X",Input_alloc & " 에 해당하는 데이타","X")
		Frm1.vspdData.Col = C_center
		Frm1.vspdData.Text = ""
...
Function ExeReflect()
    ...
    currency_code = Trim(Frm1.txtCurrencyCode.Value)
        ...
        Call CommonQueryRs("count(*)","g_alloc_data","yyyymm = " & FilterVar(strYYYYMM, "''", "S") & " and alloc_kinds = " & FilterVar("3", "''", "S") & "  and alloc_base = " & FilterVar(Trim(Frm1.txtCurrencyCode.value), "''", "S") & " " ,lgF0,lgF1,lgF2,lgF3,lgF4,lgF5,lgF6)
					...
					<TD CLASS="CLSMTABP">
						<TABLE ID="MyTab" CELLSPACING=0 CELLPADDING=0>
							<TR>
								...
								<td background="../../../CShared/image/table/seltab_up_bg.gif" align="center" CLASS="CLSMTAB"><font color=white>영업그룹별 기준Data</font></td>
						...
						<FIELDSET CLASS="CLSFLD">
							<TABLE <%=LR_SPACE_TYPE_40%>>
								<TR>
									...
									<TD CLASS="TD6" NOWRAP>
										<script language =javascript src='./js/gd003ma1_fpDateTime3_fpdtWk_yymm.js'></script>
				...
				<TR>
					<TD WIDTH=100% HEIGHT=100% valign=top>
							<TABLE <%=LR_SPACE_TYPE_30%>>
								<TR>
									<TD HEIGHT="100%">
										<script language =javascript src='./js/gd003ma1_OBJECT1_vspdData.js'></script>
								</TD>
								</TR>
							</TABLE>
					</TD>
					...
					<TD>
							...
							<TABLE <%=LR_SPACE_TYPE_30%>>
										<TR HEIGHT=20>
							    			...
							    			<TD CLASS=TD6 NOWRAP><script language =javascript src='./js/gd003ma1_fpDoubleSingle2_txtDataAmt.js'></script></TD>
										</TR>
							</TABLE>
							</FIELDSET>
					</TD>
