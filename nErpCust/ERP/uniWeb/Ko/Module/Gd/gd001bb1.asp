    ...
    Else
        ...
        Do While Not lgObjRs.EOF
            ...
            Select Case CStr(lgObjRs("MINOR_CD"))
                Case "09"
                    lgstrData = lgstrData & Chr(11) & "G_USP_GD020BA1"
                Case "10"
                    lgstrData = lgstrData & Chr(11) & "G_USP_GD020BA2"
                Case "11"
                    lgstrData = lgstrData & Chr(11) & "G_USP_GD020BA3"
            End Select
        ...
        Case "M"
           ...
           Select Case Mid(pDataType,2,1)
               ...
               Case "R"
                       ...
                       lgStrSQL = lgStrSQL & " AND B.SEQ_NO = " & FilterVar("4", "''", "S") & " "
