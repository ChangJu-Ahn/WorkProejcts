...
*  1. Module Name          : GD
*  2. Function Name        :
*  3. Program ID           : gd002ma1
*  4. Program Name         : 경영손익 영업그룹별 배부기준 등록 
...
Const BIZ_PGM_ID      = "gd002mb1.asp"						           '☆: Biz Logic ASP Name
	...
	Select Case iWhere
	    ...
	    Case 2
	     ...
	     Case 3
	    	...
	    	arrParam(4) = "BM.major_cd = " & FilterVar("G1004", "''", "S") & " AND   BM.MINOR_CD = BC.MINOR_CD AND   BC.SEQ_NO = 4 AND  REFERENCE  = " & FilterVar("Y", "''", "S") & " "' Where Condition
	...
	With frm1.vspdData
       ...
       Select case CStr(frm1.txtCurrencyCode.value)
            case "1"
				...
				ggoSpread.SSSetEdit     C_acct_gm         ,     "계정그룹명"     ,30,,,30,2
           ...
           case "3"
				...
				ggoSpread.SSSetButton   c_code_pb
				ggoSpread.SSSetEdit     C_acct_nm         ,     "계정명"         ,21,,,30,2
...
Sub vspdData_Change(Col , Row)
	...
	'=============================cost center 값 체크 시작 ==================================================
			...
			If currency_code = "2" or currency_code = "3" then
				If alloc_from <>"" Then
				    IntRetCD = CommonQueryRs("cost_nm","b_cost_center","cost_type <>" & FilterVar("C", "''", "S") & "  and cost_cd not in (select cost_cd from g_dstb_cc) and cost_cd = " & FilterVar(alloc_from, "''", "S") & "",lgF0,lgF1,lgF2,lgF3,lgF4,lgF5,lgF6)
				    If IntRetCD = False Then
...
Function ExeReflect()
    ...
    If currency_code = "3" Then
        Call CommonQueryRs("count(*)","g_alloc_Base","yyyymm = " & FilterVar(strYYYYMM, "''", "S") & " and alloc_kinds = " & FilterVar("3", "''", "S") & " and from_alloc <>" & FilterVar("*", "''", "S") & "  and acct_gp <>" & FilterVar("*", "''", "S") & " " ,lgF0,lgF1,lgF2,lgF3,lgF4,lgF5,lgF6)
    ...
    Elseif currency_code = "2" Then
        Call CommonQueryRs("count(*)","g_alloc_Base","yyyymm = " & FilterVar(strYYYYMM, "''", "S") & " and alloc_kinds = " & FilterVar("3", "''", "S") & " and from_alloc <>" & FilterVar("*", "''", "S") & "  and acct_gp = " & FilterVar("*", "''", "S") & " " ,lgF0,lgF1,lgF2,lgF3,lgF4,lgF5,lgF6)
            ...
            End if
    Else
        Call CommonQueryRs("count(*)","g_alloc_Base","yyyymm = " & FilterVar(strYYYYMM, "''", "S") & " and alloc_kinds = " & FilterVar("3", "''", "S") & " and acct_gp <>" & FilterVar("*", "''", "S") & "  and from_alloc = " & FilterVar("*", "''", "S") & " " ,lgF0,lgF1,lgF2,lgF3,lgF4,lgF5,lgF6)
            If Trim(Replace(lgF0,Chr(11),"")) <> 0 then
	            IntRetCD = DisplayMsgBox("GA0009",Parent.VB_YES_NO,"X","X")
            End if
    End If
					...
					<TD CLASS="CLSMTABP">
						<TABLE ID="MyTab" CELLSPACING=0 CELLPADDING=0>
							<TR>
								...
								<td background="../../../CShared/image/table/seltab_up_bg.gif" align="center" CLASS="CLSMTAB"><font color=white>영업그룹별 배부기준</font></td>
						...
						<FIELDSET CLASS="CLSFLD">
							<TABLE <%=LR_SPACE_TYPE_40%>>
								<TR>
									...
									<TD CLASS=TD6 NOWRAP WIDTH=86%><script language =javascript src='./js/gd002ma1_fpDateTime3_fpdtWk_yymm.js'></script></TD>
							    	...
							    	<TR>
                                    <TD CLASS=TD5 ID = "titleCC" NOWRAP>Profit Center</TD>
									<TD CLASS=TD6 NOWRAP>
				...
				<TR>
					<TD WIDTH=100% HEIGHT=* valign=top>
						<TABLE <%=LR_SPACE_TYPE_30%>>
							<TR>
								<TD HEIGHT="100%">
									<script language =javascript src='./js/gd002ma1_vaSpread_vspdData.js'></script>
								</TD>
							</TR>
						</TABLE>
					</TD>
