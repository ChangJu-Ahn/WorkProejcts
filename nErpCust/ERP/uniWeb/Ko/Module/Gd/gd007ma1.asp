...
*  1. Module Name          : 경영손익 
*  2. Function Name        :
*  3. Program ID           : GD007MA1
*  4. Program Name         : GD007MA1
*  5. Program Desc         : 경영손익 영업조직별 손익현황 조회 
*  6. Comproxy List        :
...
Const BIZ_PGM_ID      = "GD007MB1.asp"						           '☆: Biz Logic ASP Name
Const BIZ_PGM_JUMP_ID = "GD009MA1"
'========================================================================================================
   ...
   '------ Developer Coding part (Start ) --------------------------------------------------------------    
	With Frm1                      	
		...
		Case 0
			...
			If UCase(Trim(.txtJumpFlag.Value)) = "GD007MA1" Then
				...
				If ReadCookie("SalesOrgcd")	<>"" Then .txtDeptCd.Value			= ReadCookie("SalesOrgcd")'				
...
Function FncQuery()
	...
	If CompareDateByFormat(frm1.fpdtWk_yymm.text,frm1.fpdtWk_yymm1.text,frm1.fpdtWk_yymm.Alt,frm1.fpdtWk_yymm1.Alt, _
        	               "970025",frm1.fpdtWk_yymm.UserDefinedFormat,Parent.gComDateType, true) = False Then	   
	   frm1.fpdtWk_yymm.focus
...
Function OpenCode()
    ...
    arrField(0) = "SALES_ORG"	     			<%' Field명(1)%>
    arrField(1) = "SALES_ORG_NM"					<%' Field명(0)%>
					...
					<TD NOWRAP  CLASS="CLSMTABP">
						<TABLE ID="MyTab" CELLSPACING=0 CELLPADDING=0>
							<TR>
								...
								<TD NOWRAP  background="../../../CShared/image/table/seltab_up_bg.gif" align="center" CLASS="CLSMTAB"><font color=white>영업조직별 손익현황</font></td>
						...
						<FIELDSET CLASS="CLSFLD">
							<TABLE <%=LR_SPACE_TYPE_40%>>
								<TR>
									...
									<TD NOWRAP  CLASS=TD6 NOWRAP><script language =javascript src='./js/gd007ma1_fpdtWk_yymm_fpdtWk_yymm.js'></script>~<script language =javascript src='./js/gd007ma1_fpdtWk_yymm1_fpdtWk_yymm1.js'></script></TD>
                                    <TD NOWRAP  CLASS=TD5 NOWRAP>영업조직</TD>
									<TD NOWRAP  CLASS=TD6 NOWRAP>
									 <INPUT TYPE=TEXT NAME="txtDeptCd" SIZE=15 MAXLENGTH=4 tag="12XXXU" ALT="영업조직코드"><IMG SRC="../../../CShared/image/btnPopup.gif" NAME="btnCode" ALIGN=top TYPE="BUTTON" ONCLICK="vbscript:OpenCode()">
									 <INPUT TYPE=TEXT NAME="txtDeptNm" SIZE=20 MAXLENGTH=50 tag="14" ALT="영업조직명" >
									 </TD>
								</TR>
							</TABLE>
						</FIELDSET>
						...
						<TABLE <%=LR_SPACE_TYPE_20%>>
							<TR>
								<TD NOWRAP  HEIGHT="100%">
									<script language =javascript src='./js/gd007ma1_vspdData_vspdData.js'></script>
								</TD>
							</TR>
						</TABLE>
					</TD>
