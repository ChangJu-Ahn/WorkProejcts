...
'========================================================================================================
Const BIZ_PGM_ID		= "gd009mb1.asp"                                      'Biz Logic ASP 
					...
					<TD CLASS="CLSMTABP">
						<TABLE ID="MyTab" CELLSPACING=0 CELLPADDING=0>
							<TR>
								...
								<td background="../../../CShared/image/table/seltab_up_bg.gif" align="center" CLASS="CLSMTAB"><font color=white>영업조직별손익비교</font></td>
						...
						<FIELDSET CLASS="CLSFLD">
							<TABLE <%=LR_SPACE_TYPE_40%>>
								<TR>
                                    ...
                                    <TD CLASS=TD6 NOWRAP><script language =javascript src='./js/gd009ma1_txtFrYYYYMM_txtFrYYYYMM.js'></script> ~
                                                         <script language =javascript src='./js/gd009ma1_txtToYYYYMM_txtToYYYYMM.js'></script></TD>
						...
						<TABLE <%=LR_SPACE_TYPE_30%>>
							<TR>
								<TD HEIGHT="80%" COLSPAN=6>
									<script language =javascript src='./js/gd009ma1_OBJECT1_vspdData.js'></script>
								</TD>
							</TR>
							<TR>								
								<TD CLASS=TD5 NOWRAP>매출액합계</TD>
								<TD CLASS=TD6 ><script language =javascript src='./js/gd009ma1_totSalesAmt_totSalesAmt.js'></script></TD>
								<TD CLASS=TD5 NOWRAP>매출원가합계</TD>
								<TD CLASS=TD6 ><script language =javascript src='./js/gd009ma1_totCostAmt_totCostAmt.js'></script></TD>
								<TD CLASS=TD5 NOWRAP>매출이익합계</TD>
								<TD CLASS=TD6 ><script language =javascript src='./js/gd009ma1_totPorfitAmt_totPorfitAmt.js'></script></TD>
							</TR>
							<TR>
								<TD CLASS=TD5 NOWRAP>영업이익합계</TD>
								<TD CLASS=TD6 ><script language =javascript src='./js/gd009ma1_totSalesProfitAmt_totSalesProfitAmt.js'></script></TD>
								<TD CLASS=TD5 NOWRAP>경상이익합계</TD>
								<TD CLASS=TD6 ><script language =javascript src='./js/gd009ma1_totCurProfitAmt_totCurProfitAmt.js'></script></TD>
								<TD CLASS=TD5 NOWRAP>세전이익합계</TD>
								<TD CLASS=TD6 ><script language =javascript src='./js/gd009ma1_totNetProfitAmt_totNetProfitAmt.js'></script></TD>

							</TR>
							<TR>
								<TD CLASS=TD5 NOWRAP>총원가합계</TD>
								<TD CLASS=TD6 ><script language =javascript src='./js/gd009ma1_totTotCostAmt_totTotCostAmt.js'></script></TD>								
								<TD CLASS=TD5 NOWRAP></TD>
								<TD CLASS=TD6 ></TD>
								<TD CLASS=TD5 NOWRAP></TD>
								<TD CLASS=TD6 ></TD>
