   ...
   Currency_code = Trim(lgkeyStream(5))
    ...
    Else
        ...
        Do While Not lgObjRs.EOF
                    ...
                    lgstrData = lgstrData & Chr(11) & ""
                    lgstrData = lgstrData & Chr(11) & UNINumClientFormat(lgObjRs(8), ggExchRate.DecPoint, 0)
...
Sub bulk_disposal()
   ...
   If Currency_code = "3" Then
        ...
        Call CommonQueryRs("count(*)","g_alloc_Base","yyyymm =" & FilterVar(lgKeyStream(0), "''", "S") & " and alloc_kinds = " & FilterVar("3", "''", "S") & " and from_alloc <>" & FilterVar("*", "''", "S") & "  and acct_gp <>" & FilterVar("*", "''", "S") & " ",lgF0,lgF1,lgF2,lgF3,lgF4,lgF5,lgF6)
...
Sub SubBizSaveMultiCreate(arrColVal)
    ...
    lgStrSQL = lgStrSQL & FilterVar(UCase(strAcct_cd),"'*'","S")     & ","
        ...
        Case "M"
           ...
           Select Case Mid(pDataType,2,1)
               ...
               Case "R"
                       ...
                       lgStrSQL = lgStrSQL & "  and gab.alloc_kinds = " & FilterVar("3", "''", "S") & ""
