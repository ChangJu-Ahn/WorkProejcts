...
*  2. Function Name        :
*  3. Program ID           : GD001BA1
*  4. Program Name         : 경영손익 영업그룹별 손익작업 
*  5. Program Desc         : 경영손익 영업그룹별 손익작업 
*  6. Comproxy List        :
...
Sub InitSpreadSheet()
	...
	With frm1.vspdData
       ...
       ggoSpread.SSSetButton   C_ERR_PB
		...
		Call ggoSpread.SSSetColHidden(C_YYYYMM ,C_JOB_SP	,True)
					...
					<TD NOWRAP  CLASS="CLSMTABP">
						<TABLE ID="MyTab" CELLSPACING=0 CELLPADDING=0>
							<TR>
								...
								<TD NOWRAP  background="../../../CShared/image/table/seltab_up_bg.gif" align="center" CLASS="CLSMTAB"><font color=white>영업그룹별 손익작업</font></td>
					...
					<TD NOWRAP  HEIGHT=20>
						<TABLE <%=LR_SPACE_TYPE_60%>>
						    	<TR>
									...
									<TD NOWRAP  CLASS=TD656 NOWRAP><script language =javascript src='./js/gd001ba1_fpDateTime_txtWork_dt.js'></script></TD>
								</TR>
    					</TABLE>
					</TD>
				</TR>
					    ...
					    <TABLE <%=LR_SPACE_TYPE_20%>>
							<TR>
								<TD NOWRAP  HEIGHT="100%">
									<script language =javascript src='./js/gd001ba1_vspdData_vspdData.js'></script>
								</TD>
							</TR>
						</TABLE>
					</TD>
