...
'================================================================================================================================
Const BIZ_PGM_ID 		= "m4141pb1_KO441.asp"                              '☆: Biz Logic ASP Name
	...
	Select Case iWhere
		Case 0	'입출고유형 
			...
			If trim(frm1.hdnRcptFlg.value) <> "" then 
				arrParam(4) = arrParam(4) & " And RCPT_FLG='" & trim(frm1.hdnRcptFlg.value) & "' "
			end if
			arrParam(5) = "입출고유형"			
		...
		Case 1	'공급처 
			...
			arrParam(4) = "BP_TYPE In ('S','CS') And usage_flag='Y' AND  in_out_flag = 'O'"' Where Condition
					...
					<TR>
						...
						<TD CLASS="TD6" NOWRAP>
							<table cellspacing=0 cellpadding=0>
								<tr NOWRAP>
									<td NOWRAP>
										<script language =javascript src='./js/m4141pa1_fpDateTime1_txtFrRcptDt.js'></script>
									</td>
									<td NOWRAP>~</td>
									<td NOWRAP>
										<script language =javascript src='./js/m4141pa1_fpDateTime1_txtToRcptDt.js'></script>
									</td>
								<tr>
							</table>
						</TD>
			...
			<TABLE <%=LR_SPACE_TYPE_20%>>
				<TR>
					<TD HEIGHT=100% WIDTH=100% COLSPAN=4>					
						<script language =javascript src='./js/m4141pa1_vspdData_vspdData.js'></script>
					</TD>
				</TR>
			</TABLE>
		</TD>
