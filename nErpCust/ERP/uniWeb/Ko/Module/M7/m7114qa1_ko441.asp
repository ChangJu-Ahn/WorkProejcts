...
Const BIZ_PGM_ID 		= "m7114qb1_ko441.asp"                     
...
<%'========================================================================================%>
Sub InitSpreadSheet()
    Call SetZAdoSpreadSheet("M7114QA1_KO441","S","A","V20071214", Parent.C_SORT_DBAGENT, frm1.vspdData, C_MaxKey, "X", "X" )    '20071214::hanc  M7114QA1_KO441  M3111QA2KO441
					...
					<TD CLASS="CLSMTABP">
						<TABLE ID="MyTab" CELLSPACING=0 CELLPADDING=0>
							<TR>
								...
								<td background="../../../CShared/image/table/seltab_up_bg.gif" align="center" CLASS="CLSMTAB"><font color=white>발주대비입고현황</font></td>
							...
							<TABLE <%=LR_SPACE_TYPE_40%>>
								...
								<TR>						   
									...
									<TD CLASS="TD6" NOWRAP>
										<table cellspacing=0 cellpadding=0>
											<tr>
												<td>
													<SCRIPT LANGUAGE=JavaScript> ExternalWrite('<OBJECT id=fpDateTime2 title=FPDATETIME style="LEFT: 0px; WIDTH: 100px; TOP: 0px; HEIGHT: 20px" name=txtPoFrDt CLASSID=<%=gCLSIDFPDT%> tag="12X1" ALT="발주일"></OBJECT>');</SCRIPT>
												</td>
												<td>~</td>
												<td>
													<SCRIPT LANGUAGE=JavaScript> ExternalWrite('<OBJECT id=fpDateTime2 title=FPDATETIME style="LEFT: 0px; WIDTH: 100px; TOP: 0px; HEIGHT: 20px" name=txtPoToDt CLASSID=<%=gCLSIDFPDT%> ALT="발주일" tag="12X1"></OBJECT>');</SCRIPT>
												</td>
											<tr>
										</table>
							         </TD>
	                            ...
	                            <TR>
									...
									<TD CLASS="TD6" NOWRAP><INPUT TYPE=radio AlT="전체"   NAME="rdoClsFlg" ID="rdoClsFlg0" CLASS="RADIO" value = "A" tag="11" checked><label for="rdoClsFlg0">&nbsp;전체&nbsp;&nbsp;</label>
														   <INPUT TYPE=radio AlT="미입고"   NAME="rdoClsFlg" ID="rdoClsFlg1" CLASS="RADIO" value = "Y" tag="11"><label for="rdoClsFlg1">&nbsp;미입고&nbsp;</label>
								</TR>
