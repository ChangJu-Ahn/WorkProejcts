...
'*  2. Function Name        :																			*
'*  3. Program ID           : m3112rb5_ko441.asp														*
...
Sub FixUNISQLData()
	...
	IF  Trim(Request("txtRcptflg")) = "Y" THEN                                                                           '    parameter의 수에 따라 변경함 
	     UNISqlId(0) = "m3112ra502KO441" 
	ELSE 
	     UNISqlId(0) = "m3112ra501KO441" 
	END IF
...
'20071211::hanc		strVal = strVal & " AND F.BP_CD = " & FilterVar(Trim(Request("txtSupplier")), " " , "S") & " "
		strVal = strVal & " AND F.BP_CD LIKE " & FilterVar(Trim(Request("txtSupplier")) & "%", " ", "S") & " "
	End If
...
'20071211::hanc		strVal = strVal & " AND F.RCPT_TYPE = " & FilterVar(Trim(Request("txtRcptType")), " " , "S") & " "
		strVal = strVal & " AND F.RCPT_TYPE LIKE " & FilterVar(Trim(Request("txtRcptType")) & "%", " ", "S") & " "
		strVal = strVal & " AND F.RCPT_TYPE <> 'IGR' "
	ELSE 
'20071211::hanc		strVal = strVal & " AND F.ISSUE_TYPE = " & FilterVar(Trim(Request("txtRcptType")), " " , "S") & " "
		strVal = strVal & " AND F.ISSUE_TYPE LIKE " & FilterVar(Trim(Request("txtRcptType")) & "%", " ", "S") & " "
		strVal = strVal & " AND F.RCPT_TYPE <> 'IGR' "
	End If	
     ...
     If Request("gBizArea") <> "" Then
        strVal = strVal & " AND F.PUR_BIZ_AREA=" & FilterVar(Request("gBizArea"),"''","S")
     End If
