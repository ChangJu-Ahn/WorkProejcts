...
'*  2. Function Name        : 																	*
'*  3. Program ID           : m4114pa1																	*
'*  4. Program Name         : 월별매입가계정현황-발생금액(GR) 팝업																*
'*  5. Program Desc         :  																			*
'*  6. Component List       : 
...
Const BIZ_PGM_ID 		= "m4114pb1.asp"                              '☆: Biz Logic ASP Name
...
'--------------
Dim C_IO_TYPE_CD	'입출고유형 
Dim C_IO_TYPE_NM	'입출고유형명 
Dim C_MVMT_AMT		'발생금액(GR)
'---------------
...
Sub InitSpreadPosVariables() 
	C_IO_TYPE_CD	= 1		'입출고유형 
	C_IO_TYPE_NM	= 2		'입출고유형명 
	C_MVMT_AMT		= 3		'발생금액(GR)
End Sub
'=======================================  GetSpreadColumnPos()  ========================================
Sub GetSpreadColumnPos(ByVal pvSpdNo)
    ...
    Select Case UCase(pvSpdNo)
       Case "A"
			...
			C_IO_TYPE_CD	= iCurColumnPos(1)		'입출고유형 
			C_IO_TYPE_NM	= iCurColumnPos(2)		'입출고유형명 
			C_MVMT_AMT		= iCurColumnPos(3)		'발생금액(GR)
	End Select
End Sub
<!--
...
Sub InitSpreadSheet()
    With frm1
		...
		ggoSpread.SSSetEdit		C_IO_TYPE_CD,		"입출고유형", 18, 0
		ggoSpread.SSSetEdit		C_IO_TYPE_NM,		"입출고유형명", 20, 0
		SetSpreadFloatLocal 	C_MVMT_AMT,			"발생금액(GR)",15,1,2
