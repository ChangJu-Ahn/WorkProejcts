...
'*  2. Function Name        :																			*
'*  3. Program ID           : m4111pa2.asp																*
'*  4. Program Name         :																			*
'*  5. Program Desc         : 검사결과등록-입고참조-입고번호팝업														*
...
'================================================================================================================================
Const BIZ_PGM_QRY_ID = "m4111pb2.asp"                               '☆: Biz Logic ASP Name
...
Sub InitSpreadSheet()
	...
	Call SetZAdoSpreadSheet("M4111PA2","S","A","V20030528",PopupParent.C_SORT_DBAGENT,frm1.vspdData, C_MaxKey, "X","X")
...
Function OKClick()
	...
	frm1.vspdData.Col = GetKeyPos("A",C_Rcpt_No)		
...
Function DbQuery() 
    ...
    With frm1
		...
		If lgIntFlgMode = PopupParent.OPMD_UMODE Then
		    ...
		    strVal = strVal & "&txtChkFlag=" & chkFlg
		else
			strVal = BIZ_PGM_QRY_ID & "?txtMode=" & PopupParent.UID_M0001
					...
					<TR>
						...
						<TD CLASS="TD6" NOWRAP>
							<table cellspacing=0 cellpadding=0>
								<tr NOWRAP>
									<td NOWRAP>
										<script language =javascript src='./js/m4111pa2_fpDateTime1_txtFrRcptDt.js'></script>
									</td>
									<td NOWRAP>~</td>
									<td NOWRAP>
										<script language =javascript src='./js/m4111pa2_fpDateTime1_txtToRcptDt.js'></script>
									</td>
								<tr>
							</table>
						</TD>
			...
			<TABLE <%=LR_SPACE_TYPE_20%>>
				<TR>
					<TD HEIGHT=100% WIDTH=100% COLSPAN=4>					
						<script language =javascript src='./js/m4111pa2_vaSpread1_vspdData.js'></script>
					</TD>
				</TR>
			</TABLE>
		</TD>
