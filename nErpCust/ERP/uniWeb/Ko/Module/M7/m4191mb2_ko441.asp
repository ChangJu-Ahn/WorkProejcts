...
Sub SubBizQueryMulti()														'☜: 현재 조회/Prev/Next 요청을 받음 
	...
	If CheckSYSTEMError2(Err,True,"","","","","") = true then 
		...
		Response.Write "	parent.frm1.txtMvmtNo.Value 	= """ & ConvSPChars(Request("txtGrNo")) & """" & vbCr
    ...
    Response.Write ".frm1.txtMvmtNo.Value          = """ & ConvSPChars(I2_m_pur_goods_mvmt_rcpt_no) & """"         					& vbCr
	...
	For iLngRow = 0 To iMax
		...
		istrData = ""
        istrData = istrData & Chr(11) & ConvSPChars(EG1_export_group(iLngRow,M_plant_cd))				'입고Seq 1
        istrData = istrData & Chr(11) & ConvSPChars(EG1_export_group(iLngRow,M_plant_nm))               '2
        istrData = istrData & Chr(11) & ConvSPChars(EG1_export_group(iLngRow,M_item_cd))                '3
        istrData = istrData & Chr(11) & ConvSPChars(EG1_export_group(iLngRow,M_item_nm))	            '4
        istrData = istrData & Chr(11) & ConvSPChars(EG1_export_group(iLngRow,M_spec))	                '5
        istrData = istrData & Chr(11) & ConvSPChars(EG1_export_group(iLngRow,M_tracking_no))            '6
        If ConvSPChars(EG1_export_group(iLngRow,M_inspect_flg)) = "N" Then                              '7
        	istrData = istrData & Chr(11) & "0"
        Else
        	istrData = istrData & Chr(11) & "Y"
        End If
        istrData = istrData & Chr(11) & ""                                                                          '8
        istrData = istrData & Chr(11) & UNINumClientFormat(EG1_export_group(iLngRow,M_mvmt_rcpt_qyt),ggQty.DecPoint,0) '9
        istrData = istrData & Chr(11) & UNINumClientFormat(EG1_export_group(iLngRow,M_mvmt_qty),ggQty.DecPoint,0)       '10
        istrData = istrData & Chr(11) & ConvSPChars(EG1_export_group(iLngRow,M_mvmt_rcpt_unit))	 '11
        istrData = istrData & Chr(11) & ConvSPChars(EG1_export_group(iLngRow,M_mvmt_cur))	        '12
	    istrData = istrData & Chr(11) & UniConvNumDBToCompanyWithOutChange(EG1_export_group(iLngRow,M_item_prc), 0) '13
	    istrData = istrData & Chr(11) & UniConvNumDBToCompanyWithOutChange(EG1_export_group(iLngRow,M_item_doc_amt), 0) '14
	    istrData = istrData & Chr(11) & 0 '15
        istrData = istrData & Chr(11) & ConvSPChars(EG1_export_group(iLngRow,M_sl_cd))  '16
        istrData = istrData & Chr(11) & "" '17
        istrData = istrData & Chr(11) & ConvSPChars(EG1_export_group(iLngRow,M_sl_nm)) '18
                	
        istrData = istrData & Chr(11) & ""  '19
        istrData = istrData & Chr(11) & ""  '20
        istrData = istrData & Chr(11) & ConvSPChars(EG1_export_group(iLngRow,M_lot_no)) '21
        istrData = istrData & Chr(11) & ConvSPChars(EG1_export_group(iLngRow,M_lot_sub_no)) '22
        istrData = istrData & Chr(11) & ConvSPChars(EG1_export_group(iLngRow,M_maker_lot_no))   '23
        istrData = istrData & Chr(11) & ConvSPChars(EG1_export_group(iLngRow,M_maker_lot_sub_no)) '24
        istrData = istrData & Chr(11) & ConvSPChars(EG1_export_group(iLngRow,M_remark_dtl)) '25
        istrData = istrData & Chr(11) & ConvSPChars(EG1_export_group(iLngRow,M_gm_no))  '26
        istrData = istrData & Chr(11) & ConvSPChars(EG1_export_group(iLngRow,M_gm_seq_no)) '27
        istrData = istrData & Chr(11) & ConvSPChars(EG1_export_group(iLngRow,M_inspect_req_no)) '28
        istrData = istrData & Chr(11) & ConvSPChars(EG1_export_group(iLngRow,M_inspect_result_no)) '29
        istrData = istrData & Chr(11) & ""  '30
        istrData = istrData & Chr(11) & ""  '31
        istrData = istrData & Chr(11) & ""  '32
        istrData = istrData & Chr(11) & ""  '33
        istrData = istrData & Chr(11) & ""  '34
        istrData = istrData & Chr(11) & ""  '35
        istrData = istrData & Chr(11) & "" '36
        istrData = istrData & Chr(11) & "" '37
        istrData = istrData & Chr(11) & ConvSPChars(EG1_export_group(iLngRow,M_mvmt_no)) '38
...
'        istrData = istrData & Chr(11) & ConvSPChars(EG1_export_group(iLngRow,M_procure_type))
    ...
    Response.Write "	.frm1.txtMvmtNo1.value = """ & ConvSPChars(Request("txtGrNo")) & """" & vbCr
...
Sub SubBizSaveMulti()														'☜: 저장 요청을 받음 
	...
	Response.Write "		.frm1.txtMvmtNo.value    = """ & UCase(ConvSPChars(E5_b_auto_numbering))  & """" & vbCr'
