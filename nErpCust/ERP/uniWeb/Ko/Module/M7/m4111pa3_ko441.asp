...
Const BIZ_PGM_QRY_ID = "m4111pb3_ko441.asp"                               '☆: Biz Logic ASP Name
Const C_MaxKey          = 8                                           '☆: key count of SpreadSheet
Const C_LC_NO			= 1
Const C_PO_NO			= 8     'HANC
...
Sub InitSpreadSheet()
	...
	Call SetZAdoSpreadSheet("M4111PA3KO441","S","A","V20030525",PopupParent.C_SORT_DBAGENT,frm1.vspdData, C_MaxKey, "X","X")
...
Function OKClick()
	...
	frm1.vspdData.Col = GetKeyPos("A",C_PO_NO)
					...
					<TR>
						...
						<TD CLASS="TD6" NOWRAP>
							<table cellspacing=0 cellpadding=0>
								<tr NOWRAP>
									<td NOWRAP>
										<script language =javascript src='./js/m4111pa3_fpDateTime1_txtFrRcptDt.js'></script>
									</td>
									<td NOWRAP>~</td>
									<td NOWRAP>
										<script language =javascript src='./js/m4111pa3_fpDateTime1_txtToRcptDt.js'></script>
									</td>
								<tr>
							</table>
						</TD>
			...
			<TABLE <%=LR_SPACE_TYPE_20%>>
				<TR>
					<TD HEIGHT=100% WIDTH=100% COLSPAN=4>					
						<script language =javascript src='./js/m4111pa3_vaSpread1_vspdData.js'></script>
					</TD>
				</TR>
			</TABLE>
		</TD>
...
<DIV ID="MousePT" NAME="MousePT" STYLE="visible:true">
	<IFRAME NAME="MouseWindow" FRAMEBORDER=0 SCROLLING=NO noresize framespacing=0 WIDTH=220 HEIGHT=41 SRC="../..                                                    
