...
Sub FixUNISQLData()
	...
	End If
     ...
     If Request("gPlant") <> "" Then
        strVal = strVal & " AND M_PUR_GOODS_MVMT01.PLANT_CD=" & FilterVar(Request("gPlant"),"''","S")
     End If
     If Request("gPurGrp") <> "" Then
        strVal = strVal & " AND M_PUR_GOODS_MVMT01.PUR_GRP=" & FilterVar(Request("gPurGrp"),"''","S")
     End If
     If Request("gPurOrg") <> "" Then
        strVal = strVal & " AND M_PUR_GOODS_MVMT01.PUR_ORG=" & FilterVar(Request("gPurOrg"),"''","S")
     End If
     If Request("gBizArea") <> "" Then
        strVal = strVal & " AND M_PUR_GOODS_MVMT01.MVMT_BIZ_AREA=" & FilterVar(Request("gBizArea"),"''","S")
     End If   
