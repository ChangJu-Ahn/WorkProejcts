...
<Script Language=vbscript>
    ...
    With Parent
         ...
         Call .ReFormatSpreadCellByCellByCurrency2(.frm1.vspdData,"<%=iPrevEndRow+1%>",<%=iEndRow%>,parent.parent.gCurrency,.GetKeyPos("A",17),"A","Q","X","X")
