...
'*  3. Program ID           :
'*  4. Program Name         :
'*  5. Program Desc         : 구매입출고관리- 미입고상세조회 
'*  6. Comproxy List        :
...
<SCRIPT LANGUAGE="VBScript"   SRC="m3112qa4_KO441.vbs"></SCRIPT>
					...
					<TD CLASS="CLSMTABP">
						<TABLE ID="MyTab" CELLSPACING=0 CELLPADDING=0>
							<TR>
								...
								<td background="../../../CShared/image/table/seltab_up_bg.gif" align="center" CLASS="CLSMTAB"><font color=white>미입고상세</font></td>
