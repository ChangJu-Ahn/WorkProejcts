...
'*  3. Program ID           : m4111ma1_ko441	
'*  4. Program Name         : 구매입고 
'*  5. Program Desc         :
'*  6. Comproxy List        : m41211,m41218
...
<SCRIPT LANGUAGE="VBScript"   SRC="m4191ma1_ko441.vbs"></SCRIPT>

<SCRIPT LANGUAGE=VBSCRIPT>

Option Explicit					

'==============================================================================================================================Const BIZ_PGM_ID = "m4111mb1_ko441.asp"									
Const BIZ_PGM_ID = "m4191mb1_ko441.asp"
Const BIZ_PGM_ID1 = "m4191mb2_ko441.asp"
...
Dim C_TransTime     '2008-03-29 7:29오후 :: hanc
Dim C_MainLot       '2008-03-29 7:29오후 :: hanc
Dim C_ImportTime    '2008-03-29 7:29오후 :: hanc
Dim C_CreateType    '2008-03-29 7:29오후 :: hanc

'2008-04-28 8:48오후 :: hanc
Dim C_StockCd	
Dim C_StockCdPop	
					...
					<TD CLASS="CLSMTABP">
						<TABLE ID="MyTab" CELLSPACING=0 CELLPADDING=0>
							<TR>
								...
								<td background="../../../CShared/image/table/seltab_up_bg.gif" align="center" CLASS="CLSMTAB"><font color=white>구매입고(MEM전용)</font></td>
								<td background="../../../CShared/image/table/seltab_up_bg.gif" align="right"><img src="../../../CShared/image/table/seltab_up_right.gif" width="10" height="23"></td>
						    </TR>
						</TABLE>
					</TD>
					<TD WIDTH=* align=right><A href="vbscript:OpenPORef2()">MES입고참조</A>&nbsp;|&nbsp;											
					                        <A href="vbscript:OpenPORef1()">발주참조</A>&nbsp;|&nbsp;											
					                        <A href="vbscript:OpenPORef()" STYLE="display:none" >발주내역참조</A>
											<A href="vbscript:OpenCcRef()">통관참조</A>&nbsp;|&nbsp;
											<A href="vbscript:OpenLLCRef()">LOCAL L/C참조</A>&nbsp;|&nbsp;
											<A href="vbscript:OpenIvRef()">매입내역참조</A></TD>
					<TD WIDTH=10>&nbsp;</TD>
				</TR>
			</TABLE>
		</TD>
						...
						<FIELDSET CLASS="CLSFLD">
							<TABLE <%=LR_SPACE_TYPE_40%>>
								<TR>
									...
									<TD CLASS="TD6" NOWRAP><INPUT  READONLY=true  STYLE = "text-transform:uppercase"   TYPE=TEXT ALT="입고번호" NAME="txtMvmtNo" MAXLENGTH=18 SIZE=32 tag="12XXXU"><IMG SRC="../../../CShared/image/btnPopup.gif" NAME="btnMvmtNo" align=top TYPE="BUTTON"ONCLICK="vbscript:OpenMvmtNo()"></TD>
					...
					<TD WIDTH=100% HEIGHT=* VALIGN=TOP>
						<TABLE <%=LR_SPACE_TYPE_60%>>
							<TR>
								...
								<TD CLASS="TD6" NOWRAP>
									<script language=JavaScript>
										ExternalWrite('<OBJECT ALT=입고일 NAME="txtGmDt" classid=<%=gCLSIDFPDT%> id=fpDateTime1 CLASS=FPDTYYYYMMDD Title="FPDATETIME" tag="23N1"></OBJECT>');
									</script>	
								</TD>
							</TR>
							<TR>
								<TD CLASS="TD5" NOWRAP>공급처</TD>
								<TD CLASS="TD6" NOWRAP><INPUT CLASS = REQUIRED STYLE = "text-transform:uppercase" TYPE=TEXT ALT="공급처" NAME="txtSupplierCd" MAXLENGTH=10 SIZE=10 ALT="공급처" tag="23XXXU" OnChange="VBScript:changeSpplCd()"><IMG SRC="../../../CShared/image/btnPopup.gif" NAME="btnGroup1Cd" align=top TYPE="BUTTON"ONCLICK="vbscript:OpenSppl()" OnMouseOver="vbscript:PopUpMouseOver()" OnMouseOut="vbscript:PopUpMouseOut()">
							...
							<TR>	
								...
								<TD CLASS="TD6" NOWRAP><INPUT  STYLE = "text-transform:uppercase" TYPE=TEXT ALT="비고" NAME="txtRemark" MAXLENGTH=120 SIZE=34 tag="21XXXU"></TD>
							</TR>
							<TR>
								<TD HEIGHT=100% WIDTH=100% COLSPAN=4>
									<script language=JavaScript>
										ExternalWrite('<OBJECT classid=<%=gCLSIDFPSPD%> NAME=vspdData WIDTH=100% HEIGHT=100% tag="23" TITLE="SPREAD" id=OBJECT1><PARAM NAME="MaxCols" VALUE="0"><PARAM NAME="MaxRows" VALUE="0"></OBJECT>');
									</script>	
								</TD>
							</TR>
						</TABLE>
...
<INPUT TYPE=HIDDEN NAME="hPoNo" tag="24" TabIndex="-1">
