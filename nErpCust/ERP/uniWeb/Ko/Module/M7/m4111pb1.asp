...
'*  8. Modified date(Last)  : 2005/05/28
'*  9. Modifier (First)     : 
...
Sub FixUNISQLData()
    ...
    UNISqlId(0) = "M411PA101"											' main query(spread sheet에 뿌려지는 query statement)
	...
	IF LEN(Trim(Request("txtGroup"))) THEN
		strVal = strVal & " AND A.PUR_GRP =  " & FilterVar(Trim(UCase(Request("txtGroup"))), " " , "S") & " "
	ELSE
	...
	UNIValue(1,0) = FilterVar(Trim(UCase(Request("txtSupplier"))), "" , "S") 			    	'공급처 
