...
'----------------------------------------------------------------------------------------------------------
 Sub MakeSpreadSheetData()
	...
	Const C_IO_TYPE_CD	= 0	'입출고유형 
	Const C_IO_TYPE_NM	= 1	'입출고유형명 
	Const C_MVMT_AMT	= 2	'발생금액(GR)
	...
	Do while Not (rs0.EOF Or rs0.BOF)
		...
		iRowStr = iRowStr & Chr(11) & ConvSPChars(rs0(C_IO_TYPE_CD))	        
		iRowStr = iRowStr & Chr(11) & ConvSPChars(rs0(C_IO_TYPE_NM))	        
		iRowStr = iRowStr & Chr(11) & UNINumClientFormat(rs0(C_MVMT_AMT), ggQty.DecPoint, 0)
