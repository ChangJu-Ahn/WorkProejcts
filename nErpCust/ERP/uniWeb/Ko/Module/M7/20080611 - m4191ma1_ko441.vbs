...
Sub InitSpreadSheet()
	...
	With frm1.vspdData
        ...
        '2008-04-28 8:38오후 :: hanc
		ggoSpread.SSSetEdit			C_StockCd,		"STOCK_TYPE", 10
		ggoSpread.SSSetButton 		C_StockCdPop


		Call ggoSpread.MakePairsColumn(C_SlCd,C_SlCdPop)
        '2008-04-28 8:40오후 :: hanc
		Call ggoSpread.MakePairsColumn(C_StockCd,C_StockCdPop)
...
Sub SetSpreadColor(ByVal pvStartRow, ByVal pvEndRow)
    ...
    '2008-04-28 8:40오후 :: hanc
	ggoSpread.SpreadUnlock C_StockCd,				pvStartRow,		C_StockCdPop,				pvEndRow
    ...
    '2008-04-28 8:40오후 :: hanc
	ggoSpread.SSSetRequired 	C_StockCd ,	pvStartRow, pvEndRow
End Sub
'==============================================================================================================================
...
'2008-04-28 8:40오후 :: hanc
			C_StockCd			= iCurColumnPos(46)
			C_StockCdPop		= iCurColumnPos(47)
...
Function OpenCcRef()
	...
	iCalledAspName = AskPRAspName("M4212RA1")
	
	If Trim(iCalledAspName) = "" Then
		IntRetCD = DisplayMsgBox("900040", parent.VB_INFORMATION, "M4212RA1", "X")
		lblnWinEvent = False
		Exit Function
	End If
...
Function OpenLLCRef()
	...
	iCalledAspName = AskPRAspName("M3212RA4")
	
	If Trim(iCalledAspName) = "" Then
		IntRetCD = DisplayMsgBox("900040", parent.VB_INFORMATION, "M3212RA4", "X")
		lblnWinEvent = False
		Exit Function
	End If
...
Function OpenIvRef()
	...
	iCalledAspName = AskPRAspName("M5112RA1")
	
	If Trim(iCalledAspName) = "" Then
		IntRetCD = DisplayMsgBox("900040", parent.VB_INFORMATION, "M5112RA1", "X")
		lblnWinEvent = False
		Exit Function
	End If
...
End Function
'==============================================================================================================================
'2008-04-28 8:42오후 :: hanc
Function OpenStockCd()
	Dim arrRet
	Dim arrParam(5), arrField(6), arrHeader(6)
	Dim iCalledAspName
	Dim IntRetCD
	...
	frm1.vspdData.Row = iCurRow
    frm1.vspdData.Col = C_ItemCd
    s_item_cd   =   frm1.vspdData.Text
	
	arrParam(0) = "STOCK_TYPE"						
	arrParam(1) = "B_USER_DEFINED_minoR"			
	arrParam(2) =  ""
'	arrParam(3) = Trim(frm1.txtSlNm.Value)
	arrParam(4) = "ud_major_cd = 'ZZ003' "
	arrParam(5) = "STOCK_TYPE"						
	
    arrField(0) = "ED13" & Parent.gColSep &"UD_MINOR_CD"						
    arrField(1) = "ED10" & Parent.gColSep &"UD_REFERENCE"			
    arrField(2) = "ED15" & Parent.gColSep &"IsNull([DBO].[ufn_GetSTOCKSLNM](UD_REFERENCE), '') "
    arrField(3) = "ED00" & Parent.gColSep &"[DBO].[ufn_GetSTOCKSL]('" & s_item_cd & "')"
    
    arrHeader(0) = "STOCK TYPE"					
    arrHeader(1) = "창고"					
    arrHeader(2) = "창고명"					
    arrHeader(3) = "GUBUN"
	...
	Call frm1.vspdData.SetText(C_StockCd,	iCurRow, arrRet(0))
	If arrRet(3) = "Y" Then
		If Trim(arrRet(1)) <> "" Then
			Call frm1.vspdData.SetText(C_SlCd,	iCurRow, arrRet(1))
			Call frm1.vspdData.SetText(C_SlNm,	iCurRow, arrRet(2))
		End If
	End If	
...
Sub vspdData_ButtonClicked(ByVal Col, ByVal Row, Byval ButtonDown)
	...
	If Col = C_SlCdPop Then
    	Call OpenSlCd()
	ElseIf Col = C_StockCdPop Then      '2008-04-28 8:41오후 :: hanc
    	Call OpenStockCd()
		...
		For lRow = 1 To .vspdData.MaxRows
			...
			Select Case .vspdData.Text
				Case ggoSpread.InsertFlag, ggoSpread.UpdateFlag
					...
					strVal = strVal & iColSep	'M745_IG1_I10_ext1_cd
					strVal = strVal & iColSep	'M745_IG1_I10_ext1_qty
					strVal = strVal & iColSep	'M745_IG1_I10_ext1_amt
					strVal = strVal & iColSep	'M745_IG1_I10_ext1_rt
					strVal = strVal & Trim(GetSpreadText(frm1.vspdData,C_StockCd,lRow, "X","X")) & iColSep	'M745_IG1_I10_ext2_cd
					strVal = strVal & iColSep 
					strVal = strVal & iColSep
					strVal = strVal & iColSep
					strVal = strVal & iColSep
