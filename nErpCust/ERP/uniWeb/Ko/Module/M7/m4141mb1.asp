...
Sub SubBizQueryMulti()														'☜: 현재 조회/Prev/Next 요청을 받음 
    ...
    Call iPM7G428.M_LIST_PUR_RCPT_SVR(gStrGlobalCollection, C_SHEETMAXROWS_D, I1_m_pur_goods_mvmt_no, I2_m_pur_goods_mvmt_rcpt_no, EG1_export_group)
	...
	For iLngRow = 0 To iMax
        ...
        istrData = istrData & Chr(11) & ConvSPChars(EG1_export_group(iLngRow,M744_EG1_E11_mvmt_prc))  		'단가(추가)
        istrData = istrData & Chr(11) & ConvSPChars(EG1_export_group(iLngRow,M744_EG1_E11_mvmt_doc_amt))  	'금액(추가)
        istrData = istrData & Chr(11) & ConvSPChars(EG1_export_group(iLngRow,M744_EG1_E11_mvmt_cur))  		'화폐(추가)
        ...
        istrData = istrData & Chr(11) & ConvSPChars(EG1_export_group(iLngRow,M744_EG1_E11_remark_dtl))		'비고(추가)
...
Sub SubBizSaveMulti()														'☜: 저장 요청을 받음 
    ...
    Call iPM7G421R.M_MAINT_PUR_RETURN_SVR(gStrGlobalCollection, iCommandSent,I2_m_pur_goods_mvmt, _
                                ...
                                itxtSpread, E5_b_auto_numbering, iErrorPosition, I7_remark_hdr)
