...
'*  2. Function Name        :																			*
'*  3. Program ID           : m4161pa1.asp																*
'*  4. Program Name         :																			*
'*  5. Program Desc         : 검사결과등록-결과등록번호 팝업의 재고처리번호 팝업						*
'*  6. Comproxy List        : 																			*
...
Const BIZ_PGM_QRY_ID = "m4161pb1.asp"  
'================================================================================================================================
...
Sub InitSpreadSheet()
	...
	Call SetZAdoSpreadSheet("M4161PA1","S","A","V20030528",PopupParent.C_SORT_DBAGENT,frm1.vspdData, C_MaxKey, "X","X")
...
Function OpenMvmtType()
	...
	If IsOpenPop = True Or UCase(frm1.txtMoveType.className) = UCase(PopupParent.UCN_PROTECTED) Then Exit Function
	...
	arrParam(4) = "((RCPT_FLG=" & FilterVar("Y", "''", "S") & "  AND RET_FLG=" & FilterVar("N", "''", "S") & " ) or (RET_FLG=" & FilterVar("N", "''", "S") & "  And SUBCONTRA_FLG=" & FilterVar("N", "''", "S") & " )) AND USAGE_FLG=" & FilterVar("Y", "''", "S") & "  "
	arrParam(5) = "입고유형"			
...
Function SetMovetype(byval arrRet)
	frm1.txtMoveType.Value	= arrRet(0)		
	frm1.txtMoveTypeNm.Value= arrRet(1)		
...
Function FncQuery() 
    ...
    with frm1
		if (UniConvDateToYYYYMMDD(.txtFrRcptDt.text,PopupParent.gDateFormat,"") > UniConvDateToYYYYMMDD(.txtToRcptDt.text,PopupParent.gDateFormat,"")) And Trim(.txtFrRcptDt.text) <> "" And Trim(.txtToRcptDt.text) <> "" then	
			Call DisplayMsgBox("17a003","X","재고처리일","X")					
			Exit Function
		End if   
	End with
			...
			<FIELDSET CLASS="CLSFLD">
				<TABLE <%=LR_SPACE_TYPE_40%>>
					<TR>
						...
						<TD CLASS="TD6" NOWRAP><INPUT TYPE=TEXT Alt="입고형태" NAME="txtMoveType" SIZE=10 MAXLENGTH=5 tag="11NXXU"><IMG SRC="../../../CShared/image/btnPopup.gif" NAME="btnMoveType" align=top TYPE="BUTTON"ONCLICK="vbscript:OpenMvmtType()">
											   <INPUT TYPE=TEXT Alt="입고형태" NAME="txtMoveTypeNm" SIZE=20 tag="14X"></TD>
						<TD CLASS="TD5" NOWRAP>재고처리일</TD>
						<TD CLASS="TD6" NOWRAP>
							<table cellspacing=0 cellpadding=0>
								<tr NOWRAP>
									<td NOWRAP>
										<script language =javascript src='./js/m4161pa1_fpDateTime1_txtFrRcptDt.js'></script>
									</td>
									<td NOWRAP>~</td>
									<td NOWRAP>
										<script language =javascript src='./js/m4161pa1_fpDateTime1_txtToRcptDt.js'></script>
									</td>
								<tr>
							</table>
						</TD>
			...
			<TABLE <%=LR_SPACE_TYPE_20%>>
				<TR>
					<TD HEIGHT=100% WIDTH=100% COLSPAN=4>					
						<script language =javascript src='./js/m4161pa1_vspdData_vspdData.js'></script>
					</TD>
				</TR>
			</TABLE>
		</TD>
