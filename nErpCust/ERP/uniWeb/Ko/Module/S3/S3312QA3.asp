...
'========================================
Sub InitSpreadSheet()
    Call SetZAdoSpreadSheet("S3312QA3","S","A", "V20030701", parent.C_SORT_DBAGENT,frm1.vspdData,C_MaxKey, "X", "X")
    Call SetSpreadLock()       
End Sub

Sub InitSpreadSheet1()
    Call SetZAdoSpreadSheet("S3312QA31","S","B", "V20030701", parent.C_SORT_DBAGENT,frm1.vspdData1,C_MaxKey, "X", "X")
    Call SetSpreadLock1()       
End Sub
					...
					<TD CLASS="CLSMTABP">
						<TABLE ID="MyTab" CELLSPACING=0 CELLPADDING=0>
							<TR>
								...
								<td background="../../../CShared/image/table/seltab_up_bg.gif" align="center" CLASS="CLSMTAB"><font color=white>수주실적(거래처)</font></td>
							...
							<TABLE <%=LR_SPACE_TYPE_40%>>
								<TR>
									...
									<TABLE CELLSPACING=0 CELLPADDING=0>
										<TR>
											<TD>
											<script language =javascript src='./js/s3312qa3_OBJECT1_txtConFromDt.js'></script>
											</TD>
										</TR>
									</TABLE>							        
							        </TD>
						...
						<FIELDSET CLASS="CLSFLD">
							<TABLE <%=LR_SPACE_TYPE_20%>>
								<TR>
									...
									<TD CLASS=TD6 NOWRAP>
										<script language =javascript src='./js/s3312qa3_fpDoubleSingle2_txt_TOTAL.js'></script>
									</TD>
				...
				<TR>
					<TD WIDTH=100% HEIGHT=* valign=top>
						<TABLE <%=LR_SPACE_TYPE_20%>>
							<TR>
								<TD HEIGHT="100%">
									<script language =javascript src='./js/s3312qa3_vspdData_vspdData.js'></script>
									<script language =javascript src='./js/s3312qa3_vspdData1_vspdData1.js'></script>
								</TD>
							</TR>
						</TABLE>
					</TD>
