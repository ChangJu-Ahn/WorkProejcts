...
Function OpenMesDnRef()
	...
	ggoSpread.Source = frm1.vspdData
	arrParam(0) = Trim(frm1.txtSoldToParty.value)
	IsOpenPop = True
	
	iCalledAspName = AskPRAspName("S3112RA2_KO441")	
	If Trim(iCalledAspName) = "" then
		IntRetCD = DisplayMsgBox("900040",parent.VB_INFORMATION, "S3112RA2_KO441", "x")
		IsOpenPop = False
		Exit Function
	End If
	...
	With frm1
		...
		For intCnt = 1 to intLoopCnt + 1
			...
			If blnEqualFlg = False Then
				...
				ggoSpread.SpreadUnLock	C_SoUnit, intCnt,C_SoUnit, intCnt   
				ggoSpread.SpreadUnLock	C_SoUnitPopup, intCnt, C_SoUnitPopup, intCnt
				ggoSpread.SpreadUnLock	C_SoQty, intCnt, C_SoQty, intCnt
				ggoSpread.SpreadUnLock	C_SoPrice, intCnt, C_SoPrice, intCnt 
				ggoSpread.SpreadUnLock	C_SoPriceFlag, intCnt, C_SoPriceFlag, intCnt
				ggoSpread.SpreadUnLock	C_SoPriceAutoChk, intCnt, C_SoPriceAutoChk, intCnt
				ggoSpread.SpreadUnLock	C_NetAmt, intCnt, C_NetAmt, intCnt
				ggoSpread.SpreadUnLock	C_TotalAmt, intCnt, C_TotalAmt, intCnt
				ggoSpread.SpreadUnLock	C_PlantCd, intCnt, C_PlantCd, intCnt
				ggoSpread.SpreadUnLock	C_PlantCdPopup, intCnt, C_PlantCdPopup, intCnt  
				ggoSpread.SpreadUnLock	C_DlvyDt, intCnt, C_DlvyDt, intCnt
				ggoSpread.SpreadUnLock	C_ShipToParty, intCnt, C_ShipToParty, intCnt
				ggoSpread.SpreadUnLock	C_ShipToPartyPopup, intCnt, C_ShipToPartyPopup, intCnt     
				ggoSpread.SpreadUnLock	C_VatType, intCnt, C_VatType, intCnt 
				ggoSpread.SpreadUnLock	C_VatTypePopup, intCnt, C_VatTypePopup, intCnt   
				ggoSpread.SpreadUnLock	C_VatIncFlagNm, intCnt, C_VatIncFlagNm, intCnt 
				ggoSpread.SpreadUnLock	C_TolMoreRate, intCnt, C_TolMoreRate, intCnt
				ggoSpread.SpreadUnLock	C_TolLessRate, intCnt, C_TolLessRate, intCnt 
				ggoSpread.SpreadUnLock	C_BonusQty, intCnt, C_BonusQty, intCnt 
				ggoSpread.SpreadUnLock	C_SlCd, intCnt, C_SlCd, intCnt
				ggoSpread.SpreadUnLock	C_SlCdPopup, intCnt, C_SlCdPopup, intCnt 
				ggoSpread.SpreadUnLock	C_Remark, intCnt, C_Remark, intCnt   

	
										   'Col				Row         Row2
		ggoSpread.SSSetProtected	C_ItemCd,		intCnt,	intCnt			
		'ggoSpread.SSSetRequired		C_ItemCd,		intCnt, intCnt	
		ggoSpread.SSSetProtected	C_ItemName,		intCnt, intCnt
		ggoSpread.SSSetProtected	C_ItemSpec,		intCnt, intCnt	
		ggoSpread.SSSetRequired		C_SoUnit,		intCnt, intCnt		
		ggoSpread.SSSetProtected	C_TrackingNo,	intCnt, intCnt
		ggoSpread.SSSetProtected	C_TrackingNoPopup,	intCnt, intCnt
		ggoSpread.SSSetProtected	C_SoSupplyQty,	intCnt, intCnt		
		ggoSpread.SSSetRequired		C_SoPriceFlag,	intCnt, intCnt		
		ggoSpread.SSSetRequired		C_SoQty,		intCnt, intCnt
		ggoSpread.SSSetRequired		C_DlvyDt,		intCnt, intCnt
		ggoSpread.SSSetRequired		C_ShipToParty,	intCnt, intCnt
		ggoSpread.SSSetRequired		C_PlantCd,		intCnt, intCnt		
		ggoSpread.SSSetRequired		C_TotalAmt,		intCnt, intCnt
		ggoSpread.SSSetProtected	C_NetAmt,		intCnt, intCnt
		ggoSpread.SSSetProtected	C_DnReqDt,		intCnt, intCnt
		ggoSpread.SSSetProtected	C_VATAmt,		intCnt, intCnt
		ggoSpread.SSSetRequired		C_VatType,		intCnt, intCnt
		ggoSpread.SSSetProtected	C_VatTypeNm,	intCnt, intCnt
		ggoSpread.SSSetProtected	C_VatRate,		pintCnt, intCnt
		ggoSpread.SSSetProtected	C_VatIncFlag,	intCnt, intCnt
		ggoSpread.SSSetRequired		C_VatIncFlagNm,intCnt, intCnt
		ggoSpread.SSSetProtected	C_RetTypeNm,	intCnt, intCnt
		ggoSpread.SSSetProtected	C_LotNo,		intCnt, intCnt
		ggoSpread.SSSetProtected	C_LotSeq,		intCnt, intCnt
		ggoSpread.SSSetProtected	C_PreDNNo,		intCnt, intCnt
		ggoSpread.SSSetProtected	C_PreDNSeq,		intCnt, intCnt
...
Function QtyPriceChange(iRow)
	...
	' 붙여넣기 할때 안 바뀜 ( 박 정 순 수정 2008-01-18 )
	frm1.vspdData.Col = C_VatIncFlagNm
	If Trim(frm1.vspdData.Text) = "포함" Then
...
Function ItemByHScodeChange(CRow)
	...
	With frm1.vspdData
		...
		.Col	= C_VatType
		'If .text = "" Then  -- 박정순 수정 (2007-08-14)  품목변경시 항상 다시 vat_type 을 가져오게 수정.
