...
'**********************************************************************************************************!-->
Const BIZ_PGM_ID = "s3313mb1_ko441.asp"
				...
				<tr>
					...
					<table id="MyTab" cellspacing="0" cellpadding="0">
						<tr>
							...
							<td background="../../../CShared/image/table/seltab_up_bg.gif" align="center" class="CLSMTAB"><font color="#FFFFFF">일일수주실적조회</font></td>
					...
					<table <%=lr_space_type_40%>>
						<TR>
							...
							<TR>
								...
								<TD CLASS="TD6" NOWRAP>
									<script language="javascript" src="./js/s3313ma1_ko441_fpDateTime1_txtDocumentDt.js"></script>	
									</TD>		
				...
				<tr>
					...
					<table <%=lr_space_type_60%>>
						<tr>
							...
							<script language="javascript" src="./js/s3313ma1_ko441_vspdData.js"></script>
							</td>
						</tr>
					</table>
					</td>
