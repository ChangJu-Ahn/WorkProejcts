...
'========================================================================================================
Const BIZ_PGM_ID = "S3101MB1_KO441.asp"                                      '비지니스 로직 ASP명 
...
Sub InitSpreadSheet()
	...
	With frm1.vspdData
        ...
        .MaxRows = 0
			...
			ggoSpread.SSSetEdit   C_PROFORMA_NO     , "견적NO", 20,,, 18, 2
			ggoSpread.SSSetEdit   C_BP_CD     			, "고객코드", 10,,, 10, 2
			ggoSpread.SSSetButton C_BP_POP
			ggoSpread.SSSetEdit  	C_BP_NM           , "고객명", 16
			ggoSpread.SSSetEdit   C_TEL_NO     			, "연락처", 10,,, 20, 1
			ggoSpread.SSSetEdit   C_CUST_USER       , "고객담당자", 10,,, 20, 1
		  ggoSpread.SSSetDate		C_PROFORMA_DT			,	"견적일",		10,		2,					parent.gDateFormat
			ggoSpread.SSSetEdit   C_DOCUMENT   			, "내용", 30,,, 50, 1
	  	ggoSpread.SSSetFloat	C_AMT							,	"견적단가(금액)",		15,		parent.ggAmtOfMoneyNo,	ggStrIntegeralPart,	ggStrDeciPointPart,	parent.gComNum1000,	parent.gComNumDec,	,	,	"Z"			
			ggoSpread.SSSetEdit  	C_USR_NM          , "작성자", 10
			ggoSpread.SSSetCheck	C_CONFIRM_YN			, "견적확정여부",10,,,true
			ggoSpread.SSSetCheck	C_BILL_YN					, "매출적용여부",10,,,true
		  ggoSpread.SSSetDate		C_TAX_DT					,	"청구년월일",		10,		2,					parent.gDateFormat
...
'     call ggoSpread.SSSetColHidden(C_FLAG,C_FLAG,True)
			...
			Call .AddCellSpan(0,							-1000,1,2)							'시작컬럼, 시작로, 길이컬럼, 길이행 

			Call .AddCellSpan(C_PROFORMA_NO,	-1000,1,2)	'시작컬럼, 시작로, 길이컬럼, 길이행 
			.Col = C_PROFORMA_NO :.Text ="견적NO"
			
			Call .AddCellSpan(C_BP_CD,				-1000,5,1)	'시작컬럼, 시작로, 길이컬럼, 길이행 
			.Col = C_BP_CD :.Text ="고객정보"
			
			Call .AddCellSpan(C_PROFORMA_DT,	-1000,5,1)	'시작컬럼, 시작로, 길이컬럼, 길이행 
			.Col = C_PROFORMA_DT :.Text ="견적사항"
			
			Call .AddCellSpan(C_BILL_YN,			-1000,2,1)	'시작컬럼, 시작로, 길이컬럼, 길이행 			
			.Col = C_BILL_YN :.Text ="매출연계"
			
			Call .AddCellSpan(C_REMARK,				-1000,1,2)	'시작컬럼, 시작로, 길이컬럼, 길이행 
			
			.Row = 2
			.Col = C_BP_CD :.Text ="고객코드"
			.Col = C_BP_NM :.Text ="고객명"
			.Col = C_TEL_NO :.Text ="연락처"
			.Col = C_CUST_USER :.Text ="고객담당자"
			.Col = C_PROFORMA_DT :.Text ="견적일"
			.Col = C_DOCUMENT :.Text ="내용"
			.Col = C_AMT :.Text ="견적단가(금액)"
			.Col = C_USR_NM :.Text ="작성자"
			.Col = C_CONFIRM_YN :.Text ="견적확정여부"
			.Col = C_BILL_YN :.Text ="매출적용여부"
			.Col = C_TAX_DT :.Text ="청구년월일"
			.Col = C_REMARK :.Text ="비고"
					        

			.rowheight(-1000) =13	' 높이 재지정 
			.rowheight(-999) = 13	' 높이 재지정 
...
Function txtBpCd_OnChange()    
    ...
    ELSE    
        ...
        If IntRetCd = false Then
            Call DisplayMsgBox("17A003","X","거래처코드","X")                         '☜ : 해당사원은 존재하지 않습니다.            
            frm1.txtBpNm.value=""
            frm1.txtBpCd.focus
					...
					<TD CLASS="CLSMTABP">
						<TABLE ID="MyTab" CELLSPACING=0 CELLPADDING=0>
							<TR>
								...
								<td background="../../../CShared/image/table/seltab_up_bg.gif" align="center" CLASS="CLSMTABP"><font color=white>견적대장등록</font></td>
