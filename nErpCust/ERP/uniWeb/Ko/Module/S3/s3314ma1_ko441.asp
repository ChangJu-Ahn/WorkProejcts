...
Const BIZ_PGM_ID    = "s3314mb1_KO441.asp"
Const BIZ_PGM_ID2   = "s3314mb2_KO441.asp"						  '20080129::hanc         '☆: Biz Logic ASP Name
Const BIZ_PGM_ID3   = "s3314mb3_KO441.asp"						  '20080303::hanc         '☆: Biz Logic ASP Name
...
Sub MakeKeyStream()
	...
	lgKeyStream = lgKeyStream & Trim(frm1.txtSalesGroup_cd.Value) & parent.gColSep
           ...
           Select Case .vspdData.Text
               ...
               Case ggoSpread.UpdateFlag                                      '☜: Update
                    ...
                    .vspdData.Col = C_Item_Cd			:	strVal = strVal & Trim(.vspdData.Text) & parent.gColSep
                                                            strVal = strVal & Trim(frm1.txtSalesGroup_cd.value) & parent.gColSep        '2008-06-27 12:23오전 :: hanc
...
Function ExeReflect() 
	...
	If Trim(frm1.txtSalesGroup_cd.Value) = "" then        '20080303::hanc
		Call DisplayMsgBox("ZZ0018","X", "X", "X")
		frm1.txtSalesGroup_cd.focus
		Exit Function
	End If
                    ...
                    <TD HEIGHT=20 WIDTH=100%>
                        ...
                        <TABLE <%=LR_SPACE_TYPE_40%>>
                            <TR>
                                ...
                                <TD CLASS="TD5" NOWRAP>생산계획기간</TD>
                                <TD CLASS="TD6" NOWRAP>
									<TABLE CELLSPACING=0 CELLPADDING=0>
										<TR>
											<TD>
                                                <SCRIPT LANGUAGE=JavaScript> ExternalWrite('<OBJECT title=FPDATETIME style="LEFT: 0px; WIDTH: 100px;  HEIGHT: 20px" name=txtYYYYMM CLASSID=<%=gCLSIDFPDT%> ALT="기준일자" tag="12X1" VIEWASTEXT id=OBJECT1></OBJECT>');</SCRIPT>&nbsp;
  											</TD>
											<TD>
							...
							<TR>
								...
								<TD CLASS="TD6"><INPUT NAME="txtSalesGroup_cd" ALT="영업그룹" TYPE="Text" MAXLENGTH=4 SiZE=10 tag="12XXXU"><IMG SRC="../../../CShared/image/btnPopup.gif" NAME="btnStoRo" align=top TYPE="BUTTON" ONCLICK="vbscript:OpenConSItemDC 3">&nbsp;<INPUT NAME="txtSalesGroup_nm" TYPE="Text" MAXLENGTH="20" SIZE=25 tag=14></TD>
							</TR>	
                            <TR>
