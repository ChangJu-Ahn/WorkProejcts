...
'========================================
Sub InitSpreadSheet()
    Call SetZAdoSpreadSheet("S3312QA2","S","A", "V20030702", parent.C_SORT_DBAGENT,frm1.vspdData,C_MaxKey, "X", "X")
    Call SetSpreadLock()       
End Sub

Sub InitSpreadSheet1()
    Call SetZAdoSpreadSheet("S3312QA21","S","B", "V20030702", parent.C_SORT_DBAGENT,frm1.vspdData1,C_MaxKey, "X", "X")
    Call SetSpreadLock1()       
End Sub
...
Function DbQuery() 
    ...
    With frm1
        If lgIntFlgMode  <> parent.OPMD_UMODE Then								
			...
			.txtHRetType.value		= .txtRetType.value
	...
	With frm1
		Select Case pvIntWhere
			...
			Case C_PopRetType												
				...
				iArrParam(2) = Trim(.txtRetType.value)
				iArrParam(3) = ""
				iArrParam(4) = "MAJOR_CD=" & FilterVar("B9017", "''", "S") & ""
				
				iArrField(0) = "ED15" & Parent.gColSep & "Minor_cd"
				iArrField(1) = "ED30" & Parent.gColSep & "Minor_nm"
    
			    iArrHeader(0) = .txtRetType.Alt
			    iArrHeader(1) = .txtRetTypeNm.Alt
...
Function SetConPopup(Byval pvArrRet,ByVal pvIntWhere)
	...
	With frm1
		Select Case pvIntWhere
			...
			Case C_PopRetType
				.txtRetType.value = pvArrRet(0) 
				.txtRetTypeNm.value = pvArrRet(1)
					...
					<TD CLASS="CLSMTABP">
						<TABLE ID="MyTab" CELLSPACING=0 CELLPADDING=0>
							<TR>
								...
								<td background="../../../CShared/image/table/seltab_up_bg.gif" align="center" CLASS="CLSMTAB"><font color=white>반품현황(년간)</font></td>
							...
							<TABLE <%=LR_SPACE_TYPE_40%>>
								<TR>
									...
									<TABLE CELLSPACING=0 CELLPADDING=0>
										<TR>
											<TD>
											<script language =javascript src='./js/s3312qa2_OBJECT1_txtConFromDt.js'></script>
											</TD>
										</TR>
									</TABLE>							        
							        </TD>
								...
								<TR>
									...
									<TD CLASS="TD6"><INPUT TYPE="Text" NAME="txtRetType" SiZE=10 MAXLENGTH=4 tag="11XXXU" ALT="반품형태"><IMG SRC="../../../CShared/image/btnPopup.gif" NAME="btnRetType" align=top TYPE="BUTTON" ONCLICK="vbscript:OpenConPopup C_PopRetType">&nbsp;<INPUT TYPE="Text" NAME="txtRetTypeNm" SIZE=20 tag="14" ALT="반품형태명"></TD>
						...
						<FIELDSET CLASS="CLSFLD">
							<TABLE <%=LR_SPACE_TYPE_20%>>
								<TR>
									...
									<TD CLASS=TD6 NOWRAP>
										<script language =javascript src='./js/s3312qa2_fpDoubleSingle2_txt_TOTAL.js'></script>
									</TD>
				...
				<TR>
					<TD WIDTH=100% HEIGHT=* valign=top>
						<TABLE <%=LR_SPACE_TYPE_20%>>
							<TR>
								<TD HEIGHT="100%">
									<script language =javascript src='./js/s3312qa2_vspdData_vspdData.js'></script>

									<script language =javascript src='./js/s3312qa2_vspdData1_vspdData1.js'></script>
								</TD>
							</TR>
						</TABLE>
					</TD>
...
<INPUT TYPE=HIDDEN NAME="txtHRetType"		tag="24" TABINDEX="-1">
