...
'**********************************************************************************************
'*  1. Module Name          : 영업 
'*  2. Function Name        : 거래처별 수주집계 출력 
'*  3. Program ID           : S3113OA1
'*  4. Program Name         : 거래처별 수주집계 출력 
'*  5. Program Desc         : 거래처별 수주집계 출력 
'*  6. Comproxy List        : 
...
Function BtnPrint(ByVal pvStrPrint) 
	...
	ObjName = AskEBDocumentName("s3113oa1","ebr")
					...
					<TD>
						<TABLE ID="MyTab" CELLSPACING=0 CELLPADDING=0>
							<TR>
								...
								<td background="../../../CShared/image/table/seltab_up_bg.gif" align="center" CLASS="CLSMTAB"><font color=white>거래처별 수주집계출력</font></td>
								...
								<TR>
									...
									<TD CLASS=TD6 NOWRAP>
										<TABLE CELLSPACING=0 CELLPADDING=0>
											<TR>
												<TD>
													<script language =javascript src='./js/s3113oa1_fpDateTime1_txtConSoDtFromDt.js'></script>
												</TD>
												<TD>
													&nbsp;~&nbsp;
												</TD>
												<TD>
													<script language =javascript src='./js/s3113oa1_fpDateTime2_txtConSoDtToDt.js'></script>
												</TD>
