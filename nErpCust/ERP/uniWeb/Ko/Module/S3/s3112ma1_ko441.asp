...
<SCRIPT LANGUAGE="VBScript"   SRC="s3112ma1_ko441.vbs"> </SCRIPT>
  ...
  <TD WIDTH=100%>
   <TABLE <%=LR_SPACE_TYPE_10%>>
    <TR>
     ...
     <TD WIDTH=* align=right><A href="vbscript:OpenMESDnRef">MES출고참조</A>&nbsp;|&nbsp;<A href="vbscript:OpenBOMRef">BOM참조</A>&nbsp;|&nbsp;<A href="vbscript:OpenStockDtlRef">재고현황참조</A>&nbsp;|&nbsp;<A href="vbscript:OpenSoDtlRef">수주내역참조</A>&nbsp;|&nbsp;<A href="vbscript:OpenStyleRef">클래스참조</A>&nbsp;<A ID="txtOpenPrjRef" STYLE="DISPLAY: none" href="vbscript:OpenPrjRef">|&nbsp;프로젝트내역참조</A></TD>
     <TD WIDTH=10>&nbsp;</TD>
    </TR>
   </TABLE>
  </TD>
