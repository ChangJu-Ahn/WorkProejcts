...
Sub SetDefaultVal()
	...
	If Len(arrParam(5)) then
		iStatusFlag = arrParam(5)
	End If	

	Select Case iStatusFlag
		Case "ML", "MA", "MS", "CL", "ES", "EL", "EC"
			lblTitle.innerHTML = "수입자"
	End Select
...
'=============================================================================================================
Sub InitSpreadSheet()
	Call SetZAdoSpreadSheet("S3135PA3","S","A","V20021106", PopupParent.C_SORT_DBAGENT, frm1.vspdData, C_MaxKey, "X", "X" )    
    Call SetSpreadLock 	  	      
End Sub
...
Function DbQuery() 
    ...
    With frm1
		If lgIntFlgMode <> PopupParent.OPMD_UMODE Then		
			...
			.txtHPtnBpCd.value		=  Trim(frm1.txtPtnBpCd.value)
			.txtHSalesGrp.value		=  Trim(frm1.txtSalesGrp.value)
			.txtHPlant.value		=  Trim(frm1.txtPlant.value)
			.txtHItem.value			=  Trim(frm1.txtItem.value)
			.txtHFromDt.value		=  Trim(frm1.txtFromDt.text)
			.txtHToDt.value			=  Trim(frm1.txtToDt.text)						
			.txtHStatusFlag.value   =  iStatusFlag					
		...
		<TD HEIGHT=20 WIDTH=100%>
			<FIELDSET CLASS="CLSFLD">
				<TABLE <%=LR_SPACE_TYPE_40%>>
					<TR>
						<TD CLASS=TD5 id = "lblTitle" NOWRAP>주문처</TD>
					...
					<TR>
						...
						<TD CLASS=TD6>
							<TABLE CELLSPACING=0 CELLPADDING=0>
								<TR>
									<TD>
										<script language =javascript src='./js/s3135pa3_fpDateTime1_txtFromDt.js'></script>
									</TD>
									<TD>
										&nbsp;~&nbsp;
									</TD>
									<TD>
										<script language =javascript src='./js/s3135pa3_fpDateTime2_txtToDt.js'></script>
									</TD>
								</TR>
							</TABLE>
						</TD>					
	...
	<TR>
		<TD WIDTH=100% HEIGHT=* valign=top>
			<TABLE <%=LR_SPACE_TYPE_20%>>
				<TR>
					<TD HEIGHT="100%">
						<script language =javascript src='./js/s3135pa3_vaSpread_vspdData.js'></script>
					</TD>
				</TR>
			</TABLE>
		</TD>
...
<INPUT TYPE=HIDDEN NAME="txtHStatusFlag" TAG="24" TABINDEX=-1>	
</FORM>
