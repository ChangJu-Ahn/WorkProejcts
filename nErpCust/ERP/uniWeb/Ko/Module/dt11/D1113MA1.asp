...
'========================================================================================================
Const BIZ_PGM_ID      = "D1113MB1.asp"
Const BIZ_PGM_SAVE_ID = "D1113MB2.asp" 
...
Sub InitSpreadSheet()
	...
	With frm1.vspdData
		...
		.MaxCols = C1_remarks + 1
		.MaxRows = 0
		
		Call GetSpreadColumnPos("A")
		
		ggoSpread.SSSetEdit  	C1_bp_cd       ,   "거래처"    , 20,0,,10,2
		ggoSpread.SSSetButton   C1_bp_cd_B
		ggoSpread.SSSetEdit  	C1_bp_nm       ,   "거래처명"  , 20
		ggoSpread.SSSetCombo    C1_rev_flag    ,   ""          , 12
		ggoSpread.SSSetCombo    C1_rev_flag_nm ,   "역발행업무", 12
		ggoSpread.SSSetEdit  	C1_remarks     ,   "비고"      , 50,,,2000
		
 		Call ggoSpread.SSSetColHidden(C1_rev_flag, C1_rev_flag, True)
...
Sub SetSpreadLock()
	With frm1.vspdData
        ...
        ggoSpread.SpreadLock C1_bp_cd_B   , -1, C1_bp_cd_B
...
Sub SetSpreadColor(ByVal pvStartRow, ByVal pvEndRow, ByVal QueryStatus)
	With frm1.vspdData
		...
		ggoSpread.SSSetRequired  C1_bp_cd , pvStartRow, pvEndRow
        ggoSpread.SSSetProtected C1_bp_nm , pvStartRow, pvEndRow
		.ReDraw = True		
	End With
End Sub
...
Sub InitGridComboBox()
	...
	IntRetCD1= CommonQueryRs("MINOR_CD,MINOR_NM","B_MINOR","(MAJOR_CD = " & FilterVar("DT005", "''", "S") & " )",lgF0,lgF1,lgF2,lgF3,lgF4,lgF5,lgF6)	

	If intRetCD <> False Then
		ggoSpread.Source = frm1.vspddata
		ggoSpread.SetCombo Replace(vbTab & lgF0,Chr(11),vbTab), C1_rev_flag
		ggoSpread.SetCombo Replace(vbTab & lgF1,Chr(11),vbTab), C1_rev_flag_nm
	End If
...
Sub GetSpreadColumnPos(ByVal pvSpdNo)
 	...
 	Select Case UCase(pvSpdNo)
 		Case "A"
            ...
            C1_bp_cd       = 	iCurColumnPos(1)
            C1_bp_cd_B     = 	iCurColumnPos(2)
            C1_bp_nm       = 	iCurColumnPos(3)
            C1_rev_flag    = 	iCurColumnPos(4)
            C1_rev_flag_nm = 	iCurColumnPos(5)
...
Sub vspdData_ButtonClicked(ByVal Col, ByVal Row, ByVal ButtonDown)
	With frm1.vspdData 
		ggoSpread.Source = frm1.vspdData
		If Row > 0 And Col = C1_bp_cd_B Then
		    .Col = Col
		    .Row = Row
			...
			Select Case .vspdData.Text
				...
				Case iInsertFlag
					...
					strVal = "C" & iColSep _
							     ...
							     & GetSpreadText(.vspdData,C1_rev_flag    ,lRow,"X","X") & iColSep _
								...
								<FIELDSET CLASS="CLSFLD">
									<TABLE <%=LR_SPACE_TYPE_40%>>
										<TR>
											...
											<TD CLASS="TD6" NOWRAP>
												<INPUT CLASS="clstxt" TYPE=TEXT NAME="BizPartnerID" SIZE=10 MAXLENGTH=10 STYLE="TEXT-ALIGN: Left" tag="11XXXU" ALT="거래처"><IMG SRC="../../../CShared/image/btnPopup.gif" NAME="btnTaxareaCd" align=top TYPE="BUTTON" ONCLICK="vbscript:OpenUsrId frm1.BizPartnerID.value,0">
