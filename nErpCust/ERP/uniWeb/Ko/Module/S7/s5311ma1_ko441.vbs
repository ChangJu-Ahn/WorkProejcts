...
Function OpenTaxbillNoPop()
	...
	iCalledAspName = AskPRAspName("s5311pa1_ko441")	
	if Trim(iCalledAspName) = "" then
		IntRetCD = DisplayMsgBox("900040",parent.VB_INFORMATION, "s5311pa1_ko441", "x")
		gblnWinEvent = False
		exit Function
	end if
...
Function OpenBillRef()
	...
	iCalledAspName = AskPRAspName("s5111ra3_ko441")	
	if Trim(iCalledAspName) = "" then
		IntRetCD = DisplayMsgBox("900040",parent.VB_INFORMATION, "s5111ra3_ko441", "x")
		gblnWinEvent = False
		exit Function
	end if
