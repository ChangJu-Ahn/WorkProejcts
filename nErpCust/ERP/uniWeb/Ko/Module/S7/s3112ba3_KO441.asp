...
'*  3. Program ID           : s3112ba3
'*  4. Program Name         : 출하내역 참조
'*  5. Program Desc         : 매출채권내역등록에서 출하내역 참조 Popup
'*  6. Comproxy List        : 
...
' External ASP File
'========================================
Const BIZ_PGM_ID 		= "s3112bb3_ko441.asp"                              '☆: Biz Logic ASP Name
Const BIZ_PGM_ID2 		= "s3112bb4_ko441.asp"                              '☆: Biz Logic ASP Name


' Constant variables 
'========================================
Const C_MaxKey          = 29                                           '☆: key count of SpreadSheet
Const C_PopItemCd		= 1
...
Sub InitSpreadSheet()
	...
	Call SetZAdoSpreadSheet("S3112BA3_KO441","S","A","V20080419",PopupParent.C_SORT_DBAGENT,frm1.vspdData, C_MaxKey, "X","X")		
	Call SetZAdoSpreadSheet("S3112BA4_KO441","S","B","V20080419",PopupParent.C_SORT_DBAGENT,frm1.vspdData2, 0, "X","X")		
...
Sub vspdData_Click(ByVal Col, ByVal Row)
	...
	If frm1.vspdData.MaxRows = 0 or Row=0 Then Exit Sub
	If lgActiveRow=Row Then Exit Sub
	Call DbQuery2(Row)
	lgActiveRow=Row
End Sub
...
Function DbQuery() 
    ...
    With frm1
		...
		If lgIntFlgMode = PopupParent.OPMD_UMODE Then
			...
			strVal = strVal & "&txtLotNo=" & Trim(.txtHLotNo.value)			
		Else
			' 처음 조회시
...
Function DbQuery2(Row) 
	...
	strVal = BIZ_PGM_ID2 & "?txtBPCD=" & frm1.txtSoldToParty.value
	strVal = strVal & "&txtITEMCD=" & GetSpreadText(frm1.vspdData,GetKeyPos("A", 2),Row,"X","X")	
	strVal = strVal & "&txtLOTNO=" & GetSpreadText(frm1.vspdData,GetKeyPos("A", 27),Row,"X","X")		
			...
			<FIELDSET CLASS="CLSFLD">
				<TABLE <%=LR_SPACE_TYPE_40%>>
					...
					<TR>
						...
						<TD CLASS=TD6 NOWRAP><INPUT NAME="txtLotNo" ALT="LOT 번호" TYPE=TEXT MAXLENGTH=25 SIZE=30 TAG="11XXXU" TABINDEX=-1></TD>
					</TR>
					<TR>
	...
	<TR>
		<TD WIDTH=100% HEIGHT=* valign=top>
			<TABLE <%=LR_SPACE_TYPE_20%>>
				...
				<TR>
					<TD HEIGHT="50%">
						<SCRIPT LANGUAGE=JavaScript> ExternalWrite('<OBJECT CLASSID=<%=gCLSIDFPSPD%> NAME=vspdData2 WIDTH=100% HEIGHT=100% TAG="23" id=vaSpread2 TITLE="SPREAD"> <PARAM NAME="MaxRows" Value=0> <PARAM NAME="MaxCols" Value=0> <PARAM NAME="ReDraw" VALUE=0> </OBJECT>');</SCRIPT>
					</TD>
				</TR>
			</TABLE>
		</TD>
...
<INPUT TYPE=HIDDEN NAME="txtHLotNo" TAG="24">
