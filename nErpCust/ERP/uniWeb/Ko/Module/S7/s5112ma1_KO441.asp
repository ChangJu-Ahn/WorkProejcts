...
Const BIZ_BillHdr_JUMP_ID = "s5111ma1_ko441"           
...
Dim C_LOT_NO_KO441
Dim C_CUST_LOT_NO_KO441
'2008-06-17 1:36오전 :: hanc
Dim C_pgm_name_KO441
Dim C_pgm_price_KO441
...
Sub initSpreadPosVariables()  
	...
	C_LOT_NO_KO441 = 40
	C_CUST_LOT_NO_KO441 = 41
    '2008-06-17 1:37오전 :: hanc
	C_pgm_name_KO441 = 42
	C_pgm_price_KO441 = 43
...
Sub InitSpreadSheet()
	...
	With ggoSpread
		...
		'patch version
		.Spreadinit "V20031002",,parent.gAllowDragDropSpread    
		frm1.vspdData.ReDraw = False
		
	    frm1.vspdData.MaxRows = 0 : frm1.vspdData.MaxCols = 0	     
	    frm1.vspdData.MaxCols = C_pgm_price_KO441 + 1           '☜: 최대 Columns의 항상 1개 증가시킴
		...
		.SSSetEdit  C_LOT_NO_KO441, "LOT No.", 20
		.SSSetEdit  C_CUST_LOT_NO_KO441, "Customer LOT No.", 20

		.SSSetEdit  C_pgm_name_KO441, "PGM NAME", 20,,,50,2
	    .SSSetFloat C_pgm_price_KO441,"PGM 적용단가",15,Parent.ggUnitCostNo,ggStrIntegeralPart, ggStrDeciPointPart,Parent.gComNum1000,Parent.gComNumDec
	    ...
	    call .SSSetColHidden(C_OldBillAmt, C_CREATE_TYPE_KO441, True)				'☜: 공통콘트롤 사용 Hidden Column
...
Sub SetSpreadColor(ByVal pvStartRow,ByVal pvEndRow)
	with frm1
		...
		ggoSpread.SSSetProtected C_LOT_NO_KO441	, pvStartRow, pvEndRow
		ggoSpread.SSSetProtected C_CUST_LOT_NO_KO441	, pvStartRow, pvEndRow
		ggoSpread.SSSetProtected C_pgm_name_KO441	, pvStartRow, pvEndRow
		ggoSpread.SSSetProtected C_pgm_price_KO441	, pvStartRow, pvEndRow
	  ...
	  Dim iCnt
		for iCnt=pvStartRow To pvEndRow
			if Trim(GetSpreadText(frm1.vspdData,C_OUT_NO_KO441,iCnt,"X","X")) <> "" Then
				ggoSpread.SSSetProtected  C_BillQty, iCnt, iCnt
				'ggoSpread.SSSetProtected  C_BillPrice, iCnt, iCnt
				'ggoSpread.SSSetProtected  C_BillAmt, iCnt, iCnt		
			End if
		next
...
Sub GetSpreadColumnPos(ByVal pvSpdNo)
    ...
    Select Case UCase(pvSpdNo)
       Case "A"
	        ...
	        C_LOT_NO_KO441 = iCurColumnPos(40)
			C_CUST_LOT_NO_KO441 = iCurColumnPos(41)
			'2008-06-17 1:38오전 :: hanc
			C_pgm_name_KO441   = iCurColumnPos(42)
			C_pgm_price_KO441  = iCurColumnPos(43)
...
Sub SetPostYesSpreadColor(ByVal lRow)
	With frm1
		...
		ggoSpread.SSSetProtected C_LOT_NO_KO441	, lRow, .vspdData.MaxRows
		ggoSpread.SSSetProtected C_CUST_LOT_NO_KO441	, lRow, .vspdData.MaxRows
		ggoSpread.SSSetProtected C_pgm_name_KO441	, lRow, .vspdData.MaxRows
		ggoSpread.SSSetProtected C_pgm_price_KO441	, lRow, .vspdData.MaxRows
...
Sub SetQuerySpreadColor(ByVal lRow)
	...
	With frm1
		...
		for iCnt=lRow To .vspdData.MaxRows
			if Trim(GetSpreadText(frm1.vspdData,C_OUT_NO_KO441,iCnt,"X","X")) <> "" Then
				ggoSpread.SSSetProtected  C_BillQty, iCnt, iCnt
				'ggoSpread.SSSetProtected  C_BillPrice, iCnt, iCnt
				'ggoSpread.SSSetProtected  C_BillAmt, iCnt, iCnt		
  ...
  For lRow = 1 To .vspdData.MaxRows
   ...
   Select Case .vspdData.Text
    ...
    '---     Public Const S515_IG1_I2_CREATE_TYPE_KO441 = 45
			  ...
			  strVal = strVal & Trim(.vspdData.Text) & Parent.gColSep
    '---     Public Const S515_IG1_I2_LOT_NO = 46
              .vspdData.Col = C_LOT_NO_KO441
			  strVal = strVal & Trim(.vspdData.Text) & Parent.gColSep
    '---     Public Const S515_IG1_I2_CUST_LOT_NO = 47
              .vspdData.Col = C_CUST_LOT_NO_KO441
			  strVal = strVal & Trim(.vspdData.Text) & Parent.gColSep
    '---     Public Const S515_IG1_I2_CUST_LOT_NO = 48
              .vspdData.Col = C_pgm_name_KO441
			  strVal = strVal & Trim(.vspdData.Text) & Parent.gColSep
    '---     Public Const S515_IG1_I2_CUST_LOT_NO = 49
              .vspdData.Col = C_pgm_price_KO441
...
Function OpenDNDtlRef2()
	...
	iCalledAspName = AskPRAspName("s3112ba3_KO441")
	...
	With frm1
		...
		For intCnt = 1 to intLoopCnt 
			...
			If blnEqualFlg = false then
                ...
                if arrRet(intCnt - 1, 28) <> 0 then
    				.vspdData.Col = C_BillPrice          
    				.vspdData.text = arrRet(intCnt - 1, 28)

    				.vspdData.Col = C_BillAmt          
    				.vspdData.text = cdbl(arrRet(intCnt - 1, 28)) * cdbl(arrRet(intCnt - 1, 4))
                end if
				...
				strVal = strVal & arrRet(intCnt - 1, 26) & Parent.gColSep			'Customer Lot No.
				strVal = strVal & arrRet(intCnt - 1, 9) & Parent.gColSep			'출하번호
				strVal = strVal & arrRet(intCnt - 1, 10) & Parent.gColSep			'출하순번
				strVal = strVal & frm1.txtConBillNo.value & Parent.gRowSep			'매출번호
     ...
     <TD CLASS="CLSMTABP">
      <TABLE ID="MyTab" CELLSPACING=0 CELLPADDING=0>
       <TR>
        ...
        <td background="../../../CShared/image/table/seltab_up_bg.gif" align="center" CLASS="CLSMTAB"><font color=white>매출채권내역등록</font></td>
        <td background="../../../CShared/image/table/seltab_up_bg.gif" align="right"><img src="../../../CShared/image/table/seltab_up_right.gif" width="10" height="23"></td>
          </TR>
      </TABLE>
     </TD>
     <TD WIDTH=* align=right><A href="vbscript:OpenSODtlRef">수주내역참조</A>&nbsp;|&nbsp;<A href="vbscript:OpenLCDtlRef">L/C내역참조</A>&nbsp;|&nbsp;<A href="vbscript:OpenDNDtlRef">출하내역참조</A>&nbsp;|&nbsp;<A href="vbscript:OpenDNDtlRef2">정상출하 및 MES출하참조</A></TD>
     <TD WIDTH=10>&nbsp;</TD>
    </TR>
   </TABLE>
  </TD>
