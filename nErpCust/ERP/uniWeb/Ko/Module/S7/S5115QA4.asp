...
Sub SetDefaultVal()
	With frm1
		...
		.txtConFromDt2.Text	= cstr(FromDateOfDB)
		.txtConToDt2.Text	= cstr(ToDateOfDB)
...
'========================================
Sub InitSpreadSheet()
    Call SetZAdoSpreadSheet("S5115QA4","S","A", "V20030618", parent.C_SORT_DBAGENT,frm1.vspdData,C_MaxKey, "X", "X")
    Call SetSpreadLock()       
End Sub
...
Function FncQuery() 
	...
	If ValidDateCheck(frm1.txtConFromDt2, frm1.txtConToDt2) = False Then Exit Function
	...
	frm1.txt_TOTAL_Balance_AMT.text = 0		    	
...
Function DbQuery() 
    ...
    With frm1
        If lgIntFlgMode  <> parent.OPMD_UMODE Then		
			...
			.txtHConFromDt2.value	= .txtConFromDt2.text			
			.txtHConToDt2.value		= .txtConToDt2.text	
...
Function OpenConPopup(ByVal pvIntWhere)
	...
	'출하유형 
	Case C_PopDnType
		iArrParam(1) = "(select distinct mov_type from s_so_type_config) A, b_minor B, B_CONFIGURATION C "	
		iArrParam(2) = Trim(frm1.txtConDnType.value)					
		iArrParam(3) = ""											
		iArrParam(4) = "A.mov_type = B.minor_cd and B.major_cd = " & FilterVar("I0001", "''", "S") & " AND C.minor_cd = B.minor_cd AND C.REFERENCE = " & FilterVar("Y", "''", "S") & "  AND	C.SEQ_NO = 1 "	
...
'========================================
Sub txtConFromDt2_DblClick(Button)
	If Button = 1 Then
       Frm1.txtConFromDt2.Action = 7
       Call SetFocusToDocument("M")	
       Frm1.txtConFromDt2.Focus
	End If
End Sub

'========================================
Sub txtConToDt2_DblClick(Button)
	If Button = 1 Then
       Frm1.txtConToDt2.Action = 7
       Call SetFocusToDocument("M")	
       Frm1.txtConToDt2.Focus
	End If
End Sub
...
'========================================
Sub txtConFromDt2_KeyPress(KeyAscii)
	If KeyAscii = 13 Then 
	   Call MainQuery()
	End If   
End Sub
...
'========================================
Sub txtConToDt2_KeyPress(KeyAscii)
	If KeyAscii = 13 Then 
	   Call MainQuery()
	End If   
End Sub
					...
					<TD CLASS="CLSMTABP">
						<TABLE ID="MyTab" CELLSPACING=0 CELLPADDING=0>
							<TR>
								...
								<td background="../../../CShared/image/table/seltab_up_bg.gif" align="center" CLASS="CLSMTAB"><font color=white>매출가계정잔액현황</font></td>
							...
							<TABLE <%=LR_SPACE_TYPE_40%>>
								<TR>
									...
									<TABLE CELLSPACING=0 CELLPADDING=0>
										<TR>
											<TD>
											<script language =javascript src='./js/s5115qa4_OBJECT1_txtConFromDt.js'></script>
											</TD>
											<TD>
											&nbsp;~&nbsp;
											</TD>
											<TD>
											<script language =javascript src='./js/s5115qa4_OBJECT2_txtConToDt.js'></script>
											</TD>
										</TR>
									</TABLE>							        
							        </TD>							        
									...
									<TABLE CELLSPACING=0 CELLPADDING=0>
										<TR>
											<TD>
											<script language =javascript src='./js/s5115qa4_OBJECT3_txtConFromDt2.js'></script>
											</TD>
											<TD>
											&nbsp;~&nbsp;
											</TD>
											<TD>
											<script language =javascript src='./js/s5115qa4_OBJECT4_txtConToDt2.js'></script>
											</TD>
										</TR>
									</TABLE>							        
							        </TD>							        
						...
						<FIELDSET CLASS="CLSFLD">
							<TABLE <%=LR_SPACE_TYPE_20%>>
								<TR>
									...
									<TD CLASS=TD6 NOWRAP>
										<script language =javascript src='./js/s5115qa4_fpDoubleSingle2_txt_TOTAL_Gi_AMT.js'></script>
									</TD>
									<TD CLASS="TD5" NOWRAP>매출채권합계</TD>
									<TD CLASS=TD6 NOWRAP>
										<script language =javascript src='./js/s5115qa4_fpDoubleSingle2_txt_TOTAL_Bill_AMT.js'></script>
									</TD>
								</TR>
								<TR>
									<TD CLASS="TD5" NOWRAP>매출가계정잔액합계</TD>
									<TD CLASS=TD6 NOWRAP>
										<script language =javascript src='./js/s5115qa4_fpDoubleSingle2_txt_TOTAL_Balance_AMT.js'></script>
									</TD>
									<TD CLASS="TD5" NOWRAP></TD>
									<TD CLASS=TD6 NOWRAP></TD>
								</TR>
				...
				<TR>
					<TD WIDTH=100% HEIGHT=* valign=top>
						<TABLE <%=LR_SPACE_TYPE_20%>>
							<TR>
								<TD HEIGHT="100%">
									<script language =javascript src='./js/s5115qa4_vspdData_vspdData.js'></script>
								</TD>
							</TR>
						</TABLE>
					</TD>
...
<INPUT TYPE=HIDDEN NAME="txtHConFromDt2"	tag="24" TABINDEX="-1">
<INPUT TYPE=HIDDEN NAME="txtHConToDt2"		tag="24" TABINDEX="-1">
