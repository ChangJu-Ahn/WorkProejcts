...
Const BIZ_BillDtl_JUMP_ID = "s5112ma1_KO441"
...
Function OpenSORef()
	...
	iCalledAspName = AskPRAspName("s3111ba1_KO441")
	
	If Trim(iCalledAspName) = "" Then
		IntRetCD = DisplayMsgBox("900040", parent.VB_INFORMATION, "s3111ba1_KO441", "X")
		Exit Function
	End If
...
Function OpenLCRef()
	...
	iCalledAspName = AskPRAspName("s3111ba2_KO441")
	
	If Trim(iCalledAspName) = "" Then
		IntRetCD = DisplayMsgBox("900040", parent.VB_INFORMATION, "s3111ba2_KO441", "X")
		lblnWinEvent = False
		Exit Function
	End If
...
Function OpenDNRef()
	...
	iCalledAspName = AskPRAspName("s3111ba3_KO441")
	
	If Trim(iCalledAspName) = "" Then
		IntRetCD = DisplayMsgBox("900040", parent.VB_INFORMATION, "s3111ba3_KO441", "X")
		lblnWinEvent = False
		Exit Function
	End If
...
Sub LockFieldInit()
    ...
    Call LockObjectField(frm1.txtPlanIncomeDt,"R")
...
'	End If
	...
	If frm1.txtPlanIncomeDt.Text = "" then
		Call DisplayMsgBox("17A002","X" , "수금만기일","X")
		Exit Function
	End If 
