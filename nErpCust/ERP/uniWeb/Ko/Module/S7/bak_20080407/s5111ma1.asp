...
<SCRIPT LANGUAGE="VBScript"   SRC="S5111ma1.vbs"></SCRIPT>
    ...
    <TR>
     ...
     <TD CLASS="CLSSTABP">
      <TABLE ID="MyTab" CELLSPACING=0 CELLPADDING=0 onclick="ClickTab1()">
       <TR>
        ...
        <td background="../../../CShared/image/table/seltab_up_bg.gif" align="center" CLASS="CLSSTAB"><font color=white>매출채권일반</font></td>
     ...
     <TD CLASS="CLSSTABP">
      <TABLE ID="MyTab" CELLSPACING=0 CELLPADDING=0 onclick="ClickTab2()">
       <TR>
        ...
        <td background="../../../CShared/image/table/tab_up_bg.gif" align="center" CLASS="CLSSTAB"><font color=white>채권금액정보</font></td>
     ...
     <TD CLASS="CLSSTABP">
      <TABLE ID="MyTab" CELLSPACING=0 CELLPADDING=0 onclick="ClickTab3()">
       <TR>
        <td background="../../../CShared/image/table/tab_up_bg.gif"><img src="../../../CShared/image/table/tab_up_left.gif" width="9" height="23"></td>
        <td background="../../../CShared/image/table/tab_up_bg.gif" align="center" CLASS="CLSSTAB"><font color=white>무역정보</font></td>
        <td background="../../../CShared/image/table/tab_up_bg.gif" align="right"><img src="../../../CShared/image/table/tab_up_right.gif" width="10" height="23"></td>
          </TR>
      </TABLE>
     </TD>
     ...
     <TD WIDTH=100% VALIGN=TOP>
      ...
      <TABLE <%=LR_SPACE_TYPE_60%>>
       <TR>
        ...
        <TD CLASS=TD6 NOWRAP>
         <TABLE CELLSPACING=0 CELLPADDING=0>
          <TR>
           <TD>
            <script language =javascript src='./js/s5111ma1_fpDateTime1_txtBillDt.js'></script>
           </TD>
          </TR>
         </TABLE>
        </TD>
       ...
       <TR>
        ...
        <TD CLASS=TD6 NOWRAP>
         <script language =javascript src='./js/s5111ma1_fpDoubleSingle3_txtXchgRate.js'></script>
        </TD>
       ...
       <TR>
        ...
        <TD CLASS=TD6 NOWRAP>
         <TABLE CELLSPACING=0 CELLPADDING=0>
          <TR>
           <TD>
            <script language =javascript src='./js/s5111ma1_fpDoubleSingle3_txtVatRate.js'></script>&nbsp;<LABEL><b>%</b></LABEL>
           </TD>
       ...
       <TR>
        ...
        <TD CLASS=TD6 NOWRAP>
         <script language =javascript src='./js/s5111ma1_fpDoubleSingle8_txtPayDur.js'></script>&nbsp;<LABEL>일</LABEL>
        </TD>
       </TR>       
       <TR>
        ...
        <TD CLASS=TD6 NOWRAP>
         <TABLE CELLSPACING=0 CELLPADDING=0>
          <TR>
           <TD>
            <script language =javascript src='./js/s5111ma1_fpDateTime2_txtPlanIncomeDt.js'></script>
           </TD>
          </TR>
         </TABLE>
        </TD>
      ...
      <TABLE <%=LR_SPACE_TYPE_60%>>
       <TR>
        ...
        <TD CLASS=TD6 NOWRAP>
          ...
          <TR>
           <TD>
            <script language =javascript src='./js/s5111ma1_fpDoubleSingle1_txtBillAmt.js'></script></TD>
           </TD>
           <TD>
        ...
        <TD CLASS=TD6 NOWRAP>
         <TABLE CELLSPACING=0 CELLPADDING=0>
          <TR>
           <TD>
            <script language =javascript src='./js/s5111ma1_fpDoubleSingle5_txtBillAmtLoc.js'></script>
           </TD>
           <TD>
       ...
       <TR>
        ...
        <TD CLASS=TD6 NOWRAP>
         <script language =javascript src='./js/s5111ma1_fpDoubleSingle2_txtVatAmt.js'></script>       
        </TD>
        <TD CLASS=TD5 NOWRAP>VAT자국금액</TD>
        <TD CLASS=TD6 NOWRAP>
         <script language =javascript src='./js/s5111ma1_fpDoubleSingle6_txtVatLocAmt.js'></script>       
        </TD>
       </TR>        
       <TR>
        <TD CLASS=TD5 NOWRAP>적립금액</TD>
        <TD CLASS=TD6 NOWRAP>
         <script language =javascript src='./js/s5111ma1_fpDoubleSingle4_txtDepositAmt.js'></script>       
        </TD>
        <TD CLASS=TD5 NOWRAP>적립금자국액</TD>
        <TD CLASS=TD6 NOWRAP>
         <script language =javascript src='./js/s5111ma1_fpDoubleSingle7_txtDepositAmtLoc.js'></script>       
        </TD>        
       </TR>
       <TR>
        <TD CLASS=TD5 NOWRAP>총매출채권금액</TD>
        <TD CLASS=TD6 NOWRAP>
         <script language =javascript src='./js/s5111ma1_fpDoubleSingle4_txtTotBillAmt.js'></script>       
        </TD>
        <TD CLASS=TD5 NOWRAP>총매출채권자국금액</TD>
        <TD CLASS=TD6 NOWRAP>
         <script language =javascript src='./js/s5111ma1_fpDoubleSingle7_txtTotBillAmtLoc.js'></script>       
        </TD>        
       </TR>   
       <TR>
        <TD CLASS=TD5 NOWRAP>총수금액</TD>
        <TD CLASS=TD6 NOWRAP>
         <script language =javascript src='./js/s5111ma1_fpDoubleSingle4_txtIncomeAmt.js'></script>       
        </TD>
        <TD CLASS=TD5 NOWRAP>총수금자국액</TD>
        <TD CLASS=TD6 NOWRAP>
         <script language =javascript src='./js/s5111ma1_fpDoubleSingle7_txtIncomeLocAmt.js'></script>       
        </TD>        
       </TR>   
      ...
      <TABLE <%=LR_SPACE_TYPE_60%>>
       ...
       <TR>
        ...
        <TD CLASS=TD6 NOWRAP>
         <script language =javascript src='./js/s5111ma1_fpDoubleSingle7_txtAcceptFobAmt.js'></script>       
        </TD>
       </TR>
