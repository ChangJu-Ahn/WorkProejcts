...
Sub SubBizQueryMulti()
    ...
    '---------- Developer Coding part (Start) ---------------------------------------------------------------
'20071221::hanc
lgStrSQL = "select TOP " & iSelCount & "  'A' AS PART,                                                                                                     "
...
lgStrSQL = lgStrSQL & "         FROM   S_DN_HDR,                                                                                              "
lgStrSQL = lgStrSQL & "                S_DN_DTL,                                                                                              "
lgStrSQL = lgStrSQL & "                B_BIZ_PARTNER,                                                                                         "
lgStrSQL = lgStrSQL & "                B_ITEM                                                                                                 "
...
'lgStrSQL = lgStrSQL & "        AND TOT.ITEM_CD <> ''                                                                                          "
