...
' External ASP File
'========================================
Const BIZ_PGM_ID 		= "s3112bb3.asp"                              '☆: Biz Logic ASP Name
...
Sub InitSpreadSheet()
	...
	Call SetZAdoSpreadSheet("S3112BA3","S","A","V20030318",PopupParent.C_SORT_DBAGENT,frm1.vspdData, _
							C_MaxKey, "X","X")		
	Call SetSpreadLock 	 
					...
					<TR>
						...
						<TD CLASS=TD6>
							<TABLE CELLSPACING=0 CELLPADDING=0>
								<TR>
									<TD>
										<script language =javascript src='./js/s3112ba3_fpDateTime1_txtFromDt.js'></script>
									</TD>
									<TD>
										&nbsp;~&nbsp;
									</TD>
									<TD>
										<script language =javascript src='./js/s3112ba3_fpDateTime2_txtToDt.js'></script>
									</TD>
								</TR>
							</TABLE>
						</TD>
	...
	<TR>
		<TD WIDTH=100% HEIGHT=* valign=top>
			<TABLE <%=LR_SPACE_TYPE_20%>>
				<TR>
					<TD HEIGHT="100%">
						<script language =javascript src='./js/s3112ba3_vaSpread_vspdData.js'></script>
					</TD>
				</TR>
			</TABLE>
		</TD>
