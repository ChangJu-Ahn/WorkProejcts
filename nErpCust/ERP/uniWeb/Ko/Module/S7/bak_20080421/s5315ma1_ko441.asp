...
'**********************************************************************************************************!-->
Const BIZ_PGM_ID = "s5315mb1_ko441.asp"
...
Sub InitComboBox()
	With frm1
		Call SetCombo(frm1.cboApType, "1","대분류")
		Call SetCombo(frm1.cboApType, "2","중분류") 
		Call SetCombo(frm1.cboApType, "3","소분류")      
	     .cboApType.value = "1"
    End With
End Sub
				...
				<tr>
					...
					<table id="MyTab" cellspacing="0" cellpadding="0">
						<tr>
							...
							<td background="../../../CShared/image/table/seltab_up_bg.gif" align="center" class="CLSMTAB"><font color="#FFFFFF">일일매출실적조회</font></td>
				...
				<tr>
					...
					<table <%=lr_space_type_40%>>
						<TR>
								...
								<TD CLASS="TD6" NOWRAP>
								<input type="TEXT" alt="공장" name="txtPlantCd1" size="10" maxlength="4" tag="12NXXU"><img src="../../../CShared/image/btnPopup.gif" name="btnORGCd1" align="top" type="BUTTON" onclick="vbscript:OpenPlant('Plant1')" onmouseover="vbscript:PopUpMouseOver()" onmouseout="vbscript:PopUpMouseOut()">
								<input type="TEXT" alt="공장" name="txtPlantNm1" size="40" maxlength="40" tag="14X"></TD>
							...
							<TR>
								...
								<TD CLASS="TD6" NOWRAP>
									<script language="javascript" src="./js/s5315ma1_ko441_fpDateTime1_txtDocumentDt.js"></script>	
									</TD>		
				...
				<tr>
					...
					<table <%=lr_space_type_60%>>
						<tr>
							...
							<script language="javascript" src="./js/s5315ma1_ko441_vspdData.js"></script>
							</td>
						</tr>
					</table>
					</td>
