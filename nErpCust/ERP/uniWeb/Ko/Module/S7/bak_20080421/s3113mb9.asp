...
'--------------- 개발자 coding part(실행로직,Start)----------------------------------------------------
    If Len(Trim(Request("txtFromDt"))) Then
		UNIValue(0,1) = " " & FilterVar(UNIConvDate(Request("txtFromDt")), "''", "S") & ""                           '시작일 
	Else
		UNIValue(0,1) = "Null"
	End If

    If Len(Trim(Request("txtFromDt"))) Then
		UNIValue(0,2) = " " & FilterVar(UNIConvDate(Request("txtToDt")), "''", "S") & ""									'종료일 
	Else
		UNIValue(0,2) = "Null"
	End If
	...
	If Len(Trim(Request("txtSoNo"))) Then
		UNIValue(0,4) = " " & FilterVar(Request("txtSoNo"), "''", "S") & ""				'S/O번호 
    Else
		UNIValue(0,4) = "NULL"
   	End If
	...
	If Len(Trim(Request("txtPlantCd"))) Then
		UNIValue(0,6) = " " & FilterVar(Request("txtPlantCd"), "''", "S") & ""			'공장 
    Else
		UNIValue(0,6) = "NULL"
   	End If
	
	If Len(Trim(Request("txtItemCd"))) Then
		UNIValue(0,7) = " " & FilterVar(Request("txtItemCd"), "''", "S") & ""				'품목 
    Else
		UNIValue(0,7) = "NULL"
   	End If
