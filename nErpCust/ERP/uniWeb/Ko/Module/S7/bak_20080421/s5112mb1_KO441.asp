...
Case "VirtualOut"    
  ...
  End If
	...
	For LngRow = 0 To Ubound(EG1_export_group,1)
			istrData = istrData & Chr(11) &  ConvSPChars(EG1_export_group(LngRow,C_ITEM_CD))'1
			...
			istrData = istrData & Chr(11) &  ConvSPChars(EG1_export_group(LngRow,C_DN_NO))'40
			istrData = istrData & Chr(11) &  ConvSPChars(EG1_export_group(LngRow,C_DN_SEQ))'41
			istrData = istrData & Chr(11) &  LngMaxRow + LngRow 			
	Next
