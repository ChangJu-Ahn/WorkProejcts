...
Function BtnPrint(ByVal pvStrPrint) 
	...
	If frm1.rdoTaxFlagY.checked = true then	'--- 과세세금계산서 
		If frm1.cboApType.Value = "양식출력" then
			ObjName = AskEBDocumentName("s5111oa5","ebr")
		Else
			ObjName = AskEBDocumentName("s5111oa6","ebr")
		End If
	Else
		If frm1.cboApType.Value = "양식출력" then
			ObjName = AskEBDocumentName("s5111oa8","ebr")
		Else
			ObjName = AskEBDocumentName("s5111oa9","ebr")
		End If	
	End if
