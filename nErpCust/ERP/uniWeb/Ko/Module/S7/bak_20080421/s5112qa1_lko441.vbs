...
' External ASP File
'========================================
Const BIZ_PGM_ID        = "s5112qb1_lko441.asp"
...
Sub InitSpreadSheet()
	...
	Call SetZAdoSpreadSheet("S5112QA1_lko441","S","A","V20030714", Parent.C_SORT_DBAGENT, frm1.vspdData, C_MaxKey, "X", "X" )
...
Function DbQuery() 
    ...
    With frm1
		...
		If lgIntFlgMode = Parent.OPMD_UMODE Then
			...
			strVal = strVal & "&txtProjectCd=" & Trim(.txtHProjectCd.value)
		Else
			' 처음 조회시 
			...
			strVal = strVal & "&txtProjectCd=" & Trim(.txtProjectCd.value)
		End If
