...
'========================================================================================================
Sub InitSpreadSheet()
    Call SetZAdoSpreadSheet("S5115QA1","S","A", "V20030523", parent.C_SORT_DBAGENT,frm1.vspdData,C_MaxKey, "X", "X")
    Call SetSpreadLock()       
End Sub
...
Function OpenBillDtl()
	...
	If frm1.vspdData.Text = "0" Then
		...
		frm1.vspdData.Col = GetKeyPos("A",4)			' 매출채권일자 
		arrParam(0) = frm1.vspdData.Text
		
		frm1.vspdData.Col = GetKeyPos("A",4)			' 매출채권일자 
		arrParam(1) = frm1.vspdData.Text		
		
		frm1.vspdData.Col = GetKeyPos("A",2)			' 매출채권형태 
		arrParam(4) = frm1.vspdData.Text
		
		frm1.vspdData.Col = GetKeyPos("A",3)			' 매출채권형태명 
					...
					<TD CLASS="CLSMTABP">
						<TABLE ID="MyTab" CELLSPACING=0 CELLPADDING=0>
							<TR>
								...
								<td background="../../../CShared/image/table/seltab_up_bg.gif" align="center" CLASS="CLSMTAB"><font color=white>매출채권조회(매출채권형태)</font></td>
