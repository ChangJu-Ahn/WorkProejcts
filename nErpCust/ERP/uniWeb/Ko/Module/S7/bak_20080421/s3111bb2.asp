...
'*  3. Program ID           : S3111BB3
'*  4. Program Name         : 출하참조(매출채권등록)
'*  5. Program Desc         : 
'*  6. Comproxy List        : 
...
<Script Language=vbscript>
    With parent.frm1
		...
		If "<%=lgDataExist%>" = "Yes" Then
			...
			Call parent.ReFormatSpreadCellByCellByCurrency(.vspdData,"<%=iFrPoint+1%>",.vspdData.MaxRows,parent.GetKeyPos("A",9),parent.GetKeyPos("A",10),"A","I","X","X")
