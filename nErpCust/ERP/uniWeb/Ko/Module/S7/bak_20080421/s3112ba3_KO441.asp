...
Sub InitSpreadSheet()
	...
	Call SetZAdoSpreadSheet("S3112BA3_KO441","S","A","V20080418",PopupParent.C_SORT_DBAGENT,frm1.vspdData, C_MaxKey, "X","X")		
	Call SetZAdoSpreadSheet("S3112BA4_KO441","S","B","V20080418",PopupParent.C_SORT_DBAGENT,frm1.vspdData2, 0, "X","X")		
...
Function DbQuery2(Row) 
	...
	strVal = strVal & "&txtLOTNO=" & GetSpreadText(frm1.vspdData,GetKeyPos("A", 26),Row,"X","X")		
