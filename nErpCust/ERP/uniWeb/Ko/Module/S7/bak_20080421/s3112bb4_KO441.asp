...
'--------------- 개발자 coding part(실행로직,Start)----------------------------------------------------
    ...
    UNISqlId(0) = "S3112BA4_KO441"
'--------------- 개발자 coding part(실행로직,End)------------------------------------------------------

    UNIValue(0,0) = Trim(lgSelectList)                                      '☜: Select list
    
'--------------- 개발자 coding part(실행로직,Start)----------------------------------------------------
    UNIValue(0,1) = " " & FilterVar(Request("txtBPCD"), "''", "S") & ""                    '주문처 
    UNIValue(0,2) = " " & FilterVar(Request("txtITEMCD"), "''", "S") & ""                       '화폐단위 
    UNIValue(0,3) = " " & FilterVar(Request("txtLOTNO"), "''", "S") & ""                     '영업그룹 
