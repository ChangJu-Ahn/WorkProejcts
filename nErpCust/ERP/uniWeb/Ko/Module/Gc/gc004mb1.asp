...
Sub bulk_disposal()
  ...
  '  strWhere_in = "and from_alloc <> " & FilterVar("*", "''", "S") & "  and acct_gp = " & FilterVar("*", "''", "S") & " "
    ...
    Call CommonQueryRs("count(*)","g_alloc_data","yyyymm = " & FilterVar(YYYYMM, "''", "S") & " and alloc_kinds = " & FilterVar("2", "''", "S") & "  and alloc_base = " & FilterVar(Currency_code, "''", "S") & " " ,lgF0,lgF1,lgF2,lgF3,lgF4,lgF5,lgF6)
...
Sub SubBizQueryMulti()
    ...
    If Trim(lgKeyStream(1)) <> "" Then
        ...
        Call CommonQueryRs(" b.minor_nm "," b_configuration a, b_minor b ","  a.minor_cd = b.minor_cd and b.major_cd = " & FilterVar("G1004", "''", "S") & " AND  a.seq_no =3  and reference = " & FilterVar("Y", "''", "S") & "  and a.minor_cd = " & FilterVar(lgKeyStream(1), "''", "S"),lgF0,lgF1,lgF2,lgF3,lgF4,lgF5,lgF6)       
...
Sub SubBizSaveMultiCreate(arrColVal)
    ...
    lgStrSQL = lgStrSQL & " TO_SALES_GRP  ,"
    lgStrSQL = lgStrSQL & " TO_ITEM_GROUP ,"
...
Sub SubBizSaveMultiUpdate(arrColVal)
    ...
    lgStrSQL = lgStrSQL & " TO_DATA    = " & Replace(UNIConvNum(arrColVal(4),0),",","")  & ","	
        ...
        Case "M"
           ...
           Select Case Mid(pDataType,2,1)
               ...
               Case "R"
                       ...
                       lgStrSQL = lgStrSQL & " and  g.alloc_kinds = " & FilterVar(2, "''", "S")                       
			 ...
			 Case "I"
					   ...
					   lgStrSQL = lgStrSQL & " and	a.alloc_kinds = '2'	 "   
					   lgStrSQL = lgStrSQL & " and alloc_base = " & FilterVar(Currency_code, "''", "S")            
