    ...
    Else
        ...
        Do While Not lgObjRs.EOF
            ...
            Select Case CStr(lgObjRs("MINOR_CD"))
                Case "06"
                    lgstrData = lgstrData & Chr(11) & "G_USP_GC030BA1"
                Case "07"
                    lgstrData = lgstrData & Chr(11) & "G_USP_GC030BA2"
                Case "08"
                    lgstrData = lgstrData & Chr(11) & "G_USP_GC030BA3"
            End Select
...
Sub SubBizBatchMulti(arrColVal)
    ...
    Dim strMsg_cd
    Dim strYYYYMM
    strYYYYMM = Replace(lgKeyStream(0),gServerDateType,"")
    With lgObjComm
        ...
        Case "M"
           ...
           Select Case Mid(pDataType,2,1)
               ...
               Case "R"
                       ...
                       lgStrSQL = lgStrSQL & " AND B.SEQ_NO = " & FilterVar("3", "''", "S") & " "
