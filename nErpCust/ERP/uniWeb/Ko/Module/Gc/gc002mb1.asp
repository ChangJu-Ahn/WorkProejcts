...
Sub bulk_disposal()
   ...
   ' 조건의 달에 해당하는 데이터가 존재시에 전달과 중복되는 데이터들을 삭제한다.
    ...
    If Currency_code = "3" Then
        ...
        Call CommonQueryRs("count(*)","g_alloc_Base","yyyymm = " & FilterVar(lgKeyStream(0), "''", "S") & " and alloc_kinds = " & FilterVar("2", "''", "S") & " and from_alloc <>" & FilterVar("*", "''", "S") & "  and acct_gp <>" & FilterVar("*", "''", "S") & " ",lgF0,lgF1,lgF2,lgF3,lgF4,lgF5,lgF6)
