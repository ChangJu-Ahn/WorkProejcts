...
*  1. Module Name          : 경영손익 
*  2. Function Name        : 
*  3. Program ID           : GC005MA1
*  4. Program Name         : PROFIT 센터별 배부현황 
*  5. Program Desc         : 
*  6. Comproxy List        :
...
Const BIZ_PGM_ID      = "GC005MB1.asp"						           '☆: Biz Logic ASP Name
...
'Const C_SHEETMAXROWS_D1 = 100                                          '☜: Fetch count at a time
...
Sub InitSpreadSheet()
	...
	With Frm1.vspdData
       ...
       ggoSpread.SSSetEdit  C_center     , "Cost Center"        ,15,   ,, 50,2
       ggoSpread.SSSetEdit  C_centerNm   , "Cost Center 명"     ,20,   ,, 30    
...
Sub InitSpreadSheet1()    
	...
	With Frm1.vspdData1
       ...
       ggoSpread.SSSetEdit  C_center1     , "Profit Center"      ,15,   ,, 50,2
       ggoSpread.SSSetEdit  C_centerNm1   , "Profit Center 명"     ,20,   ,, 30    
						...
						<FIELDSET CLASS="CLSFLD">
							<TABLE <%=LR_SPACE_TYPE_40%>>
								<TR>
									...
									<TD CLASS="TD6" NOWRAP>
										<script language =javascript src='./js/gc005ma1_fpDateTime3_fpdtWk_yymm.js'></script>										
									</TD>									
							...
							<TR>
								<TD WIDTH="50%">
									<TABLE  <%=LR_SPACE_TYPE_20%> CLASS="BasicTB" CELLSPACING=0>
										<TR>
										<TD  COLSPAN=3>
											<script language =javascript src='./js/gc005ma1_vaSpread1_vspdData.js'></script>
										</TD>
										</TR>
										<TR HEIGHT=20>
								            ...
								            <TD CLASS=TD6 NOWRAP>
									            <script language =javascript src='./js/gc005ma1_txtDataAmt_txtDataAmt.js'></script>
											</TD>
										</TR>
									</TABLE>
								</TD>
								<TD WIDTH="50%">
									<TABLE  <%=LR_SPACE_TYPE_20%> CLASS="BasicTB" CELLSPACING=0>
										<TR>
											<TD COLSPAN=3>
												<script language =javascript src='./js/gc005ma1_vaSpread2_vspdData1.js'></script>
											</TD>
										</TR>
										<TR HEIGHT=20>
										    <TD CLASS=TD6 NOWRAP>&nbsp;</TD>										    
											<TD CLASS=TD5 NOWRAP>합계</TD>								            
											<TD CLASS="TD6" >
												<script language =javascript src='./js/gc005ma1_txtDataAmt1_txtDataAmt1.js'></script></TD>			    	    		            			    	    		            
										</TR>										
									</TABLE>
								</TD>
							</TR>
