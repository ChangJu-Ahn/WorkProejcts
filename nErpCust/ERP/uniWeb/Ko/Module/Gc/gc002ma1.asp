...
*  1. Module Name          : GC
*  2. Function Name        :
*  3. Program ID           : GC002MA1
*  4. Program Name         : 경영손익 사업부 공통비 배부기준 등록 
...
Const BIZ_PGM_ID      = "GC002MB1.asp"						           '☆: Biz Logic ASP Name
	...
	Select Case iWhere
	    ...
	    Case 2
	     ...
	     Case 3
	    	...
	    	arrParam(4) = "BM.major_cd = " & FilterVar("G1004", "''", "S") & " AND   BM.MINOR_CD = BC.MINOR_CD AND   BC.SEQ_NO = 3 AND  REFERENCE  = " & FilterVar("Y", "''", "S") & " "' Where Condition
       ...
       Call AppendNumberPlace("6","3","0")
        ...
        select case CStr(frm1.txtCurrencyCode.value)
            case "1"
				...
				ggoSpread.SSSetFloat    C_alloc_rate      ,     "배부기준율"     ,15,6,ggStrIntegeralPart, ggStrDeciPointPart,Parent.gComNum1000,Parent.gComNumDec,,,"Z"
			...
			case "2"
				...
				ggoSpread.SSSetButton   C_curr_PB
				ggoSpread.SSSetFloat    C_alloc_rate      ,     "배부기준율"     ,25,6,ggStrIntegeralPart, ggStrDeciPointPart,Parent.gComNum1000,Parent.gComNumDec,,,"Z"
			...
			case "3"  
				...
				ggoSpread.SSSetButton   C_curr_PB
				ggoSpread.SSSetFloat    C_alloc_rate      ,     "배부기준율"     ,12,6,ggStrIntegeralPart, ggStrDeciPointPart,Parent.gComNum1000,Parent.gComNumDec,,,"Z"
...
Sub SetSpreadLock(ByVal lRow  , ByVal lRow2 )
    ...
    .vspdData.ReDraw = False
      ...
      ggoSpread.SpreadLock  c_code_pb,	lRow,  c_code_pb,	lRow2
...
Function FncSave()
   ...
   '----->데이터 저장하기 전에 배부기준율의 합이 100인여부를 check한다.<-------------------------------------
   '-------------------------->Start<---------------------------------------------------------------------
    ggoSpread.Source = frm1.vspdData
       ...
       For lRow = 1 To .vspdData.MaxRows
           ...
           Select Case .vspdData.Text
               ...
               Case ggoSpread.InsertFlag                                      '☜: Update
                     ...
                     .vspdData.Col = C_alloc_rate  : strVal = strVal & Trim(.vspdData.value) & iRowSep
                    lGrpCnt = lGrpCnt + 1
...
Function ExeReflect()
    ...
    If currency_code = "3" Then
        Call CommonQueryRs("count(*)","g_alloc_Base","yyyymm = " & FilterVar(strYYYYMM, "''", "S") & " and alloc_kinds = " & FilterVar("2", "''", "S") & " and from_alloc <>" & FilterVar("*", "''", "S") & "  and acct_gp <>" & FilterVar("*", "''", "S") & " " ,lgF0,lgF1,lgF2,lgF3,lgF4,lgF5,lgF6)
    ...
    Else
        Call CommonQueryRs("count(*)","g_alloc_Base","yyyymm = " & FilterVar(strYYYYMM, "''", "S") & " and alloc_kinds = " & FilterVar("2", "''", "S") & " and acct_gp <>" & FilterVar("*", "''", "S") & "  and from_alloc = " & FilterVar("*", "''", "S") & " " ,lgF0,lgF1,lgF2,lgF3,lgF4,lgF5,lgF6)
            if Trim(Replace(lgF0,Chr(11),"")) <> 0 then
	            IntRetCD = DisplayMsgBox("GA0009",Parent.VB_YES_NO,"X","X")
            end if
    End If
						...
						<FIELDSET CLASS="CLSFLD">
							<TABLE <%=LR_SPACE_TYPE_40%>>
								<TR>
									...
									<TD CLASS=TD6 NOWRAP WIDTH=86%><script language =javascript src='./js/gc002ma1_fpDateTime3_fpdtWk_yymm.js'></script></TD>
				...
				<TR>
					<TD WIDTH=100% HEIGHT=* valign=top>
						<TABLE <%=LR_SPACE_TYPE_30%>>
							<TR>
								<TD HEIGHT="100%">
									<script language =javascript src='./js/gc002ma1_vaSpread_vspdData.js'></script>
								</TD>
							</TR>
						</TABLE>
					</TD>
