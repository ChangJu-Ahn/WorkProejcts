...
'*  3. Program ID           : h5305oa1
'*  4. Program Name         : 퇴직시보수총액통보서 
'*  5. Program Desc         : 퇴직시보수총액통보서 
'*  6. Comproxy List        : +
					...
					<TD CLASS="CLSMTABP">
						<TABLE ID="MyTab" CELLSPACING=0 CELLPADDING=0>
							<TR>
								...
								<td background="../../../CShared/image/table/seltab_up_bg.gif" align="center" CLASS="CLSLTAB"><font color=white>퇴직시보수총액통보서</font></td>
					...
					<TD HEIGHT=20>
						<TABLE <%=LR_SPACE_TYPE_60%>>   
							<TR>
								...
								<TD CLASS=TD6 NOWRAP><script language =javascript src='./js/h5305oa1_txtFr_acq_dt_txtFr_acq_dt.js'></script>&nbsp;~</TD>
							</TR>	
							<TR>
								<TD CLASS=TD5 NOWRAP></TD>
								<TD CLASS=TD6 NOWRAP><script language =javascript src='./js/h5305oa1_txtTo_acq_dt_txtTo_acq_dt.js'></script>&nbsp;</TD>
							</TR>
							<TR>
								<TD CLASS=TD5 NOWRAP>신고일</TD>
								<TD CLASS=TD6 NOWRAP><script language =javascript src='./js/h5305oa1_txtRprt_dt_txtRprt_dt.js'></script></TD>
							</TR>
							<TR>
