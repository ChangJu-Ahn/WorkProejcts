...
*  2. Function Name        : 
*  3. Program ID           : h5301ma1
*  4. Program Name         : 월건강보험 조회및조정 
*  5. Program Desc         : 월건강보험 조회,수정 
*  6. Comproxy List        :
...
'========================================================================================================
Const BIZ_PGM_ID      = "h5301mb1.asp"						           '☆: Biz Logic ASP Name
Const BIZ_PGM_ID1     = "h5301mb2.asp"						           '☆: Biz Logic ASP Name
...
Sub InitData()
    ...
    With frm1.vspdData2        
        ...
        .Text =  FncSumSheet(frm1.vspdData,C_HDB020T_PRSN_INSUR_AMT, 1, frm1.vspdData.MaxRows, false, -1, -1, "V")
        
        .Col   = C_HDB020T_COMP_INSUR_AMT2
        .Text =  FncSumSheet(frm1.vspdData,C_HDB020T_COMP_INSUR_AMT, 1, frm1.vspdData.MaxRows, false, -1, -1, "V")
        ...
        .ReDraw = False
            ...
            ggoSpread.SpreadLock    C_HDF020T_MED_INSUR_NO2,  -1, C_HDF020T_MED_INSUR_NO2,  -1
        .ReDraw = True
    End With
End Sub
...
Sub InitSpreadSheet(ByVal pvSpdNo)
    ...
    If pvSpdNo = "" OR pvSpdNo = "A" Then
    	...
    	With frm1.vspdData
           ...
           .MaxCols   = C_HDF020T_MED_INSUR_NO + 1                                                 ' ☜:☜: Add 1 to Maxcols
           ...
           ggoSpread.SSSetEdit     C_HDB020T_EMP_NO,              "사번", 13,,,,2
           ggoSpread.SSSetEdit     C_HAA010T_NAME,                "성명", 15,,,,2
           ggoSpread.SSSetEdit     C_HAA010T_DEPT_NM,             "부서", 22,,,,2
           ggoSpread.SSSetEdit     C_HDB020T_GRADE,               "등급", 14,,,4,2
           ggoSpread.SSSetFloat    C_HDB020T_PRSN_INSUR_AMT,      "개인부담료", 18, parent.ggAmtOfMoneyNo, ggStrIntegeralPart,  ggStrDeciPointPart, parent.gComNum1000, parent.gComNumDec,,,"Z"
           ggoSpread.SSSetFloat    C_HDB020T_COMP_INSUR_AMT,      "회사부담료", 18, parent.ggAmtOfMoneyNo, ggStrIntegeralPart,  ggStrDeciPointPart, parent.gComNum1000, parent.gComNumDec,,,"Z"
           ggoSpread.SSSetEdit     C_HDF020T_MED_INSUR_NO,        "건강보험번호", 16
    ...
    If pvSpdNo = "" OR pvSpdNo = "B" Then
    	With frm1.vspdData2
           ...
           .MaxCols   = C_HDF020T_MED_INSUR_NO2 + 1                                           ' ☜:☜: Add 1 to Maxcols
    	   .Col       = .MaxCols                                                              ' ☜:☜: Hide maxcols
           .ColHidden = True                                                                  ' ☜:☜:
           ...
           .DisplayColHeaders = False
            ...
            ggoSpread.SSSetEdit     C_HDB020T_EMP_NO2,              "", 13,,,,2
            ggoSpread.SSSetEdit     C_HAA010T_NAME2,                "", 15,,,,2
            ggoSpread.SSSetEdit     C_HAA010T_DEPT_NM2,             "", 22,,,,2
            ggoSpread.SSSetEdit     C_HDB020T_GRADE2,               "", 14,,,,2
            ggoSpread.SSSetFloat    C_HDB020T_PRSN_INSUR_AMT2,      "", 18, parent.ggAmtOfMoneyNo, ggStrIntegeralPart,  ggStrDeciPointPart, parent.gComNum1000, parent.gComNumDec,,,"Z"
            ggoSpread.SSSetFloat    C_HDB020T_COMP_INSUR_AMT2,      "", 18, parent.ggAmtOfMoneyNo, ggStrIntegeralPart,  ggStrDeciPointPart, parent.gComNum1000, parent.gComNumDec,,,"Z"
            ggoSpread.SSSetEdit     C_HDF020T_MED_INSUR_NO2,        "", 16
...
Sub SetSpreadLock()
    ...
    .vspdData.ReDraw = False
        ...
        ggoSpread.SpreadLock    C_HDF020T_MED_INSUR_NO, -1, C_HDF020T_MED_INSUR_NO, -1
...
Sub GetSpreadColumnPos(ByVal pvSpdNo)
    ...
    Select Case UCase(pvSpdNo)
       Case "A"
            ...
            C_HDF020T_MED_INSUR_NO = iCurColumnPos(7)            
        ...
        Case "B"
            ...
            C_HDF020T_MED_INSUR_NO2 = iCurColumnPos(7)
       ...
       For lRow = 1 To .vspdData.MaxRows
           ...
           Select Case .vspdData.Text
               Case  ggoSpread.UpdateFlag                                      '☜: Update
                    ...
                    .vspdData.Col = C_HDB020T_COMP_INSUR_AMT             : strVal = strVal & Trim(.vspdData.Text) &  parent.gRowSep
                    lGrpCnt = lGrpCnt + 1
           End Select
       Next
...
Function txtDept_cd_OnChange()
    ...
    Else
        IntRetCd =  FuncDeptName(Trim(frm1.txtDept_cd.value),"",lgUsrIntCd,strDept_nm,lsInternal_cd)
        If  IntRetCd < 0 then
            if  IntRetCd = -1 then
                Call  DisplayMsgBox("800098", "x","x","x")   ' 등록되지 않은 부서코드입니다.
            else
					...
					<TD CLASS="CLSMTABP">
						<TABLE ID="MyTab" CELLSPACING=0 CELLPADDING=0>
							<TR>
								...
								<td background="../../../CShared/image/table/seltab_up_bg.gif" align="center" CLASS="CLSLTAB"><font color=white>월건강보험조회및조정</font></td>
						...
						<FIELDSET CLASS="CLSFLD">
                           <TABLE <%=LR_SPACE_TYPE_40%>>
						    <TR>
			                    ...
			                    <TD CLASS=TD6 NOWRAP><script language =javascript src='./js/h5301ma1_txtPay_yymm_txtPay_yymm.js'></script></TD>
								<TD CLASS=TD5 NOWRAP>등 급</TD>       
					            <TD CLASS=TD6 NOWRAP><INPUT NAME="txtGrade" MAXLENGTH="4" SIZE=10 ALT ="등급" tag="11XXXU"></TD>
							</TR>
						    <TR>
								...
								<TD CLASS=TD6 NOWRAP><INPUT NAME="txtDept_cd" SIZE=10  MAXLENGTH=10  ALT ="부서코드" tag="11XXXU"><IMG SRC="../../../CShared/image/btnPopup.gif" NAME="btnPlantCd" ALIGN=top TYPE="BUTTON" ONCLICK="VBScript: OpenDept(0)">
								                     <INPUT NAME="txtDept_nm" SIZE=20  MAXLENGTH=40  ALT ="부서코드명"   tag="14XXXU">
								                     <INPUT NAME="txtInternal_cd" TYPE="HIDDEN"  SIZE=20  ALT ="부서코드명"   tag="14XXXU"></TD>
							</TR>							 
						   </TABLE>
						</FIELDSET>
					</TD>
				...
				<TR>
					<TD WIDTH=100% HEIGHT=* VALIGN=TOP>
						<TABLE <%=LR_SPACE_TYPE_20%> >
							<TR>
								<TD HEIGHT=100%>
									<script language =javascript src='./js/h5301ma1_vaSpread_vspdData.js'></script>
								</TD>
							</TR>
						</TABLE>
					</TD>
				...
				<TR>
					<TD WIDTH=100% HEIGHT=44 VALIGN=TOP>
						<TABLE <%=LR_SPACE_TYPE_20%> >
							<TR>
								<TD HEIGHT=100%>
									<script language =javascript src='./js/h5301ma1_vaSpread1_vspdData2.js'></script>
								</TD>
							</TR>
						</TABLE>
					</TD>
