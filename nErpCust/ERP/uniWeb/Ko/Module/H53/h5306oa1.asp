...
'*  3. Program ID           : h5306oa1
'*  4. Program Name         : 건강보험 피부양자 자격취득/상실신고서 
'*  5. Program Desc         : 건강보험 피부양자 자격취득/상실신고서 
'*  6. Comproxy List        : +
...
Function FncBtnPrint() 
	...
	dim emp_no, singo_dt, sect_cd, cust_cd	
        
    If Not chkField(Document, "1") Then									<%'⊙: This function check indispensable field%>
       Exit Function
    End If
	
	If frm1.txtPrtGbn(0).checked Then
		StrEbrFile = "h5306oa1_1"
	Else
		StrEbrFile = "h5306oa1_2"
	End If
		
	emp_no		= frm1.txtEmp_no.value
	sect_cd		= frm1.txtSect_cd.value
	cust_cd		= frm1.txtCust_cd.value
	singo_dt	= UniConvDateToYYYYMMDD(frm1.txtRprt_dt.text,Parent.gDateFormat,"")   ' yyyyMMdd
	...
	If frm1.txtPrtGbn(1).checked = true Then
		Call FncBtnPrint2()
	End if	
...
Function FncBtnPrint2() 
	...
	StrEbrFile = "h5306oa1_3"
	
	condvar = ""

    ObjName = AskEBDocumentName(StrEbrFile, "ebr")
		
	call FncEBRPrint(EBAction1 , ObjName , condvar)
...
Function txtSect_cd_Onchange()
    ...
    Else
        ...
        If IntRetCd = false then
			Call DisplayMsgbox("800054","X","X","X")	'해당사원은 존재하지 않습니다.
			 frm1.txtSect_nm.value = ""
             frm1.txtSect_cd.focus
            Set gActiveElement = document.ActiveElement       
					...
					<TD CLASS="CLSMTABP">
						<TABLE ID="MyTab" CELLSPACING=0 CELLPADDING=0>
							<TR>
								...
								<td background="../../../CShared/image/table/seltab_up_bg.gif" align="center" CLASS="CLSLTAB"><font color=white>피부양자취득/상실신고</font></td>
					...
					<TD HEIGHT=20>
						<TABLE <%=LR_SPACE_TYPE_60%>>   
							<TR>
								...
								<TD CLASS=TD6 NOWRAP><script language =javascript src='./js/h5306oa1_txtRprt_dt_txtRprt_dt.js'></script></TD>
							</TR>
							<TR>
							...
							<TR>
								...
								<TD CLASS=TD6 NOWRAP><INPUT NAME="txtEmp_no" ALT="대상자" TYPE="Text" MAXLENGTH="13" SIZE=13 tag="12XXXU"><IMG SRC="../../../CShared/image/btnPopup.gif" NAME="btnBP_CD" align=top TYPE="BUTTON"ONCLICK="vbscript:OpenEmpName (1)">
								                     <INPUT NAME="txtName" TYPE="Text" MAXLENGTH="30" SIZE=20 tag="14XXXX"></TD>	
						    </TR>
							<TR>
								<TD CLASS=TD5 NOWRAP>출력구분</TD>
				        	    <TD CLASS=TD6><INPUT TYPE="RADIO" CLASS="RADIO" NAME="txtPrtGbn" TAG="2X" VALUE="취득" CHECKED ID="txtPrtGbn1"><LABEL FOR="txtPrtGbn1">취득</LABEL>&nbsp;
  				        	                  <INPUT TYPE="RADIO" CLASS="RADIO" NAME="txtPrtGbn" TAG="2X" VALUE="상실" ID="txtPrtGbn2"><LABEL FOR="txtPrtGbn2">상실</LABEL></TD>
							</TR>
