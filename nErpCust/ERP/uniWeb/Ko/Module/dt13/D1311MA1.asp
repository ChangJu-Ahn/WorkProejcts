...
'========================================================================================================
Const BIZ_PGM_ID  = "D1311MB1.asp"
Const BIZ_PGM_ID2 = "D1311MB2.asp"
Const BIZ_PGM_ID3 = "D1311MB3.asp"
...
Sub InitSpreadSheet()
	...
	With frm1.vspdData	
		...
		ggoSpread.SSSetEdit	C1_sup_reg_num		,"공급자 사업자번호",	15
		ggoSpread.SSSetEdit	C1_sup_cmp_name 	,"공급자 사업자명",	20
		...
		ggoSpread.SSSetEdit	C1_apply_system 	,"시스템 매입번호",	15
...
Sub SetSpreadLock()
	With frm1
		...
		ggoSpread.SpreadLock	C1_pub_date 	,-1,	C1_pub_date 
		ggoSpread.SpreadLock	C1_sup_reg_num 	,-1,	C1_sup_reg_num 
		ggoSpread.SpreadLock	C1_sup_cmp_name 	,-1,	C1_sup_cmp_name 
		ggoSpread.SpreadLock	C1_total_amt 	,-1,	C1_total_amt 
		ggoSpread.SpreadLock	C1_sup_tot_amt 	,-1,	C1_sup_tot_amt 
		ggoSpread.SpreadLock	C1_sur_tax 	,-1,	C1_sur_tax 
		ggoSpread.SpreadUnLock	C1_apply_system 	,-1,	C1_apply_system 
		ggoSpread.SpreadUnLock	C1_apply_system_pop 	,-1,	C1_apply_system_pop
		ggoSpread.SpreadLock	C1_snd_mgm_no 	,-1,	C1_snd_mgm_no 
		...
		ggoSpread.SpreadLock	C1_proc_date 	,-1,	C1_proc_date 
		ggoSpread.SpreadLock	C1_inv_type2 	,-1,	C1_inv_type2 
		ggoSpread.SpreadLock	C1_old_apply_system	,-1,	C1_old_apply_system
		...
		For lRow = 1 To .vspdData.MaxRows
			...
			If .vspdData.text = "1" Then
				...
				If Not (is_send_flag = sendStatusFail _
							AND (proc_flag = docStatusOpen or proc_flag = docStatusReject or proc_flag = docStatusApprove or proc_flag = docStatusRequestDisuse) ) Then
...
Function fnApprovalDisuse()
	With frm1
		Call ChangeDocStatus(docStatusRequestDisuse, .btnApprovalDisuse.title)
	End With
End Function
		...
		For lRow = 1 To .vspdData.MaxRows
			...
			If .vspdData.text = "1" Then
				...
				Select Case pvChangeCode
					...
					Case docStatusRequestDisuse
						If Not proc_flag =  docStatusApprove Then
							BlnChkErr = True
						End If
	...
	With frm1	
		...
		If .vspdData.MaxRows > 0 Then
            ...
            For loopCount = 1 To frm1.vspdData.MaxRows
                ...
                If Not (frm1.vspdData.text = docStatusOpen Or frm1.vspdData.text = docStatusApprove) Then
							...
							<TD CLASS="CLSMTABP">
								<TABLE ID="MyTab" CELLSPACING=0 CELLPADDING=0>
									<TR>
										...
										<td background="../../../CShared/image/table/seltab_up_bg.gif" align="center" CLASS="CLSMTAB"><font color=white>매입정발행등록</font></td>
  					...
  					<TABLE <%=LR_SPACE_TYPE_30%>>
						<TR>
							...
							<TD><BUTTON NAME="btnReSend" CLASS="CLSSBTN" OnClick="VBScript:Call fnResend()" title = "재전송">재전송</BUTTON>&nbsp; 
								<BUTTON NAME="btnOpen" CLASS="CLSSBTN" OnClick="VBScript:Call fnOpen()" title = "개봉">개봉</BUTTON>&nbsp; 
								...
								<BUTTON NAME="btnApprovalDisuse" CLASS="CLSSBTN" OnClick="VBScript:Call fnApprovalDisuse()" title = "폐기요청">폐기요청</BUTTON>&nbsp;</TD>
							<TD WIDTH=10>&nbsp;</TD>
						</TR>
  					</TABLE>
				</TD>
