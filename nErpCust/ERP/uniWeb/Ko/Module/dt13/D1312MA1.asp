...
'========================================================================================================
Const BIZ_PGM_ID  = "D1312MB1.asp"
Const BIZ_PGM_ID2 = "D1312MB2.asp"
Const BIZ_PGM_ID3 = "D1312MB3.asp"
Const BIZ_PGM_ID4 = "D1312MB4.asp"
'==========================================  1.2.1 Global 상수 선언  ======================================
...
Sub InitSpreadPosVariables()
    ...
    C1_fi_vat_amt       = 20
    C1_total_loc_amt    = 21
    C1_fi_total_loc_amt = 22
    C1_net_loc_amt      = 23
    C1_fi_net_loc_amt   = 24
    C1_vat_loc_amt      = 25
    C1_fi_vat_loc_amt   = 26
    C1_tax_biz_area     = 27
    C1_tax_biz_area_nm  = 28
    C1_pur_grp          = 29
    C1_pur_grp_nm       = 30
    C1_remarks          = 31
    C1_disuse_reason    = 32
...
Sub SetSpreadLock()
    With frm1
        ...
        ggoSpread.SpreadUNLock  C1_disuse_reason   , -1, C1_disuse_reason
...
Sub GetSpreadColumnPos(ByVal pvSpdNo)
    ...
    Select Case UCase(pvSpdNo)
        Case "A"
            ...
            C1_build_cd         = iCurColumnPos(7 )
            C1_build_nm         = iCurColumnPos(8 )
            C1_issued_dt        = iCurColumnPos(9 )
            C1_vat_inc_flag_nm  = iCurColumnPos(10)
            C1_vat_type         = iCurColumnPos(11)
            C1_vat_type_nm      = iCurColumnPos(12)
            C1_vat_rate         = iCurColumnPos(13)
            C1_cur              = iCurColumnPos(14)
            C1_total_amt        = iCurColumnPos(15)
            C1_fi_total_amt     = iCurColumnPos(16)
            C1_net_amt          = iCurColumnPos(17)
            C1_fi_net_amt       = iCurColumnPos(18)
            C1_vat_amt          = iCurColumnPos(19)
            C1_fi_vat_amt       = iCurColumnPos(20)
            C1_total_loc_amt    = iCurColumnPos(21)
            C1_fi_total_loc_amt = iCurColumnPos(22)
            C1_net_loc_amt      = iCurColumnPos(23)
            C1_fi_net_loc_amt   = iCurColumnPos(24)
            C1_vat_loc_amt      = iCurColumnPos(25)
            C1_fi_vat_loc_amt   = iCurColumnPos(26)
            C1_tax_biz_area     = iCurColumnPos(27)
            C1_tax_biz_area_nm  = iCurColumnPos(28)
            C1_pur_grp          = iCurColumnPos(29)
            C1_pur_grp_nm       = iCurColumnPos(30)
            C1_remarks          = iCurColumnPos(31)
            C1_disuse_reason    = iCurColumnPos(32)
            C1_legacy_pk        = iCurColumnPos(33)
            C1_sale_no          = iCurColumnPos(34)
            C1_remark           = iCurColumnPos(35)
            C1_remark2          = iCurColumnPos(36)
            C1_remark3          = iCurColumnPos(37)
                                                   
            C1_proc_flag        = iCurColumnPos(38)
            C1_is_send          = iCurColumnPos(39)
            C1_issue_dt_fg      = iCurColumnPos(40)
            C1_inv_amend_type   = iCurColumnPos(41)

            C1_name             = iCurColumnPos(42)
            C1_name_B           = iCurColumnPos(43)
            C1_email            = iCurColumnPos(44)
            C1_bp_seq           = iCurColumnPos(45)
            C1_name2            = iCurColumnPos(46)
            C1_name2_B          = iCurColumnPos(47)
            C1_email2           = iCurColumnPos(48)
            C1_bp_seq2          = iCurColumnPos(49)
    ...
    With frm1
        ...
        If .vspdData.MaxRows > 0 Then
            ...
            For loopCount = 1 To frm1.vspdData.MaxRows
                ...
                If Not (frm1.vspdData.text = docStatusSalesApprove Or frm1.vspdData.text = docStatusApprove) Then
                    ggoSpread.SSSetProtected    C1_disuse_reason    , loopCount, loopCount
                End If
            Next
        End If
    End With
                            ...
                            <TD CLASS="CLSMTABP">
                                <TABLE ID="MyTab" CELLSPACING=0 CELLPADDING=0>
                                    <TR>
                                        ...
                                        <td background="../../../CShared/image/table/seltab_up_bg.gif" align="center" CLASS="CLSMTAB"><font color=white>매입역발행등록</font></td>
                ...
                <TD WIDTH="100%" >
                    <TABLE <%=LR_SPACE_TYPE_30%>>
                        <TR>
                            <TD WIDTH=10>&nbsp;</TD>
                            <TD>
                                <BUTTON NAME="btnReSend" CLASS="CLSSBTN" OnClick="VBScript:Call fnResend()" title="재전송">재전송</BUTTON>&nbsp;
                                <BUTTON NAME="btnPublish" CLASS="CLSSBTN" OnClick="VBScript:Call fnPublish()" title="발행">발행</BUTTON>&nbsp;
                                <BUTTON NAME="btnApproval" CLASS="CLSSBTN" OnClick="VBScript:Call fnApproval()" title="승인">승인</BUTTON>&nbsp;
                                <BUTTON NAME="btnReject" CLASS="CLSSBTN" OnClick="VBScript:Call fnReject()" title="반려">반려</BUTTON>&nbsp;
                                <BUTTON NAME="btnReqDisuse" CLASS="CLSSBTN" OnClick="VBScript:Call fnReqDisuse()" title="폐기요청">폐기요청</BUTTON>&nbsp;
                            </TD>
                            <TD WIDTH=10>&nbsp;</TD>
                        </TR>
                    </TABLE>
