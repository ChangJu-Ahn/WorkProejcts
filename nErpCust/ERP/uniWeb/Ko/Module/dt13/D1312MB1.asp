...
If Request("txtPurchaseGrpCd") = "" Then
	
	Response.Write "<Script Language=VBScript>" & vbCrLf
		Response.Write "parent.frm1.txtPurchaseGrpNm.value = """"" & vbCrLf
	Response.Write "</Script>" & vbCrLf
	UNIValue(0, 4) = "|"
Else
	UNIValue(0, 4) = FilterVar(UCase(Request("txtPurchaseGrpCd")), "''", "S")
End If
...
UNIValue(0, 8) = " (I.INV_AMEND_TYPE = '00' OR I.INV_AMEND_TYPE = '' OR I.INV_AMEND_TYPE IS NULL) "
...
<%		Dim iDx
		For iDx = 0 to rs0.RecordCount - 1 %>
			...
			strData = strData & Chr(11) & "<%=ConvSPChars(rs0("vat_rate"))%>"
