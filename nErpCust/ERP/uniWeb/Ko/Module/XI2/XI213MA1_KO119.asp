...
*  3. Program ID           : XI213MA1_KO119
*  4. Program Name         : XI213MA1_KO119
...
Const BIZ_PGM_ID = "XI213MB1_KO119.asp"                               'Biz Logic ASP 
	...
	<TR HEIGHT=20>
		<TD WIDTH=100%>
			<TABLE <%=LR_SPACE_TYPE_30%>>
			    <TR>
					<TD WIDTH=10>&nbsp;</TD>
					<TD WIDTH=* ALIGN=RIGHT><a href = "VBSCRIPT:PgmJump(BIZ_PGM_JUMP_ID)" ONCLICK="VBSCRIPT:CookiePage 1">품목정보등록</a>&nbsp;&nbsp;|&nbsp;
								<a href = "VBSCRIPT:PgmJump(BIZ_PGM_JUMP_ID1)" ONCLICK="VBSCRIPT:CookiePage 1">공장별품목정보등록</a>
					</TD>
					<TD WIDTH=10>&nbsp;</TD>
				</TR>
			</TABLE>
