...
'*  2. Function Name        : 자재제조사정보 송신형황(S)
'*  3. Program ID           : XI215MA1_KO119
'*  4. Program Name         : 자재제조사정보 송신형황(S)
'*  5. Program Desc         : 자재제조사정보 송신형황(S)
'*  6. Comproxy List        :
...
Const BIZ_PGM_ID = "XI215MB1_KO119.asp"	
Const BIZ_PGM_JUMP_ID = "M1211MA1"				      '☆: Jump ASP명 
...
Function CookiePage(ByVal flgs)
	...
	If flgs = 1 Then
		WriteCookie "m1211qa1_plantcd", lsConPlantcd
		WriteCookie "m1211qa1_itemcd", lsConItemCd
		WriteCookie "m1211qa1_suppliercd", lsConBpCd
	 Else
...
Sub InitSpreadSheet()
	...
	With frm1.vspdData  
		...
		ggoSpread.SSSetEdit  PLANT_CD, "공장",		 6, , ,4
		ggoSpread.SSSetEdit  ITEM_CD, "품목코드",	15, , ,18
		ggoSpread.SSSetEdit  ITEM_NM, "품 목 명",	20, , ,50
		ggoSpread.SSSetEdit  BP_CODE, "공급처",		 6, , ,10
		ggoSpread.SSSetEdit  BP_NAME, "공급처명",	20, , ,50
		ggoSpread.SSSetEdit  BP_ITCD, "공급처품목코드",	15, , ,20
		ggoSpread.SSSetEdit  BP_ITNM, "공급처품목명",	20, , ,50
		ggoSpread.SSSetEdit  BP_SPEC, "공급처규격",		20, , ,50
		ggoSpread.SSSetEdit  CM_FLAG, "생성구분",		 8, , , 1
		ggoSpread.SSSetEdit  CM_SEND, "최종송신일시",   20
		ggoSpread.SSSetEdit  CM_UPDT, "MES수신여부",	10, , , 1
		ggoSpread.SSSetEdit  CM_ERRD, "에러내역",		25, , ,50
		ggoSpread.SSSetEdit  CM_RECV, "ME최종수신일시",	20
...
Sub GetSpreadColumnPos(ByVal pvSpdNo)
    ...
    Select Case UCase(pvSpdNo)
       Case "A"
			...
			PLANT_CD = iCurColumnPos(1)
			ITEM_CD = iCurColumnPos(2)
			ITEM_NM = iCurColumnPos(3)
			BP_CODE = iCurColumnPos(4)
			BP_NAME = iCurColumnPos(5)
			BP_ITCD = iCurColumnPos(6)
			BP_ITNM = iCurColumnPos(7)
			BP_SPEC = iCurColumnPos(8)
...
Sub SetSpreadColor(ByVal lRow)
	With frm1
		...
		ggoSpread.SSSetProtected  PLANT_CD, lRow, lRow
...
Sub vspdData_Click(ByVal Col , ByVal Row )
    ...
    frm1.vspdData.Col = 1
    lsConPlantcd      = frm1.vspdData.Text
						...
						<FIELDSET CLASS="CLSFLD">
							<TABLE <%=LR_SPACE_TYPE_40%>>
								<TR>
									...
									<TD CLASS="TD6" NOWRAP>
										<INPUT NAME="txtPlantCD" TYPE="Text" MAXLENGTH="10" TAG="11XXXU" SIZE="10"><IMG SRC="../../../CShared/image/btnPopup.gif" NAME="ImgPlantCD" align="top" TYPE="BUTTON" WIDTH="16" HEIGHT="20" ONCLICK="vbscript:OpenPopUp frm1.txtPlantCD.value, 0"> <INPUT NAME="txtPlantNM" TYPE="Text" TAG="14" SIZE="20">
									</TD>
								...
								<TR>
									...
									<TD CLASS="TD6" NOWRAP>
										<INPUT NAME="txtItemCD" TYPE="Text" MAXLENGTH="20" TAG="11XXXU" SIZE="20"><IMG SRC="../../../CShared/image/btnPopup.gif" NAME="ImgItemCD" ALIGN="top" TYPE="BUTTON" WIDTH="16" HEIGHT="20" ONCLICK="vbscript:OpenPopUp frm1.txtItemCD, 1"> <INPUT NAME="txtItemNM" TYPE="Text" TAG="14" SIZE="25">
									</TD>
	...
	<TR HEIGHT=20>
		<TD WIDTH=100%>
			<TABLE <%=LR_SPACE_TYPE_30%>>
			    <TR>
					<TD WIDTH=10>&nbsp;</TD>
					<TD WIDTH=* ALIGN=RIGHT><a href = "VBSCRIPT:PgmJump(BIZ_PGM_JUMP_ID)" ONCLICK="VBSCRIPT:CookiePage 1">품목별공급처등록</a>
					</TD>
					<TD WIDTH=10>&nbsp;</TD>
				</TR>
			</TABLE>
