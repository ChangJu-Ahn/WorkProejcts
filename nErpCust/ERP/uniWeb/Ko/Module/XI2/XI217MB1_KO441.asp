...
'	UNIValue(0, 0) = C_SHEETMAXROWS_D + 1
	UNIValue(0, 0) = FilterVar(UCase(Request("txtPlantCd")),"''","S")
	UNIValue(0, 1) = FilterVar(UniConvDate(Request("txtSendStartDt")) ,"''","S")
	UNIValue(0, 2) = FilterVar(UniConvDate(Request("txtSendEndDt")) ,"''","S")

	If Trim(Request("txtItemCd")) = "" Then
		UNIValue(0, 3) = FilterVar("%","''","S")
	Else
		UNIValue(0, 3) = FilterVar(UCase(Trim(Request("txtItemCd"))),"''","S")
	End If 
	
	If Trim(Request("txtPlanStartDt")) = "" Then
		UNIValue(0, 4) = FilterVar("1900-01-01","''","S")
	Else
		UNIValue(0, 4) = FilterVar(UniConvDate(Request("txtPlanStartDt")),"''","S")
	End If
	
	If Trim(Request("txtPlanEndDt")) = "" Then
		UNIValue(0, 5) = FilterVar("2999-12-31","''","S")
	Else
		UNIValue(0, 5) = FilterVar(UniConvDate(Request("txtPlanEndDt")),"''","S")
	End If

	If Trim(Request("rdoFlag")) = "A" Then
		UNIValue(0, 6) = FilterVar("%", "''", "S") 
	Else
		UNIValue(0, 6) = FilterVar(UCase(Request("rdoFlag")), "''", "S")
	End If

	If Trim(Request("txtProdtOrderNo")) = "" Then
		UNIValue(0, 7)	= FilterVar("%", "''", "S") 
	Else
		UNIValue(0, 7)	= FilterVar(UCase(Request("txtProdtOrderNo"))&"%","''","S")
	End If
...
'		UNIValue(0, 9) = "''"
'	Else
'		UNIValue(0, 8) = FilterVar(UCase(Request("lgStrPrevKey1")),"''","S")
...
'		UNIValue(0, 11) = "''"
'	Else
'		UNIValue(0, 10) = FilterVar(UCase(Request("lgStrPrevKey2")),"''","S")
...
'		UNIValue(0, 13) = "''"
'	Else
'		UNIValue(0, 12) = FilterVar(UCase(Request("lgStrPrevKey3")),"''","S")
...
'		UNIValue(0, 15) = "0"
'	Else
'		UNIValue(0, 14) = FilterVar(UCase(Request("lgStrPrevKey4")),"0","SNM")
...
'		UNIValue(0, 16) = "''"
'	Else
'		UNIValue(0, 16) = FilterVar(UCase(Request("lgStrPrevKey5")),"''","S")
'	End If						
