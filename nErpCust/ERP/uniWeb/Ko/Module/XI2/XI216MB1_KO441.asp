...
'	strSQL = strSQL & "  , a.mes_receive_dt"
	strSQL = strSQL & "  , CASE WHEN A.MES_RECEIVE_FLAG = 'N' THEN NULL ELSE A.MES_RECEIVE_DT END MES_RECEIVE_DT       " '20083036::HANC
	strSQL = strSQL & " FROM"
	strSQL = strSQL & "  t_if_snd_bom_ko441 a     (nolock) "
