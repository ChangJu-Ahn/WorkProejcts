...
'            lgstrData = lgstrData & Chr(11) & ConvSPChars(lgObjRs("std_time"))
            ...
            lgstrData = lgstrData & Chr(11) & ConvSPChars(lgObjRs("ITEM_CD"))
            lgstrData = lgstrData & Chr(11) & ConvSPChars(lgObjRs("ITEM_NM"))
            lgstrData = lgstrData & Chr(11) & ConvSPChars(lgObjRs("ROUT_NO"))
        ...
        Case "M"
           ...
           Select Case Mid(pDataType,2,1)
               Case "R"
                       ...
                       lgStrSQL = lgStrSQL & "          	C.ITEM_NM ITEM_NM,                                                  "
                       lgStrSQL = lgStrSQL & "          	A.ROUT_NO ROUT_NO,                                                  "
                       lgStrSQL = lgStrSQL & "          	A.OPR_NO OPR_NO,                                                    "
                       lgStrSQL = lgStrSQL & "          	A.WC_CD WC_CD,                                                      "
                       lgStrSQL = lgStrSQL & "          	D.WC_NM WC_NM,                                                      "
                       ...
                       lgStrSQL = lgStrSQL & "      FROM	T_IF_SND_ROUTING_KO441 A,                                           "
                       lgStrSQL = lgStrSQL & "              B_ITEM C,                                                           "
                       lgStrSQL = lgStrSQL & "              P_WORK_CENTER D                                                     "
                       lgStrSQL = lgStrSQL & "      WHERE	A.ITEM_CD	= C.ITEM_CD                                             "
                       lgStrSQL = lgStrSQL & "      AND		A.WC_CD	    = D.WC_CD                                               " & pCode
