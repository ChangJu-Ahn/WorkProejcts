...
Const BIZ_PGM_ID = "XI220MB1_KO441.asp"                               'Biz Logic ASP 
...
Sub MakeKeyStream(pRow)
    ...
    lgKeyStream = lgKeyStream & Trim(Frm1.txtConWcCd.Value)  & parent.gColSep
...
'2008-03-18 4:46오후 :: hanc
		...
		ggoSpread.SSSetEdit		C2_WC_CD,            "작업장",10,,,18,2
		ggoSpread.SSSetEdit		C2_WC_NM,            "작업장명",15,,,24,2
		ggoSpread.SSSetEdit		C2_INSIDE_FLG,       "사내외구분",10,,,14,2
...
'2008-03-18 4:47오후 :: hanc
            ...
            C2_WC_CD            = iCurColumnPos(2)
            C2_WC_NM            = iCurColumnPos(3)
            C2_INSIDE_FLG       = iCurColumnPos(4)
			C_ValidFromDt		= iCurColumnPos(5)
			C_ValidToDt			= iCurColumnPos(6)
			C_CreateType		= iCurColumnPos(7)
			C_SendDt			= iCurColumnPos(8)
			C_MesReceiveFlag	= iCurColumnPos(9)
			C_ErrDesc			= iCurColumnPos(10)
			C_MesReceiveDt		= iCurColumnPos(11)
