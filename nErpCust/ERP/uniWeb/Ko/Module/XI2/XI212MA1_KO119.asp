...
*  3. Program ID           : XI212MA1_KO119
*  4. Program Name         : XI212MA1_KO119
...
Const BIZ_PGM_ID = "XI212MB1_KO119.asp"                               'Biz Logic ASP 
...
Sub InitSpreadSheet()
	...
	With frm1.vspdData
       ...
       .MaxRows = 0	
		...
		ggoSpread.SSSetEdit		C_CreateType,		"생성구분",8,,,8

		ggoSpread.SSSetEdit		C_SendDt,			"ERP 최종송신일시", 18, , ,20
		ggoSpread.SSSetEdit		C_MesReceiveFlag,	"MES 수신여부",12,,,40
		ggoSpread.SSSetEdit		C_ErrDesc,			"에러내역",25,,,40
		ggoSpread.SSSetEdit		C_MesReceiveDt,		"MES 최종수신일시", 18, , ,20
