...
<%
	...
	strSQL = strSQL & " FROM"
	strSQL = strSQL & "  t_if_snd_maker_mat_ko119 a (nolock)"
	...
	strSQL = strSQL & " WHERE"
	strSQL = strSQL & "      a.plant_cd LIKE    (CASE '" & Request("txtPlantCD") & "' WHEN '' THEN '%'          ELSE '" & Request("txtPlantCD") & "'       END)"
