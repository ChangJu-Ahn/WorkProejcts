...
Const BIZ_PGM_ID = "XI211MB1_KO441.asp"	
...
Sub InitSpreadSheet()
	...
	With frm1.vspdData  
		...
		ggoSpread.SSSetEdit  BP_TYPE, "거래처구분",		10, 2, , 2
		ggoSpread.SSSetEdit  BP_USAG, "유효구분",		 8, 2, , 1
		ggoSpread.SSSetEdit  BP_CRET, "생성구분",		 8, 2, , 1
		ggoSpread.SSSetEdit  BP_SEND, "최종전송일시",	19, , ,30
		ggoSpread.SSSetEdit  BP_UPDT, "MES수신여부",		12, 2, , 1
