...
*  2. Function Name        : 공정(작업장) 전송현황 
*  3. Program ID           : XI220MA1_KO441
*  4. Program Name         : XI220MA1_KO441
*  5. Program Desc         : 공정(작업장) 전송현황 
*  6. Comproxy List        :
*  7. Modified date(First) : 2008/03/18
...
Const BIZ_PGM_ID = "XI221MB1_KO441.asp"                               'Biz Logic ASP 
...
'2008-03-18 4:46오후 :: hanc
		ggoSpread.SSSetEdit		C2_PLANT_CD,		"공장",10,,,4,2
		ggoSpread.SSSetEdit		C2_ITEM_CD,			"품목",12,,,18,2
		ggoSpread.SSSetEdit		C2_ITEM_NM,			"품목명",15,,,40
		ggoSpread.SSSetEdit		C2_ROUT_NO,		    "라우팅No",10,,,40,2
		ggoSpread.SSSetEdit		C2_OPR_NO,		    "공정",10,,,40,2
		ggoSpread.SSSetEdit		C2_WC_CD,		    "작업장",10,,,40
		ggoSpread.SSSetEdit		C2_WC_NM,		    "작업장명",13,,,40
...
'2008-03-18 4:47오후 :: hanc
            C2_PLANT_CD         = iCurColumnPos(1)
            C2_ITEM_CD          = iCurColumnPos(2)
            C2_ITEM_NM          = iCurColumnPos(3)
            C2_ROUT_NO          = iCurColumnPos(4) 
            C2_OPR_NO           = iCurColumnPos(5) 
            C2_WC_CD            = iCurColumnPos(6) 
            C2_WC_NM            = iCurColumnPos(7) 

			C_ValidFromDt		= iCurColumnPos(8)
			C_ValidToDt			= iCurColumnPos(9)
			C_CreateType		= iCurColumnPos(10)
			C_SendDt			= iCurColumnPos(11)
			C_MesReceiveFlag	= iCurColumnPos(12)
			C_ErrDesc			= iCurColumnPos(13)
			C_MesReceiveDt		= iCurColumnPos(14)
    	                ...
    	                <FIELDSET CLASS="CLSFLD">
			                <TABLE <%=LR_SPACE_TYPE_40%>>
								...
								<TR style="display:none">
									...
									<TD CLASS=TD6 NOWRAP><INPUT TYPE=TEXT NAME="txtConWcCd" SIZE=10 MAXLENGTH=7 tag="11XXXU" ALT="작업장"><IMG SRC="../../../CShared/image/btnPopup.gif" NAME="btnWCCd1" ALIGN=top TYPE="BUTTON" ONCLICK="vbscript:OpenConWC()"> <INPUT TYPE=TEXT NAME="txtConWcNm" SIZE=50 tag="14"></TD>
								</TR>
							</TABLE>
						</FIELDSET>
					</TD>
