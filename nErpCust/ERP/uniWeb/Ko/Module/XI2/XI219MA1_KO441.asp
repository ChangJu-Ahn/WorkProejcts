...
<SCRIPT LANGUAGE="VBScript"   SRC="XI219MA1_KO441.vbs"> </SCRIPT>
			...
			<TABLE <%=LR_SPACE_TYPE_20%>>
					...
					<TD HEIGHT=20 WIDTH="100%">
						<FIELDSET CLASS=CLSFLD>
							<TABLE <%=LR_SPACE_TYPE_40%>>
                                    ...
                                    <TD CLASS=TD6 NOWRAP><SCRIPT LANGUAGE=javaScript SRC="./js/XI219MA1_KO441_txtPrintFrDt_txtPrintFrDt.js"></SCRIPT>
                                    &nbsp;~&nbsp;<SCRIPT LANGUAGE=javaScript SRC="./js/XI219MA1_KO441_txtPrintToDt_txtPrintToDt.js"></SCRIPT></TD>
				...
				<TR>
					<TD WIDTH="100%" HEIGHT="100%" VALIGN=top>
							...
							<TR>
								<TD HEIGHT="100%">
									<SCRIPT LANGUAGE=javaScript SRC="./js/XI219MA1_KO441_vspdData_vspdData.js"></SCRIPT>
								</TD>
							</TR>
						</TABLE>
					</TD>
	    ...
	    <TD>
	        <TABLE <%=LR_SPACE_TYPE_30%>>
	            <TR>
	                ...
	                <TD WIDTH=*><SCRIPT LANGUAGE=javaScript SRC="./js/XI219MA1_KO441_cFLkUpExcel.js"></SCRIPT></TD>
	                <TD WIDTH=10>&nbsp;</TD>
	            </TR>
	        </TABLE>
	    </TD>   
