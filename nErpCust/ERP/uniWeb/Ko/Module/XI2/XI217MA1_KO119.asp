...
'**********************************************************************************************************
Const BIZ_PGM_QRY_ID = "xi217mb1_ko119.asp"							'☆: 비지니스 로직(Qeury) ASP명 
...
Sub InitSpreadSheet()
	...
	With frm1.vspdData 
		...
		ggoSpread.SSSetDate 	C_JobPlanDt, 	"계획일자",			10, 2, parent.gDateFormat
