...
'*  2. Function Name        : 
'*  3. Program ID           : p1712qa1.asp
'*  4. Program Name         : 설계BOM조회(Multi)
'*  5. Program Desc         :
'*  6. Component List       : 
...
<SCRIPT LANGUAGE = "VBScript" SRC = "p1712qa1.vbs"></SCRIPT>
					...
					<TD CLASS="CLSMTABP">
						<TABLE ID="MyTab" CELLSPACING=0 CELLPADDING=0>
							<TR>
								...
								<td background="../../../CShared/image/table/seltab_up_bg.gif" align="center" CLASS="CLSMTAB"><font color=white>설계BOM조회(Multi)</font></td>
						...
						<FIELDSET CLASS="CLSFLD">
							<TABLE <%=LR_SPACE_TYPE_40%>>
								<TR>
									...
									<TD CLASS=TD6 NOWRAP><INPUT TYPE="RADIO" NAME="rdoSrchType" ID="rdoSrchType1" CLASS="RADIO" tag="1X" Value="2" CHECKED><LABEL FOR="rdoSrchType1">정전개</LABEL></TD>													     
								</TR>
								<TR>
					...
					<TD WIDTH=100% HEIGHT=* valign=top>
						<TABLE <%=LR_SPACE_TYPE_60%>>
							<TR>
								...
								<TD CLASS=TD6 NOWRAP><SELECT NAME="cboItemAcct" STYLE=" Width: 168px;" ALT="품목계정" tag="24"><INPUT TYPE=HIDDEN NAME="txtItemAcct" tag="24" ALT="품목계정"></TD>
	...
	<TR HEIGHT="20">
		<TD WIDTH="100%">
			<TABLE <%=LR_SPACE_TYPE_30%>>
			    <TR>
				<TD WIDTH=10>&nbsp;</TD>
				<TD WIDTH=* ALIGN=RIGHT><A href="vbscript:LoadEBomHistory()">설계BOM이력조회</A>&nbsp;|&nbsp;<A href="vbscript:LoadPBomCreate()">제조BOM작성(이관의뢰)</A>&nbsp;|&nbsp;<A href="vbscript:LoadEBomToPBom()">제조BOM이관</A></TD>
				<TD WIDTH=10>&nbsp;</TD>
			</TABLE>
		</TD>
	</TR>	
...
<INPUT TYPE=HIDDEN NAME="txtBomNo" tag="14">
</FORM>
