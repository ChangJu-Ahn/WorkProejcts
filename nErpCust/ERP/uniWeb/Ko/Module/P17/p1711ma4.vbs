Const BIZ_PGM_QRY_ID	= "p1711mb14.asp"											'☆: 비지니스 로직 ASP명 
Const BIZ_PGM_SAVE_ID	= "p1711mb15.asp"											'☆: 비지니스 로직 ASP명 
Const BIZ_PGM_DEL_ID	= "p1711mb16.asp"											'☆: 비지니스 로직 ASP명 
...
Function OpenECNNo(ByVal strECNNo, ByVal iPos)
	...
	'If iPos = "0" AND UCase(frm1.txtECNNo.className) = UCase(parent.UCN_PROTECTED) Then 
	'	IsOpenPop = False
	'	Exit Function
	'End If		
