...
'*  2. Function Name	: 
'*  3. Program ID		: p1711qa1.asp
'*  4. Program Name		: 설계BOM 조회 
'*  5. Program Desc		:
'*  6. Component List	: 
...
<SCRIPT LANGUAGE = "VBScript" SRC = "p1711qa1.vbs"></SCRIPT>
					...
					<TD CLASS="CLSMTABP">
						<TABLE ID="MyTab" CELLSPACING=0 CELLPADDING=0>
							<TR>
								...
								<td background="../../../CShared/image/table/seltab_up_bg.gif" align="center" CLASS="CLSMTAB"><font color=white>설계BOM조회</font></td>
...
<INPUT TYPE=HIDDEN NAME="txtBomNo1" tag="14">
