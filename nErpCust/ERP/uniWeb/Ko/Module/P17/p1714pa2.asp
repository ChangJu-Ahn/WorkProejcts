...
'********************************************************************************************************
Const BIZ_PGM_QRY_ID = "p1714pb2.asp"			'☆: 비지니스 로직 ASP명 
'============================================  1.2.1 Global 상수 선언  ==================================
'========================================================================================================
...
Sub InitSpreadSheet()
	...
	vspdData.MaxCols = C_ErrorDesc + 1
	vspdData.MaxRows = 0

	Call GetSpreadColumnPos("A")

	ggoSpread.SSSetEdit		C_ReqTransNo,		"이관의뢰번호", 18,,,18,2
	ggoSpread.SSSetEdit		C_PrntPlantCd,		"대상공장", 12
	ggoSpread.SSSetEdit		C_PlantNm,			"대상공장명", 18
	ggoSpread.SSSetEdit		C_ChildItemCd,		"자품목", 12
	ggoSpread.SSSetEdit		C_ItemNm,			"자품목명", 20
	ggoSpread.SSSetEdit		C_ErrorCd,			"Error Cd", 12
	ggoSpread.SSSetEdit		C_ErrorDesc,		"Error Message", 40

	Call ggoSpread.SSSetColHidden(vspdData.MaxCols,vspdData.MaxCols, True)
	Call ggoSpread.SSSetColHidden(C_ErrorCd,C_ErrorCd, True)
...
<TABLE CELLSPACING=0 CLASS="basicTB">
	...
	<TR>
		<TD HEIGHT=100%>
			<script language =javascript src='./js/p1714pa2_vspdData_vspdData.js'></script>
		</TD>
	</TR>
	<TR>
		<TD HEIGHT=30>
