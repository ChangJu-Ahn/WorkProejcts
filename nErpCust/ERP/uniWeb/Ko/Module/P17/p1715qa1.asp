...
'*  2. Function Name        : 
'*  3. Program ID           : p1715qa1.asp
'*  4. Program Name         : 설계BOM집약정전개 조회 
'*  5. Program Desc         :
'*  6. Component List        : 
...
<SCRIPT LANGUAGE = "VBScript" SRC = "p1715qa1.vbs"></SCRIPT>
									...
									<TD CLASS=TD6 NOWRAP>
										<TABLE CELLPADDING=0 CELLSPACING=0>
											<TR>
												...
												<TD>
													&nbsp;<INPUT TYPE=TEXT NAME="txtBasicUnit" SIZE=5 MAXLENGTH=3 tag="24" STYLE="Text-Transform: uppercase" ALT="기준단위">
												</TD>
											</TR>
										</TABLE>
									</TD>									
...
<INPUT TYPE=HIDDEN NAME="txtBomNo1" tag="24">
</FORM>
