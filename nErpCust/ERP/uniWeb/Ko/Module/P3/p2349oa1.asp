...
'*  1. Module Name          : 
'*  2. Function Name        : 
'*  3. Program ID           : p2349oa1.asp
'*  4. Program Name         : MRP요청출력 
'*  5. Program Desc         :
'*  6. Comproxy List        : 
...
Sub InitComboBox()
    ...
    Call SetCombo(frm1.cboStatus , "SO", "수주")
	Call SetCombo(frm1.cboStatus, "MP", "MPS")
	Call SetCombo(frm1.cboStatus, "OD", "예약")
					...
					<TD>
						<TABLE ID="MyTab" CELLSPACING=0 CELLPADDING=0>
							<TR>
								...
								<td background="../../../CShared/image/table/seltab_up_bg.gif" align="center" CLASS="CLSMTABP"><font color=white>MRP요청출력</font></td>
