...
'*  1. Module Name          : 
'*  2. Function Name        : 
'*  3. Program ID           : p2352oa1.asp
'*  4. Program Name         : MRP전개결과출력 
'*  5. Program Desc         :
'*  6. Comproxy List        : 
					...
					<TD>
						<TABLE ID="MyTab" CELLSPACING=0 CELLPADDING=0>
							<TR>
								...
								<td background="../../../CShared/image/table/seltab_up_bg.gif" align="center" CLASS="CLSMTABP"><font color=white>MRP전개결과출력</font></td>
