...
'*  4. Program Name         :																			*
'*  5. Program Desc         : MRP Run No. Popup															*
'*  6. Comproxy List        :																			*
'*  7. Modified date(First) : 2000/04/19																*
'*  8. Modified date(Last)  : 2002/11/28																*
...
Const BIZ_PGM_QRY_ID	= "p2313pb1.asp"				 '☆: 비지니스 로직 ASP명 
...
Sub InitSpreadSheet()
	...
	ggoSpread.SSSetDate 	C_Date, "일자", 20, 2, PopupParent.gDateFormat
