					...
					<TD>
						<TABLE ID="MyTab" CELLSPACING=0 CELLPADDING=0>
							<TR>
								...
								<td background="../../../CShared/image/table/seltab_up_bg.gif" align="center" CLASS="CLSMTAB"><font color=white>MRP승인/전개취소</font></td>
	...
	<TR HEIGHT=20>
		<TD WIDTH=100%>
			<TABLE <%=LR_SPACE_TYPE_30%>>
				<TR>
					<TD WIDTH=10>&nbsp;</TD>	
					<TD><BUTTON NAME="btnApprove" CLASS="CLSMBTN" Flag=1 onclick="ApproveMRP()">MRP 승인</BUTTON>&nbsp;<BUTTON NAME="btnCancel" CLASS="CLSMBTN" Flag=1 onclick="CancelMRP()">MRP 전개취소</BUTTON></TD>
				</TR>
			</TABLE>
		</TD>
	</TR>							
