...
'*  3. Program ID			: p2345ra1																			*
'*  4. Program Name			:																			*
'*  5. Program Desc			: 에러내역Reference Popup															*
...
Sub InitSpreadSheet()
    ...
    ggoSpread.SSSetEdit C_Error, "에러", 25    
    ggoSpread.SSSetDate C_StartPlanDt, "시작일", 11,2, PopupParent.gDateFormat
    ggoSpread.SSSetDate C_EndPlanDt, "종료일", 11,2, PopupParent.gDateFormat
    ggoSpread.SSSetEdit C_PlanOrderNo, "계획 ORDER NO.", 18
...
Sub GetSpreadColumnPos(ByVal pvSpdNo)
    ...
    Select Case UCase(pvSpdNo)
       Case "A"
			...
			C_StartPlanDt	= iCurColumnPos(4)
			C_EndPlanDt		= iCurColumnPos(5)
			C_PlanOrderNo	= iCurColumnPos(6)
...
Function DbQuery()
    ...
    strVal = strVal & "&lgMrpRunNo=" & lgMrpRunNo
...
<TABLE CELLSPACING=0 CLASS="basicTB">
	...
	<TR>
		<TD HEIGHT=100%>
			<script language =javascript src='./js/p2345ra1_vspdData_vspdData.js'></script>
		</TD>
	</TR>
	<TR>
		<TD HEIGHT=30>
