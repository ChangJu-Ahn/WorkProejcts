...
'*  1. Module Name          : 
'*  2. Function Name        : 
'*  3. Program ID           : p2353oa1.asp
'*  4. Program Name         : MRP전개근거출력 
'*  5. Program Desc         :
'*  6. Comproxy List        : 
...
Function BtnPreview() 
	...
	strUrl = "plant_cd|" & var1 
	If frm1.rdoPrintType3.checked = False Then
		strUrl = strUrl & "|factor1|" & var2
		strUrl = strUrl & "|factor2|" & var8
	End If
					...
					<TD>
						<TABLE ID="MyTab" CELLSPACING=0 CELLPADDING=0>
							<TR>
								...
								<td background="../../../CShared/image/table/seltab_up_bg.gif" align="center" CLASS="CLSMTABP"><font color=white>MRP전개근거출력</font></td>
						...
						<FIELDSET CLASS="CLSFLD">
							<TABLE WIDTH=100% CELLSPACING=0 CELLPADDING=2>
								...
								<TR>
									...
									<TD CLASS=TD6 NOWRAP><SELECT NAME="cboProdMgr" ALT="생산담당" STYLE="Width: 98px;" tag="X1XXXU"><OPTION VALUE=""></OPTION></SELECT></TD>
								</TR>
								<TR>
									<TD CLASS=TD5 NOWRAP>구매조직</TD>
									<TD CLASS=TD6 NOWRAP><INPUT TYPE=TEXT NAME="txtPurOrg" SIZE=15 MAXLENGTH=4 tag="X4XXXU" ALT="구매조직"><IMG SRC="../../../CShared/image/btnPopup.gif" NAME="btnPurOrg" align=top TYPE="BUTTON" ONCLICK="vbscript:OpenPurOrg()">&nbsp;<INPUT TYPE=HIDDEN NAME="txtPurOrgNm" SIZE=30 tag="X4"></TD>
								</TR>
								<TR>	
					    ...
					    <FIELDSET CLASS="CLSFLD">
					        <TABLE WIDTH=100% CELLSPACING=0 CELLPADDING=2>
								<TR>
									...
									<TD CLASS=TD6 NOWRAP><INPUT TYPE="RADIO" NAME="rdoPrintType" ID="rdoPrintType1" CLASS="RADIO" CHECKED><LABEL FOR="rdoPrintType1">생산</LABEL>
													     <INPUT TYPE="RADIO" NAME="rdoPrintType" ID="rdoPrintType2" CLASS="RADIO" ><LABEL FOR="rdoPrintType2">구매</LABEL>
														 <INPUT TYPE="RADIO" NAME="rdoPrintType" ID="rdoPrintType3" CLASS="RADIO" ><LABEL FOR="rdoPrintType3">전체</LABEL></TD>
								</TR>
					        </TABLE>
					    </FIELDSET>
					</TD>
