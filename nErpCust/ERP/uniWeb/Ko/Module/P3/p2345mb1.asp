...
With parent
    ...
    .frm1.txtApproveDt.text		= "<%= UNIDateClientFormat(rs0("approve_dt")) %>"
    .frm1.txtApprover.value		= "<%= ConvSPChars(rs0("approver")) %>"
    .frm1.txtStartOrderNo.value = "<%= ConvSPChars(rs0("start_order_no")) %>"
    .frm1.txtEndOrderNo.value	= "<%= ConvSPChars(rs0("end_order_no")) %>"
    .frm1.txtConvQty.Text		= "<%= rs0("conv_order_qty") %>"
    .frm1.txtErrQty.Text		= "<%= rs0("error_qty") %>"
