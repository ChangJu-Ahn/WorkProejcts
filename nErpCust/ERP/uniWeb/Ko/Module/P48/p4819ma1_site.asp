...
*  2. Function Name        : ERP와 MES수불차이
*  3. Program ID           : p4819ma1_site
*  4. Program Name         : ERP와 MES수불차이조회
*  5. Program Desc         : 양마감후 공정별 품목별ERP와 MES수불차이 실적조회 
*  6. Comproxy List        :
*  7. Modified date(First) : 2011/05/01
...
'========================================================================================================
Const BIZ_PGM_ID = "p4819mb1_site.asp"                                      '비지니스 로직 ASP명
...
Const C_SHEETMAXROWS    = 8000	                                      '한 화면에 보여지는 최대갯수*1.5%>
Const C_SHEETMAXROWS_D  = 8000                                          '☆: Server에서 한번에 fetch할 최대 데이타 건수
...
Sub SetDefaultVal()
	...
	frm1.txtGlYear.text	= UniConvDateAToB(StartDate ,parent.gServerDateFormat,parent.gDateFormat) 


	Call ggoOper.FormatDate(frm1.txtGlYear, Parent.gDateFormat, 2)
	
    
	'frm1.txtGlYear.Year = strYear '& strMonth
...
Sub MakeKeyStream(pRow)
    ...
    Dim strQueryFg 'as string
    Dim strUserId  'as string
    Dim strZeroFg 'as string 
    Dim strZeroYN 
...
'	if frm1.queryFg1.checked = True Then
'		strQueryFg = "BS"	
'	End IF

    'strUserId = xmlDoc.selectSingleNode("/root/data/data_auth_usr_id").Text


	lgKeyStream   = frm1.txtGlYear.text & gColSep    
...
Sub InitSpreadSheet()
	...
	With frm1.vspdData	
		...
		.MaxCols = C_M05 + 1				   								    <%'☜: 최대 Columns의 항상 1개 증가시킴 %>
		...
		ggospread.SSSetEdit   C_ACCTCD   , "공장"   , 10 ', 2,, , 2 
		ggoSpread.SSSetEdit   C_ACCTNM   , "공정코드"     , 28      
		ggoSpread.SSSetEdit   C_TOT      , "공정명"   , 20      
		ggoSpread.SSSetEdit   C_M01      , "품목코드"     , 28 		
		ggoSpread.SSSetEdit   C_M02      , "품목명"     , 28 		
		ggoSpread.SSSetFloat  C_M03      , "ERP수량"   , 12, ggAmtOfMoneyNo,ggStrIntegeralPart, ggStrDeciPointPart,gComNum1000,gComNumDec	
		ggoSpread.SSSetFloat  C_M04      , "MES수량"   , 12, ggAmtOfMoneyNo,ggStrIntegeralPart, ggStrDeciPointPart,gComNum1000,gComNumDec	
		ggoSpread.SSSetFloat  C_M05      , "차이수량"   , 12, ggAmtOfMoneyNo,ggStrIntegeralPart, ggStrDeciPointPart,gComNum1000,gComNumDec		                             
		.ReDraw = true
...
Sub SetSpreadLock()
    With frm1
        ...
        ggoSpread.SpreadLock    C_ACCTCD, -1, C_M05
					...
					<TD CLASS="CLSMTABP">
						<TABLE ID="MyTab" CELLSPACING=0 CELLPADDING=0>
							<TR>
								...
								<td background="../../image/table/seltab_up_bg.gif" align="center" CLASS="CLSMTAB"><font color=white>MES간수불차이</font></td>
				...
				<TR>
					<TD HEIGHT=20 WIDTH=100%>
						...
						<TABLE <%=LR_SPACE_TYPE_40%>>
						    <TR>
                                <TD CLASS="TD5" NOWRAP>마감년월</TD>
								<TD CLASS="TD6" NOWRAP><SCRIPT LANGUAGE=JavaScript> ExternalWrite('<OBJECT CLASSID=<%=gCLSIDFPDT%> NAME="txtGlYear" CLASS="FPDTYYYYMM" tag="12" Title="FPDATETIME" ALT="년월" id=fpDateTime></OBJECT>');</SCRIPT></TD>
                            </TR>
