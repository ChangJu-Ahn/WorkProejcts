...
*  2. Function Name        : 양마감실적조회
*  3. Program ID           : p4818oa1_site
*  4. Program Name         : 양마감실적조회
*  5. Program Desc         : 양마감후 공정별 품목별 실적조회 
*  6. Comproxy List        :
...
'========================================================================================================
Const BIZ_PGM_ID = "p4818ob1_site.asp"                                      '비지니스 로직 ASP명
...
Sub InitSpreadSheet()
	...
	With frm1.vspdData	
		...
		.MaxCols = C_M02 + 1				   								    <%'☜: 최대 Columns의 항상 1개 증가시킴 %>
		...
		ggospread.SSSetEdit   C_ACCTCD   , "공정코드"   , 10 ', 2,, , 2 
		ggoSpread.SSSetEdit   C_ACCTNM   , "공정명"     , 28      
		ggoSpread.SSSetEdit   C_TOT      , "품목코드"   , 20      
		ggoSpread.SSSetEdit   C_M01      , "품목명"     , 28 		
		ggoSpread.SSSetFloat  C_M02      , "실적수량"   , 12, ggAmtOfMoneyNo,ggStrIntegeralPart, ggStrDeciPointPart,gComNum1000,gComNumDec		
...
Sub SetSpreadLock()
    With frm1
        ...
        ggoSpread.SpreadLock    C_ACCTCD, -1, C_M02
					...
					<TD CLASS="CLSMTABP">
						<TABLE ID="MyTab" CELLSPACING=0 CELLPADDING=0>
							<TR>
								...
								<td background="../../image/table/seltab_up_bg.gif" align="center" CLASS="CLSMTAB"><font color=white>양마감 실적조회</font></td>
