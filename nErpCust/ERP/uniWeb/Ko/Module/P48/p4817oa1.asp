...
'*  2. Function Name        : 
'*  3. Program ID           : p4817oa1.asp
'*  4. Program Name         : Month/Day Mfg. Plan & Prod.Report   
'*  5. Program Desc         : Month/Day Mfg. Plan & Prod.Report
'*  6. Comproxy List        : 
'*  7. Modified date(First) : 2002/09/11
					...
					<TD>
						<TABLE ID="MyTab" CELLSPACING=0 CELLPADDING=0>
							<TR>
								...
								<td background="../../image/table/seltab_up_bg.gif" align="center" CLASS="CLSMTABP"><font color=white>제조계획 vs. 제조실적출력</font></td>
						...
						<FIELDSET CLASS="CLSFLD">
							<TABLE WIDTH=100% CELLSPACING=0 CELLPADDING=0>
								...
								<TR>	
									...
									<TD CLASS="TD6" NOWRAP>
													<SELECT Name="cboYear" STYLE="WIDTH=80" tag="X2XXXU"></SELECT>&nbsp;
