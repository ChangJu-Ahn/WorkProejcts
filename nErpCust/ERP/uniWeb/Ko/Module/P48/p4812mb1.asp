...
'*  2. Function Name        : 
'*  3. Program ID           : p4812mb1.asp
'*  4. Program Name         : Called By p4812ma1
'*  5. Program Desc         : Monthly MPS Plan & Prod. results
...
Dim strItemGroupCd
	...
	Select Case strQryMode
		...
		Case CStr(OPMD_UMODE) 
			UNIValue(0, 3) = FilterVar(UCase(iStrPrevKey), "''", "S")
	End Select
	UNIValue(0, 4) = strItemGroupCd
