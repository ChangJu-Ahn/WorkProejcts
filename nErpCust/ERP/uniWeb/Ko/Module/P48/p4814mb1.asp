...
'*  2. Function Name        : 
'*  3. Program ID           : p4814mb1.asp
'*  4. Program Name         : Called By p4814ma1
'*  5. Program Desc         : Monthly Mfg. Plan & Prod. results
...
iLngMaxRows = Request("txtMaxRows")
	...
	Select Case strQryMode
		...
		Case CStr(OPMD_UMODE) 
			UNIValue(0, 3) = FilterVar(iStrPrevKey, "''", "S")
	End Select
