...
'*  1. Module Name          : 
'*  2. Function Name        : 
'*  3. Program ID		    : zc010ma1.asp
'*  4. Program Name         : 선택이동항목등록 
'*  5. Program Desc         : 
'*  6. Component List       : 
...
Const BIZ_PGM_ID = "ZC010mb1.asp"			'☆: 비지니스 로직 ASP명 
'==========================================================================================================
'⊙: Grid Columns
Dim C_MItemCD
Dim C_MItemNM
...
Dim C_MItemTblPopUp
Dim C_ColmID
Dim C_MItemColmPopUp1
Dim C_ColmIDNM
Dim C_MItemColmPopUp2
Dim C_MAJORCD
Dim C_MAJORPOPUP
Dim C_MAJORNM
Dim C_KeyColm1
Dim C_MItemColmPopUp3
Dim C_DataTypeCd1
Dim C_DataTypeNm1
Dim C_KeyColm2	
Dim C_MItemColmPopUp4
Dim C_DataTypeCd2
Dim C_DataTypeNm2
Dim C_KeyColm3
Dim C_MItemColmPopUp5
Dim C_DataTypeCd3
Dim C_DataTypeNm3
Dim C_KeyColm4
Dim C_MItemColmPopUp6
Dim C_DataTypeCd4
Dim C_DataTypeNm4
Dim C_KeyColm5
Dim C_MItemColmPopUp7
Dim C_DataTypeCd5
Dim C_DataTypeNm5
...
Sub InitSpreadPosVariables()
    ...
    C_MItemTblPopUp		= 8
	C_ColmID			= 9
    C_MItemColmPopUp1	= 10
	C_ColmIDNM			= 11
    C_MItemColmPopUp2	= 12
	C_MAJORCD			= 13
	C_MAJORPOPUP		= 14
	C_MAJORNM			= 15
	C_KeyColm1			= 16
    C_MItemColmPopUp3	= 17
	C_DataTypeCd1		= 18
	C_DataTypeNm1		= 19
	C_KeyColm2			= 20
    C_MItemColmPopUp4	= 21
	C_DataTypeCd2		= 22
	C_DataTypeNm2		= 23
	C_KeyColm3			= 24
    C_MItemColmPopUp5	= 25
	C_DataTypeCd3		= 26
	C_DataTypeNm3		= 27
	C_KeyColm4			= 28
    C_MItemColmPopUp6	= 29
	C_DataTypeCd4		= 30
	C_DataTypeNm4		= 31
	C_KeyColm5			= 32
    C_MItemColmPopUp7	= 33
	C_DataTypeCd5		= 34
	C_DataTypeNm5		= 35
End Sub
...
Sub InitSpreadSheet()
	...
	With frm1.vspdData
		...
		ggoSpread.SSSetEdit		C_MItemCD        ,"이동선택항목코드"  , 10, , , 10
		ggoSpread.SSSetEdit		C_MItemNM        ,"이동선택항목명"    , 20, , , 30
		ggoSpread.SSSetEdit		C_MItemEngNM     ,"이동선택항목영문명", 20, , , 50
...
'		Call AppendNumberPlace("6","3","0")
        ...
        ggoSpread.SSSetButton   C_MItemTblPopUp 'jsk add

		ggoSpread.SSSetEdit		C_ColmID        ,"컬럼ID"        , 20, , , 32, 2
        ggoSpread.SSSetButton   C_MItemColmPopUp1 'jsk add

		ggoSpread.SSSetEdit		C_ColmIDNM      ,"컬럼명ID"      , 20, , , 32, 2
        ggoSpread.SSSetButton   C_MItemColmPopUp2 'jsk add
        ...
        ggoSpread.SSSetButton   C_MItemColmPopUp3 'jsk add
        ...
        ggoSpread.SSSetButton   C_MItemColmPopUp4 'jsk add
        ...
        ggoSpread.SSSetButton   C_MItemColmPopUp5 'jsk add
        ...
        ggoSpread.SSSetButton   C_MItemColmPopUp6 'jsk add
        ...
        ggoSpread.SSSetButton   C_MItemColmPopUp7 'jsk add
		ggoSpread.SSSetCombo	C_DataTypeCd5   ,"자료유형5"     , 15
		ggoSpread.SSSetCombo	C_DataTypeNm5   ,"자료유형5"     , 15

		Call ggoSpread.MakePairsColumn(C_TblID,C_MItemTblPopUp,"1")
		Call ggoSpread.MakePairsColumn(C_MAJORCD,C_MAJORPOPUP,"1")
		Call ggoSpread.MakePairsColumn(C_ColmIDNM,C_MItemColmPopUp2,"1")
		Call ggoSpread.MakePairsColumn(C_KeyColm1,C_MItemColmPopUp3,"1")
		Call ggoSpread.MakePairsColumn(C_KeyColm2,C_MItemColmPopUp4,"1")
		Call ggoSpread.MakePairsColumn(C_KeyColm3,C_MItemColmPopUp5,"1")
		Call ggoSpread.MakePairsColumn(C_KeyColm4,C_MItemColmPopUp6,"1")
		Call ggoSpread.MakePairsColumn(C_KeyColm5,C_MItemColmPopUp7,"1")
...
Sub SetSpreadLock()
    With frm1.vspdData
		...
		ggoSpread.SpreadLock C_MItemCD   , -1, C_MItemCD
		ggoSpread.SpreadLock C_MItemNM   , -1, C_MItemNM
		ggoSpread.SpreadLock C_MItemEngNM, -1, C_MItemEngNM
...
Sub SetSpreadColor(ByVal pvStartRow, ByVal pvEndRow)
    With frm1
		...
		ggoSpread.SSSetRequired  C_MItemCD,    pvStartRow, pvEndRow	' 관리항목코드 
		ggoSpread.SSSetRequired  C_MItemNM,    pvStartRow, pvEndRow	' 관리항목명 
		ggoSpread.SSSetRequired  C_MItemEngNM, pvStartRow, pvEndRow	' 관리항목영문명 
...
Sub InitComboBox()
	...
	'자료유형(Data Type)
	Call CommonQueryRs("MINOR_CD, MINOR_NM", "B_MINOR", "MAJOR_CD='A1018'", lgF0, lgF1, lgF2, lgF3, lgF4, lgF5, lgF6)    
	iCodeArr = vbTab & lgF0
    iNameArr = vbTab & lgF1
...
Sub GetSpreadColumnPos(ByVal pvSpdNo)
    ...
    Select Case UCase(pvSpdNo)
       Case "A"
			...
			C_MItemCD			= iCurColumnPos(1) 
			C_MItemNM			= iCurColumnPos(2) 
			C_MItemEngNM		= iCurColumnPos(3) 
			C_DataTypeCd		= iCurColumnPos(4) 
			C_DataTypeNm		= iCurColumnPos(5) 
			C_DataLen			= iCurColumnPos(6) 
			C_TblID				= iCurColumnPos(7) 
			C_MItemTblPopUp		= iCurColumnPos(8) 
			C_ColmID			= iCurColumnPos(9)
			C_MItemColmPopUp1	= iCurColumnPos(10)
			C_ColmIDNM			= iCurColumnPos(11)
			C_MItemColmPopUp2	= iCurColumnPos(12)
			C_MAJORCD			= iCurColumnPos(13)
			C_MAJORPOPUP		= iCurColumnPos(14)
			C_MAJORNM			= iCurColumnPos(15)
			C_KeyColm1			= iCurColumnPos(16)
			C_MItemColmPopUp3	= iCurColumnPos(17)
			C_DataTypeCd1		= iCurColumnPos(18)
			C_DataTypeNm1		= iCurColumnPos(19)
			C_KeyColm2			= iCurColumnPos(20)
			C_MItemColmPopUp4	= iCurColumnPos(21)
			C_DataTypeCd2		= iCurColumnPos(22)
			C_DataTypeNm2		= iCurColumnPos(23)
			C_KeyColm3			= iCurColumnPos(24)
			C_MItemColmPopUp5	= iCurColumnPos(25)
			C_DataTypeCd3		= iCurColumnPos(26)
			C_DataTypeNm3		= iCurColumnPos(27)
			C_KeyColm4			= iCurColumnPos(28)
			C_MItemColmPopUp6	= iCurColumnPos(29)
			C_DataTypeCd4		= iCurColumnPos(30)
			C_DataTypeNm4		= iCurColumnPos(31)
			C_KeyColm5			= iCurColumnPos(32)
			C_MItemColmPopUp7	= iCurColumnPos(33)
			C_DataTypeCd5		= iCurColumnPos(34)
			C_DataTypeNm5		= iCurColumnPos(35)
    End Select
End Sub
...
Function OpenPopUp(Byval strCode, Byval iWhere)
	...
	Select Case iWhere
		Case 0
			arrParam(0) = "선택이동항목 팝업"			' 팝업 명칭 
			arrParam(1) = "Z_MOVE_ITEM" 				' TABLE 명칭 
			arrParam(2) = strCode						' Code Condition
			arrParam(3) = ""							' Name Cindition
			arrParam(4) = ""							' Where Condition
			arrParam(5) = "관리항목"				' 조건필드의 라벨 명칭 

			arrField(0) = "MOVE_ITEM_CD"						' Field명(0)
			arrField(1) = "MOVE_ITEM_NM"						' Field명(1)
			arrField(2) = "MOVE_ITEM_ENG_NM"					' Field명(2)

			arrHeader(0) = "선택이동항목코드"			' Header명(0)
			arrHeader(1) = "선택이동항목명"				' Header명(1)
			arrHeader(2) = "선택이동항목영문명"			' Header명(2)
		Case 1
		...
		Case 3
			arrParam(0) = "필드명 팝업"
			arrParam(1) = "SYSCOLUMNS A(NOLOCK), SYSTYPES B(NOLOCK)"
			arrParam(2) = strCode
			arrParam(3) = ""

			frm1.vspdData.Col = C_TblID
			frm1.vspdData.row = frm1.vspdData.ActiveRow
			arrParam(4) = "A.XTYPE = B.XTYPE AND A.ID = (SELECT id FROM SYSOBJECTS  WHERE (XTYPE = 'U' OR XTYPE = 'V')  and name = " & FilterVar(UCASE(Trim(frm1.vspdData.text)),"''","S") & ")"
			arrParam(5) = "필드명"
		...
		Case 3, 4, 6, 7, 8, 9, 10
			...
			frm1.vspdData.Col = C_TblID
			frm1.vspdData.row = frm1.vspdData.ActiveRow
			arrParam(4) = "A.XTYPE = B.XTYPE AND A.ID = (SELECT id FROM SYSOBJECTS  WHERE (XTYPE = 'U' OR XTYPE = 'V')  and name = " & FilterVar(UCASE(Trim(frm1.vspdData.text)),"''","S") & ")"   ' Where Condition
			arrParam(5) = "필드명"
...
Function SetPopUp(Byval arrRet, Byval iWhere)
	...
	With frm1
		Select Case iWhere
			Case 0
				.txtMItemCd.value = Trim(arrRet(0))
				.txtMItemNm.value = arrRet(1)
			Case 1
...
Sub vspdData_ButtonClicked(ByVal Col, ByVal Row, Byval ButtonDown)
    ...
    With frm1
        Select Case Col
            Case C_MItemTblPopUp '테이블ID
                .vspdData.Col = Col-1
                .vspdData.Row = Row
                Call OpenPopUp(.vspdData.Text, 2)
            Case C_MItemColmPopUp1 '컬럼ID
                .vspdData.Col = Col-1
                .vspdData.Row = Row
                Call OpenPopUp(.vspdData.Text, 3)
            Case C_MItemColmPopUp2 '컬럼명ID
                .vspdData.Col = Col-1
                .vspdData.Row = Row
            ...
            Case C_MItemColmPopUp3 'Key컬럼1
                .vspdData.Col = Col-1
                .vspdData.Row = Row
                Call OpenPopUp(.vspdData.Text, 6)
            Case C_MItemColmPopUp4 'Key컬럼2
                .vspdData.Col = Col-1
                .vspdData.Row = Row
                Call OpenPopUp(.vspdData.Text, 7)
            Case C_MItemColmPopUp5 'Key컬럼3
                .vspdData.Col = Col-1
                .vspdData.Row = Row
                Call OpenPopUp(.vspdData.Text, 8)
            Case C_MItemColmPopUp6 'Key컬럼4
                .vspdData.Col = Col-1
                .vspdData.Row = Row
                Call OpenPopUp(.vspdData.Text, 9)
            Case C_MItemColmPopUp7 'Key컬럼5
                .vspdData.Col = Col-1
                .vspdData.Row = Row
...
Function DbQuery() 
    ...
    With frm1
	    If lgIntFlgMode = Parent.OPMD_UMODE Then
			...
			strVal = strVal & "&txtMItemCd=" & Trim(.hMItemCd.value)	'조회 조건 데이타 
			strVal = strVal & "&lgStrPrevKey=" & lgStrPrevKey
			strVal = strVal & "&txtMaxRows=" & .vspdData.MaxRows
		Else
			strVal = BIZ_PGM_ID & "?txtMode=" & Parent.UID_M0001
			strVal = strVal & "&txtMItemCd=" & Trim(.txtMItemCd.value)	'조회 조건 데이타 
			strVal = strVal & "&lgStrPrevKey=" & lgStrPrevKey
			strVal = strVal & "&txtMaxRows=" & .vspdData.MaxRows
		End If
...
Function DbQuery_Seven(ByVal Row)
    ...
    With frm1
        ...
        strWhere =  " o.name =" & FilterVar(trim(UCASE(Trim(strTableName))),"''","S") 
        ...
        strWhere = strWhere & " and  (o.XTYPE = 'U' OR o.XTYPE = 'V')  "
        strWhere = strWhere & " and (c.name = index_col ( " & FilterVar(trim(UCASE(Trim(strTableName))),"''","S") & ", i.indid,  1) or "
        strWhere = strWhere & "      c.name = index_col ( " & FilterVar(trim(UCASE(Trim(strTableName))),"''","S") & ", i.indid,  2) or "
        strWhere = strWhere & "      c.name = index_col ( " & FilterVar(trim(UCASE(Trim(strTableName))),"''","S") & ", i.indid,  3) or "
        strWhere = strWhere & "      c.name = index_col ( " & FilterVar(trim(UCASE(Trim(strTableName))),"''","S") & ", i.indid,  4) or "
        strWhere = strWhere & "      c.name = index_col ( " & FilterVar(trim(UCASE(Trim(strTableName))),"''","S") & ", i.indid,  5) or "
        strWhere = strWhere & "      c.name = index_col ( " & FilterVar(trim(UCASE(Trim(strTableName))),"''","S") & ", i.indid,  6) or "
        strWhere = strWhere & "      c.name = index_col ( " & FilterVar(trim(UCASE(Trim(strTableName))),"''","S") & ", i.indid,  7) or "
        strWhere = strWhere & "      c.name = index_col ( " & FilterVar(trim(UCASE(Trim(strTableName))),"''","S") & ", i.indid,  8) or "
        strWhere = strWhere & "      c.name = index_col ( " & FilterVar(trim(UCASE(Trim(strTableName))),"''","S") & ", i.indid,  9) or "
        strWhere = strWhere & "      c.name = index_col ( " & FilterVar(trim(UCASE(Trim(strTableName))),"''","S") & ", i.indid, 10) or "
        strWhere = strWhere & "      c.name = index_col ( " & FilterVar(trim(UCASE(Trim(strTableName))),"''","S") & ", i.indid, 11) or "
        strWhere = strWhere & "      c.name = index_col ( " & FilterVar(trim(UCASE(Trim(strTableName))),"''","S") & ", i.indid, 12) or "
        strWhere = strWhere & "      c.name = index_col ( " & FilterVar(trim(UCASE(Trim(strTableName))),"''","S") & ", i.indid, 13) or "
        strWhere = strWhere & "      c.name = index_col ( " & FilterVar(trim(UCASE(Trim(strTableName))),"''","S") & ", i.indid, 14) or "
        strWhere = strWhere & "      c.name = index_col ( " & FilterVar(trim(UCASE(Trim(strTableName))),"''","S") & ", i.indid, 15) or "
        strWhere = strWhere & "      c.name = index_col ( " & FilterVar(trim(UCASE(Trim(strTableName))),"''","S") & ", i.indid, 16)    "
        strWhere = strWhere & "      )                                              "
		...
		For IRow = 1 To .vspdData.MaxRows
		    ...
		    Select Case .vspdData.Text
		        Case ggoSpread.InsertFlag															'☜: 신규 
		            ...
		            .vspdData.Col = C_MItemCD
		            strVal = strVal & Trim(.vspdData.Text) & Parent.gColSep
		            .vspdData.Col = C_MItemNM
		            strVal = strVal & Trim(.vspdData.Text) & Parent.gColSep
		            .vspdData.Col = C_MItemEngNM
		            strVal = strVal & Trim(.vspdData.Text) & Parent.gColSep
		            .vspdData.Col = C_DataTypeCd
		            strVal = strVal & Trim(.vspdData.Text) & Parent.gColSep
		            .vspdData.Col = C_DataLen
					...
					<TD CLASS="CLSMTABP">
						<TABLE ID="MyTab" CELLSPACING=0 CELLPADDING=0>
							<TR>
								...
								<td background="../../../CShared/image/table/seltab_up_bg.gIf" align="center" CLASS="CLSMTABP"><font color=white>선택이동항목등록</font></td>
					...
					<TD HEIGHT=20 WIDTH=100%>
						<FIELDSET CLASS="CLSFLD">
							<TABLE WIDTH=100%  CELLSPACING=0>
								<TR>
									<TD CLASS="TD5" NOWRAP>선택이동항목</TD>
									<TD CLASS="TD656" NOWRAP><INPUT NAME="txtMItemCD" MAXLENGTH="10" SIZE=10 ALT ="선택이동항목" tag="1XNXXU"><IMG SRC="../../../CShared/image/btnPopup.gIf" NAME="btnCountryCd" ALIGN=top TYPE="BUTTON" ONCLICK="vbscript:Call OpenPopUp(frm1.txtMItemCD.Value, 0)">
													<INPUT NAME="txtMItemNM" MAXLENGTH="30" SIZE=20 ALT ="관리항목명" tag="14X"></TD>
								</TR>
							</TABLE>
						</FIELDSET>
					</TD>
				...
				<TR>
					<TD WIDTH=100% HEIGHT=* valign=top>
						<TABLE <%=LR_SPACE_TYPE_20%>>
							<TR>
								<TD HEIGHT="100%">
								<script language =javascript src='./js/zc010ma1_I994066685_vspdData.js'></script>
								</TD>
							</TR>
						</TABLE>
					</TD>
...
<INPUT TYPE=hidden NAME="hMItemCd" tag="24" tabindex="-1">
</FORM>
