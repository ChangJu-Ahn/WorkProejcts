...
'========================================================================================================
Const BIZ_PGM_ID		= "gh010mb1.asp"                                      'Biz Logic ASP 
...
Sub InitSpreadSheet()
	...
	With frm1.vspdData
       ...
       ggoSpread.SSSetEdit		C_ItemGrp		,"품목그룹명"		,18     ,					,						,40						,2
...
Sub GetSpreadColumnPos(ByVal pvSpdNo)
    ...
    Select Case UCase(pvSpdNo)
       Case "A"
			...
			C_Bp						= iCurColumnPos(10)			
			C_BpNm						= iCurColumnPos(11)			
			C_BillAmt					= iCurColumnPos(12)		
			C_BillCost					= iCurColumnPos(13)		
			C_BillProf					= iCurColumnPos(14)		
			C_SalesExp					= iCurColumnPos(15)		
			C_GenAdminExp				= iCurColumnPos(16)		
			C_SalesProf					= iCurColumnPos(17)		
			C_ExtSalesProf				= iCurColumnPos(18)		
			C_ExtSalesExp				= iCurColumnPos(19)		
			C_TotalCost					= iCurColumnPos(20)			
			C_OrdProf					= iCurColumnPos(21)		
			C_SPProf					= iCurColumnPos(22)		
			C_SPLoss					= iCurColumnPos(23)		
			C_TransProf					= iCurColumnPos(24)			
    End Select    
End Sub
'========================================================================================
					...
					<TD CLASS="CLSMTABP">
						<TABLE ID="MyTab" CELLSPACING=0 CELLPADDING=0>
							<TR>
								...
								<td background="../../../CShared/image/table/seltab_up_bg.gif" align="center" CLASS="CLSMTAB"><font color=white>품목그룹거래처별손익비교</font></td>
						...
						<FIELDSET CLASS="CLSFLD">
							<TABLE <%=LR_SPACE_TYPE_40%>>
								<TR>
                                    ...
                                    <TD CLASS=TD6 NOWRAP><script language =javascript src='./js/gh010ma1_txtFrYYYYMM_txtFrYYYYMM.js'></script> ~
                                                         <script language =javascript src='./js/gh010ma1_txtToYYYYMM_txtToYYYYMM.js'></script></TD>
						...
						<TABLE <%=LR_SPACE_TYPE_30%>>
							<TR>
								<TD HEIGHT="80%" COLSPAN=6>
									<script language =javascript src='./js/gh010ma1_OBJECT1_vspdData.js'></script>
								</TD>
							</TR>
							<TR>								
								<TD CLASS=TD5 NOWRAP>매출액합계</TD>
								<TD CLASS=TD6 ><script language =javascript src='./js/gh010ma1_totSalesAmt_totSalesAmt.js'></script></TD>
								<TD CLASS=TD5 NOWRAP>매출원가합계</TD>
								<TD CLASS=TD6 ><script language =javascript src='./js/gh010ma1_totCostAmt_totCostAmt.js'></script></TD>
								<TD CLASS=TD5 NOWRAP>매출이익합계</TD>
								<TD CLASS=TD6 ><script language =javascript src='./js/gh010ma1_totPorfitAmt_totPorfitAmt.js'></script></TD>
							</TR>
							<TR>
								<TD CLASS=TD5 NOWRAP>영업이익합계</TD>
								<TD CLASS=TD6 ><script language =javascript src='./js/gh010ma1_totSalesProfitAmt_totSalesProfitAmt.js'></script></TD>
								<TD CLASS=TD5 NOWRAP>경상이익합계</TD>
								<TD CLASS=TD6 ><script language =javascript src='./js/gh010ma1_totCurProfitAmt_totCurProfitAmt.js'></script></TD>
								<TD CLASS=TD5 NOWRAP>세전이익합계</TD>
								<TD CLASS=TD6 ><script language =javascript src='./js/gh010ma1_totNetProfitAmt_totNetProfitAmt.js'></script></TD>

							</TR>
							<TR>
								<TD CLASS=TD5 NOWRAP>총원가합계</TD>
								<TD CLASS=TD6 ><script language =javascript src='./js/gh010ma1_totTotCostAmt_totTotCostAmt.js'></script></TD>								
