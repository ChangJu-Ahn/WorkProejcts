...
*  1. Module Name          : 경영손익 
*  2. Function Name        : 
*  3. Program ID           : GH004MA1
*  4. Program Name         : 품목그룹별 배부 현황 
*  5. Program Desc         : 
*  6. Comproxy List        :
...
Const BIZ_PGM_ID      = "gh004mb1.asp"						           '☆: Biz Logic ASP Name
...
Const C_SHEETMAXROWS_D  = 1000                                          '☜: Fetch count at a time
'--------------------------------------------------------------------------------------------------------
...
Const C_SHEETMAXROWS_D1 = 1000                                         '☜: Fetch count at a time
...
Sub InitSpreadSheet()
	...
	With Frm1.vspdData
       ...
       ggoSpread.SSSetEdit  C_center     , "영업그룹"        ,15,   ,, 25,2
       ggoSpread.SSSetEdit  C_centerNm   , "영업그룹명"     ,25,   ,, 30    
       ggoSpread.SSSetFloat C_data       , "금       액"          ,20,    Parent.ggAmtOfMoneyNo ,ggStrIntegeralPart, ggStrDeciPointPart,Parent.gComNum1000,Parent.gComNumDec
...
Sub InitSpreadSheet1()
	...
	With Frm1.vspdData1
       ...
       ggoSpread.SSSetEdit  C_center1     , "품목그룹"         ,15,   ,, 25,2
       ggoSpread.SSSetEdit  C_centerNm1   , "품목그룹명"       ,25,   ,, 80    
       ggoSpread.SSSetFloat C_data1       , "금       액"      ,20,    Parent.ggAmtOfMoneyNo ,ggStrIntegeralPart, ggStrDeciPointPart,Parent.gComNum1000,Parent.gComNumDec       
					...
					<TD CLASS="CLSMTABP">
						<TABLE ID="MyTab" CELLSPACING=0 CELLPADDING=0>
							<TR>
								...
								<td background="../../../CShared/image/table/seltab_up_bg.gif" align="center" CLASS="CLSMTABP"><font color=white>품목그룹별 배부현황</font></td>
						...
						<FIELDSET CLASS="CLSFLD">
							<TABLE <%=LR_SPACE_TYPE_40%>>
								<TR>
									...
									<TD CLASS="TD6" NOWRAP>
										<script language =javascript src='./js/gh004ma1_fpDateTime3_fpdtWk_yymm.js'></script>										
									</TD>									
							...
							<TR>
								<TD WIDTH="50%">
									<TABLE  <%=LR_SPACE_TYPE_20%> CLASS="BasicTB" CELLSPACING=0>
										<TR>
										<TD  COLSPAN=3>
											<script language =javascript src='./js/gh004ma1_vaSpread1_vspdData.js'></script>
										</TD>
										</TR>
										<TR HEIGHT=20>
								            ...
								            <TD CLASS=TD6 NOWRAP>
									            <script language =javascript src='./js/gh004ma1_txtDataAmt_txtDataAmt.js'></script>
											</TD>
										</TR>
									</TABLE>
								</TD>
								<TD WIDTH="50%">
									<TABLE  <%=LR_SPACE_TYPE_20%> CLASS="BasicTB" CELLSPACING=0>
										<TR>
											<TD COLSPAN=3>
												<script language =javascript src='./js/gh004ma1_vaSpread2_vspdData1.js'></script>
											</TD>
										</TR>
										<TR HEIGHT=20>
										    <TD CLASS=TD6 NOWRAP>&nbsp;</TD>										    
											<TD CLASS=TD5 NOWRAP>합계</TD>								            
											<TD CLASS="TD6" >
												<script language =javascript src='./js/gh004ma1_txtDataAmt1_txtDataAmt1.js'></script></TD>			    	    		            			    	    		            
										</TR>										
									</TABLE>
								</TD>
							</TR>
