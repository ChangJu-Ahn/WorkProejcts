...
'========================================================================================================
Const BIZ_PGM_ID		= "gh009mb1.asp"                                      'Biz Logic ASP 
...
Sub GetSpreadColumnPos(ByVal pvSpdNo)
    ...
    Select Case UCase(pvSpdNo)
       Case "A"
			...
			C_BillAmt					= iCurColumnPos(10)		
			C_BillCost					= iCurColumnPos(11)		
			C_BillProf					= iCurColumnPos(12)		
			C_SalesExp					= iCurColumnPos(13)		
			C_GenAdminExp				= iCurColumnPos(14)		
			C_SalesProf					= iCurColumnPos(15)		
			C_ExtSalesProf				= iCurColumnPos(16)		
			C_ExtSalesExp				= iCurColumnPos(17)		
			C_TotalCost					= iCurColumnPos(18)			
			C_OrdProf					= iCurColumnPos(19)		
			C_SPProf					= iCurColumnPos(20)		
			C_SPLoss					= iCurColumnPos(21)		
			C_TransProf					= iCurColumnPos(22)			
    End Select    
End Sub
'========================================================================================
						...
						<FIELDSET CLASS="CLSFLD">
							<TABLE <%=LR_SPACE_TYPE_40%>>
								<TR>
                                    ...
                                    <TD CLASS=TD6 NOWRAP><script language =javascript src='./js/gh009ma1_txtFrYYYYMM_txtFrYYYYMM.js'></script> ~
                                                         <script language =javascript src='./js/gh009ma1_txtToYYYYMM_txtToYYYYMM.js'></script></TD>
						...
						<TABLE <%=LR_SPACE_TYPE_30%>>
							<TR>
								<TD HEIGHT="80%" COLSPAN=6>
									<script language =javascript src='./js/gh009ma1_OBJECT1_vspdData.js'></script>
								</TD>
							</TR>
							<TR>								
								<TD CLASS=TD5 NOWRAP>매출액합계</TD>
								<TD CLASS=TD6 ><script language =javascript src='./js/gh009ma1_totSalesAmt_totSalesAmt.js'></script></TD>
								<TD CLASS=TD5 NOWRAP>매출원가합계</TD>
								<TD CLASS=TD6 ><script language =javascript src='./js/gh009ma1_totCostAmt_totCostAmt.js'></script></TD>
								<TD CLASS=TD5 NOWRAP>매출이익합계</TD>
								<TD CLASS=TD6 ><script language =javascript src='./js/gh009ma1_totPorfitAmt_totPorfitAmt.js'></script></TD>
							</TR>
							<TR>
								<TD CLASS=TD5 NOWRAP>영업이익합계</TD>
								<TD CLASS=TD6 ><script language =javascript src='./js/gh009ma1_totSalesProfitAmt_totSalesProfitAmt.js'></script></TD>
								<TD CLASS=TD5 NOWRAP>경상이익합계</TD>
								<TD CLASS=TD6 ><script language =javascript src='./js/gh009ma1_totCurProfitAmt_totCurProfitAmt.js'></script></TD>
								<TD CLASS=TD5 NOWRAP>세전이익합계</TD>
								<TD CLASS=TD6 ><script language =javascript src='./js/gh009ma1_totNetProfitAmt_totNetProfitAmt.js'></script></TD>

							</TR>
							<TR>
								<TD CLASS=TD5 NOWRAP>총원가합계</TD>
								<TD CLASS=TD6 ><script language =javascript src='./js/gh009ma1_totTotCostAmt_totTotCostAmt.js'></script></TD>								
								<TD CLASS=TD5 NOWRAP></TD>
								<TD CLASS=TD6 ></TD>
								<TD CLASS=TD5 NOWRAP></TD>
								<TD CLASS=TD6 ></TD>
