...
Err.Clear
	...
	txtItemGroup	= Trim(lgKeyStream(2))
...
Sub FixUNISQLData()
    ...
    Redim UNIValue(1,17)                                                  '⊙: DB-Agent로 전송될 parameter를 위한 변수 
...
<Script Language=vbscript>
	...
	With Parent
	   ...
	   .frm1.txtDeptNm.value	= "<%=ConvSPChars(txtItemGroupNm)%>"
