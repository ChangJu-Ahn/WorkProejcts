...
*  1. Module Name          : 경영손익 
*  2. Function Name        :
*  3. Program ID           : GH007MA1
*  4. Program Name         : GH007MA1
...
Const BIZ_PGM_ID		= "GH007MB1.asp"						           '☆: Biz Logic ASP Name
Const BIZ_PGM_JUMP_ID	= "GH009MA1"
...
Function OpenCode()
	...
	arrParam(1) = "(select distinct item_group_cd as item_group_cd from g_item_group_profit where yyyymm between " & FilterVar(strYYYYMM, "''", "S") & " and " & FilterVar(strYYYYMM1, "''", "S") & " ) a left outer join b_item_group b on a.item_group_cd = b.item_group_cd " <%' TABLE 명칭 %>
						...
						<FIELDSET CLASS="CLSFLD">
							<TABLE <%=LR_SPACE_TYPE_40%>>
								<TR>
									...
									<TD NOWRAP  CLASS=TD6 NOWRAP><script language =javascript src='./js/gh007ma1_fpdtWk_yymm_fpdtWk_yymm.js'></script>~<script language =javascript src='./js/gh007ma1_fpdtWk_yymm1_fpdtWk_yymm1.js'></script></TD>
                                    <TD NOWRAP  CLASS=TD5 NOWRAP>품목그룹</TD>
									<TD NOWRAP  CLASS=TD6 NOWRAP>
									 <INPUT TYPE=TEXT NAME="txtDeptCd" SIZE=15 MAXLENGTH=18 tag="12XXXU" ALT="품목그룹코드"><IMG SRC="../../../CShared/image/btnPopup.gif" NAME="btnCode" ALIGN=top TYPE="BUTTON" ONCLICK="vbscript:OpenCode()">
						...
						<TABLE <%=LR_SPACE_TYPE_20%>>
							<TR>
								<TD NOWRAP  HEIGHT="100%">
									<script language =javascript src='./js/gh007ma1_vspdData_vspdData.js'></script>
								</TD>
							</TR>
						</TABLE>
					</TD>
