    ...
    Else
        ...
        Do While Not lgObjRs.EOF
            ...
            Select Case CStr(lgObjRs("MINOR_CD"))
                Case "12"
                    lgstrData = lgstrData & Chr(11) & "G_USP_GH020BA1"
                Case "13"
                    lgstrData = lgstrData & Chr(11) & "G_USP_GH020BA2"
                Case "14"
                    lgstrData = lgstrData & Chr(11) & "G_USP_GH020BA3"
            End Select
        ...
        Case "M"
           ...
           Select Case Mid(pDataType,2,1)
               ...
               Case "R"
                       ...
                       lgStrSQL = lgStrSQL & " AND B.SEQ_NO = " & FilterVar("5", "''", "S") & " "
