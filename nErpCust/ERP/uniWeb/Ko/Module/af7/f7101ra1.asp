...
'*  5. Program Desc         :
'*  6. Comproxy List        : 
'*  7. Modified date(First) : 2001/02/07
...
Const BIZ_PGM_ID 		= "f7101rb1.asp"                              '☆: Biz Logic ASP Name
...
Sub LoadInfTB19029()
	...
	<% Call LoadBNumericFormatA("Q", "A", "NOCOOKIE", "RA") %>	'------ Developer Coding part (End )   -------------------------------------------------------------- 
End Sub
...
Function FncSplitColumn()
    ...
    If ACol > iColumnLimit Then
		...
		iRet = PopupParent.DisplayMsgBox("900030", "X", Trim(frm1.vspdData.Text), "X")
       Exit Function
    End If   
...
Function DbQuery() 
    ...
    '--------- Developer Coding Part (Start) ----------------------------------------------------------
        ...
        Else
			...
			strVal = strVal & "&txtToPrNo="		& Trim(.txtToPrNo.value)
			strVal = strVal & "&txtBpCd="		& Trim(.txtBpCd.value)
			strVal = strVal & "&txtPrrcptType="	& Trim(.htxtPrrcptType.value)			
			strVal = strVal & "&txtBPCd_Alt=" & Trim(.txtBPCd.alt)
        End If   
			...
			<FIELDSET CLASS="CLSFLD">
				<TABLE <%=LR_SPACE_TYPE_40%>>
					<TR>				
						...
						<TD CLASS=TD6 NOWRAP>
							<INPUT TYPE="Text" NAME="txtFrPrNo" SIZE=15 MAXLENGTH=20 STYLE="TEXT-ALIGN: left" tag="1" ALT="시작선수금번호">&nbsp;~
							<INPUT TYPE="Text" NAME="txtToPrNo" SIZE=15 MAXLENGTH=20 STYLE="TEXT-ALIGN: left" tag="1" ALT="종료선수금번호">
						</TD>
					</TR>
					<TR>				
						<TD CLASS=TD5 NOWRAP>수금처코드</TD>
						<TD CLASS=TD6 NOWRAP>
							<INPUT NAME="txtBpCd" ALT="수금처코드" MAXLENGTH="10" SIZE=10 STYLE="TEXT-ALIGN: left" tag="11"><IMG SRC="../../../CShared/image/btnPopup.gif" NAME="btnCostCd" align=top TYPE="BUTTON" ONCLICK="vbscript:Call OpenPopup(frm1.txtBpCd.Value, 0)">
							<INPUT NAME="txtBpNm" ALT="수금처명" MAXLENGTH="20" SIZE=20 STYLE="TEXT-ALIGN: left" tag="14X">
						</TD>
						<TD CLASS="TD5" NOWRAP>선수금유형</TD>
						<TD CLASS="TD6" NOWRAP>
							<INPUT TYPE=TEXT NAME="txtPrrcptType" SIZE=10 MAXLENGTH=10  tag="11XXXU" ALT="선수금유형"><IMG SRC="../../../CShared/image/btnPopup.gif" NAME="btnPrpaymType" align=top TYPE="BUTTON"ONCLICK="vbscript:Call OpenPopup(frm1.txtPrrcptType.value, 1)">&nbsp;
							<INPUT TYPE=TEXT NAME="txtPrrcptTypeNm" SIZE=20 tag="14XXXU" ALT="선수금유형명"></TD>
					</TR>
				</TABLE>
			</FIELDSET>
		</TD>
...
<INPUT TYPE=HIDDEN NAME="htxtPrrcptType"tag="24" TABINDEX="-1">
</FORM>
