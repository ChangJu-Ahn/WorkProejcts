...
Sub  TrimData()
    ...
    '--------------- 개발자 coding part(실행로직,Start)----------------------------------------------------
     ...
     strPrRcptNoFr	 = UCase(Trim(Request("txtPrRcptNoFr")))
     strPrRcptNoTo	 = UCase(Trim(Request("txtPrRcptNoTo")))
     ...
     If strPrRcptNoFr <> "" Then
		strCond = strCond & " and A.PRRCPT_NO >=  " & FilterVar(strPrRcptNoFr , "''", "S") & ""
     End If
     
     If strPrRcptNoTo <> "" Then
		strCond = strCond & " and A.PRRCPT_NO <=  " & FilterVar(strPrRcptNoTo , "''", "S") & ""
     End If
...
<Script Language=vbscript>
    If "<%=lgDataExist%>" = "Yes" Then
       ...
       If "<%=lgPageNo%>" = "1" Then   ' "1" means that this query is first and next data exists
          ...
          Parent.Frm1.htxtPrRcptNoFr.Value		= Parent.Frm1.txtPrRcptNoFr.Value
          Parent.Frm1.htxtPrRcptNoTo.Value		= Parent.Frm1.txtPrRcptNoTo.Value
       End If
