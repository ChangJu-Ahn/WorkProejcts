...
'*  4. Program Name         : 선수금내역조회 
'*  5. Program Desc         : 선수금내역조회 
'*  6. Comproxy List        : +
...
Const C_MaxKey_B            = 2                                    '☆☆☆☆: Max key value
						...
						<FIELDSET CLASS="CLSFLD">
							<TABLE <%=LR_SPACE_TYPE_40%>>
			 					<TR>
									...
									<TD CLASS="TD6" NOWRAP><SCRIPT LANGUAGE=JavaScript> ExternalWrite('<OBJECT CLASSID=<%=gCLSIDFPDT%> name=txtFromDt CLASS=FPDTYYYYMMDD title=FPDATETIME ALT="시작일" tag="12X1" VIEWASTEXT id=fpDateTime1></OBJECT>');</SCRIPT>&nbsp;~&nbsp;<SCRIPT LANGUAGE=JavaScript> ExternalWrite('<OBJECT CLASSID=<%=gCLSIDFPDT%> name=txtToDt CLASS=FPDTYYYYMMDD title=FPDATETIME ALT="종료일" tag="12X1" VIEWASTEXT id=fpDateTime2></OBJECT>');</SCRIPT></TD>
								...
								<TR>
									...
									<TD CLASS="TD6" NOWRAP>
										<INPUT TYPE=TEXT NAME="txtPrrcptType" SIZE=10 MAXLENGTH=10  tag="11XXXU" ALT="선수금유형"><IMG SRC="../../../CShared/image/btnPopup.gif" NAME="btnPrpaymType" align=top TYPE="BUTTON"ONCLICK="vbscript:Call OpenPopup(frm1.txtPrrcptType.value, 2)">&nbsp;
										<INPUT TYPE=TEXT NAME="txtPrrcptTypeNm" SIZE=30 tag="14XXXU" ALT="선수금유형명"></TD>
