...
Sub TrimData()
	...
	strCond = strCond & " AND ((A.GL_NO <> '' AND A.prrcpt_sts = " & FilterVar("O", "''", "S") & "  AND A.conf_fg = " & FilterVar("C", "''", "S") & " ) OR A.prrcpt_no IN (SELECT distinct prrcpt_no FROM f_prrcpt_sttl )) " 
...
<Script Language=vbscript>
    If "<%=lgDataExist%>" = "Yes" Then
       ...
       Call Parent.ReFormatSpreadCellByCellByCurrency(Parent.Frm1.vspdData,<%=iPrevEndRow+1%>,<%=iEndRow%>,Parent.GetKeyPos("A",1),Parent.GetKeyPos("A",2),"A", "Q" ,"X","X")
       Call Parent.ReFormatSpreadCellByCellByCurrency(Parent.Frm1.vspdData,<%=iPrevEndRow+1%>,<%=iEndRow%>,Parent.GetKeyPos("A",1),Parent.GetKeyPos("A",3),"A", "Q" ,"X","X")
       Call Parent.ReFormatSpreadCellByCellByCurrency(Parent.Frm1.vspdData,<%=iPrevEndRow+1%>,<%=iEndRow%>,Parent.GetKeyPos("A",1),Parent.GetKeyPos("A",4),"A", "Q" ,"X","X")
