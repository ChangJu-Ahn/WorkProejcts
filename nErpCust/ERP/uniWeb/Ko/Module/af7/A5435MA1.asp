...
*  2. Function Name        : 
*  3. Program ID           : a5435ma1
*  4. Program Name         : Verify PRERECEIPT
*  5. Program Desc         : 
...
Const BIZ_PGM_ID      = "A5435MB1.asp"						           '☆: Biz Logic ASP Name
Const BIZ_PGM_ID1     = "A5435MB2.asp"	
Const BIZ_PGM_ID2     = "A5435MB3.asp"	
...
Sub SetDefaultVal()
	...
	frm1.txtPrFrDt.Text  = UniConvDateAToB(FirstDate, Parent.gServerDateFormat, Parent.gDateFormat)
	frm1.txtPrToDt.Text  = UniConvDateAToB(LastDate, Parent.gServerDateFormat, Parent.gDateFormat)
	...
	Select Case UCase(Trim(pvSpdNo))
		Case "A"
			With frm1.vspdData1
				...
				ggoSpread.SSSetFloat   C_PrLocAmt1         ,"선수금액(자국)"     ,15     ,Parent.ggAmtOfMoneyNo,ggStrIntegeralPart, ggStrDeciPointPart,Parent.gComNum1000,Parent.gComNumDec,1      ,True  
		...
		Case "B"
			With frm1.vspdData2
				...
				ggoSpread.SSSetEdit    C_AcctNm2           ,"계정코드명"         ,15    ,3
				                      'ColumnPosition     Header            Width   Grp                    IntegeralPart       DeciPointpart                             Align   Sep    PZ   Min       Max 
				ggoSpread.SSSetFloat   C_PrLocAmt2         ,"선수금액(자국)"     ,15     ,Parent.ggAmtOfMoneyNo,ggStrIntegeralPart, ggStrDeciPointPart,Parent.gComNum1000,Parent.gComNumDec,1      ,True  
		...
		Case "C"
			With frm1.vspdData3
				...
				ggoSpread.SSSetEdit    C_PrNo          ,"선수금번호"         ,15    ,2        ,     ,15     ,2
				ggoSpread.SSSetDate    C_PrDt          ,"선급일자"           ,10    ,2        ,Parent.gDateFormat   ,-1 
				ggoSpread.SSSetDate    C_GlDt          ,"회계전표일자"       ,10    ,2        ,Parent.gDateFormat   ,-1 
				                      'ColumnPosition     Header            Width   Grp                    IntegeralPart       DeciPointpart                             Align   Sep    PZ   Min       Max 
				
				ggoSpread.SSSetFloat   C_PrLocAmt3     ,"선수금액(자국)"     ,15     ,Parent.ggAmtOfMoneyNo,ggStrIntegeralPart, ggStrDeciPointPart,Parent.gComNum1000,Parent.gComNumDec,1      ,True 
				...
				ggoSpread.SSSetEdit    C_GLNo          ,"회계전표번호"       ,15    ,2        ,     ,18     ,2
				ggoSpread.SSSetEdit    C_TempGlNo      ,"결의전표번호"       ,15    ,0        ,     ,18     ,2				
				ggoSpread.SSSetEdit    C_BatchNO       ,"Batch 번호"         ,15    ,2        ,     ,18     ,2
				ggoSpread.SSSetDate    C_TempGlDt      ,"결의전표일자"       ,10    ,2        ,Parent.gDateFormat   ,-1 
				ggoSpread.SSSetEdit    C_PrType3       ,"전표입력경로"       , 5    ,         ,    ,10       ,2
				ggoSpread.SSSetEdit    C_PrTypeNm3     ,"전표입력경로명"     ,15    ,3				
				...
				Call ggoSpread.SSSetColHidden(C_PrType3,C_PrType3,True)			
				.ReDraw = True
    ...
    Select Case UCase(pvSpdNo)
       ...
       Case "B"
		...
		Case "C"
			...
			C_PrNo			    = iCurColumnPos(3)
			C_PrDt			    = iCurColumnPos(4)
			C_GlDt			    = iCurColumnPos(5)
			
			C_PrLocAmt3		    = iCurColumnPos(6)
			...
			C_PrType3			= iCurColumnPos(15)
			C_PrTypeNm3			= iCurColumnPos(16)
...
Function  OpenPopUp(Byval strCode, Byval iWhere)
	...
	Select Case iWhere
		...
		Case 1
			...
			arrParam(3)  = ""												' Name Cindition
			arrParam(4)  = "ACCT_TYPE = " & FilterVar("G3", "''", "S") & "  "								' Where Condition
			arrParam(5)  = "계정코드"			
		...
		Case 3
			...
			arrParam(1) = " f_prrcpt a , b_minor b "						' TABLE 명칭 
			arrParam(2) = strCode						 					' Code Condition
			arrParam(3) = ""												' Name Condition
			arrParam(4) = " b.major_cd=" & FilterVar("A1001", "''", "S") & "  and a.prrcpt_fg=b.minor_cd " ' Where Condition
			arrParam(5) = "전표입력경로"			
			arrField(0) = "a.prrcpt_fg "									' Field명(0)
...
Function DbQuery(pDirect)
    ...
    strVal = strVal		& "&txtPrFrDt="      & frm1.txtPrFrDt.text								'☜:
    strVal = strVal		& "&txtPrToDt="      & frm1.txtPrToDt.text								'☜:
...
Sub DoSum()
	...
	Select Case gSelframeFlg
		Case TAB1
			With frm1.vspdData1
				dbTotPrLocAmt		= FncSumSheet(frm1.vspdData1,C_PrLocAmt1, 1, .MaxRows, False, -1, -1, "V")
				...
				frm1.txtTotPrLocAmt1.text = UNIConvNumPCToCompanyByCurrency(dbTotPrLocAmt,parent.gCurrency,parent.ggAmtOfMoneyNo, parent.gLocRndPolicyNo, "X")
		...
		Case TAB2
			With frm1.vspdData2
				dbTotPrLocAmt		= FncSumSheet(frm1.vspdData2,C_PrLocAmt2, 1, .MaxRows, False, -1, -1, "V")
				...
				frm1.txtTotPrLocAmt2.text = UNIConvNumPCToCompanyByCurrency(dbTotPrLocAmt,parent.gCurrency,parent.ggAmtOfMoneyNo, parent.gLocRndPolicyNo, "X")
...
'========================================================================================================
' Name : txtPrFrDt_DblClick
' Desc : developer describe this line
'========================================================================================================
Sub txtPrFrDt_DblClick(Button)
    If Button = 1 Then
		frm1.txtPrFrDt.Action = 7                                    ' 7 : Popup Calendar ocx
...
End Sub
'========================================================================================================
' Name : txtPrToDt_DblClick
' Desc : developer describe this line
'========================================================================================================
Sub txtPrToDt_DblClick(Button)
    If Button = 1 Then
		frm1.txtPrToDt.Action = 7                                    ' 7 : Popup Calendar ocx
		Call SetFocusToDocument("M")	
				...
				<TR>
					...
					<TD CLASS="CLSMTABP">
						<TABLE ID="MyTab" CELLSPACING=0 CELLPADDING=0 onclick="ClickTab3()">
							<TR>
								<td background="../../image/table/tab_up_bg.gif"><IMG height=23 src="../../image/table/tab_up_left.gif" width=9></td>
								<td background="../../image/table/tab_up_bg.gif" align="center" CLASS="CLSMTABP"><font color=white>선수금번호별입금금액</font></td>
								<td background="../../image/table/tab_up_bg.gif" align="right"><IMG height=23 src="../../image/table/tab_up_right.gif" width=10></td>
						    </TR>
						</TABLE>
					</TD>	
						...
						<FIELDSET CLASS="CLSFLD">
							<TABLE <%=LR_SPACE_TYPE_40%>>
								<TR>
									...
									<TD CLASS="TD6" NOWRAP>
									    <script language =javascript src='./js/a5435ma1_fpDateTime1_txtPrFrDt.js'></script>
									    &nbsp;~&nbsp;
									    <script language =javascript src='./js/a5435ma1_fpDateTime2_txtPrToDt.js'></script>
									</TD>
					...
					<TD WIDTH=100% HEIGHT=* VALIGN=TOP>
							...
							<TABLE <%=LR_SPACE_TYPE_60%>>
								<TR>
									<TD WIDTH=100% HEIGHT=100% COLSPAN=4>
										<script language =javascript src='./js/a5435ma1_OBJECT1_vspdData1.js'></script>
									</TD>
								</TR>
								<TR>
									<TD HEIGHT=40 WIDTH=25%>
										<FIELDSET CLASS="CLSFLD">
											<TABLE  <%=LR_SPACE_TYPE_20%>>
												<TR>
													<TD CLASS="TD5" NOWRAP>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;선수금액(자국)합계</TD>
													<TD CLASS=TD6 NOWRAP>
														<script language =javascript src='./js/a5435ma1_OBJECT1_txtTotPrLocAmt1.js'></script>
													</TD>
													<TD class=TD5 STYLE="WIDTH : 0px;"></TD>												
													<TD CLASS="TD5" NOWRAP>차이금액합계</TD>
													<TD CLASS=TD6 NOWRAP>
														<script language =javascript src='./js/a5435ma1_OBJECT1_txtTotDiffLocAmt1.js'></script>
													</TD>
												...
												<TR>
													...
													<TD CLASS=TD6 NOWRAP>
														<script language =javascript src='./js/a5435ma1_OBJECT1_txtTotGlLocAmt1.js'></script>
													</TD>
													<TD class=TD5 STYLE="WIDTH : 0px;"></TD>												
													<TD CLASS="TD5" NOWRAP>결의전표금액(자국)합계</TD>
													<TD CLASS=TD6 NOWRAP>
														<script language =javascript src='./js/a5435ma1_OBJECT1_txtTotTempGlLocAmt1.js'></script>
													</TD>
												</TR>
											</TABLE>
										</FIELDSET>
						...
						<DIV ID="TabDiv" SCROLL=no>
							<TABLE <%=LR_SPACE_TYPE_60%>>
								<TR>
									<TD WIDTH=100% HEIGHT=100% COLSPAN=4>
										<script language =javascript src='./js/a5435ma1_OBJECT1_vspdData2.js'></script>
									</TD>
								</TR>
								<TR>
									<TD HEIGHT=40 WIDTH=25%>
										<FIELDSET CLASS="CLSFLD">
											<TABLE  <%=LR_SPACE_TYPE_20%>>
												<TR>
													<TD CLASS="TD5" NOWRAP>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;선수금액(자국)합계</TD>
													<TD CLASS=TD6 NOWRAP>
														<script language =javascript src='./js/a5435ma1_OBJECT1_txtTotPrLocAmt2.js'></script>
													</TD>
													<TD class=TD5 STYLE="WIDTH : 0px;"></TD>												
													<TD CLASS="TD5" NOWRAP>차이금액합계</TD>
													<TD CLASS=TD6 NOWRAP>
														<script language =javascript src='./js/a5435ma1_OBJECT1_txtTotDiffLocAmt2.js'></script>
													</TD>
												</TR>
												<TR>
													<TD CLASS="TD5" NOWRAP>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;회계전표금액(자국)합계</TD>
													<TD CLASS=TD6 NOWRAP>
														<script language =javascript src='./js/a5435ma1_OBJECT1_txtTotGlLocAmt2.js'></script>
													</TD>
													<TD class=TD5 STYLE="WIDTH : 0px;"></TD>												
													<TD CLASS="TD5" NOWRAP>결의전표금액(자국)합계</TD>
													<TD CLASS=TD6 NOWRAP>
														<script language =javascript src='./js/a5435ma1_OBJECT1_txtTotTempGlLocAmt2.js'></script>
													</TD>
												</TR>
											</TABLE>
										</FIELDSET>
						...
						<DIV ID="TabDiv" SCROLL=no>
							<TABLE <%=LR_SPACE_TYPE_60%>>
								<TR>
									<TD WIDTH=100% HEIGHT=100% COLSPAN=4>
										<script language =javascript src='./js/a5435ma1_OBJECT1_vspdData3.js'></script>
									</TD>
								</TR>
								<TR>
									<TD HEIGHT=40 WIDTH=25%>
										<FIELDSET CLASS="CLSFLD">
											<TABLE  <%=LR_SPACE_TYPE_20%>>
												<TR>
													<TD CLASS="TD5" NOWRAP>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;선수금액(자국)합계</TD>
													<TD CLASS=TD6 NOWRAP>
														<script language =javascript src='./js/a5435ma1_OBJECT1_txtTotPrLocAmt3.js'></script>
													</TD>
													<TD class=TD5 STYLE="WIDTH : 0px;"></TD>												
													<TD CLASS="TD5" NOWRAP>차이금액합계</TD>
													<TD CLASS=TD6 NOWRAP>
														<script language =javascript src='./js/a5435ma1_OBJECT1_txtTotDiffLocAmt3.js'></script>
													</TD>
												</TR>
												<TR>
													<TD CLASS="TD5" NOWRAP>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;회계전표금액(자국)합계</TD>
													<TD CLASS=TD6 NOWRAP>
														<script language =javascript src='./js/a5435ma1_OBJECT1_txtTotGlLocAmt3.js'></script>
													</TD>
													<TD class=TD5 STYLE="WIDTH : 0px;"></TD>												
													<TD CLASS="TD5" NOWRAP>결의전표금액(자국)합계</TD>
													<TD CLASS=TD6 NOWRAP>
														<script language =javascript src='./js/a5435ma1_OBJECT1_txtTotTempGlLocAmt3.js'></script>
													</TD>
												</TR>
											</TABLE>
										</FIELDSET>
