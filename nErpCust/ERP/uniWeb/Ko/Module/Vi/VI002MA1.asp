...
Function SetPrintCond(StrEbrFile, strUrl)
	...
	strYyyymm		= txtQueryDate.year & right("0" & txtQueryDate.month,2) & "01"
...
<BODY TABINDEX="-1" SCROLL="no">
	...
	<TABLE  <%=TABSTYLE01%> >
		<TR>
			...
			<TD CLASS="TD6E" NOWRAP><script language =javascript src='./js/vi002ma1_fpDateTime1_txtQueryDate.js'></script>&nbsp;</TD>
