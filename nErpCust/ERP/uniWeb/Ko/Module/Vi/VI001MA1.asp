...
<BODY TABINDEX="-1" SCROLL="no">
	...
	<TABLE  <%=TABSTYLE01%> >
		<TR>
			...
			<TD CLASS="TD6E" NOWRAP><script language =javascript src='./js/vi001ma1_fpDateTime1_txtQueryDate.js'></script>&nbsp;</TD>
