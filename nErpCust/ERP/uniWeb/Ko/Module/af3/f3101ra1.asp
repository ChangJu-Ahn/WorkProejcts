...
'------ Set Parameters from Parent ASP -----------------------------------------------------------------------
	...
	Select Case arrParam(5)	
		Case "1" 
				top.document.title = "은행계좌참조팝업"
		Case "2"
				top.document.title = "은행코드팝업"
		Case "3"
				top.document.title = "은행계좌팝업"
	End Select
...
Sub InitSpreadSheet()
   ...
   If lgdiffer = "3" Then
	Call SetZAdoSpreadSheet("f3101RA2", "S", "A", "V20030923", PopupParent.C_SORT_DBAGENT, frm1.vspdData, C_MaxKey, "X", "X")
   Else 
    Call SetZAdoSpreadSheet("f3101RA1", "S", "A", "V20030923", PopupParent.C_SORT_DBAGENT, frm1.vspdData, C_MaxKey, "X", "X")	
   End If	
	Call SetSpreadLock() 
End Sub
