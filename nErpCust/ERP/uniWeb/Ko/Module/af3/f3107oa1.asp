...
'⊙: 비지니스 로직 ASP명 
'Const BIZ_PGM_ID = "f3107mb1.asp"			'☆: 비지니스 로직 ASP명 
...
Sub SetPrintCond(strUrl, StrEbrFile)
	...
	Case "DP"	 '적금명세서 
		...
		End If
	Case Else	 '예금명세서 
		If frm1.rdoCurr_Dom.checked = True Then		 '자국화폐 
					...
					<TD HEIGHT=* WIDTH=*>
						<TABLE <%=LR_SPACE_TYPE_60%>>
							<TR>
								...
								<TD CLASS="TD6" NOWRAP><SELECT ID="cboBankAcctType" NAME="cboBankAcctType" ALT="예적금구분" STYLE="WIDTH: 132px" tag="12X"></TD>
							</TR>
							<TR>
								<TD CLASS="TD5" NOWRAP>자국/외화구분</TD>
								<TD CLASS="TD6" NOWRAP>
									<INPUT TYPE="RADIO" CLASS="Radio" NAME="rdoCurr" ID="rdoCurr_Dom" Checked><LABEL FOR=rdoCurr_Dom>자국화폐</LABEL>&nbsp;
									<INPUT TYPE="RADIO" CLASS="Radio" NAME="rdoCurr" ID="rdoCurr_For"><LABEL FOR=rdoCurr_For>외화화폐</LABEL></TD>
								</TD>
							</TR>
							<TR></TR>
							<TR>
								<TD CLASS="TD5" NOWRAP>사업장</TD>
								<TD CLASS="TD6" NOWRAP><INPUT TYPE="Text" NAME="txtBizAreaCd" SIZE=10 MAXLENGTH=10 tag="11XXXU" ALT="사업장코드" ><IMG SRC="../../../CShared/image/btnPopup.gif" NAME="btnBizAreaCd" ALIGN=top TYPE="BUTTON" ONCLICK="vbscript:Call OpenPopup(frm1.txtBizAreaCD.Value,0)"> <INPUT TYPE="Text" NAME="txtBizAreaNm" SIZE=25 tag="14X" ALT="사업장명">&nbsp;~</TD>
							</TR>
							<TR>
								<TD CLASS="TD5" NOWRAP></TD>
								<TD CLASS="TD6" NOWRAP><INPUT TYPE="Text" NAME="txtBizAreaCd1" SIZE=10 MAXLENGTH=10 tag="11XXXU" ALT="사업장코드" ><IMG SRC="../../../CShared/image/btnPopup.gif" NAME="btnBizAreaCd1" ALIGN=top TYPE="BUTTON" ONCLICK="vbscript:Call OpenPopup(frm1.txtBizAreaCD1.Value,3)"> <INPUT TYPE="Text" NAME="txtBizAreaNm1" SIZE=25 tag="14X" ALT="사업장명"></TD>
							</TR>
							<TR>
								<TD CLASS="TD5" NOWRAP>은행</TD>
								<TD CLASS="TD6" NOWRAP><INPUT TYPE="Text" NAME="txtBankCd" SIZE=10 MAXLENGTH=10 tag="11XXXU" ALT="은행코드" ><IMG SRC="../../../CShared/image/btnPopup.gif" NAME="btnBankCd" ALIGN=top TYPE="BUTTON" ONCLICK="vbscript:Call OpenPopup(frm1.txtBankCD.Value,2)"> <INPUT TYPE="Text" NAME="txtBankNm" SIZE=25 tag="14X" ALT="은행명"></TD>
							</TR>
							<TR>
