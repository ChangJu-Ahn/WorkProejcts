...
Const BIZ_PGM_ID = "f3101mb1_ko441.asp"											 '☆: 비지니스 로직 ASP명 
Const BIZ_PGM_ID2 = "f3101mb2.asp"	

Const JUMP_PGM_ID_BANK_REP = "b1310ma1_ko441"										 '☆: Jump Page to 은행정보등록 
...
Function OpenRefParBankAcctNo(ByVal iOpt1)
	Dim arrRet
	Dim arrParam(11)	                           '권한관리 추가 (3 -> 4)
	Dim IntRetCD	
	Dim iCalledAspName
	
	iCalledAspName = AskPRAspName("F3101RA1_KO441")
	
	If Trim(iCalledAspName) = "" Then
		IntRetCD = DisplayMsgBox("900040", parent.VB_INFORMATION, "f3101ra1_ko441", "X")
		IsOpenPop = False
		Exit Function
	End If
...
'	arrParam(4)	= lgAuthorityFlag              '권한관리 추가	
   ...
   arrParam(6) = iOpt1
	...
	Else
		'frm1.txtBankCd.value		= arrRet(0)
		'frm1.txtBankNM.value		= arrRet(1)
		frm1.txtParBankAcctNo.value	= arrRet(2)
		'frm1.cboDpstFg.Value		= arrRet(3)
		'frm1.cboDpstType.Value		= arrRet(4)
		
		Call txtParBankAcctNo_Change()
	End If
					...
					<TD WIDTH=100% HEIGHT=* VALIGN=TOP>
						<TABLE <%=LR_SPACE_TYPE_60%>>
							...
							<TR>
								...
								<TD CLASS=TD6 NOWRAP><INPUT CLASS="clstxt" TYPE="Text" ID="txtParBankAcctNo" NAME="txtParBankAcctNo" SIZE=18 MAXLENGTH=30  tag="22XXXU" ALT="모계좌번호"><IMG SRC="../../../CShared/image/btnPopup.gif" NAME="btnBankAcctNo" ALIGN=top TYPE="BUTTON" ONCLICK="vbscript:Call OpenRefParBankAcctNo(frm1.txtParBankAcctNo.Value)"></TD>								
							</TR>
							<TR>
