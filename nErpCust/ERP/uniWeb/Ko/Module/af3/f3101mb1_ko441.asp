...
Sub SubBizQuery()
	...
	Const C_PAR_BANK_ACCT_NO = 9	'모계좌번호 >>air
	...
	Set PAFG305LIST = server.CreateObject ("PAFG305_KO441.cFLkUpDpstSvr")
    ...
    Set PAFG305LIST = nothing
		...
		Response.Write "	.txtParBankAcctNo.Value	=	""" & ConvSPChars(E5_f_dpst(C_PAR_BANK_ACCT_NO)) & """" & vbCr	'모계좌 >>air
...
Sub SubBizSave()
	...
	Const C_PAR_BANK_ACCT_NO = 2	'모계좌	>>air
	Const C_LOAN_TYPE = 3
	Const C_BANK_RATE = 4
	Const C_START_DT = 5
	Const C_END_DT = 6
	...
	iarrData(C_PAR_BANK_ACCT_NO)	= Request("txtParBankAcctNo")					'모계좌	>>air
    ...
    Set PAFG305CU = server.CreateObject("PAFG305_KO441.cFMngDpstSvr")   
...
Sub SubBizDelete()
    ...
    Set PAFG305D = server.CreateObject ("PAFG305_KO441.cFMngDpstSvr")    
