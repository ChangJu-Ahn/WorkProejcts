...
<Script Language=vbscript>
	With Parent.frm1
		...
		.txtWcCd.Value = "<%=ConvSPChars(Trim(E2_q_inspection_request(E2_p_wc_cd)))%>"
		.txtWcNm.Value = "<%=ConvSPChars(Trim(E2_q_inspection_request(E2_p_wc_nm)))%>"
	
		.txtRoutNo.Value = "<%=ConvSPChars(Trim(E2_q_inspection_request(E2_p_rout_no)))%>"
		.txtRoutNoDesc.Value = "<%=ConvSPChars(Trim(E2_q_inspection_request(E2_p_rout_no_desc)))%>"
		.txtOprNo.Value = "<%=ConvSPChars(Trim(E2_q_inspection_request(E2_p_opr_no)))%>"
		.txtOprNoDesc.Value = "<%=ConvSPChars(Trim(E2_q_inspection_request(E2_p_opr_no_desc)))%>"
