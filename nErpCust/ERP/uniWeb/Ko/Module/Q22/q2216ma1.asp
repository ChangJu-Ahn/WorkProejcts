...
Const BIZ_PGM_QRY_ID = "Q2216MB1.asp"										 '☆: 비지니스 로직 ASP명 
Const BIZ_PGM_SAVE_ID = "Q2216MB2.asp"										 '☆: 비지니스 로직 ASP명 

Const BIZ_PGM_JUMP1_ID = "Q2211MA1"
Const BIZ_PGM_JUMP2_ID = "Q2217MA1"
					...
					<TD CLASS="CLSMTABP">
						<TABLE ID="MyTab" CELLSPACING=0 CELLPADDING=0>
							<TR>
								...
								<TD BACKGROUND="../../../CShared/image/table/seltab_up_bg.gif" ALIGN="center" CLASS="CLSMTAB"><FONT COLOR=white>공정검사 부적합처리</FONT></TD>
					...
					<TD HEIGHT=*  WIDTH=100% VALIGN=TOP>						
						<TABLE <%=LR_SPACE_TYPE_60%>>
			                ...
			                <TR>
								...
								<TD CLASS="TD6" NOWRAP>
									<script language =javascript src='./js/q2216ma1_fpDoubleSingle1_txtLotSize.js'></script>
								</TD>       
							</TR>
			                <TR>
			                	<TD CLASS="TD5" NOWRAP>검사수</TD>            
								<TD CLASS="TD6" NOWRAP>
									<script language =javascript src='./js/q2216ma1_fpDoubleSingle2_txtInspQty.js'></script>
								</TD>
								<TD CLASS="TD5" NOWRAP>불량수</TD>
								<TD CLASS="TD6" NOWRAP>
									<script language =javascript src='./js/q2216ma1_fpDoubleSingle3_txtDefectQty.js'></script>
								</TD>
			                			</TR>
							<TR>
								<TD HEIGHT=100% WIDTH=100% colspan=4>
									<script language =javascript src='./js/q2216ma1_I287591391_vspdData.js'></script>
								</TD>	
							</TR>
						</TABLE>
					</TD>
	...
	<TR HEIGHT=20>
      		<TD WIDTH=100%>
      			<TABLE <%=LR_SPACE_TYPE_30%>>
        				<TR>        				
        					<TD WIDTH=10>&nbsp;</TD>
        					<TD WIDTH=* ALIGN=RIGHT><A href="vbscript:LoadInspection">공정검사</A>&nbsp;|&nbsp;<A href="vbscript:LoadRelease">Release</A></TD>
        					<TD WIDTH=10>&nbsp;</TD>
       				</TR>
      			</TABLE>
      		</TD>
