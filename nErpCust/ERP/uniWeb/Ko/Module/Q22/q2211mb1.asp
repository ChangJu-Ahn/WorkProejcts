...
With Parent.frm1
	...
	.txtRoutNo.Value = "<%=ConvSPChars(Trim(EG2_q_inspection_request(E2_p_rout_no)))%>"
	.txtRoutNoDesc.Value = "<%=ConvSPChars(Trim(EG2_q_inspection_request(E2_p_rout_no_desc)))%>"
	.txtOprNo.Value = "<%=ConvSPChars(Trim(EG2_q_inspection_request(E2_p_opr_no)))%>"
	.txtOprNoDesc.Value = "<%=ConvSPChars(Trim(EG2_q_inspection_request(E2_p_opr_no_desc)))%>"
	...
	Parent.lgIntFlgMode = Parent.Parent.OPMD_UMODE
End with
</Script>	
<%
'-----------------------
...
Call PQIG020.Q_LIST_INSP_DETAIL_SVR(gStrGlobalCollection,C_SHEETMAXROWS_D, _
									I1_q_inspection_details,strResultNo,strInspReqNo,EG1_export_group, E1_q_inspection_details)
...
<Script Language=vbscript>
		With Parent
			If  "<%=E4_q_inspection_result(18)%>"<> "" Then
				 ...
				 .frm1.hInspItemCd.value = "<%=lgStrPrevKey1%>"
				 .frm1.hInspSeries.value = "<%=lgStrPrevKey2%>"
			 	.DbQueryOk
			End If
		End With
</Script>
...
Dim PvArr
ReDim PvArr(UBound(EG1_export_group))
    
For LngRow = 0 To UBound(EG1_export_group)
	If LngRow < C_SHEETMAXROWS_D Then	
			
		strData = Chr(11) & ConvSPChars(EG1_export_group(LngRow,Q210_EG1_E1_q_inspection_details_insp_item_cd)) & _
				  Chr(11) & "" & _
				  Chr(11) & ConvSPChars(EG1_export_group(LngRow,Q210_EG1_E2_q_inspection_item_insp_item_nm)) & _
				  Chr(11) & EG1_export_group(LngRow,Q210_EG1_E1_q_inspection_details_Insp_Order) & _
				  Chr(11) & EG1_export_group(LngRow,Q210_EG1_E1_q_inspection_details_insp_series) & _
				  Chr(11) & UniNumClientFormat(EG1_export_group(LngRow,Q210_EG1_E1_q_inspection_details_sample_qty), ggQty.DecPoint ,0) & _
				  Chr(11) & UniNumClientFormat(EG1_export_group(LngRow,Q210_EG1_E1_q_inspection_details_accpt_decision_qty), ggQty.DecPoint ,0) & _
				  Chr(11) & UniNumClientFormat(EG1_export_group(LngRow,Q210_EG1_E1_q_inspection_details_rejt_decision_qty), ggQty.DecPoint ,0)
					
		If Trim(EG1_export_group(LngRow,Q210_EG1_E1_q_inspection_details_accpt_decision_discreate)) <> "" Then
		...
		If Trim(EG1_export_group(LngRow,Q210_EG1_E1_q_inspection_details_max_defect_ratio)) <> "" Then
			strData = strData & Chr(11) & UniNumClientFormat(EG1_export_group(LngRow,Q210_EG1_E1_q_inspection_details_max_defect_ratio), 4, 0)
		Else
			strData = strData & Chr(11) & ""
		End If
					
		strData = strData & Chr(11) & EG1_export_group(LngRow,Q210_EG1_E4_InspMethodCd_b_minor_minor_nm) _
						  & Chr(11) & EG1_export_group(LngRow,Q210_EG1_E7_InspUnitIndctn_b_minor_minor_nm) _
						  & Chr(11) & ConvSPChars(EG1_export_group(LngRow,Q210_EG1_E3_q_inspection_standard_by_item_insp_spec))
					
		If Trim(EG1_export_group(LngRow,Q210_EG1_E3_q_inspection_standard_by_item_lsl)) <> "" Then
			strData = strData & Chr(11) & UniNumClientFormat(EG1_export_group(LngRow,Q210_EG1_E3_q_inspection_standard_by_item_lsl), 4, 0)
		Else
			strData = strData & Chr(11) & ""
		End If
					
		If Trim(EG1_export_group(LngRow,Q210_EG1_E3_q_inspection_standard_by_item_usl)) <> "" Then
			strData = strData & Chr(11) & UniNumClientFormat(EG1_export_group(LngRow,Q210_EG1_E3_q_inspection_standard_by_item_usl), 4, 0)
		Else
			strData = strData & Chr(11) & ""
		End If
					
		strData = strData & Chr(11) & ConvSPChars(EG1_export_group(LngRow,Q210_EG1_E5_q_measurement_equipment_measmt_equipmt_nm)) _
						  & Chr(11) & ConvSPChars(EG1_export_group(LngRow,Q210_EG1_E1_q_inspection_details_measmt_unit_cd)) _
						  & Chr(11) & ConvSPChars(EG1_export_group(LngRow,Q210_EG1_E1_q_inspection_details_insp_method_cd)) _
						  & Chr(11) & ConvSPChars(EG1_export_group(LngRow,Q210_EG1_E1_q_inspection_details_insp_unit_indctn)) _
						  & Chr(11) & ConvSPChars(EG1_export_group(LngRow,Q210_EG1_E1_q_inspection_details_measmt_equipmt_cd)) _
...
With Parent
	...
	Else
		...
		.frm1.hInspReqNo.value = "<%=ConvSPChars(strInspReqNo)%>"
		.frm1.hPlantCd.value = "<%=ConvSPChars(strPlantCd)%>"
		.frm1.hInspItemCd.value = "<%=ConvSPChars(lgStrPrevKey1)%>"
		.frm1.hInspSeries.value = "<%=lgStrPrevKey2%>"
		.DbQueryOk
	End If
End with
