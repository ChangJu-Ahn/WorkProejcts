...
Const BIZ_PGM_ID          = "q2214qb1.asp"             '☆: Biz logic spread sheet for #1
Const BIZ_PGM_ID1		  = "q2214qb2.asp"             '☆: Biz logic spread sheet for #2
...
Sub InitSpreadSheet(ByVal pvGridId)
    If pvGridId = "A" Then                                   ' 초기화 Spreadsheet #1 
        Call SetZAdoSpreadSheet("Q2214QA1", "S", "A", "V20040818", parent.C_SORT_DBAGENT, frm1.vspdData, C_MaxKey, "X", "X")
    End If

    Call SetZAdoSpreadSheet("Q2214QA1", "S", "B", "V20040818", parent.C_SORT_DBAGENT, frm1.vspdData2, C_MaxKey, "X", "X")
...
'--------------- 개발자 coding part(실행로직,Start)----------------------------------------------
			strVal	= BIZ_PGM_ID & "?txtPlantCd=" & Trim(.txtPlantCd.value) _
					...
					& "&txtDefectTypeCd=" & Trim(.txtDefectTypeCd.value) _
					& "&iOpt=" & pOpt
        Else   
			strVal	= BIZ_PGM_ID1 & "?txtPlantCd=" & Trim(.txtPlantCd.value) _
					...
					& "&txtDefectTypeCd=" & GetKeyPosVal("A", 5) _
					& "&iOpt=" & pOpt
        End If  
					...
					<TD CLASS="CLSMTABP">
						<TABLE ID="MyTab" CELLSPACING=0 CELLPADDING=0>
							<TR>
								...
								<td background="../../../CShared/image/table/seltab_up_bg.gif" align="center" CLASS="CLSMTAB"><font color=white>공정검사불량원인조회</font></td>
						...
						<FIELDSET CLASS="CLSFLD">
							<TABLE <%=LR_SPACE_TYPE_40%>>
								<TR>
									...
									<TD CLASS="TD6">
										<script language =javascript src='./js/q2214qa1_fpDateTime5_txtDtFr.js'></script>&nbsp;~&nbsp;
										<script language =javascript src='./js/q2214qa1_fpDateTime6_txtDtTo.js'></script>																				
									</TD>
								</TR>
								<TR>
							...
							<TR>
								<TD HEIGHT=100% WIDTH=100% Colspan=4>
									<TABLE WIDTH="100%" HEIGHT="100%" CELLSPACING=0 CELLPADDING=0>
										<TR HEIGHT="*">
											<TD WIDTH="60%">
												<script language =javascript src='./js/q2214qa1_A_vspdData.js'></script>
											</TD>
											<TD WIDTH=10>&nbsp;</TD>
											<TD WIDTH="40%">
												<script language =javascript src='./js/q2214qa1_B_vspdData2.js'></script>
											</TD>
										</TR>
									</TABLE>
								</TD>
