...
'*  2. Function Name        : 
'*  3. Program ID           : Q2213QB1
'*  4. Program Name         : 불량유형조회 
'*  5. Program Desc         : 
'*  6. Component List       : 
'*  7. Modified date(First) : 2002/05/14
'*  8. Modified date(Last)  : 2004/07/19
...
Sub HeaderData()
	...
	'작업장 
	If strWcCd <> "" Then
		UNISqlId(0) = "Q2213QA123"
		UNIValue(0,0) = FilterWcCd		'---작업장 
		...
		lgstrRetMsg = lgADF.QryRs(gDsnNo, UNISqlId, UNIValue, UNILock, UNIFlag, rs0)
  		iStr = Split(lgstrRetMsg,gColSep)
    		...
    		If  rs0.EOF And rs0.BOF Then
        			Call DisplayMsgBox("182100", vbOKOnly, "", "", I_MKSCRIPT)   'No Data Found!!
        			rs0.Close
        			Set rs0 = Nothing
        			Response.End													'☜: 비지니스 로직 처리를 종료함 
    		Else    
...
Sub FixUNISQLData()
	...
	'	Case "I"
	'		Redim UNIValue(0,8)    
	'		UNISqlId(0) = "Q2213QA102"
	'	Case "W"
	'		Redim UNIValue(0,8)    
	'		UNISqlId(0) = "Q2213QA103"
	'	Case "IW"
	'		Redim UNIValue(0,9)    
	'		UNISqlId(0) = "Q2213QA104"
	'	Case "IS"
	'		Redim UNIValue(0,9)    
	'		UNISqlId(0) = "Q2213QA105"
	'	Case "A"
	'		Redim UNIValue(0,10)             
	'		UNISqlId(0) = "Q2213QA106"
	'End Select
	...
	If Trim(strInspItemCd) <> "" Then
		strQryCnd = strQryCnd & "AND A.WC_CD = " & FilterWcCd
	End If
	...
	'    	Case "W"
	'    		 UNIValue(0,6) = FilterWcCd	    					'---작업장 
	    		 
	'    	Case "IW"
	'    		 UNIValue(0,6) = FilterItemCd					'---품목 
	'    		 UNIValue(0,7) = FilterWcCd	    					'---작업장 
	'    	Case "IS"
	'    		 UNIValue(0,6) = FilterItemCd					'---품목 
	...
	'    		UNIValue(0,6) = FilterItemCd					'---품목 
	'    		UNIValue(0,7) = FilterWcCd	    					'---작업장 
	'    		UNIValue(0,8) = FilterInspItemCd	    			'---검사항목 
	'    End Select
...
Sub TrimData()
	...
	FilterWcCd = FilterVar(strWcCd, "''", "S")
	FilterInspItemCd = FilterVar(strInspItemCd, "''", "S")
	
    'If strItemCd = "" And strWcCd = "" And strInspItemCd = "" Then
	'	strFlag = "N"
	'ElseIf strItemCd <> "" And strWcCd = "" And strInspItemCd = "" Then
	'	strFlag = "I"
	'ElseIf strItemCd = "" And strWcCd <> "" And strInspItemCd = "" Then
	'	strFlag = "W"
	'ElseIf strItemCd <> "" And strWcCd <> "" And strInspItemCd = "" Then
...
<Script Language=vbscript>
    With parent
		...
		.frm1.txtWcNm.Value = "<%=ConvSPChars(strWcNm)%>"
