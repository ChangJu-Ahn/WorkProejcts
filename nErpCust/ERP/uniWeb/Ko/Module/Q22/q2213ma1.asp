...
Const BIZ_PGM_QRY_ID = "Q2213MB1.asp"								'☆: 비지니스 로직 ASP명 
Const BIZ_PGM_QRY2_ID = "Q2213MB3.asp"								'☆: 비지니스 로직 ASP명 
Const BIZ_PGM_SAVE_ID = "Q2213MB2.asp"								'☆: 비지니스 로직 ASP명 
'/* 전체 삭제 관련 - START */
Const BIZ_PGM_DEL_ID = "Q2213MB4.asp"
'/* 전체 삭제 관련 - END */
Const BIZ_PGM_JUMP1_ID = "Q2211MA1"
Const BIZ_PGM_JUMP2_ID = "Q2214MA1"
...
Function SortSheet()
    ...
    With frm1.vspdData2
        ...
        .Col = 1	'C_DefectTypeCd	'###그리드 컨버전 주의부분###
        .Col2 = .MaxCols
        .Row = 1
        .Row2 = .MaxRows
					...
					<TD CLASS="CLSMTABP">
						<TABLE ID="MyTab" CELLSPACING=0 CELLPADDING=0">
							<TR>
								...
								<TD BACKGROUND="../../../CShared/image/table/seltab_up_bg.gif" ALIGN="center" CLASS="CLSMTAB"><FONT COLOR=white>공정검사 불량유형</FONT></TD>
					...
					<TD HEIGHT=*  WIDTH=100% VALIGN=TOP>						
						<TABLE <%=LR_SPACE_TYPE_60%>>
							...
							<TR>
								...
								<TD CLASS="TD6" NOWRAP>
									<script language =javascript src='./js/q2213ma1_fpDoubleSingle1_txtLotSize.js'></script>
								</TD>
							</TR>
							<TR>
								<TD HEIGHT=100% WIDTH=100% Colspan=4>
									<TABLE WIDTH="100%" HEIGHT="100%" CELLSPACING=0 CELLPADDING=0>
										<TR HEIGHT="*">
											<TD WIDTH="52%">
												<script language =javascript src='./js/q2213ma1_I135652244_vspdData.js'></script>
											</TD>
											<TD WIDTH=10>&nbsp;</TD>
											<TD WIDTH="48%">
												<script language =javascript src='./js/q2213ma1_I898629289_vspdData2.js'></script>
											</TD>
										</TR>
									</TABLE>
								</TD>
	...
	<TR HEIGHT=20>
    	<TD WIDTH=100%>
    		<TABLE <%=LR_SPACE_TYPE_30%>>
    			<TR>        				
    				<TD WIDTH=10>&nbsp;</TD>
    				<TD WIDTH=* ALIGN=RIGHT><A href="vbscript:LoadInspection">공정검사</A>&nbsp;|&nbsp;<A href="vbscript:LoadDefectCause">불량원인</A></TD>
					<TD WIDTH=10>&nbsp;</TD>
    			</TR>
    		</TABLE>
    	</TD>
