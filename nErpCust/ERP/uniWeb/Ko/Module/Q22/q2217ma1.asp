...
Const BIZ_PGM_QRY_ID = "Q2217MB1.asp"
Const BIZ_PGM_SAVE_ID = "Q2217MB2.asp"
Const BIZ_PGM_DEL_ID = "Q2217MB3.asp"											 '☆: 비지니스 로직 ASP명 
					...
					<TD CLASS="CLSMTABP">
						<TABLE ID="MyTab" CELLSPACING=0 CELLPADDING=0>
							<TR>
								...
								<TD BACKGROUND="../../../CShared/image/table/seltab_up_bg.gif" ALIGN="center" CLASS="CLSMTAB"><FONT COLOR=white>공정검사 Release</FONT></TD>
					...
					<TD HEIGHT=*  WIDTH=100% VALIGN=TOP>						
						<TABLE <%=LR_SPACE_TYPE_60%>>
							<TR>
								...
								<TD CLASS="TD6" NOWRAP>
									<script language =javascript src='./js/q2217ma1_txtReleaseDt_txtReleaseDt.js'></script>
								</TD>
							</TR>
							<TR>
							...
							<TR>
								...
								<TD CLASS="TD6" NOWRAP><INPUT TYPE=TEXT NAME="txtWcCd" SIZE=10 ALT="작업장" tag="24">&nbsp;<INPUT TYPE=TEXT NAME="txtWcNm" SIZE=20 tag="24"></TD>
								<TD CLASS="TD5" NOWRAP>검사의뢰일</TD>
								<TD CLASS="TD6" NOWRAP>
									<script language =javascript src='./js/q2217ma1_txtInspReqDt_txtInspReqDt.js'></script>
								</TD>
							</TR>							
							<TR>
								...
								<TD CLASS="TD6" NOWRAP>
									<script language =javascript src='./js/q2217ma1_fpDoubleSingle1_txtLotSize.js'></script>
								</TD>
	                		</TR>
	                		<TR>
								...
								<TD CLASS="TD6" NOWRAP>
									<script language =javascript src='./js/q2217ma1_txtInspDt_txtInspDt.js'></script>
								</TD>
							</TR>
							<TR>
								<TD CLASS="TD5" NOWRAP>양품수</TD>
								<TD CLASS="TD6" NOWRAP>
									<script language =javascript src='./js/q2217ma1_fpDoubleSingle2_txtGoodQty.js'></script>
								</TD>
								<TD CLASS="TD5" NOWRAP>불량품수</TD>
								<TD CLASS="TD6" NOWRAP>
									<script language =javascript src='./js/q2217ma1_fpDoubleSingle3_txtDefectQty.js'></script>
								</TD>
							</TR>
							<TR>
	...
	<TR HEIGHT=20>
      		<TD WIDTH=100%>
      			<TABLE <%=LR_SPACE_TYPE_30%>>
        				<TR>        				
        					<TD WIDTH=10>&nbsp;</TD>
        					<TD WIDTH=* ALIGN=RIGHT><A href="vbscript:LoadInspection">공정검사</A></TD>
        					<TD WIDTH=10>&nbsp;</TD>
       				</TR>
      			</TABLE>
      		</TD>
