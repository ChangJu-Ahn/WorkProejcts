...
Const BIZ_PGM_QRY_ID = "Q2211MB1.asp"										 '☆: 비지니스 로직 ASP명 
Const BIZ_PGM_SAVE_ID = "Q2211MB2.asp"										 '☆: 비지니스 로직 ASP명 
Const BIZ_PGM_DEL_ID = "Q2211MB3.asp"
Const BIZ_PGM_QRY2_ID = "Q2211MB4.asp"
'/* 2003-05 정기패치 : 검사의뢰번호 LOOK UP 기능 추가 - START */
Const BIZ_PGM_LOOKUP_ID = "q2211mb5.asp"							
'/* 2003-05 정기패치 : 검사의뢰번호 LOOK UP 기능 추가 - END */
Const BIZ_PGM_JUMP1_ID = "Q2212ma1"
Const BIZ_PGM_JUMP2_ID = "Q2213ma1"
Const BIZ_PGM_JUMP3_ID = "Q2214ma1"
Const BIZ_PGM_JUMP4_ID = "Q2215ma1"
Const BIZ_PGM_JUMP5_ID = "Q2216ma1"
Const BIZ_PGM_JUMP6_ID = "Q2217ma1"
...
Function OpenInspReqNo2()        
	...
	If arrRet(0) <> "" Then
		...
		frm1.txtRoutNo.Value		= arrRet(7)
		frm1.txtRoutNoDesc.Value	= arrRet(8)
		frm1.txtOprNo.Value			= arrRet(9)
		frm1.txtOprNoDesc.Value		= arrRet(10)
		frm1.txtWcCd.Value			= arrRet(11)
		frm1.txtWcNm.Value			= arrRet(12)
					...
					<TD CLASS="CLSMTABP">
						<TABLE ID="MyTab" CELLSPACING=0 CELLPADDING=0>
							<TR>
								...
								<TD BACKGROUND="../../../CShared/image/table/seltab_up_bg.gif" ALIGN="center" CLASS="CLSMTAB"><FONT COLOR=white>공정검사 등록</FONT></TD>
									...
									<FIELDSET CLASS="CLSFLD"><LEGEND>검사의뢰내용</LEGEND>
										<TABLE WIDTH="100%" CELLSPACING=0 CELLPADDING=0>
											...
											<TR>
												...
												<TD CLASS="TD6" NOWRAP><INPUT TYPE=TEXT NAME="txtWcCd" SIZE=10 MAXLENGTH=4 ALT="작업장" tag="24">
      		...
      		<TD WIDTH=100%>
      			<TABLE <%=LR_SPACE_TYPE_30%>>
        				<TR>        				
        					...
        					<TD WIDTH=* ALIGN=RIGHT><A href="vbscript:LoadInspDetails">검사내역</A>&nbsp;|&nbsp;<A href="vbscript:LoadDefectType">불량유형</A>&nbsp;|&nbsp;<A href="vbscript:LoadDefectCause">불량원인</A>&nbsp;|&nbsp;<A href="vbscript:LoadDecision">판정</A>&nbsp;|&nbsp;<A href="vbscript:LoadDisposition">부적합처리</A>&nbsp;|&nbsp;<A href="vbscript:LoadRelease">Release</A></TD>
        					<TD WIDTH=10>&nbsp;</TD>
       				</TR>
      			</TABLE>
      		</TD>
