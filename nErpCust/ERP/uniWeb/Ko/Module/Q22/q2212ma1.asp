...
'###검사분류별 변경부분 Start###
Const BIZ_PGM_QRY_ID = "Q2212MB1.asp"
Const BIZ_PGM_QRY2_ID = "Q2212MB3.asp"
Const BIZ_PGM_SAVE_ID = "Q2212MB2.asp"
'/* 전체 삭제 관련 - START */
Const BIZ_PGM_DEL_ID = "Q2212MB4.asp"
'/* 전체 삭제 관련 - END */
Const BIZ_PGM_JUMP1_ID = "Q2211MA1"
Const BIZ_PGM_JUMP2_ID = "Q2213MA1"
'/* 9월 정기패치: 판정으로의 Link 추가 - START */
Const BIZ_PGM_JUMP3_ID = "Q2215MA1"
...
Sub InsertSampleRows()
    ...
    With frm1
    	...
    	Call DeleteDataForInsertSampleRows(lConvRow, lglngHiddenRows(lConvRow - 1))
	...
	lglngHiddenRows(lConvRow - 1) = lngMaxRows
...
'   Event Desc :
'=======================================================================================================
Sub Sub_vspdData_ScriptLeaveCell(ByVal Col, ByVal Row, ByVal NewCol, ByVal NewRow, Cancel)	'###그리드 컨버전 주의부분###
					...
					<TD CLASS="CLSMTABP">
						<TABLE ID="MyTab" CELLSPACING=0 CELLPADDING=0">
							<TR>
								...
								<TD BACKGROUND="../../../CShared/image/table/seltab_up_bg.gif" ALIGN="center" CLASS="CLSMTAB"><FONT COLOR=white>공정검사내역 등록</FONT></TD>
					...
					<TD HEIGHT=*  WIDTH=100% VALIGN=TOP>						
						<TABLE <%=LR_SPACE_TYPE_60%>>
							...
							<TR>
								...
								<TD CLASS="TD6" NOWRAP>
									<script language =javascript src='./js/q2212ma1_fpDoubleSingle1_txtLotSize.js'></script>
								</TD>
							</TR>
							<TR>
										...
										<TR HEIGHT="*">
												...
												<TABLE <%=LR_SPACE_TYPE_20%>>
													<TR HEIGHT="*" WIDTH="100%">
														<TD WIDTH="100%" Colspan=4>
															<script language =javascript src='./js/q2212ma1_I731624817_vspdData.js'></script>
														</TD>
													</TR>
													<TR HEIGHT="20" WIDTH="100%">
														<TD CLASS="TD5" NOWRAP>시료수</TD>            
														<TD CLASS="TD6" NOWRAP>
															<script language =javascript src='./js/q2212ma1_fpDoubleSingle1_txtSampleQty.js'></script>
														</TD>
														<TD CLASS="TD5" NOWRAP>불량수</TD>
														<TD CLASS="TD6" NOWRAP>
															<script language =javascript src='./js/q2212ma1_fpDoubleSingle2_txtDefectQty.js'></script>
														</TD>
													</TR>			
													<TR HEIGHT="20" WIDTH="100%">
											...
											<TD HEIGHT=100% WIDTH=35%>
												<TABLE <%=LR_SPACE_TYPE_20%>>
													<TR HEIGHT="*">
														<TD WIDTH="100%">
															<script language =javascript src='./js/q2212ma1_I225494283_vspdData2.js'></script>
														</TD>
													</TR>
												</TABLE>
											</TD>
    	...
    	<TD WIDTH=100%>
    		<TABLE <%=LR_SPACE_TYPE_30%>>
    			<TR>        				
    				...
    				<!-- '/* 9월 정기패치: 판정으로의 Link 추가 - START */ -->
    				<TD WIDTH=* ALIGN=RIGHT><A href="vbscript:LoadInspection">공정검사</A>&nbsp;|&nbsp;<A href="vbscript:LoadDefectType">불량유형</A>&nbsp;|&nbsp;<A href="vbscript:LoadDecision">판정</A></TD>
    				<!-- '/* 9월 정기패치: 판정으로의 Link 추가 - END */ -->
					<TD WIDTH=10>&nbsp;</TD>
    			</TR>
    		</TABLE>
