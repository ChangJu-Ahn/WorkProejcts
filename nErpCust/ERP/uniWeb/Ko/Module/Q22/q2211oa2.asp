...
'*  2. Function Name        : 
'*  3. Program ID           : Q2211OA2
'*  4. Program Name         : 월보출력 
'*  5. Program Desc         : 
'*  6. Component List       : 
'*  7. Modified date(First) : 2002/05/14
'*  8. Modified date(Last)  : 2004/07/22
...
Function FncBtnPrint() 
	...
	var2 = frm1.txtStartDt.Year & frm1.txtStartDt.Month
	var3 = frm1.txtEndDt.Year & frm1.txtEndDt.Month
	...
	var6 = Trim(frm1.txtRoutNo.value)
	
	If var6  = "" Then
		var6 = "%"
	End If
	
	var7 = Trim(frm1.txtOprNo.value)
...
' 월보의 조회타입 선택(일별,품목별,공급처별,품목/공급처별) 
	...
	strUrl = strUrl & "|ItemCd|" & var5
	strUrl = strUrl & "|RoutNo|" & var6
	strUrl = strUrl & "|OprNo|" & var7
...
Function FncBtnPreview() 
	...
	var2 = frm1.txtStartDt.Year & Right("0" & frm1.txtStartDt.Month,2)'& frm1.txtStartDt.Month
	var3 = frm1.txtEndDt.Year & Right("0" & frm1.txtEndDt.Month,2)'& frm1.txtEndDt.Month
...
' 일보의 조회타입 선택(일별,품목별,공급처별,품목/공급처별) 
	If frm1.RadioOutputType.rdoCase1.Checked Then
		strEbrFile = "Q2211OA21"
	ElseIf frm1.RadioOutputType.rdoCase2.Checked Then
		strEbrFile = "Q2211OA22"
					...
					<TD>
						<TABLE ID="MyTab" CELLSPACING=0 CELLPADDING=0>
							<TR>
								...
								<td background="../../../CShared/image/table/seltab_up_bg.gif" align="center" CLASS="CLSMTAB"><font color=white>공정검사월보</font></td>
						...
						<FIELDSET CLASS="CLSFLD" STYLE="HEIGHT: 100%">
							<TABLE WIDTH=100% CELLSPACING=0 CELLPADDING=0 STYLE="HEIGHT: 100%">
								<TR>
									...
									<TD CLASS="TD6" NOWRAP><INPUT NAME="txtPlantCd" SIZE="10" MAXLENGTH="4" ALT="공장" TAG="12XXXU" ><IMG ALIGN=top HEIGHT=20 NAME=btnPlantCd ONCLICK=vbscript:OpenPlant() SRC="../../../CShared/image/btnPopup.gif" WIDTH=16  TYPE="BUTTON">&nbsp;<INPUT NAME="txtPlantNm" SIZE="30" TAG="14X"></TD>
                                </TR>
								<TR>
									<TD CLASS=TD5 NOWRAP>기간</TD>
									<TD CLASS=TD6 NOWRAP>
										<script language =javascript src='./js/q2211oa2_fpDateTime1_txtStartDt.js'></script>&nbsp;~&nbsp;
										<script language =javascript src='./js/q2211oa2_fpDateTime2_txtEndDt.js'></script>																																
									</TD>
								</TR>
								<TR>
								...
								<TR>
									...
									<TD CLASS="TD6" NOWRAP><INPUT TYPE=TEXT NAME="txtRoutNo" SIZE=10 MAXLENGTH=20 tag="11XXXU" ALT="라우팅"><IMG SRC="../../../CShared/image/btnPopup.gif" NAME="btnRoutNo" align=top TYPE="BUTTON" ONCLICK="vbscript:OpenRoutNo()">&nbsp;<input TYPE=TEXT NAME="txtRoutNoDesc" SIZE="30" tag="14"></TD>
								</TR>
								<TR>
								...
								<TR>
									...
									<TD CLASS="TD6" NOWRAP>
										...
										<INPUT TYPE="RADIO" CLASS="RADIO" NAME="RadioOutputType" ID="rdoCase3" TAG="1X"><LABEL FOR="rdoCase3">라우팅별</LABEL>               
										<INPUT TYPE="RADIO" CLASS="RADIO" NAME="RadioOutputType" ID="rdoCase4" TAG="1X"><LABEL FOR="rdoCase4">공정별</LABEL>
										<INPUT TYPE="RADIO" CLASS="RADIO" NAME="RadioOutputType" ID="rdoCase5" TAG="1X"><LABEL FOR="rdoCase5">품목/라우팅별</LABEL>               
									</TD>               
								</TR>
								<TR>
									<TD CLASS="TD5" NOWRAP></TD>
									<TD CLASS="TD6" NOWRAP>
										<INPUT TYPE="RADIO" CLASS="RADIO" NAME="RadioOutputType" ID="rdoCase6" TAG="1X"><LABEL FOR="rdoCase6">품목/공정별</LABEL>              
										<INPUT TYPE="RADIO" CLASS="RADIO" NAME="RadioOutputType" ID="rdoCase7" TAG="1X"><LABEL FOR="rdoCase7">라우팅/공정별</LABEL>              
										<INPUT TYPE="RADIO" CLASS="RADIO" NAME="RadioOutputType" ID="rdoCase8" TAG="1X"><LABEL FOR="rdoCase8">품목/라우팅/공정별</LABEL>              
									</TD>              
								</TR>               
							</TABLE>               
						</FIELDSET>               
