...
Sub SubBizDelete()
    ...
    iErrorPosition = iPM1G111.M_MAINT_ITEM_PRICE_SVR_MULTI(gStrGlobalCollection, I1_b_plant_cd, I2_b_item_cd, itxtSpread )
...
Sub SubBizQueryMulti()
    ...
    Const M334_I5_plant_cd = 3	'조회관련추가 
    Const M334_I5_item_cd = 4
    ReDim  I5_m_item_pur_price(M334_I5_item_cd)
    ...
    '20050503 비고관련 추가 
    Const M334_EG1_E1_m_item_pur_price_remark = 12
    
    Const M334_EG1_E1_m_item_pur_price_pur_plantcd = 13
    Const M334_EG1_E1_m_item_pur_price_pur_plantnm = 14
    Const M334_EG1_E1_m_item_pur_price_pur_itemcd = 15
    Const M334_EG1_E1_m_item_pur_price_pur_itemnm = 16
    Const M334_EG1_E1_m_item_pur_price_pur_itemspec = 17
    ...
    Const M334_E3_plant_cd = 3
    Const M334_E3_item_cd = 4
    ...
    If lgStrPrevKey <> "" then	
		...
		I5_m_item_pur_price(M334_I5_plant_cd) = arrValue(3)
		I5_m_item_pur_price(M334_I5_item_cd) = arrValue(4)
	else			
		I5_m_item_pur_price(M334_I5_pur_unit) = ""
		I5_m_item_pur_price(M334_I5_pur_cur) = ""
		I5_m_item_pur_price(M334_I5_valid_fr_dt) = ""
		I5_m_item_pur_price(M334_I5_plant_cd) = ""
		I5_m_item_pur_price(M334_I5_item_cd) = ""
	End If	
	
	'Call DisplayMsgBox("x", vbInformation, Request("txtItemGroupCd") & "===", "FASDFADS1111", I_MKSCRIPT)
	
	
	Call iPM1G118.M_LIST_ITEM_PRICE_SVR_MULTI(gStrGlobalCollection, C_SHEETMAXROWS_D, I1_b_plant_plant_cd, I2_b_item_item_cd, _
        I3_fr_dt, I4_to_dt, I5_m_item_pur_price, EG1_export_group, E1_b_plant, E2_b_item, Trim(UCase(Request("txtItemGroupCd"))),E3_m_item_pur_price)
	...
	For iLngRow = 0 To UBound(EG1_export_group,1)
		...
		Else
		   StrNextKey = ConvSPChars(E3_m_item_pur_price(M334_E3_pur_unit)) & gColSep 
		   StrNextKey = StrNextKey & ConvSPChars(E3_m_item_pur_price(M334_E3_pur_cur)) & gColSep
		   StrNextKey = StrNextKey & ConvSPChars(E3_m_item_pur_price(M334_E3_valid_fr_dt)) & gColSep
		   StrNextKey = StrNextKey & ConvSPChars(E3_m_item_pur_price(M334_E3_plant_cd)) & gColSep
		   StrNextKey = StrNextKey & ConvSPChars(E3_m_item_pur_price(M334_E3_item_cd)) & gColSep
           Exit For
        End If 

		istrData = istrData & Chr(11) & ConvSPChars(EG1_export_group(iLngRow,M334_EG1_E1_m_item_pur_price_pur_plantcd))
        istrData = istrData & Chr(11) & " "      'PopUp
        istrData = istrData & Chr(11) & ConvSPChars(EG1_export_group(iLngRow,M334_EG1_E1_m_item_pur_price_pur_plantnm))
        istrData = istrData & Chr(11) & ConvSPChars(EG1_export_group(iLngRow,M334_EG1_E1_m_item_pur_price_pur_itemcd))
        istrData = istrData & Chr(11) & " "      'PopUp
        istrData = istrData & Chr(11) & ConvSPChars(EG1_export_group(iLngRow,M334_EG1_E1_m_item_pur_price_pur_itemnm))
        istrData = istrData & Chr(11) & ConvSPChars(EG1_export_group(iLngRow,M334_EG1_E1_m_item_pur_price_pur_itemspec))
	...
	Response.Write " .frm1.hdnItemGroup.value     = """ & ConvSPChars(UCase(Request("txtItemGroupCd")))   & """" & vbCr
	Response.Write " .frm1.hdnFrDt.value     = """ & Request("txtAppFrDt")                       & """" & vbCr
	Response.Write " .frm1.hdnToDt.value     = """ & Request("txtAppToDt")                       & """" & vbCr
    Response.Write " .DbQueryOk "		    	   & vbCr 
...
Sub SubBizSaveMulti()
	...
	iErrorPosition = iPM1G111.M_MAINT_ITEM_PRICE_SVR_MULTI(gStrGlobalCollection, I1_b_plant_cd, I2_b_item_cd, itxtSpread, iErrorPosition ) 
   ...
   End If        
	...
	Response.Write "<Script language=vbs> " & vbCr 
	Response.Write "With parent " & vbCr
	Response.Write " .frm1.txtPlantCd1.value    = """ & ConvSPChars(UCase(Request("txtPlantCd1")))  & """" & vbCr
	Response.Write " .frm1.txtItemCd1.value     = """ & ConvSPChars(UCase(Request("txtitemcd1")))   & """" & vbCr
	Response.Write " .frm1.txtItemGroupCd.value     = """ & ConvSPChars(UCase(Request("txtItemGroupCd")))   & """" & vbCr        
	Response.Write " .frm1.txtAppFrDt.value     = """ & ConvSPChars(UCase(Request("txtAppFrDt")))   & """" & vbCr        
	Response.Write " .frm1.txtAppToDt.value     = """ & ConvSPChars(UCase(Request("txtAppToDt")))   & """" & vbCr                
