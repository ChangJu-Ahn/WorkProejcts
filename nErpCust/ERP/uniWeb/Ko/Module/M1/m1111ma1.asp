...
Sub InitSpreadSheet()
	...
	With frm1.vspdData
		...
		ggoSpread.SSSetDate   C_AppDt, "단가적용일", 25,2,gDateFormat
		'이성룡 수정 
        'ggoSpread.SSSetFloat  C_Cost , "단가"       ,33    ,"C"   ,ggStrIntegeralPart, ggStrDeciPointPart,Parent.gComNum1000,Parent.gComNumDec, 1,,"Z"
        ggoSpread.SSSetFloat  C_Cost , "단가"       ,23    ,"C"   ,ggStrIntegeralPart, ggStrDeciPointPart,Parent.gComNum1000,Parent.gComNumDec, 1,,"Z"
        '이성룡 추가 
...
Sub SetSpreadColor(ByVal pvStartRow, Byval pvEndRow)
    ...
    With frm1
		...
		ggoSpread.SSSetProtected  C_Curr, pvStartRow, pvEndRow
		ggoSpread.SSSetProtected  C_AppDt, pvStartRow, pvEndRow
    ...
    For lRow = 1 To .vspdData.MaxRows
        ...
        Select Case Trim(GetSpreadText(.vspdData,0,lRow,"X","X"))
            ...
            Case ggoSpread.DeleteFlag      
				...
				strDel = strDel & UNIConvNum(GetSpreadText(.vspdData,C_Cost,lRow,"X","X"),0) & ColSep & lRow & RowSep
                lGrpCnt = lGrpCnt + 1
        End Select
      ...
      <FIELDSET CLASS="CLSFLD">
       <TABLE <%=LR_SPACE_TYPE_40%>>
        <TR>
         ...
         <TD CLASS="TD6" NOWRAP><INPUT TYPE=TEXT ALT="품목" NAME="txtitemcd1" SIZE=20 MAXLENGTH=18 tag="12NXXU" ><IMG SRC="../../../CShared/image/btnPopup.gif" NAME="btnPlantCd" align=top TYPE="BUTTON"ONCLICK="vbscript:OpenItemCd1()" OnMouseOver="vbscript:PopUpMouseOver()" OnMouseOut="vbscript:PopUpMouseOut()">
                  </TD>
        </TR>
        <TR>
         ...
         <TD CLASS="TD6" NOWRAP><INPUT TYPE=TEXT ALT="품목" NAME="txtitemNm1" SIZE=42 tag="14X"></TD>
        </TR>
       </TABLE>
      </FIELDSET>
     </TD>
      ...
      <TABLE <%=LR_SPACE_TYPE_60%>>
       <TR>
        ...
        <TD CLASS="TD6" NOWRAP><INPUT TYPE=TEXT ALT="품목" NAME="txtitemcd2" SIZE=10 MAXLENGTH=18 tag="23NXXU" ><IMG SRC="../../../CShared/image/btnPopup.gif" NAME="btnPlantCd" align=top TYPE="BUTTON"ONCLICK="vbscript:OpenItemCd2()" OnMouseOver="vbscript:PopUpMouseOver()" OnMouseOut="vbscript:PopUpMouseOut()">
                <INPUT TYPE=TEXT ALT="품목" NAME="txtitemNm2" SIZE=27 tag="24X"></TD>
       </TR>
       <TR>
