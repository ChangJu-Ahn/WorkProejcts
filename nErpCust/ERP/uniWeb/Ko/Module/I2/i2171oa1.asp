...
'*  2. Function Name        : 실사선별장표출력 
'*  3. Program ID           : i2171oa1.ebr
'*  4. Program Name         :
'*  5. Program Desc         :
...
Function FncBtnPrint() 
	...
	ObjName = AskEBDocumentName(StrEbrFlie, "ebr")
...
Function Plant_SLCd_PhyInvNo_Check(ByVal ChkIndex)
	...
	'-----------------------
		...
		If lgF0(0) <> "DC" Then
			Call DisplayMsgBox("169913","X","X","X")
			frm1.txtPhyInvNo.focus
			Plant_SLCd_PhyInvNo_Check = False
			Exit function
		End If 
					...
					<TD>
						<TABLE ID="MyTab" CELLSPACING=0 CELLPADDING=0>
							<TR>
								...
								<td background="../../../CShared/image/table/seltab_up_bg.gif" align="center" CLASS="CLSMTAB"><font color=white>실사선별장표출력</font></td>
					...
					<TD>
						<TABLE <%=LR_SPACE_TYPE_60%> >
							...
							<TR>
								...
								<TD CLASS="TD6">
								<script language =javascript src='./js/i2171oa1_fpDateTime1_txtInspDt.js'></script></TD>
							</TR>
							<TR>
								<TD CLASS="TD5" NOWRAP>출력형태</TD>
								<TD CLASS="TD6">
								<INPUT TYPE="RADIO" CLASS="RADIO" NAME="RadioOutputType" ID="rdoCase1" TAG="1X" checked><LABEL FOR="rdoCase1">기본</LABEL>
								<INPUT TYPE="RADIO" CLASS="RADIO" NAME="RadioOutputType" ID="rdoCase2" TAG="1X"><LABEL FOR="rdoCase2">상세</LABEL>
								</TD>
							</TR>
						</TABLE>
					</TD>
