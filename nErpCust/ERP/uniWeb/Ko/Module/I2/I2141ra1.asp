<%@ LANGUAGE="VBSCRIPT" %>
<!--'**********************************************************************************************
'*  1. Module Name          : List After Phy inv operation
'*  2. Function Name        : 
'*  3. Program ID           : I2141ra1.asp
'*  4. Program Name         : 
...
arrPhyInvNo  = arrParam(3)
arrInspDt	 = arrParam(4)
arrItemCd	 = arrParam(5)
arrItemNm	 = arrParam(6)
...
Sub SetDefaultVal()
	...
	txtPhyInvNo.value	= arrPhyInvNo
	txtItemCd.value		= arrItemCd
	txtItemNm.value		= arrItemNm
...
Sub InitSpreadSheet()
	...
	ggoSpread.Spreadinit "V20060829", , PopupParent.gAllowDragDropSpread
	...
	With  vspdData
		...
		ggoSpread.SSSetFloat C_Amount,   "금액",         15, PopupParent.ggAmtOfMoneyNo,ggStrIntegeralPart, ggStrDeciPointPart, PopupParent.gComNum1000, PopupParent.gComNumDec 
...
Function DbQuery() 
    ...
    strVal = BIZ_PGM_ID & "?txtPlantCd="		& Trim(txtPlantCd.value)	& _
						"&txtPhyInvNo="			& Trim(txtPhyInvNo.value)	& _
						"&txtItemCd="			& Trim(txtItemCd.value)		& _
						"&txtInspDt="			& arrInspDt					& _
			...
			<FIELDSET CLASS="CLSFLD">
				<TABLE <%=LR_SPACE_TYPE_40%> > 
					<TR>
						...
						<TD CLASS="TD6" NOWRAP><input NAME="txtPhyInvNo" TYPE="Text" MAXLENGTH="18" tag="14XXXU" ALT = "실사번호" size=15></TD>
					</TR>
					<TR>
						<TD CLASS="TD5" NOWRAP>품목</TD>
						<TD CLASS="TD6" NOWRAP><input NAME="txtItemCd" TYPE="Text" MAXLENGTH="18" tag="14XXXU" ALT = "품목" size=15>&nbsp;<input NAME="txtItemNm" TYPE="Text" MAXLENGTH="40" tag="14N"></TD>	
					</TR>
				</TABLE>
			</FIELDSET>
		</TD>
 ...
 <TR>
	<TD HEIGHT=* VALIGN=TOP>
		<TABLE <%=LR_SPACE_TYPE_20%>>
			<TR>
				<TD>
					<SCRIPT LANGUAGE=JavaScript> ExternalWrite('<OBJECT CLASSID=<%=gCLSIDFPSPD%> NAME=vspdData WIDTH=100% HEIGHT=100% TITLE="SPREAD"> <PARAM NAME="MaxCols" VALUE="0"> <PARAM NAME="MaxRows" VALUE="0"> <PARAM NAME="ReDraw" VALUE="0"> <PARAM NAME="FontSize" VALUE="10"> </OBJECT>');</SCRIPT>
				</TD>
			</TR>  
		</TABLE>
	</TD>
...
<INPUT TYPE=HIDDEN NAME="txtInspDt" tag="24" TABINDEX="-1">
