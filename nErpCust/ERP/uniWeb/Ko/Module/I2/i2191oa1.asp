...
'*  2. Function Name        : 실사 TAG 출력 
'*  3. Program ID           : I2191OA1
'*  4. Program Name         :
'*  5. Program Desc         :
'*  6. Comproxy List        : 
'*  7. Modified date(First) : 2003/06/23
'*  8. Modified date(Last)  : 2003/06/23
...
Function FncBtnPrint() 
	...
	ObjName = AskEBDocumentName("i2191oa1", "ebr")
					...
					<TD>
						<TABLE ID="MyTab" CELLSPACING=0 CELLPADDING=0>
							<TR>
								...
								<td background="../../../CShared/image/table/seltab_up_bg.gif" align="center" CLASS="CLSMTAB"><font color=white>실사TAG 출력</font></td>
					...
					<TD>
						<TABLE <%=LR_SPACE_TYPE_60%> >
							...
							<TR>
								...
								<TD CLASS="TD6">
								<script language =javascript src='./js/i2191oa1_fpDateTime2_txtInspDt.js'></script></TD>
							</TR>
						</TABLE>
					</TD>
				</TR>
