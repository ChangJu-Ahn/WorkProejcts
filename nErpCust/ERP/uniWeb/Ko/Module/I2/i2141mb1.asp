...
'*  3. Program ID           : I2141mb1.asp
'*  4. Program Name         : 실사Posting항목조회 
'*  5. Program Desc         : 실사등록된 품목에 대하여 조회한다.
'*  6. Comproxy List        : 
'                             
...
Dim ChkFlg   	    
    ...
    I4_b_item_cd	= Request("txtItemCd")    
 	...
 	If Request("rdoDisplayFlg") = "N" Then
		I5_display_flg = "PN"
	End If
	...
	if isEmpty(EG1_group_export) then Response.End						
	...
	For LngRow = 0 To GroupCount
		...
		If (EG1_group_export(LngRow,I209_EG1_E5_i_physical_inventory_detail_sts_indctr) = "P") then  
			ChkFlg = 1
		Else
			ChkFlg = 0
		End If
							
		Qty = CDbl(EG1_group_export(LngRow,I209_EG1_E5_i_physical_inventory_detail_good_qty)) _
				+ CDbl(EG1_group_export(LngRow,I209_EG1_E5_i_physical_inventory_detail_bad_qty))
		InvQty = CDbl(EG1_group_export(LngRow,I209_EG1_E5_i_physical_inventory_detail_inv_good_qty)) _
				+ CDbl(EG1_group_export(LngRow,I209_EG1_E5_i_physical_inventory_detail_inv_bad_qty))
				
		strData = Chr(11) & ChkFlg & _
				  ...
				  Chr(11) & UniConvNumberDBToCompany(EG1_group_export(LngRow,I209_EG1_E1_good_mvmt_workset_entry_qty), ggQty.DecPoint, ggQty.RndPolicy, ggQty.RndUnit, 0) & _
				  Chr(11) & UniConvNumberDBToCompany(EG1_group_export(LngRow,I209_EG1_E1_good_mvmt_workset_amount), ggAmtOfMoney.DecPoint, ggAmtOfMoney.RndPolicy, ggAmtOfMoney.RndUnit, 0) & _
				  Chr(11) & UniConvNumberDBToCompany(Qty, ggQty.DecPoint, ggQty.RndPolicy, ggQty.RndUnit, 0) & _
				  Chr(11) & UniConvNumberDBToCompany(InvQty, ggQty.DecPoint, ggQty.RndPolicy, ggQty.RndUnit, 0) & _
				  Chr(11) & UniConvNumberDBToCompany(Qty * CDbl(EG1_group_export(LngRow,I209_EG1_E5_i_physical_inventory_detail_prc)), ggAmtOfMoney.DecPoint, ggAmtOfMoney.RndPolicy, ggAmtOfMoney.RndUnit, 0) & _
				  Chr(11) & UniConvNumberDBToCompany(InvQty * CDbl(EG1_group_export(LngRow,I209_EG1_E5_i_physical_inventory_detail_prc)), ggAmtOfMoney.DecPoint, ggAmtOfMoney.RndPolicy, ggAmtOfMoney.RndUnit, 0) & _
