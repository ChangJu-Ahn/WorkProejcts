...
'========================================================================================================
Const BIZ_PGM_ID = "a5233mb1_ko441.asp"                                      '비지니스 로직 ASP명
...
Sub MakeKeyStream(pRow)
	...
	Dim IntRetCd
	Dim strBiz, strBiz1, strAcctFr, strAcctTo, VarFiscDt, strCurrencyCd
...
Sub InitSpreadSheet()
	...
	With frm1.vspdData	
		...
		ggoSpread.SSSetEdit   C_ACCTNM		, "계정코드명"		, 16        
		ggoSpread.SSSetEdit	  C_CUR			, "화 폐"			,  5, 2,, , 2 
		ggoSpread.SSSetFloat  C_PRE			, "이월금액(외화)"	, 12, ggQtyNo,ggStrIntegeralPart, ggStrDeciPointPart,gComNum1000,gComNumDec
		ggoSpread.SSSetFloat  C_PRE_KRW     , "이월금액(원화)"	, 12, ggAmtOfMoneyNo,ggStrIntegeralPart, ggStrDeciPointPart,gComNum1000,gComNumDec		
		'ggoSpread.SSSetFloat  C_INC			, "차변금액(외화)"	, 12, ggQtyNo,ggStrIntegeralPart, ggStrDeciPointPart,gComNum1000,gComNumDec
		'ggoSpread.SSSetFloat  C_INC_KRW		, "차변금액(원화)"	, 12, ggAmtOfMoneyNo,ggStrIntegeralPart, ggStrDeciPointPart,gComNum1000,gComNumDec
		'ggoSpread.SSSetFloat  C_DEC			, "대변금액(외화)"	, 12, ggQtyNo,ggStrIntegeralPart, ggStrDeciPointPart,gComNum1000,gComNumDec
		'ggoSpread.SSSetFloat  C_DEC_KRW		, "대변금액(원화)"	, 12, ggAmtOfMoneyNo,ggStrIntegeralPart, ggStrDeciPointPart,gComNum1000,gComNumDec

		ggoSpread.SSSetFloat  C_INC			, "증가(외화)"	, 12, ggQtyNo,ggStrIntegeralPart, ggStrDeciPointPart,gComNum1000,gComNumDec
		ggoSpread.SSSetFloat  C_INC_KRW		, "증가(원화)"	, 12, ggAmtOfMoneyNo,ggStrIntegeralPart, ggStrDeciPointPart,gComNum1000,gComNumDec
		ggoSpread.SSSetFloat  C_DEC			, "감소(외화)"	, 12, ggQtyNo,ggStrIntegeralPart, ggStrDeciPointPart,gComNum1000,gComNumDec
		ggoSpread.SSSetFloat  C_DEC_KRW		, "감소(원화)"	, 12, ggAmtOfMoneyNo,ggStrIntegeralPart, ggStrDeciPointPart,gComNum1000,gComNumDec


		ggoSpread.SSSetFloat  C_JAN			, "외화잔액"		, 12, ggQtyNo,ggStrIntegeralPart, ggStrDeciPointPart,gComNum1000,gComNumDec
