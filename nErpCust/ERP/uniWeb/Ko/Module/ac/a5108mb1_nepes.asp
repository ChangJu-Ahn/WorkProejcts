...
if txtClassType = "BS" Then
    UNISqlId(0) = "a5108QA101"
elseif txtClassType = "PL" Then
...
Sub SubBizBatchMulti()
	...
	elseif txtClassType = "PL" Then
	   strSp = "usp_a_pl"
	   txtFromGlDt = trim(left(txtFromGlDt,6))
	   txtToGlDt = trim(left(txtToGlDt,6))
	   txtPreFromGlDt = trim(left(txtPreFromGlDt,6))
	   txtPreToGlDt = trim(left(txtPreToGlDt,6))
	else
