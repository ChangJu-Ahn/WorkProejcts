...
*  2. Function Name        : 제조원가명세서월별추이현황
*  3. Program ID           : a5113ma1_site
*  4. Program Name         : 제조원가명세서월별추이현황
*  5. Program Desc         : 계정명대분류소분류가 보임
*  6. Comproxy List        :
*  7. Modified date(First) : 2011/04/14
...
'========================================================================================================
Const BIZ_PGM_ID = "a5113mb1_site.asp"                                      '비지니스 로직 ASP명
...
Sub MakeKeyStream(pRow)
	...
	lgKeyStream   = frm1.txtGlYear.text+"01" & gColSep     
	lgKeyStream   = lgKeyStream & frm1.txtGlYear.text+"12"  & gColSep
	lgKeyStream   = lgKeyStream & strQueryFg  & gColSep    
    lgKeyStream   = lgKeyStream & strBiz & gColSep ' 사업장추가함.
	lgKeyStream   = lgKeyStream & "N" & gColSep	
    lgKeyStream   = lgKeyStream & strZeroYN & gColSep	
    lgKeyStream   = lgKeyStream & gUsrId & gColSep  
...
Sub InitSpreadSheet()
	...
	With frm1.vspdData	
		...
		ggospread.SSSetEdit   C_ACCTCD   , ""   , 0'10, 2,, , 2 
		ggoSpread.SSSetEdit   C_ACCTNM   , "계정명" , 28      
		
		ggoSpread.SSSetFloat  C_TOT      , ""   , 0, ggAmtOfMoneyNo,ggStrIntegeralPart, ggStrDeciPointPart,gComNum1000,gComNumDec
					...
					<TD CLASS="CLSMTABP">
						<TABLE ID="MyTab" CELLSPACING=0 CELLPADDING=0>
							<TR>
								...
								<td background="../../image/table/seltab_up_bg.gif" align="center" CLASS="CLSMTAB"><font color=white>제조원가명세서 월별추이현황</font></td>
					...
					<TD HEIGHT=20 WIDTH=100%>
						...
						<TABLE <%=LR_SPACE_TYPE_40%>>
						    <TR>
                                ...
                                <TD CLASS="TD6" NOWRAP>
										<SPAN STYLE="WIDTH: 80px"><INPUT TYPE="RADIO" CLASS="RADIO" NAME="ZeroFg" CHECKED ID="RADIO1" VALUE="Y" tag="15"><LABEL FOR="ZeroFg1">전체</LABEL></SPAN>
										<SPAN STYLE="WIDTH: 80px"><INPUT TYPE="RADIO" CLASS="RADIO" NAME="ZeroFg"  ID="RADIO2" VALUE="N" tag="15"><LABEL FOR="ZeroFg2">발생금액</LABEL></SPAN>
								</TD>	  -->									
						   ...
						   <TR>
                            ...
                            -->
									...
									<TD CLASS="TD6" NOWRAP>
						           	...
						           	<TD CLASS="TD5" NOWRAP>재무제표구분</TD>
									<TD CLASS="TD6" NOWRAP>
										<SPAN STYLE="WIDTH: 80px"><INPUT TYPE="RADIO" CLASS="RADIO" NAME="QueryFg" CHECKED ID="queryFg1" VALUE="Y" tag="15"><LABEL FOR="ZeroFg1">제조원가명세서(MCS)</LABEL></SPAN>
										<SPAN STYLE="WIDTH: 80px"><INPUT TYPE="RADIO" CLASS="RADIO" NAME="QueryFg"  ID="queryFg2" VALUE="N" tag="15"><LABEL FOR="ZeroFg2">공사원가명세서(MCSC)</LABEL></SPAN>
                                    </TD>		
						    </TR>					
						</TABLE>
						</FIELDSET>
