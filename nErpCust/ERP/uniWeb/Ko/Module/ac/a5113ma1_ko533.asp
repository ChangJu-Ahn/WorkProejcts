...
*  3. Program ID           : a5113ma1_ko533
*  4. Program Name         : 제조원가명세서월별추이현황_DISPLAY용
*  5. Program Desc         : 계정명대분류소분류가 보임
*  6. Comproxy List        :
*  7. Modified date(First) : 2011/02/09
...
'========================================================================================================
Const BIZ_PGM_ID = "a5113mb1_ko533.asp"                                      '비지니스 로직 ASP명
...
Sub InitSpreadSheet()
	...
	With frm1.vspdData	
		...
		ggoSpread.SSSetEdit   C_ACCTNM   , "계정명" , 28 ', 3,, , 2       
					...
					<TD CLASS="CLSMTABP">
						<TABLE ID="MyTab" CELLSPACING=0 CELLPADDING=0>
							<TR>
								...
								<td background="../../image/table/seltab_up_bg.gif" align="center" CLASS="CLSMTAB"><font color=white>제조원가명세서월별추이현황</font></td>
