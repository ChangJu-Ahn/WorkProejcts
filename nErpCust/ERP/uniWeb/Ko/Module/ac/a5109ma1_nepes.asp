...
//    function CallVBSub() 
//    {  
//        execScript("SetUrl()", "vbscript");
//    }    
    function GetInfo() {
        if (!oFrame) createIFrame();

        //var empID = document.getElementById("EmpID").value;
        oFrame.src = "http://192.168.31.231:369/ERPAddition/AM/AM_A1001/am_a1001.aspx?db=nepes";
    }
    function GetInfo_display() {
        if (!oFrame) createIFrame();

        //var empID = document.getElementById("EmpID").value;
        oFrame.src = "http://192.168.31.231:369/ERPAddition/AM/AM_A1001/am_a1001.aspx?db=nepes_display";
    }
    function GetInfo_rigma() {
        if (!oFrame) createIFrame();

        //var empID = document.getElementById("EmpID").value;
        oFrame.src = "http://192.168.31.231:369/ERPAddition/AM/AM_A1001/am_a1001.aspx?db=nepes_rigma";
    }
    function GetInfo_led() {
        if (!oFrame) createIFrame();

        //var empID = document.getElementById("EmpID").value;
        oFrame.src = "http://192.168.31.231:369/ERPAddition/AM/AM_A1001/am_a1001.aspx?db=nepes_led";
    }
    var oFrame = null;
