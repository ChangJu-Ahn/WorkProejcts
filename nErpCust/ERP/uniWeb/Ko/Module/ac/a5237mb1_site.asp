...
Sub SubBizQueryMulti()    
    ...
    Else
       ...
       Do While Not lgObjRs.EOF        
          ...
          ' lgStrData = ConvSPChars(exportData(lgStrData))
          ' iStrData = iStrData & Chr(11) & Cstr(lgLngMaxRow + iDx) & Chr(11) & Chr(12)
           ' & Chr(11) & lgLngMaxRow + iDx
           'lgStrData = lgStrData & Chr(11) & Chr(12)                                            
           lgObjRs.MoveNext
...
Sub SubMakeSQLStatements(pDataType,pCode,pCode1,pComp)
    ...
    With lgObjComm
       ...
       .Parameters.Append .CreateParameter("@biz_area_cd", adWChar, adParamInput, 4, lgKeyStream(3))
