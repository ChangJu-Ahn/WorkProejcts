...
*  3. Program ID           : a5232ma1_ko441
*  4. Program Name         : 
*  5. Program Desc         : 계정별증감명세서
*  6. Comproxy List        :
...
'========================================================================================================
Const BIZ_PGM_ID = "a5232mb1_site1.asp"                                      '비지니스 로직 ASP명
...
Sub MakeKeyStream(pRow)
    ...
    Dim strCostCd1, strCostCd2, strDeptCd1,strDeptCd2


    strBiz = Trim(frm1.txtBizAreaCd.value )
    strBiz1 = Trim(frm1.txtBizAreaCd1.value )
    strCostCd1 = Trim(frm1.txtCostCd1.value )
	strCostCd2 = Trim(frm1.txtCostCd2.value )
    strDeptCd1 = Trim(frm1.txtDeptCd1.value )
    strDeptCd2 = Trim(frm1.txtDeptCd2.value )
...
'	VarFiscDt	= GetFiscDate(frm1.txtGlYear.Text)
    ...
    lgKeyStream   = lgKeyStream & strCostCd1 & gColSep
    lgKeyStream   = lgKeyStream & strCostCd2 & gColSep
    lgKeyStream   = lgKeyStream & strDeptCd1 & gColSep
    lgKeyStream   = lgKeyStream & strDeptCd2 & gColSep
...
Sub InitSpreadSheet()
	...
	With frm1.vspdData	
        ...
        ggospread.SSSetEdit   C_COSTCD   , "Cost코드"   , 10, 2,, , 2 
		ggoSpread.SSSetEdit   C_COSTNM   , "Cost명"     , 22        
        ggospread.SSSetEdit   C_DEPTCD   , "부서코드"   , 10, 2,, , 2 
		ggoSpread.SSSetEdit   C_DEPTNM   , "부서명"     , 22        
...
Sub SetSpreadLock()
    With frm1
        ...
        ggoSpread.SpreadLock    C_COSTCD, -1, C_M12
...
Function OpenPopUp(iWhere)
    ...
    SELECT CASE iWhere
         ...
         CASE 4
			 ...
			 arrParam(2) = Trim(frm1.txtDeptCd1.Value)
			 arrParam(3) = ""
			 arrParam(4) = "A.ORG_CHANGE_ID = " & FilterVar(parent.gChangeOrgId, "''", "S")  
			 arrParam(5) = frm1.txtDeptCd1.Alt
	     ...
	     CASE 5
			 ...
			 arrParam(2) = Trim(frm1.txtCostCd1.Value)								' Code Condition
			 arrParam(3) = ""									' Name Cindition
			 arrParam(4) = ""									' Where Condition
			 arrParam(5) = "코스트센타"
         ...
         CASE 6
			 arrParam(0) = "부서코드팝업"
			 arrParam(1) = "B_ACCT_DEPT A"
			 arrParam(2) = Trim(frm1.txtDeptCd2.Value)
			 arrParam(3) = ""
			 arrParam(4) = "A.ORG_CHANGE_ID = " & FilterVar(parent.gChangeOrgId, "''", "S")  
			 arrParam(5) = frm1.txtDeptCd2.Alt
	     ...
	     CASE 7
			 arrParam(0) = "코스트센타 팝업"					' 팝업 명칭 
			 arrParam(1) = "B_COST_CENTER"						' TABLE 명칭 
			 arrParam(2) = Trim(frm1.txtCostCd2.Value)								' Code Condition
			 arrParam(3) = ""									' Name Cindition
			 arrParam(4) = ""									' Where Condition
			 arrParam(5) = "코스트센타"
...
'				.txtAcctToNm.value = arrRet(1)   		  			
		    ...
		    CASE 4
				.txtDeptCd1.value = arrRet(0)
				.txtDeptNm1.value = arrRet(1)

		    CASE 5
				.txtCostCd1.value = arrRet(0)
				.txtCostNm1.value = arrRet(1)				  	
			  
			CASE 6
				.txtDeptCd2.value = arrRet(0)
				.txtDeptNm2.value = arrRet(1)	

			CASE 7
				.txtCostCd2.value = arrRet(0)
				.txtCostNm2.value = arrRet(1)	
		End SELECT
					...
					<TD HEIGHT=20 WIDTH=100%>
						...
						<TABLE <%=LR_SPACE_TYPE_40%>>
						    <TR>
								...
								<TD CLASS="TD6" NOWRAP><INPUT NAME="txtBizAreaCd" ALT="사업장코드" Size="10" 
                                        MAXLENGTH="10" STYLE="TEXT-ALIGN: LEFT; background-color: #FFFF00;" 
                                        tag="11NXXU"><IMG SRC="../../../CShared/image/btnPopup.gif" NAME="btn" ALIGN=top TYPE="BUTTON" ONCLICK="vbscript:CALL OpenPopUp(0)">
						    ...
						    <TR>
								...
								<TD CLASS="TD6" NOWRAP><INPUT NAME="txtBizAreaCd1" ALT="사업장코드" Size="10" 
                                        MAXLENGTH="10" STYLE="TEXT-ALIGN: LEFT; background-color: #FFFF00;" 
                                        tag="11NXXU"><IMG SRC="../../../CShared/image/btnPopup.gif" NAME="btn" ALIGN=top TYPE="BUTTON" ONCLICK="vbscript:CALL OpenPopUp(1)">
                            ...
                            <TR>
								...
								<TD CLASS="TD6" NOWRAP><INPUT NAME="txtDeptCd1" ALT="부서코드" Size="10" MAXLENGTH="10" STYLE="TEXT-ALIGN: LEFT" tag="11NXXU"><IMG SRC="../../../CShared/image/btnPopup.gif" NAME="btn" ALIGN=top TYPE="BUTTON" ONCLICK="vbscript:CALL OpenPopUp(4)">
													   <INPUT NAME="txtDeptNm1" ALT="부서명" Size="25" MAXLENGTH="40" STYLE="TEXT-ALIGN: LEFT" tag="14NXXU">&nbsp;~&nbsp;</TD>
								<TD CLASS="TD5" NOWRAP>CostCenter</TD>
								<TD CLASS="TD6" NOWRAP><INPUT NAME="txtCostCd1" ALT="Cost코드" Size="10" MAXLENGTH="10" STYLE="TEXT-ALIGN: LEFT" tag="11NXXU"><IMG SRC="../../../CShared/image/btnPopup.gif" NAME="btn" ALIGN=top TYPE="BUTTON" ONCLICK="vbscript:CALL OpenPopUp(5)">
													   <INPUT NAME="txtCostNm1" ALT="Cost명" Size="25" MAXLENGTH="40" STYLE="TEXT-ALIGN: LEFT" tag="14NXXU">&nbsp;~&nbsp;</TD>
                             </TR>
                            <TR>
								<TD CLASS="TD5" NOWRAP>&nbsp;</TD>
								<TD CLASS="TD6" NOWRAP><INPUT NAME="txtDeptCd2" ALT="부서코드" Size="10" MAXLENGTH="10" STYLE="TEXT-ALIGN: LEFT" tag="11NXXU"><IMG SRC="../../../CShared/image/btnPopup.gif" NAME="btn" ALIGN=top TYPE="BUTTON" ONCLICK="vbscript:CALL OpenPopUp(6)">
													   <INPUT NAME="txtDeptNm2" ALT="부서명" Size="25" MAXLENGTH="40" STYLE="TEXT-ALIGN: LEFT" tag="14NXXU"></TD>
								<TD CLASS="TD5" NOWRAP>&nbsp;</TD>
								<TD CLASS="TD6" NOWRAP><INPUT NAME="txtCostCd2" ALT="Cost코드" Size="10" MAXLENGTH="10" STYLE="TEXT-ALIGN: LEFT" tag="11NXXU"><IMG SRC="../../../CShared/image/btnPopup.gif" NAME="btn" ALIGN=top TYPE="BUTTON" ONCLICK="vbscript:CALL OpenPopUp(7)">
													   <INPUT NAME="txtCostNm2" ALT="Cost명" Size="25" MAXLENGTH="40" STYLE="TEXT-ALIGN: LEFT" tag="14NXXU"></TD>
                             </TR>
						</TABLE>
						</FIELDSET>
					</TD>
