...
Sub SubMakeSQLStatements(pDataType,pCode,pCode1,pComp)
   ...
   'pCode 재정의 : lgKeyStream(6)은 함수에 사용하지 않기 때문에
    ...
    With lgObjComm
       .CommandText = "dbo.usp_a_mcs_total"   
       ...
       .Parameters.Append .CreateParameter("@hq_brch_fg",	 adWChar, adParamInput, 1,  lgKeyStream(4))
       .Parameters.Append .CreateParameter("@zero_fg",	     adWChar, adParamInput, 1,  lgKeyStream(5))
    ...
    'If strZeroFg1 = "1" then
    	lgStrSQL = " SELECT *  "
		lgStrSQL = lgStrSQL & " FROM ufn_a_mcs_ko533(" & pCode & ") "
    'elseif strZeroFg1 = "2" then
	'	lgStrSQL = " SELECT *  "
    '	lgStrSQL = lgStrSQL & " FROM ufn_a_mcs_ko533(" & pCode & ") "                    
    'end if
