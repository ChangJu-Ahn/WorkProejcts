...
Sub FixUNISQLData()
    ...
    UNISqlId(0) = "A5133MA101"	'일계표조회 
	UNISqlId(1) = "A5133MA102"	'현금차변잔액 
	UNISqlId(2) = "A5133MA103"  '현금대변잔액 
	UNISqlId(3) = "A5133MA104"	'기초입력경로    
...
'	UNIValue(2,1) = Trim(strFrDt)	
'	UNIValue(2,2) = Trim(strToDt)	
...
'		Response.End													'☜: 비지니스 로직 처리를 종료함 
    ...
    <Script Language=vbscript>
		With parent
    '	.frm1.txtYAmt.text		= "<%=UNINumClientFormat(TTotSumAmt, ggAmtOfMoney.DecPoint, 0)%>"
...
'	Call fnGetCompStDt
	Call ExtractDateFrom(gFiscStartDt,gAPDateFormat,gApDateSeperator,strCompYr,strCompMnth,strCompDt)
