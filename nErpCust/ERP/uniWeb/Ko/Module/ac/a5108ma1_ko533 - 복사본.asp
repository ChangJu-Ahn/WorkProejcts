...
*  2. Function Name        : 대차대조표월별추이현황
*  3. Program ID           : a5108ma1_ko533
*  4. Program Name         : 대차대조표월별추이현황_DISPLAY용
*  5. Program Desc         : 계정명대분류소분류가 보임
*  6. Comproxy List        :
*  7. Modified date(First) : 2011/02/16
...
'========================================================================================================
Const BIZ_PGM_ID = "a5108mb1_ko533.asp"                                      '비지니스 로직 ASP명
...
Sub MakeKeyStream(pRow)
    ...
    lgKeyStream   = lgKeyStream & "ND01" & gColSep
					...
					<TD CLASS="CLSMTABP">
						<TABLE ID="MyTab" CELLSPACING=0 CELLPADDING=0>
							<TR>
								...
								<td background="../../image/table/seltab_up_bg.gif" align="center" CLASS="CLSMTAB"><font color=white>대차대조표 월별추이현황</font></td>
						...
						<TABLE <%=LR_SPACE_TYPE_40%>>
						    <TR>
								...
								<TD CLASS="TD6" NOWRAP><INPUT NAME="txtBizAreaCd" ALT="사업장코드" Size="10" MAXLENGTH="10" STYLE="TEXT-ALIGN: LEFT" tag="11NXXU"><IMG SRC="../../../CShared/image/btnPopup.gif" NAME="btn" ALIGN=top TYPE="BUTTON" ONCLICK="vbscript:CALL OpenPopUp(0)">
													   <INPUT NAME="txtBizAreaNm" ALT="사업장명" Size="15" MAXLENGTH="40" STYLE="TEXT-ALIGN: LEFT" tag="14NXXU">&nbsp;~&nbsp;</TD> 
						   ...
						   <TR>
                            ...
                            -->
									...
									<TD CLASS="TD6" NOWRAP>
						           	...
						           	<TD CLASS="TD5" NOWRAP>재무제표구분</TD>
									<TD CLASS="TD6" NOWRAP>
										<SPAN STYLE="WIDTH: 80px"><INPUT TYPE="RADIO" CLASS="RADIO" NAME="QueryFg" CHECKED ID="queryFg1" VALUE="Y" tag="15"><LABEL FOR="ZeroFg1">재무제표코드(BS)</LABEL></SPAN>										
                                    </TD>		
						    </TR>					
						</TABLE>
						</FIELDSET>
