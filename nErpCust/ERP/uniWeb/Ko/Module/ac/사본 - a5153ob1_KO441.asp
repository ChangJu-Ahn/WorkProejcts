...
Sub SubBizBatch()
    ...
    With lgObjComm
	    ...
	    lgObjComm.Parameters.Append lgObjComm.CreateParameter("@from_mnth"      ,adVarChar,adParamInput,06, StrFrDt)
	    lgObjComm.Parameters.Append lgObjComm.CreateParameter("@to_mnth"		,adVarChar,adParamInput,06, StrToDt)
