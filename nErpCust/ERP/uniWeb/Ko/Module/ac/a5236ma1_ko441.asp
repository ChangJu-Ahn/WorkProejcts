...
'========================================================================================================
Const BIZ_PGM_ID = "a5236mb1_ko441.asp"                                      '비지니스 로직 ASP명
...
'	frm1.txtToGLDt.text   = "<%=EndDate%>"
	...
	Call ggoOper.FormatDate(frm1.txtGlYear2,   Parent.gDateFormat, 3)
...
'	VarFiscDt	= GetFiscDate(frm1.txtGlYear.Text)
    ...
    lgKeyStream   = lgKeyStream & Replace(frm1.txtGlYear2.text,"-","") & gColSep
...
Sub InitSpreadSheet()
	...
	With frm1.vspdData	
		...
		.MaxCols = C_LM12 + 1				   								    <%'☜: 최대 Columns의 항상 1개 증가시킴 %>
		...
		ggoSpread.SSSetFloat  C_LTOT     , "비교년도 합  계"  , 14, ggAmtOfMoneyNo,ggStrIntegeralPart, ggStrDeciPointPart,gComNum1000,gComNumDec
		ggoSpread.SSSetFloat  C_LM01     , "비교년도 1  월"   , 12, ggAmtOfMoneyNo,ggStrIntegeralPart, ggStrDeciPointPart,gComNum1000,gComNumDec
		ggoSpread.SSSetFloat  C_LM02     , "비교년도 2  월"   , 12, ggAmtOfMoneyNo,ggStrIntegeralPart, ggStrDeciPointPart,gComNum1000,gComNumDec		
		ggoSpread.SSSetFloat  C_LM03     , "비교년도 3  월"   , 12, ggAmtOfMoneyNo,ggStrIntegeralPart, ggStrDeciPointPart,gComNum1000,gComNumDec
		ggoSpread.SSSetFloat  C_LM04     , "비교년도 4  월"   , 12, ggAmtOfMoneyNo,ggStrIntegeralPart, ggStrDeciPointPart,gComNum1000,gComNumDec
		ggoSpread.SSSetFloat  C_LM05     , "비교년도 5  월"   , 12, ggAmtOfMoneyNo,ggStrIntegeralPart, ggStrDeciPointPart,gComNum1000,gComNumDec
		ggoSpread.SSSetFloat  C_LM06     , "비교년도 6  월"   , 12, ggAmtOfMoneyNo,ggStrIntegeralPart, ggStrDeciPointPart,gComNum1000,gComNumDec
		ggoSpread.SSSetFloat  C_LM07     , "비교년도 7  월"   , 12, ggAmtOfMoneyNo,ggStrIntegeralPart, ggStrDeciPointPart,gComNum1000,gComNumDec
		ggoSpread.SSSetFloat  C_LM08     , "비교년도 8  월"   , 12, ggAmtOfMoneyNo,ggStrIntegeralPart, ggStrDeciPointPart,gComNum1000,gComNumDec
		ggoSpread.SSSetFloat  C_LM09     , "비교년도 9  월"   , 12, ggAmtOfMoneyNo,ggStrIntegeralPart, ggStrDeciPointPart,gComNum1000,gComNumDec
		ggoSpread.SSSetFloat  C_LM10     , "비교년도 10 월"   , 12, ggAmtOfMoneyNo,ggStrIntegeralPart, ggStrDeciPointPart,gComNum1000,gComNumDec
		ggoSpread.SSSetFloat  C_LM11     , "비교년도 11 월"   , 12, ggAmtOfMoneyNo,ggStrIntegeralPart, ggStrDeciPointPart,gComNum1000,gComNumDec
		ggoSpread.SSSetFloat  C_LM12     , "비교년도 12 월"   , 12, ggAmtOfMoneyNo,ggStrIntegeralPart, ggStrDeciPointPart,gComNum1000,gComNumDec
...
Sub SetSpreadLock()
    With frm1
        ...
        ggoSpread.SpreadLock    C_ACCTCD, -1, C_LM12
...
Sub txtGlYear2_DblClick(Button)
    If Button = 1 Then
        frm1.txtGlYear.Action = 7
    End If
End Sub
					...
					<TD HEIGHT=20 WIDTH=100%>
						...
						<TABLE <%=LR_SPACE_TYPE_40%>>
						    <TR>
								...
								<TD CLASS="TD6" NOWRAP><SCRIPT LANGUAGE=JavaScript> ExternalWrite('<OBJECT CLASSID=<%=gCLSIDFPDT%> NAME="txtGlYear"  CLASS=FPDTYYYY tag="12" Title="FPDATETIME" ALT="연도" id=fpDateTime1></OBJECT>');</SCRIPT>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;비교년도:&nbsp;
													   <SCRIPT LANGUAGE=JavaScript> ExternalWrite('<OBJECT CLASSID=<%=gCLSIDFPDT%> NAME="txtGlYear2" CLASS=FPDTYYYY tag="12" Title="FPDATETIME" ALT="비교연도" id=fpDateTime1></OBJECT>');</SCRIPT>
								</TD>
