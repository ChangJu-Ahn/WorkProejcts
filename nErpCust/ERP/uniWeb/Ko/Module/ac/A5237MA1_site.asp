...
*  2. Function Name        : cost센터별제조비용집계
*  3. Program ID           : a5237ma1_ko533
*  4. Program Name         : cost센터별제조비용집계_DISPLAY용
*  5. Program Desc         : cost센터별제조비용집계
*  6. Comproxy List        :
*  7. Modified date(First) : 2011/03/30
...
'========================================================================================================
'Const BIZ_PGM_ID = "a5237mb1_KO533.asp"                                      '비지니스 로직 ASP명
Const BIZ_PGM_ID = "a5237mb1_site.asp"
...
'	lgKeyStream   = Replace(frm1.txtGlYear.text,"-","") & gColSep     
    ...
    lgKeyStream   = "ALL" & gColSep  
    lgKeyStream   = lgKeyStream & strZeroFg & gColSep       
	lgKeyStream   = lgKeyStream & Replace(frm1.txtGlYear.text,"-","") & gColSep     
...
Dim i
	...
	With frm1.vspdData	
		...
		.MaxCols = 131' C_M12 + 1				   								    <%'☜: 최대 Columns의 항상 1개 증가시킴 %>
    ...
    '가로로 조회되는 칼럼을 만들어 준다.
		for i = 1 to 131
            ggoSpread.SSSetEdit   i   , i , 17        		
            ' ggoSpread.SSSetFloat  i      , "1  월"   , 12, ggAmtOfMoneyNo,ggStrIntegeralPart, ggStrDeciPointPart,gComNum1000,gComNumDec            
        next
...
Sub SetSpreadLock()
    With frm1
        ...
        ggoSpread.SpreadLock    1, -1, 129'99
					...
					<TD CLASS="CLSMTABP">
						<TABLE ID="MyTab" CELLSPACING=0 CELLPADDING=0>
							<TR>
								...
								<td background="../../image/table/seltab_up_bg.gif" align="center" CLASS="CLSMTAB"><font color=white>코스트센터별 제조비용집계</font></td>
					...
					<TD HEIGHT=20 WIDTH=100%>
						...
						<TABLE <%=LR_SPACE_TYPE_40%>>
						    <TR>
								...
								<TD CLASS="TD6" NOWRAP>
								    <SCRIPT LANGUAGE=JavaScript>ExternalWrite('<OBJECT CLASSID=<%=gCLSIDFPDT%> NAME="txtGlYear" CLASS=FPDTYYYYMM tag="12X1" Title="FPDATETIME" ALT="조회년월" id=fpDateTime1></OBJECT>');</SCRIPT></TD>
								...
								<TD CLASS="TD6" NOWRAP>
									<SPAN STYLE="WIDTH: 80px"><INPUT TYPE="RADIO" CLASS="RADIO" NAME="ZeroFg" CHECKED ID="ZeroFg1" VALUE="Y" tag="15"><LABEL FOR="ZeroFg1">집계</LABEL></SPAN>
									<SPAN STYLE="WIDTH: 80px"><INPUT TYPE="RADIO" CLASS="RADIO" NAME="ZeroFg"  ID="ZeroFg2" VALUE="N" tag="15"><LABEL FOR="ZeroFg2">상세</LABEL></SPAN>
								</TD>										
						    </TR>					
						</TABLE>
						</FIELDSET>
...
<!--				<TR>
	...
	<TR>
   <!-- <%=BizSize%>>-->
		<TD WIDTH=100% HEIGHT=1><IFRAME NAME="MyBizASP" SRC="../../blank.htm" WIDTH=100% HEIGHT=1 FRAMEBORDER=0 SCROLLING=no
