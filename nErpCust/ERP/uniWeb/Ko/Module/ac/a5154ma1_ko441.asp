...
'*  3. Program ID           : A5154MA1_ko441
'*  4. Program Name         : 결의전표_계정별 상세조회 
...
Const BIZ_PGM_ID        = "A5154MB1_ko441.asp"
Const C_MaxKey          = 2 
...
'========================================================================================
Sub InitSpreadSheet()
    'Call SetZAdoSpreadSheet("A5154MA1_ko321","S","A","V20021211",parent.C_SORT_DBAGENT,frm1.vspdData, C_MaxKey, "X","X")
    Call SetZAdoSpreadSheet("A5154MA1_ko441","S","A","V20021211",parent.C_SORT_DBAGENT,frm1.vspdData, C_MaxKey, "X","X")
...
'--------------- 개발자 coding part(실행로직,Start)----------------------------------------------
		...
		strVal = strVal & "&cboConfFg=" & .cboConfFg.value
					...
					<TD CLASS="CLSMTABP">
						<TABLE ID="MyTab" CELLSPACING=0 CELLPADDING=0>
							<TR>
								...
								<td background="../../../CShared/image/table/seltab_up_bg.gif" align="center" CLASS="CLSMTAB"><font color=white>결의전표_계정별상세조회</font></td>
					...
					<TD HEIGHT=20 WIDTH=100%>
						<FIELDSET CLASS="CLSFLD">
								...
								<TR>
									...
									<TD CLASS="TD6" NOWRAP><OBJECT classid=<%=gCLSIDFPDT%> NAME="txtFromGlDt" CLASS=FPDTYYYYMMDD tag="12" Title="FPDATETIME" ALT="시작일자" id=fpDateTime1></OBJECT>&nbsp;~&nbsp;
												           <OBJECT classid=<%=gCLSIDFPDT%> NAME="txtToGlDt"   CLASS=FPDTYYYYMMDD tag="12" Title="FPDATETIME" ALT="종료일자" id=fpDateTime2></OBJECT></TD>
								...
								<TR>
									...
									<TD CLASS=TD6 NOWRAP><OBJECT classid=<%=gCLSIDFPDS%> name="txtAmtFr" style="HEIGHT: 20px; LEFT: 0px; TOP: 0px; WIDTH: 100px" title=FPDOUBLESINGLE tag="11XXXX" ALT="시작금액" id=OBJECT1></OBJECT>&nbsp;~&nbsp;
										 <OBJECT classid=<%=gCLSIDFPDS%> name="txtAmtTo" style="HEIGHT: 20px; LEFT: 0px; TOP: 0px; WIDTH: 100px" title=FPDOUBLESINGLE tag="11XXXX" ALT="종료금액" id=OBJECT2></OBJECT>
										 </TD>	
								 ...
								 <TR>
									...
									<TD CLASS=TD656 NOWRAP COLSPAN=3><INPUT NAME="txtDesc" ALT="적요" MAXLENGTH="128" SIZE="70" tag="11" ></TD>
								 </TR>
					...
					<TD WIDTH=100% HEIGHT=* valign=top>
						<TABLE <%=LR_SPACE_TYPE_60%>>
							<TR>
								...
								<OBJECT CLASSID=<%=gCLSIDFPSPD%> ID=vspdData NAME=vspdData WIDTH=100% HEIGHT=100% tag="23" TITLE="SPREAD" >
							...
							<TR>
								...
								<TD class=TD5 NOWRAP><OBJECT classid=<%=gCLSIDFPDS%> name="txtTDrAmt" style="HEIGHT: 20px; LEFT: 0px; TOP: 0px; WIDTH: 150px" title=FPDOUBLESINGLE ALT="차변" tag="24X2" id=OBJECT22></OBJECT></TD>								
								<TD CLASS=TD5 NOWRAP>대변</TD>
								<TD class=TD5 NOWRAP><OBJECT classid=<%=gCLSIDFPDS%> name="txtTCrAmt" style="HEIGHT: 20px; LEFT: 0px; TOP: 0px; WIDTH: 150px" title=FPDOUBLESINGLE ALT="대변" tag="24X2" id=OBJECT22></OBJECT></TD>								
								<TD CLASS=TD5 NOWRAP>잔액</TD>
								<TD class=TD5 NOWRAP><OBJECT classid=<%=gCLSIDFPDS%> name="txtTSumAmt" style="HEIGHT: 20px; LEFT: 0px; TOP: 0px; WIDTH: 150px" title=FPDOUBLESINGLE ALT="잔액" tag="24X2" id=OBJECT22></OBJECT></TD>								
							</TR>
							<TR>
								<TD CLASS=TD5 NOWRAP>발생금액</TD>
								<TD CLASS=TD5 NOWRAP>차변</TD>
								<TD class=TD5 NOWRAP><OBJECT classid=<%=gCLSIDFPDS%> name="txtNDrAmt" style="HEIGHT: 20px; LEFT: 0px; TOP: 0px; WIDTH: 150px" title=FPDOUBLESINGLE ALT="차변" tag="24X2" id=OBJECT22></OBJECT></TD>								
								<TD CLASS=TD5 NOWRAP>대변</TD>
								<TD class=TD5 NOWRAP><OBJECT classid=<%=gCLSIDFPDS%> name="txtNCrAmt" style="HEIGHT: 20px; LEFT: 0px; TOP: 0px; WIDTH: 150px" title=FPDOUBLESINGLE ALT="대변" tag="24X2" id=OBJECT22></OBJECT></TD>								
								<TD CLASS=TD5 NOWRAP>차이</TD>
								<TD class=TD5 NOWRAP><OBJECT classid=<%=gCLSIDFPDS%> name="txtNSumAmt" style="HEIGHT: 20px; LEFT: 0px; TOP: 0px; WIDTH: 150px" title=FPDOUBLESINGLE ALT="차이" tag="24X2" id=OBJECT22></OBJECT></TD>								
							</TR>
							<TR>
								<TD CLASS=TD5 NOWRAP>누계금액</TD>
								<TD CLASS=TD5 NOWRAP>차변</TD>
								<TD class=TD5 NOWRAP><OBJECT classid=<%=gCLSIDFPDS%> name="txtSDrAmt" style="HEIGHT: 20px; LEFT: 0px; TOP: 0px; WIDTH: 150px" title=FPDOUBLESINGLE ALT="차변" tag="24X2" id=OBJECT22></OBJECT></TD>								
								<TD CLASS=TD5 NOWRAP>대변</TD>
								<TD class=TD5 NOWRAP><OBJECT classid=<%=gCLSIDFPDS%> name="txtSCrAmt" style="HEIGHT: 20px; LEFT: 0px; TOP: 0px; WIDTH: 150px" title=FPDOUBLESINGLE ALT="대변" tag="24X2" id=OBJECT22></OBJECT></TD>								
								<TD CLASS=TD5 NOWRAP>잔액</TD>
								<TD class=TD5 NOWRAP><OBJECT classid=<%=gCLSIDFPDS%> name="txtSSumAmt" style="HEIGHT: 20px; LEFT: 0px; TOP: 0px; WIDTH: 150px" title=FPDOUBLESINGLE ALT="잔액" tag="24X2" id=OBJECT22></OBJECT></TD>
							</TR>
						</TABLE>						
					</TD>
				</TR>
