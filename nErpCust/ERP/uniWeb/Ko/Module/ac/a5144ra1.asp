...
Const BIZ_PGM_ID 		= "a5144rb1.asp"                              '☆: Biz Logic ASP Name
'========================================================================================================
...
Dim arrParam
DIm txtStdDt		'결산 년월					
DIm txtFromDt		'결산 시작일자 
DIm txtToDt			'결산 종료일자 
DIm txtGlinputType	'입력경로 
...
Sub SetDefaultVal()
	...
	frm1.txtInputType.value	= arrParam(1)		'입력경로 
	frm1.txtFromDt.value	= Trim(arrParam(2))	'시작일 
	frm1.txtToDt.value		= Trim(arrParam(3))	'종료일 
	frm1.txtBizAreaCd.value = Trim(arrParam(4))	'사업장 
	frm1.hOrgChangeId.value = Trim(arrParam(5))	'hOrgChangeId
End Sub
...
Sub InitSpreadSheet()
    ...
    Call SetZAdoSpreadSheet("A5144RA1","S","A","V20021212",PopupParent.C_SORT_DBAGENT,frm1.vspdData, C_MaxKey, "X","X")
...
Function OpenPopupGL()
	...
	arrParam(0) = Trim(GetKeyPosVal("A", 1))	'회계전표번호 
...
Function FncQuery() 
    ...
    End If
     ...
     If Trim(frm1.txtAcctCd.value) = "" or Trim(frm1.txtInputType.value) = "" Then
...
Function DbQuery() 
    ...
    With frm1
		strVal = BIZ_PGM_ID & "?txtFromDt=" & UniConvDateToYYYYMMDD(frm1.txtFromDt.value,parent.gDateFormat,"")
		strVal = strVal & "&txtToDt=" & UniConvDateToYYYYMMDD(frm1.txtToDt.value,parent.gDateFormat,"")
...
<TABLE <%=LR_SPACE_TYPE_20%>>
			...
			<FIELDSET CLASS="CLSFLD">
				<TABLE <%=LR_SPACE_TYPE_40%>>
					<TR>
						...
						<TD CLASS=TD6 NOWRAP><INPUT TYPE=TEXT NAME="txtFromDt" SIZE=10 MAXLENGTH=10 tag="14XXXU" ALT="회계년도" STYLE="TEXT-ALIGN:left"> ~ <INPUT TYPE=TEXT NAME="txtToDt" SIZE=10 MAXLENGTH=10 tag="14XXXU" ALT="회계년도" STYLE="TEXT-ALIGN:left"></TD>						
					...
					<TR>
						<TD CLASS=TD5 ID="txtStdYYMMTit" NOWRAP>전표입력경로</TD>
						<TD CLASS=TD6 NOWRAP><INPUT TYPE="Text" NAME="txtInputType" SIZE=10 MAXLENGTH=10 tag="14XXXU" ALT="전표입력경로코드"> <INPUT TYPE="Text" NAME="txtInputTypeNm" SIZE=18 tag="24X" ALT="전표입력경로명"></TD>
	...
	<TR>
		<TD WIDTH=100% HEIGHT=* VALIGN=TOP>
			...
			<TABLE <%=LR_SPACE_TYPE_20%>>
				<TR>
					<TD CLASS="TD5" NOWRAP>차변금액</TD>
					<TD CLASS=TD6 NOWRAP>
						<script language =javascript src='./js/a5144ra1_fpDoubleSingle2_txtDrLocAmt.js'></script></TD>
					<TD CLASS="TD5" NOWRAP>대변금액</TD>
					<TD CLASS=TD6 NOWRAP>
						<script language =javascript src='./js/a5144ra1_fpDoubleSingle2_txtCrLocAmt.js'></script>
						&nbsp; &nbsp; &nbsp;<BUTTON NAME="btnGl" CLASS="CLSMBTN" ONCLICK="vbscript:OpenPopUpGl()">회계전표팝업</BUTTON>
						</TD>
				</TR>
			</TABLE>
			</FIELDSET>
	...
	<TR HEIGHT=100%>
		<TD WIDTH=100% HEIGHT=* VALIGN=TOP>
			<TABLE <%=LR_SPACE_TYPE_20%>>
				<TR HEIGHT=100%>
					<TD WIDTH=100%>
						<script language =javascript src='./js/a5144ra1_vspdData_vspdData.js'></script>
					</TD>
				</TR>
			</TABLE>
		</TD>
