...
*  2. Function Name        : 손익계산서월별추이현황
*  3. Program ID           : a5109ma1_site
*  4. Program Name         : 손익계산서월별추이현황
...
'========================================================================================================
Const BIZ_PGM_ID = "a5109mb1_site.asp"                                      '비지니스 로직 ASP명
					...
					<TD CLASS="CLSMTABP">
						<TABLE ID="MyTab" CELLSPACING=0 CELLPADDING=0>
							<TR>
								...
								<td background="../../image/table/seltab_up_bg.gif" align="center" CLASS="CLSMTAB"><font color=white>손익계산서 월별추이현황</font></td>
						   ...
						   <TR>
                            ...
                            -->
									...
									<TD CLASS="TD6" NOWRAP>
						           	...
						           	<TD CLASS="TD5" NOWRAP>재무제표구분</TD>
									<TD CLASS="TD6" NOWRAP>
										<SPAN STYLE="WIDTH: 80px"><INPUT TYPE="RADIO" CLASS="RADIO" NAME="QueryFg" CHECKED ID="queryFg1" VALUE="Y" tag="15"><LABEL FOR="ZeroFg1">재무제표코드(PL)</LABEL></SPAN>										
                                    </TD>		
						    </TR>					
						</TABLE>
						</FIELDSET>
