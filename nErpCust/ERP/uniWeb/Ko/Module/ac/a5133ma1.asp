...
'*  3. Program ID           : a5133ma1
'*  4. Program Name         : 기초 계정집계표 조회 
'*  5. Program Desc         : Query of Account Summerization
'*  6. Comproxy List        : 
'*  7. Modified date(First) : 2002/02/22
...
'========================================================================================================
Const BIZ_PGM_ID 		= "a5133Mb1.asp"                              '☆: Biz Logic ASP Name
...
'--------------- 개발자 coding part(실행로직,Start)-----------------------------------------------------------
  ...
  Call GetAdoFiledInf("A5133MA1","S", "A")						'☆: spread sheet 필드정보 query   -----
...
Function FncBtnPreview() 
	...
	Dim StrEbrFile, VarBizArea, VarClassTypeFr, VarClassTypeTo, VarDateFr,VarDateTo,  VarDate, VarDrAmt, VarCrAmt
					...
					<TD CLASS="CLSMTABP">
						<TABLE ID="MyTab" CELLSPACING=0 CELLPADDING=0>
							<TR>
								...
								<td background="../../image/table/seltab_up_bg.gif" align="center" CLASS="CLSMTAB"><font color=white>기초계정집계표조회</font></td>
						...
						<FIELDSET CLASS="CLSFLD">
							<TABLE <%=LR_SPACE_TYPE_40%>>
								<TR>
									...
									<TD CLASS="TD6" NOWRAP><script language =javascript src='./js/a5133ma1_fpDateYr_txtDateYr.js'></script>
									</TD>
						...
						<TABLE <%=LR_SPACE_TYPE_20%>>
							<TR>
								<TD HEIGHT="100%" NOWRAP>
									<script language =javascript src='./js/a5133ma1_vspdData_vspdData.js'></script>
								</TD>
							</TR>
						</TABLE>
					</TD>
