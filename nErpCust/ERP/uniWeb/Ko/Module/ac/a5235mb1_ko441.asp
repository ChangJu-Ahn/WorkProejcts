...
Sub SubBizQueryMulti()    
    ...
    Err.Clear                                                               '☜: Clear Error status
	 ...
	 strWhere = FilterVar(lgKeyStream(0), "''", "S") & ", " & _ 
				...
				FilterVar(lgKeyStream(7), "''", "S") & ", " & _ 
				FilterVar(lgKeyStream(8), "''", "S") 
    ...
    Else
       ...
       Do While Not lgObjRs.EOF        
			...
			lgStrData = lgStrData & Chr(11) & lgObjRs("CTRL_VAL1")
			lgStrData = lgStrData & Chr(11) & lgObjRs("CTRL_VAL_NM1")   
			lgStrData = lgStrData & Chr(11) & lgObjRs("CTRL_VAL2")   
			lgStrData = lgStrData & Chr(11) & lgObjRs("CUR")   
			lgStrData = lgStrData & Chr(11) & lgObjRs("PRE")  
			lgStrData = lgStrData & Chr(11) & lgObjRs("PRE_KRW")  
			lgStrData = lgStrData & Chr(11) & lgObjRs("INC")  
			lgStrData = lgStrData & Chr(11) & lgObjRs("INC_KRW")  
			lgStrData = lgStrData & Chr(11) & lgObjRs("DEC1")  
			lgStrData = lgStrData & Chr(11) & lgObjRs("DEC_KRW")  
			lgStrData = lgStrData & Chr(11) & lgObjRs("JAN")  
			lgStrData = lgStrData & Chr(11) & lgObjRs("JAN_KRW")
        ...
        Case "M"
           ...
           Select Case Mid(pDataType,2,1)
               ...
               Case "R"     
						...
						lgStrSQL = " SELECT *  "
						lgStrSQL = lgStrSQL & " FROM ufn_a5235ma1_ko441(" & pCode & ") "
