...
Sub SubBizQueryMulti()    
    ...
    Else
       ...
       Do While Not lgObjRs.EOF        
           ...
           lgStrData = lgStrData & Chr(11) & lgObjRs(17)   
           lgStrData = lgStrData & Chr(11) & lgObjRs(18)   
           lgStrData = lgStrData & Chr(11) & lgObjRs(19)  
           lgStrData = lgStrData & Chr(11) & lgObjRs(20)  
           lgStrData = lgStrData & Chr(11) & lgObjRs(21)  
           lgStrData = lgStrData & Chr(11) & lgObjRs(22)  
           lgStrData = lgStrData & Chr(11) & lgObjRs(23)  
           lgStrData = lgStrData & Chr(11) & lgObjRs(24)  
           lgStrData = lgStrData & Chr(11) & lgObjRs(25)  
           lgStrData = lgStrData & Chr(11) & lgObjRs(26)
           lgStrData = lgStrData & Chr(11) & lgObjRs(27)    
           ...
           Select Case Mid(pDataType,2,1)
               ...
               Case "R"     
					If strZeroFg1 = "Y" then
						...
						lgStrSQL = " SELECT *  "
						lgStrSQL = lgStrSQL & " FROM ufn_a5236ma1_ko441(" & pCode & ") "
