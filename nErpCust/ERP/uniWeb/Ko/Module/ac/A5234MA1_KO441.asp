...
Const BIZ_PGM_ID      = "A5234MB1_KO441.asp"
...
Sub MakeKeyStream(pDirect)
   '------ Developer Coding part (Start ) -------------------------------------------------------------- 
    ...
    lgKeyStream = lgKeyStream & Trim(frm1.txtCurrencyCd.value)		& Parent.gColSep
...
Sub InitSpreadSheet()
	...
	With frm1.vspdData
		...
		ggoSpread.SSSetEdit    C_currency		,"화폐"				,4
		ggoSpread.SSSetFloat   C_xchg_rate	    	,"환율"				,8 ,"7",ggStrIntegeralPart, ggStrDeciPointPart,parent.gComNum1000,parent.gComNumDec,,,"Z"
		ggoSpread.SSSetFloat   C_doc_amt	    	,"외화금액"			,12 ,"6",ggStrIntegeralPart, ggStrDeciPointPart,parent.gComNum1000,parent.gComNumDec,,,"Z"
...
Sub GetSpreadColumnPos(ByVal pvSpdNo)
    ...
    Select Case UCase(pvSpdNo)
       Case "A"
			...
			C_xchg_rate		= iCurColumnPos(10)
			C_doc_amt		= iCurColumnPos(11)

			C_minor_nm		= iCurColumnPos(12)
			C_item_desc		= iCurColumnPos(13)
			C_ctrl_val1		= iCurColumnPos(14)
			C_ctrl_val2		= iCurColumnPos(15)
			C_ctrl_val3		= iCurColumnPos(16)
			C_ctrl_val4		= iCurColumnPos(17)
			C_ctrl_val5		= iCurColumnPos(18)
			C_ctrl_val6		= iCurColumnPos(19)		
...
Function QueryCtrlVal()
    ...
    Dim ArrRet
      ...
      Call CommonQueryRs( "TBL_ID,DATA_COLM_ID,DATA_COLM_NM,COLM_DATA_TYPE,KEY_COLM_ID1,MAJOR_CD " , _ 
				"A_CTRL_ITEM" , _
				 "CTRL_CD = " & FilterVar(frm1.txtCtrlCd.value, "''", "S"), _ 
				 lgF0,lgF1,lgF2,lgF3,lgF4,lgF5,lgF6)
	...
	IF Trim(ArrRet(0)) <> "" then
		...
		if len(trim(replace(lgF5,Chr(11),""))) > 1 then

			frm1.hWhere.value = replace(lgF4,Chr(11),"") & "= " & filterVar(replace(lgF5,Chr(11),""),"''","S")
		else
					...
					<TD CLASS="CLSMTABP">
						<TABLE ID="MyTab" CELLSPACING=0 CELLPADDING=0>
							<TR>
								...
								<td background="../../../CShared/image/table/seltab_up_bg.gif" align="center" CLASS="CLSMTAB"><font color=white>외화계정별보조부(S)</font></td>
				...
				<TR>
					<TD HEIGHT=20 WIDTH=100%>
						...
						-->
							...
							<TD CLASS="TD6" NOWRAP><INPUT NAME="txtCurrencyCd" ALT="화폐코드" Size="10" MAXLENGTH="3" STYLE="TEXT-ALIGN: LEFT" tag="11NXXU"><IMG SRC="../../../CShared/image/btnPopup.gif" NAME="btn" ALIGN=top TYPE="BUTTON" ONCLICK="vbscript:CALL OpenPopUp(21)">
...
<INPUT TYPE=hidden NAME="hWhere" tag="24" TABINDEX="-1">
</FORM>
