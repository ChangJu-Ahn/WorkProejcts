...
Sub InitSpreadSheet()
	...
	With frm1.vspdData
	    ...
	    ggoSpread.SSSetFloat  C_ITEM_AMT,       "잔액"          ,15, parent.ggAmTofMoneyNo,ggStrIntegeralPart, ggStrDeciPointPart,parent.gComNum1000,parent.gComNumDec
    	            ...
    	            <TD HEIGHT=20 WIDTH=90%>
			            ...
			            <TABLE <%=LR_SPACE_TYPE_40%>>
			            	...
			            	<TR>
			            		...
			            		<TD CLASS="TD6" NOWRAP>
									<INPUT TYPE=TEXT NAME="txtBizAreaCd" SIZE=10 MAXLENGTH=20 tag="12XXXU" ALT="사업장"><IMG SRC="../../../CShared/image/btnPopup.gif" NAME="btnMajorCd" ALIGN=top TYPE="BUTTON" ONCLICK="vbscript:OpenCondAreaPopup(1)">
