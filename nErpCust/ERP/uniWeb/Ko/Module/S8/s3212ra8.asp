...
'*  3. Program ID           : S3212RA8
'*  4. Program Name         : L/C 내역참조 
'*  5. Program Desc         : B/L내역등록에서 L/C 내역참조Popup
'*  6. Comproxy List        : 
...
'========================================================================================================
Const BIZ_PGM_ID 		= "s3212rb8.asp"                              '☆: Biz Logic ASP Name
'========================================================================================================
...
Sub InitSpreadSheet()
	...
	Call SetZAdoSpreadSheet("S3212RA8","S","A","V20030301",PopupParent.C_SORT_DBAGENT,frm1.vspdData, _
								C_MaxKey, "X","X")		
	Call SetSpreadLock 	 
					...
					<TR>
						...
						<TD CLASS=TD6>
							<TABLE CELLSPACING=0 CELLPADDING=0>
								<TR>
									<TD>
										<script language =javascript src='./js/s3212ra8_fpDateTime1_txtFromDt.js'></script>
									</TD>
									<TD>
										&nbsp;~&nbsp;
									</TD>
									<TD>
										<script language =javascript src='./js/s3212ra8_fpDateTime2_txtToDt.js'></script>
									</TD>
								</TR>
							</TABLE>
						</TD>
	...
	<TR>
		<TD WIDTH=100% HEIGHT=* valign=top>
			<TABLE <%=LR_SPACE_TYPE_20%>>
				<TR>
					<TD HEIGHT="100%">
						<script language =javascript src='./js/s3212ra8_vaSpread_vspdData.js'></script>
					</TD>
				</TR>
			</TABLE>
		</TD>
