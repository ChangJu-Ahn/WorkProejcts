...
'========================================================================================================
Const BIZ_PGM_ID 		= "s3211rb8_KO441.asp"                              '☆: Biz Logic ASP Name
'========================================================================================================
...
Sub InitSpreadSheet()
	...
	Call SetZAdoSpreadSheet("S3111BA2","S","A","V20021202",PopupParent.C_SORT_DBAGENT,frm1.vspdData, _
								C_MaxKey, "X","X")		
	Call SetSpreadLock
...
Function OKClick()
	...
	With frm1
		If .vspdData.ActiveRow > 0 Then	
			...
			.vspdData.Col =  GetKeyPos("A",1)		' L/C 관리번호 
			iArrReturn(0) = .vspdData.Text
			.vspdData.Col =  GetKeyPos("A",4)		' 수주번호 
					...
					<TR>
						...
						<TD CLASS="TD6" NOWRAP>
							<TABLE CELLSPACING=0 CELLPADDING=0>
								<TR>
									<TD>
										<script language =javascript src='./js/s3211ra8_fpDateTime1_txtFromDt.js'></script>
									</TD>
									<TD>
										&nbsp;~&nbsp;
									</TD>
									<TD>
										<script language =javascript src='./js/s3211ra8_fpDateTime2_txtToDt.js'></script>
									</TD>
								</TR>
							</TABLE>
						</TD>
	...
	<TR>
		<TD WIDTH=100% HEIGHT=* valign=top>
			<TABLE <%=LR_SPACE_TYPE_20%>>
				<TR>
					<TD HEIGHT="100%">
						<script language =javascript src='./js/s3211ra8_OBJECT1_vspdData.js'></script>
					</TD>
				</TR>
			</TABLE>
		</TD>
