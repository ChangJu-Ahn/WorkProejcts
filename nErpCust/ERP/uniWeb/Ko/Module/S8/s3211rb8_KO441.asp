...
'--------------- 개발자 coding part(실행로직,Start)----------------------------------------------------
    If Len(Trim(Request("txtApplicant"))) Then
		UNIValue(0,1) = " " & FilterVar(Request("txtApplicant"), "''", "S") & ""                   '주문처 
	Else
		UNIValue(0,1) = "Null"
	End If
    ...
    If Len(Trim(Request("txtCurrency"))) Then
		UNIValue(0,4) = " " & FilterVar(Request("txtCurrency"), "''", "S") & ""                      '화폐 
	Else
		UNIValue(0,4) = "Null"
	End If
	...
	If Len(Request("gBizArea")) Then
		UNIValue(0,6) = UNIValue(0,6) & " AND LC.BIZ_AREA = " & FilterVar(Request("gBizArea"), "''", "S") & " "			
	End If

	If Len(Request("gPlant")) Then
		UNIValue(0,6) = UNIValue(0,6) & " AND LC.PLANT_CD = " & FilterVar(Request("gPlant"), "''", "S") & " "			
	End If

	If Len(Request("gSalesGrp")) Then
		UNIValue(0,6) = UNIValue(0,6) & " AND LC.SALES_GRP = " & FilterVar(Request("gSalesGrp"), "''", "S") & " "			
	End If

	If Len(Request("gSalesOrg")) Then
		UNIValue(0,6) = UNIValue(0,6) & " AND LC.SALES_ORG = " & FilterVar(Request("gSalesOrg"), "''", "S") & " "			
	End If
