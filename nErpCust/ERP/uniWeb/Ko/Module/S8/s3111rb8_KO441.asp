...
'----------------------------------------------------------------------------------------------------------
	Sub FixUNISQLData()
	    ...
	    UNISqlId(0) = "S3111RA801"  ' main query(spread sheet에 뿌려지는 query statement)
		...
		If Len(Trim(Request("txtApplicant"))) Then
			strVal = " AND SH.sold_to_party  =  " & FilterVar(Request("txtApplicant"), "''", "S") & ""
		End If
	...
	If Len(Request("gBizArea")) Then
		strVal = strVal & " AND SH.BIZ_AREA = " & FilterVar(Request("gBizArea"), "''", "S") & " "			
	End If

	If Len(Request("gSalesGrp")) Then
		strVal = strVal & " AND SH.SALES_GRP = " & FilterVar(Request("gSalesGrp"), "''", "S") & " "			
	End If

	If Len(Request("gSalesOrg")) Then
		strVal = strVal & " AND SH.SALES_ORG = " & FilterVar(Request("gSalesOrg"), "''", "S") & " "			
	End If
