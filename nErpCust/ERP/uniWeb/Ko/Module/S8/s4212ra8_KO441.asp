...
'*  3. Program ID           : S4212RA8
'*  4. Program Name         : 통관 내역참조 
'*  5. Program Desc         : B/L내역등록에서 통관 내역참조Popup
'*  6. Comproxy List        : 
...
'========================================================================================================
Const BIZ_PGM_ID 		= "s4212rb8_KO441.asp"                              '☆: Biz Logic ASP Name
'========================================================================================================
Const C_MaxKey          = 24                                           '☆: key count of SpreadSheet
Const C_PopItemCd		= 1
'========================================================================================================
...
Sub SetDefaultVal()
	...
	With frm1
		...
		lgStrRefFlag			= iArrParam(11)

		If lgStrRefFlag = "M" Then
			Call ggoOper.SetReqAttr(frm1.txtTrackingNo,"Q")
			frm1.btnTrackingNo.disabled = True
		End If
	End With
...
Sub InitSpreadSheet()
	...
	<%IF Request("txtRefFlag") = "M" Then%>
		Call SetZAdoSpreadSheet("S4212RA802","S","A","V20030301",PopupParent.C_SORT_DBAGENT,frm1.vspdData, _
								C_MaxKey, "X","X")		
			    
	<%Else%>
		Call SetZAdoSpreadSheet("S4212RA801","S","A","V20030301",PopupParent.C_SORT_DBAGENT,frm1.vspdData, _
								C_MaxKey, "X","X")	
	<%End If%>
...
Function DbQuery() 
    ...
    With frm1
		...
		strVal = strVal & "&txtRefFlag=" & lgStrRefFlag
		...
		<TD HEIGHT=20 WIDTH=100%>
			<FIELDSET CLASS="CLSFLD">
				<TABLE <%=LR_SPACE_TYPE_40%>>
					<TR>
						<TD CLASS=TD5>송장작성일</TD>
						<TD CLASS=TD6>
							<TABLE CELLSPACING=0 CELLPADDING=0>
								<TR>
									<TD>
										<script language =javascript src='./js/s4212ra8_fpDateTime1_txtFromDt.js'></script>
									</TD>
									<TD>
										&nbsp;~&nbsp;
									</TD>
									<TD>
										<script language =javascript src='./js/s4212ra8_fpDateTime2_txtToDt.js'></script>
									</TD>
								</TR>
							</TABLE>
						</TD>
	...
	<TR>
		<TD WIDTH=100% HEIGHT=* valign=top>
			<TABLE <%=LR_SPACE_TYPE_20%>>
				<TR>
					<TD HEIGHT="100%">
						<script language =javascript src='./js/s4212ra8_vaSpread_vspdData.js'></script>
					</TD>
				</TR>
			</TABLE>
		</TD>
