...
'>>AIR   ggoSpread.SpreadLock C_Price, lRow, -1
...
'>>AIR   ggoSpread.SSSetProtected C_Price, pvStartRow, pvEndRow
...
Function OpenSODtRef()
	...
	iCalledAspName = AskPRAspName("s3112ra8_KO441")	
	if Trim(iCalledAspName) = "" then
		IntRetCD = DisplayMsgBox("900040",parent.VB_INFORMATION, "s3112ra8_KO441", "x")
		gblnWinEvent = False
		exit Function
	end if
	gblnWinEvent = True
...
Function OpenLCDtRef()
	...
	iCalledAspName = AskPRAspName("s3212ra8_KO441")	
	if Trim(iCalledAspName) = "" then
		IntRetCD = DisplayMsgBox("900040",parent.VB_INFORMATION, "s3212ra8_KO441", "x")
		exit Function
	end if
...
Function OpenCCDtlRef()
	...
	iCalledAspName = AskPRAspName("s4212ra8_KO441")	
	if Trim(iCalledAspName) = "" then
		IntRetCD = DisplayMsgBox("900040",parent.VB_INFORMATION, "s4212ra8_KO441", "x")
		exit Function
	end if
...
'========================================================================================================
 Sub vspdData_Change(ByVal Col, ByVal Row )
  ...
  Select Case Col
   '>>AIR Case C_Qty, C_DocAmt
   Case C_Qty, C_DocAmt, C_Price
       ...
       <TABLE <%=LR_SPACE_TYPE_60%>>
        ...
        <TR>
         ...
         <TD CLASS=TD6 NOWRAP>
          <TABLE CELLSPACING=0 CELLPADDING=0> 
           <TR>
            <TD><script language =javascript src='./js/s5212ma1_fpDoubleSingle3_txtDocAmt.js'></script></TD>
         ...
         <TD CLASS=TD6 NOWRAP>
          <TABLE CELLSPACING=0 CELLPADDING=0> 
           <TR>
            <TD><script language =javascript src='./js/s5212ma1_fpDoubleSingle3_txtLocAmt.js'></script></TD>
        ...
        <TR>
         <TD HEIGHT=100% WIDTH=100% COLSPAN=4>
          <script language =javascript src='./js/s5212ma1_vaSpread_vspdData.js'></script>
         </TD>
        </TR>
       </TABLE>
      </TD>
