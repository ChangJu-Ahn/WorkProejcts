...
'========================================================================================================
 ...
 Const EXBL_DETAIL_ENTRY_ID  = "s5212ma1"  
...
Function OpenSORef()
	...
	iCalledAspName = AskPRAspName("s3111ra8")	
	if Trim(iCalledAspName) = "" then
		IntRetCD = DisplayMsgBox("900040",parent.VB_INFORMATION, "s3111ra8", "x")
		gblnWinEvent = False
		exit Function
	end if
...
Function OpenLCRef()
	...
	iCalledAspName = AskPRAspName("s3211ra8")	
	if Trim(iCalledAspName) = "" then
		IntRetCD = DisplayMsgBox("900040",parent.VB_INFORMATION, "s3211ra8", "x")
		exit Function
	end if
...
Function OpenCCRef()
	...
	iCalledAspName = AskPRAspName("s4211ra8")	
	if Trim(iCalledAspName) = "" then
		IntRetCD = DisplayMsgBox("900040",parent.VB_INFORMATION, "s4211ra8", "x")
		exit Function
	end if
