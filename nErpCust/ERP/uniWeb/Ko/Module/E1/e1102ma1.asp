...
Const BIZ_PGM_ID      = "e1102mb1.asp"						           '☆: Biz Logic ASP Name
'========================================================================================================
...
'========================================================================================================
' Function Name : FncAdd
' Function Desc : 추가 
'========================================================================================================
Function FncAdd()
	'------ Developer Coding part (Start)  -------------------------------------------------------------- 
    document.location = "e1103ma1.asp"
    '& "?txtMode=" & "UID_M0001"
    '& "&txtKeyStream=" & lgKeyStream
    '& "&txtPrevNext=" & "N"
	'------ Developer Coding part (End )   -------------------------------------------------------------- 
    'Call DbQuery()
End Function
                        ...
                        <TD colspan=4>
                            <TABLE cellSpacing=1 cellPadding=0 border=0 bgcolor=#ffffff>
                                <TR bgcolor=#d0d6e4 height=20>
			                        <TD></TD>
			                        <TD class=TDFAMILY_TITLE1>발령일</TD>
			                        <TD class=TDFAMILY_TITLE1>발령구분</TD>
			                        <TD class=TDFAMILY_TITLE1>발령부서</TD>
			                        <TD class=TDFAMILY_TITLE1>직위</TD>
			                        <TD class=TDFAMILY_TITLE1>급호봉</TD>
                                </TR>
<%            
                                For i=1 To 10
                                    ...
                                    Response.Write "<TD><INPUT name='" & i & "'  tag='25X' class=base2 flag='SPREADCELL' style='WIDTH:  30px; TEXT-ALIGN: center;' ></TD>"
                                    Response.Write "<TD><INPUT name='SPREADCELL' tag='25X' class=base2 flag='SPREADCELL' style='WIDTH:  90px; TEXT-ALIGN: center;' ></TD>"
                                    Response.Write "<TD><INPUT name='SPREADCELL' tag='25X' class=base2 flag='SPREADCELL' style='WIDTH: 150px;'></TD>"
                                	Response.Write "<TD><INPUT name='SPREADCELL' tag='25X' class=base2 flag='SPREADCELL' style='WIDTH: 210px;'></TD>"
                                	Response.Write "<TD><INPUT name='SPREADCELL' tag='25X' class=base2 flag='SPREADCELL' style='WIDTH: 125px; TEXT-ALIGN: left;'></TD>"
                                	Response.Write "<TD><INPUT name='SPREADCELL' tag='25X' class=base2 flag='SPREADCELL' style='WIDTH: 160px;'></TD>"
                                    Response.Write "</TR>"
                                Next
%>
                            </TABLE>
