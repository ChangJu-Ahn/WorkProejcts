...
<br>
    <TABLE cellSpacing=0 cellPadding=0 width=600 border=0 bgcolor='#ffffff' align = center>
        <TR height=30 bgcolor='#ffffff' align = center  width=600>
            <TD bgcolor='#d0d6e4'valign=middle align='right'  width='240'>
            		<font size='2' color='#29499C'><b><%=left(lgPay_Yymm,4)%>&nbsp;년 &nbsp;<%=right(lgPay_Yymm,2)%>&nbsp;월<b></font>
            </TD>
            <TD bgcolor='#d0d6e4'valign=middle align='right'>
								<INPUT NAME="prov_nm"  class=Base1 style='text-align:right;color:#29499C;FONT-WEIGHT: bolder;' SiZE=8 readonly>            </TD>
...
<BR>
    <TABLE cellSpacing=1 cellPadding=1 border=0 bgcolor='#ffffff'  align = center  width=600>
        <TR height=20 bgcolor='#E9EDF9' align = center>
            ...
            <TD width=150>
            <INPUT NAME="name"  class=Base1 style=';text-align:center;color:#29499C' SiZE=10 readonly>
            </TD>
        ...
        <TR height=20 bgcolor='#E9EDF9' align = center>
            ...
            <TD width=150>
            <INPUT class=Base1 NAME="grade" style='text-align:center;color:#29499C' SiZE=10 readonly>
            </TD>
    ...
    <TABLE cellSpacing=1 cellPadding=0 border=0 bgcolor='#ffffff'  align = center width=600>
        <TR height=20 bgcolor='#E9EDF9' align = center>
            <TD width=150 bgcolor='#d0d6e4'><font color='#29499C'><b>연 차 발 생</b></font></TD>
            <TD width=150>
                 <INPUT class=Base2 NAME="YEAR_LEFT" style='text-align:right;color:#29499C' SiZE=15 readonly></TD>
            <TD width=150 bgcolor='#d0d6e4'><font color='#29499C'><b>월 차 발 생</b></font></TD>
            <TD width=150><INPUT class=Base1 NAME="MONTH_LEFT" style='text-align:right;color:#29499C' SiZE=15 readonly ID="Text7"></TD>
        </TR>
        <TR height=20 bgcolor='#E9EDF9' align = center>
            <TD width=150 bgcolor='#d0d6e4'><font color='#29499C'><b>근 속 가 산</b></font></TD>
            <TD width=150><INPUT class=Base1 NAME="YEAR_PART" style='text-align:right;color:#29499C' SiZE=15 readonly ID="Text1"></TD>
            <TD width=150 bgcolor='#d0d6e4'>&nbsp;</TD>
            <TD width=150>&nbsp;</TD>
        </TR>
        <TR height=20 bgcolor='#E9EDF9' align = center>
            <TD width=150 bgcolor='#d0d6e4'><font color='#29499C'><b>연 차 사 용</b></font></TD>
            <TD width=150><INPUT class=Base1 NAME="YEAR_USE" style='text-align:right;color:#29499C' SiZE=15 readonly ID="Text3"></TD>
            <TD width=150 bgcolor='#d0d6e4'><font color='#29499C'><b>월 차 사 용</b></font></TD>
            <TD width=150><INPUT class=Base1 NAME="MONTH_USE" style='text-align:right;color:#29499C' SiZE=15 readonly ID="Text3"></TD>
        </TR>
        <TR height=20 bgcolor='#E9EDF9' align = center>
            <TD width=150 bgcolor='#d0d6e4'><font color='#29499C'><b>연 차 지 급</b></font></TD>
            <TD width=150><INPUT class=Base1 NAME="YEAR_CNT" style='text-align:right;color:#29499C' SiZE=15 readonly ID="Text4"></TD>
            <TD width=150 bgcolor='#d0d6e4'><font color='#29499C'><b>월 차 지 급</b></font></TD>
            <TD width=150><INPUT class=Base1 NAME="MONTH_CNT" style='text-align:right;color:#29499C' SiZE=15 readonly ID="Text5"></TD>
        </TR>
	  </TABLE>    
    <br>
    <TABLE cellSpacing=1 cellPadding=1 border=0 bgcolor='#ffffff'  align = center width='600'>
        <TR height=20 bgcolor='#d0d6e4' align = center>
            <TD width=300><font color='#29499C'><b>기준금내역</b></font></TD>
        ...
        <TR bgcolor='#E9EDF9' align = center  valign=top>
            <TD width=300>
            		<table width=290  cellSpacing=0 cellPadding=0 >
	           			<tr>
            				<td width=60%><font color='#29499C'>연차기준금액</font></td>
            				<td width=40%>
        							<INPUT class=Base1 NAME="YEAR_SUM" SiZE=18 style='text-align:right;color:#29499C' readonly>
        						</td>
            			</tr>
	           			<tr>
            				<td width=60%><font color='#29499C'>월차기준금액</font>
            				</td>
            				<td width=40%>
        							<INPUT class=Base1 NAME="MONTH_SUM" SiZE=18 style='text-align:right;color:#29499C' readonly>
        						</td>
            			</tr>
	           			<tr>
	           			    <td width=60%>&nbsp;</td>
	           			...
	           			<tr>
            				<td width=60%><font color='#29499C'>연차 1개당 기준금액</font>
            				</td>
            				<td width=40%>
        							<INPUT class=Base1 NAME="YEAR_PER" SiZE=18 style='text-align:right;color:#29499C' readonly>
        						</td>
            			</tr>   
	           			<tr>
            				<td width=60%><font color='#29499C'>월차 1개당 기준금액</font>
            				</td>
            				<td width=40%>
        							<INPUT class=Base1 NAME="MONTH_PER" SiZE=18 style='text-align:right;color:#29499C' readonly>
        						</td>
            			</tr>               			            			           			
           		</table></TD>
            <TD width=300>
            		<table width=290  cellSpacing=0 cellPadding=0>
            			...
            			<tr>
            				...
            				<td width=40%>
        							<INPUT class=Base1 NAME="sub_amt<%=i%>" SiZE=18 style='text-align:right;color:#29499C' readonly>
        					</td>
            			</tr>
            			<%Next%>
            		</table>
    ...
    <TABLE cellSpacing=1 cellPadding=1 border=0 bgcolor='#ffffff' width=600 align = center>
     ...
     <TABLE cellSpacing=1 cellPadding=1 border=0 bgcolor='#ffffff'  align = center  width=600>
         <TR height=20 bgcolor='#E9EDF9' align = center width=600>
             <TD width=50% bgcolor='#d0d6e4'><font color='#29499C'><b>실지급액</b></font></TD>
