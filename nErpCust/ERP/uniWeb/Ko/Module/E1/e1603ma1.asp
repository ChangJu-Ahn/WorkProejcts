...
Function GridDsplay()
	Dim i
	    For i=1 To 10
	        ...
	        document.writeln "<TD><INPUT name='SPREADCELL_DILIG_STRT_DT" & i & "' tag='25X' flag='SPREADCELL' style='WIDTH:  80px; TEXT-ALIGN: center'></TD>"
	        document.writeln "<TD><INPUT name='SPREADCELL_DILIG_END_DT" & i & "' tag='25X' flag='SPREADCELL' style='WIDTH:  80px; TEXT-ALIGN: center'></TD>"
                        ...
                        <TD colspan=4>
                            <TABLE cellSpacing=1 cellPadding=0 width="100%" border=0 bgcolor=#ffffff>
                                <TR bgcolor=#d0d6e4 height=20 valign=middle>
		                        	...
		                        	<TD NOWRAP class=TDFAMILY_TITLE1 colspan=2>근태기간</TD>
