                    ...
                    <TR height=45 valign=center>
                        ...
                        <TD VALIGN=center ALIGN=LEFT>
                            <TABLE cellSpacing=0 cellPadding=0 border=0 bgcolor=#ffffff><TR>
                                    ...
                                    <TD class=base1>직위:<INPUT class=base1 NAME="txtroll_pstn" MAXLENGTH=40 SiZE=20 tag=14></TD>
...
<%            
                                For i=1 To 10
                                    ...
                                    Response.Write "<TD><INPUT name='" & i & "'  tag='25X' flag='SPREADCELL' class=base2 style='WIDTH:  30px; TEXT-ALIGN: center;' ></TD>"
                                    Response.Write "<TD><INPUT name='SPREADCELL' tag='25X' flag='SPREADCELL' class=base2 style='WIDTH: 100px; TEXT-ALIGN: left;' ></TD>"
                                	Response.Write "<TD><INPUT name='SPREADCELL' tag='25X' flag='SPREADCELL' class=base2 style='WIDTH:  75px; TEXT-ALIGN: center;' ></TD>"
                                	Response.Write "<TD><INPUT name='SPREADCELL' tag='25X' flag='SPREADCELL' class=base2 style='WIDTH:  75px; TEXT-ALIGN: center;' ></TD>"
                                	Response.Write "<TD><INPUT name='SPREADCELL' tag='25X' flag='SPREADCELL' class=base2 style='WIDTH: 110px; TEXT-ALIGN: left;' ></TD>"
                                	Response.Write "<TD><INPUT name='SPREADCELL' tag='25X' flag='SPREADCELL' class=base2 style='WIDTH: 110px; TEXT-ALIGN: left;' ></TD>"
                                    Response.Write "<TD><INPUT name='SPREADCELL' tag='25X' flag='SPREADCELL' class=base2 style='WIDTH: 180px; TEXT-ALIGN: left;' ></TD>"
                                    Response.Write "<TD><INPUT name='SPREADCELL' tag='25X' flag='SPREADCELL' class=base2 style='WIDTH:  81px; TEXT-ALIGN: center;' ></TD>"
                                	Response.Write "<TD><INPUT name='SPREADCELL' tag='25X' flag='SPREADCELL' class=base2 style='WIDTH:  60px; TEXT-ALIGN: right;' ></TD>"
                                	Response.Write "<TD><INPUT name='SPREADCELL' tag='25X' flag='SPREADCELL' class=base2 style='WIDTH: 120px; TEXT-ALIGN: right;' ></TD>"
                                	Response.Write "<TD><INPUT name='SPREADCELL' tag='25X' flag='SPREADCELL' class=base2 style='WIDTH:  80px; TEXT-ALIGN: right;' ></TD>"
                                	Response.Write "<TD><INPUT name='SPREADCELL' tag='25X' flag='SPREADCELL' class=base2 style='WIDTH:  60px; TEXT-ALIGN: right;' ></TD>"
                                	Response.Write "<TD><INPUT name='SPREADCELL' tag='25X' flag='SPREADCELL' class=base2 style='WIDTH: 120px; TEXT-ALIGN: right;' ></TD>"
                                	Response.Write "<TD><INPUT name='SPREADCELL' tag='25X' flag='SPREADCELL' class=base2 style='WIDTH:  70px; TEXT-ALIGN: right;' ></TD>"
                                	Response.Write "<TD><INPUT name='SPREADCELL' tag='25X' flag='SPREADCELL' class=base2 style='WIDTH:  60px; TEXT-ALIGN: right;' ></TD>"
                                    Response.Write "</TR>"
                                Next
%>
