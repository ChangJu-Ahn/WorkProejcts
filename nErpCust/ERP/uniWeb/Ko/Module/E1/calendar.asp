...
Sub window_onload
    ...
    txtDate.value = uniConvYYYYMMDDToDate(gDateFormat,lgYear,lgMonth,lgDay)
		...
		<TD Height=30>
			<TABLE WIDTH=95% HEIGHT=100% BORDER=0 CELLSPACING=0 CELLPADDING=0 ALIGN="center">
				<TR>
					...
					<TD ALIGN=RIGHT>
						<IMG SRC="../../../Cshared/Image/ok_d.gif" NAME="btnOK" Style="CURSOR: hand" ALT="OK" onMouseOut="javascript:MM_swapImgRestore()" onMouseOver="javascript:MM_swapImage(this.name,'','../../../Cshared/Image/OK.gif',1)"></IMG>&nbsp;&nbsp;
						<IMG SRC="../../../Cshared/Image/cancel_d.gif" NAME="btnCancel" Style="CURSOR: hand" ALT="CANCEL" onMouseOut="javascript:MM_swapImgRestore()" onMouseOver="javascript:MM_swapImage(this.name,'','../../../Cshared/Image/Cancel.gif',1)"></IMG>&nbsp;&nbsp;</TD>
					</TD>
				</TR>
			</TABLE>
		</TD>
