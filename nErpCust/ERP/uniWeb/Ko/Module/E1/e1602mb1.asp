...
Sub SubBizQuery()
    ...
    On Error Resume Next                                                             '☜: Protect system from crashing
    Err.Clear                                                                        '☜: Clear Error status
'Response.Write ",lgKeyStream(4):" & lgKeyStream(4)
'Response.Write ",lgKeyStream(5):" & lgKeyStream(5)
'Response.Write ",lgKeyStream(1):" & lgKeyStream(1)
...
<%		
	...
	iKey1 = iKey1 & "   AND ((dilig_strt_dt between  " & FilterVar(UNIConvDateCompanyToDB((lgKeyStream(2)),NULL), "''", "S") & " and  " & FilterVar(UNIConvDateCompanyToDB((lgKeyStream(3)),NULL), "''", "S") & ")"
	iKey1 = iKey1 & "    OR  (dilig_end_dt between  " & FilterVar(UNIConvDateCompanyToDB((lgKeyStream(2)),NULL), "''", "S") & " and  " & FilterVar(UNIConvDateCompanyToDB((lgKeyStream(3)),NULL), "''", "S") & "))"
...
'                Case ""
					...
					lgStrSQL = lgStrSQL & " dilig_strt_dt, dilig_end_dt, dilig_cd,"
...
'					lgStrSQL = "Select emp_no, "
'					lgStrSQL = lgStrSQL & " dilig_strt_dt, dilig_end_dt, dilig_cd,"
'					lgStrSQL = lgStrSQL & " dbo.ufn_H_GetCodeName('hca010t',dilig_cd,'') as dilig_nm ,"
'					lgStrSQL = lgStrSQL & " remark, "
'					lgStrSQL = lgStrSQL & " dbo.ufn_H_GetEmpName(app_emp_no)  as app_emp_no,"
'					lgStrSQL = lgStrSQL & " app_yn "
'					lgStrSQL = lgStrSQL & " From E11070T "
