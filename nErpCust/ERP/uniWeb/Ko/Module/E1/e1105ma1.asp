...
Const BIZ_PGM_ID      = "e1105mb1.asp"						           '☆: Biz Logic ASP Name
'========================================================================================================
                        ...
                        <TD colspan=4>
                            <TABLE cellSpacing=1 cellPadding=0 border=0 bgcolor=#ffffff>
                                <TR bgcolor=#d0d6e4 height=20>
		                        	<TD></TD>
		                        	<TD class=TDFAMILY_TITLE1>상벌종류</TD>
		                        	<TD class=TDFAMILY_TITLE1>발생일자</TD>
		                        	<TD class=TDFAMILY_TITLE1>유효일자</TD>
		                        	<TD class=TDFAMILY_TITLE1>가산점</TD>
		                        	<TD class=TDFAMILY_TITLE1>사유</TD>
		                        	<TD class=TDFAMILY_TITLE1>관련기관</TD>
		                        </TR>
<%            
        For i=1 To 10
            ...
            Response.Write "<TD><INPUT name='SPREADCELL' tag='25X' flag='SPREADCELL' style='WIDTH: 110px;'></TD>"
            Response.Write "<TD><INPUT name='SPREADCELL' tag='25X' flag='SPREADCELL' style='WIDTH: 100px; TEXT-ALIGN: center'></TD>"
        	Response.Write "<TD><INPUT name='SPREADCELL' tag='25X' flag='SPREADCELL' style='WIDTH:  80px; TEXT-ALIGN: center'></TD>"
        	Response.Write "<TD><INPUT name='SPREADCELL' tag='25X' flag='SPREADCELL' style='WIDTH: 100px; TEXT-ALIGN: right'></TD>"
        	Response.Write "<TD><INPUT name='SPREADCELL' tag='25X' flag='SPREADCELL' style='WIDTH: 180px;'></TD>"
        	Response.Write "<TD><INPUT name='SPREADCELL' tag='25X' flag='SPREADCELL' style='WIDTH: 165px;'></TD>"
            Response.Write "</TR>"
        Next
%>
                            </TABLE>
