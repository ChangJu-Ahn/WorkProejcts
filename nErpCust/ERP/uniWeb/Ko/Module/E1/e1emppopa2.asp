        ...
        <TR>
            ...
            <TD>
                <TABLE cellSpacing=0 cellPadding=0 border=0 bgcolor=#ffffff>
                    ...
                    <TR height=25 valign=middle>
                        <TD class=base1 colspan=2>등록여부 :
    					    <INPUT TYPE="RADIO" NAME="txtChk" tag="12" CHECKED ID="txtChkA" VALUE=A STYLE="BORDER-BOTTOM:0px solid; BORDER-LEFT:0px solid; BORDER-RIGHT:0px solid; BORDER-TOP:0px solid; BACKGROUND-COLOR: #FFFFFF"><LABEL FOR="txtChkA">전체</LABEL>
                            <INPUT TYPE="RADIO" NAME="txtChk" tag="12" ID="txtChkY" VALUE=Y STYLE="BORDER-BOTTOM:0px solid; BORDER-LEFT:0px solid; BORDER-RIGHT:0px solid; BORDER-TOP:0px solid; BACKGROUND-COLOR: #FFFFFF"><LABEL FOR="txtChkY">등록</LABEL>
    					    <INPUT TYPE="RADIO" NAME="txtChk" tag="12" ID="txtChkN" VALUE=N STYLE="BORDER-BOTTOM:0px solid; BORDER-LEFT:0px solid; BORDER-RIGHT:0px solid; BORDER-TOP:0px solid; BACKGROUND-COLOR: #FFFFFF"><LABEL FOR="txtChkN">미등록</LABEL>
                        </TD>
                    </TR>
                    <TR>
                        <TD colspan=2>
...
<%            
        For i=1 To 10
            ...
            Response.Write "<TD flag='SPREADCELL'><INPUT name='SPREADCELL_name" & i & "' tag='25X' flag='SPREADCELL' style='WIDTH: 80px; TEXT-ALIGN: left' onMouseOver='vbscript: Call MouseRow(" & i & ")'></TD>"
            ...
            Response.Write "<TD flag='SPREADCELL'><INPUT name='SPREADCELL_res_no" & i & "' tag='25x' flag='SPREADCELL' style='WIDTH: 90px; TEXT-ALIGN: left'  onMouseOver='vbscript: Call MouseRow(" & i & ")'></TD>"
            Response.Write "<TD flag='SPREADCELL'><INPUT name='SPREADCELL_yn" & i & "' tag='25x' flag='SPREADCELL' style='WIDTH: 70px; TEXT-ALIGN: center' onMouseOver='vbscript: Call MouseRow(" & i & ")'></TD>"
            Response.Write "</TR>"
        Next        
%>
