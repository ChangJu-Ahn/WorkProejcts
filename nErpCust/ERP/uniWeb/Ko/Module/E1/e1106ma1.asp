...
Const BIZ_PGM_ID      = "e1106mb1.asp"						           '☆: Biz Logic ASP Name
'========================================================================================================
                        ...
                        <TD colspan=4>
                            <TABLE cellSpacing=1 cellPadding=0 border=0 bgcolor=#ffffff>
                                <TR bgcolor=#d0d6e4 height=20>
		                        	<TD></TD>
		                        	<TD class=TDFAMILY_TITLE1>근무기간</TD>
		                        	<TD class=TDFAMILY_TITLE1>회사</TD>
		                        	<TD class=TDFAMILY_TITLE1>직위</TD>
		                        	<TD class=TDFAMILY_TITLE1>담당업무</TD>
		                        	<TD class=TDFAMILY_TITLE1>경력</TD>
                                </TR>
<%            
        For i=1 To 10
            ...
            Response.Write "<TD><INPUT name='SPREADCELL' tag='25X' flag='SPREADCELL' style='WIDTH: 170px; TEXT-ALIGN: center;' onClick='vbscript: Call GetRow(1)' onChange='vbscript: Call grid1.SetUpdateFlag()'></TD>"
            Response.Write "<TD><INPUT name='SPREADCELL' tag='25X' flag='SPREADCELL' style='WIDTH: 205px;' onClick='vbscript: Call GetRow(1)' onChange='vbscript: Call grid1.SetUpdateFlag()'></TD>"
        	Response.Write "<TD><INPUT name='SPREADCELL' tag='25X' flag='SPREADCELL' style='WIDTH:  80px;' onClick='vbscript: Call GetRow(1)' onChange='vbscript: Call grid1.SetUpdateFlag()'></TD>"
        	Response.Write "<TD><INPUT name='SPREADCELL' tag='25X' flag='SPREADCELL' style='WIDTH: 200px;' onClick='vbscript: Call GetRow(1)' onChange='vbscript: Call grid1.SetUpdateFlag()'></TD>"
        	Response.Write "<TD><INPUT name='SPREADCELL' tag='25X' flag='SPREADCELL' style='WIDTH:  80px; TEXT-ALIGN: center;' onClick='vbscript: Call GetRow(1)' onChange='vbscript: Call grid1.SetUpdateFlag()'></TD>"
            Response.Write "</TR>"
        Next
%>
                            </TABLE>
