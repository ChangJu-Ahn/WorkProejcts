                    ...
                    <TR>
                        <TD colspan=4>
                            <TABLE cellSpacing=1 cellPadding=0 width=100% border=0 bgcolor=#ffffff>
                                <TR>
		                            <TD CLASS="TDFAMILY_TITLE" NOWRAP>근무날짜</TD>
		                            <TD CLASS="TDFAMILY2" COLSPAN=3>
										<INPUT CLASS="SINPUTTEST_STYLE" ID="txtDilig_dt" NAME="txtDilig_dt" TYPE="Text" MAXLENGTH=10 SiZE=10 alt="근무날짜" tag="22D" ondblclick="VBScript:Call OpenCalendar('txtDilig_dt',3)">&nbsp;
		                            </TD>
                                </TR>  
                                <TR>
		                            <TD CLASS="TDFAMILY_TITLE" NOWRAP>근무구분</TD>
		                            <TD CLASS="TDFAMILY2" COLSPAN=3><SELECT NAME="txtDilig_cd" ALT="근무구분" STYLE="WIDTH: 150px" TAG="22"><OPTION VALUE=""></OPTION></SELECT>
		                            </TD>
                                </TR>
                                <TR>
		                            <TD CLASS="TDFAMILY_TITLE" NOWRAP>근무시간</TD>
		                            <TD CLASS="TDFAMILY2" COLSPAN=3>
										<SELECT NAME="txtDilig_hour" ALT="시간" STYLE="WIDTH: 50px" TAG="22"><OPTION VALUE=""></OPTION></SELECT>시간
										<SELECT NAME="txtDilig_min" ALT="분" STYLE="WIDTH: 50px" TAG="22"><OPTION VALUE=""></OPTION></SELECT>분
		                            </TD>
                                </TR>                              
