    ...
    Select Case pMode 
      Case "R"
            ...
            Case ""
                ...
                lgStrSQL = lgStrSQL & "  INVEST_SUB_SUM,our_stock_amt, CARD_SUB_SUM,FORE_EDU_SUB_AMT, TAX_STD, CALU_TAX, INCOME_TAX_SUB, HOUSE_REPAY, FORE_PAY, "
                lgStrSQL = lgStrSQL & "  STOCK_SAVE, poli_tax_sub, TAX_SUB_SUM, REDU_SUM, DEC_INCOME_TAX, DEC_RES_TAX ,DEC_FARM_TAX , "
