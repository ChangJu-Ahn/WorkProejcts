...
'        Call SubSkipRs(lgObjRs,lgMaxCount * lgStrPrevKeyIndex)
        ...
        Do While Not lgObjRs.EOF
            ...
            lgstrData = lgstrData & Chr(11) & UNIConvDateDBToCompany(lgObjRs("career_start"),Null) & "~" & UNIConvDateDBToCompany(lgObjRs("career_end"),Null)
            ...
            lgstrData = lgstrData & Chr(11) & ConvSPChars(lgObjRs("career_yy")) & "³â" & ConvSPChars(lgObjRs("career_mm")) & "¿ù"
	'------ Developer Coding part (End   ) ------------------------------------------------------------------
      ...
      Case "R"
             Select Case  lgPrevNext 
                Case ""
                    ...
                    lgStrSQL = lgStrSQL & " career_start, "
                    lgStrSQL = lgStrSQL & " career_end, "
                    lgStrSQL = lgStrSQL & " comp_nm, "
                    lgStrSQL = lgStrSQL & " a.roll_pstn, "
                    lgStrSQL = lgStrSQL & " func_nm, "
                    lgStrSQL = lgStrSQL & " career_yy, "
                    lgStrSQL = lgStrSQL & " a.career_mm "
                    lgStrSQL = lgStrSQL & " FROM  HAA050T a,HAA010T b"
