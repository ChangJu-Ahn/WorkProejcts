...
Const BIZ_PGM_ID      = "e1202mb3.asp"						           '☆: Biz Logic ASP Name
...
<FORM NAME=frm1 TARGET="MyBizASP" METHOD="POST">
    ...
    <TABLE cellSpacing=0 cellPadding=0 width=700 border=0 bgcolor=#ffffff>
        <TR><TD WIDTH="100%" HEIGHT=z0><IFRAME NAME="MyBizASP" WIDTH="100%" HEIGHT=0 FRAMEBORDER=0 SCROLLING=no noresize framespacing=0></IFRAME></TD></TR>
    </TABLE>
<br>
...
<BR>
    ...
    <TABLE cellSpacing=1 cellPadding=0 border=0 bgcolor='#ffffff'  align = center width=600>
        <TR height=20 bgcolor='#E9EDF9' align = center>
            <TD width=150 bgcolor='#d0d6e4'><font color='#29499C'><b>상여기본지급율</b></font></TD>
            <TD width=150>
                 <INPUT class=Base2 NAME="BONUS_RATE" style='text-align:right;color:#29499C' SiZE=15 readonly>&nbsp;%</TD>
            <TD width=150 bgcolor='#d0d6e4'><INPUT class=Base1 NAME="SPLENDOR_text" style='text-align:center;color:#29499C;font-weight:bold' SiZE=15 readonly >&nbsp;</TD>
            <TD width=150><INPUT class=Base1 NAME="SPLENDOR_RATE" style='text-align:right;color:#29499C' SiZE=15 readonly ID="Text7">&nbsp;</TD>
        </TR>
        <TR height=20 bgcolor='#E9EDF9' align = center>
            <TD width=150 bgcolor='#d0d6e4'><font color='#29499C'><b>가산율</b></font></TD>
            <TD width=150><INPUT class=Base1 NAME="ADD_RATE" style='text-align:right;color:#29499C' SiZE=15 readonly ID="Text1">&nbsp;%&nbsp;</TD>
            <TD width=150 bgcolor='#d0d6e4'>&nbsp;</TD>
            <TD width=150>&nbsp;</TD>
        </TR>
        <TR height=20 bgcolor='#E9EDF9' align = center>
            <TD width=150 bgcolor='#d0d6e4'><font color='#29499C'><b>일할계산차감율</b></font></TD>
            <TD width=150><INPUT class=Base1 NAME="MINUS1_RATE" style='text-align:right;color:#29499C' SiZE=15 readonly ID="Text3">&nbsp;%&nbsp;</TD>
            <TD width=150 bgcolor='#d0d6e4'>&nbsp;</TD>
            <TD width=150>&nbsp;</TD>
        </TR>
        <TR height=20 bgcolor='#E9EDF9' align = center>
            <TD width=150 bgcolor='#d0d6e4'><font color='#29499C'><b>근태차감율</b></font></TD>
            <TD width=150><INPUT class=Base1 NAME="MINUS2_RATE" style='text-align:right;color:#29499C' SiZE=15 readonly ID="Text4">&nbsp;%&nbsp;</TD>
            <TD width=150 bgcolor='#d0d6e4'><font color='#29499C'><b>총상여지급율</b></font></TD>
            <TD width=150><INPUT class=Base1 NAME="PROV_RATE" style='text-align:right;color:#29499C' SiZE=15 readonly ID="Text5">&nbsp;%&nbsp;</TD>
        </TR>
	  </TABLE>    
    <br>
    <TABLE cellSpacing=1 cellPadding=1 border=0 bgcolor='#ffffff'  align = center width='600'>
        <TR height=20 bgcolor='#d0d6e4' align = center>
            <TD width=300><font color='#29499C'><b>지급기준금내역</b></font></TD>
            ...
            <TD width=300>
            		<table width=290  cellSpacing=0 cellPadding=0 >
            			...
            			<tr>
            				...
            				<td width=40%>
        							<INPUT class=Base1 NAME="pay_amt<%=i%>" SiZE=18 style='text-align:right;color:#29499C' readonly>
        						</td>
            			</tr>
            			<%Next%>
            		</table>            </TD>
    ...
    <TABLE cellSpacing=1 cellPadding=1 border=0 bgcolor='#ffffff' width=600 align = center>
		<TR height=20 bgcolor='#ffffff' width=600>
     				<td bgcolor='#d0d6e4' width = 30% align=center><font color='#29499C'><b>기준금액총액</b></font></td>
     				<td align = 'left' bgcolor='#E9EDF9' width =20%>
     				   <INPUT NAME="BONUS_BAS" class=Base1 SiZE=18 style='text-align:right;color:#29499C' readonly ID="Text2">&nbsp;
     				</td>
     				<td bgcolor='#E9EDF9' width = 30% align=center>&nbsp;</td>
     				<td align = 'left' bgcolor='#E9EDF9' width =20%>&nbsp;</td>
        </TR>
        <TR height=20 bgcolor='#ffffff' width=600>
