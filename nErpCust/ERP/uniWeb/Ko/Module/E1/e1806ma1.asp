...
<FORM NAME="frm1" TARGET="MyBizASP" METHOD="post">
    <TABLE cellSpacing=0 cellPadding=0 width=749 border=0>
        <TR height=45 valign=middle>
            <TD class=base1 colspan=3>정렬순서:
    	        <INPUT TYPE="RADIO" NAME="txtuse_yn" tag="12" ID="txtuse_yn1" VALUE="emp_no" STYLE="BORDER-BOTTOM:0px solid; BORDER-LEFT:0px solid; BORDER-RIGHT:0px solid; BORDER-TOP:0px solid; BACKGROUND-COLOR: #FFFFFF"><LABEL FOR="txtuse_yn1">사번별</LABEL>
                <INPUT TYPE="RADIO" NAME="txtuse_yn" tag="12" ID="txtuse_yn2" VALUE="dept_cd" STYLE="BORDER-BOTTOM:0px solid; BORDER-LEFT:0px solid; BORDER-RIGHT:0px solid; BORDER-TOP:0px solid; BACKGROUND-COLOR: #FFFFFF"><LABEL FOR="txtuse_yn2">부서별</LABEL>
            </TD>
        </TR>
        <TR>
            <TD width=13></TD>
...
<%            
        For i=1 To 10
            ...
            Response.Write "<TD><INPUT name='SPREADCELL_emp_no" & i & "' tag='25X' flag='SPREADCELL' style='WIDTH: 100px; TEXT-ALIGN: left' onMouseOver='vbscript: Call MouseRow(" & i & ")'></TD>"
            Response.Write "<TD><INPUT name='SPREADCELL_NAME" & i & "' tag='25X' flag='SPREADCELL' style='WIDTH: 200px; TEXT-ALIGN: left' onMouseOver='vbscript: Call MouseRow(" & i & ")'></TD>"
            Response.Write "<TD><INPUT name='SPREADCELL_deptcd" & i & "' tag='25X' flag='SPREADCELL' style='WIDTH: 120px; TEXT-ALIGN: left' onMouseOver='vbscript: Call MouseRow(" & i & ")'></TD>"
            Response.Write "<TD><INPUT name='SPREADCELL_deptnm" & i & "' tag='25X' flag='SPREADCELL' style='WIDTH: 170px; TEXT-ALIGN: left' onMouseOver='vbscript: Call MouseRow(" & i & ")'></TD>"
            Response.Write "<TD><INPUT name='SPREADCELL_date" & i & "' tag='25X' flag='SPREADCELL' style='WIDTH: 70px; TEXT-ALIGN: center' onMouseOver='vbscript: Call MouseRow(" & i & ")'></TD>"
            Response.Write "<TD><INPUT name='SPREADCELL_internal_auth" & i & "' tag='25X' flag='SPREADCELL' style='WIDTH: 70px; TEXT-ALIGN: center' onMouseOver='vbscript: Call MouseRow(" & i & ")'></TD>"            
            Response.Write "</TR>"
        Next
%>
                            </TABLE>
