...
<Script Language=vbscript>
       With Parent
            ...
            .Frm1.INVEST_SUB_AMT.Value          = "<%=UNINumClientFormat(lgObjRs("INVEST_SUB_AMT"), ggAmtOfMoney.DecPoint, 0)%>"

            .Frm1.VENTURE_SUB_AMT.Value         = "<%=UNINumClientFormat(lgObjRs("VENTURE_SUB_AMT"), ggAmtOfMoney.DecPoint, 0)%>"
...
'   DB Save
    ...
    lgStrSQL = lgStrSQL & "       INVEST_SUB_AMT           = " & UNIConvNum(Request("INVEST_SUB_AMT"),0)      & ","

    lgStrSQL = lgStrSQL & "       VENTURE_SUB_AMT          = " & UNIConvNum(Request("VENTURE_SUB_AMT"),0)      & ","
