...
'--------------------------------------------------------------------------------------------------------
'Const C_GAZET_DT = 1										'Column constant for Spread Sheet 
                        ...
                        <TD colspan=4>
                            <TABLE cellSpacing=1 cellPadding=0 width=100% border=0 bgcolor=#ffffff>
                                <TR bgcolor=#d0d6e4 height=20>
	                        		...
	                        		<TD CLASS=TDFAMILY_TITLE1>입학</TD>
	                        		<TD CLASS=TDFAMILY_TITLE1>졸업</TD>
...
<%            
                                For i=1 To 10
                                    ...
                                    Response.Write "<TD><INPUT name='SPREADCELL' tag='25X' flag='SPREADCELL' class=base2 style='WIDTH: 110px;'></TD>"
                                	Response.Write "<TD><INPUT name='SPREADCELL' tag='25X' flag='SPREADCELL' class=base2 style='WIDTH:  90px; TEXT-ALIGN: center;'></TD>"
                                	Response.Write "<TD><INPUT name='SPREADCELL' tag='25X' flag='SPREADCELL' class=base2 style='WIDTH:  90px; TEXT-ALIGN: center;'></TD>"
                                	Response.Write "<TD><INPUT name='SPREADCELL' tag='25X' flag='SPREADCELL' class=base2 style='WIDTH: 230px;'></TD>"
                                	Response.Write "<TD><INPUT name='SPREADCELL' tag='25X' flag='SPREADCELL' class=base2 style='WIDTH: 215px;'></TD>"
                                    Response.Write "</TR>"
                                Next
%>
                            </TABLE>
