...
Function GridDsplay()
	Dim i
	    For i=1 To 10
	        ...
	        document.writeln "<TD><INPUT type=text name='SPREADCELL_dept_cd" & i & "' tag='25X' flag='SPREADCELL' style='WIDTH: 180px; TEXT-ALIGN: left' onMouseOver='vbscript: Call MouseRow(" & i & ")'></TD>"
	        document.writeln "<TD><INPUT name='SPREADCELL_dept_nm" & i & "' tag='25X' flag='SPREADCELL' style='WIDTH: 350px; TEXT-ALIGN: left'  onMouseOver='vbscript: Call MouseRow(" & i & ")'></TD>"
	        document.writeln "</TR>"
	    Next
End Function
'========================================================================================================
            ...
            <TD>
                <TABLE cellSpacing=0 cellPadding=0 border=0 bgcolor=#ffffff>
                    <TR height=36 valign=center>
                        <TD class=base1>부서코드:<INPUT class=base1 NAME="txtDept_cd" MAXLENGTH=13 SiZE=12 tag=12></TD>
                        <TD class=base1>부서명:<INPUT class=base1 NAME="txtDept_nm" MAXLENGTH=20 SiZE=20 tag=12></TD>
                    </TR>
                    <TR>
                        <TD colspan=2>
