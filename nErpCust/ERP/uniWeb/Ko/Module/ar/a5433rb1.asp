...
Dim C_SHEETMAXROWS_D                                                             '☜ : 한번에 가져올수 있는 데이타 건수 
...
Sub  TrimData()
    ...
    '--------------- 개발자 coding part(실행로직,Start)----------------------------------------------------
     strAllcNo	   = FilterVar(UCase(Trim(Request("txtallcNo"))),"","S")                                                          
     
	 
	 strCond=""
     
     If strAllcNo <> "" Then strCond = strCond & " WHERE  B.CLS_Ar_NO=" & FilterVar(strAllcNo ,null,"S")
