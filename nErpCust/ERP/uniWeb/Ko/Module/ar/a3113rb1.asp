...
Sub  TrimData()
    ...
    strCond = strCond & " AND A.AP_STS = " & FilterVar("O", "''", "S") & "  AND a.ap_amt < 0 AND A.CONF_FG = " & FilterVar("C", "''", "S") & "  AND A.gl_no <> '' And a.bal_amt <> 0 "
...
<Script Language=vbscript>
    If "<%=lgDataExist%>" = "Yes" Then
       ...
       'Show multi spreadsheet data from this line
		...
		Call Parent.ReFormatSpreadCellByCellByCurrency(Parent.Frm1.vspdData,<%=iPrevEndRow+1%>,<%=iEndRow%>,Parent.GetKeyPos("A",12),Parent.GetKeyPos("A",14),"A", "I" ,"X","X")
		Call Parent.ReFormatSpreadCellByCellByCurrency(Parent.Frm1.vspdData,<%=iPrevEndRow+1%>,<%=iEndRow%>,Parent.GetKeyPos("A",12),Parent.GetKeyPos("A",16),"A", "I" ,"X","X")
		Call Parent.ReFormatSpreadCellByCellByCurrency(Parent.Frm1.vspdData,<%=iPrevEndRow+1%>,<%=iEndRow%>,Parent.GetKeyPos("A",12),Parent.GetKeyPos("A",20),"A", "I" ,"X","X")
