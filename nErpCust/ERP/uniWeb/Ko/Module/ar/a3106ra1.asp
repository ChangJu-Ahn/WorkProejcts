...
'========================================================================================================
Const BIZ_PGM_ID 		= "a3106rb1.asp"                              '☆: Biz Logic ASP Name
...
Sub InitSpreadSheet()
    ...
    Call SetZAdoSpreadSheet("a3106RA110","S","A","V20021211",PopupParent.C_SORT_DBAGENT,vspdData, C_MaxKey, "X","X")
    Call SetSpreadLock() 
End Sub
...
<TABLE <%=LR_SPACE_TYPE_20%>>
			...
			<FIELDSET CLASS="CLSFLD">
				<TABLE <%=LR_SPACE_TYPE_40%>>
					...
					<TR>
						...
						<TD CLASS=TD6 NOWRAP><script language =javascript src='./js/a3106ra1_OBJECT3_txtArDt.js'></script>								
						&nbsp;~&nbsp;<script language =javascript src='./js/a3106ra1_OBJECT4_txtToArDt.js'></script></TD>												
						<TD CLASS=TD5 NOWRAP>만기일자</TD>
						<TD CLASS=TD6 NOWRAP><script language =javascript src='./js/a3106ra1_OBJECT1_txtArDueDt.js'></script>								
						&nbsp;~&nbsp;<script language =javascript src='./js/a3106ra1_OBJECT2_txtToArDueDt.js'></script></TD>												
					</TR>
					<TR>						
	...
	<TD WIDTH=100% HEIGHT=* VALIGN=TOP>
			<TABLE <%=LR_SPACE_TYPE_20%>>
				<TR HEIGHT=100%>
					<TD WIDTH=100%>
						<script language =javascript src='./js/a3106ra1_vspdData_vspdData.js'></script>
					</TD>
				</TR>
			</TABLE>
		</TD>
