...
*  2. Function Name        : 
*  3. Program ID           : a5433ma1
*  4. Program Name         : Verify AR
*  5. Program Desc         : 
...
Const BIZ_PGM_ID      = "A5433MB1.asp"						           '☆: Biz Logic ASP Name
Const BIZ_PGM_ID1     = "A5433MB2.asp"	
Const BIZ_PGM_ID2     = "A5433MB3.asp"	
	...
	Select Case UCase(Trim(pvSpdNo))
		Case "A"
			With frm1.vspdData1
				...
				ggoSpread.SSSetFloat   C_AllcLocAmt1         ,"반제금액(자국)"     ,15     ,Parent.ggAmtOfMoneyNo,ggStrIntegeralPart, ggStrDeciPointPart,Parent.gComNum1000,Parent.gComNumDec,1      ,True  
		...
		Case "B"
			With frm1.vspdData2
				...
				ggoSpread.SSSetEdit    C_AcctNm2           ,"계정코드명"         ,15    ,3
				                      'ColumnPosition     Header            Width   Grp                    IntegeralPart       DeciPointpart                             Align   Sep    PZ   Min       Max 
				ggoSpread.SSSetFloat   C_AllcLocAmt2         ,"반제금액(자국)"     ,15     ,Parent.ggAmtOfMoneyNo,ggStrIntegeralPart, ggStrDeciPointPart,Parent.gComNum1000,Parent.gComNumDec,1      ,True  
		...
		Case "C"
			With frm1.vspdData3
				...
				ggoSpread.SSSetDate    C_AllcDt          ,"반제일자"           ,10    ,2        ,Parent.gDateFormat   ,-1 
				ggoSpread.SSSetDate    C_GlDt          ,"회계전표일자"       ,10    ,2        ,Parent.gDateFormat   ,-1 
				                      'ColumnPosition     Header            Width   Grp                    IntegeralPart       DeciPointpart                             Align   Sep    PZ   Min       Max 
				
				ggoSpread.SSSetFloat   C_AllcLocAmt3     ,"반제금액(자국)"     ,15     ,Parent.ggAmtOfMoneyNo,ggStrIntegeralPart, ggStrDeciPointPart,Parent.gComNum1000,Parent.gComNumDec,1      ,True 
				...
				ggoSpread.SSSetEdit    C_BatchNO       ,"Batch 번호"         ,15    ,3        ,     ,18     ,2
				ggoSpread.SSSetDate    C_TempGlDt      ,"결의전표일자"       ,10    ,2        ,Parent.gDateFormat   ,-1 
				ggoSpread.SSSetEdit    C_GlinputType3       ,"전표입력경로"       , 5    ,         ,    ,10       ,2
				ggoSpread.SSSetEdit    C_GlinputTypeNm3     ,"전표입력경로명"     ,15    ,3				
				ggoSpread.SSSetEdit    C_AllcNo          ,"반제번호"           ,15    ,3        ,     ,15     ,2
				...
				Call ggoSpread.SSSetColHidden(C_GlinputType3,C_GlinputType3,True)		
				.ReDraw = True
    ...
    Select Case UCase(pvSpdNo)
       ...
       Case "B"
		...
		Case "C"
			...
			C_AllcDt			= iCurColumnPos(3)
			C_GlDt			    = iCurColumnPos(4)
			C_AllcLocAmt3		= iCurColumnPos(5)
			C_GlLocAmt3		    = iCurColumnPos(6)
			C_DiffAmt3          = iCurColumnPos(7)
			C_TempGlLocAmt3	    = iCurColumnPos(8)
			C_BatchLocAmt3	    = iCurColumnPos(9)
			C_GLNo			    = iCurColumnPos(10)
			C_TempGlNo		    = iCurColumnPos(11)
			C_BatchNO		    = iCurColumnPos(12)
			C_TempGlDt			= iCurColumnPos(13)
			C_GlinputType3		= iCurColumnPos(14)
			C_GlinputTypeNm3	= iCurColumnPos(15)
			C_AllcNo			= iCurColumnPos(16)
...
Function  OpenPopupAllc()
	...
	iCalledAspName = AskPRAspName("a5433ra1")
	If Trim(iCalledAspName) = "" Then
		IntRetCD = DisplayMsgBox("900040", parent.VB_INFORMATION, "a5433ra1", "X")
		IsOpenPop = False
		Exit Function
	End If
...
Function  OpenPopUp(Byval strCode, Byval iWhere)
	...
	Select Case iWhere
		...
		Case 1
			...
			arrParam(3)  = ""											' Name Cindition
			arrParam(4)  = "ACCT_TYPE LIKE " & FilterVar("%I%", "''", "S") & "  "						' Where Condition
			arrParam(5)  = "계정코드"			
		...
		Case 3
			...
			arrParam(4) = " MAJOR_CD=" & FilterVar("A1001", "''", "S") & "  AND MINOR_CD IN (" & FilterVar("RX", "''", "S") & ", " & FilterVar("CP", "''", "S") & " ," & FilterVar("CS", "''", "S") & " , " & FilterVar("LR", "''", "S") & " ," & FilterVar("CL", "''", "S") & "  ," & FilterVar("CR", "''", "S") & " ) " ' Where Condition
			arrParam(5) = "전표입력경로"			
...
Function MoveJmpClick()
	...
	Select Case gSelframeFlg
		Case TAB1
			RefView.innerHTML =  "<font color=""#777777"">반제정보&nbsp;|&nbsp;회계전표&nbsp;|&nbsp;결의전표</font>"
		...
		Case TAB3
			RefView.innerHTML =  "<A href='vbscript:OpenPopupAllc()'>반제정보</A>&nbsp;|&nbsp;<A href='vbscript:OpenPopupGL()'>회계전표</A>&nbsp;|&nbsp;<A href='vbscript:OpenPopupTempGL()'>결의전표</A>"
			inputTypeViewtemp1.style.DISPLAY="NONE"
			inputTypeViewtemp2.style.DISPLAY="NONE"
			inputTypeView1.style.DISPLAY=""
			inputTypeView2.style.DISPLAY=""
...
Sub DoSum()
	...
	Select Case gSelframeFlg
		Case TAB1
			With frm1.vspdData1
				dbTotAllcLocAmt		= FncSumSheet(frm1.vspdData1,C_AllcLocAmt1, 1, .MaxRows, False, -1, -1, "V")
				...
				frm1.txtTotAllcLocAmt1.text = UNIConvNumPCToCompanyByCurrency(dbTotAllcLocAmt,parent.gCurrency,parent.ggAmtOfMoneyNo, parent.gLocRndPolicyNo, "X")
		...
		Case TAB2
			With frm1.vspdData2
				dbTotAllcLocAmt		= FncSumSheet(frm1.vspdData2,C_AllcLocAmt2, 1, .MaxRows, False, -1, -1, "V")
				...
				frm1.txtTotAllcLocAmt2.text = UNIConvNumPCToCompanyByCurrency(dbTotAllcLocAmt,parent.gCurrency,parent.ggAmtOfMoneyNo, parent.gLocRndPolicyNo, "X")
				...
				<TR>
					...
					<TD CLASS="CLSMTABP">
						<TABLE ID="MyTab" CELLSPACING=0 CELLPADDING=0 onclick="ClickTab3()">
							<TR>
								<td background="../../image/table/tab_up_bg.gif"><IMG height=23 src="../../image/table/tab_up_left.gif" width=9></td>
								<td background="../../image/table/tab_up_bg.gif" align="center" CLASS="CLSMTABP"><font color=white>채권반제별발생금액</font></td>
								<td background="../../image/table/tab_up_bg.gif" align="right"><IMG height=23 src="../../image/table/tab_up_right.gif" width=10></td>
						    </TR>
						</TABLE>
					</TD>	
		    		<TD WIDTH=* align=right><span id="RefView"><A href="vbscript:OpenPopupAllc()">반제정보</A>&nbsp;|&nbsp;<A href="vbscript:OpenPopupGL()">회계전표</A>&nbsp;|&nbsp;<A href="vbscript:OpenPopupTempGL()">결의전표</A> </SPAN></TD>					
					<TD WIDTH=10></TD>
				</TR>
			</TABLE>
		</TD>
						...
						<FIELDSET CLASS="CLSFLD">
							<TABLE <%=LR_SPACE_TYPE_40%>>
								<TR>
									...
									<TD CLASS="TD6" NOWRAP>
									    <script language =javascript src='./js/a5433ma1_fpDateTime1_txtFrDt.js'></script>
									    &nbsp;~&nbsp;
									    <script language =javascript src='./js/a5433ma1_fpDateTime2_txtToDt.js'></script>
									</TD>
					...
					<TD WIDTH=100% HEIGHT=* VALIGN=TOP>
							...
							<TABLE <%=LR_SPACE_TYPE_60%>>
								<TR>
									<TD WIDTH=100% HEIGHT=100% COLSPAN=4>
										<script language =javascript src='./js/a5433ma1_OBJECT1_vspdData1.js'></script>
									</TD>
								</TR>
								<TR>
									<TD HEIGHT=40 WIDTH=25%>
										<FIELDSET CLASS="CLSFLD">
											<TABLE  <%=LR_SPACE_TYPE_20%>>
												<TR>
													<TD CLASS="TD5" NOWRAP>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;반제금액(자국)합계</TD>
													<TD CLASS=TD6 NOWRAP>
														<script language =javascript src='./js/a5433ma1_OBJECT1_txtTotAllcLocAmt1.js'></script>
													</TD>
													<TD class=TD5 STYLE="WIDTH : 0px;"></TD>												
													<TD CLASS="TD5" NOWRAP>차이금액합계</TD>
													<TD CLASS=TD6 NOWRAP>
														<script language =javascript src='./js/a5433ma1_OBJECT1_txtTotDiffLocAmt1.js'></script>
													</TD>
												</TR>
												<TR>
													<TD CLASS="TD5" NOWRAP>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;회계전표금액(자국)합계</TD>
													<TD CLASS=TD6 NOWRAP>
														<script language =javascript src='./js/a5433ma1_OBJECT1_txtTotGlLocAmt1.js'></script>
													</TD>
													<TD class=TD5 STYLE="WIDTH : 0px;"></TD>												
													<TD CLASS="TD5" NOWRAP>결의전표금액(자국)합계</TD>
													<TD CLASS=TD6 NOWRAP>
														<script language =javascript src='./js/a5433ma1_OBJECT1_txtTotTempGlLocAmt1.js'></script>
													</TD>
												</TR>
											</TABLE>
										</FIELDSET>
						...
						<DIV ID="TabDiv" SCROLL=no>
							<TABLE <%=LR_SPACE_TYPE_60%>>
								<TR>
									<TD WIDTH=100% HEIGHT=100% COLSPAN=4>
										<script language =javascript src='./js/a5433ma1_OBJECT1_vspdData2.js'></script>
									</TD>
								</TR>
								<TR>
									<TD HEIGHT=40 WIDTH=25%>
										<FIELDSET CLASS="CLSFLD">
											<TABLE  <%=LR_SPACE_TYPE_20%>>
												<TR>
													<TD CLASS="TD5" NOWRAP>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;반제금액(자국)합계</TD>
													<TD CLASS=TD6 NOWRAP>
														<script language =javascript src='./js/a5433ma1_OBJECT1_txtTotAllcLocAmt2.js'></script>
													</TD>
													<TD class=TD5 STYLE="WIDTH : 0px;"></TD>												
													<TD CLASS="TD5" NOWRAP>차이금액합계</TD>
													<TD CLASS=TD6 NOWRAP>
														<script language =javascript src='./js/a5433ma1_OBJECT1_txtTotDiffLocAmt2.js'></script>
													</TD>
												</TR>
												<TR>
													<TD CLASS="TD5" NOWRAP>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;회계전표금액(자국)합계</TD>
													<TD CLASS=TD6 NOWRAP>
														<script language =javascript src='./js/a5433ma1_OBJECT1_txtTotGlLocAmt2.js'></script>
													</TD>
													<TD class=TD5 STYLE="WIDTH : 0px;"></TD>												
													<TD CLASS="TD5" NOWRAP>결의전표금액(자국)합계</TD>
													<TD CLASS=TD6 NOWRAP>
														<script language =javascript src='./js/a5433ma1_OBJECT1_txtTotTempGlLocAmt2.js'></script>
													</TD>
												</TR>
											</TABLE>
										</FIELDSET>
						...
						<DIV ID="TabDiv" SCROLL=no>
							<TABLE <%=LR_SPACE_TYPE_60%>>
								<TR>
									<TD WIDTH=100% HEIGHT=100% COLSPAN=4>
										<script language =javascript src='./js/a5433ma1_OBJECT1_vspdData3.js'></script>
									</TD>
								</TR>
								<TR>
									<TD HEIGHT=40 WIDTH=25%>
										<FIELDSET CLASS="CLSFLD">
											<TABLE  <%=LR_SPACE_TYPE_20%>>
												<TR>
													<TD CLASS="TD5" NOWRAP>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;반제금액(자국)합계</TD>
													<TD CLASS=TD6 NOWRAP>
														<script language =javascript src='./js/a5433ma1_OBJECT1_txtTotAllcLocAmt3.js'></script>
													</TD>
													<TD class=TD5 STYLE="WIDTH : 0px;"></TD>												
													<TD CLASS="TD5" NOWRAP>차이금액합계</TD>
													<TD CLASS=TD6 NOWRAP>
														<script language =javascript src='./js/a5433ma1_OBJECT1_txtTotDiffLocAmt3.js'></script>
													</TD>
												</TR>
												<TR>
													<TD CLASS="TD5" NOWRAP>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;회계전표금액(자국)합계</TD>
													<TD CLASS=TD6 NOWRAP>
														<script language =javascript src='./js/a5433ma1_OBJECT1_txtTotGlLocAmt3.js'></script>
													</TD>
													<TD class=TD5 STYLE="WIDTH : 0px;"></TD>												
													<TD CLASS="TD5" NOWRAP>결의전표금액(자국)합계</TD>
													<TD CLASS=TD6 NOWRAP>
														<script language =javascript src='./js/a5433ma1_OBJECT1_txtTotTempGlLocAmt3.js'></script>
													</TD>
												</TR>
											</TABLE>
										</FIELDSET>
