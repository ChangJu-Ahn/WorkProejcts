...
Const BIZ_PGM_ID 		= "a3506rb2.asp"                              '☆: Biz Logic ASP Name
...
Sub InitSpreadSheet()
    ...
    Call SetZAdoSpreadSheet("A3506RA2","S","A","V20021211",PopupParent.C_SORT_DBAGENT,frm1.vspdData, C_MaxKey, "X","X")
    Call SetSpreadLock() 
...
Function EscPopUp(Byval iWhere)
	...
	Select Case iWhere
		Case 1
				frm1.txtBpCd.focus
		Case 2
				frm1.txtAdjustNoFr.focus	
		Case 3
				frm1.txtAdjustNoTo.focus
		Case 4
				frm1.txtRcptNoFr.focus
		Case 5
				frm1.txtRcptNoTo.focus
	End Select	
...
Function SetPopUp(Byval arrRet, Byval iWhere)
	...
	Select Case iWhere
		...
		Case 3
				...
				frm1.txtAdjustNoTo.focus
		Case 4
				Frm1.txtRcptNoFr.value = arrRet(0)		
				frm1.txtRcptNoFr.focus
		Case 5
				Frm1.txtRcptNoTo.value = arrRet(0)		
				frm1.txtRcptNoTo.focus
	End Select	
...
Function DbQuery()
    ...
    '--------- Developer Coding Part (Start) ----------------------------------------------------------
        If lgIntFlgMode  <> PopupParent.OPMD_UMODE Then   ' This means that it is first search
			...
			strVal = strVal & "&txtRcptNoFr=" & Trim(.txtRcptNoFr.value)
			strVal = strVal & "&txtRcptNoTo=" & Trim(.txtRcptNoTo.value)
			strVal = strVal & "&txtAdJustDtFr=" & Trim(.txtAdJustDtFr.Text)					'☆: 조회 조건 데이타 
			strVal = strVal & "&txtAdJustDtTo=" & Trim(.txtAdJustDtTo.Text)					'☆: 조회 조건 데이타 
			strVal = strVal & "&txtBpcd_Alt=" & Trim(.txtBpCd.alt)
	    Else
			strVal = strVal & "?txtBpCd=" & Trim(.htxtBpCd.value)
			strVal = strVal & "&txtAdJustDtFr=" & Trim(.htxtAdJustDtFr.value)					'☆: 조회 조건 데이타 
			strVal = strVal & "&txtAdJustDtTo=" & Trim(.htxtAdJustDtTo.value)					'☆: 조회 조건 데이타 
			strVal = strVal & "&txtBpcd_Alt=" & Trim(.txtBpCd.alt)
			strVal = strVal & "&txtAdjustNoFr=" & Trim(.htxtAdjustNoFr.value)
			strVal = strVal & "&txtAdjustNoTo=" & Trim(.htxtAdjustNoTo.value)
			strVal = strVal & "&txtRcptNoFr=" & Trim(.htxtRcptNoFr.value)
			strVal = strVal & "&txtRcptNoTo=" & Trim(.htxtRcptNoTo.value)
			...
			<FIELDSET CLASS="CLSFLD">
				<TABLE <%=LR_SPACE_TYPE_40%>>
					<TR>				
						...
						<TD CLASS=TD6 NOWRAP>
							<SCRIPT LANGUAGE=JavaScript> ExternalWrite('<OBJECT CLASSID=<%=gCLSIDFPDT%> NAME="txtAdJustDtFr" CLASS=FPDTYYYYMMDD tag="12" Title="FPDATETIME" ALT="시작일자"></OBJECT>');</SCRIPT>								
							&nbsp;~&nbsp;<SCRIPT LANGUAGE=JavaScript> ExternalWrite('<OBJECT CLASSID=<%=gCLSIDFPDT%> NAME="txtAdJustDtTo" CLASS=FPDTYYYYMMDD tag="12" Title="FPDATETIME" ALT="종료일자" ></OBJECT>');</SCRIPT></TD>												
					...
					<TR>
						...
						<TD CLASS=TD6 NOWRAP>
							<INPUT TYPE="Text" NAME="txtAdjustNoFr" SIZE=10 MAXLENGTH=10 tag="11NXXU" ALT="청산번호"><IMG SRC="../../../CShared/image/btnPopup.gif" NAME="btnBizCd" ALIGN=top TYPE="BUTTON" ONCLICK="vbscript: CALL OpenPopUp(frm1.txtAdjustNoFr.value,2)"> ~
							<INPUT TYPE="Text" NAME="txtAdjustNoTo" SIZE=10 MAXLENGTH=10 tag="11NXXU" ALT="청산번호"><IMG SRC="../../../CShared/image/btnPopup.gif" NAME="btnBizCd" ALIGN=top TYPE="BUTTON" ONCLICK="vbscript: CALL OpenPopUp(frm1.txtAdjustNoTo.value,3)"> 
						</TD>
						<TD CLASS=TD5 NOWRAP>입금번호</TD>
						<TD CLASS=TD6 NOWRAP>
							<INPUT TYPE="Text" NAME="txtRcptNoFr" SIZE=10 MAXLENGTH=10 tag="11NXXU" ALT="입금번호"><IMG SRC="../../../CShared/image/btnPopup.gif" NAME="btnBizCd" ALIGN=top TYPE="BUTTON" ONCLICK="vbscript: CALL OpenPopUp(frm1.txtRcptNoFr.value,4)"> ~
							<INPUT TYPE="Text" NAME="txtRcptNoTo" SIZE=10 MAXLENGTH=10 tag="11NXXU" ALT="입금번호"><IMG SRC="../../../CShared/image/btnPopup.gif" NAME="btnBizCd" ALIGN=top TYPE="BUTTON" ONCLICK="vbscript: CALL OpenPopUp(frm1.txtRcptNoTo.value,5)"> 
						</TD>
					</TR>
				</TABLE>
			</FIELDSET>
...
<INPUT TYPE=HIDDEN NAME="htxtRcptNoFr"		tag="24">
<INPUT TYPE=HIDDEN NAME="htxtRcptNoTo"        tag="24">
