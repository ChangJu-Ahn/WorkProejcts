...
'*  3. Program ID           : A3118ma1
'*  4. Program Name         : 채권잔액정리 
'*  5. Program Desc         : 채권잔액정리 
'*  6. Modified date(First) : 2000/09/25
'*  7. Modified date(Last)  : 2002/01/07
...
'@PGM_ID
Const BIZ_PGM_ID         = "a3118mb1.asp"											' F_PrPaym_Sttl 의 CRUD
...
Sub  InitSpreadSheet()
    ...
    With frm1
	    ...
	    ggoSpread.SSSetDate	 C_AdjustDt    , "청산일자"      , 11, 2, parent.gDateFormat
	    ...
	    ggoSpread.SSSetEdit	 C_RefNo       , "참조번호"      , 14,,,18,2
...
Sub  SetSpread2ColorAR()
    ...
    With frm1
		...
		For i = 1 To .vspddata2.maxrows
			...
			If (.vspddata2.text = "D" And .vspddata2.text <> "") _
...
Function OpenArNo()
	...
	iCalledAspName = AskPRAspName("a3118ra1")
	
	If Trim(iCalledAspName) = "" Then
		IntRetCD = DisplayMsgBox("900040", parent.VB_INFORMATION, "a3118ra1", "X")
		IsOpenPop = False
		Exit Function
	End If
...
'   Function Desc : 
'=======================================================================================================
Function SetArInfo(Byval arrRet)
	With frm1
...
Function SetAcctCd(Byval arrRet)
	With frm1
		...
		Call vspdData_Change(C_AcctCd, .vspddata.activerow)			' 변경이 일어났다고 알려줌 
...
Function SetCurrency(ByVal arrRet)
	With frm1
		...
		Call vspdData_Change(C_DocCur , .vspdData.Row)											' 변경이 일어났다고 알려줌 
		...
		For lngRows = 1 To .MaxRows
			...
			Select Case .Text
			    Case ggoSpread.InsertFlag, ggoSpread.UpdateFlag
			        ...
			        .Col = C_AdjustDt		'3
			        strVal = strVal & UniConvDateAToB(Trim(.Text),parent.gDateFormat,parent.gServerDateFormat) & parent.gColSep
					.Col = C_AcctCd		'4
			        strVal = strVal & Trim(.Text) & parent.gColSep
			        .Col = C_AdjustAmt	'5
...
Function DbQuery2(ByVal Row)
	...
	With frm1
		...
		strFrom = " A_CTRL_ITEM	A (NOLOCK), A_ACCT_CTRL_ASSN B (NOLOCK), A_AR_ADJUST_DTL C (NOLOCK), A_AR_ADJUST D (NOLOCK) "
...
Sub DoSum()
	Dim dblTotAdjustAmt
	Dim dblTotAdjustLocAmt

	With frm1.vspdData
		dblTotAdjustAmt = FncSumSheet1(frm1.vspdData,C_AdjustAmt, 1, .MaxRows, False, -1, -1, "V")
		dblTotAdjustLocAmt = FncSumSheet1(frm1.vspdData,C_AdjustLocAmt, 1, .MaxRows, False, -1, -1, "V")
		
		If CommonQueryRs( "CURRENCY_DESC" , "B_CURRENCY" ,  " CURRENCY =  " & FilterVar(frm1.txtDocCur.value , "''", "S") & "" , lgF0,lgF1,lgF2,lgF3,lgF4,lgF5,lgF6) Then   			        							
			frm1.txtTotAdjustAmt.text	= UNIConvNumPCToCompanyByCurrency(dblTotAdjustAmt,frm1.txtDocCur.value,parent.ggAmtOfMoneyNo, "X", "X")
		End If	
        frm1.txtTotAdjustLocAmt.text = UNIConvNumPCToCompanyByCurrency(dblTotAdjustLocAmt,parent.gCurrency,parent.ggAmtOfMoneyNo, parent.gLocRndPolicyNo, "X")
...
Sub CurFormatNumericOCX()
	With frm1
		' 채권액 
		ggoOper.FormatFieldByObjectOfCur .txtArAmt, .txtDocCur.value, parent.ggAmtOfMoneyNo, gBCurrency, gBDataType, gBDecimals, parent.gDateFormat, parent.gComNum1000, parent.gComNumDec
		' 잔액 
		...
		' 청산금액 
		ggoOper.FormatFieldByObjectOfCur .txtTotAdjustAmt, .txtDocCur.value, parent.ggAmtOfMoneyNo, gBCurrency, gBDataType, gBDecimals, parent.gDateFormat, parent.gComNum1000, parent.gComNumDec
	End With
End Sub
...
Sub  vspdData_Change(ByVal Col, ByVal Row )
	...
	Select Case Col
		Case C_AdjustAmt
			...
			If (UNICDbl(frm1.txtArAmt.Text) > 0 And parent.UNICDbl(AdjustAmt) < 0) Or (UNICDbl(frm1.txtArAmt.Text) < 0 And parent.UNICDbl(AdjustAmt) > 0) then
				frm1.vspdData.Text = UNIConvNumPCToCompanyByCurrency(parent.UNICDbl(AdjustAmt) * (-1),frm1.txtDocCur.value,parent.ggAmtOfMoneyNo, "X", "X")
			End If   	
						...
						<FIELDSET CLASS="CLSFLD">
							<TABLE <%=LR_SPACE_TYPE_40%>>
								<TR>
									...
									<TD CLASS="TD656" NOWRAP><INPUT NAME="txtArNo" MAXLENGTH=18 STYLE="TEXT-ALIGN: Left" tag ="12XXXU" ALT="채권번호"><IMG align=top name=btnPrpaymNo src="../../../CShared/image/btnPopup.gif"  TYPE="BUTTON" onclick="vbscript:OpenArNo"></TD>								
								</TR>
							</TABLE>
						</FIELDSET>
					</TD>
					...
					<TD WIDTH=100% HEIGHT=* valign=top>
						<TABLE <%=LR_SPACE_TYPE_60%>>
							<TR>
								...
								<TD CLASS="TD6" NOWRAP><INPUT TYPE=TEXT NAME="txtDeptCd" SIZE=10 MAXLENGTH=10 STYLE="TEXT-ALIGN: Left" tag="24XXXU" ALT="부서">&nbsp;<INPUT TYPE=TEXT NAME="txtDeptNm" SIZE=25 tag="24" ALT="부서명"></TD>
								<TD CLASS="TD5" NOWRAP>채권일자</TD>
								<TD CLASS="TD6" NOWRAP><SCRIPT LANGUAGE=JavaScript> ExternalWrite('<OBJECT CLASSID=<%=gCLSIDFPDT%> name=txtArDt CLASS=FPDTYYYYMMDD title=FPDATETIME ALT="채권일자" tag="24X1" ></OBJECT>');</SCRIPT></TD>
							</TR>
							<TR>
								<TD CLASS="TD5" NOWRAP>거래처</TD>
								<TD CLASS="TD6" NOWRAP><INPUT TYPE=TEXT NAME="txtBpCd" SIZE=10 MAXLENGTH=10 STYLE="TEXT-ALIGN: Left" tag="24XXXU" ALT="거래처">&nbsp;<INPUT TYPE=TEXT NAME="txtBpNm" SIZE=25 tag="24" ALT="거래처명"></TD>
								<TD CLASS="TD5" NOWRAP>참조번호</TD>
								<TD CLASS="TD6" NOWRAP><INPUT TYPE=TEXT NAME="txtRefNo" SIZE=30 MAXLENGTH=30 STYLE="TEXT-ALIGN: Left" tag="24XXXU" ALT="참조번호"></TD>
							</TR>
							<TR>
								<TD CLASS="TD5" NOWRAP>거래통화</TD>
								<TD CLASS="TD6" NOWRAP><INPUT NAME="txtDocCur" ALT="거래통화" TYPE="Text" SIZE=10 MAXLENGTH=3 STYLE="TEXT-ALIGN: Left" tag="24XXXU" ></TD>
							...
							<TR>
							    ...
							    <TD CLASS="TD6" NOWRAP><SCRIPT LANGUAGE=JavaScript> ExternalWrite('<OBJECT CLASSID=<%=gCLSIDFPDS%> name=txtArAmt CLASS=FPDS140 title=FPDOUBLESINGLE ALT="채권액" tag="24X2"></OBJECT>');</SCRIPT></TD>
								<TD CLASS="TD5" NOWRAP>채권액(자국)</TD>
							    <TD CLASS="TD6" NOWRAP><SCRIPT LANGUAGE=JavaScript> ExternalWrite('<OBJECT CLASSID=<%=gCLSIDFPDS%> name=txtArLocAmt CLASS=FPDS140 title=FPDOUBLESINGLE ALT="채권액(자국)" tag="24X2"></OBJECT>');</SCRIPT></TD>
							</TR>
							<TR>
							...
							<TR>
								...
								<TD CLASS="TD6" NOWRAP COLSPAN=3><INPUT TYPE=TEXT NAME="txtArDesc" SIZE=90 MAXLENGTH=128 tag="24" ALT="적요"></TD>
							</TR>						
							<TR HEIGHT="50%">
							...
							<TR>
								<TD COLSPAN=4>
									<TABLE <%=LR_SPACE_TYPE_20%>>
										<TR>																					
								<TD class=TDT NOWRAP>청산금액</TD>
								<TD class=TD6 NOWRAP>									
									<SCRIPT LANGUAGE=JavaScript> ExternalWrite('<OBJECT CLASSID=<%=gCLSIDFPDS%> name="txtTotAdjustAmt" CLASS=FPDS140 title=FPDOUBLESINGLE ALT="순매출액" tag="24X2" id=OBJECT22></OBJECT>');</SCRIPT></TD>
								<TD class=TDT STYLE="WIDTH : 0px;"></TD>
								<TD class=TDT NOWRAP>청산금액(자국)</TD>
								<TD class=TD6 NOWRAP>
									<SCRIPT LANGUAGE=JavaScript> ExternalWrite('<OBJECT CLASSID=<%=gCLSIDFPDS%> name="txtTotAdjustLocAmt" CLASS=FPDS140 title=FPDOUBLESINGLE ALT="순매출액(자국)" tag="24X2" id=OBJECT22></OBJECT>');</SCRIPT></TD>
										</TR>
									</TABLE>
								</TD>																											
							</TR>
							<TR HEIGHT="50%">
								<TD WIDTH="100%" COLSPAN=4>
									<SCRIPT LANGUAGE=JavaScript> ExternalWrite('<OBJECT CLASSID=<%=gCLSIDFPSPD%> HEIGHT="100%" name=vspdData2 width="100%" tag="2" TITLE="SPREAD"> <PARAM NAME="MaxCols" VALUE="0"><PARAM NAME="MaxRows" VALUE="0"></OBJECT>');</SCRIPT>
								</TD>
							</TR>
						</TABLE>
					</TD>
...
<INPUT TYPE=hidden NAME="hArNo"    tag="24" TABINDEX="-1">
