...
Const BIZ_PGM_ID 		= "a3117rb1.asp"                              '☆: Biz Logic ASP Name
			...
			<FIELDSET CLASS="CLSFLD">
				<TABLE <%=LR_SPACE_TYPE_40%>>
					<TR>				
						...
						<TD CLASS=TD6 NOWRAP>
							<SCRIPT LANGUAGE=JavaScript> ExternalWrite('<OBJECT title=FPDATETIME CLASS=FPDTYYYYMMDD name=txtFrAllcDt CLASSID=<%=gCLSIDFPDT%> ALT="반제일자" tag="12"> </OBJECT>');</SCRIPT>&nbsp;~&nbsp;
							<SCRIPT LANGUAGE=JavaScript> ExternalWrite('<OBJECT title=FPDATETIME CLASS=FPDTYYYYMMDD name=txtToAllcDt CLASSID=<%=gCLSIDFPDT%> ALT="반제일자" tag="12"> </OBJECT>');</SCRIPT>
						</TD>												
