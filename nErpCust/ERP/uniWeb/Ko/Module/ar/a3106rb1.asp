...
<Script Language=vbscript>
    If "<%=lgDataExist%>" = "Yes" Then
       ...
       'Show multi spreadsheet data from this line
			...
			Call Parent.ReFormatSpreadCellByCellByCurrency(Parent.vspdData,<%=iPrevEndRow+1%>,<%=iEndRow%>,Parent.GetKeyPos("A",14),Parent.GetKeyPos("A",8),"A", "I" ,"X","X")
			Call Parent.ReFormatSpreadCellByCellByCurrency(Parent.vspdData,<%=iPrevEndRow+1%>,<%=iEndRow%>,Parent.GetKeyPos("A",14),Parent.GetKeyPos("A",9),"A", "I" ,"X","X")
			Call Parent.ReFormatSpreadCellByCellByCurrency(Parent.vspdData,<%=iPrevEndRow+1%>,<%=iEndRow%>,Parent.GetKeyPos("A",14),Parent.GetKeyPos("A",10),"A", "I" ,"X","X")
