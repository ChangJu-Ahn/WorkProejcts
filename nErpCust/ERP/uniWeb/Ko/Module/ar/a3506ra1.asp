			...
			<FIELDSET CLASS="CLSFLD">
				<TABLE <%=LR_SPACE_TYPE_40%>>
					...
					<TR>
						...
						<TD CLASS=TD6 NOWRAP>
							<INPUT TYPE="Text" NAME="txtArNoFr" SIZE=10 MAXLENGTH=10 tag="11NXXU" ALT="채권번호"><IMG SRC="../../../CShared/image/btnPopup.gif" NAME="btnBizCd" ALIGN=top TYPE="BUTTON" ONCLICK="vbscript: CALL OpenPopUp(frm1.txtArNoFr.value,4)"> ~
							<INPUT TYPE="Text" NAME="txtArNoTo" SIZE=10 MAXLENGTH=10 tag="11NXXU" ALT="채권번호"><IMG SRC="../../../CShared/image/btnPopup.gif" NAME="btnBizCd" ALIGN=top TYPE="BUTTON" ONCLICK="vbscript: CALL OpenPopUp(frm1.txtArNoTo.value,5)"> 
						</TD>
					</TR>
				</TABLE>
			</FIELDSET>
