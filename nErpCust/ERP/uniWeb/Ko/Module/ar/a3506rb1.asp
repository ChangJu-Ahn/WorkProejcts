...
Sub  TrimData()
    ...
    '--------------- 개발자 coding part(실행로직,Start)----------------------------------------------------
     ...
     strArNoFr	   = FilterVar(UCase(Trim(Request("txtArNoFr"))),"","S")
     strArNoTo	   = FilterVar(UCase(Trim(Request("txtArNoTo"))),"","S")
     ...
     If strBpCd <> "" Then
		strCond = strCond & " and B.PAY_BP_CD =  " & FilterVar(strBpCd , "''", "S") & ""
     End If
     ...
     If strArNoFr <> "" Then
		strCond = strCond & " and A.AR_NO >=  " & FilterVar(strArNoFr , "''", "S") & ""
     End If
     
     If strArNoTo <> "" Then
		strCond = strCond & " and A.AR_NO <=  " & FilterVar(strArNoTo , "''", "S") & ""
     End If
...
<Script Language=vbscript>
    If "<%=lgDataExist%>" = "Yes" Then
       ...
       If "<%=lgPageNo%>" = "1" Then   ' "1" means that this query is first and next data exists
          ...
          Parent.Frm1.htxtArNoFr.Value			= Parent.Frm1.txtArNoFr.Value
          Parent.Frm1.htxtArNoTo.Value			= Parent.Frm1.txtArNoTo.Value
       End If
