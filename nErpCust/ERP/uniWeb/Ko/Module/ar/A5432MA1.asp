...
Const BIZ_PGM_ID      = "A5432MB1.asp"						           '☆: Biz Logic ASP Name
Const BIZ_PGM_ID1     = "A5432MB2.asp"	
Const BIZ_PGM_ID2     = "A5432MB3.asp"	
...
Sub SetDefaultVal()
	...
	frm1.txtArFrDt.Text  = UniConvDateAToB(FirstDate, Parent.gServerDateFormat, Parent.gDateFormat)
	frm1.txtArToDt.Text  = UniConvDateAToB(LastDate, Parent.gServerDateFormat, Parent.gDateFormat)
	
	frm1.txtShowBiz.value = "N"
	frm1.txtShowBp.value = "N"

	frm1.txtArFrDt.focus 	
End Sub
	...
	Select Case UCase(Trim(pvSpdNo))
		Case "A"
			With frm1.vspdData1
				...
				ggoSpread.SSSetFloat   C_ARLocAmt1         ,"채권금액(자국)"     ,15     ,Parent.ggAmtOfMoneyNo,ggStrIntegeralPart, ggStrDeciPointPart,Parent.gComNum1000,Parent.gComNumDec,1      ,True  
		...
		Case "B"
			With frm1.vspdData2
				...
				ggoSpread.SSSetEdit    C_AcctNm2           ,"계정코드명"         ,15    ,3
				                      'ColumnPosition     Header            Width   Grp                    IntegeralPart       DeciPointpart                             Align   Sep    PZ   Min       Max 
				ggoSpread.SSSetFloat   C_ARLocAmt2         ,"채권금액(자국)"     ,15     ,Parent.ggAmtOfMoneyNo,ggStrIntegeralPart, ggStrDeciPointPart,Parent.gComNum1000,Parent.gComNumDec,1      ,True  
		...
		Case "C"
			With frm1.vspdData3
				...
				ggoSpread.SSSetEdit    C_ArNo          ,"채권번호"           ,15    ,3        ,     ,15     ,2
				ggoSpread.SSSetDate    C_ArDt          ,"채권일자"           ,10    ,2        ,Parent.gDateFormat   ,-1 
				...
				ggoSpread.SSSetFloat   C_ARLocAmt3     ,"채권금액(자국)"     ,15     ,Parent.ggAmtOfMoneyNo,ggStrIntegeralPart, ggStrDeciPointPart,Parent.gComNum1000,Parent.gComNumDec,1      ,True 
				...
				ggoSpread.SSSetEdit    C_ArType3       ,"전표입력경로"       , 5    ,         ,    ,10       ,2
				ggoSpread.SSSetEdit    C_ArTypeNm3     ,"전표입력경로명"     ,15    ,3				
				...
				Call ggoSpread.SSSetColHidden(C_ArType3,C_ArType3,True)
				.ReDraw = True			
				.ReDraw = True
    ...
    Select Case UCase(pvSpdNo)
       ...
       Case "B"
		...
		Case "C"
			...
			C_ArNo			    = iCurColumnPos(3)
			C_ArDt			    = iCurColumnPos(4)
			C_GlDt			    = iCurColumnPos(5)
			
			C_ARLocAmt3		    = iCurColumnPos(6)
			...
			C_ArType3			= iCurColumnPos(15)
			C_ArTypeNm3			= iCurColumnPos(16)
...
Function  OpenPopUp(Byval strCode, Byval iWhere)
	...
	Select Case iWhere
		...
		Case 3
			...
			arrParam(1) = " a_open_ar a , b_minor b "					' TABLE 명칭 
			arrParam(2) = strCode						 				' Code Condition
			arrParam(3) = ""											' Name Condition
			arrParam(4) = " b.major_cd=" & FilterVar("A1001", "''", "S") & "  and a.ar_type=b.minor_cd " ' Where Condition
			arrParam(5) = "전표입력경로"			
			arrField(0) = "a.ar_type"									' Field명(0)
...
Function DbQuery(pDirect)
    ...
    strVal = strVal		& "&txtArFrDt="      & frm1.txtArFrDt.text								'☜:
    strVal = strVal		& "&txtArToDt="      & frm1.txtArToDt.text								'☜:
...
Sub DoSum()
	...
	Select Case gSelframeFlg
		Case TAB1
			With frm1.vspdData1
				dbTotArLocAmt		= FncSumSheet(frm1.vspdData1,C_ARLocAmt1, 1, .MaxRows, False, -1, -1, "V")
				...
				frm1.txtTotArLocAmt1.text = UNIConvNumPCToCompanyByCurrency(dbTotArLocAmt,parent.gCurrency,parent.ggAmtOfMoneyNo, parent.gLocRndPolicyNo, "X")
		...
		Case TAB2
			With frm1.vspdData2
				dbTotArLocAmt		= FncSumSheet(frm1.vspdData2,C_ARLocAmt2, 1, .MaxRows, False, -1, -1, "V")
				...
				frm1.txtTotArLocAmt2.text = UNIConvNumPCToCompanyByCurrency(dbTotArLocAmt,parent.gCurrency,parent.ggAmtOfMoneyNo, parent.gLocRndPolicyNo, "X")
...
'========================================================================================================
' Name : txtArFrDt_DblClick
' Desc : developer describe this line
'========================================================================================================
Sub txtArFrDt_DblClick(Button)
    If Button = 1 Then
		frm1.txtArFrDt.Action = 7                                    ' 7 : Popup Calendar ocx
		Call SetFocusToDocument("M")	
		frm1.txtArFrDt.Focus
    End If
End Sub

Sub txtArFrDt_KeyDown(KeyCode, Shift)
	If KeyCode = 13 Then 
		frm1.txtArFrDt.focus
		Call FncQuery
	end if
End Sub
'========================================================================================================
' Name : txtArToDt_DblClick
' Desc : developer describe this line
'========================================================================================================
Sub txtArToDt_DblClick(Button)
    If Button = 1 Then
		frm1.txtArToDt.Action = 7                                    ' 7 : Popup Calendar ocx
		Call SetFocusToDocument("M")	
		frm1.txtArToDt.Focus
    End If
End Sub

Sub txtArToDt_KeyDown(KeyCode, Shift)
	If KeyCode = 13 Then 
		frm1.txtArToDt.focus
		Call FncQuery
	end if
				...
				<TR>
					...
					<TD CLASS="CLSMTABP">
						<TABLE ID="MyTab" CELLSPACING=0 CELLPADDING=0 onclick="ClickTab3()">
							<TR>
								<td background="../../image/table/tab_up_bg.gif"><IMG height=23 src="../../image/table/tab_up_left.gif" width=9></td>
								<td background="../../image/table/tab_up_bg.gif" align="center" CLASS="CLSMTABP"><font color=white>채권별발생금액</font></td>
								<td background="../../image/table/tab_up_bg.gif" align="right"><IMG height=23 src="../../image/table/tab_up_right.gif" width=10></td>
						    </TR>
						</TABLE>
					</TD>	
						...
						<FIELDSET CLASS="CLSFLD">
							<TABLE <%=LR_SPACE_TYPE_40%>>
								<TR>
									...
									<TD CLASS="TD6" NOWRAP>
									    <script language =javascript src='./js/a5432ma1_fpDateTime1_txtArFrDt.js'></script>
									    &nbsp;~&nbsp;
									    <script language =javascript src='./js/a5432ma1_fpDateTime2_txtArToDt.js'></script>
									</TD>
					...
					<TD WIDTH=100% HEIGHT=* VALIGN=TOP>
							...
							<TABLE <%=LR_SPACE_TYPE_60%>>
								<TR>
									<TD WIDTH=100% HEIGHT=100% COLSPAN=4>
										<script language =javascript src='./js/a5432ma1_OBJECT1_vspdData1.js'></script>
									</TD>
								</TR>
								<TR>
									<TD HEIGHT=40 WIDTH=25%>
										<FIELDSET CLASS="CLSFLD">
											<TABLE  <%=LR_SPACE_TYPE_20%>>
												<TR>
													<TD CLASS="TD5" NOWRAP>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;채권금액(자국)합계</TD>
													<TD CLASS=TD6 NOWRAP>
														<script language =javascript src='./js/a5432ma1_OBJECT1_txtTotArLocAmt1.js'></script>
													</TD>
													<TD class=TD5 STYLE="WIDTH : 0px;"></TD>												
													<TD CLASS="TD5" NOWRAP>차이금액합계</TD>
													<TD CLASS=TD6 NOWRAP>
														<script language =javascript src='./js/a5432ma1_OBJECT1_txtTotDiffLocAmt1.js'></script>
													</TD>
												</TR>
												<TR>
													<TD CLASS="TD5" NOWRAP>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;회계전표금액(자국)합계</TD>
													<TD CLASS=TD6 NOWRAP>
														<script language =javascript src='./js/a5432ma1_OBJECT1_txtTotGlLocAmt1.js'></script>
													</TD>
													<TD class=TD5 STYLE="WIDTH : 0px;"></TD>												
													<TD CLASS="TD5" NOWRAP>결의전표금액(자국)합계</TD>
													<TD CLASS=TD6 NOWRAP>
														<script language =javascript src='./js/a5432ma1_OBJECT1_txtTotTempGlLocAmt1.js'></script>
													</TD>
												</TR>
											</TABLE>
										</FIELDSET>
						...
						<DIV ID="TabDiv" SCROLL=no>
							<TABLE <%=LR_SPACE_TYPE_60%>>
								<TR>
									<TD WIDTH=100% HEIGHT=100% COLSPAN=4>
										<script language =javascript src='./js/a5432ma1_OBJECT1_vspdData2.js'></script>
									</TD>
								</TR>
								<TR>
									<TD HEIGHT=40 WIDTH=25%>
										<FIELDSET CLASS="CLSFLD">
											<TABLE  <%=LR_SPACE_TYPE_20%>>
												<TR>
													<TD CLASS="TD5" NOWRAP>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;채권금액(자국)합계</TD>
													<TD CLASS=TD6 NOWRAP>
														<script language =javascript src='./js/a5432ma1_OBJECT1_txtTotArLocAmt2.js'></script>
													</TD>
													<TD class=TD5 STYLE="WIDTH : 0px;"></TD>												
													<TD CLASS="TD5" NOWRAP>차이금액합계</TD>
													<TD CLASS=TD6 NOWRAP>
														<script language =javascript src='./js/a5432ma1_OBJECT1_txtTotDiffLocAmt2.js'></script>
													</TD>
												</TR>
												<TR>
													<TD CLASS="TD5" NOWRAP>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;회계전표금액(자국)합계</TD>
													<TD CLASS=TD6 NOWRAP>
														<script language =javascript src='./js/a5432ma1_OBJECT1_txtTotGlLocAmt2.js'></script>
													</TD>
													<TD class=TD5 STYLE="WIDTH : 0px;"></TD>												
													<TD CLASS="TD5" NOWRAP>결의전표금액(자국)합계</TD>
													<TD CLASS=TD6 NOWRAP>
														<script language =javascript src='./js/a5432ma1_OBJECT1_txtTotTempGlLocAmt2.js'></script>
													</TD>
												</TR>
											</TABLE>
										</FIELDSET>
						...
						<DIV ID="TabDiv" SCROLL=no>
							<TABLE <%=LR_SPACE_TYPE_60%>>
								<TR>
									<TD WIDTH=100% HEIGHT=100% COLSPAN=4>
										<script language =javascript src='./js/a5432ma1_OBJECT1_vspdData3.js'></script>
									</TD>
								</TR>
								<TR>
									<TD HEIGHT=40 WIDTH=25%>
										<FIELDSET CLASS="CLSFLD">
											<TABLE  <%=LR_SPACE_TYPE_20%>>
												<TR>
													<TD CLASS="TD5" NOWRAP>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;채권금액(자국)합계</TD>
													<TD CLASS=TD6 NOWRAP>
														<script language =javascript src='./js/a5432ma1_OBJECT1_txtTotArLocAmt3.js'></script>
													</TD>
													<TD class=TD5 STYLE="WIDTH : 0px;"></TD>												
													<TD CLASS="TD5" NOWRAP>차이금액합계</TD>
													<TD CLASS=TD6 NOWRAP>
														<script language =javascript src='./js/a5432ma1_OBJECT1_txtTotDiffLocAmt3.js'></script>
													</TD>
												</TR>
												<TR>
													<TD CLASS="TD5" NOWRAP>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;회계전표금액(자국)합계</TD>
													<TD CLASS=TD6 NOWRAP>
														<script language =javascript src='./js/a5432ma1_OBJECT1_txtTotGlLocAmt3.js'></script>
													</TD>
													<TD class=TD5 STYLE="WIDTH : 0px;"></TD>												
													<TD CLASS="TD5" NOWRAP>결의전표금액(자국)합계</TD>
													<TD CLASS=TD6 NOWRAP>
														<script language =javascript src='./js/a5432ma1_OBJECT1_txtTotTempGlLocAmt3.js'></script>
													</TD>
												</TR>
											</TABLE>
										</FIELDSET>
