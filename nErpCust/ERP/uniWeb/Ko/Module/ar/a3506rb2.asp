...
Sub  TrimData()
    ...
    '--------------- 개발자 coding part(실행로직,Start)----------------------------------------------------
     ...
     strAdjustNoFr	   = UCase(Trim(Request("txtAdjustNoFr")))
     strAdjustNoTo	   = UCase(Trim(Request("txtAdjustNoTo")))
     strRcptNoFr	   = UCase(Trim(Request("txtRcptNoFr")))
     strRcptNoTo	   = UCase(Trim(Request("txtRcptNoTo")))
     ...
     If strRcptNoFr <> "" Then
		strCond = strCond & " and A.RCPT_NO >=  " & FilterVar(strRcptNoFr , "''", "S") & ""
     End If
     
     If strRcptNoTo <> "" Then
		strCond = strCond & " and A.RCPT_NO <=  " & FilterVar(strRcptNoTo , "''", "S") & ""
     End If
...
<Script Language=vbscript>
    If "<%=lgDataExist%>" = "Yes" Then
       ...
       If "<%=lgPageNo%>" = "1" Then   ' "1" means that this query is first and next data exists
          ...
          Parent.Frm1.htxtRcptNoFr.Value		= Parent.Frm1.txtRcptNoFr.Value
          Parent.Frm1.htxtRcptNoTo.Value		= Parent.Frm1.txtRcptNoTo.Value
       End If
