...
'========================================================================================================
Const BIZ_PGM_ID 		= "a3106rb5.asp"                              '☆: Biz Logic ASP Name
...
Sub InitSpreadSheet()
    ...
    Call SetZAdoSpreadSheet("a3106RA5","S","A","V20021211",PopupParent.C_SORT_DBAGENT,vspdData, C_MaxKey, "X","X")
    Call SetSpreadLock() 
End Sub
			...
			<FIELDSET CLASS="CLSFLD">
				<TABLE <%=LR_SPACE_TYPE_40%>>
					...
					<TR>						
						...
						<TD CLASS=TD6 NOWRAP><INPUT TYPE=TEXT NAME="txtRefNo" SIZE=20 MAXLENGTH=10 STYLE="TEXT-ALIGN: Left" tag=11NXXU" ALT="참조번호"></TD>
					</TR>
					<TR>
						...
						<TD CLASS=TD6 NOWRAP><INPUT NAME=txtProject ALT="프로젝트" MAXLENGTH=25 SIZE=25 tag="1X">
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
