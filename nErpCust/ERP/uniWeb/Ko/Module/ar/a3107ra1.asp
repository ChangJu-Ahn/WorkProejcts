...
'========================================================================================================	
Sub InitVariables()
	If Trim("<%=Request("PGM")%>") = "A3111MA1" Then			'가수금반제 
		Redim arrReturn(0, 0)
	Else
		Redim arrReturn(0)
	End If		
...
Function OpenRcpt()
	...
	arrParam(0) = Trim(txtRcptNo.value)				'회계전표번호 
			...
			<FIELDSET CLASS="CLSFLD">
				<TABLE <%=LR_SPACE_TYPE_40%>>
					<TR>				
						...
						<TD CLASS=TD6 NOWRAP><SCRIPT LANGUAGE=JavaScript> ExternalWrite('<OBJECT CLASSID=<%=gCLSIDFPDT%> NAME="txtRcptDt" CLASS=FPDTYYYYMMDD tag="12" Title="FPDATETIME" ALT="입금시작일자" ></OBJECT>');</SCRIPT>				
						&nbsp;~&nbsp;<SCRIPT LANGUAGE=JavaScript> ExternalWrite('<OBJECT CLASSID=<%=gCLSIDFPDT%> NAME="txtToRcptDt" CLASS=FPDTYYYYMMDD tag="12" Title="FPDATETIME" ALT="입금종료일자" ></OBJECT>');</SCRIPT>					
					...
					<TR>
						...
						<TD CLASS=TD6 NOWRAP><INPUT TYPE="Text" NAME="txtBpCd" SIZE=10 MAXLENGTH=10 STYLE="TEXT-ALIGN: Left" tag="11NXXU" ALT="수금처"><IMG SRC="../../../CShared/image/btnPopup.gif" NAME="btnBizCd" ALIGN=top TYPE="BUTTON" ONCLICK="vbscript:CALL OpenBp(txtBpCd.Value, 1)"> <INPUT TYPE=TEXT NAME="txtBpNm" SIZE=20 MAXLENGTH=20 STYLE="TEXT-ALIGN: Left" tag="14" ALT="수금처명"></TD>
						<TD CLASS=TD5 NOWRAP>사업장</TD>
						<TD CLASS=TD6 NOWRAP><INPUT TYPE=TEXT NAME="txtBizCd" SIZE=10 MAXLENGTH=10 STYLE="TEXT-ALIGN: Left" tag=11NXXU" ALT="사업장"><IMG SRC="../../../CShared/image/btnPopup.gif" NAME="btnCostCd" ALIGN=top TYPE="BUTTON" ONCLICK="vbscript:OpenBizCd()"> <INPUT TYPE=TEXT NAME="txtBizNm" SIZE=20 MAXLENGTH=20 STYLE="TEXT-ALIGN: left" tag="14" ALT="사업장명">					
					...
					<TR ID="DetailCondition" style="display: none">
						...
						<TD CLASS=TD6 NOWRAP><INPUT TYPE=TEXT NAME="txtRcptNo" MAXLENGTH=18 STYLE="TEXT-ALIGN: Left" tag=11NXXU" ALT="가수금번호"><IMG SRC="../../../CShared/image/btnPopup.gif" NAME="btnrcpt" ALIGN=top TYPE="BUTTON" ONCLICK="vbscript:OpenRcpt()"></TD>
						<TD CLASS=TD5 NOWRAP>비고</TD>
						<TD CLASS=TD6 NOWRAP><INPUT TYPE=TEXT NAME="txtremark" SIZE=30 MAXLENGTH=100 STYLE="TEXT-ALIGN: Left" tag=11NXXU" ALT="비고"></TD>					
					</TR> 
				</TABLE>
			</FIELDSET>
		</TD>
