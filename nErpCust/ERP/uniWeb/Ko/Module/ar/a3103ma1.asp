...
*  4. Program Name         : 채권승인 
*  5. Program Desc         : 채권승인 및 미승인 조회 및 저장 처리 
*  6. Comproxy List        :
...
Const BIZ_PGM_ID1 = "a3103mb2.asp"												'☆: 비지니스 로직 ASP명 
Const BIZ_PGM_ID = "a3103mb1.asp"												'☆: 비지니스 로직 ASP명 
...
Sub  InitSpreadSheet()
    ...
    With frm1.vspdData
		...
		ggoSpread.SSSetDate   C_AR_DT      , "채권일자"    ,10, 2, parent.gDateFormat  
		ggoSpread.SSSetDate   C_GL_DT      , "전표일자"    ,10, 2, parent.gDateFormat  
		ggoSpread.SSSetEdit   C_AR_NO      , "채권번호"    ,20,3
		ggoSpread.SSSetEdit   C_BP_NM      , "거래처"      ,12,3        
		ggoSpread.SSSetEdit   C_DOC_CUR    , "통화"        ,12,3        
		ggoSpread.SSSetFloat  C_AR_AMT     , "채권액"      ,15, "A"  ,ggStrIntegeralPart, ggStrDeciPointPart,parent.gComNum1000,parent.gComNumDec
		ggoSpread.SSSetFloat  C_AR_LOC_AMT , "채권액(자국)",15, parent.ggAmtOfMoneyNo  ,ggStrIntegeralPart, ggStrDeciPointPart,parent.gComNum1000,parent.gComNumDec
...
Sub SetSpreadLock()
    ...
    With frm1
		...
		ggoSpread.SpreadLock   C_AR_DT		,-1 ,C_AR_DT							'승인체크박스부터 전표일전까지 Locking
		ggoSpread.SpreadUnLock C_GL_DT		,-1 , C_GL_DT							'전표일 UnLocking
		ggoSpread.SpreadLock   C_AR_NO		,-1									'전표일다음부터 끝까지 Locking
	...
	With frm1
		For lRow = 1 To .vspdData.MaxRows
			...
			If Trim(.vspdData.Text) = "1" Then
				...
				If CompareDateByFormat(.vspdData.text,GLDT,"채권일자","전표일", _
						...
						<FIELDSET CLASS="CLSFLD">
							<TABLE <%=LR_SPACE_TYPE_40%>>
								<TR>
									...
									<TD CLASS="TD6"NOWRAP>
										<SCRIPT LANGUAGE=JavaScript> ExternalWrite('<OBJECT CLASSID=<%=gCLSIDFPDT%> NAME="txtFromReqDt" CLASS=FPDTYYYYMMDD tag="12" Title="FPDATETIME" ALT="채권일자" id=fpDateTime1></OBJECT>');</SCRIPT>~ 
										<SCRIPT LANGUAGE=JavaScript> ExternalWrite('<OBJECT CLASSID=<%=gCLSIDFPDT%> NAME="txtToReqDt" CLASS=FPDTYYYYMMDD tag="12" Title="FPDATETIME" ALT="채권일자" id=fpDateTime2></OBJECT>');</SCRIPT>										
									</TD>
								...
								<TR>
									...
									<TD CLASS="TD6"NOWRAP><SELECT NAME="cboConfFg" tag="12" STYLE="WIDTH:82px:" Alt="승인상태"></SELECT> 
								...
								<TR>
									...
									<TD CLASS=TD6 NOWRAP><INPUT NAME=txtProject ALT="프로젝트" MAXLENGTH=25 SIZE=25 tag="11"></TD>
								</TR>
					...
					<TD WIDTH=100% HEIGHT=* valign=top>
						<TABLE <%=LR_SPACE_TYPE_20%>>
							...
							<TR>
								...
								<TD class=TD6 NOWRAP>
									<SCRIPT LANGUAGE=JavaScript> ExternalWrite('<OBJECT CLASSID=<%=gCLSIDFPDS%> name="txtTotArLocAmt" CLASS=FPDS140 title=FPDOUBLESINGLE ALT="채권액(자국)" tag="24X2" id=OBJECT22></OBJECT>');</SCRIPT></TD>
							</TR>														
						</TABLE>
					</TD>
				</TR>
