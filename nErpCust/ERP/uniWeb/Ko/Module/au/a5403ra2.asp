...
Const BIZ_PGM_ID 		= "a5403rb2.asp"                              '☆: Biz Logic ASP Name
...
Sub InitSpreadSheet()
	...
	Call SetZAdoSpreadSheet("A5403RA2", "S", "A", "V20021210", PopupParent.C_SORT_DBAGENT, frm1.vspdData, C_MaxKey, "X", "X")
	Call SetSpreadLock() 
End Sub
...
<TABLE <%=LR_SPACE_TYPE_20%>>
	...
	<TR>
		<TD WIDTH=100% HEIGHT=50><IFRAME NAME="MyBizASP" SRC="../../blank.htm" WIDTH=100% HEIGHT=<%=BizSize%> FRAMEBORDER=0 SCROLLING=YES noresize framespacing=0></IFRAME></TD>  
			<!--TD WIDTH=100% HEIGHT=80%><IFRAME NAME="MyBizASP" SRC="../../blank.htm" WIDTH=100% HEIGHT=80% FRAMEBORDER=1 SCROLLING=yes resize framespacing=0></IFRAME></TD-->  
	</TR>
</TABLE>
