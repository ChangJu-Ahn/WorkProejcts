...
'========================================================================================================
Const BIZ_PGM_ID  = "D1313MB1.asp"
Const BIZ_PGM_ID2 = "D1313MB2.asp"
Const BIZ_PGM_ID3 = "D1313MB3.asp"
Const BIZ_PGM_ID4 = "D1313MB4.asp"
'==========================================  1.2.1 Global 상수 선언  ======================================
...
Sub GetSpreadColumnPos(ByVal pvSpdNo)
    ...
    Select Case UCase(pvSpdNo)
        Case "A"
            ...
            C1_name             = iCurColumnPos(43)
            C1_name_B           = iCurColumnPos(44)
            C1_email            = iCurColumnPos(45)
            C1_bp_seq           = iCurColumnPos(46)
            C1_name2            = iCurColumnPos(47)
            C1_name2_B          = iCurColumnPos(48)
            C1_email2           = iCurColumnPos(49)
            C1_bp_seq2          = iCurColumnPos(50)
                            ...
                            <TD CLASS="CLSMTABP">
                                <TABLE ID="MyTab" CELLSPACING=0 CELLPADDING=0>
                                    <TR>
                                        ...
                                        <td background="../../../CShared/image/table/seltab_up_bg.gif" align="center" CLASS="CLSMTAB"><font color=white>매입수정역발행등록</font></td>
