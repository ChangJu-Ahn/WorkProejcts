...
Sub SubBizQuery()
	...
	If E3_b_biz_partner_ftn(EG1_E1_b_biz_partner_ftn_partner_ftn)   = "MGS" Then 
	   Response.Write ".rdoParttype21.checked = True " & vbCr
	elseif	E3_b_biz_partner_ftn(EG1_E1_b_biz_partner_ftn_partner_ftn)   = "MBI" Then    
	   Response.Write ".rdoParttype22.checked = True " & vbCr
	elseif	E3_b_biz_partner_ftn(EG1_E1_b_biz_partner_ftn_partner_ftn)   = "MPA" Then    	   
...
Sub SubBizSave()
	...
	If CheckSYSTEMError(Err,True) = True Then
       Set iB1H021 = Nothing		                                                 '☜: Unload Comproxy DLL
       Exit Sub
    End If  
