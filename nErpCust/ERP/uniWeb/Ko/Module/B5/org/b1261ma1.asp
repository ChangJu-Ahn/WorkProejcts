					...
					<TD WIDTH=100% VALIGN=TOP>
						...
						<TABLE <%=LR_SPACE_TYPE_60%>>
							...
							<TR>
								...
								<TD CLASS=TD5 NOWRAP>거래처별칭</TD>
								<TD CLASS=TD6 NOWRAP><INPUT NAME="txtBp_alias_nm" TYPE="Text" ALT="거래처별칭" MAXLENGTH="80" SIZE=40 tag="21XXX"></TD>
							</TR>
							<TR>
						...
						<TABLE <%=LR_SPACE_TYPE_60%>>
							...
							<TR>							
								...
								<TD CLASS=TD6 NOWRAP>
									<input type=radio CLASS="RADIO" name="rdoSoldInspect" id="rdoSoldInspectA" value="A" tag = "21" >
										<label for="rdoSoldInspectA">입고후검사</label>&nbsp;&nbsp;&nbsp;&nbsp;
									<input type=radio CLASS = "RADIO" name="rdoSoldInspect" id="rdoSoldInspectB" value="B" tag = "21" checked>
