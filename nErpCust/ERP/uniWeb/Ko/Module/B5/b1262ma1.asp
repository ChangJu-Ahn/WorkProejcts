...
'*  1. Module Name          : Sales
'*  2. Function Name        : 
'*  3. Program ID           : B1262MA1
'*  4. Program Name         : 매출처형태등록                    
'*  5. Program Desc         : 매출처형태등록                 
...
Function OpenBp_cd(Byval strCode, Byval iWhere)
 ...
 Select Case iWhere
 Case 0
  arrParam(0) = "계약처"      <%' 팝업 명칭 %>

  arrParam(2) = Trim(frm1.txtBp_cd1.Value)		<%' Code Condition%>
  arrParam(3) = ""								<%' Name Cindition%>
 
  arrParam(5) = "계약처"		<%' TextBox 명칭 %>

  arrHeader(0) = "계약처"		<%' Header명(0)%>
  arrHeader(1) = "계약처명"     <%' Header명(1)%>
 ...
 arrParam(4) = "BP_TYPE IN (" & FilterVar("S", "''", "S") & " ," & FilterVar("CS", "''", "S") & " )"		<%' Where Condition%>
...
<%  '-----------------------
 ...
 If frm1.rdoParttype1.checked = True Then 
  frm1.txtRadioType.value = "MGS"
 ElseIf frm1.rdoParttype2.checked = True Then
  frm1.txtRadioType.value = "MBI"
 ElseIf frm1.rdoParttype3.checked = True Then
  frm1.txtRadioType.value = "MPA"
 Else
  'Msgbox "거래처형태의 선택버튼을 다시 확인하시오!"
  Exit Function
 End IF
...
Function DbDelete() 
    ...
    strVal = strVal & "&txtBp_cd2=" & Trim(frm1.txtBp_cd2.value)
    strVal = strVal & "&txtPartner_cd2=" & Trim(frm1.txtPartner_cd2.value) 
    strVal = strVal & "&txtRadioType=" & Trim(frm1.txtRadioType.value)  
...
Function DbSaveOk()               <%'☆: 저장 성공후 실행 로직 %>
	...
	If frm1.txtRadioType.value = "MGS" Then
	 frm1.rdoParttype1.checked = True
	ElseIf frm1.txtRadioType.value = "MBI" Then
	 frm1.rdoParttype2.checked = True
	ElseIf frm1.txtRadioType.value = "MPA" Then
	 frm1.rdoParttype3.checked = True
	End If
     ...
     <TD CLASS="CLSMTABP">
      <TABLE ID="MyTab" CELLSPACING=0 CELLPADDING=0>
       <TR>
        ...
        <td background="../../../CShared/image/table/seltab_up_bg.gif" align="center" CLASS="CLSMTAB"><font color=white>매입거래처형태등록</font></td>
     ...
     <TD HEIGHT=20 WIDTH=100%>
      <FIELDSET CLASS="CLSFLD">
       <TABLE <%=LR_SPACE_TYPE_40%>>
        <TR>
         <TD CLASS="TD5" NOWRAP>계약처</TD>
         <TD CLASS="TD6"><INPUT NAME="txtBp_cd1" ALT="계약처" TYPE="Text" MAXLENGTH=10 SiZE=10 tag="12XXXU"><IMG SRC="../../../CShared/image/btnPopup.gif" NAME="btnBp_Cd" align=top TYPE="BUTTON" ONCLICK="vbscript:OpenBp_cd frm1.txtBp_cd1.value,0">&nbsp;<INPUT NAME="txtBp_nm1" TYPE="Text" MAXLENGTH="20" SIZE=25 tag="14"></TD>
         <TD CLASS="TD5" NOWRAP>파트너거래처</TD>
         <TD CLASS="TD6"><INPUT NAME="txtPartner_cd1" ALT="파트너거래처" TYPE="Text" MAXLENGTH=10 SiZE=10 tag="12XXXU"><IMG SRC="../../../CShared/image/btnPopup.gif" NAME="btnPartner_Cd" align=top TYPE="BUTTON" ONCLICK="vbscript:OpenBp_cd frm1.txtPartner_cd1.value,2">&nbsp;<INPUT NAME="txtPartner_nm1" TYPE="Text" MAXLENGTH="20" SIZE=25 tag="14"></TD>
        </TR>
        <TR>
         <TD CLASS="TD5" NOWRAP>거래처형태</TD>
         <TD CLASS="TD6">
          <input type=radio CLASS="RADIO" name="rdoParttype" id="rdoParttype1" value="MGS" tag = "11" checked>
           <label for="rdoParttype1">공급처</label>&nbsp;&nbsp;&nbsp;&nbsp;
          <input type=radio CLASS="RADIO" name="rdoParttype" id="rdoParttype2" value="MBI" tag = "11">
           <label for="rdoParttype2">세금계산서발행처</label>&nbsp;&nbsp;&nbsp;&nbsp;
          <input type=radio CLASS = "RADIO" name="rdoParttype" id="rdoParttype3" value="MPA" tag = "11">
           <label for="rdoParttype3">지급처</label></TD>
         <TD CLASS="TD5"></TD>
         <TD CLASS="TD6"></TD>
        </TR>
       </TABLE>
    ...
    <TR>
     <TD WIDTH=100% VALIGN=TOP>
      <TABLE <%=LR_SPACE_TYPE_60%>>
       <TR>
        <TD CLASS=TD5 NOWRAP>계약처</TD>
        <TD CLASS=TD656 NOWRAP><INPUT NAME="txtBp_cd2" ALT="계약처" TYPE="Text" MAXLENGTH=10 SiZE=10 tag="23XXXU"><IMG SRC="../../../CShared/image/btnPopup.gif" NAME="btnBp_Cd" align=top TYPE="BUTTON" ONCLICK="vbscript:OpenBp_cd frm1.txtBp_cd2.value,1">&nbsp;<INPUT NAME="txtBp_nm2" TYPE="Text" MAXLENGTH="20" SIZE=25 tag="24"></TD>
       </TR>
       <TR>
        <TD CLASS=TD5 NOWRAP>거래처형태</TD>
        <TD CLASS=TD656 NOWRAP>
         <input type=radio CLASS="RADIO" name="rdoParttype_2" id="rdoParttype21" value="MGS" tag = "23" checked>
          <label for="rdoParttype21">공급처</label>&nbsp;&nbsp;&nbsp;&nbsp;
         <input type=radio CLASS="RADIO" name="rdoParttype_2" id="rdoParttype22" value="MBI" tag = "23">
          <label for="rdoParttype22">세금계산서발행처</label>&nbsp;&nbsp;&nbsp;&nbsp;
         <input type=radio CLASS = "RADIO" name="rdoParttype_2" id="rdoParttype23" value="MPA" tag = "23">
          <label for="rdoParttype23">지급처</label></TD>
       </TR>
       <TR>
        <TD CLASS=TD5 NOWRAP>파트너거래처</TD>
        <TD CLASS=TD656 NOWRAP><INPUT NAME="txtPartner_cd2" ALT="파트너거래처" TYPE="Text" MAXLENGTH=10 SiZE=10 tag="23XXXU"><IMG SRC="../../../CShared/image/btnPopup.gif" NAME="btnPartner_Cd" align=top TYPE="BUTTON" ONCLICK="vbscript:OpenBp_cd frm1.txtPartner_cd2.value,3">&nbsp;<INPUT NAME="txtPartner_nm2" TYPE="Text" MAXLENGTH="20" SIZE=25 tag="24"></TD>
       </TR>
       <TR>
