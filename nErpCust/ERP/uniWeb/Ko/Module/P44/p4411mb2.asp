...
With parent																	'☜: 화면 처리 ASP 를 지칭함 
	...
	.frm1.vspdData1.Col = .C_CurrencyCode
	strCurrencyCode = .frm1.vspdData1.Text
...
%>
		...
		Call .ReFormatSpreadCellByCellByCurrency2(.Frm1.vspdData2, LngMaxRow + 1, LngMaxRow + <%=i%>, strCurrencyCode, .C_SubcontractPrice1, "C", "I", "X", "X")
		Call .ReFormatSpreadCellByCellByCurrency2(.Frm1.vspdData2, LngMaxRow + 1, LngMaxRow + <%=i%>, strCurrencyCode,.C_SubcontractAmt1, "A", "I", "X", "X")
		Call .ReFormatSpreadCellByCellByCurrency2(.Frm1.vspdData3, LngMaxRows + 1, LngMaxRows + <%=i%>, strCurrencyCode,.C_SubcontractPrice2, "C", "I", "X", "X")
		Call .ReFormatSpreadCellByCellByCurrency2(.Frm1.vspdData3, LngMaxRows + 1, LngMaxRows + <%=i%>, strCurrencyCode,.C_SubcontractAmt2, "A", "I", "X", "X")						
<%	
	End If
