...
'Grid 1 - Order Header
Const BIZ_PGM_QRY1_ID	= "p4416mb1.asp"								'☆: Head Query 비지니스 로직 ASP명 
'Grid 2 - Production Results
Const BIZ_PGM_QRY2_ID	= "p4416mb2.asp"								'☆: 비지니스 로직 ASP명 
...
Sub InitSpreadSheet(ByVal pvSpdNo)
	...
	If pvSpdNo = "B" Or pvSpdNo = "*" Then	
		...
		With frm1.vspdData2
			...
			ggoSpread.SSSetCombo	C_ReasonDesc, "불량이유", 15
			...
			ggoSpread.SSSetEdit		C_InspReqNo, "검사의뢰번호", 18
			ggoSpread.SSSetEdit		C_ProdtOrderNo1, "", 18
			ggoSpread.SSSetFloat	C_Sequence, "순번", 10, "7", ggStrIntegeralPart, ggStrDeciPointPart, parent.gComNum1000, parent.gComNumDec, , ,"Z"
...
Dim iCurColumnPos
	...
	With frm1 
	    ...
	    If lRow > 0 Then
            ...
            For iCols = 1 To 19 'vspdData2 의 데이타만 변경한다.
                .vspdData2.Col = iCols
                .vspdData3.Col = iCols
                .vspdData3.Text = .vspdData2.Text
            Next
