...
'*  2. Function Name		: 																			*
'*  3. Program ID			: p4420ra5																	*
'*  4. Program Name			: 제품생산월보(Tracking No.별상세)											*
'*  5. Program Desc			: Reference Popup															*
'*  6. Comproxy List        : ADO : p4420ra5															*
...
'============================================  1.2.1 Global 상수 선언  ==================================
'========================================================================================================
Const BIZ_PGM_ID = "p4420rb5.asp"					 '☆: 비지니스 로직 ASP명 
...
Sub GetSpreadColumnPos(ByVal pvSpdNo)
    ...
    Select Case UCase(pvSpdNo)
       Case "A"
			...
			C_ProdQty		= iCurColumnPos(2)
			C_GoodQty		= iCurColumnPos(3)
			C_BadQty		= iCurColumnPos(4)
...
Sub Form_Load()
	...
	Call ggoOper.FormatDate(frm1.txtWorkDt, PopupParent.gDateFormat, "2")
	Call InitVariables
					...
					<TD CLASS="CLSMTABP">
						<TABLE ID="MyTab" CELLSPACING=0 CELLPADDING=0>
							<TR>
								...
								<td background="../../../CShared/image/table/seltab_up_bg.gif" align="center" CLASS="CLSMTAB"><font color=white>Tracking No.별상세내역</font></td>
			...
			<FIELDSET CLASS="CLSFLD">
				<TABLE WIDTH=100% CELLSPACING=0 CELLPADDING=0>
 					<TR>
						...
						<TD CLASS=TD6 NOWRAP><INPUT TYPE=TEXT NAME="txtItemCd" SIZE=20 MAXLENGTH=18 tag="14" ALT="품목">&nbsp;<INPUT TYPE=TEXT NAME="txtItemNm" SIZE=30 tag="14" ALT="품목명"></TD>
						<TD CLASS=TD5 NOWRAP>작업년월</TD> 
						<TD CLASS=TD6 NOWRAP>
							<script language =javascript src='./js/p4420ra5_I499945580_txtWorkDt.js'></script>
						</TD>
					</TR>
				</TABLE>
			</FIELDSET>
	...
	<TR>
		<TD WIDTH=100% HEIGHT=* valign=top>
			<TABLE WIDTH="100%" HEIGHT="100%">
				<TR HEIGHT="100%">
					<TD WIDTH="100%">
						<script language =javascript src='./js/p4420ra5_fpSpread1_vspdData.js'></script>
					</TD>
				</TR>
			</TABLE>
		</TD>
