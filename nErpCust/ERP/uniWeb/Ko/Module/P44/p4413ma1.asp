...
'*  2. Function Name        : Confirm Production Results By Order (Single - Upper Grid)
'*  3. Program ID           : p4413ma1
'*  4. Program Name         : Confirm Production Results By Order (Single)
'*  5. Program Desc         : Confirm Production Results By Order (Single)
...
<SCRIPT LANGUAGE="VBScript"   SRC = "p4413ma1.vbs"></SCRIPT>
					...
					<TD CLASS="CLSMTABP">
						<TABLE ID="MyTab" CELLSPACING=0 CELLPADDING=0>
							<TR>
								...
								<td background="../../../CShared/image/table/seltab_up_bg.gif" align="center" CLASS="CLSMTAB"><font color=white>오더별실적등록(Single)</font></td>
						...
						<FIELDSET CLASS="CLSFLD">
							<TABLE <%=LR_SPACE_TYPE_40%>>
								<TR>
									...
									<TD CLASS="TD6">
										<script language =javascript src='./js/p4413ma1_I735172897_txtProdFromDt.js'></script>
										&nbsp;~&nbsp;
										<script language =javascript src='./js/p4413ma1_I698962593_txtProdTODt.js'></script>
									</TD>																						
								</TR>
								<TR>
						...
						<FIELDSET CLASS="CLSFLD">
							<TABLE WIDTH=100% CELLSPACING=0 CELLPADDING=0>
								<TR>
									...
									<TD CLASS=TD6 NOWRAP>
										<script language =javascript src='./js/p4413ma1_fpDateTime1_txtReportDT.js'></script>
									</TD>
									<TR>
						...
						<TABLE <%=LR_SPACE_TYPE_20%>>
							<TR HEIGHT="50%">
								<TD WIDTH="100%" colspan=4>
									<script language =javascript src='./js/p4413ma1_A_vspdData1.js'></script>
								</TD>
							</TR>
							<TR HEIGHT="50%">
								<TD WIDTH="100%" colspan=4>
									<script language =javascript src='./js/p4413ma1_B_vspdData2.js'></script>
								</TD>
							</TR>
						</TABLE>
					</TD>
...
<script language =javascript src='./js/p4413ma1_C_vspdData3.js'></script>
<P ID="divTextArea"></P>
</FORM>
