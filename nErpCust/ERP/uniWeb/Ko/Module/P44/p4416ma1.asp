...
'*  2. Function Name        : Confirm Production Results By Order (Multi)
'*  3. Program ID           : p4416ma1
'*  4. Program Name         : Confirm Production Results By Order (Multi)
'*  5. Program Desc         : Confirm Production Results By Order (Multi)
'*  6. Comproxy List        : 
...
<SCRIPT LANGUAGE="VBScript"   SRC = "p4416ma1.vbs"></SCRIPT>
					...
					<TD CLASS="CLSMTABP">
						<TABLE ID="MyTab" CELLSPACING=0 CELLPADDING=0>
							<TR>
								...
								<td background="../../../CShared/image/table/seltab_up_bg.gif" align="center" CLASS="CLSMTAB"><font color=white>오더별실적등록(Multi)</font></td>
						...
						<FIELDSET CLASS="CLSFLD">
							<TABLE <%=LR_SPACE_TYPE_40%>>
								<TR>
									...
									<TD CLASS="TD6">
										<script language =javascript src='./js/p4416ma1_I714948344_txtProdFromDt.js'></script>
										&nbsp;~&nbsp;
										<script language =javascript src='./js/p4416ma1_I699595969_txtProdTODt.js'></script>
									</TD>																						
								</TR>
								<TR>
								...
								<TR>
									...
									<TD CLASS=TD6 NOWRAP><INPUT TYPE=TEXT NAME="txtItemGroupCd" SIZE=18 MAXLENGTH=10 tag="11xxxU" ALT="품목그룹"><IMG SRC="../../../CShared/image/btnPopup.gif" NAME="btnItemCd" align=top TYPE="BUTTON"ONCLICK="vbscript:OpenItemGroupInfo">&nbsp;<INPUT TYPE=TEXT NAME="txtItemGroupNm" SIZE=25 tag="14"></TD>
						...
						<FIELDSET CLASS="CLSFLD">
							<TABLE WIDTH=100% CELLSPACING=0 CELLPADDING=0>
								<TR>
									...
									<TD CLASS=TD6 NOWRAP>
										<script language =javascript src='./js/p4416ma1_I591130387_txtReportDT.js'></script>
									</TD>
						...
						<TABLE <%=LR_SPACE_TYPE_20%>>
							<TR HEIGHT="30%">
								<TD WIDTH="100%" colspan=4>
									<script language =javascript src='./js/p4416ma1_A_vspdData1.js'></script>
								</TD>
							</TR>
							<TR HEIGHT="30%">
								<TD WIDTH="100%" colspan=4>
									<script language =javascript src='./js/p4416ma1_B_vspdData2.js'></script>
								</TD>
							</TR>
						</TABLE>
					</TD>
...
<script language =javascript src='./js/p4416ma1_C_vspdData3.js'></script>
<P ID="divTextArea"></P>
</FORM>
