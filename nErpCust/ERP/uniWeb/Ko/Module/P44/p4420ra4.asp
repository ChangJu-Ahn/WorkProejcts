...
'*  2. Function Name		: 																			*
'*  3. Program ID			: p4420ra4																	*
'*  4. Program Name			: 제품생산월보(오더별상세내역)													*
...
'============================================  1.2.1 Global 상수 선언  ==================================
'========================================================================================================
Const BIZ_PGM_ID = "p4420rb4.asp"					<% '☆: 비지니스 로직 ASP명 %>
...
Sub InitSpreadSheet()
    ...
    ggoSpread.SSSetDate 	C_RePortDt,      "생산일자"	,12, 2, PopupParent.gDateFormat
					...
					<TD CLASS="CLSMTABP">
						<TABLE ID="MyTab" CELLSPACING=0 CELLPADDING=0>
							<TR>
								...
								<td background="../../../CShared/image/table/seltab_up_bg.gif" align="center" CLASS="CLSMTAB"><font color=white>오더별상세내역</font></td>
			...
			<FIELDSET CLASS="CLSFLD">
				<TABLE WIDTH=100% CELLSPACING=0 CELLPADDING=0>
 					<TR>
						...
						<TD CLASS=TD6 NOWRAP>
							<script language =javascript src='./js/p4420ra4_I339170593_txtWorkDt.js'></script>
						</TD>
					</TR>
				</TABLE>
			</FIELDSET>
	...
	<TR>
		<TD WIDTH=100% HEIGHT=* valign=top>
			<TABLE WIDTH="100%" HEIGHT="100%">
				<TR HEIGHT="100%">
					<TD WIDTH="100%">
						<script language =javascript src='./js/p4420ra4_fpSpread1_vspdData.js'></script>
					</TD>
				</TR>
			</TABLE>
		</TD>
