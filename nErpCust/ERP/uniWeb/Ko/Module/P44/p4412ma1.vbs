...
'Grid 1 - Order Header
Const BIZ_PGM_QRY1_ID	= "p4412mb1.asp"						'☆: Head Query 비지니스 로직 ASP명 
'Grid 2 - Production Results
Const BIZ_PGM_QRY2_ID	= "p4412mb2.asp"						'☆: 비지니스 로직 ASP명 
...
Sub GetSpreadColumnPos(ByVal pvSpdNo)
    ...
    Select Case UCase(pvSpdNo)
		Case "A"
			...
			C_JobCd						= iCurColumnPos(29)
			C_JobDesc					= iCurColumnPos(30)
			C_RoutOrder					= iCurColumnPos(31)
			C_OrderStatus				= iCurColumnPos(32)
			C_OrderStatusNm				= iCurColumnPos(33)
			C_MilestoneFlg				= iCurColumnPos(34)
			C_InsideFlag				= iCurColumnPos(35)
			C_InsideFlagNm				= iCurColumnPos(36)
			C_TrackingNo				= iCurColumnPos(37)
			C_ProdtOrderType			= iCurColumnPos(38)
			C_AutoRcptFlg				= iCurColumnPos(39)
			C_LotReq					= iCurColumnPos(40)
			C_LotGenMthd				= iCurColumnPos(41)
			C_ProdInspReq				= iCurColumnPos(42)
			C_FinalInspReq				= iCurColumnPos(43)
			C_ItemGroupCd				= iCurColumnPos(44)
			C_ItemGroupNm				= iCurColumnPos(45)
			C_ParentOrderNo				= iCurColumnPos(46)
			C_ParentOprNo				= iCurColumnPos(47)
			C_OrginalOrderNo			= iCurColumnPos(48)
			C_OrginalOprNo				= iCurColumnPos(49)
			C_ReworkPrevQty				= iCurColumnPos(50)
		...
		Case "B"
			...
			' Hidden
			 ...
			 C_ProdInspReq1				= iCurColumnPos(23)
			 C_FinalInspReq1			= iCurColumnPos(24)
			 C_RoutOrder1				= iCurColumnPos(25)
