...
Sub initSpreadPosVariables()
    ...
    C_Report_Dt                   = 7 
    C_Report_Type                 = 8 
    C_Prod_Qty_In_Order_Unit      = 9 
    C_Insp_Good_Qty_In_Order_Unit = 10
    C_Insp_Bad_Qty_In_Order_Unit  = 11
    C_Rcpt_Qty_In_Order_Unit      = 12
    C_Remark                      = 13
    C_Cur_Cd                      = 14
    C_Seq                         = 15
    C_Opr_No                      = 16
...
Sub MakeKeyStream(pRow)
    ...
    lgKeyStream = lgKeyStream & frm1.hCostCd.value & Parent.gColSep    
End Sub
...
Sub InitSpreadSheet()
    ...
    With frm1.vspdData
        ...
        ggoSpread.SSSetEdit     C_Wc_CD                      , "작업장코드"      , 20
        ...
        ggoSpread.SSSetEdit     C_Lot_No                     , "Lot No"      , 15
...
Sub SetSpreadLock()
    With frm1
        ...
        ggoSpread.SpreadLock     C_Wc_CD                      , -1, C_Wc_CD
        ...
        ggoSpread.SpreadLock     C_Lot_No                    , -1, C_Lot_No
...
Sub GetSpreadColumnPos(ByVal pvSpdNo)
    ...
    Select Case UCase(pvSpdNo)
        Case "A"
            ...
            C_Wc_CD                       = iCurColumnPos(2)
            C_Wc_Nm                       = iCurColumnPos(3) 
            C_Prodt_Order_No              = iCurColumnPos(4) 
            C_Item_Cd                     = iCurColumnPos(5) 
            C_Item_Nm                     = iCurColumnPos(6) 
            C_Report_Dt                   = iCurColumnPos(7) 
            C_Report_Type                 = iCurColumnPos(8) 
            C_Prod_Qty_In_Order_Unit      = iCurColumnPos(9) 
            C_Insp_Good_Qty_In_Order_Unit = iCurColumnPos(10)
            C_Insp_Bad_Qty_In_Order_Unit  = iCurColumnPos(11)
            C_Rcpt_Qty_In_Order_Unit      = iCurColumnPos(12)
            C_Remark                      = iCurColumnPos(13)
            C_Cur_Cd                      = iCurColumnPos(14)
            C_Seq                         = iCurColumnPos(15)
            C_Opr_No                      = iCurColumnPos(16)
            C_Inst_Dt                     = iCurColumnPos(17)
            C_Lot_No                      = iCurColumnPos(18)
            C_Report_Type_Cd              = iCurColumnPos(19)
    End Select
End Sub
...
Function FncQuery()
    ...
    frm1.hCostCd.value = Trim(frm1.txtCostCd.value)
                        ...
                        <FIELDSET CLASS="CLSFLD">
                            <TABLE <%=LR_SPACE_TYPE_40%>>
                                ...
                                <TR>
									...
									<TD CLASS=TD6 NOWRAP><INPUT TYPE=TEXT NAME="txtCostCd" SIZE=17 MAXLENGTH=10 tag="11xxxU" ALT="Cost Center"><IMG SRC="../../../CShared/image/btnPopup.gif" NAME="btnCostCtr" align=top TYPE="BUTTON" ONCLICK="vbscript:OpenCostCtr()">&nbsp;<INPUT NAME="txtCostNm" MAXLENGTH="20" SIZE=30 ALT ="코스트센타명" tag="x4"></TD>
                                </TR>                                
