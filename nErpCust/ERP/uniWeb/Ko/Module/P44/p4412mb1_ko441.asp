...
Err.Clear																	'☜: Protect system from crashing
	...
	UNISqlId(0) = "P4412MB1HKO441"      '2008-03-25 2:44오후 :: hanc
...
%>				
				...
				strData = strData & Chr(11) & ""		'입력부 - Lot Sub No.
				...
				strData = strData & Chr(11) & "<%=ConvSPChars(rs0("STATUS_NM"))%>"												'지시 
