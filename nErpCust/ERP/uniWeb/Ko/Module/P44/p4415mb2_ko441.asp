...
Err.Clear																	'☜: Protect system from crashing
	...
	UNISqlId(0) = "P4412MB2KO441"       '20080310::hanc
...
%>
			...
			strData = strData & Chr(11) & "<%=UniConvNumberDBToCompany(rs0("batch_cnt"),ggQty.DecPoint, ggQty.RndPolicy, ggQty.RndUnit, 0)%>"      '20080310::hanc
