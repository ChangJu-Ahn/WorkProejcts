...
'Grid 1 - Order Header
Const BIZ_PGM_QRY1_ID	= "p4415mb1.asp"						'☆: Head Query 비지니스 로직 ASP명 
'Grid 2 - Production Results
Const BIZ_PGM_QRY2_ID	= "p4415mb2.asp"						'☆: 비지니스 로직 ASP명 
'Post Production Results
Const BIZ_PGM_SAVE_ID	= "p4415mb3.asp"						
'Shift Header
Const BIZ_PGM_SHIFT		= "p4415mb5.asp"						'☆: 비지니스 로직 ASP명 
...
'			ggoSpread.SSSetFloat	C_ProdQty, "실적수량",15,parent.ggQtyNo ,ggStrIntegeralPart, ggStrDeciPointPart,parent.gComNum1000,parent.gComNumDec,,,"Z", -1000000000000000           '2008-03-21 2:06오후 :: hanc min수량 추가
			ggoSpread.SSSetFloat	C_ProdQty, "실적수량",15    ,"A"   ,     ggStrIntegeralPart ,ggStrDeciPointPart,Parent.gComNum1000,Parent.gComNumDec,1,,"Z", -1000000000000000           '2008-03-21 2:06오후 :: hanc min수량 추가
...
'			ggoSpread.SSSetFloat	C_ProdQty2,		"실적수량",15,parent.ggQtyNo ,ggStrIntegeralPart, ggStrDeciPointPart,parent.gComNum1000,parent.gComNumDec,,,"Z", -1000000000000000           '2008-03-21 2:06오후 :: hanc min수량 추가
			ggoSpread.SSSetFloat	C_ProdQty2,     "실적수량",15    ,"A"   ,     ggStrIntegeralPart ,ggStrDeciPointPart,Parent.gComNum1000,Parent.gComNumDec,1,,"Z", -1000000000000000           '2008-03-21 2:06오후 :: hanc min수량 추가
