...
'	UNISqlId(0) = "p4418mb1d"
	UNISqlId(0) = "p4418mb1d_KO441"   '2008-05-26 11:19오후 :: hanc ::임시로 작업함 (이유 인터페이스로 넘어온데이터 (LOT_NO존재)는 화면ui에서 삭제못하게 함
...
%>
				...
				strData = strData & Chr(11) & "<%=ConvSPChars(rs2("LOT_NO_KO441"))%>"
