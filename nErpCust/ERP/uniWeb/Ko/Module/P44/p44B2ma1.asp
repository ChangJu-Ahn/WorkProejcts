...
'**********************************************************************************************************
Const BIZ_PGM_QRY_ID	= "p44B2mb1.asp"							'☆: 비지니스 로직(Qeury) ASP명 
...
Sub InitSpreadSheet(ByVal pvSpdNo)
	...
	If pvSpdNo = "A" Or pvSpdNo = "*" Then
		...
		With frm1.vspdData
			...
			ggoSpread.SSSetEdit		C_erp_apply_nm,		"반영여부", 8
			ggoSpread.SSSetEdit		C_err_desc,			"에러내역", 45
			ggoSpread.SSSetEdit		C_prodt_order_no,	"제조오더번호",18
			ggoSpread.SSSetEdit		C_opr_no,			"공정", 8
			ggoSpread.SSSetEdit		C_result_seq,		"실적순번", 8
			...
			ggoSpread.SSSetFloat	C_order_qty,		"오더수량", 15,parent.ggQtyNo,ggStrIntegeralPart, ggStrDeciPointPart,parent.gComNum1000,parent.gComNumDec,,,"Z"
			ggoSpread.SSSetFloat	C_order_qty,		"실적수량", 15,parent.ggQtyNo,ggStrIntegeralPart, ggStrDeciPointPart,parent.gComNum1000,parent.gComNumDec,,,"Z"
					...
					<TD CLASS="CLSMTABP">
						<TABLE ID="MyTab" CELLSPACING=0 CELLPADDING=0>
							<TR>
								...
								<td background="../../../CShared/image/table/seltab_up_bg.gif" align="center" CLASS="CLSMTAB"><font color=white>POP반영결과처리</font></td>
						...
						<FIELDSET CLASS="CLSFLD">
							<TABLE <%=LR_SPACE_TYPE_40%>>
								...
								<TR>
									...
									<TD CLASS=TD6 NOWRAP><INPUT TYPE="RADIO" CLASS="RADIO" NAME="rdoSchedIssueFlg" tag="11" ID="rdoApplyFlag1" VALUE="Y"><LABEL FOR="rdoSchedIssueFlg">성공</LABEL>
														<INPUT TYPE="RADIO" CLASS="RADIO" NAME="rdoSchedIssueFlg" tag="11" ID="rdoApplyFlag2" VALUE="N"><LABEL FOR="rdoSchedIssueFlg">실패</LABEL>
									...
									<TD CLASS=TD6 NOWRAP><INPUT TYPE=TEXT NAME="txtInfNo" SIZE=18 MAXLENGTH=18 tag="11xxxU" ALT="입력번호"><IMG SRC="../../../CShared/image/btnPopup.gif" NAME="btnInf" ALIGN=top TYPE="BUTTON" ONCLICK="vbscript:OpenInfNo()"></TD>
								</TR>
								<TR>
