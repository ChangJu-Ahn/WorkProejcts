...
Dim iTotalStr
Dim strCur
Dim strErrDesc, strTmpDesc1, strTmpDesc2
...
%>
			strTmpDesc1 = Replace("<%=ConvSPChars(rs0("err_desc"))%>", Chr(11), " ")
			strTmpDesc2 = Replace(strTmpDesc1, Chr(13), " ")
			strErrDesc = Replace(strTmpDesc2, Chr(10),  " ")
...
%>
		...
		'Call .ReFormatSpreadCellByCellByCurrency(.Frm1.vspdData1, LngMaxRow + 1, LngMaxRow + <%=i%>, .parent.gCurrency,.C_subcontract_prc, "C", "I", "X", "X")
		'Call .ReFormatSpreadCellByCellByCurrency(.Frm1.vspdData1, LngMaxRow + 1, LngMaxRow + <%=i%>, .parent.gCurrency,.C_subcontract_amt, "A", "I", "X", "X")
