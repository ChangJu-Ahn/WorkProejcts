...
'*  2. Function Name        : 
'*  3. Program ID           : p4413mb2.asp
'*  4. Program Name         : List Production Results
'*  5. Program Desc         : 
'*  6. Modified date(First) : ?
'*  7. Modified date(Last)  : 2003/03/25
...
%>
			...
			strData1 = ""
			strData1 = strData1 & Chr(11) & "<%=UNIDateClientFormat(rs0("report_dt"))%>"
			strData1 = strData1 & Chr(11) & Trim("<%=ConvSPChars(rs0("report_type"))%>")
			strData1 = strData1 & Chr(11) & Trim("<%=ConvSPChars(rs0("shift_cd"))%>")
			strData1 = strData1 & Chr(11) & "<%=UniNumClientFormat(rs0("prod_qty_in_order_unit"),ggQty.DecPoint,0)%>"
