...
'Grid 1 - Order Header
Const BIZ_PGM_QRY1_ID	= "p4415mb1_ko441.asp"						'☆: Head Query 비지니스 로직 ASP명 
'Grid 2 - Production Results
Const BIZ_PGM_QRY2_ID	= "p4415mb2_ko441.asp"						'☆: 비지니스 로직 ASP명 
'Post Production Results
Const BIZ_PGM_SAVE_ID	= "p4415mb3_ko441.asp"						
'Shift Header
Const BIZ_PGM_SHIFT		= "p4415mb5_ko441.asp"						'☆: 비지니스 로직 ASP명 
...
Dim C_Spec					
Dim C_ProdtOrderQty			
Dim C_batch_cnt_h       '20080314::hanc			
...
Sub InitSpreadSheet(ByVal pvSpdNo)
	...
	If pvSpdNo = "A" Or pvSpdNo = "*" Then
		...
		With frm1.vspdData1 
            ...
            '20080314::hanc
			ggoSpread.SSSetFloat	C_batch_cnt_h,"배치수",15,parent.ggQtyNo,ggStrIntegeralPart, ggStrDeciPointPart,parent.gComNum1000,parent.gComNumDec,,,"Z"
	...
	If pvSpdNo = "B" Or pvSpdNo = "*" Then
		...
		With frm1.vspdData2
			...
			ggoSpread.SSSetEdit		C_Remark1, "재작업", 10,,,120	
	...
	If pvSpdNo = "C" Or pvSpdNo = "*" Then
		...
		With frm1.vspdData3
			...
			ggoSpread.SSSetFloat	C_BatchCnt2,		"배치수",15,parent.ggQtyNo ,ggStrIntegeralPart, ggStrDeciPointPart,parent.gComNum1000,parent.gComNumDec,,,"Z"
...
Sub SetSpreadColor(ByVal pvStartRow, ByVal pvEndRow, ByVal strLotReq, ByVal strLotGenMthd, ByVal strProdInspReq, ByVal strFinalInspReq, ByVal strAutoRcptFlg, ByVal strInsideFlg, ByVal strRoutOrder)
    ...
    With frm1.vspdData2
		...
		ggoSpread.SpreadUnLock C_BatchCnt,pvStartRow,C_BatchCnt,pvEndRow      '20080310::hanc
		ggoSpread.SSSetRequired C_BatchCnt,					pvStartRow, pvEndRow
...
Sub InitSpreadPosVariables(ByVal pvSpdNo)
	...
	If pvSpdNo = "A" Or pvSpdNo = "*" Then
		 ...
		 C_Spec						= 5
		 C_ProdtOrderQty			= 6
         C_batch_cnt_h   			= 7     '20080314::hanc
		 C_ProdtOrderUnit			= 8 
		 C_ProdQtyInOrderUnit		= 9 
		 C_RemainQty				= 10
		 C_GoodQtyInOrderUnit		= 11
		 C_BadQtyInOrderUnit		= 12
		 C_InspGoodQtyInOrderUnit	= 13
		 C_InspBadQtyInOrderUnit	= 14
		 C_RcptQtyInOrderUnit		= 15
		 C_PlanStartDt				= 16
		 C_PlanComptDt				= 17
		 C_ReleaseDt				= 18
		 C_RealStartDt				= 19
	...
	If pvSpdNo = "C" Or pvSpdNo = "*" Then
		' Grid 3(vspdData3) - Hidden
		 ...
		 C_ShiftId2					= 3
		 C_ProdQty2					= 4
		 C_BatchCnt2			    = 5             '20080310::hanc
		 C_ReasonCd2				= 6 
		 C_ReasonDesc2				= 7 
		 C_Remark2					= 8 
		 C_LotNo2					= 9 
		 C_LotSubNo2				= 10
		 C_RcptDocumentNo2			= 11
		 C_IssueDocumentNo2			= 12
		 C_InspReqNo2				= 13
		 C_Insp_Good_Qty2			= 14
		 C_Insp_Bad_Qty2			= 15
		 C_Rcpt_Qty2				= 16
    ...
    Select Case UCase(pvSpdNo)
		Case "A"
			...
			Call ggoSpread.GetSpreadColumnPos(iCurColumnPos)
             ...
             C_batch_cnt_h   			= iCurColumnPos(7)  '20080314::hanc
			 ...
			 C_BadQtyInOrderUnit		= iCurColumnPos(12)
			 C_InspGoodQtyInOrderUnit	= iCurColumnPos(13)
			 C_InspBadQtyInOrderUnit	= iCurColumnPos(14)
			 C_RcptQtyInOrderUnit		= iCurColumnPos(15)
			 C_PlanStartDt				= iCurColumnPos(16)
			 C_PlanComptDt				= iCurColumnPos(17)
			 C_ReleaseDt				= iCurColumnPos(18)
			 C_RealStartDt				= iCurColumnPos(19)
			 C_RoutNo					= iCurColumnPos(20)
			 C_WcCd						= iCurColumnPos(21)
			 C_WcNm						= iCurColumnPos(22)
			 C_JobCd					= iCurColumnPos(23)
			 C_JobDesc					= iCurColumnPos(24)
			 C_RoutOrder				= iCurColumnPos(25)
			 C_OrderStatus				= iCurColumnPos(26)
			 C_OrderStatusNm			= iCurColumnPos(27)
			 C_MilestoneFlg				= iCurColumnPos(28)
			 C_InsideFlag				= iCurColumnPos(29)
			 C_InsideFlagNm				= iCurColumnPos(30)
			 C_TrackingNo				= iCurColumnPos(31)
			 C_ProdtOrderType			= iCurColumnPos(32)
			 C_AutoRcptFlg				= iCurColumnPos(33)
			 C_LotReq					= iCurColumnPos(34)
			 C_LotGenMthd				= iCurColumnPos(35)
			 C_ProdInspReq				= iCurColumnPos(36)
			 C_FinalInspReq				= iCurColumnPos(37)
			 C_ItemGroupCd				= iCurColumnPos(38)
			 C_ItemGroupNm				= iCurColumnPos(39)
			 C_ParentOrderNo			= iCurColumnPos(40)
			 C_ParentOprNo				= iCurColumnPos(41)
			 C_OrginalOrderNo			= iCurColumnPos(42)
			 C_OrginalOprNo				= iCurColumnPos(43)
			 C_ReworkPrevQty			= iCurColumnPos(44)
		...
		Case "B"
			...
			' Grid 2(vspdData2) - Results
			 ...
			 C_BatchCnt					= iCurColumnPos(5)          '20080310::hanc
			 C_ReasonCd					= iCurColumnPos(6) 
			 C_ReasonDesc				= iCurColumnPos(7) 
			 C_Remark1					= iCurColumnPos(8) 
			 C_LotNo					= iCurColumnPos(9) 
			 C_LotSubNo					= iCurColumnPos(10)
			 C_RcptDocumentNo			= iCurColumnPos(11)
			 C_IssueDocumentNo			= iCurColumnPos(12)
			 C_InspReqNo				= iCurColumnPos(13)
			 C_Insp_Good_Qty1			= iCurColumnPos(14)
			 C_Insp_Bad_Qty1			= iCurColumnPos(15)
			 C_Rcpt_Qty1				= iCurColumnPos(16)
			' Hidden
			 C_ProdtOrderNo1			= iCurColumnPos(17)
			 C_OprNo1					= iCurColumnPos(18)
			 C_Sequence					= iCurColumnPos(19)
			 C_MilestoneFlg1			= iCurColumnPos(20)
			 C_InsideFlag1				= iCurColumnPos(21)
			 C_AutoRcptFlg1				= iCurColumnPos(22)
			 C_LotReq1					= iCurColumnPos(23)
			 C_LotGenMthd1				= iCurColumnPos(24)
...
Function FncInsertRow(ByVal pvRowCnt) 
	...
	With frm1
    	...
    	For pvRow = .vspdData2.ActiveRow To .vspdData2.ActiveRow + imRow -1
			...
			.vspdData2.value = "0"
			.vspdData2.Col = C_BatchCnt     '20080310::hanc
			.vspdData2.value = "0"
...
Dim iCurColumnPos
	...
	With frm1 
	    ...
	    If lRow > 0 Then
            ...
            For iCols = 1 To 27 'vspdData2 의 데이타만 변경한다.        '20080310::hanc   26->27
                .vspdData2.Col = iCurColumnPos(iCols)
                .vspdData3.Col = iCols
                .vspdData3.Text = .vspdData2.Text
            Next
		...
		With .vspdData3
			...
			ggoSpread.SSSetRequired C_BatchCnt,					LngCurRow, LngCurRow        '20080310::hanc
		...
		For IntRows = 1 To .MaxRows
			...
			Select Case .Text
			    ...
			    Case ggoSpread.InsertFlag
					...
					strVal = strVal & IntRows & iColSep		'15

					.Col = C_BatchCnt2		' batch cnt  20080310::hanc
					strVal = strVal & UNIConvNum(.Text,0) & iRowSep     
