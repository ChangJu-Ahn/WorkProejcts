...
'*  2. Function Name        : 
'*  3. Program ID           : p4420rb3.asp
'*  4. Program Name         : 제품생산월보(작업조별상세)
'*  5. Program Desc         :
'*  6. Modified date(First) : 2000/12/20
...
%>
		strData = ""
		strData = strData & Chr(11) & "<%=ConvSPChars(rs0("SHIFTCD"))%>"	
		strData = strData & Chr(11) & "<%=ConvSPChars(rs0("DESCPT"))%>"		
