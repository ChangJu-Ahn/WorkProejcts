...
Const BIZ_PGM_ID = "p4411rb1.asp"						'☆: 비지니스 로직 ASP명 
...
Sub InitSpreadSheet()
	...
	ggoSpread.SSSetDate 	C_ProdDt,				"실적일", 11, 2, PopupParent.gDateFormat
	ggoSpread.SSSetEdit 	C_ShiftNo,				"Shift", 8
	ggoSpread.SSSetEdit 	C_BadFlg,				"양/불", 6
	ggoSpread.SSSetFloat	C_ProdQtyInOrderUnit,	"생산량",15,PopupParent.ggQtyNo ,ggStrIntegeralPart, ggStrDeciPointPart,PopupParent.gComNum1000,PopupParent.gComNumDec,,,"Z"
	ggoSpread.SSSetEdit 	C_ProdtOrderUnit,		"오더단위", 8
	ggoSpread.SSSetFloat	C_ProdQtyInBaseUnit,	"기준생산량",15,PopupParent.ggQtyNo ,ggStrIntegeralPart, ggStrDeciPointPart,PopupParent.gComNum1000,PopupParent.gComNumDec,,,"Z"
...
Function DbQuery()
	...
	strVal = strVal & "&lgProdOrdNo=" & lgProdOrdNo					'☆: 조회 조건 데이타 
	strVal = strVal & "&lgOprCd=" & lgOprCd							'☆: 조회 조건 데이타 
...
'========================================================================================
Function DbQueryOk(ByVal lngStartRow)														'☆: 조회 성공후 실행로직 
	'-----------------------
