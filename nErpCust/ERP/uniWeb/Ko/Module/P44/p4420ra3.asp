...
'*  2. Function Name		: 																			*
'*  3. Program ID			: p4420ra3.asp																*
'*  4. Program Name			: 제품생산월보(작업조별상세)												*
'*  6. Comproxy List        : ADO : 189611sad															*
...
'============================================  1.2.1 Global 상수 선언  ==================================
'========================================================================================================
Const BIZ_PGM_ID = "p4420rb3.asp"					<% '☆: 비지니스 로직 ASP명 %>
...
'========================================================================================================
Sub SetDefaultVal()
	'lblTitle.innerHTML = "제품생산월보(작업조별상세)"
...
Sub InitSpreadSheet()
    ...
    ggoSpread.SSSetEdit 	C_Descpt,		 "Shift 명"	,15
					...
					<TD CLASS="CLSMTABP">
						<TABLE ID="MyTab" CELLSPACING=0 CELLPADDING=0>
							<TR>
								...
								<td background="../../../CShared/image/table/seltab_up_bg.gif" align="center" CLASS="CLSMTAB"><font color=white>Shift별상세내역</font></td>
			...
			<FIELDSET CLASS="CLSFLD">
				<TABLE WIDTH=100% CELLSPACING=0 CELLPADDING=0>
 					<TR>
						...
						<TD CLASS=TD6 NOWRAP>
							<script language =javascript src='./js/p4420ra3_I105348807_txtWorkDt.js'></script>
						</TD>
					</TR>
				</TABLE>
			</FIELDSET>
	...
	<TR>
		<TD WIDTH=100% HEIGHT=* valign=top>
			<TABLE WIDTH="100%" HEIGHT="100%">
				<TR HEIGHT="100%">
					<TD WIDTH="100%">
						<script language =javascript src='./js/p4420ra3_I765363574_vspdData.js'></script>
					</TD>
				</TR>
			</TABLE>
		</TD>
