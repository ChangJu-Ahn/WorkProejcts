...
'*  2. Function Name		: 
'*  3. Program ID			: p4419ma1
'*  4. Program Name			: Production Cancel By Order
'*  5. Program Desc			:
...
<SCRIPT LANGUAGE="VBScript"   SRC="p4419ma1.vbs"></SCRIPT> 
					...
					<TD CLASS="CLSMTABP">
						<TABLE ID="MyTab" CELLSPACING=0 CELLPADDING=0>
							<TR>
								...
								<td background="../../../CShared/image/table/seltab_up_bg.gif" align="center" CLASS="CLSMTAB"><font color=white>오더별실적취소</font></td>
