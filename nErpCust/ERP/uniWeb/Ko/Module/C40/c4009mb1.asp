...
Sub SubBizQueryMulti()
	...
	Set iPC4G009Q = Server.CreateObject("PC4G009.cListDirDstbFctrAcctAssnSvr")
	...
	' -- minor_cd 는 필수입력이 아님.
	Call iPC4G009Q.C_LIST_DIR_DSTB_FCTR_ACCT_ASSN_S_SVR(gStrGloBalCollection, Trim(Request("txtACCT_CD")), arrHeadData)
    
    If CheckSYSTEMError(Err, True) = True Then					
       Call SetErrorStatus  
       Set iPC4G009Q = Nothing
       Exit Sub
	...
	Response.Write "	.frm1.hMINOR_CD.value = 	""" & Trim(Request("txtACCT_CD"))       & """" & vbCr
...
Sub SubBizSaveMulti()
	...
	If sSQLI1 = "" And sSQLU1 = "" And sSQLD1 = "" Then
		Call DisplayMsgBox("970021", vbInformation, "txtSpreadI1~2", "", I_MKSCRIPT)      '☜ : No data is found. 
		Exit Sub
	End If
	
    
    Set PC4G009Data = Server.CreateObject("PC4G009.cMngDirDstbFctrAcctAssnSvr")
    ...
    Call PC4G009Data.C_MNG_DIR_DSTB_FCTR_ACCT_ASSN_S_SVR(gStrGlobalCollection, sSQLI1, sSQLU1, sSQLD1, lgErrorPos)			
