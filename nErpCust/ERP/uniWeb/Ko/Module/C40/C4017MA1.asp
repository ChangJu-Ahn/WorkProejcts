...
Const BIZ_PGM_ID = "C4017MB1.asp"	                          'Biz Logic ASP
...
Function OpenWorkStep(Byval strCode)
	...
	arrParam(2) = strCode
	arrParam(3) = ""	
	arrParam(4) = "a.MAJOR_CD = " & FilterVar("C4001", "''", "S") & " and minor_cd in ('09','11') " 
	arrParam(5) = "작업단계"			
...
Function OpenDstbFctrCd(Byval strCode)
	...
	arrParam(0) = "배부요소팝업"
	arrParam(1) = "C_DSTB_FCTR_S a,b_minor b "		
	arrParam(2) = strCode
	arrParam(3) = ""		
	arrParam(4) = "b.major_cd = 'C4000' and a.dstb_fctr_cd = b.minor_cd"	
	arrParam(5) = "배부요소"			
	
    arrField(0) = "a.DSTB_FCTR_CD"	
					...
					<TD CLASS="CLSMTABP">
						<TABLE ID="MyTab" CELLSPACING=0 CELLPADDING=0>
							<TR>
								...
								<td background="../../../CShared/image/table/seltab_up_bg.gif" align="center" CLASS="CLSMTAB"><font color=white>공통재료비배부규칙등록</font></td>
