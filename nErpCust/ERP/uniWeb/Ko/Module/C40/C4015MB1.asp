...
Sub SubBizQueryMulti()
    ...
    Set PC4G015Data = Server.CreateObject("PC4G015.cCListStdRatebyCESvr")
    ...
    Call PC4G015Data.C_LIST_STD_RATE_BY_CE_SVR(gStrGlobalCollection,importArray, exportData,exportData1)
	
	If CheckSYSTEMError(Err, True) = True Then					
       Set PC4G015Data = Nothing
       Call SetErrorStatus
       Exit Sub
    End If    
...
Sub SubBizSaveMulti()
   ...
   txtSpread     = Trim(Request("txtSpread"))
    ...
    Set PC4G015Data = Server.CreateObject("PC4G015.cCMngStdRateByCESvr")
    ...
    Call PC4G015Data.C_MANAGE_STD_RATE_BY_CE_SVR(gStrGloBalCollection, txtSpread, iErrPosition)		
