...
Sub SubBizQueryMulti()
    ...
    Set PC4G016Data = Server.CreateObject("PC4G016.cCListDstFctrSvr")
    ...
    Call PC4G016Data.C_LIST_DSTB_FCTR_SVR(gStrGlobalCollection,importArray, exportData, exportData1)
	
	If CheckSYSTEMError(Err, True) = True Then					
       Set PC4G016Data = Nothing
...
Sub SubBizSaveMulti()
    ...
    Set PC4G016Data = Server.CreateObject("PC4G016.cCMngDstFctrSvr")
    ...
    Call PC4G016Data.C_MANAGE_DSTB_FCTR_SVR(gStrGlobalCollection, txtSpread, iErrPosition)			
