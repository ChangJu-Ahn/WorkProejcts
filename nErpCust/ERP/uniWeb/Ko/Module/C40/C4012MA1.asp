...
'========================================================================================================
Const BIZ_PGM_ID = "C4012MB1.asp"                                      'Biz Logic ASP 
'========================================================================================================
...
Sub InitSpreadSheet()
	...
	ggoSpread.SSSetCheck	C_SalesFlag			,"매출원가여부"		,10	, ,"",true 
	...
	'Call ggoSpread.SSSetColHidden(C_SalesFlag,C_SalesFlag,True)
...
Sub SetSpreadColor2(ByVal iRow)
	...
	ELSE
		...
		IF UCase(Trim(.vspdData.text)) = "I99" or UCase(Trim(.vspdData.text)) = "I9Z" or UCase(Trim(.vspdData.text)) = "IZZ" Then
			ggoSpread.SSSetProtected C_CostFlag,	iRow,	iRow	
			ggoSpread.SSSetProtected C_DiffFlag,	iRow,	iRow
			ggoSpread.SSSetProtected C_SalesFlag,	iRow,	iRow					
		END IF
	...
	With Frm1.VspdData
		 ...
		 If .ActiveRow > 0 Then
			...
			ELSEIF .Text = "OI" Then 
				...
				ggoSpread.SpreadUnLock C_SalesFlag,.ActiveRow,C_SalesFlag,.ActiveRow
			ELSEIF .Text = "ST" Then
				ggoSpread.SpreadUnLock C_PriceFlag,.ActiveRow,C_PriceFlag,.ActiveRow
				ggoSpread.SpreadUnLock C_DiffFlag,.ActiveRow,C_DiffFlag,.ActiveRow
			END IF   
...
Function OpenVersion()
	...
	arrParam(1) = "C_MOVETYPE_CONFIGURATION_S"
...
Function OpenItemAcct(ByVal strCode)
	...
	arrParam(2) = strCode
	arrParam(3) = ""								
	arrParam(4) = "Major_Cd='P1001' and a.minor_cd = b.item_acct and b.item_acct_group <> '6MRO' "		
	arrParam(5) = "품목계정"    				
