...
Sub SubBizAutoGen()
    ...
    Set PC4G014Data = Server.CreateObject("PC4G014.cCMngCoElmByAcctSvr")
    ...
    Call PC4G014Data.C_GEN_COST_ELMT_BY_ACCT_SVR(gStrGlobalCollection,iErrPosition)			
		
    If CheckSYSTEMError2(Err, True ,iErrPosition & "행","","","","") = True Then												
       Call SetErrorStatus
       Set PC4G014Data = Nothing
       Exit Sub
    End If    
...
Sub SubBizQueryMulti()
    ...
    Set PC4G014Data = Server.CreateObject("PC4G014.cCListCoElmByAcctSvr")
    ...
    Call PC4G014Data.C_LIST_COST_ELMT_BY_ACCT_SVR(gStrGlobalCollection,importArray, exportData, exportData1)
...
'   importString(C_AcctCD) = Trim(Request("txtAcctCd"))
    ...
    Call PC4G014Data.C_MANAGE_COST_ELMT_BY_ACCT_SVR(gStrGlobalCollection, txtSpread, iErrPosition)			
