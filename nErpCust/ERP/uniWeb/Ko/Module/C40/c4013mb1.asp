...
Sub SubBizQueryMulti()
    ...
    Set PC4G013Data = Server.CreateObject("PC4G013.cCListPlantPrioritySvr")
    ...
    Call PC4G013Data.C_LIST_PLANT_PRIORITY_SVR(gStrGlobalCollection,importArray, exportData1)
	
	If CheckSYSTEMError(Err, True) = True Then					
       Set PC4G013Data = Nothing
       Call SetErrorStatus
       Exit Sub
    End If    
...
Sub SubBizSaveMulti()
   ...
   txtSpread     = Trim(Request("txtSpread"))
    ...
    Set PC4G013Data = Server.CreateObject("PC4G013.cCMngPlantPrioritySvr")
    ...
    Call PC4G013Data.C_MANAGE_PLANT_PRIORITY_SVR(gStrGloBalCollection, txtSpread, iErrPosition)		
