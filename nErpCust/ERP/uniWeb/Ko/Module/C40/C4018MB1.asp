...
Sub SubBizBulkCopy()
    ...
    Set PC4G018Data = Server.CreateObject("PC4G018.cCMngWkVerSvr")
    ...
    Call PC4G018Data.C_MANAGE_WORK_VERSION_SVR(gStrGlobalCollection, txtYYYYMM, , , "X")			
		
    If CheckSYSTEMError(Err, True) = True Then					
       Call SetErrorStatus
       Set PC4G018Data = Nothing
       Exit Sub
    End If    
...
'   Dim exportData
    ...
    Set PC4G018Data = Server.CreateObject("PC4G018.cCListWkVerSvr")

	If CheckSYSTEMError(Err, True) = True Then					
       Exit Sub
    End If    
   
    Call PC4G018Data.C_LIST_WORK_VERSION_SVR(gStrGlobalCollection,importArray, exportData1)
...
Sub SubBizSaveMulti()
    ...
    Call PC4G018Data.C_MANAGE_WORK_VERSION_SVR(gStrGlobalCollection, importString, txtSpread, iErrPosition,"S")			
