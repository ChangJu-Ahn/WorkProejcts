...
Const BIZ_PGM_ID = "U2211MB1_TEST.asp"
'Const BIZ_PGM_REG_ID = "U2211MA1_TEST"
		...
		Case "B"
			...
			With frm1.vspdData
			   ...
			   '.MaxRows = 0
				...
				ggoSpread.SSSetEdit		C_H_TITLE,			"제목",	15
				ggoSpread.SSSetEdit		C_H_INS_USER,		"등록자", 12
				ggoSpread.SSSetEdit		C_H_INS_DT,			"등록일", 12
				ggoSpread.SSSetEdit		C_H_DOCUMENT_ABBR,	"요약설명", 30,,,100
...
'	End with 
''MSGBOX strVal
''MSGBOX "U2211RA1_TEST.asp?txtBpCd=" & sDhBpCd & "&DLVY_NO=" & sDhDlvyNo & "&document_no=" & sDhDocumentNo
	  MyBizASP1.location.href = "U2211RA1_TEST.asp?txtBpCd=" & sDhBpCd & "&DLVY_NO=" & sDhDlvyNo & "&document_no=" & sDhDocumentNo
...
Sub vspdData_TopLeftChange(ByVal OldLeft , ByVal OldTop , ByVal NewLeft , ByVal NewTop )
    ...
    If frm1.vspdData.MaxRows < NewTop + VisibleRowCnt(frm1.vspdData, NewTop) Then	        '☜: 재쿼리 체크 
		...
		If lgPageNo > 0 Then
			Call DisableToolBar(Parent.TBC_H_QUERY)
...
'========================================================================================
Function FncExcel() 
 	Call parent.FncExport(Parent.C_H_MULTI)		
 End Function
...
'========================================================================================
Function FncFind() 
    Call parent.FncFind(Parent.C_H_MULTI, False)                                         '☜:화면 유형, Tab 유무 
End Function
...
Function DbQueryDtlOk()
	Dim ii
'MsgBox "DbQueryDtlOk(10)"	
    lgIntFlgMode = Parent.OPMD_UMODE							'⊙: Indicates that current mode is Update mode
	Call ggoOper.LockField(Document, "Q")			'This function lock the suitable field
	Call SetToolBar("110000000001111")				'버튼 툴바 제어 
'MsgBox "DbQueryDtlOk(20)"
    If frm1.vspdData.MaxRows > 0 Then
		Call SetToolBar("110010110001111")
		frm1.vspddata.focus
		MyBizASP1.location.href = "U2211RA1_TEST.asp?dlvy_no=" & ""
	End If
'MsgBox "DbQueryDtlOk(30)"	
	'Call InitData()
	Set gActiveElement = document.activeElement
	call vspdData_click (1,1)
	frm1.txtDlvyNo.focus()
'MsgBox "DbQueryDtlOk(40)"	
End Function
...
'	iTmpCUBufferMaxCount = parent.C_H_CHUNK_ARRAY_COUNT '한번에 설정한 버퍼의 크기 설정[수정,신규]
'	iTmpDBufferMaxCount  = parent.C_H_CHUNK_ARRAY_COUNT '한번에 설정한 버퍼의 크기 설정[삭제]
...
'					strVal = strVal & Trim(GetSpreadText(.vspdData,C_H_DOCUMENT_ABBR,lRow,"X","X")) & RowSep
'					lGrpCnt = lGrpCnt + 1
...
'		End If
		...
		arrRet = window.showModalDialog ("U2211PA1_TEST.asp?strMode=" & parent.UID_M0001 & "&bp_cd=" & sBpCd & "&dlvy_no=" & sDlvyNo, Array(window.parent,parm(0),parm(1)), _
       "dialogWidth=600px; dialogHeight=670px; center: Yes; help: No; resizable: No; status: No;")	
...
'	End If
	...
	IsOpenPop = True
MsgBox arrParam(0) & " / " & arrParam(1) & " / " & arrParam(2)		
	arrRet = window.showModalDialog ("U2211PA1_TEST.asp?strMode=" & parent.UID_M0002 & "&bp_cd=" & sBpCd & "&dlvy_no=" & sDlvyNo & "&Document_no=" & sDocument_no, Array(window.parent, arrParam), _
...
<TABLE <%=LR_SPACE_TYPE_00%> >
	...
	<TR>
		<TD WIDTH=100% HEIGHT=100% VALIGN=TOP>
			<IFRAME NAME="MyBizASP" SRC="../../blank.htm" WIDTH=100% HEIGHT=10% FRAMEBORDER=0 SCROLLING=NO  framespacing=0></IFRAME>
			<IFRAME NAME="MyBizASP1" SRC="U2211RA1_TEST.asp" WIDTH=100% HEIGHT=80% FRAMEBORDER=0 SCROLLING=NO  framespacing=0></IFRAME>
