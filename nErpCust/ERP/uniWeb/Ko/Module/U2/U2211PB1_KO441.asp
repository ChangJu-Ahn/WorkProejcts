...
'Call ServerMesgBox("in-RunFileAttachForINSERT", vbInformation, I_MKSCRIPT)	
'Call ServerMesgBox(Request("txtFileInf"), vbInformation, I_MKSCRIPT)		
'Call ServerMesgBox(UBound(arrTemp) - 1, vbInformation, I_MKSCRIPT)					
	lgStrSQL = ""
