        ...
        Case "M"
           ...
           Select Case Mid(pDataType,2,1)
               ...
               Case "Y"
					...
					lgStrSQL = lgStrSQL & "	   AND B.PO_NO = E.PO_NO "
					lgStrSQL = lgStrSQL & "	   AND (DLVY_NO IS NULL OR DLVY_NO = '') "
					...
					If lgkeystream(1) <> "" Then
						lgStrSQL = lgStrSQL & "  and A.plan_dvry_dt >= " & FilterVar(lgKeyStream(1),"''", "S")
					End If
					
					If lgkeystream(2) <> "" Then
						lgStrSQL = lgStrSQL & "  and A.plan_dvry_dt <= " & FilterVar(lgKeyStream(2),"''", "S")
					End If
