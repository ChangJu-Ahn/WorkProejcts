...
<SCRIPT LANGUAGE = "VBScript" SRC = " u2211qa1.vbs"></SCRIPT>
					...
					<TD CLASS="CLSMTABP">
						<TABLE ID="MyTab" CELLSPACING=0 CELLPADDING=0>
							<TR>
								...
								<td background="../../../CShared/image/table/seltab_up_bg.gif" align="center" CLASS="CLSMTAB"><font color=white>납품명세서조회(납품처)</font></td>
						...
						<FIELDSET CLASS="CLSFLD">
							<TABLE <%=LR_SPACE_TYPE_40%>>
			 					<TR>
									...
									<TD CLASS=TD6 NOWRAP><INPUT TYPE=TEXT NAME="txtBpCd" SIZE=10 MAXLENGTH=10 tag="14xxxU" ALT="업체"><IMG SRC="../../../CShared/image/btnPopup.gif" NAME="btnPlantCd" align=top TYPE="BUTTON"ONCLICK="vbscript:Openbpcd()">&nbsp;
				...
				<TR>
					<TD WIDTH=100% HEIGHT=* valign=top>
						<TABLE <%=LR_SPACE_TYPE_60%>>
							<TR>
			 					<TD CLASS=TD5 NOWRAP>명세서발행번호</TD>
								<TD CLASS=TD6 NOWRAP><INPUT TYPE=TEXT NAME="txtDlvyNo2" SIZE=20 MAXLENGTH=18 tag="24" ALT="명세서발행번호"></TD>
								<TD CLASS=TD5 NOWRAP>납입시간</TD>
								<TD CLASS=TD6 NOWRAP><INPUT TYPE=TEXT NAME="txtDlvyTime" SIZE=5 MAXLENGTH=4 tag="24" ALT="납입시간"></TD></TD>
							</TR>
							<TR>
			 					<TD CLASS=TD5 NOWRAP>운송회사</TD>
								<TD CLASS=TD6 NOWRAP><INPUT TYPE=TEXT NAME="txtTransCo" SIZE=30 MAXLENGTH=30 tag="24" ALT="운송회사"></TD>
								<TD CLASS=TD5 NOWRAP>차량번호</TD>
								<TD CLASS=TD6 NOWRAP><INPUT TYPE=TEXT NAME="txtVehicleNo" SIZE=20 MAXLENGTH=20 tag="24" ALT="차량번호"></TD></TD>
							</TR>
							<TR>
			 					<TD CLASS=TD5 NOWRAP>운전자명</TD>
								<TD CLASS=TD6 NOWRAP><INPUT TYPE=TEXT NAME="txtDriver" SIZE=20 MAXLENGTH=20 tag="24" ALT="운전자명"></TD>
								<TD CLASS=TD5 NOWRAP>전화번호</TD>
								<TD CLASS=TD6 NOWRAP><INPUT TYPE=TEXT NAME="txtTelNo1" SIZE=20 MAXLENGTH=20 tag="24" ALT="전화번호1">&nbsp;<INPUT TYPE=TEXT NAME="txtTelNo2" SIZE=20 MAXLENGTH=20 tag="24" ALT="전화번호2"></TD>
							</TR>
							<TR>
			 					<TD CLASS=TD5 NOWRAP>납품장소</TD>
								<TD CLASS=TD6 COLSPAN = 3 NOWRAP><INPUT TYPE=TEXT NAME="txtDlvyPlace" SIZE=50 MAXLENGTH=50 tag="24" ALT="납품장소"></TD>
							</TR>
							<TR>
			 					<TD CLASS=TD5 NOWRAP>비고</TD>
								<TD CLASS=TD6 COLSPAN = 3 NOWRAP><INPUT TYPE=TEXT NAME="txtREMARK" SIZE=100 MAXLENGTH=100 tag="24" ALT="비고"></TD>
							</TR>
							<TR HEIGHT="100%">
								<TD WIDTH="100%" colspan = "4">
									<SCRIPT LANGUAGE=JavaScript> ExternalWrite('<OBJECT CLASSID=<%=gCLSIDFPSPD%> name=vspdData1 Id = "A" HEIGHT="100%" width="100%" tag="24" TITLE="SPREAD"> <PARAM NAME="MaxCols" VALUE="0"> <PARAM NAME="MaxRows" VALUE="0"> </OBJECT>');</SCRIPT>
								</TD>
							</TR>
						</TABLE>
					</TD>
