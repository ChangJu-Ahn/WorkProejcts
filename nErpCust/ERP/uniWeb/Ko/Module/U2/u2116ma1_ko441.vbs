...
'*                            
'**********************************************************************************************
Const BIZ_PGM_ID	= "u2116mb1_ko441.asp"			'☆: List & Manage SCM Orders
Const BIZ_PGM_ID2	= "u2116mb2_ko441.asp"			'☆: List & Manage SCM Orders
...
Dim	C_ReceiptQty
Dim	C_RcptRemainQty
Dim C_LOT_NO        '2008-06-09 1:55오후 :: hanc
...
Sub InitSpreadSheet(ByVal pvSpdNo)
	...
	If pvSpdNo = "A" Or pvSpdNo = "*" Then
		...
		With frm1
            ...
            ggoSpread.SSSetEdit		C_LotNo,		"LOT NO"      ,10,,,10          '2008-06-09 12:04오후 :: hanc
    ...
    If pvSpdNo = "B" Or pvSpdNo = "*" Then
		...
		With frm1
            ...
            ggoSpread.SSSetEdit		C_Lot_No,		"LOT NO"      ,10,,,10          '2008-06-09 12:04오후 :: hanc
...
Sub SetSpreadLock(ByVal pvSpdNo)
	...
	If pvSpdNo = "A" Then
		...
		With frm1
			...
			ggoSpread.SSSetRequired  C_LotNo, -1        '2008-06-09 12:05오후 :: hanc
...
Sub SetSpreadColor(ByVal pvStartRow, ByVal pvEndRow)
	...
	If .Text = "Y" Then
		...
		ggoSpread.SSSetProtected  C_LotNo,		pvStartRow, pvEndRow        '2008-06-09 12:06오후 :: hanc
...
Sub InitSpreadPosVariables(ByVal pvSpdNo)	
	If pvSpdNo = "A" Or pvSpdNo = "*" Then
		...
		C_SLPOP			= 21
		C_SLNM			= 22
		C_LotNo			= 23        '2008-06-09 1:20오후 :: hanc
		C_ClsFlg		= 24
		C_RcptFlg		= 25
...
Sub GetSpreadColumnPos(ByVal pvSpdNo)
 	...
 	Select Case Ucase(pvSpdNo)
 		Case "A"
			...
			C_LotNo		    = iCurColumnPos(23)     '2008-06-09 1:20오후 :: hanc
			C_ClsFlg		= iCurColumnPos(24)
			C_RcptFlg		= iCurColumnPos(25)
           ...
           Select Case .vspdData1.Text
               ...
               Case  ggoSpread.UpdateFlag                                      '☜: Update
					...
					If .vspdData1.Value > 0 Then
						...
						.vspdData1.Col = C_SLCD			: strVal = strVal & Trim(.vspdData1.Text) &  parent.gColSep	'6
						.vspdData1.Col = C_LOTNO		: strVal = strVal & Trim(.vspdData1.Text) &  parent.gRowSep	'7 '2008-06-09 1:48오후 :: hanc
