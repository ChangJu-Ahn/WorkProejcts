...
Sub SubBizSaveMultiUpdate(arrColVal)
	...
	lgStrSQL = lgStrSQL & vbCrLf & "        LOT_NO       = " & FilterVar(Trim(UCase(arrColVal(13))),"","S")   & ","
    ...
    Select Case Mid(pDataType,1,1)
        Case "M"
           ...
           Select Case Mid(pDataType,2,1)
               Case "R"
					lgStrSQL =            "	SELECT TOP " & iSelCount  & " A.PO_NO , A.PO_SEQ_NO , A.SPLIT_SEQ_NO , B.ITEM_CD , C.ITEM_NM , C.SPEC , A.LOT_NO, b.TRACKING_NO, "
