...
'*  3. Program ID			: u2117ma1.asp
'*  4. Program Name			: Manage Firm Purchase Receipt
'*  5. Program Desc			: Manage Firm Purchase Receipt
'*  6. Comproxy List		: 
'*  7. Modified date(First)	: 2007/04/12
'*  8. Modified date(Last)	: 
'*  9. Modifier (First)		: Park, BumSoo
'* 10. Modifier (Last)		: Park, BumSoo  (2005-01-07) Noh-H-G
'* 11. Comment
'**********************************************************************************************
-->
<HTML>
...
<SCRIPT LANGUAGE = "VBScript" SRC = "u2117ma1.vbs"></SCRIPT>
					...
					<TD CLASS="CLSMTABP">
						<TABLE ID="MyTab" CELLSPACING=0 CELLPADDING=0>
							<TR>
								...
								<td background="../../../CShared/image/table/seltab_up_bg.gif" align="center" CLASS="CLSMTAB"><font color=white>납품예정서수정</font></td>
