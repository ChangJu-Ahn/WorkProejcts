...
Dim project_code,strMode,lngRow
	...
	Dim strSystemFolder
	Dim iTempPath
	Dim strBpCd, strReport_No,strins_person,strReport_Text, num1, num2
	Dim strTitle
	Dim arrTemp
	Dim strReport_Abbr
	Dim struse_dt
	...
	If IsNull(strReport_No) Or strReport_No = "" Then
		...
		Call SubOpenDB(lgObjConn)
			...
			Else
				...
				num1 = Mid(strReport_No,1,1)
				num2 = "000000" & CStr(CInt(Mid(strReport_No,2,7)) + 1)
				num2 = Right(num2,7) 
				strReport_No = num1 & num2
		    End If
...
function AttachFile(){
	...
	//document.FR_ATTWIZ.SetTempDir('D:/uniERPII/uniWeb/Ko/Module/u2/files/');
