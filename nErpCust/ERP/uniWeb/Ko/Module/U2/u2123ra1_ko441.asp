...
'================================================================================================================================
Const BIZ_PGM_ID 		= "u2123rb1_ko441.asp"
...
Dim C_ItemName
Dim C_Spec
Dim C_LotNo     '2008-06-10 9:34오전 :: hanc
Dim C_PlantCd
Dim C_PlantNm
Dim C_OrderUnit
Dim C_OrderNo
...
Sub InitSpreadPosVariables()
		...
		C_ItemName		= 4
		C_Spec			= 5
        C_LotNo		    = 6         '2008-06-10 9:45오전 :: hanc
		C_OrderUnit		= 7 
		C_DvryPlanDt	= 8 
		C_DvryQty		= 9 
		C_PlantCd		= 10
...
Sub GetSpreadColumnPos()
	...
	Call ggoSpread.GetSpreadColumnPos(iCurColumnPos)
			...
			C_LotNo		    = iCurColumnPos(6)  '2008-06-10 9:45오전 :: hanc 
			...
			C_SPLIT_SEQ_NO	= iCurColumnPos(12)
