...
<SCRIPT LANGUAGE = "VBScript" SRC = " U2122MA1_ko441.vbs"></SCRIPT>
					...
					<TD CLASS="CLSMTABP">
						<TABLE ID="MyTab" CELLSPACING=0 CELLPADDING=0>
							<TR>
								...
								<td background="../../../CShared/image/table/seltab_up_bg.gif" align="center" CLASS="CLSMTAB"><font color=white>납품명세서발행등록</font></td>
								<td background="../../../CShared/image/table/seltab_up_bg.gif" align="right"><img src="../../../CShared/image/table/seltab_up_right.gif" width="10" height="23"></td>
						    </TR>
						</TABLE>
					</TD>
					<TD WIDTH=*>&nbsp;</TD>
					<TD WIDTH=* align=right><A href="vbscript:OpenReqRef()">납품예정정보참조</A> </TD>
					<TD WIDTH=10>&nbsp;</TD>
				</TR>
			</TABLE>
		</TD>
					...
					<TD WIDTH=100% HEIGHT=* valign=top>
						<TABLE <%=LR_SPACE_TYPE_60%>>
							<TR>
								...
								<TD CLASS=TD6 NOWRAP>
								<!--<INPUT TYPE=TEXT NAME="txtDlvyTime" SIZE=5 MAXLENGTH=4 tag="21" ALT="납입시간"></TD>-->
							...
							<TR>
								...
								<TD CLASS=TD6 COLSPAN = 3 NOWRAP><INPUT TYPE=TEXT NAME="txtDlvyPlace" SIZE=50 MAXLENGTH=50 tag="21" ALT="납품장소"></TD>
							</TR>
							<TR>
		...
		<TD WIDTH=100%>
			<TABLE <%=LR_SPACE_TYPE_30%>>
				<TR>				
					...
					<TD></TD>
					<!--<TD>
						<INPUT TYPE=CHECKBOX NAME="chk1" tag="31" Class="Check" CHECKED><LABEL ID="lblFlag1" FOR="chk1">공급받는자용</LABEL>&nbsp;&nbsp;
						<INPUT TYPE=CHECKBOX NAME="chk2" tag="31" Class="Check"><LABEL ID="lblFlag2" FOR="chk2">검수용</LABEL>
						<INPUT TYPE=CHECKBOX NAME="chk3" tag="31" Class="Check" CHECKED><LABEL ID="lblFlag3" FOR="chk3">공급자용</LABEL>
					</TD>-->
				</TR>
			</TABLE>
		</TD>
