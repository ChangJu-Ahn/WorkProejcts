...
'*  2. Function Name        : 
'*  3. Program ID           :
'*  4. Program Name         : u2115qa1.vbs
'*  5. Program Desc         : 미납품상세현황 
'*  6. Comproxy List        : 
...
Sub InitSpreadSheet(ByVal pvSpdNo)
	...
	If pvSpdNo = "A" Or pvSpdNo = "*" Then
		...
		With frm1.vspdData 
			...
			ggoSpread.SSSetDate 	C_SoDt,			"수주일",		12, 2, parent.gDateFormat
...
Sub GetSpreadColumnPos(ByVal pvSpdNo)
 	...
 	Case "A"
		...
		C_PlantCd		= iCurColumnPos(7)
		C_PlantNm		= iCurColumnPos(8)
		C_Gubun			= iCurColumnPos(9)
		C_DvryDT		= iCurColumnPos(10)
		C_SaleQty		= iCurColumnPos(11)
		C_IssueQty		= iCurColumnPos(12)
		C_RemainQty		= iCurColumnPos(13)
		C_RemainWaitQty	= iCurColumnPos(14)
		C_RemainFirmQty	= iCurColumnPos(15)
