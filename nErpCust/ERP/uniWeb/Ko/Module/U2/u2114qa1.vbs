...
'*  2. Function Name        : 
'*  3. Program ID           :
'*  4. Program Name         : U2114qa1.vbs
'*  5. Program Desc         : 미납품집계조회 
'*  6. Comproxy List        : 
...
Const BIZ_PGM_ID1		= "u2114qb1.asp"
Const BIZ_PGM_ID2		= "u2114qb2.asp"
...
Sub InitSpreadSheet(ByVal pvSpdNo)
	...
	If pvSpdNo = "A" Or pvSpdNo = "*" Then
		...
		With frm1.vspdData1 
			...
			ggoSpread.SSSetEdit		C_POUnit,		"납품단위",		8
			...
			ggoSpread.SSSetFloat	C_UnRcptQty,	"미납품량",		12,parent.ggQtyNo,ggStrIntegeralPart, ggStrDeciPointPart,parent.gComNum1000,parent.gComNumDec,,,"Z"
			ggoSpread.SSSetFloat	C_UnRcptWaitQty,"납품대기수량",	12,parent.ggQtyNo,ggStrIntegeralPart, ggStrDeciPointPart,parent.gComNum1000,parent.gComNumDec,,,"Z"
			ggoSpread.SSSetFloat	C_UnRcptFirmQty,"미납품잔량",		12,parent.ggQtyNo,ggStrIntegeralPart, ggStrDeciPointPart,parent.gComNum1000,parent.gComNumDec,,,"Z"
    ...
    If pvSpdNo = "B" Or pvSpdNo = "*" Then
		...
		With frm1.vspdData2 
			...
			ggoSpread.Spreadinit "V20040420", ,Parent.gAllowDragDropSpread
			...
			ggoSpread.SSSetEdit 	C_PONo,			"수주번호",		18
			...
			ggoSpread.SSSetDate 	C_DvryDT2,		"납기일",		10, 2, parent.gDateFormat		 
			ggoSpread.SSSetFloat	C_SaleQty,		"수주수량",		15,parent.ggQtyNo ,ggStrIntegeralPart, ggStrDeciPointPart,parent.gComNum1000,parent.gComNumDec,,,"Z"
			ggoSpread.SSSetFloat	C_IssueQty,		"납품수량",		15,parent.ggQtyNo ,ggStrIntegeralPart, ggStrDeciPointPart,parent.gComNum1000,parent.gComNumDec,,,"Z"
			ggoSpread.SSSetFloat	C_RemainQty,	"미납품량",		15,parent.ggQtyNo ,ggStrIntegeralPart, ggStrDeciPointPart,parent.gComNum1000,parent.gComNumDec,,,"Z"
			ggoSpread.SSSetFloat	C_RemainWaitQty,"납품대기수량",	12,parent.ggQtyNo,ggStrIntegeralPart, ggStrDeciPointPart,parent.gComNum1000,parent.gComNumDec,,,"Z"
			ggoSpread.SSSetFloat	C_RemainFirmQty,"미납품잔량",	12,parent.ggQtyNo,ggStrIntegeralPart, ggStrDeciPointPart,parent.gComNum1000,parent.gComNumDec,,,"Z"
...
Sub GetSpreadColumnPos(ByVal pvSpdNo)
 	...
 	Case "B"
		...
		C_SoDt			= iCurColumnPos(7)
		C_DvryDT2		= iCurColumnPos(8)
