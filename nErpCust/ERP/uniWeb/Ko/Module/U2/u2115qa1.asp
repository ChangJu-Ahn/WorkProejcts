...
'**********************************************************************************************
'*  1. Module Name          : SCM
'*  2. Function Name        : Order Management (for Supplier)
'*  3. Program ID           :
'*  4. Program Name         : U2115QA1.ASP
'*  5. Program Desc         : 미납품상세조회 
'*  6. Comproxy List        : 
...
<SCRIPT LANGUAGE="VBScript"   SRC="u2115qa1.vbs"></SCRIPT>
					...
					<TD CLASS="CLSMTABP">
						<TABLE ID="MyTab" CELLSPACING=0 CELLPADDING=0>
							<TR>
								...
								<td background="../../../CShared/image/table/seltab_up_bg.gif" align="center" CLASS="CLSMTAB"><font color=white>미납품상세현황</font></td>
						...
						<FIELDSET CLASS="CLSFLD">
							<TABLE <%=LR_SPACE_TYPE_40%>>
								<TR>						   
									...
									<TD CLASS=TD6 NOWRAP><INPUT TYPE=TEXT NAME="txtBpCd" SIZE=10 MAXLENGTH=10 tag="14xxxU" ALT="업체">&nbsp;<INPUT TYPE=TEXT NAME="txtBpNm" SIZE=20 tag="14"></TD>
								    <TD CLASS="TD5" NOWRAP>납품공장</TD>
									<TD CLASS="TD6" NOWRAP><INPUT TYPE=TEXT ALT="납품공장" NAME="txtPlantCd" SIZE=6 LANG="ko" MAXLENGTH=4 STYLE="text-transform:uppercase" tag="1XNXXU"><IMG SRC="../../../CShared/image/btnPopup.gif" NAME="btnPlantCd" align=top TYPE="BUTTON" ONCLICK="vbscript:OpenPlant() ">
									...
									<TD CLASS=TD6 NOWRAP>
										<table cellpadding=0 cellspacing=0>
											<tr>
												...
												<td NOWRAP>~</td>
												<td NOWRAP>
												<SCRIPT LANGUAGE=JavaScript> ExternalWrite('<OBJECT id=fpDateTime2 title=FPDATETIME CLASS=FPDTYYYYMMDD name=txtDvToDt CLASSID=<%=gCLSIDFPDT%> tag="12" ALT="종료일" ></OBJECT>');</SCRIPT>
												</td>
											</tr>
										</table>
									</TD>
								...
								<TR>
									...
									<TD CLASS="TD6" NOWRAP><INPUT TYPE=radio Class="Radio" ALT="전체" NAME="rdoAppflg" id = "rdoAppflg1" Value="A" checked tag="11"><label for="rdoAppflg1">&nbsp;전체&nbsp;</label>
														   <INPUT TYPE=radio Class="Radio" ALT="정상" NAME="rdoAppflg" id = "rdoAppflg2" Value="N" tag="11"><label for="rdoAppflg2">&nbsp;정상&nbsp;</label>
