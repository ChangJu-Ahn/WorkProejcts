...
Sub SubBizSaveCheck(arrColVal)
    ...
    '--발주량 - 입고량 - 미입고량 <  입력값  : 에러 , 발주량 < 입고량 + 미입고량 + 입고량(2005-09-10 LSW)
           ...
           Select Case Mid(pDataType,2,1)
               Case "R"
                    lgStrSQL	= " select	TOP " & iSelCount  & " c.po_dt, d.item_cd, e.item_nm, e.spec, d.po_unit, a.po_no, a.po_seq_no, " _
								...
								& "			CASE WHEN C.RET_FLG = " & FilterVar("Y","''","S") & " THEN '반품' ELSE '정상' END RET_FLG2 , " _
								...
								& "			d.SL_CD , I.SL_NM , d.cls_flg, J.RCPT_FLG " _ 
					...
					'--2005-08-02 출하검사시 요청사항 (발주확정된 건만 조회되게 수정 )
