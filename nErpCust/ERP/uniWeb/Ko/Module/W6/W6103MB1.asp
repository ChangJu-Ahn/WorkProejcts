...
Sub SubBizDelete()
	...
	' 디테일부터 제거한다.
    lgStrSQL =            "DELETE TB_JT1 WITH (ROWLOCK) " & vbCrLf
    ...
    Else
		...
		iDx = 1
				...
				Do While Not lgObjRs.EOF
					...
					lgstrData = lgstrData & "	.Col = " & C_SEQ_NO & " : .value = """ & lgObjRs("SEQ_NO") & """" & vbCrLf
					...
					lgstrData = lgstrData & "	.Col = " & C_W4_VAL & " : .value = """ & lgObjRs("W4_VAL") & """" & vbCrLf
					lgstrData = lgstrData & "	.Col = " & C_W5 & " : .value = """ & lgObjRs("W5") & """" & vbCrLf
					lgstrData = lgstrData & "	.Col = " & C_W6 & " : .value = """ & lgObjRs("W6") & """" & vbCrLf
                    lgstrData = lgstrData & "	.Col = " & C_W6 + 1 & " : .value = """  &  iDx  & """" & vbCrLf
...
Sub SubMakeSQLStatements(pMode,pCode1, pCode2, pCode3)
    Select Case pMode 
      Case "R"
            ...
            lgStrSQL = lgStrSQL & " FROM TB_JT1 WITH (NOLOCK) "
...
Sub SubBizSaveMultiCreate(arrColVal)
    ...
    On Error Resume Next
	lgStrSQL = "INSERT INTO TB_JT1 WITH (ROWLOCK) (" & vbCrLf
...
Sub SubBizSaveMultiUpdate(arrColVal)
    ...
    lgStrSQL = "UPDATE  TB_JT1 WITH (ROWLOCK) "
