...
Sub SubBizSaveSingleUpdate()
    ...
    lgStrSQL = lgStrSQL & " W1_1A  = " & FilterVar(Trim(UCase(lgKeyStream(3))),"","S")   & ","  
    lgStrSQL = lgStrSQL & " W1_1B  = " & UNIConvNum(lgKeyStream(4),0)  & ","
    lgStrSQL = lgStrSQL & " W1_2A  = " & FilterVar(Trim(UCase(lgKeyStream(5))),"","S")   & ","  
    lgStrSQL = lgStrSQL & " W1_2B  = " & UNIConvNum(lgKeyStream(6),0)  & ","
    lgStrSQL = lgStrSQL & " W1_3A  = " & FilterVar(Trim(UCase(lgKeyStream(7))),"","S")   & ","  
    lgStrSQL = lgStrSQL & " W1_3B  = " & UNIConvNum(lgKeyStream(8),0)  & ","   
    lgStrSQL = lgStrSQL & " W1_Sum  = " & UNIConvNum(lgKeyStream(9),0)  & ","        
    
    lgStrSQL = lgStrSQL & " W2_4  = " & FilterVar(Trim(UCase(lgKeyStream(10))),"","S")   & ","
    lgStrSQL = lgStrSQL & " W2_5  = " & FilterVar(Trim(UCase(lgKeyStream(11))),"","S")   & ","  
    lgStrSQL = lgStrSQL & " W2_6  = " & FilterVar(Trim(UCase(lgKeyStream(12))),"","S")   & ","  
    lgStrSQL = lgStrSQL & " W2_7  = " & FilterVar(Trim(UCase(lgKeyStream(13))),"","S")   & "," 
