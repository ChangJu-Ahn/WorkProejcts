...
'*  1. Module Name          : 법인세 
'*  2. Function Name        : 제8호부표5의2외국납부세액명세 
'*  3. Program ID           : W6115MA1
'*  4. Program Name         : W6115MA1.asp
'*  5. Program Desc         : 제8호부표5의2외국납부세액명세 
...
Const BIZ_MNU_ID = "w6115MA1"											 '☆: 비지니스 로직 ASP명 
Const BIZ_PGM_ID = "w6115MB1.asp"											 '☆: 비지니스 로직 ASP명 
				          ...
				          <TABLE   border = 0 cellpadding = 1 cellspacing = 1 ID="Table2" WIDTH =  100%>
				                     <TR>
										<TD WIDTH=620 valign=top  >
										       ...
										       <FIELDSET CLASS="CLSFLD"><LEGEND ALIGN=LEFT>1.외국납부세액공제 등 대상</LEGEND>
														<TABLE bgcolor = #696969  border = 0 cellpadding = 1 cellspacing = 1 ID="Table1" WIDTH =  100%>
															...
															<TR>
																 ...
																 <TD CLASS="TD61" align =CENTER  >
																	 <INPUT TYPE=TEXT NAME="txtw1_1A"   tag="25"  alt="(101)외국납부세목" maxlength=20 size=25>
																</TD>
																
																 <TD CLASS="TD61" align =CENTER  >
																	<SCRIPT LANGUAGE=JavaScript> ExternalWrite('<OBJECT CLASSID=<%=gCLSIDFPDS%> id="txtw1_1B" name=txtw1_1B CLASS=FPDS140 title=FPDOUBLESINGLE ALT="" tag="25X2Z" width = 100% ></OBJECT>');</SCRIPT>
																</TD>
															</TR>
															...
															<TR>
																 ...
																 <TD CLASS="TD61" align =CENTER  >
																	 <INPUT TYPE=TEXT NAME="txtw1_2A"   tag="25"  maxlength=20 alt="(101)외국납부세목"  size=25>
																</TD>
																
																 <TD CLASS="TD61" align =CENTER  >
																	<SCRIPT LANGUAGE=JavaScript> ExternalWrite('<OBJECT CLASSID=<%=gCLSIDFPDS%> id="txtw1_2B" name=txtw1_2B CLASS=FPDS140 title=FPDOUBLESINGLE ALT="" tag="25X2Z" width = 100% ></OBJECT>');</SCRIPT>
																</TD>
															</TR>
															<TR>
																 <TD CLASS="TD51" align =LEFT>
																 ...
																 <TD CLASS="TD61" align =CENTER  >
																	 <INPUT TYPE=TEXT NAME="txtw1_3A"   tag="25"  maxlength=20 alt="(101)외국납부세목" size=25 >
																</TD>
																
																 <TD CLASS="TD61" align =CENTER  >
																	<SCRIPT LANGUAGE=JavaScript> ExternalWrite('<OBJECT CLASSID=<%=gCLSIDFPDS%> id="txtw1_3B" name=txtw1_3B CLASS=FPDS140 title=FPDOUBLESINGLE ALT="" tag="25X2Z" width = 100% ></OBJECT>');</SCRIPT>
																</TD>
															</TR>
															<TR>
																 <TD CLASS="TD51" align =CENTER>
																 ...
																 <TD CLASS="TD51" align =CENTER  >
																	<SCRIPT LANGUAGE=JavaScript> ExternalWrite('<OBJECT CLASSID=<%=gCLSIDFPDS%> id="txtW1_Sum" name=txtW1_Sum CLASS=FPDS140 title=FPDOUBLESINGLE ALT="" tag="24X2Z" width = 100% ></OBJECT>');</SCRIPT>
																</TD>
															</TR>
															       ...
															       <FIELDSET CLASS="CLSFLD"><LEGEND ALIGN=LEFT>3.손금 산입명세</LEGEND>
																			<TABLE bgcolor = #696969  border = 0 cellpadding = 1 cellspacing = 1 ID="Table3" WIDTH =  100%>
																				...
																				<TR>
																					 ...
																					 <TD CLASS="TD61" align =CENTER  >
																						<SCRIPT LANGUAGE=JavaScript> ExternalWrite('<OBJECT CLASSID=<%=gCLSIDFPDS%> id="txtW3_8" name=txtW3_8 CLASS=FPDS140 title=FPDOUBLESINGLE ALT="" tag="25X2Z" width = 100% ></OBJECT>');</SCRIPT>
																					</TD>
																				</TR>
																				...
																				<TR>
																					 ...
																					 <TD CLASS="TD61" align =CENTER  >
																						<SCRIPT LANGUAGE=JavaScript> ExternalWrite('<OBJECT CLASSID=<%=gCLSIDFPDS%> id="txtW3_9" name=txtW3_9 CLASS=FPDS140 title=FPDOUBLESINGLE ALT="" tag="25X2Z" width = 100% ></OBJECT>');</SCRIPT>
																					</TD>
																				</TR>
																				<TR>
																					 <TD CLASS="TD51" align =LEFT>
																					 ...
																					 <TD CLASS="TD61" align =CENTER  >
																						<SCRIPT LANGUAGE=JavaScript> ExternalWrite('<OBJECT CLASSID=<%=gCLSIDFPDS%> id="txtW3_10" name=txtW3_10 CLASS=FPDS140 title=FPDOUBLESINGLE ALT="" tag="25X2Z" width = 100% ></OBJECT>');</SCRIPT>
																					</TD>
																				</TR>
																				<TR>
																					 <TD CLASS="TD51" align =LEFT>
																					 ...
																					 <TD CLASS="TD51" align =CENTER  >
																						<SCRIPT LANGUAGE=JavaScript> ExternalWrite('<OBJECT CLASSID=<%=gCLSIDFPDS%> id="txtW3_11" name=txtW3_11 CLASS=FPDS140 title=FPDOUBLESINGLE ALT="" tag="25X2Z" width = 100% ></OBJECT>');</SCRIPT>
																					</TD>
																				</TR>
																				<TR>
																					 <TD CLASS="TD51" align =LEFT>
																					 ...
																					 <TD CLASS="TD51" align =CENTER  >
																						<SCRIPT LANGUAGE=JavaScript> ExternalWrite('<OBJECT CLASSID=<%=gCLSIDFPDS%> id="txtW3_12" name=txtW3_12 CLASS=FPDS140 title=FPDOUBLESINGLE ALT="" tag="25X2Z" width = 100% ></OBJECT>');</SCRIPT>
																					</TD>
																				</TR>
																				<TR>
																					 <TD CLASS="TD51" align =CENTER>
																					 ...
																					 <TD CLASS="TD51" align =CENTER  >
																						<SCRIPT LANGUAGE=JavaScript> ExternalWrite('<OBJECT CLASSID=<%=gCLSIDFPDS%> id="txtWSUM" name=txtW3_SUM CLASS=FPDS140 title=FPDOUBLESINGLE ALT="" tag="24X2Z" width = 100% ></OBJECT>');</SCRIPT>
																					</TD>
																				</TR>
