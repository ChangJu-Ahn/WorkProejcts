...
Case CStr(UID_M0002)														'☜: 현재 조회/Prev/Next 요청을 받음 
	...
	With lgObjComm
		...
		.CommandText = "usp_v_va0020t"
		.CommandType = adCmdStoredProc

		.Parameters.Append .CreateParameter("RETURN_VALUE",	adInteger,	adParamReturnValue)

		.Parameters.Append .CreateParameter("@strDate",		adVarChar,	adParamInput,	8,	strDate)
		.Parameters.Append .CreateParameter("@strBizAreaCd",adVarChar,	adParamInput,	10,	strBizAreaCd)
