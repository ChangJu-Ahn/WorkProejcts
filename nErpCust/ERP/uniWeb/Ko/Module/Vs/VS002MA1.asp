...
'	txtQueryDate.Text	= UNIGetFirstDay("<%=GetSvrDate%>", Parent.gDateFormat)
...
Function SetPrintCond(StrEbrFile, strUrl)
	...
	Dim strDate, strUnit, strPlantCd
...
<BODY TABINDEX="-1" SCROLL="no">
	...
	<TABLE  <%=TABSTYLE01%> >
		<TR>
			...
			<TD CLASS="TD6E" NOWRAP><script language =javascript src='./js/vs002ma1_fpDateTime1_txtQueryDate.js'></script>&nbsp;</TD>
