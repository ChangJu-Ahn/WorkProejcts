...
Function OpenBp_cd(Byval strCode, Byval iWhere)
	...
	If iWhere = 0 Then
		arrParam(2) = Trim(txtBp_cdFrom.value)		<%' Code Condition%>
		arrParam(3) = ""								<%' Name Cindition%>

		txtBp_cdFrom.focus 
	Else
		arrParam(2) = Trim(txtBp_cdTo.value)		<%' Code Condition%>
		arrParam(3) = ""	
														<%' Name Cindition%>
		txtBp_cdTo.focus 
	End If
...
Function SetPrintCond(StrEbrFile, strUrl)
	...
	Dim strYyyymmdd, strUnit, strSoldtoparty,strBiz_area_cd
		
	SetPrintCond = False
	strYyyymmdd		= UNIConvDateToYYYYMMDD(txtQueryDate.Text ,parent.gDateFormat, "")
	strUnit	  		= FilterVar(cboUnit.value,"","SNM")
	strSoldtoparty	= FilterVar(txtBp_cdFrom.value,"","SNM")
	strBiz_area_cd	= FilterVar(txtBizAreaCd.value,"","SNM")


	StrEbrFile = "VS003MA1"
	
	If strSoldtoparty = "" Then strSoldtoparty = "%"
	If strBiz_area_cd = "" Then strBiz_area_cd = "%"

	StrUrl = StrUrl & "strYyyymmdd|" & strYyyymmdd
	StrUrl = StrUrl & "|strUnit|" & strUnit
	StrUrl = StrUrl & "|strSoldtoparty|" & strSoldtoparty
	StrUrl = StrUrl & "|biz_area_cd|" & strBiz_area_cd
	SetPrintCond = True	
...
'========================================================================================
' Function Name : txtBizAreaCd_cd_OnChange
' Function Desc : 
'========================================================================================
Function txtBizAreaCd_OnChange()
    ...
    If txtBizAreaCd.value = "" Then
        txtBizAreaNm.value = ""
    ELSE    
        IntRetCd =  CommonQueryRs(" BIZ_AREA_NM "," B_BIZ_AREA "," BIZ_AREA_CD="&filterVar(txtBizAreaCd.value,"''","S") & "" ,lgF0,lgF1,lgF2,lgF3,lgF4,lgF5,lgF6)
        If IntRetCd = false Then
			 call DisplayMsgBox("971012","X", "사업장","X")
			 txtBizAreaNm.value=""
			 txtBizAreaCd.focus
			
        Else
            txtBizAreaNm.value=Trim(Replace(lgF0,Chr(11),""))
        End If
    End If
    
End Function
'========================================================================================
' Function Name : txtBp_cdFrom_cd_OnChange
' Function Desc : 
'========================================================================================
Function txtBp_cdFrom_OnChange()
    Dim IntRetCd

    If txtBp_cdFrom.value = "" Then
        txtBp_nmFrom.value = ""
    ELSE    
        IntRetCd =  CommonQueryRs(" BP_NM "," B_BIZ_PARTNER "," BP_CD="&filterVar(txtBp_cdFrom.value,"''","S") & "" ,lgF0,lgF1,lgF2,lgF3,lgF4,lgF5,lgF6)
        If IntRetCd = false Then
			 call DisplayMsgBox("971012","X", "거래처","X")
			 txtBp_nmFrom.value=""
			 txtBp_cdFrom.focus
			
        Else
            txtBp_nmFrom.value=Trim(Replace(lgF0,Chr(11),""))
        End If
    End If
...
<BODY TABINDEX="-1" SCROLL="no">
	...
	<TABLE  <%=TABSTYLE01%> >
		<TR>
			...
			<TD CLASS="TD6E" NOWRAP><script language =javascript src='./js/vs003ma1_fpDateTime1_txtQueryDate.js'></script>&nbsp;</TD>
		...
		<TR>
			...
			<TD CLASS="TD6E" NOWRAP><input NAME="txtBp_cdFrom" TYPE="Text" MAXLENGTH="10" tag="11XXXU" size="10"><img SRC="../../../CShared/image/btnPopup.gif" NAME="ImgBp_cdFrom" align="top" TYPE="BUTTON" WIDTH="16" HEIGHT="20" ONCLICK="vbscript:OpenBp_cd txtBp_cdFrom.value,0"> 
