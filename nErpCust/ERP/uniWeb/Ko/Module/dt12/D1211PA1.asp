...
Const BIZ_PGM_ID = "d1211pb1.asp"							'☆: 비지니스 로직 ASP명 
...
Sub InitSpreadSheet()
	...
	ggoSpread.SSSetEdit 	C_inv_no,		"계산서번호", 18	
	ggoSpread.SSSetEdit 	C_wrk_dtm,		"작업일", 20	
	ggoSpread.SSSetEdit 	C_proc_flag,	"계산서상태", 10
	ggoSpread.SSSetEdit 	C_proc_flag_nm,	"계산서상태", 10
	ggoSpread.SSSetEdit 	C_proc_usr_id,	"처리회원사ID", 10	
	
	ggoSpread.SSSetEdit 	C_proc_usr_name,"처리회원사명", 18	
	ggoSpread.SSSetEdit 	C_attr02,		"폐기/반려사유", 10	
	ggoSpread.SSSetFloat	C_sup_tot_amt,	"공급가액",15,PopupParent.ggQtyNo,ggStrIntegeralPart, ggStrDeciPointPart,PopupParent.gComNum1000,PopupParent.gComNumDec,,,"Z"
	ggoSpread.SSSetFloat	C_sur_tax,		"VAT금액",15,PopupParent.ggQtyNo,ggStrIntegeralPart, ggStrDeciPointPart,PopupParent.gComNum1000,PopupParent.gComNumDec,,,"Z"
			...
			<FIELDSET CLASS="CLSFLD">
				<TABLE WIDTH=100% CELLSPACING=0>					
					<TR>
						...
						<TD CLASS=TD656 NOWRAP><INPUT TYPE=TEXT NAME="txtInvoiceNo" SIZE=18 MAXLENGTH=4 tag="14xxxU" ALT="계산서번호"></TD>
					</TR>
				</TABLE>
			</FIELDSET>
		</TD>
