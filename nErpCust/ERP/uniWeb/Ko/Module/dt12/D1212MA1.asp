...
'========================================================================================================
Const BIZ_PGM_ID  = "D1212MB1.asp"
Const BIZ_PGM_ID2 = "D1212MB2.asp"
Const BIZ_PGM_ID3 = "D1212MB3.asp"
...
Sub Form_Load()
   ...
   With frm1
      ...
      .btnSalesApproval.disabled	= false
	...
	With frm1	
		...
		If .vspdData.MaxRows > 0 Then
            ...
            For loopCount = 1 To frm1.vspdData.MaxRows
                ...
                If Not (frm1.vspdData.text = docStatusOpen) Then
							...
							<TD CLASS="CLSMTABP">
								<TABLE ID="MyTab" CELLSPACING=0 CELLPADDING=0>
									<TR>
										...
										<td background="../../../CShared/image/table/seltab_up_bg.gif" align="center" CLASS="CLSMTAB"><font color=white>매출역발행등록</font></td>
  					...
  					<TABLE <%=LR_SPACE_TYPE_30%>>
						<TR>
							...
							<TD>
							    ...
							    <BUTTON NAME="btnSalesApproval" CLASS="CLSSBTN" OnClick="VBScript:Call fnSalesApproval()" title = "매출승인">매출승인</BUTTON>&nbsp;
