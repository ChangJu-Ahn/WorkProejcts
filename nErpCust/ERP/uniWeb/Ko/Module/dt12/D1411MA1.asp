...
'========================================================================================================
Const BIZ_PGM_ID  = "D1411MB1.asp"
Const BIZ_PGM_ID2 = "D1411MB2.asp"
Const BIZ_PGM_ID3 = "D1411MB3.asp"
Const BIZ_PGM_ID4 = "D1411MB4.asp"
'==========================================  1.2.1 Global 상수 선언  ======================================
...
Sub InitSpreadPosVariables(ByVal pvSpdNo)
    ...
    If pvSpdNo = "A" Or pvSpdNo = "*" Then
		...
		C1_vat_loc_amt       = 19
		C1_credit_cd         = 20
		C1_report_biz_area_cd= 21
		C1_tax_biz_area_nm   = 22
		C1_biz_area_cd       = 23
		C1_biz_area_nm       = 24
		C1_ref_no            = 25
		C1_disuse_reason     = 26
...
Sub InitSpreadSheet(ByVal pvSpdNo)
	...
	If pvSpdNo = "A" Or pvSpdNo = "*" Then
		...
		With frm1.vspdData	
		    ...
		    ggoSpread.SSSetEdit   C1_inv_amend_type    ,"수정구분"        ,10        
...
Sub GetSpreadColumnPos(ByVal pvSpdNo)
	...
	Select Case UCase(pvSpdNo)
		Case "A"
            ...
            C1_issued_dt         = 	iCurColumnPos( 7)
            C1_io_fg             = 	iCurColumnPos( 8)
            C1_bp_cd             = 	iCurColumnPos( 9)
            C1_bp_nm             = 	iCurColumnPos(10)
            C1_made_vat_fg       = 	iCurColumnPos(11)
            C1_doc_cur           = 	iCurColumnPos(12)
            C1_vat_type          = 	iCurColumnPos(13)
            C1_vat_type_nm       = 	iCurColumnPos(14)
            C1_vat_rate          = 	iCurColumnPos(15)
            C1_net_amt           = 	iCurColumnPos(16)
            C1_net_loc_amt       = 	iCurColumnPos(17)
            C1_vat_amt           = 	iCurColumnPos(18)
            C1_vat_loc_amt       = 	iCurColumnPos(19)
            C1_credit_cd         = 	iCurColumnPos(20)
            C1_report_biz_area_cd= 	iCurColumnPos(21)
            C1_tax_biz_area_nm   = 	iCurColumnPos(22)
            C1_biz_area_cd       = 	iCurColumnPos(23)
            C1_biz_area_nm       = 	iCurColumnPos(24)
            C1_ref_no            = 	iCurColumnPos(25)
            C1_disuse_reason     = 	iCurColumnPos(26)
            C1_legacy_pk         = 	iCurColumnPos(27)
            C1_sale_no           = 	iCurColumnPos(28)
            C1_remark            = 	iCurColumnPos(29)
            C1_remark2           = 	iCurColumnPos(30)
            C1_remark3           = 	iCurColumnPos(31)
            C1_proc_flag         = 	iCurColumnPos(32)
            C1_is_send           = 	iCurColumnPos(33)
            C1_issue_dt_fg       = 	iCurColumnPos(34)
            C1_inv_amend_type    =  iCurColumnPos(35)
            
            C1_name             =   iCurColumnPos(36)
            C1_name_B           =   iCurColumnPos(37)
            C1_email            =   iCurColumnPos(38)
            C1_bp_seq           =   iCurColumnPos(39)
            C1_name2            =   iCurColumnPos(40)
            C1_name2_B          =   iCurColumnPos(41)
            C1_email2           =   iCurColumnPos(42)
            C1_bp_seq2          =   iCurColumnPos(43)
							...
							<TD CLASS="CLSMTABP">
								<TABLE ID="MyTab" CELLSPACING=0 CELLPADDING=0>
									<TR>
										...
										<td background="../../../CShared/image/table/seltab_up_bg.gif" align="center" CLASS="CLSMTAB"><font color=white>회계정발행등록</font></td>
