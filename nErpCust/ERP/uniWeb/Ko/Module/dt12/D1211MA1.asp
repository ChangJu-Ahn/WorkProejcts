...
'========================================================================================================
Const BIZ_PGM_ID  = "D1211MB1.asp"
Const BIZ_PGM_ID2 = "D1211MB2.asp"
Const BIZ_PGM_ID3 = "D1211MB3.asp"
Const BIZ_PGM_ID4 = "D1211MB4.asp"
'==========================================  1.2.1 Global 상수 선언  ======================================
...
Dim C1_send_check   '=  0
Dim C1_proc_flag_nm '=  1
Dim C1_is_send_nm   '=  2
Dim C1_where_flag   '=  3
Dim C1_tax_bill_no  '=  4
Dim C1_tax_doc_no   '=  5
Dim C1_inv_no   '=  6
Dim C1_tax_bill_type_nm '=  7
Dim C1_bp_cd    '=  8
Dim C1_bp_nm    '=  9
Dim C1_issued_dt    '=  10
Dim C1_vat_calc_type_nm '=  11
Dim C1_vat_inc_flag_nm  '=  12
Dim C1_vat_type '=  13
Dim C1_vat_type_nm  '=  14
Dim C1_vat_rate '=  15
Dim C1_cur  '=  16
Dim C1_total_amt    '=  17
Dim C1_fi_total_amt '=  18
Dim C1_net_amt  '=  19
Dim C1_fi_net_amt   '=  20
Dim C1_vat_amt  '=  21
Dim C1_fi_vat_amt   '=  22
Dim C1_total_loc_amt    '=  23
Dim C1_fi_total_loc_amt '=  24
Dim C1_net_loc_amt  '=  25
Dim C1_fi_net_loc_amt   '=  26
Dim C1_vat_loc_amt  '=  27
Dim C1_fi_vat_loc_amt   '=  28
Dim C1_report_biz_area  '=  29
Dim C1_tax_biz_area_nm  '=  30
Dim C1_sales_grp    '=  31
Dim C1_sales_grp_nm '=  32
Dim C1_remarks  '=  33
Dim C1_disuse_reason    '=  34
Dim C1_legacy_pk    '=  35
Dim C1_sale_no  '=  36
Dim C1_remark   '=  37
Dim C1_remark2  '=  38
...
Dim C1_proc_flag    '=  40
Dim C1_is_send  '=  41
Dim C1_issue_dt_fg  '=  42
Dim C1_inv_amend_type   '=  43
...
Sub InitSpreadPosVariables()
    ...
    C1_tax_doc_no   =   6
    C1_inv_no   =   7
    C1_tax_bill_type_nm =   8
    C1_bp_cd    =   9
    C1_bp_nm    =   10
    C1_issued_dt    =   11
    C1_vat_calc_type_nm =   12
    C1_vat_inc_flag_nm  =   13
    C1_vat_type =   14
    C1_vat_type_nm  =   15
    C1_vat_rate =   16
    C1_cur  =   17
    ...
    C1_fi_vat_amt   =   23
    C1_total_loc_amt    =   24
    C1_fi_total_loc_amt =   25
    C1_net_loc_amt  =   26
    C1_fi_net_loc_amt   =   27
    C1_vat_loc_amt  =   28
    C1_fi_vat_loc_amt   =   29
    C1_report_biz_area  =   30
    C1_tax_biz_area_nm  =   31
    C1_sales_grp    =   32
    C1_sales_grp_nm =   33
    C1_remarks  =   34
    C1_disuse_reason    =   35
...
Sub InitSpreadSheet()
    ...
    With frm1.vspdData
        ...
        ggoSpread.SSSetEdit     C1_inv_amend_type,      "수정사유",                 10
        ...
        Call ggoSpread.SSSetColHidden(C1_proc_flag, C1_inv_amend_type, True)
...
Sub InitSpreadSheet2()
    ...
    With frm1.vspdData2
        ...
        Call ggoSpread.SSSetColHidden(C2_bill_no, C2_tax_bill_no, True)
...
Sub SetSpreadLock()
    With frm1
        ...
        ggoSpread.SpreadLock    C1_inv_amend_type   ,  -1,  C1_inv_amend_type
...
Sub GetSpreadColumnPos(ByVal pvSpdNo)
    ...
    Select Case UCase(pvSpdNo)
        Case "A"
            ...
            C1_tax_bill_type_nm =   iCurColumnPos(8)
            C1_bp_cd    =   iCurColumnPos(9)
            C1_bp_nm    =   iCurColumnPos(10)
            C1_issued_dt    =   iCurColumnPos(11)
            C1_vat_calc_type_nm =   iCurColumnPos(12)
            C1_vat_inc_flag_nm  =   iCurColumnPos(13)
            C1_vat_type =   iCurColumnPos(14)
            C1_vat_type_nm  =   iCurColumnPos(15)
            C1_vat_rate =   iCurColumnPos(16)
            C1_cur  =   iCurColumnPos(17)
            C1_total_amt    =   iCurColumnPos(18)
            C1_fi_total_amt =   iCurColumnPos(19)
            C1_net_amt  =   iCurColumnPos(20)
            C1_fi_net_amt   =   iCurColumnPos(21)
            C1_vat_amt  =   iCurColumnPos(22)
            C1_fi_vat_amt   =   iCurColumnPos(23)
            C1_total_loc_amt    =   iCurColumnPos(24)
            C1_fi_total_loc_amt =   iCurColumnPos(25)
            C1_net_loc_amt  =   iCurColumnPos(26)
            C1_fi_net_loc_amt   =   iCurColumnPos(27)
            C1_vat_loc_amt  =   iCurColumnPos(28)
            C1_fi_vat_loc_amt   =   iCurColumnPos(29)
            C1_report_biz_area  =   iCurColumnPos(30)
            C1_tax_biz_area_nm  =   iCurColumnPos(31)
            C1_sales_grp    =   iCurColumnPos(32)
            C1_sales_grp_nm =   iCurColumnPos(33)
            C1_remarks  =   iCurColumnPos(34)
            C1_disuse_reason    =   iCurColumnPos(35)
            C1_legacy_pk    =   iCurColumnPos(36)
            C1_sale_no  =   iCurColumnPos(37)
            C1_remark   =   iCurColumnPos(38)
            C1_remark2  =   iCurColumnPos(39)
            C1_remark3  =   iCurColumnPos(40)
            C1_proc_flag    =   iCurColumnPos(41)
            C1_is_send  =   iCurColumnPos(42)
            C1_issue_dt_fg  =   iCurColumnPos(43)
            C1_inv_amend_type   =   iCurColumnPos(44)
            C1_name =   iCurColumnPos(45)
            C1_name_B =   iCurColumnPos(46)
            C1_email    =   iCurColumnPos(47)
            C1_bp_seq   =   iCurColumnPos(48)
            C1_name2    =   iCurColumnPos(49)
            C1_name2_B    =   iCurColumnPos(50)
            C1_email2   =   iCurColumnPos(51)
            C1_bp_seq2  =   iCurColumnPos(52)
    End Select
End Sub
                            ...
                            <TD CLASS="CLSMTABP">
                                <TABLE ID="MyTab" CELLSPACING=0 CELLPADDING=0>
                                    <TR>
                                        ...
                                        <td background="../../../CShared/image/table/seltab_up_bg.gif" align="center" CLASS="CLSMTAB"><font color=white>매출정발행등록</font></td>
