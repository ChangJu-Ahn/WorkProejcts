...
'*  7. Modified date(Last)  : 2000/12/9
'*  8. Modifier (First)     : 
...
On Error Resume Next
	...
	UNISqlId(0) = "185900sab"

	UNIValue(0, 0) = "^"
	UNIValue(0, 1) =  FilterVar(Trim(Request("lgPlantCd"))	, "''", "S") 
	
	IF Request("lgItemCd") = "" Then
	   strItemCd = "|"
	ELSE
	   strItemCd = FilterVar(Trim(Request("lgItemCd"))	, "''", "S")
	END IF
	...
	UNIValue(0, 3) =  FilterVar(Trim(Request("lgPlanOrderNo"))	, "''", "S")
