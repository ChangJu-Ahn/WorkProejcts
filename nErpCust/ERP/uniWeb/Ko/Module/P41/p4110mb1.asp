...
With parent																	'☜: 화면 처리 ASP 를 지칭함 
    IF .parent.CompareDateByFormat("<%=UNIDateClientFormat(rs2("end_dt"))%>",.frm1.txtEndDt.text,"","","970025",gDateFormat,gComDateType,False) = False And "<%=rs2("push_flg")%>" = "Y" Then  'Cdate(.frm1.txtEndDt.text) < Cdate("<%=UNIDateClientFormat(rs2("end_dt"))%>") AND "<%=rs2("push_flg")%>" = "Y" Then
		.frm1.txtStartDt.text = "<%= UNIDateClientFormat(rs2("start_dt")) %>"
		.frm1.txtEndDt.text = "<%= UNIDateClientFormat(rs2("end_dt")) %>"
	End If
...
%>	
			...
			strData1 = strData1 & Chr(11) & "<%=ConvSPChars(rs0("mps_no"))%>"
			strData1 = strData1 & Chr(11) & "<%=ConvSPChars(rs0("splt_seq_no"))%>"
			strData1 = strData1 & Chr(11) & "<%=ConvSPChars(rs0("bom_no"))%>"
...
%>			
			...
			strData2 = strData2 & Chr(11) & "<%=ConvSPChars(rs1("mps_no"))%>"
			strData2 = strData2 & Chr(11) & "<%=ConvSPChars(rs1("splt_seq_no"))%>"
			strData2 = strData2 & Chr(11) & "<%=ConvSPChars(rs1("bom_no"))%>"
			strData2 = strData2 & Chr(11) & "<%=ConvSPChars(rs1("procur_type"))%>"
			strData2 = strData2 & Chr(11) & "<%=ConvSPChars(rs1("procur_nm"))%>"
			strData2 = strData2 & Chr(11) & "0"
