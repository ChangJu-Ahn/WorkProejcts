...
'========================================================================================================
Const BIZ_PGM_ID = "P4104MB1_KO441.asp"                                      'Biz Logic ASP 
'========================================================================================================
...
Sub MakeKeyStream(ByVal pOpt)
   ...
   Select Case pOpt
       Case "MQ"
                  ...
                  lgKeyStream = lgKeyStream & frm1.txtProdFromDt.Text  & Parent.gColSep
                  lgKeyStream = lgKeyStream & frm1.txtProdToDt.Text  & Parent.gColSep
       Case "MN"
                  lgKeyStream = Frm1.htxtPlantCd.Value & Parent.gColSep       'You Must append one character(Parent.gColSep)
                  lgKeyStream = lgKeyStream & frm1.htxtPlantCd.Value  & Parent.gColSep                  
                  lgKeyStream = lgKeyStream & frm1.txtProdFromDt.Text  & Parent.gColSep
                  lgKeyStream = lgKeyStream & frm1.txtProdToDt.Text  & Parent.gColSep
   End Select                 
...
Sub InitSpreadSheet()
	...
	With frm1.vspdData
       ...
       ggoSpread.SSSetEdit    C_REPORT_DT    ,"실적년월"             ,8     ,0                  ,     ,100     ,2
       ggoSpread.SSSetEdit    C_PRODT_ORDER_NO    ,"제조오더번호"             ,18     ,0                  ,     ,100     ,2
       ...
       ggoSpread.SSSetFloat   C_CNT1        ,"생산실적건수"   ,15    , Parent.ggQtyNo   ,ggStrIntegeralPart ,ggStrDeciPointPart,Parent.gComNum1000,Parent.gComNumDec ,       ,      ,"P" 
...
'       call ggoSpread.MakePairsColumn(C_EnrollDT,C_GraduatedDT,"1")
       ...
       Call ggoSpread.SSSetColHidden(C_CNT1,C_CNT1,True)
...
Sub GetSpreadColumnPos(ByVal pvSpdNo)
    ...
    Select Case UCase(pvSpdNo)
       Case "A"
            ...
            C_REPORT_DT		=  iCurColumnPos(1)
            C_PRODT_ORDER_NO=  iCurColumnPos(2)  
			...
			C_CNT1			=  iCurColumnPos(8)	
			C_CNT2		    =  iCurColumnPos(9)	
			C_CNT3	        =  iCurColumnPos(10)	
			C_CNT4	        =  iCurColumnPos(11)	
					...
					<TD CLASS="CLSMTABP">
						<TABLE ID="MyTab" CELLSPACING=0 CELLPADDING=0>
							<TR>
								...
								<td background="../../../CShared/image/table/seltab_up_bg.gif" align="center" CLASS="CLSMTAB"><font color=white>실적기준생산기준정보건수</font></td>
