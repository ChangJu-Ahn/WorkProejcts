...
Const BIZ_PGM_QRY_ID            = "p4112mb1_ko441.asp"              '☆: List Production Order Header
Const BIZ_PGM_QRY2_ID	        = "p4112mb6_ko441.asp"				'☆: 비지니스 로직 ASP명
Const BIZ_PGM_SAVE_ID           = "p4112mb2_ko441.asp"              '☆: Manage Production Order Header
Const BIZ_PGM_SAVE_ID2          = "p4112mb7_ko441.asp"
Const BIZ_PGM_RELEASE_ID        = "p4112mb3_ko441.asp"              '☆: Release Production Order
Const BIZ_PGM_CANCEL_ID         = "p4112mb8_ko441.asp"              '☆: Release Production Order
...
Dim C_WcCd2          '= 4
Dim C_WcNm2          '= 5
Dim C_MachineCd2     '= 6       '2008-03-25 1:47오후 :: hanc
Dim C_MachineNm2     '= 7       '2008-03-25 1:47오후 :: hanc
Dim C_ItemCd2        '= 8 
Dim C_ItemCdPopup2   '= 9 
Dim C_ItemNm2        '= 10
Dim C_Spec2          '= 11
Dim C_ReqQty2        '= 12
Dim C_BaseUnit2      '= 13
Dim C_IssuedQty2     '= 14
Dim C_ReqDt2         '= 15
Dim C_TrackingNo2    '= 16
Dim C_SlCd2          '= 17
Dim C_SlCdPopup2     '= 18
Dim C_SlNm2          '= 19
Dim C_ResvStatus2    '= 20
Dim C_ResvDesc2      '= 21
Dim C_IssueMthd2     '= 22
Dim C_IssueMthdDesc2 '= 23
Dim C_ReqNo2         '= 24
Dim C_Seq2           '= 25
Dim C_ProdtOrderNo2  '= 26
Dim C_OrderStatus2   '= 27
Dim C_InsideFlag2    '= 28
'==========================================  1.2.2 Global 변수 선언  =====================================
...
Sub InitSpreadComboBox()
    ...
    '2008-05-15 2:13오후 :: hanc
    Call CommonQueryRs(" MINOR_CD,MINOR_NM "," B_MINOR "," MAJOR_CD = " & FilterVar("ZZ006", "''", "S") & " ",lgF0,lgF1,lgF2,lgF3,lgF4,lgF5,lgF6)
    ggoSpread.Source = frm1.vspdData
    ggoSpread.SetCombo Replace(lgF0,Chr(11),vbTab), C_IssueMthd2
    ggoSpread.SetCombo Replace(lgF1,Chr(11),vbTab), C_IssueMthdDesc2
...
Sub InitSpreadSheet(ByVal pvSpdNo)
    ...
    If pvSpdNo = "B" Or pvSpdNo = "*" Then
        ...
        ggoSpread.SSSetEdit     C_MachineCd2,        "장비TYPE", 10     '2008-03-25 1:48오후 :: hanc
        ggoSpread.SSSetEdit     C_MachineNm2,        "장비코드", 20     '2008-03-25 1:48오후 :: hanc
        ...
        ggoSpread.SSSetCombo	C_IssueMthd2,	"출고방법", 10
        ggoSpread.SSSetCombo	C_IssueMthdDesc2,"출고방법", 10
...
Sub SetSpreadLock(ByVal pvSpdNo)
    With frm1
		...
		If pvSpdNo = "B" Then
			...
			ggoSpread.SpreadLock C_MachineCd2,          -1, C_MachineCd2
			ggoSpread.SpreadLock C_MachineNm2,          -1, C_MachineNm2
...
'20080515::hanc			ggoSpread.SpreadLock C_IssueMthdDesc2, -1, C_IssueMthdDesc2
			...
			ggoSpread.SSSetRequired  C_IssueMthd2, -1
			ggoSpread.SSSetRequired  C_IssueMthdDesc2, -1
...
Sub SetSpreadColor2(ByVal pvStartRow, ByVal pvEndRow)
    With frm1.vspdData2
        ...
        ggoSpread.SSSetProtected C_MachineCd2,          pvStartRow, pvEndRow
        ggoSpread.SSSetProtected C_MachineNm2,          pvStartRow, pvEndRow
        ...
        ggoSpread.SSSetRequired C_IssueMthd2,     pvStartRow, pvEndRow
        ggoSpread.SSSetRequired C_IssueMthdDesc2, pvStartRow, pvEndRow
...
Sub InitSpreadPosVariables(ByVal pvSpdNo)
    ...
    If pvSpdNo = "A" Or pvSpdNo = "*" Then
        ...
        C_PlanOrderNo           = 28
        C_TrackingNo            = 29
        C_TrackingNoPopup       = 30
        C_ScheduledStartDt      = 31
        C_ScheduledEndDt        = 32
        C_ValidFromDT           = 33
        C_ValidToDT             = 34
        C_OrderUnitMFG          = 35
    ...
    If pvSpdNo = "B" Or pvSpdNo = "*" Then
        ...
        C_WcCd2          = 4
        C_WcNm2          = 5
        C_MachineCd2     = 6        '2008-03-25 1:49오후 :: hanc
        C_MachineNm2     = 7        '2008-03-25 1:49오후 :: hanc
        C_ItemCd2        = 8 
        C_ItemCdPopup2   = 9 
        C_ItemNm2        = 10
        C_Spec2          = 11
...
Sub GetSpreadColumnPos(ByVal pvSpdNo)
    ...
    Case "A"
        ...
        C_WcCdPopup             = iCurColumnPos(19)
        C_WcNm                  = iCurColumnPos(20)
        C_OrderStatus           = iCurColumnPos(21)
        C_OrderStatusDesc       = iCurColumnPos(22)
        C_ReWorkFlag            = iCurColumnPos(23)
        C_Remark                = iCurColumnPos(24)
        C_BOMNo                 = iCurColumnPos(25)
        C_OrderType             = iCurColumnPos(26)
        C_OrderTypeDesc         = iCurColumnPos(27)
        C_PlanOrderNo           = iCurColumnPos(28)
        C_TrackingNo            = iCurColumnPos(29)
        C_TrackingNoPopup       = iCurColumnPos(30)
        C_ScheduledStartDt      = iCurColumnPos(31)
        C_ScheduledEndDt        = iCurColumnPos(32)
        C_ValidFromDT           = iCurColumnPos(33)
        C_ValidToDT             = iCurColumnPos(34)
        C_OrderUnitMFG          = iCurColumnPos(35)
        C_OrderLtMFG            = iCurColumnPos(36)
        C_FixedMRPQty           = iCurColumnPos(37)
        C_MinMRPQty             = iCurColumnPos(38)
        C_MaxMRPQty             = iCurColumnPos(39)
        C_RoundQty              = iCurColumnPos(40)
        C_ScrapRateMFG          = iCurColumnPos(41)
        C_MPSMgr                = iCurColumnPos(42)
        C_MRPMgr                = iCurColumnPos(43)
        C_ProdMgr               = iCurColumnPos(44)
        C_ItemGroupCd           = iCurColumnPos(45)
        C_ItemGroupNm           = iCurColumnPos(46)
        C_MRPRunNo              = iCurColumnPos(47)
        C_ParentOrderNo         = iCurColumnPos(48)
        C_ParentOprNo           = iCurColumnPos(49)
        C_CostCd                = iCurColumnPos(50)
        C_Costpopup             = iCurColumnPos(51)
        C_CostNm                = iCurColumnPos(52)
        C_OprNo                 = iCurColumnPos(53)

		C_BsItemCd              = iCurColumnPos(54)
        C_BsItemNm              = iCurColumnPos(55)
    ...
    Case "B"
        ...
        C_MachineCd2          = iCurColumnPos(6) '2008-03-25 1:50오후 :: hanc
        C_MachineNm2          = iCurColumnPos(7) '2008-03-25 1:50오후 :: hanc
        C_ItemCd2        = iCurColumnPos(8) 
        C_ItemCdPopup2   = iCurColumnPos(9) 
        C_ItemNm2        = iCurColumnPos(10)
        C_Spec2          = iCurColumnPos(11)
        C_ReqQty2        = iCurColumnPos(12)
        C_BaseUnit2      = iCurColumnPos(13)
        C_IssuedQty2     = iCurColumnPos(14)
        C_ReqDt2         = iCurColumnPos(15)
        C_TrackingNo2    = iCurColumnPos(16)
        C_SlCd2          = iCurColumnPos(17)
        C_SlCdPopup2     = iCurColumnPos(18)
        C_SlNm2          = iCurColumnPos(19)
        C_ResvStatus2    = iCurColumnPos(20)
        C_ResvDesc2      = iCurColumnPos(21)
        C_IssueMthd2     = iCurColumnPos(22)
        C_IssueMthdDesc2 = iCurColumnPos(23)
        C_ReqNo2         = iCurColumnPos(24)
        C_Seq2           = iCurColumnPos(25)
        C_ProdtOrderNo2  = iCurColumnPos(26)
        C_OrderStatus2   = iCurColumnPos(27)
        C_InsideFlag2    = iCurColumnPos(28)
    End Select
...
Function ReleaseOrder()
    ...
    If iTmpCUBufferCount > -1 Then   ' 나머지 데이터 처리
       ...
       divTextArea.appendChild(objTEXTAREA)
    End If
'MsgBox "strVal of BIZ_PGM_RELEASE_ID : " & strVal
'Exit Function
...
'20080506::HANC            If (DtPlanStartDt <> "" and DtInvCloseDt <> "") and (isdate(DtPlanStartDt) and isdate(DtInvCloseDt)) Then
'20080506::HANC                If DtPlanStartDt <= DtInvCloseDt Then
'20080506::HANC                    Call DisplayMsgBox("189204", "x", "x", "x")
'20080506::HANC                    .Col = C_PlanStartDt
'20080506::HANC                    .Text = ""
'20080506::HANC                    Exit Sub
'20080506::HANC                End If
'20080506::HANC            End If
...
Function DbSave2()
    ...
    If ggoSpread.SSCheckChange = True Then                  '⊙: Check If data is chaged
        ...
        If iTmpDBufferCount > -1 Then    ' 나머지 데이터 처리 
           ...
           divTextArea.appendChild(objTEXTAREA)     
        End If   
'MsgBox " strVal of BIZ_PGM_SAVE_ID2  : " & strVal
'Exit Function
