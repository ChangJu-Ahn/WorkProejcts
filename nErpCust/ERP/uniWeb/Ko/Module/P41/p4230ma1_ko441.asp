...
<SCRIPT LANGUAGE = "VBScript" SRC = "p4230ma1_ko441.vbs"></SCRIPT>
						...
						<FIELDSET CLASS="CLSFLD">
							<TABLE <%=LR_SPACE_TYPE_40%>>
								<TR>
									...
									<TD CLASS="TD6">
										<script language =javascript src='./js/p4230ma1_ko441_I930485457_txtprodFromDt.js'></script>
										&nbsp;~&nbsp;
										<script language =javascript src='./js/p4230ma1_ko441_I202343761_txtprodToDt.js'></script>
									</TD>
								</TR>
								<TR>
						...
						<TABLE <%=LR_SPACE_TYPE_20%>>
							<TR HEIGHT="50%">
								<TD WIDTH="100%" colspan=4>
									<script language =javascript src='./js/p4230ma1_ko441_A_vspdData1.js'></script>
								</TD>
							</TR>
							<TR HEIGHT="50%">
								<TD WIDTH="50%">
									<script language =javascript src='./js/p4230ma1_ko441_B_vspdData2.js'></script>
								</TD>
								<TD WIDTH="50%">
									<script language =javascript src='./js/p4230ma1_ko441_C_vspdData3.js'></script>
								</TD>
							</TR>
						</TABLE>
					</TD>
