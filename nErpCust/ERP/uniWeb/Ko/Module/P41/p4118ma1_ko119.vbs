...
'Grid 1 - Order Header
Const BIZ_PGM_QRY1_ID	= "p4118mb1_ko119.asp"						'☆: Head Query 비지니스 로직 ASP명 
'Post Production Results
Const BIZ_PGM_SAVE_ID	= "p4118mb2_ko119.asp"						'☆: 비지니스 로직 ASP명 							
...
Const C_JobPlanTime1	=   7
Const C_JobOrderNo1		=   8      
Const C_JobQty1			=	9
Const C_JobSeq1			=	10
Const C_JobPlanTime2	=   11
Const C_JobOrderNo2     =   12
Const C_JobQty2         =	13 
Const C_JobSeq2			=	14
Const C_JobPlanTime3	=   15
Const C_JobOrderNo3     =   16
Const C_JobQty3         =	17
Const C_JobSeq3			=	18
Const C_JobPlanTime4	=   19
Const C_JobOrderNo4     =   20 
Const C_JobQty4         =	21 
Const C_JobSeq4			=	22
Const C_JobPlanTime5	=   23
Const C_JobOrderNo5		=	24 
Const C_JobQty5			=	25
Const C_JobSeq5			=	26
Const C_JobPlanTime6	=   27
Const C_JobOrderNo6		=	28
Const C_JobQty6			=	29
Const C_JobSeq6			=	30
Const C_JobPlanTime7	=   31
Const C_JobOrderNo7		=	32
Const C_JobQty7			=	33
Const C_JobSeq7			=	34
Const C_JobPlanTime8	=   35
Const C_JobOrderNo8		=	36
Const C_JobQty8			=	37
Const C_JobSeq8			=	38
Const C_JobPlanTime9	=   39
Const C_JobOrderNo9		=	40
Const C_JobQty9			=	41
Const C_JobSeq9			=	42
Const C_JobPlanTime10	=   43
Const C_JobOrderNo10	=	44	
Const C_JobQty10		=	45
Const C_JobSeq10		=	46
Const C_JobPlanTime11	=   47
Const C_JobOrderNo11	=	48
Const C_JobQty11		=	49
Const C_JobSeq11		=	50
Const C_JobPlanTime12	=   51
Const C_JobOrderNo12	=	52
Const C_JobQty12		=	53
Const C_JobSeq12		=	54
Const C_JobPlanTime13	=   55
Const C_JobOrderNo13	=	56
Const C_JobQty13		=	57
Const C_JobSeq13		=	58
Const C_JobPlanTime14	=   59
Const C_JobOrderNo14	=	60
Const C_JobQty14		=	61
Const C_JobSeq14		=	62
Const C_JobPlanTime15	=   63
Const C_JobOrderNo15	=	64
Const C_JobQty15		=	65
Const C_JobSeq15		=	66
Const C_JobPlanTime16	=   67
Const C_JobOrderNo16	=	68
Const C_JobQty16		=	69
Const C_JobSeq16		=	70
Const C_JobPlanTime17	=   71
Const C_JobOrderNo17	=	72
Const C_JobQty17		=	73
Const C_JobSeq17		=	74
Const C_JobPlanTime18	=   75
Const C_JobOrderNo18	=	76
Const C_JobQty18		=	77
Const C_JobSeq18		=	78
Const C_JobPlanTime19	=   79
Const C_JobOrderNo19	=	80
Const C_JobQty19		=	81
Const C_JobSeq19		=	82
Const C_JobPlanTime20	=   83
Const C_JobOrderNo20	=	84
Const C_JobQty20		=	85
Const C_JobSeq20		=	86
Const C_JobPlanTime21	=   87
Const C_JobOrderNo21	=	88
Const C_JobQty21		=	89
Const C_JobSeq21		=	90
Const C_JobPlanTime22	=   91
Const C_JobOrderNo22	=	92
Const C_JobQty22		=	93
Const C_JobSeq22		=	94
Const C_JobPlanTime23	=   95
Const C_JobOrderNo23	=	96
Const C_JobQty23		=	97
Const C_JobSeq23		=	98
Const C_JobPlanTime24	=   99
Const C_JobOrderNo24	=	100
Const C_JobQty24		=	101
Const C_JobSeq24		=	102
      ...
      End if
		...
		With frm1.vspdData1
          ...
          Select Case C_GRIDCOUNT
			Case "1"
				.MaxCols = C_JobSeq1 +1										'☜: 최대 Columns의 항상 1개 증가시킴 
			Case "2"
				.MaxCols = C_JobSeq2 +1
			Case "3"
				.MaxCols = C_JobSeq3 +1
			...
			Case "9"
				.MaxCols = C_JobSeq9 +1		
			Case "10"
				.MaxCols = C_JobSeq10 +1		
			Case "11"
				.MaxCols = C_JobSeq11 +1		
			Case "12"
				.MaxCols = C_JobSeq12 +1		
			Case "13"
				.MaxCols = C_JobSeq13 +1		
			Case "14"
				.MaxCols = C_JobSeq14 +1		
			Case "15"
				.MaxCols = C_JobSeq15 +1		
			Case "16"
				.MaxCols = C_JobSeq16 +1		
			Case "17"
				.MaxCols = C_JobSeq17 +1		
			Case "18"
				.MaxCols = C_JobSeq18 +1		
			Case "19"
				.MaxCols = C_JobSeq19 +1		
			Case "20"
				.MaxCols = C_JobSeq20 +1		
			Case "21"
				.MaxCols = C_JobSeq21 +1		
			Case "22"
				.MaxCols = C_JobSeq22 +1
			Case "23"
				.MaxCols = C_JobSeq23 +1		
			Case "24"
				.MaxCols = C_JobSeq24 +1						
		  End Select				
...
'			Call GetSpreadColumnPos("B") 
			...
			if (iDx = "9" or iDx = "13" or iDx = "17" or iDx = "21" or iDx = "25" or iDx = "29" or iDx = "33" or iDx = "37" or iDx = "41" or iDx = "45" or iDx = "49" or iDx = "53" or iDx = "57" or iDx = "61" or iDx = "65" or iDx = "69" or iDx = "73" or iDx = "77" or iDx = "81" or iDx = "85" or iDx = "89" or iDx = "93" or iDx = "97" or iDx = "101") then
				ggoSpread.SSSetFloat	iDx, strJobCaption ,8, "6",ggStrIntegeralPart, ggStrDeciPointPart,parent.gComNum1000,parent.gComNumDec,,,"Z"
			elseif (iDx = "7" or iDx = "11" or iDx = "15" or iDx = "19" or iDx = "23" or iDx = "27" or iDx = "31" or iDx = "35" or iDx = "39" or iDx = "43" or iDx = "47" or iDx = "51" or iDx = "55" or iDx = "59" or iDx = "63" or iDx = "67" or iDx = "71" or iDx = "75" or iDx = "79" or iDx = "83" or iDx = "87" or iDx = "91" or iDx = "95" or iDx = "99") then
			    ggoSpread.SSSetEdit		iDx, "작업계획시간" , 4
			Call ggoSpread.SSSetColHidden(iDx, iDx, True)
			elseif (iDx = "8" or iDx = "12" or iDx = "16" or iDx = "20" or iDx = "24" or iDx = "28" or iDx = "32" or iDx = "36" or iDx = "40" or iDx = "44" or iDx = "48" or iDx = "52" or iDx = "56" or iDx = "60" or iDx = "64" or iDx = "68" or iDx = "72" or iDx = "76" or iDx = "80" or iDx = "84" or iDx = "88" or iDx = "92" or iDx = "96" or iDx = "100") then  
				ggoSpread.SSSetEdit		iDx, "작업지시번호" , 13,,,18
				Call ggoSpread.SSSetColHidden(iDx, iDx, True)
			else
				ggoSpread.SSSetEdit	    iDx, "우선순위" ,8, 2, -1, 5	
			end if	
			...
			With frm1
			  ...
			  For ii = 1  to C_GRIDCOUNT * 4
				  ...
				  Case "96"
					iDx = "102"
                End Select
			    if (iDx = "10" or iDx = "14" or iDx = "18" or iDx = "22" or iDx = "26" or iDx = "30" or iDx = "34" or iDx = "38" or iDx = "42" or iDx = "46" or iDx = "50" or iDx = "54" or iDx = "58" or iDx = "62" or iDx = "66" or iDx = "70" or iDx = "74" or iDx = "78" or iDx = "82" or iDx = "86" or iDx = "90" or iDx = "94" or iDx = "98" or iDx = "102") then    
			       frm1.vspdData1.Col = (int(iDx) - 2)
			       value1 = frm1.vspdData1.text 
'			        if value1 = "" then
'						Call SetSpreadColor(iDx, frm1.vspdData1.Row, frm1.vspdData1.Row) 
'			        else 
			            ggoSpread.SpreadUnLock iDx, Row,iDx
'  			        end if 
			    else
					ggoSpread.SSSetProtected iDx, -1, iDx
				End if	
			  Next 	
  ...
  ggoSpread.Source = frm1.vspdData1
   	...
   	For  i = 1 to frm1.vspddata1.maxrows
			    ...
			    if (iDx = "10" or iDx = "14" or iDx = "18" or iDx = "22" or iDx = "26" or iDx = "30" or iDx = "34" or iDx = "38" or iDx = "42" or iDx = "46" or iDx = "50" or iDx = "54" or iDx = "58" or iDx = "62" or iDx = "66" or iDx = "70" or iDx = "74" or iDx = "78" or iDx = "82" or iDx = "86" or iDx = "90" or iDx = "94" or iDx = "98" or iDx = "102") then    
			       ...
			       value1 = frm1.vspdData1.Text 
			        if value1 = "" then
						ggoSpread.SpreadLock iDx, i, iDx, i
			        else 
			            ggoSpread.SpreadUnLock iDx, i, iDx, i
  			        end if 
'			    else
'					ggoSpread.SSSetProtected iDx, -1, iDx
				End if	
...
'		    Case "10", "14", "18", "22", "26", "30", "34", "38", "42", "46", "50", "54", "58", "62", "66", "70", "74", "78", "82", "86", "90", "94", "98", "102" 
				ggoSpread.Source = frm1.vspdData1
    ...
    For lRow = 1 To .vspdData1.MaxRows
        ...
        Select Case .vspdData1.Text
			...
			For Loop2 = 1  to  C_GRIDCOUNT 
                ...
                .vspdData1.Col = C_ProdtOrderNo1	'3
                strVal = strVal & Trim(.vspdData1.Text) & parent.gColSep
                
                .vspdData1.Col = C_JobLineCd	'4
                strVal = strVal & Trim(.vspdData1.Text) & parent.gColSep
                
                strVal = strVal & UNIConvDate(Trim(StartDate2)) & parent.gColSep
                strVal = strVal & UNIConvDate(Trim(EndDate2)) & parent.gColSep
                
                .vspdData1.Col =  ((Loop2*3) + 3) - 2    '5	 '작업계획시간
                strVal = strVal & Trim(.vspdData1.Text) & parent.gColSep
                
                
                .vspdData1.Col = ((Loop2*3) + 3 ) -1    '6	 '작업지시번호
                strVal = strVal & Trim(.vspdData1.Text) & parent.gColSep
                
        
                .vspdData1.Col = ((Loop2*3) + 3 ) 	'7   '작업예정수량
                strVal = strVal & UNIConvNum(Trim(.vspdData1.Text),0) & parent.gRowSep
...
'                strVal = strVal & UNIConvDate(Trim(EndDate2)) & parent.gColSep
                ...
                .vspdData1.Col =  ((Loop2*4) + 6) - 3    '6	 '작업계획시간          '7
                strVal = strVal & Trim(.vspdData1.Text) & parent.gColSep
                
                .vspdData1.Col = ((Loop2*4) + 6 ) -2    '7	 '작업지시번호           '8
                strVal = strVal & Trim(.vspdData1.Text) & parent.gColSep
                
'                .vspdData1.Col = ((Loop2*3) + 3 ) 	    '작업예정수량
'                strVal = strVal & UNIConvNum(Trim(.vspdData1.Text),0) & parent.gRowSep
				
               .vspdData1.Col = ((Loop2*4) + 6 )     '8	 '우선순위                '9
            ...
            Case ggoSpread.DeleteFlag												'☜: 삭제 
              ...
              For Loop2 = 1  to  C_GRIDCOUNT
				...
				strDel = strDel & "D" & parent.gColSep	& lRow & parent.gColSep & Loop2 &  parent.gColSep
                 ...
                 .vspdData1.Col = C_ProdtOrderNo1	'3
                strDel = strDel & Trim(.vspdData1.Text) & parent.gColSep
                ...
                .vspdData1.Col = ((Loop2*3) + 3 ) 	'7   '작업예정수량
                strDel = strDel & UNIConvNum(Trim(.vspdData1.Text),0) & parent.gRowSep
