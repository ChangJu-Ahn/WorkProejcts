...
'   importString2 = Trim(Request("txtProdFromDt"))
   ...
   txtSpread    = Trim(Request("txtSpread"))
    ...
    Set PP4G171_ko119_Data = Server.CreateObject("PP4G171_KO119.cPMngWorkOrderSeq")
    ...
    Call PP4G171_ko119_Data.P_Manage_Work_Order_Seq(gStrGlobalCollection, importString,  txtSpread, iErrPosition)			
		
    If CheckSYSTEMError2(Err, True ,iErrPosition & "Çà","","","","") = True Then					
       Call SetErrorStatus
       Set PP4G171_ko119_Data = Nothing
       Exit Sub
    End If    
