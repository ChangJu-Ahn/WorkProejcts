...
<SCRIPT LANGUAGE = "VBScript" SRC = "p4130ma1_ko441.vbs"></SCRIPT>
					...
					<TD CLASS="CLSMTABP">
						<TABLE ID="MyTab" CELLSPACING=0 CELLPADDING=0>
							<TR>
								...
								<td background="../../../CShared/image/table/seltab_up_bg.gif" align="center" CLASS="CLSMTAB"><font color=white>제조오더전송</font></td>
						...
						<FIELDSET CLASS="CLSFLD">
							<TABLE <%=LR_SPACE_TYPE_40%>>
								<TR>
									...
									<TD CLASS="TD6">
										<script language =javascript src='./js/p4130ma1_ko441_I930485457_txtprodFromDt.js'></script>
										&nbsp;~&nbsp;
										<script language =javascript src='./js/p4130ma1_ko441_I202343761_txtprodToDt.js'></script>
									</TD>
								</TR>
								<TR>
								...
								<TR>
									...
									<TD CLASS=TD6 NOWRAP>
										<INPUT TYPE="RADIO" CLASS="RADIO" NAME="rdoSendStatus" tag="11" CHECKED ID="rdoStatus1" VALUE="Y" ONCLICK="vbscript:ClickrdoStatus1()"><LABEL FOR="rdoStatus1">전송</LABEL>
										<INPUT TYPE="RADIO" CLASS="RADIO" NAME="rdoSendStatus" tag="11" ID="rdoStatus2" VALUE="N"  ONCLICK="vbscript:ClickrdoStatus2()"><LABEL FOR="rdoStatus2">미전송</LABEL>
                                    </TD>
						...
						<TABLE <%=LR_SPACE_TYPE_20%>>
							<TR HEIGHT="50%">
								<TD WIDTH="100%" colspan=4>
									<script language =javascript src='./js/p4130ma1_ko441_A_vspdData1.js'></script>
								</TD>
							</TR>
							<TR HEIGHT="50%">
								<TD WIDTH="50%">
									<script language =javascript src='./js/p4130ma1_ko441_B_vspdData2.js'></script>
								</TD>
								<TD WIDTH="50%">
									<script language =javascript src='./js/p4130ma1_ko441_C_vspdData3.js'></script>
								</TD>
							</TR>
						</TABLE>
					</TD>
    ...
    <TR HEIGHT="20">
      <TD WIDTH="100%">
		<TABLE <%=LR_SPACE_TYPE_30%>>
			<TR>
			  <TD WIDTH=10>&nbsp;</TD>
			  <TD WIDTH="*" align="left"><a><button name="btnAutoSel" class="clsmbtn">전 송</button></a></TD>
			  <TD WIDTH=10>&nbsp;</TD>
			</TR>
		</TABLE>
      </TD>
...
<INPUT TYPE=HIDDEN NAME="hSendStatus" tag="24">
<P ID="divTextArea"></P>
</FORM>
