...
<SCRIPT LANGUAGE="VBScript"   SRC="p4117ma1_ko119.vbs"></SCRIPT>
					...
					<TD CLASS="CLSMTABP">
						<TABLE ID="MyTab" CELLSPACING=0 CELLPADDING=0>
							<TR>
								...
								<td background="../../../CShared/image/table/seltab_up_bg.gif" align="center" CLASS="CLSMTAB"><font color=white>시간대별작업지시등록(S)</font></td>
						...
						<FIELDSET CLASS="CLSFLD">
							<TABLE <%=LR_SPACE_TYPE_40%>>
								<TR>
									...
									<TD CLASS="TD6">
										<script language =javascript src='./js/p4117ma1_ko119_I847991329_txtProdFromDt.js'></script>
<!--										
										&nbsp;~&nbsp;
						...
						<TABLE <%=LR_SPACE_TYPE_20%>>
							<TR HEIGHT="50%">
								<TD WIDTH="100%" colspan=4>
									<script language =javascript src='./js/p4117ma1_ko119_A_vspdData1.js'></script>
								</TD>
							</TR>
							<TR HEIGHT="50%">
								<TD WIDTH="100%" colspan=4>
									<script language =javascript src='./js/p4117ma1_ko119_B_vspdData2.js'></script>
								</TD>
							</TR>
						</TABLE>
					</TD>
...
<script language =javascript src='./js/p4117ma1_ko119_C_vspdData3.js'></script>		
<P ID="divTextArea"></P>
</FORM>
