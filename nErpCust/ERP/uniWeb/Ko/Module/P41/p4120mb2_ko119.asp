...
'*  2. Function Name		: 
'*  3. Program ID			: p4120mb2_ko119.asp
...
'   importString2 = Trim(Request("txtProdFromDt"))
   ...
   txtSpread    = Trim(Request("txtSpread"))
    ...
    Set PP4G173_ko119_Data = Server.CreateObject("PP4G173_KO119.cPMngWorkOrdCont")
    ...
    Call PP4G173_ko119_Data.P_Manage_Work_Order_Cont(gStrGlobalCollection, importString,  txtSpread, iErrPosition)			
		
    If CheckSYSTEMError2(Err, True ,iErrPosition & "Çà","","","","") = True Then					
       Call SetErrorStatus
       Set PP4G173_ko119_Data = Nothing
       Exit Sub
    End If    
