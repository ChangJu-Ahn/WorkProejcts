...
Const BIZ_PGM_ID = "p4114rb1.asp"							'☆: 비지니스 로직 ASP명 
...
Sub InitSpreadSheet()
	...
	ggoSpread.SSSetEdit		C_ChangeSeq,	"이력순서", 8							
	ggoSpread.SSSetEdit		C_ActionFlg,	"이력구분", 8	
	ggoSpread.SSSetDate 	C_ApplyDt,		"적용일자", 11, 2, PopupParent.gDateFormat						
	ggoSpread.SSSetEdit		C_PreWcCd,		"이전 작업장", 12
	ggoSpread.SSSetEdit		C_PreWcNm,		"작업장명", 15
	ggoSpread.SSSetEdit		C_UsrNm,		"처리자", 15
