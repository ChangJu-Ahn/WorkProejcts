...
Const BIZ_PGM_QRY1_ID						= "p4130mb1_ko441.asp"		'☆: Release Production Order Query ASP명 
Const BIZ_PGM_QRY2_ID						= "p4130mb2_ko441.asp"		'☆: Operation Query ASP명 
Const BIZ_PGM_QRY3_ID						= "p4130mb3_ko441.asp"		'☆: Reservation Query ASP명 
Const BIZ_PGM_SAVE_ID						= "p4130mb4_ko441.asp"		'☆: Cancel Release Production Order ASP명 
...
Dim  C_Select			'= 1
Dim  C_IfFlag			'= 2
Dim  C_OrdNo			'= 3 																'☆: Spread Sheet 의 Columns 인덱스 
Dim  C_ItemCd			'= 4 
Dim  C_ItemNm			'= 5 
Dim	 C_Spec				'= 6 
Dim  C_RoutNo			'= 7 
...
Sub InitVariables()
    ...
    If frm1.rdoStatus1.checked = True Then
	    frm1.btnAutoSel.value = "전송취소"
    Else
	    frm1.btnAutoSel.value = "전송"
    End If
'20080114::hanc	frm1.btnAutoSel.value = "전체선택"
...
Sub InitSpreadSheet(ByVal pvSpdNo)
    ...
    With frm1
		If pvSpdNo = "A" Or pvSpdNo = "*" Then
			...
			ggoSpread.SSSetEdit			C_IfFlag,		"전송구분", 10
...
Sub InitSpreadPosVariables(ByVal pvSpdNo)
	...
	If pvSpdNo = "A" Or pvSpdNo = "*" Then
		...
		C_Select			= 1
		C_IfFlag			= 2
		C_OrdNo				= 3 																'☆: Spread Sheet 의 Columns 인덱스 
		C_ItemCd			= 4 
		C_Spec				= 5 
		C_ItemNm			= 6 
		C_RoutNo			= 7 
...
Sub GetSpreadColumnPos(ByVal pvSpdNo)
 	...
 	Select Case UCase(pvSpdNo)
 		Case "A"
			...
			C_IfFlag			= iCurColumnPos(2)
			C_OrdNo				= iCurColumnPos(3) 																'☆: Spread Sheet 의 Columns 인덱스 
			C_ItemCd			= iCurColumnPos(4) 
			C_ItemNm			= iCurColumnPos(5) 
			C_Spec				= iCurColumnPos(6) 
			C_RoutNo			= iCurColumnPos(7) 
			C_PlanStartDt		= iCurColumnPos(8) 
			C_PlanEndDt			= iCurColumnPos(9) 
			C_OrdQty			= iCurColumnPos(10)
			C_OrdUnit			= iCurColumnPos(11)
			C_TrackingNo		= iCurColumnPos(12)
			C_OrderType			= iCurColumnPos(13)
			C_OrderTypeDesc		= iCurColumnPos(14)
...
'20080114::hanc		frm1.btnAutoSel.value = "전체선택취소"
	End If
...
Function FncQuery() 
    ...
    If frm1.rdoStatus2.checked = True Then
        frm1.hSendStatus.value = "N"
    Else
        frm1.hSendStatus.value = "Y"
    End If
...
Function DbQuery() 
    ...
    If lgIntFlgMode = parent.OPMD_UMODE Then
        ...
        strVal = strVal & "&rdoSendStatus=" & Trim(frm1.hSendStatus.value)      '20080115::hanc
...
Function DbQueryOk(Byval LngMaxRow)
    ...
    '20080115::hanc  Call SetToolBar("11001001000111")
    ...
    For lRow = 1 To .vspdData1.MaxRows
        ...
        Select Case .vspdData1.Text
            ...
            Case ggoSpread.UpdateFlag
				...
				.vspdData1.Col = C_OrdQty			
				strVal = strVal & Trim(.vspdData1.Text) & iColSep
				
				.vspdData1.Col = C_RoutNo			
				strVal = strVal & Trim(.vspdData1.Text) & iColSep

				.vspdData1.Col = C_PlanStartDt			
				strVal = strVal & Trim(.vspdData1.Text) & iColSep

				.vspdData1.Col = C_PlanEndDt			
				strVal = strVal & Trim(.vspdData1.Text) & iColSep

				.vspdData1.Col = C_OrderType			
				strVal = strVal & Trim(.vspdData1.Text) & iColSep

				strVal = strVal & Trim(frm1.hSendStatus.value) & iColSep
