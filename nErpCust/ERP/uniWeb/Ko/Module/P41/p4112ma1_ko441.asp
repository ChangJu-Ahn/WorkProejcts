...
<SCRIPT LANGUAGE = "VBScript" SRC = "p4112ma1_ko441.vbs"></SCRIPT>
					...
					<TD CLASS="CLSMTABP">
						<TABLE ID="MyTab" CELLSPACING=0 CELLPADDING=0>
							<TR>
								...
								<td background="../../../CShared/image/table/seltab_up_bg.gif" align="center" CLASS="CLSMTAB"><font color=white>제조오더관리(소요량조정포함)</font></td>
						...
						<FIELDSET CLASS="CLSFLD">
							<TABLE <%=LR_SPACE_TYPE_40%>>
								...
								<TR>
									...
									<TD CLASS="TD6" NOWRAP><INPUT TYPE=TEXT ALT="기준품목" NAME="txtBsItemcd" SIZE=15 MAXLENGTH=18 tag="11NXXU"><IMG SRC="../../../CShared/image/btnPopup.gif" NAME="btnItemCd" align=top TYPE="BUTTON" ONCLICK="vbscript:OpenBsItem()">&nbsp;<INPUT TYPE=TEXT ALT="품목" NAME="txtBsitemNm" SIZE=20 tag="14X"></TD>
<!--
...
-->
								...
								<TR>
									...
									<TD CLASS=TD6 NOWRAP>
                                        <SELECT NAME="cboOrderType" ALT="지시구분" STYLE="Width: 98px;" tag="11"><OPTION VALUE=""></OPTION></SELECT>
										<INPUT TYPE="RADIO" CLASS="RADIO" NAME="rdoOrderStatus" tag="11" CHECKED ID="rdoStatus1" VALUE="RL"><LABEL FOR="rdoStatus1">확정</LABEL>
										<INPUT TYPE="RADIO" CLASS="RADIO" NAME="rdoOrderStatus" tag="11" ID="rdoStatus2" VALUE="OP"><LABEL FOR="rdoStatus2">미확정</LABEL>
                                    </TD>
								</TR>
							</TABLE>
						</FIELDSET>
	...
	<TR HEIGHT=20>
		<TD WIDTH=100%>
			<TABLE <%=LR_SPACE_TYPE_30%>>
				<TR>				
					<TD WIDTH=10>&nbsp;</TD>
					<TD Align=left><BUTTON NAME="btnRelease" CLASS="CLSMBTN">제조오더확정취소</BUTTON></TD>
