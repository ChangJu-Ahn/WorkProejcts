...
Function SetToolBar(inpar)
    ...
    if  mid(inpar,1,1) = "1" then
	    parent.submit.style.visibility = "visible"
	    parent.submit.width = "28"
	else
	    parent.submit.style.visibility = "hidden"
	    parent.submit.width = "0"
    end if

    ' 삭제
    if  mid(inpar,3,1) = "1" then
	    parent.del.style.visibility = "visible"
	   parent.del.width = "28"
	else
	    parent.del.style.visibility = "hidden"
	    parent.del.width = "0"
    end if

    ' 추가
    if  mid(inpar,2,1) = "1" then
	    parent.add.style.visibility = "visible"
	    parent.add.width = "28"
	else
	    parent.add.style.visibility = "hidden"
	    parent.add.width = "0"
    end if

    ' 저장
    if  mid(inpar,4,1) = "1" then
	    parent.save.style.visibility = "visible"
	    parent.save.width = "28"
	else
	    parent.save.style.visibility = "hidden"
	    parent.save.width = "0"
    end if

    ' 출력
    if  mid(inpar,5,1) = "1" then
	    parent.prt.style.visibility = "visible"
	    parent.prt.width = "28"
	else
	    parent.prt.style.visibility = "hidden"
	    parent.prt.width = "0"
    end if
